...
class OFOxsFlowCountVer15 implements OFOxsFlowCount {
...
//
    ...
    final static OFOxsFlowCountVer15 DEFAULT = new OFOxsFlowCountVer15(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFOxsFlowCount.Builder {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxsFlowCount> {
        ...
        public OFOxsFlowCount readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxsFlowCountVer15 oxsFlowCountVer15 = new OFOxsFlowCountVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxsFlowCountVer15);
    ...
    final static OFOxsFlowCountVer15Funnel FUNNEL = new OFOxsFlowCountVer15Funnel();
