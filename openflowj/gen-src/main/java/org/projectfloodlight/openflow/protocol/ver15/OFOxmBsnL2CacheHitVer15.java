...
class OFOxmBsnL2CacheHitVer15 implements OFOxmBsnL2CacheHit {
...
//
    ...
    final static OFOxmBsnL2CacheHitVer15 DEFAULT = new OFOxmBsnL2CacheHitVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnL2CacheHit> {
        ...
        public OFOxmBsnL2CacheHit readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnL2CacheHitVer15 oxmBsnL2CacheHitVer15 = new OFOxmBsnL2CacheHitVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnL2CacheHitVer15);
    ...
    final static OFOxmBsnL2CacheHitVer15Funnel FUNNEL = new OFOxmBsnL2CacheHitVer15Funnel();
    static class OFOxmBsnL2CacheHitVer15Funnel implements Funnel<OFOxmBsnL2CacheHitVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnL2CacheHitVer15> {
        @Override
