...
class OFBsnTlvAnchorVer15 implements OFBsnTlvAnchor {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvAnchor> {
        ...
        public OFBsnTlvAnchor readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvAnchorVer15 bsnTlvAnchorVer15 = new OFBsnTlvAnchorVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvAnchorVer15);
    ...
    final static OFBsnTlvAnchorVer15Funnel FUNNEL = new OFBsnTlvAnchorVer15Funnel();
    static class OFBsnTlvAnchorVer15Funnel implements Funnel<OFBsnTlvAnchorVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvAnchorVer15> {
        @Override
