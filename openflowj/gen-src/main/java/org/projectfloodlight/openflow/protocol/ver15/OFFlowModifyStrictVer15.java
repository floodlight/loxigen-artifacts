...
class OFFlowModifyStrictVer15 implements OFFlowModifyStrict {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowModifyStrictVer15.class);
    // version: 1.5
...
//
    ...
    final static OFFlowModifyStrictVer15 DEFAULT = new OFFlowModifyStrictVer15(
    ...
    OFFlowModifyStrictVer15(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, int importance, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property cookieMask cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property tableId cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property outGroup cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property flags cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property match cannot be null");
        }
        if(instructions == null) {
            throw new NullPointerException("OFFlowModifyStrictVer15: property instructions cannot be null");
        }
        this.xid = xid;
        this.cookie = cookie;
    ...
    static class BuilderWithParent implements OFFlowModifyStrict.Builder {
        final OFFlowModifyStrictVer15 parentMessage;
        ...
        BuilderWithParent(OFFlowModifyStrictVer15 parentMessage) {
    ...
    public OFFlowModifyStrict.Builder setImportance(int importance) {
        ...
        public OFFlowModifyStrict build() {
                ...
                //
                return new OFFlowModifyStrictVer15(
                    xid,
                    cookie,
                    cookieMask,
                    tableId,
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFFlowModifyStrict> {
        ...
        public OFFlowModifyStrict readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFInstruction> instructions = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFInstructionVer15.READER);

            OFFlowModifyStrictVer15 flowModifyStrictVer15 = new OFFlowModifyStrictVer15(
                    xid,
                      cookie,
                      cookieMask,
                      tableId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowModifyStrictVer15);
            return flowModifyStrictVer15;
        }
    }
    ...
    final static OFFlowModifyStrictVer15Funnel FUNNEL = new OFFlowModifyStrictVer15Funnel();
    static class OFFlowModifyStrictVer15Funnel implements Funnel<OFFlowModifyStrictVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowModifyStrictVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFFlowModifyStrictVer15> {
        @Override
        public void write(ByteBuf bb, OFFlowModifyStrictVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowModifyStrictVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowModifyStrictVer15 other = (OFFlowModifyStrictVer15) obj;
