...
class OFBsnLacpStatsReplyVer15 implements OFBsnLacpStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnLacpStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnLacpStatsReplyVer15 DEFAULT = new OFBsnLacpStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnLacpStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnLacpStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnLacpStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnLacpStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnLacpStatsReply.Builder {
        final OFBsnLacpStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnLacpStatsReplyVer15 parentMessage) {
    ...
    public OFBsnLacpStatsReply.Builder setXid(long xid) {
        ...
        public OFBsnLacpStatsReply build() {
                ...
                //
                return new OFBsnLacpStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnLacpStatsReply> {
        ...
        public OFBsnLacpStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnLacpStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnLacpStatsEntryVer15.READER);

            OFBsnLacpStatsReplyVer15 bsnLacpStatsReplyVer15 = new OFBsnLacpStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLacpStatsReplyVer15);
            return bsnLacpStatsReplyVer15;
        }
    }
    ...
    final static OFBsnLacpStatsReplyVer15Funnel FUNNEL = new OFBsnLacpStatsReplyVer15Funnel();
    static class OFBsnLacpStatsReplyVer15Funnel implements Funnel<OFBsnLacpStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnLacpStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnLacpStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnLacpStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnLacpStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnLacpStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnLacpStatsReplyVer15 other = (OFBsnLacpStatsReplyVer15) obj;
