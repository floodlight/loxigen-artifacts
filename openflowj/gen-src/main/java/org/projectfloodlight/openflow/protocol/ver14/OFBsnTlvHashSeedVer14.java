...
class OFBsnTlvHashSeedVer14 implements OFBsnTlvHashSeed {
...
//
    ...
    final static OFBsnTlvHashSeedVer14 DEFAULT = new OFBsnTlvHashSeedVer14(
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvHashSeed> {
        ...
        public OFBsnTlvHashSeed readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvHashSeedVer14 bsnTlvHashSeedVer14 = new OFBsnTlvHashSeedVer14(
                    seed1,
                      seed2
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvHashSeedVer14);
    ...
    final static OFBsnTlvHashSeedVer14Funnel FUNNEL = new OFBsnTlvHashSeedVer14Funnel();
    static class OFBsnTlvHashSeedVer14Funnel implements Funnel<OFBsnTlvHashSeedVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvHashSeedVer14> {
        @Override
