...
class OFOxmIpv6SrcMaskedVer15 implements OFOxmIpv6SrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6SrcMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6SrcMaskedVer15 DEFAULT = new OFOxmIpv6SrcMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6SrcMaskedVer15(IPv6Address value, IPv6Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6SrcMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv6SrcMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IPv6Address> getCanonical() {
        if (IPv6Address.NO_MASK.equals(mask)) {
            return new OFOxmIpv6SrcVer15(value);
    ...
    static class BuilderWithParent implements OFOxmIpv6SrcMasked.Builder {
        final OFOxmIpv6SrcMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv6SrcMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6SrcMasked> {
        ...
        public OFOxmIpv6SrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6SrcMaskedVer15 oxmIpv6SrcMaskedVer15 = new OFOxmIpv6SrcMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6SrcMaskedVer15);
            return oxmIpv6SrcMaskedVer15;
        }
    }
    ...
    final static OFOxmIpv6SrcMaskedVer15Funnel FUNNEL = new OFOxmIpv6SrcMaskedVer15Funnel();
    static class OFOxmIpv6SrcMaskedVer15Funnel implements Funnel<OFOxmIpv6SrcMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6SrcMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003520L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6SrcMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6SrcMaskedVer15 message) {
            // fixed value property typeLen = 0x80003520L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6SrcMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6SrcMaskedVer15 other = (OFOxmIpv6SrcMaskedVer15) obj;
