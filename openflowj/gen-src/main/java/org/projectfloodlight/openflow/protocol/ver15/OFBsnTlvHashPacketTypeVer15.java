...
class OFBsnTlvHashPacketTypeVer15 implements OFBsnTlvHashPacketType {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvHashPacketType> {
        @Override
        public OFBsnTlvHashPacketType readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvHashPacketTypeVer15 bsnTlvHashPacketTypeVer15 = new OFBsnTlvHashPacketTypeVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvHashPacketTypeVer15);
    ...
    final static OFBsnTlvHashPacketTypeVer15Funnel FUNNEL = new OFBsnTlvHashPacketTypeVer15Funnel();
    static class OFBsnTlvHashPacketTypeVer15Funnel implements Funnel<OFBsnTlvHashPacketTypeVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvHashPacketTypeVer15> {
        @Override
