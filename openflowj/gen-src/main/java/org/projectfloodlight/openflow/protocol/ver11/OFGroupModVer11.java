        ...
        public OFGroupMod readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(command) {
               case (short) 0x0:
                   ...
                   return OFGroupAddVer11.READER.readFrom(context, bb);
               case (short) 0x2:
                   bb.readerIndex(start);
                   // discriminator value OFGroupModCommand.DELETE=2 for class OFGroupDeleteVer11
                   return OFGroupDeleteVer11.READER.readFrom(context, bb);
               case (short) 0x1:
                   bb.readerIndex(start);
                   // discriminator value OFGroupModCommand.MODIFY=1 for class OFGroupModifyVer11
                   return OFGroupModifyVer11.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFGroupModVer11.class, "command", command);
            }
            OFGroupTypeSerializerVer11.readFrom(bb);
            // pad: 1 bytes
            bb.skipBytes(1);
            OFGroup.read4Bytes(bb);
            ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBucketVer11.READER);
