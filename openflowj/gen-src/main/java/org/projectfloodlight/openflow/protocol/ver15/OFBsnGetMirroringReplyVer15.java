...
class OFBsnGetMirroringReplyVer15 implements OFBsnGetMirroringReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGetMirroringReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnGetMirroringReplyVer15 DEFAULT = new OFBsnGetMirroringReplyVer15(
        DEFAULT_XID, DEFAULT_REPORT_MIRROR_PORTS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGetMirroringReplyVer15(long xid, short reportMirrorPorts) {
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnGetMirroringReply.Builder {
        final OFBsnGetMirroringReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGetMirroringReplyVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnGetMirroringReply> {
        @Override
        public OFBsnGetMirroringReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnGetMirroringReplyVer15 bsnGetMirroringReplyVer15 = new OFBsnGetMirroringReplyVer15(
                    xid,
                      reportMirrorPorts
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGetMirroringReplyVer15);
            return bsnGetMirroringReplyVer15;
        }
    }
    ...
    final static OFBsnGetMirroringReplyVer15Funnel FUNNEL = new OFBsnGetMirroringReplyVer15Funnel();
    static class OFBsnGetMirroringReplyVer15Funnel implements Funnel<OFBsnGetMirroringReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGetMirroringReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGetMirroringReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGetMirroringReplyVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGetMirroringReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGetMirroringReplyVer15 other = (OFBsnGetMirroringReplyVer15) obj;
