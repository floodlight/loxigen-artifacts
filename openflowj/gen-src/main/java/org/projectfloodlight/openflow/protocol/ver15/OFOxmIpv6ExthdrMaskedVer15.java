...
class OFOxmIpv6ExthdrMaskedVer15 implements OFOxmIpv6ExthdrMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6ExthdrMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6ExthdrMaskedVer15 DEFAULT = new OFOxmIpv6ExthdrMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6ExthdrMaskedVer15(U16 value, U16 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6ExthdrMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv6ExthdrMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U16> getCanonical() {
        if (U16.NO_MASK.equals(mask)) {
            return new OFOxmIpv6ExthdrVer15(value);
    ...
    static class BuilderWithParent implements OFOxmIpv6ExthdrMasked.Builder {
        final OFOxmIpv6ExthdrMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv6ExthdrMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6ExthdrMasked> {
        ...
        public OFOxmIpv6ExthdrMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6ExthdrMaskedVer15 oxmIpv6ExthdrMaskedVer15 = new OFOxmIpv6ExthdrMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6ExthdrMaskedVer15);
            return oxmIpv6ExthdrMaskedVer15;
        }
    }
    ...
    final static OFOxmIpv6ExthdrMaskedVer15Funnel FUNNEL = new OFOxmIpv6ExthdrMaskedVer15Funnel();
    static class OFOxmIpv6ExthdrMaskedVer15Funnel implements Funnel<OFOxmIpv6ExthdrMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6ExthdrMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004f04L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6ExthdrMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6ExthdrMaskedVer15 message) {
            // fixed value property typeLen = 0x80004f04L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6ExthdrMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6ExthdrMaskedVer15 other = (OFOxmIpv6ExthdrMaskedVer15) obj;
