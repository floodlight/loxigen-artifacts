...
class OFPortStatsEntryVer15 implements OFPortStatsEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFPortStatsEntryVer15.class);
    // version: 1.5
...
//
    ...
    final static OFPortStatsEntryVer15 DEFAULT = new OFPortStatsEntryVer15(
    ...
    OFPortStatsEntryVer15(OFPort portNo, long durationSec, long durationNsec, U64 rxPackets, U64 txPackets, U64 rxBytes, U64 txBytes, U64 rxDropped, U64 txDropped, U64 rxErrors, U64 txErrors, List<OFPortStatsProp> properties) {
        if(portNo == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property portNo cannot be null");
        }
        if(rxPackets == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property rxPackets cannot be null");
        }
        if(txPackets == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property txPackets cannot be null");
        }
        if(rxBytes == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property rxBytes cannot be null");
        }
        if(txBytes == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property txBytes cannot be null");
        }
        if(rxDropped == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property rxDropped cannot be null");
        }
        if(txDropped == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property txDropped cannot be null");
        }
        if(rxErrors == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property rxErrors cannot be null");
        }
        if(txErrors == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property txErrors cannot be null");
        }
        if(properties == null) {
            throw new NullPointerException("OFPortStatsEntryVer15: property properties cannot be null");
        }
        this.portNo = portNo;
    ...
    public U64 getRxFrameErr()throws UnsupportedOperationException {
        throw new UnsupportedOperationException("Property rxFrameErr not supported in version 1.5");
    }

    @Override
    public U64 getRxOverErr()throws UnsupportedOperationException {
        throw new UnsupportedOperationException("Property rxOverErr not supported in version 1.5");
    }

    @Override
    public U64 getRxCrcErr()throws UnsupportedOperationException {
        throw new UnsupportedOperationException("Property rxCrcErr not supported in version 1.5");
    }

    @Override
    public U64 getCollisions()throws UnsupportedOperationException {
        throw new UnsupportedOperationException("Property collisions not supported in version 1.5");
    }
    ...
    static class BuilderWithParent implements OFPortStatsEntry.Builder {
        final OFPortStatsEntryVer15 parentMessage;
        ...
        BuilderWithParent(OFPortStatsEntryVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFPortStatsEntry build() {
                ...
                //
                return new OFPortStatsEntryVer15(
                    portNo,
                    durationSec,
                    durationNsec,
                    rxPackets,
...
//
    ...
    static class Reader implements OFMessageReader<OFPortStatsEntry> {
        ...
        public OFPortStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", portStatsEntryVer15);
            return portStatsEntryVer15;
        }
    }
    ...
    final static OFPortStatsEntryVer15Funnel FUNNEL = new OFPortStatsEntryVer15Funnel();
    static class OFPortStatsEntryVer15Funnel implements Funnel<OFPortStatsEntryVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFPortStatsEntryVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFPortStatsEntryVer15> {
        @Override
        public void write(ByteBuf bb, OFPortStatsEntryVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFPortStatsEntryVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFPortStatsEntryVer15 other = (OFPortStatsEntryVer15) obj;
