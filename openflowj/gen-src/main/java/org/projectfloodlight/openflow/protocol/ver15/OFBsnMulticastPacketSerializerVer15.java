...
public class OFBsnMulticastPacketSerializerVer15 {
    ...
    public static OFBsnMulticastPacket ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnMulticastPacket in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnMulticastPacket e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnMulticastPacket in version 1.5: " + e);
        }
    }
