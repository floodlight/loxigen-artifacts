        ...
        public OFGroupMod readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(command) {
               case (short) 0x0:
                   ...
                   return OFGroupAddVer12.READER.readFrom(context, bb);
               case (short) 0x2:
                   bb.readerIndex(start);
                   // discriminator value OFGroupModCommand.DELETE=2 for class OFGroupDeleteVer12
                   return OFGroupDeleteVer12.READER.readFrom(context, bb);
               case (short) 0x1:
                   bb.readerIndex(start);
                   // discriminator value OFGroupModCommand.MODIFY=1 for class OFGroupModifyVer12
                   return OFGroupModifyVer12.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFGroupModVer12.class, "command", command);
            }
            OFGroupTypeSerializerVer12.readFrom(bb);
            // pad: 1 bytes
            bb.skipBytes(1);
            OFGroup.read4Bytes(bb);
            ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBucketVer12.READER);
