...
class OFRoleRequestVer15 implements OFRoleRequest {
...
//
    ...
    static class Reader implements OFMessageReader<OFRoleRequest> {
        ...
        public OFRoleRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFRoleRequestVer15 roleRequestVer15 = new OFRoleRequestVer15(
                    xid,
                      role,
                      shortId,
                      generationId
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", roleRequestVer15);
    ...
    final static OFRoleRequestVer15Funnel FUNNEL = new OFRoleRequestVer15Funnel();
    static class OFRoleRequestVer15Funnel implements Funnel<OFRoleRequestVer15> {
    ...
    static class Writer implements OFMessageWriter<OFRoleRequestVer15> {
        @Override
