...
class OFMeterConfigStatsRequestVer15 implements OFMeterConfigStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterConfigStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFMeterConfigStatsRequestVer15 DEFAULT = new OFMeterConfigStatsRequestVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_METER_ID
    );

    // package private constructor - used by readers, builders, and factory
    OFMeterConfigStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, long meterId) {
        if(flags == null) {
    ...
    static class BuilderWithParent implements OFMeterConfigStatsRequest.Builder {
        final OFMeterConfigStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFMeterConfigStatsRequestVer15 parentMessage) {
    ...
    public OFMeterConfigStatsRequest.Builder setMeterId(long meterId) {
        ...
        public OFMeterConfigStatsRequest build() {
                ...
                //
                return new OFMeterConfigStatsRequestVer15(
                    xid,
                    flags,
                    meterId
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFMeterConfigStatsRequest> {
        @Override
        public OFMeterConfigStatsRequest readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFMeterConfigStatsRequestVer15 meterConfigStatsRequestVer15 = new OFMeterConfigStatsRequestVer15(
                    xid,
                      flags,
                      meterId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterConfigStatsRequestVer15);
            return meterConfigStatsRequestVer15;
        }
    }
    ...
    final static OFMeterConfigStatsRequestVer15Funnel FUNNEL = new OFMeterConfigStatsRequestVer15Funnel();
    static class OFMeterConfigStatsRequestVer15Funnel implements Funnel<OFMeterConfigStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterConfigStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFMeterConfigStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFMeterConfigStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterConfigStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterConfigStatsRequestVer15 other = (OFMeterConfigStatsRequestVer15) obj;
