...
public interface OFBsnTlvs {
    ...
    OFBsnTlvBfdEncapType.Builder buildBfdEncapType() throws UnsupportedOperationException;
    OFBsnTlvBfdEncapType bfdEncapType(OFBsnBfdEncapType value);
    OFBsnTlvBfdEndpointEvent.Builder buildBfdEndpointEvent() throws UnsupportedOperationException;
    OFBsnTlvBfdEndpointEvent bfdEndpointEvent(OFBsnBfdEndpointEvent value);
    OFBsnTlvBfdEndpointId.Builder buildBfdEndpointId() throws UnsupportedOperationException;
    OFBsnTlvBfdEndpointId bfdEndpointId(int value);
    OFBsnTlvBfdEndpointType.Builder buildBfdEndpointType() throws UnsupportedOperationException;
    OFBsnTlvBfdEndpointType bfdEndpointType(OFBsnBfdEndpointType value);
    OFBsnTlvBfdLocalDiscriminator.Builder buildBfdLocalDiscriminator() throws UnsupportedOperationException;
    OFBsnTlvBfdLocalDiscriminator bfdLocalDiscriminator(long value);
    OFBsnTlvBfdLocalMinEchoInterval.Builder buildBfdLocalMinEchoInterval() throws UnsupportedOperationException;
    OFBsnTlvBfdLocalMinEchoInterval bfdLocalMinEchoInterval(long value);
    OFBsnTlvBfdLocalMinRxInterval.Builder buildBfdLocalMinRxInterval() throws UnsupportedOperationException;
    OFBsnTlvBfdLocalMinRxInterval bfdLocalMinRxInterval(long value);
    OFBsnTlvBfdLocalMinTxInterval.Builder buildBfdLocalMinTxInterval() throws UnsupportedOperationException;
    OFBsnTlvBfdLocalMinTxInterval bfdLocalMinTxInterval(long value);
    OFBsnTlvBfdLocalMultiplier.Builder buildBfdLocalMultiplier() throws UnsupportedOperationException;
    OFBsnTlvBfdLocalMultiplier bfdLocalMultiplier(short value);
    OFBsnTlvBfdLocalState.Builder buildBfdLocalState() throws UnsupportedOperationException;
    OFBsnTlvBfdLocalState bfdLocalState(OFBsnBfdEndpointState value);
    OFBsnTlvBfdRemoteDiscriminator.Builder buildBfdRemoteDiscriminator() throws UnsupportedOperationException;
    OFBsnTlvBfdRemoteDiscriminator bfdRemoteDiscriminator(long value);
    OFBsnTlvBfdRemoteMinEchoInterval.Builder buildBfdRemoteMinEchoInterval() throws UnsupportedOperationException;
    OFBsnTlvBfdRemoteMinEchoInterval bfdRemoteMinEchoInterval(long value);
    OFBsnTlvBfdRemoteMinRxInterval.Builder buildBfdRemoteMinRxInterval() throws UnsupportedOperationException;
    OFBsnTlvBfdRemoteMinRxInterval bfdRemoteMinRxInterval(long value);
    OFBsnTlvBfdRemoteMinTxInterval.Builder buildBfdRemoteMinTxInterval() throws UnsupportedOperationException;
    OFBsnTlvBfdRemoteMinTxInterval bfdRemoteMinTxInterval(long value);
    OFBsnTlvBfdRemoteMultiplier.Builder buildBfdRemoteMultiplier() throws UnsupportedOperationException;
    OFBsnTlvBfdRemoteMultiplier bfdRemoteMultiplier(short value);
    OFBsnTlvBfdRemoteState.Builder buildBfdRemoteState() throws UnsupportedOperationException;
    OFBsnTlvBfdRemoteState bfdRemoteState(OFBsnBfdEndpointState value);
