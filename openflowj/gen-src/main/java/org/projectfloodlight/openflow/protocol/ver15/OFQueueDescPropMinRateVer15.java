...
class OFQueueDescPropMinRateVer15 implements OFQueueDescPropMinRate {
...
//
    ...
    final static OFQueueDescPropMinRateVer15 DEFAULT = new OFQueueDescPropMinRateVer15(
        DEFAULT_RATE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFQueueDescPropMinRate> {
        @Override
        public OFQueueDescPropMinRate readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFQueueDescPropMinRateVer15 queueDescPropMinRateVer15 = new OFQueueDescPropMinRateVer15(
                    rate
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueDescPropMinRateVer15);
    ...
    final static OFQueueDescPropMinRateVer15Funnel FUNNEL = new OFQueueDescPropMinRateVer15Funnel();
    static class OFQueueDescPropMinRateVer15Funnel implements Funnel<OFQueueDescPropMinRateVer15> {
    ...
    static class Writer implements OFMessageWriter<OFQueueDescPropMinRateVer15> {
        @Override
