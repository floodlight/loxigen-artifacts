...
class OFMeterStatsRequestVer15 implements OFMeterStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFMeterStatsRequestVer15 DEFAULT = new OFMeterStatsRequestVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_METER_ID
    );

    // package private constructor - used by readers, builders, and factory
    OFMeterStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, long meterId) {
        if(flags == null) {
            throw new NullPointerException("OFMeterStatsRequestVer15: property flags cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFMeterStatsRequest.Builder {
        final OFMeterStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFMeterStatsRequestVer15 parentMessage) {
    ...
    public OFMeterStatsRequest.Builder setMeterId(long meterId) {
        ...
        public OFMeterStatsRequest build() {
                ...
                //
                return new OFMeterStatsRequestVer15(
                    xid,
                    flags,
                    meterId
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterStatsRequest> {
        ...
        public OFMeterStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(statsType != (short) 0x9)
                throw new OFParseError("Wrong statsType: Expected=OFStatsType.METER_STATS(9), got="+statsType);
            ...
            OFMeterStatsRequestVer15 meterStatsRequestVer15 = new OFMeterStatsRequestVer15(
                    xid,
                      flags,
                      meterId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterStatsRequestVer15);
            return meterStatsRequestVer15;
        }
    }
    ...
    final static OFMeterStatsRequestVer15Funnel FUNNEL = new OFMeterStatsRequestVer15Funnel();
    static class OFMeterStatsRequestVer15Funnel implements Funnel<OFMeterStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFMeterStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFMeterStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterStatsRequestVer15 other = (OFMeterStatsRequestVer15) obj;
