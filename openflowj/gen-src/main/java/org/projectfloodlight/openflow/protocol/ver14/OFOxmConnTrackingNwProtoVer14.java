...
class OFOxmConnTrackingNwProtoVer14 implements OFOxmConnTrackingNwProto {
...
//
    ...
    final static OFOxmConnTrackingNwProtoVer14 DEFAULT = new OFOxmConnTrackingNwProtoVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmConnTrackingNwProto> {
        ...
        public OFOxmConnTrackingNwProto readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingNwProtoVer14 oxmConnTrackingNwProtoVer14 = new OFOxmConnTrackingNwProtoVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingNwProtoVer14);
    ...
    final static OFOxmConnTrackingNwProtoVer14Funnel FUNNEL = new OFOxmConnTrackingNwProtoVer14Funnel();
    static class OFOxmConnTrackingNwProtoVer14Funnel implements Funnel<OFOxmConnTrackingNwProtoVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingNwProtoVer14> {
        @Override
