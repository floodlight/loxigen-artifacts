...
class OFBsnSetAuxCxnsRequestVer15 implements OFBsnSetAuxCxnsRequest {
...
//
    ...
    final static OFBsnSetAuxCxnsRequestVer15 DEFAULT = new OFBsnSetAuxCxnsRequestVer15(
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnSetAuxCxnsRequest> {
        @Override
        public OFBsnSetAuxCxnsRequest readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnSetAuxCxnsRequestVer15 bsnSetAuxCxnsRequestVer15 = new OFBsnSetAuxCxnsRequestVer15(
                    xid,
                      numAux
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSetAuxCxnsRequestVer15);
    ...
    final static OFBsnSetAuxCxnsRequestVer15Funnel FUNNEL = new OFBsnSetAuxCxnsRequestVer15Funnel();
    static class OFBsnSetAuxCxnsRequestVer15Funnel implements Funnel<OFBsnSetAuxCxnsRequestVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnSetAuxCxnsRequestVer15> {
        @Override
