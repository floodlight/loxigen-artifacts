...
class OFOxmIpv6NdTargetVer15 implements OFOxmIpv6NdTarget {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6NdTargetVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6NdTargetVer15 DEFAULT = new OFOxmIpv6NdTargetVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6NdTargetVer15(IPv6Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6NdTargetVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6NdTarget.Builder {
        final OFOxmIpv6NdTargetVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv6Address value;

        BuilderWithParent(OFOxmIpv6NdTargetVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6NdTarget> {
        ...
        public OFOxmIpv6NdTarget readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6NdTargetVer15 oxmIpv6NdTargetVer15 = new OFOxmIpv6NdTargetVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6NdTargetVer15);
            return oxmIpv6NdTargetVer15;
        }
    }
    ...
    final static OFOxmIpv6NdTargetVer15Funnel FUNNEL = new OFOxmIpv6NdTargetVer15Funnel();
    static class OFOxmIpv6NdTargetVer15Funnel implements Funnel<OFOxmIpv6NdTargetVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6NdTargetVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003e10L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6NdTargetVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6NdTargetVer15 message) {
            // fixed value property typeLen = 0x80003e10L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6NdTargetVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6NdTargetVer15 other = (OFOxmIpv6NdTargetVer15) obj;
