...
class OFOxmIcmpv4CodeMaskedVer15 implements OFOxmIcmpv4CodeMasked {
...
//
    ...
    final static OFOxmIcmpv4CodeMaskedVer15 DEFAULT = new OFOxmIcmpv4CodeMaskedVer15(
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv4CodeMasked> {
        ...
        public OFOxmIcmpv4CodeMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIcmpv4CodeMaskedVer15 oxmIcmpv4CodeMaskedVer15 = new OFOxmIcmpv4CodeMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv4CodeMaskedVer15);
    ...
    final static OFOxmIcmpv4CodeMaskedVer15Funnel FUNNEL = new OFOxmIcmpv4CodeMaskedVer15Funnel();
    static class OFOxmIcmpv4CodeMaskedVer15Funnel implements Funnel<OFOxmIcmpv4CodeMaskedVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv4CodeMaskedVer15> {
        @Override
