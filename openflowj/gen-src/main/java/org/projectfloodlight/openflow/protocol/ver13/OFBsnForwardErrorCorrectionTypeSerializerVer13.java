...
public class OFBsnForwardErrorCorrectionTypeSerializerVer13 {
    ...
    public static OFBsnForwardErrorCorrectionType ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnForwardErrorCorrectionType in version 1.3: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnForwardErrorCorrectionType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnForwardErrorCorrectionType in version 1.3: " + e);
        }
    }
