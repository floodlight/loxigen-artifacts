...
class OFActionSetMplsTtlVer15 implements OFActionSetMplsTtl {
    private static final Logger logger = LoggerFactory.getLogger(OFActionSetMplsTtlVer15.class);
    // version: 1.5
...
//
    ...
    final static OFActionSetMplsTtlVer15 DEFAULT = new OFActionSetMplsTtlVer15(
        DEFAULT_MPLS_TTL
    );

    // package private constructor - used by readers, builders, and factory
    OFActionSetMplsTtlVer15(short mplsTtl) {
    ...
    static class BuilderWithParent implements OFActionSetMplsTtl.Builder {
        final OFActionSetMplsTtlVer15 parentMessage;

        // OF message fields
        private boolean mplsTtlSet;
        private short mplsTtl;

        BuilderWithParent(OFActionSetMplsTtlVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFActionSetMplsTtl> {
        ...
        public OFActionSetMplsTtl readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionSetMplsTtlVer15 actionSetMplsTtlVer15 = new OFActionSetMplsTtlVer15(
                    mplsTtl
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionSetMplsTtlVer15);
            return actionSetMplsTtlVer15;
        }
    }
    ...
    final static OFActionSetMplsTtlVer15Funnel FUNNEL = new OFActionSetMplsTtlVer15Funnel();
    static class OFActionSetMplsTtlVer15Funnel implements Funnel<OFActionSetMplsTtlVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionSetMplsTtlVer15 message, PrimitiveSink sink) {
            // fixed value property type = 15
    ...
    static class Writer implements OFMessageWriter<OFActionSetMplsTtlVer15> {
        @Override
        public void write(ByteBuf bb, OFActionSetMplsTtlVer15 message) {
            // fixed value property type = 15
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionSetMplsTtlVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionSetMplsTtlVer15 other = (OFActionSetMplsTtlVer15) obj;
