...
public class OFControllerRoleReasonSerializerVer15 {
    ...
    public static OFControllerRoleReason ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFControllerRoleReason in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFControllerRoleReason e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFControllerRoleReason in version 1.5: " + e);
        }
    }
