...
class OFRoleReplyVer15 implements OFRoleReply {
    private static final Logger logger = LoggerFactory.getLogger(OFRoleReplyVer15.class);
    // version: 1.5
...
//
    ...
    OFRoleReplyVer15(long xid, OFControllerRole role, int shortId, U64 generationId) {
        if(role == null) {
            throw new NullPointerException("OFRoleReplyVer15: property role cannot be null");
        }
        if(generationId == null) {
            throw new NullPointerException("OFRoleReplyVer15: property generationId cannot be null");
        }
        this.xid = xid;
        this.role = role;
    ...
    static class BuilderWithParent implements OFRoleReply.Builder {
        final OFRoleReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFRoleReplyVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFRoleReply> {
        ...
        public OFRoleReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFRoleReplyVer15 roleReplyVer15 = new OFRoleReplyVer15(
                    xid,
                      role,
                      shortId,
                      generationId
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", roleReplyVer15);
            return roleReplyVer15;
        }
    }
    ...
    final static OFRoleReplyVer15Funnel FUNNEL = new OFRoleReplyVer15Funnel();
    static class OFRoleReplyVer15Funnel implements Funnel<OFRoleReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFRoleReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFRoleReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFRoleReplyVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFRoleReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFRoleReplyVer15 other = (OFRoleReplyVer15) obj;
