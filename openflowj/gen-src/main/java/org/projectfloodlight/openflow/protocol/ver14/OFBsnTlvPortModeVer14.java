...
class OFBsnTlvPortModeVer14 implements OFBsnTlvPortMode {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvPortMode> {
        ...
        public OFBsnTlvPortMode readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvPortModeVer14 bsnTlvPortModeVer14 = new OFBsnTlvPortModeVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvPortModeVer14);
    ...
    final static OFBsnTlvPortModeVer14Funnel FUNNEL = new OFBsnTlvPortModeVer14Funnel();
    static class OFBsnTlvPortModeVer14Funnel implements Funnel<OFBsnTlvPortModeVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvPortModeVer14> {
        @Override
