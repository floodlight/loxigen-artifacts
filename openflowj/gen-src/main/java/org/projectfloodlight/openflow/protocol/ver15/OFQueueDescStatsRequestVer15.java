...
class OFQueueDescStatsRequestVer15 implements OFQueueDescStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFQueueDescStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFQueueDescStatsRequestVer15 DEFAULT = new OFQueueDescStatsRequestVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_PORT_NO, DEFAULT_QUEUE_ID
    );

    // package private constructor - used by readers, builders, and factory
    OFQueueDescStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, OFPort portNo, long queueId) {
        if(flags == null) {
            throw new NullPointerException("OFQueueDescStatsRequestVer15: property flags cannot be null");
        }
        if(portNo == null) {
            throw new NullPointerException("OFQueueDescStatsRequestVer15: property portNo cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFQueueDescStatsRequest.Builder {
        final OFQueueDescStatsRequestVer15 parentMessage;
    ...
    public OFQueueDescStatsRequest.Builder setQueueId(long queueId) {
        ...
        public OFQueueDescStatsRequest build() {
                ...
                //
                return new OFQueueDescStatsRequestVer15(
                    xid,
                    flags,
                    portNo,
                    queueId
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueDescStatsRequest> {
        ...
        public OFQueueDescStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFQueueDescStatsRequestVer15 queueDescStatsRequestVer15 = new OFQueueDescStatsRequestVer15(
                    xid,
                      flags,
                      portNo,
                      queueId
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueDescStatsRequestVer15);
            return queueDescStatsRequestVer15;
        }
    }
    ...
    final static OFQueueDescStatsRequestVer15Funnel FUNNEL = new OFQueueDescStatsRequestVer15Funnel();
    static class OFQueueDescStatsRequestVer15Funnel implements Funnel<OFQueueDescStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueDescStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFQueueDescStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFQueueDescStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueDescStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueDescStatsRequestVer15 other = (OFQueueDescStatsRequestVer15) obj;
