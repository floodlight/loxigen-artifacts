...
class OFBsnPduRxReplyVer15 implements OFBsnPduRxReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnPduRxReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnPduRxReplyVer15 DEFAULT = new OFBsnPduRxReplyVer15(
        DEFAULT_XID, DEFAULT_STATUS, DEFAULT_PORT_NO, DEFAULT_SLOT_NUM
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnPduRxReplyVer15(long xid, long status, OFPort portNo, short slotNum) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnPduRxReplyVer15: property portNo cannot be null");
        }
        this.xid = xid;
        this.status = status;
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFBsnPduRxReply.Builder {
        final OFBsnPduRxReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnPduRxReplyVer15 parentMessage) {
    ...
    public OFBsnPduRxReply.Builder setSlotNum(short slotNum) {
        ...
        public OFBsnPduRxReply build() {
                ...
                //
                return new OFBsnPduRxReplyVer15(
                    xid,
                    status,
                    portNo,
                    slotNum
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnPduRxReply> {
        ...
        public OFBsnPduRxReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnPduRxReplyVer15 bsnPduRxReplyVer15 = new OFBsnPduRxReplyVer15(
                    xid,
                      status,
                      portNo,
                      slotNum
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnPduRxReplyVer15);
            return bsnPduRxReplyVer15;
        }
    }
    ...
    final static OFBsnPduRxReplyVer15Funnel FUNNEL = new OFBsnPduRxReplyVer15Funnel();
    static class OFBsnPduRxReplyVer15Funnel implements Funnel<OFBsnPduRxReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnPduRxReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnPduRxReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnPduRxReplyVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnPduRxReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnPduRxReplyVer15 other = (OFBsnPduRxReplyVer15) obj;
