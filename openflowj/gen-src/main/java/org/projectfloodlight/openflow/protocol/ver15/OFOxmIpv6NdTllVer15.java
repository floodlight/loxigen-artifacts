...
class OFOxmIpv6NdTllVer15 implements OFOxmIpv6NdTll {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6NdTllVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6NdTllVer15 DEFAULT = new OFOxmIpv6NdTllVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6NdTllVer15(MacAddress value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6NdTllVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6NdTll.Builder {
        final OFOxmIpv6NdTllVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private MacAddress value;

        BuilderWithParent(OFOxmIpv6NdTllVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6NdTll> {
        ...
        public OFOxmIpv6NdTll readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6NdTllVer15 oxmIpv6NdTllVer15 = new OFOxmIpv6NdTllVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6NdTllVer15);
            return oxmIpv6NdTllVer15;
        }
    }
    ...
    final static OFOxmIpv6NdTllVer15Funnel FUNNEL = new OFOxmIpv6NdTllVer15Funnel();
    static class OFOxmIpv6NdTllVer15Funnel implements Funnel<OFOxmIpv6NdTllVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6NdTllVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004206L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6NdTllVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6NdTllVer15 message) {
            // fixed value property typeLen = 0x80004206L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6NdTllVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6NdTllVer15 other = (OFOxmIpv6NdTllVer15) obj;
