...
public class OFBsnModuleEepromEncodingSerializerVer14 {
        ...
        for(OFBsnModuleEepromEncoding e: set) {
            switch(e) {
                ...
                case BSN_MODULE_EEPROM_ENCODING_64B_66B:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Illegal enum value for type OFBsnModuleEepromEncoding in version 1.4: " + e);
            }
        }
        return wireValue;
    }
