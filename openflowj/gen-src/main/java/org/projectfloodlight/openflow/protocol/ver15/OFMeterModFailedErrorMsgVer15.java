...
class OFMeterModFailedErrorMsgVer15 implements OFMeterModFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterModFailedErrorMsgVer15.class);
    // version: 1.5
...
//
    ...
    OFMeterModFailedErrorMsgVer15(long xid, OFMeterModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFMeterModFailedErrorMsgVer15: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFMeterModFailedErrorMsgVer15: property data cannot be null");
        }
    ...
    static class BuilderWithParent implements OFMeterModFailedErrorMsg.Builder {
        final OFMeterModFailedErrorMsgVer15 parentMessage;
        ...
        BuilderWithParent(OFMeterModFailedErrorMsgVer15 parentMessage) {
    ...
    public OFMeterModFailedErrorMsg.Builder setXid(long xid) {
        ...
        public OFMeterModFailedErrorMsg build() {
                ...
                //
                return new OFMeterModFailedErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterModFailedErrorMsg> {
        ...
        public OFMeterModFailedErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFMeterModFailedCode code = OFMeterModFailedCodeSerializerVer15.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_15);

            OFMeterModFailedErrorMsgVer15 meterModFailedErrorMsgVer15 = new OFMeterModFailedErrorMsgVer15(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterModFailedErrorMsgVer15);
            return meterModFailedErrorMsgVer15;
        }
    }
    ...
    final static OFMeterModFailedErrorMsgVer15Funnel FUNNEL = new OFMeterModFailedErrorMsgVer15Funnel();
    static class OFMeterModFailedErrorMsgVer15Funnel implements Funnel<OFMeterModFailedErrorMsgVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterModFailedErrorMsgVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFMeterModFailedCodeSerializerVer15.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFMeterModFailedErrorMsgVer15> {
        @Override
        public void write(ByteBuf bb, OFMeterModFailedErrorMsgVer15 message) {
            ...
            OFMeterModFailedCodeSerializerVer15.writeTo(bb, message.code);
            message.data.writeTo(bb);

            // update length field
            int length = bb.writerIndex() - startIndex;
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFMeterModFailedErrorMsgVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterModFailedErrorMsgVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterModFailedErrorMsgVer15 other = (OFMeterModFailedErrorMsgVer15) obj;
