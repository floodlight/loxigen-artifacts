...
class OFBsnTlvBfdEndpointVer13 implements OFBsnTlvBfdEndpoint {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvBfdEndpoint> {
        @Override
        public OFBsnTlvBfdEndpoint readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvBfdEndpointVer13 bsnTlvBfdEndpointVer13 = new OFBsnTlvBfdEndpointVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvBfdEndpointVer13);
    ...
    final static OFBsnTlvBfdEndpointVer13Funnel FUNNEL = new OFBsnTlvBfdEndpointVer13Funnel();
    static class OFBsnTlvBfdEndpointVer13Funnel implements Funnel<OFBsnTlvBfdEndpointVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvBfdEndpointVer13> {
        @Override
