...
class OFOxmBsnInnerEthDstVer15 implements OFOxmBsnInnerEthDst {
...
//
    ...
    final static OFOxmBsnInnerEthDstVer15 DEFAULT = new OFOxmBsnInnerEthDstVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInnerEthDst> {
        ...
        public OFOxmBsnInnerEthDst readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInnerEthDstVer15 oxmBsnInnerEthDstVer15 = new OFOxmBsnInnerEthDstVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInnerEthDstVer15);
    ...
    final static OFOxmBsnInnerEthDstVer15Funnel FUNNEL = new OFOxmBsnInnerEthDstVer15Funnel();
    static class OFOxmBsnInnerEthDstVer15Funnel implements Funnel<OFOxmBsnInnerEthDstVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInnerEthDstVer15> {
        @Override
