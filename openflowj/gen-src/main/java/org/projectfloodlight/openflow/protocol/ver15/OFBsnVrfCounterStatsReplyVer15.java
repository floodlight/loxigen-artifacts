...
class OFBsnVrfCounterStatsReplyVer15 implements OFBsnVrfCounterStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVrfCounterStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnVrfCounterStatsReplyVer15 DEFAULT = new OFBsnVrfCounterStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnVrfCounterStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnVrfCounterStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnVrfCounterStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnVrfCounterStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnVrfCounterStatsReply.Builder {
        final OFBsnVrfCounterStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnVrfCounterStatsReplyVer15 parentMessage) {
    ...
    public OFBsnVrfCounterStatsReply.Builder setXid(long xid) {
        ...
        public OFBsnVrfCounterStatsReply build() {
                ...
                //
                return new OFBsnVrfCounterStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVrfCounterStatsReply> {
        ...
        public OFBsnVrfCounterStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVrfCounterStatsReplyVer15);
            return bsnVrfCounterStatsReplyVer15;
        }
    }
    ...
    final static OFBsnVrfCounterStatsReplyVer15Funnel FUNNEL = new OFBsnVrfCounterStatsReplyVer15Funnel();
    static class OFBsnVrfCounterStatsReplyVer15Funnel implements Funnel<OFBsnVrfCounterStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVrfCounterStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnVrfCounterStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnVrfCounterStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnVrfCounterStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVrfCounterStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVrfCounterStatsReplyVer15 other = (OFBsnVrfCounterStatsReplyVer15) obj;
