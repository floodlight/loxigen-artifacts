...
class OFBsnTlvApplyBytesVer13 implements OFBsnTlvApplyBytes {
...
//
    ...
    final static OFBsnTlvApplyBytesVer13 DEFAULT = new OFBsnTlvApplyBytesVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvApplyBytes> {
        ...
        public OFBsnTlvApplyBytes readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvApplyBytesVer13 bsnTlvApplyBytesVer13 = new OFBsnTlvApplyBytesVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvApplyBytesVer13);
    ...
    final static OFBsnTlvApplyBytesVer13Funnel FUNNEL = new OFBsnTlvApplyBytesVer13Funnel();
    static class OFBsnTlvApplyBytesVer13Funnel implements Funnel<OFBsnTlvApplyBytesVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvApplyBytesVer13> {
        @Override
