...
public class OFGroupModCommandSerializerVer15 {
    ...
    public final static short INSERT_BUCKET_VAL = (short) 0x3;
    public final static short REMOVE_BUCKET_VAL = (short) 0x5;
    ...
    public static OFGroupModCommand ofWireValue(short val) {
        switch(val) {
            ...
            case INSERT_BUCKET_VAL:
                return OFGroupModCommand.INSERT_BUCKET;
            case REMOVE_BUCKET_VAL:
                return OFGroupModCommand.REMOVE_BUCKET;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFGroupModCommand in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFGroupModCommand e) {
        switch(e) {
            ...
            case DELETE:
                return DELETE_VAL;
            case INSERT_BUCKET:
                return INSERT_BUCKET_VAL;
            case REMOVE_BUCKET:
                return REMOVE_BUCKET_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFGroupModCommand in version 1.5: " + e);
        }
    }
