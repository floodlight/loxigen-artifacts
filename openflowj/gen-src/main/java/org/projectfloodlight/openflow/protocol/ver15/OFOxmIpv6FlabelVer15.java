...
class OFOxmIpv6FlabelVer15 implements OFOxmIpv6Flabel {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6FlabelVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6FlabelVer15 DEFAULT = new OFOxmIpv6FlabelVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6FlabelVer15(IPv6FlowLabel value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6FlabelVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6Flabel.Builder {
        final OFOxmIpv6FlabelVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv6FlowLabel value;

        BuilderWithParent(OFOxmIpv6FlabelVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6Flabel> {
        ...
        public OFOxmIpv6Flabel readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6FlabelVer15 oxmIpv6FlabelVer15 = new OFOxmIpv6FlabelVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6FlabelVer15);
            return oxmIpv6FlabelVer15;
        }
    }
    ...
    final static OFOxmIpv6FlabelVer15Funnel FUNNEL = new OFOxmIpv6FlabelVer15Funnel();
    static class OFOxmIpv6FlabelVer15Funnel implements Funnel<OFOxmIpv6FlabelVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6FlabelVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003804L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6FlabelVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6FlabelVer15 message) {
            // fixed value property typeLen = 0x80003804L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6FlabelVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6FlabelVer15 other = (OFOxmIpv6FlabelVer15) obj;
