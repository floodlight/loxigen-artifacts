...
class OFBsnGentableErrorVer14 implements OFBsnGentableError {
...
//
    ...
    OFBsnGentableErrorVer14(long xid, GenTableId tableId, String errMsg, OFErrorCauseData data) {
        if(tableId == null) {
    ...
    public OFBsnGentableError.Builder setData(OFErrorCauseData data) {
        ...
        public OFBsnGentableError build() {
                ...
                //
                return new OFBsnGentableErrorVer14(
                    xid,
                    tableId,
                    errMsg,
                    data
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableError> {
        ...
        public OFBsnGentableError readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableErrorVer14 bsnGentableErrorVer14 = new OFBsnGentableErrorVer14(
                    xid,
                      tableId,
                      errMsg,
                      data
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableErrorVer14);
    ...
    final static OFBsnGentableErrorVer14Funnel FUNNEL = new OFBsnGentableErrorVer14Funnel();
    static class OFBsnGentableErrorVer14Funnel implements Funnel<OFBsnGentableErrorVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableErrorVer14> {
        @Override
