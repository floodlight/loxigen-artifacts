...
class OFUint64Ver15 implements OFUint64 {
...
//
    ...
    final static OFUint64Ver15 DEFAULT = new OFUint64Ver15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFUint64> {
        ...
        public OFUint64 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFUint64Ver15 uint64Ver15 = new OFUint64Ver15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", uint64Ver15);
            return uint64Ver15;
        }
    }
    ...
    final static OFUint64Ver15Funnel FUNNEL = new OFUint64Ver15Funnel();
    static class OFUint64Ver15Funnel implements Funnel<OFUint64Ver15> {
    ...
    static class Writer implements OFMessageWriter<OFUint64Ver15> {
        @Override
