...
class OFOxmArpOpMaskedVer15 implements OFOxmArpOpMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmArpOpMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmArpOpMaskedVer15 DEFAULT = new OFOxmArpOpMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmArpOpMaskedVer15(ArpOpcode value, ArpOpcode mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmArpOpMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmArpOpMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmArpOpMasked.Builder {
        final OFOxmArpOpMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmArpOpMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmArpOpMasked> {
        @Override
        public OFOxmArpOpMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmArpOpMaskedVer15 oxmArpOpMaskedVer15 = new OFOxmArpOpMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpOpMaskedVer15);
            return oxmArpOpMaskedVer15;
        }
    }
    ...
    final static OFOxmArpOpMaskedVer15Funnel FUNNEL = new OFOxmArpOpMaskedVer15Funnel();
    static class OFOxmArpOpMaskedVer15Funnel implements Funnel<OFOxmArpOpMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmArpOpMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002b04L
    ...
    static class Writer implements OFMessageWriter<OFOxmArpOpMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmArpOpMaskedVer15 message) {
            // fixed value property typeLen = 0x80002b04L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmArpOpMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmArpOpMaskedVer15 other = (OFOxmArpOpMaskedVer15) obj;
