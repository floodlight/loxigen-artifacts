...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvKnownMulticastRate> {
        @Override
        public OFBsnTlvKnownMulticastRate readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
