...
class OFBsnVlanCounterStatsReplyVer15 implements OFBsnVlanCounterStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVlanCounterStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnVlanCounterStatsReplyVer15 DEFAULT = new OFBsnVlanCounterStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnVlanCounterStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnVlanCounterStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnVlanCounterStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnVlanCounterStatsReplyVer15: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnVlanCounterStatsReply.Builder {
        final OFBsnVlanCounterStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnVlanCounterStatsReplyVer15 parentMessage) {
    ...
    public OFBsnVlanCounterStatsReply.Builder setEntries(List<OFBsnVlanCounterStatsEntry> entries) {
        ...
        public OFBsnVlanCounterStatsReply build() {
                ...
                //
                return new OFBsnVlanCounterStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnVlanCounterStatsReply> {
        @Override
        public OFBsnVlanCounterStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnVlanCounterStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnVlanCounterStatsEntryVer15.READER);

            OFBsnVlanCounterStatsReplyVer15 bsnVlanCounterStatsReplyVer15 = new OFBsnVlanCounterStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVlanCounterStatsReplyVer15);
            return bsnVlanCounterStatsReplyVer15;
        }
    }
    ...
    final static OFBsnVlanCounterStatsReplyVer15Funnel FUNNEL = new OFBsnVlanCounterStatsReplyVer15Funnel();
    static class OFBsnVlanCounterStatsReplyVer15Funnel implements Funnel<OFBsnVlanCounterStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVlanCounterStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnVlanCounterStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnVlanCounterStatsReplyVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVlanCounterStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVlanCounterStatsReplyVer15 other = (OFBsnVlanCounterStatsReplyVer15) obj;
