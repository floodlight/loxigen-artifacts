...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnVirtualPortRemoveRequest> {
        @Override
        public OFBsnVirtualPortRemoveRequest readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
