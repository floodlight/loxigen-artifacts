...
class OFOxmBsnInPorts128Ver15 implements OFOxmBsnInPorts128 {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnInPorts128Ver15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnInPorts128Ver15 DEFAULT = new OFOxmBsnInPorts128Ver15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnInPorts128Ver15(OFBitMask128 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnInPorts128Ver15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnInPorts128.Builder {
        final OFOxmBsnInPorts128Ver15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private OFBitMask128 value;

        BuilderWithParent(OFOxmBsnInPorts128Ver15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInPorts128> {
        ...
        public OFOxmBsnInPorts128 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInPorts128Ver15 oxmBsnInPorts128Ver15 = new OFOxmBsnInPorts128Ver15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInPorts128Ver15);
            return oxmBsnInPorts128Ver15;
        }
    }
    ...
    final static OFOxmBsnInPorts128Ver15Funnel FUNNEL = new OFOxmBsnInPorts128Ver15Funnel();
    static class OFOxmBsnInPorts128Ver15Funnel implements Funnel<OFOxmBsnInPorts128Ver15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnInPorts128Ver15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x30010L
            sink.putInt(0x30010);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInPorts128Ver15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInPorts128Ver15 message) {
            // fixed value property typeLen = 0x30010L
            bb.writeInt(0x30010);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnInPorts128Ver15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnInPorts128Ver15 other = (OFOxmBsnInPorts128Ver15) obj;
