...
class OFBsnPduTxRequestVer15 implements OFBsnPduTxRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnPduTxRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnPduTxRequestVer15 DEFAULT = new OFBsnPduTxRequestVer15(
        DEFAULT_XID, DEFAULT_TX_INTERVAL_MS, DEFAULT_PORT_NO, DEFAULT_SLOT_NUM, DEFAULT_DATA
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnPduTxRequestVer15(long xid, long txIntervalMs, OFPort portNo, short slotNum, byte[] data) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnPduTxRequestVer15: property portNo cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBsnPduTxRequestVer15: property data cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnPduTxRequest.Builder {
        final OFBsnPduTxRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnPduTxRequestVer15 parentMessage) {
    ...
    public OFBsnPduTxRequest.Builder setXid(long xid) {
        ...
        public OFBsnPduTxRequest build() {
                ...
                //
                return new OFBsnPduTxRequestVer15(
                    xid,
                    txIntervalMs,
                    portNo,
                    slotNum,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnPduTxRequest> {
        ...
        public OFBsnPduTxRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnPduTxRequestVer15 bsnPduTxRequestVer15 = new OFBsnPduTxRequestVer15(
                    xid,
                      txIntervalMs,
                      portNo,
                      slotNum,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnPduTxRequestVer15);
            return bsnPduTxRequestVer15;
        }
    }
    ...
    final static OFBsnPduTxRequestVer15Funnel FUNNEL = new OFBsnPduTxRequestVer15Funnel();
    static class OFBsnPduTxRequestVer15Funnel implements Funnel<OFBsnPduTxRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnPduTxRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnPduTxRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnPduTxRequestVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnPduTxRequestVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnPduTxRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnPduTxRequestVer15 other = (OFBsnPduTxRequestVer15) obj;
