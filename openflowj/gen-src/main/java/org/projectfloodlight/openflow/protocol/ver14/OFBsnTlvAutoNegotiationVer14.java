...
class OFBsnTlvAutoNegotiationVer14 implements OFBsnTlvAutoNegotiation {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvAutoNegotiation> {
        ...
        public OFBsnTlvAutoNegotiation readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvAutoNegotiationVer14 bsnTlvAutoNegotiationVer14 = new OFBsnTlvAutoNegotiationVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvAutoNegotiationVer14);
    ...
    final static OFBsnTlvAutoNegotiationVer14Funnel FUNNEL = new OFBsnTlvAutoNegotiationVer14Funnel();
    static class OFBsnTlvAutoNegotiationVer14Funnel implements Funnel<OFBsnTlvAutoNegotiationVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvAutoNegotiationVer14> {
        @Override
