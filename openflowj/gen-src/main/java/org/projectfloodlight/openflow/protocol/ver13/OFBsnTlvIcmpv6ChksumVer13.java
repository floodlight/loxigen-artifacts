...
class OFBsnTlvIcmpv6ChksumVer13 implements OFBsnTlvIcmpv6Chksum {
...
//
    ...
    final static OFBsnTlvIcmpv6ChksumVer13 DEFAULT = new OFBsnTlvIcmpv6ChksumVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvIcmpv6Chksum> {
        ...
        public OFBsnTlvIcmpv6Chksum readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvIcmpv6ChksumVer13 bsnTlvIcmpv6ChksumVer13 = new OFBsnTlvIcmpv6ChksumVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvIcmpv6ChksumVer13);
    ...
    final static OFBsnTlvIcmpv6ChksumVer13Funnel FUNNEL = new OFBsnTlvIcmpv6ChksumVer13Funnel();
    static class OFBsnTlvIcmpv6ChksumVer13Funnel implements Funnel<OFBsnTlvIcmpv6ChksumVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvIcmpv6ChksumVer13> {
        @Override
