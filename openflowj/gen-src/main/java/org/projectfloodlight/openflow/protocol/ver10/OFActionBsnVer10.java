        ...
        public OFActionBsn readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(subtype) {
               case 0x4:
                   ...
                   return OFActionBsnChecksumVer10.READER.readFrom(context, bb);
               case 0x1:
                   bb.readerIndex(start);
                   // discriminator value 0x1L=0x1L for class OFActionBsnMirrorVer10
                   return OFActionBsnMirrorVer10.READER.readFrom(context, bb);
               case 0x2:
                   bb.readerIndex(start);
                   // discriminator value 0x2L=0x2L for class OFActionBsnSetTunnelDstVer10
                   return OFActionBsnSetTunnelDstVer10.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFActionBsnVer10.class, "subtype", subtype);
            }
            // pad: 4 bytes
            bb.skipBytes(4);
