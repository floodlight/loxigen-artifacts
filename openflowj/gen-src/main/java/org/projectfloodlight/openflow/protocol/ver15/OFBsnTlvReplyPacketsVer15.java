...
class OFBsnTlvReplyPacketsVer15 implements OFBsnTlvReplyPackets {
...
//
    ...
    final static OFBsnTlvReplyPacketsVer15 DEFAULT = new OFBsnTlvReplyPacketsVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvReplyPackets> {
        ...
        public OFBsnTlvReplyPackets readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvReplyPacketsVer15 bsnTlvReplyPacketsVer15 = new OFBsnTlvReplyPacketsVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvReplyPacketsVer15);
    ...
    final static OFBsnTlvReplyPacketsVer15Funnel FUNNEL = new OFBsnTlvReplyPacketsVer15Funnel();
    static class OFBsnTlvReplyPacketsVer15Funnel implements Funnel<OFBsnTlvReplyPacketsVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvReplyPacketsVer15> {
        @Override
