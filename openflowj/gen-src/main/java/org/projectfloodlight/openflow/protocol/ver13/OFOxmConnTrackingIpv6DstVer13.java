...
class OFOxmConnTrackingIpv6DstVer13 implements OFOxmConnTrackingIpv6Dst {
...
//
    ...
    final static OFOxmConnTrackingIpv6DstVer13 DEFAULT = new OFOxmConnTrackingIpv6DstVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmConnTrackingIpv6Dst> {
        ...
        public OFOxmConnTrackingIpv6Dst readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingIpv6DstVer13 oxmConnTrackingIpv6DstVer13 = new OFOxmConnTrackingIpv6DstVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingIpv6DstVer13);
    ...
    final static OFOxmConnTrackingIpv6DstVer13Funnel FUNNEL = new OFOxmConnTrackingIpv6DstVer13Funnel();
    static class OFOxmConnTrackingIpv6DstVer13Funnel implements Funnel<OFOxmConnTrackingIpv6DstVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingIpv6DstVer13> {
        @Override
