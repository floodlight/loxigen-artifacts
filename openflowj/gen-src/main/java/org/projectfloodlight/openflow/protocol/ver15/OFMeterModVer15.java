...
class OFMeterModVer15 implements OFMeterMod {
...
//
    ...
    OFMeterModVer15(long xid, OFMeterModCommand command, Set<OFMeterFlags> flags, long meterId, List<OFMeterBand> bands) {
        if(command == null) {
    ...
    static class BuilderWithParent implements OFMeterMod.Builder {
        ...
        BuilderWithParent(OFMeterModVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterMod> {
        ...
        public OFMeterMod readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFMeterModCommand command = OFMeterModCommandSerializerVer15.readFrom(bb);
            Set<OFMeterFlags> flags = OFMeterFlagsSerializerVer15.readFrom(bb);
            long meterId = U32.f(bb.readInt());
            List<OFMeterBand> bands = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFMeterBandVer15.READER);

            OFMeterModVer15 meterModVer15 = new OFMeterModVer15(
                    xid,
                      command,
                      flags,
                      meterId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterModVer15);
            return meterModVer15;
        }
    }
    ...
    final static OFMeterModVer15Funnel FUNNEL = new OFMeterModVer15Funnel();
    static class OFMeterModVer15Funnel implements Funnel<OFMeterModVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterModVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFMeterModCommandSerializerVer15.putTo(message.command, sink);
    ...
    static class Writer implements OFMessageWriter<OFMeterModVer15> {
        @Override
        public void write(ByteBuf bb, OFMeterModVer15 message) {
            ...
            OFMeterModCommandSerializerVer15.writeTo(bb, message.command);
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFMeterModVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterModVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterModVer15 other = (OFMeterModVer15) obj;
