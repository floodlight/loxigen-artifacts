...
class OFOxmConnTrackingIpv6SrcVer15 implements OFOxmConnTrackingIpv6Src {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmConnTrackingIpv6SrcVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmConnTrackingIpv6SrcVer15 DEFAULT = new OFOxmConnTrackingIpv6SrcVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmConnTrackingIpv6SrcVer15(IPv6Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmConnTrackingIpv6SrcVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmConnTrackingIpv6Src.Builder {
        final OFOxmConnTrackingIpv6SrcVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv6Address value;

        BuilderWithParent(OFOxmConnTrackingIpv6SrcVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConnTrackingIpv6Src> {
        ...
        public OFOxmConnTrackingIpv6Src readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingIpv6SrcVer15 oxmConnTrackingIpv6SrcVer15 = new OFOxmConnTrackingIpv6SrcVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingIpv6SrcVer15);
            return oxmConnTrackingIpv6SrcVer15;
        }
    }
    ...
    final static OFOxmConnTrackingIpv6SrcVer15Funnel FUNNEL = new OFOxmConnTrackingIpv6SrcVer15Funnel();
    static class OFOxmConnTrackingIpv6SrcVer15Funnel implements Funnel<OFOxmConnTrackingIpv6SrcVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmConnTrackingIpv6SrcVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x1f410L
            sink.putInt(0x1f410);
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingIpv6SrcVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmConnTrackingIpv6SrcVer15 message) {
            // fixed value property typeLen = 0x1f410L
            bb.writeInt(0x1f410);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmConnTrackingIpv6SrcVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmConnTrackingIpv6SrcVer15 other = (OFOxmConnTrackingIpv6SrcVer15) obj;
