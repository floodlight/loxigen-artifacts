...
class OFBsnTlvAnalyticsVer14 implements OFBsnTlvAnalytics {
...
//
    ...
    final static OFBsnTlvAnalyticsVer14 DEFAULT = new OFBsnTlvAnalyticsVer14(

    );

    final static OFBsnTlvAnalyticsVer14 INSTANCE = new OFBsnTlvAnalyticsVer14();
    ...
    static class Reader implements OFMessageReader<OFBsnTlvAnalytics> {
        @Override
        public OFBsnTlvAnalytics readFrom(ByteBuf bb) throws OFParseError {
            int start = bb.readerIndex();
            // fixed value property type == 0xce
    ...
    final static OFBsnTlvAnalyticsVer14Funnel FUNNEL = new OFBsnTlvAnalyticsVer14Funnel();
    static class OFBsnTlvAnalyticsVer14Funnel implements Funnel<OFBsnTlvAnalyticsVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvAnalyticsVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0xce
            sink.putShort((short) 0xce);
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvAnalyticsVer14> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvAnalyticsVer14 message) {
            // fixed value property type = 0xce
            bb.writeShort((short) 0xce);
            // fixed value property length = 4
