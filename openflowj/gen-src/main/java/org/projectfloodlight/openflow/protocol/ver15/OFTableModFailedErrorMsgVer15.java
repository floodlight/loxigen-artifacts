...
class OFTableModFailedErrorMsgVer15 implements OFTableModFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFTableModFailedErrorMsgVer15.class);
    // version: 1.5
...
//
    ...
    OFTableModFailedErrorMsgVer15(long xid, OFTableModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFTableModFailedErrorMsgVer15: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFTableModFailedErrorMsgVer15: property data cannot be null");
        }
    ...
    static class BuilderWithParent implements OFTableModFailedErrorMsg.Builder {
        final OFTableModFailedErrorMsgVer15 parentMessage;
        ...
        BuilderWithParent(OFTableModFailedErrorMsgVer15 parentMessage) {
    ...
    public OFTableModFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFTableModFailedErrorMsg build() {
                ...
                //
                return new OFTableModFailedErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableModFailedErrorMsg> {
        ...
        public OFTableModFailedErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFTableModFailedCode code = OFTableModFailedCodeSerializerVer15.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_15);

            OFTableModFailedErrorMsgVer15 tableModFailedErrorMsgVer15 = new OFTableModFailedErrorMsgVer15(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableModFailedErrorMsgVer15);
            return tableModFailedErrorMsgVer15;
        }
    }
    ...
    final static OFTableModFailedErrorMsgVer15Funnel FUNNEL = new OFTableModFailedErrorMsgVer15Funnel();
    static class OFTableModFailedErrorMsgVer15Funnel implements Funnel<OFTableModFailedErrorMsgVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableModFailedErrorMsgVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFTableModFailedCodeSerializerVer15.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFTableModFailedErrorMsgVer15> {
        @Override
        public void write(ByteBuf bb, OFTableModFailedErrorMsgVer15 message) {
            ...
            OFTableModFailedCodeSerializerVer15.writeTo(bb, message.code);
            message.data.writeTo(bb);

            // update length field
            int length = bb.writerIndex() - startIndex;
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFTableModFailedErrorMsgVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableModFailedErrorMsgVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableModFailedErrorMsgVer15 other = (OFTableModFailedErrorMsgVer15) obj;
