...
class OFActionSetQueueVer15 implements OFActionSetQueue {
...
//
    ...
    final static OFActionSetQueueVer15 DEFAULT = new OFActionSetQueueVer15(
        DEFAULT_QUEUE_ID
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFActionSetQueue> {
        @Override
        public OFActionSetQueue readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFActionSetQueueVer15 actionSetQueueVer15 = new OFActionSetQueueVer15(
                    queueId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionSetQueueVer15);
    ...
    final static OFActionSetQueueVer15Funnel FUNNEL = new OFActionSetQueueVer15Funnel();
    static class OFActionSetQueueVer15Funnel implements Funnel<OFActionSetQueueVer15> {
    ...
    static class Writer implements OFMessageWriter<OFActionSetQueueVer15> {
        @Override
