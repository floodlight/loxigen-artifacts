...
public class OFFactoryVer13 implements OFFactory {
    ...
    public OFFlowDescEntry.Builder buildFlowDescEntry() {
        throw new UnsupportedOperationException("OFFlowDescEntry not supported in version 1.3");
    }

    public OFFlowDescReply.Builder buildFlowDescReply() {
        throw new UnsupportedOperationException("OFFlowDescReply not supported in version 1.3");
    }

    public OFFlowDescRequest.Builder buildFlowDescRequest() {
        throw new UnsupportedOperationException("OFFlowDescRequest not supported in version 1.3");
    }
