...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnGentableEntryStatsRequest> {
        @Override
        public OFBsnGentableEntryStatsRequest readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
