...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmIcmpv4Code> {
        @Override
        public OFOxmIcmpv4Code readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
