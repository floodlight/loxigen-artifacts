...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmBsnL3DstClassIdMasked> {
        @Override
        public OFOxmBsnL3DstClassIdMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
