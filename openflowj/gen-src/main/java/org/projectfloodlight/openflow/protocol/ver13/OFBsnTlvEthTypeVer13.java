...
class OFBsnTlvEthTypeVer13 implements OFBsnTlvEthType {
...
//
    ...
    final static OFBsnTlvEthTypeVer13 DEFAULT = new OFBsnTlvEthTypeVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvEthType> {
        ...
        public OFBsnTlvEthType readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvEthTypeVer13 bsnTlvEthTypeVer13 = new OFBsnTlvEthTypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvEthTypeVer13);
    ...
    final static OFBsnTlvEthTypeVer13Funnel FUNNEL = new OFBsnTlvEthTypeVer13Funnel();
    static class OFBsnTlvEthTypeVer13Funnel implements Funnel<OFBsnTlvEthTypeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvEthTypeVer13> {
        @Override
