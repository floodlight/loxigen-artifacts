...
class OFBsnTlvRoutingParamVer15 implements OFBsnTlvRoutingParam {
...
//
    ...
    static class BuilderWithParent implements OFBsnTlvRoutingParam.Builder {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnTlvRoutingParam build() {
                OFBsnRoutingParam value = this.valueSet ? this.value : parentMessage.value;
                if(value == null)
    ...
    static class Builder implements OFBsnTlvRoutingParam.Builder {
        // OF message fields
        private boolean valueSet;
        private OFBsnRoutingParam value;
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvRoutingParam> {
        @Override
        public OFBsnTlvRoutingParam readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            if(bb.readableBytes() < LENGTH)
                return null;
            int start = bb.readerIndex();
            // fixed value property type == 0xa1
            ...
            OFBsnTlvRoutingParamVer15 bsnTlvRoutingParamVer15 = new OFBsnTlvRoutingParamVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvRoutingParamVer15);
    ...
    final static OFBsnTlvRoutingParamVer15Funnel FUNNEL = new OFBsnTlvRoutingParamVer15Funnel();
    static class OFBsnTlvRoutingParamVer15Funnel implements Funnel<OFBsnTlvRoutingParamVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvRoutingParamVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0xa1
            sink.putShort((short) 0xa1);
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvRoutingParamVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvRoutingParamVer15 message) {
            // fixed value property type = 0xa1
            bb.writeShort((short) 0xa1);
            // fixed value property length = 6
