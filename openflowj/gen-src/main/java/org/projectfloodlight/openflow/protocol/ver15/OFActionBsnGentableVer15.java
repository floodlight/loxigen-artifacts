...
class OFActionBsnGentableVer15 implements OFActionBsnGentable {
...
//
    ...
    final static OFActionBsnGentableVer15 DEFAULT = new OFActionBsnGentableVer15(
...
//
    ...
    static class Reader implements OFMessageReader<OFActionBsnGentable> {
        ...
        public OFActionBsnGentable readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionBsnGentableVer15 actionBsnGentableVer15 = new OFActionBsnGentableVer15(
                    tableId,
                      key
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionBsnGentableVer15);
    ...
    final static OFActionBsnGentableVer15Funnel FUNNEL = new OFActionBsnGentableVer15Funnel();
    static class OFActionBsnGentableVer15Funnel implements Funnel<OFActionBsnGentableVer15> {
    ...
    static class Writer implements OFMessageWriter<OFActionBsnGentableVer15> {
        @Override
        public void write(ByteBuf bb, OFActionBsnGentableVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFActionBsnGentableVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
