...
class OFOxmBsnUdf1Ver15 implements OFOxmBsnUdf1 {
...
//
    ...
    final static OFOxmBsnUdf1Ver15 DEFAULT = new OFOxmBsnUdf1Ver15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnUdf1> {
        ...
        public OFOxmBsnUdf1 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnUdf1Ver15 oxmBsnUdf1Ver15 = new OFOxmBsnUdf1Ver15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnUdf1Ver15);
    ...
    final static OFOxmBsnUdf1Ver15Funnel FUNNEL = new OFOxmBsnUdf1Ver15Funnel();
    static class OFOxmBsnUdf1Ver15Funnel implements Funnel<OFOxmBsnUdf1Ver15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnUdf1Ver15> {
        @Override
