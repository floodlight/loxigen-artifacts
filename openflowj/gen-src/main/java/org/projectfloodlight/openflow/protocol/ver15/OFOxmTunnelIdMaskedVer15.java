...
class OFOxmTunnelIdMaskedVer15 implements OFOxmTunnelIdMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmTunnelIdMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmTunnelIdMaskedVer15 DEFAULT = new OFOxmTunnelIdMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmTunnelIdMaskedVer15(U64 value, U64 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmTunnelIdMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmTunnelIdMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmTunnelIdMasked.Builder {
        final OFOxmTunnelIdMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmTunnelIdMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunnelIdMasked> {
        ...
        public OFOxmTunnelIdMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunnelIdMaskedVer15 oxmTunnelIdMaskedVer15 = new OFOxmTunnelIdMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunnelIdMaskedVer15);
            return oxmTunnelIdMaskedVer15;
        }
    }
    ...
    final static OFOxmTunnelIdMaskedVer15Funnel FUNNEL = new OFOxmTunnelIdMaskedVer15Funnel();
    static class OFOxmTunnelIdMaskedVer15Funnel implements Funnel<OFOxmTunnelIdMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmTunnelIdMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004d10L
    ...
    static class Writer implements OFMessageWriter<OFOxmTunnelIdMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmTunnelIdMaskedVer15 message) {
            // fixed value property typeLen = 0x80004d10L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmTunnelIdMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmTunnelIdMaskedVer15 other = (OFOxmTunnelIdMaskedVer15) obj;
