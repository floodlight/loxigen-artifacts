...
class OFBsnGentableEntryDeleteVer15 implements OFBsnGentableEntryDelete {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryDeleteVer15.class);
    // version: 1.5
...
//
    ...
    OFBsnGentableEntryDeleteVer15(long xid, GenTableId tableId, List<OFBsnTlv> key) {
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableEntryDeleteVer15: property tableId cannot be null");
        }
        if(key == null) {
            throw new NullPointerException("OFBsnGentableEntryDeleteVer15: property key cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnGentableEntryDelete.Builder {
        final OFBsnGentableEntryDeleteVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryDeleteVer15 parentMessage) {
    ...
    public OFBsnGentableEntryDelete.Builder setKey(List<OFBsnTlv> key) {
        ...
        public OFBsnGentableEntryDelete build() {
                ...
                //
                return new OFBsnGentableEntryDeleteVer15(
                    xid,
                    tableId,
                    key
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryDelete> {
        ...
        public OFBsnGentableEntryDelete readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableEntryDeleteVer15 bsnGentableEntryDeleteVer15 = new OFBsnGentableEntryDeleteVer15(
                    xid,
                      tableId,
                      key
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryDeleteVer15);
            return bsnGentableEntryDeleteVer15;
        }
    }
    ...
    final static OFBsnGentableEntryDeleteVer15Funnel FUNNEL = new OFBsnGentableEntryDeleteVer15Funnel();
    static class OFBsnGentableEntryDeleteVer15Funnel implements Funnel<OFBsnGentableEntryDeleteVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableEntryDeleteVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryDeleteVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableEntryDeleteVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnGentableEntryDeleteVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryDeleteVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryDeleteVer15 other = (OFBsnGentableEntryDeleteVer15) obj;
