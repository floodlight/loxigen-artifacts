...
class OFGroupStatsEntryVer15 implements OFGroupStatsEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupStatsEntryVer15.class);
    // version: 1.5
...
//
    ...
    final static OFGroupStatsEntryVer15 DEFAULT = new OFGroupStatsEntryVer15(
    ...
    OFGroupStatsEntryVer15(OFGroup group, long refCount, U64 packetCount, U64 byteCount, long durationSec, long durationNsec, List<OFBucketCounter> bucketStats) {
        if(group == null) {
            throw new NullPointerException("OFGroupStatsEntryVer15: property group cannot be null");
        }
        if(packetCount == null) {
            throw new NullPointerException("OFGroupStatsEntryVer15: property packetCount cannot be null");
        }
        if(byteCount == null) {
            throw new NullPointerException("OFGroupStatsEntryVer15: property byteCount cannot be null");
        }
        if(bucketStats == null) {
            throw new NullPointerException("OFGroupStatsEntryVer15: property bucketStats cannot be null");
        }
        this.group = group;
    ...
    static class BuilderWithParent implements OFGroupStatsEntry.Builder {
        final OFGroupStatsEntryVer15 parentMessage;
        ...
        BuilderWithParent(OFGroupStatsEntryVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFGroupStatsEntry build() {
                ...
                //
                return new OFGroupStatsEntryVer15(
                    group,
                    refCount,
                    packetCount,
                    byteCount,
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupStatsEntry> {
        ...
        public OFGroupStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBucketCounter> bucketStats = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBucketCounterVer15.READER);

            OFGroupStatsEntryVer15 groupStatsEntryVer15 = new OFGroupStatsEntryVer15(
                    group,
                      refCount,
                      packetCount,
                      byteCount,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupStatsEntryVer15);
            return groupStatsEntryVer15;
        }
    }
    ...
    final static OFGroupStatsEntryVer15Funnel FUNNEL = new OFGroupStatsEntryVer15Funnel();
    static class OFGroupStatsEntryVer15Funnel implements Funnel<OFGroupStatsEntryVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupStatsEntryVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFGroupStatsEntryVer15> {
        @Override
        public void write(ByteBuf bb, OFGroupStatsEntryVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFGroupStatsEntryVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupStatsEntryVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupStatsEntryVer15 other = (OFGroupStatsEntryVer15) obj;
