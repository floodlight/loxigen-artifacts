...
class OFPortStatsPropEthernetVer15 implements OFPortStatsPropEthernet {
...
//
    ...
    final static OFPortStatsPropEthernetVer15 DEFAULT = new OFPortStatsPropEthernetVer15(
    ...
    public OFVersion getVersion() {
        ...
        public OFPortStatsPropEthernet build() {
                ...
                //
                return new OFPortStatsPropEthernetVer15(
                    rxFrameErr,
                    rxOverErr,
                    rxCrcErr,
                    collisions
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFPortStatsPropEthernet> {
        @Override
        public OFPortStatsPropEthernet readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFPortStatsPropEthernetVer15 portStatsPropEthernetVer15 = new OFPortStatsPropEthernetVer15(
                    rxFrameErr,
                      rxOverErr,
                      rxCrcErr,
                      collisions
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", portStatsPropEthernetVer15);
    ...
    final static OFPortStatsPropEthernetVer15Funnel FUNNEL = new OFPortStatsPropEthernetVer15Funnel();
    static class OFPortStatsPropEthernetVer15Funnel implements Funnel<OFPortStatsPropEthernetVer15> {
    ...
    static class Writer implements OFMessageWriter<OFPortStatsPropEthernetVer15> {
        @Override
