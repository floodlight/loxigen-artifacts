...
class OFGroupDeleteVer15 implements OFGroupDelete {
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupDelete> {
        ...
        public OFGroupDelete readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFGroupDeleteVer15 groupDeleteVer15 = new OFGroupDeleteVer15(
                    xid,
                      groupType,
                      group,
                      commandBucketId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupDeleteVer15);
    ...
    final static OFGroupDeleteVer15Funnel FUNNEL = new OFGroupDeleteVer15Funnel();
    static class OFGroupDeleteVer15Funnel implements Funnel<OFGroupDeleteVer15> {
    ...
    static class Writer implements OFMessageWriter<OFGroupDeleteVer15> {
        @Override
