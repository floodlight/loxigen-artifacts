...
class OFBsnTlvHashGtpHeaderMatchVer13 implements OFBsnTlvHashGtpHeaderMatch {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnTlvHashGtpHeaderMatchVer13.class);
    // version: 1.3
...
//
    ...
    final static OFBsnTlvHashGtpHeaderMatchVer13 DEFAULT = new OFBsnTlvHashGtpHeaderMatchVer13(
        DEFAULT_FIRST_HEADER_BYTE, DEFAULT_FIRST_HEADER_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnTlvHashGtpHeaderMatchVer13(short firstHeaderByte, short firstHeaderMask) {
    ...
    static class BuilderWithParent implements OFBsnTlvHashGtpHeaderMatch.Builder {
        final OFBsnTlvHashGtpHeaderMatchVer13 parentMessage;
        ...
        BuilderWithParent(OFBsnTlvHashGtpHeaderMatchVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvHashGtpHeaderMatch> {
        ...
        public OFBsnTlvHashGtpHeaderMatch readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvHashGtpHeaderMatchVer13 bsnTlvHashGtpHeaderMatchVer13 = new OFBsnTlvHashGtpHeaderMatchVer13(
                    firstHeaderByte,
                      firstHeaderMask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvHashGtpHeaderMatchVer13);
            return bsnTlvHashGtpHeaderMatchVer13;
        }
    }
    ...
    final static OFBsnTlvHashGtpHeaderMatchVer13Funnel FUNNEL = new OFBsnTlvHashGtpHeaderMatchVer13Funnel();
    static class OFBsnTlvHashGtpHeaderMatchVer13Funnel implements Funnel<OFBsnTlvHashGtpHeaderMatchVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvHashGtpHeaderMatchVer13 message, PrimitiveSink sink) {
            // fixed value property type = 0x68
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvHashGtpHeaderMatchVer13> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvHashGtpHeaderMatchVer13 message) {
            // fixed value property type = 0x68
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTlvHashGtpHeaderMatchVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTlvHashGtpHeaderMatchVer13 other = (OFBsnTlvHashGtpHeaderMatchVer13) obj;
