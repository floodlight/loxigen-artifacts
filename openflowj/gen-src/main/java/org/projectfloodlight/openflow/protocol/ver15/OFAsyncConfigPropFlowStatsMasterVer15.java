...
class OFAsyncConfigPropFlowStatsMasterVer15 implements OFAsyncConfigPropFlowStatsMaster {
...
//
    ...
    final static OFAsyncConfigPropFlowStatsMasterVer15 DEFAULT = new OFAsyncConfigPropFlowStatsMasterVer15(
        DEFAULT_MASK
    );
    ...
    static class BuilderWithParent implements OFAsyncConfigPropFlowStatsMaster.Builder {
    ...
    static class Builder implements OFAsyncConfigPropFlowStatsMaster.Builder {
        // OF message fields
        private boolean maskSet;
        private long mask;
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFAsyncConfigPropFlowStatsMaster> {
        @Override
        public OFAsyncConfigPropFlowStatsMaster readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFAsyncConfigPropFlowStatsMasterVer15 asyncConfigPropFlowStatsMasterVer15 = new OFAsyncConfigPropFlowStatsMasterVer15(
                    mask
                    );
            if(logger.isTraceEnabled())
    ...
    final static OFAsyncConfigPropFlowStatsMasterVer15Funnel FUNNEL = new OFAsyncConfigPropFlowStatsMasterVer15Funnel();
    static class OFAsyncConfigPropFlowStatsMasterVer15Funnel implements Funnel<OFAsyncConfigPropFlowStatsMasterVer15> {
    ...
    static class Writer implements OFMessageWriter<OFAsyncConfigPropFlowStatsMasterVer15> {
        @Override
