...
class OFBsnTlvUriSchemeVer14 implements OFBsnTlvUriScheme {
...
//
    ...
    final static OFBsnTlvUriSchemeVer14 DEFAULT = new OFBsnTlvUriSchemeVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvUriScheme> {
        ...
        public OFBsnTlvUriScheme readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvUriSchemeVer14 bsnTlvUriSchemeVer14 = new OFBsnTlvUriSchemeVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvUriSchemeVer14);
    ...
    final static OFBsnTlvUriSchemeVer14Funnel FUNNEL = new OFBsnTlvUriSchemeVer14Funnel();
    static class OFBsnTlvUriSchemeVer14Funnel implements Funnel<OFBsnTlvUriSchemeVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvUriSchemeVer14> {
        @Override
