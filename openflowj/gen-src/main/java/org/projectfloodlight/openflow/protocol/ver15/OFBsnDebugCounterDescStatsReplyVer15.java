...
class OFBsnDebugCounterDescStatsReplyVer15 implements OFBsnDebugCounterDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnDebugCounterDescStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnDebugCounterDescStatsReplyVer15 DEFAULT = new OFBsnDebugCounterDescStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnDebugCounterDescStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnDebugCounterDescStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnDebugCounterDescStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnDebugCounterDescStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnDebugCounterDescStatsReply.Builder {
        final OFBsnDebugCounterDescStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnDebugCounterDescStatsReplyVer15 parentMessage) {
    ...
    public OFBsnDebugCounterDescStatsReply.Builder setXid(long xid) {
        ...
        public OFBsnDebugCounterDescStatsReply build() {
                ...
                //
                return new OFBsnDebugCounterDescStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnDebugCounterDescStatsReply> {
        ...
        public OFBsnDebugCounterDescStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnDebugCounterDescStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnDebugCounterDescStatsEntryVer15.READER);

            OFBsnDebugCounterDescStatsReplyVer15 bsnDebugCounterDescStatsReplyVer15 = new OFBsnDebugCounterDescStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnDebugCounterDescStatsReplyVer15);
            return bsnDebugCounterDescStatsReplyVer15;
        }
    }
    ...
    final static OFBsnDebugCounterDescStatsReplyVer15Funnel FUNNEL = new OFBsnDebugCounterDescStatsReplyVer15Funnel();
    static class OFBsnDebugCounterDescStatsReplyVer15Funnel implements Funnel<OFBsnDebugCounterDescStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnDebugCounterDescStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnDebugCounterDescStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnDebugCounterDescStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnDebugCounterDescStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnDebugCounterDescStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnDebugCounterDescStatsReplyVer15 other = (OFBsnDebugCounterDescStatsReplyVer15) obj;
