...
class OFOxmConnTrackingIpv6DstMaskedVer15 implements OFOxmConnTrackingIpv6DstMasked {
...
//
    ...
    final static OFOxmConnTrackingIpv6DstMaskedVer15 DEFAULT = new OFOxmConnTrackingIpv6DstMaskedVer15(
    ...
    public OFOxm<IPv6Address> getCanonical() {
        if (IPv6Address.NO_MASK.equals(mask)) {
            return new OFOxmConnTrackingIpv6DstVer15(value);
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmConnTrackingIpv6DstMasked> {
        ...
        public OFOxmConnTrackingIpv6DstMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingIpv6DstMaskedVer15 oxmConnTrackingIpv6DstMaskedVer15 = new OFOxmConnTrackingIpv6DstMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingIpv6DstMaskedVer15);
    ...
    final static OFOxmConnTrackingIpv6DstMaskedVer15Funnel FUNNEL = new OFOxmConnTrackingIpv6DstMaskedVer15Funnel();
    static class OFOxmConnTrackingIpv6DstMaskedVer15Funnel implements Funnel<OFOxmConnTrackingIpv6DstMaskedVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingIpv6DstMaskedVer15> {
        @Override
