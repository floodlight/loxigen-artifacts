...
public class OFFactoryVer10 implements OFFactory {
    ...
    public OFFlowDescEntry.Builder buildFlowDescEntry() {
        throw new UnsupportedOperationException("OFFlowDescEntry not supported in version 1.0");
    }

    public OFFlowDescReply.Builder buildFlowDescReply() {
        throw new UnsupportedOperationException("OFFlowDescReply not supported in version 1.0");
    }

    public OFFlowDescRequest.Builder buildFlowDescRequest() {
        throw new UnsupportedOperationException("OFFlowDescRequest not supported in version 1.0");
    }
