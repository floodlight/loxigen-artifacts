...
public class OFTableModFailedCodeSerializerVer15 {
    ...
    public static OFTableModFailedCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFTableModFailedCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFTableModFailedCode e) {
        switch(e) {
            ...
            case EPERM:
                return EPERM_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFTableModFailedCode in version 1.5: " + e);
        }
    }
