...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnFlowIdleEnableSetRequest> {
        @Override
        public OFBsnFlowIdleEnableSetRequest readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
