...
class OFMeterBandDscpRemarkVer15 implements OFMeterBandDscpRemark {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterBandDscpRemarkVer15.class);
    // version: 1.5
...
//
    ...
    final static OFMeterBandDscpRemarkVer15 DEFAULT = new OFMeterBandDscpRemarkVer15(
        DEFAULT_RATE, DEFAULT_BURST_SIZE, DEFAULT_PREC_LEVEL
    );

    // package private constructor - used by readers, builders, and factory
    OFMeterBandDscpRemarkVer15(long rate, long burstSize, short precLevel) {
        this.rate = rate;
    ...
    static class BuilderWithParent implements OFMeterBandDscpRemark.Builder {
        final OFMeterBandDscpRemarkVer15 parentMessage;
        ...
        BuilderWithParent(OFMeterBandDscpRemarkVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFMeterBandDscpRemark build() {
                ...
                //
                return new OFMeterBandDscpRemarkVer15(
                    rate,
                    burstSize,
                    precLevel
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterBandDscpRemark> {
        ...
        public OFMeterBandDscpRemark readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFMeterBandDscpRemarkVer15 meterBandDscpRemarkVer15 = new OFMeterBandDscpRemarkVer15(
                    rate,
                      burstSize,
                      precLevel
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterBandDscpRemarkVer15);
            return meterBandDscpRemarkVer15;
        }
    }
    ...
    final static OFMeterBandDscpRemarkVer15Funnel FUNNEL = new OFMeterBandDscpRemarkVer15Funnel();
    static class OFMeterBandDscpRemarkVer15Funnel implements Funnel<OFMeterBandDscpRemarkVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterBandDscpRemarkVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0x2
    ...
    static class Writer implements OFMessageWriter<OFMeterBandDscpRemarkVer15> {
        @Override
        public void write(ByteBuf bb, OFMeterBandDscpRemarkVer15 message) {
            // fixed value property type = 0x2
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterBandDscpRemarkVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterBandDscpRemarkVer15 other = (OFMeterBandDscpRemarkVer15) obj;
