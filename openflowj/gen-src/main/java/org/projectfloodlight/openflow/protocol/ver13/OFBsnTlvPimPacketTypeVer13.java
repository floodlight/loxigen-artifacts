...
class OFBsnTlvPimPacketTypeVer13 implements OFBsnTlvPimPacketType {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvPimPacketType> {
        ...
        public OFBsnTlvPimPacketType readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvPimPacketTypeVer13 bsnTlvPimPacketTypeVer13 = new OFBsnTlvPimPacketTypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvPimPacketTypeVer13);
    ...
    final static OFBsnTlvPimPacketTypeVer13Funnel FUNNEL = new OFBsnTlvPimPacketTypeVer13Funnel();
    static class OFBsnTlvPimPacketTypeVer13Funnel implements Funnel<OFBsnTlvPimPacketTypeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvPimPacketTypeVer13> {
        @Override
