...
class OFBsnGentableBucketStatsRequestVer15 implements OFBsnGentableBucketStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableBucketStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    OFBsnGentableBucketStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, GenTableId tableId) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableBucketStatsRequestVer15: property flags cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableBucketStatsRequestVer15: property tableId cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableBucketStatsRequest.Builder {
        final OFBsnGentableBucketStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableBucketStatsRequestVer15 parentMessage) {
    ...
    public OFBsnGentableBucketStatsRequest.Builder setTableId(GenTableId tableId) {
        ...
        public OFBsnGentableBucketStatsRequest build() {
                ...
                //
                return new OFBsnGentableBucketStatsRequestVer15(
                    xid,
                    flags,
                    tableId
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableBucketStatsRequest> {
        ...
        public OFBsnGentableBucketStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableBucketStatsRequestVer15 bsnGentableBucketStatsRequestVer15 = new OFBsnGentableBucketStatsRequestVer15(
                    xid,
                      flags,
                      tableId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableBucketStatsRequestVer15);
            return bsnGentableBucketStatsRequestVer15;
        }
    }
    ...
    final static OFBsnGentableBucketStatsRequestVer15Funnel FUNNEL = new OFBsnGentableBucketStatsRequestVer15Funnel();
    static class OFBsnGentableBucketStatsRequestVer15Funnel implements Funnel<OFBsnGentableBucketStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableBucketStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableBucketStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableBucketStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableBucketStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableBucketStatsRequestVer15 other = (OFBsnGentableBucketStatsRequestVer15) obj;
