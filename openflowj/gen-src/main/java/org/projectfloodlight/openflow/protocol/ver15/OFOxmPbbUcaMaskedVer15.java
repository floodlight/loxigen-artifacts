...
class OFOxmPbbUcaMaskedVer15 implements OFOxmPbbUcaMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmPbbUcaMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmPbbUcaMaskedVer15 DEFAULT = new OFOxmPbbUcaMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmPbbUcaMaskedVer15(OFBooleanValue value, OFBooleanValue mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmPbbUcaMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmPbbUcaMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<OFBooleanValue> getCanonical() {
        if (OFBooleanValue.NO_MASK.equals(mask)) {
            return new OFOxmPbbUcaVer15(value);
    ...
    static class BuilderWithParent implements OFOxmPbbUcaMasked.Builder {
        final OFOxmPbbUcaMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmPbbUcaMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmPbbUcaMasked> {
        @Override
        public OFOxmPbbUcaMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmPbbUcaMaskedVer15 oxmPbbUcaMaskedVer15 = new OFOxmPbbUcaMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmPbbUcaMaskedVer15);
            return oxmPbbUcaMaskedVer15;
        }
    }
    ...
    final static OFOxmPbbUcaMaskedVer15Funnel FUNNEL = new OFOxmPbbUcaMaskedVer15Funnel();
    static class OFOxmPbbUcaMaskedVer15Funnel implements Funnel<OFOxmPbbUcaMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmPbbUcaMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80005302L
    ...
    static class Writer implements OFMessageWriter<OFOxmPbbUcaMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmPbbUcaMaskedVer15 message) {
            // fixed value property typeLen = 0x80005302L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmPbbUcaMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmPbbUcaMaskedVer15 other = (OFOxmPbbUcaMaskedVer15) obj;
