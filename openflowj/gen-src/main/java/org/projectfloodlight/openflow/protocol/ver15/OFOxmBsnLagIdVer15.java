...
class OFOxmBsnLagIdVer15 implements OFOxmBsnLagId {
...
//
    ...
    final static OFOxmBsnLagIdVer15 DEFAULT = new OFOxmBsnLagIdVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnLagId> {
        ...
        public OFOxmBsnLagId readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnLagIdVer15 oxmBsnLagIdVer15 = new OFOxmBsnLagIdVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnLagIdVer15);
    ...
    final static OFOxmBsnLagIdVer15Funnel FUNNEL = new OFOxmBsnLagIdVer15Funnel();
    static class OFOxmBsnLagIdVer15Funnel implements Funnel<OFOxmBsnLagIdVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnLagIdVer15> {
        @Override
