...
class OFOxmArpOpVer15 implements OFOxmArpOp {
...
//
    ...
    final static OFOxmArpOpVer15 DEFAULT = new OFOxmArpOpVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmArpOp> {
        ...
        public OFOxmArpOp readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmArpOpVer15 oxmArpOpVer15 = new OFOxmArpOpVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpOpVer15);
    ...
    final static OFOxmArpOpVer15Funnel FUNNEL = new OFOxmArpOpVer15Funnel();
    static class OFOxmArpOpVer15Funnel implements Funnel<OFOxmArpOpVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmArpOpVer15> {
        @Override
