...
class OFBsnDebugCounterStatsReplyVer15 implements OFBsnDebugCounterStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnDebugCounterStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnDebugCounterStatsReplyVer15 DEFAULT = new OFBsnDebugCounterStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnDebugCounterStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnDebugCounterStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnDebugCounterStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnDebugCounterStatsReplyVer15: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnDebugCounterStatsReply.Builder {
        final OFBsnDebugCounterStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnDebugCounterStatsReplyVer15 parentMessage) {
    ...
    public OFBsnDebugCounterStatsReply.Builder setEntries(List<OFBsnDebugCounterStatsEntry> entries) {
        ...
        public OFBsnDebugCounterStatsReply build() {
                ...
                //
                return new OFBsnDebugCounterStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnDebugCounterStatsReply> {
        @Override
        public OFBsnDebugCounterStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnDebugCounterStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnDebugCounterStatsEntryVer15.READER);

            OFBsnDebugCounterStatsReplyVer15 bsnDebugCounterStatsReplyVer15 = new OFBsnDebugCounterStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnDebugCounterStatsReplyVer15);
            return bsnDebugCounterStatsReplyVer15;
        }
    }
    ...
    final static OFBsnDebugCounterStatsReplyVer15Funnel FUNNEL = new OFBsnDebugCounterStatsReplyVer15Funnel();
    static class OFBsnDebugCounterStatsReplyVer15Funnel implements Funnel<OFBsnDebugCounterStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnDebugCounterStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnDebugCounterStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnDebugCounterStatsReplyVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnDebugCounterStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnDebugCounterStatsReplyVer15 other = (OFBsnDebugCounterStatsReplyVer15) obj;
