...
class OFBsnTlvTimestampVer13 implements OFBsnTlvTimestamp {
...
//
    ...
    final static OFBsnTlvTimestampVer13 DEFAULT = new OFBsnTlvTimestampVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvTimestamp> {
        ...
        public OFBsnTlvTimestamp readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvTimestampVer13 bsnTlvTimestampVer13 = new OFBsnTlvTimestampVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvTimestampVer13);
    ...
    final static OFBsnTlvTimestampVer13Funnel FUNNEL = new OFBsnTlvTimestampVer13Funnel();
    static class OFBsnTlvTimestampVer13Funnel implements Funnel<OFBsnTlvTimestampVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvTimestampVer13> {
        @Override
