...
class OFBsnTlvArpSpaVer15 implements OFBsnTlvArpSpa {
...
//
    ...
    final static OFBsnTlvArpSpaVer15 DEFAULT = new OFBsnTlvArpSpaVer15(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFBsnTlvArpSpa.Builder {
    ...
    static class Builder implements OFBsnTlvArpSpa.Builder {
        // OF message fields
        private boolean valueSet;
        private IPv4Address value;
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvArpSpa> {
        @Override
        public OFBsnTlvArpSpa readFrom(ByteBuf bb) throws OFParseError {
            int start = bb.readerIndex();
            // fixed value property type == 0xc7
            ...
            OFBsnTlvArpSpaVer15 bsnTlvArpSpaVer15 = new OFBsnTlvArpSpaVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvArpSpaVer15);
    ...
    final static OFBsnTlvArpSpaVer15Funnel FUNNEL = new OFBsnTlvArpSpaVer15Funnel();
    static class OFBsnTlvArpSpaVer15Funnel implements Funnel<OFBsnTlvArpSpaVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvArpSpaVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0xc7
            sink.putShort((short) 0xc7);
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvArpSpaVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvArpSpaVer15 message) {
            // fixed value property type = 0xc7
            bb.writeShort((short) 0xc7);
            // fixed value property length = 8
