        ...
        public OFExperimenter readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               case 0x5c16c7:
                   ...
                   return OFBsnHeaderVer13.READER.readFrom(context, bb);
               case 0x2320:
                   bb.readerIndex(start);
                   // discriminator value 0x2320L=0x2320L for class OFNiciraHeaderVer13
                   return OFNiciraHeaderVer13.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFExperimenterVer13.class, "experimenter", experimenter);
            }
            U32.f(bb.readInt());
