...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFFlowLightweightStatsReply> {
        @Override
        public OFFlowLightweightStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFFlowLightweightStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFFlowLightweightStatsEntryVer15.READER);
