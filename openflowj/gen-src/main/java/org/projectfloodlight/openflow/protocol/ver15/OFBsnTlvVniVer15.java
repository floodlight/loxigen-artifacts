...
class OFBsnTlvVniVer15 implements OFBsnTlvVni {
...
//
    ...
    final static OFBsnTlvVniVer15 DEFAULT = new OFBsnTlvVniVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvVni> {
        @Override
        public OFBsnTlvVni readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvVniVer15 bsnTlvVniVer15 = new OFBsnTlvVniVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvVniVer15);
    ...
    final static OFBsnTlvVniVer15Funnel FUNNEL = new OFBsnTlvVniVer15Funnel();
    static class OFBsnTlvVniVer15Funnel implements Funnel<OFBsnTlvVniVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvVniVer15> {
        @Override
