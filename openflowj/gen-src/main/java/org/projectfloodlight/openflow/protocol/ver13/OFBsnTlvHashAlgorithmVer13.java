...
class OFBsnTlvHashAlgorithmVer13 implements OFBsnTlvHashAlgorithm {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvHashAlgorithm> {
        @Override
        public OFBsnTlvHashAlgorithm readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvHashAlgorithmVer13 bsnTlvHashAlgorithmVer13 = new OFBsnTlvHashAlgorithmVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvHashAlgorithmVer13);
    ...
    final static OFBsnTlvHashAlgorithmVer13Funnel FUNNEL = new OFBsnTlvHashAlgorithmVer13Funnel();
    static class OFBsnTlvHashAlgorithmVer13Funnel implements Funnel<OFBsnTlvHashAlgorithmVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvHashAlgorithmVer13> {
        @Override
