        ...
        public OFFlowMod readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(command) {
               case (short) 0x0:
                   ...
                   return OFFlowAddVer11.READER.readFrom(context, bb);
               case (short) 0x3:
                   bb.readerIndex(start);
                   // discriminator value OFFlowModCommand.DELETE=3 for class OFFlowDeleteVer11
                   return OFFlowDeleteVer11.READER.readFrom(context, bb);
               case (short) 0x4:
                   bb.readerIndex(start);
                   // discriminator value OFFlowModCommand.DELETE_STRICT=4 for class OFFlowDeleteStrictVer11
                   return OFFlowDeleteStrictVer11.READER.readFrom(context, bb);
               case (short) 0x1:
                   bb.readerIndex(start);
                   // discriminator value OFFlowModCommand.MODIFY=1 for class OFFlowModifyVer11
                   return OFFlowModifyVer11.READER.readFrom(context, bb);
               case (short) 0x2:
                   bb.readerIndex(start);
                   // discriminator value OFFlowModCommand.MODIFY_STRICT=2 for class OFFlowModifyStrictVer11
                   return OFFlowModifyStrictVer11.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFFlowModVer11.class, "command", command);
            }
            U16.f(bb.readShort());
            U16.f(bb.readShort());
            U16.f(bb.readShort());
            OFBufferId.of(bb.readInt());
            OFPort.read4Bytes(bb);
            OFGroup.read4Bytes(bb);
            OFFlowModFlagsSerializerVer11.readFrom(bb);
            // pad: 2 bytes
            bb.skipBytes(2);
            ChannelUtilsVer11.readOFMatch(context, bb);
            ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFInstructionVer11.READER);
