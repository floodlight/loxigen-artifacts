...
class OFOxmConnTrackingTpSrcMaskedVer13 implements OFOxmConnTrackingTpSrcMasked {
...
//
    ...
    final static OFOxmConnTrackingTpSrcMaskedVer13 DEFAULT = new OFOxmConnTrackingTpSrcMaskedVer13(
    ...
    public OFOxm<TransportPort> getCanonical() {
        if (TransportPort.NO_MASK.equals(mask)) {
            return new OFOxmConnTrackingTpSrcVer13(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConnTrackingTpSrcMasked> {
        ...
        public OFOxmConnTrackingTpSrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingTpSrcMaskedVer13 oxmConnTrackingTpSrcMaskedVer13 = new OFOxmConnTrackingTpSrcMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingTpSrcMaskedVer13);
    ...
    final static OFOxmConnTrackingTpSrcMaskedVer13Funnel FUNNEL = new OFOxmConnTrackingTpSrcMaskedVer13Funnel();
    static class OFOxmConnTrackingTpSrcMaskedVer13Funnel implements Funnel<OFOxmConnTrackingTpSrcMaskedVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingTpSrcMaskedVer13> {
        @Override
