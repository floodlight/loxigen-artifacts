...
class OFBsnTlvSocketVer15 implements OFBsnTlvSocket {
...
//
    ...
    final static OFBsnTlvSocketVer15 DEFAULT = new OFBsnTlvSocketVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvSocket> {
        ...
        public OFBsnTlvSocket readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvSocketVer15 bsnTlvSocketVer15 = new OFBsnTlvSocketVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvSocketVer15);
    ...
    final static OFBsnTlvSocketVer15Funnel FUNNEL = new OFBsnTlvSocketVer15Funnel();
    static class OFBsnTlvSocketVer15Funnel implements Funnel<OFBsnTlvSocketVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvSocketVer15> {
        @Override
