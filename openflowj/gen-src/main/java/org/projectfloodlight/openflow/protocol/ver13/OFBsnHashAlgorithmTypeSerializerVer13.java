...
public class OFBsnHashAlgorithmTypeSerializerVer13 {
    ...
    public static OFBsnHashAlgorithmType ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnHashAlgorithmType in version 1.3: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnHashAlgorithmType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnHashAlgorithmType in version 1.3: " + e);
        }
    }
