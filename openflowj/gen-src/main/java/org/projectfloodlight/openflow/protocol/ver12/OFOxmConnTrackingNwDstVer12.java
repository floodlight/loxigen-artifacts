...
class OFOxmConnTrackingNwDstVer12 implements OFOxmConnTrackingNwDst {
...
//
    ...
    final static OFOxmConnTrackingNwDstVer12 DEFAULT = new OFOxmConnTrackingNwDstVer12(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConnTrackingNwDst> {
        ...
        public OFOxmConnTrackingNwDst readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingNwDstVer12 oxmConnTrackingNwDstVer12 = new OFOxmConnTrackingNwDstVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingNwDstVer12);
    ...
    final static OFOxmConnTrackingNwDstVer12Funnel FUNNEL = new OFOxmConnTrackingNwDstVer12Funnel();
    static class OFOxmConnTrackingNwDstVer12Funnel implements Funnel<OFOxmConnTrackingNwDstVer12> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingNwDstVer12> {
        @Override
