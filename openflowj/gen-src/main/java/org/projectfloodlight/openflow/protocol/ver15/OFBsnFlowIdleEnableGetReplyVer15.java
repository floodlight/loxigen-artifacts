...
class OFBsnFlowIdleEnableGetReplyVer15 implements OFBsnFlowIdleEnableGetReply {
...
//
    ...
    final static OFBsnFlowIdleEnableGetReplyVer15 DEFAULT = new OFBsnFlowIdleEnableGetReplyVer15(
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnFlowIdleEnableGetReply> {
        @Override
        public OFBsnFlowIdleEnableGetReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnFlowIdleEnableGetReplyVer15 bsnFlowIdleEnableGetReplyVer15 = new OFBsnFlowIdleEnableGetReplyVer15(
                    xid,
                      enabled
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnFlowIdleEnableGetReplyVer15);
    ...
    final static OFBsnFlowIdleEnableGetReplyVer15Funnel FUNNEL = new OFBsnFlowIdleEnableGetReplyVer15Funnel();
    static class OFBsnFlowIdleEnableGetReplyVer15Funnel implements Funnel<OFBsnFlowIdleEnableGetReplyVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnFlowIdleEnableGetReplyVer15> {
        @Override
