...
class OFBsnGentableEntryDescStatsRequestVer15 implements OFBsnGentableEntryDescStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryDescStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    OFBsnGentableEntryDescStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, GenTableId tableId, U128 checksum, U128 checksumMask) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsRequestVer15: property flags cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsRequestVer15: property tableId cannot be null");
        }
        if(checksum == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsRequestVer15: property checksum cannot be null");
        }
        if(checksumMask == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsRequestVer15: property checksumMask cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableEntryDescStatsRequest.Builder {
        final OFBsnGentableEntryDescStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryDescStatsRequestVer15 parentMessage) {
    ...
    public OFBsnGentableEntryDescStatsRequest.Builder setChecksumMask(U128 checksumMask) {
        ...
        public OFBsnGentableEntryDescStatsRequest build() {
                ...
                //
                return new OFBsnGentableEntryDescStatsRequestVer15(
                    xid,
                    flags,
                    tableId,
                    checksum,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryDescStatsRequest> {
        ...
        public OFBsnGentableEntryDescStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableEntryDescStatsRequestVer15 bsnGentableEntryDescStatsRequestVer15 = new OFBsnGentableEntryDescStatsRequestVer15(
                    xid,
                      flags,
                      tableId,
                      checksum,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryDescStatsRequestVer15);
            return bsnGentableEntryDescStatsRequestVer15;
        }
    }
    ...
    final static OFBsnGentableEntryDescStatsRequestVer15Funnel FUNNEL = new OFBsnGentableEntryDescStatsRequestVer15Funnel();
    static class OFBsnGentableEntryDescStatsRequestVer15Funnel implements Funnel<OFBsnGentableEntryDescStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableEntryDescStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryDescStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableEntryDescStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryDescStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryDescStatsRequestVer15 other = (OFBsnGentableEntryDescStatsRequestVer15) obj;
