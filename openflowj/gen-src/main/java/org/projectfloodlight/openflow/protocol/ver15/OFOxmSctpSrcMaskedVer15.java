...
class OFOxmSctpSrcMaskedVer15 implements OFOxmSctpSrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmSctpSrcMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmSctpSrcMaskedVer15 DEFAULT = new OFOxmSctpSrcMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmSctpSrcMaskedVer15(TransportPort value, TransportPort mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmSctpSrcMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmSctpSrcMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<TransportPort> getCanonical() {
        if (TransportPort.NO_MASK.equals(mask)) {
            return new OFOxmSctpSrcVer15(value);
    ...
    static class BuilderWithParent implements OFOxmSctpSrcMasked.Builder {
        final OFOxmSctpSrcMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmSctpSrcMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmSctpSrcMasked> {
        @Override
        public OFOxmSctpSrcMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmSctpSrcMaskedVer15 oxmSctpSrcMaskedVer15 = new OFOxmSctpSrcMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmSctpSrcMaskedVer15);
            return oxmSctpSrcMaskedVer15;
        }
    }
    ...
    final static OFOxmSctpSrcMaskedVer15Funnel FUNNEL = new OFOxmSctpSrcMaskedVer15Funnel();
    static class OFOxmSctpSrcMaskedVer15Funnel implements Funnel<OFOxmSctpSrcMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmSctpSrcMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002304L
    ...
    static class Writer implements OFMessageWriter<OFOxmSctpSrcMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmSctpSrcMaskedVer15 message) {
            // fixed value property typeLen = 0x80002304L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmSctpSrcMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmSctpSrcMaskedVer15 other = (OFOxmSctpSrcMaskedVer15) obj;
