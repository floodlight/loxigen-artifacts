...
public class OFHeaderTypeOnfSerializerVer15 {
    ...
    public final static short NO_HEADER_VAL = (short) 0x1;
    public final static short OXM_EXPERIMENTER_VAL = (short) 0xffff;
    ...
    public static short toWireValue(OFHeaderTypeOnf e) {
        switch(e) {
            case ETHERNET:
                return ETHERNET_VAL;
            case NO_HEADER:
                return NO_HEADER_VAL;
            case OXM_EXPERIMENTER:
                return OXM_EXPERIMENTER_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFHeaderTypeOnf in version 1.5: " + e);
        }
    }
