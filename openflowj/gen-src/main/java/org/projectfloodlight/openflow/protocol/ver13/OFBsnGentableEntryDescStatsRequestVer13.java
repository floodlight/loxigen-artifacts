...
//
    ...
    final static OFBsnGentableEntryDescStatsRequestVer13 DEFAULT = new OFBsnGentableEntryDescStatsRequestVer13(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_TABLE_ID, DEFAULT_CHECKSUM, DEFAULT_CHECKSUM_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableEntryDescStatsRequestVer13(long xid, Set<OFStatsRequestFlags> flags, int tableId, OFChecksum128 checksum, OFChecksum128 checksumMask) {
        this.xid = xid;
        this.flags = flags;
    ...
    @Override
    public OFBsnGentableEntryDescStatsRequest.Builder setTableId(int tableId) {
        this.tableId = tableId;
