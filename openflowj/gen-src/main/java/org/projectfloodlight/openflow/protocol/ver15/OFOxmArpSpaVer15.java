...
class OFOxmArpSpaVer15 implements OFOxmArpSpa {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmArpSpaVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmArpSpaVer15 DEFAULT = new OFOxmArpSpaVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmArpSpaVer15(IPv4Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmArpSpaVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmArpSpa.Builder {
        final OFOxmArpSpaVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv4Address value;

        BuilderWithParent(OFOxmArpSpaVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmArpSpa> {
        ...
        public OFOxmArpSpa readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmArpSpaVer15 oxmArpSpaVer15 = new OFOxmArpSpaVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpSpaVer15);
            return oxmArpSpaVer15;
        }
    }
    ...
    final static OFOxmArpSpaVer15Funnel FUNNEL = new OFOxmArpSpaVer15Funnel();
    static class OFOxmArpSpaVer15Funnel implements Funnel<OFOxmArpSpaVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmArpSpaVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002c04L
    ...
    static class Writer implements OFMessageWriter<OFOxmArpSpaVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmArpSpaVer15 message) {
            // fixed value property typeLen = 0x80002c04L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmArpSpaVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmArpSpaVer15 other = (OFOxmArpSpaVer15) obj;
