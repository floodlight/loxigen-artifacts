...
class OFBsnTlvUdpSrcVer15 implements OFBsnTlvUdpSrc {
...
//
    ...
    final static OFBsnTlvUdpSrcVer15 DEFAULT = new OFBsnTlvUdpSrcVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvUdpSrc> {
        @Override
        public OFBsnTlvUdpSrc readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvUdpSrcVer15 bsnTlvUdpSrcVer15 = new OFBsnTlvUdpSrcVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvUdpSrcVer15);
    ...
    final static OFBsnTlvUdpSrcVer15Funnel FUNNEL = new OFBsnTlvUdpSrcVer15Funnel();
    static class OFBsnTlvUdpSrcVer15Funnel implements Funnel<OFBsnTlvUdpSrcVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvUdpSrcVer15> {
        @Override
