...
class OFOxmBsnVfiMaskedVer13 implements OFOxmBsnVfiMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnVfiMaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmBsnVfiMaskedVer13 DEFAULT = new OFOxmBsnVfiMaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnVfiMaskedVer13(VFI value, VFI mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnVfiMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnVfiMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<VFI> getCanonical() {
        if (VFI.NO_MASK.equals(mask)) {
            return new OFOxmBsnVfiVer13(value);
    ...
    static class BuilderWithParent implements OFOxmBsnVfiMasked.Builder {
        final OFOxmBsnVfiMaskedVer13 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnVfiMaskedVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnVfiMasked> {
        ...
        public OFOxmBsnVfiMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnVfiMaskedVer13 oxmBsnVfiMaskedVer13 = new OFOxmBsnVfiMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnVfiMaskedVer13);
            return oxmBsnVfiMaskedVer13;
        }
    }
    ...
    final static OFOxmBsnVfiMaskedVer13Funnel FUNNEL = new OFOxmBsnVfiMaskedVer13Funnel();
    static class OFOxmBsnVfiMaskedVer13Funnel implements Funnel<OFOxmBsnVfiMaskedVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnVfiMaskedVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x33304L
            sink.putInt(0x33304);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnVfiMaskedVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnVfiMaskedVer13 message) {
            // fixed value property typeLen = 0x33304L
            bb.writeInt(0x33304);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnVfiMaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnVfiMaskedVer13 other = (OFOxmBsnVfiMaskedVer13) obj;
