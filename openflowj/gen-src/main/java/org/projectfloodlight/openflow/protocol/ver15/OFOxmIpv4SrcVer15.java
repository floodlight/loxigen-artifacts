...
class OFOxmIpv4SrcVer15 implements OFOxmIpv4Src {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv4SrcVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv4SrcVer15 DEFAULT = new OFOxmIpv4SrcVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv4SrcVer15(IPv4Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv4SrcVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv4Src.Builder {
        final OFOxmIpv4SrcVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv4Address value;

        BuilderWithParent(OFOxmIpv4SrcVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv4Src> {
        ...
        public OFOxmIpv4Src readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv4SrcVer15 oxmIpv4SrcVer15 = new OFOxmIpv4SrcVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv4SrcVer15);
            return oxmIpv4SrcVer15;
        }
    }
    ...
    final static OFOxmIpv4SrcVer15Funnel FUNNEL = new OFOxmIpv4SrcVer15Funnel();
    static class OFOxmIpv4SrcVer15Funnel implements Funnel<OFOxmIpv4SrcVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv4SrcVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001604L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv4SrcVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv4SrcVer15 message) {
            // fixed value property typeLen = 0x80001604L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv4SrcVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv4SrcVer15 other = (OFOxmIpv4SrcVer15) obj;
