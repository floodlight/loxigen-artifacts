...
class OFBsnGenericCommandReplyVer14 implements OFBsnGenericCommandReply {
...
//
    ...
    final static OFBsnGenericCommandReplyVer14 DEFAULT = new OFBsnGenericCommandReplyVer14(
    ...
    public OFBsnGenericCommandReply.Builder setTlvs(List<OFBsnTlv> tlvs) {
        ...
        public OFBsnGenericCommandReply build() {
                ...
                //
                return new OFBsnGenericCommandReplyVer14(
                    xid,
                    status,
                    tlvs
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGenericCommandReply> {
        ...
        public OFBsnGenericCommandReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGenericCommandReplyVer14 bsnGenericCommandReplyVer14 = new OFBsnGenericCommandReplyVer14(
                    xid,
                      status,
                      tlvs
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGenericCommandReplyVer14);
    ...
    final static OFBsnGenericCommandReplyVer14Funnel FUNNEL = new OFBsnGenericCommandReplyVer14Funnel();
    static class OFBsnGenericCommandReplyVer14Funnel implements Funnel<OFBsnGenericCommandReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGenericCommandReplyVer14> {
        @Override
