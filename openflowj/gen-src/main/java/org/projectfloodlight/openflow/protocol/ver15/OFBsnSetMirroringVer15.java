...
class OFBsnSetMirroringVer15 implements OFBsnSetMirroring {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnSetMirroringVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnSetMirroringVer15 DEFAULT = new OFBsnSetMirroringVer15(
        DEFAULT_XID, DEFAULT_REPORT_MIRROR_PORTS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnSetMirroringVer15(long xid, short reportMirrorPorts) {
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnSetMirroring.Builder {
        final OFBsnSetMirroringVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnSetMirroringVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnSetMirroring> {
        @Override
        public OFBsnSetMirroring readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnSetMirroringVer15 bsnSetMirroringVer15 = new OFBsnSetMirroringVer15(
                    xid,
                      reportMirrorPorts
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSetMirroringVer15);
            return bsnSetMirroringVer15;
        }
    }
    ...
    final static OFBsnSetMirroringVer15Funnel FUNNEL = new OFBsnSetMirroringVer15Funnel();
    static class OFBsnSetMirroringVer15Funnel implements Funnel<OFBsnSetMirroringVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnSetMirroringVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnSetMirroringVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnSetMirroringVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnSetMirroringVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnSetMirroringVer15 other = (OFBsnSetMirroringVer15) obj;
