...
class OFGroupDescStatsReplyVer15 implements OFGroupDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupDescStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFGroupDescStatsReplyVer15 DEFAULT = new OFGroupDescStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFGroupDescStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFGroupDescStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFGroupDescStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFGroupDescStatsReplyVer15: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFGroupDescStatsReply.Builder {
        final OFGroupDescStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFGroupDescStatsReplyVer15 parentMessage) {
    ...
    public OFGroupDescStatsReply.Builder setEntries(List<OFGroupDescStatsEntry> entries) {
        ...
        public OFGroupDescStatsReply build() {
                ...
                //
                return new OFGroupDescStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFGroupDescStatsReply> {
        @Override
        public OFGroupDescStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFGroupDescStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFGroupDescStatsEntryVer15.READER);

            OFGroupDescStatsReplyVer15 groupDescStatsReplyVer15 = new OFGroupDescStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupDescStatsReplyVer15);
            return groupDescStatsReplyVer15;
        }
    }
    ...
    final static OFGroupDescStatsReplyVer15Funnel FUNNEL = new OFGroupDescStatsReplyVer15Funnel();
    static class OFGroupDescStatsReplyVer15Funnel implements Funnel<OFGroupDescStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupDescStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFGroupDescStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFGroupDescStatsReplyVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupDescStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupDescStatsReplyVer15 other = (OFGroupDescStatsReplyVer15) obj;
