...
//
    ...
    static class Reader implements OFMessageReader<OFGroupDescStatsReply> {
        ...
        public OFGroupDescStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFGroupDescStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFGroupDescStatsEntryVer15.READER);
    ...
    static class Writer implements OFMessageWriter<OFGroupDescStatsReplyVer15> {
        ...
        public void write(ByteBuf bb, OFGroupDescStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFGroupDescStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
