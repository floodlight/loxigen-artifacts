...
public class OFTableReasonSerializerVer15 {
    ...
    public static OFTableReason ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFTableReason in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFTableReason e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFTableReason in version 1.5: " + e);
        }
    }
