...
class OFTableFeaturePropWriteActionsMissVer15 implements OFTableFeaturePropWriteActionsMiss {
...
//
    ...
    final static OFTableFeaturePropWriteActionsMissVer15 DEFAULT = new OFTableFeaturePropWriteActionsMissVer15(
        DEFAULT_ACTION_IDS
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturePropWriteActionsMiss> {
        ...
        public OFTableFeaturePropWriteActionsMiss readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFTableFeaturePropWriteActionsMissVer15 tableFeaturePropWriteActionsMissVer15 = new OFTableFeaturePropWriteActionsMissVer15(
                    actionIds
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableFeaturePropWriteActionsMissVer15);
    ...
    final static OFTableFeaturePropWriteActionsMissVer15Funnel FUNNEL = new OFTableFeaturePropWriteActionsMissVer15Funnel();
    static class OFTableFeaturePropWriteActionsMissVer15Funnel implements Funnel<OFTableFeaturePropWriteActionsMissVer15> {
    ...
    static class Writer implements OFMessageWriter<OFTableFeaturePropWriteActionsMissVer15> {
        @Override
