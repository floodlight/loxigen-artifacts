...
class OFBsnTlvOuterSrcMacVer14 implements OFBsnTlvOuterSrcMac {
...
//
    ...
    final static OFBsnTlvOuterSrcMacVer14 DEFAULT = new OFBsnTlvOuterSrcMacVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvOuterSrcMac> {
        ...
        public OFBsnTlvOuterSrcMac readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvOuterSrcMacVer14 bsnTlvOuterSrcMacVer14 = new OFBsnTlvOuterSrcMacVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvOuterSrcMacVer14);
    ...
    final static OFBsnTlvOuterSrcMacVer14Funnel FUNNEL = new OFBsnTlvOuterSrcMacVer14Funnel();
    static class OFBsnTlvOuterSrcMacVer14Funnel implements Funnel<OFBsnTlvOuterSrcMacVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvOuterSrcMacVer14> {
        @Override
