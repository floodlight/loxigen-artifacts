...
class OFInstructionClearActionsVer15 implements OFInstructionClearActions {
...
//
    ...
    final static OFInstructionClearActionsVer15 DEFAULT = new OFInstructionClearActionsVer15(

    );

    final static OFInstructionClearActionsVer15 INSTANCE = new OFInstructionClearActionsVer15();
    ...
    final static OFInstructionClearActionsVer15Funnel FUNNEL = new OFInstructionClearActionsVer15Funnel();
    static class OFInstructionClearActionsVer15Funnel implements Funnel<OFInstructionClearActionsVer15> {
    ...
    static class Writer implements OFMessageWriter<OFInstructionClearActionsVer15> {
        @Override
