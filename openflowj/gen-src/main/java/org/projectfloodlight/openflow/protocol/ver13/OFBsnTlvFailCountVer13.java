...
class OFBsnTlvFailCountVer13 implements OFBsnTlvFailCount {
...
//
    ...
    final static OFBsnTlvFailCountVer13 DEFAULT = new OFBsnTlvFailCountVer13(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFBsnTlvFailCount.Builder {
    ...
    static class Builder implements OFBsnTlvFailCount.Builder {
        // OF message fields
        private boolean valueSet;
        private U64 value;
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvFailCount> {
        @Override
        public OFBsnTlvFailCount readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            if(bb.readableBytes() < LENGTH)
                return null;
            int start = bb.readerIndex();
            // fixed value property type == 0xc2
            ...
            OFBsnTlvFailCountVer13 bsnTlvFailCountVer13 = new OFBsnTlvFailCountVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvFailCountVer13);
    ...
    final static OFBsnTlvFailCountVer13Funnel FUNNEL = new OFBsnTlvFailCountVer13Funnel();
    static class OFBsnTlvFailCountVer13Funnel implements Funnel<OFBsnTlvFailCountVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvFailCountVer13 message, PrimitiveSink sink) {
            // fixed value property type = 0xc2
            sink.putShort((short) 0xc2);
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvFailCountVer13> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvFailCountVer13 message) {
            // fixed value property type = 0xc2
            bb.writeShort((short) 0xc2);
            // fixed value property length = 12
