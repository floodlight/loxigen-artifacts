...
class OFActionIdOutputVer15 implements OFActionIdOutput {
...
//
    ...
    final static OFActionIdOutputVer15 DEFAULT = new OFActionIdOutputVer15(

    );

    final static OFActionIdOutputVer15 INSTANCE = new OFActionIdOutputVer15();
    ...
    static class Reader extends AbstractOFMessageReader<OFActionIdOutput> {
        @Override
        public OFActionIdOutput readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
    ...
    final static OFActionIdOutputVer15Funnel FUNNEL = new OFActionIdOutputVer15Funnel();
    static class OFActionIdOutputVer15Funnel implements Funnel<OFActionIdOutputVer15> {
    ...
    static class Writer implements OFMessageWriter<OFActionIdOutputVer15> {
        @Override
