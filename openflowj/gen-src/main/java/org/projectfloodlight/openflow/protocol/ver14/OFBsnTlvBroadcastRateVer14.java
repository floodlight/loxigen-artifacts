...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvBroadcastRate> {
        @Override
        public OFBsnTlvBroadcastRate readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
