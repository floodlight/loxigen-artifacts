...
class OFOxmIpv4SrcMaskedVer15 implements OFOxmIpv4SrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv4SrcMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv4SrcMaskedVer15 DEFAULT = new OFOxmIpv4SrcMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv4SrcMaskedVer15(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv4SrcMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv4SrcMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IPv4Address> getCanonical() {
        if (IPv4Address.NO_MASK.equals(mask)) {
            return new OFOxmIpv4SrcVer15(value);
    ...
    static class BuilderWithParent implements OFOxmIpv4SrcMasked.Builder {
        final OFOxmIpv4SrcMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv4SrcMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv4SrcMasked> {
        ...
        public OFOxmIpv4SrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv4SrcMaskedVer15 oxmIpv4SrcMaskedVer15 = new OFOxmIpv4SrcMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv4SrcMaskedVer15);
            return oxmIpv4SrcMaskedVer15;
        }
    }
    ...
    final static OFOxmIpv4SrcMaskedVer15Funnel FUNNEL = new OFOxmIpv4SrcMaskedVer15Funnel();
    static class OFOxmIpv4SrcMaskedVer15Funnel implements Funnel<OFOxmIpv4SrcMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv4SrcMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001708L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv4SrcMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv4SrcMaskedVer15 message) {
            // fixed value property typeLen = 0x80001708L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv4SrcMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv4SrcMaskedVer15 other = (OFOxmIpv4SrcMaskedVer15) obj;
