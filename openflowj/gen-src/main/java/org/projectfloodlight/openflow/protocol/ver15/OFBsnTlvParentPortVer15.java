...
class OFBsnTlvParentPortVer15 implements OFBsnTlvParentPort {
...
//
    ...
    final static OFBsnTlvParentPortVer15 DEFAULT = new OFBsnTlvParentPortVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvParentPort> {
        ...
        public OFBsnTlvParentPort readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvParentPortVer15 bsnTlvParentPortVer15 = new OFBsnTlvParentPortVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvParentPortVer15);
    ...
    final static OFBsnTlvParentPortVer15Funnel FUNNEL = new OFBsnTlvParentPortVer15Funnel();
    static class OFBsnTlvParentPortVer15Funnel implements Funnel<OFBsnTlvParentPortVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvParentPortVer15> {
        @Override
