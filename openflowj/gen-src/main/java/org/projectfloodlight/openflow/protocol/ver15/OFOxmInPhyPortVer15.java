...
class OFOxmInPhyPortVer15 implements OFOxmInPhyPort {
...
//
    ...
    final static OFOxmInPhyPortVer15 DEFAULT = new OFOxmInPhyPortVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmInPhyPort> {
        ...
        public OFOxmInPhyPort readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmInPhyPortVer15 oxmInPhyPortVer15 = new OFOxmInPhyPortVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmInPhyPortVer15);
    ...
    final static OFOxmInPhyPortVer15Funnel FUNNEL = new OFOxmInPhyPortVer15Funnel();
    static class OFOxmInPhyPortVer15Funnel implements Funnel<OFOxmInPhyPortVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmInPhyPortVer15> {
        @Override
