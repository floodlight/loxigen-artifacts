...
public class OFBsnRateUnitSerializerVer15 {
    ...
    public static OFBsnRateUnit ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnRateUnit in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnRateUnit e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnRateUnit in version 1.5: " + e);
        }
    }
