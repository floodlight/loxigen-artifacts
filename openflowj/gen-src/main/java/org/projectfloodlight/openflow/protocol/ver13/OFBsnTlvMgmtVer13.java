...
class OFBsnTlvMgmtVer13 implements OFBsnTlvMgmt {
...
//
    ...
    final static OFBsnTlvMgmtVer13 DEFAULT = new OFBsnTlvMgmtVer13(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFBsnTlvMgmt.Builder {
    ...
    static class Builder implements OFBsnTlvMgmt.Builder {
        // OF message fields
        private boolean valueSet;
        private long value;
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvMgmt> {
        @Override
        public OFBsnTlvMgmt readFrom(ByteBuf bb) throws OFParseError {
            int start = bb.readerIndex();
            // fixed value property type == 0xd3
            ...
            OFBsnTlvMgmtVer13 bsnTlvMgmtVer13 = new OFBsnTlvMgmtVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvMgmtVer13);
    ...
    final static OFBsnTlvMgmtVer13Funnel FUNNEL = new OFBsnTlvMgmtVer13Funnel();
    static class OFBsnTlvMgmtVer13Funnel implements Funnel<OFBsnTlvMgmtVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvMgmtVer13 message, PrimitiveSink sink) {
            // fixed value property type = 0xd3
            sink.putShort((short) 0xd3);
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvMgmtVer13> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvMgmtVer13 message) {
            // fixed value property type = 0xd3
            bb.writeShort((short) 0xd3);
            // fixed value property length = 8
