...
class OFPortDescPropBsnDiagVer15 implements OFPortDescPropBsnDiag {
...
//
    ...
    static class Reader implements OFMessageReader<OFPortDescPropBsnDiag> {
        ...
        public OFPortDescPropBsnDiag readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", portDescPropBsnDiagVer15);
    ...
    final static OFPortDescPropBsnDiagVer15Funnel FUNNEL = new OFPortDescPropBsnDiagVer15Funnel();
    static class OFPortDescPropBsnDiagVer15Funnel implements Funnel<OFPortDescPropBsnDiagVer15> {
    ...
    static class Writer implements OFMessageWriter<OFPortDescPropBsnDiagVer15> {
        @Override
