...
class OFOxmArpShaVer15 implements OFOxmArpSha {
...
//
    ...
    final static OFOxmArpShaVer15 DEFAULT = new OFOxmArpShaVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmArpSha> {
        @Override
        public OFOxmArpSha readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmArpShaVer15 oxmArpShaVer15 = new OFOxmArpShaVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpShaVer15);
    ...
    final static OFOxmArpShaVer15Funnel FUNNEL = new OFOxmArpShaVer15Funnel();
    static class OFOxmArpShaVer15Funnel implements Funnel<OFOxmArpShaVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmArpShaVer15> {
        @Override
