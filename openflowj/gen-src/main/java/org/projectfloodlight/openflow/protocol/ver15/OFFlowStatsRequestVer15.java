...
class OFFlowStatsRequestVer15 implements OFFlowStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFFlowStatsRequestVer15 DEFAULT = new OFFlowStatsRequestVer15(
    ...
    OFFlowStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, TableId tableId, OFPort outPort, OFGroup outGroup, U64 cookie, U64 cookieMask, Match match) {
        if(flags == null) {
            throw new NullPointerException("OFFlowStatsRequestVer15: property flags cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowStatsRequestVer15: property tableId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowStatsRequestVer15: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowStatsRequestVer15: property outGroup cannot be null");
        }
        if(cookie == null) {
            throw new NullPointerException("OFFlowStatsRequestVer15: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowStatsRequestVer15: property cookieMask cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowStatsRequestVer15: property match cannot be null");
        }
    ...
    static class BuilderWithParent implements OFFlowStatsRequest.Builder {
        final OFFlowStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFFlowStatsRequestVer15 parentMessage) {
    ...
    public OFFlowStatsRequest.Builder setMatch(Match match) {
        ...
        public OFFlowStatsRequest build() {
                ...
                //
                return new OFFlowStatsRequestVer15(
                    xid,
                    flags,
                    tableId,
                    outPort,
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowStatsRequest> {
        ...
        public OFFlowStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFFlowStatsRequestVer15 flowStatsRequestVer15 = new OFFlowStatsRequestVer15(
                    xid,
                      flags,
                      tableId,
                      outPort,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowStatsRequestVer15);
            return flowStatsRequestVer15;
        }
    }
    ...
    final static OFFlowStatsRequestVer15Funnel FUNNEL = new OFFlowStatsRequestVer15Funnel();
    static class OFFlowStatsRequestVer15Funnel implements Funnel<OFFlowStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFFlowStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFFlowStatsRequestVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFFlowStatsRequestVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowStatsRequestVer15 other = (OFFlowStatsRequestVer15) obj;
