...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTableChecksumStatsReply> {
        @Override
        public OFBsnTableChecksumStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnTableChecksumStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnTableChecksumStatsEntryVer15.READER);
