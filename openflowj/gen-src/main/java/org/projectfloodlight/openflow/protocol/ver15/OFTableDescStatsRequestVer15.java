...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFTableDescStatsRequest> {
        @Override
        public OFTableDescStatsRequest readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
