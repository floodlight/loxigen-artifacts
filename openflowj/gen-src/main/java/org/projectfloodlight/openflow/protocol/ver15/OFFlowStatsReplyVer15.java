...
class OFFlowStatsReplyVer15 implements OFFlowStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFFlowStatsReplyVer15 DEFAULT = new OFFlowStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFFlowStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFFlowStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFFlowStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFFlowStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFFlowStatsReply.Builder {
        final OFFlowStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFFlowStatsReplyVer15 parentMessage) {
    ...
    public OFFlowStatsReply.Builder setEntries(List<OFFlowStatsEntry> entries) {
        ...
        public OFFlowStatsReply build() {
                ...
                //
                return new OFFlowStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowStatsReply> {
        ...
        public OFFlowStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFFlowStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFFlowStatsEntryVer15.READER);

            OFFlowStatsReplyVer15 flowStatsReplyVer15 = new OFFlowStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowStatsReplyVer15);
            return flowStatsReplyVer15;
        }
    }
    ...
    final static OFFlowStatsReplyVer15Funnel FUNNEL = new OFFlowStatsReplyVer15Funnel();
    static class OFFlowStatsReplyVer15Funnel implements Funnel<OFFlowStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFFlowStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFFlowStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFFlowStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowStatsReplyVer15 other = (OFFlowStatsReplyVer15) obj;
