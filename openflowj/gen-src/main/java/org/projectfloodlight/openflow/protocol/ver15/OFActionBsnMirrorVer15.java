...
class OFActionBsnMirrorVer15 implements OFActionBsnMirror {
    private static final Logger logger = LoggerFactory.getLogger(OFActionBsnMirrorVer15.class);
    // version: 1.5
...
//
    ...
    final static OFActionBsnMirrorVer15 DEFAULT = new OFActionBsnMirrorVer15(
        DEFAULT_DEST_PORT, DEFAULT_VLAN_TAG, DEFAULT_COPY_STAGE
    );

    // package private constructor - used by readers, builders, and factory
    OFActionBsnMirrorVer15(OFPort destPort, long vlanTag, short copyStage) {
        if(destPort == null) {
    ...
    static class BuilderWithParent implements OFActionBsnMirror.Builder {
        final OFActionBsnMirrorVer15 parentMessage;
        ...
        BuilderWithParent(OFActionBsnMirrorVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionBsnMirror build() {
                ...
                //
                return new OFActionBsnMirrorVer15(
                    destPort,
                    vlanTag,
                    copyStage
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionBsnMirror> {
        ...
        public OFActionBsnMirror readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionBsnMirrorVer15 actionBsnMirrorVer15 = new OFActionBsnMirrorVer15(
                    destPort,
                      vlanTag,
                      copyStage
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionBsnMirrorVer15);
            return actionBsnMirrorVer15;
        }
    }
    ...
    final static OFActionBsnMirrorVer15Funnel FUNNEL = new OFActionBsnMirrorVer15Funnel();
    static class OFActionBsnMirrorVer15Funnel implements Funnel<OFActionBsnMirrorVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionBsnMirrorVer15 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionBsnMirrorVer15> {
        @Override
        public void write(ByteBuf bb, OFActionBsnMirrorVer15 message) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionBsnMirrorVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionBsnMirrorVer15 other = (OFActionBsnMirrorVer15) obj;
