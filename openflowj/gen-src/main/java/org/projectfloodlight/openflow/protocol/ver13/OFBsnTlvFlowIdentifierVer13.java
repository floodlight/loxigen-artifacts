...
class OFBsnTlvFlowIdentifierVer13 implements OFBsnTlvFlowIdentifier {
...
//
    ...
    final static OFBsnTlvFlowIdentifierVer13 DEFAULT = new OFBsnTlvFlowIdentifierVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvFlowIdentifier> {
        ...
        public OFBsnTlvFlowIdentifier readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvFlowIdentifierVer13 bsnTlvFlowIdentifierVer13 = new OFBsnTlvFlowIdentifierVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvFlowIdentifierVer13);
    ...
    final static OFBsnTlvFlowIdentifierVer13Funnel FUNNEL = new OFBsnTlvFlowIdentifierVer13Funnel();
    static class OFBsnTlvFlowIdentifierVer13Funnel implements Funnel<OFBsnTlvFlowIdentifierVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvFlowIdentifierVer13> {
        @Override
