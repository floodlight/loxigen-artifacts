...
class OFOxmConnTrackingNwSrcVer12 implements OFOxmConnTrackingNwSrc {
...
//
    ...
    final static OFOxmConnTrackingNwSrcVer12 DEFAULT = new OFOxmConnTrackingNwSrcVer12(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConnTrackingNwSrc> {
        ...
        public OFOxmConnTrackingNwSrc readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingNwSrcVer12 oxmConnTrackingNwSrcVer12 = new OFOxmConnTrackingNwSrcVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingNwSrcVer12);
    ...
    final static OFOxmConnTrackingNwSrcVer12Funnel FUNNEL = new OFOxmConnTrackingNwSrcVer12Funnel();
    static class OFOxmConnTrackingNwSrcVer12Funnel implements Funnel<OFOxmConnTrackingNwSrcVer12> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingNwSrcVer12> {
        @Override
