...
class OFOxmEthDstMaskedVer15 implements OFOxmEthDstMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmEthDstMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmEthDstMaskedVer15 DEFAULT = new OFOxmEthDstMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmEthDstMaskedVer15(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmEthDstMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmEthDstMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmEthDstVer15(value);
    ...
    static class BuilderWithParent implements OFOxmEthDstMasked.Builder {
        final OFOxmEthDstMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmEthDstMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmEthDstMasked> {
        ...
        public OFOxmEthDstMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmEthDstMaskedVer15 oxmEthDstMaskedVer15 = new OFOxmEthDstMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmEthDstMaskedVer15);
            return oxmEthDstMaskedVer15;
        }
    }
    ...
    final static OFOxmEthDstMaskedVer15Funnel FUNNEL = new OFOxmEthDstMaskedVer15Funnel();
    static class OFOxmEthDstMaskedVer15Funnel implements Funnel<OFOxmEthDstMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmEthDstMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x8000070cL
    ...
    static class Writer implements OFMessageWriter<OFOxmEthDstMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmEthDstMaskedVer15 message) {
            // fixed value property typeLen = 0x8000070cL
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmEthDstMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmEthDstMaskedVer15 other = (OFOxmEthDstMaskedVer15) obj;
