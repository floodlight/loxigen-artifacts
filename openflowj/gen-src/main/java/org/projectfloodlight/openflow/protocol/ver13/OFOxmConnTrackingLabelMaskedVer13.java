...
class OFOxmConnTrackingLabelMaskedVer13 implements OFOxmConnTrackingLabelMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmConnTrackingLabelMaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmConnTrackingLabelMaskedVer13 DEFAULT = new OFOxmConnTrackingLabelMaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmConnTrackingLabelMaskedVer13(U128 value, U128 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmConnTrackingLabelMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmConnTrackingLabelMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U128> getCanonical() {
        if (U128.NO_MASK.equals(mask)) {
            return new OFOxmConnTrackingLabelVer13(value);
    ...
    static class BuilderWithParent implements OFOxmConnTrackingLabelMasked.Builder {
        final OFOxmConnTrackingLabelMaskedVer13 parentMessage;
        ...
        BuilderWithParent(OFOxmConnTrackingLabelMaskedVer13 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmConnTrackingLabelMasked> {
        ...
        public OFOxmConnTrackingLabelMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingLabelMaskedVer13 oxmConnTrackingLabelMaskedVer13 = new OFOxmConnTrackingLabelMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingLabelMaskedVer13);
            return oxmConnTrackingLabelMaskedVer13;
        }
    }
    ...
    final static OFOxmConnTrackingLabelMaskedVer13Funnel FUNNEL = new OFOxmConnTrackingLabelMaskedVer13Funnel();
    static class OFOxmConnTrackingLabelMaskedVer13Funnel implements Funnel<OFOxmConnTrackingLabelMaskedVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmConnTrackingLabelMaskedVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x1d920L
            sink.putInt(0x1d920);
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingLabelMaskedVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmConnTrackingLabelMaskedVer13 message) {
            // fixed value property typeLen = 0x1d920L
            bb.writeInt(0x1d920);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmConnTrackingLabelMaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmConnTrackingLabelMaskedVer13 other = (OFOxmConnTrackingLabelMaskedVer13) obj;
