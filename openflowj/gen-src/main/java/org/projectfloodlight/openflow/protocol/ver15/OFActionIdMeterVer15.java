...
class OFActionIdMeterVer15 implements OFActionIdMeter {
...
//
    ...
    final static OFActionIdMeterVer15 DEFAULT = new OFActionIdMeterVer15(

    );

    final static OFActionIdMeterVer15 INSTANCE = new OFActionIdMeterVer15();
    ...
    static class Reader extends AbstractOFMessageReader<OFActionIdMeter> {
        @Override
        public OFActionIdMeter readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
    ...
    final static OFActionIdMeterVer15Funnel FUNNEL = new OFActionIdMeterVer15Funnel();
    static class OFActionIdMeterVer15Funnel implements Funnel<OFActionIdMeterVer15> {
    ...
    static class Writer implements OFMessageWriter<OFActionIdMeterVer15> {
        @Override
