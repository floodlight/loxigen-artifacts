...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFAsyncConfigPropContStatusMaster> {
        @Override
        public OFAsyncConfigPropContStatusMaster readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
