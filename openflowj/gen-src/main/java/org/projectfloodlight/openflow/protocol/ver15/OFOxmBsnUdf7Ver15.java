...
class OFOxmBsnUdf7Ver15 implements OFOxmBsnUdf7 {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnUdf7Ver15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnUdf7Ver15 DEFAULT = new OFOxmBsnUdf7Ver15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnUdf7Ver15(UDF value) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnUdf7Ver15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnUdf7.Builder {
        final OFOxmBsnUdf7Ver15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private UDF value;

        BuilderWithParent(OFOxmBsnUdf7Ver15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnUdf7> {
        ...
        public OFOxmBsnUdf7 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnUdf7Ver15 oxmBsnUdf7Ver15 = new OFOxmBsnUdf7Ver15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnUdf7Ver15);
            return oxmBsnUdf7Ver15;
        }
    }
    ...
    final static OFOxmBsnUdf7Ver15Funnel FUNNEL = new OFOxmBsnUdf7Ver15Funnel();
    static class OFOxmBsnUdf7Ver15Funnel implements Funnel<OFOxmBsnUdf7Ver15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnUdf7Ver15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x31e04L
            sink.putInt(0x31e04);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnUdf7Ver15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnUdf7Ver15 message) {
            // fixed value property typeLen = 0x31e04L
            bb.writeInt(0x31e04);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnUdf7Ver15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnUdf7Ver15 other = (OFOxmBsnUdf7Ver15) obj;
