...
class OFAsyncConfigPropPortStatusSlaveVer15 implements OFAsyncConfigPropPortStatusSlave {
...
//
    ...
    final static OFAsyncConfigPropPortStatusSlaveVer15 DEFAULT = new OFAsyncConfigPropPortStatusSlaveVer15(
        DEFAULT_MASK
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFAsyncConfigPropPortStatusSlave> {
        @Override
        public OFAsyncConfigPropPortStatusSlave readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFAsyncConfigPropPortStatusSlaveVer15 asyncConfigPropPortStatusSlaveVer15 = new OFAsyncConfigPropPortStatusSlaveVer15(
                    mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", asyncConfigPropPortStatusSlaveVer15);
    ...
    final static OFAsyncConfigPropPortStatusSlaveVer15Funnel FUNNEL = new OFAsyncConfigPropPortStatusSlaveVer15Funnel();
    static class OFAsyncConfigPropPortStatusSlaveVer15Funnel implements Funnel<OFAsyncConfigPropPortStatusSlaveVer15> {
    ...
    static class Writer implements OFMessageWriter<OFAsyncConfigPropPortStatusSlaveVer15> {
        @Override
