...
public class OFBsnVlanCounterSerializerVer15 {
    ...
    public static OFBsnVlanCounter ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnVlanCounter in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnVlanCounter e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnVlanCounter in version 1.5: " + e);
        }
    }
