...
class OFOxmBsnL3SrcClassIdMaskedVer15 implements OFOxmBsnL3SrcClassIdMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnL3SrcClassIdMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnL3SrcClassIdMaskedVer15 DEFAULT = new OFOxmBsnL3SrcClassIdMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnL3SrcClassIdMaskedVer15(ClassId value, ClassId mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnL3SrcClassIdMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnL3SrcClassIdMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<ClassId> getCanonical() {
        if (ClassId.NO_MASK.equals(mask)) {
            return new OFOxmBsnL3SrcClassIdVer15(value);
    ...
    static class BuilderWithParent implements OFOxmBsnL3SrcClassIdMasked.Builder {
        final OFOxmBsnL3SrcClassIdMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnL3SrcClassIdMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnL3SrcClassIdMasked> {
        ...
        public OFOxmBsnL3SrcClassIdMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnL3SrcClassIdMaskedVer15 oxmBsnL3SrcClassIdMaskedVer15 = new OFOxmBsnL3SrcClassIdMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnL3SrcClassIdMaskedVer15);
            return oxmBsnL3SrcClassIdMaskedVer15;
        }
    }
    ...
    final static OFOxmBsnL3SrcClassIdMaskedVer15Funnel FUNNEL = new OFOxmBsnL3SrcClassIdMaskedVer15Funnel();
    static class OFOxmBsnL3SrcClassIdMaskedVer15Funnel implements Funnel<OFOxmBsnL3SrcClassIdMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnL3SrcClassIdMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x30b08L
            sink.putInt(0x30b08);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnL3SrcClassIdMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnL3SrcClassIdMaskedVer15 message) {
            // fixed value property typeLen = 0x30b08L
            bb.writeInt(0x30b08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnL3SrcClassIdMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnL3SrcClassIdMaskedVer15 other = (OFOxmBsnL3SrcClassIdMaskedVer15) obj;
