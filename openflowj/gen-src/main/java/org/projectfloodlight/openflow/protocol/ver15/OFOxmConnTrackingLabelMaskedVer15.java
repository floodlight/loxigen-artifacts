...
class OFOxmConnTrackingLabelMaskedVer15 implements OFOxmConnTrackingLabelMasked {
...
//
    ...
    final static OFOxmConnTrackingLabelMaskedVer15 DEFAULT = new OFOxmConnTrackingLabelMaskedVer15(
    ...
    public OFOxm<U128> getCanonical() {
        if (U128.NO_MASK.equals(mask)) {
            return new OFOxmConnTrackingLabelVer15(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConnTrackingLabelMasked> {
        ...
        public OFOxmConnTrackingLabelMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingLabelMaskedVer15 oxmConnTrackingLabelMaskedVer15 = new OFOxmConnTrackingLabelMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingLabelMaskedVer15);
    ...
    final static OFOxmConnTrackingLabelMaskedVer15Funnel FUNNEL = new OFOxmConnTrackingLabelMaskedVer15Funnel();
