...
class OFOxmBsnUdf6MaskedVer15 implements OFOxmBsnUdf6Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnUdf6MaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnUdf6MaskedVer15 DEFAULT = new OFOxmBsnUdf6MaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnUdf6MaskedVer15(UDF value, UDF mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnUdf6MaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnUdf6MaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<UDF> getCanonical() {
        if (UDF.NO_MASK.equals(mask)) {
            return new OFOxmBsnUdf6Ver15(value);
    ...
    static class BuilderWithParent implements OFOxmBsnUdf6Masked.Builder {
        final OFOxmBsnUdf6MaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnUdf6MaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnUdf6Masked> {
        ...
        public OFOxmBsnUdf6Masked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnUdf6MaskedVer15 oxmBsnUdf6MaskedVer15 = new OFOxmBsnUdf6MaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnUdf6MaskedVer15);
            return oxmBsnUdf6MaskedVer15;
        }
    }
    ...
    final static OFOxmBsnUdf6MaskedVer15Funnel FUNNEL = new OFOxmBsnUdf6MaskedVer15Funnel();
    static class OFOxmBsnUdf6MaskedVer15Funnel implements Funnel<OFOxmBsnUdf6MaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnUdf6MaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x31d08L
            sink.putInt(0x31d08);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnUdf6MaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnUdf6MaskedVer15 message) {
            // fixed value property typeLen = 0x31d08L
            bb.writeInt(0x31d08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnUdf6MaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnUdf6MaskedVer15 other = (OFOxmBsnUdf6MaskedVer15) obj;
