...
class OFBsnVlanCounterStatsEntryVer15 implements OFBsnVlanCounterStatsEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVlanCounterStatsEntryVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnVlanCounterStatsEntryVer15 DEFAULT = new OFBsnVlanCounterStatsEntryVer15(
        DEFAULT_VLAN_VID, DEFAULT_VALUES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnVlanCounterStatsEntryVer15(int vlanVid, List<U64> values) {
        if(values == null) {
    ...
    static class BuilderWithParent implements OFBsnVlanCounterStatsEntry.Builder {
        final OFBsnVlanCounterStatsEntryVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnVlanCounterStatsEntryVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVlanCounterStatsEntry> {
        ...
        public OFBsnVlanCounterStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVlanCounterStatsEntryVer15);
            return bsnVlanCounterStatsEntryVer15;
        }
    }
    ...
    final static OFBsnVlanCounterStatsEntryVer15Funnel FUNNEL = new OFBsnVlanCounterStatsEntryVer15Funnel();
    static class OFBsnVlanCounterStatsEntryVer15Funnel implements Funnel<OFBsnVlanCounterStatsEntryVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVlanCounterStatsEntryVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFBsnVlanCounterStatsEntryVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnVlanCounterStatsEntryVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnVlanCounterStatsEntryVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVlanCounterStatsEntryVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVlanCounterStatsEntryVer15 other = (OFBsnVlanCounterStatsEntryVer15) obj;
