...
class OFOxmBsnVrfMaskedVer15 implements OFOxmBsnVrfMasked {
...
//
    ...
    final static OFOxmBsnVrfMaskedVer15 DEFAULT = new OFOxmBsnVrfMaskedVer15(
    ...
    public OFOxm<VRF> getCanonical() {
        if (VRF.NO_MASK.equals(mask)) {
            return new OFOxmBsnVrfVer15(value);
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmBsnVrfMasked> {
        @Override
        public OFOxmBsnVrfMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnVrfMaskedVer15 oxmBsnVrfMaskedVer15 = new OFOxmBsnVrfMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnVrfMaskedVer15);
    ...
    final static OFOxmBsnVrfMaskedVer15Funnel FUNNEL = new OFOxmBsnVrfMaskedVer15Funnel();
