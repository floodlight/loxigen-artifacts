...
class OFFlowModifyVer15 implements OFFlowModify {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowModifyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFFlowModifyVer15 DEFAULT = new OFFlowModifyVer15(
    ...
    OFFlowModifyVer15(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, int importance, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowModifyVer15: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowModifyVer15: property cookieMask cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowModifyVer15: property tableId cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowModifyVer15: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowModifyVer15: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowModifyVer15: property outGroup cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowModifyVer15: property flags cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowModifyVer15: property match cannot be null");
        }
        if(instructions == null) {
            throw new NullPointerException("OFFlowModifyVer15: property instructions cannot be null");
        }
        this.xid = xid;
        this.cookie = cookie;
    ...
    static class BuilderWithParent implements OFFlowModify.Builder {
        final OFFlowModifyVer15 parentMessage;
        ...
        BuilderWithParent(OFFlowModifyVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFFlowModify> {
        ...
        public OFFlowModify readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFFlowModifyVer15 flowModifyVer15 = new OFFlowModifyVer15(
                    xid,
                      cookie,
                      cookieMask,
                      tableId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowModifyVer15);
            return flowModifyVer15;
        }
    }
    ...
    final static OFFlowModifyVer15Funnel FUNNEL = new OFFlowModifyVer15Funnel();
    static class OFFlowModifyVer15Funnel implements Funnel<OFFlowModifyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowModifyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFFlowModifyVer15> {
        @Override
        public void write(ByteBuf bb, OFFlowModifyVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowModifyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowModifyVer15 other = (OFFlowModifyVer15) obj;
