...
class OFBsnVportQInQVer15 implements OFBsnVportQInQ {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVportQInQVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnVportQInQVer15 DEFAULT = new OFBsnVportQInQVer15(
    ...
    OFBsnVportQInQVer15(long portNo, int ingressTpid, int ingressVlanId, int egressTpid, int egressVlanId, String ifName) {
        if(ifName == null) {
    ...
    static class BuilderWithParent implements OFBsnVportQInQ.Builder {
        final OFBsnVportQInQVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnVportQInQVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnVportQInQ build() {
                ...
                //
                return new OFBsnVportQInQVer15(
                    portNo,
                    ingressTpid,
                    ingressVlanId,
                    egressTpid,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVportQInQ> {
        ...
        public OFBsnVportQInQ readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnVportQInQVer15 bsnVportQInQVer15 = new OFBsnVportQInQVer15(
                    portNo,
                      ingressTpid,
                      ingressVlanId,
                      egressTpid,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVportQInQVer15);
            return bsnVportQInQVer15;
        }
    }
    ...
    final static OFBsnVportQInQVer15Funnel FUNNEL = new OFBsnVportQInQVer15Funnel();
    static class OFBsnVportQInQVer15Funnel implements Funnel<OFBsnVportQInQVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVportQInQVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0x0
    ...
    static class Writer implements OFMessageWriter<OFBsnVportQInQVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnVportQInQVer15 message) {
            // fixed value property type = 0x0
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVportQInQVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVportQInQVer15 other = (OFBsnVportQInQVer15) obj;
