    ...
    static class Reader implements OFMessageReader<OFOxs<?>> {
        ...
        public OFOxs<?> readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(typeLen) {
               ...
               case (int) 0x80020910:
                   // discriminator value 0x80020910L=0x80020910L for class OFOxsByteCountMaskedVer15
                   return OFOxsByteCountMaskedVer15.READER.readFrom(bb);
               case (int) 0x80020008:
                   // discriminator value 0x80020008L=0x80020008L for class OFOxsDurationVer15
                   return OFOxsDurationVer15.READER.readFrom(bb);
               case (int) 0x80020110:
                   // discriminator value 0x80020110L=0x80020110L for class OFOxsDurationMaskedVer15
                   return OFOxsDurationMaskedVer15.READER.readFrom(bb);
               case (int) 0x80020404:
                   // discriminator value 0x80020404L=0x80020404L for class OFOxsFlowCountVer15
                   return OFOxsFlowCountVer15.READER.readFrom(bb);
               case (int) 0x80020508:
                   // discriminator value 0x80020508L=0x80020508L for class OFOxsFlowCountMaskedVer15
                   return OFOxsFlowCountMaskedVer15.READER.readFrom(bb);
               case (int) 0x80020208:
                   // discriminator value 0x80020208L=0x80020208L for class OFOxsIdleTimeVer15
                   return OFOxsIdleTimeVer15.READER.readFrom(bb);
               case (int) 0x80020310:
                   // discriminator value 0x80020310L=0x80020310L for class OFOxsIdleTimeMaskedVer15
                   return OFOxsIdleTimeMaskedVer15.READER.readFrom(bb);
               case (int) 0x80020608:
               ...
               case (int) 0x80020710:
                   // discriminator value 0x80020710L=0x80020710L for class OFOxsPacketCountMaskedVer15
                   return OFOxsPacketCountMaskedVer15.READER.readFrom(bb);
               default:
