...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnDebugCounterDescStatsReply> {
        @Override
        public OFBsnDebugCounterDescStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnDebugCounterDescStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnDebugCounterDescStatsEntryVer14.READER);
