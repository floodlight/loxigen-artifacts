...
public class OFBadPropertyCodeSerializerVer15 {
    ...
    public static OFBadPropertyCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBadPropertyCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBadPropertyCode e) {
        switch(e) {
            ...
            case EPERM:
                return EPERM_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBadPropertyCode in version 1.5: " + e);
        }
    }
