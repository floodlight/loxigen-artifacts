...
class OFAggregateStatsRequestVer15 implements OFAggregateStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFAggregateStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFAggregateStatsRequestVer15 DEFAULT = new OFAggregateStatsRequestVer15(
    ...
    OFAggregateStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, TableId tableId, OFPort outPort, OFGroup outGroup, U64 cookie, U64 cookieMask, Match match) {
        if(flags == null) {
            throw new NullPointerException("OFAggregateStatsRequestVer15: property flags cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFAggregateStatsRequestVer15: property tableId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFAggregateStatsRequestVer15: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFAggregateStatsRequestVer15: property outGroup cannot be null");
        }
        if(cookie == null) {
            throw new NullPointerException("OFAggregateStatsRequestVer15: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFAggregateStatsRequestVer15: property cookieMask cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFAggregateStatsRequestVer15: property match cannot be null");
        }
    ...
    static class BuilderWithParent implements OFAggregateStatsRequest.Builder {
        final OFAggregateStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFAggregateStatsRequestVer15 parentMessage) {
    ...
    public OFAggregateStatsRequest.Builder setMatch(Match match) {
        ...
        public OFAggregateStatsRequest build() {
                ...
                //
                return new OFAggregateStatsRequestVer15(
                    xid,
                    flags,
                    tableId,
                    outPort,
...
//
    ...
    static class Reader implements OFMessageReader<OFAggregateStatsRequest> {
        ...
        public OFAggregateStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFAggregateStatsRequestVer15 aggregateStatsRequestVer15 = new OFAggregateStatsRequestVer15(
                    xid,
                      flags,
                      tableId,
                      outPort,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", aggregateStatsRequestVer15);
            return aggregateStatsRequestVer15;
        }
    }
    ...
    final static OFAggregateStatsRequestVer15Funnel FUNNEL = new OFAggregateStatsRequestVer15Funnel();
    static class OFAggregateStatsRequestVer15Funnel implements Funnel<OFAggregateStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFAggregateStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFAggregateStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFAggregateStatsRequestVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFAggregateStatsRequestVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFAggregateStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFAggregateStatsRequestVer15 other = (OFAggregateStatsRequestVer15) obj;
