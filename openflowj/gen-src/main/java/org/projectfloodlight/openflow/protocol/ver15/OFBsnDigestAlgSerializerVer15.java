...
public class OFBsnDigestAlgSerializerVer15 {
    ...
    public static OFBsnDigestAlg ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnDigestAlg in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnDigestAlg e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnDigestAlg in version 1.5: " + e);
        }
    }
