...
class OFOxmTunnelIpv4DstVer15 implements OFOxmTunnelIpv4Dst {
...
//
    ...
    final static OFOxmTunnelIpv4DstVer15 DEFAULT = new OFOxmTunnelIpv4DstVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmTunnelIpv4Dst> {
        @Override
        public OFOxmTunnelIpv4Dst readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunnelIpv4DstVer15 oxmTunnelIpv4DstVer15 = new OFOxmTunnelIpv4DstVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunnelIpv4DstVer15);
    ...
    final static OFOxmTunnelIpv4DstVer15Funnel FUNNEL = new OFOxmTunnelIpv4DstVer15Funnel();
    static class OFOxmTunnelIpv4DstVer15Funnel implements Funnel<OFOxmTunnelIpv4DstVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmTunnelIpv4DstVer15> {
        @Override
