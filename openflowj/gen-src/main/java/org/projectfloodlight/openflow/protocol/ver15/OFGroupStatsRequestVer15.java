...
class OFGroupStatsRequestVer15 implements OFGroupStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFGroupStatsRequestVer15 DEFAULT = new OFGroupStatsRequestVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_GROUP_ID
    );

    // package private constructor - used by readers, builders, and factory
    OFGroupStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, OFGroup group) {
        if(flags == null) {
            throw new NullPointerException("OFGroupStatsRequestVer15: property flags cannot be null");
        }
        if(group == null) {
            throw new NullPointerException("OFGroupStatsRequestVer15: property group cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
        this.group = group;
    ...
    static class BuilderWithParent implements OFGroupStatsRequest.Builder {
        final OFGroupStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFGroupStatsRequestVer15 parentMessage) {
    ...
    public OFGroupStatsRequest.Builder setGroup(OFGroup group) {
        ...
        public OFGroupStatsRequest build() {
                ...
                //
                return new OFGroupStatsRequestVer15(
                    xid,
                    flags,
                    group
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupStatsRequest> {
        ...
        public OFGroupStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFGroupStatsRequestVer15 groupStatsRequestVer15 = new OFGroupStatsRequestVer15(
                    xid,
                      flags,
                      group
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupStatsRequestVer15);
            return groupStatsRequestVer15;
        }
    }
    ...
    final static OFGroupStatsRequestVer15Funnel FUNNEL = new OFGroupStatsRequestVer15Funnel();
    static class OFGroupStatsRequestVer15Funnel implements Funnel<OFGroupStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFGroupStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFGroupStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupStatsRequestVer15 other = (OFGroupStatsRequestVer15) obj;
