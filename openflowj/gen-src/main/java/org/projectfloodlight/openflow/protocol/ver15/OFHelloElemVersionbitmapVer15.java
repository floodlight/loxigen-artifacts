...
class OFHelloElemVersionbitmapVer15 implements OFHelloElemVersionbitmap {
...
//
    ...
    final static OFHelloElemVersionbitmapVer15 DEFAULT = new OFHelloElemVersionbitmapVer15(
        DEFAULT_BITMAPS
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFHelloElemVersionbitmap> {
        @Override
        public OFHelloElemVersionbitmap readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<U32> bitmaps = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), U32.READER);

            OFHelloElemVersionbitmapVer15 helloElemVersionbitmapVer15 = new OFHelloElemVersionbitmapVer15(
                    bitmaps
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", helloElemVersionbitmapVer15);
    ...
    final static OFHelloElemVersionbitmapVer15Funnel FUNNEL = new OFHelloElemVersionbitmapVer15Funnel();
    static class OFHelloElemVersionbitmapVer15Funnel implements Funnel<OFHelloElemVersionbitmapVer15> {
    ...
    static class Writer implements OFMessageWriter<OFHelloElemVersionbitmapVer15> {
        @Override
