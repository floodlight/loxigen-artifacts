...
class OFRoleRequestFailedErrorMsgVer15 implements OFRoleRequestFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFRoleRequestFailedErrorMsgVer15.class);
    // version: 1.5
...
//
    ...
    OFRoleRequestFailedErrorMsgVer15(long xid, OFRoleRequestFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFRoleRequestFailedErrorMsgVer15: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFRoleRequestFailedErrorMsgVer15: property data cannot be null");
        }
    ...
    static class BuilderWithParent implements OFRoleRequestFailedErrorMsg.Builder {
        final OFRoleRequestFailedErrorMsgVer15 parentMessage;
        ...
        BuilderWithParent(OFRoleRequestFailedErrorMsgVer15 parentMessage) {
    ...
    public OFRoleRequestFailedErrorMsg.Builder setXid(long xid) {
        ...
        public OFRoleRequestFailedErrorMsg build() {
                ...
                //
                return new OFRoleRequestFailedErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFRoleRequestFailedErrorMsg> {
        ...
        public OFRoleRequestFailedErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFRoleRequestFailedCode code = OFRoleRequestFailedCodeSerializerVer15.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_15);

            OFRoleRequestFailedErrorMsgVer15 roleRequestFailedErrorMsgVer15 = new OFRoleRequestFailedErrorMsgVer15(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", roleRequestFailedErrorMsgVer15);
            return roleRequestFailedErrorMsgVer15;
        }
    }
    ...
    final static OFRoleRequestFailedErrorMsgVer15Funnel FUNNEL = new OFRoleRequestFailedErrorMsgVer15Funnel();
    static class OFRoleRequestFailedErrorMsgVer15Funnel implements Funnel<OFRoleRequestFailedErrorMsgVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFRoleRequestFailedErrorMsgVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFRoleRequestFailedCodeSerializerVer15.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFRoleRequestFailedErrorMsgVer15> {
        @Override
        public void write(ByteBuf bb, OFRoleRequestFailedErrorMsgVer15 message) {
            ...
            OFRoleRequestFailedCodeSerializerVer15.writeTo(bb, message.code);
            message.data.writeTo(bb);

            // update length field
            int length = bb.writerIndex() - startIndex;
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFRoleRequestFailedErrorMsgVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFRoleRequestFailedErrorMsgVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFRoleRequestFailedErrorMsgVer15 other = (OFRoleRequestFailedErrorMsgVer15) obj;
