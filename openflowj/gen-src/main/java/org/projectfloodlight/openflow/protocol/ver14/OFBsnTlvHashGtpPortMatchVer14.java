...
class OFBsnTlvHashGtpPortMatchVer14 implements OFBsnTlvHashGtpPortMatch {
...
//
    ...
    OFBsnTlvHashGtpPortMatchVer14(OFBsnHashGtpPortMatch match, int srcPort, int dstPort) {
        if(match == null) {
    ...
    static class BuilderWithParent implements OFBsnTlvHashGtpPortMatch.Builder {
        ...
        BuilderWithParent(OFBsnTlvHashGtpPortMatchVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnTlvHashGtpPortMatch build() {
                ...
                //
                return new OFBsnTlvHashGtpPortMatchVer14(
                    match,
                    srcPort,
                    dstPort
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvHashGtpPortMatch> {
        ...
        public OFBsnTlvHashGtpPortMatch readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnHashGtpPortMatch match = OFBsnHashGtpPortMatchSerializerVer14.readFrom(bb);
            int srcPort = U16.f(bb.readShort());
            int dstPort = U16.f(bb.readShort());

            OFBsnTlvHashGtpPortMatchVer14 bsnTlvHashGtpPortMatchVer14 = new OFBsnTlvHashGtpPortMatchVer14(
                    match,
                      srcPort,
                      dstPort
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvHashGtpPortMatchVer14);
            return bsnTlvHashGtpPortMatchVer14;
        }
    }
    ...
    final static OFBsnTlvHashGtpPortMatchVer14Funnel FUNNEL = new OFBsnTlvHashGtpPortMatchVer14Funnel();
    static class OFBsnTlvHashGtpPortMatchVer14Funnel implements Funnel<OFBsnTlvHashGtpPortMatchVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvHashGtpPortMatchVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0x69
            sink.putShort((short) 0x69);
            // fixed value property length = 9
            sink.putShort((short) 0x9);
            OFBsnHashGtpPortMatchSerializerVer14.putTo(message.match, sink);
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvHashGtpPortMatchVer14> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvHashGtpPortMatchVer14 message) {
            // fixed value property type = 0x69
            bb.writeShort((short) 0x69);
            // fixed value property length = 9
            bb.writeShort((short) 0x9);
            OFBsnHashGtpPortMatchSerializerVer14.writeTo(bb, message.match);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTlvHashGtpPortMatchVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTlvHashGtpPortMatchVer14 other = (OFBsnTlvHashGtpPortMatchVer14) obj;
