...
class OFOxmArpTpaMaskedVer15 implements OFOxmArpTpaMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmArpTpaMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmArpTpaMaskedVer15 DEFAULT = new OFOxmArpTpaMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmArpTpaMaskedVer15(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmArpTpaMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmArpTpaMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmArpTpaMasked.Builder {
        final OFOxmArpTpaMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmArpTpaMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmArpTpaMasked> {
        ...
        public OFOxmArpTpaMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmArpTpaMaskedVer15 oxmArpTpaMaskedVer15 = new OFOxmArpTpaMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpTpaMaskedVer15);
            return oxmArpTpaMaskedVer15;
        }
    }
    ...
    final static OFOxmArpTpaMaskedVer15Funnel FUNNEL = new OFOxmArpTpaMaskedVer15Funnel();
    static class OFOxmArpTpaMaskedVer15Funnel implements Funnel<OFOxmArpTpaMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmArpTpaMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002f08L
    ...
    static class Writer implements OFMessageWriter<OFOxmArpTpaMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmArpTpaMaskedVer15 message) {
            // fixed value property typeLen = 0x80002f08L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmArpTpaMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmArpTpaMaskedVer15 other = (OFOxmArpTpaMaskedVer15) obj;
