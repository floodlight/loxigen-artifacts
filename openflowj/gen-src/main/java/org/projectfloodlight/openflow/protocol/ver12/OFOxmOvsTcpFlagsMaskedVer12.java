...
class OFOxmOvsTcpFlagsMaskedVer12 implements OFOxmOvsTcpFlagsMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmOvsTcpFlagsMaskedVer12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmOvsTcpFlagsMaskedVer12 DEFAULT = new OFOxmOvsTcpFlagsMaskedVer12(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmOvsTcpFlagsMaskedVer12(U16 value, U16 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmOvsTcpFlagsMaskedVer12: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmOvsTcpFlagsMaskedVer12: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U16> getCanonical() {
        if (U16.NO_MASK.equals(mask)) {
            return new OFOxmOvsTcpFlagsVer12(value);
    ...
    static class BuilderWithParent implements OFOxmOvsTcpFlagsMasked.Builder {
        final OFOxmOvsTcpFlagsMaskedVer12 parentMessage;
        ...
        BuilderWithParent(OFOxmOvsTcpFlagsMaskedVer12 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmOvsTcpFlagsMasked> {
        @Override
        public OFOxmOvsTcpFlagsMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmOvsTcpFlagsMaskedVer12 oxmOvsTcpFlagsMaskedVer12 = new OFOxmOvsTcpFlagsMaskedVer12(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmOvsTcpFlagsMaskedVer12);
            return oxmOvsTcpFlagsMaskedVer12;
        }
    }
    ...
    final static OFOxmOvsTcpFlagsMaskedVer12Funnel FUNNEL = new OFOxmOvsTcpFlagsMaskedVer12Funnel();
    static class OFOxmOvsTcpFlagsMaskedVer12Funnel implements Funnel<OFOxmOvsTcpFlagsMaskedVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmOvsTcpFlagsMaskedVer12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0xffff5508L
    ...
    static class Writer implements OFMessageWriter<OFOxmOvsTcpFlagsMaskedVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmOvsTcpFlagsMaskedVer12 message) {
            // fixed value property typeLen = 0xffff5508L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmOvsTcpFlagsMaskedVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmOvsTcpFlagsMaskedVer12 other = (OFOxmOvsTcpFlagsMaskedVer12) obj;
