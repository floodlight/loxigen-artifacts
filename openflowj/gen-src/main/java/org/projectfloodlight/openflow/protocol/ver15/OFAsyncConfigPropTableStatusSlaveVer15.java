...
class OFAsyncConfigPropTableStatusSlaveVer15 implements OFAsyncConfigPropTableStatusSlave {
...
//
    ...
    final static OFAsyncConfigPropTableStatusSlaveVer15 DEFAULT = new OFAsyncConfigPropTableStatusSlaveVer15(
        DEFAULT_MASK
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFAsyncConfigPropTableStatusSlave> {
        @Override
        public OFAsyncConfigPropTableStatusSlave readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFAsyncConfigPropTableStatusSlaveVer15 asyncConfigPropTableStatusSlaveVer15 = new OFAsyncConfigPropTableStatusSlaveVer15(
                    mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", asyncConfigPropTableStatusSlaveVer15);
    ...
    final static OFAsyncConfigPropTableStatusSlaveVer15Funnel FUNNEL = new OFAsyncConfigPropTableStatusSlaveVer15Funnel();
    static class OFAsyncConfigPropTableStatusSlaveVer15Funnel implements Funnel<OFAsyncConfigPropTableStatusSlaveVer15> {
    ...
    static class Writer implements OFMessageWriter<OFAsyncConfigPropTableStatusSlaveVer15> {
        @Override
