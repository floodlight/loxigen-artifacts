...
class OFBsnTlvApplyBytesVer14 implements OFBsnTlvApplyBytes {
...
//
    ...
    final static OFBsnTlvApplyBytesVer14 DEFAULT = new OFBsnTlvApplyBytesVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvApplyBytes> {
        ...
        public OFBsnTlvApplyBytes readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvApplyBytesVer14 bsnTlvApplyBytesVer14 = new OFBsnTlvApplyBytesVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvApplyBytesVer14);
    ...
    final static OFBsnTlvApplyBytesVer14Funnel FUNNEL = new OFBsnTlvApplyBytesVer14Funnel();
    static class OFBsnTlvApplyBytesVer14Funnel implements Funnel<OFBsnTlvApplyBytesVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvApplyBytesVer14> {
        @Override
