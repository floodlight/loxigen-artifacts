...
//
    ...
    OFGroupRemoveBucketVer15(long xid, OFGroupType groupType, OFGroup group, OFGroupBucket commandBucketId, List<OFBucket> buckets, List<OFGroupProp> properties) {
        if(groupType == null) {
    ...
    @Override
    public OFGroupRemoveBucket.Builder setBuckets(List<OFBucket> buckets) {
        this.buckets = buckets;
    ...
    @Override
    public OFGroupRemoveBucket.Builder setProperties(List<OFGroupProp> properties) {
        this.properties = properties;
...
//
    ...
    static class OFGroupRemoveBucketVer15Funnel implements Funnel<OFGroupRemoveBucketVer15> {
    ...
    static class Writer implements OFMessageWriter<OFGroupRemoveBucketVer15> {
        @Override
