...
//
    ...
    OFActionNiciraResubmitTableVer13(OFPort port, TableId tableId) {
        if(port == null) {
            throw new NullPointerException("OFActionNiciraResubmitTableVer13: property port cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFActionNiciraResubmitTableVer13: property tableId cannot be null");
        }
        this.port = port;
