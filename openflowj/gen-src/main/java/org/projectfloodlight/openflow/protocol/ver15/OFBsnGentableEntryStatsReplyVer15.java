...
class OFBsnGentableEntryStatsReplyVer15 implements OFBsnGentableEntryStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnGentableEntryStatsReplyVer15 DEFAULT = new OFBsnGentableEntryStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableEntryStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableEntryStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableEntryStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGentableEntryStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnGentableEntryStatsReply.Builder {
        final OFBsnGentableEntryStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryStatsReplyVer15 parentMessage) {
    ...
    public OFBsnGentableEntryStatsReply.Builder setEntries(List<OFBsnGentableEntryStatsEntry> entries) {
        ...
        public OFBsnGentableEntryStatsReply build() {
                ...
                //
                return new OFBsnGentableEntryStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryStatsReply> {
        ...
        public OFBsnGentableEntryStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnGentableEntryStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGentableEntryStatsEntryVer15.READER);

            OFBsnGentableEntryStatsReplyVer15 bsnGentableEntryStatsReplyVer15 = new OFBsnGentableEntryStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryStatsReplyVer15);
            return bsnGentableEntryStatsReplyVer15;
        }
    }
    ...
    final static OFBsnGentableEntryStatsReplyVer15Funnel FUNNEL = new OFBsnGentableEntryStatsReplyVer15Funnel();
    static class OFBsnGentableEntryStatsReplyVer15Funnel implements Funnel<OFBsnGentableEntryStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableEntryStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableEntryStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnGentableEntryStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryStatsReplyVer15 other = (OFBsnGentableEntryStatsReplyVer15) obj;
