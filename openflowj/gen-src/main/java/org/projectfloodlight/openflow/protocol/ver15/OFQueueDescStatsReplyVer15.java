...
class OFQueueDescStatsReplyVer15 implements OFQueueDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFQueueDescStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFQueueDescStatsReplyVer15 DEFAULT = new OFQueueDescStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFQueueDescStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFQueueDesc> entries) {
        if(flags == null) {
            throw new NullPointerException("OFQueueDescStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
    ...
    static class BuilderWithParent implements OFQueueDescStatsReply.Builder {
        final OFQueueDescStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFQueueDescStatsReplyVer15 parentMessage) {
    ...
    public OFQueueDescStatsReply.Builder setEntries(List<OFQueueDesc> entries) {
        ...
        public OFQueueDescStatsReply build() {
                ...
                //
                return new OFQueueDescStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFQueueDescStatsReply> {
        @Override
        public OFQueueDescStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFQueueDesc> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFQueueDescVer15.READER);

            OFQueueDescStatsReplyVer15 queueDescStatsReplyVer15 = new OFQueueDescStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueDescStatsReplyVer15);
            return queueDescStatsReplyVer15;
        }
    }
    ...
    final static OFQueueDescStatsReplyVer15Funnel FUNNEL = new OFQueueDescStatsReplyVer15Funnel();
    static class OFQueueDescStatsReplyVer15Funnel implements Funnel<OFQueueDescStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueDescStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFQueueDescStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFQueueDescStatsReplyVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueDescStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueDescStatsReplyVer15 other = (OFQueueDescStatsReplyVer15) obj;
