...
//
    ...
    static class Reader implements OFMessageReader<OFQueueDescStatsReply> {
        ...
        public OFQueueDescStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFQueueDesc> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFQueueDescVer15.READER);
    ...
    static class Writer implements OFMessageWriter<OFQueueDescStatsReplyVer15> {
        ...
        public void write(ByteBuf bb, OFQueueDescStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFQueueDescStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
