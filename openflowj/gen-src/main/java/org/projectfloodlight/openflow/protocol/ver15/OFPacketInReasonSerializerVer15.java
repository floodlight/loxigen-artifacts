...
public class OFPacketInReasonSerializerVer15 {
    ...
    public static OFPacketInReason ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFPacketInReason in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFPacketInReason e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFPacketInReason in version 1.5: " + e);
        }
    }
