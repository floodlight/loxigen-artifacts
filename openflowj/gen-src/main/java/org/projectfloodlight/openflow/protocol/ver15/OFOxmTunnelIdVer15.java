...
class OFOxmTunnelIdVer15 implements OFOxmTunnelId {
...
//
    ...
    final static OFOxmTunnelIdVer15 DEFAULT = new OFOxmTunnelIdVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmTunnelId> {
        @Override
        public OFOxmTunnelId readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunnelIdVer15 oxmTunnelIdVer15 = new OFOxmTunnelIdVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunnelIdVer15);
    ...
    final static OFOxmTunnelIdVer15Funnel FUNNEL = new OFOxmTunnelIdVer15Funnel();
    static class OFOxmTunnelIdVer15Funnel implements Funnel<OFOxmTunnelIdVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmTunnelIdVer15> {
        @Override
