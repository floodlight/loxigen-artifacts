...
class OFOxmTunnelIpv4SrcMaskedVer15 implements OFOxmTunnelIpv4SrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmTunnelIpv4SrcMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmTunnelIpv4SrcMaskedVer15 DEFAULT = new OFOxmTunnelIpv4SrcMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmTunnelIpv4SrcMaskedVer15(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmTunnelIpv4SrcMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmTunnelIpv4SrcMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IPv4Address> getCanonical() {
        if (IPv4Address.NO_MASK.equals(mask)) {
            return new OFOxmTunnelIpv4SrcVer15(value);
    ...
    static class BuilderWithParent implements OFOxmTunnelIpv4SrcMasked.Builder {
        final OFOxmTunnelIpv4SrcMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmTunnelIpv4SrcMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunnelIpv4SrcMasked> {
        ...
        public OFOxmTunnelIpv4SrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunnelIpv4SrcMaskedVer15 oxmTunnelIpv4SrcMaskedVer15 = new OFOxmTunnelIpv4SrcMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunnelIpv4SrcMaskedVer15);
            return oxmTunnelIpv4SrcMaskedVer15;
        }
    }
    ...
    final static OFOxmTunnelIpv4SrcMaskedVer15Funnel FUNNEL = new OFOxmTunnelIpv4SrcMaskedVer15Funnel();
    static class OFOxmTunnelIpv4SrcMaskedVer15Funnel implements Funnel<OFOxmTunnelIpv4SrcMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmTunnelIpv4SrcMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x13f08L
            sink.putInt(0x13f08);
    ...
    static class Writer implements OFMessageWriter<OFOxmTunnelIpv4SrcMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmTunnelIpv4SrcMaskedVer15 message) {
            // fixed value property typeLen = 0x13f08L
            bb.writeInt(0x13f08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmTunnelIpv4SrcMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmTunnelIpv4SrcMaskedVer15 other = (OFOxmTunnelIpv4SrcMaskedVer15) obj;
