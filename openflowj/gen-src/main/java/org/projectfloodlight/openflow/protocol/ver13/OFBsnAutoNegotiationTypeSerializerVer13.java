...
public class OFBsnAutoNegotiationTypeSerializerVer13 {
    ...
    public static OFBsnAutoNegotiationType ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnAutoNegotiationType in version 1.3: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnAutoNegotiationType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnAutoNegotiationType in version 1.3: " + e);
        }
    }
