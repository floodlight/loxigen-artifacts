...
class OFPortStatsReplyVer15 implements OFPortStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFPortStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFPortStatsReplyVer15 DEFAULT = new OFPortStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFPortStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFPortStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFPortStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFPortStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFPortStatsReply.Builder {
        final OFPortStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFPortStatsReplyVer15 parentMessage) {
    ...
    public OFPortStatsReply.Builder setXid(long xid) {
        ...
        public OFPortStatsReply build() {
                ...
                //
                return new OFPortStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFPortStatsReply> {
        ...
        public OFPortStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFPortStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFPortStatsEntryVer15.READER);

            OFPortStatsReplyVer15 portStatsReplyVer15 = new OFPortStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", portStatsReplyVer15);
            return portStatsReplyVer15;
        }
    }
    ...
    final static OFPortStatsReplyVer15Funnel FUNNEL = new OFPortStatsReplyVer15Funnel();
    static class OFPortStatsReplyVer15Funnel implements Funnel<OFPortStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFPortStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFPortStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFPortStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFPortStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFPortStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFPortStatsReplyVer15 other = (OFPortStatsReplyVer15) obj;
