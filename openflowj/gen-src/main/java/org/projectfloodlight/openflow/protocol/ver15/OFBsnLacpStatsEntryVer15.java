...
class OFBsnLacpStatsEntryVer15 implements OFBsnLacpStatsEntry {
...
//
    ...
    final static OFBsnLacpStatsEntryVer15 DEFAULT = new OFBsnLacpStatsEntryVer15(
    ...
    OFBsnLacpStatsEntryVer15(OFPort portNo, int actorSysPriority, MacAddress actorSysMac, int actorPortPriority, int actorPortNum, int actorKey, short convergenceStatus, int partnerSysPriority, MacAddress partnerSysMac, int partnerPortPriority, int partnerPortNum, int partnerKey) {
        if(portNo == null) {
    ...
    static class BuilderWithParent implements OFBsnLacpStatsEntry.Builder {
        ...
        BuilderWithParent(OFBsnLacpStatsEntryVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnLacpStatsEntry> {
        ...
        public OFBsnLacpStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnLacpStatsEntryVer15 bsnLacpStatsEntryVer15 = new OFBsnLacpStatsEntryVer15(
                    portNo,
                      actorSysPriority,
                      actorSysMac,
                      actorPortPriority,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLacpStatsEntryVer15);
            return bsnLacpStatsEntryVer15;
        }
    }
    ...
    final static OFBsnLacpStatsEntryVer15Funnel FUNNEL = new OFBsnLacpStatsEntryVer15Funnel();
    static class OFBsnLacpStatsEntryVer15Funnel implements Funnel<OFBsnLacpStatsEntryVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnLacpStatsEntryVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFBsnLacpStatsEntryVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnLacpStatsEntryVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnLacpStatsEntryVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnLacpStatsEntryVer15 other = (OFBsnLacpStatsEntryVer15) obj;
