...
class OFGroupDescStatsEntryVer15 implements OFGroupDescStatsEntry {
...
//
    ...
    public OFVersion getVersion() {
        ...
        public OFGroupDescStatsEntry build() {
                ...
                //
                return new OFGroupDescStatsEntryVer15(
                    groupType,
                    group,
                    buckets,
                    properties
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupDescStatsEntry> {
        ...
        public OFGroupDescStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupDescStatsEntryVer15);
    ...
    final static OFGroupDescStatsEntryVer15Funnel FUNNEL = new OFGroupDescStatsEntryVer15Funnel();
    ...
    static class Writer implements OFMessageWriter<OFGroupDescStatsEntryVer15> {
        ...
        public void write(ByteBuf bb, OFGroupDescStatsEntryVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFGroupDescStatsEntryVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
