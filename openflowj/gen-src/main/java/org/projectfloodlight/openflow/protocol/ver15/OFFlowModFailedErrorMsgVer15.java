...
class OFFlowModFailedErrorMsgVer15 implements OFFlowModFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowModFailedErrorMsgVer15.class);
    // version: 1.5
...
//
    ...
    OFFlowModFailedErrorMsgVer15(long xid, OFFlowModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFFlowModFailedErrorMsgVer15: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFFlowModFailedErrorMsgVer15: property data cannot be null");
        }
    ...
    static class BuilderWithParent implements OFFlowModFailedErrorMsg.Builder {
        final OFFlowModFailedErrorMsgVer15 parentMessage;
        ...
        BuilderWithParent(OFFlowModFailedErrorMsgVer15 parentMessage) {
    ...
    public OFFlowModFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFFlowModFailedErrorMsg build() {
                ...
                //
                return new OFFlowModFailedErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowModFailedErrorMsg> {
        ...
        public OFFlowModFailedErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFFlowModFailedCode code = OFFlowModFailedCodeSerializerVer15.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_15);

            OFFlowModFailedErrorMsgVer15 flowModFailedErrorMsgVer15 = new OFFlowModFailedErrorMsgVer15(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowModFailedErrorMsgVer15);
            return flowModFailedErrorMsgVer15;
        }
    }
    ...
    final static OFFlowModFailedErrorMsgVer15Funnel FUNNEL = new OFFlowModFailedErrorMsgVer15Funnel();
    static class OFFlowModFailedErrorMsgVer15Funnel implements Funnel<OFFlowModFailedErrorMsgVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowModFailedErrorMsgVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFFlowModFailedCodeSerializerVer15.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFFlowModFailedErrorMsgVer15> {
        @Override
        public void write(ByteBuf bb, OFFlowModFailedErrorMsgVer15 message) {
            ...
            OFFlowModFailedCodeSerializerVer15.writeTo(bb, message.code);
            message.data.writeTo(bb);

            // update length field
            int length = bb.writerIndex() - startIndex;
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFFlowModFailedErrorMsgVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowModFailedErrorMsgVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowModFailedErrorMsgVer15 other = (OFFlowModFailedErrorMsgVer15) obj;
