...
class OFOxmIcmpv6CodeVer15 implements OFOxmIcmpv6Code {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIcmpv6CodeVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIcmpv6CodeVer15 DEFAULT = new OFOxmIcmpv6CodeVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIcmpv6CodeVer15(U8 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIcmpv6CodeVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIcmpv6Code.Builder {
        final OFOxmIcmpv6CodeVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U8 value;

        BuilderWithParent(OFOxmIcmpv6CodeVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv6Code> {
        ...
        public OFOxmIcmpv6Code readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIcmpv6CodeVer15 oxmIcmpv6CodeVer15 = new OFOxmIcmpv6CodeVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv6CodeVer15);
            return oxmIcmpv6CodeVer15;
        }
    }
    ...
    final static OFOxmIcmpv6CodeVer15Funnel FUNNEL = new OFOxmIcmpv6CodeVer15Funnel();
    static class OFOxmIcmpv6CodeVer15Funnel implements Funnel<OFOxmIcmpv6CodeVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIcmpv6CodeVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003c01L
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv6CodeVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIcmpv6CodeVer15 message) {
            // fixed value property typeLen = 0x80003c01L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIcmpv6CodeVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIcmpv6CodeVer15 other = (OFOxmIcmpv6CodeVer15) obj;
