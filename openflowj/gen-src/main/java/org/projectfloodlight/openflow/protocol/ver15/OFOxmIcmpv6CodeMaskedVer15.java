...
class OFOxmIcmpv6CodeMaskedVer15 implements OFOxmIcmpv6CodeMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIcmpv6CodeMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIcmpv6CodeMaskedVer15 DEFAULT = new OFOxmIcmpv6CodeMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIcmpv6CodeMaskedVer15(U8 value, U8 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIcmpv6CodeMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIcmpv6CodeMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U8> getCanonical() {
        if (U8.NO_MASK.equals(mask)) {
            return new OFOxmIcmpv6CodeVer15(value);
    ...
    static class BuilderWithParent implements OFOxmIcmpv6CodeMasked.Builder {
        final OFOxmIcmpv6CodeMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIcmpv6CodeMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv6CodeMasked> {
        ...
        public OFOxmIcmpv6CodeMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIcmpv6CodeMaskedVer15 oxmIcmpv6CodeMaskedVer15 = new OFOxmIcmpv6CodeMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv6CodeMaskedVer15);
            return oxmIcmpv6CodeMaskedVer15;
        }
    }
    ...
    final static OFOxmIcmpv6CodeMaskedVer15Funnel FUNNEL = new OFOxmIcmpv6CodeMaskedVer15Funnel();
    static class OFOxmIcmpv6CodeMaskedVer15Funnel implements Funnel<OFOxmIcmpv6CodeMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIcmpv6CodeMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003d02L
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv6CodeMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIcmpv6CodeMaskedVer15 message) {
            // fixed value property typeLen = 0x80003d02L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIcmpv6CodeMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIcmpv6CodeMaskedVer15 other = (OFOxmIcmpv6CodeMaskedVer15) obj;
