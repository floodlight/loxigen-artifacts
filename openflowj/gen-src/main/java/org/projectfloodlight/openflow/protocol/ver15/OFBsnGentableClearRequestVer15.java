...
class OFBsnGentableClearRequestVer15 implements OFBsnGentableClearRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableClearRequestVer15.class);
    // version: 1.5
...
//
    ...
    OFBsnGentableClearRequestVer15(long xid, GenTableId tableId, U128 checksum, U128 checksumMask) {
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableClearRequestVer15: property tableId cannot be null");
        }
        if(checksum == null) {
            throw new NullPointerException("OFBsnGentableClearRequestVer15: property checksum cannot be null");
        }
        if(checksumMask == null) {
            throw new NullPointerException("OFBsnGentableClearRequestVer15: property checksumMask cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnGentableClearRequest.Builder {
        final OFBsnGentableClearRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableClearRequestVer15 parentMessage) {
    ...
    public OFBsnGentableClearRequest.Builder setChecksumMask(U128 checksumMask) {
        ...
        public OFBsnGentableClearRequest build() {
                ...
                //
                return new OFBsnGentableClearRequestVer15(
                    xid,
                    tableId,
                    checksum,
                    checksumMask
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableClearRequest> {
        ...
        public OFBsnGentableClearRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableClearRequestVer15 bsnGentableClearRequestVer15 = new OFBsnGentableClearRequestVer15(
                    xid,
                      tableId,
                      checksum,
                      checksumMask
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableClearRequestVer15);
            return bsnGentableClearRequestVer15;
        }
    }
    ...
    final static OFBsnGentableClearRequestVer15Funnel FUNNEL = new OFBsnGentableClearRequestVer15Funnel();
    static class OFBsnGentableClearRequestVer15Funnel implements Funnel<OFBsnGentableClearRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableClearRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableClearRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableClearRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableClearRequestVer15(");
