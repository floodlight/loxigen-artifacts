...
class OFBsnFlowChecksumBucketStatsReplyVer15 implements OFBsnFlowChecksumBucketStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnFlowChecksumBucketStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnFlowChecksumBucketStatsReplyVer15 DEFAULT = new OFBsnFlowChecksumBucketStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnFlowChecksumBucketStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnFlowChecksumBucketStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnFlowChecksumBucketStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnFlowChecksumBucketStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnFlowChecksumBucketStatsReply.Builder {
        final OFBsnFlowChecksumBucketStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnFlowChecksumBucketStatsReplyVer15 parentMessage) {
    ...
    public OFBsnFlowChecksumBucketStatsReply.Builder setXid(long xid) {
        ...
        public OFBsnFlowChecksumBucketStatsReply build() {
                ...
                //
                return new OFBsnFlowChecksumBucketStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnFlowChecksumBucketStatsReply> {
        ...
        public OFBsnFlowChecksumBucketStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnFlowChecksumBucketStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnFlowChecksumBucketStatsEntryVer15.READER);

            OFBsnFlowChecksumBucketStatsReplyVer15 bsnFlowChecksumBucketStatsReplyVer15 = new OFBsnFlowChecksumBucketStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnFlowChecksumBucketStatsReplyVer15);
            return bsnFlowChecksumBucketStatsReplyVer15;
        }
    }
    ...
    final static OFBsnFlowChecksumBucketStatsReplyVer15Funnel FUNNEL = new OFBsnFlowChecksumBucketStatsReplyVer15Funnel();
    static class OFBsnFlowChecksumBucketStatsReplyVer15Funnel implements Funnel<OFBsnFlowChecksumBucketStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnFlowChecksumBucketStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnFlowChecksumBucketStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnFlowChecksumBucketStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnFlowChecksumBucketStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnFlowChecksumBucketStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnFlowChecksumBucketStatsReplyVer15 other = (OFBsnFlowChecksumBucketStatsReplyVer15) obj;
