...
class OFOxmIpProtoVer15 implements OFOxmIpProto {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpProtoVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpProtoVer15 DEFAULT = new OFOxmIpProtoVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpProtoVer15(IpProtocol value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpProtoVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpProto.Builder {
        final OFOxmIpProtoVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IpProtocol value;

        BuilderWithParent(OFOxmIpProtoVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpProto> {
        ...
        public OFOxmIpProto readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpProtoVer15 oxmIpProtoVer15 = new OFOxmIpProtoVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpProtoVer15);
            return oxmIpProtoVer15;
        }
    }
    ...
    final static OFOxmIpProtoVer15Funnel FUNNEL = new OFOxmIpProtoVer15Funnel();
    static class OFOxmIpProtoVer15Funnel implements Funnel<OFOxmIpProtoVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpProtoVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001401L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpProtoVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpProtoVer15 message) {
            // fixed value property typeLen = 0x80001401L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpProtoVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpProtoVer15 other = (OFOxmIpProtoVer15) obj;
