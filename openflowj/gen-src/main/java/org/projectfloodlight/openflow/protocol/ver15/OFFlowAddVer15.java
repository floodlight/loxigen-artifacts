...
class OFFlowAddVer15 implements OFFlowAdd {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowAddVer15.class);
    // version: 1.5
...
//
    ...
    final static OFFlowAddVer15 DEFAULT = new OFFlowAddVer15(
    ...
    OFFlowAddVer15(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, int importance, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowAddVer15: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowAddVer15: property cookieMask cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowAddVer15: property tableId cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowAddVer15: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowAddVer15: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowAddVer15: property outGroup cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowAddVer15: property flags cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowAddVer15: property match cannot be null");
        }
    ...
    static class BuilderWithParent implements OFFlowAdd.Builder {
        final OFFlowAddVer15 parentMessage;
        ...
        BuilderWithParent(OFFlowAddVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowAdd> {
        ...
        public OFFlowAdd readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFFlowAddVer15 flowAddVer15 = new OFFlowAddVer15(
                    xid,
                      cookie,
                      cookieMask,
                      tableId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowAddVer15);
            return flowAddVer15;
        }
    }
    ...
    final static OFFlowAddVer15Funnel FUNNEL = new OFFlowAddVer15Funnel();
    static class OFFlowAddVer15Funnel implements Funnel<OFFlowAddVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowAddVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFFlowAddVer15> {
        @Override
        public void write(ByteBuf bb, OFFlowAddVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFFlowAddVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowAddVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowAddVer15 other = (OFFlowAddVer15) obj;
