...
class OFFlowDescEntryVer15 implements OFFlowDescEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowDescEntryVer15.class);
    // version: 1.5
...
//
    ...
    OFFlowDescEntryVer15(TableId tableId, int priority, int idleTimeout, int hardTimeout, Set<OFFlowModFlags> flags, int importance, U64 cookie, Match match, Stat stats, List<OFInstruction> instructions) {
        if(tableId == null) {
            throw new NullPointerException("OFFlowDescEntryVer15: property tableId cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowDescEntryVer15: property flags cannot be null");
        }
        if(cookie == null) {
            throw new NullPointerException("OFFlowDescEntryVer15: property cookie cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowDescEntryVer15: property match cannot be null");
        }
        if(stats == null) {
            throw new NullPointerException("OFFlowDescEntryVer15: property stats cannot be null");
        }
        if(instructions == null) {
            throw new NullPointerException("OFFlowDescEntryVer15: property instructions cannot be null");
        }
    ...
    public OFFlowDescEntry.Builder createBuilder() {
        return new BuilderWithParent(this);
    }

    static class BuilderWithParent implements OFFlowDescEntry.Builder {
        final OFFlowDescEntryVer15 parentMessage;
        ...
        BuilderWithParent(OFFlowDescEntryVer15 parentMessage) {
    ...
    @Override
    public OFFlowDescEntry.Builder setTableId(TableId tableId) {
        this.tableId = tableId;
    ...
    @Override
    public OFFlowDescEntry.Builder setPriority(int priority) {
        this.priority = priority;
    ...
    @Override
    public OFFlowDescEntry.Builder setIdleTimeout(int idleTimeout) {
        this.idleTimeout = idleTimeout;
    ...
    @Override
    public OFFlowDescEntry.Builder setHardTimeout(int hardTimeout) {
        this.hardTimeout = hardTimeout;
    ...
    @Override
    public OFFlowDescEntry.Builder setFlags(Set<OFFlowModFlags> flags) {
        this.flags = flags;
        this.flagsSet = true;
        return this;
    }
    ...
    @Override
    public OFFlowDescEntry.Builder setImportance(int importance) {
        this.importance = importance;
    ...
    @Override
    public OFFlowDescEntry.Builder setCookie(U64 cookie) {
        this.cookie = cookie;
        this.cookieSet = true;
        return this;
    }
    ...
    @Override
    public OFFlowDescEntry.Builder setMatch(Match match) {
        this.match = match;
        this.matchSet = true;
        return this;
    }
    ...
    @Override
    public OFFlowDescEntry.Builder setStats(Stat stats) {
        this.stats = stats;
        this.statsSet = true;
        return this;
    }
    ...
    @Override
    public OFFlowDescEntry.Builder setInstructions(List<OFInstruction> instructions) {
        this.instructions = instructions;
    ...
    public OFVersion getVersion() {
        ...
        public OFFlowDescEntry build() {
                ...
                //
                return new OFFlowDescEntryVer15(
                    tableId,
                    priority,
                    idleTimeout,
                    hardTimeout,
    ...
    static class Builder implements OFFlowDescEntry.Builder {
        // OF message fields
        private boolean tableIdSet;
        private TableId tableId;
        private boolean prioritySet;
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowDescEntry> {
        @Override
        public OFFlowDescEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFFlowDescEntryVer15 flowDescEntryVer15 = new OFFlowDescEntryVer15(
                    tableId,
                      priority,
                      idleTimeout,
                      hardTimeout,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowDescEntryVer15);
            return flowDescEntryVer15;
        }
    }
    ...
    final static OFFlowDescEntryVer15Funnel FUNNEL = new OFFlowDescEntryVer15Funnel();
    static class OFFlowDescEntryVer15Funnel implements Funnel<OFFlowDescEntryVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowDescEntryVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFFlowDescEntryVer15> {
        @Override
        public void write(ByteBuf bb, OFFlowDescEntryVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowDescEntryVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowDescEntryVer15 other = (OFFlowDescEntryVer15) obj;
