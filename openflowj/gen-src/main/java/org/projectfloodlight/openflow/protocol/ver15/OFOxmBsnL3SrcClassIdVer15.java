...
class OFOxmBsnL3SrcClassIdVer15 implements OFOxmBsnL3SrcClassId {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnL3SrcClassIdVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnL3SrcClassIdVer15 DEFAULT = new OFOxmBsnL3SrcClassIdVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnL3SrcClassIdVer15(ClassId value) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnL3SrcClassIdVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnL3SrcClassId.Builder {
        final OFOxmBsnL3SrcClassIdVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private ClassId value;

        BuilderWithParent(OFOxmBsnL3SrcClassIdVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnL3SrcClassId> {
        ...
        public OFOxmBsnL3SrcClassId readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnL3SrcClassIdVer15 oxmBsnL3SrcClassIdVer15 = new OFOxmBsnL3SrcClassIdVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnL3SrcClassIdVer15);
            return oxmBsnL3SrcClassIdVer15;
        }
    }
    ...
    final static OFOxmBsnL3SrcClassIdVer15Funnel FUNNEL = new OFOxmBsnL3SrcClassIdVer15Funnel();
    static class OFOxmBsnL3SrcClassIdVer15Funnel implements Funnel<OFOxmBsnL3SrcClassIdVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnL3SrcClassIdVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x30a04L
            sink.putInt(0x30a04);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnL3SrcClassIdVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnL3SrcClassIdVer15 message) {
            // fixed value property typeLen = 0x30a04L
            bb.writeInt(0x30a04);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnL3SrcClassIdVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnL3SrcClassIdVer15 other = (OFOxmBsnL3SrcClassIdVer15) obj;
