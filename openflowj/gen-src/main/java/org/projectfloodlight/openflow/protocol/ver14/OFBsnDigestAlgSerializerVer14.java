...
public class OFBsnDigestAlgSerializerVer14 {
    ...
    public static OFBsnDigestAlg ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnDigestAlg in version 1.4: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnDigestAlg e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnDigestAlg in version 1.4: " + e);
        }
    }
