...
public class OFBsnPimPacketTypeSerializerVer14 {
    ...
    public static OFBsnPimPacketType ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnPimPacketType in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnPimPacketType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnPimPacketType in version 1.4: " + e);
        }
    }
