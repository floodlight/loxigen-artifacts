...
class OFBsnVportL2GreVer15 implements OFBsnVportL2Gre {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVportL2GreVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnVportL2GreVer15 DEFAULT = new OFBsnVportL2GreVer15(
    ...
    OFBsnVportL2GreVer15(Set<OFBsnVportL2GreFlags> flags, OFPort portNo, OFPort loopbackPortNo, MacAddress localMac, MacAddress nhMac, IPv4Address srcIp, IPv4Address dstIp, short dscp, short ttl, long vpn, long rateLimit, String ifName) {
        if(flags == null) {
            throw new NullPointerException("OFBsnVportL2GreVer15: property flags cannot be null");
        }
        if(portNo == null) {
            throw new NullPointerException("OFBsnVportL2GreVer15: property portNo cannot be null");
        }
        if(loopbackPortNo == null) {
            throw new NullPointerException("OFBsnVportL2GreVer15: property loopbackPortNo cannot be null");
        }
        if(localMac == null) {
            throw new NullPointerException("OFBsnVportL2GreVer15: property localMac cannot be null");
        }
        if(nhMac == null) {
            throw new NullPointerException("OFBsnVportL2GreVer15: property nhMac cannot be null");
        }
        if(srcIp == null) {
            throw new NullPointerException("OFBsnVportL2GreVer15: property srcIp cannot be null");
        }
        if(dstIp == null) {
            throw new NullPointerException("OFBsnVportL2GreVer15: property dstIp cannot be null");
        }
        if(ifName == null) {
            throw new NullPointerException("OFBsnVportL2GreVer15: property ifName cannot be null");
        }
        this.flags = flags;
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFBsnVportL2Gre.Builder {
        final OFBsnVportL2GreVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnVportL2GreVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnVportL2Gre build() {
                ...
                //
                return new OFBsnVportL2GreVer15(
                    flags,
                    portNo,
                    loopbackPortNo,
                    localMac,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVportL2Gre> {
        ...
        public OFBsnVportL2Gre readFrom(ByteBuf bb) throws OFParseError {
            ...
            Set<OFBsnVportL2GreFlags> flags = OFBsnVportL2GreFlagsSerializerVer15.readFrom(bb);
            ...
            OFBsnVportL2GreVer15 bsnVportL2GreVer15 = new OFBsnVportL2GreVer15(
                    flags,
                      portNo,
                      loopbackPortNo,
                      localMac,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVportL2GreVer15);
            return bsnVportL2GreVer15;
        }
    }
    ...
    final static OFBsnVportL2GreVer15Funnel FUNNEL = new OFBsnVportL2GreVer15Funnel();
    static class OFBsnVportL2GreVer15Funnel implements Funnel<OFBsnVportL2GreVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVportL2GreVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0x1
            sink.putShort((short) 0x1);
            // fixed value property length = 64
            sink.putShort((short) 0x40);
            OFBsnVportL2GreFlagsSerializerVer15.putTo(message.flags, sink);
    ...
    static class Writer implements OFMessageWriter<OFBsnVportL2GreVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnVportL2GreVer15 message) {
            // fixed value property type = 0x1
            bb.writeShort((short) 0x1);
            // fixed value property length = 64
            bb.writeShort((short) 0x40);
            OFBsnVportL2GreFlagsSerializerVer15.writeTo(bb, message.flags);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVportL2GreVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVportL2GreVer15 other = (OFBsnVportL2GreVer15) obj;
