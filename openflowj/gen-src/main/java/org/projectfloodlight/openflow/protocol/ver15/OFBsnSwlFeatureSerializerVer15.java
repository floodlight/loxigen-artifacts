...
public class OFBsnSwlFeatureSerializerVer15 {
    ...
    public static OFBsnSwlFeature ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnSwlFeature in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnSwlFeature e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnSwlFeature in version 1.5: " + e);
        }
    }
