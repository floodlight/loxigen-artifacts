...
public class OFBsnLoglevelSerializerVer15 {
    ...
    public static OFBsnLoglevel ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnLoglevel in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnLoglevel e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnLoglevel in version 1.5: " + e);
        }
    }
