        ...
        public OFActionExperimenter readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               case 0x5c16c7:
                   ...
                   return OFActionBsnVer11.READER.readFrom(context, bb);
               case 0x2320:
                   bb.readerIndex(start);
                   // discriminator value 0x2320L=0x2320L for class OFActionNiciraVer11
                   return OFActionNiciraVer11.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFActionExperimenterVer11.class, "experimenter", experimenter);
            }
