...
class OFOxmSctpSrcVer15 implements OFOxmSctpSrc {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmSctpSrcVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmSctpSrcVer15 DEFAULT = new OFOxmSctpSrcVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmSctpSrcVer15(TransportPort value) {
        if(value == null) {
            throw new NullPointerException("OFOxmSctpSrcVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmSctpSrc.Builder {
        final OFOxmSctpSrcVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private TransportPort value;

        BuilderWithParent(OFOxmSctpSrcVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmSctpSrc> {
        ...
        public OFOxmSctpSrc readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmSctpSrcVer15 oxmSctpSrcVer15 = new OFOxmSctpSrcVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmSctpSrcVer15);
            return oxmSctpSrcVer15;
        }
    }
    ...
    final static OFOxmSctpSrcVer15Funnel FUNNEL = new OFOxmSctpSrcVer15Funnel();
    static class OFOxmSctpSrcVer15Funnel implements Funnel<OFOxmSctpSrcVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmSctpSrcVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002202L
    ...
    static class Writer implements OFMessageWriter<OFOxmSctpSrcVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmSctpSrcVer15 message) {
            // fixed value property typeLen = 0x80002202L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmSctpSrcVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmSctpSrcVer15 other = (OFOxmSctpSrcVer15) obj;
