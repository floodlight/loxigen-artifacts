...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFInstructionBsnDisableVlanCounters> {
        @Override
        public OFInstructionBsnDisableVlanCounters readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
