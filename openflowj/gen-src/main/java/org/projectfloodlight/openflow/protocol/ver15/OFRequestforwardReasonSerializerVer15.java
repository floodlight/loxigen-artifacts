...
public class OFRequestforwardReasonSerializerVer15 {
    ...
    public static OFRequestforwardReason ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFRequestforwardReason in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFRequestforwardReason e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFRequestforwardReason in version 1.5: " + e);
        }
    }
