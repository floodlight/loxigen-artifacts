...
public class OFMatchTypeSerializerVer15 {
    ...
    public static OFMatchType ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFMatchType in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFMatchType e) {
        switch(e) {
            ...
            case OXM:
                return OXM_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFMatchType in version 1.5: " + e);
        }
    }
