...
class OFOxmVlanPcpVer15 implements OFOxmVlanPcp {
...
//
    ...
    final static OFOxmVlanPcpVer15 DEFAULT = new OFOxmVlanPcpVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmVlanPcp> {
        ...
        public OFOxmVlanPcp readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmVlanPcpVer15 oxmVlanPcpVer15 = new OFOxmVlanPcpVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmVlanPcpVer15);
    ...
    final static OFOxmVlanPcpVer15Funnel FUNNEL = new OFOxmVlanPcpVer15Funnel();
    static class OFOxmVlanPcpVer15Funnel implements Funnel<OFOxmVlanPcpVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmVlanPcpVer15> {
        @Override
