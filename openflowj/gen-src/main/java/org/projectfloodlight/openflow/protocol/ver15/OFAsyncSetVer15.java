...
class OFAsyncSetVer15 implements OFAsyncSet {
...
//
    ...
    final static OFAsyncSetVer15 DEFAULT = new OFAsyncSetVer15(
...
//
    ...
    static class Reader implements OFMessageReader<OFAsyncSet> {
        ...
        public OFAsyncSet readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFAsyncSetVer15 asyncSetVer15 = new OFAsyncSetVer15(
                    xid,
                      properties
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", asyncSetVer15);
    ...
    final static OFAsyncSetVer15Funnel FUNNEL = new OFAsyncSetVer15Funnel();
    static class OFAsyncSetVer15Funnel implements Funnel<OFAsyncSetVer15> {
    ...
    static class Writer implements OFMessageWriter<OFAsyncSetVer15> {
        @Override
