...
class OFOxmMetadataVer15 implements OFOxmMetadata {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmMetadataVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmMetadataVer15 DEFAULT = new OFOxmMetadataVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmMetadataVer15(OFMetadata value) {
        if(value == null) {
            throw new NullPointerException("OFOxmMetadataVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmMetadata.Builder {
        final OFOxmMetadataVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private OFMetadata value;

        BuilderWithParent(OFOxmMetadataVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmMetadata> {
        ...
        public OFOxmMetadata readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmMetadataVer15 oxmMetadataVer15 = new OFOxmMetadataVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmMetadataVer15);
            return oxmMetadataVer15;
        }
    }
    ...
    final static OFOxmMetadataVer15Funnel FUNNEL = new OFOxmMetadataVer15Funnel();
    static class OFOxmMetadataVer15Funnel implements Funnel<OFOxmMetadataVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmMetadataVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80000408L
    ...
    static class Writer implements OFMessageWriter<OFOxmMetadataVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmMetadataVer15 message) {
            // fixed value property typeLen = 0x80000408L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmMetadataVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmMetadataVer15 other = (OFOxmMetadataVer15) obj;
