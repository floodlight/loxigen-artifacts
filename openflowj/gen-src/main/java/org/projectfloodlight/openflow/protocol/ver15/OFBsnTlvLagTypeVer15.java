...
class OFBsnTlvLagTypeVer15 implements OFBsnTlvLagType {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvLagType> {
        ...
        public OFBsnTlvLagType readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvLagTypeVer15 bsnTlvLagTypeVer15 = new OFBsnTlvLagTypeVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvLagTypeVer15);
    ...
    final static OFBsnTlvLagTypeVer15Funnel FUNNEL = new OFBsnTlvLagTypeVer15Funnel();
    static class OFBsnTlvLagTypeVer15Funnel implements Funnel<OFBsnTlvLagTypeVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvLagTypeVer15> {
        @Override
