...
class OFBsnTlvActorStateVer15 implements OFBsnTlvActorState {
...
//
    ...
    final static OFBsnTlvActorStateVer15 DEFAULT = new OFBsnTlvActorStateVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvActorState> {
        ...
        public OFBsnTlvActorState readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvActorStateVer15 bsnTlvActorStateVer15 = new OFBsnTlvActorStateVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvActorStateVer15);
    ...
    final static OFBsnTlvActorStateVer15Funnel FUNNEL = new OFBsnTlvActorStateVer15Funnel();
    static class OFBsnTlvActorStateVer15Funnel implements Funnel<OFBsnTlvActorStateVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvActorStateVer15> {
        @Override
