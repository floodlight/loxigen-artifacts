...
public class OFPortStatsOpticalFlagsSerializerVer15 {
        ...
        for(OFPortStatsOpticalFlags e: set) {
            switch(e) {
                ...
                case TX_TEMP:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Illegal enum value for type OFPortStatsOpticalFlags in version 1.5: " + e);
            }
        }
        return wireValue;
    }
