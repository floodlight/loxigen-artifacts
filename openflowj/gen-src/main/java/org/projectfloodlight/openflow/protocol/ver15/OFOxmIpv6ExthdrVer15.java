...
class OFOxmIpv6ExthdrVer15 implements OFOxmIpv6Exthdr {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6ExthdrVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6ExthdrVer15 DEFAULT = new OFOxmIpv6ExthdrVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6ExthdrVer15(U16 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6ExthdrVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6Exthdr.Builder {
        final OFOxmIpv6ExthdrVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U16 value;

        BuilderWithParent(OFOxmIpv6ExthdrVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6Exthdr> {
        ...
        public OFOxmIpv6Exthdr readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6ExthdrVer15 oxmIpv6ExthdrVer15 = new OFOxmIpv6ExthdrVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6ExthdrVer15);
            return oxmIpv6ExthdrVer15;
        }
    }
    ...
    final static OFOxmIpv6ExthdrVer15Funnel FUNNEL = new OFOxmIpv6ExthdrVer15Funnel();
    static class OFOxmIpv6ExthdrVer15Funnel implements Funnel<OFOxmIpv6ExthdrVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6ExthdrVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004e02L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6ExthdrVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6ExthdrVer15 message) {
            // fixed value property typeLen = 0x80004e02L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6ExthdrVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6ExthdrVer15 other = (OFOxmIpv6ExthdrVer15) obj;
