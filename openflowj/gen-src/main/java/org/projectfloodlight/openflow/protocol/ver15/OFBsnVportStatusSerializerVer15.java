...
public class OFBsnVportStatusSerializerVer15 {
    ...
    public static OFBsnVportStatus ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnVportStatus in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnVportStatus e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnVportStatus in version 1.5: " + e);
        }
    }
