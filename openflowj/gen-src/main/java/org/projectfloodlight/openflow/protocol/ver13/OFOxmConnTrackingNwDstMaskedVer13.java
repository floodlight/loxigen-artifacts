...
class OFOxmConnTrackingNwDstMaskedVer13 implements OFOxmConnTrackingNwDstMasked {
...
//
    ...
    final static OFOxmConnTrackingNwDstMaskedVer13 DEFAULT = new OFOxmConnTrackingNwDstMaskedVer13(
    ...
    public OFOxm<U32> getCanonical() {
        if (U32.NO_MASK.equals(mask)) {
            return new OFOxmConnTrackingNwDstVer13(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConnTrackingNwDstMasked> {
        ...
        public OFOxmConnTrackingNwDstMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingNwDstMaskedVer13 oxmConnTrackingNwDstMaskedVer13 = new OFOxmConnTrackingNwDstMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingNwDstMaskedVer13);
    ...
    final static OFOxmConnTrackingNwDstMaskedVer13Funnel FUNNEL = new OFOxmConnTrackingNwDstMaskedVer13Funnel();
    static class OFOxmConnTrackingNwDstMaskedVer13Funnel implements Funnel<OFOxmConnTrackingNwDstMaskedVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingNwDstMaskedVer13> {
        @Override
