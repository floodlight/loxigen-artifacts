...
public class OFTypeSerializerVer15 {
    ...
    public final static byte CONTROLLER_STATUS_VAL = (byte) 0x23;
    ...
    public static OFType ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFType in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFType in version 1.5: " + e);
        }
    }
