...
class OFOxmIpDscpVer15 implements OFOxmIpDscp {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpDscpVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpDscpVer15 DEFAULT = new OFOxmIpDscpVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpDscpVer15(IpDscp value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpDscpVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpDscp.Builder {
        final OFOxmIpDscpVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IpDscp value;

        BuilderWithParent(OFOxmIpDscpVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpDscp> {
        ...
        public OFOxmIpDscp readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpDscpVer15 oxmIpDscpVer15 = new OFOxmIpDscpVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpDscpVer15);
            return oxmIpDscpVer15;
        }
    }
    ...
    final static OFOxmIpDscpVer15Funnel FUNNEL = new OFOxmIpDscpVer15Funnel();
    static class OFOxmIpDscpVer15Funnel implements Funnel<OFOxmIpDscpVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpDscpVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001001L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpDscpVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpDscpVer15 message) {
            // fixed value property typeLen = 0x80001001L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpDscpVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpDscpVer15 other = (OFOxmIpDscpVer15) obj;
