...
class OFBsnTableFullErrorVer15 implements OFBsnTableFullError {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnTableFullErrorVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnTableFullErrorVer15 DEFAULT = new OFBsnTableFullErrorVer15(
        DEFAULT_XID, DEFAULT_ERR_MSG, DEFAULT_DATA
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnTableFullErrorVer15(long xid, String errMsg, OFErrorCauseData data) {
        if(errMsg == null) {
            throw new NullPointerException("OFBsnTableFullErrorVer15: property errMsg cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBsnTableFullErrorVer15: property data cannot be null");
        }
        this.xid = xid;
        this.errMsg = errMsg;
        this.data = data;
    ...
    static class BuilderWithParent implements OFBsnTableFullError.Builder {
        final OFBsnTableFullErrorVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnTableFullErrorVer15 parentMessage) {
    ...
    public OFBsnTableFullError.Builder setData(OFErrorCauseData data) {
        ...
        public OFBsnTableFullError build() {
                ...
                //
                return new OFBsnTableFullErrorVer15(
                    xid,
                    errMsg,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTableFullError> {
        ...
        public OFBsnTableFullError readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTableFullErrorVer15 bsnTableFullErrorVer15 = new OFBsnTableFullErrorVer15(
                    xid,
                      errMsg,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTableFullErrorVer15);
            return bsnTableFullErrorVer15;
        }
    }
    ...
    final static OFBsnTableFullErrorVer15Funnel FUNNEL = new OFBsnTableFullErrorVer15Funnel();
    static class OFBsnTableFullErrorVer15Funnel implements Funnel<OFBsnTableFullErrorVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTableFullErrorVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnTableFullErrorVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnTableFullErrorVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTableFullErrorVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTableFullErrorVer15 other = (OFBsnTableFullErrorVer15) obj;
