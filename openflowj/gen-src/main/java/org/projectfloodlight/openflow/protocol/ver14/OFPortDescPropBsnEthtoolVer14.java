...
//
    ...
    OFPortDescPropBsnEthtoolVer14(Set<OFBsnModuleEepromIdentifier> identifier, Set<OFBsnModuleEepromExtendedIdentifier> extidentifier, Set<OFBsnModuleEepromConnector> connector, String transdata, Set<OFBsnModuleEepromEncoding> encoding, OFBsnUnit brNominal, Set<OFBsnModuleEepromRateIdentifier> rateidentifier, OFBsnUnit lengthSmfKm, OFBsnUnit lengthSmf, OFBsnUnit length50Um, OFBsnUnit length625Um, OFBsnUnit lengthCopper, OFBsnUnit lengthOm3, String vendorName, String vendorOui, String vendorPn, String vendorRev, OFPortDescPropCompliance cmplnce, List<OFPortDescProp> moreProperties) {
        ...
        if(vendorName == null) {
            throw new NullPointerException("OFPortDescPropBsnEthtoolVer14: property vendorName cannot be null");
        }
        if(vendorOui == null) {
            throw new NullPointerException("OFPortDescPropBsnEthtoolVer14: property vendorOui cannot be null");
        }
        if(vendorPn == null) {
            throw new NullPointerException("OFPortDescPropBsnEthtoolVer14: property vendorPn cannot be null");
        }
        if(vendorRev == null) {
            throw new NullPointerException("OFPortDescPropBsnEthtoolVer14: property vendorRev cannot be null");
        }
        if(cmplnce == null) {
            throw new NullPointerException("OFPortDescPropBsnEthtoolVer14: property cmplnce cannot be null");
        }
...
//
    ...
    static class Reader implements OFMessageReader<OFPortDescPropBsnEthtool> {
        ...
        public OFPortDescPropBsnEthtool readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFPortDescPropCompliance cmplnce = OFPortDescPropComplianceVer14.READER.readFrom(bb);
