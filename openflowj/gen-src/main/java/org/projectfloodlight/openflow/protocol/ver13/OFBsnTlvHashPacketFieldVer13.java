...
class OFBsnTlvHashPacketFieldVer13 implements OFBsnTlvHashPacketField {
...
//
    ...
    final static OFBsnTlvHashPacketFieldVer13 DEFAULT = new OFBsnTlvHashPacketFieldVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvHashPacketField> {
        ...
        public OFBsnTlvHashPacketField readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvHashPacketFieldVer13 bsnTlvHashPacketFieldVer13 = new OFBsnTlvHashPacketFieldVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvHashPacketFieldVer13);
    ...
    final static OFBsnTlvHashPacketFieldVer13Funnel FUNNEL = new OFBsnTlvHashPacketFieldVer13Funnel();
    static class OFBsnTlvHashPacketFieldVer13Funnel implements Funnel<OFBsnTlvHashPacketFieldVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvHashPacketFieldVer13> {
        @Override
