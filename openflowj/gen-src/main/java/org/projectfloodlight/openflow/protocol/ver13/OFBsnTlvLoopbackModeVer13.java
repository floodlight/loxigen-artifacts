...
class OFBsnTlvLoopbackModeVer13 implements OFBsnTlvLoopbackMode {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvLoopbackMode> {
        @Override
        public OFBsnTlvLoopbackMode readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvLoopbackModeVer13 bsnTlvLoopbackModeVer13 = new OFBsnTlvLoopbackModeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvLoopbackModeVer13);
    ...
    final static OFBsnTlvLoopbackModeVer13Funnel FUNNEL = new OFBsnTlvLoopbackModeVer13Funnel();
    static class OFBsnTlvLoopbackModeVer13Funnel implements Funnel<OFBsnTlvLoopbackModeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvLoopbackModeVer13> {
        @Override
