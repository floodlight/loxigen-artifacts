...
class OFBsnLacpConvergenceNotifVer15 implements OFBsnLacpConvergenceNotif {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnLacpConvergenceNotifVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnLacpConvergenceNotifVer15 DEFAULT = new OFBsnLacpConvergenceNotifVer15(
    ...
    OFBsnLacpConvergenceNotifVer15(long xid, short convergenceStatus, OFPort portNo, int actorSysPriority, MacAddress actorSysMac, int actorPortPriority, int actorPortNum, int actorKey, int partnerSysPriority, MacAddress partnerSysMac, int partnerPortPriority, int partnerPortNum, int partnerKey) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnLacpConvergenceNotifVer15: property portNo cannot be null");
        }
        if(actorSysMac == null) {
            throw new NullPointerException("OFBsnLacpConvergenceNotifVer15: property actorSysMac cannot be null");
        }
        if(partnerSysMac == null) {
            throw new NullPointerException("OFBsnLacpConvergenceNotifVer15: property partnerSysMac cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnLacpConvergenceNotif.Builder {
        final OFBsnLacpConvergenceNotifVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnLacpConvergenceNotifVer15 parentMessage) {
    ...
    public OFBsnLacpConvergenceNotif.Builder setPartnerKey(int partnerKey) {
        ...
        public OFBsnLacpConvergenceNotif build() {
                ...
                //
                return new OFBsnLacpConvergenceNotifVer15(
                    xid,
                    convergenceStatus,
                    portNo,
                    actorSysPriority,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnLacpConvergenceNotif> {
        ...
        public OFBsnLacpConvergenceNotif readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnLacpConvergenceNotifVer15 bsnLacpConvergenceNotifVer15 = new OFBsnLacpConvergenceNotifVer15(
                    xid,
                      convergenceStatus,
                      portNo,
                      actorSysPriority,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLacpConvergenceNotifVer15);
            return bsnLacpConvergenceNotifVer15;
        }
    }
    ...
    final static OFBsnLacpConvergenceNotifVer15Funnel FUNNEL = new OFBsnLacpConvergenceNotifVer15Funnel();
    static class OFBsnLacpConvergenceNotifVer15Funnel implements Funnel<OFBsnLacpConvergenceNotifVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnLacpConvergenceNotifVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnLacpConvergenceNotifVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnLacpConvergenceNotifVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnLacpConvergenceNotifVer15(");
