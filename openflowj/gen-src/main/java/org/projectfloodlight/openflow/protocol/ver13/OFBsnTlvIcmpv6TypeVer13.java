...
class OFBsnTlvIcmpv6TypeVer13 implements OFBsnTlvIcmpv6Type {
...
//
    ...
    final static OFBsnTlvIcmpv6TypeVer13 DEFAULT = new OFBsnTlvIcmpv6TypeVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvIcmpv6Type> {
        ...
        public OFBsnTlvIcmpv6Type readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvIcmpv6TypeVer13 bsnTlvIcmpv6TypeVer13 = new OFBsnTlvIcmpv6TypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvIcmpv6TypeVer13);
    ...
    final static OFBsnTlvIcmpv6TypeVer13Funnel FUNNEL = new OFBsnTlvIcmpv6TypeVer13Funnel();
    static class OFBsnTlvIcmpv6TypeVer13Funnel implements Funnel<OFBsnTlvIcmpv6TypeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvIcmpv6TypeVer13> {
        @Override
