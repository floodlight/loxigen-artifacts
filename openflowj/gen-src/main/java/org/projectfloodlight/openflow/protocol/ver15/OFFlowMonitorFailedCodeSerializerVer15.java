...
public class OFFlowMonitorFailedCodeSerializerVer15 {
    ...
    public static OFFlowMonitorFailedCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFFlowMonitorFailedCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFFlowMonitorFailedCode e) {
        switch(e) {
            ...
            case BAD_OUT:
                return BAD_OUT_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFFlowMonitorFailedCode in version 1.5: " + e);
        }
    }
