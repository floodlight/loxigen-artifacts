...
public class OFBsnPortSpeedGbpsTypeSerializerVer14 {
    ...
    public static OFBsnPortSpeedGbpsType ofWireValue(int val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnPortSpeedGbpsType in version 1.4: " + val);
        }
    }
    ...
    public static int toWireValue(OFBsnPortSpeedGbpsType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnPortSpeedGbpsType in version 1.4: " + e);
        }
    }
