...
class OFBsnTlvTcpDstVer15 implements OFBsnTlvTcpDst {
...
//
    ...
    final static OFBsnTlvTcpDstVer15 DEFAULT = new OFBsnTlvTcpDstVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvTcpDst> {
        @Override
        public OFBsnTlvTcpDst readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvTcpDstVer15 bsnTlvTcpDstVer15 = new OFBsnTlvTcpDstVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvTcpDstVer15);
    ...
    final static OFBsnTlvTcpDstVer15Funnel FUNNEL = new OFBsnTlvTcpDstVer15Funnel();
    static class OFBsnTlvTcpDstVer15Funnel implements Funnel<OFBsnTlvTcpDstVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvTcpDstVer15> {
        @Override
