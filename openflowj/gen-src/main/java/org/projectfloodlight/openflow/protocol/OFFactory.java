...
public interface OFFactory extends XidGenerator {
    ...
    OFActionIdBsnMirror actionIdBsnMirror();
    OFActionIdBsnSetTunnelDst actionIdBsnSetTunnelDst();
    OFActionIdCopyTtlIn actionIdCopyTtlIn();
    OFActionIdCopyTtlOut actionIdCopyTtlOut();
    OFActionIdDecMplsTtl actionIdDecMplsTtl();
    OFActionIdDecNwTtl actionIdDecNwTtl();
    OFActionIdGroup actionIdGroup();
    OFActionIdNiciraDecTtl actionIdNiciraDecTtl();
    OFActionIdOutput actionIdOutput();
    OFActionIdPopMpls actionIdPopMpls();
    OFActionIdPopPbb actionIdPopPbb();
    OFActionIdPopVlan actionIdPopVlan();
    OFActionIdPushMpls actionIdPushMpls();
    OFActionIdPushPbb actionIdPushPbb();
    OFActionIdPushVlan actionIdPushVlan();
    OFActionIdSetField actionIdSetField();
    OFActionIdSetMplsTtl actionIdSetMplsTtl();
    OFActionIdSetNwTtl actionIdSetNwTtl();
    OFActionIdSetQueue actionIdSetQueue();
    ...
    OFInstructionIdApplyActions instructionIdApplyActions();
    OFInstructionIdBsnDisableSrcMacCheck instructionIdBsnDisableSrcMacCheck();
    OFInstructionIdClearActions instructionIdClearActions();
    OFInstructionIdGotoTable instructionIdGotoTable();
    OFInstructionIdMeter instructionIdMeter();
    OFInstructionIdWriteActions instructionIdWriteActions();
    OFInstructionIdWriteMetadata instructionIdWriteMetadata();
