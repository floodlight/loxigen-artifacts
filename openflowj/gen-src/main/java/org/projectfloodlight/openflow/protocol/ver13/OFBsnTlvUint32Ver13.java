...
class OFBsnTlvUint32Ver13 implements OFBsnTlvUint32 {
...
//
    ...
    final static OFBsnTlvUint32Ver13 DEFAULT = new OFBsnTlvUint32Ver13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvUint32> {
        ...
        public OFBsnTlvUint32 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvUint32Ver13 bsnTlvUint32Ver13 = new OFBsnTlvUint32Ver13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvUint32Ver13);
    ...
    final static OFBsnTlvUint32Ver13Funnel FUNNEL = new OFBsnTlvUint32Ver13Funnel();
    static class OFBsnTlvUint32Ver13Funnel implements Funnel<OFBsnTlvUint32Ver13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvUint32Ver13> {
        @Override
