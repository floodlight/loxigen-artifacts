...
class OFPacketQueueVer15 implements OFPacketQueue {
...
//
    ...
    final static OFPacketQueueVer15 DEFAULT = new OFPacketQueueVer15(
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFPacketQueue> {
        ...
        public OFPacketQueue readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            // pad: 6 bytes
            bb.skipBytes(6);
            List<OFQueueProp> properties = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFQueuePropVer15.READER);

            OFPacketQueueVer15 packetQueueVer15 = new OFPacketQueueVer15(
                    queueId,
                      port,
                      properties
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", packetQueueVer15);
    ...
    final static OFPacketQueueVer15Funnel FUNNEL = new OFPacketQueueVer15Funnel();
