        ...
        public OFExperimenterStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               case 0x5c16c7:
                   ...
                   return OFBsnStatsReplyVer11.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFExperimenterStatsReplyVer11.class, "experimenter", experimenter);
            }
            // pad: 4 bytes
            bb.skipBytes(4);
