...
class OFBsnTlvMetadataVer14 implements OFBsnTlvMetadata {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvMetadata> {
        ...
        public OFBsnTlvMetadata readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvMetadataVer14 bsnTlvMetadataVer14 = new OFBsnTlvMetadataVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvMetadataVer14);
    ...
    final static OFBsnTlvMetadataVer14Funnel FUNNEL = new OFBsnTlvMetadataVer14Funnel();
    static class OFBsnTlvMetadataVer14Funnel implements Funnel<OFBsnTlvMetadataVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvMetadataVer14> {
        @Override
