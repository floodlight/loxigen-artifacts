...
class OFBsnLacpStatsRequestVer15 implements OFBsnLacpStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnLacpStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnLacpStatsRequestVer15 DEFAULT = new OFBsnLacpStatsRequestVer15(
        DEFAULT_XID, DEFAULT_FLAGS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnLacpStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags) {
        if(flags == null) {
            throw new NullPointerException("OFBsnLacpStatsRequestVer15: property flags cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    }
    ...
    static class BuilderWithParent implements OFBsnLacpStatsRequest.Builder {
        final OFBsnLacpStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnLacpStatsRequestVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnLacpStatsRequest> {
        ...
        public OFBsnLacpStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnLacpStatsRequestVer15 bsnLacpStatsRequestVer15 = new OFBsnLacpStatsRequestVer15(
                    xid,
                      flags
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLacpStatsRequestVer15);
            return bsnLacpStatsRequestVer15;
        }
    }
    ...
    final static OFBsnLacpStatsRequestVer15Funnel FUNNEL = new OFBsnLacpStatsRequestVer15Funnel();
    static class OFBsnLacpStatsRequestVer15Funnel implements Funnel<OFBsnLacpStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnLacpStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnLacpStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnLacpStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnLacpStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnLacpStatsRequestVer15 other = (OFBsnLacpStatsRequestVer15) obj;
