...
class OFOxmArpShaMaskedVer15 implements OFOxmArpShaMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmArpShaMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmArpShaMaskedVer15 DEFAULT = new OFOxmArpShaMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmArpShaMaskedVer15(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmArpShaMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmArpShaMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmArpShaMasked.Builder {
        final OFOxmArpShaMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmArpShaMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmArpShaMasked> {
        ...
        public OFOxmArpShaMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmArpShaMaskedVer15 oxmArpShaMaskedVer15 = new OFOxmArpShaMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpShaMaskedVer15);
            return oxmArpShaMaskedVer15;
        }
    }
    ...
    final static OFOxmArpShaMaskedVer15Funnel FUNNEL = new OFOxmArpShaMaskedVer15Funnel();
    static class OFOxmArpShaMaskedVer15Funnel implements Funnel<OFOxmArpShaMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmArpShaMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x8000310cL
    ...
    static class Writer implements OFMessageWriter<OFOxmArpShaMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmArpShaMaskedVer15 message) {
            // fixed value property typeLen = 0x8000310cL
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmArpShaMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmArpShaMaskedVer15 other = (OFOxmArpShaMaskedVer15) obj;
