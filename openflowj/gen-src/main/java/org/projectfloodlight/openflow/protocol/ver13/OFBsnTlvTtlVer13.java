...
class OFBsnTlvTtlVer13 implements OFBsnTlvTtl {
...
//
    ...
    final static OFBsnTlvTtlVer13 DEFAULT = new OFBsnTlvTtlVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvTtl> {
        ...
        public OFBsnTlvTtl readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvTtlVer13 bsnTlvTtlVer13 = new OFBsnTlvTtlVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvTtlVer13);
    ...
    final static OFBsnTlvTtlVer13Funnel FUNNEL = new OFBsnTlvTtlVer13Funnel();
