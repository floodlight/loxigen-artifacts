...
class OFQueueStatsRequestVer15 implements OFQueueStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFQueueStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFQueueStatsRequestVer15 DEFAULT = new OFQueueStatsRequestVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_PORT_NO, DEFAULT_QUEUE_ID
    );

    // package private constructor - used by readers, builders, and factory
    OFQueueStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags, OFPort portNo, long queueId) {
        if(flags == null) {
            throw new NullPointerException("OFQueueStatsRequestVer15: property flags cannot be null");
        }
        if(portNo == null) {
            throw new NullPointerException("OFQueueStatsRequestVer15: property portNo cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFQueueStatsRequest.Builder {
        final OFQueueStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFQueueStatsRequestVer15 parentMessage) {
    ...
    public OFQueueStatsRequest.Builder setQueueId(long queueId) {
        ...
        public OFQueueStatsRequest build() {
                ...
                //
                return new OFQueueStatsRequestVer15(
                    xid,
                    flags,
                    portNo,
                    queueId
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueStatsRequest> {
        ...
        public OFQueueStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFQueueStatsRequestVer15 queueStatsRequestVer15 = new OFQueueStatsRequestVer15(
                    xid,
                      flags,
                      portNo,
                      queueId
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueStatsRequestVer15);
            return queueStatsRequestVer15;
        }
    }
    ...
    final static OFQueueStatsRequestVer15Funnel FUNNEL = new OFQueueStatsRequestVer15Funnel();
    static class OFQueueStatsRequestVer15Funnel implements Funnel<OFQueueStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFQueueStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFQueueStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueStatsRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueStatsRequestVer15 other = (OFQueueStatsRequestVer15) obj;
