...
class OFBsnPduRxRequestVer15 implements OFBsnPduRxRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnPduRxRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnPduRxRequestVer15 DEFAULT = new OFBsnPduRxRequestVer15(
        DEFAULT_XID, DEFAULT_TIMEOUT_MS, DEFAULT_PORT_NO, DEFAULT_SLOT_NUM, DEFAULT_DATA
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnPduRxRequestVer15(long xid, long timeoutMs, OFPort portNo, short slotNum, byte[] data) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnPduRxRequestVer15: property portNo cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBsnPduRxRequestVer15: property data cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnPduRxRequest.Builder {
        final OFBsnPduRxRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnPduRxRequestVer15 parentMessage) {
    ...
    public OFBsnPduRxRequest.Builder setData(byte[] data) {
        ...
        public OFBsnPduRxRequest build() {
                ...
                //
                return new OFBsnPduRxRequestVer15(
                    xid,
                    timeoutMs,
                    portNo,
                    slotNum,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnPduRxRequest> {
        ...
        public OFBsnPduRxRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnPduRxRequestVer15 bsnPduRxRequestVer15 = new OFBsnPduRxRequestVer15(
                    xid,
                      timeoutMs,
                      portNo,
                      slotNum,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnPduRxRequestVer15);
            return bsnPduRxRequestVer15;
        }
    }
    ...
    final static OFBsnPduRxRequestVer15Funnel FUNNEL = new OFBsnPduRxRequestVer15Funnel();
    static class OFBsnPduRxRequestVer15Funnel implements Funnel<OFBsnPduRxRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnPduRxRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnPduRxRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnPduRxRequestVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnPduRxRequestVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnPduRxRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnPduRxRequestVer15 other = (OFBsnPduRxRequestVer15) obj;
