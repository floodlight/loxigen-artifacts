...
class OFTableFeaturePropWriteActionsVer15 implements OFTableFeaturePropWriteActions {
    private static final Logger logger = LoggerFactory.getLogger(OFTableFeaturePropWriteActionsVer15.class);
    // version: 1.5
...
//
    ...
    final static OFTableFeaturePropWriteActionsVer15 DEFAULT = new OFTableFeaturePropWriteActionsVer15(
        DEFAULT_ACTION_IDS
    );

    // package private constructor - used by readers, builders, and factory
    OFTableFeaturePropWriteActionsVer15(List<OFActionId> actionIds) {
        if(actionIds == null) {
            throw new NullPointerException("OFTableFeaturePropWriteActionsVer15: property actionIds cannot be null");
        }
    ...
    static class BuilderWithParent implements OFTableFeaturePropWriteActions.Builder {
        final OFTableFeaturePropWriteActionsVer15 parentMessage;

        // OF message fields
        private boolean actionIdsSet;
        private List<OFActionId> actionIds;

        BuilderWithParent(OFTableFeaturePropWriteActionsVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturePropWriteActions> {
        ...
        public OFTableFeaturePropWriteActions readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableFeaturePropWriteActionsVer15);
            return tableFeaturePropWriteActionsVer15;
        }
    }
    ...
    final static OFTableFeaturePropWriteActionsVer15Funnel FUNNEL = new OFTableFeaturePropWriteActionsVer15Funnel();
    static class OFTableFeaturePropWriteActionsVer15Funnel implements Funnel<OFTableFeaturePropWriteActionsVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableFeaturePropWriteActionsVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0x4
    ...
    static class Writer implements OFMessageWriter<OFTableFeaturePropWriteActionsVer15> {
        @Override
        public void write(ByteBuf bb, OFTableFeaturePropWriteActionsVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFTableFeaturePropWriteActionsVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableFeaturePropWriteActionsVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableFeaturePropWriteActionsVer15 other = (OFTableFeaturePropWriteActionsVer15) obj;
