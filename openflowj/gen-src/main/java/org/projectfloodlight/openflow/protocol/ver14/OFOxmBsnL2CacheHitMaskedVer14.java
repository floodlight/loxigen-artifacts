...
class OFOxmBsnL2CacheHitMaskedVer14 implements OFOxmBsnL2CacheHitMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnL2CacheHitMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmBsnL2CacheHitMaskedVer14 DEFAULT = new OFOxmBsnL2CacheHitMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnL2CacheHitMaskedVer14(OFBooleanValue value, OFBooleanValue mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnL2CacheHitMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnL2CacheHitMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<OFBooleanValue> getCanonical() {
        if (OFBooleanValue.NO_MASK.equals(mask)) {
            return new OFOxmBsnL2CacheHitVer14(value);
    ...
    static class BuilderWithParent implements OFOxmBsnL2CacheHitMasked.Builder {
        final OFOxmBsnL2CacheHitMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnL2CacheHitMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnL2CacheHitMasked> {
        ...
        public OFOxmBsnL2CacheHitMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnL2CacheHitMaskedVer14 oxmBsnL2CacheHitMaskedVer14 = new OFOxmBsnL2CacheHitMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnL2CacheHitMaskedVer14);
            return oxmBsnL2CacheHitMaskedVer14;
        }
    }
    ...
    final static OFOxmBsnL2CacheHitMaskedVer14Funnel FUNNEL = new OFOxmBsnL2CacheHitMaskedVer14Funnel();
    static class OFOxmBsnL2CacheHitMaskedVer14Funnel implements Funnel<OFOxmBsnL2CacheHitMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnL2CacheHitMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32502L
            sink.putInt(0x32502);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnL2CacheHitMaskedVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnL2CacheHitMaskedVer14 message) {
            // fixed value property typeLen = 0x32502L
            bb.writeInt(0x32502);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnL2CacheHitMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnL2CacheHitMaskedVer14 other = (OFOxmBsnL2CacheHitMaskedVer14) obj;
