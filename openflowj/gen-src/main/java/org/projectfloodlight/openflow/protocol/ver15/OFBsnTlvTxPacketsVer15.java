...
class OFBsnTlvTxPacketsVer15 implements OFBsnTlvTxPackets {
...
//
    ...
    final static OFBsnTlvTxPacketsVer15 DEFAULT = new OFBsnTlvTxPacketsVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvTxPackets> {
        ...
        public OFBsnTlvTxPackets readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvTxPacketsVer15 bsnTlvTxPacketsVer15 = new OFBsnTlvTxPacketsVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvTxPacketsVer15);
    ...
    final static OFBsnTlvTxPacketsVer15Funnel FUNNEL = new OFBsnTlvTxPacketsVer15Funnel();
    static class OFBsnTlvTxPacketsVer15Funnel implements Funnel<OFBsnTlvTxPacketsVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvTxPacketsVer15> {
        @Override
