...
class OFBsnTlvNextHopMacVer14 implements OFBsnTlvNextHopMac {
...
//
    ...
    final static OFBsnTlvNextHopMacVer14 DEFAULT = new OFBsnTlvNextHopMacVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvNextHopMac> {
        ...
        public OFBsnTlvNextHopMac readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvNextHopMacVer14 bsnTlvNextHopMacVer14 = new OFBsnTlvNextHopMacVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvNextHopMacVer14);
    ...
    final static OFBsnTlvNextHopMacVer14Funnel FUNNEL = new OFBsnTlvNextHopMacVer14Funnel();
    static class OFBsnTlvNextHopMacVer14Funnel implements Funnel<OFBsnTlvNextHopMacVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvNextHopMacVer14> {
        @Override
