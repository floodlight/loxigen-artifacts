...
class OFBsnTlvPassiveVer15 implements OFBsnTlvPassive {
...
//
    ...
    final static OFBsnTlvPassiveVer15 DEFAULT = new OFBsnTlvPassiveVer15(

    );

    final static OFBsnTlvPassiveVer15 INSTANCE = new OFBsnTlvPassiveVer15();
    ...
    final static OFBsnTlvPassiveVer15Funnel FUNNEL = new OFBsnTlvPassiveVer15Funnel();
    static class OFBsnTlvPassiveVer15Funnel implements Funnel<OFBsnTlvPassiveVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvPassiveVer15> {
        @Override
