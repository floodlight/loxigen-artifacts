...
class OFOxmBsnInPorts512Ver15 implements OFOxmBsnInPorts512 {
...
//
    ...
    final static OFOxmBsnInPorts512Ver15 DEFAULT = new OFOxmBsnInPorts512Ver15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnInPorts512Ver15(OFBitMask512 value) {
        if(value == null) {
    ...
    static class BuilderWithParent implements OFOxmBsnInPorts512.Builder {
        ...
        BuilderWithParent(OFOxmBsnInPorts512Ver15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInPorts512> {
        ...
        public OFOxmBsnInPorts512 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInPorts512Ver15 oxmBsnInPorts512Ver15 = new OFOxmBsnInPorts512Ver15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInPorts512Ver15);
            return oxmBsnInPorts512Ver15;
        }
    }
    ...
    final static OFOxmBsnInPorts512Ver15Funnel FUNNEL = new OFOxmBsnInPorts512Ver15Funnel();
    static class OFOxmBsnInPorts512Ver15Funnel implements Funnel<OFOxmBsnInPorts512Ver15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnInPorts512Ver15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32640L
            sink.putInt(0x32640);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInPorts512Ver15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInPorts512Ver15 message) {
            // fixed value property typeLen = 0x32640L
            bb.writeInt(0x32640);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnInPorts512Ver15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnInPorts512Ver15 other = (OFOxmBsnInPorts512Ver15) obj;
