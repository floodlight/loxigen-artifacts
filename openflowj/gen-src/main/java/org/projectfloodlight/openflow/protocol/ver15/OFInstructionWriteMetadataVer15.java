...
class OFInstructionWriteMetadataVer15 implements OFInstructionWriteMetadata {
    private static final Logger logger = LoggerFactory.getLogger(OFInstructionWriteMetadataVer15.class);
    // version: 1.5
...
//
    ...
    final static OFInstructionWriteMetadataVer15 DEFAULT = new OFInstructionWriteMetadataVer15(
        DEFAULT_METADATA, DEFAULT_METADATA_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFInstructionWriteMetadataVer15(U64 metadata, U64 metadataMask) {
        if(metadata == null) {
            throw new NullPointerException("OFInstructionWriteMetadataVer15: property metadata cannot be null");
        }
        if(metadataMask == null) {
            throw new NullPointerException("OFInstructionWriteMetadataVer15: property metadataMask cannot be null");
        }
    ...
    static class BuilderWithParent implements OFInstructionWriteMetadata.Builder {
        final OFInstructionWriteMetadataVer15 parentMessage;
        ...
        BuilderWithParent(OFInstructionWriteMetadataVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFInstructionWriteMetadata> {
        ...
        public OFInstructionWriteMetadata readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFInstructionWriteMetadataVer15 instructionWriteMetadataVer15 = new OFInstructionWriteMetadataVer15(
                    metadata,
                      metadataMask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", instructionWriteMetadataVer15);
            return instructionWriteMetadataVer15;
        }
    }
    ...
    final static OFInstructionWriteMetadataVer15Funnel FUNNEL = new OFInstructionWriteMetadataVer15Funnel();
    static class OFInstructionWriteMetadataVer15Funnel implements Funnel<OFInstructionWriteMetadataVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFInstructionWriteMetadataVer15 message, PrimitiveSink sink) {
            // fixed value property type = 2
    ...
    static class Writer implements OFMessageWriter<OFInstructionWriteMetadataVer15> {
        @Override
        public void write(ByteBuf bb, OFInstructionWriteMetadataVer15 message) {
            // fixed value property type = 2
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFInstructionWriteMetadataVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFInstructionWriteMetadataVer15 other = (OFInstructionWriteMetadataVer15) obj;
