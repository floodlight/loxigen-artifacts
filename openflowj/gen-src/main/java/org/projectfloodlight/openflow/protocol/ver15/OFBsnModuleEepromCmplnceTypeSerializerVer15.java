...
public class OFBsnModuleEepromCmplnceTypeSerializerVer15 {
        ...
        for(OFBsnModuleEepromCmplnceType e: set) {
            switch(e) {
                ...
                case BSN_MODULE_EEPROM_COMPLIANCE_TYPE_CU_ACTIVE:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Illegal enum value for type OFBsnModuleEepromCmplnceType in version 1.5: " + e);
            }
        }
        return wireValue;
    }
