...
class OFBsnTlvTunnelCapabilityVer15 implements OFBsnTlvTunnelCapability {
...
//
    ...
    final static OFBsnTlvTunnelCapabilityVer15 DEFAULT = new OFBsnTlvTunnelCapabilityVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvTunnelCapability> {
        ...
        public OFBsnTlvTunnelCapability readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvTunnelCapabilityVer15 bsnTlvTunnelCapabilityVer15 = new OFBsnTlvTunnelCapabilityVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvTunnelCapabilityVer15);
    ...
    final static OFBsnTlvTunnelCapabilityVer15Funnel FUNNEL = new OFBsnTlvTunnelCapabilityVer15Funnel();
    static class OFBsnTlvTunnelCapabilityVer15Funnel implements Funnel<OFBsnTlvTunnelCapabilityVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvTunnelCapabilityVer15> {
        @Override
