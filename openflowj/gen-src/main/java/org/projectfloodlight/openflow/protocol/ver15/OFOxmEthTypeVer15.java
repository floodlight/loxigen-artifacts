...
class OFOxmEthTypeVer15 implements OFOxmEthType {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmEthTypeVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmEthTypeVer15 DEFAULT = new OFOxmEthTypeVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmEthTypeVer15(EthType value) {
        if(value == null) {
            throw new NullPointerException("OFOxmEthTypeVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmEthType.Builder {
        final OFOxmEthTypeVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private EthType value;

        BuilderWithParent(OFOxmEthTypeVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmEthType> {
        ...
        public OFOxmEthType readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmEthTypeVer15 oxmEthTypeVer15 = new OFOxmEthTypeVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmEthTypeVer15);
            return oxmEthTypeVer15;
        }
    }
    ...
    final static OFOxmEthTypeVer15Funnel FUNNEL = new OFOxmEthTypeVer15Funnel();
    static class OFOxmEthTypeVer15Funnel implements Funnel<OFOxmEthTypeVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmEthTypeVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80000a02L
    ...
    static class Writer implements OFMessageWriter<OFOxmEthTypeVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmEthTypeVer15 message) {
            // fixed value property typeLen = 0x80000a02L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmEthTypeVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmEthTypeVer15 other = (OFOxmEthTypeVer15) obj;
