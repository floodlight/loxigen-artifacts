...
public class OFBsnDecapSerializerVer15 {
    ...
    public static OFBsnDecap ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnDecap in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnDecap e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnDecap in version 1.5: " + e);
        }
    }
