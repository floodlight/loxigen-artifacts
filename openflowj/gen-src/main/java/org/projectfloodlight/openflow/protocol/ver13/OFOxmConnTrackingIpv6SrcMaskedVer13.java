...
class OFOxmConnTrackingIpv6SrcMaskedVer13 implements OFOxmConnTrackingIpv6SrcMasked {
...
//
    ...
    final static OFOxmConnTrackingIpv6SrcMaskedVer13 DEFAULT = new OFOxmConnTrackingIpv6SrcMaskedVer13(
    ...
    public OFOxm<IPv6Address> getCanonical() {
        if (IPv6Address.NO_MASK.equals(mask)) {
            return new OFOxmConnTrackingIpv6SrcVer13(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConnTrackingIpv6SrcMasked> {
        ...
        public OFOxmConnTrackingIpv6SrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConnTrackingIpv6SrcMaskedVer13 oxmConnTrackingIpv6SrcMaskedVer13 = new OFOxmConnTrackingIpv6SrcMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConnTrackingIpv6SrcMaskedVer13);
    ...
    final static OFOxmConnTrackingIpv6SrcMaskedVer13Funnel FUNNEL = new OFOxmConnTrackingIpv6SrcMaskedVer13Funnel();
    static class OFOxmConnTrackingIpv6SrcMaskedVer13Funnel implements Funnel<OFOxmConnTrackingIpv6SrcMaskedVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConnTrackingIpv6SrcMaskedVer13> {
        @Override
