...
class OFOxmVlanPcpMaskedVer15 implements OFOxmVlanPcpMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmVlanPcpMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmVlanPcpMaskedVer15 DEFAULT = new OFOxmVlanPcpMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmVlanPcpMaskedVer15(VlanPcp value, VlanPcp mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmVlanPcpMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmVlanPcpMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmVlanPcpMasked.Builder {
        final OFOxmVlanPcpMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmVlanPcpMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmVlanPcpMasked> {
        ...
        public OFOxmVlanPcpMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmVlanPcpMaskedVer15 oxmVlanPcpMaskedVer15 = new OFOxmVlanPcpMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmVlanPcpMaskedVer15);
            return oxmVlanPcpMaskedVer15;
        }
    }
    ...
    final static OFOxmVlanPcpMaskedVer15Funnel FUNNEL = new OFOxmVlanPcpMaskedVer15Funnel();
    static class OFOxmVlanPcpMaskedVer15Funnel implements Funnel<OFOxmVlanPcpMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmVlanPcpMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80000f02L
    ...
    static class Writer implements OFMessageWriter<OFOxmVlanPcpMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmVlanPcpMaskedVer15 message) {
            // fixed value property typeLen = 0x80000f02L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmVlanPcpMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmVlanPcpMaskedVer15 other = (OFOxmVlanPcpMaskedVer15) obj;
