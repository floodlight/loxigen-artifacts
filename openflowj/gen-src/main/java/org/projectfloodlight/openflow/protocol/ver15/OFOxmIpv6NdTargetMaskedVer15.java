...
class OFOxmIpv6NdTargetMaskedVer15 implements OFOxmIpv6NdTargetMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6NdTargetMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6NdTargetMaskedVer15 DEFAULT = new OFOxmIpv6NdTargetMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6NdTargetMaskedVer15(IPv6Address value, IPv6Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6NdTargetMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv6NdTargetMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IPv6Address> getCanonical() {
        if (IPv6Address.NO_MASK.equals(mask)) {
            return new OFOxmIpv6NdTargetVer15(value);
    ...
    static class BuilderWithParent implements OFOxmIpv6NdTargetMasked.Builder {
        final OFOxmIpv6NdTargetMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv6NdTargetMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6NdTargetMasked> {
        ...
        public OFOxmIpv6NdTargetMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6NdTargetMaskedVer15 oxmIpv6NdTargetMaskedVer15 = new OFOxmIpv6NdTargetMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6NdTargetMaskedVer15);
            return oxmIpv6NdTargetMaskedVer15;
        }
    }
    ...
    final static OFOxmIpv6NdTargetMaskedVer15Funnel FUNNEL = new OFOxmIpv6NdTargetMaskedVer15Funnel();
    static class OFOxmIpv6NdTargetMaskedVer15Funnel implements Funnel<OFOxmIpv6NdTargetMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6NdTargetMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003f20L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6NdTargetMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6NdTargetMaskedVer15 message) {
            // fixed value property typeLen = 0x80003f20L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6NdTargetMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6NdTargetMaskedVer15 other = (OFOxmIpv6NdTargetMaskedVer15) obj;
