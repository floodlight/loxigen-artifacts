...
class OFBsnTlvIpTunnelTypeVer13 implements OFBsnTlvIpTunnelType {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvIpTunnelType> {
        ...
        public OFBsnTlvIpTunnelType readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvIpTunnelTypeVer13 bsnTlvIpTunnelTypeVer13 = new OFBsnTlvIpTunnelTypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvIpTunnelTypeVer13);
    ...
    final static OFBsnTlvIpTunnelTypeVer13Funnel FUNNEL = new OFBsnTlvIpTunnelTypeVer13Funnel();
    static class OFBsnTlvIpTunnelTypeVer13Funnel implements Funnel<OFBsnTlvIpTunnelTypeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvIpTunnelTypeVer13> {
        @Override
