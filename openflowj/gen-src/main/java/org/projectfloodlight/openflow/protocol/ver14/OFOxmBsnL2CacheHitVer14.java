...
class OFOxmBsnL2CacheHitVer14 implements OFOxmBsnL2CacheHit {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnL2CacheHitVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmBsnL2CacheHitVer14 DEFAULT = new OFOxmBsnL2CacheHitVer14(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnL2CacheHitVer14(OFBooleanValue value) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnL2CacheHitVer14: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnL2CacheHit.Builder {
        final OFOxmBsnL2CacheHitVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private OFBooleanValue value;

        BuilderWithParent(OFOxmBsnL2CacheHitVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnL2CacheHit> {
        ...
        public OFOxmBsnL2CacheHit readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnL2CacheHitVer14 oxmBsnL2CacheHitVer14 = new OFOxmBsnL2CacheHitVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnL2CacheHitVer14);
            return oxmBsnL2CacheHitVer14;
        }
    }
    ...
    final static OFOxmBsnL2CacheHitVer14Funnel FUNNEL = new OFOxmBsnL2CacheHitVer14Funnel();
    static class OFOxmBsnL2CacheHitVer14Funnel implements Funnel<OFOxmBsnL2CacheHitVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnL2CacheHitVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32401L
            sink.putInt(0x32401);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnL2CacheHitVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnL2CacheHitVer14 message) {
            // fixed value property typeLen = 0x32401L
            bb.writeInt(0x32401);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnL2CacheHitVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnL2CacheHitVer14 other = (OFOxmBsnL2CacheHitVer14) obj;
