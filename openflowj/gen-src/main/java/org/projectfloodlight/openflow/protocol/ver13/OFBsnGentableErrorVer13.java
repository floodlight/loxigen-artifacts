...
class OFBsnGentableErrorVer13 implements OFBsnGentableError {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableErrorVer13.class);
    // version: 1.3
...
//
    ...
    OFBsnGentableErrorVer13(long xid, OFBsnGentableErrorCode errorCode, GenTableId tableId, String errMsg, OFErrorCauseData data) {
        if(errorCode == null) {
            throw new NullPointerException("OFBsnGentableErrorVer13: property errorCode cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableErrorVer13: property tableId cannot be null");
        }
        if(errMsg == null) {
            throw new NullPointerException("OFBsnGentableErrorVer13: property errMsg cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBsnGentableErrorVer13: property data cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnGentableError.Builder {
        final OFBsnGentableErrorVer13 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableErrorVer13 parentMessage) {
    ...
    public OFBsnGentableError.Builder setData(OFErrorCauseData data) {
        ...
        public OFBsnGentableError build() {
                ...
                //
                return new OFBsnGentableErrorVer13(
                    xid,
                    errorCode,
                    tableId,
                    errMsg,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableError> {
        ...
        public OFBsnGentableError readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableErrorCode errorCode = OFBsnGentableErrorCodeSerializerVer13.readFrom(bb);
            ...
            OFBsnGentableErrorVer13 bsnGentableErrorVer13 = new OFBsnGentableErrorVer13(
                    xid,
                      errorCode,
                      tableId,
                      errMsg,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableErrorVer13);
            return bsnGentableErrorVer13;
        }
    }
    ...
    final static OFBsnGentableErrorVer13Funnel FUNNEL = new OFBsnGentableErrorVer13Funnel();
    static class OFBsnGentableErrorVer13Funnel implements Funnel<OFBsnGentableErrorVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableErrorVer13 message, PrimitiveSink sink) {
            // fixed value property version = 4
            ...
            OFBsnGentableErrorCodeSerializerVer13.putTo(message.errorCode, sink);
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableErrorVer13> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableErrorVer13 message) {
            ...
            OFBsnGentableErrorCodeSerializerVer13.writeTo(bb, message.errorCode);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableErrorVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableErrorVer13 other = (OFBsnGentableErrorVer13) obj;
