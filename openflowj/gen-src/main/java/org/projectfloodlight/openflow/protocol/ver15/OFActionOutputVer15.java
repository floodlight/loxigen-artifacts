...
class OFActionOutputVer15 implements OFActionOutput {
    private static final Logger logger = LoggerFactory.getLogger(OFActionOutputVer15.class);
    // version: 1.5
...
//
    ...
    final static OFActionOutputVer15 DEFAULT = new OFActionOutputVer15(
        DEFAULT_PORT, DEFAULT_MAX_LEN
    );

    // package private constructor - used by readers, builders, and factory
    OFActionOutputVer15(OFPort port, int maxLen) {
        if(port == null) {
            throw new NullPointerException("OFActionOutputVer15: property port cannot be null");
        }
        this.port = port;
        this.maxLen = maxLen;
    }
    ...
    static class BuilderWithParent implements OFActionOutput.Builder {
        final OFActionOutputVer15 parentMessage;
        ...
        BuilderWithParent(OFActionOutputVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFActionOutput> {
        ...
        public OFActionOutput readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionOutputVer15 actionOutputVer15 = new OFActionOutputVer15(
                    port,
                      maxLen
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionOutputVer15);
            return actionOutputVer15;
        }
    }
    ...
    final static OFActionOutputVer15Funnel FUNNEL = new OFActionOutputVer15Funnel();
    static class OFActionOutputVer15Funnel implements Funnel<OFActionOutputVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionOutputVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0
    ...
    static class Writer implements OFMessageWriter<OFActionOutputVer15> {
        @Override
        public void write(ByteBuf bb, OFActionOutputVer15 message) {
            // fixed value property type = 0
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionOutputVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionOutputVer15 other = (OFActionOutputVer15) obj;
