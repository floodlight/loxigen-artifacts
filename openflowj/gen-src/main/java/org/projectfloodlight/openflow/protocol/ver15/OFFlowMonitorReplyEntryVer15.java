...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFFlowMonitorReplyEntry> {
        @Override
        public OFFlowMonitorReplyEntry readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
