...
class OFBsnGentableSetBucketsSizeVer15 implements OFBsnGentableSetBucketsSize {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableSetBucketsSizeVer15.class);
    // version: 1.5
...
//
    ...
    OFBsnGentableSetBucketsSizeVer15(long xid, GenTableId tableId, long bucketsSize) {
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableSetBucketsSizeVer15: property tableId cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnGentableSetBucketsSize.Builder {
        final OFBsnGentableSetBucketsSizeVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableSetBucketsSizeVer15 parentMessage) {
    ...
    public OFBsnGentableSetBucketsSize.Builder setBucketsSize(long bucketsSize) {
        ...
        public OFBsnGentableSetBucketsSize build() {
                ...
                //
                return new OFBsnGentableSetBucketsSizeVer15(
                    xid,
                    tableId,
                    bucketsSize
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableSetBucketsSize> {
        ...
        public OFBsnGentableSetBucketsSize readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableSetBucketsSizeVer15 bsnGentableSetBucketsSizeVer15 = new OFBsnGentableSetBucketsSizeVer15(
                    xid,
                      tableId,
                      bucketsSize
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableSetBucketsSizeVer15);
            return bsnGentableSetBucketsSizeVer15;
        }
    }
    ...
    final static OFBsnGentableSetBucketsSizeVer15Funnel FUNNEL = new OFBsnGentableSetBucketsSizeVer15Funnel();
    static class OFBsnGentableSetBucketsSizeVer15Funnel implements Funnel<OFBsnGentableSetBucketsSizeVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableSetBucketsSizeVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableSetBucketsSizeVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableSetBucketsSizeVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableSetBucketsSizeVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableSetBucketsSizeVer15 other = (OFBsnGentableSetBucketsSizeVer15) obj;
