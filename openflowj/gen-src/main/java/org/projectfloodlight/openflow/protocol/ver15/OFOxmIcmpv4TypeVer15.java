...
class OFOxmIcmpv4TypeVer15 implements OFOxmIcmpv4Type {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIcmpv4TypeVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIcmpv4TypeVer15 DEFAULT = new OFOxmIcmpv4TypeVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIcmpv4TypeVer15(ICMPv4Type value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIcmpv4TypeVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIcmpv4Type.Builder {
        final OFOxmIcmpv4TypeVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private ICMPv4Type value;

        BuilderWithParent(OFOxmIcmpv4TypeVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv4Type> {
        ...
        public OFOxmIcmpv4Type readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIcmpv4TypeVer15 oxmIcmpv4TypeVer15 = new OFOxmIcmpv4TypeVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv4TypeVer15);
            return oxmIcmpv4TypeVer15;
        }
    }
    ...
    final static OFOxmIcmpv4TypeVer15Funnel FUNNEL = new OFOxmIcmpv4TypeVer15Funnel();
    static class OFOxmIcmpv4TypeVer15Funnel implements Funnel<OFOxmIcmpv4TypeVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIcmpv4TypeVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002601L
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv4TypeVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIcmpv4TypeVer15 message) {
            // fixed value property typeLen = 0x80002601L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIcmpv4TypeVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIcmpv4TypeVer15 other = (OFOxmIcmpv4TypeVer15) obj;
