...
class OFBsnTlvArpSpaVer13 implements OFBsnTlvArpSpa {
...
//
    ...
    final static OFBsnTlvArpSpaVer13 DEFAULT = new OFBsnTlvArpSpaVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvArpSpa> {
        ...
        public OFBsnTlvArpSpa readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvArpSpaVer13 bsnTlvArpSpaVer13 = new OFBsnTlvArpSpaVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvArpSpaVer13);
    ...
    final static OFBsnTlvArpSpaVer13Funnel FUNNEL = new OFBsnTlvArpSpaVer13Funnel();
    static class OFBsnTlvArpSpaVer13Funnel implements Funnel<OFBsnTlvArpSpaVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvArpSpaVer13> {
        @Override
