...
public class OFAsyncConfigFailedCodeSerializerVer15 {
    ...
    public static OFAsyncConfigFailedCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFAsyncConfigFailedCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFAsyncConfigFailedCode e) {
        switch(e) {
            ...
            case EPERM:
                return EPERM_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFAsyncConfigFailedCode in version 1.5: " + e);
        }
    }
