...
public class OFBsnHashPacketTypeSerializerVer13 {
    ...
    public static OFBsnHashPacketType ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnHashPacketType in version 1.3: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnHashPacketType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnHashPacketType in version 1.3: " + e);
        }
    }
