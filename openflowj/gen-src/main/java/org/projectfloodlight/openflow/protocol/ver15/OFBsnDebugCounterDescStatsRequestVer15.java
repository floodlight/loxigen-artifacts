...
class OFBsnDebugCounterDescStatsRequestVer15 implements OFBsnDebugCounterDescStatsRequest {
...
//
    ...
    final static OFBsnDebugCounterDescStatsRequestVer15 DEFAULT = new OFBsnDebugCounterDescStatsRequestVer15(
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnDebugCounterDescStatsRequest> {
        ...
        public OFBsnDebugCounterDescStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnDebugCounterDescStatsRequestVer15 bsnDebugCounterDescStatsRequestVer15 = new OFBsnDebugCounterDescStatsRequestVer15(
                    xid,
                      flags
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnDebugCounterDescStatsRequestVer15);
    ...
    final static OFBsnDebugCounterDescStatsRequestVer15Funnel FUNNEL = new OFBsnDebugCounterDescStatsRequestVer15Funnel();
    static class OFBsnDebugCounterDescStatsRequestVer15Funnel implements Funnel<OFBsnDebugCounterDescStatsRequestVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnDebugCounterDescStatsRequestVer15> {
        @Override
