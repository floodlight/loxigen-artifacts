...
class OFActionBsnChecksumVer15 implements OFActionBsnChecksum {
...
//
    ...
    final static OFActionBsnChecksumVer15 DEFAULT = new OFActionBsnChecksumVer15(
        DEFAULT_CHECKSUM
    );

    // package private constructor - used by readers, builders, and factory
    OFActionBsnChecksumVer15(U128 checksum) {
        if(checksum == null) {
    ...
    static class BuilderWithParent implements OFActionBsnChecksum.Builder {
        ...
        BuilderWithParent(OFActionBsnChecksumVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFActionBsnChecksum> {
        ...
        public OFActionBsnChecksum readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionBsnChecksumVer15 actionBsnChecksumVer15 = new OFActionBsnChecksumVer15(
                    checksum
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionBsnChecksumVer15);
            return actionBsnChecksumVer15;
        }
    }
    ...
    final static OFActionBsnChecksumVer15Funnel FUNNEL = new OFActionBsnChecksumVer15Funnel();
    static class OFActionBsnChecksumVer15Funnel implements Funnel<OFActionBsnChecksumVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionBsnChecksumVer15 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionBsnChecksumVer15> {
        @Override
        public void write(ByteBuf bb, OFActionBsnChecksumVer15 message) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionBsnChecksumVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionBsnChecksumVer15 other = (OFActionBsnChecksumVer15) obj;
