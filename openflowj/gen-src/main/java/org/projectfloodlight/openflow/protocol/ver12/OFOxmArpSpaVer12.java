...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmArpSpa> {
        @Override
        public OFOxmArpSpa readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
