...
class OFOxmIpv6NdSllMaskedVer15 implements OFOxmIpv6NdSllMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6NdSllMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6NdSllMaskedVer15 DEFAULT = new OFOxmIpv6NdSllMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6NdSllMaskedVer15(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6NdSllMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv6NdSllMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmIpv6NdSllVer15(value);
    ...
    static class BuilderWithParent implements OFOxmIpv6NdSllMasked.Builder {
        final OFOxmIpv6NdSllMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv6NdSllMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6NdSllMasked> {
        ...
        public OFOxmIpv6NdSllMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6NdSllMaskedVer15 oxmIpv6NdSllMaskedVer15 = new OFOxmIpv6NdSllMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6NdSllMaskedVer15);
            return oxmIpv6NdSllMaskedVer15;
        }
    }
    ...
    final static OFOxmIpv6NdSllMaskedVer15Funnel FUNNEL = new OFOxmIpv6NdSllMaskedVer15Funnel();
    static class OFOxmIpv6NdSllMaskedVer15Funnel implements Funnel<OFOxmIpv6NdSllMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6NdSllMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x8000410cL
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6NdSllMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6NdSllMaskedVer15 message) {
            // fixed value property typeLen = 0x8000410cL
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6NdSllMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6NdSllMaskedVer15 other = (OFOxmIpv6NdSllMaskedVer15) obj;
