...
class OFBsnTlvExternalNetmaskVer15 implements OFBsnTlvExternalNetmask {
...
//
    ...
    final static OFBsnTlvExternalNetmaskVer15 DEFAULT = new OFBsnTlvExternalNetmaskVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvExternalNetmask> {
        @Override
        public OFBsnTlvExternalNetmask readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvExternalNetmaskVer15 bsnTlvExternalNetmaskVer15 = new OFBsnTlvExternalNetmaskVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvExternalNetmaskVer15);
    ...
    final static OFBsnTlvExternalNetmaskVer15Funnel FUNNEL = new OFBsnTlvExternalNetmaskVer15Funnel();
    static class OFBsnTlvExternalNetmaskVer15Funnel implements Funnel<OFBsnTlvExternalNetmaskVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvExternalNetmaskVer15> {
        @Override
