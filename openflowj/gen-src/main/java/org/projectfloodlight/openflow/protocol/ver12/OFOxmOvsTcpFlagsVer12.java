...
class OFOxmOvsTcpFlagsVer12 implements OFOxmOvsTcpFlags {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmOvsTcpFlagsVer12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmOvsTcpFlagsVer12 DEFAULT = new OFOxmOvsTcpFlagsVer12(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmOvsTcpFlagsVer12(U16 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmOvsTcpFlagsVer12: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmOvsTcpFlags.Builder {
        final OFOxmOvsTcpFlagsVer12 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U16 value;

        BuilderWithParent(OFOxmOvsTcpFlagsVer12 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmOvsTcpFlags> {
        ...
        public OFOxmOvsTcpFlags readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmOvsTcpFlagsVer12 oxmOvsTcpFlagsVer12 = new OFOxmOvsTcpFlagsVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmOvsTcpFlagsVer12);
            return oxmOvsTcpFlagsVer12;
        }
    }
    ...
    final static OFOxmOvsTcpFlagsVer12Funnel FUNNEL = new OFOxmOvsTcpFlagsVer12Funnel();
    static class OFOxmOvsTcpFlagsVer12Funnel implements Funnel<OFOxmOvsTcpFlagsVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmOvsTcpFlagsVer12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0xffff5406L
    ...
    static class Writer implements OFMessageWriter<OFOxmOvsTcpFlagsVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmOvsTcpFlagsVer12 message) {
            // fixed value property typeLen = 0xffff5406L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmOvsTcpFlagsVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmOvsTcpFlagsVer12 other = (OFOxmOvsTcpFlagsVer12) obj;
