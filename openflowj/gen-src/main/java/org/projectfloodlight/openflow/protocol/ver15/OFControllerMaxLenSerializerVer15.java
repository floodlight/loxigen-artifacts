...
public class OFControllerMaxLenSerializerVer15 {
    ...
    public static OFControllerMaxLen ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFControllerMaxLen in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFControllerMaxLen e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFControllerMaxLen in version 1.5: " + e);
        }
    }
