...
class OFOxmMplsLabelVer15 implements OFOxmMplsLabel {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmMplsLabelVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmMplsLabelVer15 DEFAULT = new OFOxmMplsLabelVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmMplsLabelVer15(U32 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmMplsLabelVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmMplsLabel.Builder {
        final OFOxmMplsLabelVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U32 value;

        BuilderWithParent(OFOxmMplsLabelVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmMplsLabel> {
        ...
        public OFOxmMplsLabel readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmMplsLabelVer15 oxmMplsLabelVer15 = new OFOxmMplsLabelVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmMplsLabelVer15);
            return oxmMplsLabelVer15;
        }
    }
    ...
    final static OFOxmMplsLabelVer15Funnel FUNNEL = new OFOxmMplsLabelVer15Funnel();
    static class OFOxmMplsLabelVer15Funnel implements Funnel<OFOxmMplsLabelVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmMplsLabelVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004404L
    ...
    static class Writer implements OFMessageWriter<OFOxmMplsLabelVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmMplsLabelVer15 message) {
            // fixed value property typeLen = 0x80004404L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmMplsLabelVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmMplsLabelVer15 other = (OFOxmMplsLabelVer15) obj;
