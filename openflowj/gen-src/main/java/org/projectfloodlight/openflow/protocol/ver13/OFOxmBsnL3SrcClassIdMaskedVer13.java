...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmBsnL3SrcClassIdMasked> {
        @Override
        public OFOxmBsnL3SrcClassIdMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
