...
//
    ...
    OFOxmBsnVxlanNetworkIdVer14(U32 value) {
        if(value == null) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnVxlanNetworkId> {
        @Override
        public OFOxmBsnVxlanNetworkId readFrom(ChannelBuffer bb) throws OFParseError {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnVxlanNetworkIdVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmBsnVxlanNetworkIdVer14 message) {
            // fixed value property typeLen = 0x32a04L
            bb.writeInt(0x32a04);
