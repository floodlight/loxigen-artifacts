...
public class OFPortStatsPropTypeSerializerVer15 {
    ...
    public static OFPortStatsPropType ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFPortStatsPropType in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFPortStatsPropType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFPortStatsPropType in version 1.5: " + e);
        }
    }
