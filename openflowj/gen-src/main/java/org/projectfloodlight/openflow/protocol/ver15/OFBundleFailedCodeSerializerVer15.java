...
public class OFBundleFailedCodeSerializerVer15 {
    ...
    public final static short SCHED_NOT_SUPPORTED_VAL = (short) 0x10;
    public final static short SCHED_FUTURE_VAL = (short) 0x11;
    public final static short SCHED_PAST_VAL = (short) 0x12;
    ...
    public static OFBundleFailedCode ofWireValue(short val) {
        switch(val) {
            ...
            case SCHED_NOT_SUPPORTED_VAL:
                return OFBundleFailedCode.SCHED_NOT_SUPPORTED;
            case SCHED_FUTURE_VAL:
                return OFBundleFailedCode.SCHED_FUTURE;
            case SCHED_PAST_VAL:
                return OFBundleFailedCode.SCHED_PAST;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBundleFailedCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBundleFailedCode e) {
        switch(e) {
            ...
            case SCHED_NOT_SUPPORTED:
                return SCHED_NOT_SUPPORTED_VAL;
            case SCHED_FUTURE:
                return SCHED_FUTURE_VAL;
            case SCHED_PAST:
                return SCHED_PAST_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBundleFailedCode in version 1.5: " + e);
        }
    }
