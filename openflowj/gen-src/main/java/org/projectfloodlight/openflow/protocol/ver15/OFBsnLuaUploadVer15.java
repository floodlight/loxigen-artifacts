...
class OFBsnLuaUploadVer15 implements OFBsnLuaUpload {
...
//
    ...
    final static OFBsnLuaUploadVer15 DEFAULT = new OFBsnLuaUploadVer15(
    ...
    public OFBsnLuaUpload.Builder setData(byte[] data) {
        ...
        public OFBsnLuaUpload build() {
                ...
                //
                return new OFBsnLuaUploadVer15(
                    xid,
                    flags,
                    filename,
                    data
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnLuaUpload> {
        @Override
        public OFBsnLuaUpload readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnLuaUploadVer15 bsnLuaUploadVer15 = new OFBsnLuaUploadVer15(
                    xid,
                      flags,
                      filename,
                      data
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLuaUploadVer15);
    ...
    final static OFBsnLuaUploadVer15Funnel FUNNEL = new OFBsnLuaUploadVer15Funnel();
    static class OFBsnLuaUploadVer15Funnel implements Funnel<OFBsnLuaUploadVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnLuaUploadVer15> {
        @Override
