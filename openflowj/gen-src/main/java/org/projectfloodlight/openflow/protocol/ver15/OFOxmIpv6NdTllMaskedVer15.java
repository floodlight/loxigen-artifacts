...
class OFOxmIpv6NdTllMaskedVer15 implements OFOxmIpv6NdTllMasked {
...
//
    ...
    final static OFOxmIpv6NdTllMaskedVer15 DEFAULT = new OFOxmIpv6NdTllMaskedVer15(
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmIpv6NdTllVer15(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6NdTllMasked> {
        ...
        public OFOxmIpv6NdTllMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6NdTllMaskedVer15 oxmIpv6NdTllMaskedVer15 = new OFOxmIpv6NdTllMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6NdTllMaskedVer15);
    ...
    final static OFOxmIpv6NdTllMaskedVer15Funnel FUNNEL = new OFOxmIpv6NdTllMaskedVer15Funnel();
    static class OFOxmIpv6NdTllMaskedVer15Funnel implements Funnel<OFOxmIpv6NdTllMaskedVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6NdTllMaskedVer15> {
        @Override
