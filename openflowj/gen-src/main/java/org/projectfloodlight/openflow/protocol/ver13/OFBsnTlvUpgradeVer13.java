...
class OFBsnTlvUpgradeVer13 implements OFBsnTlvUpgrade {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvUpgrade> {
        ...
        public OFBsnTlvUpgrade readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvUpgradeVer13 bsnTlvUpgradeVer13 = new OFBsnTlvUpgradeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvUpgradeVer13);
    ...
    final static OFBsnTlvUpgradeVer13Funnel FUNNEL = new OFBsnTlvUpgradeVer13Funnel();
