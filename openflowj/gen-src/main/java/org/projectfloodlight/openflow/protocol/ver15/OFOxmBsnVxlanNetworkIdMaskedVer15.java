...
class OFOxmBsnVxlanNetworkIdMaskedVer15 implements OFOxmBsnVxlanNetworkIdMasked {
...
//
    ...
    final static OFOxmBsnVxlanNetworkIdMaskedVer15 DEFAULT = new OFOxmBsnVxlanNetworkIdMaskedVer15(
    ...
    public OFOxm<VxlanNI> getCanonical() {
        if (VxlanNI.NO_MASK.equals(mask)) {
            return new OFOxmBsnVxlanNetworkIdVer15(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnVxlanNetworkIdMasked> {
        ...
        public OFOxmBsnVxlanNetworkIdMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnVxlanNetworkIdMaskedVer15 oxmBsnVxlanNetworkIdMaskedVer15 = new OFOxmBsnVxlanNetworkIdMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnVxlanNetworkIdMaskedVer15);
    ...
    final static OFOxmBsnVxlanNetworkIdMaskedVer15Funnel FUNNEL = new OFOxmBsnVxlanNetworkIdMaskedVer15Funnel();
    static class OFOxmBsnVxlanNetworkIdMaskedVer15Funnel implements Funnel<OFOxmBsnVxlanNetworkIdMaskedVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnVxlanNetworkIdMaskedVer15> {
        @Override
