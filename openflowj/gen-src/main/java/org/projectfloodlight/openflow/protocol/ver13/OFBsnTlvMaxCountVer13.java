...
class OFBsnTlvMaxCountVer13 implements OFBsnTlvMaxCount {
...
//
    ...
    final static OFBsnTlvMaxCountVer13 DEFAULT = new OFBsnTlvMaxCountVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvMaxCount> {
        ...
        public OFBsnTlvMaxCount readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvMaxCountVer13 bsnTlvMaxCountVer13 = new OFBsnTlvMaxCountVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvMaxCountVer13);
    ...
    final static OFBsnTlvMaxCountVer13Funnel FUNNEL = new OFBsnTlvMaxCountVer13Funnel();
    static class OFBsnTlvMaxCountVer13Funnel implements Funnel<OFBsnTlvMaxCountVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvMaxCountVer13> {
        @Override
