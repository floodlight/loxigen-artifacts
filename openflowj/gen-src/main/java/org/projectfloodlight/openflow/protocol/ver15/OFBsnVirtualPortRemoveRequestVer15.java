...
class OFBsnVirtualPortRemoveRequestVer15 implements OFBsnVirtualPortRemoveRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVirtualPortRemoveRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnVirtualPortRemoveRequestVer15 DEFAULT = new OFBsnVirtualPortRemoveRequestVer15(
        DEFAULT_XID, DEFAULT_VPORT_NO
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnVirtualPortRemoveRequestVer15(long xid, long vportNo) {
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnVirtualPortRemoveRequest.Builder {
        final OFBsnVirtualPortRemoveRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnVirtualPortRemoveRequestVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVirtualPortRemoveRequest> {
        ...
        public OFBsnVirtualPortRemoveRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnVirtualPortRemoveRequestVer15 bsnVirtualPortRemoveRequestVer15 = new OFBsnVirtualPortRemoveRequestVer15(
                    xid,
                      vportNo
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVirtualPortRemoveRequestVer15);
            return bsnVirtualPortRemoveRequestVer15;
        }
    }
    ...
    final static OFBsnVirtualPortRemoveRequestVer15Funnel FUNNEL = new OFBsnVirtualPortRemoveRequestVer15Funnel();
    static class OFBsnVirtualPortRemoveRequestVer15Funnel implements Funnel<OFBsnVirtualPortRemoveRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVirtualPortRemoveRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnVirtualPortRemoveRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnVirtualPortRemoveRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVirtualPortRemoveRequestVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVirtualPortRemoveRequestVer15 other = (OFBsnVirtualPortRemoveRequestVer15) obj;
