...
class OFQueueStatsReplyVer15 implements OFQueueStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFQueueStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFQueueStatsReplyVer15 DEFAULT = new OFQueueStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFQueueStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFQueueStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFQueueStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFQueueStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFQueueStatsReply.Builder {
        final OFQueueStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFQueueStatsReplyVer15 parentMessage) {
    ...
    public OFQueueStatsReply.Builder setXid(long xid) {
        ...
        public OFQueueStatsReply build() {
                ...
                //
                return new OFQueueStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueStatsReply> {
        ...
        public OFQueueStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFQueueStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFQueueStatsEntryVer15.READER);

            OFQueueStatsReplyVer15 queueStatsReplyVer15 = new OFQueueStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueStatsReplyVer15);
            return queueStatsReplyVer15;
        }
    }
    ...
    final static OFQueueStatsReplyVer15Funnel FUNNEL = new OFQueueStatsReplyVer15Funnel();
    static class OFQueueStatsReplyVer15Funnel implements Funnel<OFQueueStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFQueueStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFQueueStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFQueueStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueStatsReplyVer15 other = (OFQueueStatsReplyVer15) obj;
