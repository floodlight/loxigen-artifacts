...
public class OFBsnHashTypeSerializerVer15 {
    ...
    public static OFBsnHashType ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnHashType in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnHashType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnHashType in version 1.5: " + e);
        }
    }
