...
class OFMeterStatsReplyVer15 implements OFMeterStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFMeterStatsReplyVer15 DEFAULT = new OFMeterStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFMeterStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFMeterStats> entries) {
        if(flags == null) {
            throw new NullPointerException("OFMeterStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFMeterStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFMeterStatsReply.Builder {
        final OFMeterStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFMeterStatsReplyVer15 parentMessage) {
    ...
    public OFMeterStatsReply.Builder setXid(long xid) {
        ...
        public OFMeterStatsReply build() {
                ...
                //
                return new OFMeterStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterStatsReply> {
        ...
        public OFMeterStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFMeterStats> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFMeterStatsVer15.READER);

            OFMeterStatsReplyVer15 meterStatsReplyVer15 = new OFMeterStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterStatsReplyVer15);
            return meterStatsReplyVer15;
        }
    }
    ...
    final static OFMeterStatsReplyVer15Funnel FUNNEL = new OFMeterStatsReplyVer15Funnel();
    static class OFMeterStatsReplyVer15Funnel implements Funnel<OFMeterStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFMeterStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFMeterStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFMeterStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterStatsReplyVer15 other = (OFMeterStatsReplyVer15) obj;
