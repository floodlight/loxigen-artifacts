...
class OFBsnTlvLoadVer14 implements OFBsnTlvLoad {
...
//
    ...
    final static OFBsnTlvLoadVer14 DEFAULT = new OFBsnTlvLoadVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvLoad> {
        ...
        public OFBsnTlvLoad readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvLoadVer14 bsnTlvLoadVer14 = new OFBsnTlvLoadVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvLoadVer14);
    ...
    final static OFBsnTlvLoadVer14Funnel FUNNEL = new OFBsnTlvLoadVer14Funnel();
    static class OFBsnTlvLoadVer14Funnel implements Funnel<OFBsnTlvLoadVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvLoadVer14> {
        @Override
