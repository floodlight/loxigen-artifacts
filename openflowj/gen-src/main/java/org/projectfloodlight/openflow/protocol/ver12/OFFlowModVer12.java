        ...
        public OFFlowMod readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(command) {
               case (short) 0x0:
                   ...
                   return OFFlowAddVer12.READER.readFrom(context, bb);
               case (short) 0x3:
                   bb.readerIndex(start);
                   // discriminator value OFFlowModCommand.DELETE=3 for class OFFlowDeleteVer12
                   return OFFlowDeleteVer12.READER.readFrom(context, bb);
               case (short) 0x4:
                   bb.readerIndex(start);
                   // discriminator value OFFlowModCommand.DELETE_STRICT=4 for class OFFlowDeleteStrictVer12
                   return OFFlowDeleteStrictVer12.READER.readFrom(context, bb);
               case (short) 0x1:
                   bb.readerIndex(start);
                   // discriminator value OFFlowModCommand.MODIFY=1 for class OFFlowModifyVer12
                   return OFFlowModifyVer12.READER.readFrom(context, bb);
               case (short) 0x2:
                   bb.readerIndex(start);
                   // discriminator value OFFlowModCommand.MODIFY_STRICT=2 for class OFFlowModifyStrictVer12
                   return OFFlowModifyStrictVer12.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFFlowModVer12.class, "command", command);
            }
            U16.f(bb.readShort());
            U16.f(bb.readShort());
            U16.f(bb.readShort());
            ...
            OFFlowModFlagsSerializerVer12.readFrom(bb);
            // pad: 2 bytes
            bb.skipBytes(2);
            ChannelUtilsVer12.readOFMatch(context, bb);
            ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFInstructionVer12.READER);
