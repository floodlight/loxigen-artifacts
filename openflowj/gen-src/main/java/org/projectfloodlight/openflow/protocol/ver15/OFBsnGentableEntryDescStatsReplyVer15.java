...
class OFBsnGentableEntryDescStatsReplyVer15 implements OFBsnGentableEntryDescStatsReply {
...
//
    ...
    final static OFBsnGentableEntryDescStatsReplyVer15 DEFAULT = new OFBsnGentableEntryDescStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableEntryDescStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableEntryDescStatsEntry> entries) {
        if(flags == null) {
    ...
    static class BuilderWithParent implements OFBsnGentableEntryDescStatsReply.Builder {
        ...
        BuilderWithParent(OFBsnGentableEntryDescStatsReplyVer15 parentMessage) {
    ...
    public OFBsnGentableEntryDescStatsReply.Builder setEntries(List<OFBsnGentableEntryDescStatsEntry> entries) {
        ...
        public OFBsnGentableEntryDescStatsReply build() {
                ...
                //
                return new OFBsnGentableEntryDescStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnGentableEntryDescStatsReply> {
        @Override
        public OFBsnGentableEntryDescStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnGentableEntryDescStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnGentableEntryDescStatsEntryVer15.READER);

            OFBsnGentableEntryDescStatsReplyVer15 bsnGentableEntryDescStatsReplyVer15 = new OFBsnGentableEntryDescStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryDescStatsReplyVer15);
            return bsnGentableEntryDescStatsReplyVer15;
        }
    }
    ...
    final static OFBsnGentableEntryDescStatsReplyVer15Funnel FUNNEL = new OFBsnGentableEntryDescStatsReplyVer15Funnel();
    static class OFBsnGentableEntryDescStatsReplyVer15Funnel implements Funnel<OFBsnGentableEntryDescStatsReplyVer15> {
        ...
        @Override
        public void funnel(OFBsnGentableEntryDescStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryDescStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableEntryDescStatsReplyVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryDescStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryDescStatsReplyVer15 other = (OFBsnGentableEntryDescStatsReplyVer15) obj;
