...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryDescStatsReply> {
        ...
        public OFBsnGentableEntryDescStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnGentableEntryDescStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGentableEntryDescStatsEntryVer15.READER);
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryDescStatsReplyVer15> {
        ...
        public void write(ByteBuf bb, OFBsnGentableEntryDescStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnGentableEntryDescStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
