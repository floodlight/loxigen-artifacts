...
class OFGroupInsertBucketVer15 implements OFGroupInsertBucket {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupInsertBucketVer15.class);
    // version: 1.5
...
//
    ...
    OFGroupInsertBucketVer15(long xid, OFGroupType groupType, OFGroup group, OFGroupBucket commandBucketId, List<OFBucket> buckets, List<OFGroupProp> properties) {
        if(groupType == null) {
            throw new NullPointerException("OFGroupInsertBucketVer15: property groupType cannot be null");
        }
        if(group == null) {
            throw new NullPointerException("OFGroupInsertBucketVer15: property group cannot be null");
        }
        if(commandBucketId == null) {
            throw new NullPointerException("OFGroupInsertBucketVer15: property commandBucketId cannot be null");
        }
        if(buckets == null) {
            throw new NullPointerException("OFGroupInsertBucketVer15: property buckets cannot be null");
        }
        if(properties == null) {
    ...
    public OFGroupModCommand getCommand() {
        return OFGroupModCommand.INSERT_BUCKET;
    }
    ...
    public OFGroupInsertBucket.Builder createBuilder() {
        return new BuilderWithParent(this);
    }

    static class BuilderWithParent implements OFGroupInsertBucket.Builder {
        final OFGroupInsertBucketVer15 parentMessage;
        ...
        BuilderWithParent(OFGroupInsertBucketVer15 parentMessage) {
    ...
    @Override
    public OFGroupInsertBucket.Builder setBuckets(List<OFBucket> buckets) {
        this.buckets = buckets;
    ...
    @Override
    public OFGroupInsertBucket.Builder setCommandBucketId(OFGroupBucket commandBucketId) {
        this.commandBucketId = commandBucketId;
    ...
    @Override
    public OFGroupInsertBucket.Builder setGroup(OFGroup group) {
        this.group = group;
        this.groupSet = true;
        return this;
    }
    ...
    @Override
    public OFGroupInsertBucket.Builder setGroupType(OFGroupType groupType) {
        this.groupType = groupType;
    ...
    @Override
    public OFGroupInsertBucket.Builder setProperties(List<OFGroupProp> properties) {
        this.properties = properties;
    ...
    @Override
    public OFGroupInsertBucket.Builder setXid(long xid) {
        this.xid = xid;
        this.xidSet = true;
        return this;
    }
        ...
        @Override
        public OFGroupInsertBucket build() {
                ...
                //
                return new OFGroupInsertBucketVer15(
                    xid,
                    groupType,
                    group,
                    commandBucketId,
    ...
    static class Builder implements OFGroupInsertBucket.Builder {
        // OF message fields
        private boolean xidSet;
        private long xid;
        private boolean groupTypeSet;
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupInsertBucket> {
        ...
        public OFGroupInsertBucket readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(command != (short) 0x3)
                throw new OFParseError("Wrong command: Expected=OFGroupModCommand.INSERT_BUCKET(3), got="+command);
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupInsertBucketVer15);
            return groupInsertBucketVer15;
        }
    }
    ...
    final static OFGroupInsertBucketVer15Funnel FUNNEL = new OFGroupInsertBucketVer15Funnel();
    static class OFGroupInsertBucketVer15Funnel implements Funnel<OFGroupInsertBucketVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupInsertBucketVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFGroupInsertBucketVer15> {
        @Override
        public void write(ByteBuf bb, OFGroupInsertBucketVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFGroupInsertBucketVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupInsertBucketVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupInsertBucketVer15 other = (OFGroupInsertBucketVer15) obj;
