...
class OFBsnGentableStatsEntryVer15 implements OFBsnGentableStatsEntry {
...
//
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnGentableStatsEntry build() {
                ...
                //
                return new OFBsnGentableStatsEntryVer15(
                    tableId,
                    entryCount,
                    checksum
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableStatsEntry> {
        ...
        public OFBsnGentableStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableStatsEntryVer15 bsnGentableStatsEntryVer15 = new OFBsnGentableStatsEntryVer15(
                    tableId,
                      entryCount,
                      checksum
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableStatsEntryVer15);
    ...
    final static OFBsnGentableStatsEntryVer15Funnel FUNNEL = new OFBsnGentableStatsEntryVer15Funnel();
    static class OFBsnGentableStatsEntryVer15Funnel implements Funnel<OFBsnGentableStatsEntryVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableStatsEntryVer15> {
        @Override
