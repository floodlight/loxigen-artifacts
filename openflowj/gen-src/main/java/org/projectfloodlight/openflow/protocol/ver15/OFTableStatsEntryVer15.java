...
class OFTableStatsEntryVer15 implements OFTableStatsEntry {
...
//
    ...
    final static OFTableStatsEntryVer15 DEFAULT = new OFTableStatsEntryVer15(
        DEFAULT_TABLE_ID, DEFAULT_ACTIVE_COUNT, DEFAULT_LOOKUP_COUNT, DEFAULT_MATCHED_COUNT
    );

    // package private constructor - used by readers, builders, and factory
    OFTableStatsEntryVer15(TableId tableId, long activeCount, U64 lookupCount, U64 matchedCount) {
        if(tableId == null) {
    ...
    static class BuilderWithParent implements OFTableStatsEntry.Builder {
        ...
        BuilderWithParent(OFTableStatsEntryVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFTableStatsEntry build() {
                ...
                //
                return new OFTableStatsEntryVer15(
                    tableId,
                    activeCount,
                    lookupCount,
                    matchedCount
...
//
    ...
    static class Reader implements OFMessageReader<OFTableStatsEntry> {
        ...
        public OFTableStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFTableStatsEntryVer15 tableStatsEntryVer15 = new OFTableStatsEntryVer15(
                    tableId,
                      activeCount,
                      lookupCount,
                      matchedCount
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableStatsEntryVer15);
            return tableStatsEntryVer15;
        }
    }
    ...
    final static OFTableStatsEntryVer15Funnel FUNNEL = new OFTableStatsEntryVer15Funnel();
    static class OFTableStatsEntryVer15Funnel implements Funnel<OFTableStatsEntryVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableStatsEntryVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFTableStatsEntryVer15> {
        @Override
        public void write(ByteBuf bb, OFTableStatsEntryVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableStatsEntryVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableStatsEntryVer15 other = (OFTableStatsEntryVer15) obj;
