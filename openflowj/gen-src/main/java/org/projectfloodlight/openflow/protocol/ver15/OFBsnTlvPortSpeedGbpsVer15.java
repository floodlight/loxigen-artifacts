...
class OFBsnTlvPortSpeedGbpsVer15 implements OFBsnTlvPortSpeedGbps {
...
//
    ...
    final static OFBsnTlvPortSpeedGbpsVer15 DEFAULT = new OFBsnTlvPortSpeedGbpsVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvPortSpeedGbps> {
        ...
        public OFBsnTlvPortSpeedGbps readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvPortSpeedGbpsVer15 bsnTlvPortSpeedGbpsVer15 = new OFBsnTlvPortSpeedGbpsVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvPortSpeedGbpsVer15);
    ...
    final static OFBsnTlvPortSpeedGbpsVer15Funnel FUNNEL = new OFBsnTlvPortSpeedGbpsVer15Funnel();
    static class OFBsnTlvPortSpeedGbpsVer15Funnel implements Funnel<OFBsnTlvPortSpeedGbpsVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvPortSpeedGbpsVer15> {
        @Override
