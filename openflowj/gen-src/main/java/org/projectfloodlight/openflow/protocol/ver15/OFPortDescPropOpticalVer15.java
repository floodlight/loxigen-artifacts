...
class OFPortDescPropOpticalVer15 implements OFPortDescPropOptical {
...
//
    ...
    final static OFPortDescPropOpticalVer15 DEFAULT = new OFPortDescPropOpticalVer15(
    ...
    OFPortDescPropOpticalVer15(long supported, long txMinFreqLmda, long txMaxFreqLmda, long txGridFreqLmda, long rxMinFreqLmda, long rxMaxFreqLmda, long rxGridFreqLmda, int txPwrMin, int txPwrMax) {
    ...
    static class BuilderWithParent implements OFPortDescPropOptical.Builder {
        ...
        BuilderWithParent(OFPortDescPropOpticalVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFPortDescPropOptical build() {
                ...
                //
                return new OFPortDescPropOpticalVer15(
                    supported,
                    txMinFreqLmda,
                    txMaxFreqLmda,
                    txGridFreqLmda,
...
//
    ...
    static class Reader implements OFMessageReader<OFPortDescPropOptical> {
        ...
        public OFPortDescPropOptical readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFPortDescPropOpticalVer15 portDescPropOpticalVer15 = new OFPortDescPropOpticalVer15(
                    supported,
                      txMinFreqLmda,
                      txMaxFreqLmda,
                      txGridFreqLmda,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", portDescPropOpticalVer15);
            return portDescPropOpticalVer15;
        }
    }
    ...
    final static OFPortDescPropOpticalVer15Funnel FUNNEL = new OFPortDescPropOpticalVer15Funnel();
    static class OFPortDescPropOpticalVer15Funnel implements Funnel<OFPortDescPropOpticalVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFPortDescPropOpticalVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0x1
    ...
    static class Writer implements OFMessageWriter<OFPortDescPropOpticalVer15> {
        @Override
        public void write(ByteBuf bb, OFPortDescPropOpticalVer15 message) {
            // fixed value property type = 0x1
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFPortDescPropOpticalVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFPortDescPropOpticalVer15 other = (OFPortDescPropOpticalVer15) obj;
