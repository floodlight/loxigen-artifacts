...
class OFOxmIpv4DstMaskedVer15 implements OFOxmIpv4DstMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv4DstMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv4DstMaskedVer15 DEFAULT = new OFOxmIpv4DstMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv4DstMaskedVer15(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv4DstMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv4DstMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IPv4Address> getCanonical() {
        if (IPv4Address.NO_MASK.equals(mask)) {
            return new OFOxmIpv4DstVer15(value);
    ...
    static class BuilderWithParent implements OFOxmIpv4DstMasked.Builder {
        final OFOxmIpv4DstMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv4DstMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmIpv4DstMasked> {
        @Override
        public OFOxmIpv4DstMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv4DstMaskedVer15 oxmIpv4DstMaskedVer15 = new OFOxmIpv4DstMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv4DstMaskedVer15);
            return oxmIpv4DstMaskedVer15;
        }
    }
    ...
    final static OFOxmIpv4DstMaskedVer15Funnel FUNNEL = new OFOxmIpv4DstMaskedVer15Funnel();
    static class OFOxmIpv4DstMaskedVer15Funnel implements Funnel<OFOxmIpv4DstMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv4DstMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001908L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv4DstMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv4DstMaskedVer15 message) {
            // fixed value property typeLen = 0x80001908L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv4DstMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv4DstMaskedVer15 other = (OFOxmIpv4DstMaskedVer15) obj;
