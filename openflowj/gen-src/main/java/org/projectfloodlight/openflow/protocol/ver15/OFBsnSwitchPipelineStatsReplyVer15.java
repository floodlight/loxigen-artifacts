...
class OFBsnSwitchPipelineStatsReplyVer15 implements OFBsnSwitchPipelineStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnSwitchPipelineStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnSwitchPipelineStatsReplyVer15 DEFAULT = new OFBsnSwitchPipelineStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnSwitchPipelineStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnSwitchPipelineStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnSwitchPipelineStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnSwitchPipelineStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnSwitchPipelineStatsReply.Builder {
        final OFBsnSwitchPipelineStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnSwitchPipelineStatsReplyVer15 parentMessage) {
    ...
    public OFBsnSwitchPipelineStatsReply.Builder setEntries(List<OFBsnSwitchPipelineStatsEntry> entries) {
        ...
        public OFBsnSwitchPipelineStatsReply build() {
                ...
                //
                return new OFBsnSwitchPipelineStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnSwitchPipelineStatsReply> {
        ...
        public OFBsnSwitchPipelineStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnSwitchPipelineStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnSwitchPipelineStatsEntryVer15.READER);

            OFBsnSwitchPipelineStatsReplyVer15 bsnSwitchPipelineStatsReplyVer15 = new OFBsnSwitchPipelineStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSwitchPipelineStatsReplyVer15);
            return bsnSwitchPipelineStatsReplyVer15;
        }
    }
    ...
    final static OFBsnSwitchPipelineStatsReplyVer15Funnel FUNNEL = new OFBsnSwitchPipelineStatsReplyVer15Funnel();
    static class OFBsnSwitchPipelineStatsReplyVer15Funnel implements Funnel<OFBsnSwitchPipelineStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnSwitchPipelineStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnSwitchPipelineStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnSwitchPipelineStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnSwitchPipelineStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnSwitchPipelineStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnSwitchPipelineStatsReplyVer15 other = (OFBsnSwitchPipelineStatsReplyVer15) obj;
