...
class OFOxmBsnInnerVlanVidVer15 implements OFOxmBsnInnerVlanVid {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnInnerVlanVidVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnInnerVlanVidVer15 DEFAULT = new OFOxmBsnInnerVlanVidVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnInnerVlanVidVer15(OFVlanVidMatch value) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnInnerVlanVidVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnInnerVlanVid.Builder {
        final OFOxmBsnInnerVlanVidVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private OFVlanVidMatch value;

        BuilderWithParent(OFOxmBsnInnerVlanVidVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInnerVlanVid> {
        ...
        public OFOxmBsnInnerVlanVid readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInnerVlanVidVer15 oxmBsnInnerVlanVidVer15 = new OFOxmBsnInnerVlanVidVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInnerVlanVidVer15);
            return oxmBsnInnerVlanVidVer15;
        }
    }
    ...
    final static OFOxmBsnInnerVlanVidVer15Funnel FUNNEL = new OFOxmBsnInnerVlanVidVer15Funnel();
    static class OFOxmBsnInnerVlanVidVer15Funnel implements Funnel<OFOxmBsnInnerVlanVidVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnInnerVlanVidVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x33002L
            sink.putInt(0x33002);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInnerVlanVidVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInnerVlanVidVer15 message) {
            // fixed value property typeLen = 0x33002L
            bb.writeInt(0x33002);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnInnerVlanVidVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnInnerVlanVidVer15 other = (OFOxmBsnInnerVlanVidVer15) obj;
