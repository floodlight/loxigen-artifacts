        ...
        public OFExperimenterStatsRequest<?> readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               case 0x5c16c7:
                   ...
                   return OFBsnStatsRequestVer12.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFExperimenterStatsRequestVer12.class, "experimenter", experimenter);
            }
            U32.f(bb.readInt());
