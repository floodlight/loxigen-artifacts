...
public class OFBadRequestCodeSerializerVer15 {
    ...
    public final static short MULTIPART_BAD_SCHED_VAL = (short) 0x10;
    public final static short PIPELINE_FIELDS_ONLY_VAL = (short) 0x11;
    public final static short UNKNOWN_VAL = (short) 0x12;
    ...
    public static OFBadRequestCode ofWireValue(short val) {
        switch(val) {
            ...
            case MULTIPART_BAD_SCHED_VAL:
                return OFBadRequestCode.MULTIPART_BAD_SCHED;
            case PIPELINE_FIELDS_ONLY_VAL:
                return OFBadRequestCode.PIPELINE_FIELDS_ONLY;
            case UNKNOWN_VAL:
                return OFBadRequestCode.UNKNOWN;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBadRequestCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBadRequestCode e) {
        switch(e) {
            ...
            case MULTIPART_BAD_SCHED:
                return MULTIPART_BAD_SCHED_VAL;
            case PIPELINE_FIELDS_ONLY:
                return PIPELINE_FIELDS_ONLY_VAL;
            case UNKNOWN:
                return UNKNOWN_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBadRequestCode in version 1.5: " + e);
        }
    }
