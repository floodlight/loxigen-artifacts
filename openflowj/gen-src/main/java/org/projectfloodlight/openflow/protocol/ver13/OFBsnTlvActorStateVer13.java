...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvActorState> {
        @Override
        public OFBsnTlvActorState readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
