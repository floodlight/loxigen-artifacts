...
class OFBsnGentableEntryStatsEntryVer15 implements OFBsnGentableEntryStatsEntry {
...
//
    ...
    final static OFBsnGentableEntryStatsEntryVer15 DEFAULT = new OFBsnGentableEntryStatsEntryVer15(
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnGentableEntryStatsEntry> {
        ...
        public OFBsnGentableEntryStatsEntry readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnTlv> stats = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnTlvVer15.READER);

            OFBsnGentableEntryStatsEntryVer15 bsnGentableEntryStatsEntryVer15 = new OFBsnGentableEntryStatsEntryVer15(
                    key,
                      stats
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryStatsEntryVer15);
    ...
    final static OFBsnGentableEntryStatsEntryVer15Funnel FUNNEL = new OFBsnGentableEntryStatsEntryVer15Funnel();
    static class OFBsnGentableEntryStatsEntryVer15Funnel implements Funnel<OFBsnGentableEntryStatsEntryVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryStatsEntryVer15> {
        @Override
