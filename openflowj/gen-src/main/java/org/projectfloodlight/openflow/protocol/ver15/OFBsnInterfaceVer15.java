...
class OFBsnInterfaceVer15 implements OFBsnInterface {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnInterfaceVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnInterfaceVer15 DEFAULT = new OFBsnInterfaceVer15(
        DEFAULT_HW_ADDR, DEFAULT_NAME, DEFAULT_IPV4_ADDR, DEFAULT_IPV4_NETMASK
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnInterfaceVer15(MacAddress hwAddr, String name, IPv4Address ipv4Addr, IPv4Address ipv4Netmask) {
        if(hwAddr == null) {
            throw new NullPointerException("OFBsnInterfaceVer15: property hwAddr cannot be null");
        }
        if(name == null) {
            throw new NullPointerException("OFBsnInterfaceVer15: property name cannot be null");
        }
        if(ipv4Addr == null) {
            throw new NullPointerException("OFBsnInterfaceVer15: property ipv4Addr cannot be null");
        }
        if(ipv4Netmask == null) {
            throw new NullPointerException("OFBsnInterfaceVer15: property ipv4Netmask cannot be null");
        }
        this.hwAddr = hwAddr;
        this.name = name;
    ...
    static class BuilderWithParent implements OFBsnInterface.Builder {
        final OFBsnInterfaceVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnInterfaceVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnInterface build() {
                ...
                //
                return new OFBsnInterfaceVer15(
                    hwAddr,
                    name,
                    ipv4Addr,
                    ipv4Netmask
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnInterface> {
        ...
        public OFBsnInterface readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnInterfaceVer15 bsnInterfaceVer15 = new OFBsnInterfaceVer15(
                    hwAddr,
                      name,
                      ipv4Addr,
                      ipv4Netmask
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnInterfaceVer15);
            return bsnInterfaceVer15;
        }
    }
    ...
    final static OFBsnInterfaceVer15Funnel FUNNEL = new OFBsnInterfaceVer15Funnel();
    static class OFBsnInterfaceVer15Funnel implements Funnel<OFBsnInterfaceVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnInterfaceVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFBsnInterfaceVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnInterfaceVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnInterfaceVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnInterfaceVer15 other = (OFBsnInterfaceVer15) obj;
