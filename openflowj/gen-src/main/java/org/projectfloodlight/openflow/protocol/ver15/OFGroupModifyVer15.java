...
class OFGroupModifyVer15 implements OFGroupModify {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupModifyVer15.class);
    // version: 1.5
...
//
    ...
    OFGroupModifyVer15(long xid, OFGroupType groupType, OFGroup group, OFGroupBucket commandBucketId, List<OFBucket> buckets, List<OFGroupProp> properties) {
        if(groupType == null) {
            throw new NullPointerException("OFGroupModifyVer15: property groupType cannot be null");
        }
        if(group == null) {
            throw new NullPointerException("OFGroupModifyVer15: property group cannot be null");
        }
        if(commandBucketId == null) {
            throw new NullPointerException("OFGroupModifyVer15: property commandBucketId cannot be null");
        }
        if(buckets == null) {
            throw new NullPointerException("OFGroupModifyVer15: property buckets cannot be null");
        }
        if(properties == null) {
            throw new NullPointerException("OFGroupModifyVer15: property properties cannot be null");
        }
    ...
    static class BuilderWithParent implements OFGroupModify.Builder {
        final OFGroupModifyVer15 parentMessage;
        ...
        BuilderWithParent(OFGroupModifyVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupModify> {
        ...
        public OFGroupModify readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFGroupModifyVer15 groupModifyVer15 = new OFGroupModifyVer15(
                    xid,
                      groupType,
                      group,
                      commandBucketId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupModifyVer15);
            return groupModifyVer15;
        }
    }
    ...
    final static OFGroupModifyVer15Funnel FUNNEL = new OFGroupModifyVer15Funnel();
    static class OFGroupModifyVer15Funnel implements Funnel<OFGroupModifyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupModifyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFGroupModifyVer15> {
        @Override
        public void write(ByteBuf bb, OFGroupModifyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFGroupModifyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupModifyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupModifyVer15 other = (OFGroupModifyVer15) obj;
