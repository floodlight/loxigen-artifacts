...
class OFTableFeaturePropTableSyncFromVer15 implements OFTableFeaturePropTableSyncFrom {
...
//
    ...
    final static OFTableFeaturePropTableSyncFromVer15 DEFAULT = new OFTableFeaturePropTableSyncFromVer15(
        DEFAULT_TABLE_IDS
    );

    // package private constructor - used by readers, builders, and factory
    OFTableFeaturePropTableSyncFromVer15(List<U8> tableIds) {
        if(tableIds == null) {
    ...
    static class BuilderWithParent implements OFTableFeaturePropTableSyncFrom.Builder {
        ...
        BuilderWithParent(OFTableFeaturePropTableSyncFromVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturePropTableSyncFrom> {
        ...
        public OFTableFeaturePropTableSyncFrom readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableFeaturePropTableSyncFromVer15);
            return tableFeaturePropTableSyncFromVer15;
        }
    }
    ...
    final static OFTableFeaturePropTableSyncFromVer15Funnel FUNNEL = new OFTableFeaturePropTableSyncFromVer15Funnel();
    static class OFTableFeaturePropTableSyncFromVer15Funnel implements Funnel<OFTableFeaturePropTableSyncFromVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableFeaturePropTableSyncFromVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0x10
    ...
    static class Writer implements OFMessageWriter<OFTableFeaturePropTableSyncFromVer15> {
        @Override
        public void write(ByteBuf bb, OFTableFeaturePropTableSyncFromVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFTableFeaturePropTableSyncFromVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableFeaturePropTableSyncFromVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableFeaturePropTableSyncFromVer15 other = (OFTableFeaturePropTableSyncFromVer15) obj;
