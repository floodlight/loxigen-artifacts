...
class OFTableStatsReplyVer15 implements OFTableStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFTableStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFTableStatsReplyVer15 DEFAULT = new OFTableStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFTableStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFTableStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFTableStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFTableStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFTableStatsReply.Builder {
        final OFTableStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFTableStatsReplyVer15 parentMessage) {
    ...
    public OFTableStatsReply.Builder setEntries(List<OFTableStatsEntry> entries) {
        ...
        public OFTableStatsReply build() {
                ...
                //
                return new OFTableStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableStatsReply> {
        ...
        public OFTableStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFTableStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFTableStatsEntryVer15.READER);

            OFTableStatsReplyVer15 tableStatsReplyVer15 = new OFTableStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableStatsReplyVer15);
            return tableStatsReplyVer15;
        }
    }
    ...
    final static OFTableStatsReplyVer15Funnel FUNNEL = new OFTableStatsReplyVer15Funnel();
    static class OFTableStatsReplyVer15Funnel implements Funnel<OFTableStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFTableStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFTableStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFTableStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableStatsReplyVer15 other = (OFTableStatsReplyVer15) obj;
