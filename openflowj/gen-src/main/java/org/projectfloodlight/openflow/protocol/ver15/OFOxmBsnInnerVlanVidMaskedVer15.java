...
class OFOxmBsnInnerVlanVidMaskedVer15 implements OFOxmBsnInnerVlanVidMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnInnerVlanVidMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnInnerVlanVidMaskedVer15 DEFAULT = new OFOxmBsnInnerVlanVidMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnInnerVlanVidMaskedVer15(OFVlanVidMatch value, OFVlanVidMatch mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnInnerVlanVidMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnInnerVlanVidMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<OFVlanVidMatch> getCanonical() {
        if (OFVlanVidMatch.NO_MASK.equals(mask)) {
            return new OFOxmBsnInnerVlanVidVer15(value);
    ...
    static class BuilderWithParent implements OFOxmBsnInnerVlanVidMasked.Builder {
        final OFOxmBsnInnerVlanVidMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnInnerVlanVidMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInnerVlanVidMasked> {
        ...
        public OFOxmBsnInnerVlanVidMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInnerVlanVidMaskedVer15 oxmBsnInnerVlanVidMaskedVer15 = new OFOxmBsnInnerVlanVidMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInnerVlanVidMaskedVer15);
            return oxmBsnInnerVlanVidMaskedVer15;
        }
    }
    ...
    final static OFOxmBsnInnerVlanVidMaskedVer15Funnel FUNNEL = new OFOxmBsnInnerVlanVidMaskedVer15Funnel();
    static class OFOxmBsnInnerVlanVidMaskedVer15Funnel implements Funnel<OFOxmBsnInnerVlanVidMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnInnerVlanVidMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x33104L
            sink.putInt(0x33104);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInnerVlanVidMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInnerVlanVidMaskedVer15 message) {
            // fixed value property typeLen = 0x33104L
            bb.writeInt(0x33104);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnInnerVlanVidMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnInnerVlanVidMaskedVer15 other = (OFOxmBsnInnerVlanVidMaskedVer15) obj;
