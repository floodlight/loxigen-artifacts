...
class OFBsnTlvLagTypeVer14 implements OFBsnTlvLagType {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvLagType> {
        ...
        public OFBsnTlvLagType readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvLagTypeVer14 bsnTlvLagTypeVer14 = new OFBsnTlvLagTypeVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvLagTypeVer14);
    ...
    final static OFBsnTlvLagTypeVer14Funnel FUNNEL = new OFBsnTlvLagTypeVer14Funnel();
    static class OFBsnTlvLagTypeVer14Funnel implements Funnel<OFBsnTlvLagTypeVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvLagTypeVer14> {
        @Override
