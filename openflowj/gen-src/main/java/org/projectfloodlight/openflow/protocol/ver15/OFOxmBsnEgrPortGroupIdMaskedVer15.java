...
class OFOxmBsnEgrPortGroupIdMaskedVer15 implements OFOxmBsnEgrPortGroupIdMasked {
...
//
    ...
    final static OFOxmBsnEgrPortGroupIdMaskedVer15 DEFAULT = new OFOxmBsnEgrPortGroupIdMaskedVer15(
    ...
    public OFOxm<ClassId> getCanonical() {
        if (ClassId.NO_MASK.equals(mask)) {
            return new OFOxmBsnEgrPortGroupIdVer15(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnEgrPortGroupIdMasked> {
        ...
        public OFOxmBsnEgrPortGroupIdMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnEgrPortGroupIdMaskedVer15 oxmBsnEgrPortGroupIdMaskedVer15 = new OFOxmBsnEgrPortGroupIdMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnEgrPortGroupIdMaskedVer15);
    ...
    final static OFOxmBsnEgrPortGroupIdMaskedVer15Funnel FUNNEL = new OFOxmBsnEgrPortGroupIdMaskedVer15Funnel();
    static class OFOxmBsnEgrPortGroupIdMaskedVer15Funnel implements Funnel<OFOxmBsnEgrPortGroupIdMaskedVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnEgrPortGroupIdMaskedVer15> {
        @Override
