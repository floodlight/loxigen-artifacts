...
public class OFMeterSerializerVer15 {
    ...
    public static OFMeter ofWireValue(int val) {
        switch(val) {
            ...
            case ALL_VAL:
                return OFMeter.ALL;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFMeter in version 1.5: " + val);
        }
    }
    ...
    public static int toWireValue(OFMeter e) {
        switch(e) {
            ...
            case ALL:
                return ALL_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFMeter in version 1.5: " + e);
        }
    }
