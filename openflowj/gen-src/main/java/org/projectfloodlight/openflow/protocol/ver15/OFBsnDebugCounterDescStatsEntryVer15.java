...
class OFBsnDebugCounterDescStatsEntryVer15 implements OFBsnDebugCounterDescStatsEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnDebugCounterDescStatsEntryVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnDebugCounterDescStatsEntryVer15 DEFAULT = new OFBsnDebugCounterDescStatsEntryVer15(
        DEFAULT_COUNTER_ID, DEFAULT_NAME, DEFAULT_DESCRIPTION
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnDebugCounterDescStatsEntryVer15(U64 counterId, String name, String description) {
        if(counterId == null) {
            throw new NullPointerException("OFBsnDebugCounterDescStatsEntryVer15: property counterId cannot be null");
        }
        if(name == null) {
            throw new NullPointerException("OFBsnDebugCounterDescStatsEntryVer15: property name cannot be null");
        }
        if(description == null) {
            throw new NullPointerException("OFBsnDebugCounterDescStatsEntryVer15: property description cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnDebugCounterDescStatsEntry.Builder {
        final OFBsnDebugCounterDescStatsEntryVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnDebugCounterDescStatsEntryVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnDebugCounterDescStatsEntry build() {
                ...
                //
                return new OFBsnDebugCounterDescStatsEntryVer15(
                    counterId,
                    name,
                    description
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnDebugCounterDescStatsEntry> {
        ...
        public OFBsnDebugCounterDescStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnDebugCounterDescStatsEntryVer15 bsnDebugCounterDescStatsEntryVer15 = new OFBsnDebugCounterDescStatsEntryVer15(
                    counterId,
                      name,
                      description
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnDebugCounterDescStatsEntryVer15);
            return bsnDebugCounterDescStatsEntryVer15;
        }
    }
    ...
    final static OFBsnDebugCounterDescStatsEntryVer15Funnel FUNNEL = new OFBsnDebugCounterDescStatsEntryVer15Funnel();
    static class OFBsnDebugCounterDescStatsEntryVer15Funnel implements Funnel<OFBsnDebugCounterDescStatsEntryVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnDebugCounterDescStatsEntryVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFBsnDebugCounterDescStatsEntryVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnDebugCounterDescStatsEntryVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnDebugCounterDescStatsEntryVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnDebugCounterDescStatsEntryVer15 other = (OFBsnDebugCounterDescStatsEntryVer15) obj;
