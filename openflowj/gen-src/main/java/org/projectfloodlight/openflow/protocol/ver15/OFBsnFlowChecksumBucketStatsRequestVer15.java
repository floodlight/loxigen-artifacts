...
class OFBsnFlowChecksumBucketStatsRequestVer15 implements OFBsnFlowChecksumBucketStatsRequest {
...
//
    ...
    final static OFBsnFlowChecksumBucketStatsRequestVer15 DEFAULT = new OFBsnFlowChecksumBucketStatsRequestVer15(
    ...
    public OFBsnFlowChecksumBucketStatsRequest.Builder setTableId(TableId tableId) {
        ...
        public OFBsnFlowChecksumBucketStatsRequest build() {
                ...
                //
                return new OFBsnFlowChecksumBucketStatsRequestVer15(
                    xid,
                    flags,
                    tableId
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnFlowChecksumBucketStatsRequest> {
        ...
        public OFBsnFlowChecksumBucketStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnFlowChecksumBucketStatsRequestVer15 bsnFlowChecksumBucketStatsRequestVer15 = new OFBsnFlowChecksumBucketStatsRequestVer15(
                    xid,
                      flags,
                      tableId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnFlowChecksumBucketStatsRequestVer15);
    ...
    final static OFBsnFlowChecksumBucketStatsRequestVer15Funnel FUNNEL = new OFBsnFlowChecksumBucketStatsRequestVer15Funnel();
    static class OFBsnFlowChecksumBucketStatsRequestVer15Funnel implements Funnel<OFBsnFlowChecksumBucketStatsRequestVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnFlowChecksumBucketStatsRequestVer15> {
        @Override
