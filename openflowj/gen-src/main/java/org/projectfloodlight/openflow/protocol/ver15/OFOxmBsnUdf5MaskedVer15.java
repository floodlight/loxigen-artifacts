...
class OFOxmBsnUdf5MaskedVer15 implements OFOxmBsnUdf5Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnUdf5MaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnUdf5MaskedVer15 DEFAULT = new OFOxmBsnUdf5MaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnUdf5MaskedVer15(UDF value, UDF mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnUdf5MaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnUdf5MaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<UDF> getCanonical() {
        if (UDF.NO_MASK.equals(mask)) {
            return new OFOxmBsnUdf5Ver15(value);
    ...
    static class BuilderWithParent implements OFOxmBsnUdf5Masked.Builder {
        final OFOxmBsnUdf5MaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnUdf5MaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnUdf5Masked> {
        ...
        public OFOxmBsnUdf5Masked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnUdf5MaskedVer15 oxmBsnUdf5MaskedVer15 = new OFOxmBsnUdf5MaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnUdf5MaskedVer15);
            return oxmBsnUdf5MaskedVer15;
        }
    }
    ...
    final static OFOxmBsnUdf5MaskedVer15Funnel FUNNEL = new OFOxmBsnUdf5MaskedVer15Funnel();
    static class OFOxmBsnUdf5MaskedVer15Funnel implements Funnel<OFOxmBsnUdf5MaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnUdf5MaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x31b08L
            sink.putInt(0x31b08);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnUdf5MaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnUdf5MaskedVer15 message) {
            // fixed value property typeLen = 0x31b08L
            bb.writeInt(0x31b08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnUdf5MaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnUdf5MaskedVer15 other = (OFOxmBsnUdf5MaskedVer15) obj;
