        ...
        public OFBsnTlv readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(type) {
               case (short) 0xc0:
                   ...
                   return OFBsnTlvActiveVer15.READER.readFrom(context, bb);
               case (short) 0x2c:
                   bb.readerIndex(start);
               ...
               case (short) 0xbe:
                   ...
                   return OFBsnTlvDnsAnalyticsVer15.READER.readFrom(context, bb);
               case (short) 0x79:
                   bb.readerIndex(start);
               ...
               case (short) 0xc2:
                   ...
                   return OFBsnTlvFailCountVer15.READER.readFrom(context, bb);
               case (short) 0xa3:
                   bb.readerIndex(start);
               ...
               case (short) 0xc1:
                   ...
                   return OFBsnTlvLinkUpVer15.READER.readFrom(context, bb);
               case (short) 0x92:
                   bb.readerIndex(start);
               ...
               case (short) 0xbc:
                   ...
                   return OFBsnTlvLosslessVer15.READER.readFrom(context, bb);
               case (short) 0xb2:
                   bb.readerIndex(start);
               ...
               case (short) 0xbd:
                   ...
                   return OFBsnTlvRedundantMgmtVer15.READER.readFrom(context, bb);
               case (short) 0x3b:
                   bb.readerIndex(start);
               ...
               case (short) 0xbf:
                   ...
                   return OFBsnTlvSrcMacCmlVer15.READER.readFrom(context, bb);
               case (short) 0x61:
                   bb.readerIndex(start);
