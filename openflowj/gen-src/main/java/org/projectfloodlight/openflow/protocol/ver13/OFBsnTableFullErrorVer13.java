...
class OFBsnTableFullErrorVer13 implements OFBsnTableFullError {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnTableFullErrorVer13.class);
    // version: 1.3
...
//
    ...
    final static OFBsnTableFullErrorVer13 DEFAULT = new OFBsnTableFullErrorVer13(
        DEFAULT_XID, DEFAULT_ERR_MSG, DEFAULT_DATA
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnTableFullErrorVer13(long xid, String errMsg, OFErrorCauseData data) {
        if(errMsg == null) {
            throw new NullPointerException("OFBsnTableFullErrorVer13: property errMsg cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBsnTableFullErrorVer13: property data cannot be null");
        }
        this.xid = xid;
        this.errMsg = errMsg;
        this.data = data;
    ...
    static class BuilderWithParent implements OFBsnTableFullError.Builder {
        final OFBsnTableFullErrorVer13 parentMessage;
        ...
        BuilderWithParent(OFBsnTableFullErrorVer13 parentMessage) {
    ...
    public OFBsnTableFullError.Builder setData(OFErrorCauseData data) {
        ...
        public OFBsnTableFullError build() {
                ...
                //
                return new OFBsnTableFullErrorVer13(
                    xid,
                    errMsg,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTableFullError> {
        ...
        public OFBsnTableFullError readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTableFullErrorVer13 bsnTableFullErrorVer13 = new OFBsnTableFullErrorVer13(
                    xid,
                      errMsg,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTableFullErrorVer13);
            return bsnTableFullErrorVer13;
        }
    }
    ...
    final static OFBsnTableFullErrorVer13Funnel FUNNEL = new OFBsnTableFullErrorVer13Funnel();
    static class OFBsnTableFullErrorVer13Funnel implements Funnel<OFBsnTableFullErrorVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTableFullErrorVer13 message, PrimitiveSink sink) {
            // fixed value property version = 4
    ...
    static class Writer implements OFMessageWriter<OFBsnTableFullErrorVer13> {
        @Override
        public void write(ByteBuf bb, OFBsnTableFullErrorVer13 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTableFullErrorVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTableFullErrorVer13 other = (OFBsnTableFullErrorVer13) obj;
