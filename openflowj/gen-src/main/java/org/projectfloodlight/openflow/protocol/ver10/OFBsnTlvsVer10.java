...
public class OFBsnTlvsVer10 implements OFBsnTlvs {
    ...
    public OFBsnTlvDhcpv6OptClientLlAddr dhcpv6OptClientLlAddr() {
        throw new UnsupportedOperationException("OFBsnTlvDhcpv6OptClientLlAddr not supported in version 1.0");
    }

    public OFBsnTlvDhcpv6OptRemoteId.Builder buildDhcpv6OptRemoteId() {
        throw new UnsupportedOperationException("OFBsnTlvDhcpv6OptRemoteId not supported in version 1.0");
    }
