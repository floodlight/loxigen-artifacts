...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnGentableEntryDescStatsReply> {
        ...
        public OFBsnGentableEntryDescStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnGentableEntryDescStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnGentableEntryDescStatsEntryVer13.READER);
