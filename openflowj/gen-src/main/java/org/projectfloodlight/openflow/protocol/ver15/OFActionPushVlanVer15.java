...
class OFActionPushVlanVer15 implements OFActionPushVlan {
    private static final Logger logger = LoggerFactory.getLogger(OFActionPushVlanVer15.class);
    // version: 1.5
...
//
    ...
    final static OFActionPushVlanVer15 DEFAULT = new OFActionPushVlanVer15(
        DEFAULT_ETHERTYPE
    );

    // package private constructor - used by readers, builders, and factory
    OFActionPushVlanVer15(EthType ethertype) {
        if(ethertype == null) {
            throw new NullPointerException("OFActionPushVlanVer15: property ethertype cannot be null");
        }
    ...
    static class BuilderWithParent implements OFActionPushVlan.Builder {
        final OFActionPushVlanVer15 parentMessage;

        // OF message fields
        private boolean ethertypeSet;
        private EthType ethertype;

        BuilderWithParent(OFActionPushVlanVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFActionPushVlan> {
        ...
        public OFActionPushVlan readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionPushVlanVer15 actionPushVlanVer15 = new OFActionPushVlanVer15(
                    ethertype
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionPushVlanVer15);
            return actionPushVlanVer15;
        }
    }
    ...
    final static OFActionPushVlanVer15Funnel FUNNEL = new OFActionPushVlanVer15Funnel();
    static class OFActionPushVlanVer15Funnel implements Funnel<OFActionPushVlanVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionPushVlanVer15 message, PrimitiveSink sink) {
            // fixed value property type = 17
    ...
    static class Writer implements OFMessageWriter<OFActionPushVlanVer15> {
        @Override
        public void write(ByteBuf bb, OFActionPushVlanVer15 message) {
            // fixed value property type = 17
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionPushVlanVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionPushVlanVer15 other = (OFActionPushVlanVer15) obj;
