...
class OFPacketInVer15 implements OFPacketIn {
    private static final Logger logger = LoggerFactory.getLogger(OFPacketInVer15.class);
    // version: 1.5
...
//
    ...
    OFPacketInVer15(long xid, OFBufferId bufferId, int totalLen, OFPacketInReason reason, TableId tableId, U64 cookie, Match match, byte[] data) {
        if(bufferId == null) {
            throw new NullPointerException("OFPacketInVer15: property bufferId cannot be null");
        }
        if(reason == null) {
            throw new NullPointerException("OFPacketInVer15: property reason cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFPacketInVer15: property tableId cannot be null");
        }
        if(cookie == null) {
            throw new NullPointerException("OFPacketInVer15: property cookie cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFPacketInVer15: property match cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFPacketInVer15: property data cannot be null");
        }
    ...
    public OFPort getInPhyPort()throws UnsupportedOperationException {
        throw new UnsupportedOperationException("Property inPhyPort not supported in version 1.5");
    }
    ...
    static class BuilderWithParent implements OFPacketIn.Builder {
        final OFPacketInVer15 parentMessage;
        ...
        BuilderWithParent(OFPacketInVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFPacketIn> {
        ...
        public OFPacketIn readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFPacketInVer15 packetInVer15 = new OFPacketInVer15(
                    xid,
                      bufferId,
                      totalLen,
                      reason,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", packetInVer15);
            return packetInVer15;
        }
    }
    ...
    final static OFPacketInVer15Funnel FUNNEL = new OFPacketInVer15Funnel();
    static class OFPacketInVer15Funnel implements Funnel<OFPacketInVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFPacketInVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFPacketInReasonSerializerVer15.putTo(message.reason, sink);
    ...
    static class Writer implements OFMessageWriter<OFPacketInVer15> {
        @Override
        public void write(ByteBuf bb, OFPacketInVer15 message) {
            ...
            OFPacketInReasonSerializerVer15.writeTo(bb, message.reason);
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFPacketInVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFPacketInVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFPacketInVer15 other = (OFPacketInVer15) obj;
