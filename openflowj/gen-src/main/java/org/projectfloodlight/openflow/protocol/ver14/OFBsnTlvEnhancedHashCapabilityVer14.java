...
class OFBsnTlvEnhancedHashCapabilityVer14 implements OFBsnTlvEnhancedHashCapability {
...
//
    ...
    final static OFBsnTlvEnhancedHashCapabilityVer14 DEFAULT = new OFBsnTlvEnhancedHashCapabilityVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvEnhancedHashCapability> {
        ...
        public OFBsnTlvEnhancedHashCapability readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvEnhancedHashCapabilityVer14 bsnTlvEnhancedHashCapabilityVer14 = new OFBsnTlvEnhancedHashCapabilityVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvEnhancedHashCapabilityVer14);
    ...
    final static OFBsnTlvEnhancedHashCapabilityVer14Funnel FUNNEL = new OFBsnTlvEnhancedHashCapabilityVer14Funnel();
    static class OFBsnTlvEnhancedHashCapabilityVer14Funnel implements Funnel<OFBsnTlvEnhancedHashCapabilityVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvEnhancedHashCapabilityVer14> {
        @Override
