...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFMeterFeaturesStatsRequest> {
        @Override
        public OFMeterFeaturesStatsRequest readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
