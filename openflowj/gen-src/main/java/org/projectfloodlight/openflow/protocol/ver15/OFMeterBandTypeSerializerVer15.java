...
public class OFMeterBandTypeSerializerVer15 {
    ...
    public static OFMeterBandType ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFMeterBandType in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFMeterBandType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFMeterBandType in version 1.5: " + e);
        }
    }
