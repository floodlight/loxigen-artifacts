...
//
    ...
    OFPortDescPropBsnExtendedCapabilitiesVer15(short anConfigurable, short fecConfigurable, short anConflict, short fecConflict, U64 reserve1, U64 reserve2, U64 reserve3) {
        if(reserve1 == null) {
            throw new NullPointerException("OFPortDescPropBsnExtendedCapabilitiesVer15: property reserve1 cannot be null");
        }
        if(reserve2 == null) {
            throw new NullPointerException("OFPortDescPropBsnExtendedCapabilitiesVer15: property reserve2 cannot be null");
        }
        if(reserve3 == null) {
            throw new NullPointerException("OFPortDescPropBsnExtendedCapabilitiesVer15: property reserve3 cannot be null");
        }
