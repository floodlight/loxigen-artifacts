...
public class OFBadInstructionCodeSerializerVer15 {
    ...
    public static OFBadInstructionCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBadInstructionCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBadInstructionCode e) {
        switch(e) {
            ...
            case DUP_INST:
                return DUP_INST_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBadInstructionCode in version 1.5: " + e);
        }
    }
