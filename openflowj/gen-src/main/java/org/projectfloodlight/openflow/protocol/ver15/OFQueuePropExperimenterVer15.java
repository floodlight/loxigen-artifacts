...
abstract class OFQueuePropExperimenterVer15 {
    // version: 1.5
    final static byte WIRE_VERSION = 6;
    final static int MINIMUM_LENGTH = 16;


    public final static OFQueuePropExperimenterVer15.Reader READER = new Reader();
    ...
    static class Reader implements OFMessageReader<OFQueuePropExperimenter> {
        ...
        public OFQueuePropExperimenter readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               default:
                   throw new OFParseError("Unknown value for discriminator experimenter of class OFQueuePropExperimenterVer15: " + experimenter);
            }
        }
    }
}
