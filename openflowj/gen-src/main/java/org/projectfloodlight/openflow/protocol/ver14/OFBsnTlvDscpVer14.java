...
class OFBsnTlvDscpVer14 implements OFBsnTlvDscp {
...
//
    ...
    final static OFBsnTlvDscpVer14 DEFAULT = new OFBsnTlvDscpVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvDscp> {
        ...
        public OFBsnTlvDscp readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvDscpVer14 bsnTlvDscpVer14 = new OFBsnTlvDscpVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvDscpVer14);
    ...
    final static OFBsnTlvDscpVer14Funnel FUNNEL = new OFBsnTlvDscpVer14Funnel();
    static class OFBsnTlvDscpVer14Funnel implements Funnel<OFBsnTlvDscpVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvDscpVer14> {
        @Override
