...
class OFOxmBsnUdf3MaskedVer15 implements OFOxmBsnUdf3Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnUdf3MaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnUdf3MaskedVer15 DEFAULT = new OFOxmBsnUdf3MaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnUdf3MaskedVer15(UDF value, UDF mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnUdf3MaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnUdf3MaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<UDF> getCanonical() {
        if (UDF.NO_MASK.equals(mask)) {
            return new OFOxmBsnUdf3Ver15(value);
    ...
    static class BuilderWithParent implements OFOxmBsnUdf3Masked.Builder {
        final OFOxmBsnUdf3MaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnUdf3MaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnUdf3Masked> {
        ...
        public OFOxmBsnUdf3Masked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnUdf3MaskedVer15 oxmBsnUdf3MaskedVer15 = new OFOxmBsnUdf3MaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnUdf3MaskedVer15);
            return oxmBsnUdf3MaskedVer15;
        }
    }
    ...
    final static OFOxmBsnUdf3MaskedVer15Funnel FUNNEL = new OFOxmBsnUdf3MaskedVer15Funnel();
    static class OFOxmBsnUdf3MaskedVer15Funnel implements Funnel<OFOxmBsnUdf3MaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnUdf3MaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x31708L
            sink.putInt(0x31708);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnUdf3MaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnUdf3MaskedVer15 message) {
            // fixed value property typeLen = 0x31708L
            bb.writeInt(0x31708);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnUdf3MaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnUdf3MaskedVer15 other = (OFOxmBsnUdf3MaskedVer15) obj;
