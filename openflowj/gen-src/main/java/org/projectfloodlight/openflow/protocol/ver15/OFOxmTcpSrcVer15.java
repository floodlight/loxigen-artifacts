...
class OFOxmTcpSrcVer15 implements OFOxmTcpSrc {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmTcpSrcVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmTcpSrcVer15 DEFAULT = new OFOxmTcpSrcVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmTcpSrcVer15(TransportPort value) {
        if(value == null) {
            throw new NullPointerException("OFOxmTcpSrcVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmTcpSrc.Builder {
        final OFOxmTcpSrcVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private TransportPort value;

        BuilderWithParent(OFOxmTcpSrcVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmTcpSrc> {
        @Override
        public OFOxmTcpSrc readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmTcpSrcVer15 oxmTcpSrcVer15 = new OFOxmTcpSrcVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTcpSrcVer15);
            return oxmTcpSrcVer15;
        }
    }
    ...
    final static OFOxmTcpSrcVer15Funnel FUNNEL = new OFOxmTcpSrcVer15Funnel();
    static class OFOxmTcpSrcVer15Funnel implements Funnel<OFOxmTcpSrcVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmTcpSrcVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001a02L
    ...
    static class Writer implements OFMessageWriter<OFOxmTcpSrcVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmTcpSrcVer15 message) {
            // fixed value property typeLen = 0x80001a02L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmTcpSrcVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmTcpSrcVer15 other = (OFOxmTcpSrcVer15) obj;
