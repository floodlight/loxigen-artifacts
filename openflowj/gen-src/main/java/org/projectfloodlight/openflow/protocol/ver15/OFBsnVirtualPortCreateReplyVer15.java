...
class OFBsnVirtualPortCreateReplyVer15 implements OFBsnVirtualPortCreateReply {
...
//
    ...
    final static OFBsnVirtualPortCreateReplyVer15 DEFAULT = new OFBsnVirtualPortCreateReplyVer15(
    ...
    public OFBsnVirtualPortCreateReply.Builder setVportNo(long vportNo) {
        ...
        public OFBsnVirtualPortCreateReply build() {
                ...
                //
                return new OFBsnVirtualPortCreateReplyVer15(
                    xid,
                    status,
                    vportNo
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVirtualPortCreateReply> {
        ...
        public OFBsnVirtualPortCreateReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnVirtualPortCreateReplyVer15 bsnVirtualPortCreateReplyVer15 = new OFBsnVirtualPortCreateReplyVer15(
                    xid,
                      status,
                      vportNo
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVirtualPortCreateReplyVer15);
    ...
    final static OFBsnVirtualPortCreateReplyVer15Funnel FUNNEL = new OFBsnVirtualPortCreateReplyVer15Funnel();
    static class OFBsnVirtualPortCreateReplyVer15Funnel implements Funnel<OFBsnVirtualPortCreateReplyVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnVirtualPortCreateReplyVer15> {
        @Override
