...
class OFBsnSetAuxCxnsReplyVer15 implements OFBsnSetAuxCxnsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnSetAuxCxnsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnSetAuxCxnsReplyVer15 DEFAULT = new OFBsnSetAuxCxnsReplyVer15(
        DEFAULT_XID, DEFAULT_NUM_AUX, DEFAULT_STATUS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnSetAuxCxnsReplyVer15(long xid, long numAux, long status) {
        this.xid = xid;
        this.numAux = numAux;
        this.status = status;
    }
    ...
    static class BuilderWithParent implements OFBsnSetAuxCxnsReply.Builder {
        final OFBsnSetAuxCxnsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnSetAuxCxnsReplyVer15 parentMessage) {
    ...
    public OFBsnSetAuxCxnsReply.Builder setStatus(long status) {
        ...
        public OFBsnSetAuxCxnsReply build() {
                ...
                //
                return new OFBsnSetAuxCxnsReplyVer15(
                    xid,
                    numAux,
                    status
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnSetAuxCxnsReply> {
        @Override
        public OFBsnSetAuxCxnsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnSetAuxCxnsReplyVer15 bsnSetAuxCxnsReplyVer15 = new OFBsnSetAuxCxnsReplyVer15(
                    xid,
                      numAux,
                      status
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSetAuxCxnsReplyVer15);
            return bsnSetAuxCxnsReplyVer15;
        }
    }
    ...
    final static OFBsnSetAuxCxnsReplyVer15Funnel FUNNEL = new OFBsnSetAuxCxnsReplyVer15Funnel();
    static class OFBsnSetAuxCxnsReplyVer15Funnel implements Funnel<OFBsnSetAuxCxnsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnSetAuxCxnsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnSetAuxCxnsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnSetAuxCxnsReplyVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnSetAuxCxnsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnSetAuxCxnsReplyVer15 other = (OFBsnSetAuxCxnsReplyVer15) obj;
