...
public class OFBsnUdfAnchorSerializerVer15 {
    ...
    public static OFBsnUdfAnchor ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnUdfAnchor in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnUdfAnchor e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnUdfAnchor in version 1.5: " + e);
        }
    }
