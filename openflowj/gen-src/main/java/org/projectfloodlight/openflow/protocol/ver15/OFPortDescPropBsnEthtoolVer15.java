...
//
    ...
    final static OFPortDescPropBsnEthtoolVer15 DEFAULT = new OFPortDescPropBsnEthtoolVer15(
        DEFAULT_DATA_JSON
    );

    // package private constructor - used by readers, builders, and factory
    OFPortDescPropBsnEthtoolVer15(byte[] dataJson) {
        if(dataJson == null) {
            throw new NullPointerException("OFPortDescPropBsnEthtoolVer15: property dataJson cannot be null");
        }
