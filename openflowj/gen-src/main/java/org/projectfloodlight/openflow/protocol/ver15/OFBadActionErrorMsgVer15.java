...
class OFBadActionErrorMsgVer15 implements OFBadActionErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFBadActionErrorMsgVer15.class);
    // version: 1.5
...
//
    ...
    OFBadActionErrorMsgVer15(long xid, OFBadActionCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFBadActionErrorMsgVer15: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBadActionErrorMsgVer15: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
    ...
    static class BuilderWithParent implements OFBadActionErrorMsg.Builder {
        final OFBadActionErrorMsgVer15 parentMessage;
        ...
        BuilderWithParent(OFBadActionErrorMsgVer15 parentMessage) {
    ...
    public OFBadActionErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFBadActionErrorMsg build() {
                ...
                //
                return new OFBadActionErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBadActionErrorMsg> {
        ...
        public OFBadActionErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBadActionCode code = OFBadActionCodeSerializerVer15.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_15);

            OFBadActionErrorMsgVer15 badActionErrorMsgVer15 = new OFBadActionErrorMsgVer15(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", badActionErrorMsgVer15);
            return badActionErrorMsgVer15;
        }
    }
    ...
    final static OFBadActionErrorMsgVer15Funnel FUNNEL = new OFBadActionErrorMsgVer15Funnel();
    static class OFBadActionErrorMsgVer15Funnel implements Funnel<OFBadActionErrorMsgVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBadActionErrorMsgVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFBadActionCodeSerializerVer15.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFBadActionErrorMsgVer15> {
        @Override
        public void write(ByteBuf bb, OFBadActionErrorMsgVer15 message) {
            ...
            OFBadActionCodeSerializerVer15.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBadActionErrorMsgVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBadActionErrorMsgVer15 other = (OFBadActionErrorMsgVer15) obj;
