...
class OFBsnFlowIdleEnableSetReplyVer15 implements OFBsnFlowIdleEnableSetReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnFlowIdleEnableSetReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnFlowIdleEnableSetReplyVer15 DEFAULT = new OFBsnFlowIdleEnableSetReplyVer15(
        DEFAULT_XID, DEFAULT_ENABLE, DEFAULT_STATUS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnFlowIdleEnableSetReplyVer15(long xid, long enable, long status) {
        this.xid = xid;
        this.enable = enable;
        this.status = status;
    }
    ...
    static class BuilderWithParent implements OFBsnFlowIdleEnableSetReply.Builder {
        final OFBsnFlowIdleEnableSetReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnFlowIdleEnableSetReplyVer15 parentMessage) {
    ...
    public OFBsnFlowIdleEnableSetReply.Builder setStatus(long status) {
        ...
        public OFBsnFlowIdleEnableSetReply build() {
                ...
                //
                return new OFBsnFlowIdleEnableSetReplyVer15(
                    xid,
                    enable,
                    status
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnFlowIdleEnableSetReply> {
        ...
        public OFBsnFlowIdleEnableSetReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnFlowIdleEnableSetReplyVer15 bsnFlowIdleEnableSetReplyVer15 = new OFBsnFlowIdleEnableSetReplyVer15(
                    xid,
                      enable,
                      status
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnFlowIdleEnableSetReplyVer15);
            return bsnFlowIdleEnableSetReplyVer15;
        }
    }
    ...
    final static OFBsnFlowIdleEnableSetReplyVer15Funnel FUNNEL = new OFBsnFlowIdleEnableSetReplyVer15Funnel();
    static class OFBsnFlowIdleEnableSetReplyVer15Funnel implements Funnel<OFBsnFlowIdleEnableSetReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnFlowIdleEnableSetReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnFlowIdleEnableSetReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnFlowIdleEnableSetReplyVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnFlowIdleEnableSetReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnFlowIdleEnableSetReplyVer15 other = (OFBsnFlowIdleEnableSetReplyVer15) obj;
