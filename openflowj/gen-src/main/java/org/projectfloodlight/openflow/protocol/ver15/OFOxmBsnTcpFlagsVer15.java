...
class OFOxmBsnTcpFlagsVer15 implements OFOxmBsnTcpFlags {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnTcpFlagsVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnTcpFlagsVer15 DEFAULT = new OFOxmBsnTcpFlagsVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnTcpFlagsVer15(U16 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnTcpFlagsVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnTcpFlags.Builder {
        final OFOxmBsnTcpFlagsVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U16 value;

        BuilderWithParent(OFOxmBsnTcpFlagsVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnTcpFlags> {
        ...
        public OFOxmBsnTcpFlags readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnTcpFlagsVer15 oxmBsnTcpFlagsVer15 = new OFOxmBsnTcpFlagsVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnTcpFlagsVer15);
            return oxmBsnTcpFlagsVer15;
        }
    }
    ...
    final static OFOxmBsnTcpFlagsVer15Funnel FUNNEL = new OFOxmBsnTcpFlagsVer15Funnel();
    static class OFOxmBsnTcpFlagsVer15Funnel implements Funnel<OFOxmBsnTcpFlagsVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnTcpFlagsVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32002L
            sink.putInt(0x32002);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnTcpFlagsVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnTcpFlagsVer15 message) {
            // fixed value property typeLen = 0x32002L
            bb.writeInt(0x32002);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnTcpFlagsVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnTcpFlagsVer15 other = (OFOxmBsnTcpFlagsVer15) obj;
