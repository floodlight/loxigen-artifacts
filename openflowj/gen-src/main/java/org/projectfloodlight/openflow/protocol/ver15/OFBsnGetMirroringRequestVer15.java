...
class OFBsnGetMirroringRequestVer15 implements OFBsnGetMirroringRequest {
...
//
    ...
    final static OFBsnGetMirroringRequestVer15 DEFAULT = new OFBsnGetMirroringRequestVer15(
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGetMirroringRequest> {
        ...
        public OFBsnGetMirroringRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGetMirroringRequestVer15 bsnGetMirroringRequestVer15 = new OFBsnGetMirroringRequestVer15(
                    xid,
                      reportMirrorPorts
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGetMirroringRequestVer15);
    ...
    final static OFBsnGetMirroringRequestVer15Funnel FUNNEL = new OFBsnGetMirroringRequestVer15Funnel();
    static class OFBsnGetMirroringRequestVer15Funnel implements Funnel<OFBsnGetMirroringRequestVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGetMirroringRequestVer15> {
        @Override
