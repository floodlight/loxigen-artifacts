...
public class OFFactoryVer11 implements OFFactory {
    ...
    public OFFlowDescEntry.Builder buildFlowDescEntry() {
        throw new UnsupportedOperationException("OFFlowDescEntry not supported in version 1.1");
    }

    public OFFlowDescReply.Builder buildFlowDescReply() {
        throw new UnsupportedOperationException("OFFlowDescReply not supported in version 1.1");
    }

    public OFFlowDescRequest.Builder buildFlowDescRequest() {
        throw new UnsupportedOperationException("OFFlowDescRequest not supported in version 1.1");
    }
