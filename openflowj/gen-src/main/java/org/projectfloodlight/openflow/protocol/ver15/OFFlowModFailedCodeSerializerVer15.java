...
public class OFFlowModFailedCodeSerializerVer15 {
    ...
    public final static short IS_SYNC_VAL = (short) 0xa;
    ...
    public static OFFlowModFailedCode ofWireValue(short val) {
        switch(val) {
            ...
            case IS_SYNC_VAL:
                return OFFlowModFailedCode.IS_SYNC;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFFlowModFailedCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFFlowModFailedCode e) {
        switch(e) {
            ...
            case IS_SYNC:
                return IS_SYNC_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFFlowModFailedCode in version 1.5: " + e);
        }
    }
