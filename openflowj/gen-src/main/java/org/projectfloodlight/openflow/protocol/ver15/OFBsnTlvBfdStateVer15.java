...
class OFBsnTlvBfdStateVer15 implements OFBsnTlvBfdState {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvBfdState> {
        ...
        public OFBsnTlvBfdState readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvBfdStateVer15 bsnTlvBfdStateVer15 = new OFBsnTlvBfdStateVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvBfdStateVer15);
    ...
    final static OFBsnTlvBfdStateVer15Funnel FUNNEL = new OFBsnTlvBfdStateVer15Funnel();
    static class OFBsnTlvBfdStateVer15Funnel implements Funnel<OFBsnTlvBfdStateVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvBfdStateVer15> {
        @Override
