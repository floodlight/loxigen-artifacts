...
class OFOxmIcmpv6TypeMaskedVer15 implements OFOxmIcmpv6TypeMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIcmpv6TypeMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIcmpv6TypeMaskedVer15 DEFAULT = new OFOxmIcmpv6TypeMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIcmpv6TypeMaskedVer15(U8 value, U8 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIcmpv6TypeMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIcmpv6TypeMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U8> getCanonical() {
        if (U8.NO_MASK.equals(mask)) {
            return new OFOxmIcmpv6TypeVer15(value);
    ...
    static class BuilderWithParent implements OFOxmIcmpv6TypeMasked.Builder {
        final OFOxmIcmpv6TypeMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIcmpv6TypeMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv6TypeMasked> {
        ...
        public OFOxmIcmpv6TypeMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIcmpv6TypeMaskedVer15 oxmIcmpv6TypeMaskedVer15 = new OFOxmIcmpv6TypeMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv6TypeMaskedVer15);
            return oxmIcmpv6TypeMaskedVer15;
        }
    }
    ...
    final static OFOxmIcmpv6TypeMaskedVer15Funnel FUNNEL = new OFOxmIcmpv6TypeMaskedVer15Funnel();
    static class OFOxmIcmpv6TypeMaskedVer15Funnel implements Funnel<OFOxmIcmpv6TypeMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIcmpv6TypeMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003b02L
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv6TypeMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIcmpv6TypeMaskedVer15 message) {
            // fixed value property typeLen = 0x80003b02L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIcmpv6TypeMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIcmpv6TypeMaskedVer15 other = (OFOxmIcmpv6TypeMaskedVer15) obj;
