...
class OFOxmBsnInPorts128MaskedVer15 implements OFOxmBsnInPorts128Masked {
...
//
    ...
    final static OFOxmBsnInPorts128MaskedVer15 DEFAULT = new OFOxmBsnInPorts128MaskedVer15(
    ...
    public OFOxm<OFBitMask128> getCanonical() {
        if (OFBitMask128.NO_MASK.equals(mask)) {
            return new OFOxmBsnInPorts128Ver15(value);
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmBsnInPorts128Masked> {
        @Override
        public OFOxmBsnInPorts128Masked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInPorts128MaskedVer15 oxmBsnInPorts128MaskedVer15 = new OFOxmBsnInPorts128MaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInPorts128MaskedVer15);
    ...
    final static OFOxmBsnInPorts128MaskedVer15Funnel FUNNEL = new OFOxmBsnInPorts128MaskedVer15Funnel();
    static class OFOxmBsnInPorts128MaskedVer15Funnel implements Funnel<OFOxmBsnInPorts128MaskedVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInPorts128MaskedVer15> {
        @Override
