...
class OFOxmIpv6DstMaskedVer15 implements OFOxmIpv6DstMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6DstMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6DstMaskedVer15 DEFAULT = new OFOxmIpv6DstMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6DstMaskedVer15(IPv6Address value, IPv6Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6DstMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv6DstMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6DstMasked.Builder {
        final OFOxmIpv6DstMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv6DstMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6DstMasked> {
        ...
        public OFOxmIpv6DstMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6DstMaskedVer15 oxmIpv6DstMaskedVer15 = new OFOxmIpv6DstMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6DstMaskedVer15);
            return oxmIpv6DstMaskedVer15;
        }
    }
    ...
    final static OFOxmIpv6DstMaskedVer15Funnel FUNNEL = new OFOxmIpv6DstMaskedVer15Funnel();
    static class OFOxmIpv6DstMaskedVer15Funnel implements Funnel<OFOxmIpv6DstMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6DstMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003720L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6DstMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6DstMaskedVer15 message) {
            // fixed value property typeLen = 0x80003720L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6DstMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6DstMaskedVer15 other = (OFOxmIpv6DstMaskedVer15) obj;
