...
class OFBsnTlvTunnelCapabilityVer14 implements OFBsnTlvTunnelCapability {
...
//
    ...
    final static OFBsnTlvTunnelCapabilityVer14 DEFAULT = new OFBsnTlvTunnelCapabilityVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvTunnelCapability> {
        ...
        public OFBsnTlvTunnelCapability readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvTunnelCapabilityVer14 bsnTlvTunnelCapabilityVer14 = new OFBsnTlvTunnelCapabilityVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvTunnelCapabilityVer14);
    ...
    final static OFBsnTlvTunnelCapabilityVer14Funnel FUNNEL = new OFBsnTlvTunnelCapabilityVer14Funnel();
    static class OFBsnTlvTunnelCapabilityVer14Funnel implements Funnel<OFBsnTlvTunnelCapabilityVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvTunnelCapabilityVer14> {
        @Override
