...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnGentableEntryDescStatsEntry> {
        @Override
        public OFBsnGentableEntryDescStatsEntry readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
