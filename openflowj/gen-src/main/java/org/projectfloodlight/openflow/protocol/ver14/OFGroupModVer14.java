        ...
        public OFGroupMod readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(command) {
               case (short) 0x0:
                   ...
                   return OFGroupAddVer14.READER.readFrom(context, bb);
               case (short) 0x2:
                   bb.readerIndex(start);
                   // discriminator value OFGroupModCommand.DELETE=2 for class OFGroupDeleteVer14
                   return OFGroupDeleteVer14.READER.readFrom(context, bb);
               case (short) 0x1:
                   bb.readerIndex(start);
                   // discriminator value OFGroupModCommand.MODIFY=1 for class OFGroupModifyVer14
                   return OFGroupModifyVer14.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFGroupModVer14.class, "command", command);
            }
            OFGroupTypeSerializerVer14.readFrom(bb);
            // pad: 1 bytes
            bb.skipBytes(1);
            OFGroup.read4Bytes(bb);
            ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBucketVer14.READER);
