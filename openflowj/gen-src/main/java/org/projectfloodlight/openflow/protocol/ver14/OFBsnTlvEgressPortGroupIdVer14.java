...
class OFBsnTlvEgressPortGroupIdVer14 implements OFBsnTlvEgressPortGroupId {
...
//
    ...
    final static OFBsnTlvEgressPortGroupIdVer14 DEFAULT = new OFBsnTlvEgressPortGroupIdVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvEgressPortGroupId> {
        ...
        public OFBsnTlvEgressPortGroupId readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvEgressPortGroupIdVer14 bsnTlvEgressPortGroupIdVer14 = new OFBsnTlvEgressPortGroupIdVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvEgressPortGroupIdVer14);
    ...
    final static OFBsnTlvEgressPortGroupIdVer14Funnel FUNNEL = new OFBsnTlvEgressPortGroupIdVer14Funnel();
    static class OFBsnTlvEgressPortGroupIdVer14Funnel implements Funnel<OFBsnTlvEgressPortGroupIdVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvEgressPortGroupIdVer14> {
        @Override
