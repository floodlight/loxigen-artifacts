...
class OFBsnGentableEntryAddVer15 implements OFBsnGentableEntryAdd {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryAddVer15.class);
    // version: 1.5
...
//
    ...
    OFBsnGentableEntryAddVer15(long xid, GenTableId tableId, U128 checksum, List<OFBsnTlv> key, List<OFBsnTlv> value) {
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableEntryAddVer15: property tableId cannot be null");
        }
        if(checksum == null) {
            throw new NullPointerException("OFBsnGentableEntryAddVer15: property checksum cannot be null");
        }
        if(key == null) {
            throw new NullPointerException("OFBsnGentableEntryAddVer15: property key cannot be null");
        }
        if(value == null) {
            throw new NullPointerException("OFBsnGentableEntryAddVer15: property value cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnGentableEntryAdd.Builder {
        final OFBsnGentableEntryAddVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryAddVer15 parentMessage) {
    ...
    public OFBsnGentableEntryAdd.Builder setValue(List<OFBsnTlv> value) {
        ...
        public OFBsnGentableEntryAdd build() {
                ...
                //
                return new OFBsnGentableEntryAddVer15(
                    xid,
                    tableId,
                    checksum,
                    key,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryAdd> {
        ...
        public OFBsnGentableEntryAdd readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGentableEntryAddVer15 bsnGentableEntryAddVer15 = new OFBsnGentableEntryAddVer15(
                    xid,
                      tableId,
                      checksum,
                      key,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryAddVer15);
            return bsnGentableEntryAddVer15;
        }
    }
    ...
    final static OFBsnGentableEntryAddVer15Funnel FUNNEL = new OFBsnGentableEntryAddVer15Funnel();
    static class OFBsnGentableEntryAddVer15Funnel implements Funnel<OFBsnGentableEntryAddVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableEntryAddVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryAddVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableEntryAddVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnGentableEntryAddVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryAddVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryAddVer15 other = (OFBsnGentableEntryAddVer15) obj;
