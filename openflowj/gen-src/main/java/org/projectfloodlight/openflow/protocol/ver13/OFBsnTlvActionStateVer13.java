...
class OFBsnTlvActionStateVer13 implements OFBsnTlvActionState {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvActionState> {
        ...
        public OFBsnTlvActionState readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvActionStateVer13 bsnTlvActionStateVer13 = new OFBsnTlvActionStateVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvActionStateVer13);
    ...
    final static OFBsnTlvActionStateVer13Funnel FUNNEL = new OFBsnTlvActionStateVer13Funnel();
    static class OFBsnTlvActionStateVer13Funnel implements Funnel<OFBsnTlvActionStateVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvActionStateVer13> {
        @Override
