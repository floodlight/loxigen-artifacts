...
class OFBsnTlvVfiVer14 implements OFBsnTlvVfi {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnTlvVfiVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnTlvVfiVer14 DEFAULT = new OFBsnTlvVfiVer14(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFBsnTlvVfi.Builder {
        final OFBsnTlvVfiVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private int value;

        BuilderWithParent(OFBsnTlvVfiVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvVfi> {
        ...
        public OFBsnTlvVfi readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvVfiVer14 bsnTlvVfiVer14 = new OFBsnTlvVfiVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvVfiVer14);
            return bsnTlvVfiVer14;
        }
    }
    ...
    final static OFBsnTlvVfiVer14Funnel FUNNEL = new OFBsnTlvVfiVer14Funnel();
    static class OFBsnTlvVfiVer14Funnel implements Funnel<OFBsnTlvVfiVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvVfiVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0x63
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvVfiVer14> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvVfiVer14 message) {
            // fixed value property type = 0x63
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTlvVfiVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTlvVfiVer14 other = (OFBsnTlvVfiVer14) obj;
