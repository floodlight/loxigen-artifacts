...
class OFQueueOpFailedErrorMsgVer15 implements OFQueueOpFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFQueueOpFailedErrorMsgVer15.class);
    // version: 1.5
...
//
    ...
    OFQueueOpFailedErrorMsgVer15(long xid, OFQueueOpFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFQueueOpFailedErrorMsgVer15: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFQueueOpFailedErrorMsgVer15: property data cannot be null");
        }
    ...
    static class BuilderWithParent implements OFQueueOpFailedErrorMsg.Builder {
        final OFQueueOpFailedErrorMsgVer15 parentMessage;
        ...
        BuilderWithParent(OFQueueOpFailedErrorMsgVer15 parentMessage) {
    ...
    public OFQueueOpFailedErrorMsg.Builder setXid(long xid) {
        ...
        public OFQueueOpFailedErrorMsg build() {
                ...
                //
                return new OFQueueOpFailedErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueOpFailedErrorMsg> {
        ...
        public OFQueueOpFailedErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFQueueOpFailedCode code = OFQueueOpFailedCodeSerializerVer15.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_15);

            OFQueueOpFailedErrorMsgVer15 queueOpFailedErrorMsgVer15 = new OFQueueOpFailedErrorMsgVer15(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueOpFailedErrorMsgVer15);
            return queueOpFailedErrorMsgVer15;
        }
    }
    ...
    final static OFQueueOpFailedErrorMsgVer15Funnel FUNNEL = new OFQueueOpFailedErrorMsgVer15Funnel();
    static class OFQueueOpFailedErrorMsgVer15Funnel implements Funnel<OFQueueOpFailedErrorMsgVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueOpFailedErrorMsgVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFQueueOpFailedCodeSerializerVer15.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFQueueOpFailedErrorMsgVer15> {
        @Override
        public void write(ByteBuf bb, OFQueueOpFailedErrorMsgVer15 message) {
            ...
            OFQueueOpFailedCodeSerializerVer15.writeTo(bb, message.code);
            message.data.writeTo(bb);

            // update length field
            int length = bb.writerIndex() - startIndex;
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFQueueOpFailedErrorMsgVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueOpFailedErrorMsgVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueOpFailedErrorMsgVer15 other = (OFQueueOpFailedErrorMsgVer15) obj;
