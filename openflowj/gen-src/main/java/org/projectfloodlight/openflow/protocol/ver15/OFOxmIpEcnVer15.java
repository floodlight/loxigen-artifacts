...
class OFOxmIpEcnVer15 implements OFOxmIpEcn {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpEcnVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpEcnVer15 DEFAULT = new OFOxmIpEcnVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpEcnVer15(IpEcn value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpEcnVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpEcn.Builder {
        final OFOxmIpEcnVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IpEcn value;

        BuilderWithParent(OFOxmIpEcnVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpEcn> {
        ...
        public OFOxmIpEcn readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpEcnVer15 oxmIpEcnVer15 = new OFOxmIpEcnVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpEcnVer15);
            return oxmIpEcnVer15;
        }
    }
    ...
    final static OFOxmIpEcnVer15Funnel FUNNEL = new OFOxmIpEcnVer15Funnel();
    static class OFOxmIpEcnVer15Funnel implements Funnel<OFOxmIpEcnVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpEcnVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001201L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpEcnVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpEcnVer15 message) {
            // fixed value property typeLen = 0x80001201L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpEcnVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpEcnVer15 other = (OFOxmIpEcnVer15) obj;
