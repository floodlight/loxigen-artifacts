...
class OFOxmIpv6SrcVer15 implements OFOxmIpv6Src {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6SrcVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv6SrcVer15 DEFAULT = new OFOxmIpv6SrcVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6SrcVer15(IPv6Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6SrcVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6Src.Builder {
        final OFOxmIpv6SrcVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv6Address value;

        BuilderWithParent(OFOxmIpv6SrcVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmIpv6Src> {
        @Override
        public OFOxmIpv6Src readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6SrcVer15 oxmIpv6SrcVer15 = new OFOxmIpv6SrcVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6SrcVer15);
            return oxmIpv6SrcVer15;
        }
    }
    ...
    final static OFOxmIpv6SrcVer15Funnel FUNNEL = new OFOxmIpv6SrcVer15Funnel();
    static class OFOxmIpv6SrcVer15Funnel implements Funnel<OFOxmIpv6SrcVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6SrcVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003410L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6SrcVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6SrcVer15 message) {
            // fixed value property typeLen = 0x80003410L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6SrcVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6SrcVer15 other = (OFOxmIpv6SrcVer15) obj;
