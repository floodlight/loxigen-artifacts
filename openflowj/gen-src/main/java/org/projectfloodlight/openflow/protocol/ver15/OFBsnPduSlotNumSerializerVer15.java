...
public class OFBsnPduSlotNumSerializerVer15 {
    ...
    public static OFBsnPduSlotNum ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnPduSlotNum in version 1.5: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnPduSlotNum e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnPduSlotNum in version 1.5: " + e);
        }
    }
