...
class OFGroupModFailedErrorMsgVer15 implements OFGroupModFailedErrorMsg {
...
//
    ...
    public OFGroupModFailedErrorMsg.Builder setXid(long xid) {
        ...
        public OFGroupModFailedErrorMsg build() {
                ...
                //
                return new OFGroupModFailedErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupModFailedErrorMsg> {
        ...
        public OFGroupModFailedErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupModFailedErrorMsgVer15);
    ...
    final static OFGroupModFailedErrorMsgVer15Funnel FUNNEL = new OFGroupModFailedErrorMsgVer15Funnel();
    static class OFGroupModFailedErrorMsgVer15Funnel implements Funnel<OFGroupModFailedErrorMsgVer15> {
    ...
    static class Writer implements OFMessageWriter<OFGroupModFailedErrorMsgVer15> {
        @Override
        public void write(ByteBuf bb, OFGroupModFailedErrorMsgVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFGroupModFailedErrorMsgVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
