...
class OFBsnLogVer15 implements OFBsnLog {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnLogVer15.class);
    // version: 1.5
...
//
    ...
    OFBsnLogVer15(long xid, OFBsnLoglevel loglevel, String data) {
        if(loglevel == null) {
            throw new NullPointerException("OFBsnLogVer15: property loglevel cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBsnLogVer15: property data cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnLog.Builder {
        final OFBsnLogVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnLogVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnLog> {
        @Override
        public OFBsnLog readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnLoglevel loglevel = OFBsnLoglevelSerializerVer15.readFrom(bb);
            String data = ChannelUtils.readFixedLengthString(bb, length - (bb.readerIndex() - start));

            OFBsnLogVer15 bsnLogVer15 = new OFBsnLogVer15(
                    xid,
                      loglevel,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLogVer15);
            return bsnLogVer15;
        }
    }
    ...
    final static OFBsnLogVer15Funnel FUNNEL = new OFBsnLogVer15Funnel();
    static class OFBsnLogVer15Funnel implements Funnel<OFBsnLogVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnLogVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            // fixed value property subtype = 0x3fL
            sink.putInt(0x3f);
            OFBsnLoglevelSerializerVer15.putTo(message.loglevel, sink);
    ...
    static class Writer implements OFMessageWriter<OFBsnLogVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnLogVer15 message) {
            ...
            // fixed value property subtype = 0x3fL
            bb.writeInt(0x3f);
            OFBsnLoglevelSerializerVer15.writeTo(bb, message.loglevel);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnLogVer15(");
