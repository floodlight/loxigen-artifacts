...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFMeterStatsReply> {
        @Override
        public OFMeterStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFMeterStats> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFMeterStatsVer13.READER);
