...
public class OFErrorTypeSerializerVer15 {
    ...
    public static OFErrorType ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFErrorType in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFErrorType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFErrorType in version 1.5: " + e);
        }
    }
