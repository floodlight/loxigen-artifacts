...
class OFOxmIpv4DstVer15 implements OFOxmIpv4Dst {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv4DstVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmIpv4DstVer15 DEFAULT = new OFOxmIpv4DstVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv4DstVer15(IPv4Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv4DstVer15: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv4Dst.Builder {
        final OFOxmIpv4DstVer15 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv4Address value;

        BuilderWithParent(OFOxmIpv4DstVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv4Dst> {
        ...
        public OFOxmIpv4Dst readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv4DstVer15 oxmIpv4DstVer15 = new OFOxmIpv4DstVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv4DstVer15);
            return oxmIpv4DstVer15;
        }
    }
    ...
    final static OFOxmIpv4DstVer15Funnel FUNNEL = new OFOxmIpv4DstVer15Funnel();
    static class OFOxmIpv4DstVer15Funnel implements Funnel<OFOxmIpv4DstVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv4DstVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001804L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv4DstVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv4DstVer15 message) {
            // fixed value property typeLen = 0x80001804L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv4DstVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv4DstVer15 other = (OFOxmIpv4DstVer15) obj;
