    ...
    static class Reader implements OFMessageReader<OFStatsReply> {
        ...
        public OFStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(statsType) {
               ...
               case (short) 0x11:
                   // discriminator value OFStatsType.FLOW=17 for class OFFlowStatsReplyVer15
               ...
               case (short) 0x1:
                   // discriminator value OFStatsType.FLOW_DESC=1 for class OFFlowDescReplyVer15
                   return OFFlowDescReplyVer15.READER.readFrom(bb);
               case (short) 0x10:
