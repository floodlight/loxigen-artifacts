...
abstract class OFTableModPropExperimenterVer15 {
    // version: 1.5
    final static byte WIRE_VERSION = 6;
    final static int MINIMUM_LENGTH = 12;


    public final static OFTableModPropExperimenterVer15.Reader READER = new Reader();
    ...
    static class Reader implements OFMessageReader<OFTableModPropExperimenter> {
        ...
        public OFTableModPropExperimenter readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               default:
                   throw new OFParseError("Unknown value for discriminator experimenter of class OFTableModPropExperimenterVer15: " + experimenter);
            }
        }
    }
}
