...
class OFBsnTlvRateUnitVer15 implements OFBsnTlvRateUnit {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvRateUnit> {
        ...
        public OFBsnTlvRateUnit readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvRateUnitVer15 bsnTlvRateUnitVer15 = new OFBsnTlvRateUnitVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvRateUnitVer15);
    ...
    final static OFBsnTlvRateUnitVer15Funnel FUNNEL = new OFBsnTlvRateUnitVer15Funnel();
    static class OFBsnTlvRateUnitVer15Funnel implements Funnel<OFBsnTlvRateUnitVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvRateUnitVer15> {
        @Override
