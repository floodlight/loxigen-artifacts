...
class OFOxmOvsTcpFlagsMaskedVer15 implements OFOxmOvsTcpFlagsMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmOvsTcpFlagsMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmOvsTcpFlagsMaskedVer15 DEFAULT = new OFOxmOvsTcpFlagsMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmOvsTcpFlagsMaskedVer15(U16 value, U16 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmOvsTcpFlagsMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmOvsTcpFlagsMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmOvsTcpFlagsMasked.Builder {
        final OFOxmOvsTcpFlagsMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmOvsTcpFlagsMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmOvsTcpFlagsMasked> {
        ...
        public OFOxmOvsTcpFlagsMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmOvsTcpFlagsMaskedVer15 oxmOvsTcpFlagsMaskedVer15 = new OFOxmOvsTcpFlagsMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmOvsTcpFlagsMaskedVer15);
            return oxmOvsTcpFlagsMaskedVer15;
        }
    }
    ...
    final static OFOxmOvsTcpFlagsMaskedVer15Funnel FUNNEL = new OFOxmOvsTcpFlagsMaskedVer15Funnel();
    static class OFOxmOvsTcpFlagsMaskedVer15Funnel implements Funnel<OFOxmOvsTcpFlagsMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmOvsTcpFlagsMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0xffff5508L
    ...
    static class Writer implements OFMessageWriter<OFOxmOvsTcpFlagsMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmOvsTcpFlagsMaskedVer15 message) {
            // fixed value property typeLen = 0xffff5508L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmOvsTcpFlagsMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmOvsTcpFlagsMaskedVer15 other = (OFOxmOvsTcpFlagsMaskedVer15) obj;
