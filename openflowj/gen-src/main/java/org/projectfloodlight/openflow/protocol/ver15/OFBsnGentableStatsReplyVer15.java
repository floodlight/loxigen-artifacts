...
class OFBsnGentableStatsReplyVer15 implements OFBsnGentableStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnGentableStatsReplyVer15 DEFAULT = new OFBsnGentableStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
    ...
    static class BuilderWithParent implements OFBsnGentableStatsReply.Builder {
        final OFBsnGentableStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableStatsReplyVer15 parentMessage) {
    ...
    public OFBsnGentableStatsReply.Builder setXid(long xid) {
        ...
        public OFBsnGentableStatsReply build() {
                ...
                //
                return new OFBsnGentableStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableStatsReply> {
        ...
        public OFBsnGentableStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnGentableStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGentableStatsEntryVer15.READER);

            OFBsnGentableStatsReplyVer15 bsnGentableStatsReplyVer15 = new OFBsnGentableStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableStatsReplyVer15);
            return bsnGentableStatsReplyVer15;
        }
    }
    ...
    final static OFBsnGentableStatsReplyVer15Funnel FUNNEL = new OFBsnGentableStatsReplyVer15Funnel();
    static class OFBsnGentableStatsReplyVer15Funnel implements Funnel<OFBsnGentableStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnGentableStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableStatsReplyVer15 other = (OFBsnGentableStatsReplyVer15) obj;
