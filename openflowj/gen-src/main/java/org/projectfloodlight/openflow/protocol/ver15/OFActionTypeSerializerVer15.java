...
public class OFActionTypeSerializerVer15 {
    ...
    public final static short COPY_FIELD_VAL = (short) 0x1c;
    public final static short METER_VAL = (short) 0x1d;
    ...
    public static short toWireValue(OFActionType e) {
        switch(e) {
            ...
            case POP_PBB:
                return POP_PBB_VAL;
            case COPY_FIELD:
                return COPY_FIELD_VAL;
            case METER:
                return METER_VAL;
            case EXPERIMENTER:
                return EXPERIMENTER_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFActionType in version 1.5: " + e);
        }
    }
