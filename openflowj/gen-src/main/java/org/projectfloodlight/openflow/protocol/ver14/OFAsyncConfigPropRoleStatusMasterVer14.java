...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFAsyncConfigPropRoleStatusMaster> {
        @Override
        public OFAsyncConfigPropRoleStatusMaster readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
