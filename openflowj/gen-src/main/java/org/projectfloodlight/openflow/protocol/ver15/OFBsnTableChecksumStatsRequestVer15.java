...
class OFBsnTableChecksumStatsRequestVer15 implements OFBsnTableChecksumStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnTableChecksumStatsRequestVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnTableChecksumStatsRequestVer15 DEFAULT = new OFBsnTableChecksumStatsRequestVer15(
        DEFAULT_XID, DEFAULT_FLAGS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnTableChecksumStatsRequestVer15(long xid, Set<OFStatsRequestFlags> flags) {
        if(flags == null) {
            throw new NullPointerException("OFBsnTableChecksumStatsRequestVer15: property flags cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    }
    ...
    static class BuilderWithParent implements OFBsnTableChecksumStatsRequest.Builder {
        final OFBsnTableChecksumStatsRequestVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnTableChecksumStatsRequestVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTableChecksumStatsRequest> {
        ...
        public OFBsnTableChecksumStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTableChecksumStatsRequestVer15 bsnTableChecksumStatsRequestVer15 = new OFBsnTableChecksumStatsRequestVer15(
                    xid,
                      flags
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTableChecksumStatsRequestVer15);
            return bsnTableChecksumStatsRequestVer15;
        }
    }
    ...
    final static OFBsnTableChecksumStatsRequestVer15Funnel FUNNEL = new OFBsnTableChecksumStatsRequestVer15Funnel();
    static class OFBsnTableChecksumStatsRequestVer15Funnel implements Funnel<OFBsnTableChecksumStatsRequestVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTableChecksumStatsRequestVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnTableChecksumStatsRequestVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnTableChecksumStatsRequestVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTableChecksumStatsRequestVer15(");
