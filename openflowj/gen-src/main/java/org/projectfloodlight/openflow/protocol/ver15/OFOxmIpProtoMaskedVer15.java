...
class OFOxmIpProtoMaskedVer15 implements OFOxmIpProtoMasked {
...
//
    ...
    final static OFOxmIpProtoMaskedVer15 DEFAULT = new OFOxmIpProtoMaskedVer15(
    ...
    public OFOxm<IpProtocol> getCanonical() {
        if (IpProtocol.NO_MASK.equals(mask)) {
            return new OFOxmIpProtoVer15(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpProtoMasked> {
        ...
        public OFOxmIpProtoMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpProtoMaskedVer15 oxmIpProtoMaskedVer15 = new OFOxmIpProtoMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpProtoMaskedVer15);
    ...
    final static OFOxmIpProtoMaskedVer15Funnel FUNNEL = new OFOxmIpProtoMaskedVer15Funnel();
    static class OFOxmIpProtoMaskedVer15Funnel implements Funnel<OFOxmIpProtoMaskedVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmIpProtoMaskedVer15> {
        @Override
