...
public class OFBundleCtrlTypeSerializerVer15 {
    ...
    public static OFBundleCtrlType ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBundleCtrlType in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBundleCtrlType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBundleCtrlType in version 1.5: " + e);
        }
    }
