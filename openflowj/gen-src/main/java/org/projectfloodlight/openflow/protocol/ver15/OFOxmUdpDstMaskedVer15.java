...
class OFOxmUdpDstMaskedVer15 implements OFOxmUdpDstMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmUdpDstMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmUdpDstMaskedVer15 DEFAULT = new OFOxmUdpDstMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmUdpDstMaskedVer15(TransportPort value, TransportPort mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmUdpDstMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmUdpDstMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<TransportPort> getCanonical() {
        if (TransportPort.NO_MASK.equals(mask)) {
            return new OFOxmUdpDstVer15(value);
    ...
    static class BuilderWithParent implements OFOxmUdpDstMasked.Builder {
        final OFOxmUdpDstMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmUdpDstMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFOxmUdpDstMasked> {
        @Override
        public OFOxmUdpDstMasked readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFOxmUdpDstMaskedVer15 oxmUdpDstMaskedVer15 = new OFOxmUdpDstMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmUdpDstMaskedVer15);
            return oxmUdpDstMaskedVer15;
        }
    }
    ...
    final static OFOxmUdpDstMaskedVer15Funnel FUNNEL = new OFOxmUdpDstMaskedVer15Funnel();
    static class OFOxmUdpDstMaskedVer15Funnel implements Funnel<OFOxmUdpDstMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmUdpDstMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002104L
    ...
    static class Writer implements OFMessageWriter<OFOxmUdpDstMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmUdpDstMaskedVer15 message) {
            // fixed value property typeLen = 0x80002104L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmUdpDstMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmUdpDstMaskedVer15 other = (OFOxmUdpDstMaskedVer15) obj;
