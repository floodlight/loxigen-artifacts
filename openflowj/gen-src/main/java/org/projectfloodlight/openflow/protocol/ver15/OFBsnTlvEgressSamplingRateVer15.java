...
class OFBsnTlvEgressSamplingRateVer15 implements OFBsnTlvEgressSamplingRate {
...
//
    ...
    final static OFBsnTlvEgressSamplingRateVer15 DEFAULT = new OFBsnTlvEgressSamplingRateVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvEgressSamplingRate> {
        ...
        public OFBsnTlvEgressSamplingRate readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvEgressSamplingRateVer15 bsnTlvEgressSamplingRateVer15 = new OFBsnTlvEgressSamplingRateVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvEgressSamplingRateVer15);
    ...
    final static OFBsnTlvEgressSamplingRateVer15Funnel FUNNEL = new OFBsnTlvEgressSamplingRateVer15Funnel();
    static class OFBsnTlvEgressSamplingRateVer15Funnel implements Funnel<OFBsnTlvEgressSamplingRateVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvEgressSamplingRateVer15> {
        @Override
