...
class OFBsnTlvPortUsageVer14 implements OFBsnTlvPortUsage {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvPortUsage> {
        ...
        public OFBsnTlvPortUsage readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvPortUsageVer14 bsnTlvPortUsageVer14 = new OFBsnTlvPortUsageVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvPortUsageVer14);
    ...
    final static OFBsnTlvPortUsageVer14Funnel FUNNEL = new OFBsnTlvPortUsageVer14Funnel();
    static class OFBsnTlvPortUsageVer14Funnel implements Funnel<OFBsnTlvPortUsageVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvPortUsageVer14> {
        @Override
