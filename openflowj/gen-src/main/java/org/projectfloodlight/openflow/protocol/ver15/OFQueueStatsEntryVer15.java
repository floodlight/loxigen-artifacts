...
class OFQueueStatsEntryVer15 implements OFQueueStatsEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFQueueStatsEntryVer15.class);
    // version: 1.5
...
//
    ...
    final static OFQueueStatsEntryVer15 DEFAULT = new OFQueueStatsEntryVer15(
    ...
    OFQueueStatsEntryVer15(OFPort portNo, long queueId, U64 txBytes, U64 txPackets, U64 txErrors, long durationSec, long durationNsec, List<OFQueueStatsProp> properties) {
        if(portNo == null) {
            throw new NullPointerException("OFQueueStatsEntryVer15: property portNo cannot be null");
        }
        if(txBytes == null) {
            throw new NullPointerException("OFQueueStatsEntryVer15: property txBytes cannot be null");
        }
        if(txPackets == null) {
            throw new NullPointerException("OFQueueStatsEntryVer15: property txPackets cannot be null");
        }
        if(txErrors == null) {
            throw new NullPointerException("OFQueueStatsEntryVer15: property txErrors cannot be null");
        }
        if(properties == null) {
            throw new NullPointerException("OFQueueStatsEntryVer15: property properties cannot be null");
        }
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFQueueStatsEntry.Builder {
        final OFQueueStatsEntryVer15 parentMessage;
        ...
        BuilderWithParent(OFQueueStatsEntryVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFQueueStatsEntry build() {
                ...
                //
                return new OFQueueStatsEntryVer15(
                    portNo,
                    queueId,
                    txBytes,
                    txPackets,
...
//
    ...
    final static OFQueueStatsEntryVer15Funnel FUNNEL = new OFQueueStatsEntryVer15Funnel();
    static class OFQueueStatsEntryVer15Funnel implements Funnel<OFQueueStatsEntryVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueStatsEntryVer15 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFQueueStatsEntryVer15> {
        @Override
        public void write(ByteBuf bb, OFQueueStatsEntryVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFQueueStatsEntryVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueStatsEntryVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueStatsEntryVer15 other = (OFQueueStatsEntryVer15) obj;
