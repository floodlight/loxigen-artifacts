...
class OFFlowDeleteVer15 implements OFFlowDelete {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowDeleteVer15.class);
    // version: 1.5
...
//
    ...
    final static OFFlowDeleteVer15 DEFAULT = new OFFlowDeleteVer15(
    ...
    OFFlowDeleteVer15(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, int importance, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property cookieMask cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property tableId cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property outGroup cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property flags cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property match cannot be null");
        }
        if(instructions == null) {
            throw new NullPointerException("OFFlowDeleteVer15: property instructions cannot be null");
        }
    ...
    static class BuilderWithParent implements OFFlowDelete.Builder {
        final OFFlowDeleteVer15 parentMessage;
        ...
        BuilderWithParent(OFFlowDeleteVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowDelete> {
        ...
        public OFFlowDelete readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFFlowDeleteVer15 flowDeleteVer15 = new OFFlowDeleteVer15(
                    xid,
                      cookie,
                      cookieMask,
                      tableId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowDeleteVer15);
            return flowDeleteVer15;
        }
    }
    ...
    final static OFFlowDeleteVer15Funnel FUNNEL = new OFFlowDeleteVer15Funnel();
    static class OFFlowDeleteVer15Funnel implements Funnel<OFFlowDeleteVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowDeleteVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFFlowDeleteVer15> {
        @Override
        public void write(ByteBuf bb, OFFlowDeleteVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFFlowDeleteVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowDeleteVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowDeleteVer15 other = (OFFlowDeleteVer15) obj;
