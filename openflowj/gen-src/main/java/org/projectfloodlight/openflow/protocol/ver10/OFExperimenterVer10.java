        ...
        public OFExperimenter readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               case 0x5c16c7:
                   ...
                   return OFBsnHeaderVer10.READER.readFrom(context, bb);
               case 0x2320:
                   bb.readerIndex(start);
                   // discriminator value 0x2320L=0x2320L for class OFNiciraHeaderVer10
                   return OFNiciraHeaderVer10.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFExperimenterVer10.class, "experimenter", experimenter);
            }
