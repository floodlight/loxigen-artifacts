...
class OFBsnGentableBucketStatsReplyVer15 implements OFBsnGentableBucketStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableBucketStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnGentableBucketStatsReplyVer15 DEFAULT = new OFBsnGentableBucketStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableBucketStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableBucketStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableBucketStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGentableBucketStatsReplyVer15: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableBucketStatsReply.Builder {
        final OFBsnGentableBucketStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableBucketStatsReplyVer15 parentMessage) {
    ...
    public OFBsnGentableBucketStatsReply.Builder setEntries(List<OFBsnGentableBucketStatsEntry> entries) {
        ...
        public OFBsnGentableBucketStatsReply build() {
                ...
                //
                return new OFBsnGentableBucketStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnGentableBucketStatsReply> {
        @Override
        public OFBsnGentableBucketStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnGentableBucketStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnGentableBucketStatsEntryVer15.READER);

            OFBsnGentableBucketStatsReplyVer15 bsnGentableBucketStatsReplyVer15 = new OFBsnGentableBucketStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableBucketStatsReplyVer15);
            return bsnGentableBucketStatsReplyVer15;
        }
    }
    ...
    final static OFBsnGentableBucketStatsReplyVer15Funnel FUNNEL = new OFBsnGentableBucketStatsReplyVer15Funnel();
    static class OFBsnGentableBucketStatsReplyVer15Funnel implements Funnel<OFBsnGentableBucketStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableBucketStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableBucketStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableBucketStatsReplyVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableBucketStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableBucketStatsReplyVer15 other = (OFBsnGentableBucketStatsReplyVer15) obj;
