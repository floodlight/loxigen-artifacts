...
class OFBsnGentableDescStatsReplyVer15 implements OFBsnGentableDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableDescStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnGentableDescStatsReplyVer15 DEFAULT = new OFBsnGentableDescStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableDescStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableDescStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableDescStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGentableDescStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnGentableDescStatsReply.Builder {
        final OFBsnGentableDescStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableDescStatsReplyVer15 parentMessage) {
    ...
    public OFBsnGentableDescStatsReply.Builder setXid(long xid) {
        ...
        public OFBsnGentableDescStatsReply build() {
                ...
                //
                return new OFBsnGentableDescStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableDescStatsReply> {
        ...
        public OFBsnGentableDescStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnGentableDescStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGentableDescStatsEntryVer15.READER);

            OFBsnGentableDescStatsReplyVer15 bsnGentableDescStatsReplyVer15 = new OFBsnGentableDescStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableDescStatsReplyVer15);
            return bsnGentableDescStatsReplyVer15;
        }
    }
    ...
    final static OFBsnGentableDescStatsReplyVer15Funnel FUNNEL = new OFBsnGentableDescStatsReplyVer15Funnel();
    static class OFBsnGentableDescStatsReplyVer15Funnel implements Funnel<OFBsnGentableDescStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableDescStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableDescStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnGentableDescStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnGentableDescStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableDescStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableDescStatsReplyVer15 other = (OFBsnGentableDescStatsReplyVer15) obj;
