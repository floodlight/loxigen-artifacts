...
class OFQueueDescPropMaxRateVer15 implements OFQueueDescPropMaxRate {
...
//
    ...
    final static OFQueueDescPropMaxRateVer15 DEFAULT = new OFQueueDescPropMaxRateVer15(
        DEFAULT_RATE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueDescPropMaxRate> {
        ...
        public OFQueueDescPropMaxRate readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFQueueDescPropMaxRateVer15 queueDescPropMaxRateVer15 = new OFQueueDescPropMaxRateVer15(
                    rate
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueDescPropMaxRateVer15);
    ...
    final static OFQueueDescPropMaxRateVer15Funnel FUNNEL = new OFQueueDescPropMaxRateVer15Funnel();
    static class OFQueueDescPropMaxRateVer15Funnel implements Funnel<OFQueueDescPropMaxRateVer15> {
    ...
    static class Writer implements OFMessageWriter<OFQueueDescPropMaxRateVer15> {
        @Override
