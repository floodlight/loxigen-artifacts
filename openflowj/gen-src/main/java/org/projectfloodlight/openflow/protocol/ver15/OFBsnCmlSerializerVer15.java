...
public class OFBsnCmlSerializerVer15 {
    ...
    public static OFBsnCml ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnCml in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnCml e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnCml in version 1.5: " + e);
        }
    }
