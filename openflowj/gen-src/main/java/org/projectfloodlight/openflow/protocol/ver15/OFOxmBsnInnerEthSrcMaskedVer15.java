...
class OFOxmBsnInnerEthSrcMaskedVer15 implements OFOxmBsnInnerEthSrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnInnerEthSrcMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnInnerEthSrcMaskedVer15 DEFAULT = new OFOxmBsnInnerEthSrcMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnInnerEthSrcMaskedVer15(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnInnerEthSrcMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnInnerEthSrcMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmBsnInnerEthSrcVer15(value);
    ...
    static class BuilderWithParent implements OFOxmBsnInnerEthSrcMasked.Builder {
        final OFOxmBsnInnerEthSrcMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnInnerEthSrcMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInnerEthSrcMasked> {
        ...
        public OFOxmBsnInnerEthSrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInnerEthSrcMaskedVer15 oxmBsnInnerEthSrcMaskedVer15 = new OFOxmBsnInnerEthSrcMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInnerEthSrcMaskedVer15);
            return oxmBsnInnerEthSrcMaskedVer15;
        }
    }
    ...
    final static OFOxmBsnInnerEthSrcMaskedVer15Funnel FUNNEL = new OFOxmBsnInnerEthSrcMaskedVer15Funnel();
    static class OFOxmBsnInnerEthSrcMaskedVer15Funnel implements Funnel<OFOxmBsnInnerEthSrcMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnInnerEthSrcMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32f0cL
            sink.putInt(0x32f0c);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInnerEthSrcMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInnerEthSrcMaskedVer15 message) {
            // fixed value property typeLen = 0x32f0cL
            bb.writeInt(0x32f0c);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnInnerEthSrcMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnInnerEthSrcMaskedVer15 other = (OFOxmBsnInnerEthSrcMaskedVer15) obj;
