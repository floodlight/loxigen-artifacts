...
public class OFBadActionCodeSerializerVer15 {
    ...
    public final static short BAD_SET_MASK_VAL = (short) 0x10;
    public final static short BAD_METER_VAL = (short) 0x11;
    ...
    public static OFBadActionCode ofWireValue(short val) {
        switch(val) {
            ...
            case BAD_SET_MASK_VAL:
                return OFBadActionCode.BAD_SET_MASK;
            case BAD_METER_VAL:
                return OFBadActionCode.BAD_METER;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBadActionCode in version 1.5: " + val);
        }
    }
    ...
    public static short toWireValue(OFBadActionCode e) {
        switch(e) {
            ...
            case BAD_SET_MASK:
                return BAD_SET_MASK_VAL;
            case BAD_METER:
                return BAD_METER_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBadActionCode in version 1.5: " + e);
        }
    }
