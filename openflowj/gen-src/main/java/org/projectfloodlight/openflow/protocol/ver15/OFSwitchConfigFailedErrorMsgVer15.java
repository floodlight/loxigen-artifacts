...
class OFSwitchConfigFailedErrorMsgVer15 implements OFSwitchConfigFailedErrorMsg {
...
//
    ...
    public OFSwitchConfigFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFSwitchConfigFailedErrorMsg build() {
                ...
                //
                return new OFSwitchConfigFailedErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFSwitchConfigFailedErrorMsg> {
        ...
        public OFSwitchConfigFailedErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFSwitchConfigFailedErrorMsgVer15 switchConfigFailedErrorMsgVer15 = new OFSwitchConfigFailedErrorMsgVer15(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", switchConfigFailedErrorMsgVer15);
    ...
    final static OFSwitchConfigFailedErrorMsgVer15Funnel FUNNEL = new OFSwitchConfigFailedErrorMsgVer15Funnel();
    static class OFSwitchConfigFailedErrorMsgVer15Funnel implements Funnel<OFSwitchConfigFailedErrorMsgVer15> {
    ...
    static class Writer implements OFMessageWriter<OFSwitchConfigFailedErrorMsgVer15> {
        @Override
