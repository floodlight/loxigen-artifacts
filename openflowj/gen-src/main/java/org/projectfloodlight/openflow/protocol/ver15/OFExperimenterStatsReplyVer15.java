...
abstract class OFExperimenterStatsReplyVer15 {
    ...
    public final static OFExperimenterStatsReplyVer15.Reader READER = new Reader();
    ...
    static class Reader implements OFMessageReader<OFExperimenterStatsReply> {
        ...
        public OFExperimenterStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               case 0x5c16c7:
                   // discriminator value 0x5c16c7L=0x5c16c7L for class OFBsnStatsReplyVer15
                   return OFBsnStatsReplyVer15.READER.readFrom(bb);
               default:
                   throw new OFParseError("Unknown value for discriminator experimenter of class OFExperimenterStatsReplyVer15: " + experimenter);
            }
        }
    }
}
