...
public class OFBsnExtendedCapabilitiesSerializerVer15 {
        ...
        for(OFBsnExtendedCapabilities e: set) {
            switch(e) {
                ...
                case BSN_EXT_CAP_FEC_DISABLE:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Illegal enum value for type OFBsnExtendedCapabilities in version 1.5: " + e);
            }
        }
        return wireValue;
    }
