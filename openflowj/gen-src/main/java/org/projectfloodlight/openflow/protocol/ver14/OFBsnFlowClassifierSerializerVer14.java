...
public class OFBsnFlowClassifierSerializerVer14 {
    ...
    public static OFBsnFlowClassifier ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnFlowClassifier in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnFlowClassifier e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnFlowClassifier in version 1.4: " + e);
        }
    }
