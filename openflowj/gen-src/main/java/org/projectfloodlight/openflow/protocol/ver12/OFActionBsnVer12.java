        ...
        public OFActionBsn readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            switch(subtype) {
               case 0x4:
                   ...
                   return OFActionBsnChecksumVer12.READER.readFrom(context, bb);
               case 0x1:
                   bb.readerIndex(start);
                   // discriminator value 0x1L=0x1L for class OFActionBsnMirrorVer12
                   return OFActionBsnMirrorVer12.READER.readFrom(context, bb);
               case 0x2:
                   bb.readerIndex(start);
                   // discriminator value 0x2L=0x2L for class OFActionBsnSetTunnelDstVer12
                   return OFActionBsnSetTunnelDstVer12.READER.readFrom(context, bb);
               default:
                   context.getUnparsedHandler().unparsedMessage(OFActionBsnVer12.class, "subtype", subtype);
            }
            // pad: 4 bytes
            bb.skipBytes(4);
