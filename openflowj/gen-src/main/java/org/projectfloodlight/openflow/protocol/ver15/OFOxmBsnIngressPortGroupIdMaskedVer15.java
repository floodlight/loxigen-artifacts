...
class OFOxmBsnIngressPortGroupIdMaskedVer15 implements OFOxmBsnIngressPortGroupIdMasked {
...
//
    ...
    final static OFOxmBsnIngressPortGroupIdMaskedVer15 DEFAULT = new OFOxmBsnIngressPortGroupIdMaskedVer15(
    ...
    public OFOxm<ClassId> getCanonical() {
        if (ClassId.NO_MASK.equals(mask)) {
            return new OFOxmBsnIngressPortGroupIdVer15(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnIngressPortGroupIdMasked> {
        ...
        public OFOxmBsnIngressPortGroupIdMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnIngressPortGroupIdMaskedVer15 oxmBsnIngressPortGroupIdMaskedVer15 = new OFOxmBsnIngressPortGroupIdMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnIngressPortGroupIdMaskedVer15);
    ...
    final static OFOxmBsnIngressPortGroupIdMaskedVer15Funnel FUNNEL = new OFOxmBsnIngressPortGroupIdMaskedVer15Funnel();
    static class OFOxmBsnIngressPortGroupIdMaskedVer15Funnel implements Funnel<OFOxmBsnIngressPortGroupIdMaskedVer15> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnIngressPortGroupIdMaskedVer15> {
        @Override
