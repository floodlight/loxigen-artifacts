...
class OFMeterBandExperimenterVer15 implements OFMeterBandExperimenter {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterBandExperimenterVer15.class);
    // version: 1.5
...
//
    ...
    final static OFMeterBandExperimenterVer15 DEFAULT = new OFMeterBandExperimenterVer15(
    ...
    static class BuilderWithParent implements OFMeterBandExperimenter.Builder {
        final OFMeterBandExperimenterVer15 parentMessage;
        ...
        BuilderWithParent(OFMeterBandExperimenterVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFMeterBandExperimenter build() {
                ...
                //
                return new OFMeterBandExperimenterVer15(
                    rate,
                    burstSize,
                    experimenter
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFMeterBandExperimenter> {
        @Override
        public OFMeterBandExperimenter readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFMeterBandExperimenterVer15 meterBandExperimenterVer15 = new OFMeterBandExperimenterVer15(
                    rate,
                      burstSize,
                      experimenter
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterBandExperimenterVer15);
            return meterBandExperimenterVer15;
        }
    }
    ...
    final static OFMeterBandExperimenterVer15Funnel FUNNEL = new OFMeterBandExperimenterVer15Funnel();
    static class OFMeterBandExperimenterVer15Funnel implements Funnel<OFMeterBandExperimenterVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterBandExperimenterVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0xffff
    ...
    static class Writer implements OFMessageWriter<OFMeterBandExperimenterVer15> {
        @Override
        public void write(ByteBuf bb, OFMeterBandExperimenterVer15 message) {
            // fixed value property type = 0xffff
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterBandExperimenterVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterBandExperimenterVer15 other = (OFMeterBandExperimenterVer15) obj;
