...
class OFBadRequestErrorMsgVer15 implements OFBadRequestErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFBadRequestErrorMsgVer15.class);
    // version: 1.5
...
//
    ...
    OFBadRequestErrorMsgVer15(long xid, OFBadRequestCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFBadRequestErrorMsgVer15: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBadRequestErrorMsgVer15: property data cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBadRequestErrorMsg.Builder {
        final OFBadRequestErrorMsgVer15 parentMessage;
        ...
        BuilderWithParent(OFBadRequestErrorMsgVer15 parentMessage) {
    ...
    public OFBadRequestErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFBadRequestErrorMsg build() {
                ...
                //
                return new OFBadRequestErrorMsgVer15(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBadRequestErrorMsg> {
        ...
        public OFBadRequestErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBadRequestCode code = OFBadRequestCodeSerializerVer15.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_15);

            OFBadRequestErrorMsgVer15 badRequestErrorMsgVer15 = new OFBadRequestErrorMsgVer15(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", badRequestErrorMsgVer15);
            return badRequestErrorMsgVer15;
        }
    }
    ...
    final static OFBadRequestErrorMsgVer15Funnel FUNNEL = new OFBadRequestErrorMsgVer15Funnel();
    static class OFBadRequestErrorMsgVer15Funnel implements Funnel<OFBadRequestErrorMsgVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBadRequestErrorMsgVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            OFBadRequestCodeSerializerVer15.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFBadRequestErrorMsgVer15> {
        @Override
        public void write(ByteBuf bb, OFBadRequestErrorMsgVer15 message) {
            ...
            OFBadRequestCodeSerializerVer15.writeTo(bb, message.code);
            message.data.writeTo(bb);

            // update length field
            int length = bb.writerIndex() - startIndex;
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBadRequestErrorMsgVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBadRequestErrorMsgVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBadRequestErrorMsgVer15 other = (OFBadRequestErrorMsgVer15) obj;
