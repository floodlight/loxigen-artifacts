...
class OFOxmBsnTcpFlagsMaskedVer15 implements OFOxmBsnTcpFlagsMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnTcpFlagsMaskedVer15.class);
    // version: 1.5
...
//
    ...
    final static OFOxmBsnTcpFlagsMaskedVer15 DEFAULT = new OFOxmBsnTcpFlagsMaskedVer15(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnTcpFlagsMaskedVer15(U16 value, U16 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnTcpFlagsMaskedVer15: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnTcpFlagsMaskedVer15: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U16> getCanonical() {
        if (U16.NO_MASK.equals(mask)) {
            return new OFOxmBsnTcpFlagsVer15(value);
    ...
    static class BuilderWithParent implements OFOxmBsnTcpFlagsMasked.Builder {
        final OFOxmBsnTcpFlagsMaskedVer15 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnTcpFlagsMaskedVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnTcpFlagsMasked> {
        ...
        public OFOxmBsnTcpFlagsMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnTcpFlagsMaskedVer15 oxmBsnTcpFlagsMaskedVer15 = new OFOxmBsnTcpFlagsMaskedVer15(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnTcpFlagsMaskedVer15);
            return oxmBsnTcpFlagsMaskedVer15;
        }
    }
    ...
    final static OFOxmBsnTcpFlagsMaskedVer15Funnel FUNNEL = new OFOxmBsnTcpFlagsMaskedVer15Funnel();
    static class OFOxmBsnTcpFlagsMaskedVer15Funnel implements Funnel<OFOxmBsnTcpFlagsMaskedVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnTcpFlagsMaskedVer15 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32104L
            sink.putInt(0x32104);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnTcpFlagsMaskedVer15> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnTcpFlagsMaskedVer15 message) {
            // fixed value property typeLen = 0x32104L
            bb.writeInt(0x32104);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnTcpFlagsMaskedVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnTcpFlagsMaskedVer15 other = (OFOxmBsnTcpFlagsMaskedVer15) obj;
