...
class OFMeterConfigStatsReplyVer15 implements OFMeterConfigStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterConfigStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFMeterConfigStatsReplyVer15 DEFAULT = new OFMeterConfigStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFMeterConfigStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFMeterConfig> entries) {
        if(flags == null) {
            throw new NullPointerException("OFMeterConfigStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFMeterConfigStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFMeterConfigStatsReply.Builder {
        final OFMeterConfigStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFMeterConfigStatsReplyVer15 parentMessage) {
    ...
    public OFMeterConfigStatsReply.Builder setEntries(List<OFMeterConfig> entries) {
        ...
        public OFMeterConfigStatsReply build() {
                ...
                //
                return new OFMeterConfigStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterConfigStatsReply> {
        ...
        public OFMeterConfigStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterConfigStatsReplyVer15);
            return meterConfigStatsReplyVer15;
        }
    }
    ...
    final static OFMeterConfigStatsReplyVer15Funnel FUNNEL = new OFMeterConfigStatsReplyVer15Funnel();
    static class OFMeterConfigStatsReplyVer15Funnel implements Funnel<OFMeterConfigStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterConfigStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFMeterConfigStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFMeterConfigStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFMeterConfigStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterConfigStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterConfigStatsReplyVer15 other = (OFMeterConfigStatsReplyVer15) obj;
