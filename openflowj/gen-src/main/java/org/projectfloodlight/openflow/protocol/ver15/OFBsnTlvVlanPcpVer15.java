...
class OFBsnTlvVlanPcpVer15 implements OFBsnTlvVlanPcp {
...
//
    ...
    final static OFBsnTlvVlanPcpVer15 DEFAULT = new OFBsnTlvVlanPcpVer15(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvVlanPcp> {
        @Override
        public OFBsnTlvVlanPcp readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvVlanPcpVer15 bsnTlvVlanPcpVer15 = new OFBsnTlvVlanPcpVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvVlanPcpVer15);
    ...
    final static OFBsnTlvVlanPcpVer15Funnel FUNNEL = new OFBsnTlvVlanPcpVer15Funnel();
    static class OFBsnTlvVlanPcpVer15Funnel implements Funnel<OFBsnTlvVlanPcpVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvVlanPcpVer15> {
        @Override
