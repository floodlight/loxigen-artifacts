...
class OFFeaturesReplyVer15 implements OFFeaturesReply {
    private static final Logger logger = LoggerFactory.getLogger(OFFeaturesReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFFeaturesReplyVer15 DEFAULT = new OFFeaturesReplyVer15(
    ...
    OFFeaturesReplyVer15(long xid, DatapathId datapathId, long nBuffers, short nTables, OFAuxId auxiliaryId, Set<OFCapabilities> capabilities, long reserved) {
        if(datapathId == null) {
            throw new NullPointerException("OFFeaturesReplyVer15: property datapathId cannot be null");
        }
        if(auxiliaryId == null) {
            throw new NullPointerException("OFFeaturesReplyVer15: property auxiliaryId cannot be null");
        }
    ...
    static class BuilderWithParent implements OFFeaturesReply.Builder {
        final OFFeaturesReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFFeaturesReplyVer15 parentMessage) {
    ...
    public OFFeaturesReply.Builder setPorts(List<OFPortDesc> ports) throws UnsupportedOperationException {
        ...
        public OFFeaturesReply build() {
                ...
                //
                return new OFFeaturesReplyVer15(
                    xid,
                    datapathId,
                    nBuffers,
                    nTables,
...
//
    ...
    static class Reader implements OFMessageReader<OFFeaturesReply> {
        ...
        public OFFeaturesReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 2 bytes
            bb.skipBytes(2);
            Set<OFCapabilities> capabilities = OFCapabilitiesSerializerVer15.readFrom(bb);
            long reserved = U32.f(bb.readInt());

            OFFeaturesReplyVer15 featuresReplyVer15 = new OFFeaturesReplyVer15(
                    xid,
                      datapathId,
                      nBuffers,
                      nTables,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", featuresReplyVer15);
            return featuresReplyVer15;
        }
    }
    ...
    final static OFFeaturesReplyVer15Funnel FUNNEL = new OFFeaturesReplyVer15Funnel();
    static class OFFeaturesReplyVer15Funnel implements Funnel<OFFeaturesReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFeaturesReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
            ...
            // skip pad (2 bytes)
            OFCapabilitiesSerializerVer15.putTo(message.capabilities, sink);
    ...
    static class Writer implements OFMessageWriter<OFFeaturesReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFFeaturesReplyVer15 message) {
            // fixed value property version = 6
            ...
            // pad: 2 bytes
            bb.writeZero(2);
            OFCapabilitiesSerializerVer15.writeTo(bb, message.capabilities);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFeaturesReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFeaturesReplyVer15 other = (OFFeaturesReplyVer15) obj;
