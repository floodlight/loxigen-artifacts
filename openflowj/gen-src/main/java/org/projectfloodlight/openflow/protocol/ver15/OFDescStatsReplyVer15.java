...
class OFDescStatsReplyVer15 implements OFDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFDescStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFDescStatsReplyVer15 DEFAULT = new OFDescStatsReplyVer15(
    ...
    OFDescStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, String mfrDesc, String hwDesc, String swDesc, String serialNum, String dpDesc) {
        if(flags == null) {
            throw new NullPointerException("OFDescStatsReplyVer15: property flags cannot be null");
        }
        if(mfrDesc == null) {
            throw new NullPointerException("OFDescStatsReplyVer15: property mfrDesc cannot be null");
        }
        if(hwDesc == null) {
            throw new NullPointerException("OFDescStatsReplyVer15: property hwDesc cannot be null");
        }
        if(swDesc == null) {
            throw new NullPointerException("OFDescStatsReplyVer15: property swDesc cannot be null");
        }
        if(serialNum == null) {
            throw new NullPointerException("OFDescStatsReplyVer15: property serialNum cannot be null");
        }
        if(dpDesc == null) {
            throw new NullPointerException("OFDescStatsReplyVer15: property dpDesc cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFDescStatsReply.Builder {
        final OFDescStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFDescStatsReplyVer15 parentMessage) {
    ...
    public OFDescStatsReply.Builder setDpDesc(String dpDesc) {
        ...
        public OFDescStatsReply build() {
                ...
                //
                return new OFDescStatsReplyVer15(
                    xid,
                    flags,
                    mfrDesc,
                    hwDesc,
...
//
    ...
    static class Reader implements OFMessageReader<OFDescStatsReply> {
        ...
        public OFDescStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFDescStatsReplyVer15 descStatsReplyVer15 = new OFDescStatsReplyVer15(
                    xid,
                      flags,
                      mfrDesc,
                      hwDesc,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", descStatsReplyVer15);
            return descStatsReplyVer15;
        }
    }
    ...
    final static OFDescStatsReplyVer15Funnel FUNNEL = new OFDescStatsReplyVer15Funnel();
    static class OFDescStatsReplyVer15Funnel implements Funnel<OFDescStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFDescStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFDescStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFDescStatsReplyVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFDescStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFDescStatsReplyVer15 other = (OFDescStatsReplyVer15) obj;
