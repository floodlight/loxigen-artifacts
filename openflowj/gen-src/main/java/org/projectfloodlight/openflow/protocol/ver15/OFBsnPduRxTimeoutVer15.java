...
class OFBsnPduRxTimeoutVer15 implements OFBsnPduRxTimeout {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnPduRxTimeoutVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnPduRxTimeoutVer15 DEFAULT = new OFBsnPduRxTimeoutVer15(
        DEFAULT_XID, DEFAULT_PORT_NO, DEFAULT_SLOT_NUM
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnPduRxTimeoutVer15(long xid, OFPort portNo, short slotNum) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnPduRxTimeoutVer15: property portNo cannot be null");
        }
        this.xid = xid;
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFBsnPduRxTimeout.Builder {
        final OFBsnPduRxTimeoutVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnPduRxTimeoutVer15 parentMessage) {
    ...
    public OFBsnPduRxTimeout.Builder setSlotNum(short slotNum) {
        ...
        public OFBsnPduRxTimeout build() {
                ...
                //
                return new OFBsnPduRxTimeoutVer15(
                    xid,
                    portNo,
                    slotNum
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnPduRxTimeout> {
        ...
        public OFBsnPduRxTimeout readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnPduRxTimeoutVer15 bsnPduRxTimeoutVer15 = new OFBsnPduRxTimeoutVer15(
                    xid,
                      portNo,
                      slotNum
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnPduRxTimeoutVer15);
            return bsnPduRxTimeoutVer15;
        }
    }
    ...
    final static OFBsnPduRxTimeoutVer15Funnel FUNNEL = new OFBsnPduRxTimeoutVer15Funnel();
    static class OFBsnPduRxTimeoutVer15Funnel implements Funnel<OFBsnPduRxTimeoutVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnPduRxTimeoutVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnPduRxTimeoutVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnPduRxTimeoutVer15 message) {
            // fixed value property version = 6
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnPduRxTimeoutVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnPduRxTimeoutVer15 other = (OFBsnPduRxTimeoutVer15) obj;
