...
class OFGroupStatsReplyVer15 implements OFGroupStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFGroupStatsReplyVer15 DEFAULT = new OFGroupStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFGroupStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFGroupStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFGroupStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFGroupStatsReplyVer15: property entries cannot be null");
        }
    ...
    static class BuilderWithParent implements OFGroupStatsReply.Builder {
        final OFGroupStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFGroupStatsReplyVer15 parentMessage) {
    ...
    public OFGroupStatsReply.Builder setEntries(List<OFGroupStatsEntry> entries) {
        ...
        public OFGroupStatsReply build() {
                ...
                //
                return new OFGroupStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupStatsReply> {
        ...
        public OFGroupStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFGroupStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFGroupStatsEntryVer15.READER);

            OFGroupStatsReplyVer15 groupStatsReplyVer15 = new OFGroupStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupStatsReplyVer15);
            return groupStatsReplyVer15;
        }
    }
    ...
    final static OFGroupStatsReplyVer15Funnel FUNNEL = new OFGroupStatsReplyVer15Funnel();
    static class OFGroupStatsReplyVer15Funnel implements Funnel<OFGroupStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFGroupStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFGroupStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFGroupStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupStatsReplyVer15 other = (OFGroupStatsReplyVer15) obj;
