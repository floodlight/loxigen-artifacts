...
class OFBsnTlvActionStateVer15 implements OFBsnTlvActionState {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvActionState> {
        ...
        public OFBsnTlvActionState readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvActionStateVer15 bsnTlvActionStateVer15 = new OFBsnTlvActionStateVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvActionStateVer15);
    ...
    final static OFBsnTlvActionStateVer15Funnel FUNNEL = new OFBsnTlvActionStateVer15Funnel();
    static class OFBsnTlvActionStateVer15Funnel implements Funnel<OFBsnTlvActionStateVer15> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvActionStateVer15> {
        @Override
