...
class OFBsnTlvDscpVer13 implements OFBsnTlvDscp {
...
//
    ...
    final static OFBsnTlvDscpVer13 DEFAULT = new OFBsnTlvDscpVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnTlvDscp> {
        ...
        public OFBsnTlvDscp readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvDscpVer13 bsnTlvDscpVer13 = new OFBsnTlvDscpVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvDscpVer13);
    ...
    final static OFBsnTlvDscpVer13Funnel FUNNEL = new OFBsnTlvDscpVer13Funnel();
    static class OFBsnTlvDscpVer13Funnel implements Funnel<OFBsnTlvDscpVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvDscpVer13> {
        @Override
