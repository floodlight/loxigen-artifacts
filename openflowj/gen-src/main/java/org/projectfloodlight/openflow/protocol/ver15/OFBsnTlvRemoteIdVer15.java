...
class OFBsnTlvRemoteIdVer15 implements OFBsnTlvRemoteId {
...
//
    ...
    final static OFBsnTlvRemoteIdVer15 DEFAULT = new OFBsnTlvRemoteIdVer15(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnTlvRemoteIdVer15(byte[] value) {
        if(value == null) {
    ...
    static class BuilderWithParent implements OFBsnTlvRemoteId.Builder {
        ...
        BuilderWithParent(OFBsnTlvRemoteIdVer15 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvRemoteId> {
        ...
        public OFBsnTlvRemoteId readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvRemoteIdVer15 bsnTlvRemoteIdVer15 = new OFBsnTlvRemoteIdVer15(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvRemoteIdVer15);
            return bsnTlvRemoteIdVer15;
        }
    }
    ...
    final static OFBsnTlvRemoteIdVer15Funnel FUNNEL = new OFBsnTlvRemoteIdVer15Funnel();
    static class OFBsnTlvRemoteIdVer15Funnel implements Funnel<OFBsnTlvRemoteIdVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvRemoteIdVer15 message, PrimitiveSink sink) {
            // fixed value property type = 0xe0
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvRemoteIdVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvRemoteIdVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnTlvRemoteIdVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTlvRemoteIdVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTlvRemoteIdVer15 other = (OFBsnTlvRemoteIdVer15) obj;
