...
class OFBsnPortCounterStatsReplyVer15 implements OFBsnPortCounterStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnPortCounterStatsReplyVer15.class);
    // version: 1.5
...
//
    ...
    final static OFBsnPortCounterStatsReplyVer15 DEFAULT = new OFBsnPortCounterStatsReplyVer15(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnPortCounterStatsReplyVer15(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnPortCounterStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnPortCounterStatsReplyVer15: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnPortCounterStatsReplyVer15: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnPortCounterStatsReply.Builder {
        final OFBsnPortCounterStatsReplyVer15 parentMessage;
        ...
        BuilderWithParent(OFBsnPortCounterStatsReplyVer15 parentMessage) {
    ...
    public OFBsnPortCounterStatsReply.Builder setEntries(List<OFBsnPortCounterStatsEntry> entries) {
        ...
        public OFBsnPortCounterStatsReply build() {
                ...
                //
                return new OFBsnPortCounterStatsReplyVer15(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader extends AbstractOFMessageReader<OFBsnPortCounterStatsReply> {
        @Override
        public OFBsnPortCounterStatsReply readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnPortCounterStatsEntry> entries = ChannelUtils.readList(context, bb, length - (bb.readerIndex() - start), OFBsnPortCounterStatsEntryVer15.READER);

            OFBsnPortCounterStatsReplyVer15 bsnPortCounterStatsReplyVer15 = new OFBsnPortCounterStatsReplyVer15(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnPortCounterStatsReplyVer15);
            return bsnPortCounterStatsReplyVer15;
        }
    }
    ...
    final static OFBsnPortCounterStatsReplyVer15Funnel FUNNEL = new OFBsnPortCounterStatsReplyVer15Funnel();
    static class OFBsnPortCounterStatsReplyVer15Funnel implements Funnel<OFBsnPortCounterStatsReplyVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnPortCounterStatsReplyVer15 message, PrimitiveSink sink) {
            // fixed value property version = 6
    ...
    static class Writer implements OFMessageWriter<OFBsnPortCounterStatsReplyVer15> {
        @Override
        public void write(ByteBuf bb, OFBsnPortCounterStatsReplyVer15 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnPortCounterStatsReplyVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnPortCounterStatsReplyVer15 other = (OFBsnPortCounterStatsReplyVer15) obj;
