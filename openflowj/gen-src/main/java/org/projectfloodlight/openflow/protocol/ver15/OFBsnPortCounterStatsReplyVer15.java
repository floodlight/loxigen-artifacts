...
//
    ...
    static class Reader implements OFMessageReader<OFBsnPortCounterStatsReply> {
        ...
        public OFBsnPortCounterStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnPortCounterStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnPortCounterStatsEntryVer15.READER);
    ...
    static class Writer implements OFMessageWriter<OFBsnPortCounterStatsReplyVer15> {
        ...
        public void write(ByteBuf bb, OFBsnPortCounterStatsReplyVer15 message) {
            ...
            if (length > MAXIMUM_LENGTH) {
                throw new IllegalArgumentException("OFBsnPortCounterStatsReplyVer15: message length (" + length + ") exceeds maximum (0xFFFF)");
            }
