...
class OFActionCopyTtlInVer15 implements OFActionCopyTtlIn {
...
//
    ...
    final static OFActionCopyTtlInVer15 DEFAULT = new OFActionCopyTtlInVer15(

    );

    final static OFActionCopyTtlInVer15 INSTANCE = new OFActionCopyTtlInVer15();
    ...
    static class Reader extends AbstractOFMessageReader<OFActionCopyTtlIn> {
        @Override
        public OFActionCopyTtlIn readFrom(OFMessageReaderContext context, ByteBuf bb) throws OFParseError {
    ...
    final static OFActionCopyTtlInVer15Funnel FUNNEL = new OFActionCopyTtlInVer15Funnel();
    static class OFActionCopyTtlInVer15Funnel implements Funnel<OFActionCopyTtlInVer15> {
    ...
    static class Writer implements OFMessageWriter<OFActionCopyTtlInVer15> {
        @Override
