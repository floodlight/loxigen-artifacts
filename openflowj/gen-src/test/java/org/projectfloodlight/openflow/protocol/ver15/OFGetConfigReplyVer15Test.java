...
public class OFGetConfigReplyVer15Test {
    ...
    public void testRead() throws Exception {
        ...
        OFGetConfigReply getConfigReplyRead = OFGetConfigReplyVer15.READER.readFrom(input);
   ...
   public void testReadWrite() throws Exception {
       ...
       // FIXME should invoke the overall reader once implemented
       OFGetConfigReply getConfigReply = OFGetConfigReplyVer15.READER.readFrom(input);
       assertEquals(GET_CONFIG_REPLY_SERIALIZED.length, input.readerIndex());
