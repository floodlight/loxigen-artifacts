...
public class OFFlowLightweightStatsReplyVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowLightweightStatsReplyVer15.READER, OFStatsReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowLightweightStatsReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object flowLightweightStatsReplyRead = messageReader.readFrom(input);
        assertThat(flowLightweightStatsReplyRead, CoreMatchers.instanceOf(OFFlowLightweightStatsReplyVer15.class));
        OFFlowLightweightStatsReply.Builder builder = factory.buildFlowLightweightStatsReply();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsReplyFlags>of(OFStatsReplyFlags.REPLY_MORE))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(FLOW_LIGHTWEIGHT_STATS_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < FLOW_LIGHTWEIGHT_STATS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFFlowLightweightStatsReply flowLightweightStatsReply = (OFFlowLightweightStatsReply) messageReader.readFrom(input);
       assertEquals(FLOW_LIGHTWEIGHT_STATS_REPLY_SERIALIZED.length, input.readerIndex());
