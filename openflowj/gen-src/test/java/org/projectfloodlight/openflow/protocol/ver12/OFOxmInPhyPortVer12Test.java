...
public class OFOxmInPhyPortVer12Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFOxmInPhyPortVer12.READER, OFOxmVer12.READER
        );
    }

    public OFOxmInPhyPortVer12Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(oxmInPhyPortRead, CoreMatchers.instanceOf(OFOxmInPhyPortVer12.class));
   }
