...
public class OFFlowMonitorRequestVer15Test {
    ...
    final static byte[] FLOW_MONITOR_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x12, 0x0, 0x30, 0x12, 0x34, 0x56, 0x78, 0x0, 0x10, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x1, 0x0, 0x0, 0x1, 0x0, 0x10, (byte) 0x80, 0x0, 0x1, 0x8, 0x0, 0x0, 0x0, 0x4, 0x0, 0x0, 0x0, 0x5 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowMonitorRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowMonitorRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFFlowMonitorRequest.Builder builder = factory.buildFlowMonitorRequest();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(FLOW_MONITOR_REQUEST_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(FLOW_MONITOR_REQUEST_SERIALIZED);

        Object flowMonitorRequestRead = messageReader.readFrom(input);
        assertThat(flowMonitorRequestRead, CoreMatchers.instanceOf(OFFlowMonitorRequestVer15.class));
        OFFlowMonitorRequest.Builder builder = factory.buildFlowMonitorRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
        ...
        assertEquals(FLOW_MONITOR_REQUEST_SERIALIZED.length, input.readerIndex());

        assertEquals(flowMonitorRequestBuilt, flowMonitorRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(FLOW_MONITOR_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < FLOW_MONITOR_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFFlowMonitorRequest flowMonitorRequest = (OFFlowMonitorRequest) messageReader.readFrom(input);
       assertEquals(FLOW_MONITOR_REQUEST_SERIALIZED.length, input.readerIndex());
