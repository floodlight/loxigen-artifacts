...
public class OFFlowDeleteStrictVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowDeleteStrictVer13.READER, OFFlowModVer13.READER, OFMessageVer13.READER
        );
    }

    public OFFlowDeleteStrictVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(flowDeleteStrictRead, CoreMatchers.instanceOf(OFFlowDeleteStrictVer13.class));
        OFFlowDeleteStrict.Builder builder = factory.buildFlowDeleteStrict();
        builder.setXid(0x12345678)
    .setCookie(U64.parseHex("FEDCBA9876543210"))
    .setCookieMask(U64.parseHex("FF00FF00FF00FF00"))
