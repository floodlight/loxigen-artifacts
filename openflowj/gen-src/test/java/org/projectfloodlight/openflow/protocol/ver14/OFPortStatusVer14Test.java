...
public class OFPortStatusVer14Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPortStatusVer14.READER, OFMessageVer14.READER
        );
    }

    public OFPortStatusVer14Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(portStatusRead, CoreMatchers.instanceOf(OFPortStatusVer14.class));
   }
