...
public class OFFlowModifyStrictVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowModifyStrictVer13.READER, OFFlowModVer13.READER, OFMessageVer13.READER
        );
    }

    public OFFlowModifyStrictVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(flowModifyStrictRead, CoreMatchers.instanceOf(OFFlowModifyStrictVer13.class));
        OFFlowModifyStrict.Builder builder = factory.buildFlowModifyStrict();
        builder.setXid(0x12345678)
    .setCookie(U64.parseHex("FEDCBA9876543210"))
    .setCookieMask(U64.parseHex("FF00FF00FF00FF00"))
