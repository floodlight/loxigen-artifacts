...
public class OFFlowModifyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowModifyVer13.READER, OFFlowModVer13.READER, OFMessageVer13.READER
        );
    }

    public OFFlowModifyVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(flowModifyRead, CoreMatchers.instanceOf(OFFlowModifyVer13.class));
        OFFlowModify.Builder builder = factory.buildFlowModify();
        builder.setXid(0x12345678)
    .setCookie(U64.parseHex("FEDCBA9876543210"))
    .setCookieMask(U64.parseHex("FF00FF00FF00FF00"))
