...
public class OFFlowMonitorReplyVer15Test {
    ...
    final static byte[] FLOW_MONITOR_REPLY_SERIALIZED =
        new byte[] { 0x6, 0x13, 0x0, 0x14, 0x12, 0x34, 0x56, 0x78, 0x0, 0x10, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x0, 0x1 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowMonitorReplyVer15.READER, OFStatsReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowMonitorReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFFlowMonitorReply.Builder builder = factory.buildFlowMonitorReply();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(FLOW_MONITOR_REPLY_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(FLOW_MONITOR_REPLY_SERIALIZED);

        Object flowMonitorReplyRead = messageReader.readFrom(input);
        assertThat(flowMonitorReplyRead, CoreMatchers.instanceOf(OFFlowMonitorReplyVer15.class));
        OFFlowMonitorReply.Builder builder = factory.buildFlowMonitorReply();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsReplyFlags>of(OFStatsReplyFlags.REPLY_MORE))
        ...
        assertEquals(FLOW_MONITOR_REPLY_SERIALIZED.length, input.readerIndex());

        assertEquals(flowMonitorReplyBuilt, flowMonitorReplyRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(FLOW_MONITOR_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < FLOW_MONITOR_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFFlowMonitorReply flowMonitorReply = (OFFlowMonitorReply) messageReader.readFrom(input);
       assertEquals(FLOW_MONITOR_REPLY_SERIALIZED.length, input.readerIndex());
