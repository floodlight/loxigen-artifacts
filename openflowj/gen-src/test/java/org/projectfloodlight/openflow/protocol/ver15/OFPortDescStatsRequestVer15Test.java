...
public class OFPortDescStatsRequestVer15Test {
    ...
    final static byte[] PORT_DESC_STATS_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x12, 0x0, 0x18, 0x12, 0x34, 0x56, 0x78, 0x0, 0xd, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPortDescStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFPortDescStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFPortDescStatsRequest.Builder builder = factory.buildPortDescStatsRequest();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(PORT_DESC_STATS_REQUEST_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(PORT_DESC_STATS_REQUEST_SERIALIZED);

        Object portDescStatsRequestRead = messageReader.readFrom(input);
        assertThat(portDescStatsRequestRead, CoreMatchers.instanceOf(OFPortDescStatsRequestVer15.class));
        OFPortDescStatsRequest.Builder builder = factory.buildPortDescStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
        ...
        assertEquals(PORT_DESC_STATS_REQUEST_SERIALIZED.length, input.readerIndex());

        assertEquals(portDescStatsRequestBuilt, portDescStatsRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(PORT_DESC_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < PORT_DESC_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFPortDescStatsRequest portDescStatsRequest = (OFPortDescStatsRequest) messageReader.readFrom(input);
       assertEquals(PORT_DESC_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
