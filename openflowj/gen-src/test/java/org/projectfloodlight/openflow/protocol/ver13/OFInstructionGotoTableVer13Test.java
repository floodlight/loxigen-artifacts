...
public class OFInstructionGotoTableVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFInstructionGotoTableVer13.READER, OFInstructionVer13.READER
        );
    }

    public OFInstructionGotoTableVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(instructionGotoTableRead, CoreMatchers.instanceOf(OFInstructionGotoTableVer13.class));
   }
