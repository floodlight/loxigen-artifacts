...
public class OFFeaturesRequestVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFeaturesRequestVer13.READER, OFMessageVer13.READER
        );
    }

    public OFFeaturesRequestVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(featuresRequestRead, CoreMatchers.instanceOf(OFFeaturesRequestVer13.class));
   }
