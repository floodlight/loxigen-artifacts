...
public class OFDescStatsRequestVer15Test {
    ...
    final static byte[] DESC_STATS_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x12, 0x0, 0x10, 0x12, 0x34, 0x56, 0x78, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFDescStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFDescStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFDescStatsRequest.Builder builder = factory.buildDescStatsRequest();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(DESC_STATS_REQUEST_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(DESC_STATS_REQUEST_SERIALIZED);

        Object descStatsRequestRead = messageReader.readFrom(input);
        assertThat(descStatsRequestRead, CoreMatchers.instanceOf(OFDescStatsRequestVer15.class));
        OFDescStatsRequest.Builder builder = factory.buildDescStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
        ...
        assertEquals(DESC_STATS_REQUEST_SERIALIZED.length, input.readerIndex());

        assertEquals(descStatsRequestBuilt, descStatsRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(DESC_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < DESC_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFDescStatsRequest descStatsRequest = (OFDescStatsRequest) messageReader.readFrom(input);
       assertEquals(DESC_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
