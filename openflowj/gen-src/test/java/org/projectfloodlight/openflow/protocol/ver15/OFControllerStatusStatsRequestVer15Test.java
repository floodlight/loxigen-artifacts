...
public class OFControllerStatusStatsRequestVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFControllerStatusStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFControllerStatusStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object controllerStatusStatsRequestRead = messageReader.readFrom(input);
        assertThat(controllerStatusStatsRequestRead, CoreMatchers.instanceOf(OFControllerStatusStatsRequestVer15.class));
        OFControllerStatusStatsRequest.Builder builder = factory.buildControllerStatusStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(CONTROLLER_STATUS_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < CONTROLLER_STATUS_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFControllerStatusStatsRequest controllerStatusStatsRequest = (OFControllerStatusStatsRequest) messageReader.readFrom(input);
       assertEquals(CONTROLLER_STATUS_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
