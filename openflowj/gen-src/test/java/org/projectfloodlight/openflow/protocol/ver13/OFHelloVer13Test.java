...
public class OFHelloVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFHelloVer13.READER, OFMessageVer13.READER
        );
    }

    public OFHelloVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(helloRead, CoreMatchers.instanceOf(OFHelloVer13.class));
   }
