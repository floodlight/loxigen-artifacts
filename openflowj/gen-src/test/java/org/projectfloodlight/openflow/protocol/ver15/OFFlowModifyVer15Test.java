...
public class OFFlowModifyVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowModifyVer15.READER, OFFlowModVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowModifyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object flowModifyRead = messageReader.readFrom(input);
        assertThat(flowModifyRead, CoreMatchers.instanceOf(OFFlowModifyVer15.class));
        OFFlowModify.Builder builder = factory.buildFlowModify();
        builder
        .setXid(0x12345678)
        .setCookie(U64.parseHex("FEDCBA9876543210"))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(FLOW_MODIFY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < FLOW_MODIFY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFFlowModify flowModify = (OFFlowModify) messageReader.readFrom(input);
       assertEquals(FLOW_MODIFY_SERIALIZED.length, input.readerIndex());
