...
public class OFQueueGetConfigReplyVer10Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFQueueGetConfigReplyVer10.READER, OFMessageVer10.READER
        );
    }

    public OFQueueGetConfigReplyVer10Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object queueGetConfigReplyRead = messageReader.readFrom(input);
        assertThat(queueGetConfigReplyRead, CoreMatchers.instanceOf(OFQueueGetConfigReplyVer10.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(QUEUE_GET_CONFIG_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < QUEUE_GET_CONFIG_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFQueueGetConfigReply queueGetConfigReply = (OFQueueGetConfigReply) messageReader.readFrom(input);
