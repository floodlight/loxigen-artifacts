...
public class OFBsnGentableClearRequestVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBsnGentableClearRequestVer13.READER, OFBsnHeaderVer13.READER, OFExperimenterVer13.READER, OFMessageVer13.READER
        );
    }

    public OFBsnGentableClearRequestVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object bsnGentableClearRequestRead = messageReader.readFrom(input);
        assertThat(bsnGentableClearRequestRead, CoreMatchers.instanceOf(OFBsnGentableClearRequestVer13.class));
        OFBsnGentableClearRequest.Builder builder = factory.buildBsnGentableClearRequest();
        builder.setXid(0x12345678)
    .setChecksum(U128.of(0xFEDCBA9876543210L, 0xFFEECCBBAA990000L))
    .setChecksumMask(U128.of(0xFFFFFFFFFFFFFFFFL, 0xFFFFFFFFFFFF0000L))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BSN_GENTABLE_CLEAR_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < BSN_GENTABLE_CLEAR_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBsnGentableClearRequest bsnGentableClearRequest = (OFBsnGentableClearRequest) messageReader.readFrom(input);
       assertEquals(BSN_GENTABLE_CLEAR_REQUEST_SERIALIZED.length, input.readerIndex());
