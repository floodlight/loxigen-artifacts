...
public class OFGroupModifyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFGroupModifyVer13.READER, OFGroupModVer13.READER, OFMessageVer13.READER
        );
    }

    public OFGroupModifyVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object groupModifyRead = messageReader.readFrom(input);
        assertThat(groupModifyRead, CoreMatchers.instanceOf(OFGroupModifyVer13.class));
        OFGroupModify.Builder builder = factory.buildGroupModify();
            OFActions actions = factory.actions();
    builder
      .setXid(0x12345678)
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(GROUP_MODIFY_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < GROUP_MODIFY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFGroupModify groupModify = (OFGroupModify) messageReader.readFrom(input);
       assertEquals(GROUP_MODIFY_SERIALIZED.length, input.readerIndex());
