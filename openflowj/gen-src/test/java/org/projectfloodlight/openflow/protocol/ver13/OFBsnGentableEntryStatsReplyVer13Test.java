...
public class OFBsnGentableEntryStatsReplyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBsnGentableEntryStatsReplyVer13.READER, OFBsnStatsReplyVer13.READER, OFExperimenterStatsReplyVer13.READER, OFStatsReplyVer13.READER, OFMessageVer13.READER
        );
    }

    public OFBsnGentableEntryStatsReplyVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object bsnGentableEntryStatsReplyRead = messageReader.readFrom(input);
        assertThat(bsnGentableEntryStatsReplyRead, CoreMatchers.instanceOf(OFBsnGentableEntryStatsReplyVer13.class));
        OFBsnGentableEntryStatsReply.Builder builder = factory.buildBsnGentableEntryStatsReply();
        builder.setXid(0x12345678)
    .setEntries(
        ImmutableList.<OFBsnGentableEntryStatsEntry>of(
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BSN_GENTABLE_ENTRY_STATS_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < BSN_GENTABLE_ENTRY_STATS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBsnGentableEntryStatsReply bsnGentableEntryStatsReply = (OFBsnGentableEntryStatsReply) messageReader.readFrom(input);
       assertEquals(BSN_GENTABLE_ENTRY_STATS_REPLY_SERIALIZED.length, input.readerIndex());
