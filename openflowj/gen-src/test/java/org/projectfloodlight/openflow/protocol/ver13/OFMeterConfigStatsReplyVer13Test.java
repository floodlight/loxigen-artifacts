...
public class OFMeterConfigStatsReplyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFMeterConfigStatsReplyVer13.READER, OFStatsReplyVer13.READER, OFMessageVer13.READER
        );
    }

    public OFMeterConfigStatsReplyVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(meterConfigStatsReplyRead, CoreMatchers.instanceOf(OFMeterConfigStatsReplyVer13.class));
   }
