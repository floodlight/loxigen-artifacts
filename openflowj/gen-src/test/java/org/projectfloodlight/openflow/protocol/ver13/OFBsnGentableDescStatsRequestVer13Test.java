...
public class OFBsnGentableDescStatsRequestVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBsnGentableDescStatsRequestVer13.READER, OFBsnStatsRequestVer13.READER, OFExperimenterStatsRequestVer13.READER, OFStatsRequestVer13.READER, OFMessageVer13.READER
        );
    }

    public OFBsnGentableDescStatsRequestVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object bsnGentableDescStatsRequestRead = messageReader.readFrom(input);
        assertThat(bsnGentableDescStatsRequestRead, CoreMatchers.instanceOf(OFBsnGentableDescStatsRequestVer13.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BSN_GENTABLE_DESC_STATS_REQUEST_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < BSN_GENTABLE_DESC_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBsnGentableDescStatsRequest bsnGentableDescStatsRequest = (OFBsnGentableDescStatsRequest) messageReader.readFrom(input);
