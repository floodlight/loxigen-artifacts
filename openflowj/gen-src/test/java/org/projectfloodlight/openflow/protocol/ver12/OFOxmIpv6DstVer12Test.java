...
public class OFOxmIpv6DstVer12Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFOxmIpv6DstVer12.READER, OFOxmVer12.READER
        );
    }

    public OFOxmIpv6DstVer12Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object oxmIpv6DstRead = messageReader.readFrom(input);
        assertThat(oxmIpv6DstRead, CoreMatchers.instanceOf(OFOxmIpv6DstVer12.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(OXM_IPV6_DST_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < OXM_IPV6_DST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFOxmIpv6Dst oxmIpv6Dst = (OFOxmIpv6Dst) messageReader.readFrom(input);
