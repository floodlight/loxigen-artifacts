...
public class OFGetConfigRequestVer15Test {
    ...
    final static byte[] GET_CONFIG_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x7, 0x0, 0x8, 0x12, 0x34, 0x56, 0x78 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFGetConfigRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFGetConfigRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object getConfigRequestRead = messageReader.readFrom(input);
        assertThat(getConfigRequestRead, CoreMatchers.instanceOf(OFGetConfigRequestVer15.class));
        OFGetConfigRequest.Builder builder = factory.buildGetConfigRequest();
        builder.setXid(0x12345678).build();
        ...
        assertEquals(getConfigRequestBuilt, getConfigRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(GET_CONFIG_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < GET_CONFIG_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFGetConfigRequest getConfigRequest = (OFGetConfigRequest) messageReader.readFrom(input);
       assertEquals(GET_CONFIG_REQUEST_SERIALIZED.length, input.readerIndex());
