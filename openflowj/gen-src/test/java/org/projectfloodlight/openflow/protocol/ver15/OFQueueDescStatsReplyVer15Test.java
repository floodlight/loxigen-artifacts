...
public class OFQueueDescStatsReplyVer15Test {
    ...
    final static byte[] QUEUE_DESC_STATS_REPLY_SERIALIZED =
        new byte[] { 0x6, 0x13, 0x0, 0x28, 0x12, 0x34, 0x56, 0x78, 0x0, 0xf, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x18, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x8, 0x0, 0x1, 0x0, 0x0 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFQueueDescStatsReplyVer15.READER, OFStatsReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFQueueDescStatsReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFQueueDescStatsReply.Builder builder = factory.buildQueueDescStatsReply();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(QUEUE_DESC_STATS_REPLY_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(QUEUE_DESC_STATS_REPLY_SERIALIZED);

        Object queueDescStatsReplyRead = messageReader.readFrom(input);
        assertThat(queueDescStatsReplyRead, CoreMatchers.instanceOf(OFQueueDescStatsReplyVer15.class));
        OFQueueDescStatsReply.Builder builder = factory.buildQueueDescStatsReply();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsReplyFlags>of(OFStatsReplyFlags.REPLY_MORE))
        ...
        assertEquals(QUEUE_DESC_STATS_REPLY_SERIALIZED.length, input.readerIndex());

        assertEquals(queueDescStatsReplyBuilt, queueDescStatsReplyRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(QUEUE_DESC_STATS_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < QUEUE_DESC_STATS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFQueueDescStatsReply queueDescStatsReply = (OFQueueDescStatsReply) messageReader.readFrom(input);
       assertEquals(QUEUE_DESC_STATS_REPLY_SERIALIZED.length, input.readerIndex());
