...
public class OFHelloVer15Test {
    ...
    final static byte[] HELLO_SERIALIZED =
        new byte[] { 0x6, 0x0, 0x0, 0x20, 0x12, 0x34, 0x56, 0x78, 0x0, 0x1, 0x0, 0xc, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x2, 0x0, 0x1, 0x0, 0xc, 0x0, 0x0, 0x0, 0x3, 0x0, 0x0, 0x0, 0x4 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFHelloVer15.READER, OFMessageVer15.READER
        );
    }

    public OFHelloVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(helloRead, CoreMatchers.instanceOf(OFHelloVer15.class));
        OFHello.Builder builder = factory.buildHello();
        builder
        .setXid(0x12345678)
        .setElements(ImmutableList.<OFHelloElem>of(
