...
public class OFInstructionApplyActionsVer15Test {
    ...
    final static byte[] INSTRUCTION_APPLY_ACTIONS_SERIALIZED =
        new byte[] { 0x0, 0x4, 0x0, 0x10, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc, 0x0, 0x8, 0x0, 0x0, 0x0, 0x0 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFInstructionApplyActionsVer15.READER, OFInstructionVer15.READER
        );
    }

    public OFInstructionApplyActionsVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFInstructionApplyActions.Builder builder = factory.buildApplyActions();
...
builder.setActions(ImmutableList.<OFAction>of(actions.copyTtlIn()));
        ...
        assertThat(written, CoreMatchers.equalTo(INSTRUCTION_APPLY_ACTIONS_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(INSTRUCTION_APPLY_ACTIONS_SERIALIZED);

        Object instructionApplyActionsRead = messageReader.readFrom(input);
        assertThat(instructionApplyActionsRead, CoreMatchers.instanceOf(OFInstructionApplyActionsVer15.class));
        OFInstructionApplyActions.Builder builder = factory.buildApplyActions();
        OFActions actions = OFFactories.getFactory(OFVersion.OF_15).actions();
builder.setActions(ImmutableList.<OFAction>of(actions.copyTtlIn()));
        OFInstructionApplyActions instructionApplyActionsBuilt = builder.build();

        assertEquals(INSTRUCTION_APPLY_ACTIONS_SERIALIZED.length, input.readerIndex());

        assertEquals(instructionApplyActionsBuilt, instructionApplyActionsRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(INSTRUCTION_APPLY_ACTIONS_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < INSTRUCTION_APPLY_ACTIONS_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFInstructionApplyActions instructionApplyActions = (OFInstructionApplyActions) messageReader.readFrom(input);
       assertEquals(INSTRUCTION_APPLY_ACTIONS_SERIALIZED.length, input.readerIndex());
