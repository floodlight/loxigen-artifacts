...
public class OFOxmIpv6DstVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFOxmIpv6DstVer13.READER, OFOxmVer13.READER
        );
    }

    public OFOxmIpv6DstVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(oxmIpv6DstRead, CoreMatchers.instanceOf(OFOxmIpv6DstVer13.class));
   }
