...
public class OFBarrierReplyVer15Test {
    ...
    final static byte[] BARRIER_REPLY_SERIALIZED =
        new byte[] { 0x6, 0x15, 0x0, 0x8, 0x12, 0x34, 0x56, 0x78 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBarrierReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFBarrierReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        ...
        assertThat(written, CoreMatchers.equalTo(BARRIER_REPLY_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(BARRIER_REPLY_SERIALIZED);

        Object barrierReplyRead = messageReader.readFrom(input);
        assertThat(barrierReplyRead, CoreMatchers.instanceOf(OFBarrierReplyVer15.class));
        OFBarrierReply.Builder builder = factory.buildBarrierReply();
        builder.setXid(0x12345678).build();
        OFBarrierReply barrierReplyBuilt = builder.build();

        assertEquals(BARRIER_REPLY_SERIALIZED.length, input.readerIndex());

        assertEquals(barrierReplyBuilt, barrierReplyRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BARRIER_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < BARRIER_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBarrierReply barrierReply = (OFBarrierReply) messageReader.readFrom(input);
       assertEquals(BARRIER_REPLY_SERIALIZED.length, input.readerIndex());
