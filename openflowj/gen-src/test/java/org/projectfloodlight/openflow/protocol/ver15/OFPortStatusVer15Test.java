...
public class OFPortStatusVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPortStatusVer15.READER, OFMessageVer15.READER
        );
    }

    public OFPortStatusVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(portStatusRead, CoreMatchers.instanceOf(OFPortStatusVer15.class));
        OFPortStatus.Builder builder = factory.buildPortStatus();
        builder
        .setXid(0x12345678)
        .setReason(OFPortReason.ADD)
