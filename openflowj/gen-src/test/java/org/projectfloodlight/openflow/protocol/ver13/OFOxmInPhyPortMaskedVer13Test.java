...
public class OFOxmInPhyPortMaskedVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFOxmInPhyPortMaskedVer13.READER, OFOxmVer13.READER
        );
    }

    public OFOxmInPhyPortMaskedVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(oxmInPhyPortMaskedRead, CoreMatchers.instanceOf(OFOxmInPhyPortMaskedVer13.class));
   }
