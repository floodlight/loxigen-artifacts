...
public class OFPortStatsRequestVer15Test {
    ...
    final static byte[] PORT_STATS_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x12, 0x0, 0x18, 0x12, 0x34, 0x56, 0x78, 0x0, 0x4, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPortStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFPortStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFPortStatsRequest.Builder builder = factory.buildPortStatsRequest();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(PORT_STATS_REQUEST_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(PORT_STATS_REQUEST_SERIALIZED);

        Object portStatsRequestRead = messageReader.readFrom(input);
        assertThat(portStatsRequestRead, CoreMatchers.instanceOf(OFPortStatsRequestVer15.class));
        OFPortStatsRequest.Builder builder = factory.buildPortStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
        ...
        assertEquals(PORT_STATS_REQUEST_SERIALIZED.length, input.readerIndex());

        assertEquals(portStatsRequestBuilt, portStatsRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(PORT_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < PORT_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFPortStatsRequest portStatsRequest = (OFPortStatsRequest) messageReader.readFrom(input);
       assertEquals(PORT_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
