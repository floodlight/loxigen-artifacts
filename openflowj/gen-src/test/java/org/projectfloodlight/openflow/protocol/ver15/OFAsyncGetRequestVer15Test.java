...
public class OFAsyncGetRequestVer15Test {
    ...
    final static byte[] ASYNC_GET_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x1a, 0x0, 0x8, 0x12, 0x34, 0x56, 0x78 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFAsyncGetRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFAsyncGetRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFAsyncGetRequest.Builder builder = factory.buildAsyncGetRequest();
        ...
        assertThat(written, CoreMatchers.equalTo(ASYNC_GET_REQUEST_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(ASYNC_GET_REQUEST_SERIALIZED);

        Object asyncGetRequestRead = messageReader.readFrom(input);
        assertThat(asyncGetRequestRead, CoreMatchers.instanceOf(OFAsyncGetRequestVer15.class));
        OFAsyncGetRequest.Builder builder = factory.buildAsyncGetRequest();
        builder.setXid(0x12345678).build();
        OFAsyncGetRequest asyncGetRequestBuilt = builder.build();

        assertEquals(ASYNC_GET_REQUEST_SERIALIZED.length, input.readerIndex());

        assertEquals(asyncGetRequestBuilt, asyncGetRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(ASYNC_GET_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < ASYNC_GET_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFAsyncGetRequest asyncGetRequest = (OFAsyncGetRequest) messageReader.readFrom(input);
       assertEquals(ASYNC_GET_REQUEST_SERIALIZED.length, input.readerIndex());
