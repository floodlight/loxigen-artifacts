...
public class OFBsnPortCounterStatsReplyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBsnPortCounterStatsReplyVer13.READER, OFBsnStatsReplyVer13.READER, OFExperimenterStatsReplyVer13.READER, OFStatsReplyVer13.READER, OFMessageVer13.READER
        );
    }

    public OFBsnPortCounterStatsReplyVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object bsnPortCounterStatsReplyRead = messageReader.readFrom(input);
        assertThat(bsnPortCounterStatsReplyRead, CoreMatchers.instanceOf(OFBsnPortCounterStatsReplyVer13.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BSN_PORT_COUNTER_STATS_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < BSN_PORT_COUNTER_STATS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBsnPortCounterStatsReply bsnPortCounterStatsReply = (OFBsnPortCounterStatsReply) messageReader.readFrom(input);
