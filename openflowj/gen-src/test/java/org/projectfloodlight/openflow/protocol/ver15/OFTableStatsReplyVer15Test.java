...
public class OFTableStatsReplyVer15Test {
    ...
    final static byte[] TABLE_STATS_REPLY_SERIALIZED =
        new byte[] { 0x6, 0x13, 0x0, 0x28, 0x12, 0x34, 0x56, 0x78, 0x0, 0x3, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFTableStatsReplyVer15.READER, OFStatsReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFTableStatsReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFTableStatsReply.Builder builder = factory.buildTableStatsReply();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(TABLE_STATS_REPLY_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(TABLE_STATS_REPLY_SERIALIZED);

        Object tableStatsReplyRead = messageReader.readFrom(input);
        assertThat(tableStatsReplyRead, CoreMatchers.instanceOf(OFTableStatsReplyVer15.class));
        OFTableStatsReply.Builder builder = factory.buildTableStatsReply();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsReplyFlags>of(OFStatsReplyFlags.REPLY_MORE))
        ...
        assertEquals(TABLE_STATS_REPLY_SERIALIZED.length, input.readerIndex());

        assertEquals(tableStatsReplyBuilt, tableStatsReplyRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(TABLE_STATS_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < TABLE_STATS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFTableStatsReply tableStatsReply = (OFTableStatsReply) messageReader.readFrom(input);
       assertEquals(TABLE_STATS_REPLY_SERIALIZED.length, input.readerIndex());
