...
public class OFFlowDeleteVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowDeleteVer15.READER, OFFlowModVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowDeleteVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(flowDeleteRead, CoreMatchers.instanceOf(OFFlowDeleteVer15.class));
        OFFlowDelete.Builder builder = factory.buildFlowDelete();
        builder
        .setXid(0x12345678)
        .setCookie(U64.parseHex("FEDCBA9876543210"))
