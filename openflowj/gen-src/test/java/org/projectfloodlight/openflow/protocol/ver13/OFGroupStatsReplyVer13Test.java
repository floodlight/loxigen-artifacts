...
public class OFGroupStatsReplyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFGroupStatsReplyVer13.READER, OFStatsReplyVer13.READER, OFMessageVer13.READER
        );
    }

    public OFGroupStatsReplyVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(groupStatsReplyRead, CoreMatchers.instanceOf(OFGroupStatsReplyVer13.class));
   }
