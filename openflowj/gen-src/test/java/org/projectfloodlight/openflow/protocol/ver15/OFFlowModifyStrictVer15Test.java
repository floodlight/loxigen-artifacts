...
public class OFFlowModifyStrictVer15Test {
    ...
    public void testRead() throws Exception {
        ...
        OFFlowModifyStrict flowModifyStrictRead = OFFlowModifyStrictVer15.READER.readFrom(input);
   ...
   public void testReadWrite() throws Exception {
       ...
       // FIXME should invoke the overall reader once implemented
       OFFlowModifyStrict flowModifyStrict = OFFlowModifyStrictVer15.READER.readFrom(input);
       assertEquals(FLOW_MODIFY_STRICT_SERIALIZED.length, input.readerIndex());
