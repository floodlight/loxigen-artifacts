...
public class OFFlowStatsReplyVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowStatsReplyVer15.READER, OFStatsReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowStatsReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(flowStatsReplyRead, CoreMatchers.instanceOf(OFFlowStatsReplyVer15.class));
        OFFlowStatsReply.Builder builder = factory.buildFlowStatsReply();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsReplyFlags>of(OFStatsReplyFlags.REPLY_MORE))
