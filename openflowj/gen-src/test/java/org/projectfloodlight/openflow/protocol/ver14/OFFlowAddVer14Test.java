...
public class OFFlowAddVer14Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowAddVer14.READER, OFFlowModVer14.READER, OFMessageVer14.READER
        );
    }

    public OFFlowAddVer14Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(flowAddRead, CoreMatchers.instanceOf(OFFlowAddVer14.class));
        OFFlowAdd.Builder builder = factory.buildFlowAdd();
        builder.setXid(0x12345678)
    .setCookie(U64.parseHex("FEDCBA9876543210"))
    .setCookieMask(U64.parseHex("FF00FF00FF00FF00"))
