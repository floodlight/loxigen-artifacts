...
public class OFBadMatchErrorMsgVer15Test {
    ...
    public void testRead() throws Exception {
        ...
        OFBadMatchErrorMsg badMatchErrorMsgRead = OFBadMatchErrorMsgVer15.READER.readFrom(input);
   ...
   public void testReadWrite() throws Exception {
       ...
       // FIXME should invoke the overall reader once implemented
       OFBadMatchErrorMsg badMatchErrorMsg = OFBadMatchErrorMsgVer15.READER.readFrom(input);
       assertEquals(BAD_MATCH_ERROR_MSG_SERIALIZED.length, input.readerIndex());
