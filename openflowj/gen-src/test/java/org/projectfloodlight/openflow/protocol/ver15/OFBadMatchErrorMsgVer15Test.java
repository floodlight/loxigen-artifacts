...
public class OFBadMatchErrorMsgVer15Test {
    ...
    final static byte[] BAD_MATCH_ERROR_MSG_SERIALIZED =
        new byte[] { 0x6, 0x1, 0x0, 0xf, 0x12, 0x34, 0x56, 0x78, 0x0, 0x4, 0x0, 0x8, 0x61, 0x62, 0x63 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBadMatchErrorMsgVer15.READER, OFErrorMsgVer15.READER, OFMessageVer15.READER
        );
    }

    public OFBadMatchErrorMsgVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(badMatchErrorMsgRead, CoreMatchers.instanceOf(OFBadMatchErrorMsgVer15.class));
        OFBadMatchErrorMsg.Builder builder = factory.buildBadMatchErrorMsg();
        builder
        .setXid(0x12345678)
        .setCode(OFBadMatchCode.BAD_MASK)
