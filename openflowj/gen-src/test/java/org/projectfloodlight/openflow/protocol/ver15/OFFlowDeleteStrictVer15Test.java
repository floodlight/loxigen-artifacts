...
public class OFFlowDeleteStrictVer15Test {
    ...
    public void testRead() throws Exception {
        ...
        OFFlowDeleteStrict flowDeleteStrictRead = OFFlowDeleteStrictVer15.READER.readFrom(input);
   ...
   public void testReadWrite() throws Exception {
       ...
       // FIXME should invoke the overall reader once implemented
       OFFlowDeleteStrict flowDeleteStrict = OFFlowDeleteStrictVer15.READER.readFrom(input);
       assertEquals(FLOW_DELETE_STRICT_SERIALIZED.length, input.readerIndex());
