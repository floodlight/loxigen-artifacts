...
public class OFFlowDeleteStrictVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowDeleteStrictVer15.READER, OFFlowModVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowDeleteStrictVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object flowDeleteStrictRead = messageReader.readFrom(input);
        assertThat(flowDeleteStrictRead, CoreMatchers.instanceOf(OFFlowDeleteStrictVer15.class));
        OFFlowDeleteStrict.Builder builder = factory.buildFlowDeleteStrict();
        builder
        .setXid(0x12345678)
        .setCookie(U64.parseHex("FEDCBA9876543210"))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(FLOW_DELETE_STRICT_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < FLOW_DELETE_STRICT_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFFlowDeleteStrict flowDeleteStrict = (OFFlowDeleteStrict) messageReader.readFrom(input);
       assertEquals(FLOW_DELETE_STRICT_SERIALIZED.length, input.readerIndex());
