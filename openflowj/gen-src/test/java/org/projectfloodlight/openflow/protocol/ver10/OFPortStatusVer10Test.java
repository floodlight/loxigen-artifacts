...
public class OFPortStatusVer10Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPortStatusVer10.READER, OFMessageVer10.READER
        );
    }

    public OFPortStatusVer10Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(portStatusRead, CoreMatchers.instanceOf(OFPortStatusVer10.class));
   }
