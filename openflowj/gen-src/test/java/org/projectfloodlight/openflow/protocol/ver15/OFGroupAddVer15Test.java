...
public class OFGroupAddVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFGroupAddVer15.READER, OFGroupModVer15.READER, OFMessageVer15.READER
        );
    }

    public OFGroupAddVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object groupAddRead = messageReader.readFrom(input);
        assertThat(groupAddRead, CoreMatchers.instanceOf(OFGroupAddVer15.class));
        OFGroupAdd.Builder builder = factory.buildGroupAdd();
        builder
        .setXid(0x12345678)
        .setGroupType(OFGroupType.SELECT)
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(GROUP_ADD_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < GROUP_ADD_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFGroupAdd groupAdd = (OFGroupAdd) messageReader.readFrom(input);
       assertEquals(GROUP_ADD_SERIALIZED.length, input.readerIndex());
