...
public class OFMeterStatsReplyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFMeterStatsReplyVer13.READER, OFStatsReplyVer13.READER, OFMessageVer13.READER
        );
    }

    public OFMeterStatsReplyVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object meterStatsReplyRead = messageReader.readFrom(input);
        assertThat(meterStatsReplyRead, CoreMatchers.instanceOf(OFMeterStatsReplyVer13.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(METER_STATS_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < METER_STATS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFMeterStatsReply meterStatsReply = (OFMeterStatsReply) messageReader.readFrom(input);
