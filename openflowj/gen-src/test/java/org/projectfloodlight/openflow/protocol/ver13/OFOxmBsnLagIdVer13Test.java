...
public class OFOxmBsnLagIdVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFOxmBsnLagIdVer13.READER, OFOxmVer13.READER
        );
    }

    public OFOxmBsnLagIdVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object oxmBsnLagIdRead = messageReader.readFrom(input);
        assertThat(oxmBsnLagIdRead, CoreMatchers.instanceOf(OFOxmBsnLagIdVer13.class));
        OFOxmBsnLagId.Builder builder = factory.buildBsnLagId();
        builder.setValue(LagId.of(0x12345678));
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(OXM_BSN_LAG_ID_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < OXM_BSN_LAG_ID_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFOxmBsnLagId oxmBsnLagId = (OFOxmBsnLagId) messageReader.readFrom(input);
       assertEquals(OXM_BSN_LAG_ID_SERIALIZED.length, input.readerIndex());
