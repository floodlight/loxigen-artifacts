...
public class OFMeterConfigStatsReplyVer15Test {
    ...
    final static byte[] METER_CONFIG_STATS_REPLY_SERIALIZED =
        new byte[] { 0x6, 0x13, 0x0, 0x28, 0x12, 0x34, 0x56, 0x78, 0x0, 0xa, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x18, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x0, 0x10, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFMeterConfigStatsReplyVer15.READER, OFStatsReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFMeterConfigStatsReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFMeterConfigStatsReply.Builder builder = factory.buildMeterConfigStatsReply();
        builder
        .setXid(0x12345678)
    ...
    public void testRead() throws Exception {
        ...
        Object meterConfigStatsReplyRead = messageReader.readFrom(input);
        assertThat(meterConfigStatsReplyRead, CoreMatchers.instanceOf(OFMeterConfigStatsReplyVer15.class));
        OFMeterConfigStatsReply.Builder builder = factory.buildMeterConfigStatsReply();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsReplyFlags>of(OFStatsReplyFlags.REPLY_MORE))
        ...
        assertEquals(meterConfigStatsReplyBuilt, meterConfigStatsReplyRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(METER_CONFIG_STATS_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < METER_CONFIG_STATS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFMeterConfigStatsReply meterConfigStatsReply = (OFMeterConfigStatsReply) messageReader.readFrom(input);
       assertEquals(METER_CONFIG_STATS_REPLY_SERIALIZED.length, input.readerIndex());
