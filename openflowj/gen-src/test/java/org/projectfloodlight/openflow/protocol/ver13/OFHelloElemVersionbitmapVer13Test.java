...
public class OFHelloElemVersionbitmapVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFHelloElemVersionbitmapVer13.READER, OFHelloElemVer13.READER
        );
    }

    public OFHelloElemVersionbitmapVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object helloElemVersionbitmapRead = messageReader.readFrom(input);
        assertThat(helloElemVersionbitmapRead, CoreMatchers.instanceOf(OFHelloElemVersionbitmapVer13.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(HELLO_ELEM_VERSIONBITMAP_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < HELLO_ELEM_VERSIONBITMAP_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFHelloElemVersionbitmap helloElemVersionbitmap = (OFHelloElemVersionbitmap) messageReader.readFrom(input);
