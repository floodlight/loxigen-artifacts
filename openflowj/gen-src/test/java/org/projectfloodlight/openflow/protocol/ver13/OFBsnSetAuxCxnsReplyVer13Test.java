...
public class OFBsnSetAuxCxnsReplyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBsnSetAuxCxnsReplyVer13.READER, OFBsnHeaderVer13.READER, OFExperimenterVer13.READER, OFMessageVer13.READER
        );
    }

    public OFBsnSetAuxCxnsReplyVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object bsnSetAuxCxnsReplyRead = messageReader.readFrom(input);
        assertThat(bsnSetAuxCxnsReplyRead, CoreMatchers.instanceOf(OFBsnSetAuxCxnsReplyVer13.class));
        OFBsnSetAuxCxnsReply.Builder builder = factory.buildBsnSetAuxCxnsReply();
        builder.setXid(0x12345678)
        .setNumAux(1)
        .setStatus(0);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BSN_SET_AUX_CXNS_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < BSN_SET_AUX_CXNS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBsnSetAuxCxnsReply bsnSetAuxCxnsReply = (OFBsnSetAuxCxnsReply) messageReader.readFrom(input);
       assertEquals(BSN_SET_AUX_CXNS_REPLY_SERIALIZED.length, input.readerIndex());
