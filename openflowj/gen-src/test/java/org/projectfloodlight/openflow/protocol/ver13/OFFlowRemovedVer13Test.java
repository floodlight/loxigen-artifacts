...
public class OFFlowRemovedVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowRemovedVer13.READER, OFMessageVer13.READER
        );
    }

    public OFFlowRemovedVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(flowRemovedRead, CoreMatchers.instanceOf(OFFlowRemovedVer13.class));
   }
