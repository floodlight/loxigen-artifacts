...
public class OFFeaturesRequestVer15Test {
    ...
    final static byte[] FEATURES_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x5, 0x0, 0x8, 0x12, 0x34, 0x56, 0x78 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFeaturesRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFeaturesRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object featuresRequestRead = messageReader.readFrom(input);
        assertThat(featuresRequestRead, CoreMatchers.instanceOf(OFFeaturesRequestVer15.class));
        OFFeaturesRequest.Builder builder = factory.buildFeaturesRequest();
        builder.setXid(0x12345678).build();
        ...
        assertEquals(featuresRequestBuilt, featuresRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(FEATURES_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < FEATURES_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFFeaturesRequest featuresRequest = (OFFeaturesRequest) messageReader.readFrom(input);
       assertEquals(FEATURES_REQUEST_SERIALIZED.length, input.readerIndex());
