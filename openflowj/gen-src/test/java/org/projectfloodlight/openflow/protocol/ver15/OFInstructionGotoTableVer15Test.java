...
public class OFInstructionGotoTableVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFInstructionGotoTableVer15.READER, OFInstructionVer15.READER
        );
    }

    public OFInstructionGotoTableVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFInstructionGotoTable.Builder builder = factory.buildGotoTable();
    ...
    public void testRead() throws Exception {
        ...
        Object instructionGotoTableRead = messageReader.readFrom(input);
        assertThat(instructionGotoTableRead, CoreMatchers.instanceOf(OFInstructionGotoTableVer15.class));
        OFInstructionGotoTable.Builder builder = factory.buildGotoTable();
        builder.setTableId(TableId.of(5)).build();
        ...
        assertEquals(instructionGotoTableBuilt, instructionGotoTableRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(INSTRUCTION_GOTO_TABLE_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < INSTRUCTION_GOTO_TABLE_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFInstructionGotoTable instructionGotoTable = (OFInstructionGotoTable) messageReader.readFrom(input);
       assertEquals(INSTRUCTION_GOTO_TABLE_SERIALIZED.length, input.readerIndex());
