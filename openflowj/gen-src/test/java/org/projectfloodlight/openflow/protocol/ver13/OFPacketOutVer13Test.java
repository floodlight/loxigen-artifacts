...
public class OFPacketOutVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPacketOutVer13.READER, OFMessageVer13.READER
        );
    }

    public OFPacketOutVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(packetOutRead, CoreMatchers.instanceOf(OFPacketOutVer13.class));
   }
