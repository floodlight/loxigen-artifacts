...
public class OFEchoReplyVer15Test {
    ...
    final static byte[] ECHO_REPLY_SERIALIZED =
        new byte[] { 0x6, 0x3, 0x0, 0xb, 0x12, 0x34, 0x56, 0x78, 0x61, 0x62, 0x63 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFEchoReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFEchoReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(echoReplyRead, CoreMatchers.instanceOf(OFEchoReplyVer15.class));
        OFEchoReply.Builder builder = factory.buildEchoReply();
        builder.setXid(0x12345678).setData(new byte[] {97,98,99}).build();
        ...
        assertEquals(echoReplyBuilt, echoReplyRead);
