...
public class OFBsnGentableEntryStatsRequestVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBsnGentableEntryStatsRequestVer13.READER, OFBsnStatsRequestVer13.READER, OFExperimenterStatsRequestVer13.READER, OFStatsRequestVer13.READER, OFMessageVer13.READER
        );
    }

    public OFBsnGentableEntryStatsRequestVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object bsnGentableEntryStatsRequestRead = messageReader.readFrom(input);
        assertThat(bsnGentableEntryStatsRequestRead, CoreMatchers.instanceOf(OFBsnGentableEntryStatsRequestVer13.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BSN_GENTABLE_ENTRY_STATS_REQUEST_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < BSN_GENTABLE_ENTRY_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBsnGentableEntryStatsRequest bsnGentableEntryStatsRequest = (OFBsnGentableEntryStatsRequest) messageReader.readFrom(input);
