...
public class OFPacketInVer15Test {
    OFFactory factory;

    final static byte[] PACKET_IN_SERIALIZED =
        new byte[] { 0x6, 0xa, 0x0, 0x35, 0x12, 0x34, 0x56, 0x78, 0x0, 0x0, 0x0, 0x64, 0x42, 0x68, 0x1, 0x14, (byte) 0xfe, (byte) 0xdc, (byte) 0xba, (byte) 0x98, 0x76, 0x54, 0x32, 0x10, 0x0, 0x1, 0x0, 0x16, (byte) 0x80, 0x0, 0x1, 0x8, 0x0, 0x0, 0x0, 0x4, 0x0, 0x0, 0x0, 0x5, (byte) 0x80, 0x0, 0x2a, 0x2, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x61, 0x62, 0x63 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPacketInVer15.READER, OFMessageVer15.READER
        );
    }

    public OFPacketInVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(packetInRead, CoreMatchers.instanceOf(OFPacketInVer15.class));
        OFPacketIn.Builder builder = factory.buildPacketIn();
        builder
        .setXid(0x12345678)
        .setBufferId(OFBufferId.of(100))
