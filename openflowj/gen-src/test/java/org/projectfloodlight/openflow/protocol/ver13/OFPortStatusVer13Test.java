...
public class OFPortStatusVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPortStatusVer13.READER, OFMessageVer13.READER
        );
    }

    public OFPortStatusVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object portStatusRead = messageReader.readFrom(input);
        assertThat(portStatusRead, CoreMatchers.instanceOf(OFPortStatusVer13.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(PORT_STATUS_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < PORT_STATUS_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFPortStatus portStatus = (OFPortStatus) messageReader.readFrom(input);
