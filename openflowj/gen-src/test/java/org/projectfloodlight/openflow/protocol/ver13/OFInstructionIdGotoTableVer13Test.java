...
public class OFInstructionIdGotoTableVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFInstructionIdGotoTableVer13.READER, OFInstructionIdVer13.READER
        );
    }

    public OFInstructionIdGotoTableVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object instructionIdGotoTableRead = messageReader.readFrom(input);
        assertThat(instructionIdGotoTableRead, CoreMatchers.instanceOf(OFInstructionIdGotoTableVer13.class));
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(INSTRUCTION_ID_GOTO_TABLE_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < INSTRUCTION_ID_GOTO_TABLE_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFInstructionIdGotoTable instructionIdGotoTable = (OFInstructionIdGotoTable) messageReader.readFrom(input);
       assertEquals(INSTRUCTION_ID_GOTO_TABLE_SERIALIZED.length, input.readerIndex());
