...
public class OFGetConfigRequestVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFGetConfigRequestVer13.READER, OFMessageVer13.READER
        );
    }

    public OFGetConfigRequestVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(getConfigRequestRead, CoreMatchers.instanceOf(OFGetConfigRequestVer13.class));
   }
