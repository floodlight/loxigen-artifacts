...
public class OFFlowStatsRequestVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object flowStatsRequestRead = messageReader.readFrom(input);
        assertThat(flowStatsRequestRead, CoreMatchers.instanceOf(OFFlowStatsRequestVer15.class));
        OFFlowStatsRequest.Builder builder = factory.buildFlowStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(FLOW_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < FLOW_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFFlowStatsRequest flowStatsRequest = (OFFlowStatsRequest) messageReader.readFrom(input);
       assertEquals(FLOW_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
