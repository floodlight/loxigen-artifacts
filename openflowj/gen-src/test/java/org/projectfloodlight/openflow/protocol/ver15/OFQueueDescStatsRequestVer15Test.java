...
public class OFQueueDescStatsRequestVer15Test {
    ...
    final static byte[] QUEUE_DESC_STATS_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x12, 0x0, 0x18, 0x12, 0x34, 0x56, 0x78, 0x0, 0xf, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFQueueDescStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFQueueDescStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFQueueDescStatsRequest.Builder builder = factory.buildQueueDescStatsRequest();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(QUEUE_DESC_STATS_REQUEST_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(QUEUE_DESC_STATS_REQUEST_SERIALIZED);

        Object queueDescStatsRequestRead = messageReader.readFrom(input);
        assertThat(queueDescStatsRequestRead, CoreMatchers.instanceOf(OFQueueDescStatsRequestVer15.class));
        OFQueueDescStatsRequest.Builder builder = factory.buildQueueDescStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
        ...
        assertEquals(QUEUE_DESC_STATS_REQUEST_SERIALIZED.length, input.readerIndex());

        assertEquals(queueDescStatsRequestBuilt, queueDescStatsRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(QUEUE_DESC_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < QUEUE_DESC_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFQueueDescStatsRequest queueDescStatsRequest = (OFQueueDescStatsRequest) messageReader.readFrom(input);
       assertEquals(QUEUE_DESC_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
