...
public class OFEchoRequestVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFEchoRequestVer13.READER, OFMessageVer13.READER
        );
    }

    public OFEchoRequestVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(echoRequestRead, CoreMatchers.instanceOf(OFEchoRequestVer13.class));
   }
