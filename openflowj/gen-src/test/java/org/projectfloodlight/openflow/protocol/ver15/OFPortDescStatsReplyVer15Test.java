...
public class OFPortDescStatsReplyVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPortDescStatsReplyVer15.READER, OFStatsReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFPortDescStatsReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(portDescStatsReplyRead, CoreMatchers.instanceOf(OFPortDescStatsReplyVer15.class));
        OFPortDescStatsReply.Builder builder = factory.buildPortDescStatsReply();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsReplyFlags>of(OFStatsReplyFlags.REPLY_MORE))
