...
public class OFBundleFeaturesStatsRequestVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBundleFeaturesStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFBundleFeaturesStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object bundleFeaturesStatsRequestRead = messageReader.readFrom(input);
        assertThat(bundleFeaturesStatsRequestRead, CoreMatchers.instanceOf(OFBundleFeaturesStatsRequestVer15.class));
        OFBundleFeaturesStatsRequest.Builder builder = factory.buildBundleFeaturesStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BUNDLE_FEATURES_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < BUNDLE_FEATURES_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBundleFeaturesStatsRequest bundleFeaturesStatsRequest = (OFBundleFeaturesStatsRequest) messageReader.readFrom(input);
       assertEquals(BUNDLE_FEATURES_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
