...
public class OFFlowAddVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowAddVer15.READER, OFFlowModVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowAddVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(flowAddRead, CoreMatchers.instanceOf(OFFlowAddVer15.class));
        OFFlowAdd.Builder builder = factory.buildFlowAdd();
        builder
        .setXid(0x12345678)
        .setCookie(U64.parseHex("FEDCBA9876543210"))
