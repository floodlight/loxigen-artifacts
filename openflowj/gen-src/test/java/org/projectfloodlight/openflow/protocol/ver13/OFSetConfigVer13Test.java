...
public class OFSetConfigVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFSetConfigVer13.READER, OFMessageVer13.READER
        );
    }

    public OFSetConfigVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(setConfigRead, CoreMatchers.instanceOf(OFSetConfigVer13.class));
   }
