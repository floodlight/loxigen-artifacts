...
public class OFPacketOutVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPacketOutVer15.READER, OFMessageVer15.READER
        );
    }

    public OFPacketOutVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object packetOutRead = messageReader.readFrom(input);
        assertThat(packetOutRead, CoreMatchers.instanceOf(OFPacketOutVer15.class));
        OFPacketOut.Builder builder = factory.buildPacketOut();
        builder
        .setXid(0x12345678)
        .setBufferId(OFBufferId.of(100))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(PACKET_OUT_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < PACKET_OUT_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFPacketOut packetOut = (OFPacketOut) messageReader.readFrom(input);
       assertEquals(PACKET_OUT_SERIALIZED.length, input.readerIndex());
