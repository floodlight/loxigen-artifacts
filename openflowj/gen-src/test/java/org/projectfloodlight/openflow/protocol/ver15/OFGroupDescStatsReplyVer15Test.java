...
public class OFGroupDescStatsReplyVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFGroupDescStatsReplyVer15.READER, OFStatsReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFGroupDescStatsReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(groupDescStatsReplyRead, CoreMatchers.instanceOf(OFGroupDescStatsReplyVer15.class));
        OFGroupDescStatsReply.Builder builder = factory.buildGroupDescStatsReply();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsReplyFlags>of(OFStatsReplyFlags.REPLY_MORE))
