...
public class OFEchoRequestVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFEchoRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFEchoRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(echoRequestRead, CoreMatchers.instanceOf(OFEchoRequestVer15.class));
        OFEchoRequest.Builder builder = factory.buildEchoRequest();
        builder.setXid(0x12345678).setData(new byte[] {97,98,99}).build();
