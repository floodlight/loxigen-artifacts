...
public class OFPortDescVer10Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPortDescVer10.READER
        );
    }

    public OFPortDescVer10Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object portDescRead = messageReader.readFrom(input);
        assertThat(portDescRead, CoreMatchers.instanceOf(OFPortDescVer10.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(PORT_DESC_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < PORT_DESC_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFPortDesc portDesc = (OFPortDesc) messageReader.readFrom(input);
