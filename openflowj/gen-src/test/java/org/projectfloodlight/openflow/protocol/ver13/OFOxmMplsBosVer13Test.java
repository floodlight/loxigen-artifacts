...
public class OFOxmMplsBosVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFOxmMplsBosVer13.READER, OFOxmVer13.READER
        );
    }

    public OFOxmMplsBosVer13Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        Object oxmMplsBosRead = messageReader.readFrom(input);
        assertThat(oxmMplsBosRead, CoreMatchers.instanceOf(OFOxmMplsBosVer13.class));
   }
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(OXM_MPLS_BOS_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < OXM_MPLS_BOS_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFOxmMplsBos oxmMplsBos = (OFOxmMplsBos) messageReader.readFrom(input);
