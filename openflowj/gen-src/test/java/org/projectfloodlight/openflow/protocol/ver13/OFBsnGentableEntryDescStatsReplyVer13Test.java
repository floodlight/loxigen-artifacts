...
public class OFBsnGentableEntryDescStatsReplyVer13Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFBsnGentableEntryDescStatsReplyVer13.READER, OFBsnStatsReplyVer13.READER, OFExperimenterStatsReplyVer13.READER, OFStatsReplyVer13.READER, OFMessageVer13.READER
        );
    }

    public OFBsnGentableEntryDescStatsReplyVer13Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object bsnGentableEntryDescStatsReplyRead = messageReader.readFrom(input);
        assertThat(bsnGentableEntryDescStatsReplyRead, CoreMatchers.instanceOf(OFBsnGentableEntryDescStatsReplyVer13.class));
        OFBsnGentableEntryDescStatsReply.Builder builder = factory.buildBsnGentableEntryDescStatsReply();
        builder.setXid(0x12345678)
    .setEntries(
        ImmutableList.<OFBsnGentableEntryDescStatsEntry>of(
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(BSN_GENTABLE_ENTRY_DESC_STATS_REPLY_SERIALIZED);
        for(int prefixLength: PREFIX_BYTES) {
            ...
            for(int partialLength = 0; partialLength < BSN_GENTABLE_ENTRY_DESC_STATS_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFBsnGentableEntryDescStatsReply bsnGentableEntryDescStatsReply = (OFBsnGentableEntryDescStatsReply) messageReader.readFrom(input);
       assertEquals(BSN_GENTABLE_ENTRY_DESC_STATS_REPLY_SERIALIZED.length, input.readerIndex());
