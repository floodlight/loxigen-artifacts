...
public class OFMeterConfigStatsRequestVer15Test {
    ...
    final static byte[] METER_CONFIG_STATS_REQUEST_SERIALIZED =
        new byte[] { 0x6, 0x12, 0x0, 0x18, 0x12, 0x34, 0x56, 0x78, 0x0, 0xa, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFMeterConfigStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFMeterConfigStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFMeterConfigStatsRequest.Builder builder = factory.buildMeterConfigStatsRequest();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(METER_CONFIG_STATS_REQUEST_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(METER_CONFIG_STATS_REQUEST_SERIALIZED);

        Object meterConfigStatsRequestRead = messageReader.readFrom(input);
        assertThat(meterConfigStatsRequestRead, CoreMatchers.instanceOf(OFMeterConfigStatsRequestVer15.class));
        OFMeterConfigStatsRequest.Builder builder = factory.buildMeterConfigStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
        ...
        assertEquals(METER_CONFIG_STATS_REQUEST_SERIALIZED.length, input.readerIndex());

        assertEquals(meterConfigStatsRequestBuilt, meterConfigStatsRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(METER_CONFIG_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < METER_CONFIG_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFMeterConfigStatsRequest meterConfigStatsRequest = (OFMeterConfigStatsRequest) messageReader.readFrom(input);
       assertEquals(METER_CONFIG_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
