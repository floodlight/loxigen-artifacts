...
public class OFPacketOutVer10Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFPacketOutVer10.READER, OFMessageVer10.READER
        );
    }

    public OFPacketOutVer10Test(OFMessageReader<?> messageReader) {
   ...
   // FIXME: No java stanza in test_data for this class. Add to support write test
    ...
    public void testRead() throws Exception {
        ...
        assertThat(packetOutRead, CoreMatchers.instanceOf(OFPacketOutVer10.class));
   }
