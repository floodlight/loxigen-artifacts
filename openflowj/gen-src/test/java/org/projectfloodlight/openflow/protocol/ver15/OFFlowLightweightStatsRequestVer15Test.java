...
public class OFFlowLightweightStatsRequestVer15Test {
    ...
    final static byte[] FLOW_LIGHTWEIGHT_STATS_REQUEST_SERIALIZED =
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFFlowLightweightStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFFlowLightweightStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFFlowLightweightStatsRequest.Builder builder = factory.buildFlowLightweightStatsRequest();
        builder
        .setXid(0x12345678)
        ...
        .setMatch(factory.buildMatch()
                        ...
                        .build())
        .build();
        OFFlowLightweightStatsRequest flowLightweightStatsRequest = builder.build();
        ByteBuf bb = Unpooled.buffer();
        flowLightweightStatsRequest.writeTo(bb);
        byte[] written = new byte[bb.readableBytes()];
        bb.readBytes(written);

        assertThat(written, CoreMatchers.equalTo(FLOW_LIGHTWEIGHT_STATS_REQUEST_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(FLOW_LIGHTWEIGHT_STATS_REQUEST_SERIALIZED);

        Object flowLightweightStatsRequestRead = messageReader.readFrom(input);
        assertThat(flowLightweightStatsRequestRead, CoreMatchers.instanceOf(OFFlowLightweightStatsRequestVer15.class));
        OFFlowLightweightStatsRequest.Builder builder = factory.buildFlowLightweightStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
        ...
        .setMatch(factory.buildMatch()
                        ...
                        .build())
        .build();
        OFFlowLightweightStatsRequest flowLightweightStatsRequestBuilt = builder.build();

        assertEquals(FLOW_LIGHTWEIGHT_STATS_REQUEST_SERIALIZED.length, input.readerIndex());

        assertEquals(flowLightweightStatsRequestBuilt, flowLightweightStatsRequestRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(FLOW_LIGHTWEIGHT_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < FLOW_LIGHTWEIGHT_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFFlowLightweightStatsRequest flowLightweightStatsRequest = (OFFlowLightweightStatsRequest) messageReader.readFrom(input);
       assertEquals(FLOW_LIGHTWEIGHT_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
