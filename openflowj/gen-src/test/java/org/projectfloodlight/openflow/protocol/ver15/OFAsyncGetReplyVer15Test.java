...
public class OFAsyncGetReplyVer15Test {
    ...
    final static byte[] ASYNC_GET_REPLY_SERIALIZED =
        new byte[] { 0x6, 0x1b, 0x0, 0x10, 0x12, 0x34, 0x56, 0x78, 0x0, 0x1, 0x0, 0x8, 0x0, 0x0, 0x0, 0x0 };
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFAsyncGetReplyVer15.READER, OFMessageVer15.READER
        );
    }

    public OFAsyncGetReplyVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testWrite() {
        OFAsyncGetReply.Builder builder = factory.buildAsyncGetReply();
        builder
        .setXid(0x12345678)
        ...
        assertThat(written, CoreMatchers.equalTo(ASYNC_GET_REPLY_SERIALIZED));
    }


    @Test
    public void testRead() throws Exception {
        ByteBuf input = Unpooled.copiedBuffer(ASYNC_GET_REPLY_SERIALIZED);

        Object asyncGetReplyRead = messageReader.readFrom(input);
        assertThat(asyncGetReplyRead, CoreMatchers.instanceOf(OFAsyncGetReplyVer15.class));
        OFAsyncGetReply.Builder builder = factory.buildAsyncGetReply();
        builder
        .setXid(0x12345678)
        .setProperties(ImmutableList.<OFAsyncConfigProp>of(factory.buildAsyncConfigPropPacketInMaster().setMask(0).build()))
        ...
        assertEquals(ASYNC_GET_REPLY_SERIALIZED.length, input.readerIndex());

        assertEquals(asyncGetReplyBuilt, asyncGetReplyRead);
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(ASYNC_GET_REPLY_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < ASYNC_GET_REPLY_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFAsyncGetReply asyncGetReply = (OFAsyncGetReply) messageReader.readFrom(input);
       assertEquals(ASYNC_GET_REPLY_SERIALIZED.length, input.readerIndex());
