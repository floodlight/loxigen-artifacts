...
public class OFGroupFeaturesStatsRequestVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFGroupFeaturesStatsRequestVer15.READER, OFStatsRequestVer15.READER, OFMessageVer15.READER
        );
    }

    public OFGroupFeaturesStatsRequestVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        Object groupFeaturesStatsRequestRead = messageReader.readFrom(input);
        assertThat(groupFeaturesStatsRequestRead, CoreMatchers.instanceOf(OFGroupFeaturesStatsRequestVer15.class));
        OFGroupFeaturesStatsRequest.Builder builder = factory.buildGroupFeaturesStatsRequest();
        builder
        .setXid(0x12345678)
        .setFlags(ImmutableSet.<OFStatsRequestFlags>of(OFStatsRequestFlags.REQ_MORE))
   ...
   public void testPartialRead() throws Exception {
       ByteBuf msgBuffer = Unpooled.copiedBuffer(GROUP_FEATURES_STATS_REQUEST_SERIALIZED);
       for (int prefixLength: PREFIX_BYTES) {
           ...
           for (int partialLength = 0; partialLength < GROUP_FEATURES_STATS_REQUEST_SERIALIZED.length - 1; partialLength++) {
   ...
   public void testReadWrite() throws Exception {
       ...
       OFGroupFeaturesStatsRequest groupFeaturesStatsRequest = (OFGroupFeaturesStatsRequest) messageReader.readFrom(input);
       assertEquals(GROUP_FEATURES_STATS_REQUEST_SERIALIZED.length, input.readerIndex());
