...
public class OFHelloElemVersionbitmapVer15Test {
    ...
    public static Iterable<Object> data() {
        return ImmutableList.<Object>of(
                OFHelloElemVersionbitmapVer15.READER, OFHelloElemVer15.READER
        );
    }

    public OFHelloElemVersionbitmapVer15Test(OFMessageReader<?> messageReader) {
    ...
    public void testRead() throws Exception {
        ...
        assertThat(helloElemVersionbitmapRead, CoreMatchers.instanceOf(OFHelloElemVersionbitmapVer15.class));
        OFHelloElemVersionbitmap.Builder builder = factory.buildHelloElemVersionbitmap();
        builder.setBitmaps(ImmutableList.<U32>of(U32.of(0x01234567),U32.of(0x89abcdef))).build();
