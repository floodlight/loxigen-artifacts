...
int
of_list_queue_prop_first(of_list_queue_prop_t *list, of_queue_prop_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_queue_prop_init(_obj, list->version, -1, 1);
...
int
of_list_queue_prop_next(of_list_queue_prop_t *list, of_queue_prop_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_queue_prop_append_bind(of_list_queue_prop_t *list, of_queue_prop_t *obj)
{
...
int
of_list_queue_prop_append(of_list_queue_prop_t *list, of_queue_prop_t *obj)
{
