...
void
of_bsn_generic_command_reply_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_4:
        ...
        *(uint8_t *)(buf + 1) = 0x4; /* type */
        *(uint32_t *)(buf + 8) = U32_HTON(0x5c16c7); /* experimenter */
        *(uint32_t *)(buf + 12) = U32_HTON(0x48); /* subtype */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_bsn_generic_command_reply of_bsn_generic_command_reply
 */

/**
 * Create a new of_bsn_generic_command_reply object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_generic_command_reply_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_GENERIC_COMMAND_REPLY];

    if ((obj = of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_bsn_generic_command_reply_init(obj, version, bytes, 0);
    of_bsn_generic_command_reply_push_wire_types(obj);
    of_object_message_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_generic_command_reply.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_generic_command_reply_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_GENERIC_COMMAND_REPLY] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_GENERIC_COMMAND_REPLY;
...
/**
 * Get xid from an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param xid Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_bsn_generic_command_reply_xid_get(
    ...
    uint32_t *xid)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_GENERIC_COMMAND_REPLY);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set xid in an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param xid The value to write into the object
 */
void
of_bsn_generic_command_reply_xid_set(
    of_bsn_generic_command_reply_t *obj,
    uint32_t xid)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get experimenter from an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_bsn_generic_command_reply_experimenter_get(
    of_bsn_generic_command_reply_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set experimenter in an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param experimenter The value to write into the object
 */
void
of_bsn_generic_command_reply_experimenter_set(
    of_bsn_generic_command_reply_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param subtype Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_bsn_generic_command_reply_subtype_get(
    of_bsn_generic_command_reply_t *obj,
    uint32_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param subtype The value to write into the object
 */
void
of_bsn_generic_command_reply_subtype_set(
    of_bsn_generic_command_reply_t *obj,
    uint32_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get status from an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 ...
 */
void
of_bsn_generic_command_reply_status_get(
    of_bsn_generic_command_reply_t *obj,
    uint32_t *status)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set status in an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param status The value to write into the object
 */
void
of_bsn_generic_command_reply_status_set(
    of_bsn_generic_command_reply_t *obj,
    uint32_t status)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Bind an object of type of_list_bsn_tlv_t to the parent of type of_bsn_generic_command_reply for
 * member tlvs
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param tlvs Pointer to the child object of type
 * of_list_bsn_tlv_t to be filled out.
...
/**
 * Create a copy of tlvs into a new variable of type of_list_bsn_tlv_t from
 * a of_bsn_generic_command_reply instance.
 *
 * @param obj Pointer to the source of type of_bsn_generic_command_reply_t
 * @returns A pointer to a new instance of type of_list_bsn_tlv_t whose contents
 * match that of tlvs from source
 * @returns NULL if an error occurs
 */
of_list_bsn_tlv_t *
of_bsn_generic_command_reply_tlvs_get(of_bsn_generic_command_reply_t *obj) {
    of_list_bsn_tlv_t _tlvs;
    of_list_bsn_tlv_t *_tlvs_ptr;

    of_bsn_generic_command_reply_tlvs_bind(obj, &_tlvs);
    _tlvs_ptr = (of_list_bsn_tlv_t *)of_object_dup(&_tlvs);
    return _tlvs_ptr;
}

/**
 * Set tlvs in an object of type of_bsn_generic_command_reply.
 * @param obj Pointer to an object of type of_bsn_generic_command_reply.
 * @param tlvs Pointer to the child of type of_list_bsn_tlv_t.
 *
 * If the child's wire buffer is the same as the parent's, then
 ...
 */
int WARN_UNUSED_RESULT
of_bsn_generic_command_reply_tlvs_set(
    of_bsn_generic_command_reply_t *obj,
    of_list_bsn_tlv_t *tlvs)
{
    of_wire_buffer_t *wbuf;
    ...
    case OF_VERSION_1_4: {
        ...
        case 0x5:
            *id = OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES;
            break;
        case 0x6:
            *id = OF_PORT_DESC_PROP_BSN_SFF_JSON;
            break;
        case 0x7:
...
void
of_port_desc_prop_bsn_driver_info_json_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_4:
...
/**
 * \defgroup of_port_desc_prop_bsn_driver_info_json of_port_desc_prop_bsn_driver_info_json
 */

/**
 * Create a new of_port_desc_prop_bsn_driver_info_json object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_port_desc_prop_bsn_driver_info_json_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON];

    if ((obj = of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_port_desc_prop_bsn_driver_info_json_init(obj, version, bytes, 0);
    of_port_desc_prop_bsn_driver_info_json_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_port_desc_prop_bsn_driver_info_json.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_port_desc_prop_bsn_driver_info_json_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON;
...
/**
 * Get experimenter from an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_driver_info_json_experimenter_get(
    ...
    uint32_t *experimenter)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param experimenter The value to write into the object
 */
void
of_port_desc_prop_bsn_driver_info_json_experimenter_set(
    of_port_desc_prop_bsn_driver_info_json_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get exp_type from an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param exp_type Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_driver_info_json_exp_type_get(
    of_port_desc_prop_bsn_driver_info_json_t *obj,
    uint32_t *exp_type)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set exp_type in an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param exp_type The value to write into the object
 */
void
of_port_desc_prop_bsn_driver_info_json_exp_type_set(
    of_port_desc_prop_bsn_driver_info_json_t *obj,
    uint32_t exp_type)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get driver_info_json from an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param driver_info_json Pointer to the child object of type
 * of_octets_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_driver_info_json_driver_info_json_get(
    of_port_desc_prop_bsn_driver_info_json_t *obj,
    of_octets_t *driver_info_json)
{
    ...
    LOCI_ASSERT(cur_len >= 0 && cur_len < 64 * 1024);
    LOCI_ASSERT(cur_len + abs_offset <= WBUF_CURRENT_BYTES(wbuf));
    driver_info_json->bytes = cur_len;
    driver_info_json->data = OF_WIRE_BUFFER_INDEX(wbuf, abs_offset);
...
/**
 * Set driver_info_json in an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info_json.
 * @param driver_info_json The value to write into the object
 */
int WARN_UNUSED_RESULT
of_port_desc_prop_bsn_driver_info_json_driver_info_json_set(
    of_port_desc_prop_bsn_driver_info_json_t *obj,
    of_octets_t *driver_info_json)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(abs_offset >= 0);
    LOCI_ASSERT(cur_len >= 0 && cur_len < 64 * 1024);
    new_len = driver_info_json->bytes;
    of_wire_buffer_grow(wbuf, abs_offset + (new_len - cur_len));
    of_wire_buffer_octets_data_set(wbuf, abs_offset, driver_info_json, cur_len);
...
/**
 * Get configurability from an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param configurability Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_extended_capabilities_configurability_get(
    of_port_desc_prop_bsn_extended_capabilities_t *obj,
    uint64_t *configurability)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    int abs_offset; /* Offset of value relative to start of wbuf */
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u64_get(wbuf, abs_offset, configurability);
...
/**
 * Set configurability in an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param configurability The value to write into the object
 */
void
of_port_desc_prop_bsn_extended_capabilities_configurability_set(
    of_port_desc_prop_bsn_extended_capabilities_t *obj,
    uint64_t configurability)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u64_set(wbuf, abs_offset, configurability);
...
/**
 * Get conflict from an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param conflict Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_extended_capabilities_conflict_get(
    of_port_desc_prop_bsn_extended_capabilities_t *obj,
    uint64_t *conflict)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u64_get(wbuf, abs_offset, conflict);
...
/**
 * Set conflict in an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param conflict The value to write into the object
 */
void
of_port_desc_prop_bsn_extended_capabilities_conflict_set(
    of_port_desc_prop_bsn_extended_capabilities_t *obj,
    uint64_t conflict)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u64_set(wbuf, abs_offset, conflict);
...
/**
 * Get reserved1 from an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param reserved1 Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_extended_capabilities_reserved1_get(
    of_port_desc_prop_bsn_extended_capabilities_t *obj,
    uint64_t *reserved1)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u64_get(wbuf, abs_offset, reserved1);
...
/**
 * Set reserved1 in an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param reserved1 The value to write into the object
 */
void
of_port_desc_prop_bsn_extended_capabilities_reserved1_set(
    of_port_desc_prop_bsn_extended_capabilities_t *obj,
    uint64_t reserved1)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u64_set(wbuf, abs_offset, reserved1);
...
/**
 * Get reserved2 from an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param reserved2 Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_extended_capabilities_reserved2_get(
    of_port_desc_prop_bsn_extended_capabilities_t *obj,
    uint64_t *reserved2)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u64_get(wbuf, abs_offset, reserved2);
...
/**
 * Set reserved2 in an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_extended_capabilities.
 * @param reserved2 The value to write into the object
 */
void
of_port_desc_prop_bsn_extended_capabilities_reserved2_set(
    of_port_desc_prop_bsn_extended_capabilities_t *obj,
    uint64_t reserved2)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u64_set(wbuf, abs_offset, reserved2);
