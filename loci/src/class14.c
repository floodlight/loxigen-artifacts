...
void
of_bsn_tlv_flow_class_id_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_bsn_tlv_flow_class_id of_bsn_tlv_flow_class_id
 */

/**
 * Create a new of_bsn_tlv_flow_class_id object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_tlv_flow_class_id_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_FLOW_CLASS_ID];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_flow_class_id_init(obj, version, bytes, 0);
    of_bsn_tlv_flow_class_id_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_tlv_flow_class_id.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_tlv_flow_class_id_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_FLOW_CLASS_ID] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_FLOW_CLASS_ID;
...
/**
 * Get value from an object of type of_bsn_tlv_flow_class_id.
 * @param obj Pointer to an object of type of_bsn_tlv_flow_class_id.
 * @param value Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_bsn_tlv_flow_class_id_value_get(
    ...
    uint32_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_FLOW_CLASS_ID);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_bsn_tlv_flow_class_id.
 * @param obj Pointer to an object of type of_bsn_tlv_flow_class_id.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_flow_class_id_value_set(
    of_bsn_tlv_flow_class_id_t *obj,
    uint32_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_bsn_tlv_flow_classify_enable_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_bsn_tlv_flow_classify_enable of_bsn_tlv_flow_classify_enable
 */

/**
 * Create a new of_bsn_tlv_flow_classify_enable object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_tlv_flow_classify_enable_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_FLOW_CLASSIFY_ENABLE];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_flow_classify_enable_init(obj, version, bytes, 0);
    of_bsn_tlv_flow_classify_enable_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_tlv_flow_classify_enable.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_tlv_flow_classify_enable_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_FLOW_CLASSIFY_ENABLE] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_FLOW_CLASSIFY_ENABLE;
