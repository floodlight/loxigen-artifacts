...
int
of_list_oxm_first(of_list_oxm_t *list, of_oxm_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_oxm_init(_obj, list->version, -1, 1);
...
int
of_list_oxm_next(of_list_oxm_t *list, of_oxm_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_oxm_append_bind(of_list_oxm_t *list, of_oxm_t *obj)
{
...
int
of_list_oxm_append(of_list_oxm_t *list, of_oxm_t *obj)
{
