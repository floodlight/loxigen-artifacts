...
int
of_list_bucket_counter_first(of_list_bucket_counter_t *list, of_bucket_counter_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_bucket_counter_init(_obj, list->version, -1, 1);
...
int
of_list_bucket_counter_next(of_list_bucket_counter_t *list, of_bucket_counter_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_bucket_counter_append_bind(of_list_bucket_counter_t *list, of_bucket_counter_t *obj)
{
...
int
of_list_bucket_counter_append(of_list_bucket_counter_t *list, of_bucket_counter_t *obj)
{
