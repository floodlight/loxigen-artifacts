...
void
of_bsn_tlv_metadata_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint16_t *)(buf + 0) = U16_HTON(0xdd); /* type */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_bsn_tlv_metadata of_bsn_tlv_metadata
 */

/**
 * Create a new of_bsn_tlv_metadata object
 *
...
of_bsn_tlv_metadata_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_METADATA];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_metadata_init(obj, version, bytes, 0);
    of_bsn_tlv_metadata_push_wire_types(obj);
...
/**
 * Initialize an object of type of_bsn_tlv_metadata.
 *
...
void
of_bsn_tlv_metadata_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_METADATA] >= 0);
    if (clean_wire) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_METADATA;
...
/**
 * Get value from an object of type of_bsn_tlv_metadata.
 * @param obj Pointer to an object of type of_bsn_tlv_metadata.
 * @param value Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_bsn_tlv_metadata_value_get(
    ...
    uint16_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_METADATA);
    ver = obj->version;
...
/**
 * Set value in an object of type of_bsn_tlv_metadata.
 * @param obj Pointer to an object of type of_bsn_tlv_metadata.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_metadata_value_set(
    of_bsn_tlv_metadata_t *obj,
    uint16_t value)
{
    of_wire_buffer_t *wbuf;
