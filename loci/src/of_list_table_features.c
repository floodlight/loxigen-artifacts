...
int
of_list_table_features_first(of_list_table_features_t *list, of_table_features_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_table_features_init(_obj, list->version, -1, 1);
...
int
of_list_table_features_next(of_list_table_features_t *list, of_table_features_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_table_features_append_bind(of_list_table_features_t *list, of_table_features_t *obj)
{
...
int
of_list_table_features_append(of_list_table_features_t *list, of_table_features_t *obj)
{
