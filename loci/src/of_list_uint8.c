...
int
of_list_uint8_first(of_list_uint8_t *list, of_uint8_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_uint8_init(_obj, list->version, -1, 1);
...
int
of_list_uint8_next(of_list_uint8_t *list, of_uint8_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_uint8_append_bind(of_list_uint8_t *list, of_uint8_t *obj)
{
...
int
of_list_uint8_append(of_list_uint8_t *list, of_uint8_t *obj)
{
