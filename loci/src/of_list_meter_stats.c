...
int
of_list_meter_stats_first(of_list_meter_stats_t *list, of_meter_stats_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_meter_stats_init(_obj, list->version, -1, 1);
...
int
of_list_meter_stats_next(of_list_meter_stats_t *list, of_meter_stats_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_meter_stats_append_bind(of_list_meter_stats_t *list, of_meter_stats_t *obj)
{
...
int
of_list_meter_stats_append(of_list_meter_stats_t *list, of_meter_stats_t *obj)
{
