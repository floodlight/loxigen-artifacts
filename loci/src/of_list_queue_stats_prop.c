...
int
of_list_queue_stats_prop_first(of_list_queue_stats_prop_t *list, of_queue_stats_prop_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_queue_stats_prop_init(_obj, list->version, -1, 1);
...
int
of_list_queue_stats_prop_next(of_list_queue_stats_prop_t *list, of_queue_stats_prop_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_queue_stats_prop_append_bind(of_list_queue_stats_prop_t *list, of_queue_stats_prop_t *obj)
{
...
int
of_list_queue_stats_prop_append(of_list_queue_stats_prop_t *list, of_queue_stats_prop_t *obj)
{
...
of_list_queue_stats_prop_new(of_version_t version)
{
    ...
    if ((obj = (of_list_queue_stats_prop_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }
...
void
of_list_queue_stats_prop_init(of_list_queue_stats_prop_t *obj,
