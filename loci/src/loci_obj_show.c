...
int
of_bsn_tlv_port_key_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_bsn_tlv_port_key_t *obj)
{
    int out = 0;
    uint16_t val16;
...
int
of_bsn_tlv_port_num_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_bsn_tlv_port_num_t *obj)
{
    int out = 0;
    uint16_t val16;
...
int
of_bsn_tlv_port_priority_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_bsn_tlv_port_priority_t *obj)
{
    int out = 0;
    uint16_t val16;
...
int
of_bsn_tlv_system_mac_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_bsn_tlv_system_mac_t *obj)
{
    int out = 0;
    of_mac_addr_t mac_addr;
...
int
of_bsn_tlv_system_priority_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_bsn_tlv_system_priority_t *obj)
{
    int out = 0;
    uint16_t val16;
...
static const loci_obj_show_f show_funs_v4[OF_OBJECT_COUNT] = {
    ...
    of_bsn_tlv_port_key_OF_VERSION_1_3_show,
    of_bsn_tlv_port_num_OF_VERSION_1_3_show,
    of_bsn_tlv_port_priority_OF_VERSION_1_3_show,
    ...
    of_bsn_tlv_system_mac_OF_VERSION_1_3_show,
    of_bsn_tlv_system_priority_OF_VERSION_1_3_show,
