...
void
of_bsn_tlv_flow_identifier_push_wire_types(of_object_t *obj)
{
...
/**
 * \defgroup of_bsn_tlv_flow_identifier of_bsn_tlv_flow_identifier
 */

/**
 * Create a new of_bsn_tlv_flow_identifier object
 *
...
of_bsn_tlv_flow_identifier_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_FLOW_IDENTIFIER];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_flow_identifier_init(obj, version, bytes, 0);
    of_bsn_tlv_flow_identifier_push_wire_types(obj);
...
/**
 * Initialize an object of type of_bsn_tlv_flow_identifier.
 *
...
void
of_bsn_tlv_flow_identifier_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_FLOW_IDENTIFIER] >= 0);
    if (clean_wire) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_FLOW_IDENTIFIER;
...
/**
 * Get value from an object of type of_bsn_tlv_flow_identifier.
 * @param obj Pointer to an object of type of_bsn_tlv_flow_identifier.
 * @param value Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_bsn_tlv_flow_identifier_value_get(
    ...
    uint32_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_FLOW_IDENTIFIER);
    ver = obj->version;
...
/**
 * Set value in an object of type of_bsn_tlv_flow_identifier.
 * @param obj Pointer to an object of type of_bsn_tlv_flow_identifier.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_flow_identifier_value_set(
    of_bsn_tlv_flow_identifier_t *obj,
    uint32_t value)
{
    of_wire_buffer_t *wbuf;
