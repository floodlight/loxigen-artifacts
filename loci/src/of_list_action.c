...
int
of_list_action_first(of_list_action_t *list, of_action_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_action_init(_obj, list->version, -1, 1);
...
int
of_list_action_next(of_list_action_t *list, of_action_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_action_append_bind(of_list_action_t *list, of_action_t *obj)
{
...
int
of_list_action_append(of_list_action_t *list, of_action_t *obj)
{
