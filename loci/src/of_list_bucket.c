...
int
of_list_bucket_first(of_list_bucket_t *list, of_list_iter_t iter)
{
    int rv;
...
int
of_list_bucket_next(of_list_bucket_t *list, of_list_iter_t iter)
{
    int rv;
    of_object_t *obj = iter.obj;
...
int
of_list_bucket_append_bind(of_list_bucket_t *list, of_list_iter_t iter)
{
...
int
of_list_bucket_append(of_list_bucket_t *list, of_list_iter_t iter)
{
