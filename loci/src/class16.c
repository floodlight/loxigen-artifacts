...
void
of_bsn_tlv_multicast_packet_type_push_wire_types(of_object_t *obj)
{
...
/**
 * \defgroup of_bsn_tlv_multicast_packet_type of_bsn_tlv_multicast_packet_type
 */

/**
 * Create a new of_bsn_tlv_multicast_packet_type object
 *
 ...
 *
 * \ingroup of_bsn_tlv_multicast_packet_type
 */

of_object_t *
of_bsn_tlv_multicast_packet_type_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_BSN_TLV_MULTICAST_PACKET_TYPE];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_multicast_packet_type_init(obj, version, bytes, 0);
    of_bsn_tlv_multicast_packet_type_push_wire_types(obj);
...
/**
 * Initialize an object of type of_bsn_tlv_multicast_packet_type.
 *
...
void
of_bsn_tlv_multicast_packet_type_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_MULTICAST_PACKET_TYPE] >= 0);
    if (clean_wire) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_MULTICAST_PACKET_TYPE;
...
/**
 * Get value from an object of type of_bsn_tlv_multicast_packet_type.
 * @param obj Pointer to an object of type of_bsn_tlv_multicast_packet_type.
 * @param value Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_bsn_tlv_multicast_packet_type_value_get(
    of_bsn_tlv_multicast_packet_type_t *obj,
    uint16_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_MULTICAST_PACKET_TYPE);
    ver = obj->version;
...
/**
 * Set value in an object of type of_bsn_tlv_multicast_packet_type.
 * @param obj Pointer to an object of type of_bsn_tlv_multicast_packet_type.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_multicast_packet_type_value_set(
    of_bsn_tlv_multicast_packet_type_t *obj,
    uint16_t value)
{
    of_wire_buffer_t *wbuf;
