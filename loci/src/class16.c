...
void
of_bsn_tlv_lag_type_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint16_t *)(buf + 0) = U16_HTON(0xe3); /* type */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_bsn_tlv_lag_type of_bsn_tlv_lag_type
 */

/**
 * Create a new of_bsn_tlv_lag_type object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_tlv_lag_type_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_LAG_TYPE];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_lag_type_init(obj, version, bytes, 0);
    of_bsn_tlv_lag_type_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_tlv_lag_type.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_tlv_lag_type_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_LAG_TYPE] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_LAG_TYPE;
...
/**
 * Get value from an object of type of_bsn_tlv_lag_type.
 * @param obj Pointer to an object of type of_bsn_tlv_lag_type.
 * @param value Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_bsn_tlv_lag_type_value_get(
    ...
    uint16_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_LAG_TYPE);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_bsn_tlv_lag_type.
 * @param obj Pointer to an object of type of_bsn_tlv_lag_type.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_lag_type_value_set(
    of_bsn_tlv_lag_type_t *obj,
    uint16_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_bsn_tlv_lookup_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint16_t *)(buf + 0) = U16_HTON(0xda); /* type */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_bsn_tlv_lookup_count of_bsn_tlv_lookup_count
 */

/**
 * Create a new of_bsn_tlv_lookup_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_tlv_lookup_count_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_LOOKUP_COUNT];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_lookup_count_init(obj, version, bytes, 0);
    of_bsn_tlv_lookup_count_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_tlv_lookup_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_tlv_lookup_count_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_LOOKUP_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_LOOKUP_COUNT;
...
/**
 * Get value from an object of type of_bsn_tlv_lookup_count.
 * @param obj Pointer to an object of type of_bsn_tlv_lookup_count.
 * @param value Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
of_bsn_tlv_lookup_count_value_get(
    ...
    uint64_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_LOOKUP_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_bsn_tlv_lookup_count.
 * @param obj Pointer to an object of type of_bsn_tlv_lookup_count.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_lookup_count_value_set(
    of_bsn_tlv_lookup_count_t *obj,
    uint64_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_bsn_tlv_matched_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint16_t *)(buf + 0) = U16_HTON(0xd9); /* type */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_bsn_tlv_matched_count of_bsn_tlv_matched_count
 */

/**
 * Create a new of_bsn_tlv_matched_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_tlv_matched_count_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_MATCHED_COUNT];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_matched_count_init(obj, version, bytes, 0);
    of_bsn_tlv_matched_count_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_tlv_matched_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_tlv_matched_count_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_MATCHED_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_MATCHED_COUNT;
...
/**
 * Get value from an object of type of_bsn_tlv_matched_count.
 * @param obj Pointer to an object of type of_bsn_tlv_matched_count.
 * @param value Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
of_bsn_tlv_matched_count_value_get(
    ...
    uint64_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_MATCHED_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_bsn_tlv_matched_count.
 * @param obj Pointer to an object of type of_bsn_tlv_matched_count.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_matched_count_value_set(
    of_bsn_tlv_matched_count_t *obj,
    uint64_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_bsn_tlv_max_multicast_replication_groups_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint16_t *)(buf + 0) = U16_HTON(0xe5); /* type */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_bsn_tlv_max_multicast_replication_groups of_bsn_tlv_max_multicast_replication_groups
 */

/**
 * Create a new of_bsn_tlv_max_multicast_replication_groups object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_tlv_max_multicast_replication_groups_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_MAX_MULTICAST_REPLICATION_GROUPS];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_max_multicast_replication_groups_init(obj, version, bytes, 0);
    of_bsn_tlv_max_multicast_replication_groups_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_tlv_max_multicast_replication_groups.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_tlv_max_multicast_replication_groups_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_MAX_MULTICAST_REPLICATION_GROUPS] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_MAX_MULTICAST_REPLICATION_GROUPS;
...
/**
 * Get value from an object of type of_bsn_tlv_max_multicast_replication_groups.
 * @param obj Pointer to an object of type of_bsn_tlv_max_multicast_replication_groups.
 * @param value Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_bsn_tlv_max_multicast_replication_groups_value_get(
    ...
    uint32_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_MAX_MULTICAST_REPLICATION_GROUPS);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_bsn_tlv_max_multicast_replication_groups.
 * @param obj Pointer to an object of type of_bsn_tlv_max_multicast_replication_groups.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_max_multicast_replication_groups_value_set(
    of_bsn_tlv_max_multicast_replication_groups_t *obj,
    uint32_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_bsn_tlv_max_multicast_replications_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint16_t *)(buf + 0) = U16_HTON(0xe6); /* type */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_bsn_tlv_max_multicast_replications of_bsn_tlv_max_multicast_replications
 */

/**
 * Create a new of_bsn_tlv_max_multicast_replications object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_tlv_max_multicast_replications_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_MAX_MULTICAST_REPLICATIONS];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_max_multicast_replications_init(obj, version, bytes, 0);
    of_bsn_tlv_max_multicast_replications_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_tlv_max_multicast_replications.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_tlv_max_multicast_replications_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_MAX_MULTICAST_REPLICATIONS] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_MAX_MULTICAST_REPLICATIONS;
...
/**
 * Get value from an object of type of_bsn_tlv_max_multicast_replications.
 * @param obj Pointer to an object of type of_bsn_tlv_max_multicast_replications.
 * @param value Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_bsn_tlv_max_multicast_replications_value_get(
    ...
    uint32_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_MAX_MULTICAST_REPLICATIONS);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_bsn_tlv_max_multicast_replications.
 * @param obj Pointer to an object of type of_bsn_tlv_max_multicast_replications.
 * @param value The value to write into the object
 */
void
of_bsn_tlv_max_multicast_replications_value_set(
    of_bsn_tlv_max_multicast_replications_t *obj,
    uint32_t value)
{
    of_wire_buffer_t *wbuf;
