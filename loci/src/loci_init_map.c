...
const of_object_init_f of_object_init_map[] = {
    ...
    (of_object_init_f)of_bsn_tlv_port_key_init,
    (of_object_init_f)of_bsn_tlv_port_num_init,
    (of_object_init_f)of_bsn_tlv_port_priority_init,
    ...
    (of_object_init_f)of_bsn_tlv_system_mac_init,
    (of_object_init_f)of_bsn_tlv_system_priority_init,
