...
const of_object_init_f of_object_init_map[] = {
    ...
    (of_object_init_f)of_oxm_tunnel_ipv6_dst_init,
    (of_object_init_f)of_oxm_tunnel_ipv6_dst_masked_init,
    (of_object_init_f)of_oxm_tunnel_ipv6_src_init,
    (of_object_init_f)of_oxm_tunnel_ipv6_src_masked_init,
