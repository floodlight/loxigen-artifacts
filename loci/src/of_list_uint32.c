...
int
of_list_uint32_first(of_list_uint32_t *list, of_uint32_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_uint32_init(_obj, list->version, -1, 1);
...
int
of_list_uint32_next(of_list_uint32_t *list, of_uint32_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_uint32_append_bind(of_list_uint32_t *list, of_uint32_t *obj)
{
...
int
of_list_uint32_append(of_list_uint32_t *list, of_uint32_t *obj)
{
