    ...
    case OF_VERSION_1_4: {
        ...
        case 0x6:
            *id = OF_PORT_DESC_PROP_BSN_SFF_JSON;
            break;
        case 0x7:
            *id = OF_PORT_DESC_PROP_BSN_DRIVER_INFO;
            break;
        case 0x8:
            *id = OF_PORT_DESC_PROP_BSN_FIRMWARE_INFO;
            break;
        default:
...
void
of_port_desc_prop_bsn_driver_info_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_4:
...
/**
 * \defgroup of_port_desc_prop_bsn_driver_info of_port_desc_prop_bsn_driver_info
 */

/**
 * Create a new of_port_desc_prop_bsn_driver_info object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_port_desc_prop_bsn_driver_info_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_PORT_DESC_PROP_BSN_DRIVER_INFO];

    if ((obj = of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_port_desc_prop_bsn_driver_info_init(obj, version, bytes, 0);
    of_port_desc_prop_bsn_driver_info_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_port_desc_prop_bsn_driver_info.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_port_desc_prop_bsn_driver_info_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_PORT_DESC_PROP_BSN_DRIVER_INFO] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_PORT_DESC_PROP_BSN_DRIVER_INFO;
...
/**
 * Get experimenter from an object of type of_port_desc_prop_bsn_driver_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_driver_info_experimenter_get(
    ...
    uint32_t *experimenter)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_PORT_DESC_PROP_BSN_DRIVER_INFO);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_port_desc_prop_bsn_driver_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info.
 * @param experimenter The value to write into the object
 */
void
of_port_desc_prop_bsn_driver_info_experimenter_set(
    of_port_desc_prop_bsn_driver_info_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get exp_type from an object of type of_port_desc_prop_bsn_driver_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info.
 * @param exp_type Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_driver_info_exp_type_get(
    of_port_desc_prop_bsn_driver_info_t *obj,
    uint32_t *exp_type)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set exp_type in an object of type of_port_desc_prop_bsn_driver_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info.
 * @param exp_type The value to write into the object
 */
void
of_port_desc_prop_bsn_driver_info_exp_type_set(
    of_port_desc_prop_bsn_driver_info_t *obj,
    uint32_t exp_type)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get driver from an object of type of_port_desc_prop_bsn_driver_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info.
 * @param driver Pointer to the child object of type
 * of_octets_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_driver_info_driver_get(
    of_port_desc_prop_bsn_driver_info_t *obj,
    of_octets_t *driver)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(cur_len >= 0 && cur_len < 64 * 1024);
    LOCI_ASSERT(cur_len + abs_offset <= WBUF_CURRENT_BYTES(wbuf));
    driver->bytes = cur_len;
    driver->data = OF_WIRE_BUFFER_INDEX(wbuf, abs_offset);
...
/**
 * Set driver in an object of type of_port_desc_prop_bsn_driver_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_driver_info.
 * @param driver The value to write into the object
 */
int WARN_UNUSED_RESULT
of_port_desc_prop_bsn_driver_info_driver_set(
    of_port_desc_prop_bsn_driver_info_t *obj,
    of_octets_t *driver)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(abs_offset >= 0);
    LOCI_ASSERT(cur_len >= 0 && cur_len < 64 * 1024);
    new_len = driver->bytes;
    of_wire_buffer_grow(wbuf, abs_offset + (new_len - cur_len));
    of_wire_buffer_octets_data_set(wbuf, abs_offset, driver, cur_len);
...
void
of_port_desc_prop_bsn_firmware_info_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_4:
...
/**
 * \defgroup of_port_desc_prop_bsn_firmware_info of_port_desc_prop_bsn_firmware_info
 */

/**
 * Create a new of_port_desc_prop_bsn_firmware_info object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_port_desc_prop_bsn_firmware_info_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_PORT_DESC_PROP_BSN_FIRMWARE_INFO];

    if ((obj = of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_port_desc_prop_bsn_firmware_info_init(obj, version, bytes, 0);
    of_port_desc_prop_bsn_firmware_info_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_port_desc_prop_bsn_firmware_info.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_port_desc_prop_bsn_firmware_info_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_PORT_DESC_PROP_BSN_FIRMWARE_INFO] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_PORT_DESC_PROP_BSN_FIRMWARE_INFO;
...
/**
 * Get experimenter from an object of type of_port_desc_prop_bsn_firmware_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_firmware_info.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_firmware_info_experimenter_get(
    ...
    uint32_t *experimenter)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_PORT_DESC_PROP_BSN_FIRMWARE_INFO);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_port_desc_prop_bsn_firmware_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_firmware_info.
 * @param experimenter The value to write into the object
 */
void
of_port_desc_prop_bsn_firmware_info_experimenter_set(
    of_port_desc_prop_bsn_firmware_info_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get exp_type from an object of type of_port_desc_prop_bsn_firmware_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_firmware_info.
 * @param exp_type Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_firmware_info_exp_type_get(
    of_port_desc_prop_bsn_firmware_info_t *obj,
    uint32_t *exp_type)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set exp_type in an object of type of_port_desc_prop_bsn_firmware_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_firmware_info.
 * @param exp_type The value to write into the object
 */
void
of_port_desc_prop_bsn_firmware_info_exp_type_set(
    of_port_desc_prop_bsn_firmware_info_t *obj,
    uint32_t exp_type)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get firmware from an object of type of_port_desc_prop_bsn_firmware_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_firmware_info.
 * @param firmware Pointer to the child object of type
 * of_octets_t to be filled out.
 *
 */
void
of_port_desc_prop_bsn_firmware_info_firmware_get(
    of_port_desc_prop_bsn_firmware_info_t *obj,
    of_octets_t *firmware)
{
    ...
    LOCI_ASSERT(cur_len >= 0 && cur_len < 64 * 1024);
    LOCI_ASSERT(cur_len + abs_offset <= WBUF_CURRENT_BYTES(wbuf));
    firmware->bytes = cur_len;
    firmware->data = OF_WIRE_BUFFER_INDEX(wbuf, abs_offset);
...
/**
 * Set firmware in an object of type of_port_desc_prop_bsn_firmware_info.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_firmware_info.
 * @param firmware The value to write into the object
 */
int WARN_UNUSED_RESULT
of_port_desc_prop_bsn_firmware_info_firmware_set(
    of_port_desc_prop_bsn_firmware_info_t *obj,
    of_octets_t *firmware)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(abs_offset >= 0);
    LOCI_ASSERT(cur_len >= 0 && cur_len < 64 * 1024);
    new_len = firmware->bytes;
    of_wire_buffer_grow(wbuf, abs_offset + (new_len - cur_len));
    of_wire_buffer_octets_data_set(wbuf, abs_offset, firmware, cur_len);
