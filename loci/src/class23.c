...
/**
 * Get data_json from an object of type of_port_desc_prop_bsn_ethtool.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_ethtool.
 ...
 */
void
of_port_desc_prop_bsn_ethtool_data_json_get(
    of_port_desc_prop_bsn_ethtool_t *obj,
...
/**
 * Set data_json in an object of type of_port_desc_prop_bsn_ethtool.
 * @param obj Pointer to an object of type of_port_desc_prop_bsn_ethtool.
 * @param data_json The value to write into the object
 */
int WARN_UNUSED_RESULT
of_port_desc_prop_bsn_ethtool_data_json_set(
    of_port_desc_prop_bsn_ethtool_t *obj,
    of_octets_t *data_json)
{
    of_wire_buffer_t *wbuf;
