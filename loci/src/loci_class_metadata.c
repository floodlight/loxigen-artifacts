...
struct loci_class_metadata loci_class_metadata[OF_OBJECT_COUNT] = {
    ...
    [OF_BSN_TLV_PORT_KEY] = {
        ...
        .wire_length_set=of_tlv16_wire_length_set,
        .wire_type_get=of_bsn_tlv_wire_object_id_get,
        .wire_type_set=of_bsn_tlv_port_key_push_wire_types,
    },
    [OF_BSN_TLV_PORT_NUM] = {
        .wire_length_get=of_tlv16_wire_length_get,
        .wire_length_set=of_tlv16_wire_length_set,
        .wire_type_get=of_bsn_tlv_wire_object_id_get,
        .wire_type_set=of_bsn_tlv_port_num_push_wire_types,
    },
    [OF_BSN_TLV_PORT_PRIORITY] = {
        .wire_length_get=of_tlv16_wire_length_get,
        .wire_length_set=of_tlv16_wire_length_set,
        .wire_type_get=of_bsn_tlv_wire_object_id_get,
        .wire_type_set=of_bsn_tlv_port_priority_push_wire_types,
    },
    [OF_BSN_TLV_QUEUE_ID] = {
        .wire_length_get=of_tlv16_wire_length_get,
        .wire_length_set=of_tlv16_wire_length_set,
    ...
    [OF_BSN_TLV_SYSTEM_MAC] = {
        .wire_length_get=of_tlv16_wire_length_get,
        .wire_length_set=of_tlv16_wire_length_set,
        .wire_type_get=of_bsn_tlv_wire_object_id_get,
        .wire_type_set=of_bsn_tlv_system_mac_push_wire_types,
    },
    [OF_BSN_TLV_SYSTEM_PRIORITY] = {
        .wire_length_get=of_tlv16_wire_length_get,
        .wire_length_set=of_tlv16_wire_length_set,
        .wire_type_get=of_bsn_tlv_wire_object_id_get,
        .wire_type_set=of_bsn_tlv_system_priority_push_wire_types,
    },
    [OF_BSN_TLV_TX_BYTES] = {
        .wire_length_get=of_tlv16_wire_length_get,
        .wire_length_set=of_tlv16_wire_length_set,
    ...
    [OF_TABLE_FEATURE_PROP_EXPERIMENTER] = {
        ...
        .wire_length_set=of_tlv16_wire_length_set,
        .wire_type_get=of_table_feature_prop_wire_object_id_get,
        .wire_type_set=of_table_feature_prop_experimenter_push_wire_types,
    },
    [OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS] = {
        .wire_length_get=of_tlv16_wire_length_get,
        .wire_length_set=of_tlv16_wire_length_set,
        .wire_type_get=of_table_feature_prop_wire_object_id_get,
        .wire_type_set=of_table_feature_prop_experimenter_miss_push_wire_types,
    },
