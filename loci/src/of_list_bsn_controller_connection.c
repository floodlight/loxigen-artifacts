...
int
of_list_bsn_controller_connection_first(of_list_bsn_controller_connection_t *list, of_bsn_controller_connection_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_bsn_controller_connection_init(_obj, list->version, -1, 1);
...
int
of_list_bsn_controller_connection_next(of_list_bsn_controller_connection_t *list, of_bsn_controller_connection_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_bsn_controller_connection_append_bind(of_list_bsn_controller_connection_t *list, of_bsn_controller_connection_t *obj)
{
...
int
of_list_bsn_controller_connection_append(of_list_bsn_controller_connection_t *list, of_bsn_controller_connection_t *obj)
{
