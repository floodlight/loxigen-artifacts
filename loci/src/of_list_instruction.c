...
int
of_list_instruction_first(of_list_instruction_t *list, of_instruction_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_instruction_init(_obj, list->version, -1, 1);
...
int
of_list_instruction_next(of_list_instruction_t *list, of_instruction_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_instruction_append_bind(of_list_instruction_t *list, of_instruction_t *obj)
{
...
int
of_list_instruction_append(of_list_instruction_t *list, of_instruction_t *obj)
{
