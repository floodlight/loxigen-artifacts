...
of_object_fixed_len_v1[OF_OBJECT_COUNT] = {
    ...
    16,   /* 25: of_bsn_get_interfaces_reply */
    16,   /* 26: of_bsn_get_interfaces_request */
    24,   /* 27: of_bsn_get_ip_mask_reply */
    24,   /* 28: of_bsn_get_ip_mask_request */
    24,   /* 29: of_bsn_get_l2_table_reply */
    16,   /* 30: of_bsn_get_l2_table_request */
    20,   /* 31: of_bsn_get_mirroring_reply */
    20,   /* 32: of_bsn_get_mirroring_request */
    -1,   /* 33: of_bsn_get_switch_pipeline_reply */
    -1,   /* 34: of_bsn_get_switch_pipeline_request */
    16,   /* 35: of_bsn_header */
    24,   /* 36: of_bsn_hybrid_get_reply */
    16,   /* 37: of_bsn_hybrid_get_request */
    -1,   /* 38: of_bsn_lacp_convergence_notif */
    -1,   /* 39: of_bsn_lacp_stats_reply */
    -1,   /* 40: of_bsn_lacp_stats_request */
    23,   /* 41: of_bsn_pdu_rx_reply */
    26,   /* 42: of_bsn_pdu_rx_request */
    19,   /* 43: of_bsn_pdu_rx_timeout */
    23,   /* 44: of_bsn_pdu_tx_reply */
    26,   /* 45: of_bsn_pdu_tx_request */
    -1,   /* 46: of_bsn_port_counter_stats_reply */
    -1,   /* 47: of_bsn_port_counter_stats_request */
    -1,   /* 48: of_bsn_role_status */
    24,   /* 49: of_bsn_set_ip_mask */
    24,   /* 50: of_bsn_set_l2_table_reply */
    24,   /* 51: of_bsn_set_l2_table_request */
    -1,   /* 52: of_bsn_set_lacp_reply */
    -1,   /* 53: of_bsn_set_lacp_request */
    20,   /* 54: of_bsn_set_mirroring */
    20,   /* 55: of_bsn_set_pktin_suppression_reply */
    32,   /* 56: of_bsn_set_pktin_suppression_request */
    -1,   /* 57: of_bsn_set_switch_pipeline_reply */
    -1,   /* 58: of_bsn_set_switch_pipeline_request */
    20,   /* 59: of_bsn_shell_command */
    16,   /* 60: of_bsn_shell_output */
    20,   /* 61: of_bsn_shell_status */
    24,   /* 62: of_bsn_stats_reply */
    24,   /* 63: of_bsn_stats_request */
    -1,   /* 64: of_bsn_switch_pipeline_stats_reply */
    -1,   /* 65: of_bsn_switch_pipeline_stats_request */
    -1,   /* 66: of_bsn_time_reply */
    -1,   /* 67: of_bsn_time_request */
    24,   /* 68: of_bsn_virtual_port_create_reply */
    48,   /* 69: of_bsn_virtual_port_create_request */
    20,   /* 70: of_bsn_virtual_port_remove_reply */
    20,   /* 71: of_bsn_virtual_port_remove_request */
    -1,   /* 72: of_bsn_vlan_counter_stats_reply */
    -1,   /* 73: of_bsn_vlan_counter_stats_request */
    1068, /* 74: of_desc_stats_reply */
    12,   /* 75: of_desc_stats_request */
    8,    /* 76: of_echo_reply */
    8,    /* 77: of_echo_request */
    10,   /* 78: of_error_msg */
    16,   /* 79: of_experimenter */
    -1,   /* 80: of_experimenter_error_msg */
    16,   /* 81: of_experimenter_stats_reply */
    16,   /* 82: of_experimenter_stats_request */
    32,   /* 83: of_features_reply */
    8,    /* 84: of_features_request */
    72,   /* 85: of_flow_add */
    72,   /* 86: of_flow_delete */
    72,   /* 87: of_flow_delete_strict */
    72,   /* 88: of_flow_mod */
    12,   /* 89: of_flow_mod_failed_error_msg */
    72,   /* 90: of_flow_modify */
    72,   /* 91: of_flow_modify_strict */
    88,   /* 92: of_flow_removed */
    12,   /* 93: of_flow_stats_reply */
    56,   /* 94: of_flow_stats_request */
    12,   /* 95: of_get_config_reply */
    8,    /* 96: of_get_config_request */
    -1,   /* 97: of_group_add */
    -1,   /* 98: of_group_delete */
    -1,   /* 99: of_group_desc_stats_reply */
    -1,   /* 100: of_group_desc_stats_request */
    -1,   /* 101: of_group_features_stats_reply */
    -1,   /* 102: of_group_features_stats_request */
    -1,   /* 103: of_group_mod */
    -1,   /* 104: of_group_mod_failed_error_msg */
    -1,   /* 105: of_group_modify */
    -1,   /* 106: of_group_stats_reply */
    -1,   /* 107: of_group_stats_request */
    8,    /* 108: of_hello */
    12,   /* 109: of_hello_failed_error_msg */
    -1,   /* 110: of_meter_config_stats_reply */
    -1,   /* 111: of_meter_config_stats_request */
    -1,   /* 112: of_meter_features_stats_reply */
    -1,   /* 113: of_meter_features_stats_request */
    -1,   /* 114: of_meter_mod */
    -1,   /* 115: of_meter_mod_failed_error_msg */
    -1,   /* 116: of_meter_stats_reply */
    -1,   /* 117: of_meter_stats_request */
    20,   /* 118: of_nicira_controller_role_reply */
    20,   /* 119: of_nicira_controller_role_request */
    16,   /* 120: of_nicira_header */
    18,   /* 121: of_packet_in */
    16,   /* 122: of_packet_out */
    -1,   /* 123: of_port_desc_stats_reply */
    -1,   /* 124: of_port_desc_stats_request */
    32,   /* 125: of_port_mod */
    12,   /* 126: of_port_mod_failed_error_msg */
    12,   /* 127: of_port_stats_reply */
    20,   /* 128: of_port_stats_request */
    64,   /* 129: of_port_status */
    16,   /* 130: of_queue_get_config_reply */
    12,   /* 131: of_queue_get_config_request */
    12,   /* 132: of_queue_op_failed_error_msg */
    12,   /* 133: of_queue_stats_reply */
    20,   /* 134: of_queue_stats_request */
    -1,   /* 135: of_role_reply */
    -1,   /* 136: of_role_request */
    -1,   /* 137: of_role_request_failed_error_msg */
    12,   /* 138: of_set_config */
    12,   /* 139: of_stats_reply */
    12,   /* 140: of_stats_request */
    -1,   /* 141: of_switch_config_failed_error_msg */
    -1,   /* 142: of_table_features_failed_error_msg */
    -1,   /* 143: of_table_features_stats_reply */
    -1,   /* 144: of_table_features_stats_request */
    16,   /* 145: of_table_mod */
    -1,   /* 146: of_table_mod_failed_error_msg */
    12,   /* 147: of_table_stats_reply */
    12,   /* 148: of_table_stats_request */
    8,    /* 149: of_action */
    16,   /* 150: of_action_bsn */
    24,   /* 151: of_action_bsn_mirror */
    16,   /* 152: of_action_bsn_set_tunnel_dst */
    -1,   /* 153: of_action_copy_ttl_in */
    -1,   /* 154: of_action_copy_ttl_out */
    -1,   /* 155: of_action_dec_mpls_ttl */
    -1,   /* 156: of_action_dec_nw_ttl */
    16,   /* 157: of_action_enqueue */
    8,    /* 158: of_action_experimenter */
    -1,   /* 159: of_action_group */
    8,    /* 160: of_action_header */
    -1,   /* 161: of_action_id */
    -1,   /* 162: of_action_id_bsn */
    -1,   /* 163: of_action_id_bsn_mirror */
    -1,   /* 164: of_action_id_bsn_set_tunnel_dst */
    -1,   /* 165: of_action_id_copy_ttl_in */
    -1,   /* 166: of_action_id_copy_ttl_out */
    -1,   /* 167: of_action_id_dec_mpls_ttl */
    -1,   /* 168: of_action_id_dec_nw_ttl */
    -1,   /* 169: of_action_id_experimenter */
    -1,   /* 170: of_action_id_group */
    -1,   /* 171: of_action_id_header */
    -1,   /* 172: of_action_id_nicira */
    -1,   /* 173: of_action_id_nicira_dec_ttl */
    -1,   /* 174: of_action_id_output */
    -1,   /* 175: of_action_id_pop_mpls */
    -1,   /* 176: of_action_id_pop_pbb */
    -1,   /* 177: of_action_id_pop_vlan */
    -1,   /* 178: of_action_id_push_mpls */
    -1,   /* 179: of_action_id_push_pbb */
    -1,   /* 180: of_action_id_push_vlan */
    -1,   /* 181: of_action_id_set_field */
    -1,   /* 182: of_action_id_set_mpls_ttl */
    -1,   /* 183: of_action_id_set_nw_ttl */
    -1,   /* 184: of_action_id_set_queue */
    16,   /* 185: of_action_nicira */
    16,   /* 186: of_action_nicira_dec_ttl */
    8,    /* 187: of_action_output */
    -1,   /* 188: of_action_pop_mpls */
    -1,   /* 189: of_action_pop_pbb */
    -1,   /* 190: of_action_pop_vlan */
    -1,   /* 191: of_action_push_mpls */
    -1,   /* 192: of_action_push_pbb */
    -1,   /* 193: of_action_push_vlan */
    16,   /* 194: of_action_set_dl_dst */
    16,   /* 195: of_action_set_dl_src */
    -1,   /* 196: of_action_set_field */
    -1,   /* 197: of_action_set_mpls_label */
    -1,   /* 198: of_action_set_mpls_tc */
    -1,   /* 199: of_action_set_mpls_ttl */
    8,    /* 200: of_action_set_nw_dst */
    -1,   /* 201: of_action_set_nw_ecn */
    8,    /* 202: of_action_set_nw_src */
    8,    /* 203: of_action_set_nw_tos */
    -1,   /* 204: of_action_set_nw_ttl */
    -1,   /* 205: of_action_set_queue */
    8,    /* 206: of_action_set_tp_dst */
    8,    /* 207: of_action_set_tp_src */
    8,    /* 208: of_action_set_vlan_pcp */
    8,    /* 209: of_action_set_vlan_vid */
    8,    /* 210: of_action_strip_vlan */
    -1,   /* 211: of_bsn_controller_connection */
    32,   /* 212: of_bsn_interface */
    -1,   /* 213: of_bsn_lacp_stats_entry */
    -1,   /* 214: of_bsn_port_counter_stats_entry */
    -1,   /* 215: of_bsn_switch_pipeline_stats_entry */
    -1,   /* 216: of_bsn_vlan_counter_stats_entry */
    4,    /* 217: of_bsn_vport */
    4,    /* 218: of_bsn_vport_header */
    32,   /* 219: of_bsn_vport_q_in_q */
    -1,   /* 220: of_bucket */
    -1,   /* 221: of_bucket_counter */
    -1,   /* 222: of_experimenter_stats_header */
    88,   /* 223: of_flow_stats_entry */
    -1,   /* 224: of_group_desc_stats_entry */
    -1,   /* 225: of_group_stats_entry */
    8,    /* 226: of_header */
    -1,   /* 227: of_hello_elem */
    -1,   /* 228: of_hello_elem_header */
    -1,   /* 229: of_hello_elem_versionbitmap */
    -1,   /* 230: of_instruction */
    -1,   /* 231: of_instruction_apply_actions */
    -1,   /* 232: of_instruction_bsn */
    -1,   /* 233: of_instruction_bsn_disable_src_mac_check */
    -1,   /* 234: of_instruction_clear_actions */
    -1,   /* 235: of_instruction_experimenter */
    -1,   /* 236: of_instruction_goto_table */
    -1,   /* 237: of_instruction_header */
    -1,   /* 238: of_instruction_id */
    -1,   /* 239: of_instruction_id_apply_actions */
    -1,   /* 240: of_instruction_id_bsn */
    -1,   /* 241: of_instruction_id_bsn_disable_src_mac_check */
    -1,   /* 242: of_instruction_id_clear_actions */
    -1,   /* 243: of_instruction_id_experimenter */
    -1,   /* 244: of_instruction_id_goto_table */
    -1,   /* 245: of_instruction_id_header */
    -1,   /* 246: of_instruction_id_meter */
    -1,   /* 247: of_instruction_id_write_actions */
    -1,   /* 248: of_instruction_id_write_metadata */
    -1,   /* 249: of_instruction_meter */
    -1,   /* 250: of_instruction_write_actions */
    -1,   /* 251: of_instruction_write_metadata */
    40,   /* 252: of_match_v1 */
    -1,   /* 253: of_match_v2 */
    -1,   /* 254: of_match_v3 */
    -1,   /* 255: of_meter_band */
    -1,   /* 256: of_meter_band_drop */
    -1,   /* 257: of_meter_band_dscp_remark */
    -1,   /* 258: of_meter_band_experimenter */
    -1,   /* 259: of_meter_band_header */
    -1,   /* 260: of_meter_band_stats */
    -1,   /* 261: of_meter_config */
    -1,   /* 262: of_meter_features */
    -1,   /* 263: of_meter_stats */
    -1,   /* 264: of_oxm */
    -1,   /* 265: of_oxm_arp_op */
    -1,   /* 266: of_oxm_arp_op_masked */
    -1,   /* 267: of_oxm_arp_sha */
    -1,   /* 268: of_oxm_arp_sha_masked */
    -1,   /* 269: of_oxm_arp_spa */
    -1,   /* 270: of_oxm_arp_spa_masked */
    -1,   /* 271: of_oxm_arp_tha */
    -1,   /* 272: of_oxm_arp_tha_masked */
    -1,   /* 273: of_oxm_arp_tpa */
    -1,   /* 274: of_oxm_arp_tpa_masked */
    -1,   /* 275: of_oxm_bsn_global_vrf_allowed */
    -1,   /* 276: of_oxm_bsn_global_vrf_allowed_masked */
    -1,   /* 277: of_oxm_bsn_in_ports_128 */
    -1,   /* 278: of_oxm_bsn_in_ports_128_masked */
    -1,   /* 279: of_oxm_bsn_l3_dst_class_id */
    -1,   /* 280: of_oxm_bsn_l3_dst_class_id_masked */
    -1,   /* 281: of_oxm_bsn_l3_interface_class_id */
    -1,   /* 282: of_oxm_bsn_l3_interface_class_id_masked */
    -1,   /* 283: of_oxm_bsn_l3_src_class_id */
    -1,   /* 284: of_oxm_bsn_l3_src_class_id_masked */
    -1,   /* 285: of_oxm_bsn_lag_id */
    -1,   /* 286: of_oxm_bsn_lag_id_masked */
    -1,   /* 287: of_oxm_bsn_vrf */
    -1,   /* 288: of_oxm_bsn_vrf_masked */
    -1,   /* 289: of_oxm_eth_dst */
    -1,   /* 290: of_oxm_eth_dst_masked */
    -1,   /* 291: of_oxm_eth_src */
    -1,   /* 292: of_oxm_eth_src_masked */
    -1,   /* 293: of_oxm_eth_type */
    -1,   /* 294: of_oxm_eth_type_masked */
    -1,   /* 295: of_oxm_header */
    -1,   /* 296: of_oxm_icmpv4_code */
    -1,   /* 297: of_oxm_icmpv4_code_masked */
    -1,   /* 298: of_oxm_icmpv4_type */
    -1,   /* 299: of_oxm_icmpv4_type_masked */
    -1,   /* 300: of_oxm_icmpv6_code */
    -1,   /* 301: of_oxm_icmpv6_code_masked */
    -1,   /* 302: of_oxm_icmpv6_type */
    -1,   /* 303: of_oxm_icmpv6_type_masked */
    -1,   /* 304: of_oxm_in_phy_port */
    -1,   /* 305: of_oxm_in_phy_port_masked */
    -1,   /* 306: of_oxm_in_port */
    -1,   /* 307: of_oxm_in_port_masked */
    -1,   /* 308: of_oxm_ip_dscp */
    -1,   /* 309: of_oxm_ip_dscp_masked */
    -1,   /* 310: of_oxm_ip_ecn */
    -1,   /* 311: of_oxm_ip_ecn_masked */
    -1,   /* 312: of_oxm_ip_proto */
    -1,   /* 313: of_oxm_ip_proto_masked */
    -1,   /* 314: of_oxm_ipv4_dst */
    -1,   /* 315: of_oxm_ipv4_dst_masked */
    -1,   /* 316: of_oxm_ipv4_src */
    -1,   /* 317: of_oxm_ipv4_src_masked */
    -1,   /* 318: of_oxm_ipv6_dst */
    -1,   /* 319: of_oxm_ipv6_dst_masked */
    -1,   /* 320: of_oxm_ipv6_flabel */
    -1,   /* 321: of_oxm_ipv6_flabel_masked */
    -1,   /* 322: of_oxm_ipv6_nd_sll */
    -1,   /* 323: of_oxm_ipv6_nd_sll_masked */
    -1,   /* 324: of_oxm_ipv6_nd_target */
    -1,   /* 325: of_oxm_ipv6_nd_target_masked */
    -1,   /* 326: of_oxm_ipv6_nd_tll */
    -1,   /* 327: of_oxm_ipv6_nd_tll_masked */
    -1,   /* 328: of_oxm_ipv6_src */
    -1,   /* 329: of_oxm_ipv6_src_masked */
    -1,   /* 330: of_oxm_metadata */
    -1,   /* 331: of_oxm_metadata_masked */
    -1,   /* 332: of_oxm_mpls_label */
    -1,   /* 333: of_oxm_mpls_label_masked */
    -1,   /* 334: of_oxm_mpls_tc */
    -1,   /* 335: of_oxm_mpls_tc_masked */
    -1,   /* 336: of_oxm_sctp_dst */
    -1,   /* 337: of_oxm_sctp_dst_masked */
    -1,   /* 338: of_oxm_sctp_src */
    -1,   /* 339: of_oxm_sctp_src_masked */
    -1,   /* 340: of_oxm_tcp_dst */
    -1,   /* 341: of_oxm_tcp_dst_masked */
    -1,   /* 342: of_oxm_tcp_src */
    -1,   /* 343: of_oxm_tcp_src_masked */
    -1,   /* 344: of_oxm_udp_dst */
    -1,   /* 345: of_oxm_udp_dst_masked */
    -1,   /* 346: of_oxm_udp_src */
    -1,   /* 347: of_oxm_udp_src_masked */
    -1,   /* 348: of_oxm_vlan_pcp */
    -1,   /* 349: of_oxm_vlan_pcp_masked */
    -1,   /* 350: of_oxm_vlan_vid */
    -1,   /* 351: of_oxm_vlan_vid_masked */
    8,    /* 352: of_packet_queue */
    48,   /* 353: of_port_desc */
    104,  /* 354: of_port_stats_entry */
    8,    /* 355: of_queue_prop */
    -1,   /* 356: of_queue_prop_experimenter */
    8,    /* 357: of_queue_prop_header */
    -1,   /* 358: of_queue_prop_max_rate */
    16,   /* 359: of_queue_prop_min_rate */
    32,   /* 360: of_queue_stats_entry */
    -1,   /* 361: of_table_feature_prop */
    -1,   /* 362: of_table_feature_prop_apply_actions */
    -1,   /* 363: of_table_feature_prop_apply_actions_miss */
    -1,   /* 364: of_table_feature_prop_apply_setfield */
    -1,   /* 365: of_table_feature_prop_apply_setfield_miss */
    -1,   /* 366: of_table_feature_prop_experimenter */
    -1,   /* 367: of_table_feature_prop_header */
    -1,   /* 368: of_table_feature_prop_instructions */
    -1,   /* 369: of_table_feature_prop_instructions_miss */
    -1,   /* 370: of_table_feature_prop_match */
    -1,   /* 371: of_table_feature_prop_next_tables */
    -1,   /* 372: of_table_feature_prop_next_tables_miss */
    -1,   /* 373: of_table_feature_prop_wildcards */
    -1,   /* 374: of_table_feature_prop_write_actions */
    -1,   /* 375: of_table_feature_prop_write_actions_miss */
    -1,   /* 376: of_table_feature_prop_write_setfield */
    -1,   /* 377: of_table_feature_prop_write_setfield_miss */
    -1,   /* 378: of_table_features */
    64,   /* 379: of_table_stats_entry */
    -1,   /* 380: of_uint32 */
    -1,   /* 381: of_uint64 */
    -1,   /* 382: of_uint8 */
    0,    /* 383: of_list_action */
    -1,   /* 384: of_list_action_id */
    -1,   /* 385: of_list_bsn_controller_connection */
    0,    /* 386: of_list_bsn_interface */
    -1,   /* 387: of_list_bsn_lacp_stats_entry */
    -1,   /* 388: of_list_bsn_port_counter_stats_entry */
    -1,   /* 389: of_list_bsn_switch_pipeline_stats_entry */
    -1,   /* 390: of_list_bsn_vlan_counter_stats_entry */
    -1,   /* 391: of_list_bucket */
    -1,   /* 392: of_list_bucket_counter */
    0,    /* 393: of_list_flow_stats_entry */
    -1,   /* 394: of_list_group_desc_stats_entry */
    -1,   /* 395: of_list_group_stats_entry */
    -1,   /* 396: of_list_hello_elem */
    -1,   /* 397: of_list_instruction */
    -1,   /* 398: of_list_meter_band */
    -1,   /* 399: of_list_meter_band_stats */
    -1,   /* 400: of_list_meter_stats */
    -1,   /* 401: of_list_oxm */
    0,    /* 402: of_list_packet_queue */
    0,    /* 403: of_list_port_desc */
    0,    /* 404: of_list_port_stats_entry */
    0,    /* 405: of_list_queue_prop */
    0,    /* 406: of_list_queue_stats_entry */
    -1,   /* 407: of_list_table_feature_prop */
    -1,   /* 408: of_list_table_features */
    0,    /* 409: of_list_table_stats_entry */
    -1,   /* 410: of_list_uint32 */
    -1,   /* 411: of_list_uint64 */
    -1    /* 412: of_list_uint8 */
};
...
of_object_fixed_len_v2[OF_OBJECT_COUNT] = {
    ...
    16,   /* 25: of_bsn_get_interfaces_reply */
    16,   /* 26: of_bsn_get_interfaces_request */
    -1,   /* 27: of_bsn_get_ip_mask_reply */
    -1,   /* 28: of_bsn_get_ip_mask_request */
    -1,   /* 29: of_bsn_get_l2_table_reply */
    -1,   /* 30: of_bsn_get_l2_table_request */
    20,   /* 31: of_bsn_get_mirroring_reply */
    20,   /* 32: of_bsn_get_mirroring_request */
    -1,   /* 33: of_bsn_get_switch_pipeline_reply */
    -1,   /* 34: of_bsn_get_switch_pipeline_request */
    16,   /* 35: of_bsn_header */
    -1,   /* 36: of_bsn_hybrid_get_reply */
    -1,   /* 37: of_bsn_hybrid_get_request */
    -1,   /* 38: of_bsn_lacp_convergence_notif */
    -1,   /* 39: of_bsn_lacp_stats_reply */
    -1,   /* 40: of_bsn_lacp_stats_request */
    25,   /* 41: of_bsn_pdu_rx_reply */
    28,   /* 42: of_bsn_pdu_rx_request */
    21,   /* 43: of_bsn_pdu_rx_timeout */
    25,   /* 44: of_bsn_pdu_tx_reply */
    28,   /* 45: of_bsn_pdu_tx_request */
    -1,   /* 46: of_bsn_port_counter_stats_reply */
    -1,   /* 47: of_bsn_port_counter_stats_request */
    -1,   /* 48: of_bsn_role_status */
    -1,   /* 49: of_bsn_set_ip_mask */
    -1,   /* 50: of_bsn_set_l2_table_reply */
    -1,   /* 51: of_bsn_set_l2_table_request */
    -1,   /* 52: of_bsn_set_lacp_reply */
    -1,   /* 53: of_bsn_set_lacp_request */
    20,   /* 54: of_bsn_set_mirroring */
    20,   /* 55: of_bsn_set_pktin_suppression_reply */
    ...
    -1,   /* 57: of_bsn_set_switch_pipeline_reply */
    -1,   /* 58: of_bsn_set_switch_pipeline_request */
    -1,   /* 59: of_bsn_shell_command */
    -1,   /* 60: of_bsn_shell_output */
    -1,   /* 61: of_bsn_shell_status */
    24,   /* 62: of_bsn_stats_reply */
    24,   /* 63: of_bsn_stats_request */
    -1,   /* 64: of_bsn_switch_pipeline_stats_reply */
    -1,   /* 65: of_bsn_switch_pipeline_stats_request */
    ...
    -1,   /* 72: of_bsn_vlan_counter_stats_reply */
    -1,   /* 73: of_bsn_vlan_counter_stats_request */
    1072, /* 74: of_desc_stats_reply */
    16,   /* 75: of_desc_stats_request */
    8,    /* 76: of_echo_reply */
    8,    /* 77: of_echo_request */
    10,   /* 78: of_error_msg */
    16,   /* 79: of_experimenter */
    -1,   /* 80: of_experimenter_error_msg */
    24,   /* 81: of_experimenter_stats_reply */
    24,   /* 82: of_experimenter_stats_request */
    32,   /* 83: of_features_reply */
    8,    /* 84: of_features_request */
    136,  /* 85: of_flow_add */
    136,  /* 86: of_flow_delete */
    136,  /* 87: of_flow_delete_strict */
    136,  /* 88: of_flow_mod */
    12,   /* 89: of_flow_mod_failed_error_msg */
    136,  /* 90: of_flow_modify */
    136,  /* 91: of_flow_modify_strict */
    136,  /* 92: of_flow_removed */
    16,   /* 93: of_flow_stats_reply */
    136,  /* 94: of_flow_stats_request */
    12,   /* 95: of_get_config_reply */
    8,    /* 96: of_get_config_request */
    16,   /* 97: of_group_add */
    16,   /* 98: of_group_delete */
    16,   /* 99: of_group_desc_stats_reply */
    16,   /* 100: of_group_desc_stats_request */
    -1,   /* 101: of_group_features_stats_reply */
    -1,   /* 102: of_group_features_stats_request */
    16,   /* 103: of_group_mod */
    12,   /* 104: of_group_mod_failed_error_msg */
    16,   /* 105: of_group_modify */
    16,   /* 106: of_group_stats_reply */
    24,   /* 107: of_group_stats_request */
    8,    /* 108: of_hello */
    12,   /* 109: of_hello_failed_error_msg */
    -1,   /* 110: of_meter_config_stats_reply */
    -1,   /* 111: of_meter_config_stats_request */
    ...
    -1,   /* 116: of_meter_stats_reply */
    -1,   /* 117: of_meter_stats_request */
    -1,   /* 118: of_nicira_controller_role_reply */
    -1,   /* 119: of_nicira_controller_role_request */
    16,   /* 120: of_nicira_header */
    24,   /* 121: of_packet_in */
    24,   /* 122: of_packet_out */
    -1,   /* 123: of_port_desc_stats_reply */
    -1,   /* 124: of_port_desc_stats_request */
    40,   /* 125: of_port_mod */
    12,   /* 126: of_port_mod_failed_error_msg */
    16,   /* 127: of_port_stats_reply */
    24,   /* 128: of_port_stats_request */
    80,   /* 129: of_port_status */
    16,   /* 130: of_queue_get_config_reply */
    16,   /* 131: of_queue_get_config_request */
    12,   /* 132: of_queue_op_failed_error_msg */
    16,   /* 133: of_queue_stats_reply */
    24,   /* 134: of_queue_stats_request */
    -1,   /* 135: of_role_reply */
    -1,   /* 136: of_role_request */
    -1,   /* 137: of_role_request_failed_error_msg */
    12,   /* 138: of_set_config */
    16,   /* 139: of_stats_reply */
    16,   /* 140: of_stats_request */
    12,   /* 141: of_switch_config_failed_error_msg */
    -1,   /* 142: of_table_features_failed_error_msg */
    -1,   /* 143: of_table_features_stats_reply */
    -1,   /* 144: of_table_features_stats_request */
    16,   /* 145: of_table_mod */
    12,   /* 146: of_table_mod_failed_error_msg */
    16,   /* 147: of_table_stats_reply */
    16,   /* 148: of_table_stats_request */
    8,    /* 149: of_action */
    16,   /* 150: of_action_bsn */
    24,   /* 151: of_action_bsn_mirror */
    16,   /* 152: of_action_bsn_set_tunnel_dst */
    8,    /* 153: of_action_copy_ttl_in */
    8,    /* 154: of_action_copy_ttl_out */
    8,    /* 155: of_action_dec_mpls_ttl */
    8,    /* 156: of_action_dec_nw_ttl */
    -1,   /* 157: of_action_enqueue */
    8,    /* 158: of_action_experimenter */
    8,    /* 159: of_action_group */
    8,    /* 160: of_action_header */
    -1,   /* 161: of_action_id */
    -1,   /* 162: of_action_id_bsn */
    -1,   /* 163: of_action_id_bsn_mirror */
    ...
    16,   /* 185: of_action_nicira */
    16,   /* 186: of_action_nicira_dec_ttl */
    16,   /* 187: of_action_output */
    8,    /* 188: of_action_pop_mpls */
    -1,   /* 189: of_action_pop_pbb */
    8,    /* 190: of_action_pop_vlan */
    8,    /* 191: of_action_push_mpls */
    -1,   /* 192: of_action_push_pbb */
    8,    /* 193: of_action_push_vlan */
    16,   /* 194: of_action_set_dl_dst */
    16,   /* 195: of_action_set_dl_src */
    -1,   /* 196: of_action_set_field */
    8,    /* 197: of_action_set_mpls_label */
    8,    /* 198: of_action_set_mpls_tc */
    8,    /* 199: of_action_set_mpls_ttl */
    8,    /* 200: of_action_set_nw_dst */
    8,    /* 201: of_action_set_nw_ecn */
    8,    /* 202: of_action_set_nw_src */
    8,    /* 203: of_action_set_nw_tos */
    8,    /* 204: of_action_set_nw_ttl */
    8,    /* 205: of_action_set_queue */
    8,    /* 206: of_action_set_tp_dst */
    8,    /* 207: of_action_set_tp_src */
    8,    /* 208: of_action_set_vlan_pcp */
    8,    /* 209: of_action_set_vlan_vid */
    -1,   /* 210: of_action_strip_vlan */
    -1,   /* 211: of_bsn_controller_connection */
    32,   /* 212: of_bsn_interface */
    -1,   /* 213: of_bsn_lacp_stats_entry */
    -1,   /* 214: of_bsn_port_counter_stats_entry */
    ...
    32,   /* 219: of_bsn_vport_q_in_q */
    16,   /* 220: of_bucket */
    16,   /* 221: of_bucket_counter */
    -1,   /* 222: of_experimenter_stats_header */
    136,  /* 223: of_flow_stats_entry */
    8,    /* 224: of_group_desc_stats_entry */
    32,   /* 225: of_group_stats_entry */
    8,    /* 226: of_header */
    -1,   /* 227: of_hello_elem */
    -1,   /* 228: of_hello_elem_header */
    -1,   /* 229: of_hello_elem_versionbitmap */
    8,    /* 230: of_instruction */
    8,    /* 231: of_instruction_apply_actions */
    -1,   /* 232: of_instruction_bsn */
    -1,   /* 233: of_instruction_bsn_disable_src_mac_check */
    8,    /* 234: of_instruction_clear_actions */
    8,    /* 235: of_instruction_experimenter */
    8,    /* 236: of_instruction_goto_table */
    8,    /* 237: of_instruction_header */
    -1,   /* 238: of_instruction_id */
    -1,   /* 239: of_instruction_id_apply_actions */
    -1,   /* 240: of_instruction_id_bsn */
    -1,   /* 241: of_instruction_id_bsn_disable_src_mac_check */
    ...
    -1,   /* 248: of_instruction_id_write_metadata */
    -1,   /* 249: of_instruction_meter */
    8,    /* 250: of_instruction_write_actions */
    24,   /* 251: of_instruction_write_metadata */
    -1,   /* 252: of_match_v1 */
    88,   /* 253: of_match_v2 */
    -1,   /* 254: of_match_v3 */
    -1,   /* 255: of_meter_band */
    ...
    -1,   /* 389: of_list_bsn_switch_pipeline_stats_entry */
    -1,   /* 390: of_list_bsn_vlan_counter_stats_entry */
    0,    /* 391: of_list_bucket */
    0,    /* 392: of_list_bucket_counter */
    0,    /* 393: of_list_flow_stats_entry */
    0,    /* 394: of_list_group_desc_stats_entry */
    0,    /* 395: of_list_group_stats_entry */
    -1,   /* 396: of_list_hello_elem */
    0,    /* 397: of_list_instruction */
    -1,   /* 398: of_list_meter_band */
    -1,   /* 399: of_list_meter_band_stats */
    -1,   /* 400: of_list_meter_stats */
    -1,   /* 401: of_list_oxm */
...
of_object_fixed_len_v3[OF_OBJECT_COUNT] = {
    ...
    10,   /* 78: of_error_msg */
    16,   /* 79: of_experimenter */
    16,   /* 80: of_experimenter_error_msg */
    24,   /* 81: of_experimenter_stats_reply */
    24,   /* 82: of_experimenter_stats_request */
    32,   /* 83: of_features_reply */
    8,    /* 84: of_features_request */
    56,   /* 85: of_flow_add */
    56,   /* 86: of_flow_delete */
    56,   /* 87: of_flow_delete_strict */
    56,   /* 88: of_flow_mod */
    12,   /* 89: of_flow_mod_failed_error_msg */
    56,   /* 90: of_flow_modify */
    56,   /* 91: of_flow_modify_strict */
    56,   /* 92: of_flow_removed */
    16,   /* 93: of_flow_stats_reply */
    56,   /* 94: of_flow_stats_request */
    12,   /* 95: of_get_config_reply */
    8,    /* 96: of_get_config_request */
    ...
    16,   /* 99: of_group_desc_stats_reply */
    16,   /* 100: of_group_desc_stats_request */
    56,   /* 101: of_group_features_stats_reply */
    16,   /* 102: of_group_features_stats_request */
    16,   /* 103: of_group_mod */
    12,   /* 104: of_group_mod_failed_error_msg */
    16,   /* 105: of_group_modify */
    16,   /* 106: of_group_stats_reply */
    ...
    16,   /* 133: of_queue_stats_reply */
    24,   /* 134: of_queue_stats_request */
    24,   /* 135: of_role_reply */
    24,   /* 136: of_role_request */
    12,   /* 137: of_role_request_failed_error_msg */
    12,   /* 138: of_set_config */
    16,   /* 139: of_stats_reply */
    16,   /* 140: of_stats_request */
    12,   /* 141: of_switch_config_failed_error_msg */
    ...
    -1,   /* 192: of_action_push_pbb */
    8,    /* 193: of_action_push_vlan */
    -1,   /* 194: of_action_set_dl_dst */
    -1,   /* 195: of_action_set_dl_src */
    4,    /* 196: of_action_set_field */
    -1,   /* 197: of_action_set_mpls_label */
    -1,   /* 198: of_action_set_mpls_tc */
    8,    /* 199: of_action_set_mpls_ttl */
    -1,   /* 200: of_action_set_nw_dst */
    -1,   /* 201: of_action_set_nw_ecn */
    -1,   /* 202: of_action_set_nw_src */
    -1,   /* 203: of_action_set_nw_tos */
    8,    /* 204: of_action_set_nw_ttl */
    8,    /* 205: of_action_set_queue */
    -1,   /* 206: of_action_set_tp_dst */
    -1,   /* 207: of_action_set_tp_src */
    -1,   /* 208: of_action_set_vlan_pcp */
    -1,   /* 209: of_action_set_vlan_vid */
    -1,   /* 210: of_action_strip_vlan */
    -1,   /* 211: of_bsn_controller_connection */
    32,   /* 212: of_bsn_interface */
    -1,   /* 213: of_bsn_lacp_stats_entry */
    ...
    4,    /* 264: of_oxm */
    6,    /* 265: of_oxm_arp_op */
    8,    /* 266: of_oxm_arp_op_masked */
    10,   /* 267: of_oxm_arp_sha */
    16,   /* 268: of_oxm_arp_sha_masked */
    8,    /* 269: of_oxm_arp_spa */
    12,   /* 270: of_oxm_arp_spa_masked */
    10,   /* 271: of_oxm_arp_tha */
    16,   /* 272: of_oxm_arp_tha_masked */
    8,    /* 273: of_oxm_arp_tpa */
    12,   /* 274: of_oxm_arp_tpa_masked */
    5,    /* 275: of_oxm_bsn_global_vrf_allowed */
    6,    /* 276: of_oxm_bsn_global_vrf_allowed_masked */
    20,   /* 277: of_oxm_bsn_in_ports_128 */
    36,   /* 278: of_oxm_bsn_in_ports_128_masked */
    8,    /* 279: of_oxm_bsn_l3_dst_class_id */
    12,   /* 280: of_oxm_bsn_l3_dst_class_id_masked */
    8,    /* 281: of_oxm_bsn_l3_interface_class_id */
    12,   /* 282: of_oxm_bsn_l3_interface_class_id_masked */
    8,    /* 283: of_oxm_bsn_l3_src_class_id */
    12,   /* 284: of_oxm_bsn_l3_src_class_id_masked */
    8,    /* 285: of_oxm_bsn_lag_id */
    12,   /* 286: of_oxm_bsn_lag_id_masked */
    8,    /* 287: of_oxm_bsn_vrf */
    12,   /* 288: of_oxm_bsn_vrf_masked */
    10,   /* 289: of_oxm_eth_dst */
    16,   /* 290: of_oxm_eth_dst_masked */
    10,   /* 291: of_oxm_eth_src */
    16,   /* 292: of_oxm_eth_src_masked */
    6,    /* 293: of_oxm_eth_type */
    8,    /* 294: of_oxm_eth_type_masked */
    4,    /* 295: of_oxm_header */
    5,    /* 296: of_oxm_icmpv4_code */
    6,    /* 297: of_oxm_icmpv4_code_masked */
    5,    /* 298: of_oxm_icmpv4_type */
    6,    /* 299: of_oxm_icmpv4_type_masked */
    5,    /* 300: of_oxm_icmpv6_code */
    6,    /* 301: of_oxm_icmpv6_code_masked */
    5,    /* 302: of_oxm_icmpv6_type */
    6,    /* 303: of_oxm_icmpv6_type_masked */
    8,    /* 304: of_oxm_in_phy_port */
    12,   /* 305: of_oxm_in_phy_port_masked */
    8,    /* 306: of_oxm_in_port */
    12,   /* 307: of_oxm_in_port_masked */
    5,    /* 308: of_oxm_ip_dscp */
    6,    /* 309: of_oxm_ip_dscp_masked */
    5,    /* 310: of_oxm_ip_ecn */
    6,    /* 311: of_oxm_ip_ecn_masked */
    5,    /* 312: of_oxm_ip_proto */
    6,    /* 313: of_oxm_ip_proto_masked */
    8,    /* 314: of_oxm_ipv4_dst */
    12,   /* 315: of_oxm_ipv4_dst_masked */
    8,    /* 316: of_oxm_ipv4_src */
    12,   /* 317: of_oxm_ipv4_src_masked */
    20,   /* 318: of_oxm_ipv6_dst */
    36,   /* 319: of_oxm_ipv6_dst_masked */
    8,    /* 320: of_oxm_ipv6_flabel */
    12,   /* 321: of_oxm_ipv6_flabel_masked */
    10,   /* 322: of_oxm_ipv6_nd_sll */
    16,   /* 323: of_oxm_ipv6_nd_sll_masked */
    20,   /* 324: of_oxm_ipv6_nd_target */
    36,   /* 325: of_oxm_ipv6_nd_target_masked */
    10,   /* 326: of_oxm_ipv6_nd_tll */
    16,   /* 327: of_oxm_ipv6_nd_tll_masked */
    20,   /* 328: of_oxm_ipv6_src */
    36,   /* 329: of_oxm_ipv6_src_masked */
    12,   /* 330: of_oxm_metadata */
    20,   /* 331: of_oxm_metadata_masked */
    8,    /* 332: of_oxm_mpls_label */
    12,   /* 333: of_oxm_mpls_label_masked */
    5,    /* 334: of_oxm_mpls_tc */
    6,    /* 335: of_oxm_mpls_tc_masked */
    6,    /* 336: of_oxm_sctp_dst */
    8,    /* 337: of_oxm_sctp_dst_masked */
    6,    /* 338: of_oxm_sctp_src */
    8,    /* 339: of_oxm_sctp_src_masked */
    6,    /* 340: of_oxm_tcp_dst */
    8,    /* 341: of_oxm_tcp_dst_masked */
    6,    /* 342: of_oxm_tcp_src */
    8,    /* 343: of_oxm_tcp_src_masked */
    6,    /* 344: of_oxm_udp_dst */
    8,    /* 345: of_oxm_udp_dst_masked */
    6,    /* 346: of_oxm_udp_src */
    8,    /* 347: of_oxm_udp_src_masked */
    5,    /* 348: of_oxm_vlan_pcp */
    6,    /* 349: of_oxm_vlan_pcp_masked */
    6,    /* 350: of_oxm_vlan_vid */
    8,    /* 351: of_oxm_vlan_vid_masked */
    16,   /* 352: of_packet_queue */
    64,   /* 353: of_port_desc */
    104,  /* 354: of_port_stats_entry */
    8,    /* 355: of_queue_prop */
    16,   /* 356: of_queue_prop_experimenter */
    8,    /* 357: of_queue_prop_header */
    16,   /* 358: of_queue_prop_max_rate */
    16,   /* 359: of_queue_prop_min_rate */
    32,   /* 360: of_queue_stats_entry */
    -1,   /* 361: of_table_feature_prop */
    -1,   /* 362: of_table_feature_prop_apply_actions */
...
of_object_fixed_len_v4[OF_OBJECT_COUNT] = {
    ...
    20,   /* 31: of_bsn_get_mirroring_reply */
    20,   /* 32: of_bsn_get_mirroring_request */
    272,  /* 33: of_bsn_get_switch_pipeline_reply */
    16,   /* 34: of_bsn_get_switch_pipeline_request */
    16,   /* 35: of_bsn_header */
    -1,   /* 36: of_bsn_hybrid_get_reply */
    -1,   /* 37: of_bsn_hybrid_get_request */
    52,   /* 38: of_bsn_lacp_convergence_notif */
    24,   /* 39: of_bsn_lacp_stats_reply */
    24,   /* 40: of_bsn_lacp_stats_request */
    25,   /* 41: of_bsn_pdu_rx_reply */
    28,   /* 42: of_bsn_pdu_rx_request */
    21,   /* 43: of_bsn_pdu_rx_timeout */
    25,   /* 44: of_bsn_pdu_tx_reply */
    28,   /* 45: of_bsn_pdu_tx_request */
    24,   /* 46: of_bsn_port_counter_stats_reply */
    28,   /* 47: of_bsn_port_counter_stats_request */
    32,   /* 48: of_bsn_role_status */
    -1,   /* 49: of_bsn_set_ip_mask */
    -1,   /* 50: of_bsn_set_l2_table_reply */
    -1,   /* 51: of_bsn_set_l2_table_request */
    24,   /* 52: of_bsn_set_lacp_reply */
    38,   /* 53: of_bsn_set_lacp_request */
    20,   /* 54: of_bsn_set_mirroring */
    20,   /* 55: of_bsn_set_pktin_suppression_reply */
    32,   /* 56: of_bsn_set_pktin_suppression_request */
    20,   /* 57: of_bsn_set_switch_pipeline_reply */
    272,  /* 58: of_bsn_set_switch_pipeline_request */
    -1,   /* 59: of_bsn_shell_command */
    -1,   /* 60: of_bsn_shell_output */
    -1,   /* 61: of_bsn_shell_status */
    24,   /* 62: of_bsn_stats_reply */
    24,   /* 63: of_bsn_stats_request */
    24,   /* 64: of_bsn_switch_pipeline_stats_reply */
    24,   /* 65: of_bsn_switch_pipeline_stats_request */
    24,   /* 66: of_bsn_time_reply */
    16,   /* 67: of_bsn_time_request */
    24,   /* 68: of_bsn_virtual_port_create_reply */
    48,   /* 69: of_bsn_virtual_port_create_request */
    20,   /* 70: of_bsn_virtual_port_remove_reply */
    20,   /* 71: of_bsn_virtual_port_remove_request */
    24,   /* 72: of_bsn_vlan_counter_stats_reply */
    26,   /* 73: of_bsn_vlan_counter_stats_request */
    1072, /* 74: of_desc_stats_reply */
    16,   /* 75: of_desc_stats_request */
    8,    /* 76: of_echo_reply */
    8,    /* 77: of_echo_request */
    ...
    8,    /* 108: of_hello */
    12,   /* 109: of_hello_failed_error_msg */
    16,   /* 110: of_meter_config_stats_reply */
    24,   /* 111: of_meter_config_stats_request */
    32,   /* 112: of_meter_features_stats_reply */
    16,   /* 113: of_meter_features_stats_request */
    16,   /* 114: of_meter_mod */
    12,   /* 115: of_meter_mod_failed_error_msg */
    16,   /* 116: of_meter_stats_reply */
    24,   /* 117: of_meter_stats_request */
    -1,   /* 118: of_nicira_controller_role_reply */
    -1,   /* 119: of_nicira_controller_role_request */
    16,   /* 120: of_nicira_header */
    32,   /* 121: of_packet_in */
    24,   /* 122: of_packet_out */
    16,   /* 123: of_port_desc_stats_reply */
    16,   /* 124: of_port_desc_stats_request */
    40,   /* 125: of_port_mod */
    12,   /* 126: of_port_mod_failed_error_msg */
    16,   /* 127: of_port_stats_reply */
    24,   /* 128: of_port_stats_request */
    ...
    16,   /* 140: of_stats_request */
    12,   /* 141: of_switch_config_failed_error_msg */
    12,   /* 142: of_table_features_failed_error_msg */
    16,   /* 143: of_table_features_stats_reply */
    16,   /* 144: of_table_features_stats_request */
    16,   /* 145: of_table_mod */
    12,   /* 146: of_table_mod_failed_error_msg */
    16,   /* 147: of_table_stats_reply */
    16,   /* 148: of_table_stats_request */
    ...
    8,    /* 160: of_action_header */
    8,    /* 161: of_action_id */
    16,   /* 162: of_action_id_bsn */
    15,   /* 163: of_action_id_bsn_mirror */
    12,   /* 164: of_action_id_bsn_set_tunnel_dst */
    8,    /* 165: of_action_id_copy_ttl_in */
    8,    /* 166: of_action_id_copy_ttl_out */
    8,    /* 167: of_action_id_dec_mpls_ttl */
    8,    /* 168: of_action_id_dec_nw_ttl */
    8,    /* 169: of_action_id_experimenter */
    4,    /* 170: of_action_id_group */
    8,    /* 171: of_action_id_header */
    16,   /* 172: of_action_id_nicira */
    16,   /* 173: of_action_id_nicira_dec_ttl */
    10,   /* 174: of_action_id_output */
    6,    /* 175: of_action_id_pop_mpls */
    8,    /* 176: of_action_id_pop_pbb */
    8,    /* 177: of_action_id_pop_vlan */
    6,    /* 178: of_action_id_push_mpls */
    6,    /* 179: of_action_id_push_pbb */
    6,    /* 180: of_action_id_push_vlan */
    4,    /* 181: of_action_id_set_field */
    7,    /* 182: of_action_id_set_mpls_ttl */
    7,    /* 183: of_action_id_set_nw_ttl */
    4,    /* 184: of_action_id_set_queue */
    16,   /* 185: of_action_nicira */
    16,   /* 186: of_action_nicira_dec_ttl */
    16,   /* 187: of_action_output */
    8,    /* 188: of_action_pop_mpls */
    8,    /* 189: of_action_pop_pbb */
    8,    /* 190: of_action_pop_vlan */
    8,    /* 191: of_action_push_mpls */
    8,    /* 192: of_action_push_pbb */
    8,    /* 193: of_action_push_vlan */
    -1,   /* 194: of_action_set_dl_dst */
    -1,   /* 195: of_action_set_dl_src */
    4,    /* 196: of_action_set_field */
    ...
    -1,   /* 209: of_action_set_vlan_vid */
    -1,   /* 210: of_action_strip_vlan */
    264,  /* 211: of_bsn_controller_connection */
    32,   /* 212: of_bsn_interface */
    36,   /* 213: of_bsn_lacp_stats_entry */
    8,    /* 214: of_bsn_port_counter_stats_entry */
    256,  /* 215: of_bsn_switch_pipeline_stats_entry */
    8,    /* 216: of_bsn_vlan_counter_stats_entry */
    4,    /* 217: of_bsn_vport */
    4,    /* 218: of_bsn_vport_header */
    32,   /* 219: of_bsn_vport_q_in_q */
    16,   /* 220: of_bucket */
    16,   /* 221: of_bucket_counter */
    8,    /* 222: of_experimenter_stats_header */
    56,   /* 223: of_flow_stats_entry */
    8,    /* 224: of_group_desc_stats_entry */
    40,   /* 225: of_group_stats_entry */
    8,    /* 226: of_header */
    4,    /* 227: of_hello_elem */
    4,    /* 228: of_hello_elem_header */
    4,    /* 229: of_hello_elem_versionbitmap */
    4,    /* 230: of_instruction */
    8,    /* 231: of_instruction_apply_actions */
    16,   /* 232: of_instruction_bsn */
    16,   /* 233: of_instruction_bsn_disable_src_mac_check */
    8,    /* 234: of_instruction_clear_actions */
    8,    /* 235: of_instruction_experimenter */
    8,    /* 236: of_instruction_goto_table */
    4,    /* 237: of_instruction_header */
    4,    /* 238: of_instruction_id */
    8,    /* 239: of_instruction_id_apply_actions */
    16,   /* 240: of_instruction_id_bsn */
    16,   /* 241: of_instruction_id_bsn_disable_src_mac_check */
    8,    /* 242: of_instruction_id_clear_actions */
    8,    /* 243: of_instruction_id_experimenter */
    7,    /* 244: of_instruction_id_goto_table */
    4,    /* 245: of_instruction_id_header */
    4,    /* 246: of_instruction_id_meter */
    8,    /* 247: of_instruction_id_write_actions */
    8,    /* 248: of_instruction_id_write_metadata */
    8,    /* 249: of_instruction_meter */
    8,    /* 250: of_instruction_write_actions */
    24,   /* 251: of_instruction_write_metadata */
    -1,   /* 252: of_match_v1 */
    -1,   /* 253: of_match_v2 */
    4,    /* 254: of_match_v3 */
    4,    /* 255: of_meter_band */
    16,   /* 256: of_meter_band_drop */
    16,   /* 257: of_meter_band_dscp_remark */
    16,   /* 258: of_meter_band_experimenter */
    4,    /* 259: of_meter_band_header */
    16,   /* 260: of_meter_band_stats */
    8,    /* 261: of_meter_config */
    16,   /* 262: of_meter_features */
    40,   /* 263: of_meter_stats */
    4,    /* 264: of_oxm */
    6,    /* 265: of_oxm_arp_op */
    8,    /* 266: of_oxm_arp_op_masked */
    10,   /* 267: of_oxm_arp_sha */
    ...
    16,   /* 352: of_packet_queue */
    64,   /* 353: of_port_desc */
    112,  /* 354: of_port_stats_entry */
    8,    /* 355: of_queue_prop */
    16,   /* 356: of_queue_prop_experimenter */
    8,    /* 357: of_queue_prop_header */
    16,   /* 358: of_queue_prop_max_rate */
    16,   /* 359: of_queue_prop_min_rate */
    40,   /* 360: of_queue_stats_entry */
    4,    /* 361: of_table_feature_prop */
    4,    /* 362: of_table_feature_prop_apply_actions */
    4,    /* 363: of_table_feature_prop_apply_actions_miss */
    4,    /* 364: of_table_feature_prop_apply_setfield */
    4,    /* 365: of_table_feature_prop_apply_setfield_miss */
    12,   /* 366: of_table_feature_prop_experimenter */
    4,    /* 367: of_table_feature_prop_header */
    4,    /* 368: of_table_feature_prop_instructions */
    4,    /* 369: of_table_feature_prop_instructions_miss */
    4,    /* 370: of_table_feature_prop_match */
    4,    /* 371: of_table_feature_prop_next_tables */
    4,    /* 372: of_table_feature_prop_next_tables_miss */
    4,    /* 373: of_table_feature_prop_wildcards */
    4,    /* 374: of_table_feature_prop_write_actions */
    4,    /* 375: of_table_feature_prop_write_actions_miss */
    4,    /* 376: of_table_feature_prop_write_setfield */
    4,    /* 377: of_table_feature_prop_write_setfield_miss */
    64,   /* 378: of_table_features */
    24,   /* 379: of_table_stats_entry */
    4,    /* 380: of_uint32 */
    8,    /* 381: of_uint64 */
    1,    /* 382: of_uint8 */
    0,    /* 383: of_list_action */
    0,    /* 384: of_list_action_id */
    0,    /* 385: of_list_bsn_controller_connection */
    0,    /* 386: of_list_bsn_interface */
    0,    /* 387: of_list_bsn_lacp_stats_entry */
    0,    /* 388: of_list_bsn_port_counter_stats_entry */
    0,    /* 389: of_list_bsn_switch_pipeline_stats_entry */
    0,    /* 390: of_list_bsn_vlan_counter_stats_entry */
    0,    /* 391: of_list_bucket */
    0,    /* 392: of_list_bucket_counter */
    0,    /* 393: of_list_flow_stats_entry */
    0,    /* 394: of_list_group_desc_stats_entry */
    0,    /* 395: of_list_group_stats_entry */
    0,    /* 396: of_list_hello_elem */
    0,    /* 397: of_list_instruction */
    0,    /* 398: of_list_meter_band */
    0,    /* 399: of_list_meter_band_stats */
    0,    /* 400: of_list_meter_stats */
    0,    /* 401: of_list_oxm */
    0,    /* 402: of_list_packet_queue */
    0,    /* 403: of_list_port_desc */
    0,    /* 404: of_list_port_stats_entry */
    0,    /* 405: of_list_queue_prop */
    0,    /* 406: of_list_queue_stats_entry */
    0,    /* 407: of_list_table_feature_prop */
    0,    /* 408: of_list_table_features */
    0,    /* 409: of_list_table_stats_entry */
    0,    /* 410: of_list_uint32 */
    0,    /* 411: of_list_uint64 */
    0     /* 412: of_list_uint8 */
};
...
of_object_extra_len_v1[OF_OBJECT_COUNT] = {
    ...
    -1,   /* 23: of_bsn_flow_idle_enable_set_reply */
    -1,   /* 24: of_bsn_flow_idle_enable_set_request */
    0,    /* 25: of_bsn_get_interfaces_reply */
    0,    /* 26: of_bsn_get_interfaces_request */
    0,    /* 27: of_bsn_get_ip_mask_reply */
    0,    /* 28: of_bsn_get_ip_mask_request */
    0,    /* 29: of_bsn_get_l2_table_reply */
    0,    /* 30: of_bsn_get_l2_table_request */
    0,    /* 31: of_bsn_get_mirroring_reply */
    0,    /* 32: of_bsn_get_mirroring_request */
    -1,   /* 33: of_bsn_get_switch_pipeline_reply */
    -1,   /* 34: of_bsn_get_switch_pipeline_request */
    0,    /* 35: of_bsn_header */
    0,    /* 36: of_bsn_hybrid_get_reply */
    0,    /* 37: of_bsn_hybrid_get_request */
    -1,   /* 38: of_bsn_lacp_convergence_notif */
    -1,   /* 39: of_bsn_lacp_stats_reply */
    -1,   /* 40: of_bsn_lacp_stats_request */
    0,    /* 41: of_bsn_pdu_rx_reply */
    0,    /* 42: of_bsn_pdu_rx_request */
    0,    /* 43: of_bsn_pdu_rx_timeout */
    0,    /* 44: of_bsn_pdu_tx_reply */
    0,    /* 45: of_bsn_pdu_tx_request */
    -1,   /* 46: of_bsn_port_counter_stats_reply */
    -1,   /* 47: of_bsn_port_counter_stats_request */
    -1,   /* 48: of_bsn_role_status */
    0,    /* 49: of_bsn_set_ip_mask */
    0,    /* 50: of_bsn_set_l2_table_reply */
    0,    /* 51: of_bsn_set_l2_table_request */
    -1,   /* 52: of_bsn_set_lacp_reply */
    -1,   /* 53: of_bsn_set_lacp_request */
    0,    /* 54: of_bsn_set_mirroring */
    0,    /* 55: of_bsn_set_pktin_suppression_reply */
    0,    /* 56: of_bsn_set_pktin_suppression_request */
    -1,   /* 57: of_bsn_set_switch_pipeline_reply */
    -1,   /* 58: of_bsn_set_switch_pipeline_request */
    0,    /* 59: of_bsn_shell_command */
    0,    /* 60: of_bsn_shell_output */
    0,    /* 61: of_bsn_shell_status */
    0,    /* 62: of_bsn_stats_reply */
    0,    /* 63: of_bsn_stats_request */
    -1,   /* 64: of_bsn_switch_pipeline_stats_reply */
    -1,   /* 65: of_bsn_switch_pipeline_stats_request */
    -1,   /* 66: of_bsn_time_reply */
    -1,   /* 67: of_bsn_time_request */
    0,    /* 68: of_bsn_virtual_port_create_reply */
    0,    /* 69: of_bsn_virtual_port_create_request */
    0,    /* 70: of_bsn_virtual_port_remove_reply */
    0,    /* 71: of_bsn_virtual_port_remove_request */
    -1,   /* 72: of_bsn_vlan_counter_stats_reply */
    -1,   /* 73: of_bsn_vlan_counter_stats_request */
    0,    /* 74: of_desc_stats_reply */
    0,    /* 75: of_desc_stats_request */
    0,    /* 76: of_echo_reply */
    0,    /* 77: of_echo_request */
    0,    /* 78: of_error_msg */
    0,    /* 79: of_experimenter */
    -1,   /* 80: of_experimenter_error_msg */
    0,    /* 81: of_experimenter_stats_reply */
    0,    /* 82: of_experimenter_stats_request */
    0,    /* 83: of_features_reply */
    0,    /* 84: of_features_request */
    0,    /* 85: of_flow_add */
    0,    /* 86: of_flow_delete */
    0,    /* 87: of_flow_delete_strict */
    0,    /* 88: of_flow_mod */
    0,    /* 89: of_flow_mod_failed_error_msg */
    0,    /* 90: of_flow_modify */
    0,    /* 91: of_flow_modify_strict */
    0,    /* 92: of_flow_removed */
    0,    /* 93: of_flow_stats_reply */
    0,    /* 94: of_flow_stats_request */
    0,    /* 95: of_get_config_reply */
    0,    /* 96: of_get_config_request */
    -1,   /* 97: of_group_add */
    -1,   /* 98: of_group_delete */
    -1,   /* 99: of_group_desc_stats_reply */
    -1,   /* 100: of_group_desc_stats_request */
    ...
    -1,   /* 107: of_group_stats_request */
    0,    /* 108: of_hello */
    0,    /* 109: of_hello_failed_error_msg */
    -1,   /* 110: of_meter_config_stats_reply */
    -1,   /* 111: of_meter_config_stats_request */
    -1,   /* 112: of_meter_features_stats_reply */
    -1,   /* 113: of_meter_features_stats_request */
    ...
    -1,   /* 116: of_meter_stats_reply */
    -1,   /* 117: of_meter_stats_request */
    0,    /* 118: of_nicira_controller_role_reply */
    0,    /* 119: of_nicira_controller_role_request */
    0,    /* 120: of_nicira_header */
    0,    /* 121: of_packet_in */
    0,    /* 122: of_packet_out */
    -1,   /* 123: of_port_desc_stats_reply */
    -1,   /* 124: of_port_desc_stats_request */
    0,    /* 125: of_port_mod */
    0,    /* 126: of_port_mod_failed_error_msg */
    0,    /* 127: of_port_stats_reply */
    0,    /* 128: of_port_stats_request */
    0,    /* 129: of_port_status */
    0,    /* 130: of_queue_get_config_reply */
    0,    /* 131: of_queue_get_config_request */
    0,    /* 132: of_queue_op_failed_error_msg */
    0,    /* 133: of_queue_stats_reply */
    0,    /* 134: of_queue_stats_request */
    -1,   /* 135: of_role_reply */
    -1,   /* 136: of_role_request */
    -1,   /* 137: of_role_request_failed_error_msg */
    0,    /* 138: of_set_config */
    0,    /* 139: of_stats_reply */
    0,    /* 140: of_stats_request */
    -1,   /* 141: of_switch_config_failed_error_msg */
    -1,   /* 142: of_table_features_failed_error_msg */
    -1,   /* 143: of_table_features_stats_reply */
    -1,   /* 144: of_table_features_stats_request */
    0,    /* 145: of_table_mod */
    -1,   /* 146: of_table_mod_failed_error_msg */
    0,    /* 147: of_table_stats_reply */
    0,    /* 148: of_table_stats_request */
    0,    /* 149: of_action */
    0,    /* 150: of_action_bsn */
    0,    /* 151: of_action_bsn_mirror */
    0,    /* 152: of_action_bsn_set_tunnel_dst */
    -1,   /* 153: of_action_copy_ttl_in */
    -1,   /* 154: of_action_copy_ttl_out */
    -1,   /* 155: of_action_dec_mpls_ttl */
    -1,   /* 156: of_action_dec_nw_ttl */
    0,    /* 157: of_action_enqueue */
    0,    /* 158: of_action_experimenter */
    -1,   /* 159: of_action_group */
    0,    /* 160: of_action_header */
    -1,   /* 161: of_action_id */
    -1,   /* 162: of_action_id_bsn */
    -1,   /* 163: of_action_id_bsn_mirror */
    -1,   /* 164: of_action_id_bsn_set_tunnel_dst */
    ...
    -1,   /* 183: of_action_id_set_nw_ttl */
    -1,   /* 184: of_action_id_set_queue */
    0,    /* 185: of_action_nicira */
    0,    /* 186: of_action_nicira_dec_ttl */
    0,    /* 187: of_action_output */
    -1,   /* 188: of_action_pop_mpls */
    -1,   /* 189: of_action_pop_pbb */
    -1,   /* 190: of_action_pop_vlan */
    -1,   /* 191: of_action_push_mpls */
    -1,   /* 192: of_action_push_pbb */
    -1,   /* 193: of_action_push_vlan */
    0,    /* 194: of_action_set_dl_dst */
    0,    /* 195: of_action_set_dl_src */
    -1,   /* 196: of_action_set_field */
    -1,   /* 197: of_action_set_mpls_label */
    -1,   /* 198: of_action_set_mpls_tc */
    -1,   /* 199: of_action_set_mpls_ttl */
    0,    /* 200: of_action_set_nw_dst */
    -1,   /* 201: of_action_set_nw_ecn */
    0,    /* 202: of_action_set_nw_src */
    0,    /* 203: of_action_set_nw_tos */
    -1,   /* 204: of_action_set_nw_ttl */
    -1,   /* 205: of_action_set_queue */
    0,    /* 206: of_action_set_tp_dst */
    0,    /* 207: of_action_set_tp_src */
    0,    /* 208: of_action_set_vlan_pcp */
    0,    /* 209: of_action_set_vlan_vid */
    0,    /* 210: of_action_strip_vlan */
    -1,   /* 211: of_bsn_controller_connection */
    0,    /* 212: of_bsn_interface */
    -1,   /* 213: of_bsn_lacp_stats_entry */
    -1,   /* 214: of_bsn_port_counter_stats_entry */
    -1,   /* 215: of_bsn_switch_pipeline_stats_entry */
    -1,   /* 216: of_bsn_vlan_counter_stats_entry */
    0,    /* 217: of_bsn_vport */
    0,    /* 218: of_bsn_vport_header */
    0,    /* 219: of_bsn_vport_q_in_q */
    -1,   /* 220: of_bucket */
    -1,   /* 221: of_bucket_counter */
    -1,   /* 222: of_experimenter_stats_header */
    0,    /* 223: of_flow_stats_entry */
    -1,   /* 224: of_group_desc_stats_entry */
    -1,   /* 225: of_group_stats_entry */
    0,    /* 226: of_header */
    -1,   /* 227: of_hello_elem */
    ...
    -1,   /* 350: of_oxm_vlan_vid */
    -1,   /* 351: of_oxm_vlan_vid_masked */
    0,    /* 352: of_packet_queue */
    0,    /* 353: of_port_desc */
    0,    /* 354: of_port_stats_entry */
    0,    /* 355: of_queue_prop */
    -1,   /* 356: of_queue_prop_experimenter */
    0,    /* 357: of_queue_prop_header */
    -1,   /* 358: of_queue_prop_max_rate */
    0,    /* 359: of_queue_prop_min_rate */
    0,    /* 360: of_queue_stats_entry */
    -1,   /* 361: of_table_feature_prop */
    -1,   /* 362: of_table_feature_prop_apply_actions */
    -1,   /* 363: of_table_feature_prop_apply_actions_miss */
    -1,   /* 364: of_table_feature_prop_apply_setfield */
...
of_object_extra_len_v2[OF_OBJECT_COUNT] = {
    ...
    0,    /* 96: of_get_config_request */
    0,    /* 97: of_group_add */
    0,    /* 98: of_group_delete */
    0,    /* 99: of_group_desc_stats_reply */
    0,    /* 100: of_group_desc_stats_request */
    -1,   /* 101: of_group_features_stats_reply */
    -1,   /* 102: of_group_features_stats_request */
    0,    /* 103: of_group_mod */
    0,    /* 104: of_group_mod_failed_error_msg */
    0,    /* 105: of_group_modify */
    0,    /* 106: of_group_stats_reply */
    0,    /* 107: of_group_stats_request */
    0,    /* 108: of_hello */
    0,    /* 109: of_hello_failed_error_msg */
    -1,   /* 110: of_meter_config_stats_reply */
    -1,   /* 111: of_meter_config_stats_request */
    ...
    0,    /* 139: of_stats_reply */
    0,    /* 140: of_stats_request */
    0,    /* 141: of_switch_config_failed_error_msg */
    -1,   /* 142: of_table_features_failed_error_msg */
    -1,   /* 143: of_table_features_stats_reply */
    -1,   /* 144: of_table_features_stats_request */
    0,    /* 145: of_table_mod */
    0,    /* 146: of_table_mod_failed_error_msg */
    0,    /* 147: of_table_stats_reply */
    0,    /* 148: of_table_stats_request */
    0,    /* 149: of_action */
    0,    /* 150: of_action_bsn */
    0,    /* 151: of_action_bsn_mirror */
    0,    /* 152: of_action_bsn_set_tunnel_dst */
    0,    /* 153: of_action_copy_ttl_in */
    0,    /* 154: of_action_copy_ttl_out */
    0,    /* 155: of_action_dec_mpls_ttl */
    0,    /* 156: of_action_dec_nw_ttl */
    -1,   /* 157: of_action_enqueue */
    0,    /* 158: of_action_experimenter */
    0,    /* 159: of_action_group */
    0,    /* 160: of_action_header */
    -1,   /* 161: of_action_id */
    -1,   /* 162: of_action_id_bsn */
    -1,   /* 163: of_action_id_bsn_mirror */
    ...
    0,    /* 186: of_action_nicira_dec_ttl */
    0,    /* 187: of_action_output */
    0,    /* 188: of_action_pop_mpls */
    -1,   /* 189: of_action_pop_pbb */
    0,    /* 190: of_action_pop_vlan */
    0,    /* 191: of_action_push_mpls */
    -1,   /* 192: of_action_push_pbb */
    0,    /* 193: of_action_push_vlan */
    0,    /* 194: of_action_set_dl_dst */
    0,    /* 195: of_action_set_dl_src */
    -1,   /* 196: of_action_set_field */
    0,    /* 197: of_action_set_mpls_label */
    0,    /* 198: of_action_set_mpls_tc */
    0,    /* 199: of_action_set_mpls_ttl */
    0,    /* 200: of_action_set_nw_dst */
    0,    /* 201: of_action_set_nw_ecn */
    0,    /* 202: of_action_set_nw_src */
    0,    /* 203: of_action_set_nw_tos */
    0,    /* 204: of_action_set_nw_ttl */
    0,    /* 205: of_action_set_queue */
    0,    /* 206: of_action_set_tp_dst */
    0,    /* 207: of_action_set_tp_src */
    0,    /* 208: of_action_set_vlan_pcp */
    0,    /* 209: of_action_set_vlan_vid */
    ...
    0,    /* 219: of_bsn_vport_q_in_q */
    0,    /* 220: of_bucket */
    0,    /* 221: of_bucket_counter */
    -1,   /* 222: of_experimenter_stats_header */
    0,    /* 223: of_flow_stats_entry */
    0,    /* 224: of_group_desc_stats_entry */
    0,    /* 225: of_group_stats_entry */
    0,    /* 226: of_header */
    -1,   /* 227: of_hello_elem */
    -1,   /* 228: of_hello_elem_header */
    -1,   /* 229: of_hello_elem_versionbitmap */
    0,    /* 230: of_instruction */
    0,    /* 231: of_instruction_apply_actions */
    -1,   /* 232: of_instruction_bsn */
    -1,   /* 233: of_instruction_bsn_disable_src_mac_check */
    0,    /* 234: of_instruction_clear_actions */
    0,    /* 235: of_instruction_experimenter */
    0,    /* 236: of_instruction_goto_table */
    0,    /* 237: of_instruction_header */
    -1,   /* 238: of_instruction_id */
    -1,   /* 239: of_instruction_id_apply_actions */
    -1,   /* 240: of_instruction_id_bsn */
    -1,   /* 241: of_instruction_id_bsn_disable_src_mac_check */
    ...
    -1,   /* 248: of_instruction_id_write_metadata */
    -1,   /* 249: of_instruction_meter */
    0,    /* 250: of_instruction_write_actions */
    0,    /* 251: of_instruction_write_metadata */
    -1,   /* 252: of_match_v1 */
    0,    /* 253: of_match_v2 */
    -1,   /* 254: of_match_v3 */
    -1,   /* 255: of_meter_band */
...
of_object_extra_len_v3[OF_OBJECT_COUNT] = {
    ...
    0,    /* 78: of_error_msg */
    0,    /* 79: of_experimenter */
    0,    /* 80: of_experimenter_error_msg */
    0,    /* 81: of_experimenter_stats_reply */
    0,    /* 82: of_experimenter_stats_request */
    0,    /* 83: of_features_reply */
    0,    /* 84: of_features_request */
    ...
    0,    /* 99: of_group_desc_stats_reply */
    0,    /* 100: of_group_desc_stats_request */
    0,    /* 101: of_group_features_stats_reply */
    0,    /* 102: of_group_features_stats_request */
    0,    /* 103: of_group_mod */
    0,    /* 104: of_group_mod_failed_error_msg */
    0,    /* 105: of_group_modify */
    0,    /* 106: of_group_stats_reply */
    ...
    0,    /* 134: of_queue_stats_request */
    0,    /* 135: of_role_reply */
    0,    /* 136: of_role_request */
    0,    /* 137: of_role_request_failed_error_msg */
    0,    /* 138: of_set_config */
    0,    /* 139: of_stats_reply */
    0,    /* 140: of_stats_request */
    0,    /* 141: of_switch_config_failed_error_msg */
    ...
    0,    /* 264: of_oxm */
    0,    /* 265: of_oxm_arp_op */
    0,    /* 266: of_oxm_arp_op_masked */
    0,    /* 267: of_oxm_arp_sha */
    0,    /* 268: of_oxm_arp_sha_masked */
    0,    /* 269: of_oxm_arp_spa */
    0,    /* 270: of_oxm_arp_spa_masked */
    0,    /* 271: of_oxm_arp_tha */
    0,    /* 272: of_oxm_arp_tha_masked */
    0,    /* 273: of_oxm_arp_tpa */
    0,    /* 274: of_oxm_arp_tpa_masked */
    0,    /* 275: of_oxm_bsn_global_vrf_allowed */
    0,    /* 276: of_oxm_bsn_global_vrf_allowed_masked */
    0,    /* 277: of_oxm_bsn_in_ports_128 */
    0,    /* 278: of_oxm_bsn_in_ports_128_masked */
    0,    /* 279: of_oxm_bsn_l3_dst_class_id */
    0,    /* 280: of_oxm_bsn_l3_dst_class_id_masked */
    0,    /* 281: of_oxm_bsn_l3_interface_class_id */
    0,    /* 282: of_oxm_bsn_l3_interface_class_id_masked */
    0,    /* 283: of_oxm_bsn_l3_src_class_id */
    0,    /* 284: of_oxm_bsn_l3_src_class_id_masked */
    0,    /* 285: of_oxm_bsn_lag_id */
    0,    /* 286: of_oxm_bsn_lag_id_masked */
    0,    /* 287: of_oxm_bsn_vrf */
    0,    /* 288: of_oxm_bsn_vrf_masked */
    0,    /* 289: of_oxm_eth_dst */
    0,    /* 290: of_oxm_eth_dst_masked */
    0,    /* 291: of_oxm_eth_src */
    0,    /* 292: of_oxm_eth_src_masked */
    0,    /* 293: of_oxm_eth_type */
    0,    /* 294: of_oxm_eth_type_masked */
    0,    /* 295: of_oxm_header */
    0,    /* 296: of_oxm_icmpv4_code */
    0,    /* 297: of_oxm_icmpv4_code_masked */
    0,    /* 298: of_oxm_icmpv4_type */
    0,    /* 299: of_oxm_icmpv4_type_masked */
    0,    /* 300: of_oxm_icmpv6_code */
    0,    /* 301: of_oxm_icmpv6_code_masked */
    0,    /* 302: of_oxm_icmpv6_type */
    0,    /* 303: of_oxm_icmpv6_type_masked */
    0,    /* 304: of_oxm_in_phy_port */
    0,    /* 305: of_oxm_in_phy_port_masked */
    0,    /* 306: of_oxm_in_port */
    0,    /* 307: of_oxm_in_port_masked */
    0,    /* 308: of_oxm_ip_dscp */
    0,    /* 309: of_oxm_ip_dscp_masked */
    0,    /* 310: of_oxm_ip_ecn */
    0,    /* 311: of_oxm_ip_ecn_masked */
    0,    /* 312: of_oxm_ip_proto */
    0,    /* 313: of_oxm_ip_proto_masked */
    0,    /* 314: of_oxm_ipv4_dst */
    0,    /* 315: of_oxm_ipv4_dst_masked */
    0,    /* 316: of_oxm_ipv4_src */
    0,    /* 317: of_oxm_ipv4_src_masked */
    0,    /* 318: of_oxm_ipv6_dst */
    0,    /* 319: of_oxm_ipv6_dst_masked */
    0,    /* 320: of_oxm_ipv6_flabel */
    0,    /* 321: of_oxm_ipv6_flabel_masked */
    0,    /* 322: of_oxm_ipv6_nd_sll */
    0,    /* 323: of_oxm_ipv6_nd_sll_masked */
    0,    /* 324: of_oxm_ipv6_nd_target */
    0,    /* 325: of_oxm_ipv6_nd_target_masked */
    0,    /* 326: of_oxm_ipv6_nd_tll */
    0,    /* 327: of_oxm_ipv6_nd_tll_masked */
    0,    /* 328: of_oxm_ipv6_src */
    0,    /* 329: of_oxm_ipv6_src_masked */
    0,    /* 330: of_oxm_metadata */
    0,    /* 331: of_oxm_metadata_masked */
    0,    /* 332: of_oxm_mpls_label */
    0,    /* 333: of_oxm_mpls_label_masked */
    0,    /* 334: of_oxm_mpls_tc */
    0,    /* 335: of_oxm_mpls_tc_masked */
    0,    /* 336: of_oxm_sctp_dst */
    0,    /* 337: of_oxm_sctp_dst_masked */
    0,    /* 338: of_oxm_sctp_src */
    0,    /* 339: of_oxm_sctp_src_masked */
    0,    /* 340: of_oxm_tcp_dst */
    0,    /* 341: of_oxm_tcp_dst_masked */
    0,    /* 342: of_oxm_tcp_src */
    0,    /* 343: of_oxm_tcp_src_masked */
    0,    /* 344: of_oxm_udp_dst */
    0,    /* 345: of_oxm_udp_dst_masked */
    0,    /* 346: of_oxm_udp_src */
    0,    /* 347: of_oxm_udp_src_masked */
    0,    /* 348: of_oxm_vlan_pcp */
    0,    /* 349: of_oxm_vlan_pcp_masked */
    0,    /* 350: of_oxm_vlan_vid */
    0,    /* 351: of_oxm_vlan_vid_masked */
    0,    /* 352: of_packet_queue */
    0,    /* 353: of_port_desc */
    0,    /* 354: of_port_stats_entry */
    0,    /* 355: of_queue_prop */
    0,    /* 356: of_queue_prop_experimenter */
    0,    /* 357: of_queue_prop_header */
    0,    /* 358: of_queue_prop_max_rate */
    0,    /* 359: of_queue_prop_min_rate */
    0,    /* 360: of_queue_stats_entry */
    -1,   /* 361: of_table_feature_prop */
    -1,   /* 362: of_table_feature_prop_apply_actions */
...
of_object_extra_len_v4[OF_OBJECT_COUNT] = {
    ...
    0,    /* 31: of_bsn_get_mirroring_reply */
    0,    /* 32: of_bsn_get_mirroring_request */
    0,    /* 33: of_bsn_get_switch_pipeline_reply */
    0,    /* 34: of_bsn_get_switch_pipeline_request */
    0,    /* 35: of_bsn_header */
    -1,   /* 36: of_bsn_hybrid_get_reply */
    -1,   /* 37: of_bsn_hybrid_get_request */
    0,    /* 38: of_bsn_lacp_convergence_notif */
    0,    /* 39: of_bsn_lacp_stats_reply */
    0,    /* 40: of_bsn_lacp_stats_request */
    0,    /* 41: of_bsn_pdu_rx_reply */
    0,    /* 42: of_bsn_pdu_rx_request */
    0,    /* 43: of_bsn_pdu_rx_timeout */
    0,    /* 44: of_bsn_pdu_tx_reply */
    0,    /* 45: of_bsn_pdu_tx_request */
    0,    /* 46: of_bsn_port_counter_stats_reply */
    0,    /* 47: of_bsn_port_counter_stats_request */
    0,    /* 48: of_bsn_role_status */
    -1,   /* 49: of_bsn_set_ip_mask */
    -1,   /* 50: of_bsn_set_l2_table_reply */
    -1,   /* 51: of_bsn_set_l2_table_request */
    0,    /* 52: of_bsn_set_lacp_reply */
    0,    /* 53: of_bsn_set_lacp_request */
    0,    /* 54: of_bsn_set_mirroring */
    0,    /* 55: of_bsn_set_pktin_suppression_reply */
    0,    /* 56: of_bsn_set_pktin_suppression_request */
    0,    /* 57: of_bsn_set_switch_pipeline_reply */
    0,    /* 58: of_bsn_set_switch_pipeline_request */
    -1,   /* 59: of_bsn_shell_command */
    -1,   /* 60: of_bsn_shell_output */
    -1,   /* 61: of_bsn_shell_status */
    0,    /* 62: of_bsn_stats_reply */
    0,    /* 63: of_bsn_stats_request */
    0,    /* 64: of_bsn_switch_pipeline_stats_reply */
    0,    /* 65: of_bsn_switch_pipeline_stats_request */
    0,    /* 66: of_bsn_time_reply */
    0,    /* 67: of_bsn_time_request */
    0,    /* 68: of_bsn_virtual_port_create_reply */
    0,    /* 69: of_bsn_virtual_port_create_request */
    0,    /* 70: of_bsn_virtual_port_remove_reply */
    0,    /* 71: of_bsn_virtual_port_remove_request */
    0,    /* 72: of_bsn_vlan_counter_stats_reply */
    0,    /* 73: of_bsn_vlan_counter_stats_request */
    0,    /* 74: of_desc_stats_reply */
    0,    /* 75: of_desc_stats_request */
    0,    /* 76: of_echo_reply */
    0,    /* 77: of_echo_request */
    ...
    0,    /* 108: of_hello */
    0,    /* 109: of_hello_failed_error_msg */
    0,    /* 110: of_meter_config_stats_reply */
    0,    /* 111: of_meter_config_stats_request */
    0,    /* 112: of_meter_features_stats_reply */
    0,    /* 113: of_meter_features_stats_request */
    0,    /* 114: of_meter_mod */
    0,    /* 115: of_meter_mod_failed_error_msg */
    0,    /* 116: of_meter_stats_reply */
    0,    /* 117: of_meter_stats_request */
    -1,   /* 118: of_nicira_controller_role_reply */
    -1,   /* 119: of_nicira_controller_role_request */
    0,    /* 120: of_nicira_header */
    2,    /* 121: of_packet_in */
    0,    /* 122: of_packet_out */
    0,    /* 123: of_port_desc_stats_reply */
    0,    /* 124: of_port_desc_stats_request */
    0,    /* 125: of_port_mod */
    0,    /* 126: of_port_mod_failed_error_msg */
    0,    /* 127: of_port_stats_reply */
    0,    /* 128: of_port_stats_request */
    ...
    0,    /* 140: of_stats_request */
    0,    /* 141: of_switch_config_failed_error_msg */
    0,    /* 142: of_table_features_failed_error_msg */
    0,    /* 143: of_table_features_stats_reply */
    0,    /* 144: of_table_features_stats_request */
    0,    /* 145: of_table_mod */
    0,    /* 146: of_table_mod_failed_error_msg */
    0,    /* 147: of_table_stats_reply */
    0,    /* 148: of_table_stats_request */
    ...
    0,    /* 160: of_action_header */
    0,    /* 161: of_action_id */
    0,    /* 162: of_action_id_bsn */
    0,    /* 163: of_action_id_bsn_mirror */
    0,    /* 164: of_action_id_bsn_set_tunnel_dst */
    0,    /* 165: of_action_id_copy_ttl_in */
    0,    /* 166: of_action_id_copy_ttl_out */
    0,    /* 167: of_action_id_dec_mpls_ttl */
    0,    /* 168: of_action_id_dec_nw_ttl */
    0,    /* 169: of_action_id_experimenter */
    0,    /* 170: of_action_id_group */
    0,    /* 171: of_action_id_header */
    0,    /* 172: of_action_id_nicira */
    0,    /* 173: of_action_id_nicira_dec_ttl */
    0,    /* 174: of_action_id_output */
    0,    /* 175: of_action_id_pop_mpls */
    0,    /* 176: of_action_id_pop_pbb */
    0,    /* 177: of_action_id_pop_vlan */
    0,    /* 178: of_action_id_push_mpls */
    0,    /* 179: of_action_id_push_pbb */
    0,    /* 180: of_action_id_push_vlan */
    0,    /* 181: of_action_id_set_field */
    0,    /* 182: of_action_id_set_mpls_ttl */
    0,    /* 183: of_action_id_set_nw_ttl */
    0,    /* 184: of_action_id_set_queue */
    0,    /* 185: of_action_nicira */
    0,    /* 186: of_action_nicira_dec_ttl */
    0,    /* 187: of_action_output */
    0,    /* 188: of_action_pop_mpls */
    0,    /* 189: of_action_pop_pbb */
    0,    /* 190: of_action_pop_vlan */
    0,    /* 191: of_action_push_mpls */
    0,    /* 192: of_action_push_pbb */
    0,    /* 193: of_action_push_vlan */
    -1,   /* 194: of_action_set_dl_dst */
    -1,   /* 195: of_action_set_dl_src */
    0,    /* 196: of_action_set_field */
    ...
    -1,   /* 209: of_action_set_vlan_vid */
    -1,   /* 210: of_action_strip_vlan */
    0,    /* 211: of_bsn_controller_connection */
    0,    /* 212: of_bsn_interface */
    0,    /* 213: of_bsn_lacp_stats_entry */
    0,    /* 214: of_bsn_port_counter_stats_entry */
    0,    /* 215: of_bsn_switch_pipeline_stats_entry */
    0,    /* 216: of_bsn_vlan_counter_stats_entry */
    0,    /* 217: of_bsn_vport */
    0,    /* 218: of_bsn_vport_header */
    0,    /* 219: of_bsn_vport_q_in_q */
    0,    /* 220: of_bucket */
    0,    /* 221: of_bucket_counter */
    0,    /* 222: of_experimenter_stats_header */
    0,    /* 223: of_flow_stats_entry */
    0,    /* 224: of_group_desc_stats_entry */
    0,    /* 225: of_group_stats_entry */
    0,    /* 226: of_header */
    0,    /* 227: of_hello_elem */
    0,    /* 228: of_hello_elem_header */
    0,    /* 229: of_hello_elem_versionbitmap */
    0,    /* 230: of_instruction */
    0,    /* 231: of_instruction_apply_actions */
    0,    /* 232: of_instruction_bsn */
    0,    /* 233: of_instruction_bsn_disable_src_mac_check */
    0,    /* 234: of_instruction_clear_actions */
    0,    /* 235: of_instruction_experimenter */
    0,    /* 236: of_instruction_goto_table */
    0,    /* 237: of_instruction_header */
    0,    /* 238: of_instruction_id */
    0,    /* 239: of_instruction_id_apply_actions */
    0,    /* 240: of_instruction_id_bsn */
    0,    /* 241: of_instruction_id_bsn_disable_src_mac_check */
    0,    /* 242: of_instruction_id_clear_actions */
    0,    /* 243: of_instruction_id_experimenter */
    0,    /* 244: of_instruction_id_goto_table */
    0,    /* 245: of_instruction_id_header */
    0,    /* 246: of_instruction_id_meter */
    0,    /* 247: of_instruction_id_write_actions */
    0,    /* 248: of_instruction_id_write_metadata */
    0,    /* 249: of_instruction_meter */
    0,    /* 250: of_instruction_write_actions */
    0,    /* 251: of_instruction_write_metadata */
    -1,   /* 252: of_match_v1 */
    -1,   /* 253: of_match_v2 */
    0,    /* 254: of_match_v3 */
    0,    /* 255: of_meter_band */
    0,    /* 256: of_meter_band_drop */
    0,    /* 257: of_meter_band_dscp_remark */
    0,    /* 258: of_meter_band_experimenter */
    0,    /* 259: of_meter_band_header */
    0,    /* 260: of_meter_band_stats */
    0,    /* 261: of_meter_config */
    0,    /* 262: of_meter_features */
    0,    /* 263: of_meter_stats */
    0,    /* 264: of_oxm */
    0,    /* 265: of_oxm_arp_op */
    0,    /* 266: of_oxm_arp_op_masked */
    0,    /* 267: of_oxm_arp_sha */
    ...
    0,    /* 359: of_queue_prop_min_rate */
    0,    /* 360: of_queue_stats_entry */
    0,    /* 361: of_table_feature_prop */
    0,    /* 362: of_table_feature_prop_apply_actions */
    0,    /* 363: of_table_feature_prop_apply_actions_miss */
    0,    /* 364: of_table_feature_prop_apply_setfield */
    0,    /* 365: of_table_feature_prop_apply_setfield_miss */
    0,    /* 366: of_table_feature_prop_experimenter */
    0,    /* 367: of_table_feature_prop_header */
    0,    /* 368: of_table_feature_prop_instructions */
    0,    /* 369: of_table_feature_prop_instructions_miss */
    0,    /* 370: of_table_feature_prop_match */
    0,    /* 371: of_table_feature_prop_next_tables */
    0,    /* 372: of_table_feature_prop_next_tables_miss */
    0,    /* 373: of_table_feature_prop_wildcards */
    0,    /* 374: of_table_feature_prop_write_actions */
    0,    /* 375: of_table_feature_prop_write_actions_miss */
    0,    /* 376: of_table_feature_prop_write_setfield */
    0,    /* 377: of_table_feature_prop_write_setfield_miss */
    0,    /* 378: of_table_features */
    0,    /* 379: of_table_stats_entry */
    0,    /* 380: of_uint32 */
    0,    /* 381: of_uint64 */
    0,    /* 382: of_uint8 */
