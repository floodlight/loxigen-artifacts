...
int
of_list_port_stats_entry_next(of_list_port_stats_entry_t *list, of_port_stats_entry_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_port_stats_entry_append_bind(of_list_port_stats_entry_t *list, of_port_stats_entry_t *obj)
{
...
int
of_list_port_stats_entry_append(of_list_port_stats_entry_t *list, of_port_stats_entry_t *obj)
{
