...
int
of_list_bsn_tlv_first(of_list_bsn_tlv_t *list, of_list_iter_t iter)
{
    int rv;
...
int
of_list_bsn_tlv_next(of_list_bsn_tlv_t *list, of_list_iter_t iter)
{
    int rv;
    of_object_t *obj = iter.obj;
...
int
of_list_bsn_tlv_append_bind(of_list_bsn_tlv_t *list, of_list_iter_t iter)
{
...
int
of_list_bsn_tlv_append(of_list_bsn_tlv_t *list, of_list_iter_t iter)
{
