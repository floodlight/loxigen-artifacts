...
/**
 * Get value from an object of type of_bsn_tlv_active.
 * @param obj Pointer to an object of type of_bsn_tlv_active.
 * @param value Pointer to the child object of type
 * of_octets_t to be filled out.
 *
 */
void
of_bsn_tlv_active_value_get(
    ...
    of_octets_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_BSN_TLV_ACTIVE);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_bsn_tlv_active.
 * @param obj Pointer to an object of type of_bsn_tlv_active.
 * @param value The value to write into the object
 */
int WARN_UNUSED_RESULT
of_bsn_tlv_active_value_set(
    of_bsn_tlv_active_t *obj,
    of_octets_t *value)
{
    of_wire_buffer_t *wbuf;
