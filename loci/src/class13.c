    ...
    case OF_VERSION_1_3: {
        ...
        case 0xb5:
            *id = OF_BSN_TLV_PIM_HELLO_FLOOD;
            break;
        case 0xb6:
            *id = OF_BSN_TLV_BUM_PACKET;
            break;
        case 0xb7:
            *id = OF_BSN_TLV_FLOW_CLASSIFY_ENABLE;
            break;
        case 0xb8:
            *id = OF_BSN_TLV_FLOW_CLASS_ID;
            break;
        default:
            *id = OF_BSN_TLV;
            break;
...
void
of_bsn_tlv_bum_packet_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_bsn_tlv_bum_packet of_bsn_tlv_bum_packet
 */

/**
 * Create a new of_bsn_tlv_bum_packet object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_bsn_tlv_bum_packet_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_BUM_PACKET];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_bum_packet_init(obj, version, bytes, 0);
    of_bsn_tlv_bum_packet_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_bsn_tlv_bum_packet.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_bsn_tlv_bum_packet_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_BSN_TLV_BUM_PACKET] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_BSN_TLV_BUM_PACKET;
