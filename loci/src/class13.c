 ...
 */
static inline int
of_bsn_tlv_udp_dst_push_wire_values(of_bsn_tlv_udp_dst_t *obj)
{
...
of_bsn_tlv_udp_dst_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_UDP_DST] + of_object_extra_len[version][OF_BSN_TLV_UDP_DST];

    if ((obj = (of_bsn_tlv_udp_dst_t *)of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_udp_dst_init(obj, version, bytes, 0);

    if (of_bsn_tlv_udp_dst_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
void
of_bsn_tlv_udp_dst_init(of_bsn_tlv_udp_dst_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
 ...
 */
static inline int
of_bsn_tlv_udp_src_push_wire_values(of_bsn_tlv_udp_src_t *obj)
{
...
of_bsn_tlv_udp_src_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_BSN_TLV_UDP_SRC] + of_object_extra_len[version][OF_BSN_TLV_UDP_SRC];

    if ((obj = (of_bsn_tlv_udp_src_t *)of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_bsn_tlv_udp_src_init(obj, version, bytes, 0);

    if (of_bsn_tlv_udp_src_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
void
of_bsn_tlv_udp_src_init(of_bsn_tlv_udp_src_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
 ...
 */
static inline int
of_instruction_bsn_disable_vlan_counters_push_wire_values(of_instruction_bsn_disable_vlan_counters_t *obj)
{
...
of_instruction_bsn_disable_vlan_counters_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS] + of_object_extra_len[version][OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS];

    if ((obj = (of_instruction_bsn_disable_vlan_counters_t *)of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_instruction_bsn_disable_vlan_counters_init(obj, version, bytes, 0);

    if (of_instruction_bsn_disable_vlan_counters_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
void
of_instruction_bsn_disable_vlan_counters_init(of_instruction_bsn_disable_vlan_counters_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
 ...
 */
static inline int
of_instruction_id_bsn_disable_vlan_counters_push_wire_values(of_instruction_id_bsn_disable_vlan_counters_t *obj)
{
...
of_instruction_id_bsn_disable_vlan_counters_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS] + of_object_extra_len[version][OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS];

    if ((obj = (of_instruction_id_bsn_disable_vlan_counters_t *)of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_instruction_id_bsn_disable_vlan_counters_init(obj, version, bytes, 0);

    if (of_instruction_id_bsn_disable_vlan_counters_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
void
of_instruction_id_bsn_disable_vlan_counters_init(of_instruction_id_bsn_disable_vlan_counters_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
