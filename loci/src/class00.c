...
void
of_action_nicira_exit_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_0:
...
/**
 * \defgroup of_action_nicira_exit of_action_nicira_exit
 */

/**
 * Create a new of_action_nicira_exit object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_nicira_exit_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_ACTION_NICIRA_EXIT];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_action_nicira_exit_init(obj, version, bytes, 0);
    of_action_nicira_exit_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_action_nicira_exit.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_nicira_exit_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_NICIRA_EXIT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_NICIRA_EXIT;
...
/**
 * Get experimenter from an object of type of_action_nicira_exit.
 * @param obj Pointer to an object of type of_action_nicira_exit.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_nicira_exit_experimenter_get(
    ...
    uint32_t *experimenter)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_NICIRA_EXIT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_nicira_exit.
 * @param obj Pointer to an object of type of_action_nicira_exit.
 * @param experimenter The value to write into the object
 */
void
of_action_nicira_exit_experimenter_set(
    of_action_nicira_exit_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_nicira_exit.
 * @param obj Pointer to an object of type of_action_nicira_exit.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_nicira_exit_subtype_get(
    of_action_nicira_exit_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_nicira_exit.
 * @param obj Pointer to an object of type of_action_nicira_exit.
 * @param subtype The value to write into the object
 */
void
of_action_nicira_exit_subtype_set(
    of_action_nicira_exit_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get port from an object of type of_action_nicira_resubmit.
 * @param obj Pointer to an object of type of_action_nicira_resubmit.
 * @param port Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_nicira_resubmit_port_get(
    of_action_nicira_resubmit_t *obj,
    uint16_t *port)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set port in an object of type of_action_nicira_resubmit.
 * @param obj Pointer to an object of type of_action_nicira_resubmit.
 * @param port The value to write into the object
 */
void
of_action_nicira_resubmit_port_set(
    of_action_nicira_resubmit_t *obj,
    uint16_t port)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get port from an object of type of_action_nicira_resubmit_table.
 * @param obj Pointer to an object of type of_action_nicira_resubmit_table.
 * @param port Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_nicira_resubmit_table_port_get(
    of_action_nicira_resubmit_table_t *obj,
    uint16_t *port)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set port in an object of type of_action_nicira_resubmit_table.
 * @param obj Pointer to an object of type of_action_nicira_resubmit_table.
 * @param port The value to write into the object
 */
void
of_action_nicira_resubmit_table_port_set(
    of_action_nicira_resubmit_table_t *obj,
    uint16_t port)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get table_id from an object of type of_action_nicira_resubmit_table.
 * @param obj Pointer to an object of type of_action_nicira_resubmit_table.
 ...
 */
void
of_action_nicira_resubmit_table_table_id_get(
    of_action_nicira_resubmit_table_t *obj,
    uint8_t *table_id)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set table_id in an object of type of_action_nicira_resubmit_table.
 * @param obj Pointer to an object of type of_action_nicira_resubmit_table.
 * @param table_id The value to write into the object
 */
void
of_action_nicira_resubmit_table_table_id_set(
    of_action_nicira_resubmit_table_t *obj,
    uint8_t table_id)
{
    of_wire_buffer_t *wbuf;
