...
int
of_list_bsn_gentable_bucket_stats_entry_first(of_list_bsn_gentable_bucket_stats_entry_t *list, of_list_iter_t iter)
{
    int rv;
...
int
of_list_bsn_gentable_bucket_stats_entry_next(of_list_bsn_gentable_bucket_stats_entry_t *list, of_list_iter_t iter)
{
    int rv;
    of_object_t *obj = iter.obj;
...
int
of_list_bsn_gentable_bucket_stats_entry_append_bind(of_list_bsn_gentable_bucket_stats_entry_t *list, of_list_iter_t iter)
{
...
int
of_list_bsn_gentable_bucket_stats_entry_append(of_list_bsn_gentable_bucket_stats_entry_t *list, of_list_iter_t iter)
{
