...
int
of_list_bsn_gentable_bucket_stats_entry_first(of_list_bsn_gentable_bucket_stats_entry_t *list, of_bsn_gentable_bucket_stats_entry_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_bsn_gentable_bucket_stats_entry_init(_obj, list->version, -1, 1);
...
int
of_list_bsn_gentable_bucket_stats_entry_next(of_list_bsn_gentable_bucket_stats_entry_t *list, of_bsn_gentable_bucket_stats_entry_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_bsn_gentable_bucket_stats_entry_append_bind(of_list_bsn_gentable_bucket_stats_entry_t *list, of_bsn_gentable_bucket_stats_entry_t *obj)
{
...
int
of_list_bsn_gentable_bucket_stats_entry_append(of_list_bsn_gentable_bucket_stats_entry_t *list, of_bsn_gentable_bucket_stats_entry_t *obj)
{
