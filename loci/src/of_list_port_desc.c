...
int
of_list_port_desc_first(of_list_port_desc_t *list, of_port_desc_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;

    of_port_desc_init(_obj, list->version, -1, 1);
...
int
of_list_port_desc_next(of_list_port_desc_t *list, of_port_desc_t *_obj)
{
    int rv;
    of_object_t *obj = (of_object_t *)_obj;
...
int
of_list_port_desc_append_bind(of_list_port_desc_t *list, of_port_desc_t *obj)
{
...
int
of_list_port_desc_append(of_list_port_desc_t *list, of_port_desc_t *obj)
{
