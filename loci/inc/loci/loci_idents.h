...
/*
 * Defines for OFP_BSN_CCF_FEATURE_ADD_PEER_ON_EMPTY
 * Original name OFP_BSN_CCF_FEATURE_ADD_PEER_ON_EMPTY
 */
#define OFP_BSN_CCF_FEATURE_ADD_PEER_ON_EMPTY_SUPPORTED(version)      \
    (((version) == OF_VERSION_1_3) || \
     ((version) == OF_VERSION_1_4))
#define OFP_BSN_CCF_FEATURE_ADD_PEER_ON_EMPTY (0x0)
#define OFP_BSN_CCF_FEATURE_ADD_PEER_ON_EMPTY_BY_VERSION(version) (0x0)
#define OFP_BSN_CCF_FEATURE_ADD_PEER_ON_EMPTY_GENERIC 187
