...
#define OFP_BSN_BFD_ENDPOINT_REMOTE_ADMINDOWN_SUPPORTED(version)      \
    (((version) == OF_VERSION_1_3) || \
     ((version) == OF_VERSION_1_4))
#define OFP_BSN_BFD_ENDPOINT_REMOTE_ADMINDOWN (0x4)
#define OFP_BSN_BFD_ENDPOINT_REMOTE_ADMINDOWN_BY_VERSION(version) (0x4)
...
#define OFP_BSN_BFD_ENDPOINT_SESSION_ERROR_SUPPORTED(version)      \
    (((version) == OF_VERSION_1_3) || \
     ((version) == OF_VERSION_1_4))
#define OFP_BSN_BFD_ENDPOINT_SESSION_ERROR (0x5)
#define OFP_BSN_BFD_ENDPOINT_SESSION_ERROR_BY_VERSION(version) (0x5)
