...
typedef enum of_object_id_e {
    ...
    OF_OXM_MPLS_LABEL = 460,
    OF_OXM_MPLS_LABEL_MASKED = 461,
    OF_OXM_MPLS_TC = 462,
    OF_OXM_MPLS_TC_MASKED = 463,
    OF_OXM_SCTP_DST = 464,
    OF_OXM_SCTP_DST_MASKED = 465,
    OF_OXM_SCTP_SRC = 466,
    OF_OXM_SCTP_SRC_MASKED = 467,
    OF_OXM_TCP_DST = 468,
    OF_OXM_TCP_DST_MASKED = 469,
    OF_OXM_TCP_SRC = 470,
    OF_OXM_TCP_SRC_MASKED = 471,
    OF_OXM_TUNNEL_ID = 472,
    OF_OXM_TUNNEL_ID_MASKED = 473,
    OF_OXM_UDP_DST = 474,
    OF_OXM_UDP_DST_MASKED = 475,
    OF_OXM_UDP_SRC = 476,
    OF_OXM_UDP_SRC_MASKED = 477,
    OF_OXM_VLAN_PCP = 478,
    OF_OXM_VLAN_PCP_MASKED = 479,
    OF_OXM_VLAN_VID = 480,
    OF_OXM_VLAN_VID_MASKED = 481,
    OF_PACKET_QUEUE = 482,
    OF_PORT_DESC = 483,
    OF_PORT_STATS_ENTRY = 484,
    OF_QUEUE_PROP = 485,
    OF_QUEUE_PROP_EXPERIMENTER = 486,
    OF_QUEUE_PROP_HEADER = 487,
    OF_QUEUE_PROP_MAX_RATE = 488,
    OF_QUEUE_PROP_MIN_RATE = 489,
    OF_QUEUE_STATS_ENTRY = 490,
    OF_TABLE_FEATURE_PROP = 491,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 492,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 493,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 494,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 495,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 496,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 497,
    OF_TABLE_FEATURE_PROP_HEADER = 498,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 499,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 500,
    OF_TABLE_FEATURE_PROP_MATCH = 501,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 502,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 503,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 504,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 505,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 506,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 507,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 508,
    OF_TABLE_FEATURES = 509,
    OF_TABLE_STATS_ENTRY = 510,
    OF_UINT32 = 511,
    OF_UINT64 = 512,
    OF_UINT8 = 513,
    ...
    /* List objects */
    OF_LIST_ACTION = 514,
    OF_LIST_ACTION_ID = 515,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 516,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 517,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 518,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 519,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 520,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 521,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 522,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 523,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 524,
    OF_LIST_BSN_INTERFACE = 525,
    OF_LIST_BSN_LACP_STATS_ENTRY = 526,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 527,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 528,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 529,
    OF_LIST_BSN_TLV = 530,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 531,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 532,
    OF_LIST_BUCKET = 533,
    OF_LIST_BUCKET_COUNTER = 534,
    OF_LIST_FLOW_STATS_ENTRY = 535,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 536,
    OF_LIST_GROUP_STATS_ENTRY = 537,
    OF_LIST_HELLO_ELEM = 538,
    OF_LIST_INSTRUCTION = 539,
    OF_LIST_INSTRUCTION_ID = 540,
    OF_LIST_METER_BAND = 541,
    OF_LIST_METER_BAND_STATS = 542,
    OF_LIST_METER_STATS = 543,
    OF_LIST_OXM = 544,
    OF_LIST_PACKET_QUEUE = 545,
    OF_LIST_PORT_DESC = 546,
    OF_LIST_PORT_STATS_ENTRY = 547,
    OF_LIST_QUEUE_PROP = 548,
    OF_LIST_QUEUE_STATS_ENTRY = 549,
    OF_LIST_TABLE_FEATURE_PROP = 550,
    OF_LIST_TABLE_FEATURES = 551,
    OF_LIST_TABLE_STATS_ENTRY = 552,
    OF_LIST_UINT32 = 553,
    OF_LIST_UINT64 = 554,
    OF_LIST_UINT8 = 555,
