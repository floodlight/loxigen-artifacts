...
typedef enum of_object_id_e {
    ...
    OF_BSN_CONTROLLER_CONNECTIONS_REPLY = 18,
    OF_BSN_CONTROLLER_CONNECTIONS_REQUEST = 19,
    OF_BSN_FLOW_IDLE = 20,
    OF_BSN_FLOW_IDLE_ENABLE_GET_REPLY = 21,
    OF_BSN_FLOW_IDLE_ENABLE_GET_REQUEST = 22,
    OF_BSN_FLOW_IDLE_ENABLE_SET_REPLY = 23,
    OF_BSN_FLOW_IDLE_ENABLE_SET_REQUEST = 24,
    OF_BSN_GENTABLE_BUCKET_STATS_REPLY = 25,
    OF_BSN_GENTABLE_BUCKET_STATS_REQUEST = 26,
    OF_BSN_GENTABLE_CLEAR_REPLY = 27,
    OF_BSN_GENTABLE_CLEAR_REQUEST = 28,
    OF_BSN_GENTABLE_DESC_STATS_REPLY = 29,
    OF_BSN_GENTABLE_DESC_STATS_REQUEST = 30,
    OF_BSN_GENTABLE_ENTRY_ADD = 31,
    OF_BSN_GENTABLE_ENTRY_DELETE = 32,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_REPLY = 33,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_REQUEST = 34,
    OF_BSN_GENTABLE_ENTRY_STATS_REPLY = 35,
    OF_BSN_GENTABLE_ENTRY_STATS_REQUEST = 36,
    OF_BSN_GENTABLE_SET_BUCKETS_SIZE = 37,
    OF_BSN_GENTABLE_STATS_REPLY = 38,
    OF_BSN_GENTABLE_STATS_REQUEST = 39,
    OF_BSN_GET_INTERFACES_REPLY = 40,
    OF_BSN_GET_INTERFACES_REQUEST = 41,
    OF_BSN_GET_IP_MASK_REPLY = 42,
    OF_BSN_GET_IP_MASK_REQUEST = 43,
    OF_BSN_GET_L2_TABLE_REPLY = 44,
    OF_BSN_GET_L2_TABLE_REQUEST = 45,
    OF_BSN_GET_MIRRORING_REPLY = 46,
    OF_BSN_GET_MIRRORING_REQUEST = 47,
    OF_BSN_GET_SWITCH_PIPELINE_REPLY = 48,
    OF_BSN_GET_SWITCH_PIPELINE_REQUEST = 49,
    OF_BSN_HEADER = 50,
    OF_BSN_HYBRID_GET_REPLY = 51,
    OF_BSN_HYBRID_GET_REQUEST = 52,
    OF_BSN_LACP_CONVERGENCE_NOTIF = 53,
    OF_BSN_LACP_STATS_REPLY = 54,
    OF_BSN_LACP_STATS_REQUEST = 55,
    OF_BSN_PDU_RX_REPLY = 56,
    OF_BSN_PDU_RX_REQUEST = 57,
    OF_BSN_PDU_RX_TIMEOUT = 58,
    OF_BSN_PDU_TX_REPLY = 59,
    OF_BSN_PDU_TX_REQUEST = 60,
    OF_BSN_PORT_COUNTER_STATS_REPLY = 61,
    OF_BSN_PORT_COUNTER_STATS_REQUEST = 62,
    OF_BSN_ROLE_STATUS = 63,
    OF_BSN_SET_AUX_CXNS_REPLY = 64,
    OF_BSN_SET_AUX_CXNS_REQUEST = 65,
    OF_BSN_SET_IP_MASK = 66,
    OF_BSN_SET_L2_TABLE_REPLY = 67,
    OF_BSN_SET_L2_TABLE_REQUEST = 68,
    OF_BSN_SET_LACP_REPLY = 69,
    OF_BSN_SET_LACP_REQUEST = 70,
    OF_BSN_SET_MIRRORING = 71,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 72,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 73,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 74,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 75,
    OF_BSN_SHELL_COMMAND = 76,
    OF_BSN_SHELL_OUTPUT = 77,
    OF_BSN_SHELL_STATUS = 78,
    OF_BSN_STATS_REPLY = 79,
    OF_BSN_STATS_REQUEST = 80,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 81,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 82,
    OF_BSN_TIME_REPLY = 83,
    OF_BSN_TIME_REQUEST = 84,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 85,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 86,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 87,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 88,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 89,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 90,
    OF_DESC_STATS_REPLY = 91,
    OF_DESC_STATS_REQUEST = 92,
    OF_ECHO_REPLY = 93,
    OF_ECHO_REQUEST = 94,
    OF_ERROR_MSG = 95,
    OF_EXPERIMENTER = 96,
    OF_EXPERIMENTER_ERROR_MSG = 97,
    OF_EXPERIMENTER_STATS_REPLY = 98,
    OF_EXPERIMENTER_STATS_REQUEST = 99,
    OF_FEATURES_REPLY = 100,
    OF_FEATURES_REQUEST = 101,
    OF_FLOW_ADD = 102,
    OF_FLOW_DELETE = 103,
    OF_FLOW_DELETE_STRICT = 104,
    OF_FLOW_MOD = 105,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 106,
    OF_FLOW_MODIFY = 107,
    OF_FLOW_MODIFY_STRICT = 108,
    OF_FLOW_REMOVED = 109,
    OF_FLOW_STATS_REPLY = 110,
    OF_FLOW_STATS_REQUEST = 111,
    OF_GET_CONFIG_REPLY = 112,
    OF_GET_CONFIG_REQUEST = 113,
    OF_GROUP_ADD = 114,
    OF_GROUP_DELETE = 115,
    OF_GROUP_DESC_STATS_REPLY = 116,
    OF_GROUP_DESC_STATS_REQUEST = 117,
    OF_GROUP_FEATURES_STATS_REPLY = 118,
    OF_GROUP_FEATURES_STATS_REQUEST = 119,
    OF_GROUP_MOD = 120,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 121,
    OF_GROUP_MODIFY = 122,
    OF_GROUP_STATS_REPLY = 123,
    OF_GROUP_STATS_REQUEST = 124,
    OF_HELLO = 125,
    OF_HELLO_FAILED_ERROR_MSG = 126,
    OF_METER_CONFIG_STATS_REPLY = 127,
    OF_METER_CONFIG_STATS_REQUEST = 128,
    OF_METER_FEATURES_STATS_REPLY = 129,
    OF_METER_FEATURES_STATS_REQUEST = 130,
    OF_METER_MOD = 131,
    OF_METER_MOD_FAILED_ERROR_MSG = 132,
    OF_METER_STATS_REPLY = 133,
    OF_METER_STATS_REQUEST = 134,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 135,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 136,
    OF_NICIRA_HEADER = 137,
    OF_PACKET_IN = 138,
    OF_PACKET_OUT = 139,
    OF_PORT_DESC_STATS_REPLY = 140,
    OF_PORT_DESC_STATS_REQUEST = 141,
    OF_PORT_MOD = 142,
    OF_PORT_MOD_FAILED_ERROR_MSG = 143,
    OF_PORT_STATS_REPLY = 144,
    OF_PORT_STATS_REQUEST = 145,
    OF_PORT_STATUS = 146,
    OF_QUEUE_GET_CONFIG_REPLY = 147,
    OF_QUEUE_GET_CONFIG_REQUEST = 148,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 149,
    OF_QUEUE_STATS_REPLY = 150,
    OF_QUEUE_STATS_REQUEST = 151,
    OF_ROLE_REPLY = 152,
    OF_ROLE_REQUEST = 153,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 154,
    OF_SET_CONFIG = 155,
    OF_STATS_REPLY = 156,
    OF_STATS_REQUEST = 157,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 158,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 159,
    OF_TABLE_FEATURES_STATS_REPLY = 160,
    OF_TABLE_FEATURES_STATS_REQUEST = 161,
    OF_TABLE_MOD = 162,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 163,
    OF_TABLE_STATS_REPLY = 164,
    OF_TABLE_STATS_REQUEST = 165,

    /* Non-message objects */
    OF_ACTION = 166,
    OF_ACTION_BSN = 167,
    OF_ACTION_BSN_MIRROR = 168,
    OF_ACTION_BSN_SET_TUNNEL_DST = 169,
    OF_ACTION_COPY_TTL_IN = 170,
    OF_ACTION_COPY_TTL_OUT = 171,
    OF_ACTION_DEC_MPLS_TTL = 172,
    OF_ACTION_DEC_NW_TTL = 173,
    OF_ACTION_ENQUEUE = 174,
    OF_ACTION_EXPERIMENTER = 175,
    OF_ACTION_GROUP = 176,
    OF_ACTION_HEADER = 177,
    OF_ACTION_ID = 178,
    OF_ACTION_ID_BSN = 179,
    OF_ACTION_ID_BSN_MIRROR = 180,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 181,
    OF_ACTION_ID_COPY_TTL_IN = 182,
    OF_ACTION_ID_COPY_TTL_OUT = 183,
    OF_ACTION_ID_DEC_MPLS_TTL = 184,
    OF_ACTION_ID_DEC_NW_TTL = 185,
    OF_ACTION_ID_EXPERIMENTER = 186,
    OF_ACTION_ID_GROUP = 187,
    OF_ACTION_ID_HEADER = 188,
    OF_ACTION_ID_NICIRA = 189,
    OF_ACTION_ID_NICIRA_DEC_TTL = 190,
    OF_ACTION_ID_OUTPUT = 191,
    OF_ACTION_ID_POP_MPLS = 192,
    OF_ACTION_ID_POP_PBB = 193,
    OF_ACTION_ID_POP_VLAN = 194,
    OF_ACTION_ID_PUSH_MPLS = 195,
    OF_ACTION_ID_PUSH_PBB = 196,
    OF_ACTION_ID_PUSH_VLAN = 197,
    OF_ACTION_ID_SET_FIELD = 198,
    OF_ACTION_ID_SET_MPLS_TTL = 199,
    OF_ACTION_ID_SET_NW_TTL = 200,
    OF_ACTION_ID_SET_QUEUE = 201,
    OF_ACTION_NICIRA = 202,
    OF_ACTION_NICIRA_DEC_TTL = 203,
    OF_ACTION_OUTPUT = 204,
    OF_ACTION_POP_MPLS = 205,
    OF_ACTION_POP_PBB = 206,
    OF_ACTION_POP_VLAN = 207,
    OF_ACTION_PUSH_MPLS = 208,
    OF_ACTION_PUSH_PBB = 209,
    OF_ACTION_PUSH_VLAN = 210,
    OF_ACTION_SET_DL_DST = 211,
    OF_ACTION_SET_DL_SRC = 212,
    OF_ACTION_SET_FIELD = 213,
    OF_ACTION_SET_MPLS_LABEL = 214,
    OF_ACTION_SET_MPLS_TC = 215,
    OF_ACTION_SET_MPLS_TTL = 216,
    OF_ACTION_SET_NW_DST = 217,
    OF_ACTION_SET_NW_ECN = 218,
    OF_ACTION_SET_NW_SRC = 219,
    OF_ACTION_SET_NW_TOS = 220,
    OF_ACTION_SET_NW_TTL = 221,
    OF_ACTION_SET_QUEUE = 222,
    OF_ACTION_SET_TP_DST = 223,
    OF_ACTION_SET_TP_SRC = 224,
    OF_ACTION_SET_VLAN_PCP = 225,
    OF_ACTION_SET_VLAN_VID = 226,
    OF_ACTION_STRIP_VLAN = 227,
    OF_BSN_CONTROLLER_CONNECTION = 228,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 229,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 230,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 231,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 232,
    OF_BSN_GENTABLE_STATS_ENTRY = 233,
    OF_BSN_INTERFACE = 234,
    OF_BSN_LACP_STATS_ENTRY = 235,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 236,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 237,
    OF_BSN_TLV = 238,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 239,
    OF_BSN_TLV_HEADER = 240,
    OF_BSN_TLV_IDLE_NOTIFICATION = 241,
    OF_BSN_TLV_IDLE_TIME = 242,
    OF_BSN_TLV_IDLE_TIMEOUT = 243,
    OF_BSN_TLV_IPV4 = 244,
    OF_BSN_TLV_MAC = 245,
    OF_BSN_TLV_MISS_PACKETS = 246,
    OF_BSN_TLV_PORT = 247,
    OF_BSN_TLV_REPLY_PACKETS = 248,
    OF_BSN_TLV_REQUEST_PACKETS = 249,
    OF_BSN_TLV_RX_PACKETS = 250,
    OF_BSN_TLV_TX_PACKETS = 251,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 252,
    OF_BSN_TLV_VLAN_VID = 253,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 254,
    OF_BSN_VPORT = 255,
    OF_BSN_VPORT_HEADER = 256,
    OF_BSN_VPORT_Q_IN_Q = 257,
    OF_BUCKET = 258,
    OF_BUCKET_COUNTER = 259,
    OF_EXPERIMENTER_STATS_HEADER = 260,
    OF_FLOW_STATS_ENTRY = 261,
    OF_GROUP_DESC_STATS_ENTRY = 262,
    OF_GROUP_STATS_ENTRY = 263,
    OF_HEADER = 264,
    OF_HELLO_ELEM = 265,
    OF_HELLO_ELEM_HEADER = 266,
    OF_HELLO_ELEM_VERSIONBITMAP = 267,
    OF_INSTRUCTION = 268,
    OF_INSTRUCTION_APPLY_ACTIONS = 269,
    OF_INSTRUCTION_BSN = 270,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 271,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 272,
    OF_INSTRUCTION_CLEAR_ACTIONS = 273,
    OF_INSTRUCTION_EXPERIMENTER = 274,
    OF_INSTRUCTION_GOTO_TABLE = 275,
    OF_INSTRUCTION_HEADER = 276,
    OF_INSTRUCTION_ID = 277,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 278,
    OF_INSTRUCTION_ID_BSN = 279,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 280,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 281,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 282,
    OF_INSTRUCTION_ID_EXPERIMENTER = 283,
    OF_INSTRUCTION_ID_GOTO_TABLE = 284,
    OF_INSTRUCTION_ID_HEADER = 285,
    OF_INSTRUCTION_ID_METER = 286,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 287,
    OF_INSTRUCTION_ID_WRITE_METADATA = 288,
    OF_INSTRUCTION_METER = 289,
    OF_INSTRUCTION_WRITE_ACTIONS = 290,
    OF_INSTRUCTION_WRITE_METADATA = 291,
    OF_MATCH_V1 = 292,
    OF_MATCH_V2 = 293,
    OF_MATCH_V3 = 294,
    OF_METER_BAND = 295,
    OF_METER_BAND_DROP = 296,
    OF_METER_BAND_DSCP_REMARK = 297,
    OF_METER_BAND_EXPERIMENTER = 298,
    OF_METER_BAND_HEADER = 299,
    OF_METER_BAND_STATS = 300,
    OF_METER_CONFIG = 301,
    OF_METER_FEATURES = 302,
    OF_METER_STATS = 303,
    OF_OXM = 304,
    OF_OXM_ARP_OP = 305,
    OF_OXM_ARP_OP_MASKED = 306,
    OF_OXM_ARP_SHA = 307,
    OF_OXM_ARP_SHA_MASKED = 308,
    OF_OXM_ARP_SPA = 309,
    OF_OXM_ARP_SPA_MASKED = 310,
    OF_OXM_ARP_THA = 311,
    OF_OXM_ARP_THA_MASKED = 312,
    OF_OXM_ARP_TPA = 313,
    OF_OXM_ARP_TPA_MASKED = 314,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 315,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 316,
    OF_OXM_BSN_IN_PORTS_128 = 317,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 318,
    OF_OXM_BSN_L3_DST_CLASS_ID = 319,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 320,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 321,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 322,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 323,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 324,
    OF_OXM_BSN_LAG_ID = 325,
    OF_OXM_BSN_LAG_ID_MASKED = 326,
    OF_OXM_BSN_VRF = 327,
    OF_OXM_BSN_VRF_MASKED = 328,
    OF_OXM_ETH_DST = 329,
    OF_OXM_ETH_DST_MASKED = 330,
    OF_OXM_ETH_SRC = 331,
    OF_OXM_ETH_SRC_MASKED = 332,
    OF_OXM_ETH_TYPE = 333,
    OF_OXM_ETH_TYPE_MASKED = 334,
    OF_OXM_HEADER = 335,
    OF_OXM_ICMPV4_CODE = 336,
    OF_OXM_ICMPV4_CODE_MASKED = 337,
    OF_OXM_ICMPV4_TYPE = 338,
    OF_OXM_ICMPV4_TYPE_MASKED = 339,
    OF_OXM_ICMPV6_CODE = 340,
    OF_OXM_ICMPV6_CODE_MASKED = 341,
    OF_OXM_ICMPV6_TYPE = 342,
    OF_OXM_ICMPV6_TYPE_MASKED = 343,
    OF_OXM_IN_PHY_PORT = 344,
    OF_OXM_IN_PHY_PORT_MASKED = 345,
    OF_OXM_IN_PORT = 346,
    OF_OXM_IN_PORT_MASKED = 347,
    OF_OXM_IP_DSCP = 348,
    OF_OXM_IP_DSCP_MASKED = 349,
    OF_OXM_IP_ECN = 350,
    OF_OXM_IP_ECN_MASKED = 351,
    OF_OXM_IP_PROTO = 352,
    OF_OXM_IP_PROTO_MASKED = 353,
    OF_OXM_IPV4_DST = 354,
    OF_OXM_IPV4_DST_MASKED = 355,
    OF_OXM_IPV4_SRC = 356,
    OF_OXM_IPV4_SRC_MASKED = 357,
    OF_OXM_IPV6_DST = 358,
    OF_OXM_IPV6_DST_MASKED = 359,
    OF_OXM_IPV6_FLABEL = 360,
    OF_OXM_IPV6_FLABEL_MASKED = 361,
    OF_OXM_IPV6_ND_SLL = 362,
    OF_OXM_IPV6_ND_SLL_MASKED = 363,
    OF_OXM_IPV6_ND_TARGET = 364,
    OF_OXM_IPV6_ND_TARGET_MASKED = 365,
    OF_OXM_IPV6_ND_TLL = 366,
    OF_OXM_IPV6_ND_TLL_MASKED = 367,
    OF_OXM_IPV6_SRC = 368,
    OF_OXM_IPV6_SRC_MASKED = 369,
    OF_OXM_METADATA = 370,
    OF_OXM_METADATA_MASKED = 371,
    OF_OXM_MPLS_LABEL = 372,
    OF_OXM_MPLS_LABEL_MASKED = 373,
    OF_OXM_MPLS_TC = 374,
    OF_OXM_MPLS_TC_MASKED = 375,
    OF_OXM_SCTP_DST = 376,
    OF_OXM_SCTP_DST_MASKED = 377,
    OF_OXM_SCTP_SRC = 378,
    OF_OXM_SCTP_SRC_MASKED = 379,
    OF_OXM_TCP_DST = 380,
    OF_OXM_TCP_DST_MASKED = 381,
    OF_OXM_TCP_SRC = 382,
    OF_OXM_TCP_SRC_MASKED = 383,
    OF_OXM_UDP_DST = 384,
    OF_OXM_UDP_DST_MASKED = 385,
    OF_OXM_UDP_SRC = 386,
    OF_OXM_UDP_SRC_MASKED = 387,
    OF_OXM_VLAN_PCP = 388,
    OF_OXM_VLAN_PCP_MASKED = 389,
    OF_OXM_VLAN_VID = 390,
    OF_OXM_VLAN_VID_MASKED = 391,
    OF_PACKET_QUEUE = 392,
    OF_PORT_DESC = 393,
    OF_PORT_STATS_ENTRY = 394,
    OF_QUEUE_PROP = 395,
    OF_QUEUE_PROP_EXPERIMENTER = 396,
    OF_QUEUE_PROP_HEADER = 397,
    OF_QUEUE_PROP_MAX_RATE = 398,
    OF_QUEUE_PROP_MIN_RATE = 399,
    OF_QUEUE_STATS_ENTRY = 400,
    OF_TABLE_FEATURE_PROP = 401,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 402,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 403,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 404,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 405,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 406,
    OF_TABLE_FEATURE_PROP_HEADER = 407,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 408,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 409,
    OF_TABLE_FEATURE_PROP_MATCH = 410,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 411,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 412,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 413,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 414,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 415,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 416,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 417,
    OF_TABLE_FEATURES = 418,
    OF_TABLE_STATS_ENTRY = 419,
    OF_UINT32 = 420,
    OF_UINT64 = 421,
    OF_UINT8 = 422,
    ...
    /* List objects */
    OF_LIST_ACTION = 423,
    OF_LIST_ACTION_ID = 424,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 425,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 426,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 427,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 428,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 429,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 430,
    OF_LIST_BSN_INTERFACE = 431,
    OF_LIST_BSN_LACP_STATS_ENTRY = 432,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 433,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 434,
    OF_LIST_BSN_TLV = 435,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 436,
    OF_LIST_BUCKET = 437,
    OF_LIST_BUCKET_COUNTER = 438,
    OF_LIST_FLOW_STATS_ENTRY = 439,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 440,
    OF_LIST_GROUP_STATS_ENTRY = 441,
    OF_LIST_HELLO_ELEM = 442,
    OF_LIST_INSTRUCTION = 443,
    OF_LIST_METER_BAND = 444,
    OF_LIST_METER_BAND_STATS = 445,
    OF_LIST_METER_STATS = 446,
    OF_LIST_OXM = 447,
    OF_LIST_PACKET_QUEUE = 448,
    OF_LIST_PORT_DESC = 449,
    OF_LIST_PORT_STATS_ENTRY = 450,
    OF_LIST_QUEUE_PROP = 451,
    OF_LIST_QUEUE_STATS_ENTRY = 452,
    OF_LIST_TABLE_FEATURE_PROP = 453,
    OF_LIST_TABLE_FEATURES = 454,
    OF_LIST_TABLE_STATS_ENTRY = 455,
    OF_LIST_UINT32 = 456,
    OF_LIST_UINT64 = 457,
    OF_LIST_UINT8 = 458,
...
#define OF_MESSAGE_OBJECT_COUNT 166
