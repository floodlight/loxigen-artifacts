...
typedef enum of_object_id_e {
    ...
    OF_EXPERIMENTER_STATS_REPLY = 108,
    OF_EXPERIMENTER_STATS_REQUEST = 109,
    OF_FEATURES_REPLY = 110,
    OF_FEATURES_REQUEST = 111,
    OF_FLOW_ADD = 112,
    OF_FLOW_DELETE = 113,
    OF_FLOW_DELETE_STRICT = 114,
    OF_FLOW_MOD = 115,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 116,
    OF_FLOW_MODIFY = 117,
    OF_FLOW_MODIFY_STRICT = 118,
    OF_FLOW_REMOVED = 119,
    OF_FLOW_STATS_REPLY = 120,
    OF_FLOW_STATS_REQUEST = 121,
    OF_GET_CONFIG_REPLY = 122,
    OF_GET_CONFIG_REQUEST = 123,
    OF_GROUP_ADD = 124,
    OF_GROUP_DELETE = 125,
    OF_GROUP_DESC_STATS_REPLY = 126,
    OF_GROUP_DESC_STATS_REQUEST = 127,
    OF_GROUP_FEATURES_STATS_REPLY = 128,
    OF_GROUP_FEATURES_STATS_REQUEST = 129,
    OF_GROUP_MOD = 130,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 131,
    OF_GROUP_MODIFY = 132,
    OF_GROUP_STATS_REPLY = 133,
    OF_GROUP_STATS_REQUEST = 134,
    OF_HELLO = 135,
    OF_HELLO_FAILED_ERROR_MSG = 136,
    OF_METER_CONFIG_STATS_REPLY = 137,
    OF_METER_CONFIG_STATS_REQUEST = 138,
    OF_METER_FEATURES_STATS_REPLY = 139,
    OF_METER_FEATURES_STATS_REQUEST = 140,
    OF_METER_MOD = 141,
    OF_METER_MOD_FAILED_ERROR_MSG = 142,
    OF_METER_STATS_REPLY = 143,
    OF_METER_STATS_REQUEST = 144,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 145,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 146,
    OF_NICIRA_HEADER = 147,
    OF_PACKET_IN = 148,
    OF_PACKET_OUT = 149,
    OF_PORT_DESC_STATS_REPLY = 150,
    OF_PORT_DESC_STATS_REQUEST = 151,
    OF_PORT_MOD = 152,
    OF_PORT_MOD_FAILED_ERROR_MSG = 153,
    OF_PORT_STATS_REPLY = 154,
    OF_PORT_STATS_REQUEST = 155,
    OF_PORT_STATUS = 156,
    OF_QUEUE_GET_CONFIG_REPLY = 157,
    OF_QUEUE_GET_CONFIG_REQUEST = 158,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 159,
    OF_QUEUE_STATS_REPLY = 160,
    OF_QUEUE_STATS_REQUEST = 161,
    OF_ROLE_REPLY = 162,
    OF_ROLE_REQUEST = 163,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 164,
    OF_SET_CONFIG = 165,
    OF_STATS_REPLY = 166,
    OF_STATS_REQUEST = 167,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 168,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 169,
    OF_TABLE_FEATURES_STATS_REPLY = 170,
    OF_TABLE_FEATURES_STATS_REQUEST = 171,
    OF_TABLE_MOD = 172,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 173,
    OF_TABLE_STATS_REPLY = 174,
    OF_TABLE_STATS_REQUEST = 175,

    /* Non-message objects */
    OF_ACTION = 176,
    OF_ACTION_BSN = 177,
    OF_ACTION_BSN_MIRROR = 178,
    OF_ACTION_BSN_SET_TUNNEL_DST = 179,
    OF_ACTION_COPY_TTL_IN = 180,
    OF_ACTION_COPY_TTL_OUT = 181,
    OF_ACTION_DEC_MPLS_TTL = 182,
    OF_ACTION_DEC_NW_TTL = 183,
    OF_ACTION_ENQUEUE = 184,
    OF_ACTION_EXPERIMENTER = 185,
    OF_ACTION_GROUP = 186,
    OF_ACTION_HEADER = 187,
    OF_ACTION_ID = 188,
    OF_ACTION_ID_BSN = 189,
    OF_ACTION_ID_BSN_MIRROR = 190,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 191,
    OF_ACTION_ID_COPY_TTL_IN = 192,
    OF_ACTION_ID_COPY_TTL_OUT = 193,
    OF_ACTION_ID_DEC_MPLS_TTL = 194,
    OF_ACTION_ID_DEC_NW_TTL = 195,
    OF_ACTION_ID_EXPERIMENTER = 196,
    OF_ACTION_ID_GROUP = 197,
    OF_ACTION_ID_HEADER = 198,
    OF_ACTION_ID_NICIRA = 199,
    OF_ACTION_ID_NICIRA_DEC_TTL = 200,
    OF_ACTION_ID_OUTPUT = 201,
    OF_ACTION_ID_POP_MPLS = 202,
    OF_ACTION_ID_POP_PBB = 203,
    OF_ACTION_ID_POP_VLAN = 204,
    OF_ACTION_ID_PUSH_MPLS = 205,
    OF_ACTION_ID_PUSH_PBB = 206,
    OF_ACTION_ID_PUSH_VLAN = 207,
    OF_ACTION_ID_SET_FIELD = 208,
    OF_ACTION_ID_SET_MPLS_TTL = 209,
    OF_ACTION_ID_SET_NW_TTL = 210,
    OF_ACTION_ID_SET_QUEUE = 211,
    OF_ACTION_NICIRA = 212,
    OF_ACTION_NICIRA_DEC_TTL = 213,
    OF_ACTION_OUTPUT = 214,
    OF_ACTION_POP_MPLS = 215,
    OF_ACTION_POP_PBB = 216,
    OF_ACTION_POP_VLAN = 217,
    OF_ACTION_PUSH_MPLS = 218,
    OF_ACTION_PUSH_PBB = 219,
    OF_ACTION_PUSH_VLAN = 220,
    OF_ACTION_SET_DL_DST = 221,
    OF_ACTION_SET_DL_SRC = 222,
    OF_ACTION_SET_FIELD = 223,
    OF_ACTION_SET_MPLS_LABEL = 224,
    OF_ACTION_SET_MPLS_TC = 225,
    OF_ACTION_SET_MPLS_TTL = 226,
    OF_ACTION_SET_NW_DST = 227,
    OF_ACTION_SET_NW_ECN = 228,
    OF_ACTION_SET_NW_SRC = 229,
    OF_ACTION_SET_NW_TOS = 230,
    OF_ACTION_SET_NW_TTL = 231,
    OF_ACTION_SET_QUEUE = 232,
    OF_ACTION_SET_TP_DST = 233,
    OF_ACTION_SET_TP_SRC = 234,
    OF_ACTION_SET_VLAN_PCP = 235,
    OF_ACTION_SET_VLAN_VID = 236,
    OF_ACTION_STRIP_VLAN = 237,
    OF_BSN_CONTROLLER_CONNECTION = 238,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 239,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 240,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 241,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 242,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 243,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 244,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 245,
    OF_BSN_GENTABLE_STATS_ENTRY = 246,
    OF_BSN_INTERFACE = 247,
    OF_BSN_LACP_STATS_ENTRY = 248,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 249,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 250,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 251,
    OF_BSN_TLV = 252,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 253,
    OF_BSN_TLV_CIRCUIT_ID = 254,
    OF_BSN_TLV_HEADER = 255,
    OF_BSN_TLV_IDLE_NOTIFICATION = 256,
    OF_BSN_TLV_IDLE_TIME = 257,
    OF_BSN_TLV_IDLE_TIMEOUT = 258,
    OF_BSN_TLV_IPV4 = 259,
    OF_BSN_TLV_MAC = 260,
    OF_BSN_TLV_MISS_PACKETS = 261,
    OF_BSN_TLV_PORT = 262,
    OF_BSN_TLV_REPLY_PACKETS = 263,
    OF_BSN_TLV_REQUEST_PACKETS = 264,
    OF_BSN_TLV_RX_PACKETS = 265,
    OF_BSN_TLV_TX_PACKETS = 266,
    OF_BSN_TLV_UDF_ANCHOR = 267,
    OF_BSN_TLV_UDF_ID = 268,
    OF_BSN_TLV_UDF_LENGTH = 269,
    OF_BSN_TLV_UDF_OFFSET = 270,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 271,
    OF_BSN_TLV_VLAN_VID = 272,
    OF_BSN_TLV_VRF = 273,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 274,
    OF_BSN_VPORT = 275,
    OF_BSN_VPORT_HEADER = 276,
    OF_BSN_VPORT_L2GRE = 277,
    OF_BSN_VPORT_Q_IN_Q = 278,
    OF_BUCKET = 279,
    OF_BUCKET_COUNTER = 280,
    OF_FLOW_STATS_ENTRY = 281,
    OF_GROUP_DESC_STATS_ENTRY = 282,
    OF_GROUP_STATS_ENTRY = 283,
    OF_HEADER = 284,
    OF_HELLO_ELEM = 285,
    OF_HELLO_ELEM_HEADER = 286,
    OF_HELLO_ELEM_VERSIONBITMAP = 287,
    OF_INSTRUCTION = 288,
    OF_INSTRUCTION_APPLY_ACTIONS = 289,
    OF_INSTRUCTION_BSN = 290,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 291,
    OF_INSTRUCTION_BSN_DENY = 292,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 293,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 294,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 295,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 296,
    OF_INSTRUCTION_BSN_PERMIT = 297,
    OF_INSTRUCTION_CLEAR_ACTIONS = 298,
    OF_INSTRUCTION_EXPERIMENTER = 299,
    OF_INSTRUCTION_GOTO_TABLE = 300,
    OF_INSTRUCTION_HEADER = 301,
    OF_INSTRUCTION_ID = 302,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 303,
    OF_INSTRUCTION_ID_BSN = 304,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 305,
    OF_INSTRUCTION_ID_BSN_DENY = 306,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 307,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 308,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 309,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 310,
    OF_INSTRUCTION_ID_BSN_PERMIT = 311,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 312,
    OF_INSTRUCTION_ID_EXPERIMENTER = 313,
    OF_INSTRUCTION_ID_GOTO_TABLE = 314,
    OF_INSTRUCTION_ID_HEADER = 315,
    OF_INSTRUCTION_ID_METER = 316,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 317,
    OF_INSTRUCTION_ID_WRITE_METADATA = 318,
    OF_INSTRUCTION_METER = 319,
    OF_INSTRUCTION_WRITE_ACTIONS = 320,
    OF_INSTRUCTION_WRITE_METADATA = 321,
    OF_MATCH_V1 = 322,
    OF_MATCH_V2 = 323,
    OF_MATCH_V3 = 324,
    OF_METER_BAND = 325,
    OF_METER_BAND_DROP = 326,
    OF_METER_BAND_DSCP_REMARK = 327,
    OF_METER_BAND_EXPERIMENTER = 328,
    OF_METER_BAND_HEADER = 329,
    OF_METER_BAND_STATS = 330,
    OF_METER_CONFIG = 331,
    OF_METER_FEATURES = 332,
    OF_METER_STATS = 333,
    OF_OXM = 334,
    OF_OXM_ARP_OP = 335,
    OF_OXM_ARP_OP_MASKED = 336,
    OF_OXM_ARP_SHA = 337,
    OF_OXM_ARP_SHA_MASKED = 338,
    OF_OXM_ARP_SPA = 339,
    OF_OXM_ARP_SPA_MASKED = 340,
    OF_OXM_ARP_THA = 341,
    OF_OXM_ARP_THA_MASKED = 342,
    OF_OXM_ARP_TPA = 343,
    OF_OXM_ARP_TPA_MASKED = 344,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 345,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 346,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 347,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 348,
    OF_OXM_BSN_IN_PORTS_128 = 349,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 350,
    OF_OXM_BSN_L3_DST_CLASS_ID = 351,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 352,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 353,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 354,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 355,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 356,
    OF_OXM_BSN_LAG_ID = 357,
    OF_OXM_BSN_LAG_ID_MASKED = 358,
    OF_OXM_BSN_UDF0 = 359,
    OF_OXM_BSN_UDF0_MASKED = 360,
    OF_OXM_BSN_UDF1 = 361,
    OF_OXM_BSN_UDF1_MASKED = 362,
    OF_OXM_BSN_UDF2 = 363,
    OF_OXM_BSN_UDF2_MASKED = 364,
    OF_OXM_BSN_UDF3 = 365,
    OF_OXM_BSN_UDF3_MASKED = 366,
    OF_OXM_BSN_UDF4 = 367,
    OF_OXM_BSN_UDF4_MASKED = 368,
    OF_OXM_BSN_UDF5 = 369,
    OF_OXM_BSN_UDF5_MASKED = 370,
    OF_OXM_BSN_UDF6 = 371,
    OF_OXM_BSN_UDF6_MASKED = 372,
    OF_OXM_BSN_UDF7 = 373,
    OF_OXM_BSN_UDF7_MASKED = 374,
    OF_OXM_BSN_VRF = 375,
    OF_OXM_BSN_VRF_MASKED = 376,
    OF_OXM_ETH_DST = 377,
    OF_OXM_ETH_DST_MASKED = 378,
    OF_OXM_ETH_SRC = 379,
    OF_OXM_ETH_SRC_MASKED = 380,
    OF_OXM_ETH_TYPE = 381,
    OF_OXM_ETH_TYPE_MASKED = 382,
    OF_OXM_HEADER = 383,
    OF_OXM_ICMPV4_CODE = 384,
    OF_OXM_ICMPV4_CODE_MASKED = 385,
    OF_OXM_ICMPV4_TYPE = 386,
    OF_OXM_ICMPV4_TYPE_MASKED = 387,
    OF_OXM_ICMPV6_CODE = 388,
    OF_OXM_ICMPV6_CODE_MASKED = 389,
    OF_OXM_ICMPV6_TYPE = 390,
    OF_OXM_ICMPV6_TYPE_MASKED = 391,
    OF_OXM_IN_PHY_PORT = 392,
    OF_OXM_IN_PHY_PORT_MASKED = 393,
    OF_OXM_IN_PORT = 394,
    OF_OXM_IN_PORT_MASKED = 395,
    OF_OXM_IP_DSCP = 396,
    OF_OXM_IP_DSCP_MASKED = 397,
    OF_OXM_IP_ECN = 398,
    OF_OXM_IP_ECN_MASKED = 399,
    OF_OXM_IP_PROTO = 400,
    OF_OXM_IP_PROTO_MASKED = 401,
    OF_OXM_IPV4_DST = 402,
    OF_OXM_IPV4_DST_MASKED = 403,
    OF_OXM_IPV4_SRC = 404,
    OF_OXM_IPV4_SRC_MASKED = 405,
    OF_OXM_IPV6_DST = 406,
    OF_OXM_IPV6_DST_MASKED = 407,
    OF_OXM_IPV6_FLABEL = 408,
    OF_OXM_IPV6_FLABEL_MASKED = 409,
    OF_OXM_IPV6_ND_SLL = 410,
    OF_OXM_IPV6_ND_SLL_MASKED = 411,
    OF_OXM_IPV6_ND_TARGET = 412,
    OF_OXM_IPV6_ND_TARGET_MASKED = 413,
    OF_OXM_IPV6_ND_TLL = 414,
    OF_OXM_IPV6_ND_TLL_MASKED = 415,
    OF_OXM_IPV6_SRC = 416,
    OF_OXM_IPV6_SRC_MASKED = 417,
    OF_OXM_METADATA = 418,
    OF_OXM_METADATA_MASKED = 419,
    OF_OXM_MPLS_LABEL = 420,
    OF_OXM_MPLS_LABEL_MASKED = 421,
    OF_OXM_MPLS_TC = 422,
    OF_OXM_MPLS_TC_MASKED = 423,
    OF_OXM_SCTP_DST = 424,
    OF_OXM_SCTP_DST_MASKED = 425,
    OF_OXM_SCTP_SRC = 426,
    OF_OXM_SCTP_SRC_MASKED = 427,
    OF_OXM_TCP_DST = 428,
    OF_OXM_TCP_DST_MASKED = 429,
    OF_OXM_TCP_SRC = 430,
    OF_OXM_TCP_SRC_MASKED = 431,
    OF_OXM_UDP_DST = 432,
    OF_OXM_UDP_DST_MASKED = 433,
    OF_OXM_UDP_SRC = 434,
    OF_OXM_UDP_SRC_MASKED = 435,
    OF_OXM_VLAN_PCP = 436,
    OF_OXM_VLAN_PCP_MASKED = 437,
    OF_OXM_VLAN_VID = 438,
    OF_OXM_VLAN_VID_MASKED = 439,
    OF_PACKET_QUEUE = 440,
    OF_PORT_DESC = 441,
    OF_PORT_STATS_ENTRY = 442,
    OF_QUEUE_PROP = 443,
    OF_QUEUE_PROP_EXPERIMENTER = 444,
    OF_QUEUE_PROP_HEADER = 445,
    OF_QUEUE_PROP_MAX_RATE = 446,
    OF_QUEUE_PROP_MIN_RATE = 447,
    OF_QUEUE_STATS_ENTRY = 448,
    OF_TABLE_FEATURE_PROP = 449,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 450,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 451,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 452,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 453,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 454,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 455,
    OF_TABLE_FEATURE_PROP_HEADER = 456,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 457,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 458,
    OF_TABLE_FEATURE_PROP_MATCH = 459,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 460,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 461,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 462,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 463,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 464,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 465,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 466,
    OF_TABLE_FEATURES = 467,
    OF_TABLE_STATS_ENTRY = 468,
    OF_UINT32 = 469,
    OF_UINT64 = 470,
    OF_UINT8 = 471,
    ...
    /* List objects */
    OF_LIST_ACTION = 472,
    OF_LIST_ACTION_ID = 473,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 474,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 475,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 476,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 477,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 478,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 479,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 480,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 481,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 482,
    OF_LIST_BSN_INTERFACE = 483,
    OF_LIST_BSN_LACP_STATS_ENTRY = 484,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 485,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 486,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 487,
    OF_LIST_BSN_TLV = 488,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 489,
    OF_LIST_BUCKET = 490,
    OF_LIST_BUCKET_COUNTER = 491,
    OF_LIST_FLOW_STATS_ENTRY = 492,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 493,
    OF_LIST_GROUP_STATS_ENTRY = 494,
    OF_LIST_HELLO_ELEM = 495,
    OF_LIST_INSTRUCTION = 496,
    OF_LIST_INSTRUCTION_ID = 497,
    OF_LIST_METER_BAND = 498,
    OF_LIST_METER_BAND_STATS = 499,
    OF_LIST_METER_STATS = 500,
    OF_LIST_OXM = 501,
    OF_LIST_PACKET_QUEUE = 502,
    OF_LIST_PORT_DESC = 503,
    OF_LIST_PORT_STATS_ENTRY = 504,
    OF_LIST_QUEUE_PROP = 505,
    OF_LIST_QUEUE_STATS_ENTRY = 506,
    OF_LIST_TABLE_FEATURE_PROP = 507,
    OF_LIST_TABLE_FEATURES = 508,
    OF_LIST_TABLE_STATS_ENTRY = 509,
    OF_LIST_UINT32 = 510,
    OF_LIST_UINT64 = 511,
    OF_LIST_UINT8 = 512,
...
#define OF_MESSAGE_OBJECT_COUNT 176
