...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DHCPV6_OPT_CLIENT_LL_ADDR = 330,
    OF_BSN_TLV_DHCPV6_OPT_REMOTE_ID = 331,
    ...
    OF_BSN_TLV_REPLY_PACKETS = 473,
    OF_BSN_TLV_REQUEST_PACKETS = 474,
    OF_BSN_TLV_REST_SERVER = 475,
    OF_BSN_TLV_ROUTING_PARAM = 476,
    OF_BSN_TLV_RX_BYTES = 477,
    OF_BSN_TLV_RX_PACKETS = 478,
    OF_BSN_TLV_SAMPLING_RATE = 479,
    OF_BSN_TLV_SCTP_DST = 480,
    OF_BSN_TLV_SCTP_SRC = 481,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 482,
    OF_BSN_TLV_SOCKET = 483,
    OF_BSN_TLV_SRC_MAC_CML = 484,
    ...
    OF_BSN_TLV_THREAD = 493,
    OF_BSN_TLV_TIMESTAMP = 494,
    OF_BSN_TLV_TTL = 495,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 496,
    OF_BSN_TLV_TX_BYTES = 497,
    OF_BSN_TLV_TX_PACKETS = 498,
    OF_BSN_TLV_UDF_ANCHOR = 499,
    OF_BSN_TLV_UDF_CAPABILITY = 500,
    OF_BSN_TLV_UDF_DATA = 501,
    OF_BSN_TLV_UDF_ID = 502,
    OF_BSN_TLV_UDF_LENGTH = 503,
    OF_BSN_TLV_UDF_OFFSET = 504,
    OF_BSN_TLV_UDP_DST = 505,
    OF_BSN_TLV_UDP_SRC = 506,
    OF_BSN_TLV_UINT32 = 507,
    OF_BSN_TLV_UINT64_LIST = 508,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 509,
    OF_BSN_TLV_UNICAST_RATE = 510,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 511,
    OF_BSN_TLV_UNTAGGED = 512,
    OF_BSN_TLV_UPGRADE = 513,
    OF_BSN_TLV_URI_SCHEME = 514,
    OF_BSN_TLV_USE_PACKET_STATE = 515,
    OF_BSN_TLV_USER_CONFIGURED = 516,
    OF_BSN_TLV_VFI = 517,
    OF_BSN_TLV_VFP_CLASS_ID = 518,
    OF_BSN_TLV_VIRTUAL = 519,
    OF_BSN_TLV_VLAN_MAC_LIST = 520,
    OF_BSN_TLV_VLAN_PCP = 521,
    OF_BSN_TLV_VLAN_VID = 522,
    OF_BSN_TLV_VLAN_VID_MASK = 523,
    OF_BSN_TLV_VNI = 524,
    OF_BSN_TLV_VPN_KEY = 525,
    OF_BSN_TLV_VRF = 526,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 527,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 528,
    OF_BSN_VLAN_MAC = 529,
    OF_BSN_VPORT = 530,
    OF_BSN_VPORT_L2GRE = 531,
    OF_BSN_VPORT_Q_IN_Q = 532,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 533,
    OF_BUCKET = 534,
    OF_BUCKET_COUNTER = 535,
    OF_BUNDLE_PROP = 536,
    OF_BUNDLE_PROP_EXPERIMENTER = 537,
    OF_FLOW_STATS_ENTRY = 538,
    OF_GROUP_DESC_STATS_ENTRY = 539,
    OF_GROUP_STATS_ENTRY = 540,
    OF_HELLO_ELEM = 541,
    OF_HELLO_ELEM_VERSIONBITMAP = 542,
    OF_INSTRUCTION = 543,
    OF_INSTRUCTION_APPLY_ACTIONS = 544,
    OF_INSTRUCTION_BSN = 545,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 546,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 547,
    OF_INSTRUCTION_BSN_DENY = 548,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 549,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 550,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 551,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 552,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 553,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 554,
    OF_INSTRUCTION_BSN_HASH_SELECT = 555,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 556,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 557,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 558,
    OF_INSTRUCTION_BSN_PERMIT = 559,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 560,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 561,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 562,
    OF_INSTRUCTION_CLEAR_ACTIONS = 563,
    OF_INSTRUCTION_EXPERIMENTER = 564,
    OF_INSTRUCTION_GOTO_TABLE = 565,
    OF_INSTRUCTION_ID = 566,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 567,
    OF_INSTRUCTION_ID_BSN = 568,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 569,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 570,
    OF_INSTRUCTION_ID_BSN_DENY = 571,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 572,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 573,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 574,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 575,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 576,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 577,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 578,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 579,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 580,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 581,
    OF_INSTRUCTION_ID_BSN_PERMIT = 582,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 583,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 584,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 585,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 586,
    OF_INSTRUCTION_ID_EXPERIMENTER = 587,
    OF_INSTRUCTION_ID_GOTO_TABLE = 588,
    OF_INSTRUCTION_ID_METER = 589,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 590,
    OF_INSTRUCTION_ID_WRITE_METADATA = 591,
    OF_INSTRUCTION_METER = 592,
    OF_INSTRUCTION_WRITE_ACTIONS = 593,
    OF_INSTRUCTION_WRITE_METADATA = 594,
    OF_MATCH_V1 = 595,
    OF_MATCH_V2 = 596,
    OF_MATCH_V3 = 597,
    OF_METER_BAND = 598,
    OF_METER_BAND_DROP = 599,
    OF_METER_BAND_DSCP_REMARK = 600,
    OF_METER_BAND_EXPERIMENTER = 601,
    OF_METER_BAND_STATS = 602,
    OF_METER_CONFIG = 603,
    OF_METER_FEATURES = 604,
    OF_METER_STATS = 605,
    OF_OXM = 606,
    OF_OXM_ARP_OP = 607,
    OF_OXM_ARP_OP_MASKED = 608,
    OF_OXM_ARP_SHA = 609,
    OF_OXM_ARP_SHA_MASKED = 610,
    OF_OXM_ARP_SPA = 611,
    OF_OXM_ARP_SPA_MASKED = 612,
    OF_OXM_ARP_THA = 613,
    OF_OXM_ARP_THA_MASKED = 614,
    OF_OXM_ARP_TPA = 615,
    OF_OXM_ARP_TPA_MASKED = 616,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 617,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 618,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 619,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 620,
    OF_OXM_BSN_IFP_CLASS_ID = 621,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 622,
    OF_OXM_BSN_IN_PORTS_128 = 623,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 624,
    OF_OXM_BSN_IN_PORTS_512 = 625,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 626,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 627,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 628,
    OF_OXM_BSN_INNER_ETH_DST = 629,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 630,
    OF_OXM_BSN_INNER_ETH_SRC = 631,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 632,
    OF_OXM_BSN_INNER_VLAN_VID = 633,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 634,
    OF_OXM_BSN_IP_FRAGMENTATION = 635,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 636,
    OF_OXM_BSN_L2_CACHE_HIT = 637,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 638,
    OF_OXM_BSN_L3_DST_CLASS_ID = 639,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 640,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 641,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 642,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 643,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 644,
    OF_OXM_BSN_LAG_ID = 645,
    OF_OXM_BSN_LAG_ID_MASKED = 646,
    OF_OXM_BSN_TCP_FLAGS = 647,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 648,
    OF_OXM_BSN_UDF0 = 649,
    OF_OXM_BSN_UDF0_MASKED = 650,
    OF_OXM_BSN_UDF1 = 651,
    OF_OXM_BSN_UDF1_MASKED = 652,
    OF_OXM_BSN_UDF2 = 653,
    OF_OXM_BSN_UDF2_MASKED = 654,
    OF_OXM_BSN_UDF3 = 655,
    OF_OXM_BSN_UDF3_MASKED = 656,
    OF_OXM_BSN_UDF4 = 657,
    OF_OXM_BSN_UDF4_MASKED = 658,
    OF_OXM_BSN_UDF5 = 659,
    OF_OXM_BSN_UDF5_MASKED = 660,
    OF_OXM_BSN_UDF6 = 661,
    OF_OXM_BSN_UDF6_MASKED = 662,
    OF_OXM_BSN_UDF7 = 663,
    OF_OXM_BSN_UDF7_MASKED = 664,
    OF_OXM_BSN_VFI = 665,
    OF_OXM_BSN_VFI_MASKED = 666,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 667,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 668,
    OF_OXM_BSN_VRF = 669,
    OF_OXM_BSN_VRF_MASKED = 670,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 671,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 672,
    OF_OXM_CONN_TRACKING_IPV6_DST = 673,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 674,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 675,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 676,
    OF_OXM_CONN_TRACKING_LABEL = 677,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 678,
    OF_OXM_CONN_TRACKING_MARK = 679,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 680,
    OF_OXM_CONN_TRACKING_NW_DST = 681,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 682,
    OF_OXM_CONN_TRACKING_NW_PROTO = 683,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 684,
    OF_OXM_CONN_TRACKING_NW_SRC = 685,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 686,
    OF_OXM_CONN_TRACKING_STATE = 687,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 688,
    OF_OXM_CONN_TRACKING_TP_DST = 689,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 690,
    OF_OXM_CONN_TRACKING_TP_SRC = 691,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 692,
    OF_OXM_CONN_TRACKING_ZONE = 693,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 694,
    OF_OXM_ETH_DST = 695,
    OF_OXM_ETH_DST_MASKED = 696,
    OF_OXM_ETH_SRC = 697,
    OF_OXM_ETH_SRC_MASKED = 698,
    OF_OXM_ETH_TYPE = 699,
    OF_OXM_ETH_TYPE_MASKED = 700,
    OF_OXM_ICMPV4_CODE = 701,
    OF_OXM_ICMPV4_CODE_MASKED = 702,
    OF_OXM_ICMPV4_TYPE = 703,
    OF_OXM_ICMPV4_TYPE_MASKED = 704,
    OF_OXM_ICMPV6_CODE = 705,
    OF_OXM_ICMPV6_CODE_MASKED = 706,
    OF_OXM_ICMPV6_TYPE = 707,
    OF_OXM_ICMPV6_TYPE_MASKED = 708,
    OF_OXM_IN_PHY_PORT = 709,
    OF_OXM_IN_PHY_PORT_MASKED = 710,
    OF_OXM_IN_PORT = 711,
    OF_OXM_IN_PORT_MASKED = 712,
    OF_OXM_IP_DSCP = 713,
    OF_OXM_IP_DSCP_MASKED = 714,
    OF_OXM_IP_ECN = 715,
    OF_OXM_IP_ECN_MASKED = 716,
    OF_OXM_IP_PROTO = 717,
    OF_OXM_IP_PROTO_MASKED = 718,
    OF_OXM_IPV4_DST = 719,
    OF_OXM_IPV4_DST_MASKED = 720,
    OF_OXM_IPV4_SRC = 721,
    OF_OXM_IPV4_SRC_MASKED = 722,
    OF_OXM_IPV6_DST = 723,
    OF_OXM_IPV6_DST_MASKED = 724,
    OF_OXM_IPV6_EXTHDR = 725,
    OF_OXM_IPV6_EXTHDR_MASKED = 726,
    OF_OXM_IPV6_FLABEL = 727,
    OF_OXM_IPV6_FLABEL_MASKED = 728,
    OF_OXM_IPV6_ND_SLL = 729,
    OF_OXM_IPV6_ND_SLL_MASKED = 730,
    OF_OXM_IPV6_ND_TARGET = 731,
    OF_OXM_IPV6_ND_TARGET_MASKED = 732,
    OF_OXM_IPV6_ND_TLL = 733,
    OF_OXM_IPV6_ND_TLL_MASKED = 734,
    OF_OXM_IPV6_SRC = 735,
    OF_OXM_IPV6_SRC_MASKED = 736,
    OF_OXM_METADATA = 737,
    OF_OXM_METADATA_MASKED = 738,
    OF_OXM_MPLS_BOS = 739,
    OF_OXM_MPLS_BOS_MASKED = 740,
    OF_OXM_MPLS_LABEL = 741,
    OF_OXM_MPLS_LABEL_MASKED = 742,
    OF_OXM_MPLS_TC = 743,
    OF_OXM_MPLS_TC_MASKED = 744,
    OF_OXM_OVS_TCP_FLAGS = 745,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 746,
    OF_OXM_PBB_UCA = 747,
    OF_OXM_PBB_UCA_MASKED = 748,
    OF_OXM_SCTP_DST = 749,
    OF_OXM_SCTP_DST_MASKED = 750,
    OF_OXM_SCTP_SRC = 751,
    OF_OXM_SCTP_SRC_MASKED = 752,
    OF_OXM_TCP_DST = 753,
    OF_OXM_TCP_DST_MASKED = 754,
    OF_OXM_TCP_SRC = 755,
    OF_OXM_TCP_SRC_MASKED = 756,
    OF_OXM_TUNNEL_ID = 757,
    OF_OXM_TUNNEL_ID_MASKED = 758,
    OF_OXM_TUNNEL_IPV4_DST = 759,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 760,
    OF_OXM_TUNNEL_IPV4_SRC = 761,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 762,
    OF_OXM_UDP_DST = 763,
    OF_OXM_UDP_DST_MASKED = 764,
    OF_OXM_UDP_SRC = 765,
    OF_OXM_UDP_SRC_MASKED = 766,
    OF_OXM_VLAN_PCP = 767,
    OF_OXM_VLAN_PCP_MASKED = 768,
    OF_OXM_VLAN_VID = 769,
    OF_OXM_VLAN_VID_MASKED = 770,
    OF_PACKET_QUEUE = 771,
    OF_PORT_DESC = 772,
    OF_PORT_DESC_PROP = 773,
    OF_PORT_DESC_PROP_BSN = 774,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 775,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 776,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 777,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 778,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 779,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 780,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 781,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 782,
    OF_PORT_DESC_PROP_BSN_UPLINK = 783,
    OF_PORT_DESC_PROP_ETHERNET = 784,
    OF_PORT_DESC_PROP_EXPERIMENTER = 785,
    OF_PORT_DESC_PROP_OPTICAL = 786,
    OF_PORT_MOD_PROP = 787,
    OF_PORT_MOD_PROP_ETHERNET = 788,
    OF_PORT_MOD_PROP_EXPERIMENTER = 789,
    OF_PORT_MOD_PROP_OPTICAL = 790,
    OF_PORT_STATS_ENTRY = 791,
    OF_PORT_STATS_PROP = 792,
    OF_PORT_STATS_PROP_ETHERNET = 793,
    OF_PORT_STATS_PROP_EXPERIMENTER = 794,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 795,
    OF_PORT_STATS_PROP_OPTICAL = 796,
    OF_QUEUE_DESC = 797,
    OF_QUEUE_DESC_PROP = 798,
    OF_QUEUE_DESC_PROP_BSN = 799,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 800,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 801,
    OF_QUEUE_DESC_PROP_MAX_RATE = 802,
    OF_QUEUE_DESC_PROP_MIN_RATE = 803,
    OF_QUEUE_PROP = 804,
    OF_QUEUE_PROP_EXPERIMENTER = 805,
    OF_QUEUE_PROP_MAX_RATE = 806,
    OF_QUEUE_PROP_MIN_RATE = 807,
    OF_QUEUE_STATS_ENTRY = 808,
    OF_QUEUE_STATS_PROP = 809,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 810,
    OF_ROLE_PROP = 811,
    OF_ROLE_PROP_EXPERIMENTER = 812,
    OF_TABLE_DESC = 813,
    OF_TABLE_FEATURE_PROP = 814,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 815,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 816,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 817,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 818,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 819,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 820,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 821,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 822,
    OF_TABLE_FEATURE_PROP_MATCH = 823,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 824,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 825,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 826,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 827,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 828,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 829,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 830,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 831,
    OF_TABLE_FEATURES = 832,
    OF_TABLE_MOD_PROP = 833,
    OF_TABLE_MOD_PROP_EVICTION = 834,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 835,
    OF_TABLE_MOD_PROP_VACANCY = 836,
    OF_TABLE_STATS_ENTRY = 837,
    OF_UINT32 = 838,
    OF_UINT64 = 839,
    OF_UINT8 = 840,
    ...
    /* List objects */
    OF_LIST_ACTION = 841,
    OF_LIST_ACTION_ID = 842,
    OF_LIST_ASYNC_CONFIG_PROP = 843,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 844,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 845,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 846,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 847,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 848,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 849,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 850,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 851,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 852,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 853,
    OF_LIST_BSN_INTERFACE = 854,
    OF_LIST_BSN_LACP_STATS_ENTRY = 855,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 856,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 857,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 858,
    OF_LIST_BSN_TLV = 859,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 860,
    OF_LIST_BSN_VLAN_MAC = 861,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 862,
    OF_LIST_BUCKET = 863,
    OF_LIST_BUCKET_COUNTER = 864,
    OF_LIST_BUNDLE_PROP = 865,
    OF_LIST_FLOW_STATS_ENTRY = 866,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 867,
    OF_LIST_GROUP_STATS_ENTRY = 868,
    OF_LIST_HELLO_ELEM = 869,
    OF_LIST_INSTRUCTION = 870,
    OF_LIST_INSTRUCTION_ID = 871,
    OF_LIST_METER_BAND = 872,
    OF_LIST_METER_BAND_STATS = 873,
    OF_LIST_METER_CONFIG = 874,
    OF_LIST_METER_STATS = 875,
    OF_LIST_OXM = 876,
    OF_LIST_PACKET_QUEUE = 877,
    OF_LIST_PORT_DESC = 878,
    OF_LIST_PORT_DESC_PROP = 879,
    OF_LIST_PORT_MOD_PROP = 880,
    OF_LIST_PORT_STATS_ENTRY = 881,
    OF_LIST_PORT_STATS_PROP = 882,
    OF_LIST_QUEUE_DESC = 883,
    OF_LIST_QUEUE_DESC_PROP = 884,
    OF_LIST_QUEUE_PROP = 885,
    OF_LIST_QUEUE_STATS_ENTRY = 886,
    OF_LIST_QUEUE_STATS_PROP = 887,
    OF_LIST_ROLE_PROP = 888,
    OF_LIST_TABLE_DESC = 889,
    OF_LIST_TABLE_FEATURE_PROP = 890,
    OF_LIST_TABLE_FEATURES = 891,
    OF_LIST_TABLE_MOD_PROP = 892,
    OF_LIST_TABLE_STATS_ENTRY = 893,
    OF_LIST_UINT32 = 894,
    OF_LIST_UINT64 = 895,
    OF_LIST_UINT8 = 896,
