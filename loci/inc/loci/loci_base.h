...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_SET_LOOPBACK_MODE = 353,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 354,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 355,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 356,
    OF_BSN_TLV_SUB_AGENT_ID = 357,
    OF_BSN_TLV_TCP_DST = 358,
    OF_BSN_TLV_TCP_SRC = 359,
    OF_BSN_TLV_TX_BYTES = 360,
    OF_BSN_TLV_TX_PACKETS = 361,
    OF_BSN_TLV_UDF_ANCHOR = 362,
    OF_BSN_TLV_UDF_ID = 363,
    OF_BSN_TLV_UDF_LENGTH = 364,
    OF_BSN_TLV_UDF_OFFSET = 365,
    OF_BSN_TLV_UDP_DST = 366,
    OF_BSN_TLV_UDP_SRC = 367,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 368,
    OF_BSN_TLV_VLAN_PCP = 369,
    OF_BSN_TLV_VLAN_VID = 370,
    OF_BSN_TLV_VRF = 371,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 372,
    OF_BSN_VPORT = 373,
    OF_BSN_VPORT_L2GRE = 374,
    OF_BSN_VPORT_Q_IN_Q = 375,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 376,
    OF_BUCKET = 377,
    OF_BUCKET_COUNTER = 378,
    OF_BUNDLE_PROP = 379,
    OF_BUNDLE_PROP_EXPERIMENTER = 380,
    OF_FLOW_STATS_ENTRY = 381,
    OF_GROUP_DESC_STATS_ENTRY = 382,
    OF_GROUP_STATS_ENTRY = 383,
    OF_HELLO_ELEM = 384,
    OF_HELLO_ELEM_VERSIONBITMAP = 385,
    OF_INSTRUCTION = 386,
    OF_INSTRUCTION_APPLY_ACTIONS = 387,
    OF_INSTRUCTION_BSN = 388,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 389,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 390,
    OF_INSTRUCTION_BSN_DENY = 391,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 392,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 393,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 394,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 395,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 396,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 397,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 398,
    OF_INSTRUCTION_BSN_PERMIT = 399,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 400,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 401,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 402,
    OF_INSTRUCTION_CLEAR_ACTIONS = 403,
    OF_INSTRUCTION_EXPERIMENTER = 404,
    OF_INSTRUCTION_GOTO_TABLE = 405,
    OF_INSTRUCTION_ID = 406,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 407,
    OF_INSTRUCTION_ID_BSN = 408,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 409,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 410,
    OF_INSTRUCTION_ID_BSN_DENY = 411,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 412,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 413,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 414,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 415,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 416,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 417,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 418,
    OF_INSTRUCTION_ID_BSN_PERMIT = 419,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 420,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 421,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 422,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 423,
    OF_INSTRUCTION_ID_EXPERIMENTER = 424,
    OF_INSTRUCTION_ID_GOTO_TABLE = 425,
    OF_INSTRUCTION_ID_METER = 426,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 427,
    OF_INSTRUCTION_ID_WRITE_METADATA = 428,
    OF_INSTRUCTION_METER = 429,
    OF_INSTRUCTION_WRITE_ACTIONS = 430,
    OF_INSTRUCTION_WRITE_METADATA = 431,
    OF_MATCH_V1 = 432,
    OF_MATCH_V2 = 433,
    OF_MATCH_V3 = 434,
    OF_METER_BAND = 435,
    OF_METER_BAND_DROP = 436,
    OF_METER_BAND_DSCP_REMARK = 437,
    OF_METER_BAND_EXPERIMENTER = 438,
    OF_METER_BAND_STATS = 439,
    OF_METER_CONFIG = 440,
    OF_METER_FEATURES = 441,
    OF_METER_STATS = 442,
    OF_OXM = 443,
    OF_OXM_ARP_OP = 444,
    OF_OXM_ARP_OP_MASKED = 445,
    OF_OXM_ARP_SHA = 446,
    OF_OXM_ARP_SHA_MASKED = 447,
    OF_OXM_ARP_SPA = 448,
    OF_OXM_ARP_SPA_MASKED = 449,
    OF_OXM_ARP_THA = 450,
    OF_OXM_ARP_THA_MASKED = 451,
    OF_OXM_ARP_TPA = 452,
    OF_OXM_ARP_TPA_MASKED = 453,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 454,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 455,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 456,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 457,
    OF_OXM_BSN_IN_PORTS_128 = 458,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 459,
    OF_OXM_BSN_IN_PORTS_512 = 460,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 461,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 462,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 463,
    OF_OXM_BSN_INNER_ETH_DST = 464,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 465,
    OF_OXM_BSN_INNER_ETH_SRC = 466,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 467,
    OF_OXM_BSN_L2_CACHE_HIT = 468,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 469,
    OF_OXM_BSN_L3_DST_CLASS_ID = 470,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 471,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 472,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 473,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 474,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 475,
    OF_OXM_BSN_LAG_ID = 476,
    OF_OXM_BSN_LAG_ID_MASKED = 477,
    OF_OXM_BSN_TCP_FLAGS = 478,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 479,
    OF_OXM_BSN_UDF0 = 480,
    OF_OXM_BSN_UDF0_MASKED = 481,
    OF_OXM_BSN_UDF1 = 482,
    OF_OXM_BSN_UDF1_MASKED = 483,
    OF_OXM_BSN_UDF2 = 484,
    OF_OXM_BSN_UDF2_MASKED = 485,
    OF_OXM_BSN_UDF3 = 486,
    OF_OXM_BSN_UDF3_MASKED = 487,
    OF_OXM_BSN_UDF4 = 488,
    OF_OXM_BSN_UDF4_MASKED = 489,
    OF_OXM_BSN_UDF5 = 490,
    OF_OXM_BSN_UDF5_MASKED = 491,
    OF_OXM_BSN_UDF6 = 492,
    OF_OXM_BSN_UDF6_MASKED = 493,
    OF_OXM_BSN_UDF7 = 494,
    OF_OXM_BSN_UDF7_MASKED = 495,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 496,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 497,
    OF_OXM_BSN_VRF = 498,
    OF_OXM_BSN_VRF_MASKED = 499,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 500,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 501,
    OF_OXM_ETH_DST = 502,
    OF_OXM_ETH_DST_MASKED = 503,
    OF_OXM_ETH_SRC = 504,
    OF_OXM_ETH_SRC_MASKED = 505,
    OF_OXM_ETH_TYPE = 506,
    OF_OXM_ETH_TYPE_MASKED = 507,
    OF_OXM_ICMPV4_CODE = 508,
    OF_OXM_ICMPV4_CODE_MASKED = 509,
    OF_OXM_ICMPV4_TYPE = 510,
    OF_OXM_ICMPV4_TYPE_MASKED = 511,
    OF_OXM_ICMPV6_CODE = 512,
    OF_OXM_ICMPV6_CODE_MASKED = 513,
    OF_OXM_ICMPV6_TYPE = 514,
    OF_OXM_ICMPV6_TYPE_MASKED = 515,
    OF_OXM_IN_PHY_PORT = 516,
    OF_OXM_IN_PHY_PORT_MASKED = 517,
    OF_OXM_IN_PORT = 518,
    OF_OXM_IN_PORT_MASKED = 519,
    OF_OXM_IP_DSCP = 520,
    OF_OXM_IP_DSCP_MASKED = 521,
    OF_OXM_IP_ECN = 522,
    OF_OXM_IP_ECN_MASKED = 523,
    OF_OXM_IP_PROTO = 524,
    OF_OXM_IP_PROTO_MASKED = 525,
    OF_OXM_IPV4_DST = 526,
    OF_OXM_IPV4_DST_MASKED = 527,
    OF_OXM_IPV4_SRC = 528,
    OF_OXM_IPV4_SRC_MASKED = 529,
    OF_OXM_IPV6_DST = 530,
    OF_OXM_IPV6_DST_MASKED = 531,
    OF_OXM_IPV6_EXTHDR = 532,
    OF_OXM_IPV6_EXTHDR_MASKED = 533,
    OF_OXM_IPV6_FLABEL = 534,
    OF_OXM_IPV6_FLABEL_MASKED = 535,
    OF_OXM_IPV6_ND_SLL = 536,
    OF_OXM_IPV6_ND_SLL_MASKED = 537,
    OF_OXM_IPV6_ND_TARGET = 538,
    OF_OXM_IPV6_ND_TARGET_MASKED = 539,
    OF_OXM_IPV6_ND_TLL = 540,
    OF_OXM_IPV6_ND_TLL_MASKED = 541,
    OF_OXM_IPV6_SRC = 542,
    OF_OXM_IPV6_SRC_MASKED = 543,
    OF_OXM_METADATA = 544,
    OF_OXM_METADATA_MASKED = 545,
    OF_OXM_MPLS_BOS = 546,
    OF_OXM_MPLS_BOS_MASKED = 547,
    OF_OXM_MPLS_LABEL = 548,
    OF_OXM_MPLS_LABEL_MASKED = 549,
    OF_OXM_MPLS_TC = 550,
    OF_OXM_MPLS_TC_MASKED = 551,
    OF_OXM_PBB_UCA = 552,
    OF_OXM_PBB_UCA_MASKED = 553,
    OF_OXM_SCTP_DST = 554,
    OF_OXM_SCTP_DST_MASKED = 555,
    OF_OXM_SCTP_SRC = 556,
    OF_OXM_SCTP_SRC_MASKED = 557,
    OF_OXM_TCP_DST = 558,
    OF_OXM_TCP_DST_MASKED = 559,
    OF_OXM_TCP_SRC = 560,
    OF_OXM_TCP_SRC_MASKED = 561,
    OF_OXM_TUNNEL_ID = 562,
    OF_OXM_TUNNEL_ID_MASKED = 563,
    OF_OXM_TUNNEL_IPV4_DST = 564,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 565,
    OF_OXM_TUNNEL_IPV4_SRC = 566,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 567,
    OF_OXM_UDP_DST = 568,
    OF_OXM_UDP_DST_MASKED = 569,
    OF_OXM_UDP_SRC = 570,
    OF_OXM_UDP_SRC_MASKED = 571,
    OF_OXM_VLAN_PCP = 572,
    OF_OXM_VLAN_PCP_MASKED = 573,
    OF_OXM_VLAN_VID = 574,
    OF_OXM_VLAN_VID_MASKED = 575,
    OF_PACKET_QUEUE = 576,
    OF_PORT_DESC = 577,
    OF_PORT_DESC_PROP = 578,
    OF_PORT_DESC_PROP_BSN = 579,
    OF_PORT_DESC_PROP_BSN_UPLINK = 580,
    OF_PORT_DESC_PROP_ETHERNET = 581,
    OF_PORT_DESC_PROP_EXPERIMENTER = 582,
    OF_PORT_DESC_PROP_OPTICAL = 583,
    OF_PORT_MOD_PROP = 584,
    OF_PORT_MOD_PROP_ETHERNET = 585,
    OF_PORT_MOD_PROP_EXPERIMENTER = 586,
    OF_PORT_MOD_PROP_OPTICAL = 587,
    OF_PORT_STATS_ENTRY = 588,
    OF_PORT_STATS_PROP = 589,
    OF_PORT_STATS_PROP_ETHERNET = 590,
    OF_PORT_STATS_PROP_EXPERIMENTER = 591,
    OF_PORT_STATS_PROP_OPTICAL = 592,
    OF_QUEUE_DESC = 593,
    OF_QUEUE_DESC_PROP = 594,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 595,
    OF_QUEUE_DESC_PROP_MAX_RATE = 596,
    OF_QUEUE_DESC_PROP_MIN_RATE = 597,
    OF_QUEUE_PROP = 598,
    OF_QUEUE_PROP_EXPERIMENTER = 599,
    OF_QUEUE_PROP_MAX_RATE = 600,
    OF_QUEUE_PROP_MIN_RATE = 601,
    OF_QUEUE_STATS_ENTRY = 602,
    OF_QUEUE_STATS_PROP = 603,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 604,
    OF_ROLE_PROP = 605,
    OF_ROLE_PROP_EXPERIMENTER = 606,
    OF_TABLE_DESC = 607,
    OF_TABLE_FEATURE_PROP = 608,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 609,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 610,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 611,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 612,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 613,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 614,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 615,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 616,
    OF_TABLE_FEATURE_PROP_MATCH = 617,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 618,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 619,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 620,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 621,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 622,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 623,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 624,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 625,
    OF_TABLE_FEATURES = 626,
    OF_TABLE_MOD_PROP = 627,
    OF_TABLE_MOD_PROP_EVICTION = 628,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 629,
    OF_TABLE_MOD_PROP_VACANCY = 630,
    OF_TABLE_STATS_ENTRY = 631,
    OF_UINT32 = 632,
    OF_UINT64 = 633,
    OF_UINT8 = 634,
    ...
    /* List objects */
    OF_LIST_ACTION = 635,
    OF_LIST_ACTION_ID = 636,
    OF_LIST_ASYNC_CONFIG_PROP = 637,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 638,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 639,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 640,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 641,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 642,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 643,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 644,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 645,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 646,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 647,
    OF_LIST_BSN_INTERFACE = 648,
    OF_LIST_BSN_LACP_STATS_ENTRY = 649,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 650,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 651,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 652,
    OF_LIST_BSN_TLV = 653,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 654,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 655,
    OF_LIST_BUCKET = 656,
    OF_LIST_BUCKET_COUNTER = 657,
    OF_LIST_BUNDLE_PROP = 658,
    OF_LIST_FLOW_STATS_ENTRY = 659,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 660,
    OF_LIST_GROUP_STATS_ENTRY = 661,
    OF_LIST_HELLO_ELEM = 662,
    OF_LIST_INSTRUCTION = 663,
    OF_LIST_INSTRUCTION_ID = 664,
    OF_LIST_METER_BAND = 665,
    OF_LIST_METER_BAND_STATS = 666,
    OF_LIST_METER_STATS = 667,
    OF_LIST_OXM = 668,
    OF_LIST_PACKET_QUEUE = 669,
    OF_LIST_PORT_DESC = 670,
    OF_LIST_PORT_DESC_PROP = 671,
    OF_LIST_PORT_MOD_PROP = 672,
    OF_LIST_PORT_STATS_ENTRY = 673,
    OF_LIST_PORT_STATS_PROP = 674,
    OF_LIST_QUEUE_DESC = 675,
    OF_LIST_QUEUE_DESC_PROP = 676,
    OF_LIST_QUEUE_PROP = 677,
    OF_LIST_QUEUE_STATS_ENTRY = 678,
    OF_LIST_QUEUE_STATS_PROP = 679,
    OF_LIST_ROLE_PROP = 680,
    OF_LIST_TABLE_DESC = 681,
    OF_LIST_TABLE_FEATURE_PROP = 682,
    OF_LIST_TABLE_FEATURES = 683,
    OF_LIST_TABLE_MOD_PROP = 684,
    OF_LIST_TABLE_STATS_ENTRY = 685,
    OF_LIST_UINT32 = 686,
    OF_LIST_UINT64 = 687,
    OF_LIST_UINT8 = 688,
