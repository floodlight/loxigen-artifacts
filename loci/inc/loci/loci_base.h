...
typedef enum of_object_id_e {
    ...
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 273,
    OF_BSN_VPORT = 274,
    OF_BSN_VPORT_HEADER = 275,
    OF_BSN_VPORT_Q_IN_Q = 276,
    OF_BUCKET = 277,
    OF_BUCKET_COUNTER = 278,
    OF_FLOW_STATS_ENTRY = 279,
    OF_GROUP_DESC_STATS_ENTRY = 280,
    OF_GROUP_STATS_ENTRY = 281,
    OF_HEADER = 282,
    OF_HELLO_ELEM = 283,
    OF_HELLO_ELEM_HEADER = 284,
    OF_HELLO_ELEM_VERSIONBITMAP = 285,
    OF_INSTRUCTION = 286,
    OF_INSTRUCTION_APPLY_ACTIONS = 287,
    OF_INSTRUCTION_BSN = 288,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 289,
    OF_INSTRUCTION_BSN_DENY = 290,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 291,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 292,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 293,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 294,
    OF_INSTRUCTION_BSN_PERMIT = 295,
    OF_INSTRUCTION_CLEAR_ACTIONS = 296,
    OF_INSTRUCTION_EXPERIMENTER = 297,
    OF_INSTRUCTION_GOTO_TABLE = 298,
    OF_INSTRUCTION_HEADER = 299,
    OF_INSTRUCTION_ID = 300,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 301,
    OF_INSTRUCTION_ID_BSN = 302,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 303,
    OF_INSTRUCTION_ID_BSN_DENY = 304,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 305,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 306,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 307,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 308,
    OF_INSTRUCTION_ID_BSN_PERMIT = 309,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 310,
    OF_INSTRUCTION_ID_EXPERIMENTER = 311,
    OF_INSTRUCTION_ID_GOTO_TABLE = 312,
    OF_INSTRUCTION_ID_HEADER = 313,
    OF_INSTRUCTION_ID_METER = 314,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 315,
    OF_INSTRUCTION_ID_WRITE_METADATA = 316,
    OF_INSTRUCTION_METER = 317,
    OF_INSTRUCTION_WRITE_ACTIONS = 318,
    OF_INSTRUCTION_WRITE_METADATA = 319,
    OF_MATCH_V1 = 320,
    OF_MATCH_V2 = 321,
    OF_MATCH_V3 = 322,
    OF_METER_BAND = 323,
    OF_METER_BAND_DROP = 324,
    OF_METER_BAND_DSCP_REMARK = 325,
    OF_METER_BAND_EXPERIMENTER = 326,
    OF_METER_BAND_HEADER = 327,
    OF_METER_BAND_STATS = 328,
    OF_METER_CONFIG = 329,
    OF_METER_FEATURES = 330,
    OF_METER_STATS = 331,
    OF_OXM = 332,
    OF_OXM_ARP_OP = 333,
    OF_OXM_ARP_OP_MASKED = 334,
    OF_OXM_ARP_SHA = 335,
    OF_OXM_ARP_SHA_MASKED = 336,
    OF_OXM_ARP_SPA = 337,
    OF_OXM_ARP_SPA_MASKED = 338,
    OF_OXM_ARP_THA = 339,
    OF_OXM_ARP_THA_MASKED = 340,
    OF_OXM_ARP_TPA = 341,
    OF_OXM_ARP_TPA_MASKED = 342,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 343,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 344,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 345,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 346,
    OF_OXM_BSN_IN_PORTS_128 = 347,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 348,
    OF_OXM_BSN_L3_DST_CLASS_ID = 349,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 350,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 351,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 352,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 353,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 354,
    OF_OXM_BSN_LAG_ID = 355,
    OF_OXM_BSN_LAG_ID_MASKED = 356,
    OF_OXM_BSN_UDF0 = 357,
    OF_OXM_BSN_UDF0_MASKED = 358,
    OF_OXM_BSN_UDF1 = 359,
    OF_OXM_BSN_UDF1_MASKED = 360,
    OF_OXM_BSN_UDF2 = 361,
    OF_OXM_BSN_UDF2_MASKED = 362,
    OF_OXM_BSN_UDF3 = 363,
    OF_OXM_BSN_UDF3_MASKED = 364,
    OF_OXM_BSN_UDF4 = 365,
    OF_OXM_BSN_UDF4_MASKED = 366,
    OF_OXM_BSN_UDF5 = 367,
    OF_OXM_BSN_UDF5_MASKED = 368,
    OF_OXM_BSN_UDF6 = 369,
    OF_OXM_BSN_UDF6_MASKED = 370,
    OF_OXM_BSN_UDF7 = 371,
    OF_OXM_BSN_UDF7_MASKED = 372,
    OF_OXM_BSN_VRF = 373,
    OF_OXM_BSN_VRF_MASKED = 374,
    OF_OXM_ETH_DST = 375,
    OF_OXM_ETH_DST_MASKED = 376,
    OF_OXM_ETH_SRC = 377,
    OF_OXM_ETH_SRC_MASKED = 378,
    OF_OXM_ETH_TYPE = 379,
    OF_OXM_ETH_TYPE_MASKED = 380,
    OF_OXM_HEADER = 381,
    OF_OXM_ICMPV4_CODE = 382,
    OF_OXM_ICMPV4_CODE_MASKED = 383,
    OF_OXM_ICMPV4_TYPE = 384,
    OF_OXM_ICMPV4_TYPE_MASKED = 385,
    OF_OXM_ICMPV6_CODE = 386,
    OF_OXM_ICMPV6_CODE_MASKED = 387,
    OF_OXM_ICMPV6_TYPE = 388,
    OF_OXM_ICMPV6_TYPE_MASKED = 389,
    OF_OXM_IN_PHY_PORT = 390,
    OF_OXM_IN_PHY_PORT_MASKED = 391,
    OF_OXM_IN_PORT = 392,
    OF_OXM_IN_PORT_MASKED = 393,
    OF_OXM_IP_DSCP = 394,
    OF_OXM_IP_DSCP_MASKED = 395,
    OF_OXM_IP_ECN = 396,
    OF_OXM_IP_ECN_MASKED = 397,
    OF_OXM_IP_PROTO = 398,
    OF_OXM_IP_PROTO_MASKED = 399,
    OF_OXM_IPV4_DST = 400,
    OF_OXM_IPV4_DST_MASKED = 401,
    OF_OXM_IPV4_SRC = 402,
    OF_OXM_IPV4_SRC_MASKED = 403,
    OF_OXM_IPV6_DST = 404,
    OF_OXM_IPV6_DST_MASKED = 405,
    OF_OXM_IPV6_FLABEL = 406,
    OF_OXM_IPV6_FLABEL_MASKED = 407,
    OF_OXM_IPV6_ND_SLL = 408,
    OF_OXM_IPV6_ND_SLL_MASKED = 409,
    OF_OXM_IPV6_ND_TARGET = 410,
    OF_OXM_IPV6_ND_TARGET_MASKED = 411,
    OF_OXM_IPV6_ND_TLL = 412,
    OF_OXM_IPV6_ND_TLL_MASKED = 413,
    OF_OXM_IPV6_SRC = 414,
    OF_OXM_IPV6_SRC_MASKED = 415,
    OF_OXM_METADATA = 416,
    OF_OXM_METADATA_MASKED = 417,
    OF_OXM_MPLS_LABEL = 418,
    OF_OXM_MPLS_LABEL_MASKED = 419,
    OF_OXM_MPLS_TC = 420,
    OF_OXM_MPLS_TC_MASKED = 421,
    OF_OXM_SCTP_DST = 422,
    OF_OXM_SCTP_DST_MASKED = 423,
    OF_OXM_SCTP_SRC = 424,
    OF_OXM_SCTP_SRC_MASKED = 425,
    OF_OXM_TCP_DST = 426,
    OF_OXM_TCP_DST_MASKED = 427,
    OF_OXM_TCP_SRC = 428,
    OF_OXM_TCP_SRC_MASKED = 429,
    OF_OXM_UDP_DST = 430,
    OF_OXM_UDP_DST_MASKED = 431,
    OF_OXM_UDP_SRC = 432,
    OF_OXM_UDP_SRC_MASKED = 433,
    OF_OXM_VLAN_PCP = 434,
    OF_OXM_VLAN_PCP_MASKED = 435,
    OF_OXM_VLAN_VID = 436,
    OF_OXM_VLAN_VID_MASKED = 437,
    OF_PACKET_QUEUE = 438,
    OF_PORT_DESC = 439,
    OF_PORT_STATS_ENTRY = 440,
    OF_QUEUE_PROP = 441,
    OF_QUEUE_PROP_EXPERIMENTER = 442,
    OF_QUEUE_PROP_HEADER = 443,
    OF_QUEUE_PROP_MAX_RATE = 444,
    OF_QUEUE_PROP_MIN_RATE = 445,
    OF_QUEUE_STATS_ENTRY = 446,
    OF_TABLE_FEATURE_PROP = 447,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 448,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 449,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 450,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 451,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 452,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 453,
    OF_TABLE_FEATURE_PROP_HEADER = 454,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 455,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 456,
    OF_TABLE_FEATURE_PROP_MATCH = 457,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 458,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 459,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 460,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 461,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 462,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 463,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 464,
    OF_TABLE_FEATURES = 465,
    OF_TABLE_STATS_ENTRY = 466,
    OF_UINT32 = 467,
    OF_UINT64 = 468,
    OF_UINT8 = 469,
    ...
    /* List objects */
    OF_LIST_ACTION = 470,
    OF_LIST_ACTION_ID = 471,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 472,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 473,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 474,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 475,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 476,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 477,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 478,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 479,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 480,
    OF_LIST_BSN_INTERFACE = 481,
    OF_LIST_BSN_LACP_STATS_ENTRY = 482,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 483,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 484,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 485,
    OF_LIST_BSN_TLV = 486,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 487,
    OF_LIST_BUCKET = 488,
    OF_LIST_BUCKET_COUNTER = 489,
    OF_LIST_FLOW_STATS_ENTRY = 490,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 491,
    OF_LIST_GROUP_STATS_ENTRY = 492,
    OF_LIST_HELLO_ELEM = 493,
    OF_LIST_INSTRUCTION = 494,
    OF_LIST_INSTRUCTION_ID = 495,
    OF_LIST_METER_BAND = 496,
    OF_LIST_METER_BAND_STATS = 497,
    OF_LIST_METER_STATS = 498,
    OF_LIST_OXM = 499,
    OF_LIST_PACKET_QUEUE = 500,
    OF_LIST_PORT_DESC = 501,
    OF_LIST_PORT_STATS_ENTRY = 502,
    OF_LIST_QUEUE_PROP = 503,
    OF_LIST_QUEUE_STATS_ENTRY = 504,
    OF_LIST_TABLE_FEATURE_PROP = 505,
    OF_LIST_TABLE_FEATURES = 506,
    OF_LIST_TABLE_STATS_ENTRY = 507,
    OF_LIST_UINT32 = 508,
    OF_LIST_UINT64 = 509,
    OF_LIST_UINT8 = 510,
