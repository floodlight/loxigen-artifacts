...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_MGMT = 417,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 418,
    OF_BSN_TLV_MISS_PACKETS = 419,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 420,
    OF_BSN_TLV_MPLS_LABEL = 421,
    OF_BSN_TLV_MPLS_SEQUENCED = 422,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 423,
    OF_BSN_TLV_MULTICAST_PACKET = 424,
    OF_BSN_TLV_MULTIPLIER = 425,
    OF_BSN_TLV_NAME = 426,
    OF_BSN_TLV_NDP_OFFLOAD = 427,
    OF_BSN_TLV_NDP_STATIC = 428,
    OF_BSN_TLV_NEGATE = 429,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 430,
    OF_BSN_TLV_NEXT_HOP_MAC = 431,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 432,
    OF_BSN_TLV_NO_ARP_RESPONSE = 433,
    OF_BSN_TLV_NO_NS_RESPONSE = 434,
    OF_BSN_TLV_OFFSET = 435,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 436,
    OF_BSN_TLV_OUTER_SRC_MAC = 437,
    OF_BSN_TLV_PARENT_PORT = 438,
    OF_BSN_TLV_PARTNER_KEY = 439,
    OF_BSN_TLV_PARTNER_PORT_NUM = 440,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 441,
    OF_BSN_TLV_PARTNER_STATE = 442,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 443,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 444,
    OF_BSN_TLV_PASSIVE = 445,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 446,
    OF_BSN_TLV_PIM_DR = 447,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 448,
    OF_BSN_TLV_PORT = 449,
    OF_BSN_TLV_PORT_MODE = 450,
    OF_BSN_TLV_PORT_SPEED_GBPS = 451,
    OF_BSN_TLV_PORT_USAGE = 452,
    OF_BSN_TLV_PORT_VXLAN_MODE = 453,
    OF_BSN_TLV_PRESERVE_VLAN = 454,
    OF_BSN_TLV_PRIORITY = 455,
    OF_BSN_TLV_PUSH_TWO_TAGS_CAPABILITY = 456,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 457,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 458,
    OF_BSN_TLV_QOS_PRIORITY = 459,
    OF_BSN_TLV_QUEUE_ID = 460,
    OF_BSN_TLV_QUEUE_WEIGHT = 461,
    OF_BSN_TLV_RATE_LIMIT = 462,
    OF_BSN_TLV_RATE_UNIT = 463,
    OF_BSN_TLV_RECORD_PACKETS = 464,
    OF_BSN_TLV_REDUNDANT_MGMT = 465,
    OF_BSN_TLV_REFERENCE = 466,
    OF_BSN_TLV_REPLY_PACKETS = 467,
    OF_BSN_TLV_REQUEST_PACKETS = 468,
    OF_BSN_TLV_REST_SERVER = 469,
    OF_BSN_TLV_ROUTING_PARAM = 470,
    OF_BSN_TLV_RX_BYTES = 471,
    OF_BSN_TLV_RX_PACKETS = 472,
    OF_BSN_TLV_SAMPLING_RATE = 473,
    OF_BSN_TLV_SCTP_DST = 474,
    OF_BSN_TLV_SCTP_SRC = 475,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 476,
    OF_BSN_TLV_SOCKET = 477,
    OF_BSN_TLV_SRC_MAC_CML = 478,
    OF_BSN_TLV_STATUS = 479,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 480,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 481,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 482,
    OF_BSN_TLV_SUB_AGENT_ID = 483,
    OF_BSN_TLV_TCP_DST = 484,
    OF_BSN_TLV_TCP_FLAGS = 485,
    OF_BSN_TLV_TCP_SRC = 486,
    OF_BSN_TLV_THREAD = 487,
    OF_BSN_TLV_TIMESTAMP = 488,
    OF_BSN_TLV_TTL = 489,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 490,
    OF_BSN_TLV_TX_BYTES = 491,
    OF_BSN_TLV_TX_PACKETS = 492,
    OF_BSN_TLV_UDF_ANCHOR = 493,
    OF_BSN_TLV_UDF_CAPABILITY = 494,
    OF_BSN_TLV_UDF_DATA = 495,
    OF_BSN_TLV_UDF_ID = 496,
    OF_BSN_TLV_UDF_LENGTH = 497,
    OF_BSN_TLV_UDF_OFFSET = 498,
    OF_BSN_TLV_UDP_DST = 499,
    OF_BSN_TLV_UDP_SRC = 500,
    OF_BSN_TLV_UINT32 = 501,
    OF_BSN_TLV_UINT64_LIST = 502,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 503,
    OF_BSN_TLV_UNICAST_RATE = 504,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 505,
    OF_BSN_TLV_UNTAGGED = 506,
    OF_BSN_TLV_UPGRADE = 507,
    OF_BSN_TLV_URI_SCHEME = 508,
    OF_BSN_TLV_USE_PACKET_STATE = 509,
    OF_BSN_TLV_USER_CONFIGURED = 510,
    OF_BSN_TLV_VFI = 511,
    OF_BSN_TLV_VFP_CLASS_ID = 512,
    OF_BSN_TLV_VIRTUAL = 513,
    OF_BSN_TLV_VLAN_MAC_LIST = 514,
    OF_BSN_TLV_VLAN_PCP = 515,
    OF_BSN_TLV_VLAN_VID = 516,
    OF_BSN_TLV_VLAN_VID_MASK = 517,
    OF_BSN_TLV_VNI = 518,
    OF_BSN_TLV_VPN_KEY = 519,
    OF_BSN_TLV_VRF = 520,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 521,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 522,
    OF_BSN_VLAN_MAC = 523,
    OF_BSN_VPORT = 524,
    OF_BSN_VPORT_L2GRE = 525,
    OF_BSN_VPORT_Q_IN_Q = 526,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 527,
    OF_BUCKET = 528,
    OF_BUCKET_COUNTER = 529,
    OF_BUNDLE_PROP = 530,
    OF_BUNDLE_PROP_EXPERIMENTER = 531,
    OF_FLOW_STATS_ENTRY = 532,
    OF_GROUP_DESC_STATS_ENTRY = 533,
    OF_GROUP_STATS_ENTRY = 534,
    OF_HELLO_ELEM = 535,
    OF_HELLO_ELEM_VERSIONBITMAP = 536,
    OF_INSTRUCTION = 537,
    OF_INSTRUCTION_APPLY_ACTIONS = 538,
    OF_INSTRUCTION_BSN = 539,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 540,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 541,
    OF_INSTRUCTION_BSN_DENY = 542,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 543,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 544,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 545,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 546,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 547,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 548,
    OF_INSTRUCTION_BSN_HASH_SELECT = 549,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 550,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 551,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 552,
    OF_INSTRUCTION_BSN_PERMIT = 553,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 554,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 555,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 556,
    OF_INSTRUCTION_CLEAR_ACTIONS = 557,
    OF_INSTRUCTION_EXPERIMENTER = 558,
    OF_INSTRUCTION_GOTO_TABLE = 559,
    OF_INSTRUCTION_ID = 560,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 561,
    OF_INSTRUCTION_ID_BSN = 562,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 563,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 564,
    OF_INSTRUCTION_ID_BSN_DENY = 565,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 566,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 567,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 568,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 569,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 570,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 571,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 572,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 573,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 574,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 575,
    OF_INSTRUCTION_ID_BSN_PERMIT = 576,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 577,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 578,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 579,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 580,
    OF_INSTRUCTION_ID_EXPERIMENTER = 581,
    OF_INSTRUCTION_ID_GOTO_TABLE = 582,
    OF_INSTRUCTION_ID_METER = 583,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 584,
    OF_INSTRUCTION_ID_WRITE_METADATA = 585,
    OF_INSTRUCTION_METER = 586,
    OF_INSTRUCTION_WRITE_ACTIONS = 587,
    OF_INSTRUCTION_WRITE_METADATA = 588,
    OF_MATCH_V1 = 589,
    OF_MATCH_V2 = 590,
    OF_MATCH_V3 = 591,
    OF_METER_BAND = 592,
    OF_METER_BAND_DROP = 593,
    OF_METER_BAND_DSCP_REMARK = 594,
    OF_METER_BAND_EXPERIMENTER = 595,
    OF_METER_BAND_STATS = 596,
    OF_METER_CONFIG = 597,
    OF_METER_FEATURES = 598,
    OF_METER_STATS = 599,
    OF_OXM = 600,
    OF_OXM_ARP_OP = 601,
    OF_OXM_ARP_OP_MASKED = 602,
    OF_OXM_ARP_SHA = 603,
    OF_OXM_ARP_SHA_MASKED = 604,
    OF_OXM_ARP_SPA = 605,
    OF_OXM_ARP_SPA_MASKED = 606,
    OF_OXM_ARP_THA = 607,
    OF_OXM_ARP_THA_MASKED = 608,
    OF_OXM_ARP_TPA = 609,
    OF_OXM_ARP_TPA_MASKED = 610,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 611,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 612,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 613,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 614,
    OF_OXM_BSN_IFP_CLASS_ID = 615,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 616,
    OF_OXM_BSN_IN_PORTS_128 = 617,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 618,
    OF_OXM_BSN_IN_PORTS_512 = 619,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 620,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 621,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 622,
    OF_OXM_BSN_INNER_ETH_DST = 623,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 624,
    OF_OXM_BSN_INNER_ETH_SRC = 625,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 626,
    OF_OXM_BSN_INNER_VLAN_VID = 627,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 628,
    OF_OXM_BSN_IP_FRAGMENTATION = 629,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 630,
    OF_OXM_BSN_L2_CACHE_HIT = 631,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 632,
    OF_OXM_BSN_L3_DST_CLASS_ID = 633,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 634,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 635,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 636,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 637,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 638,
    OF_OXM_BSN_LAG_ID = 639,
    OF_OXM_BSN_LAG_ID_MASKED = 640,
    OF_OXM_BSN_TCP_FLAGS = 641,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 642,
    OF_OXM_BSN_UDF0 = 643,
    OF_OXM_BSN_UDF0_MASKED = 644,
    OF_OXM_BSN_UDF1 = 645,
    OF_OXM_BSN_UDF1_MASKED = 646,
    OF_OXM_BSN_UDF2 = 647,
    OF_OXM_BSN_UDF2_MASKED = 648,
    OF_OXM_BSN_UDF3 = 649,
    OF_OXM_BSN_UDF3_MASKED = 650,
    OF_OXM_BSN_UDF4 = 651,
    OF_OXM_BSN_UDF4_MASKED = 652,
    OF_OXM_BSN_UDF5 = 653,
    OF_OXM_BSN_UDF5_MASKED = 654,
    OF_OXM_BSN_UDF6 = 655,
    OF_OXM_BSN_UDF6_MASKED = 656,
    OF_OXM_BSN_UDF7 = 657,
    OF_OXM_BSN_UDF7_MASKED = 658,
    OF_OXM_BSN_VFI = 659,
    OF_OXM_BSN_VFI_MASKED = 660,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 661,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 662,
    OF_OXM_BSN_VRF = 663,
    OF_OXM_BSN_VRF_MASKED = 664,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 665,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 666,
    OF_OXM_CONN_TRACKING_IPV6_DST = 667,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 668,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 669,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 670,
    OF_OXM_CONN_TRACKING_LABEL = 671,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 672,
    OF_OXM_CONN_TRACKING_MARK = 673,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 674,
    OF_OXM_CONN_TRACKING_NW_DST = 675,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 676,
    OF_OXM_CONN_TRACKING_NW_PROTO = 677,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 678,
    OF_OXM_CONN_TRACKING_NW_SRC = 679,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 680,
    OF_OXM_CONN_TRACKING_STATE = 681,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 682,
    OF_OXM_CONN_TRACKING_TP_DST = 683,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 684,
    OF_OXM_CONN_TRACKING_TP_SRC = 685,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 686,
    OF_OXM_CONN_TRACKING_ZONE = 687,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 688,
    OF_OXM_ETH_DST = 689,
    OF_OXM_ETH_DST_MASKED = 690,
    OF_OXM_ETH_SRC = 691,
    OF_OXM_ETH_SRC_MASKED = 692,
    OF_OXM_ETH_TYPE = 693,
    OF_OXM_ETH_TYPE_MASKED = 694,
    OF_OXM_ICMPV4_CODE = 695,
    OF_OXM_ICMPV4_CODE_MASKED = 696,
    OF_OXM_ICMPV4_TYPE = 697,
    OF_OXM_ICMPV4_TYPE_MASKED = 698,
    OF_OXM_ICMPV6_CODE = 699,
    OF_OXM_ICMPV6_CODE_MASKED = 700,
    OF_OXM_ICMPV6_TYPE = 701,
    OF_OXM_ICMPV6_TYPE_MASKED = 702,
    OF_OXM_IN_PHY_PORT = 703,
    OF_OXM_IN_PHY_PORT_MASKED = 704,
    OF_OXM_IN_PORT = 705,
    OF_OXM_IN_PORT_MASKED = 706,
    OF_OXM_IP_DSCP = 707,
    OF_OXM_IP_DSCP_MASKED = 708,
    OF_OXM_IP_ECN = 709,
    OF_OXM_IP_ECN_MASKED = 710,
    OF_OXM_IP_PROTO = 711,
    OF_OXM_IP_PROTO_MASKED = 712,
    OF_OXM_IPV4_DST = 713,
    OF_OXM_IPV4_DST_MASKED = 714,
    OF_OXM_IPV4_SRC = 715,
    OF_OXM_IPV4_SRC_MASKED = 716,
    OF_OXM_IPV6_DST = 717,
    OF_OXM_IPV6_DST_MASKED = 718,
    OF_OXM_IPV6_EXTHDR = 719,
    OF_OXM_IPV6_EXTHDR_MASKED = 720,
    OF_OXM_IPV6_FLABEL = 721,
    OF_OXM_IPV6_FLABEL_MASKED = 722,
    OF_OXM_IPV6_ND_SLL = 723,
    OF_OXM_IPV6_ND_SLL_MASKED = 724,
    OF_OXM_IPV6_ND_TARGET = 725,
    OF_OXM_IPV6_ND_TARGET_MASKED = 726,
    OF_OXM_IPV6_ND_TLL = 727,
    OF_OXM_IPV6_ND_TLL_MASKED = 728,
    OF_OXM_IPV6_SRC = 729,
    OF_OXM_IPV6_SRC_MASKED = 730,
    OF_OXM_METADATA = 731,
    OF_OXM_METADATA_MASKED = 732,
    OF_OXM_MPLS_BOS = 733,
    OF_OXM_MPLS_BOS_MASKED = 734,
    OF_OXM_MPLS_LABEL = 735,
    OF_OXM_MPLS_LABEL_MASKED = 736,
    OF_OXM_MPLS_TC = 737,
    OF_OXM_MPLS_TC_MASKED = 738,
    OF_OXM_OVS_TCP_FLAGS = 739,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 740,
    OF_OXM_PBB_UCA = 741,
    OF_OXM_PBB_UCA_MASKED = 742,
    OF_OXM_SCTP_DST = 743,
    OF_OXM_SCTP_DST_MASKED = 744,
    OF_OXM_SCTP_SRC = 745,
    OF_OXM_SCTP_SRC_MASKED = 746,
    OF_OXM_TCP_DST = 747,
    OF_OXM_TCP_DST_MASKED = 748,
    OF_OXM_TCP_SRC = 749,
    OF_OXM_TCP_SRC_MASKED = 750,
    OF_OXM_TUNNEL_ID = 751,
    OF_OXM_TUNNEL_ID_MASKED = 752,
    OF_OXM_TUNNEL_IPV4_DST = 753,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 754,
    OF_OXM_TUNNEL_IPV4_SRC = 755,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 756,
    OF_OXM_UDP_DST = 757,
    OF_OXM_UDP_DST_MASKED = 758,
    OF_OXM_UDP_SRC = 759,
    OF_OXM_UDP_SRC_MASKED = 760,
    OF_OXM_VLAN_PCP = 761,
    OF_OXM_VLAN_PCP_MASKED = 762,
    OF_OXM_VLAN_VID = 763,
    OF_OXM_VLAN_VID_MASKED = 764,
    OF_PACKET_QUEUE = 765,
    OF_PORT_DESC = 766,
    OF_PORT_DESC_PROP = 767,
    OF_PORT_DESC_PROP_BSN = 768,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 769,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 770,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 771,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 772,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 773,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 774,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 775,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 776,
    OF_PORT_DESC_PROP_BSN_UPLINK = 777,
    OF_PORT_DESC_PROP_ETHERNET = 778,
    OF_PORT_DESC_PROP_EXPERIMENTER = 779,
    OF_PORT_DESC_PROP_OPTICAL = 780,
    OF_PORT_MOD_PROP = 781,
    OF_PORT_MOD_PROP_ETHERNET = 782,
    OF_PORT_MOD_PROP_EXPERIMENTER = 783,
    OF_PORT_MOD_PROP_OPTICAL = 784,
    OF_PORT_STATS_ENTRY = 785,
    OF_PORT_STATS_PROP = 786,
    OF_PORT_STATS_PROP_ETHERNET = 787,
    OF_PORT_STATS_PROP_EXPERIMENTER = 788,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 789,
    OF_PORT_STATS_PROP_OPTICAL = 790,
    OF_QUEUE_DESC = 791,
    OF_QUEUE_DESC_PROP = 792,
    OF_QUEUE_DESC_PROP_BSN = 793,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 794,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 795,
    OF_QUEUE_DESC_PROP_MAX_RATE = 796,
    OF_QUEUE_DESC_PROP_MIN_RATE = 797,
    OF_QUEUE_PROP = 798,
    OF_QUEUE_PROP_EXPERIMENTER = 799,
    OF_QUEUE_PROP_MAX_RATE = 800,
    OF_QUEUE_PROP_MIN_RATE = 801,
    OF_QUEUE_STATS_ENTRY = 802,
    OF_QUEUE_STATS_PROP = 803,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 804,
    OF_ROLE_PROP = 805,
    OF_ROLE_PROP_EXPERIMENTER = 806,
    OF_TABLE_DESC = 807,
    OF_TABLE_FEATURE_PROP = 808,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 809,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 810,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 811,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 812,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 813,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 814,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 815,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 816,
    OF_TABLE_FEATURE_PROP_MATCH = 817,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 818,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 819,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 820,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 821,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 822,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 823,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 824,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 825,
    OF_TABLE_FEATURES = 826,
    OF_TABLE_MOD_PROP = 827,
    OF_TABLE_MOD_PROP_EVICTION = 828,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 829,
    OF_TABLE_MOD_PROP_VACANCY = 830,
    OF_TABLE_STATS_ENTRY = 831,
    OF_UINT32 = 832,
    OF_UINT64 = 833,
    OF_UINT8 = 834,
    ...
    /* List objects */
    OF_LIST_ACTION = 835,
    OF_LIST_ACTION_ID = 836,
    OF_LIST_ASYNC_CONFIG_PROP = 837,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 838,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 839,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 840,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 841,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 842,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 843,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 844,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 845,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 846,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 847,
    OF_LIST_BSN_INTERFACE = 848,
    OF_LIST_BSN_LACP_STATS_ENTRY = 849,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 850,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 851,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 852,
    OF_LIST_BSN_TLV = 853,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 854,
    OF_LIST_BSN_VLAN_MAC = 855,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 856,
    OF_LIST_BUCKET = 857,
    OF_LIST_BUCKET_COUNTER = 858,
    OF_LIST_BUNDLE_PROP = 859,
    OF_LIST_FLOW_STATS_ENTRY = 860,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 861,
    OF_LIST_GROUP_STATS_ENTRY = 862,
    OF_LIST_HELLO_ELEM = 863,
    OF_LIST_INSTRUCTION = 864,
    OF_LIST_INSTRUCTION_ID = 865,
    OF_LIST_METER_BAND = 866,
    OF_LIST_METER_BAND_STATS = 867,
    OF_LIST_METER_CONFIG = 868,
    OF_LIST_METER_STATS = 869,
    OF_LIST_OXM = 870,
    OF_LIST_PACKET_QUEUE = 871,
    OF_LIST_PORT_DESC = 872,
    OF_LIST_PORT_DESC_PROP = 873,
    OF_LIST_PORT_MOD_PROP = 874,
    OF_LIST_PORT_STATS_ENTRY = 875,
    OF_LIST_PORT_STATS_PROP = 876,
    OF_LIST_QUEUE_DESC = 877,
    OF_LIST_QUEUE_DESC_PROP = 878,
    OF_LIST_QUEUE_PROP = 879,
    OF_LIST_QUEUE_STATS_ENTRY = 880,
    OF_LIST_QUEUE_STATS_PROP = 881,
    OF_LIST_ROLE_PROP = 882,
    OF_LIST_TABLE_DESC = 883,
    OF_LIST_TABLE_FEATURE_PROP = 884,
    OF_LIST_TABLE_FEATURES = 885,
    OF_LIST_TABLE_MOD_PROP = 886,
    OF_LIST_TABLE_STATS_ENTRY = 887,
    OF_LIST_UINT32 = 888,
    OF_LIST_UINT64 = 889,
    OF_LIST_UINT8 = 890,
