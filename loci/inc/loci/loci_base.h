...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PUSH_TWO_PER_POLICY = 456,
    OF_BSN_TLV_PUSH_TWO_TAGS_CAPABILITY = 457,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 458,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 459,
    OF_BSN_TLV_QOS_PRIORITY = 460,
    OF_BSN_TLV_QUEUE_ID = 461,
    OF_BSN_TLV_QUEUE_WEIGHT = 462,
    OF_BSN_TLV_RATE_LIMIT = 463,
    OF_BSN_TLV_RATE_UNIT = 464,
    OF_BSN_TLV_RECORD_PACKETS = 465,
    OF_BSN_TLV_REDUNDANT_MGMT = 466,
    OF_BSN_TLV_REFERENCE = 467,
    OF_BSN_TLV_REPLY_PACKETS = 468,
    OF_BSN_TLV_REQUEST_PACKETS = 469,
    OF_BSN_TLV_REST_SERVER = 470,
    OF_BSN_TLV_ROUTING_PARAM = 471,
    OF_BSN_TLV_RX_BYTES = 472,
    OF_BSN_TLV_RX_PACKETS = 473,
    OF_BSN_TLV_SAMPLING_RATE = 474,
    OF_BSN_TLV_SCTP_DST = 475,
    OF_BSN_TLV_SCTP_SRC = 476,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 477,
    OF_BSN_TLV_SOCKET = 478,
    OF_BSN_TLV_SRC_MAC_CML = 479,
    OF_BSN_TLV_STATUS = 480,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 481,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 482,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 483,
    OF_BSN_TLV_SUB_AGENT_ID = 484,
    OF_BSN_TLV_TCP_DST = 485,
    OF_BSN_TLV_TCP_FLAGS = 486,
    OF_BSN_TLV_TCP_SRC = 487,
    OF_BSN_TLV_THREAD = 488,
    OF_BSN_TLV_TIMESTAMP = 489,
    OF_BSN_TLV_TTL = 490,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 491,
    OF_BSN_TLV_TX_BYTES = 492,
    OF_BSN_TLV_TX_PACKETS = 493,
    OF_BSN_TLV_UDF_ANCHOR = 494,
    OF_BSN_TLV_UDF_CAPABILITY = 495,
    OF_BSN_TLV_UDF_DATA = 496,
    OF_BSN_TLV_UDF_ID = 497,
    OF_BSN_TLV_UDF_LENGTH = 498,
    OF_BSN_TLV_UDF_OFFSET = 499,
    OF_BSN_TLV_UDP_DST = 500,
    OF_BSN_TLV_UDP_SRC = 501,
    OF_BSN_TLV_UINT32 = 502,
    ...
    OF_BSN_TLV_UPGRADE = 508,
    OF_BSN_TLV_URI_SCHEME = 509,
    OF_BSN_TLV_USE_PACKET_STATE = 510,
    OF_BSN_TLV_USER_CONFIGURED = 511,
    OF_BSN_TLV_VFI = 512,
    OF_BSN_TLV_VFP_CLASS_ID = 513,
    OF_BSN_TLV_VIRTUAL = 514,
    OF_BSN_TLV_VLAN_MAC_LIST = 515,
    OF_BSN_TLV_VLAN_PCP = 516,
    OF_BSN_TLV_VLAN_VID = 517,
    OF_BSN_TLV_VLAN_VID_MASK = 518,
    OF_BSN_TLV_VNI = 519,
    OF_BSN_TLV_VPN_KEY = 520,
    OF_BSN_TLV_VRF = 521,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 522,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 523,
    OF_BSN_VLAN_MAC = 524,
    OF_BSN_VPORT = 525,
    OF_BSN_VPORT_L2GRE = 526,
    OF_BSN_VPORT_Q_IN_Q = 527,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 528,
    OF_BUCKET = 529,
    OF_BUCKET_COUNTER = 530,
    OF_BUNDLE_PROP = 531,
    OF_BUNDLE_PROP_EXPERIMENTER = 532,
    OF_FLOW_STATS_ENTRY = 533,
    OF_GROUP_DESC_STATS_ENTRY = 534,
    OF_GROUP_STATS_ENTRY = 535,
    OF_HELLO_ELEM = 536,
    OF_HELLO_ELEM_VERSIONBITMAP = 537,
    OF_INSTRUCTION = 538,
    OF_INSTRUCTION_APPLY_ACTIONS = 539,
    OF_INSTRUCTION_BSN = 540,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 541,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 542,
    OF_INSTRUCTION_BSN_DENY = 543,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 544,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 545,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 546,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 547,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 548,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 549,
    OF_INSTRUCTION_BSN_HASH_SELECT = 550,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 551,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 552,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 553,
    OF_INSTRUCTION_BSN_PERMIT = 554,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 555,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 556,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 557,
    OF_INSTRUCTION_CLEAR_ACTIONS = 558,
    OF_INSTRUCTION_EXPERIMENTER = 559,
    OF_INSTRUCTION_GOTO_TABLE = 560,
    OF_INSTRUCTION_ID = 561,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 562,
    OF_INSTRUCTION_ID_BSN = 563,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 564,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 565,
    OF_INSTRUCTION_ID_BSN_DENY = 566,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 567,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 568,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 569,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 570,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 571,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 572,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 573,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 574,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 575,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 576,
    OF_INSTRUCTION_ID_BSN_PERMIT = 577,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 578,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 579,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 580,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 581,
    OF_INSTRUCTION_ID_EXPERIMENTER = 582,
    OF_INSTRUCTION_ID_GOTO_TABLE = 583,
    OF_INSTRUCTION_ID_METER = 584,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 585,
    OF_INSTRUCTION_ID_WRITE_METADATA = 586,
    OF_INSTRUCTION_METER = 587,
    OF_INSTRUCTION_WRITE_ACTIONS = 588,
    OF_INSTRUCTION_WRITE_METADATA = 589,
    OF_MATCH_V1 = 590,
    OF_MATCH_V2 = 591,
    OF_MATCH_V3 = 592,
    OF_METER_BAND = 593,
    OF_METER_BAND_DROP = 594,
    OF_METER_BAND_DSCP_REMARK = 595,
    OF_METER_BAND_EXPERIMENTER = 596,
    OF_METER_BAND_STATS = 597,
    OF_METER_CONFIG = 598,
    OF_METER_FEATURES = 599,
    OF_METER_STATS = 600,
    OF_OXM = 601,
    OF_OXM_ARP_OP = 602,
    OF_OXM_ARP_OP_MASKED = 603,
    OF_OXM_ARP_SHA = 604,
    OF_OXM_ARP_SHA_MASKED = 605,
    OF_OXM_ARP_SPA = 606,
    OF_OXM_ARP_SPA_MASKED = 607,
    OF_OXM_ARP_THA = 608,
    OF_OXM_ARP_THA_MASKED = 609,
    OF_OXM_ARP_TPA = 610,
    OF_OXM_ARP_TPA_MASKED = 611,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 612,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 613,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 614,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 615,
    OF_OXM_BSN_IFP_CLASS_ID = 616,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 617,
    OF_OXM_BSN_IN_PORTS_128 = 618,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 619,
    OF_OXM_BSN_IN_PORTS_512 = 620,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 621,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 622,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 623,
    OF_OXM_BSN_INNER_ETH_DST = 624,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 625,
    OF_OXM_BSN_INNER_ETH_SRC = 626,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 627,
    OF_OXM_BSN_INNER_VLAN_VID = 628,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 629,
    OF_OXM_BSN_IP_FRAGMENTATION = 630,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 631,
    OF_OXM_BSN_L2_CACHE_HIT = 632,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 633,
    OF_OXM_BSN_L3_DST_CLASS_ID = 634,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 635,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 636,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 637,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 638,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 639,
    OF_OXM_BSN_LAG_ID = 640,
    OF_OXM_BSN_LAG_ID_MASKED = 641,
    OF_OXM_BSN_TCP_FLAGS = 642,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 643,
    OF_OXM_BSN_UDF0 = 644,
    OF_OXM_BSN_UDF0_MASKED = 645,
    OF_OXM_BSN_UDF1 = 646,
    OF_OXM_BSN_UDF1_MASKED = 647,
    OF_OXM_BSN_UDF2 = 648,
    OF_OXM_BSN_UDF2_MASKED = 649,
    OF_OXM_BSN_UDF3 = 650,
    OF_OXM_BSN_UDF3_MASKED = 651,
    OF_OXM_BSN_UDF4 = 652,
    OF_OXM_BSN_UDF4_MASKED = 653,
    OF_OXM_BSN_UDF5 = 654,
    OF_OXM_BSN_UDF5_MASKED = 655,
    OF_OXM_BSN_UDF6 = 656,
    OF_OXM_BSN_UDF6_MASKED = 657,
    OF_OXM_BSN_UDF7 = 658,
    OF_OXM_BSN_UDF7_MASKED = 659,
    OF_OXM_BSN_VFI = 660,
    OF_OXM_BSN_VFI_MASKED = 661,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 662,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 663,
    OF_OXM_BSN_VRF = 664,
    OF_OXM_BSN_VRF_MASKED = 665,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 666,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 667,
    OF_OXM_CONN_TRACKING_IPV6_DST = 668,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 669,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 670,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 671,
    OF_OXM_CONN_TRACKING_LABEL = 672,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 673,
    OF_OXM_CONN_TRACKING_MARK = 674,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 675,
    OF_OXM_CONN_TRACKING_NW_DST = 676,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 677,
    OF_OXM_CONN_TRACKING_NW_PROTO = 678,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 679,
    OF_OXM_CONN_TRACKING_NW_SRC = 680,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 681,
    OF_OXM_CONN_TRACKING_STATE = 682,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 683,
    OF_OXM_CONN_TRACKING_TP_DST = 684,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 685,
    OF_OXM_CONN_TRACKING_TP_SRC = 686,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 687,
    OF_OXM_CONN_TRACKING_ZONE = 688,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 689,
    OF_OXM_ETH_DST = 690,
    OF_OXM_ETH_DST_MASKED = 691,
    OF_OXM_ETH_SRC = 692,
    OF_OXM_ETH_SRC_MASKED = 693,
    OF_OXM_ETH_TYPE = 694,
    OF_OXM_ETH_TYPE_MASKED = 695,
    OF_OXM_ICMPV4_CODE = 696,
    OF_OXM_ICMPV4_CODE_MASKED = 697,
    OF_OXM_ICMPV4_TYPE = 698,
    OF_OXM_ICMPV4_TYPE_MASKED = 699,
    OF_OXM_ICMPV6_CODE = 700,
    OF_OXM_ICMPV6_CODE_MASKED = 701,
    OF_OXM_ICMPV6_TYPE = 702,
    OF_OXM_ICMPV6_TYPE_MASKED = 703,
    OF_OXM_IN_PHY_PORT = 704,
    OF_OXM_IN_PHY_PORT_MASKED = 705,
    OF_OXM_IN_PORT = 706,
    OF_OXM_IN_PORT_MASKED = 707,
    OF_OXM_IP_DSCP = 708,
    OF_OXM_IP_DSCP_MASKED = 709,
    OF_OXM_IP_ECN = 710,
    OF_OXM_IP_ECN_MASKED = 711,
    OF_OXM_IP_PROTO = 712,
    OF_OXM_IP_PROTO_MASKED = 713,
    OF_OXM_IPV4_DST = 714,
    OF_OXM_IPV4_DST_MASKED = 715,
    OF_OXM_IPV4_SRC = 716,
    OF_OXM_IPV4_SRC_MASKED = 717,
    OF_OXM_IPV6_DST = 718,
    OF_OXM_IPV6_DST_MASKED = 719,
    OF_OXM_IPV6_EXTHDR = 720,
    OF_OXM_IPV6_EXTHDR_MASKED = 721,
    OF_OXM_IPV6_FLABEL = 722,
    OF_OXM_IPV6_FLABEL_MASKED = 723,
    OF_OXM_IPV6_ND_SLL = 724,
    OF_OXM_IPV6_ND_SLL_MASKED = 725,
    OF_OXM_IPV6_ND_TARGET = 726,
    OF_OXM_IPV6_ND_TARGET_MASKED = 727,
    OF_OXM_IPV6_ND_TLL = 728,
    OF_OXM_IPV6_ND_TLL_MASKED = 729,
    OF_OXM_IPV6_SRC = 730,
    OF_OXM_IPV6_SRC_MASKED = 731,
    OF_OXM_METADATA = 732,
    OF_OXM_METADATA_MASKED = 733,
    OF_OXM_MPLS_BOS = 734,
    OF_OXM_MPLS_BOS_MASKED = 735,
    OF_OXM_MPLS_LABEL = 736,
    OF_OXM_MPLS_LABEL_MASKED = 737,
    OF_OXM_MPLS_TC = 738,
    OF_OXM_MPLS_TC_MASKED = 739,
    OF_OXM_OVS_TCP_FLAGS = 740,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 741,
    OF_OXM_PBB_UCA = 742,
    OF_OXM_PBB_UCA_MASKED = 743,
    OF_OXM_SCTP_DST = 744,
    OF_OXM_SCTP_DST_MASKED = 745,
    OF_OXM_SCTP_SRC = 746,
    OF_OXM_SCTP_SRC_MASKED = 747,
    OF_OXM_TCP_DST = 748,
    OF_OXM_TCP_DST_MASKED = 749,
    OF_OXM_TCP_SRC = 750,
    OF_OXM_TCP_SRC_MASKED = 751,
    OF_OXM_TUNNEL_ID = 752,
    OF_OXM_TUNNEL_ID_MASKED = 753,
    OF_OXM_TUNNEL_IPV4_DST = 754,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 755,
    OF_OXM_TUNNEL_IPV4_SRC = 756,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 757,
    OF_OXM_UDP_DST = 758,
    OF_OXM_UDP_DST_MASKED = 759,
    OF_OXM_UDP_SRC = 760,
    OF_OXM_UDP_SRC_MASKED = 761,
    OF_OXM_VLAN_PCP = 762,
    OF_OXM_VLAN_PCP_MASKED = 763,
    OF_OXM_VLAN_VID = 764,
    OF_OXM_VLAN_VID_MASKED = 765,
    OF_PACKET_QUEUE = 766,
    OF_PORT_DESC = 767,
    OF_PORT_DESC_PROP = 768,
    OF_PORT_DESC_PROP_BSN = 769,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 770,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 771,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 772,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 773,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 774,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 775,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 776,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 777,
    OF_PORT_DESC_PROP_BSN_UPLINK = 778,
    OF_PORT_DESC_PROP_ETHERNET = 779,
    OF_PORT_DESC_PROP_EXPERIMENTER = 780,
    OF_PORT_DESC_PROP_OPTICAL = 781,
    OF_PORT_MOD_PROP = 782,
    OF_PORT_MOD_PROP_ETHERNET = 783,
    OF_PORT_MOD_PROP_EXPERIMENTER = 784,
    OF_PORT_MOD_PROP_OPTICAL = 785,
    OF_PORT_STATS_ENTRY = 786,
    OF_PORT_STATS_PROP = 787,
    OF_PORT_STATS_PROP_ETHERNET = 788,
    OF_PORT_STATS_PROP_EXPERIMENTER = 789,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 790,
    OF_PORT_STATS_PROP_OPTICAL = 791,
    OF_QUEUE_DESC = 792,
    OF_QUEUE_DESC_PROP = 793,
    OF_QUEUE_DESC_PROP_BSN = 794,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 795,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 796,
    OF_QUEUE_DESC_PROP_MAX_RATE = 797,
    OF_QUEUE_DESC_PROP_MIN_RATE = 798,
    OF_QUEUE_PROP = 799,
    OF_QUEUE_PROP_EXPERIMENTER = 800,
    OF_QUEUE_PROP_MAX_RATE = 801,
    OF_QUEUE_PROP_MIN_RATE = 802,
    OF_QUEUE_STATS_ENTRY = 803,
    OF_QUEUE_STATS_PROP = 804,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 805,
    OF_ROLE_PROP = 806,
    OF_ROLE_PROP_EXPERIMENTER = 807,
    OF_TABLE_DESC = 808,
    OF_TABLE_FEATURE_PROP = 809,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 810,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 811,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 812,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 813,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 814,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 815,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 816,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 817,
    OF_TABLE_FEATURE_PROP_MATCH = 818,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 819,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 820,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 821,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 822,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 823,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 824,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 825,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 826,
    OF_TABLE_FEATURES = 827,
    OF_TABLE_MOD_PROP = 828,
    OF_TABLE_MOD_PROP_EVICTION = 829,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 830,
    OF_TABLE_MOD_PROP_VACANCY = 831,
    OF_TABLE_STATS_ENTRY = 832,
    OF_UINT32 = 833,
    OF_UINT64 = 834,
    OF_UINT8 = 835,
    ...
    /* List objects */
    OF_LIST_ACTION = 836,
    OF_LIST_ACTION_ID = 837,
    OF_LIST_ASYNC_CONFIG_PROP = 838,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 839,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 840,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 841,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 842,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 843,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 844,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 845,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 846,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 847,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 848,
    OF_LIST_BSN_INTERFACE = 849,
    OF_LIST_BSN_LACP_STATS_ENTRY = 850,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 851,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 852,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 853,
    OF_LIST_BSN_TLV = 854,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 855,
    OF_LIST_BSN_VLAN_MAC = 856,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 857,
    OF_LIST_BUCKET = 858,
    OF_LIST_BUCKET_COUNTER = 859,
    OF_LIST_BUNDLE_PROP = 860,
    OF_LIST_FLOW_STATS_ENTRY = 861,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 862,
    OF_LIST_GROUP_STATS_ENTRY = 863,
    OF_LIST_HELLO_ELEM = 864,
    OF_LIST_INSTRUCTION = 865,
    OF_LIST_INSTRUCTION_ID = 866,
    OF_LIST_METER_BAND = 867,
    OF_LIST_METER_BAND_STATS = 868,
    OF_LIST_METER_CONFIG = 869,
    OF_LIST_METER_STATS = 870,
    OF_LIST_OXM = 871,
    OF_LIST_PACKET_QUEUE = 872,
    OF_LIST_PORT_DESC = 873,
    OF_LIST_PORT_DESC_PROP = 874,
    OF_LIST_PORT_MOD_PROP = 875,
    OF_LIST_PORT_STATS_ENTRY = 876,
    OF_LIST_PORT_STATS_PROP = 877,
    OF_LIST_QUEUE_DESC = 878,
    OF_LIST_QUEUE_DESC_PROP = 879,
    OF_LIST_QUEUE_PROP = 880,
    OF_LIST_QUEUE_STATS_ENTRY = 881,
    OF_LIST_QUEUE_STATS_PROP = 882,
    OF_LIST_ROLE_PROP = 883,
    OF_LIST_TABLE_DESC = 884,
    OF_LIST_TABLE_FEATURE_PROP = 885,
    OF_LIST_TABLE_FEATURES = 886,
    OF_LIST_TABLE_MOD_PROP = 887,
    OF_LIST_TABLE_STATS_ENTRY = 888,
    OF_LIST_UINT32 = 889,
    OF_LIST_UINT64 = 890,
    OF_LIST_UINT8 = 891,
