...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 411,
    ...
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 487,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 488,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 489,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 490,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 491,
    OF_INSTRUCTION_BSN_HASH_SELECT = 492,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 493,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 494,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 495,
    OF_INSTRUCTION_BSN_PERMIT = 496,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 497,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 498,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 499,
    OF_INSTRUCTION_CLEAR_ACTIONS = 500,
    OF_INSTRUCTION_EXPERIMENTER = 501,
    OF_INSTRUCTION_GOTO_TABLE = 502,
    OF_INSTRUCTION_ID = 503,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 504,
    OF_INSTRUCTION_ID_BSN = 505,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 506,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 507,
    OF_INSTRUCTION_ID_BSN_DENY = 508,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 509,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 510,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 511,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 512,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 513,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 514,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 515,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 516,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 517,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 518,
    OF_INSTRUCTION_ID_BSN_PERMIT = 519,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 520,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 521,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 522,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 523,
    OF_INSTRUCTION_ID_EXPERIMENTER = 524,
    OF_INSTRUCTION_ID_GOTO_TABLE = 525,
    OF_INSTRUCTION_ID_METER = 526,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 527,
    OF_INSTRUCTION_ID_WRITE_METADATA = 528,
    OF_INSTRUCTION_METER = 529,
    OF_INSTRUCTION_WRITE_ACTIONS = 530,
    OF_INSTRUCTION_WRITE_METADATA = 531,
    OF_MATCH_V1 = 532,
    OF_MATCH_V2 = 533,
    OF_MATCH_V3 = 534,
    OF_METER_BAND = 535,
    OF_METER_BAND_DROP = 536,
    OF_METER_BAND_DSCP_REMARK = 537,
    OF_METER_BAND_EXPERIMENTER = 538,
    OF_METER_BAND_STATS = 539,
    OF_METER_CONFIG = 540,
    OF_METER_FEATURES = 541,
    OF_METER_STATS = 542,
    OF_OXM = 543,
    OF_OXM_ARP_OP = 544,
    OF_OXM_ARP_OP_MASKED = 545,
    OF_OXM_ARP_SHA = 546,
    OF_OXM_ARP_SHA_MASKED = 547,
    OF_OXM_ARP_SPA = 548,
    OF_OXM_ARP_SPA_MASKED = 549,
    OF_OXM_ARP_THA = 550,
    OF_OXM_ARP_THA_MASKED = 551,
    OF_OXM_ARP_TPA = 552,
    OF_OXM_ARP_TPA_MASKED = 553,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 554,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 555,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 556,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 557,
    OF_OXM_BSN_IFP_CLASS_ID = 558,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 559,
    OF_OXM_BSN_IN_PORTS_128 = 560,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 561,
    OF_OXM_BSN_IN_PORTS_512 = 562,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 563,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 564,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 565,
    OF_OXM_BSN_INNER_ETH_DST = 566,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 567,
    OF_OXM_BSN_INNER_ETH_SRC = 568,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 569,
    OF_OXM_BSN_INNER_VLAN_VID = 570,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 571,
    OF_OXM_BSN_IP_FRAGMENTATION = 572,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 573,
    OF_OXM_BSN_L2_CACHE_HIT = 574,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 575,
    OF_OXM_BSN_L3_DST_CLASS_ID = 576,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 577,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 578,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 579,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 580,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 581,
    OF_OXM_BSN_LAG_ID = 582,
    OF_OXM_BSN_LAG_ID_MASKED = 583,
    OF_OXM_BSN_TCP_FLAGS = 584,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 585,
    OF_OXM_BSN_UDF0 = 586,
    OF_OXM_BSN_UDF0_MASKED = 587,
    OF_OXM_BSN_UDF1 = 588,
    OF_OXM_BSN_UDF1_MASKED = 589,
    OF_OXM_BSN_UDF2 = 590,
    OF_OXM_BSN_UDF2_MASKED = 591,
    OF_OXM_BSN_UDF3 = 592,
    OF_OXM_BSN_UDF3_MASKED = 593,
    OF_OXM_BSN_UDF4 = 594,
    OF_OXM_BSN_UDF4_MASKED = 595,
    OF_OXM_BSN_UDF5 = 596,
    OF_OXM_BSN_UDF5_MASKED = 597,
    OF_OXM_BSN_UDF6 = 598,
    OF_OXM_BSN_UDF6_MASKED = 599,
    OF_OXM_BSN_UDF7 = 600,
    OF_OXM_BSN_UDF7_MASKED = 601,
    OF_OXM_BSN_VFI = 602,
    OF_OXM_BSN_VFI_MASKED = 603,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 604,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 605,
    OF_OXM_BSN_VRF = 606,
    OF_OXM_BSN_VRF_MASKED = 607,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 608,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 609,
    OF_OXM_CONN_TRACKING_IPV6_DST = 610,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 611,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 612,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 613,
    OF_OXM_CONN_TRACKING_LABEL = 614,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 615,
    OF_OXM_CONN_TRACKING_MARK = 616,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 617,
    OF_OXM_CONN_TRACKING_NW_DST = 618,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 619,
    OF_OXM_CONN_TRACKING_NW_PROTO = 620,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 621,
    OF_OXM_CONN_TRACKING_NW_SRC = 622,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 623,
    OF_OXM_CONN_TRACKING_STATE = 624,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 625,
    OF_OXM_CONN_TRACKING_TP_DST = 626,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 627,
    OF_OXM_CONN_TRACKING_TP_SRC = 628,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 629,
    OF_OXM_CONN_TRACKING_ZONE = 630,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 631,
    OF_OXM_ETH_DST = 632,
    OF_OXM_ETH_DST_MASKED = 633,
    OF_OXM_ETH_SRC = 634,
    OF_OXM_ETH_SRC_MASKED = 635,
    OF_OXM_ETH_TYPE = 636,
    OF_OXM_ETH_TYPE_MASKED = 637,
    OF_OXM_ICMPV4_CODE = 638,
    OF_OXM_ICMPV4_CODE_MASKED = 639,
    OF_OXM_ICMPV4_TYPE = 640,
    OF_OXM_ICMPV4_TYPE_MASKED = 641,
    OF_OXM_ICMPV6_CODE = 642,
    OF_OXM_ICMPV6_CODE_MASKED = 643,
    OF_OXM_ICMPV6_TYPE = 644,
    OF_OXM_ICMPV6_TYPE_MASKED = 645,
    OF_OXM_IN_PHY_PORT = 646,
    OF_OXM_IN_PHY_PORT_MASKED = 647,
    OF_OXM_IN_PORT = 648,
    OF_OXM_IN_PORT_MASKED = 649,
    OF_OXM_IP_DSCP = 650,
    OF_OXM_IP_DSCP_MASKED = 651,
    OF_OXM_IP_ECN = 652,
    OF_OXM_IP_ECN_MASKED = 653,
    OF_OXM_IP_PROTO = 654,
    OF_OXM_IP_PROTO_MASKED = 655,
    OF_OXM_IPV4_DST = 656,
    OF_OXM_IPV4_DST_MASKED = 657,
    OF_OXM_IPV4_SRC = 658,
    OF_OXM_IPV4_SRC_MASKED = 659,
    OF_OXM_IPV6_DST = 660,
    OF_OXM_IPV6_DST_MASKED = 661,
    OF_OXM_IPV6_EXTHDR = 662,
    OF_OXM_IPV6_EXTHDR_MASKED = 663,
    OF_OXM_IPV6_FLABEL = 664,
    OF_OXM_IPV6_FLABEL_MASKED = 665,
    OF_OXM_IPV6_ND_SLL = 666,
    OF_OXM_IPV6_ND_SLL_MASKED = 667,
    OF_OXM_IPV6_ND_TARGET = 668,
    OF_OXM_IPV6_ND_TARGET_MASKED = 669,
    OF_OXM_IPV6_ND_TLL = 670,
    OF_OXM_IPV6_ND_TLL_MASKED = 671,
    OF_OXM_IPV6_SRC = 672,
    OF_OXM_IPV6_SRC_MASKED = 673,
    OF_OXM_METADATA = 674,
    OF_OXM_METADATA_MASKED = 675,
    OF_OXM_MPLS_BOS = 676,
    OF_OXM_MPLS_BOS_MASKED = 677,
    OF_OXM_MPLS_LABEL = 678,
    OF_OXM_MPLS_LABEL_MASKED = 679,
    OF_OXM_MPLS_TC = 680,
    OF_OXM_MPLS_TC_MASKED = 681,
    OF_OXM_OVS_TCP_FLAGS = 682,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 683,
    OF_OXM_PBB_UCA = 684,
    OF_OXM_PBB_UCA_MASKED = 685,
    OF_OXM_SCTP_DST = 686,
    OF_OXM_SCTP_DST_MASKED = 687,
    OF_OXM_SCTP_SRC = 688,
    OF_OXM_SCTP_SRC_MASKED = 689,
    OF_OXM_TCP_DST = 690,
    OF_OXM_TCP_DST_MASKED = 691,
    OF_OXM_TCP_SRC = 692,
    OF_OXM_TCP_SRC_MASKED = 693,
    OF_OXM_TUNNEL_ID = 694,
    OF_OXM_TUNNEL_ID_MASKED = 695,
    OF_OXM_TUNNEL_IPV4_DST = 696,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 697,
    OF_OXM_TUNNEL_IPV4_SRC = 698,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 699,
    OF_OXM_UDP_DST = 700,
    OF_OXM_UDP_DST_MASKED = 701,
    OF_OXM_UDP_SRC = 702,
    OF_OXM_UDP_SRC_MASKED = 703,
    OF_OXM_VLAN_PCP = 704,
    OF_OXM_VLAN_PCP_MASKED = 705,
    OF_OXM_VLAN_VID = 706,
    OF_OXM_VLAN_VID_MASKED = 707,
    OF_PACKET_QUEUE = 708,
    OF_PORT_DESC = 709,
    OF_PORT_DESC_PROP = 710,
    OF_PORT_DESC_PROP_BSN = 711,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 712,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 713,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 714,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 715,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 716,
    OF_PORT_DESC_PROP_BSN_UPLINK = 717,
    OF_PORT_DESC_PROP_ETHERNET = 718,
    OF_PORT_DESC_PROP_EXPERIMENTER = 719,
    OF_PORT_DESC_PROP_OPTICAL = 720,
    OF_PORT_MOD_PROP = 721,
    OF_PORT_MOD_PROP_ETHERNET = 722,
    OF_PORT_MOD_PROP_EXPERIMENTER = 723,
    OF_PORT_MOD_PROP_OPTICAL = 724,
    OF_PORT_STATS_ENTRY = 725,
    OF_PORT_STATS_PROP = 726,
    OF_PORT_STATS_PROP_ETHERNET = 727,
    OF_PORT_STATS_PROP_EXPERIMENTER = 728,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 729,
    OF_PORT_STATS_PROP_OPTICAL = 730,
    OF_QUEUE_DESC = 731,
    OF_QUEUE_DESC_PROP = 732,
    OF_QUEUE_DESC_PROP_BSN = 733,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 734,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 735,
    OF_QUEUE_DESC_PROP_MAX_RATE = 736,
    OF_QUEUE_DESC_PROP_MIN_RATE = 737,
    OF_QUEUE_PROP = 738,
    OF_QUEUE_PROP_EXPERIMENTER = 739,
    OF_QUEUE_PROP_MAX_RATE = 740,
    OF_QUEUE_PROP_MIN_RATE = 741,
    OF_QUEUE_STATS_ENTRY = 742,
    OF_QUEUE_STATS_PROP = 743,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 744,
    OF_ROLE_PROP = 745,
    OF_ROLE_PROP_EXPERIMENTER = 746,
    OF_TABLE_DESC = 747,
    OF_TABLE_FEATURE_PROP = 748,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 749,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 750,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 751,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 752,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 753,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 754,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 755,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 756,
    OF_TABLE_FEATURE_PROP_MATCH = 757,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 758,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 759,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 760,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 761,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 762,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 763,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 764,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 765,
    OF_TABLE_FEATURES = 766,
    OF_TABLE_MOD_PROP = 767,
    OF_TABLE_MOD_PROP_EVICTION = 768,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 769,
    OF_TABLE_MOD_PROP_VACANCY = 770,
    OF_TABLE_STATS_ENTRY = 771,
    OF_UINT32 = 772,
    OF_UINT64 = 773,
    OF_UINT8 = 774,
    ...
    /* List objects */
    OF_LIST_ACTION = 775,
    OF_LIST_ACTION_ID = 776,
    OF_LIST_ASYNC_CONFIG_PROP = 777,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 778,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 779,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 780,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 781,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 782,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 783,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 784,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 785,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 786,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 787,
    OF_LIST_BSN_INTERFACE = 788,
    OF_LIST_BSN_LACP_STATS_ENTRY = 789,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 790,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 791,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 792,
    OF_LIST_BSN_TLV = 793,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 794,
    OF_LIST_BSN_VLAN_MAC = 795,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 796,
    OF_LIST_BUCKET = 797,
    OF_LIST_BUCKET_COUNTER = 798,
    OF_LIST_BUNDLE_PROP = 799,
    OF_LIST_FLOW_STATS_ENTRY = 800,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 801,
    OF_LIST_GROUP_STATS_ENTRY = 802,
    OF_LIST_HELLO_ELEM = 803,
    OF_LIST_INSTRUCTION = 804,
    OF_LIST_INSTRUCTION_ID = 805,
    OF_LIST_METER_BAND = 806,
    OF_LIST_METER_BAND_STATS = 807,
    OF_LIST_METER_CONFIG = 808,
    OF_LIST_METER_STATS = 809,
    OF_LIST_OXM = 810,
    OF_LIST_PACKET_QUEUE = 811,
    OF_LIST_PORT_DESC = 812,
    OF_LIST_PORT_DESC_PROP = 813,
    OF_LIST_PORT_MOD_PROP = 814,
    OF_LIST_PORT_STATS_ENTRY = 815,
    OF_LIST_PORT_STATS_PROP = 816,
    OF_LIST_QUEUE_DESC = 817,
    OF_LIST_QUEUE_DESC_PROP = 818,
    OF_LIST_QUEUE_PROP = 819,
    OF_LIST_QUEUE_STATS_ENTRY = 820,
    OF_LIST_QUEUE_STATS_PROP = 821,
    OF_LIST_ROLE_PROP = 822,
    OF_LIST_TABLE_DESC = 823,
    OF_LIST_TABLE_FEATURE_PROP = 824,
    OF_LIST_TABLE_FEATURES = 825,
    OF_LIST_TABLE_MOD_PROP = 826,
    OF_LIST_TABLE_STATS_ENTRY = 827,
    OF_LIST_UINT32 = 828,
    OF_LIST_UINT64 = 829,
    OF_LIST_UINT8 = 830,
