...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PORT = 403,
    OF_BSN_TLV_PORT_USAGE = 404,
    OF_BSN_TLV_PORT_VXLAN_MODE = 405,
    OF_BSN_TLV_PRIORITY = 406,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 407,
    OF_BSN_TLV_QOS_PRIORITY = 408,
    OF_BSN_TLV_QUEUE_ID = 409,
    OF_BSN_TLV_QUEUE_WEIGHT = 410,
    OF_BSN_TLV_RATE_LIMIT = 411,
    OF_BSN_TLV_RATE_UNIT = 412,
    OF_BSN_TLV_RECORD_PACKETS = 413,
    OF_BSN_TLV_REFERENCE = 414,
    OF_BSN_TLV_REPLY_PACKETS = 415,
    OF_BSN_TLV_REQUEST_PACKETS = 416,
    OF_BSN_TLV_REST_SERVER = 417,
    OF_BSN_TLV_RX_BYTES = 418,
    OF_BSN_TLV_RX_PACKETS = 419,
    OF_BSN_TLV_SAMPLING_RATE = 420,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 421,
    OF_BSN_TLV_STATUS = 422,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 423,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 424,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 425,
    OF_BSN_TLV_SUB_AGENT_ID = 426,
    OF_BSN_TLV_TCP_DST = 427,
    OF_BSN_TLV_TCP_FLAGS = 428,
    OF_BSN_TLV_TCP_SRC = 429,
    OF_BSN_TLV_TIMESTAMP = 430,
    OF_BSN_TLV_TTL = 431,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 432,
    OF_BSN_TLV_TX_BYTES = 433,
    OF_BSN_TLV_TX_PACKETS = 434,
    OF_BSN_TLV_UDF_ANCHOR = 435,
    OF_BSN_TLV_UDF_ID = 436,
    OF_BSN_TLV_UDF_LENGTH = 437,
    OF_BSN_TLV_UDF_OFFSET = 438,
    OF_BSN_TLV_UDP_DST = 439,
    OF_BSN_TLV_UDP_SRC = 440,
    OF_BSN_TLV_UINT64_LIST = 441,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 442,
    OF_BSN_TLV_UNICAST_RATE = 443,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 444,
    OF_BSN_TLV_UNTAGGED = 445,
    OF_BSN_TLV_URI_SCHEME = 446,
    OF_BSN_TLV_USE_PACKET_STATE = 447,
    OF_BSN_TLV_USE_PEER_WHEN_EMPTY = 448,
    OF_BSN_TLV_VFI = 449,
    ...
    OF_PORT_DESC_PROP_BSN_UPLINK = 683,
    OF_PORT_DESC_PROP_ETHERNET = 684,
    OF_PORT_DESC_PROP_EXPERIMENTER = 685,
    OF_PORT_DESC_PROP_OPTICAL = 686,
    OF_PORT_MOD_PROP = 687,
    OF_PORT_MOD_PROP_ETHERNET = 688,
    OF_PORT_MOD_PROP_EXPERIMENTER = 689,
    OF_PORT_MOD_PROP_OPTICAL = 690,
    OF_PORT_STATS_ENTRY = 691,
    OF_PORT_STATS_PROP = 692,
    OF_PORT_STATS_PROP_ETHERNET = 693,
    OF_PORT_STATS_PROP_EXPERIMENTER = 694,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 695,
    OF_PORT_STATS_PROP_OPTICAL = 696,
    OF_QUEUE_DESC = 697,
    OF_QUEUE_DESC_PROP = 698,
    OF_QUEUE_DESC_PROP_BSN = 699,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 700,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 701,
    OF_QUEUE_DESC_PROP_MAX_RATE = 702,
    OF_QUEUE_DESC_PROP_MIN_RATE = 703,
    OF_QUEUE_PROP = 704,
    OF_QUEUE_PROP_EXPERIMENTER = 705,
    OF_QUEUE_PROP_MAX_RATE = 706,
    OF_QUEUE_PROP_MIN_RATE = 707,
    OF_QUEUE_STATS_ENTRY = 708,
    OF_QUEUE_STATS_PROP = 709,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 710,
    OF_ROLE_PROP = 711,
    OF_ROLE_PROP_EXPERIMENTER = 712,
    OF_TABLE_DESC = 713,
    OF_TABLE_FEATURE_PROP = 714,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 715,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 716,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 717,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 718,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 719,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 720,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 721,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 722,
    OF_TABLE_FEATURE_PROP_MATCH = 723,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 724,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 725,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 726,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 727,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 728,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 729,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 730,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 731,
    OF_TABLE_FEATURES = 732,
    OF_TABLE_MOD_PROP = 733,
    OF_TABLE_MOD_PROP_EVICTION = 734,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 735,
    OF_TABLE_MOD_PROP_VACANCY = 736,
    OF_TABLE_STATS_ENTRY = 737,
    OF_UINT32 = 738,
    OF_UINT64 = 739,
    OF_UINT8 = 740,
    ...
    /* List objects */
    OF_LIST_ACTION = 741,
    OF_LIST_ACTION_ID = 742,
    OF_LIST_ASYNC_CONFIG_PROP = 743,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 744,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 745,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 746,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 747,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 748,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 749,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 750,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 751,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 752,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 753,
    OF_LIST_BSN_INTERFACE = 754,
    OF_LIST_BSN_LACP_STATS_ENTRY = 755,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 756,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 757,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 758,
    OF_LIST_BSN_TLV = 759,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 760,
    OF_LIST_BSN_VLAN_MAC = 761,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 762,
    OF_LIST_BUCKET = 763,
    OF_LIST_BUCKET_COUNTER = 764,
    OF_LIST_BUNDLE_PROP = 765,
    OF_LIST_FLOW_STATS_ENTRY = 766,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 767,
    OF_LIST_GROUP_STATS_ENTRY = 768,
    OF_LIST_HELLO_ELEM = 769,
    OF_LIST_INSTRUCTION = 770,
    OF_LIST_INSTRUCTION_ID = 771,
    OF_LIST_METER_BAND = 772,
    OF_LIST_METER_BAND_STATS = 773,
    OF_LIST_METER_CONFIG = 774,
    OF_LIST_METER_STATS = 775,
    OF_LIST_OXM = 776,
    OF_LIST_PACKET_QUEUE = 777,
    OF_LIST_PORT_DESC = 778,
    OF_LIST_PORT_DESC_PROP = 779,
    OF_LIST_PORT_MOD_PROP = 780,
    OF_LIST_PORT_STATS_ENTRY = 781,
    OF_LIST_PORT_STATS_PROP = 782,
    OF_LIST_QUEUE_DESC = 783,
    OF_LIST_QUEUE_DESC_PROP = 784,
    OF_LIST_QUEUE_PROP = 785,
    OF_LIST_QUEUE_STATS_ENTRY = 786,
    OF_LIST_QUEUE_STATS_PROP = 787,
    OF_LIST_ROLE_PROP = 788,
    OF_LIST_TABLE_DESC = 789,
    OF_LIST_TABLE_FEATURE_PROP = 790,
    OF_LIST_TABLE_FEATURES = 791,
    OF_LIST_TABLE_MOD_PROP = 792,
    OF_LIST_TABLE_STATS_ENTRY = 793,
    OF_LIST_UINT32 = 794,
    OF_LIST_UINT64 = 795,
    OF_LIST_UINT8 = 796,
