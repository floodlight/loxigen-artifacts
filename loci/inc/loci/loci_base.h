...
typedef enum of_object_id_e {
    ...
    OF_OXM_BSN_IN_PORTS_512 = 441,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 442,
    OF_OXM_BSN_L2_CACHE_HIT = 443,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 444,
    OF_OXM_BSN_L3_DST_CLASS_ID = 445,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 446,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 447,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 448,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 449,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 450,
    OF_OXM_BSN_LAG_ID = 451,
    OF_OXM_BSN_LAG_ID_MASKED = 452,
    OF_OXM_BSN_TCP_FLAGS = 453,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 454,
    OF_OXM_BSN_UDF0 = 455,
    OF_OXM_BSN_UDF0_MASKED = 456,
    OF_OXM_BSN_UDF1 = 457,
    OF_OXM_BSN_UDF1_MASKED = 458,
    OF_OXM_BSN_UDF2 = 459,
    OF_OXM_BSN_UDF2_MASKED = 460,
    OF_OXM_BSN_UDF3 = 461,
    OF_OXM_BSN_UDF3_MASKED = 462,
    OF_OXM_BSN_UDF4 = 463,
    OF_OXM_BSN_UDF4_MASKED = 464,
    OF_OXM_BSN_UDF5 = 465,
    OF_OXM_BSN_UDF5_MASKED = 466,
    OF_OXM_BSN_UDF6 = 467,
    OF_OXM_BSN_UDF6_MASKED = 468,
    OF_OXM_BSN_UDF7 = 469,
    OF_OXM_BSN_UDF7_MASKED = 470,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 471,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 472,
    OF_OXM_BSN_VRF = 473,
    OF_OXM_BSN_VRF_MASKED = 474,
    OF_OXM_ETH_DST = 475,
    OF_OXM_ETH_DST_MASKED = 476,
    OF_OXM_ETH_SRC = 477,
    OF_OXM_ETH_SRC_MASKED = 478,
    OF_OXM_ETH_TYPE = 479,
    OF_OXM_ETH_TYPE_MASKED = 480,
    OF_OXM_ICMPV4_CODE = 481,
    OF_OXM_ICMPV4_CODE_MASKED = 482,
    OF_OXM_ICMPV4_TYPE = 483,
    OF_OXM_ICMPV4_TYPE_MASKED = 484,
    OF_OXM_ICMPV6_CODE = 485,
    OF_OXM_ICMPV6_CODE_MASKED = 486,
    OF_OXM_ICMPV6_TYPE = 487,
    OF_OXM_ICMPV6_TYPE_MASKED = 488,
    OF_OXM_IN_PHY_PORT = 489,
    OF_OXM_IN_PHY_PORT_MASKED = 490,
    OF_OXM_IN_PORT = 491,
    OF_OXM_IN_PORT_MASKED = 492,
    OF_OXM_IP_DSCP = 493,
    OF_OXM_IP_DSCP_MASKED = 494,
    OF_OXM_IP_ECN = 495,
    OF_OXM_IP_ECN_MASKED = 496,
    OF_OXM_IP_PROTO = 497,
    OF_OXM_IP_PROTO_MASKED = 498,
    OF_OXM_IPV4_DST = 499,
    OF_OXM_IPV4_DST_MASKED = 500,
    OF_OXM_IPV4_SRC = 501,
    OF_OXM_IPV4_SRC_MASKED = 502,
    OF_OXM_IPV6_DST = 503,
    OF_OXM_IPV6_DST_MASKED = 504,
    OF_OXM_IPV6_EXTHDR = 505,
    OF_OXM_IPV6_EXTHDR_MASKED = 506,
    OF_OXM_IPV6_FLABEL = 507,
    OF_OXM_IPV6_FLABEL_MASKED = 508,
    OF_OXM_IPV6_ND_SLL = 509,
    OF_OXM_IPV6_ND_SLL_MASKED = 510,
    OF_OXM_IPV6_ND_TARGET = 511,
    OF_OXM_IPV6_ND_TARGET_MASKED = 512,
    OF_OXM_IPV6_ND_TLL = 513,
    OF_OXM_IPV6_ND_TLL_MASKED = 514,
    OF_OXM_IPV6_SRC = 515,
    OF_OXM_IPV6_SRC_MASKED = 516,
    OF_OXM_METADATA = 517,
    OF_OXM_METADATA_MASKED = 518,
    OF_OXM_MPLS_BOS = 519,
    OF_OXM_MPLS_BOS_MASKED = 520,
    OF_OXM_MPLS_LABEL = 521,
    OF_OXM_MPLS_LABEL_MASKED = 522,
    OF_OXM_MPLS_TC = 523,
    OF_OXM_MPLS_TC_MASKED = 524,
    OF_OXM_PBB_UCA = 525,
    OF_OXM_PBB_UCA_MASKED = 526,
    OF_OXM_SCTP_DST = 527,
    OF_OXM_SCTP_DST_MASKED = 528,
    OF_OXM_SCTP_SRC = 529,
    OF_OXM_SCTP_SRC_MASKED = 530,
    OF_OXM_TCP_DST = 531,
    OF_OXM_TCP_DST_MASKED = 532,
    OF_OXM_TCP_SRC = 533,
    OF_OXM_TCP_SRC_MASKED = 534,
    OF_OXM_TUNNEL_ID = 535,
    OF_OXM_TUNNEL_ID_MASKED = 536,
    OF_OXM_TUNNEL_IPV4_DST = 537,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 538,
    OF_OXM_TUNNEL_IPV4_SRC = 539,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 540,
    OF_OXM_UDP_DST = 541,
    OF_OXM_UDP_DST_MASKED = 542,
    OF_OXM_UDP_SRC = 543,
    OF_OXM_UDP_SRC_MASKED = 544,
    OF_OXM_VLAN_PCP = 545,
    OF_OXM_VLAN_PCP_MASKED = 546,
    OF_OXM_VLAN_VID = 547,
    OF_OXM_VLAN_VID_MASKED = 548,
    OF_PACKET_QUEUE = 549,
    OF_PORT_DESC = 550,
    OF_PORT_DESC_PROP = 551,
    OF_PORT_DESC_PROP_ETHERNET = 552,
    OF_PORT_DESC_PROP_EXPERIMENTER = 553,
    OF_PORT_DESC_PROP_OPTICAL = 554,
    OF_PORT_MOD_PROP = 555,
    OF_PORT_MOD_PROP_ETHERNET = 556,
    OF_PORT_MOD_PROP_EXPERIMENTER = 557,
    OF_PORT_MOD_PROP_OPTICAL = 558,
    OF_PORT_STATS_ENTRY = 559,
    OF_PORT_STATS_PROP = 560,
    OF_PORT_STATS_PROP_ETHERNET = 561,
    OF_PORT_STATS_PROP_EXPERIMENTER = 562,
    OF_PORT_STATS_PROP_OPTICAL = 563,
    OF_QUEUE_DESC = 564,
    OF_QUEUE_DESC_PROP = 565,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 566,
    OF_QUEUE_DESC_PROP_MAX_RATE = 567,
    OF_QUEUE_DESC_PROP_MIN_RATE = 568,
    OF_QUEUE_PROP = 569,
    OF_QUEUE_PROP_EXPERIMENTER = 570,
    OF_QUEUE_PROP_MAX_RATE = 571,
    OF_QUEUE_PROP_MIN_RATE = 572,
    OF_QUEUE_STATS_ENTRY = 573,
    OF_QUEUE_STATS_PROP = 574,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 575,
    OF_ROLE_PROP = 576,
    OF_ROLE_PROP_EXPERIMENTER = 577,
    OF_TABLE_DESC = 578,
    OF_TABLE_FEATURE_PROP = 579,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 580,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 581,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 582,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 583,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 584,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 585,
    ...
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 613,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 614,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 615,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 616,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 617,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 618,
    OF_LIST_BSN_INTERFACE = 619,
    OF_LIST_BSN_LACP_STATS_ENTRY = 620,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 621,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 622,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 623,
    OF_LIST_BSN_TLV = 624,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 625,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 626,
    OF_LIST_BUCKET = 627,
    OF_LIST_BUCKET_COUNTER = 628,
    OF_LIST_BUNDLE_PROP = 629,
    OF_LIST_FLOW_STATS_ENTRY = 630,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 631,
    OF_LIST_GROUP_STATS_ENTRY = 632,
    OF_LIST_HELLO_ELEM = 633,
    OF_LIST_INSTRUCTION = 634,
    OF_LIST_INSTRUCTION_ID = 635,
    OF_LIST_METER_BAND = 636,
    OF_LIST_METER_BAND_STATS = 637,
    OF_LIST_METER_STATS = 638,
    OF_LIST_OXM = 639,
    OF_LIST_PACKET_QUEUE = 640,
    OF_LIST_PORT_DESC = 641,
    OF_LIST_PORT_DESC_PROP = 642,
    OF_LIST_PORT_MOD_PROP = 643,
    OF_LIST_PORT_STATS_ENTRY = 644,
    OF_LIST_PORT_STATS_PROP = 645,
    OF_LIST_QUEUE_DESC = 646,
    OF_LIST_QUEUE_DESC_PROP = 647,
    OF_LIST_QUEUE_PROP = 648,
    OF_LIST_QUEUE_STATS_ENTRY = 649,
    OF_LIST_QUEUE_STATS_PROP = 650,
    OF_LIST_ROLE_PROP = 651,
    OF_LIST_TABLE_DESC = 652,
    OF_LIST_TABLE_FEATURE_PROP = 653,
    OF_LIST_TABLE_FEATURES = 654,
    OF_LIST_TABLE_MOD_PROP = 655,
    OF_LIST_TABLE_STATS_ENTRY = 656,
    OF_LIST_UINT32 = 657,
    OF_LIST_UINT64 = 658,
    OF_LIST_UINT8 = 659,
