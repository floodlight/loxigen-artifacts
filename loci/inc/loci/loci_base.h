...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_BFD_ENCAP_TYPE = 313,
    OF_BSN_TLV_BFD_ENDPOINT_EVENT = 314,
    OF_BSN_TLV_BFD_ENDPOINT_ID = 315,
    OF_BSN_TLV_BFD_ENDPOINT_TYPE = 316,
    OF_BSN_TLV_BFD_LOCAL_DISCRIMINATOR = 317,
    OF_BSN_TLV_BFD_LOCAL_MIN_ECHO_INTERVAL = 318,
    OF_BSN_TLV_BFD_LOCAL_MIN_RX_INTERVAL = 319,
    OF_BSN_TLV_BFD_LOCAL_MIN_TX_INTERVAL = 320,
    OF_BSN_TLV_BFD_LOCAL_MULTIPLIER = 321,
    OF_BSN_TLV_BFD_LOCAL_STATE = 322,
    OF_BSN_TLV_BFD_REMOTE_DISCRIMINATOR = 323,
    OF_BSN_TLV_BFD_REMOTE_MIN_ECHO_INTERVAL = 324,
    OF_BSN_TLV_BFD_REMOTE_MIN_RX_INTERVAL = 325,
    OF_BSN_TLV_BFD_REMOTE_MIN_TX_INTERVAL = 326,
    OF_BSN_TLV_BFD_REMOTE_MULTIPLIER = 327,
    OF_BSN_TLV_BFD_REMOTE_STATE = 328,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 329,
    OF_BSN_TLV_BROADCAST_RATE = 330,
    OF_BSN_TLV_BUCKET = 331,
    OF_BSN_TLV_CIRCUIT_ID = 332,
    OF_BSN_TLV_CONVERGENCE_STATUS = 333,
    OF_BSN_TLV_CPU_LAG = 334,
    OF_BSN_TLV_CRC_ENABLED = 335,
    OF_BSN_TLV_DATA = 336,
    OF_BSN_TLV_DATA_MASK = 337,
    OF_BSN_TLV_DECAP = 338,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 339,
    OF_BSN_TLV_DROP = 340,
    OF_BSN_TLV_DSCP = 341,
    OF_BSN_TLV_ECN = 342,
    OF_BSN_TLV_EGRESS_ONLY = 343,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 344,
    ...
    OF_BSN_TLV_IDLE_NOTIFICATION = 371,
    OF_BSN_TLV_IDLE_TIME = 372,
    OF_BSN_TLV_IDLE_TIMEOUT = 373,
    OF_BSN_TLV_IGMP_SNOOPING = 374,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 375,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 376,
    OF_BSN_TLV_INTERNAL_MAC = 377,
    OF_BSN_TLV_INTERVAL = 378,
    OF_BSN_TLV_IP_PROTO = 379,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 380,
    OF_BSN_TLV_IPV4 = 381,
    OF_BSN_TLV_IPV4_DST = 382,
    OF_BSN_TLV_IPV4_NETMASK = 383,
    OF_BSN_TLV_IPV4_SRC = 384,
    OF_BSN_TLV_IPV6 = 385,
    OF_BSN_TLV_IPV6_DST = 386,
    OF_BSN_TLV_IPV6_PREFIX = 387,
    OF_BSN_TLV_IPV6_SRC = 388,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 389,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 390,
    OF_BSN_TLV_L3 = 391,
    OF_BSN_TLV_L3_DST_CLASS_ID = 392,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 393,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 394,
    OF_BSN_TLV_LAG_OPTIONS = 395,
    OF_BSN_TLV_LOOPBACK_MODE = 396,
    OF_BSN_TLV_LOOPBACK_PORT = 397,
    OF_BSN_TLV_MAC = 398,
    ...
    OF_BSN_TLV_PORT = 429,
    OF_BSN_TLV_PORT_SPEED_GBPS = 430,
    OF_BSN_TLV_PORT_USAGE = 431,
    OF_BSN_TLV_PORT_VXLAN_MODE = 432,
    OF_BSN_TLV_PRIORITY = 433,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 434,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 435,
    OF_BSN_TLV_QOS_PRIORITY = 436,
    OF_BSN_TLV_QUEUE_ID = 437,
    OF_BSN_TLV_QUEUE_WEIGHT = 438,
    OF_BSN_TLV_RATE_LIMIT = 439,
    OF_BSN_TLV_RATE_UNIT = 440,
    OF_BSN_TLV_RECORD_PACKETS = 441,
    OF_BSN_TLV_REFERENCE = 442,
    OF_BSN_TLV_REPLY_PACKETS = 443,
    OF_BSN_TLV_REQUEST_PACKETS = 444,
    OF_BSN_TLV_REST_SERVER = 445,
    OF_BSN_TLV_ROUTING_PARAM = 446,
    OF_BSN_TLV_RX_BYTES = 447,
    OF_BSN_TLV_RX_PACKETS = 448,
    OF_BSN_TLV_SAMPLING_RATE = 449,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 450,
    OF_BSN_TLV_STATUS = 451,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 452,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 453,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 454,
    OF_BSN_TLV_SUB_AGENT_ID = 455,
    OF_BSN_TLV_TCP_DST = 456,
    OF_BSN_TLV_TCP_FLAGS = 457,
    OF_BSN_TLV_TCP_SRC = 458,
    OF_BSN_TLV_TIMESTAMP = 459,
    OF_BSN_TLV_TTL = 460,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 461,
    OF_BSN_TLV_TX_BYTES = 462,
    OF_BSN_TLV_TX_PACKETS = 463,
    OF_BSN_TLV_UDF_ANCHOR = 464,
    OF_BSN_TLV_UDF_ID = 465,
    OF_BSN_TLV_UDF_LENGTH = 466,
    OF_BSN_TLV_UDF_OFFSET = 467,
    OF_BSN_TLV_UDP_DST = 468,
    OF_BSN_TLV_UDP_SRC = 469,
    OF_BSN_TLV_UINT32 = 470,
    OF_BSN_TLV_UINT64_LIST = 471,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 472,
    OF_BSN_TLV_UNICAST_RATE = 473,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 474,
    OF_BSN_TLV_UNTAGGED = 475,
    OF_BSN_TLV_UPGRADE = 476,
    OF_BSN_TLV_URI_SCHEME = 477,
    OF_BSN_TLV_USE_PACKET_STATE = 478,
    OF_BSN_TLV_USER_CONFIGURED = 479,
    OF_BSN_TLV_VFI = 480,
    OF_BSN_TLV_VFP_CLASS_ID = 481,
    OF_BSN_TLV_VIRTUAL = 482,
    OF_BSN_TLV_VLAN_MAC_LIST = 483,
    OF_BSN_TLV_VLAN_PCP = 484,
    OF_BSN_TLV_VLAN_VID = 485,
    OF_BSN_TLV_VLAN_VID_MASK = 486,
    OF_BSN_TLV_VNI = 487,
    OF_BSN_TLV_VPN_KEY = 488,
    OF_BSN_TLV_VRF = 489,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 490,
    OF_BSN_UNIT = 491,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 492,
    OF_BSN_VLAN_MAC = 493,
    OF_BSN_VPORT = 494,
    OF_BSN_VPORT_L2GRE = 495,
    OF_BSN_VPORT_Q_IN_Q = 496,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 497,
    OF_BUCKET = 498,
    OF_BUCKET_COUNTER = 499,
    OF_BUNDLE_PROP = 500,
    OF_BUNDLE_PROP_EXPERIMENTER = 501,
    OF_FLOW_STATS_ENTRY = 502,
    OF_GROUP_DESC_STATS_ENTRY = 503,
    OF_GROUP_STATS_ENTRY = 504,
    OF_HELLO_ELEM = 505,
    OF_HELLO_ELEM_VERSIONBITMAP = 506,
    OF_INSTRUCTION = 507,
    OF_INSTRUCTION_APPLY_ACTIONS = 508,
    OF_INSTRUCTION_BSN = 509,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 510,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 511,
    OF_INSTRUCTION_BSN_DENY = 512,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 513,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 514,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 515,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 516,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 517,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 518,
    OF_INSTRUCTION_BSN_HASH_SELECT = 519,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 520,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 521,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 522,
    OF_INSTRUCTION_BSN_PERMIT = 523,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 524,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 525,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 526,
    OF_INSTRUCTION_CLEAR_ACTIONS = 527,
    OF_INSTRUCTION_EXPERIMENTER = 528,
    OF_INSTRUCTION_GOTO_TABLE = 529,
    OF_INSTRUCTION_ID = 530,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 531,
    OF_INSTRUCTION_ID_BSN = 532,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 533,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 534,
    OF_INSTRUCTION_ID_BSN_DENY = 535,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 536,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 537,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 538,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 539,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 540,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 541,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 542,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 543,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 544,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 545,
    OF_INSTRUCTION_ID_BSN_PERMIT = 546,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 547,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 548,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 549,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 550,
    OF_INSTRUCTION_ID_EXPERIMENTER = 551,
    OF_INSTRUCTION_ID_GOTO_TABLE = 552,
    OF_INSTRUCTION_ID_METER = 553,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 554,
    OF_INSTRUCTION_ID_WRITE_METADATA = 555,
    OF_INSTRUCTION_METER = 556,
    OF_INSTRUCTION_WRITE_ACTIONS = 557,
    OF_INSTRUCTION_WRITE_METADATA = 558,
    OF_MATCH_V1 = 559,
    OF_MATCH_V2 = 560,
    OF_MATCH_V3 = 561,
    OF_METER_BAND = 562,
    OF_METER_BAND_DROP = 563,
    OF_METER_BAND_DSCP_REMARK = 564,
    OF_METER_BAND_EXPERIMENTER = 565,
    OF_METER_BAND_STATS = 566,
    OF_METER_CONFIG = 567,
    OF_METER_FEATURES = 568,
    OF_METER_STATS = 569,
    OF_OXM = 570,
    OF_OXM_ARP_OP = 571,
    OF_OXM_ARP_OP_MASKED = 572,
    OF_OXM_ARP_SHA = 573,
    OF_OXM_ARP_SHA_MASKED = 574,
    OF_OXM_ARP_SPA = 575,
    OF_OXM_ARP_SPA_MASKED = 576,
    OF_OXM_ARP_THA = 577,
    OF_OXM_ARP_THA_MASKED = 578,
    OF_OXM_ARP_TPA = 579,
    OF_OXM_ARP_TPA_MASKED = 580,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 581,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 582,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 583,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 584,
    OF_OXM_BSN_IFP_CLASS_ID = 585,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 586,
    OF_OXM_BSN_IN_PORTS_128 = 587,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 588,
    OF_OXM_BSN_IN_PORTS_512 = 589,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 590,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 591,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 592,
    OF_OXM_BSN_INNER_ETH_DST = 593,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 594,
    OF_OXM_BSN_INNER_ETH_SRC = 595,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 596,
    OF_OXM_BSN_INNER_VLAN_VID = 597,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 598,
    OF_OXM_BSN_IP_FRAGMENTATION = 599,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 600,
    OF_OXM_BSN_L2_CACHE_HIT = 601,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 602,
    OF_OXM_BSN_L3_DST_CLASS_ID = 603,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 604,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 605,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 606,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 607,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 608,
    OF_OXM_BSN_LAG_ID = 609,
    OF_OXM_BSN_LAG_ID_MASKED = 610,
    OF_OXM_BSN_TCP_FLAGS = 611,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 612,
    OF_OXM_BSN_UDF0 = 613,
    OF_OXM_BSN_UDF0_MASKED = 614,
    OF_OXM_BSN_UDF1 = 615,
    OF_OXM_BSN_UDF1_MASKED = 616,
    OF_OXM_BSN_UDF2 = 617,
    OF_OXM_BSN_UDF2_MASKED = 618,
    OF_OXM_BSN_UDF3 = 619,
    OF_OXM_BSN_UDF3_MASKED = 620,
    OF_OXM_BSN_UDF4 = 621,
    OF_OXM_BSN_UDF4_MASKED = 622,
    OF_OXM_BSN_UDF5 = 623,
    OF_OXM_BSN_UDF5_MASKED = 624,
    OF_OXM_BSN_UDF6 = 625,
    OF_OXM_BSN_UDF6_MASKED = 626,
    OF_OXM_BSN_UDF7 = 627,
    OF_OXM_BSN_UDF7_MASKED = 628,
    OF_OXM_BSN_VFI = 629,
    OF_OXM_BSN_VFI_MASKED = 630,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 631,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 632,
    OF_OXM_BSN_VRF = 633,
    OF_OXM_BSN_VRF_MASKED = 634,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 635,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 636,
    OF_OXM_CONN_TRACKING_IPV6_DST = 637,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 638,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 639,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 640,
    OF_OXM_CONN_TRACKING_LABEL = 641,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 642,
    OF_OXM_CONN_TRACKING_MARK = 643,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 644,
    OF_OXM_CONN_TRACKING_NW_DST = 645,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 646,
    OF_OXM_CONN_TRACKING_NW_PROTO = 647,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 648,
    OF_OXM_CONN_TRACKING_NW_SRC = 649,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 650,
    OF_OXM_CONN_TRACKING_STATE = 651,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 652,
    OF_OXM_CONN_TRACKING_TP_DST = 653,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 654,
    OF_OXM_CONN_TRACKING_TP_SRC = 655,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 656,
    OF_OXM_CONN_TRACKING_ZONE = 657,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 658,
    OF_OXM_ETH_DST = 659,
    OF_OXM_ETH_DST_MASKED = 660,
    OF_OXM_ETH_SRC = 661,
    OF_OXM_ETH_SRC_MASKED = 662,
    OF_OXM_ETH_TYPE = 663,
    OF_OXM_ETH_TYPE_MASKED = 664,
    OF_OXM_ICMPV4_CODE = 665,
    OF_OXM_ICMPV4_CODE_MASKED = 666,
    OF_OXM_ICMPV4_TYPE = 667,
    OF_OXM_ICMPV4_TYPE_MASKED = 668,
    OF_OXM_ICMPV6_CODE = 669,
    OF_OXM_ICMPV6_CODE_MASKED = 670,
    OF_OXM_ICMPV6_TYPE = 671,
    OF_OXM_ICMPV6_TYPE_MASKED = 672,
    OF_OXM_IN_PHY_PORT = 673,
    OF_OXM_IN_PHY_PORT_MASKED = 674,
    OF_OXM_IN_PORT = 675,
    OF_OXM_IN_PORT_MASKED = 676,
    OF_OXM_IP_DSCP = 677,
    OF_OXM_IP_DSCP_MASKED = 678,
    OF_OXM_IP_ECN = 679,
    OF_OXM_IP_ECN_MASKED = 680,
    OF_OXM_IP_PROTO = 681,
    OF_OXM_IP_PROTO_MASKED = 682,
    OF_OXM_IPV4_DST = 683,
    OF_OXM_IPV4_DST_MASKED = 684,
    OF_OXM_IPV4_SRC = 685,
    OF_OXM_IPV4_SRC_MASKED = 686,
    OF_OXM_IPV6_DST = 687,
    OF_OXM_IPV6_DST_MASKED = 688,
    OF_OXM_IPV6_EXTHDR = 689,
    OF_OXM_IPV6_EXTHDR_MASKED = 690,
    OF_OXM_IPV6_FLABEL = 691,
    OF_OXM_IPV6_FLABEL_MASKED = 692,
    OF_OXM_IPV6_ND_SLL = 693,
    OF_OXM_IPV6_ND_SLL_MASKED = 694,
    OF_OXM_IPV6_ND_TARGET = 695,
    OF_OXM_IPV6_ND_TARGET_MASKED = 696,
    OF_OXM_IPV6_ND_TLL = 697,
    OF_OXM_IPV6_ND_TLL_MASKED = 698,
    OF_OXM_IPV6_SRC = 699,
    OF_OXM_IPV6_SRC_MASKED = 700,
    OF_OXM_METADATA = 701,
    OF_OXM_METADATA_MASKED = 702,
    OF_OXM_MPLS_BOS = 703,
    OF_OXM_MPLS_BOS_MASKED = 704,
    OF_OXM_MPLS_LABEL = 705,
    OF_OXM_MPLS_LABEL_MASKED = 706,
    OF_OXM_MPLS_TC = 707,
    OF_OXM_MPLS_TC_MASKED = 708,
    OF_OXM_OVS_TCP_FLAGS = 709,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 710,
    OF_OXM_PBB_UCA = 711,
    OF_OXM_PBB_UCA_MASKED = 712,
    OF_OXM_SCTP_DST = 713,
    OF_OXM_SCTP_DST_MASKED = 714,
    OF_OXM_SCTP_SRC = 715,
    OF_OXM_SCTP_SRC_MASKED = 716,
    OF_OXM_TCP_DST = 717,
    OF_OXM_TCP_DST_MASKED = 718,
    OF_OXM_TCP_SRC = 719,
    OF_OXM_TCP_SRC_MASKED = 720,
    OF_OXM_TUNNEL_ID = 721,
    OF_OXM_TUNNEL_ID_MASKED = 722,
    OF_OXM_TUNNEL_IPV4_DST = 723,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 724,
    OF_OXM_TUNNEL_IPV4_SRC = 725,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 726,
    OF_OXM_UDP_DST = 727,
    OF_OXM_UDP_DST_MASKED = 728,
    OF_OXM_UDP_SRC = 729,
    OF_OXM_UDP_SRC_MASKED = 730,
    OF_OXM_VLAN_PCP = 731,
    OF_OXM_VLAN_PCP_MASKED = 732,
    OF_OXM_VLAN_VID = 733,
    OF_OXM_VLAN_VID_MASKED = 734,
    OF_PACKET_QUEUE = 735,
    OF_PORT_DESC = 736,
    OF_PORT_DESC_PROP = 737,
    OF_PORT_DESC_PROP_BSN = 738,
    OF_PORT_DESC_PROP_BSN_ALARM = 739,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 740,
    OF_PORT_DESC_PROP_BSN_DIAG = 741,
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 742,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 743,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 744,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 745,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 746,
    OF_PORT_DESC_PROP_BSN_UPLINK = 747,
    OF_PORT_DESC_PROP_ETHERNET = 748,
    OF_PORT_DESC_PROP_EXPERIMENTER = 749,
    OF_PORT_DESC_PROP_OPTICAL = 750,
    OF_PORT_MOD_PROP = 751,
    OF_PORT_MOD_PROP_ETHERNET = 752,
    OF_PORT_MOD_PROP_EXPERIMENTER = 753,
    OF_PORT_MOD_PROP_OPTICAL = 754,
    OF_PORT_STATS_ENTRY = 755,
    OF_PORT_STATS_PROP = 756,
    OF_PORT_STATS_PROP_ETHERNET = 757,
    OF_PORT_STATS_PROP_EXPERIMENTER = 758,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 759,
    OF_PORT_STATS_PROP_OPTICAL = 760,
    OF_QUEUE_DESC = 761,
    OF_QUEUE_DESC_PROP = 762,
    OF_QUEUE_DESC_PROP_BSN = 763,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 764,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 765,
    OF_QUEUE_DESC_PROP_MAX_RATE = 766,
    OF_QUEUE_DESC_PROP_MIN_RATE = 767,
    OF_QUEUE_PROP = 768,
    OF_QUEUE_PROP_EXPERIMENTER = 769,
    OF_QUEUE_PROP_MAX_RATE = 770,
    OF_QUEUE_PROP_MIN_RATE = 771,
    OF_QUEUE_STATS_ENTRY = 772,
    OF_QUEUE_STATS_PROP = 773,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 774,
    OF_ROLE_PROP = 775,
    OF_ROLE_PROP_EXPERIMENTER = 776,
    OF_TABLE_DESC = 777,
    OF_TABLE_FEATURE_PROP = 778,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 779,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 780,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 781,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 782,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 783,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 784,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 785,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 786,
    OF_TABLE_FEATURE_PROP_MATCH = 787,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 788,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 789,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 790,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 791,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 792,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 793,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 794,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 795,
    OF_TABLE_FEATURES = 796,
    OF_TABLE_MOD_PROP = 797,
    OF_TABLE_MOD_PROP_EVICTION = 798,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 799,
    OF_TABLE_MOD_PROP_VACANCY = 800,
    OF_TABLE_STATS_ENTRY = 801,
    OF_UINT32 = 802,
    OF_UINT64 = 803,
    OF_UINT8 = 804,
    OFP_BSN_MODULE_EEPROM_TRANSCEIVER = 805,

    /* List objects */
    OF_LIST_ACTION = 806,
    OF_LIST_ACTION_ID = 807,
    OF_LIST_ASYNC_CONFIG_PROP = 808,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 809,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 810,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 811,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 812,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 813,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 814,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 815,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 816,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 817,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 818,
    OF_LIST_BSN_INTERFACE = 819,
    OF_LIST_BSN_LACP_STATS_ENTRY = 820,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 821,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 822,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 823,
    OF_LIST_BSN_TLV = 824,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 825,
    OF_LIST_BSN_VLAN_MAC = 826,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 827,
    OF_LIST_BUCKET = 828,
    OF_LIST_BUCKET_COUNTER = 829,
    OF_LIST_BUNDLE_PROP = 830,
    OF_LIST_FLOW_STATS_ENTRY = 831,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 832,
    OF_LIST_GROUP_STATS_ENTRY = 833,
    OF_LIST_HELLO_ELEM = 834,
    OF_LIST_INSTRUCTION = 835,
    OF_LIST_INSTRUCTION_ID = 836,
    OF_LIST_METER_BAND = 837,
    OF_LIST_METER_BAND_STATS = 838,
    OF_LIST_METER_CONFIG = 839,
    OF_LIST_METER_STATS = 840,
    OF_LIST_OXM = 841,
    OF_LIST_PACKET_QUEUE = 842,
    OF_LIST_PORT_DESC = 843,
    OF_LIST_PORT_DESC_PROP = 844,
    OF_LIST_PORT_MOD_PROP = 845,
    OF_LIST_PORT_STATS_ENTRY = 846,
    OF_LIST_PORT_STATS_PROP = 847,
    OF_LIST_QUEUE_DESC = 848,
    OF_LIST_QUEUE_DESC_PROP = 849,
    OF_LIST_QUEUE_PROP = 850,
    OF_LIST_QUEUE_STATS_ENTRY = 851,
    OF_LIST_QUEUE_STATS_PROP = 852,
    OF_LIST_ROLE_PROP = 853,
    OF_LIST_TABLE_DESC = 854,
    OF_LIST_TABLE_FEATURE_PROP = 855,
    OF_LIST_TABLE_FEATURES = 856,
    OF_LIST_TABLE_MOD_PROP = 857,
    OF_LIST_TABLE_STATS_ENTRY = 858,
    OF_LIST_UINT32 = 859,
    OF_LIST_UINT64 = 860,
    OF_LIST_UINT8 = 861,
