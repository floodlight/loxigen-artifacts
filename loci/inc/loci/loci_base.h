...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_METER = 234,
    OF_INSTRUCTION_WRITE_ACTIONS = 235,
    OF_INSTRUCTION_WRITE_METADATA = 236,
    OF_MATCH_V1 = 237,
    OF_MATCH_V2 = 238,
    OF_MATCH_V3 = 239,
    OF_METER_BAND = 240,
    OF_METER_BAND_DROP = 241,
    OF_METER_BAND_DSCP_REMARK = 242,
    OF_METER_BAND_EXPERIMENTER = 243,
    OF_METER_BAND_HEADER = 244,
    OF_METER_BAND_STATS = 245,
    OF_METER_CONFIG = 246,
    OF_METER_FEATURES = 247,
    OF_METER_STATS = 248,
    OF_OXM = 249,
    OF_OXM_ARP_OP = 250,
    OF_OXM_ARP_OP_MASKED = 251,
    OF_OXM_ARP_SHA = 252,
    OF_OXM_ARP_SHA_MASKED = 253,
    OF_OXM_ARP_SPA = 254,
    OF_OXM_ARP_SPA_MASKED = 255,
    OF_OXM_ARP_THA = 256,
    OF_OXM_ARP_THA_MASKED = 257,
    OF_OXM_ARP_TPA = 258,
    OF_OXM_ARP_TPA_MASKED = 259,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 260,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 261,
    OF_OXM_BSN_IN_PORTS_128 = 262,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 263,
    OF_OXM_BSN_L3_DST_CLASS_ID = 264,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 265,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 266,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 267,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 268,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 269,
    OF_OXM_BSN_LAG_ID = 270,
    OF_OXM_BSN_LAG_ID_MASKED = 271,
    OF_OXM_BSN_VRF = 272,
    OF_OXM_BSN_VRF_MASKED = 273,
    OF_OXM_ETH_DST = 274,
    OF_OXM_ETH_DST_MASKED = 275,
    OF_OXM_ETH_SRC = 276,
    OF_OXM_ETH_SRC_MASKED = 277,
    OF_OXM_ETH_TYPE = 278,
    OF_OXM_ETH_TYPE_MASKED = 279,
    OF_OXM_HEADER = 280,
    OF_OXM_ICMPV4_CODE = 281,
    OF_OXM_ICMPV4_CODE_MASKED = 282,
    OF_OXM_ICMPV4_TYPE = 283,
    OF_OXM_ICMPV4_TYPE_MASKED = 284,
    OF_OXM_ICMPV6_CODE = 285,
    OF_OXM_ICMPV6_CODE_MASKED = 286,
    OF_OXM_ICMPV6_TYPE = 287,
    OF_OXM_ICMPV6_TYPE_MASKED = 288,
    OF_OXM_IN_PHY_PORT = 289,
    OF_OXM_IN_PHY_PORT_MASKED = 290,
    OF_OXM_IN_PORT = 291,
    OF_OXM_IN_PORT_MASKED = 292,
    OF_OXM_IP_DSCP = 293,
    OF_OXM_IP_DSCP_MASKED = 294,
    OF_OXM_IP_ECN = 295,
    OF_OXM_IP_ECN_MASKED = 296,
    OF_OXM_IP_PROTO = 297,
    OF_OXM_IP_PROTO_MASKED = 298,
    OF_OXM_IPV4_DST = 299,
    OF_OXM_IPV4_DST_MASKED = 300,
    OF_OXM_IPV4_SRC = 301,
    OF_OXM_IPV4_SRC_MASKED = 302,
    OF_OXM_IPV6_DST = 303,
    OF_OXM_IPV6_DST_MASKED = 304,
    OF_OXM_IPV6_FLABEL = 305,
    OF_OXM_IPV6_FLABEL_MASKED = 306,
    OF_OXM_IPV6_ND_SLL = 307,
    OF_OXM_IPV6_ND_SLL_MASKED = 308,
    OF_OXM_IPV6_ND_TARGET = 309,
    OF_OXM_IPV6_ND_TARGET_MASKED = 310,
    OF_OXM_IPV6_ND_TLL = 311,
    OF_OXM_IPV6_ND_TLL_MASKED = 312,
    OF_OXM_IPV6_SRC = 313,
    OF_OXM_IPV6_SRC_MASKED = 314,
    OF_OXM_METADATA = 315,
    OF_OXM_METADATA_MASKED = 316,
    OF_OXM_MPLS_LABEL = 317,
    OF_OXM_MPLS_LABEL_MASKED = 318,
    OF_OXM_MPLS_TC = 319,
    OF_OXM_MPLS_TC_MASKED = 320,
    OF_OXM_SCTP_DST = 321,
    OF_OXM_SCTP_DST_MASKED = 322,
    OF_OXM_SCTP_SRC = 323,
    OF_OXM_SCTP_SRC_MASKED = 324,
    OF_OXM_TCP_DST = 325,
    OF_OXM_TCP_DST_MASKED = 326,
    OF_OXM_TCP_SRC = 327,
    OF_OXM_TCP_SRC_MASKED = 328,
    OF_OXM_UDP_DST = 329,
    OF_OXM_UDP_DST_MASKED = 330,
    OF_OXM_UDP_SRC = 331,
    OF_OXM_UDP_SRC_MASKED = 332,
    OF_OXM_VLAN_PCP = 333,
    OF_OXM_VLAN_PCP_MASKED = 334,
    OF_OXM_VLAN_VID = 335,
    OF_OXM_VLAN_VID_MASKED = 336,
    OF_PACKET_QUEUE = 337,
    OF_PORT_DESC = 338,
    OF_PORT_STATS_ENTRY = 339,
    OF_QUEUE_PROP = 340,
    OF_QUEUE_PROP_EXPERIMENTER = 341,
    OF_QUEUE_PROP_HEADER = 342,
    OF_QUEUE_PROP_MAX_RATE = 343,
    OF_QUEUE_PROP_MIN_RATE = 344,
    OF_QUEUE_STATS_ENTRY = 345,
    OF_TABLE_FEATURE_PROP = 346,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 347,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 348,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 349,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 350,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 351,
    OF_TABLE_FEATURE_PROP_HEADER = 352,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 353,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 354,
    OF_TABLE_FEATURE_PROP_MATCH = 355,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 356,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 357,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 358,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 359,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 360,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 361,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 362,
    OF_TABLE_FEATURES = 363,
    OF_TABLE_STATS_ENTRY = 364,
    OF_UINT32 = 365,
    OF_UINT64 = 366,
    OF_UINT8 = 367,
    ...
    /* List objects */
    OF_LIST_ACTION = 368,
    OF_LIST_ACTION_ID = 369,
    OF_LIST_BSN_INTERFACE = 370,
    OF_LIST_BSN_LACP_STATS_ENTRY = 371,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 372,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 373,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 374,
    OF_LIST_BUCKET = 375,
    OF_LIST_BUCKET_COUNTER = 376,
    OF_LIST_FLOW_STATS_ENTRY = 377,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 378,
    OF_LIST_GROUP_STATS_ENTRY = 379,
    OF_LIST_HELLO_ELEM = 380,
    OF_LIST_INSTRUCTION = 381,
    OF_LIST_METER_BAND = 382,
    OF_LIST_METER_BAND_STATS = 383,
    OF_LIST_METER_STATS = 384,
    OF_LIST_OXM = 385,
    OF_LIST_PACKET_QUEUE = 386,
    OF_LIST_PORT_DESC = 387,
    OF_LIST_PORT_STATS_ENTRY = 388,
    OF_LIST_QUEUE_PROP = 389,
    OF_LIST_QUEUE_STATS_ENTRY = 390,
    OF_LIST_TABLE_FEATURE_PROP = 391,
    OF_LIST_TABLE_FEATURES = 392,
    OF_LIST_TABLE_STATS_ENTRY = 393,
    OF_LIST_UINT32 = 394,
    OF_LIST_UINT64 = 395,
    OF_LIST_UINT8 = 396,
