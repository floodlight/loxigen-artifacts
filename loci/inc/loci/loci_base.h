...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DSCP = 318,
    OF_BSN_TLV_ETH_DST = 319,
    OF_BSN_TLV_ETH_SRC = 320,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 321,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 322,
    OF_BSN_TLV_EXTERNAL_IP = 323,
    OF_BSN_TLV_EXTERNAL_MAC = 324,
    OF_BSN_TLV_EXTERNAL_NETMASK = 325,
    OF_BSN_TLV_GENERATION_ID = 326,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 327,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 328,
    OF_BSN_TLV_HASH_PACKET_FIELD = 329,
    OF_BSN_TLV_HASH_PACKET_TYPE = 330,
    OF_BSN_TLV_HASH_SEED = 331,
    OF_BSN_TLV_HASH_TYPE = 332,
    OF_BSN_TLV_HEADER_SIZE = 333,
    OF_BSN_TLV_ICMP_CODE = 334,
    OF_BSN_TLV_ICMP_ID = 335,
    OF_BSN_TLV_ICMP_TYPE = 336,
    OF_BSN_TLV_IDLE_NOTIFICATION = 337,
    OF_BSN_TLV_IDLE_TIME = 338,
    OF_BSN_TLV_IDLE_TIMEOUT = 339,
    OF_BSN_TLV_IGMP_SNOOPING = 340,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 341,
    OF_BSN_TLV_INTERNAL_MAC = 342,
    OF_BSN_TLV_INTERVAL = 343,
    OF_BSN_TLV_IP_PROTO = 344,
    OF_BSN_TLV_IPV4 = 345,
    OF_BSN_TLV_IPV4_DST = 346,
    OF_BSN_TLV_IPV4_NETMASK = 347,
    OF_BSN_TLV_IPV4_SRC = 348,
    OF_BSN_TLV_IPV6 = 349,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 350,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 351,
    OF_BSN_TLV_LOOPBACK_PORT = 352,
    OF_BSN_TLV_MAC = 353,
    OF_BSN_TLV_MAC_MASK = 354,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 355,
    OF_BSN_TLV_MISS_PACKETS = 356,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 357,
    OF_BSN_TLV_MPLS_LABEL = 358,
    OF_BSN_TLV_MPLS_SEQUENCED = 359,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 360,
    OF_BSN_TLV_NAME = 361,
    OF_BSN_TLV_NEGATE = 362,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 363,
    OF_BSN_TLV_NEXT_HOP_MAC = 364,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 365,
    OF_BSN_TLV_OFFSET = 366,
    OF_BSN_TLV_PARENT_PORT = 367,
    OF_BSN_TLV_PARTNER_KEY = 368,
    OF_BSN_TLV_PARTNER_PORT_NUM = 369,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 370,
    OF_BSN_TLV_PARTNER_STATE = 371,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 372,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 373,
    OF_BSN_TLV_PORT = 374,
    OF_BSN_TLV_PORT_VXLAN_MODE = 375,
    OF_BSN_TLV_PRIORITY = 376,
    OF_BSN_TLV_QOS_PRIORITY = 377,
    OF_BSN_TLV_QUEUE_ID = 378,
    OF_BSN_TLV_QUEUE_WEIGHT = 379,
    OF_BSN_TLV_RATE_LIMIT = 380,
    OF_BSN_TLV_RATE_UNIT = 381,
    OF_BSN_TLV_REFERENCE = 382,
    OF_BSN_TLV_REPLY_PACKETS = 383,
    OF_BSN_TLV_REQUEST_PACKETS = 384,
    OF_BSN_TLV_RX_BYTES = 385,
    OF_BSN_TLV_RX_PACKETS = 386,
    OF_BSN_TLV_SAMPLING_RATE = 387,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 388,
    OF_BSN_TLV_STATUS = 389,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 390,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 391,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 392,
    OF_BSN_TLV_SUB_AGENT_ID = 393,
    OF_BSN_TLV_TCP_DST = 394,
    OF_BSN_TLV_TCP_SRC = 395,
    OF_BSN_TLV_TTL = 396,
    OF_BSN_TLV_TX_BYTES = 397,
    OF_BSN_TLV_TX_PACKETS = 398,
    OF_BSN_TLV_UDF_ANCHOR = 399,
    OF_BSN_TLV_UDF_ID = 400,
    OF_BSN_TLV_UDF_LENGTH = 401,
    OF_BSN_TLV_UDF_OFFSET = 402,
    OF_BSN_TLV_UDP_DST = 403,
    OF_BSN_TLV_UDP_SRC = 404,
    OF_BSN_TLV_UINT64_LIST = 405,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 406,
    OF_BSN_TLV_UNICAST_RATE = 407,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 408,
    OF_BSN_TLV_UNTAGGED = 409,
    OF_BSN_TLV_USE_PACKET_STATE = 410,
    OF_BSN_TLV_VFI = 411,
    OF_BSN_TLV_VFP_CLASS_ID = 412,
    OF_BSN_TLV_VLAN_MAC_LIST = 413,
    OF_BSN_TLV_VLAN_PCP = 414,
    OF_BSN_TLV_VLAN_VID = 415,
    OF_BSN_TLV_VLAN_VID_MASK = 416,
    OF_BSN_TLV_VNI = 417,
    OF_BSN_TLV_VPN_KEY = 418,
    OF_BSN_TLV_VRF = 419,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 420,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 421,
    OF_BSN_VLAN_MAC = 422,
    OF_BSN_VPORT = 423,
    OF_BSN_VPORT_L2GRE = 424,
    OF_BSN_VPORT_Q_IN_Q = 425,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 426,
    OF_BUCKET = 427,
    OF_BUCKET_COUNTER = 428,
    OF_BUNDLE_PROP = 429,
    OF_BUNDLE_PROP_EXPERIMENTER = 430,
    OF_FLOW_STATS_ENTRY = 431,
    OF_GROUP_DESC_STATS_ENTRY = 432,
    OF_GROUP_STATS_ENTRY = 433,
    OF_HELLO_ELEM = 434,
    OF_HELLO_ELEM_VERSIONBITMAP = 435,
    OF_INSTRUCTION = 436,
    OF_INSTRUCTION_APPLY_ACTIONS = 437,
    OF_INSTRUCTION_BSN = 438,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 439,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 440,
    OF_INSTRUCTION_BSN_DENY = 441,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 442,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 443,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 444,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 445,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 446,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 447,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 448,
    OF_INSTRUCTION_BSN_PERMIT = 449,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 450,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 451,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 452,
    OF_INSTRUCTION_CLEAR_ACTIONS = 453,
    OF_INSTRUCTION_EXPERIMENTER = 454,
    OF_INSTRUCTION_GOTO_TABLE = 455,
    OF_INSTRUCTION_ID = 456,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 457,
    OF_INSTRUCTION_ID_BSN = 458,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 459,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 460,
    OF_INSTRUCTION_ID_BSN_DENY = 461,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 462,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 463,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 464,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 465,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 466,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 467,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 468,
    OF_INSTRUCTION_ID_BSN_PERMIT = 469,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 470,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 471,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 472,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 473,
    OF_INSTRUCTION_ID_EXPERIMENTER = 474,
    OF_INSTRUCTION_ID_GOTO_TABLE = 475,
    OF_INSTRUCTION_ID_METER = 476,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 477,
    OF_INSTRUCTION_ID_WRITE_METADATA = 478,
    OF_INSTRUCTION_METER = 479,
    OF_INSTRUCTION_WRITE_ACTIONS = 480,
    OF_INSTRUCTION_WRITE_METADATA = 481,
    OF_MATCH_V1 = 482,
    OF_MATCH_V2 = 483,
    OF_MATCH_V3 = 484,
    OF_METER_BAND = 485,
    OF_METER_BAND_DROP = 486,
    OF_METER_BAND_DSCP_REMARK = 487,
    OF_METER_BAND_EXPERIMENTER = 488,
    OF_METER_BAND_STATS = 489,
    OF_METER_CONFIG = 490,
    OF_METER_FEATURES = 491,
    OF_METER_STATS = 492,
    OF_OXM = 493,
    OF_OXM_ARP_OP = 494,
    OF_OXM_ARP_OP_MASKED = 495,
    OF_OXM_ARP_SHA = 496,
    OF_OXM_ARP_SHA_MASKED = 497,
    OF_OXM_ARP_SPA = 498,
    OF_OXM_ARP_SPA_MASKED = 499,
    OF_OXM_ARP_THA = 500,
    OF_OXM_ARP_THA_MASKED = 501,
    OF_OXM_ARP_TPA = 502,
    OF_OXM_ARP_TPA_MASKED = 503,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 504,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 505,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 506,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 507,
    OF_OXM_BSN_IN_PORTS_128 = 508,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 509,
    OF_OXM_BSN_IN_PORTS_512 = 510,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 511,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 512,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 513,
    OF_OXM_BSN_INNER_ETH_DST = 514,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 515,
    OF_OXM_BSN_INNER_ETH_SRC = 516,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 517,
    OF_OXM_BSN_INNER_VLAN_VID = 518,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 519,
    OF_OXM_BSN_L2_CACHE_HIT = 520,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 521,
    OF_OXM_BSN_L3_DST_CLASS_ID = 522,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 523,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 524,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 525,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 526,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 527,
    OF_OXM_BSN_LAG_ID = 528,
    OF_OXM_BSN_LAG_ID_MASKED = 529,
    OF_OXM_BSN_TCP_FLAGS = 530,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 531,
    OF_OXM_BSN_UDF0 = 532,
    OF_OXM_BSN_UDF0_MASKED = 533,
    OF_OXM_BSN_UDF1 = 534,
    OF_OXM_BSN_UDF1_MASKED = 535,
    OF_OXM_BSN_UDF2 = 536,
    OF_OXM_BSN_UDF2_MASKED = 537,
    OF_OXM_BSN_UDF3 = 538,
    OF_OXM_BSN_UDF3_MASKED = 539,
    OF_OXM_BSN_UDF4 = 540,
    OF_OXM_BSN_UDF4_MASKED = 541,
    OF_OXM_BSN_UDF5 = 542,
    OF_OXM_BSN_UDF5_MASKED = 543,
    OF_OXM_BSN_UDF6 = 544,
    OF_OXM_BSN_UDF6_MASKED = 545,
    OF_OXM_BSN_UDF7 = 546,
    OF_OXM_BSN_UDF7_MASKED = 547,
    OF_OXM_BSN_VFI = 548,
    OF_OXM_BSN_VFI_MASKED = 549,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 550,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 551,
    OF_OXM_BSN_VRF = 552,
    OF_OXM_BSN_VRF_MASKED = 553,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 554,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 555,
    OF_OXM_ETH_DST = 556,
    OF_OXM_ETH_DST_MASKED = 557,
    OF_OXM_ETH_SRC = 558,
    OF_OXM_ETH_SRC_MASKED = 559,
    OF_OXM_ETH_TYPE = 560,
    OF_OXM_ETH_TYPE_MASKED = 561,
    OF_OXM_ICMPV4_CODE = 562,
    OF_OXM_ICMPV4_CODE_MASKED = 563,
    OF_OXM_ICMPV4_TYPE = 564,
    OF_OXM_ICMPV4_TYPE_MASKED = 565,
    OF_OXM_ICMPV6_CODE = 566,
    OF_OXM_ICMPV6_CODE_MASKED = 567,
    OF_OXM_ICMPV6_TYPE = 568,
    OF_OXM_ICMPV6_TYPE_MASKED = 569,
    OF_OXM_IN_PHY_PORT = 570,
    OF_OXM_IN_PHY_PORT_MASKED = 571,
    OF_OXM_IN_PORT = 572,
    OF_OXM_IN_PORT_MASKED = 573,
    OF_OXM_IP_DSCP = 574,
    OF_OXM_IP_DSCP_MASKED = 575,
    OF_OXM_IP_ECN = 576,
    OF_OXM_IP_ECN_MASKED = 577,
    OF_OXM_IP_PROTO = 578,
    OF_OXM_IP_PROTO_MASKED = 579,
    OF_OXM_IPV4_DST = 580,
    OF_OXM_IPV4_DST_MASKED = 581,
    OF_OXM_IPV4_SRC = 582,
    OF_OXM_IPV4_SRC_MASKED = 583,
    OF_OXM_IPV6_DST = 584,
    OF_OXM_IPV6_DST_MASKED = 585,
    OF_OXM_IPV6_EXTHDR = 586,
    OF_OXM_IPV6_EXTHDR_MASKED = 587,
    OF_OXM_IPV6_FLABEL = 588,
    OF_OXM_IPV6_FLABEL_MASKED = 589,
    OF_OXM_IPV6_ND_SLL = 590,
    OF_OXM_IPV6_ND_SLL_MASKED = 591,
    OF_OXM_IPV6_ND_TARGET = 592,
    OF_OXM_IPV6_ND_TARGET_MASKED = 593,
    OF_OXM_IPV6_ND_TLL = 594,
    OF_OXM_IPV6_ND_TLL_MASKED = 595,
    OF_OXM_IPV6_SRC = 596,
    OF_OXM_IPV6_SRC_MASKED = 597,
    OF_OXM_METADATA = 598,
    OF_OXM_METADATA_MASKED = 599,
    OF_OXM_MPLS_BOS = 600,
    OF_OXM_MPLS_BOS_MASKED = 601,
    OF_OXM_MPLS_LABEL = 602,
    OF_OXM_MPLS_LABEL_MASKED = 603,
    OF_OXM_MPLS_TC = 604,
    OF_OXM_MPLS_TC_MASKED = 605,
    OF_OXM_PBB_UCA = 606,
    OF_OXM_PBB_UCA_MASKED = 607,
    OF_OXM_SCTP_DST = 608,
    OF_OXM_SCTP_DST_MASKED = 609,
    OF_OXM_SCTP_SRC = 610,
    OF_OXM_SCTP_SRC_MASKED = 611,
    OF_OXM_TCP_DST = 612,
    OF_OXM_TCP_DST_MASKED = 613,
    OF_OXM_TCP_SRC = 614,
    OF_OXM_TCP_SRC_MASKED = 615,
    OF_OXM_TUNNEL_ID = 616,
    OF_OXM_TUNNEL_ID_MASKED = 617,
    OF_OXM_TUNNEL_IPV4_DST = 618,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 619,
    OF_OXM_TUNNEL_IPV4_SRC = 620,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 621,
    OF_OXM_UDP_DST = 622,
    OF_OXM_UDP_DST_MASKED = 623,
    OF_OXM_UDP_SRC = 624,
    OF_OXM_UDP_SRC_MASKED = 625,
    OF_OXM_VLAN_PCP = 626,
    OF_OXM_VLAN_PCP_MASKED = 627,
    OF_OXM_VLAN_VID = 628,
    OF_OXM_VLAN_VID_MASKED = 629,
    OF_PACKET_QUEUE = 630,
    OF_PORT_DESC = 631,
    OF_PORT_DESC_PROP = 632,
    OF_PORT_DESC_PROP_BSN = 633,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 634,
    OF_PORT_DESC_PROP_BSN_UPLINK = 635,
    OF_PORT_DESC_PROP_ETHERNET = 636,
    OF_PORT_DESC_PROP_EXPERIMENTER = 637,
    OF_PORT_DESC_PROP_OPTICAL = 638,
    OF_PORT_MOD_PROP = 639,
    OF_PORT_MOD_PROP_ETHERNET = 640,
    OF_PORT_MOD_PROP_EXPERIMENTER = 641,
    OF_PORT_MOD_PROP_OPTICAL = 642,
    OF_PORT_STATS_ENTRY = 643,
    OF_PORT_STATS_PROP = 644,
    OF_PORT_STATS_PROP_ETHERNET = 645,
    OF_PORT_STATS_PROP_EXPERIMENTER = 646,
    OF_PORT_STATS_PROP_OPTICAL = 647,
    OF_QUEUE_DESC = 648,
    OF_QUEUE_DESC_PROP = 649,
    OF_QUEUE_DESC_PROP_BSN = 650,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 651,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 652,
    OF_QUEUE_DESC_PROP_MAX_RATE = 653,
    OF_QUEUE_DESC_PROP_MIN_RATE = 654,
    OF_QUEUE_PROP = 655,
    OF_QUEUE_PROP_EXPERIMENTER = 656,
    OF_QUEUE_PROP_MAX_RATE = 657,
    OF_QUEUE_PROP_MIN_RATE = 658,
    OF_QUEUE_STATS_ENTRY = 659,
    OF_QUEUE_STATS_PROP = 660,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 661,
    OF_ROLE_PROP = 662,
    OF_ROLE_PROP_EXPERIMENTER = 663,
    OF_TABLE_DESC = 664,
    OF_TABLE_FEATURE_PROP = 665,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 666,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 667,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 668,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 669,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 670,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 671,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 672,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 673,
    OF_TABLE_FEATURE_PROP_MATCH = 674,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 675,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 676,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 677,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 678,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 679,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 680,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 681,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 682,
    OF_TABLE_FEATURES = 683,
    OF_TABLE_MOD_PROP = 684,
    OF_TABLE_MOD_PROP_EVICTION = 685,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 686,
    OF_TABLE_MOD_PROP_VACANCY = 687,
    OF_TABLE_STATS_ENTRY = 688,
    OF_UINT32 = 689,
    OF_UINT64 = 690,
    OF_UINT8 = 691,
    ...
    /* List objects */
    OF_LIST_ACTION = 692,
    OF_LIST_ACTION_ID = 693,
    OF_LIST_ASYNC_CONFIG_PROP = 694,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 695,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 696,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 697,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 698,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 699,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 700,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 701,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 702,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 703,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 704,
    OF_LIST_BSN_INTERFACE = 705,
    OF_LIST_BSN_LACP_STATS_ENTRY = 706,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 707,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 708,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 709,
    OF_LIST_BSN_TLV = 710,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 711,
    OF_LIST_BSN_VLAN_MAC = 712,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 713,
    OF_LIST_BUCKET = 714,
    OF_LIST_BUCKET_COUNTER = 715,
    OF_LIST_BUNDLE_PROP = 716,
    OF_LIST_FLOW_STATS_ENTRY = 717,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 718,
    OF_LIST_GROUP_STATS_ENTRY = 719,
    OF_LIST_HELLO_ELEM = 720,
    OF_LIST_INSTRUCTION = 721,
    OF_LIST_INSTRUCTION_ID = 722,
    OF_LIST_METER_BAND = 723,
    OF_LIST_METER_BAND_STATS = 724,
    OF_LIST_METER_CONFIG = 725,
    OF_LIST_METER_STATS = 726,
    OF_LIST_OXM = 727,
    OF_LIST_PACKET_QUEUE = 728,
    OF_LIST_PORT_DESC = 729,
    OF_LIST_PORT_DESC_PROP = 730,
    OF_LIST_PORT_MOD_PROP = 731,
    OF_LIST_PORT_STATS_ENTRY = 732,
    OF_LIST_PORT_STATS_PROP = 733,
    OF_LIST_QUEUE_DESC = 734,
    OF_LIST_QUEUE_DESC_PROP = 735,
    OF_LIST_QUEUE_PROP = 736,
    OF_LIST_QUEUE_STATS_ENTRY = 737,
    OF_LIST_QUEUE_STATS_PROP = 738,
    OF_LIST_ROLE_PROP = 739,
    OF_LIST_TABLE_DESC = 740,
    OF_LIST_TABLE_FEATURE_PROP = 741,
    OF_LIST_TABLE_FEATURES = 742,
    OF_LIST_TABLE_MOD_PROP = 743,
    OF_LIST_TABLE_STATS_ENTRY = 744,
    OF_LIST_UINT32 = 745,
    OF_LIST_UINT64 = 746,
    OF_LIST_UINT8 = 747,
