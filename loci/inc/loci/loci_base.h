...
typedef enum of_object_id_e {
    ...
    OF_BSN_GENERIC_ASYNC = 34,
    OF_BSN_GENERIC_STATS_REPLY = 35,
    OF_BSN_GENERIC_STATS_REQUEST = 36,
    OF_BSN_GENTABLE_BUCKET_STATS_REPLY = 37,
    OF_BSN_GENTABLE_BUCKET_STATS_REQUEST = 38,
    OF_BSN_GENTABLE_CLEAR_REPLY = 39,
    OF_BSN_GENTABLE_CLEAR_REQUEST = 40,
    OF_BSN_GENTABLE_DESC_STATS_REPLY = 41,
    OF_BSN_GENTABLE_DESC_STATS_REQUEST = 42,
    OF_BSN_GENTABLE_ENTRY_ADD = 43,
    OF_BSN_GENTABLE_ENTRY_DELETE = 44,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_REPLY = 45,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_REQUEST = 46,
    OF_BSN_GENTABLE_ENTRY_STATS_REPLY = 47,
    OF_BSN_GENTABLE_ENTRY_STATS_REQUEST = 48,
    OF_BSN_GENTABLE_SET_BUCKETS_SIZE = 49,
    OF_BSN_GENTABLE_STATS_REPLY = 50,
    OF_BSN_GENTABLE_STATS_REQUEST = 51,
    OF_BSN_GET_INTERFACES_REPLY = 52,
    OF_BSN_GET_INTERFACES_REQUEST = 53,
    OF_BSN_GET_IP_MASK_REPLY = 54,
    OF_BSN_GET_IP_MASK_REQUEST = 55,
    OF_BSN_GET_L2_TABLE_REPLY = 56,
    OF_BSN_GET_L2_TABLE_REQUEST = 57,
    OF_BSN_GET_MIRRORING_REPLY = 58,
    OF_BSN_GET_MIRRORING_REQUEST = 59,
    OF_BSN_GET_SWITCH_PIPELINE_REPLY = 60,
    OF_BSN_GET_SWITCH_PIPELINE_REQUEST = 61,
    OF_BSN_HEADER = 62,
    OF_BSN_HYBRID_GET_REPLY = 63,
    OF_BSN_HYBRID_GET_REQUEST = 64,
    OF_BSN_IMAGE_DESC_STATS_REPLY = 65,
    OF_BSN_IMAGE_DESC_STATS_REQUEST = 66,
    OF_BSN_LACP_CONVERGENCE_NOTIF = 67,
    OF_BSN_LACP_STATS_REPLY = 68,
    OF_BSN_LACP_STATS_REQUEST = 69,
    OF_BSN_LOG = 70,
    OF_BSN_LUA_COMMAND_REPLY = 71,
    OF_BSN_LUA_COMMAND_REQUEST = 72,
    OF_BSN_LUA_NOTIFICATION = 73,
    OF_BSN_LUA_UPLOAD = 74,
    OF_BSN_PDU_RX_REPLY = 75,
    OF_BSN_PDU_RX_REQUEST = 76,
    OF_BSN_PDU_RX_TIMEOUT = 77,
    OF_BSN_PDU_TX_REPLY = 78,
    OF_BSN_PDU_TX_REQUEST = 79,
    OF_BSN_PORT_COUNTER_STATS_REPLY = 80,
    OF_BSN_PORT_COUNTER_STATS_REQUEST = 81,
    OF_BSN_ROLE_STATUS = 82,
    OF_BSN_SET_AUX_CXNS_REPLY = 83,
    OF_BSN_SET_AUX_CXNS_REQUEST = 84,
    OF_BSN_SET_IP_MASK = 85,
    OF_BSN_SET_L2_TABLE_REPLY = 86,
    OF_BSN_SET_L2_TABLE_REQUEST = 87,
    OF_BSN_SET_LACP_REPLY = 88,
    OF_BSN_SET_LACP_REQUEST = 89,
    OF_BSN_SET_MIRRORING = 90,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 91,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 92,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 93,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 94,
    OF_BSN_SHELL_COMMAND = 95,
    OF_BSN_SHELL_OUTPUT = 96,
    OF_BSN_SHELL_STATUS = 97,
    OF_BSN_STATS_REPLY = 98,
    OF_BSN_STATS_REQUEST = 99,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 100,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 101,
    OF_BSN_TABLE_CHECKSUM_STATS_REPLY = 102,
    OF_BSN_TABLE_CHECKSUM_STATS_REQUEST = 103,
    OF_BSN_TABLE_SET_BUCKETS_SIZE = 104,
    OF_BSN_TAKEOVER = 105,
    OF_BSN_TIME_REPLY = 106,
    OF_BSN_TIME_REQUEST = 107,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 108,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 109,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 110,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 111,
    OF_BSN_VLAN_COUNTER_CLEAR = 112,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 113,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 114,
    OF_BSN_VRF_COUNTER_STATS_REPLY = 115,
    OF_BSN_VRF_COUNTER_STATS_REQUEST = 116,
    OF_BUNDLE_ADD_MSG = 117,
    OF_BUNDLE_CTRL_MSG = 118,
    OF_BUNDLE_FAILED_ERROR_MSG = 119,
    OF_DESC_STATS_REPLY = 120,
    OF_DESC_STATS_REQUEST = 121,
    OF_ECHO_REPLY = 122,
    OF_ECHO_REQUEST = 123,
    OF_ERROR_MSG = 124,
    OF_EXPERIMENTER = 125,
    OF_EXPERIMENTER_ERROR_MSG = 126,
    OF_EXPERIMENTER_STATS_REPLY = 127,
    OF_EXPERIMENTER_STATS_REQUEST = 128,
    OF_FEATURES_REPLY = 129,
    OF_FEATURES_REQUEST = 130,
    OF_FLOW_ADD = 131,
    OF_FLOW_DELETE = 132,
    OF_FLOW_DELETE_STRICT = 133,
    OF_FLOW_MOD = 134,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 135,
    OF_FLOW_MODIFY = 136,
    OF_FLOW_MODIFY_STRICT = 137,
    OF_FLOW_MONITOR_FAILED_ERROR_MSG = 138,
    OF_FLOW_REMOVED = 139,
    OF_FLOW_STATS_REPLY = 140,
    OF_FLOW_STATS_REQUEST = 141,
    OF_GET_CONFIG_REPLY = 142,
    OF_GET_CONFIG_REQUEST = 143,
    OF_GROUP_ADD = 144,
    OF_GROUP_DELETE = 145,
    OF_GROUP_DESC_STATS_REPLY = 146,
    OF_GROUP_DESC_STATS_REQUEST = 147,
    OF_GROUP_FEATURES_STATS_REPLY = 148,
    OF_GROUP_FEATURES_STATS_REQUEST = 149,
    OF_GROUP_MOD = 150,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 151,
    OF_GROUP_MODIFY = 152,
    OF_GROUP_STATS_REPLY = 153,
    OF_GROUP_STATS_REQUEST = 154,
    OF_HEADER = 155,
    OF_HELLO = 156,
    OF_HELLO_FAILED_ERROR_MSG = 157,
    OF_METER_CONFIG_STATS_REPLY = 158,
    OF_METER_CONFIG_STATS_REQUEST = 159,
    OF_METER_FEATURES_STATS_REPLY = 160,
    OF_METER_FEATURES_STATS_REQUEST = 161,
    OF_METER_MOD = 162,
    OF_METER_MOD_FAILED_ERROR_MSG = 163,
    OF_METER_STATS_REPLY = 164,
    OF_METER_STATS_REQUEST = 165,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 166,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 167,
    OF_NICIRA_HEADER = 168,
    OF_PACKET_IN = 169,
    OF_PACKET_OUT = 170,
    OF_PORT_DESC_STATS_REPLY = 171,
    OF_PORT_DESC_STATS_REQUEST = 172,
    OF_PORT_MOD = 173,
    OF_PORT_MOD_FAILED_ERROR_MSG = 174,
    OF_PORT_STATS_REPLY = 175,
    OF_PORT_STATS_REQUEST = 176,
    OF_PORT_STATUS = 177,
    OF_QUEUE_DESC_STATS_REPLY = 178,
    OF_QUEUE_DESC_STATS_REQUEST = 179,
    OF_QUEUE_GET_CONFIG_REPLY = 180,
    OF_QUEUE_GET_CONFIG_REQUEST = 181,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 182,
    OF_QUEUE_STATS_REPLY = 183,
    OF_QUEUE_STATS_REQUEST = 184,
    OF_REQUESTFORWARD = 185,
    OF_ROLE_REPLY = 186,
    OF_ROLE_REQUEST = 187,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 188,
    OF_ROLE_STATUS = 189,
    OF_SET_CONFIG = 190,
    OF_STATS_REPLY = 191,
    OF_STATS_REQUEST = 192,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 193,
    OF_TABLE_DESC_STATS_REPLY = 194,
    OF_TABLE_DESC_STATS_REQUEST = 195,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 196,
    OF_TABLE_FEATURES_STATS_REPLY = 197,
    OF_TABLE_FEATURES_STATS_REQUEST = 198,
    OF_TABLE_MOD = 199,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 200,
    OF_TABLE_STATS_REPLY = 201,
    OF_TABLE_STATS_REQUEST = 202,
    OF_TABLE_STATUS = 203,

    /* Non-message objects */
    OF_ACTION = 204,
    OF_ACTION_BSN = 205,
    OF_ACTION_BSN_CHECKSUM = 206,
    OF_ACTION_BSN_GENTABLE = 207,
    OF_ACTION_BSN_MIRROR = 208,
    OF_ACTION_BSN_SET_TUNNEL_DST = 209,
    OF_ACTION_COPY_TTL_IN = 210,
    OF_ACTION_COPY_TTL_OUT = 211,
    OF_ACTION_DEC_MPLS_TTL = 212,
    OF_ACTION_DEC_NW_TTL = 213,
    OF_ACTION_ENQUEUE = 214,
    OF_ACTION_EXPERIMENTER = 215,
    OF_ACTION_GROUP = 216,
    OF_ACTION_ID = 217,
    OF_ACTION_ID_BSN = 218,
    OF_ACTION_ID_BSN_CHECKSUM = 219,
    OF_ACTION_ID_BSN_GENTABLE = 220,
    OF_ACTION_ID_BSN_MIRROR = 221,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 222,
    OF_ACTION_ID_COPY_TTL_IN = 223,
    OF_ACTION_ID_COPY_TTL_OUT = 224,
    OF_ACTION_ID_DEC_MPLS_TTL = 225,
    OF_ACTION_ID_DEC_NW_TTL = 226,
    OF_ACTION_ID_EXPERIMENTER = 227,
    OF_ACTION_ID_GROUP = 228,
    OF_ACTION_ID_NICIRA = 229,
    OF_ACTION_ID_NICIRA_DEC_TTL = 230,
    OF_ACTION_ID_OUTPUT = 231,
    OF_ACTION_ID_POP_MPLS = 232,
    OF_ACTION_ID_POP_PBB = 233,
    OF_ACTION_ID_POP_VLAN = 234,
    OF_ACTION_ID_PUSH_MPLS = 235,
    OF_ACTION_ID_PUSH_PBB = 236,
    OF_ACTION_ID_PUSH_VLAN = 237,
    OF_ACTION_ID_SET_FIELD = 238,
    OF_ACTION_ID_SET_MPLS_TTL = 239,
    OF_ACTION_ID_SET_NW_TTL = 240,
    OF_ACTION_ID_SET_QUEUE = 241,
    OF_ACTION_NICIRA = 242,
    OF_ACTION_NICIRA_DEC_TTL = 243,
    OF_ACTION_OUTPUT = 244,
    OF_ACTION_POP_MPLS = 245,
    OF_ACTION_POP_PBB = 246,
    OF_ACTION_POP_VLAN = 247,
    OF_ACTION_PUSH_MPLS = 248,
    OF_ACTION_PUSH_PBB = 249,
    OF_ACTION_PUSH_VLAN = 250,
    OF_ACTION_SET_DL_DST = 251,
    OF_ACTION_SET_DL_SRC = 252,
    OF_ACTION_SET_FIELD = 253,
    OF_ACTION_SET_MPLS_LABEL = 254,
    OF_ACTION_SET_MPLS_TC = 255,
    OF_ACTION_SET_MPLS_TTL = 256,
    OF_ACTION_SET_NW_DST = 257,
    OF_ACTION_SET_NW_ECN = 258,
    OF_ACTION_SET_NW_SRC = 259,
    OF_ACTION_SET_NW_TOS = 260,
    OF_ACTION_SET_NW_TTL = 261,
    OF_ACTION_SET_QUEUE = 262,
    OF_ACTION_SET_TP_DST = 263,
    OF_ACTION_SET_TP_SRC = 264,
    OF_ACTION_SET_VLAN_PCP = 265,
    OF_ACTION_SET_VLAN_VID = 266,
    OF_ACTION_STRIP_VLAN = 267,
    OF_ASYNC_CONFIG_PROP = 268,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_MASTER = 269,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_SLAVE = 270,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_MASTER = 271,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_SLAVE = 272,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_MASTER = 273,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_SLAVE = 274,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_MASTER = 275,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_SLAVE = 276,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_MASTER = 277,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_SLAVE = 278,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_MASTER = 279,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_SLAVE = 280,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_MASTER = 281,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_SLAVE = 282,
    OF_BSN_CONTROLLER_CONNECTION = 283,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 284,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 285,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 286,
    OF_BSN_GENERIC_STATS_ENTRY = 287,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 288,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 289,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 290,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 291,
    OF_BSN_GENTABLE_STATS_ENTRY = 292,
    OF_BSN_INTERFACE = 293,
    OF_BSN_LACP_STATS_ENTRY = 294,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 295,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 296,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 297,
    OF_BSN_TLV = 298,
    OF_BSN_TLV_ACTOR_KEY = 299,
    OF_BSN_TLV_ACTOR_PORT_NUM = 300,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 301,
    OF_BSN_TLV_ACTOR_STATE = 302,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 303,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 304,
    OF_BSN_TLV_ANCHOR = 305,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 306,
    OF_BSN_TLV_BROADCAST_RATE = 307,
    OF_BSN_TLV_BUCKET = 308,
    OF_BSN_TLV_CIRCUIT_ID = 309,
    OF_BSN_TLV_CONVERGENCE_STATUS = 310,
    OF_BSN_TLV_CRC_ENABLED = 311,
    OF_BSN_TLV_DATA = 312,
    OF_BSN_TLV_DECAP = 313,
    OF_BSN_TLV_ETH_DST = 314,
    OF_BSN_TLV_ETH_SRC = 315,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 316,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 317,
    OF_BSN_TLV_EXTERNAL_IP = 318,
    OF_BSN_TLV_EXTERNAL_MAC = 319,
    OF_BSN_TLV_EXTERNAL_NETMASK = 320,
    OF_BSN_TLV_GENERATION_ID = 321,
    OF_BSN_TLV_HEADER_SIZE = 322,
    OF_BSN_TLV_ICMP_CODE = 323,
    OF_BSN_TLV_ICMP_ID = 324,
    OF_BSN_TLV_ICMP_TYPE = 325,
    OF_BSN_TLV_IDLE_NOTIFICATION = 326,
    OF_BSN_TLV_IDLE_TIME = 327,
    OF_BSN_TLV_IDLE_TIMEOUT = 328,
    OF_BSN_TLV_IGMP_SNOOPING = 329,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 330,
    OF_BSN_TLV_INTERNAL_MAC = 331,
    OF_BSN_TLV_INTERVAL = 332,
    OF_BSN_TLV_IP_PROTO = 333,
    OF_BSN_TLV_IPV4 = 334,
    OF_BSN_TLV_IPV4_DST = 335,
    OF_BSN_TLV_IPV4_NETMASK = 336,
    OF_BSN_TLV_IPV4_SRC = 337,
    OF_BSN_TLV_IPV6 = 338,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 339,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 340,
    OF_BSN_TLV_MAC = 341,
    OF_BSN_TLV_MAC_MASK = 342,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 343,
    OF_BSN_TLV_MISS_PACKETS = 344,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 345,
    OF_BSN_TLV_MPLS_LABEL = 346,
    OF_BSN_TLV_MPLS_SEQUENCED = 347,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 348,
    OF_BSN_TLV_NAME = 349,
    OF_BSN_TLV_NEGATE = 350,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 351,
    OF_BSN_TLV_OFFSET = 352,
    OF_BSN_TLV_PARTNER_KEY = 353,
    OF_BSN_TLV_PARTNER_PORT_NUM = 354,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 355,
    OF_BSN_TLV_PARTNER_STATE = 356,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 357,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 358,
    OF_BSN_TLV_PORT = 359,
    OF_BSN_TLV_PORT_VXLAN_MODE = 360,
    OF_BSN_TLV_PRIORITY = 361,
    OF_BSN_TLV_QUEUE_ID = 362,
    OF_BSN_TLV_QUEUE_WEIGHT = 363,
    OF_BSN_TLV_RATE_UNIT = 364,
    OF_BSN_TLV_REFERENCE = 365,
    OF_BSN_TLV_REPLY_PACKETS = 366,
    OF_BSN_TLV_REQUEST_PACKETS = 367,
    OF_BSN_TLV_RX_BYTES = 368,
    OF_BSN_TLV_RX_PACKETS = 369,
    OF_BSN_TLV_SAMPLING_RATE = 370,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 371,
    OF_BSN_TLV_STATUS = 372,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 373,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 374,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 375,
    OF_BSN_TLV_SUB_AGENT_ID = 376,
    OF_BSN_TLV_TCP_DST = 377,
    OF_BSN_TLV_TCP_SRC = 378,
    OF_BSN_TLV_TX_BYTES = 379,
    OF_BSN_TLV_TX_PACKETS = 380,
    OF_BSN_TLV_UDF_ANCHOR = 381,
    OF_BSN_TLV_UDF_ID = 382,
    OF_BSN_TLV_UDF_LENGTH = 383,
    OF_BSN_TLV_UDF_OFFSET = 384,
    OF_BSN_TLV_UDP_DST = 385,
    OF_BSN_TLV_UDP_SRC = 386,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 387,
    OF_BSN_TLV_UNICAST_RATE = 388,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 389,
    OF_BSN_TLV_USE_PACKET_STATE = 390,
    OF_BSN_TLV_VLAN_PCP = 391,
    OF_BSN_TLV_VLAN_VID = 392,
    OF_BSN_TLV_VLAN_VID_MASK = 393,
    OF_BSN_TLV_VNI = 394,
    OF_BSN_TLV_VRF = 395,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 396,
    OF_BSN_VPORT = 397,
    OF_BSN_VPORT_L2GRE = 398,
    OF_BSN_VPORT_Q_IN_Q = 399,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 400,
    OF_BUCKET = 401,
    OF_BUCKET_COUNTER = 402,
    OF_BUNDLE_PROP = 403,
    OF_BUNDLE_PROP_EXPERIMENTER = 404,
    OF_FLOW_STATS_ENTRY = 405,
    OF_GROUP_DESC_STATS_ENTRY = 406,
    OF_GROUP_STATS_ENTRY = 407,
    OF_HELLO_ELEM = 408,
    OF_HELLO_ELEM_VERSIONBITMAP = 409,
    OF_INSTRUCTION = 410,
    OF_INSTRUCTION_APPLY_ACTIONS = 411,
    OF_INSTRUCTION_BSN = 412,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 413,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 414,
    OF_INSTRUCTION_BSN_DENY = 415,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 416,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 417,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 418,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 419,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 420,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 421,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 422,
    OF_INSTRUCTION_BSN_PERMIT = 423,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 424,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 425,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 426,
    OF_INSTRUCTION_CLEAR_ACTIONS = 427,
    OF_INSTRUCTION_EXPERIMENTER = 428,
    OF_INSTRUCTION_GOTO_TABLE = 429,
    OF_INSTRUCTION_ID = 430,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 431,
    OF_INSTRUCTION_ID_BSN = 432,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 433,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 434,
    OF_INSTRUCTION_ID_BSN_DENY = 435,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 436,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 437,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 438,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 439,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 440,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 441,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 442,
    OF_INSTRUCTION_ID_BSN_PERMIT = 443,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 444,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 445,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 446,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 447,
    OF_INSTRUCTION_ID_EXPERIMENTER = 448,
    OF_INSTRUCTION_ID_GOTO_TABLE = 449,
    OF_INSTRUCTION_ID_METER = 450,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 451,
    OF_INSTRUCTION_ID_WRITE_METADATA = 452,
    OF_INSTRUCTION_METER = 453,
    OF_INSTRUCTION_WRITE_ACTIONS = 454,
    OF_INSTRUCTION_WRITE_METADATA = 455,
    OF_MATCH_V1 = 456,
    OF_MATCH_V2 = 457,
    OF_MATCH_V3 = 458,
    OF_METER_BAND = 459,
    OF_METER_BAND_DROP = 460,
    OF_METER_BAND_DSCP_REMARK = 461,
    OF_METER_BAND_EXPERIMENTER = 462,
    OF_METER_BAND_STATS = 463,
    OF_METER_CONFIG = 464,
    OF_METER_FEATURES = 465,
    OF_METER_STATS = 466,
    OF_OXM = 467,
    OF_OXM_ARP_OP = 468,
    OF_OXM_ARP_OP_MASKED = 469,
    OF_OXM_ARP_SHA = 470,
    OF_OXM_ARP_SHA_MASKED = 471,
    OF_OXM_ARP_SPA = 472,
    OF_OXM_ARP_SPA_MASKED = 473,
    OF_OXM_ARP_THA = 474,
    OF_OXM_ARP_THA_MASKED = 475,
    OF_OXM_ARP_TPA = 476,
    OF_OXM_ARP_TPA_MASKED = 477,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 478,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 479,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 480,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 481,
    OF_OXM_BSN_IN_PORTS_128 = 482,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 483,
    OF_OXM_BSN_IN_PORTS_512 = 484,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 485,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 486,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 487,
    OF_OXM_BSN_INNER_ETH_DST = 488,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 489,
    OF_OXM_BSN_INNER_ETH_SRC = 490,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 491,
    OF_OXM_BSN_INNER_VLAN_VID = 492,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 493,
    OF_OXM_BSN_L2_CACHE_HIT = 494,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 495,
    OF_OXM_BSN_L3_DST_CLASS_ID = 496,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 497,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 498,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 499,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 500,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 501,
    OF_OXM_BSN_LAG_ID = 502,
    OF_OXM_BSN_LAG_ID_MASKED = 503,
    OF_OXM_BSN_TCP_FLAGS = 504,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 505,
    OF_OXM_BSN_UDF0 = 506,
    OF_OXM_BSN_UDF0_MASKED = 507,
    OF_OXM_BSN_UDF1 = 508,
    OF_OXM_BSN_UDF1_MASKED = 509,
    OF_OXM_BSN_UDF2 = 510,
    OF_OXM_BSN_UDF2_MASKED = 511,
    OF_OXM_BSN_UDF3 = 512,
    OF_OXM_BSN_UDF3_MASKED = 513,
    OF_OXM_BSN_UDF4 = 514,
    OF_OXM_BSN_UDF4_MASKED = 515,
    OF_OXM_BSN_UDF5 = 516,
    OF_OXM_BSN_UDF5_MASKED = 517,
    OF_OXM_BSN_UDF6 = 518,
    OF_OXM_BSN_UDF6_MASKED = 519,
    OF_OXM_BSN_UDF7 = 520,
    OF_OXM_BSN_UDF7_MASKED = 521,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 522,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 523,
    OF_OXM_BSN_VRF = 524,
    OF_OXM_BSN_VRF_MASKED = 525,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 526,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 527,
    OF_OXM_ETH_DST = 528,
    OF_OXM_ETH_DST_MASKED = 529,
    OF_OXM_ETH_SRC = 530,
    OF_OXM_ETH_SRC_MASKED = 531,
    OF_OXM_ETH_TYPE = 532,
    OF_OXM_ETH_TYPE_MASKED = 533,
    OF_OXM_ICMPV4_CODE = 534,
    OF_OXM_ICMPV4_CODE_MASKED = 535,
    OF_OXM_ICMPV4_TYPE = 536,
    OF_OXM_ICMPV4_TYPE_MASKED = 537,
    OF_OXM_ICMPV6_CODE = 538,
    OF_OXM_ICMPV6_CODE_MASKED = 539,
    OF_OXM_ICMPV6_TYPE = 540,
    OF_OXM_ICMPV6_TYPE_MASKED = 541,
    OF_OXM_IN_PHY_PORT = 542,
    OF_OXM_IN_PHY_PORT_MASKED = 543,
    OF_OXM_IN_PORT = 544,
    OF_OXM_IN_PORT_MASKED = 545,
    OF_OXM_IP_DSCP = 546,
    OF_OXM_IP_DSCP_MASKED = 547,
    OF_OXM_IP_ECN = 548,
    OF_OXM_IP_ECN_MASKED = 549,
    OF_OXM_IP_PROTO = 550,
    OF_OXM_IP_PROTO_MASKED = 551,
    OF_OXM_IPV4_DST = 552,
    OF_OXM_IPV4_DST_MASKED = 553,
    OF_OXM_IPV4_SRC = 554,
    OF_OXM_IPV4_SRC_MASKED = 555,
    OF_OXM_IPV6_DST = 556,
    OF_OXM_IPV6_DST_MASKED = 557,
    OF_OXM_IPV6_EXTHDR = 558,
    OF_OXM_IPV6_EXTHDR_MASKED = 559,
    OF_OXM_IPV6_FLABEL = 560,
    OF_OXM_IPV6_FLABEL_MASKED = 561,
    OF_OXM_IPV6_ND_SLL = 562,
    OF_OXM_IPV6_ND_SLL_MASKED = 563,
    OF_OXM_IPV6_ND_TARGET = 564,
    OF_OXM_IPV6_ND_TARGET_MASKED = 565,
    OF_OXM_IPV6_ND_TLL = 566,
    OF_OXM_IPV6_ND_TLL_MASKED = 567,
    OF_OXM_IPV6_SRC = 568,
    OF_OXM_IPV6_SRC_MASKED = 569,
    OF_OXM_METADATA = 570,
    OF_OXM_METADATA_MASKED = 571,
    OF_OXM_MPLS_BOS = 572,
    OF_OXM_MPLS_BOS_MASKED = 573,
    OF_OXM_MPLS_LABEL = 574,
    OF_OXM_MPLS_LABEL_MASKED = 575,
    OF_OXM_MPLS_TC = 576,
    OF_OXM_MPLS_TC_MASKED = 577,
    OF_OXM_PBB_UCA = 578,
    OF_OXM_PBB_UCA_MASKED = 579,
    OF_OXM_SCTP_DST = 580,
    OF_OXM_SCTP_DST_MASKED = 581,
    OF_OXM_SCTP_SRC = 582,
    OF_OXM_SCTP_SRC_MASKED = 583,
    OF_OXM_TCP_DST = 584,
    OF_OXM_TCP_DST_MASKED = 585,
    OF_OXM_TCP_SRC = 586,
    OF_OXM_TCP_SRC_MASKED = 587,
    OF_OXM_TUNNEL_ID = 588,
    OF_OXM_TUNNEL_ID_MASKED = 589,
    OF_OXM_TUNNEL_IPV4_DST = 590,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 591,
    OF_OXM_TUNNEL_IPV4_SRC = 592,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 593,
    OF_OXM_UDP_DST = 594,
    OF_OXM_UDP_DST_MASKED = 595,
    OF_OXM_UDP_SRC = 596,
    OF_OXM_UDP_SRC_MASKED = 597,
    OF_OXM_VLAN_PCP = 598,
    OF_OXM_VLAN_PCP_MASKED = 599,
    OF_OXM_VLAN_VID = 600,
    OF_OXM_VLAN_VID_MASKED = 601,
    OF_PACKET_QUEUE = 602,
    OF_PORT_DESC = 603,
    OF_PORT_DESC_PROP = 604,
    OF_PORT_DESC_PROP_BSN = 605,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 606,
    OF_PORT_DESC_PROP_BSN_UPLINK = 607,
    OF_PORT_DESC_PROP_ETHERNET = 608,
    OF_PORT_DESC_PROP_EXPERIMENTER = 609,
    OF_PORT_DESC_PROP_OPTICAL = 610,
    OF_PORT_MOD_PROP = 611,
    OF_PORT_MOD_PROP_ETHERNET = 612,
    OF_PORT_MOD_PROP_EXPERIMENTER = 613,
    OF_PORT_MOD_PROP_OPTICAL = 614,
    OF_PORT_STATS_ENTRY = 615,
    OF_PORT_STATS_PROP = 616,
    OF_PORT_STATS_PROP_ETHERNET = 617,
    OF_PORT_STATS_PROP_EXPERIMENTER = 618,
    OF_PORT_STATS_PROP_OPTICAL = 619,
    OF_QUEUE_DESC = 620,
    OF_QUEUE_DESC_PROP = 621,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 622,
    OF_QUEUE_DESC_PROP_MAX_RATE = 623,
    OF_QUEUE_DESC_PROP_MIN_RATE = 624,
    OF_QUEUE_PROP = 625,
    OF_QUEUE_PROP_EXPERIMENTER = 626,
    OF_QUEUE_PROP_MAX_RATE = 627,
    OF_QUEUE_PROP_MIN_RATE = 628,
    OF_QUEUE_STATS_ENTRY = 629,
    OF_QUEUE_STATS_PROP = 630,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 631,
    OF_ROLE_PROP = 632,
    OF_ROLE_PROP_EXPERIMENTER = 633,
    OF_TABLE_DESC = 634,
    OF_TABLE_FEATURE_PROP = 635,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 636,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 637,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 638,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 639,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 640,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 641,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 642,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 643,
    OF_TABLE_FEATURE_PROP_MATCH = 644,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 645,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 646,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 647,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 648,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 649,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 650,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 651,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 652,
    OF_TABLE_FEATURES = 653,
    OF_TABLE_MOD_PROP = 654,
    OF_TABLE_MOD_PROP_EVICTION = 655,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 656,
    OF_TABLE_MOD_PROP_VACANCY = 657,
    OF_TABLE_STATS_ENTRY = 658,
    OF_UINT32 = 659,
    OF_UINT64 = 660,
    OF_UINT8 = 661,
    ...
    /* List objects */
    OF_LIST_ACTION = 662,
    OF_LIST_ACTION_ID = 663,
    OF_LIST_ASYNC_CONFIG_PROP = 664,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 665,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 666,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 667,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 668,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 669,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 670,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 671,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 672,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 673,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 674,
    OF_LIST_BSN_INTERFACE = 675,
    OF_LIST_BSN_LACP_STATS_ENTRY = 676,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 677,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 678,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 679,
    OF_LIST_BSN_TLV = 680,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 681,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 682,
    OF_LIST_BUCKET = 683,
    OF_LIST_BUCKET_COUNTER = 684,
    OF_LIST_BUNDLE_PROP = 685,
    OF_LIST_FLOW_STATS_ENTRY = 686,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 687,
    OF_LIST_GROUP_STATS_ENTRY = 688,
    OF_LIST_HELLO_ELEM = 689,
    OF_LIST_INSTRUCTION = 690,
    OF_LIST_INSTRUCTION_ID = 691,
    OF_LIST_METER_BAND = 692,
    OF_LIST_METER_BAND_STATS = 693,
    OF_LIST_METER_CONFIG = 694,
    OF_LIST_METER_STATS = 695,
    OF_LIST_OXM = 696,
    OF_LIST_PACKET_QUEUE = 697,
    OF_LIST_PORT_DESC = 698,
    OF_LIST_PORT_DESC_PROP = 699,
    OF_LIST_PORT_MOD_PROP = 700,
    OF_LIST_PORT_STATS_ENTRY = 701,
    OF_LIST_PORT_STATS_PROP = 702,
    OF_LIST_QUEUE_DESC = 703,
    OF_LIST_QUEUE_DESC_PROP = 704,
    OF_LIST_QUEUE_PROP = 705,
    OF_LIST_QUEUE_STATS_ENTRY = 706,
    OF_LIST_QUEUE_STATS_PROP = 707,
    OF_LIST_ROLE_PROP = 708,
    OF_LIST_TABLE_DESC = 709,
    OF_LIST_TABLE_FEATURE_PROP = 710,
    OF_LIST_TABLE_FEATURES = 711,
    OF_LIST_TABLE_MOD_PROP = 712,
    OF_LIST_TABLE_STATS_ENTRY = 713,
    OF_LIST_UINT32 = 714,
    OF_LIST_UINT64 = 715,
    OF_LIST_UINT8 = 716,
...
#define OF_MESSAGE_OBJECT_COUNT 204
