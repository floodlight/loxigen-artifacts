...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PARTNER_KEY = 289,
    OF_BSN_TLV_PARTNER_PORT_NUM = 290,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 291,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 292,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 293,
    OF_BSN_TLV_PORT = 294,
    OF_BSN_TLV_QUEUE_ID = 295,
    OF_BSN_TLV_QUEUE_WEIGHT = 296,
    OF_BSN_TLV_REPLY_PACKETS = 297,
    OF_BSN_TLV_REQUEST_PACKETS = 298,
    OF_BSN_TLV_RX_PACKETS = 299,
    OF_BSN_TLV_SAMPLING_RATE = 300,
    OF_BSN_TLV_SUB_AGENT_ID = 301,
    OF_BSN_TLV_TX_BYTES = 302,
    OF_BSN_TLV_TX_PACKETS = 303,
    OF_BSN_TLV_UDF_ANCHOR = 304,
    OF_BSN_TLV_UDF_ID = 305,
    OF_BSN_TLV_UDF_LENGTH = 306,
    OF_BSN_TLV_UDF_OFFSET = 307,
    OF_BSN_TLV_UDP_DST = 308,
    OF_BSN_TLV_UDP_SRC = 309,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 310,
    OF_BSN_TLV_VLAN_VID = 311,
    OF_BSN_TLV_VRF = 312,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 313,
    OF_BSN_VPORT = 314,
    OF_BSN_VPORT_HEADER = 315,
    OF_BSN_VPORT_L2GRE = 316,
    OF_BSN_VPORT_Q_IN_Q = 317,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 318,
    OF_BUCKET = 319,
    OF_BUCKET_COUNTER = 320,
    OF_FLOW_STATS_ENTRY = 321,
    OF_GROUP_DESC_STATS_ENTRY = 322,
    OF_GROUP_STATS_ENTRY = 323,
    OF_HELLO_ELEM = 324,
    OF_HELLO_ELEM_HEADER = 325,
    OF_HELLO_ELEM_VERSIONBITMAP = 326,
    OF_INSTRUCTION = 327,
    OF_INSTRUCTION_APPLY_ACTIONS = 328,
    OF_INSTRUCTION_BSN = 329,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 330,
    OF_INSTRUCTION_BSN_DENY = 331,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 332,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 333,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 334,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 335,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 336,
    OF_INSTRUCTION_BSN_PERMIT = 337,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 338,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 339,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 340,
    OF_INSTRUCTION_CLEAR_ACTIONS = 341,
    OF_INSTRUCTION_EXPERIMENTER = 342,
    OF_INSTRUCTION_GOTO_TABLE = 343,
    OF_INSTRUCTION_HEADER = 344,
    OF_INSTRUCTION_ID = 345,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 346,
    OF_INSTRUCTION_ID_BSN = 347,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 348,
    OF_INSTRUCTION_ID_BSN_DENY = 349,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 350,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 351,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 352,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 353,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 354,
    OF_INSTRUCTION_ID_BSN_PERMIT = 355,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 356,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 357,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 358,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 359,
    OF_INSTRUCTION_ID_EXPERIMENTER = 360,
    OF_INSTRUCTION_ID_GOTO_TABLE = 361,
    OF_INSTRUCTION_ID_HEADER = 362,
    OF_INSTRUCTION_ID_METER = 363,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 364,
    OF_INSTRUCTION_ID_WRITE_METADATA = 365,
    OF_INSTRUCTION_METER = 366,
    OF_INSTRUCTION_WRITE_ACTIONS = 367,
    OF_INSTRUCTION_WRITE_METADATA = 368,
    OF_MATCH_V1 = 369,
    OF_MATCH_V2 = 370,
    OF_MATCH_V3 = 371,
    OF_METER_BAND = 372,
    OF_METER_BAND_DROP = 373,
    OF_METER_BAND_DSCP_REMARK = 374,
    OF_METER_BAND_EXPERIMENTER = 375,
    OF_METER_BAND_HEADER = 376,
    OF_METER_BAND_STATS = 377,
    OF_METER_CONFIG = 378,
    OF_METER_FEATURES = 379,
    OF_METER_STATS = 380,
    OF_OXM = 381,
    OF_OXM_ARP_OP = 382,
    OF_OXM_ARP_OP_MASKED = 383,
    OF_OXM_ARP_SHA = 384,
    OF_OXM_ARP_SHA_MASKED = 385,
    OF_OXM_ARP_SPA = 386,
    OF_OXM_ARP_SPA_MASKED = 387,
    OF_OXM_ARP_THA = 388,
    OF_OXM_ARP_THA_MASKED = 389,
    OF_OXM_ARP_TPA = 390,
    OF_OXM_ARP_TPA_MASKED = 391,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 392,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 393,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 394,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 395,
    OF_OXM_BSN_IN_PORTS_128 = 396,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 397,
    OF_OXM_BSN_L3_DST_CLASS_ID = 398,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 399,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 400,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 401,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 402,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 403,
    OF_OXM_BSN_LAG_ID = 404,
    OF_OXM_BSN_LAG_ID_MASKED = 405,
    OF_OXM_BSN_TCP_FLAGS = 406,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 407,
    OF_OXM_BSN_UDF0 = 408,
    OF_OXM_BSN_UDF0_MASKED = 409,
    OF_OXM_BSN_UDF1 = 410,
    OF_OXM_BSN_UDF1_MASKED = 411,
    OF_OXM_BSN_UDF2 = 412,
    OF_OXM_BSN_UDF2_MASKED = 413,
    OF_OXM_BSN_UDF3 = 414,
    OF_OXM_BSN_UDF3_MASKED = 415,
    OF_OXM_BSN_UDF4 = 416,
    OF_OXM_BSN_UDF4_MASKED = 417,
    OF_OXM_BSN_UDF5 = 418,
    OF_OXM_BSN_UDF5_MASKED = 419,
    OF_OXM_BSN_UDF6 = 420,
    OF_OXM_BSN_UDF6_MASKED = 421,
    OF_OXM_BSN_UDF7 = 422,
    OF_OXM_BSN_UDF7_MASKED = 423,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 424,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 425,
    OF_OXM_BSN_VRF = 426,
    OF_OXM_BSN_VRF_MASKED = 427,
    OF_OXM_ETH_DST = 428,
    OF_OXM_ETH_DST_MASKED = 429,
    OF_OXM_ETH_SRC = 430,
    OF_OXM_ETH_SRC_MASKED = 431,
    OF_OXM_ETH_TYPE = 432,
    OF_OXM_ETH_TYPE_MASKED = 433,
    OF_OXM_HEADER = 434,
    OF_OXM_ICMPV4_CODE = 435,
    OF_OXM_ICMPV4_CODE_MASKED = 436,
    OF_OXM_ICMPV4_TYPE = 437,
    OF_OXM_ICMPV4_TYPE_MASKED = 438,
    OF_OXM_ICMPV6_CODE = 439,
    OF_OXM_ICMPV6_CODE_MASKED = 440,
    OF_OXM_ICMPV6_TYPE = 441,
    OF_OXM_ICMPV6_TYPE_MASKED = 442,
    OF_OXM_IN_PHY_PORT = 443,
    OF_OXM_IN_PHY_PORT_MASKED = 444,
    OF_OXM_IN_PORT = 445,
    OF_OXM_IN_PORT_MASKED = 446,
    OF_OXM_IP_DSCP = 447,
    OF_OXM_IP_DSCP_MASKED = 448,
    OF_OXM_IP_ECN = 449,
    OF_OXM_IP_ECN_MASKED = 450,
    OF_OXM_IP_PROTO = 451,
    OF_OXM_IP_PROTO_MASKED = 452,
    OF_OXM_IPV4_DST = 453,
    OF_OXM_IPV4_DST_MASKED = 454,
    OF_OXM_IPV4_SRC = 455,
    OF_OXM_IPV4_SRC_MASKED = 456,
    OF_OXM_IPV6_DST = 457,
    OF_OXM_IPV6_DST_MASKED = 458,
    OF_OXM_IPV6_FLABEL = 459,
    OF_OXM_IPV6_FLABEL_MASKED = 460,
    OF_OXM_IPV6_ND_SLL = 461,
    OF_OXM_IPV6_ND_SLL_MASKED = 462,
    OF_OXM_IPV6_ND_TARGET = 463,
    OF_OXM_IPV6_ND_TARGET_MASKED = 464,
    OF_OXM_IPV6_ND_TLL = 465,
    OF_OXM_IPV6_ND_TLL_MASKED = 466,
    OF_OXM_IPV6_SRC = 467,
    OF_OXM_IPV6_SRC_MASKED = 468,
    OF_OXM_METADATA = 469,
    OF_OXM_METADATA_MASKED = 470,
    OF_OXM_MPLS_BOS = 471,
    OF_OXM_MPLS_BOS_MASKED = 472,
    OF_OXM_MPLS_LABEL = 473,
    OF_OXM_MPLS_LABEL_MASKED = 474,
    OF_OXM_MPLS_TC = 475,
    OF_OXM_MPLS_TC_MASKED = 476,
    OF_OXM_SCTP_DST = 477,
    OF_OXM_SCTP_DST_MASKED = 478,
    OF_OXM_SCTP_SRC = 479,
    OF_OXM_SCTP_SRC_MASKED = 480,
    OF_OXM_TCP_DST = 481,
    OF_OXM_TCP_DST_MASKED = 482,
    OF_OXM_TCP_SRC = 483,
    OF_OXM_TCP_SRC_MASKED = 484,
    OF_OXM_TUNNEL_ID = 485,
    OF_OXM_TUNNEL_ID_MASKED = 486,
    OF_OXM_UDP_DST = 487,
    OF_OXM_UDP_DST_MASKED = 488,
    OF_OXM_UDP_SRC = 489,
    OF_OXM_UDP_SRC_MASKED = 490,
    OF_OXM_VLAN_PCP = 491,
    OF_OXM_VLAN_PCP_MASKED = 492,
    OF_OXM_VLAN_VID = 493,
    OF_OXM_VLAN_VID_MASKED = 494,
    OF_PACKET_QUEUE = 495,
    OF_PORT_DESC = 496,
    OF_PORT_STATS_ENTRY = 497,
    OF_QUEUE_PROP = 498,
    OF_QUEUE_PROP_EXPERIMENTER = 499,
    OF_QUEUE_PROP_HEADER = 500,
    OF_QUEUE_PROP_MAX_RATE = 501,
    OF_QUEUE_PROP_MIN_RATE = 502,
    OF_QUEUE_STATS_ENTRY = 503,
    OF_TABLE_FEATURE_PROP = 504,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 505,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 506,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 507,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 508,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 509,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 510,
    OF_TABLE_FEATURE_PROP_HEADER = 511,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 512,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 513,
    OF_TABLE_FEATURE_PROP_MATCH = 514,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 515,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 516,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 517,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 518,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 519,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 520,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 521,
    OF_TABLE_FEATURES = 522,
    OF_TABLE_STATS_ENTRY = 523,
    OF_UINT32 = 524,
    OF_UINT64 = 525,
    OF_UINT8 = 526,
    ...
    /* List objects */
    OF_LIST_ACTION = 527,
    OF_LIST_ACTION_ID = 528,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 529,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 530,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 531,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 532,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 533,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 534,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 535,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 536,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 537,
    OF_LIST_BSN_INTERFACE = 538,
    OF_LIST_BSN_LACP_STATS_ENTRY = 539,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 540,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 541,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 542,
    OF_LIST_BSN_TLV = 543,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 544,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 545,
    OF_LIST_BUCKET = 546,
    OF_LIST_BUCKET_COUNTER = 547,
    OF_LIST_FLOW_STATS_ENTRY = 548,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 549,
    OF_LIST_GROUP_STATS_ENTRY = 550,
    OF_LIST_HELLO_ELEM = 551,
    OF_LIST_INSTRUCTION = 552,
    OF_LIST_INSTRUCTION_ID = 553,
    OF_LIST_METER_BAND = 554,
    OF_LIST_METER_BAND_STATS = 555,
    OF_LIST_METER_STATS = 556,
    OF_LIST_OXM = 557,
    OF_LIST_PACKET_QUEUE = 558,
    OF_LIST_PORT_DESC = 559,
    OF_LIST_PORT_STATS_ENTRY = 560,
    OF_LIST_QUEUE_PROP = 561,
    OF_LIST_QUEUE_STATS_ENTRY = 562,
    OF_LIST_TABLE_FEATURE_PROP = 563,
    OF_LIST_TABLE_FEATURES = 564,
    OF_LIST_TABLE_STATS_ENTRY = 565,
    OF_LIST_UINT32 = 566,
    OF_LIST_UINT64 = 567,
    OF_LIST_UINT8 = 568,
