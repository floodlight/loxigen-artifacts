...
typedef enum of_object_id_e {
    ...
    OF_ACTION_ID_NICIRA_EXIT = 235,
    OF_ACTION_ID_NICIRA_RESUBMIT = 236,
    OF_ACTION_ID_NICIRA_RESUBMIT_TABLE = 237,
    OF_ACTION_ID_OUTPUT = 238,
    OF_ACTION_ID_POP_MPLS = 239,
    OF_ACTION_ID_POP_PBB = 240,
    OF_ACTION_ID_POP_VLAN = 241,
    OF_ACTION_ID_PUSH_MPLS = 242,
    OF_ACTION_ID_PUSH_PBB = 243,
    OF_ACTION_ID_PUSH_VLAN = 244,
    OF_ACTION_ID_SET_FIELD = 245,
    OF_ACTION_ID_SET_MPLS_TTL = 246,
    OF_ACTION_ID_SET_NW_TTL = 247,
    OF_ACTION_ID_SET_QUEUE = 248,
    OF_ACTION_NICIRA = 249,
    OF_ACTION_NICIRA_DEC_TTL = 250,
    OF_ACTION_NICIRA_EXIT = 251,
    OF_ACTION_NICIRA_RESUBMIT = 252,
    OF_ACTION_NICIRA_RESUBMIT_TABLE = 253,
    OF_ACTION_OUTPUT = 254,
    OF_ACTION_POP_MPLS = 255,
    OF_ACTION_POP_PBB = 256,
    OF_ACTION_POP_VLAN = 257,
    OF_ACTION_PUSH_MPLS = 258,
    OF_ACTION_PUSH_PBB = 259,
    OF_ACTION_PUSH_VLAN = 260,
    OF_ACTION_SET_DL_DST = 261,
    OF_ACTION_SET_DL_SRC = 262,
    OF_ACTION_SET_FIELD = 263,
    OF_ACTION_SET_MPLS_LABEL = 264,
    OF_ACTION_SET_MPLS_TC = 265,
    OF_ACTION_SET_MPLS_TTL = 266,
    OF_ACTION_SET_NW_DST = 267,
    OF_ACTION_SET_NW_ECN = 268,
    OF_ACTION_SET_NW_SRC = 269,
    OF_ACTION_SET_NW_TOS = 270,
    OF_ACTION_SET_NW_TTL = 271,
    OF_ACTION_SET_QUEUE = 272,
    OF_ACTION_SET_TP_DST = 273,
    OF_ACTION_SET_TP_SRC = 274,
    OF_ACTION_SET_VLAN_PCP = 275,
    OF_ACTION_SET_VLAN_VID = 276,
    OF_ACTION_STRIP_VLAN = 277,
    OF_ASYNC_CONFIG_PROP = 278,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_MASTER = 279,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_SLAVE = 280,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_MASTER = 281,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_SLAVE = 282,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_MASTER = 283,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_SLAVE = 284,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_MASTER = 285,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_SLAVE = 286,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_MASTER = 287,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_SLAVE = 288,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_MASTER = 289,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_SLAVE = 290,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_MASTER = 291,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_SLAVE = 292,
    OF_BSN_CONTROLLER_CONNECTION = 293,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 294,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 295,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 296,
    OF_BSN_GENERIC_STATS_ENTRY = 297,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 298,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 299,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 300,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 301,
    OF_BSN_GENTABLE_STATS_ENTRY = 302,
    OF_BSN_INTERFACE = 303,
    OF_BSN_LACP_STATS_ENTRY = 304,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 305,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 306,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 307,
    OF_BSN_TLV = 308,
    OF_BSN_TLV_ACTOR_KEY = 309,
    OF_BSN_TLV_ACTOR_PORT_NUM = 310,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 311,
    OF_BSN_TLV_ACTOR_STATE = 312,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 313,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 314,
    OF_BSN_TLV_ANCHOR = 315,
    OF_BSN_TLV_APPLY_BYTES = 316,
    OF_BSN_TLV_APPLY_PACKETS = 317,
    OF_BSN_TLV_AUTO_NEGOTIATION = 318,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 319,
    OF_BSN_TLV_BROADCAST_RATE = 320,
    OF_BSN_TLV_BUCKET = 321,
    OF_BSN_TLV_CIRCUIT_ID = 322,
    OF_BSN_TLV_CONVERGENCE_STATUS = 323,
    OF_BSN_TLV_CPU_LAG = 324,
    OF_BSN_TLV_CRC_ENABLED = 325,
    OF_BSN_TLV_DATA = 326,
    OF_BSN_TLV_DATA_MASK = 327,
    OF_BSN_TLV_DECAP = 328,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 329,
    OF_BSN_TLV_DROP = 330,
    OF_BSN_TLV_DSCP = 331,
    OF_BSN_TLV_ECN = 332,
    OF_BSN_TLV_EGRESS_ONLY = 333,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 334,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 335,
    OF_BSN_TLV_ETH_DST = 336,
    OF_BSN_TLV_ETH_SRC = 337,
    OF_BSN_TLV_ETH_TYPE = 338,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 339,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 340,
    OF_BSN_TLV_EXTERNAL_IP = 341,
    OF_BSN_TLV_EXTERNAL_MAC = 342,
    OF_BSN_TLV_EXTERNAL_NETMASK = 343,
    OF_BSN_TLV_FABRIC_PORT_ROLE = 344,
    OF_BSN_TLV_FLOOD = 345,
    OF_BSN_TLV_FORCE_LINK_UP = 346,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 347,
    OF_BSN_TLV_GENERATION_ID = 348,
    OF_BSN_TLV_HASH_ALGORITHM = 349,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 350,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 351,
    OF_BSN_TLV_HASH_PACKET_FIELD = 352,
    OF_BSN_TLV_HASH_PACKET_TYPE = 353,
    OF_BSN_TLV_HASH_SEED = 354,
    OF_BSN_TLV_HASH_TYPE = 355,
    OF_BSN_TLV_HEADER_SIZE = 356,
    OF_BSN_TLV_ICMP_CODE = 357,
    OF_BSN_TLV_ICMP_ID = 358,
    OF_BSN_TLV_ICMP_TYPE = 359,
    OF_BSN_TLV_ICMPV6_CHKSUM = 360,
    OF_BSN_TLV_IDLE_NOTIFICATION = 361,
    OF_BSN_TLV_IDLE_TIME = 362,
    OF_BSN_TLV_IDLE_TIMEOUT = 363,
    OF_BSN_TLV_IGMP_SNOOPING = 364,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 365,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 366,
    OF_BSN_TLV_INTERNAL_MAC = 367,
    OF_BSN_TLV_INTERVAL = 368,
    OF_BSN_TLV_IP_PROTO = 369,
    OF_BSN_TLV_IPV4 = 370,
    OF_BSN_TLV_IPV4_DST = 371,
    OF_BSN_TLV_IPV4_NETMASK = 372,
    OF_BSN_TLV_IPV4_SRC = 373,
    OF_BSN_TLV_IPV6 = 374,
    OF_BSN_TLV_IPV6_DST = 375,
    OF_BSN_TLV_IPV6_PREFIX = 376,
    OF_BSN_TLV_IPV6_SRC = 377,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 378,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 379,
    OF_BSN_TLV_L3_DST_CLASS_ID = 380,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 381,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 382,
    OF_BSN_TLV_LAG_OPTIONS = 383,
    OF_BSN_TLV_LOOPBACK_MODE = 384,
    OF_BSN_TLV_LOOPBACK_PORT = 385,
    OF_BSN_TLV_MAC = 386,
    OF_BSN_TLV_MAC_MASK = 387,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 388,
    OF_BSN_TLV_MISS_PACKETS = 389,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 390,
    OF_BSN_TLV_MPLS_LABEL = 391,
    OF_BSN_TLV_MPLS_SEQUENCED = 392,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 393,
    OF_BSN_TLV_NAME = 394,
    OF_BSN_TLV_NDP_OFFLOAD = 395,
    OF_BSN_TLV_NDP_STATIC = 396,
    OF_BSN_TLV_NEGATE = 397,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 398,
    OF_BSN_TLV_NEXT_HOP_MAC = 399,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 400,
    OF_BSN_TLV_NO_ARP_RESPONSE = 401,
    OF_BSN_TLV_NO_NS_RESPONSE = 402,
    OF_BSN_TLV_OFFSET = 403,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 404,
    OF_BSN_TLV_OUTER_SRC_MAC = 405,
    OF_BSN_TLV_PARENT_PORT = 406,
    OF_BSN_TLV_PARTNER_KEY = 407,
    OF_BSN_TLV_PARTNER_PORT_NUM = 408,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 409,
    OF_BSN_TLV_PARTNER_STATE = 410,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 411,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 412,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 413,
    OF_BSN_TLV_PORT = 414,
    OF_BSN_TLV_PORT_SPEED_GBPS = 415,
    OF_BSN_TLV_PORT_USAGE = 416,
    OF_BSN_TLV_PORT_VXLAN_MODE = 417,
    OF_BSN_TLV_PRIORITY = 418,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 419,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 420,
    OF_BSN_TLV_QOS_PRIORITY = 421,
    OF_BSN_TLV_QUEUE_ID = 422,
    OF_BSN_TLV_QUEUE_WEIGHT = 423,
    OF_BSN_TLV_RATE_LIMIT = 424,
    OF_BSN_TLV_RATE_UNIT = 425,
    OF_BSN_TLV_RECORD_PACKETS = 426,
    OF_BSN_TLV_REFERENCE = 427,
    OF_BSN_TLV_REPLY_PACKETS = 428,
    OF_BSN_TLV_REQUEST_PACKETS = 429,
    OF_BSN_TLV_REST_SERVER = 430,
    OF_BSN_TLV_ROUTING_PARAM = 431,
    OF_BSN_TLV_RX_BYTES = 432,
    OF_BSN_TLV_RX_PACKETS = 433,
    OF_BSN_TLV_SAMPLING_RATE = 434,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 435,
    OF_BSN_TLV_STATUS = 436,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 437,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 438,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 439,
    OF_BSN_TLV_SUB_AGENT_ID = 440,
    OF_BSN_TLV_TCP_DST = 441,
    OF_BSN_TLV_TCP_FLAGS = 442,
    OF_BSN_TLV_TCP_SRC = 443,
    OF_BSN_TLV_TIMESTAMP = 444,
    OF_BSN_TLV_TTL = 445,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 446,
    OF_BSN_TLV_TX_BYTES = 447,
    OF_BSN_TLV_TX_PACKETS = 448,
    OF_BSN_TLV_UDF_ANCHOR = 449,
    OF_BSN_TLV_UDF_ID = 450,
    OF_BSN_TLV_UDF_LENGTH = 451,
    OF_BSN_TLV_UDF_OFFSET = 452,
    OF_BSN_TLV_UDP_DST = 453,
    OF_BSN_TLV_UDP_SRC = 454,
    OF_BSN_TLV_UINT64_LIST = 455,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 456,
    OF_BSN_TLV_UNICAST_RATE = 457,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 458,
    OF_BSN_TLV_UNTAGGED = 459,
    OF_BSN_TLV_UPGRADE = 460,
    OF_BSN_TLV_URI_SCHEME = 461,
    OF_BSN_TLV_USE_PACKET_STATE = 462,
    OF_BSN_TLV_VFI = 463,
    OF_BSN_TLV_VFP_CLASS_ID = 464,
    OF_BSN_TLV_VIRTUAL = 465,
    OF_BSN_TLV_VLAN_MAC_LIST = 466,
    OF_BSN_TLV_VLAN_PCP = 467,
    OF_BSN_TLV_VLAN_VID = 468,
    OF_BSN_TLV_VLAN_VID_MASK = 469,
    OF_BSN_TLV_VNI = 470,
    OF_BSN_TLV_VPN_KEY = 471,
    OF_BSN_TLV_VRF = 472,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 473,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 474,
    OF_BSN_VLAN_MAC = 475,
    OF_BSN_VPORT = 476,
    OF_BSN_VPORT_L2GRE = 477,
    OF_BSN_VPORT_Q_IN_Q = 478,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 479,
    OF_BUCKET = 480,
    OF_BUCKET_COUNTER = 481,
    OF_BUNDLE_PROP = 482,
    OF_BUNDLE_PROP_EXPERIMENTER = 483,
    OF_FLOW_STATS_ENTRY = 484,
    OF_GROUP_DESC_STATS_ENTRY = 485,
    OF_GROUP_STATS_ENTRY = 486,
    OF_HELLO_ELEM = 487,
    OF_HELLO_ELEM_VERSIONBITMAP = 488,
    OF_INSTRUCTION = 489,
    OF_INSTRUCTION_APPLY_ACTIONS = 490,
    OF_INSTRUCTION_BSN = 491,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 492,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 493,
    OF_INSTRUCTION_BSN_DENY = 494,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 495,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 496,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 497,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 498,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 499,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 500,
    OF_INSTRUCTION_BSN_HASH_SELECT = 501,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 502,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 503,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 504,
    OF_INSTRUCTION_BSN_PERMIT = 505,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 506,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 507,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 508,
    OF_INSTRUCTION_CLEAR_ACTIONS = 509,
    OF_INSTRUCTION_EXPERIMENTER = 510,
    OF_INSTRUCTION_GOTO_TABLE = 511,
    OF_INSTRUCTION_ID = 512,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 513,
    OF_INSTRUCTION_ID_BSN = 514,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 515,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 516,
    OF_INSTRUCTION_ID_BSN_DENY = 517,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 518,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 519,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 520,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 521,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 522,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 523,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 524,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 525,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 526,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 527,
    OF_INSTRUCTION_ID_BSN_PERMIT = 528,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 529,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 530,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 531,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 532,
    OF_INSTRUCTION_ID_EXPERIMENTER = 533,
    OF_INSTRUCTION_ID_GOTO_TABLE = 534,
    OF_INSTRUCTION_ID_METER = 535,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 536,
    OF_INSTRUCTION_ID_WRITE_METADATA = 537,
    OF_INSTRUCTION_METER = 538,
    OF_INSTRUCTION_WRITE_ACTIONS = 539,
    OF_INSTRUCTION_WRITE_METADATA = 540,
    OF_MATCH_V1 = 541,
    OF_MATCH_V2 = 542,
    OF_MATCH_V3 = 543,
    OF_METER_BAND = 544,
    OF_METER_BAND_DROP = 545,
    OF_METER_BAND_DSCP_REMARK = 546,
    OF_METER_BAND_EXPERIMENTER = 547,
    OF_METER_BAND_STATS = 548,
    OF_METER_CONFIG = 549,
    OF_METER_FEATURES = 550,
    OF_METER_STATS = 551,
    OF_OXM = 552,
    OF_OXM_ARP_OP = 553,
    OF_OXM_ARP_OP_MASKED = 554,
    OF_OXM_ARP_SHA = 555,
    OF_OXM_ARP_SHA_MASKED = 556,
    OF_OXM_ARP_SPA = 557,
    OF_OXM_ARP_SPA_MASKED = 558,
    OF_OXM_ARP_THA = 559,
    OF_OXM_ARP_THA_MASKED = 560,
    OF_OXM_ARP_TPA = 561,
    OF_OXM_ARP_TPA_MASKED = 562,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 563,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 564,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 565,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 566,
    OF_OXM_BSN_IFP_CLASS_ID = 567,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 568,
    OF_OXM_BSN_IN_PORTS_128 = 569,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 570,
    OF_OXM_BSN_IN_PORTS_512 = 571,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 572,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 573,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 574,
    OF_OXM_BSN_INNER_ETH_DST = 575,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 576,
    OF_OXM_BSN_INNER_ETH_SRC = 577,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 578,
    OF_OXM_BSN_INNER_VLAN_VID = 579,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 580,
    OF_OXM_BSN_IP_FRAGMENTATION = 581,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 582,
    OF_OXM_BSN_L2_CACHE_HIT = 583,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 584,
    OF_OXM_BSN_L3_DST_CLASS_ID = 585,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 586,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 587,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 588,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 589,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 590,
    OF_OXM_BSN_LAG_ID = 591,
    OF_OXM_BSN_LAG_ID_MASKED = 592,
    OF_OXM_BSN_TCP_FLAGS = 593,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 594,
    OF_OXM_BSN_UDF0 = 595,
    OF_OXM_BSN_UDF0_MASKED = 596,
    OF_OXM_BSN_UDF1 = 597,
    OF_OXM_BSN_UDF1_MASKED = 598,
    OF_OXM_BSN_UDF2 = 599,
    OF_OXM_BSN_UDF2_MASKED = 600,
    OF_OXM_BSN_UDF3 = 601,
    OF_OXM_BSN_UDF3_MASKED = 602,
    OF_OXM_BSN_UDF4 = 603,
    OF_OXM_BSN_UDF4_MASKED = 604,
    OF_OXM_BSN_UDF5 = 605,
    OF_OXM_BSN_UDF5_MASKED = 606,
    OF_OXM_BSN_UDF6 = 607,
    OF_OXM_BSN_UDF6_MASKED = 608,
    OF_OXM_BSN_UDF7 = 609,
    OF_OXM_BSN_UDF7_MASKED = 610,
    OF_OXM_BSN_VFI = 611,
    OF_OXM_BSN_VFI_MASKED = 612,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 613,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 614,
    OF_OXM_BSN_VRF = 615,
    OF_OXM_BSN_VRF_MASKED = 616,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 617,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 618,
    OF_OXM_CONN_TRACKING_IPV6_DST = 619,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 620,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 621,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 622,
    OF_OXM_CONN_TRACKING_LABEL = 623,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 624,
    OF_OXM_CONN_TRACKING_MARK = 625,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 626,
    OF_OXM_CONN_TRACKING_NW_DST = 627,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 628,
    OF_OXM_CONN_TRACKING_NW_PROTO = 629,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 630,
    OF_OXM_CONN_TRACKING_NW_SRC = 631,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 632,
    OF_OXM_CONN_TRACKING_STATE = 633,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 634,
    OF_OXM_CONN_TRACKING_TP_DST = 635,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 636,
    OF_OXM_CONN_TRACKING_TP_SRC = 637,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 638,
    OF_OXM_CONN_TRACKING_ZONE = 639,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 640,
    OF_OXM_ETH_DST = 641,
    OF_OXM_ETH_DST_MASKED = 642,
    OF_OXM_ETH_SRC = 643,
    OF_OXM_ETH_SRC_MASKED = 644,
    OF_OXM_ETH_TYPE = 645,
    OF_OXM_ETH_TYPE_MASKED = 646,
    OF_OXM_ICMPV4_CODE = 647,
    OF_OXM_ICMPV4_CODE_MASKED = 648,
    OF_OXM_ICMPV4_TYPE = 649,
    OF_OXM_ICMPV4_TYPE_MASKED = 650,
    OF_OXM_ICMPV6_CODE = 651,
    OF_OXM_ICMPV6_CODE_MASKED = 652,
    OF_OXM_ICMPV6_TYPE = 653,
    OF_OXM_ICMPV6_TYPE_MASKED = 654,
    OF_OXM_IN_PHY_PORT = 655,
    OF_OXM_IN_PHY_PORT_MASKED = 656,
    OF_OXM_IN_PORT = 657,
    OF_OXM_IN_PORT_MASKED = 658,
    OF_OXM_IP_DSCP = 659,
    OF_OXM_IP_DSCP_MASKED = 660,
    OF_OXM_IP_ECN = 661,
    OF_OXM_IP_ECN_MASKED = 662,
    OF_OXM_IP_PROTO = 663,
    OF_OXM_IP_PROTO_MASKED = 664,
    OF_OXM_IPV4_DST = 665,
    OF_OXM_IPV4_DST_MASKED = 666,
    OF_OXM_IPV4_SRC = 667,
    OF_OXM_IPV4_SRC_MASKED = 668,
    OF_OXM_IPV6_DST = 669,
    OF_OXM_IPV6_DST_MASKED = 670,
    OF_OXM_IPV6_EXTHDR = 671,
    OF_OXM_IPV6_EXTHDR_MASKED = 672,
    OF_OXM_IPV6_FLABEL = 673,
    OF_OXM_IPV6_FLABEL_MASKED = 674,
    OF_OXM_IPV6_ND_SLL = 675,
    OF_OXM_IPV6_ND_SLL_MASKED = 676,
    OF_OXM_IPV6_ND_TARGET = 677,
    OF_OXM_IPV6_ND_TARGET_MASKED = 678,
    OF_OXM_IPV6_ND_TLL = 679,
    OF_OXM_IPV6_ND_TLL_MASKED = 680,
    OF_OXM_IPV6_SRC = 681,
    OF_OXM_IPV6_SRC_MASKED = 682,
    OF_OXM_METADATA = 683,
    OF_OXM_METADATA_MASKED = 684,
    OF_OXM_MPLS_BOS = 685,
    OF_OXM_MPLS_BOS_MASKED = 686,
    OF_OXM_MPLS_LABEL = 687,
    OF_OXM_MPLS_LABEL_MASKED = 688,
    OF_OXM_MPLS_TC = 689,
    OF_OXM_MPLS_TC_MASKED = 690,
    OF_OXM_OVS_TCP_FLAGS = 691,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 692,
    OF_OXM_PBB_UCA = 693,
    OF_OXM_PBB_UCA_MASKED = 694,
    OF_OXM_SCTP_DST = 695,
    OF_OXM_SCTP_DST_MASKED = 696,
    OF_OXM_SCTP_SRC = 697,
    OF_OXM_SCTP_SRC_MASKED = 698,
    OF_OXM_TCP_DST = 699,
    OF_OXM_TCP_DST_MASKED = 700,
    OF_OXM_TCP_SRC = 701,
    OF_OXM_TCP_SRC_MASKED = 702,
    OF_OXM_TUNNEL_ID = 703,
    OF_OXM_TUNNEL_ID_MASKED = 704,
    OF_OXM_TUNNEL_IPV4_DST = 705,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 706,
    OF_OXM_TUNNEL_IPV4_SRC = 707,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 708,
    OF_OXM_UDP_DST = 709,
    OF_OXM_UDP_DST_MASKED = 710,
    OF_OXM_UDP_SRC = 711,
    OF_OXM_UDP_SRC_MASKED = 712,
    OF_OXM_VLAN_PCP = 713,
    OF_OXM_VLAN_PCP_MASKED = 714,
    OF_OXM_VLAN_VID = 715,
    OF_OXM_VLAN_VID_MASKED = 716,
    OF_PACKET_QUEUE = 717,
    OF_PORT_DESC = 718,
    OF_PORT_DESC_PROP = 719,
    OF_PORT_DESC_PROP_BSN = 720,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 721,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 722,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 723,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 724,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 725,
    OF_PORT_DESC_PROP_BSN_UPLINK = 726,
    OF_PORT_DESC_PROP_ETHERNET = 727,
    OF_PORT_DESC_PROP_EXPERIMENTER = 728,
    OF_PORT_DESC_PROP_OPTICAL = 729,
    OF_PORT_MOD_PROP = 730,
    OF_PORT_MOD_PROP_ETHERNET = 731,
    OF_PORT_MOD_PROP_EXPERIMENTER = 732,
    OF_PORT_MOD_PROP_OPTICAL = 733,
    OF_PORT_STATS_ENTRY = 734,
    OF_PORT_STATS_PROP = 735,
    OF_PORT_STATS_PROP_ETHERNET = 736,
    OF_PORT_STATS_PROP_EXPERIMENTER = 737,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 738,
    OF_PORT_STATS_PROP_OPTICAL = 739,
    OF_QUEUE_DESC = 740,
    OF_QUEUE_DESC_PROP = 741,
    OF_QUEUE_DESC_PROP_BSN = 742,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 743,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 744,
    OF_QUEUE_DESC_PROP_MAX_RATE = 745,
    OF_QUEUE_DESC_PROP_MIN_RATE = 746,
    OF_QUEUE_PROP = 747,
    OF_QUEUE_PROP_EXPERIMENTER = 748,
    OF_QUEUE_PROP_MAX_RATE = 749,
    OF_QUEUE_PROP_MIN_RATE = 750,
    OF_QUEUE_STATS_ENTRY = 751,
    OF_QUEUE_STATS_PROP = 752,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 753,
    OF_ROLE_PROP = 754,
    OF_ROLE_PROP_EXPERIMENTER = 755,
    OF_TABLE_DESC = 756,
    OF_TABLE_FEATURE_PROP = 757,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 758,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 759,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 760,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 761,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 762,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 763,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 764,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 765,
    OF_TABLE_FEATURE_PROP_MATCH = 766,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 767,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 768,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 769,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 770,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 771,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 772,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 773,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 774,
    OF_TABLE_FEATURES = 775,
    OF_TABLE_MOD_PROP = 776,
    OF_TABLE_MOD_PROP_EVICTION = 777,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 778,
    OF_TABLE_MOD_PROP_VACANCY = 779,
    OF_TABLE_STATS_ENTRY = 780,
    OF_UINT32 = 781,
    OF_UINT64 = 782,
    OF_UINT8 = 783,
    ...
    /* List objects */
    OF_LIST_ACTION = 784,
    OF_LIST_ACTION_ID = 785,
    OF_LIST_ASYNC_CONFIG_PROP = 786,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 787,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 788,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 789,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 790,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 791,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 792,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 793,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 794,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 795,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 796,
    OF_LIST_BSN_INTERFACE = 797,
    OF_LIST_BSN_LACP_STATS_ENTRY = 798,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 799,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 800,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 801,
    OF_LIST_BSN_TLV = 802,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 803,
    OF_LIST_BSN_VLAN_MAC = 804,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 805,
    OF_LIST_BUCKET = 806,
    OF_LIST_BUCKET_COUNTER = 807,
    OF_LIST_BUNDLE_PROP = 808,
    OF_LIST_FLOW_STATS_ENTRY = 809,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 810,
    OF_LIST_GROUP_STATS_ENTRY = 811,
    OF_LIST_HELLO_ELEM = 812,
    OF_LIST_INSTRUCTION = 813,
    OF_LIST_INSTRUCTION_ID = 814,
    OF_LIST_METER_BAND = 815,
    OF_LIST_METER_BAND_STATS = 816,
    OF_LIST_METER_CONFIG = 817,
    OF_LIST_METER_STATS = 818,
    OF_LIST_OXM = 819,
    OF_LIST_PACKET_QUEUE = 820,
    OF_LIST_PORT_DESC = 821,
    OF_LIST_PORT_DESC_PROP = 822,
    OF_LIST_PORT_MOD_PROP = 823,
    OF_LIST_PORT_STATS_ENTRY = 824,
    OF_LIST_PORT_STATS_PROP = 825,
    OF_LIST_QUEUE_DESC = 826,
    OF_LIST_QUEUE_DESC_PROP = 827,
    OF_LIST_QUEUE_PROP = 828,
    OF_LIST_QUEUE_STATS_ENTRY = 829,
    OF_LIST_QUEUE_STATS_PROP = 830,
    OF_LIST_ROLE_PROP = 831,
    OF_LIST_TABLE_DESC = 832,
    OF_LIST_TABLE_FEATURE_PROP = 833,
    OF_LIST_TABLE_FEATURES = 834,
    OF_LIST_TABLE_MOD_PROP = 835,
    OF_LIST_TABLE_STATS_ENTRY = 836,
    OF_LIST_UINT32 = 837,
    OF_LIST_UINT64 = 838,
    OF_LIST_UINT8 = 839,
