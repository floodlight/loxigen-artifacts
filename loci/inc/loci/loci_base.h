...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV = 260,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 261,
    OF_BSN_TLV_CIRCUIT_ID = 262,
    OF_BSN_TLV_CONVERGENCE_STATUS = 263,
    OF_BSN_TLV_CRC_ENABLED = 264,
    OF_BSN_TLV_ETH_DST = 265,
    OF_BSN_TLV_ETH_SRC = 266,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 267,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 268,
    OF_BSN_TLV_EXTERNAL_IP = 269,
    OF_BSN_TLV_EXTERNAL_MAC = 270,
    OF_BSN_TLV_EXTERNAL_NETMASK = 271,
    OF_BSN_TLV_HEADER = 272,
    OF_BSN_TLV_HEADER_SIZE = 273,
    OF_BSN_TLV_IDLE_NOTIFICATION = 274,
    OF_BSN_TLV_IDLE_TIME = 275,
    OF_BSN_TLV_IDLE_TIMEOUT = 276,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 277,
    OF_BSN_TLV_INTERNAL_MAC = 278,
    OF_BSN_TLV_IPV4 = 279,
    OF_BSN_TLV_IPV4_DST = 280,
    OF_BSN_TLV_IPV4_SRC = 281,
    OF_BSN_TLV_MAC = 282,
    OF_BSN_TLV_MISS_PACKETS = 283,
    OF_BSN_TLV_PORT = 284,
    OF_BSN_TLV_PORT_KEY = 285,
    OF_BSN_TLV_PORT_NUM = 286,
    OF_BSN_TLV_PORT_PRIORITY = 287,
    OF_BSN_TLV_QUEUE_ID = 288,
    OF_BSN_TLV_QUEUE_WEIGHT = 289,
    OF_BSN_TLV_REPLY_PACKETS = 290,
    OF_BSN_TLV_REQUEST_PACKETS = 291,
    OF_BSN_TLV_RX_PACKETS = 292,
    OF_BSN_TLV_SAMPLING_RATE = 293,
    OF_BSN_TLV_SUB_AGENT_ID = 294,
    OF_BSN_TLV_SYSTEM_MAC = 295,
    OF_BSN_TLV_SYSTEM_PRIORITY = 296,
    OF_BSN_TLV_TX_BYTES = 297,
    OF_BSN_TLV_TX_PACKETS = 298,
    OF_BSN_TLV_UDF_ANCHOR = 299,
    OF_BSN_TLV_UDF_ID = 300,
    OF_BSN_TLV_UDF_LENGTH = 301,
    OF_BSN_TLV_UDF_OFFSET = 302,
    OF_BSN_TLV_UDP_DST = 303,
    OF_BSN_TLV_UDP_SRC = 304,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 305,
    OF_BSN_TLV_VLAN_VID = 306,
    OF_BSN_TLV_VRF = 307,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 308,
    OF_BSN_VPORT = 309,
    OF_BSN_VPORT_HEADER = 310,
    OF_BSN_VPORT_L2GRE = 311,
    OF_BSN_VPORT_Q_IN_Q = 312,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 313,
    OF_BUCKET = 314,
    OF_BUCKET_COUNTER = 315,
    OF_FLOW_STATS_ENTRY = 316,
    OF_GROUP_DESC_STATS_ENTRY = 317,
    OF_GROUP_STATS_ENTRY = 318,
    OF_HELLO_ELEM = 319,
    OF_HELLO_ELEM_HEADER = 320,
    OF_HELLO_ELEM_VERSIONBITMAP = 321,
    OF_INSTRUCTION = 322,
    OF_INSTRUCTION_APPLY_ACTIONS = 323,
    OF_INSTRUCTION_BSN = 324,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 325,
    OF_INSTRUCTION_BSN_DENY = 326,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 327,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 328,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 329,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 330,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 331,
    OF_INSTRUCTION_BSN_PERMIT = 332,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 333,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 334,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 335,
    OF_INSTRUCTION_CLEAR_ACTIONS = 336,
    OF_INSTRUCTION_EXPERIMENTER = 337,
    OF_INSTRUCTION_GOTO_TABLE = 338,
    OF_INSTRUCTION_HEADER = 339,
    OF_INSTRUCTION_ID = 340,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 341,
    OF_INSTRUCTION_ID_BSN = 342,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 343,
    OF_INSTRUCTION_ID_BSN_DENY = 344,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 345,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 346,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 347,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 348,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 349,
    OF_INSTRUCTION_ID_BSN_PERMIT = 350,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 351,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 352,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 353,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 354,
    OF_INSTRUCTION_ID_EXPERIMENTER = 355,
    OF_INSTRUCTION_ID_GOTO_TABLE = 356,
    OF_INSTRUCTION_ID_HEADER = 357,
    OF_INSTRUCTION_ID_METER = 358,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 359,
    OF_INSTRUCTION_ID_WRITE_METADATA = 360,
    OF_INSTRUCTION_METER = 361,
    OF_INSTRUCTION_WRITE_ACTIONS = 362,
    OF_INSTRUCTION_WRITE_METADATA = 363,
    OF_MATCH_V1 = 364,
    OF_MATCH_V2 = 365,
    OF_MATCH_V3 = 366,
    OF_METER_BAND = 367,
    OF_METER_BAND_DROP = 368,
    OF_METER_BAND_DSCP_REMARK = 369,
    OF_METER_BAND_EXPERIMENTER = 370,
    OF_METER_BAND_HEADER = 371,
    OF_METER_BAND_STATS = 372,
    OF_METER_CONFIG = 373,
    OF_METER_FEATURES = 374,
    OF_METER_STATS = 375,
    OF_OXM = 376,
    OF_OXM_ARP_OP = 377,
    OF_OXM_ARP_OP_MASKED = 378,
    OF_OXM_ARP_SHA = 379,
    OF_OXM_ARP_SHA_MASKED = 380,
    OF_OXM_ARP_SPA = 381,
    OF_OXM_ARP_SPA_MASKED = 382,
    OF_OXM_ARP_THA = 383,
    OF_OXM_ARP_THA_MASKED = 384,
    OF_OXM_ARP_TPA = 385,
    OF_OXM_ARP_TPA_MASKED = 386,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 387,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 388,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 389,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 390,
    OF_OXM_BSN_IN_PORTS_128 = 391,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 392,
    OF_OXM_BSN_L3_DST_CLASS_ID = 393,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 394,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 395,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 396,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 397,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 398,
    OF_OXM_BSN_LAG_ID = 399,
    OF_OXM_BSN_LAG_ID_MASKED = 400,
    OF_OXM_BSN_TCP_FLAGS = 401,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 402,
    OF_OXM_BSN_UDF0 = 403,
    OF_OXM_BSN_UDF0_MASKED = 404,
    OF_OXM_BSN_UDF1 = 405,
    OF_OXM_BSN_UDF1_MASKED = 406,
    OF_OXM_BSN_UDF2 = 407,
    OF_OXM_BSN_UDF2_MASKED = 408,
    OF_OXM_BSN_UDF3 = 409,
    OF_OXM_BSN_UDF3_MASKED = 410,
    OF_OXM_BSN_UDF4 = 411,
    OF_OXM_BSN_UDF4_MASKED = 412,
    OF_OXM_BSN_UDF5 = 413,
    OF_OXM_BSN_UDF5_MASKED = 414,
    OF_OXM_BSN_UDF6 = 415,
    OF_OXM_BSN_UDF6_MASKED = 416,
    OF_OXM_BSN_UDF7 = 417,
    OF_OXM_BSN_UDF7_MASKED = 418,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 419,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 420,
    OF_OXM_BSN_VRF = 421,
    OF_OXM_BSN_VRF_MASKED = 422,
    OF_OXM_ETH_DST = 423,
    OF_OXM_ETH_DST_MASKED = 424,
    OF_OXM_ETH_SRC = 425,
    OF_OXM_ETH_SRC_MASKED = 426,
    OF_OXM_ETH_TYPE = 427,
    OF_OXM_ETH_TYPE_MASKED = 428,
    OF_OXM_HEADER = 429,
    OF_OXM_ICMPV4_CODE = 430,
    OF_OXM_ICMPV4_CODE_MASKED = 431,
    OF_OXM_ICMPV4_TYPE = 432,
    OF_OXM_ICMPV4_TYPE_MASKED = 433,
    OF_OXM_ICMPV6_CODE = 434,
    OF_OXM_ICMPV6_CODE_MASKED = 435,
    OF_OXM_ICMPV6_TYPE = 436,
    OF_OXM_ICMPV6_TYPE_MASKED = 437,
    OF_OXM_IN_PHY_PORT = 438,
    OF_OXM_IN_PHY_PORT_MASKED = 439,
    OF_OXM_IN_PORT = 440,
    OF_OXM_IN_PORT_MASKED = 441,
    OF_OXM_IP_DSCP = 442,
    OF_OXM_IP_DSCP_MASKED = 443,
    OF_OXM_IP_ECN = 444,
    OF_OXM_IP_ECN_MASKED = 445,
    OF_OXM_IP_PROTO = 446,
    OF_OXM_IP_PROTO_MASKED = 447,
    OF_OXM_IPV4_DST = 448,
    OF_OXM_IPV4_DST_MASKED = 449,
    OF_OXM_IPV4_SRC = 450,
    OF_OXM_IPV4_SRC_MASKED = 451,
    OF_OXM_IPV6_DST = 452,
    OF_OXM_IPV6_DST_MASKED = 453,
    OF_OXM_IPV6_FLABEL = 454,
    OF_OXM_IPV6_FLABEL_MASKED = 455,
    OF_OXM_IPV6_ND_SLL = 456,
    OF_OXM_IPV6_ND_SLL_MASKED = 457,
    OF_OXM_IPV6_ND_TARGET = 458,
    OF_OXM_IPV6_ND_TARGET_MASKED = 459,
    OF_OXM_IPV6_ND_TLL = 460,
    OF_OXM_IPV6_ND_TLL_MASKED = 461,
    OF_OXM_IPV6_SRC = 462,
    OF_OXM_IPV6_SRC_MASKED = 463,
    OF_OXM_METADATA = 464,
    OF_OXM_METADATA_MASKED = 465,
    OF_OXM_MPLS_BOS = 466,
    OF_OXM_MPLS_BOS_MASKED = 467,
    OF_OXM_MPLS_LABEL = 468,
    OF_OXM_MPLS_LABEL_MASKED = 469,
    OF_OXM_MPLS_TC = 470,
    OF_OXM_MPLS_TC_MASKED = 471,
    OF_OXM_SCTP_DST = 472,
    OF_OXM_SCTP_DST_MASKED = 473,
    OF_OXM_SCTP_SRC = 474,
    OF_OXM_SCTP_SRC_MASKED = 475,
    OF_OXM_TCP_DST = 476,
    OF_OXM_TCP_DST_MASKED = 477,
    OF_OXM_TCP_SRC = 478,
    OF_OXM_TCP_SRC_MASKED = 479,
    OF_OXM_TUNNEL_ID = 480,
    OF_OXM_TUNNEL_ID_MASKED = 481,
    OF_OXM_UDP_DST = 482,
    OF_OXM_UDP_DST_MASKED = 483,
    OF_OXM_UDP_SRC = 484,
    OF_OXM_UDP_SRC_MASKED = 485,
    OF_OXM_VLAN_PCP = 486,
    OF_OXM_VLAN_PCP_MASKED = 487,
    OF_OXM_VLAN_VID = 488,
    OF_OXM_VLAN_VID_MASKED = 489,
    OF_PACKET_QUEUE = 490,
    OF_PORT_DESC = 491,
    OF_PORT_STATS_ENTRY = 492,
    OF_QUEUE_PROP = 493,
    OF_QUEUE_PROP_EXPERIMENTER = 494,
    OF_QUEUE_PROP_HEADER = 495,
    OF_QUEUE_PROP_MAX_RATE = 496,
    OF_QUEUE_PROP_MIN_RATE = 497,
    OF_QUEUE_STATS_ENTRY = 498,
    OF_TABLE_FEATURE_PROP = 499,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 500,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 501,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 502,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 503,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 504,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 505,
    OF_TABLE_FEATURE_PROP_HEADER = 506,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 507,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 508,
    OF_TABLE_FEATURE_PROP_MATCH = 509,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 510,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 511,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 512,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 513,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 514,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 515,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 516,
    OF_TABLE_FEATURES = 517,
    OF_TABLE_STATS_ENTRY = 518,
    OF_UINT32 = 519,
    OF_UINT64 = 520,
    OF_UINT8 = 521,
    ...
    /* List objects */
    OF_LIST_ACTION = 522,
    OF_LIST_ACTION_ID = 523,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 524,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 525,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 526,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 527,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 528,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 529,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 530,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 531,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 532,
    OF_LIST_BSN_INTERFACE = 533,
    OF_LIST_BSN_LACP_STATS_ENTRY = 534,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 535,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 536,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 537,
    OF_LIST_BSN_TLV = 538,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 539,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 540,
    OF_LIST_BUCKET = 541,
    OF_LIST_BUCKET_COUNTER = 542,
    OF_LIST_FLOW_STATS_ENTRY = 543,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 544,
    OF_LIST_GROUP_STATS_ENTRY = 545,
    OF_LIST_HELLO_ELEM = 546,
    OF_LIST_INSTRUCTION = 547,
    OF_LIST_INSTRUCTION_ID = 548,
    OF_LIST_METER_BAND = 549,
    OF_LIST_METER_BAND_STATS = 550,
    OF_LIST_METER_STATS = 551,
    OF_LIST_OXM = 552,
    OF_LIST_PACKET_QUEUE = 553,
    OF_LIST_PORT_DESC = 554,
    OF_LIST_PORT_STATS_ENTRY = 555,
    OF_LIST_QUEUE_PROP = 556,
    OF_LIST_QUEUE_STATS_ENTRY = 557,
    OF_LIST_TABLE_FEATURE_PROP = 558,
    OF_LIST_TABLE_FEATURES = 559,
    OF_LIST_TABLE_STATS_ENTRY = 560,
    OF_LIST_UINT32 = 561,
    OF_LIST_UINT64 = 562,
    OF_LIST_UINT8 = 563,
