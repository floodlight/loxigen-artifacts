...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_CRC_ENABLED = 314,
    OF_BSN_TLV_DATA = 315,
    OF_BSN_TLV_DECAP = 316,
    OF_BSN_TLV_DSCP = 317,
    OF_BSN_TLV_ETH_DST = 318,
    OF_BSN_TLV_ETH_SRC = 319,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 320,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 321,
    OF_BSN_TLV_EXTERNAL_IP = 322,
    OF_BSN_TLV_EXTERNAL_MAC = 323,
    OF_BSN_TLV_EXTERNAL_NETMASK = 324,
    OF_BSN_TLV_GENERATION_ID = 325,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 326,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 327,
    OF_BSN_TLV_HASH_PACKET_FIELD = 328,
    OF_BSN_TLV_HASH_PACKET_TYPE = 329,
    OF_BSN_TLV_HASH_SEED = 330,
    OF_BSN_TLV_HASH_TYPE = 331,
    OF_BSN_TLV_HEADER_SIZE = 332,
    OF_BSN_TLV_ICMP_CODE = 333,
    OF_BSN_TLV_ICMP_ID = 334,
    OF_BSN_TLV_ICMP_TYPE = 335,
    OF_BSN_TLV_IDLE_NOTIFICATION = 336,
    OF_BSN_TLV_IDLE_TIME = 337,
    OF_BSN_TLV_IDLE_TIMEOUT = 338,
    OF_BSN_TLV_IGMP_SNOOPING = 339,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 340,
    OF_BSN_TLV_INTERNAL_MAC = 341,
    OF_BSN_TLV_INTERVAL = 342,
    OF_BSN_TLV_IP_PROTO = 343,
    OF_BSN_TLV_IPV4 = 344,
    OF_BSN_TLV_IPV4_DST = 345,
    OF_BSN_TLV_IPV4_NETMASK = 346,
    OF_BSN_TLV_IPV4_SRC = 347,
    OF_BSN_TLV_IPV6 = 348,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 349,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 350,
    OF_BSN_TLV_LOOPBACK_PORT = 351,
    OF_BSN_TLV_MAC = 352,
    OF_BSN_TLV_MAC_MASK = 353,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 354,
    OF_BSN_TLV_MISS_PACKETS = 355,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 356,
    OF_BSN_TLV_MPLS_LABEL = 357,
    OF_BSN_TLV_MPLS_SEQUENCED = 358,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 359,
    OF_BSN_TLV_NAME = 360,
    OF_BSN_TLV_NEGATE = 361,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 362,
    OF_BSN_TLV_NEXT_HOP_MAC = 363,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 364,
    OF_BSN_TLV_OFFSET = 365,
    OF_BSN_TLV_PARENT_PORT = 366,
    OF_BSN_TLV_PARTNER_KEY = 367,
    OF_BSN_TLV_PARTNER_PORT_NUM = 368,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 369,
    OF_BSN_TLV_PARTNER_STATE = 370,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 371,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 372,
    OF_BSN_TLV_PORT = 373,
    OF_BSN_TLV_PORT_VXLAN_MODE = 374,
    OF_BSN_TLV_PRIORITY = 375,
    OF_BSN_TLV_QOS_PRIORITY = 376,
    OF_BSN_TLV_QUEUE_ID = 377,
    OF_BSN_TLV_QUEUE_WEIGHT = 378,
    OF_BSN_TLV_RATE_LIMIT = 379,
    OF_BSN_TLV_RATE_UNIT = 380,
    OF_BSN_TLV_REFERENCE = 381,
    OF_BSN_TLV_REPLY_PACKETS = 382,
    OF_BSN_TLV_REQUEST_PACKETS = 383,
    OF_BSN_TLV_RX_BYTES = 384,
    OF_BSN_TLV_RX_PACKETS = 385,
    OF_BSN_TLV_SAMPLING_RATE = 386,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 387,
    OF_BSN_TLV_STATUS = 388,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 389,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 390,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 391,
    OF_BSN_TLV_SUB_AGENT_ID = 392,
    OF_BSN_TLV_TCP_DST = 393,
    OF_BSN_TLV_TCP_SRC = 394,
    OF_BSN_TLV_TTL = 395,
    OF_BSN_TLV_TX_BYTES = 396,
    OF_BSN_TLV_TX_PACKETS = 397,
    OF_BSN_TLV_UDF_ANCHOR = 398,
    OF_BSN_TLV_UDF_ID = 399,
    OF_BSN_TLV_UDF_LENGTH = 400,
    OF_BSN_TLV_UDF_OFFSET = 401,
    OF_BSN_TLV_UDP_DST = 402,
    OF_BSN_TLV_UDP_SRC = 403,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 404,
    OF_BSN_TLV_UNICAST_RATE = 405,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 406,
    OF_BSN_TLV_UNTAGGED = 407,
    OF_BSN_TLV_USE_PACKET_STATE = 408,
    OF_BSN_TLV_VFI = 409,
    OF_BSN_TLV_VFP_CLASS_ID = 410,
    OF_BSN_TLV_VLAN_MAC_LIST = 411,
    OF_BSN_TLV_VLAN_PCP = 412,
    OF_BSN_TLV_VLAN_VID = 413,
    OF_BSN_TLV_VLAN_VID_MASK = 414,
    OF_BSN_TLV_VNI = 415,
    OF_BSN_TLV_VPN_KEY = 416,
    OF_BSN_TLV_VRF = 417,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 418,
    OF_BSN_VLAN_MAC = 419,
    OF_BSN_VPORT = 420,
    OF_BSN_VPORT_L2GRE = 421,
    OF_BSN_VPORT_Q_IN_Q = 422,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 423,
    OF_BUCKET = 424,
    OF_BUCKET_COUNTER = 425,
    OF_BUNDLE_PROP = 426,
    OF_BUNDLE_PROP_EXPERIMENTER = 427,
    OF_FLOW_STATS_ENTRY = 428,
    OF_GROUP_DESC_STATS_ENTRY = 429,
    OF_GROUP_STATS_ENTRY = 430,
    OF_HELLO_ELEM = 431,
    OF_HELLO_ELEM_VERSIONBITMAP = 432,
    OF_INSTRUCTION = 433,
    OF_INSTRUCTION_APPLY_ACTIONS = 434,
    OF_INSTRUCTION_BSN = 435,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 436,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 437,
    OF_INSTRUCTION_BSN_DENY = 438,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 439,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 440,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 441,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 442,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 443,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 444,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 445,
    OF_INSTRUCTION_BSN_PERMIT = 446,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 447,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 448,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 449,
    OF_INSTRUCTION_CLEAR_ACTIONS = 450,
    OF_INSTRUCTION_EXPERIMENTER = 451,
    OF_INSTRUCTION_GOTO_TABLE = 452,
    OF_INSTRUCTION_ID = 453,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 454,
    OF_INSTRUCTION_ID_BSN = 455,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 456,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 457,
    OF_INSTRUCTION_ID_BSN_DENY = 458,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 459,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 460,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 461,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 462,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 463,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 464,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 465,
    OF_INSTRUCTION_ID_BSN_PERMIT = 466,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 467,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 468,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 469,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 470,
    OF_INSTRUCTION_ID_EXPERIMENTER = 471,
    OF_INSTRUCTION_ID_GOTO_TABLE = 472,
    OF_INSTRUCTION_ID_METER = 473,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 474,
    OF_INSTRUCTION_ID_WRITE_METADATA = 475,
    OF_INSTRUCTION_METER = 476,
    OF_INSTRUCTION_WRITE_ACTIONS = 477,
    OF_INSTRUCTION_WRITE_METADATA = 478,
    OF_MATCH_V1 = 479,
    OF_MATCH_V2 = 480,
    OF_MATCH_V3 = 481,
    OF_METER_BAND = 482,
    OF_METER_BAND_DROP = 483,
    OF_METER_BAND_DSCP_REMARK = 484,
    OF_METER_BAND_EXPERIMENTER = 485,
    OF_METER_BAND_STATS = 486,
    OF_METER_CONFIG = 487,
    OF_METER_FEATURES = 488,
    OF_METER_STATS = 489,
    OF_OXM = 490,
    OF_OXM_ARP_OP = 491,
    OF_OXM_ARP_OP_MASKED = 492,
    OF_OXM_ARP_SHA = 493,
    OF_OXM_ARP_SHA_MASKED = 494,
    OF_OXM_ARP_SPA = 495,
    OF_OXM_ARP_SPA_MASKED = 496,
    OF_OXM_ARP_THA = 497,
    OF_OXM_ARP_THA_MASKED = 498,
    OF_OXM_ARP_TPA = 499,
    OF_OXM_ARP_TPA_MASKED = 500,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 501,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 502,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 503,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 504,
    OF_OXM_BSN_IN_PORTS_128 = 505,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 506,
    OF_OXM_BSN_IN_PORTS_512 = 507,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 508,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 509,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 510,
    OF_OXM_BSN_INNER_ETH_DST = 511,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 512,
    OF_OXM_BSN_INNER_ETH_SRC = 513,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 514,
    OF_OXM_BSN_INNER_VLAN_VID = 515,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 516,
    OF_OXM_BSN_L2_CACHE_HIT = 517,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 518,
    OF_OXM_BSN_L3_DST_CLASS_ID = 519,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 520,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 521,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 522,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 523,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 524,
    OF_OXM_BSN_LAG_ID = 525,
    OF_OXM_BSN_LAG_ID_MASKED = 526,
    OF_OXM_BSN_TCP_FLAGS = 527,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 528,
    OF_OXM_BSN_UDF0 = 529,
    OF_OXM_BSN_UDF0_MASKED = 530,
    OF_OXM_BSN_UDF1 = 531,
    OF_OXM_BSN_UDF1_MASKED = 532,
    OF_OXM_BSN_UDF2 = 533,
    OF_OXM_BSN_UDF2_MASKED = 534,
    OF_OXM_BSN_UDF3 = 535,
    OF_OXM_BSN_UDF3_MASKED = 536,
    OF_OXM_BSN_UDF4 = 537,
    OF_OXM_BSN_UDF4_MASKED = 538,
    OF_OXM_BSN_UDF5 = 539,
    OF_OXM_BSN_UDF5_MASKED = 540,
    OF_OXM_BSN_UDF6 = 541,
    OF_OXM_BSN_UDF6_MASKED = 542,
    OF_OXM_BSN_UDF7 = 543,
    OF_OXM_BSN_UDF7_MASKED = 544,
    OF_OXM_BSN_VFI = 545,
    OF_OXM_BSN_VFI_MASKED = 546,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 547,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 548,
    OF_OXM_BSN_VRF = 549,
    OF_OXM_BSN_VRF_MASKED = 550,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 551,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 552,
    OF_OXM_ETH_DST = 553,
    OF_OXM_ETH_DST_MASKED = 554,
    OF_OXM_ETH_SRC = 555,
    OF_OXM_ETH_SRC_MASKED = 556,
    OF_OXM_ETH_TYPE = 557,
    OF_OXM_ETH_TYPE_MASKED = 558,
    OF_OXM_ICMPV4_CODE = 559,
    OF_OXM_ICMPV4_CODE_MASKED = 560,
    OF_OXM_ICMPV4_TYPE = 561,
    OF_OXM_ICMPV4_TYPE_MASKED = 562,
    OF_OXM_ICMPV6_CODE = 563,
    OF_OXM_ICMPV6_CODE_MASKED = 564,
    OF_OXM_ICMPV6_TYPE = 565,
    OF_OXM_ICMPV6_TYPE_MASKED = 566,
    OF_OXM_IN_PHY_PORT = 567,
    OF_OXM_IN_PHY_PORT_MASKED = 568,
    OF_OXM_IN_PORT = 569,
    OF_OXM_IN_PORT_MASKED = 570,
    OF_OXM_IP_DSCP = 571,
    OF_OXM_IP_DSCP_MASKED = 572,
    OF_OXM_IP_ECN = 573,
    OF_OXM_IP_ECN_MASKED = 574,
    OF_OXM_IP_PROTO = 575,
    OF_OXM_IP_PROTO_MASKED = 576,
    OF_OXM_IPV4_DST = 577,
    OF_OXM_IPV4_DST_MASKED = 578,
    OF_OXM_IPV4_SRC = 579,
    OF_OXM_IPV4_SRC_MASKED = 580,
    OF_OXM_IPV6_DST = 581,
    OF_OXM_IPV6_DST_MASKED = 582,
    OF_OXM_IPV6_EXTHDR = 583,
    OF_OXM_IPV6_EXTHDR_MASKED = 584,
    OF_OXM_IPV6_FLABEL = 585,
    OF_OXM_IPV6_FLABEL_MASKED = 586,
    OF_OXM_IPV6_ND_SLL = 587,
    OF_OXM_IPV6_ND_SLL_MASKED = 588,
    OF_OXM_IPV6_ND_TARGET = 589,
    OF_OXM_IPV6_ND_TARGET_MASKED = 590,
    OF_OXM_IPV6_ND_TLL = 591,
    OF_OXM_IPV6_ND_TLL_MASKED = 592,
    OF_OXM_IPV6_SRC = 593,
    OF_OXM_IPV6_SRC_MASKED = 594,
    OF_OXM_METADATA = 595,
    OF_OXM_METADATA_MASKED = 596,
    OF_OXM_MPLS_BOS = 597,
    OF_OXM_MPLS_BOS_MASKED = 598,
    OF_OXM_MPLS_LABEL = 599,
    OF_OXM_MPLS_LABEL_MASKED = 600,
    OF_OXM_MPLS_TC = 601,
    OF_OXM_MPLS_TC_MASKED = 602,
    OF_OXM_PBB_UCA = 603,
    OF_OXM_PBB_UCA_MASKED = 604,
    OF_OXM_SCTP_DST = 605,
    OF_OXM_SCTP_DST_MASKED = 606,
    OF_OXM_SCTP_SRC = 607,
    OF_OXM_SCTP_SRC_MASKED = 608,
    OF_OXM_TCP_DST = 609,
    OF_OXM_TCP_DST_MASKED = 610,
    OF_OXM_TCP_SRC = 611,
    OF_OXM_TCP_SRC_MASKED = 612,
    OF_OXM_TUNNEL_ID = 613,
    OF_OXM_TUNNEL_ID_MASKED = 614,
    OF_OXM_TUNNEL_IPV4_DST = 615,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 616,
    OF_OXM_TUNNEL_IPV4_SRC = 617,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 618,
    OF_OXM_UDP_DST = 619,
    OF_OXM_UDP_DST_MASKED = 620,
    OF_OXM_UDP_SRC = 621,
    OF_OXM_UDP_SRC_MASKED = 622,
    OF_OXM_VLAN_PCP = 623,
    OF_OXM_VLAN_PCP_MASKED = 624,
    OF_OXM_VLAN_VID = 625,
    OF_OXM_VLAN_VID_MASKED = 626,
    OF_PACKET_QUEUE = 627,
    OF_PORT_DESC = 628,
    OF_PORT_DESC_PROP = 629,
    OF_PORT_DESC_PROP_BSN = 630,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 631,
    OF_PORT_DESC_PROP_BSN_UPLINK = 632,
    OF_PORT_DESC_PROP_ETHERNET = 633,
    OF_PORT_DESC_PROP_EXPERIMENTER = 634,
    OF_PORT_DESC_PROP_OPTICAL = 635,
    OF_PORT_MOD_PROP = 636,
    OF_PORT_MOD_PROP_ETHERNET = 637,
    OF_PORT_MOD_PROP_EXPERIMENTER = 638,
    OF_PORT_MOD_PROP_OPTICAL = 639,
    OF_PORT_STATS_ENTRY = 640,
    OF_PORT_STATS_PROP = 641,
    OF_PORT_STATS_PROP_ETHERNET = 642,
    OF_PORT_STATS_PROP_EXPERIMENTER = 643,
    OF_PORT_STATS_PROP_OPTICAL = 644,
    OF_QUEUE_DESC = 645,
    OF_QUEUE_DESC_PROP = 646,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 647,
    OF_QUEUE_DESC_PROP_MAX_RATE = 648,
    OF_QUEUE_DESC_PROP_MIN_RATE = 649,
    OF_QUEUE_PROP = 650,
    OF_QUEUE_PROP_EXPERIMENTER = 651,
    OF_QUEUE_PROP_MAX_RATE = 652,
    OF_QUEUE_PROP_MIN_RATE = 653,
    OF_QUEUE_STATS_ENTRY = 654,
    OF_QUEUE_STATS_PROP = 655,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 656,
    OF_ROLE_PROP = 657,
    OF_ROLE_PROP_EXPERIMENTER = 658,
    OF_TABLE_DESC = 659,
    OF_TABLE_FEATURE_PROP = 660,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 661,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 662,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 663,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 664,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 665,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 666,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 667,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 668,
    OF_TABLE_FEATURE_PROP_MATCH = 669,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 670,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 671,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 672,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 673,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 674,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 675,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 676,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 677,
    OF_TABLE_FEATURES = 678,
    OF_TABLE_MOD_PROP = 679,
    OF_TABLE_MOD_PROP_EVICTION = 680,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 681,
    OF_TABLE_MOD_PROP_VACANCY = 682,
    OF_TABLE_STATS_ENTRY = 683,
    OF_UINT32 = 684,
    OF_UINT64 = 685,
    OF_UINT8 = 686,
    ...
    /* List objects */
    OF_LIST_ACTION = 687,
    OF_LIST_ACTION_ID = 688,
    OF_LIST_ASYNC_CONFIG_PROP = 689,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 690,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 691,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 692,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 693,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 694,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 695,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 696,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 697,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 698,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 699,
    OF_LIST_BSN_INTERFACE = 700,
    OF_LIST_BSN_LACP_STATS_ENTRY = 701,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 702,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 703,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 704,
    OF_LIST_BSN_TLV = 705,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 706,
    OF_LIST_BSN_VLAN_MAC = 707,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 708,
    OF_LIST_BUCKET = 709,
    OF_LIST_BUCKET_COUNTER = 710,
    OF_LIST_BUNDLE_PROP = 711,
    OF_LIST_FLOW_STATS_ENTRY = 712,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 713,
    OF_LIST_GROUP_STATS_ENTRY = 714,
    OF_LIST_HELLO_ELEM = 715,
    OF_LIST_INSTRUCTION = 716,
    OF_LIST_INSTRUCTION_ID = 717,
    OF_LIST_METER_BAND = 718,
    OF_LIST_METER_BAND_STATS = 719,
    OF_LIST_METER_CONFIG = 720,
    OF_LIST_METER_STATS = 721,
    OF_LIST_OXM = 722,
    OF_LIST_PACKET_QUEUE = 723,
    OF_LIST_PORT_DESC = 724,
    OF_LIST_PORT_DESC_PROP = 725,
    OF_LIST_PORT_MOD_PROP = 726,
    OF_LIST_PORT_STATS_ENTRY = 727,
    OF_LIST_PORT_STATS_PROP = 728,
    OF_LIST_QUEUE_DESC = 729,
    OF_LIST_QUEUE_DESC_PROP = 730,
    OF_LIST_QUEUE_PROP = 731,
    OF_LIST_QUEUE_STATS_ENTRY = 732,
    OF_LIST_QUEUE_STATS_PROP = 733,
    OF_LIST_ROLE_PROP = 734,
    OF_LIST_TABLE_DESC = 735,
    OF_LIST_TABLE_FEATURE_PROP = 736,
    OF_LIST_TABLE_FEATURES = 737,
    OF_LIST_TABLE_MOD_PROP = 738,
    OF_LIST_TABLE_STATS_ENTRY = 739,
    OF_LIST_UINT32 = 740,
    OF_LIST_UINT64 = 741,
    OF_LIST_UINT8 = 742,
