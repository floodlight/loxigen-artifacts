...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DSCP = 328,
    OF_BSN_TLV_ECN = 329,
    OF_BSN_TLV_EGRESS_ONLY = 330,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 331,
    OF_BSN_TLV_ENCAP = 332,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 333,
    OF_BSN_TLV_ETH_DST = 334,
    OF_BSN_TLV_ETH_SRC = 335,
    OF_BSN_TLV_ETH_TYPE = 336,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 337,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 338,
    OF_BSN_TLV_EXTERNAL_IP = 339,
    OF_BSN_TLV_EXTERNAL_MAC = 340,
    OF_BSN_TLV_EXTERNAL_NETMASK = 341,
    OF_BSN_TLV_FABRIC_PORT_ROLE = 342,
    OF_BSN_TLV_FLOOD = 343,
    OF_BSN_TLV_FLOW_CLASSIFIER = 344,
    OF_BSN_TLV_FLOW_CLASSIFY = 345,
    OF_BSN_TLV_FLOW_IDENTIFIER = 346,
    OF_BSN_TLV_FORCE_LINK_UP = 347,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 348,
    OF_BSN_TLV_GENERATION_ID = 349,
    OF_BSN_TLV_HASH_ALGORITHM = 350,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 351,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 352,
    OF_BSN_TLV_HASH_PACKET_FIELD = 353,
    OF_BSN_TLV_HASH_PACKET_TYPE = 354,
    OF_BSN_TLV_HASH_SEED = 355,
    OF_BSN_TLV_HASH_TYPE = 356,
    OF_BSN_TLV_HEADER_SIZE = 357,
    OF_BSN_TLV_ICMP_CODE = 358,
    OF_BSN_TLV_ICMP_ID = 359,
    OF_BSN_TLV_ICMP_TYPE = 360,
    OF_BSN_TLV_ICMPV6_CHKSUM = 361,
    OF_BSN_TLV_IDENTIFIER = 362,
    OF_BSN_TLV_IDLE_NOTIFICATION = 363,
    OF_BSN_TLV_IDLE_TIME = 364,
    OF_BSN_TLV_IDLE_TIMEOUT = 365,
    OF_BSN_TLV_IGMP_SNOOPING = 366,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 367,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 368,
    OF_BSN_TLV_INTERNAL_MAC = 369,
    OF_BSN_TLV_INTERVAL = 370,
    OF_BSN_TLV_IP_PROTO = 371,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 372,
    OF_BSN_TLV_IPV4 = 373,
    OF_BSN_TLV_IPV4_DST = 374,
    OF_BSN_TLV_IPV4_NETMASK = 375,
    OF_BSN_TLV_IPV4_SRC = 376,
    OF_BSN_TLV_IPV6 = 377,
    OF_BSN_TLV_IPV6_DST = 378,
    OF_BSN_TLV_IPV6_PREFIX = 379,
    OF_BSN_TLV_IPV6_SRC = 380,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 381,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 382,
    OF_BSN_TLV_L3 = 383,
    OF_BSN_TLV_L3_DST_CLASS_ID = 384,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 385,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 386,
    OF_BSN_TLV_LAG_OPTIONS = 387,
    OF_BSN_TLV_LOOPBACK_MODE = 388,
    OF_BSN_TLV_LOOPBACK_PORT = 389,
    OF_BSN_TLV_LR_ALL_ENABLED = 390,
    OF_BSN_TLV_MAC = 391,
    OF_BSN_TLV_MAC_MASK = 392,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 393,
    OF_BSN_TLV_MISS_PACKETS = 394,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 395,
    OF_BSN_TLV_MPLS_LABEL = 396,
    OF_BSN_TLV_MPLS_SEQUENCED = 397,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 398,
    OF_BSN_TLV_MULTICAST_PACKET = 399,
    OF_BSN_TLV_MULTIPLIER = 400,
    OF_BSN_TLV_NAME = 401,
    OF_BSN_TLV_NDP_OFFLOAD = 402,
    OF_BSN_TLV_NDP_STATIC = 403,
    OF_BSN_TLV_NEGATE = 404,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 405,
    OF_BSN_TLV_NEXT_HOP_MAC = 406,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 407,
    OF_BSN_TLV_NO_ARP_RESPONSE = 408,
    OF_BSN_TLV_NO_NS_RESPONSE = 409,
    OF_BSN_TLV_OFFSET = 410,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 411,
    OF_BSN_TLV_OUTER_SRC_MAC = 412,
    OF_BSN_TLV_PARENT_PORT = 413,
    OF_BSN_TLV_PARTNER_KEY = 414,
    OF_BSN_TLV_PARTNER_PORT_NUM = 415,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 416,
    OF_BSN_TLV_PARTNER_STATE = 417,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 418,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 419,
    OF_BSN_TLV_PASSIVE = 420,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 421,
    OF_BSN_TLV_PIM_DR = 422,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 423,
    OF_BSN_TLV_PORT = 424,
    OF_BSN_TLV_PORT_MODE = 425,
    OF_BSN_TLV_PORT_SPEED_GBPS = 426,
    OF_BSN_TLV_PORT_USAGE = 427,
    OF_BSN_TLV_PORT_VXLAN_MODE = 428,
    OF_BSN_TLV_PRESERVE_VLAN = 429,
    OF_BSN_TLV_PRIORITY = 430,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 431,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 432,
    OF_BSN_TLV_QOS_PRIORITY = 433,
    OF_BSN_TLV_QUEUE_ID = 434,
    OF_BSN_TLV_QUEUE_WEIGHT = 435,
    OF_BSN_TLV_RATE_LIMIT = 436,
    OF_BSN_TLV_RATE_UNIT = 437,
    OF_BSN_TLV_RECORD_PACKETS = 438,
    OF_BSN_TLV_REFERENCE = 439,
    OF_BSN_TLV_REPLY_PACKETS = 440,
    OF_BSN_TLV_REQUEST_PACKETS = 441,
    OF_BSN_TLV_REST_SERVER = 442,
    OF_BSN_TLV_ROUTING_PARAM = 443,
    OF_BSN_TLV_RX_BYTES = 444,
    OF_BSN_TLV_RX_PACKETS = 445,
    OF_BSN_TLV_SAMPLING_RATE = 446,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 447,
    OF_BSN_TLV_STATUS = 448,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 449,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 450,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 451,
    OF_BSN_TLV_SUB_AGENT_ID = 452,
    OF_BSN_TLV_TCP_DST = 453,
    OF_BSN_TLV_TCP_FLAGS = 454,
    OF_BSN_TLV_TCP_SRC = 455,
    OF_BSN_TLV_TIMESTAMP = 456,
    OF_BSN_TLV_TTL = 457,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 458,
    OF_BSN_TLV_TX_BYTES = 459,
    OF_BSN_TLV_TX_PACKETS = 460,
    OF_BSN_TLV_UDF_ANCHOR = 461,
    OF_BSN_TLV_UDF_CAPABILITY = 462,
    OF_BSN_TLV_UDF_ID = 463,
    OF_BSN_TLV_UDF_LENGTH = 464,
    OF_BSN_TLV_UDF_OFFSET = 465,
    OF_BSN_TLV_UDP_DST = 466,
    OF_BSN_TLV_UDP_SRC = 467,
    OF_BSN_TLV_UINT32 = 468,
    OF_BSN_TLV_UINT64_LIST = 469,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 470,
    OF_BSN_TLV_UNICAST_RATE = 471,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 472,
    OF_BSN_TLV_UNTAGGED = 473,
    OF_BSN_TLV_UPGRADE = 474,
    OF_BSN_TLV_URI_SCHEME = 475,
    OF_BSN_TLV_USE_PACKET_STATE = 476,
    OF_BSN_TLV_USER_CONFIGURED = 477,
    OF_BSN_TLV_VFI = 478,
    OF_BSN_TLV_VFP_CLASS_ID = 479,
    OF_BSN_TLV_VIRTUAL = 480,
    OF_BSN_TLV_VLAN_MAC_LIST = 481,
    OF_BSN_TLV_VLAN_PCP = 482,
    OF_BSN_TLV_VLAN_VID = 483,
    OF_BSN_TLV_VLAN_VID_MASK = 484,
    OF_BSN_TLV_VNI = 485,
    OF_BSN_TLV_VPN_KEY = 486,
    OF_BSN_TLV_VRF = 487,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 488,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 489,
    OF_BSN_VLAN_MAC = 490,
    OF_BSN_VPORT = 491,
    OF_BSN_VPORT_L2GRE = 492,
    OF_BSN_VPORT_Q_IN_Q = 493,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 494,
    OF_BUCKET = 495,
    OF_BUCKET_COUNTER = 496,
    OF_BUNDLE_PROP = 497,
    OF_BUNDLE_PROP_EXPERIMENTER = 498,
    OF_FLOW_STATS_ENTRY = 499,
    OF_GROUP_DESC_STATS_ENTRY = 500,
    OF_GROUP_STATS_ENTRY = 501,
    OF_HELLO_ELEM = 502,
    OF_HELLO_ELEM_VERSIONBITMAP = 503,
    OF_INSTRUCTION = 504,
    OF_INSTRUCTION_APPLY_ACTIONS = 505,
    OF_INSTRUCTION_BSN = 506,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 507,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 508,
    OF_INSTRUCTION_BSN_DENY = 509,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 510,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 511,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 512,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 513,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 514,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 515,
    OF_INSTRUCTION_BSN_HASH_SELECT = 516,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 517,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 518,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 519,
    OF_INSTRUCTION_BSN_PERMIT = 520,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 521,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 522,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 523,
    OF_INSTRUCTION_CLEAR_ACTIONS = 524,
    OF_INSTRUCTION_EXPERIMENTER = 525,
    OF_INSTRUCTION_GOTO_TABLE = 526,
    OF_INSTRUCTION_ID = 527,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 528,
    OF_INSTRUCTION_ID_BSN = 529,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 530,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 531,
    OF_INSTRUCTION_ID_BSN_DENY = 532,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 533,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 534,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 535,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 536,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 537,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 538,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 539,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 540,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 541,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 542,
    OF_INSTRUCTION_ID_BSN_PERMIT = 543,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 544,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 545,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 546,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 547,
    OF_INSTRUCTION_ID_EXPERIMENTER = 548,
    OF_INSTRUCTION_ID_GOTO_TABLE = 549,
    OF_INSTRUCTION_ID_METER = 550,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 551,
    OF_INSTRUCTION_ID_WRITE_METADATA = 552,
    OF_INSTRUCTION_METER = 553,
    OF_INSTRUCTION_WRITE_ACTIONS = 554,
    OF_INSTRUCTION_WRITE_METADATA = 555,
    OF_MATCH_V1 = 556,
    OF_MATCH_V2 = 557,
    OF_MATCH_V3 = 558,
    OF_METER_BAND = 559,
    OF_METER_BAND_DROP = 560,
    OF_METER_BAND_DSCP_REMARK = 561,
    OF_METER_BAND_EXPERIMENTER = 562,
    OF_METER_BAND_STATS = 563,
    OF_METER_CONFIG = 564,
    OF_METER_FEATURES = 565,
    OF_METER_STATS = 566,
    OF_OXM = 567,
    OF_OXM_ARP_OP = 568,
    OF_OXM_ARP_OP_MASKED = 569,
    OF_OXM_ARP_SHA = 570,
    OF_OXM_ARP_SHA_MASKED = 571,
    OF_OXM_ARP_SPA = 572,
    OF_OXM_ARP_SPA_MASKED = 573,
    OF_OXM_ARP_THA = 574,
    OF_OXM_ARP_THA_MASKED = 575,
    OF_OXM_ARP_TPA = 576,
    OF_OXM_ARP_TPA_MASKED = 577,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 578,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 579,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 580,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 581,
    OF_OXM_BSN_IFP_CLASS_ID = 582,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 583,
    OF_OXM_BSN_IN_PORTS_128 = 584,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 585,
    OF_OXM_BSN_IN_PORTS_512 = 586,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 587,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 588,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 589,
    OF_OXM_BSN_INNER_ETH_DST = 590,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 591,
    OF_OXM_BSN_INNER_ETH_SRC = 592,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 593,
    OF_OXM_BSN_INNER_VLAN_VID = 594,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 595,
    OF_OXM_BSN_IP_FRAGMENTATION = 596,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 597,
    OF_OXM_BSN_L2_CACHE_HIT = 598,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 599,
    OF_OXM_BSN_L3_DST_CLASS_ID = 600,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 601,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 602,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 603,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 604,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 605,
    OF_OXM_BSN_LAG_ID = 606,
    OF_OXM_BSN_LAG_ID_MASKED = 607,
    OF_OXM_BSN_TCP_FLAGS = 608,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 609,
    OF_OXM_BSN_UDF0 = 610,
    OF_OXM_BSN_UDF0_MASKED = 611,
    OF_OXM_BSN_UDF1 = 612,
    OF_OXM_BSN_UDF1_MASKED = 613,
    OF_OXM_BSN_UDF2 = 614,
    OF_OXM_BSN_UDF2_MASKED = 615,
    OF_OXM_BSN_UDF3 = 616,
    OF_OXM_BSN_UDF3_MASKED = 617,
    OF_OXM_BSN_UDF4 = 618,
    OF_OXM_BSN_UDF4_MASKED = 619,
    OF_OXM_BSN_UDF5 = 620,
    OF_OXM_BSN_UDF5_MASKED = 621,
    OF_OXM_BSN_UDF6 = 622,
    OF_OXM_BSN_UDF6_MASKED = 623,
    OF_OXM_BSN_UDF7 = 624,
    OF_OXM_BSN_UDF7_MASKED = 625,
    OF_OXM_BSN_VFI = 626,
    OF_OXM_BSN_VFI_MASKED = 627,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 628,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 629,
    OF_OXM_BSN_VRF = 630,
    OF_OXM_BSN_VRF_MASKED = 631,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 632,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 633,
    OF_OXM_CONN_TRACKING_IPV6_DST = 634,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 635,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 636,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 637,
    OF_OXM_CONN_TRACKING_LABEL = 638,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 639,
    OF_OXM_CONN_TRACKING_MARK = 640,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 641,
    OF_OXM_CONN_TRACKING_NW_DST = 642,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 643,
    OF_OXM_CONN_TRACKING_NW_PROTO = 644,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 645,
    OF_OXM_CONN_TRACKING_NW_SRC = 646,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 647,
    OF_OXM_CONN_TRACKING_STATE = 648,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 649,
    OF_OXM_CONN_TRACKING_TP_DST = 650,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 651,
    OF_OXM_CONN_TRACKING_TP_SRC = 652,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 653,
    OF_OXM_CONN_TRACKING_ZONE = 654,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 655,
    OF_OXM_ETH_DST = 656,
    OF_OXM_ETH_DST_MASKED = 657,
    OF_OXM_ETH_SRC = 658,
    OF_OXM_ETH_SRC_MASKED = 659,
    OF_OXM_ETH_TYPE = 660,
    OF_OXM_ETH_TYPE_MASKED = 661,
    OF_OXM_ICMPV4_CODE = 662,
    OF_OXM_ICMPV4_CODE_MASKED = 663,
    OF_OXM_ICMPV4_TYPE = 664,
    OF_OXM_ICMPV4_TYPE_MASKED = 665,
    OF_OXM_ICMPV6_CODE = 666,
    OF_OXM_ICMPV6_CODE_MASKED = 667,
    OF_OXM_ICMPV6_TYPE = 668,
    OF_OXM_ICMPV6_TYPE_MASKED = 669,
    OF_OXM_IN_PHY_PORT = 670,
    OF_OXM_IN_PHY_PORT_MASKED = 671,
    OF_OXM_IN_PORT = 672,
    OF_OXM_IN_PORT_MASKED = 673,
    OF_OXM_IP_DSCP = 674,
    OF_OXM_IP_DSCP_MASKED = 675,
    OF_OXM_IP_ECN = 676,
    OF_OXM_IP_ECN_MASKED = 677,
    OF_OXM_IP_PROTO = 678,
    OF_OXM_IP_PROTO_MASKED = 679,
    OF_OXM_IPV4_DST = 680,
    OF_OXM_IPV4_DST_MASKED = 681,
    OF_OXM_IPV4_SRC = 682,
    OF_OXM_IPV4_SRC_MASKED = 683,
    OF_OXM_IPV6_DST = 684,
    OF_OXM_IPV6_DST_MASKED = 685,
    OF_OXM_IPV6_EXTHDR = 686,
    OF_OXM_IPV6_EXTHDR_MASKED = 687,
    OF_OXM_IPV6_FLABEL = 688,
    OF_OXM_IPV6_FLABEL_MASKED = 689,
    OF_OXM_IPV6_ND_SLL = 690,
    OF_OXM_IPV6_ND_SLL_MASKED = 691,
    OF_OXM_IPV6_ND_TARGET = 692,
    OF_OXM_IPV6_ND_TARGET_MASKED = 693,
    OF_OXM_IPV6_ND_TLL = 694,
    OF_OXM_IPV6_ND_TLL_MASKED = 695,
    OF_OXM_IPV6_SRC = 696,
    OF_OXM_IPV6_SRC_MASKED = 697,
    OF_OXM_METADATA = 698,
    OF_OXM_METADATA_MASKED = 699,
    OF_OXM_MPLS_BOS = 700,
    OF_OXM_MPLS_BOS_MASKED = 701,
    OF_OXM_MPLS_LABEL = 702,
    OF_OXM_MPLS_LABEL_MASKED = 703,
    OF_OXM_MPLS_TC = 704,
    OF_OXM_MPLS_TC_MASKED = 705,
    OF_OXM_OVS_TCP_FLAGS = 706,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 707,
    OF_OXM_PBB_UCA = 708,
    OF_OXM_PBB_UCA_MASKED = 709,
    OF_OXM_SCTP_DST = 710,
    OF_OXM_SCTP_DST_MASKED = 711,
    OF_OXM_SCTP_SRC = 712,
    OF_OXM_SCTP_SRC_MASKED = 713,
    OF_OXM_TCP_DST = 714,
    OF_OXM_TCP_DST_MASKED = 715,
    OF_OXM_TCP_SRC = 716,
    OF_OXM_TCP_SRC_MASKED = 717,
    OF_OXM_TUNNEL_ID = 718,
    OF_OXM_TUNNEL_ID_MASKED = 719,
    OF_OXM_TUNNEL_IPV4_DST = 720,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 721,
    OF_OXM_TUNNEL_IPV4_SRC = 722,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 723,
    OF_OXM_UDP_DST = 724,
    OF_OXM_UDP_DST_MASKED = 725,
    OF_OXM_UDP_SRC = 726,
    OF_OXM_UDP_SRC_MASKED = 727,
    OF_OXM_VLAN_PCP = 728,
    OF_OXM_VLAN_PCP_MASKED = 729,
    OF_OXM_VLAN_VID = 730,
    OF_OXM_VLAN_VID_MASKED = 731,
    OF_PACKET_QUEUE = 732,
    OF_PORT_DESC = 733,
    OF_PORT_DESC_PROP = 734,
    OF_PORT_DESC_PROP_BSN = 735,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 736,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 737,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 738,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 739,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 740,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 741,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 742,
    OF_PORT_DESC_PROP_BSN_UPLINK = 743,
    OF_PORT_DESC_PROP_ETHERNET = 744,
    OF_PORT_DESC_PROP_EXPERIMENTER = 745,
    OF_PORT_DESC_PROP_OPTICAL = 746,
    OF_PORT_MOD_PROP = 747,
    OF_PORT_MOD_PROP_ETHERNET = 748,
    OF_PORT_MOD_PROP_EXPERIMENTER = 749,
    OF_PORT_MOD_PROP_OPTICAL = 750,
    OF_PORT_STATS_ENTRY = 751,
    OF_PORT_STATS_PROP = 752,
    OF_PORT_STATS_PROP_ETHERNET = 753,
    OF_PORT_STATS_PROP_EXPERIMENTER = 754,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 755,
    OF_PORT_STATS_PROP_OPTICAL = 756,
    OF_QUEUE_DESC = 757,
    OF_QUEUE_DESC_PROP = 758,
    OF_QUEUE_DESC_PROP_BSN = 759,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 760,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 761,
    OF_QUEUE_DESC_PROP_MAX_RATE = 762,
    OF_QUEUE_DESC_PROP_MIN_RATE = 763,
    OF_QUEUE_PROP = 764,
    OF_QUEUE_PROP_EXPERIMENTER = 765,
    OF_QUEUE_PROP_MAX_RATE = 766,
    OF_QUEUE_PROP_MIN_RATE = 767,
    OF_QUEUE_STATS_ENTRY = 768,
    OF_QUEUE_STATS_PROP = 769,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 770,
    OF_ROLE_PROP = 771,
    OF_ROLE_PROP_EXPERIMENTER = 772,
    OF_TABLE_DESC = 773,
    OF_TABLE_FEATURE_PROP = 774,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 775,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 776,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 777,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 778,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 779,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 780,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 781,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 782,
    OF_TABLE_FEATURE_PROP_MATCH = 783,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 784,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 785,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 786,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 787,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 788,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 789,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 790,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 791,
    OF_TABLE_FEATURES = 792,
    OF_TABLE_MOD_PROP = 793,
    OF_TABLE_MOD_PROP_EVICTION = 794,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 795,
    OF_TABLE_MOD_PROP_VACANCY = 796,
    OF_TABLE_STATS_ENTRY = 797,
    OF_UINT32 = 798,
    OF_UINT64 = 799,
    OF_UINT8 = 800,
    ...
    /* List objects */
    OF_LIST_ACTION = 801,
    OF_LIST_ACTION_ID = 802,
    OF_LIST_ASYNC_CONFIG_PROP = 803,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 804,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 805,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 806,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 807,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 808,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 809,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 810,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 811,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 812,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 813,
    OF_LIST_BSN_INTERFACE = 814,
    OF_LIST_BSN_LACP_STATS_ENTRY = 815,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 816,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 817,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 818,
    OF_LIST_BSN_TLV = 819,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 820,
    OF_LIST_BSN_VLAN_MAC = 821,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 822,
    OF_LIST_BUCKET = 823,
    OF_LIST_BUCKET_COUNTER = 824,
    OF_LIST_BUNDLE_PROP = 825,
    OF_LIST_FLOW_STATS_ENTRY = 826,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 827,
    OF_LIST_GROUP_STATS_ENTRY = 828,
    OF_LIST_HELLO_ELEM = 829,
    OF_LIST_INSTRUCTION = 830,
    OF_LIST_INSTRUCTION_ID = 831,
    OF_LIST_METER_BAND = 832,
    OF_LIST_METER_BAND_STATS = 833,
    OF_LIST_METER_CONFIG = 834,
    OF_LIST_METER_STATS = 835,
    OF_LIST_OXM = 836,
    OF_LIST_PACKET_QUEUE = 837,
    OF_LIST_PORT_DESC = 838,
    OF_LIST_PORT_DESC_PROP = 839,
    OF_LIST_PORT_MOD_PROP = 840,
    OF_LIST_PORT_STATS_ENTRY = 841,
    OF_LIST_PORT_STATS_PROP = 842,
    OF_LIST_QUEUE_DESC = 843,
    OF_LIST_QUEUE_DESC_PROP = 844,
    OF_LIST_QUEUE_PROP = 845,
    OF_LIST_QUEUE_STATS_ENTRY = 846,
    OF_LIST_QUEUE_STATS_PROP = 847,
    OF_LIST_ROLE_PROP = 848,
    OF_LIST_TABLE_DESC = 849,
    OF_LIST_TABLE_FEATURE_PROP = 850,
    OF_LIST_TABLE_FEATURES = 851,
    OF_LIST_TABLE_MOD_PROP = 852,
    OF_LIST_TABLE_STATS_ENTRY = 853,
    OF_LIST_UINT32 = 854,
    OF_LIST_UINT64 = 855,
    OF_LIST_UINT8 = 856,
