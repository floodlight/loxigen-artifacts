...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DSCP = 319,
    OF_BSN_TLV_ETH_DST = 320,
    OF_BSN_TLV_ETH_SRC = 321,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 322,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 323,
    OF_BSN_TLV_EXTERNAL_IP = 324,
    OF_BSN_TLV_EXTERNAL_MAC = 325,
    OF_BSN_TLV_EXTERNAL_NETMASK = 326,
    OF_BSN_TLV_GENERATION_ID = 327,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 328,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 329,
    OF_BSN_TLV_HASH_PACKET_FIELD = 330,
    OF_BSN_TLV_HASH_PACKET_TYPE = 331,
    OF_BSN_TLV_HASH_SEED = 332,
    OF_BSN_TLV_HASH_TYPE = 333,
    OF_BSN_TLV_HEADER_SIZE = 334,
    OF_BSN_TLV_ICMP_CODE = 335,
    OF_BSN_TLV_ICMP_ID = 336,
    OF_BSN_TLV_ICMP_TYPE = 337,
    OF_BSN_TLV_IDLE_NOTIFICATION = 338,
    OF_BSN_TLV_IDLE_TIME = 339,
    OF_BSN_TLV_IDLE_TIMEOUT = 340,
    OF_BSN_TLV_IGMP_SNOOPING = 341,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 342,
    OF_BSN_TLV_INTERNAL_MAC = 343,
    OF_BSN_TLV_INTERVAL = 344,
    OF_BSN_TLV_IP_PROTO = 345,
    OF_BSN_TLV_IPV4 = 346,
    OF_BSN_TLV_IPV4_DST = 347,
    OF_BSN_TLV_IPV4_NETMASK = 348,
    OF_BSN_TLV_IPV4_SRC = 349,
    OF_BSN_TLV_IPV6 = 350,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 351,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 352,
    OF_BSN_TLV_LOOPBACK_PORT = 353,
    OF_BSN_TLV_MAC = 354,
    OF_BSN_TLV_MAC_MASK = 355,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 356,
    OF_BSN_TLV_MISS_PACKETS = 357,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 358,
    OF_BSN_TLV_MPLS_LABEL = 359,
    OF_BSN_TLV_MPLS_SEQUENCED = 360,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 361,
    OF_BSN_TLV_NAME = 362,
    OF_BSN_TLV_NEGATE = 363,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 364,
    OF_BSN_TLV_NEXT_HOP_MAC = 365,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 366,
    OF_BSN_TLV_OFFSET = 367,
    OF_BSN_TLV_PARENT_PORT = 368,
    OF_BSN_TLV_PARTNER_KEY = 369,
    OF_BSN_TLV_PARTNER_PORT_NUM = 370,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 371,
    OF_BSN_TLV_PARTNER_STATE = 372,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 373,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 374,
    OF_BSN_TLV_PORT = 375,
    OF_BSN_TLV_PORT_VXLAN_MODE = 376,
    OF_BSN_TLV_PRIORITY = 377,
    OF_BSN_TLV_QOS_PRIORITY = 378,
    OF_BSN_TLV_QUEUE_ID = 379,
    OF_BSN_TLV_QUEUE_WEIGHT = 380,
    OF_BSN_TLV_RATE_LIMIT = 381,
    OF_BSN_TLV_RATE_UNIT = 382,
    OF_BSN_TLV_REFERENCE = 383,
    OF_BSN_TLV_REPLY_PACKETS = 384,
    OF_BSN_TLV_REQUEST_PACKETS = 385,
    OF_BSN_TLV_RX_BYTES = 386,
    OF_BSN_TLV_RX_PACKETS = 387,
    OF_BSN_TLV_SAMPLING_RATE = 388,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 389,
    OF_BSN_TLV_STATUS = 390,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 391,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 392,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 393,
    OF_BSN_TLV_SUB_AGENT_ID = 394,
    OF_BSN_TLV_TCP_DST = 395,
    OF_BSN_TLV_TCP_SRC = 396,
    OF_BSN_TLV_TTL = 397,
    OF_BSN_TLV_TX_BYTES = 398,
    OF_BSN_TLV_TX_PACKETS = 399,
    OF_BSN_TLV_UDF_ANCHOR = 400,
    OF_BSN_TLV_UDF_ID = 401,
    OF_BSN_TLV_UDF_LENGTH = 402,
    OF_BSN_TLV_UDF_OFFSET = 403,
    OF_BSN_TLV_UDP_DST = 404,
    OF_BSN_TLV_UDP_SRC = 405,
    OF_BSN_TLV_UINT64_LIST = 406,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 407,
    OF_BSN_TLV_UNICAST_RATE = 408,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 409,
    OF_BSN_TLV_UNTAGGED = 410,
    OF_BSN_TLV_USE_PACKET_STATE = 411,
    OF_BSN_TLV_VFI = 412,
    OF_BSN_TLV_VFP_CLASS_ID = 413,
    OF_BSN_TLV_VLAN_MAC_LIST = 414,
    OF_BSN_TLV_VLAN_PCP = 415,
    OF_BSN_TLV_VLAN_VID = 416,
    OF_BSN_TLV_VLAN_VID_MASK = 417,
    OF_BSN_TLV_VNI = 418,
    OF_BSN_TLV_VPN_KEY = 419,
    OF_BSN_TLV_VRF = 420,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 421,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 422,
    OF_BSN_VLAN_MAC = 423,
    OF_BSN_VPORT = 424,
    OF_BSN_VPORT_L2GRE = 425,
    OF_BSN_VPORT_Q_IN_Q = 426,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 427,
    OF_BUCKET = 428,
    OF_BUCKET_COUNTER = 429,
    OF_BUNDLE_PROP = 430,
    OF_BUNDLE_PROP_EXPERIMENTER = 431,
    OF_FLOW_STATS_ENTRY = 432,
    OF_GROUP_DESC_STATS_ENTRY = 433,
    OF_GROUP_STATS_ENTRY = 434,
    OF_HELLO_ELEM = 435,
    OF_HELLO_ELEM_VERSIONBITMAP = 436,
    OF_INSTRUCTION = 437,
    OF_INSTRUCTION_APPLY_ACTIONS = 438,
    OF_INSTRUCTION_BSN = 439,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 440,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 441,
    OF_INSTRUCTION_BSN_DENY = 442,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 443,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 444,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 445,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 446,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 447,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 448,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 449,
    OF_INSTRUCTION_BSN_PERMIT = 450,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 451,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 452,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 453,
    OF_INSTRUCTION_CLEAR_ACTIONS = 454,
    OF_INSTRUCTION_EXPERIMENTER = 455,
    OF_INSTRUCTION_GOTO_TABLE = 456,
    OF_INSTRUCTION_ID = 457,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 458,
    OF_INSTRUCTION_ID_BSN = 459,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 460,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 461,
    OF_INSTRUCTION_ID_BSN_DENY = 462,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 463,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 464,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 465,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 466,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 467,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 468,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 469,
    OF_INSTRUCTION_ID_BSN_PERMIT = 470,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 471,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 472,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 473,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 474,
    OF_INSTRUCTION_ID_EXPERIMENTER = 475,
    OF_INSTRUCTION_ID_GOTO_TABLE = 476,
    OF_INSTRUCTION_ID_METER = 477,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 478,
    OF_INSTRUCTION_ID_WRITE_METADATA = 479,
    OF_INSTRUCTION_METER = 480,
    OF_INSTRUCTION_WRITE_ACTIONS = 481,
    OF_INSTRUCTION_WRITE_METADATA = 482,
    OF_MATCH_V1 = 483,
    OF_MATCH_V2 = 484,
    OF_MATCH_V3 = 485,
    OF_METER_BAND = 486,
    OF_METER_BAND_DROP = 487,
    OF_METER_BAND_DSCP_REMARK = 488,
    OF_METER_BAND_EXPERIMENTER = 489,
    OF_METER_BAND_STATS = 490,
    OF_METER_CONFIG = 491,
    OF_METER_FEATURES = 492,
    OF_METER_STATS = 493,
    OF_OXM = 494,
    OF_OXM_ARP_OP = 495,
    OF_OXM_ARP_OP_MASKED = 496,
    OF_OXM_ARP_SHA = 497,
    OF_OXM_ARP_SHA_MASKED = 498,
    OF_OXM_ARP_SPA = 499,
    OF_OXM_ARP_SPA_MASKED = 500,
    OF_OXM_ARP_THA = 501,
    OF_OXM_ARP_THA_MASKED = 502,
    OF_OXM_ARP_TPA = 503,
    OF_OXM_ARP_TPA_MASKED = 504,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 505,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 506,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 507,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 508,
    OF_OXM_BSN_IN_PORTS_128 = 509,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 510,
    OF_OXM_BSN_IN_PORTS_512 = 511,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 512,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 513,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 514,
    OF_OXM_BSN_INNER_ETH_DST = 515,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 516,
    OF_OXM_BSN_INNER_ETH_SRC = 517,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 518,
    OF_OXM_BSN_INNER_VLAN_VID = 519,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 520,
    OF_OXM_BSN_L2_CACHE_HIT = 521,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 522,
    OF_OXM_BSN_L3_DST_CLASS_ID = 523,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 524,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 525,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 526,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 527,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 528,
    OF_OXM_BSN_LAG_ID = 529,
    OF_OXM_BSN_LAG_ID_MASKED = 530,
    OF_OXM_BSN_TCP_FLAGS = 531,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 532,
    OF_OXM_BSN_UDF0 = 533,
    OF_OXM_BSN_UDF0_MASKED = 534,
    OF_OXM_BSN_UDF1 = 535,
    OF_OXM_BSN_UDF1_MASKED = 536,
    OF_OXM_BSN_UDF2 = 537,
    OF_OXM_BSN_UDF2_MASKED = 538,
    OF_OXM_BSN_UDF3 = 539,
    OF_OXM_BSN_UDF3_MASKED = 540,
    OF_OXM_BSN_UDF4 = 541,
    OF_OXM_BSN_UDF4_MASKED = 542,
    OF_OXM_BSN_UDF5 = 543,
    OF_OXM_BSN_UDF5_MASKED = 544,
    OF_OXM_BSN_UDF6 = 545,
    OF_OXM_BSN_UDF6_MASKED = 546,
    OF_OXM_BSN_UDF7 = 547,
    OF_OXM_BSN_UDF7_MASKED = 548,
    OF_OXM_BSN_VFI = 549,
    OF_OXM_BSN_VFI_MASKED = 550,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 551,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 552,
    OF_OXM_BSN_VRF = 553,
    OF_OXM_BSN_VRF_MASKED = 554,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 555,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 556,
    OF_OXM_ETH_DST = 557,
    OF_OXM_ETH_DST_MASKED = 558,
    OF_OXM_ETH_SRC = 559,
    OF_OXM_ETH_SRC_MASKED = 560,
    OF_OXM_ETH_TYPE = 561,
    OF_OXM_ETH_TYPE_MASKED = 562,
    OF_OXM_ICMPV4_CODE = 563,
    OF_OXM_ICMPV4_CODE_MASKED = 564,
    OF_OXM_ICMPV4_TYPE = 565,
    OF_OXM_ICMPV4_TYPE_MASKED = 566,
    OF_OXM_ICMPV6_CODE = 567,
    OF_OXM_ICMPV6_CODE_MASKED = 568,
    OF_OXM_ICMPV6_TYPE = 569,
    OF_OXM_ICMPV6_TYPE_MASKED = 570,
    OF_OXM_IN_PHY_PORT = 571,
    OF_OXM_IN_PHY_PORT_MASKED = 572,
    OF_OXM_IN_PORT = 573,
    OF_OXM_IN_PORT_MASKED = 574,
    OF_OXM_IP_DSCP = 575,
    OF_OXM_IP_DSCP_MASKED = 576,
    OF_OXM_IP_ECN = 577,
    OF_OXM_IP_ECN_MASKED = 578,
    OF_OXM_IP_PROTO = 579,
    OF_OXM_IP_PROTO_MASKED = 580,
    OF_OXM_IPV4_DST = 581,
    OF_OXM_IPV4_DST_MASKED = 582,
    OF_OXM_IPV4_SRC = 583,
    OF_OXM_IPV4_SRC_MASKED = 584,
    OF_OXM_IPV6_DST = 585,
    OF_OXM_IPV6_DST_MASKED = 586,
    OF_OXM_IPV6_EXTHDR = 587,
    OF_OXM_IPV6_EXTHDR_MASKED = 588,
    OF_OXM_IPV6_FLABEL = 589,
    OF_OXM_IPV6_FLABEL_MASKED = 590,
    OF_OXM_IPV6_ND_SLL = 591,
    OF_OXM_IPV6_ND_SLL_MASKED = 592,
    OF_OXM_IPV6_ND_TARGET = 593,
    OF_OXM_IPV6_ND_TARGET_MASKED = 594,
    OF_OXM_IPV6_ND_TLL = 595,
    OF_OXM_IPV6_ND_TLL_MASKED = 596,
    OF_OXM_IPV6_SRC = 597,
    OF_OXM_IPV6_SRC_MASKED = 598,
    OF_OXM_METADATA = 599,
    OF_OXM_METADATA_MASKED = 600,
    OF_OXM_MPLS_BOS = 601,
    OF_OXM_MPLS_BOS_MASKED = 602,
    OF_OXM_MPLS_LABEL = 603,
    OF_OXM_MPLS_LABEL_MASKED = 604,
    OF_OXM_MPLS_TC = 605,
    OF_OXM_MPLS_TC_MASKED = 606,
    OF_OXM_PBB_UCA = 607,
    OF_OXM_PBB_UCA_MASKED = 608,
    OF_OXM_SCTP_DST = 609,
    OF_OXM_SCTP_DST_MASKED = 610,
    OF_OXM_SCTP_SRC = 611,
    OF_OXM_SCTP_SRC_MASKED = 612,
    OF_OXM_TCP_DST = 613,
    OF_OXM_TCP_DST_MASKED = 614,
    OF_OXM_TCP_SRC = 615,
    OF_OXM_TCP_SRC_MASKED = 616,
    OF_OXM_TUNNEL_ID = 617,
    OF_OXM_TUNNEL_ID_MASKED = 618,
    OF_OXM_TUNNEL_IPV4_DST = 619,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 620,
    OF_OXM_TUNNEL_IPV4_SRC = 621,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 622,
    OF_OXM_UDP_DST = 623,
    OF_OXM_UDP_DST_MASKED = 624,
    OF_OXM_UDP_SRC = 625,
    OF_OXM_UDP_SRC_MASKED = 626,
    OF_OXM_VLAN_PCP = 627,
    OF_OXM_VLAN_PCP_MASKED = 628,
    OF_OXM_VLAN_VID = 629,
    OF_OXM_VLAN_VID_MASKED = 630,
    OF_PACKET_QUEUE = 631,
    OF_PORT_DESC = 632,
    OF_PORT_DESC_PROP = 633,
    OF_PORT_DESC_PROP_BSN = 634,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 635,
    OF_PORT_DESC_PROP_BSN_UPLINK = 636,
    OF_PORT_DESC_PROP_ETHERNET = 637,
    OF_PORT_DESC_PROP_EXPERIMENTER = 638,
    OF_PORT_DESC_PROP_OPTICAL = 639,
    OF_PORT_MOD_PROP = 640,
    OF_PORT_MOD_PROP_ETHERNET = 641,
    OF_PORT_MOD_PROP_EXPERIMENTER = 642,
    OF_PORT_MOD_PROP_OPTICAL = 643,
    OF_PORT_STATS_ENTRY = 644,
    OF_PORT_STATS_PROP = 645,
    OF_PORT_STATS_PROP_ETHERNET = 646,
    OF_PORT_STATS_PROP_EXPERIMENTER = 647,
    OF_PORT_STATS_PROP_OPTICAL = 648,
    OF_QUEUE_DESC = 649,
    OF_QUEUE_DESC_PROP = 650,
    OF_QUEUE_DESC_PROP_BSN = 651,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 652,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 653,
    OF_QUEUE_DESC_PROP_MAX_RATE = 654,
    OF_QUEUE_DESC_PROP_MIN_RATE = 655,
    OF_QUEUE_PROP = 656,
    OF_QUEUE_PROP_EXPERIMENTER = 657,
    OF_QUEUE_PROP_MAX_RATE = 658,
    OF_QUEUE_PROP_MIN_RATE = 659,
    OF_QUEUE_STATS_ENTRY = 660,
    OF_QUEUE_STATS_PROP = 661,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 662,
    OF_ROLE_PROP = 663,
    OF_ROLE_PROP_EXPERIMENTER = 664,
    OF_TABLE_DESC = 665,
    OF_TABLE_FEATURE_PROP = 666,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 667,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 668,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 669,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 670,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 671,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 672,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 673,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 674,
    OF_TABLE_FEATURE_PROP_MATCH = 675,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 676,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 677,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 678,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 679,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 680,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 681,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 682,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 683,
    OF_TABLE_FEATURES = 684,
    OF_TABLE_MOD_PROP = 685,
    OF_TABLE_MOD_PROP_EVICTION = 686,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 687,
    OF_TABLE_MOD_PROP_VACANCY = 688,
    OF_TABLE_STATS_ENTRY = 689,
    OF_UINT32 = 690,
    OF_UINT64 = 691,
    OF_UINT8 = 692,
    ...
    /* List objects */
    OF_LIST_ACTION = 693,
    OF_LIST_ACTION_ID = 694,
    OF_LIST_ASYNC_CONFIG_PROP = 695,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 696,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 697,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 698,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 699,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 700,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 701,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 702,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 703,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 704,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 705,
    OF_LIST_BSN_INTERFACE = 706,
    OF_LIST_BSN_LACP_STATS_ENTRY = 707,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 708,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 709,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 710,
    OF_LIST_BSN_TLV = 711,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 712,
    OF_LIST_BSN_VLAN_MAC = 713,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 714,
    OF_LIST_BUCKET = 715,
    OF_LIST_BUCKET_COUNTER = 716,
    OF_LIST_BUNDLE_PROP = 717,
    OF_LIST_FLOW_STATS_ENTRY = 718,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 719,
    OF_LIST_GROUP_STATS_ENTRY = 720,
    OF_LIST_HELLO_ELEM = 721,
    OF_LIST_INSTRUCTION = 722,
    OF_LIST_INSTRUCTION_ID = 723,
    OF_LIST_METER_BAND = 724,
    OF_LIST_METER_BAND_STATS = 725,
    OF_LIST_METER_CONFIG = 726,
    OF_LIST_METER_STATS = 727,
    OF_LIST_OXM = 728,
    OF_LIST_PACKET_QUEUE = 729,
    OF_LIST_PORT_DESC = 730,
    OF_LIST_PORT_DESC_PROP = 731,
    OF_LIST_PORT_MOD_PROP = 732,
    OF_LIST_PORT_STATS_ENTRY = 733,
    OF_LIST_PORT_STATS_PROP = 734,
    OF_LIST_QUEUE_DESC = 735,
    OF_LIST_QUEUE_DESC_PROP = 736,
    OF_LIST_QUEUE_PROP = 737,
    OF_LIST_QUEUE_STATS_ENTRY = 738,
    OF_LIST_QUEUE_STATS_PROP = 739,
    OF_LIST_ROLE_PROP = 740,
    OF_LIST_TABLE_DESC = 741,
    OF_LIST_TABLE_FEATURE_PROP = 742,
    OF_LIST_TABLE_FEATURES = 743,
    OF_LIST_TABLE_MOD_PROP = 744,
    OF_LIST_TABLE_STATS_ENTRY = 745,
    OF_LIST_UINT32 = 746,
    OF_LIST_UINT64 = 747,
    OF_LIST_UINT8 = 748,
