...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DATA = 318,
    OF_BSN_TLV_DECAP = 319,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 320,
    OF_BSN_TLV_DROP = 321,
    OF_BSN_TLV_DSCP = 322,
    OF_BSN_TLV_ECN = 323,
    OF_BSN_TLV_EGRESS_ONLY = 324,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 325,
    OF_BSN_TLV_ETH_DST = 326,
    OF_BSN_TLV_ETH_SRC = 327,
    OF_BSN_TLV_ETH_TYPE = 328,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 329,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 330,
    OF_BSN_TLV_EXTERNAL_IP = 331,
    OF_BSN_TLV_EXTERNAL_MAC = 332,
    OF_BSN_TLV_EXTERNAL_NETMASK = 333,
    OF_BSN_TLV_GENERATION_ID = 334,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 335,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 336,
    OF_BSN_TLV_HASH_PACKET_FIELD = 337,
    OF_BSN_TLV_HASH_PACKET_TYPE = 338,
    OF_BSN_TLV_HASH_SEED = 339,
    OF_BSN_TLV_HASH_TYPE = 340,
    OF_BSN_TLV_HEADER_SIZE = 341,
    OF_BSN_TLV_ICMP_CODE = 342,
    OF_BSN_TLV_ICMP_ID = 343,
    OF_BSN_TLV_ICMP_TYPE = 344,
    OF_BSN_TLV_ICMPV6_CHKSUM = 345,
    OF_BSN_TLV_IDLE_NOTIFICATION = 346,
    OF_BSN_TLV_IDLE_TIME = 347,
    OF_BSN_TLV_IDLE_TIMEOUT = 348,
    OF_BSN_TLV_IGMP_SNOOPING = 349,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 350,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 351,
    OF_BSN_TLV_INTERNAL_MAC = 352,
    OF_BSN_TLV_INTERVAL = 353,
    OF_BSN_TLV_IP_PROTO = 354,
    OF_BSN_TLV_IPV4 = 355,
    OF_BSN_TLV_IPV4_DST = 356,
    OF_BSN_TLV_IPV4_NETMASK = 357,
    OF_BSN_TLV_IPV4_SRC = 358,
    OF_BSN_TLV_IPV6 = 359,
    OF_BSN_TLV_IPV6_DST = 360,
    OF_BSN_TLV_IPV6_PREFIX = 361,
    OF_BSN_TLV_IPV6_SRC = 362,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 363,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 364,
    OF_BSN_TLV_L3_DST_CLASS_ID = 365,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 366,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 367,
    OF_BSN_TLV_LOOPBACK_PORT = 368,
    OF_BSN_TLV_MAC = 369,
    OF_BSN_TLV_MAC_MASK = 370,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 371,
    OF_BSN_TLV_MISS_PACKETS = 372,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 373,
    OF_BSN_TLV_MPLS_LABEL = 374,
    OF_BSN_TLV_MPLS_SEQUENCED = 375,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 376,
    OF_BSN_TLV_NAME = 377,
    OF_BSN_TLV_NDP_OFFLOAD = 378,
    OF_BSN_TLV_NDP_STATIC = 379,
    OF_BSN_TLV_NEGATE = 380,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 381,
    OF_BSN_TLV_NEXT_HOP_MAC = 382,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 383,
    OF_BSN_TLV_OFFSET = 384,
    OF_BSN_TLV_PARENT_PORT = 385,
    OF_BSN_TLV_PARTNER_KEY = 386,
    OF_BSN_TLV_PARTNER_PORT_NUM = 387,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 388,
    OF_BSN_TLV_PARTNER_STATE = 389,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 390,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 391,
    OF_BSN_TLV_PORT = 392,
    OF_BSN_TLV_PORT_VXLAN_MODE = 393,
    OF_BSN_TLV_PRIORITY = 394,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 395,
    OF_BSN_TLV_QOS_PRIORITY = 396,
    OF_BSN_TLV_QUEUE_ID = 397,
    OF_BSN_TLV_QUEUE_WEIGHT = 398,
    OF_BSN_TLV_RATE_LIMIT = 399,
    OF_BSN_TLV_RATE_UNIT = 400,
    OF_BSN_TLV_REFERENCE = 401,
    OF_BSN_TLV_REPLY_PACKETS = 402,
    OF_BSN_TLV_REQUEST_PACKETS = 403,
    OF_BSN_TLV_RX_BYTES = 404,
    OF_BSN_TLV_RX_PACKETS = 405,
    OF_BSN_TLV_SAMPLING_RATE = 406,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 407,
    OF_BSN_TLV_STATUS = 408,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 409,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 410,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 411,
    OF_BSN_TLV_SUB_AGENT_ID = 412,
    OF_BSN_TLV_TCP_DST = 413,
    OF_BSN_TLV_TCP_FLAGS = 414,
    OF_BSN_TLV_TCP_SRC = 415,
    OF_BSN_TLV_TTL = 416,
    OF_BSN_TLV_TX_BYTES = 417,
    OF_BSN_TLV_TX_PACKETS = 418,
    OF_BSN_TLV_UDF_ANCHOR = 419,
    OF_BSN_TLV_UDF_ID = 420,
    OF_BSN_TLV_UDF_LENGTH = 421,
    OF_BSN_TLV_UDF_OFFSET = 422,
    OF_BSN_TLV_UDP_DST = 423,
    OF_BSN_TLV_UDP_SRC = 424,
    OF_BSN_TLV_UINT64_LIST = 425,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 426,
    OF_BSN_TLV_UNICAST_RATE = 427,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 428,
    OF_BSN_TLV_UNTAGGED = 429,
    OF_BSN_TLV_USE_PACKET_STATE = 430,
    OF_BSN_TLV_VFI = 431,
    OF_BSN_TLV_VFP_CLASS_ID = 432,
    OF_BSN_TLV_VLAN_MAC_LIST = 433,
    OF_BSN_TLV_VLAN_PCP = 434,
    OF_BSN_TLV_VLAN_VID = 435,
    OF_BSN_TLV_VLAN_VID_MASK = 436,
    OF_BSN_TLV_VNI = 437,
    OF_BSN_TLV_VPN_KEY = 438,
    OF_BSN_TLV_VRF = 439,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 440,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 441,
    OF_BSN_VLAN_MAC = 442,
    OF_BSN_VPORT = 443,
    OF_BSN_VPORT_L2GRE = 444,
    OF_BSN_VPORT_Q_IN_Q = 445,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 446,
    OF_BUCKET = 447,
    OF_BUCKET_COUNTER = 448,
    OF_BUNDLE_PROP = 449,
    OF_BUNDLE_PROP_EXPERIMENTER = 450,
    OF_FLOW_STATS_ENTRY = 451,
    OF_GROUP_DESC_STATS_ENTRY = 452,
    OF_GROUP_STATS_ENTRY = 453,
    OF_HELLO_ELEM = 454,
    OF_HELLO_ELEM_VERSIONBITMAP = 455,
    OF_INSTRUCTION = 456,
    OF_INSTRUCTION_APPLY_ACTIONS = 457,
    OF_INSTRUCTION_BSN = 458,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 459,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 460,
    OF_INSTRUCTION_BSN_DENY = 461,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 462,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 463,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 464,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 465,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 466,
    OF_INSTRUCTION_BSN_HASH_SELECT = 467,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 468,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 469,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 470,
    OF_INSTRUCTION_BSN_PERMIT = 471,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 472,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 473,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 474,
    OF_INSTRUCTION_CLEAR_ACTIONS = 475,
    OF_INSTRUCTION_EXPERIMENTER = 476,
    OF_INSTRUCTION_GOTO_TABLE = 477,
    OF_INSTRUCTION_ID = 478,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 479,
    OF_INSTRUCTION_ID_BSN = 480,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 481,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 482,
    OF_INSTRUCTION_ID_BSN_DENY = 483,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 484,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 485,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 486,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 487,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 488,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 489,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 490,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 491,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 492,
    OF_INSTRUCTION_ID_BSN_PERMIT = 493,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 494,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 495,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 496,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 497,
    OF_INSTRUCTION_ID_EXPERIMENTER = 498,
    OF_INSTRUCTION_ID_GOTO_TABLE = 499,
    OF_INSTRUCTION_ID_METER = 500,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 501,
    OF_INSTRUCTION_ID_WRITE_METADATA = 502,
    OF_INSTRUCTION_METER = 503,
    OF_INSTRUCTION_WRITE_ACTIONS = 504,
    OF_INSTRUCTION_WRITE_METADATA = 505,
    OF_MATCH_V1 = 506,
    OF_MATCH_V2 = 507,
    OF_MATCH_V3 = 508,
    OF_METER_BAND = 509,
    OF_METER_BAND_DROP = 510,
    OF_METER_BAND_DSCP_REMARK = 511,
    OF_METER_BAND_EXPERIMENTER = 512,
    OF_METER_BAND_STATS = 513,
    OF_METER_CONFIG = 514,
    OF_METER_FEATURES = 515,
    OF_METER_STATS = 516,
    OF_OXM = 517,
    OF_OXM_ARP_OP = 518,
    OF_OXM_ARP_OP_MASKED = 519,
    OF_OXM_ARP_SHA = 520,
    OF_OXM_ARP_SHA_MASKED = 521,
    OF_OXM_ARP_SPA = 522,
    OF_OXM_ARP_SPA_MASKED = 523,
    OF_OXM_ARP_THA = 524,
    OF_OXM_ARP_THA_MASKED = 525,
    OF_OXM_ARP_TPA = 526,
    OF_OXM_ARP_TPA_MASKED = 527,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 528,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 529,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 530,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 531,
    OF_OXM_BSN_IN_PORTS_128 = 532,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 533,
    OF_OXM_BSN_IN_PORTS_512 = 534,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 535,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 536,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 537,
    OF_OXM_BSN_INNER_ETH_DST = 538,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 539,
    OF_OXM_BSN_INNER_ETH_SRC = 540,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 541,
    OF_OXM_BSN_INNER_VLAN_VID = 542,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 543,
    OF_OXM_BSN_L2_CACHE_HIT = 544,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 545,
    OF_OXM_BSN_L3_DST_CLASS_ID = 546,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 547,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 548,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 549,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 550,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 551,
    OF_OXM_BSN_LAG_ID = 552,
    OF_OXM_BSN_LAG_ID_MASKED = 553,
    OF_OXM_BSN_TCP_FLAGS = 554,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 555,
    OF_OXM_BSN_UDF0 = 556,
    OF_OXM_BSN_UDF0_MASKED = 557,
    OF_OXM_BSN_UDF1 = 558,
    OF_OXM_BSN_UDF1_MASKED = 559,
    OF_OXM_BSN_UDF2 = 560,
    OF_OXM_BSN_UDF2_MASKED = 561,
    OF_OXM_BSN_UDF3 = 562,
    OF_OXM_BSN_UDF3_MASKED = 563,
    OF_OXM_BSN_UDF4 = 564,
    OF_OXM_BSN_UDF4_MASKED = 565,
    OF_OXM_BSN_UDF5 = 566,
    OF_OXM_BSN_UDF5_MASKED = 567,
    OF_OXM_BSN_UDF6 = 568,
    OF_OXM_BSN_UDF6_MASKED = 569,
    OF_OXM_BSN_UDF7 = 570,
    OF_OXM_BSN_UDF7_MASKED = 571,
    OF_OXM_BSN_VFI = 572,
    OF_OXM_BSN_VFI_MASKED = 573,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 574,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 575,
    OF_OXM_BSN_VRF = 576,
    OF_OXM_BSN_VRF_MASKED = 577,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 578,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 579,
    OF_OXM_ETH_DST = 580,
    OF_OXM_ETH_DST_MASKED = 581,
    OF_OXM_ETH_SRC = 582,
    OF_OXM_ETH_SRC_MASKED = 583,
    OF_OXM_ETH_TYPE = 584,
    OF_OXM_ETH_TYPE_MASKED = 585,
    OF_OXM_ICMPV4_CODE = 586,
    OF_OXM_ICMPV4_CODE_MASKED = 587,
    OF_OXM_ICMPV4_TYPE = 588,
    OF_OXM_ICMPV4_TYPE_MASKED = 589,
    OF_OXM_ICMPV6_CODE = 590,
    OF_OXM_ICMPV6_CODE_MASKED = 591,
    OF_OXM_ICMPV6_TYPE = 592,
    OF_OXM_ICMPV6_TYPE_MASKED = 593,
    OF_OXM_IN_PHY_PORT = 594,
    OF_OXM_IN_PHY_PORT_MASKED = 595,
    OF_OXM_IN_PORT = 596,
    OF_OXM_IN_PORT_MASKED = 597,
    OF_OXM_IP_DSCP = 598,
    OF_OXM_IP_DSCP_MASKED = 599,
    OF_OXM_IP_ECN = 600,
    OF_OXM_IP_ECN_MASKED = 601,
    OF_OXM_IP_PROTO = 602,
    OF_OXM_IP_PROTO_MASKED = 603,
    OF_OXM_IPV4_DST = 604,
    OF_OXM_IPV4_DST_MASKED = 605,
    OF_OXM_IPV4_SRC = 606,
    OF_OXM_IPV4_SRC_MASKED = 607,
    OF_OXM_IPV6_DST = 608,
    OF_OXM_IPV6_DST_MASKED = 609,
    OF_OXM_IPV6_EXTHDR = 610,
    OF_OXM_IPV6_EXTHDR_MASKED = 611,
    OF_OXM_IPV6_FLABEL = 612,
    OF_OXM_IPV6_FLABEL_MASKED = 613,
    OF_OXM_IPV6_ND_SLL = 614,
    OF_OXM_IPV6_ND_SLL_MASKED = 615,
    OF_OXM_IPV6_ND_TARGET = 616,
    OF_OXM_IPV6_ND_TARGET_MASKED = 617,
    OF_OXM_IPV6_ND_TLL = 618,
    OF_OXM_IPV6_ND_TLL_MASKED = 619,
    OF_OXM_IPV6_SRC = 620,
    OF_OXM_IPV6_SRC_MASKED = 621,
    OF_OXM_METADATA = 622,
    OF_OXM_METADATA_MASKED = 623,
    OF_OXM_MPLS_BOS = 624,
    OF_OXM_MPLS_BOS_MASKED = 625,
    OF_OXM_MPLS_LABEL = 626,
    OF_OXM_MPLS_LABEL_MASKED = 627,
    OF_OXM_MPLS_TC = 628,
    OF_OXM_MPLS_TC_MASKED = 629,
    OF_OXM_OVS_TCP_FLAGS = 630,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 631,
    OF_OXM_PBB_UCA = 632,
    OF_OXM_PBB_UCA_MASKED = 633,
    OF_OXM_SCTP_DST = 634,
    OF_OXM_SCTP_DST_MASKED = 635,
    OF_OXM_SCTP_SRC = 636,
    OF_OXM_SCTP_SRC_MASKED = 637,
    OF_OXM_TCP_DST = 638,
    OF_OXM_TCP_DST_MASKED = 639,
    OF_OXM_TCP_SRC = 640,
    OF_OXM_TCP_SRC_MASKED = 641,
    OF_OXM_TUNNEL_ID = 642,
    OF_OXM_TUNNEL_ID_MASKED = 643,
    OF_OXM_TUNNEL_IPV4_DST = 644,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 645,
    OF_OXM_TUNNEL_IPV4_SRC = 646,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 647,
    OF_OXM_UDP_DST = 648,
    OF_OXM_UDP_DST_MASKED = 649,
    OF_OXM_UDP_SRC = 650,
    OF_OXM_UDP_SRC_MASKED = 651,
    OF_OXM_VLAN_PCP = 652,
    OF_OXM_VLAN_PCP_MASKED = 653,
    OF_OXM_VLAN_VID = 654,
    OF_OXM_VLAN_VID_MASKED = 655,
    OF_PACKET_QUEUE = 656,
    OF_PORT_DESC = 657,
    OF_PORT_DESC_PROP = 658,
    OF_PORT_DESC_PROP_BSN = 659,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 660,
    OF_PORT_DESC_PROP_BSN_UPLINK = 661,
    OF_PORT_DESC_PROP_ETHERNET = 662,
    OF_PORT_DESC_PROP_EXPERIMENTER = 663,
    OF_PORT_DESC_PROP_OPTICAL = 664,
    OF_PORT_MOD_PROP = 665,
    OF_PORT_MOD_PROP_ETHERNET = 666,
    OF_PORT_MOD_PROP_EXPERIMENTER = 667,
    OF_PORT_MOD_PROP_OPTICAL = 668,
    OF_PORT_STATS_ENTRY = 669,
    OF_PORT_STATS_PROP = 670,
    OF_PORT_STATS_PROP_ETHERNET = 671,
    OF_PORT_STATS_PROP_EXPERIMENTER = 672,
    OF_PORT_STATS_PROP_OPTICAL = 673,
    OF_QUEUE_DESC = 674,
    OF_QUEUE_DESC_PROP = 675,
    OF_QUEUE_DESC_PROP_BSN = 676,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 677,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 678,
    OF_QUEUE_DESC_PROP_MAX_RATE = 679,
    OF_QUEUE_DESC_PROP_MIN_RATE = 680,
    OF_QUEUE_PROP = 681,
    OF_QUEUE_PROP_EXPERIMENTER = 682,
    OF_QUEUE_PROP_MAX_RATE = 683,
    OF_QUEUE_PROP_MIN_RATE = 684,
    OF_QUEUE_STATS_ENTRY = 685,
    OF_QUEUE_STATS_PROP = 686,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 687,
    OF_ROLE_PROP = 688,
    OF_ROLE_PROP_EXPERIMENTER = 689,
    OF_TABLE_DESC = 690,
    OF_TABLE_FEATURE_PROP = 691,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 692,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 693,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 694,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 695,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 696,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 697,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 698,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 699,
    OF_TABLE_FEATURE_PROP_MATCH = 700,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 701,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 702,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 703,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 704,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 705,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 706,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 707,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 708,
    OF_TABLE_FEATURES = 709,
    OF_TABLE_MOD_PROP = 710,
    OF_TABLE_MOD_PROP_EVICTION = 711,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 712,
    OF_TABLE_MOD_PROP_VACANCY = 713,
    OF_TABLE_STATS_ENTRY = 714,
    OF_UINT32 = 715,
    OF_UINT64 = 716,
    OF_UINT8 = 717,
    ...
    /* List objects */
    OF_LIST_ACTION = 718,
    OF_LIST_ACTION_ID = 719,
    OF_LIST_ASYNC_CONFIG_PROP = 720,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 721,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 722,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 723,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 724,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 725,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 726,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 727,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 728,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 729,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 730,
    OF_LIST_BSN_INTERFACE = 731,
    OF_LIST_BSN_LACP_STATS_ENTRY = 732,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 733,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 734,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 735,
    OF_LIST_BSN_TLV = 736,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 737,
    OF_LIST_BSN_VLAN_MAC = 738,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 739,
    OF_LIST_BUCKET = 740,
    OF_LIST_BUCKET_COUNTER = 741,
    OF_LIST_BUNDLE_PROP = 742,
    OF_LIST_FLOW_STATS_ENTRY = 743,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 744,
    OF_LIST_GROUP_STATS_ENTRY = 745,
    OF_LIST_HELLO_ELEM = 746,
    OF_LIST_INSTRUCTION = 747,
    OF_LIST_INSTRUCTION_ID = 748,
    OF_LIST_METER_BAND = 749,
    OF_LIST_METER_BAND_STATS = 750,
    OF_LIST_METER_CONFIG = 751,
    OF_LIST_METER_STATS = 752,
    OF_LIST_OXM = 753,
    OF_LIST_PACKET_QUEUE = 754,
    OF_LIST_PORT_DESC = 755,
    OF_LIST_PORT_DESC_PROP = 756,
    OF_LIST_PORT_MOD_PROP = 757,
    OF_LIST_PORT_STATS_ENTRY = 758,
    OF_LIST_PORT_STATS_PROP = 759,
    OF_LIST_QUEUE_DESC = 760,
    OF_LIST_QUEUE_DESC_PROP = 761,
    OF_LIST_QUEUE_PROP = 762,
    OF_LIST_QUEUE_STATS_ENTRY = 763,
    OF_LIST_QUEUE_STATS_PROP = 764,
    OF_LIST_ROLE_PROP = 765,
    OF_LIST_TABLE_DESC = 766,
    OF_LIST_TABLE_FEATURE_PROP = 767,
    OF_LIST_TABLE_FEATURES = 768,
    OF_LIST_TABLE_MOD_PROP = 769,
    OF_LIST_TABLE_STATS_ENTRY = 770,
    OF_LIST_UINT32 = 771,
    OF_LIST_UINT64 = 772,
    OF_LIST_UINT8 = 773,
