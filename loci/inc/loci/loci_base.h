...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_CRC_ENABLED = 258,
    OF_BSN_TLV_HEADER = 259,
    OF_BSN_TLV_IDLE_NOTIFICATION = 260,
    OF_BSN_TLV_IDLE_TIME = 261,
    OF_BSN_TLV_IDLE_TIMEOUT = 262,
    OF_BSN_TLV_IPV4 = 263,
    OF_BSN_TLV_MAC = 264,
    OF_BSN_TLV_MISS_PACKETS = 265,
    OF_BSN_TLV_PORT = 266,
    OF_BSN_TLV_QUEUE_ID = 267,
    OF_BSN_TLV_QUEUE_WEIGHT = 268,
    OF_BSN_TLV_REPLY_PACKETS = 269,
    OF_BSN_TLV_REQUEST_PACKETS = 270,
    OF_BSN_TLV_RX_PACKETS = 271,
    OF_BSN_TLV_TX_PACKETS = 272,
    OF_BSN_TLV_UDF_ANCHOR = 273,
    OF_BSN_TLV_UDF_ID = 274,
    OF_BSN_TLV_UDF_LENGTH = 275,
    OF_BSN_TLV_UDF_OFFSET = 276,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 277,
    OF_BSN_TLV_VLAN_VID = 278,
    OF_BSN_TLV_VRF = 279,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 280,
    OF_BSN_VPORT = 281,
    OF_BSN_VPORT_HEADER = 282,
    OF_BSN_VPORT_L2GRE = 283,
    OF_BSN_VPORT_Q_IN_Q = 284,
    OF_BUCKET = 285,
    OF_BUCKET_COUNTER = 286,
    OF_FLOW_STATS_ENTRY = 287,
    OF_GROUP_DESC_STATS_ENTRY = 288,
    OF_GROUP_STATS_ENTRY = 289,
    OF_HELLO_ELEM = 290,
    OF_HELLO_ELEM_HEADER = 291,
    OF_HELLO_ELEM_VERSIONBITMAP = 292,
    OF_INSTRUCTION = 293,
    OF_INSTRUCTION_APPLY_ACTIONS = 294,
    OF_INSTRUCTION_BSN = 295,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 296,
    OF_INSTRUCTION_BSN_DENY = 297,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 298,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 299,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 300,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 301,
    OF_INSTRUCTION_BSN_PERMIT = 302,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 303,
    OF_INSTRUCTION_CLEAR_ACTIONS = 304,
    OF_INSTRUCTION_EXPERIMENTER = 305,
    OF_INSTRUCTION_GOTO_TABLE = 306,
    OF_INSTRUCTION_HEADER = 307,
    OF_INSTRUCTION_ID = 308,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 309,
    OF_INSTRUCTION_ID_BSN = 310,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 311,
    OF_INSTRUCTION_ID_BSN_DENY = 312,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 313,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 314,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 315,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 316,
    OF_INSTRUCTION_ID_BSN_PERMIT = 317,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 318,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 319,
    OF_INSTRUCTION_ID_EXPERIMENTER = 320,
    OF_INSTRUCTION_ID_GOTO_TABLE = 321,
    OF_INSTRUCTION_ID_HEADER = 322,
    OF_INSTRUCTION_ID_METER = 323,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 324,
    OF_INSTRUCTION_ID_WRITE_METADATA = 325,
    OF_INSTRUCTION_METER = 326,
    OF_INSTRUCTION_WRITE_ACTIONS = 327,
    OF_INSTRUCTION_WRITE_METADATA = 328,
    OF_MATCH_V1 = 329,
    OF_MATCH_V2 = 330,
    OF_MATCH_V3 = 331,
    OF_METER_BAND = 332,
    OF_METER_BAND_DROP = 333,
    OF_METER_BAND_DSCP_REMARK = 334,
    OF_METER_BAND_EXPERIMENTER = 335,
    OF_METER_BAND_HEADER = 336,
    OF_METER_BAND_STATS = 337,
    OF_METER_CONFIG = 338,
    OF_METER_FEATURES = 339,
    OF_METER_STATS = 340,
    OF_OXM = 341,
    OF_OXM_ARP_OP = 342,
    OF_OXM_ARP_OP_MASKED = 343,
    OF_OXM_ARP_SHA = 344,
    OF_OXM_ARP_SHA_MASKED = 345,
    OF_OXM_ARP_SPA = 346,
    OF_OXM_ARP_SPA_MASKED = 347,
    OF_OXM_ARP_THA = 348,
    OF_OXM_ARP_THA_MASKED = 349,
    OF_OXM_ARP_TPA = 350,
    OF_OXM_ARP_TPA_MASKED = 351,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 352,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 353,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 354,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 355,
    OF_OXM_BSN_IN_PORTS_128 = 356,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 357,
    OF_OXM_BSN_L3_DST_CLASS_ID = 358,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 359,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 360,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 361,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 362,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 363,
    OF_OXM_BSN_LAG_ID = 364,
    OF_OXM_BSN_LAG_ID_MASKED = 365,
    OF_OXM_BSN_TCP_FLAGS = 366,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 367,
    OF_OXM_BSN_UDF0 = 368,
    OF_OXM_BSN_UDF0_MASKED = 369,
    OF_OXM_BSN_UDF1 = 370,
    OF_OXM_BSN_UDF1_MASKED = 371,
    OF_OXM_BSN_UDF2 = 372,
    OF_OXM_BSN_UDF2_MASKED = 373,
    OF_OXM_BSN_UDF3 = 374,
    OF_OXM_BSN_UDF3_MASKED = 375,
    OF_OXM_BSN_UDF4 = 376,
    OF_OXM_BSN_UDF4_MASKED = 377,
    OF_OXM_BSN_UDF5 = 378,
    OF_OXM_BSN_UDF5_MASKED = 379,
    OF_OXM_BSN_UDF6 = 380,
    OF_OXM_BSN_UDF6_MASKED = 381,
    OF_OXM_BSN_UDF7 = 382,
    OF_OXM_BSN_UDF7_MASKED = 383,
    OF_OXM_BSN_VRF = 384,
    OF_OXM_BSN_VRF_MASKED = 385,
    OF_OXM_ETH_DST = 386,
    OF_OXM_ETH_DST_MASKED = 387,
    OF_OXM_ETH_SRC = 388,
    OF_OXM_ETH_SRC_MASKED = 389,
    OF_OXM_ETH_TYPE = 390,
    OF_OXM_ETH_TYPE_MASKED = 391,
    OF_OXM_HEADER = 392,
    OF_OXM_ICMPV4_CODE = 393,
    OF_OXM_ICMPV4_CODE_MASKED = 394,
    OF_OXM_ICMPV4_TYPE = 395,
    OF_OXM_ICMPV4_TYPE_MASKED = 396,
    OF_OXM_ICMPV6_CODE = 397,
    OF_OXM_ICMPV6_CODE_MASKED = 398,
    OF_OXM_ICMPV6_TYPE = 399,
    OF_OXM_ICMPV6_TYPE_MASKED = 400,
    OF_OXM_IN_PHY_PORT = 401,
    OF_OXM_IN_PHY_PORT_MASKED = 402,
    OF_OXM_IN_PORT = 403,
    OF_OXM_IN_PORT_MASKED = 404,
    OF_OXM_IP_DSCP = 405,
    OF_OXM_IP_DSCP_MASKED = 406,
    OF_OXM_IP_ECN = 407,
    OF_OXM_IP_ECN_MASKED = 408,
    OF_OXM_IP_PROTO = 409,
    OF_OXM_IP_PROTO_MASKED = 410,
    OF_OXM_IPV4_DST = 411,
    OF_OXM_IPV4_DST_MASKED = 412,
    OF_OXM_IPV4_SRC = 413,
    OF_OXM_IPV4_SRC_MASKED = 414,
    OF_OXM_IPV6_DST = 415,
    OF_OXM_IPV6_DST_MASKED = 416,
    OF_OXM_IPV6_FLABEL = 417,
    OF_OXM_IPV6_FLABEL_MASKED = 418,
    OF_OXM_IPV6_ND_SLL = 419,
    OF_OXM_IPV6_ND_SLL_MASKED = 420,
    OF_OXM_IPV6_ND_TARGET = 421,
    OF_OXM_IPV6_ND_TARGET_MASKED = 422,
    OF_OXM_IPV6_ND_TLL = 423,
    OF_OXM_IPV6_ND_TLL_MASKED = 424,
    OF_OXM_IPV6_SRC = 425,
    OF_OXM_IPV6_SRC_MASKED = 426,
    OF_OXM_METADATA = 427,
    OF_OXM_METADATA_MASKED = 428,
    OF_OXM_MPLS_LABEL = 429,
    OF_OXM_MPLS_LABEL_MASKED = 430,
    OF_OXM_MPLS_TC = 431,
    OF_OXM_MPLS_TC_MASKED = 432,
    OF_OXM_SCTP_DST = 433,
    OF_OXM_SCTP_DST_MASKED = 434,
    OF_OXM_SCTP_SRC = 435,
    OF_OXM_SCTP_SRC_MASKED = 436,
    OF_OXM_TCP_DST = 437,
    OF_OXM_TCP_DST_MASKED = 438,
    OF_OXM_TCP_SRC = 439,
    OF_OXM_TCP_SRC_MASKED = 440,
    OF_OXM_TUNNEL_ID = 441,
    OF_OXM_TUNNEL_ID_MASKED = 442,
    OF_OXM_UDP_DST = 443,
    OF_OXM_UDP_DST_MASKED = 444,
    OF_OXM_UDP_SRC = 445,
    OF_OXM_UDP_SRC_MASKED = 446,
    OF_OXM_VLAN_PCP = 447,
    OF_OXM_VLAN_PCP_MASKED = 448,
    OF_OXM_VLAN_VID = 449,
    OF_OXM_VLAN_VID_MASKED = 450,
    OF_PACKET_QUEUE = 451,
    OF_PORT_DESC = 452,
    OF_PORT_STATS_ENTRY = 453,
    OF_QUEUE_PROP = 454,
    OF_QUEUE_PROP_EXPERIMENTER = 455,
    OF_QUEUE_PROP_HEADER = 456,
    OF_QUEUE_PROP_MAX_RATE = 457,
    OF_QUEUE_PROP_MIN_RATE = 458,
    OF_QUEUE_STATS_ENTRY = 459,
    OF_TABLE_FEATURE_PROP = 460,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 461,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 462,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 463,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 464,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 465,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 466,
    OF_TABLE_FEATURE_PROP_HEADER = 467,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 468,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 469,
    OF_TABLE_FEATURE_PROP_MATCH = 470,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 471,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 472,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 473,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 474,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 475,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 476,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 477,
    OF_TABLE_FEATURES = 478,
    OF_TABLE_STATS_ENTRY = 479,
    OF_UINT32 = 480,
    OF_UINT64 = 481,
    OF_UINT8 = 482,
    ...
    /* List objects */
    OF_LIST_ACTION = 483,
    OF_LIST_ACTION_ID = 484,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 485,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 486,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 487,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 488,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 489,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 490,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 491,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 492,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 493,
    OF_LIST_BSN_INTERFACE = 494,
    OF_LIST_BSN_LACP_STATS_ENTRY = 495,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 496,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 497,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 498,
    OF_LIST_BSN_TLV = 499,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 500,
    OF_LIST_BUCKET = 501,
    OF_LIST_BUCKET_COUNTER = 502,
    OF_LIST_FLOW_STATS_ENTRY = 503,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 504,
    OF_LIST_GROUP_STATS_ENTRY = 505,
    OF_LIST_HELLO_ELEM = 506,
    OF_LIST_INSTRUCTION = 507,
    OF_LIST_INSTRUCTION_ID = 508,
    OF_LIST_METER_BAND = 509,
    OF_LIST_METER_BAND_STATS = 510,
    OF_LIST_METER_STATS = 511,
    OF_LIST_OXM = 512,
    OF_LIST_PACKET_QUEUE = 513,
    OF_LIST_PORT_DESC = 514,
    OF_LIST_PORT_STATS_ENTRY = 515,
    OF_LIST_QUEUE_PROP = 516,
    OF_LIST_QUEUE_STATS_ENTRY = 517,
    OF_LIST_TABLE_FEATURE_PROP = 518,
    OF_LIST_TABLE_FEATURES = 519,
    OF_LIST_TABLE_STATS_ENTRY = 520,
    OF_LIST_UINT32 = 521,
    OF_LIST_UINT64 = 522,
    OF_LIST_UINT8 = 523,
