...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_OFFSET = 390,
    OF_BSN_TLV_PARENT_PORT = 391,
    OF_BSN_TLV_PARTNER_KEY = 392,
    OF_BSN_TLV_PARTNER_PORT_NUM = 393,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 394,
    OF_BSN_TLV_PARTNER_STATE = 395,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 396,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 397,
    OF_BSN_TLV_PORT = 398,
    OF_BSN_TLV_PORT_USAGE = 399,
    OF_BSN_TLV_PORT_VXLAN_MODE = 400,
    OF_BSN_TLV_PRIORITY = 401,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 402,
    OF_BSN_TLV_QOS_PRIORITY = 403,
    OF_BSN_TLV_QUEUE_ID = 404,
    OF_BSN_TLV_QUEUE_WEIGHT = 405,
    OF_BSN_TLV_RATE_LIMIT = 406,
    OF_BSN_TLV_RATE_UNIT = 407,
    OF_BSN_TLV_REFERENCE = 408,
    OF_BSN_TLV_REPLY_PACKETS = 409,
    OF_BSN_TLV_REQUEST_PACKETS = 410,
    OF_BSN_TLV_RX_BYTES = 411,
    OF_BSN_TLV_RX_PACKETS = 412,
    OF_BSN_TLV_SAMPLING_RATE = 413,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 414,
    OF_BSN_TLV_STATUS = 415,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 416,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 417,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 418,
    OF_BSN_TLV_SUB_AGENT_ID = 419,
    OF_BSN_TLV_TCP_DST = 420,
    OF_BSN_TLV_TCP_FLAGS = 421,
    OF_BSN_TLV_TCP_SRC = 422,
    OF_BSN_TLV_TTL = 423,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 424,
    OF_BSN_TLV_TX_BYTES = 425,
    OF_BSN_TLV_TX_PACKETS = 426,
    OF_BSN_TLV_UDF_ANCHOR = 427,
    OF_BSN_TLV_UDF_ID = 428,
    OF_BSN_TLV_UDF_LENGTH = 429,
    OF_BSN_TLV_UDF_OFFSET = 430,
    OF_BSN_TLV_UDP_DST = 431,
    OF_BSN_TLV_UDP_SRC = 432,
    OF_BSN_TLV_UINT64_LIST = 433,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 434,
    OF_BSN_TLV_UNICAST_RATE = 435,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 436,
    OF_BSN_TLV_UNTAGGED = 437,
    OF_BSN_TLV_USE_PACKET_STATE = 438,
    OF_BSN_TLV_VFI = 439,
    OF_BSN_TLV_VFP_CLASS_ID = 440,
    OF_BSN_TLV_VLAN_MAC_LIST = 441,
    OF_BSN_TLV_VLAN_PCP = 442,
    OF_BSN_TLV_VLAN_VID = 443,
    OF_BSN_TLV_VLAN_VID_MASK = 444,
    OF_BSN_TLV_VNI = 445,
    OF_BSN_TLV_VPN_KEY = 446,
    OF_BSN_TLV_VRF = 447,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 448,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 449,
    OF_BSN_VLAN_MAC = 450,
    OF_BSN_VPORT = 451,
    OF_BSN_VPORT_L2GRE = 452,
    OF_BSN_VPORT_Q_IN_Q = 453,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 454,
    OF_BUCKET = 455,
    OF_BUCKET_COUNTER = 456,
    OF_BUNDLE_PROP = 457,
    OF_BUNDLE_PROP_EXPERIMENTER = 458,
    OF_FLOW_STATS_ENTRY = 459,
    OF_GROUP_DESC_STATS_ENTRY = 460,
    OF_GROUP_STATS_ENTRY = 461,
    OF_HELLO_ELEM = 462,
    OF_HELLO_ELEM_VERSIONBITMAP = 463,
    OF_INSTRUCTION = 464,
    OF_INSTRUCTION_APPLY_ACTIONS = 465,
    OF_INSTRUCTION_BSN = 466,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 467,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 468,
    OF_INSTRUCTION_BSN_DENY = 469,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 470,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 471,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 472,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 473,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 474,
    OF_INSTRUCTION_BSN_HASH_SELECT = 475,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 476,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 477,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 478,
    OF_INSTRUCTION_BSN_PERMIT = 479,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 480,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 481,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 482,
    OF_INSTRUCTION_CLEAR_ACTIONS = 483,
    OF_INSTRUCTION_EXPERIMENTER = 484,
    OF_INSTRUCTION_GOTO_TABLE = 485,
    OF_INSTRUCTION_ID = 486,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 487,
    OF_INSTRUCTION_ID_BSN = 488,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 489,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 490,
    OF_INSTRUCTION_ID_BSN_DENY = 491,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 492,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 493,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 494,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 495,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 496,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 497,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 498,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 499,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 500,
    OF_INSTRUCTION_ID_BSN_PERMIT = 501,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 502,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 503,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 504,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 505,
    OF_INSTRUCTION_ID_EXPERIMENTER = 506,
    OF_INSTRUCTION_ID_GOTO_TABLE = 507,
    OF_INSTRUCTION_ID_METER = 508,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 509,
    OF_INSTRUCTION_ID_WRITE_METADATA = 510,
    OF_INSTRUCTION_METER = 511,
    OF_INSTRUCTION_WRITE_ACTIONS = 512,
    OF_INSTRUCTION_WRITE_METADATA = 513,
    OF_MATCH_V1 = 514,
    OF_MATCH_V2 = 515,
    OF_MATCH_V3 = 516,
    OF_METER_BAND = 517,
    OF_METER_BAND_DROP = 518,
    OF_METER_BAND_DSCP_REMARK = 519,
    OF_METER_BAND_EXPERIMENTER = 520,
    OF_METER_BAND_STATS = 521,
    OF_METER_CONFIG = 522,
    OF_METER_FEATURES = 523,
    OF_METER_STATS = 524,
    OF_OXM = 525,
    OF_OXM_ARP_OP = 526,
    OF_OXM_ARP_OP_MASKED = 527,
    OF_OXM_ARP_SHA = 528,
    OF_OXM_ARP_SHA_MASKED = 529,
    OF_OXM_ARP_SPA = 530,
    OF_OXM_ARP_SPA_MASKED = 531,
    OF_OXM_ARP_THA = 532,
    OF_OXM_ARP_THA_MASKED = 533,
    OF_OXM_ARP_TPA = 534,
    OF_OXM_ARP_TPA_MASKED = 535,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 536,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 537,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 538,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 539,
    OF_OXM_BSN_IN_PORTS_128 = 540,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 541,
    OF_OXM_BSN_IN_PORTS_512 = 542,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 543,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 544,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 545,
    OF_OXM_BSN_INNER_ETH_DST = 546,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 547,
    OF_OXM_BSN_INNER_ETH_SRC = 548,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 549,
    OF_OXM_BSN_INNER_VLAN_VID = 550,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 551,
    OF_OXM_BSN_IP_FRAGMENTATION = 552,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 553,
    OF_OXM_BSN_L2_CACHE_HIT = 554,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 555,
    OF_OXM_BSN_L3_DST_CLASS_ID = 556,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 557,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 558,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 559,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 560,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 561,
    OF_OXM_BSN_LAG_ID = 562,
    OF_OXM_BSN_LAG_ID_MASKED = 563,
    OF_OXM_BSN_TCP_FLAGS = 564,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 565,
    OF_OXM_BSN_UDF0 = 566,
    OF_OXM_BSN_UDF0_MASKED = 567,
    OF_OXM_BSN_UDF1 = 568,
    OF_OXM_BSN_UDF1_MASKED = 569,
    OF_OXM_BSN_UDF2 = 570,
    OF_OXM_BSN_UDF2_MASKED = 571,
    OF_OXM_BSN_UDF3 = 572,
    OF_OXM_BSN_UDF3_MASKED = 573,
    OF_OXM_BSN_UDF4 = 574,
    OF_OXM_BSN_UDF4_MASKED = 575,
    OF_OXM_BSN_UDF5 = 576,
    OF_OXM_BSN_UDF5_MASKED = 577,
    OF_OXM_BSN_UDF6 = 578,
    OF_OXM_BSN_UDF6_MASKED = 579,
    OF_OXM_BSN_UDF7 = 580,
    OF_OXM_BSN_UDF7_MASKED = 581,
    OF_OXM_BSN_VFI = 582,
    OF_OXM_BSN_VFI_MASKED = 583,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 584,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 585,
    OF_OXM_BSN_VRF = 586,
    OF_OXM_BSN_VRF_MASKED = 587,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 588,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 589,
    OF_OXM_ETH_DST = 590,
    OF_OXM_ETH_DST_MASKED = 591,
    OF_OXM_ETH_SRC = 592,
    OF_OXM_ETH_SRC_MASKED = 593,
    OF_OXM_ETH_TYPE = 594,
    OF_OXM_ETH_TYPE_MASKED = 595,
    OF_OXM_ICMPV4_CODE = 596,
    OF_OXM_ICMPV4_CODE_MASKED = 597,
    OF_OXM_ICMPV4_TYPE = 598,
    OF_OXM_ICMPV4_TYPE_MASKED = 599,
    OF_OXM_ICMPV6_CODE = 600,
    OF_OXM_ICMPV6_CODE_MASKED = 601,
    OF_OXM_ICMPV6_TYPE = 602,
    OF_OXM_ICMPV6_TYPE_MASKED = 603,
    OF_OXM_IN_PHY_PORT = 604,
    OF_OXM_IN_PHY_PORT_MASKED = 605,
    OF_OXM_IN_PORT = 606,
    OF_OXM_IN_PORT_MASKED = 607,
    OF_OXM_IP_DSCP = 608,
    OF_OXM_IP_DSCP_MASKED = 609,
    OF_OXM_IP_ECN = 610,
    OF_OXM_IP_ECN_MASKED = 611,
    OF_OXM_IP_PROTO = 612,
    OF_OXM_IP_PROTO_MASKED = 613,
    OF_OXM_IPV4_DST = 614,
    OF_OXM_IPV4_DST_MASKED = 615,
    OF_OXM_IPV4_SRC = 616,
    OF_OXM_IPV4_SRC_MASKED = 617,
    OF_OXM_IPV6_DST = 618,
    OF_OXM_IPV6_DST_MASKED = 619,
    OF_OXM_IPV6_EXTHDR = 620,
    OF_OXM_IPV6_EXTHDR_MASKED = 621,
    OF_OXM_IPV6_FLABEL = 622,
    OF_OXM_IPV6_FLABEL_MASKED = 623,
    OF_OXM_IPV6_ND_SLL = 624,
    OF_OXM_IPV6_ND_SLL_MASKED = 625,
    OF_OXM_IPV6_ND_TARGET = 626,
    OF_OXM_IPV6_ND_TARGET_MASKED = 627,
    OF_OXM_IPV6_ND_TLL = 628,
    OF_OXM_IPV6_ND_TLL_MASKED = 629,
    OF_OXM_IPV6_SRC = 630,
    OF_OXM_IPV6_SRC_MASKED = 631,
    OF_OXM_METADATA = 632,
    OF_OXM_METADATA_MASKED = 633,
    OF_OXM_MPLS_BOS = 634,
    OF_OXM_MPLS_BOS_MASKED = 635,
    OF_OXM_MPLS_LABEL = 636,
    OF_OXM_MPLS_LABEL_MASKED = 637,
    OF_OXM_MPLS_TC = 638,
    OF_OXM_MPLS_TC_MASKED = 639,
    OF_OXM_OVS_TCP_FLAGS = 640,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 641,
    OF_OXM_PBB_UCA = 642,
    OF_OXM_PBB_UCA_MASKED = 643,
    OF_OXM_SCTP_DST = 644,
    OF_OXM_SCTP_DST_MASKED = 645,
    OF_OXM_SCTP_SRC = 646,
    OF_OXM_SCTP_SRC_MASKED = 647,
    OF_OXM_TCP_DST = 648,
    OF_OXM_TCP_DST_MASKED = 649,
    OF_OXM_TCP_SRC = 650,
    OF_OXM_TCP_SRC_MASKED = 651,
    OF_OXM_TUNNEL_ID = 652,
    OF_OXM_TUNNEL_ID_MASKED = 653,
    OF_OXM_TUNNEL_IPV4_DST = 654,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 655,
    OF_OXM_TUNNEL_IPV4_SRC = 656,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 657,
    OF_OXM_UDP_DST = 658,
    OF_OXM_UDP_DST_MASKED = 659,
    OF_OXM_UDP_SRC = 660,
    OF_OXM_UDP_SRC_MASKED = 661,
    OF_OXM_VLAN_PCP = 662,
    OF_OXM_VLAN_PCP_MASKED = 663,
    OF_OXM_VLAN_VID = 664,
    OF_OXM_VLAN_VID_MASKED = 665,
    OF_PACKET_QUEUE = 666,
    OF_PORT_DESC = 667,
    OF_PORT_DESC_PROP = 668,
    OF_PORT_DESC_PROP_BSN = 669,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 670,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 671,
    OF_PORT_DESC_PROP_BSN_UPLINK = 672,
    OF_PORT_DESC_PROP_ETHERNET = 673,
    OF_PORT_DESC_PROP_EXPERIMENTER = 674,
    OF_PORT_DESC_PROP_OPTICAL = 675,
    OF_PORT_MOD_PROP = 676,
    OF_PORT_MOD_PROP_ETHERNET = 677,
    OF_PORT_MOD_PROP_EXPERIMENTER = 678,
    OF_PORT_MOD_PROP_OPTICAL = 679,
    OF_PORT_STATS_ENTRY = 680,
    OF_PORT_STATS_PROP = 681,
    OF_PORT_STATS_PROP_ETHERNET = 682,
    OF_PORT_STATS_PROP_EXPERIMENTER = 683,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 684,
    OF_PORT_STATS_PROP_OPTICAL = 685,
    OF_QUEUE_DESC = 686,
    OF_QUEUE_DESC_PROP = 687,
    OF_QUEUE_DESC_PROP_BSN = 688,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 689,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 690,
    OF_QUEUE_DESC_PROP_MAX_RATE = 691,
    OF_QUEUE_DESC_PROP_MIN_RATE = 692,
    OF_QUEUE_PROP = 693,
    OF_QUEUE_PROP_EXPERIMENTER = 694,
    OF_QUEUE_PROP_MAX_RATE = 695,
    OF_QUEUE_PROP_MIN_RATE = 696,
    OF_QUEUE_STATS_ENTRY = 697,
    OF_QUEUE_STATS_PROP = 698,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 699,
    OF_ROLE_PROP = 700,
    OF_ROLE_PROP_EXPERIMENTER = 701,
    OF_TABLE_DESC = 702,
    OF_TABLE_FEATURE_PROP = 703,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 704,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 705,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 706,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 707,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 708,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 709,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 710,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 711,
    OF_TABLE_FEATURE_PROP_MATCH = 712,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 713,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 714,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 715,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 716,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 717,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 718,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 719,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 720,
    OF_TABLE_FEATURES = 721,
    OF_TABLE_MOD_PROP = 722,
    OF_TABLE_MOD_PROP_EVICTION = 723,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 724,
    OF_TABLE_MOD_PROP_VACANCY = 725,
    OF_TABLE_STATS_ENTRY = 726,
    OF_UINT32 = 727,
    OF_UINT64 = 728,
    OF_UINT8 = 729,
    ...
    /* List objects */
    OF_LIST_ACTION = 730,
    OF_LIST_ACTION_ID = 731,
    OF_LIST_ASYNC_CONFIG_PROP = 732,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 733,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 734,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 735,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 736,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 737,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 738,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 739,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 740,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 741,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 742,
    OF_LIST_BSN_INTERFACE = 743,
    OF_LIST_BSN_LACP_STATS_ENTRY = 744,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 745,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 746,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 747,
    OF_LIST_BSN_TLV = 748,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 749,
    OF_LIST_BSN_VLAN_MAC = 750,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 751,
    OF_LIST_BUCKET = 752,
    OF_LIST_BUCKET_COUNTER = 753,
    OF_LIST_BUNDLE_PROP = 754,
    OF_LIST_FLOW_STATS_ENTRY = 755,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 756,
    OF_LIST_GROUP_STATS_ENTRY = 757,
    OF_LIST_HELLO_ELEM = 758,
    OF_LIST_INSTRUCTION = 759,
    OF_LIST_INSTRUCTION_ID = 760,
    OF_LIST_METER_BAND = 761,
    OF_LIST_METER_BAND_STATS = 762,
    OF_LIST_METER_CONFIG = 763,
    OF_LIST_METER_STATS = 764,
    OF_LIST_OXM = 765,
    OF_LIST_PACKET_QUEUE = 766,
    OF_LIST_PORT_DESC = 767,
    OF_LIST_PORT_DESC_PROP = 768,
    OF_LIST_PORT_MOD_PROP = 769,
    OF_LIST_PORT_STATS_ENTRY = 770,
    OF_LIST_PORT_STATS_PROP = 771,
    OF_LIST_QUEUE_DESC = 772,
    OF_LIST_QUEUE_DESC_PROP = 773,
    OF_LIST_QUEUE_PROP = 774,
    OF_LIST_QUEUE_STATS_ENTRY = 775,
    OF_LIST_QUEUE_STATS_PROP = 776,
    OF_LIST_ROLE_PROP = 777,
    OF_LIST_TABLE_DESC = 778,
    OF_LIST_TABLE_FEATURE_PROP = 779,
    OF_LIST_TABLE_FEATURES = 780,
    OF_LIST_TABLE_MOD_PROP = 781,
    OF_LIST_TABLE_STATS_ENTRY = 782,
    OF_LIST_UINT32 = 783,
    OF_LIST_UINT64 = 784,
    OF_LIST_UINT8 = 785,
