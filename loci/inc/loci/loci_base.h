...
typedef enum of_object_id_e {
    ...
    OF_ACTION = 182,
    OF_ACTION_BSN = 183,
    OF_ACTION_BSN_MIRROR = 184,
    OF_ACTION_BSN_SET_TUNNEL_DST = 185,
    OF_ACTION_COPY_TTL_IN = 186,
    OF_ACTION_COPY_TTL_OUT = 187,
    OF_ACTION_DEC_MPLS_TTL = 188,
    OF_ACTION_DEC_NW_TTL = 189,
    OF_ACTION_ENQUEUE = 190,
    OF_ACTION_EXPERIMENTER = 191,
    OF_ACTION_GROUP = 192,
    OF_ACTION_HEADER = 193,
    OF_ACTION_ID = 194,
    OF_ACTION_ID_BSN = 195,
    OF_ACTION_ID_BSN_MIRROR = 196,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 197,
    OF_ACTION_ID_COPY_TTL_IN = 198,
    OF_ACTION_ID_COPY_TTL_OUT = 199,
    OF_ACTION_ID_DEC_MPLS_TTL = 200,
    OF_ACTION_ID_DEC_NW_TTL = 201,
    OF_ACTION_ID_EXPERIMENTER = 202,
    OF_ACTION_ID_GROUP = 203,
    OF_ACTION_ID_HEADER = 204,
    OF_ACTION_ID_NICIRA = 205,
    OF_ACTION_ID_NICIRA_DEC_TTL = 206,
    OF_ACTION_ID_OUTPUT = 207,
    OF_ACTION_ID_POP_MPLS = 208,
    OF_ACTION_ID_POP_PBB = 209,
    OF_ACTION_ID_POP_VLAN = 210,
    OF_ACTION_ID_PUSH_MPLS = 211,
    OF_ACTION_ID_PUSH_PBB = 212,
    OF_ACTION_ID_PUSH_VLAN = 213,
    OF_ACTION_ID_SET_FIELD = 214,
    OF_ACTION_ID_SET_MPLS_TTL = 215,
    OF_ACTION_ID_SET_NW_TTL = 216,
    OF_ACTION_ID_SET_QUEUE = 217,
    OF_ACTION_NICIRA = 218,
    OF_ACTION_NICIRA_DEC_TTL = 219,
    OF_ACTION_OUTPUT = 220,
    OF_ACTION_POP_MPLS = 221,
    OF_ACTION_POP_PBB = 222,
    OF_ACTION_POP_VLAN = 223,
    OF_ACTION_PUSH_MPLS = 224,
    OF_ACTION_PUSH_PBB = 225,
    OF_ACTION_PUSH_VLAN = 226,
    OF_ACTION_SET_DL_DST = 227,
    OF_ACTION_SET_DL_SRC = 228,
    OF_ACTION_SET_FIELD = 229,
    OF_ACTION_SET_MPLS_LABEL = 230,
    OF_ACTION_SET_MPLS_TC = 231,
    OF_ACTION_SET_MPLS_TTL = 232,
    OF_ACTION_SET_NW_DST = 233,
    OF_ACTION_SET_NW_ECN = 234,
    OF_ACTION_SET_NW_SRC = 235,
    OF_ACTION_SET_NW_TOS = 236,
    OF_ACTION_SET_NW_TTL = 237,
    OF_ACTION_SET_QUEUE = 238,
    OF_ACTION_SET_TP_DST = 239,
    OF_ACTION_SET_TP_SRC = 240,
    OF_ACTION_SET_VLAN_PCP = 241,
    OF_ACTION_SET_VLAN_VID = 242,
    OF_ACTION_STRIP_VLAN = 243,
    OF_BSN_CONTROLLER_CONNECTION = 244,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 245,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 246,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 247,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 248,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 249,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 250,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 251,
    OF_BSN_GENTABLE_STATS_ENTRY = 252,
    OF_BSN_INTERFACE = 253,
    OF_BSN_LACP_STATS_ENTRY = 254,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 255,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 256,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 257,
    OF_BSN_TLV = 258,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 259,
    OF_BSN_TLV_CIRCUIT_ID = 260,
    OF_BSN_TLV_CRC_ENABLED = 261,
    OF_BSN_TLV_HEADER = 262,
    OF_BSN_TLV_IDLE_NOTIFICATION = 263,
    OF_BSN_TLV_IDLE_TIME = 264,
    OF_BSN_TLV_IDLE_TIMEOUT = 265,
    OF_BSN_TLV_IPV4 = 266,
    OF_BSN_TLV_MAC = 267,
    OF_BSN_TLV_MISS_PACKETS = 268,
    OF_BSN_TLV_PORT = 269,
    OF_BSN_TLV_QUEUE_ID = 270,
    OF_BSN_TLV_QUEUE_WEIGHT = 271,
    OF_BSN_TLV_REPLY_PACKETS = 272,
    OF_BSN_TLV_REQUEST_PACKETS = 273,
    OF_BSN_TLV_RX_PACKETS = 274,
    OF_BSN_TLV_TX_PACKETS = 275,
    OF_BSN_TLV_UDF_ANCHOR = 276,
    OF_BSN_TLV_UDF_ID = 277,
    OF_BSN_TLV_UDF_LENGTH = 278,
    OF_BSN_TLV_UDF_OFFSET = 279,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 280,
    OF_BSN_TLV_VLAN_VID = 281,
    OF_BSN_TLV_VRF = 282,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 283,
    OF_BSN_VPORT = 284,
    OF_BSN_VPORT_HEADER = 285,
    OF_BSN_VPORT_L2GRE = 286,
    OF_BSN_VPORT_Q_IN_Q = 287,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 288,
    OF_BUCKET = 289,
    OF_BUCKET_COUNTER = 290,
    OF_FLOW_STATS_ENTRY = 291,
    OF_GROUP_DESC_STATS_ENTRY = 292,
    OF_GROUP_STATS_ENTRY = 293,
    OF_HELLO_ELEM = 294,
    OF_HELLO_ELEM_HEADER = 295,
    OF_HELLO_ELEM_VERSIONBITMAP = 296,
    OF_INSTRUCTION = 297,
    OF_INSTRUCTION_APPLY_ACTIONS = 298,
    OF_INSTRUCTION_BSN = 299,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 300,
    OF_INSTRUCTION_BSN_DENY = 301,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 302,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 303,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 304,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 305,
    OF_INSTRUCTION_BSN_PERMIT = 306,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 307,
    OF_INSTRUCTION_CLEAR_ACTIONS = 308,
    OF_INSTRUCTION_EXPERIMENTER = 309,
    OF_INSTRUCTION_GOTO_TABLE = 310,
    OF_INSTRUCTION_HEADER = 311,
    OF_INSTRUCTION_ID = 312,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 313,
    OF_INSTRUCTION_ID_BSN = 314,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 315,
    OF_INSTRUCTION_ID_BSN_DENY = 316,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 317,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 318,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 319,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 320,
    OF_INSTRUCTION_ID_BSN_PERMIT = 321,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 322,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 323,
    OF_INSTRUCTION_ID_EXPERIMENTER = 324,
    OF_INSTRUCTION_ID_GOTO_TABLE = 325,
    OF_INSTRUCTION_ID_HEADER = 326,
    OF_INSTRUCTION_ID_METER = 327,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 328,
    OF_INSTRUCTION_ID_WRITE_METADATA = 329,
    OF_INSTRUCTION_METER = 330,
    OF_INSTRUCTION_WRITE_ACTIONS = 331,
    OF_INSTRUCTION_WRITE_METADATA = 332,
    OF_MATCH_V1 = 333,
    OF_MATCH_V2 = 334,
    OF_MATCH_V3 = 335,
    OF_METER_BAND = 336,
    OF_METER_BAND_DROP = 337,
    OF_METER_BAND_DSCP_REMARK = 338,
    OF_METER_BAND_EXPERIMENTER = 339,
    OF_METER_BAND_HEADER = 340,
    OF_METER_BAND_STATS = 341,
    OF_METER_CONFIG = 342,
    OF_METER_FEATURES = 343,
    OF_METER_STATS = 344,
    OF_OXM = 345,
    OF_OXM_ARP_OP = 346,
    OF_OXM_ARP_OP_MASKED = 347,
    OF_OXM_ARP_SHA = 348,
    OF_OXM_ARP_SHA_MASKED = 349,
    OF_OXM_ARP_SPA = 350,
    OF_OXM_ARP_SPA_MASKED = 351,
    OF_OXM_ARP_THA = 352,
    OF_OXM_ARP_THA_MASKED = 353,
    OF_OXM_ARP_TPA = 354,
    OF_OXM_ARP_TPA_MASKED = 355,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 356,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 357,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 358,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 359,
    OF_OXM_BSN_IN_PORTS_128 = 360,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 361,
    OF_OXM_BSN_L3_DST_CLASS_ID = 362,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 363,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 364,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 365,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 366,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 367,
    OF_OXM_BSN_LAG_ID = 368,
    OF_OXM_BSN_LAG_ID_MASKED = 369,
    OF_OXM_BSN_TCP_FLAGS = 370,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 371,
    OF_OXM_BSN_UDF0 = 372,
    OF_OXM_BSN_UDF0_MASKED = 373,
    OF_OXM_BSN_UDF1 = 374,
    OF_OXM_BSN_UDF1_MASKED = 375,
    OF_OXM_BSN_UDF2 = 376,
    OF_OXM_BSN_UDF2_MASKED = 377,
    OF_OXM_BSN_UDF3 = 378,
    OF_OXM_BSN_UDF3_MASKED = 379,
    OF_OXM_BSN_UDF4 = 380,
    OF_OXM_BSN_UDF4_MASKED = 381,
    OF_OXM_BSN_UDF5 = 382,
    OF_OXM_BSN_UDF5_MASKED = 383,
    OF_OXM_BSN_UDF6 = 384,
    OF_OXM_BSN_UDF6_MASKED = 385,
    OF_OXM_BSN_UDF7 = 386,
    OF_OXM_BSN_UDF7_MASKED = 387,
    OF_OXM_BSN_VRF = 388,
    OF_OXM_BSN_VRF_MASKED = 389,
    OF_OXM_ETH_DST = 390,
    OF_OXM_ETH_DST_MASKED = 391,
    OF_OXM_ETH_SRC = 392,
    OF_OXM_ETH_SRC_MASKED = 393,
    OF_OXM_ETH_TYPE = 394,
    OF_OXM_ETH_TYPE_MASKED = 395,
    OF_OXM_HEADER = 396,
    OF_OXM_ICMPV4_CODE = 397,
    OF_OXM_ICMPV4_CODE_MASKED = 398,
    OF_OXM_ICMPV4_TYPE = 399,
    OF_OXM_ICMPV4_TYPE_MASKED = 400,
    OF_OXM_ICMPV6_CODE = 401,
    OF_OXM_ICMPV6_CODE_MASKED = 402,
    OF_OXM_ICMPV6_TYPE = 403,
    OF_OXM_ICMPV6_TYPE_MASKED = 404,
    OF_OXM_IN_PHY_PORT = 405,
    OF_OXM_IN_PHY_PORT_MASKED = 406,
    OF_OXM_IN_PORT = 407,
    OF_OXM_IN_PORT_MASKED = 408,
    OF_OXM_IP_DSCP = 409,
    OF_OXM_IP_DSCP_MASKED = 410,
    OF_OXM_IP_ECN = 411,
    OF_OXM_IP_ECN_MASKED = 412,
    OF_OXM_IP_PROTO = 413,
    OF_OXM_IP_PROTO_MASKED = 414,
    OF_OXM_IPV4_DST = 415,
    OF_OXM_IPV4_DST_MASKED = 416,
    OF_OXM_IPV4_SRC = 417,
    OF_OXM_IPV4_SRC_MASKED = 418,
    OF_OXM_IPV6_DST = 419,
    OF_OXM_IPV6_DST_MASKED = 420,
    OF_OXM_IPV6_FLABEL = 421,
    OF_OXM_IPV6_FLABEL_MASKED = 422,
    OF_OXM_IPV6_ND_SLL = 423,
    OF_OXM_IPV6_ND_SLL_MASKED = 424,
    OF_OXM_IPV6_ND_TARGET = 425,
    OF_OXM_IPV6_ND_TARGET_MASKED = 426,
    OF_OXM_IPV6_ND_TLL = 427,
    OF_OXM_IPV6_ND_TLL_MASKED = 428,
    OF_OXM_IPV6_SRC = 429,
    OF_OXM_IPV6_SRC_MASKED = 430,
    OF_OXM_METADATA = 431,
    OF_OXM_METADATA_MASKED = 432,
    OF_OXM_MPLS_LABEL = 433,
    OF_OXM_MPLS_LABEL_MASKED = 434,
    OF_OXM_MPLS_TC = 435,
    OF_OXM_MPLS_TC_MASKED = 436,
    OF_OXM_SCTP_DST = 437,
    OF_OXM_SCTP_DST_MASKED = 438,
    OF_OXM_SCTP_SRC = 439,
    OF_OXM_SCTP_SRC_MASKED = 440,
    OF_OXM_TCP_DST = 441,
    OF_OXM_TCP_DST_MASKED = 442,
    OF_OXM_TCP_SRC = 443,
    OF_OXM_TCP_SRC_MASKED = 444,
    OF_OXM_TUNNEL_ID = 445,
    OF_OXM_TUNNEL_ID_MASKED = 446,
    OF_OXM_UDP_DST = 447,
    OF_OXM_UDP_DST_MASKED = 448,
    OF_OXM_UDP_SRC = 449,
    OF_OXM_UDP_SRC_MASKED = 450,
    OF_OXM_VLAN_PCP = 451,
    OF_OXM_VLAN_PCP_MASKED = 452,
    OF_OXM_VLAN_VID = 453,
    OF_OXM_VLAN_VID_MASKED = 454,
    OF_PACKET_QUEUE = 455,
    OF_PORT_DESC = 456,
    OF_PORT_STATS_ENTRY = 457,
    OF_QUEUE_PROP = 458,
    OF_QUEUE_PROP_EXPERIMENTER = 459,
    OF_QUEUE_PROP_HEADER = 460,
    OF_QUEUE_PROP_MAX_RATE = 461,
    OF_QUEUE_PROP_MIN_RATE = 462,
    OF_QUEUE_STATS_ENTRY = 463,
    OF_TABLE_FEATURE_PROP = 464,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 465,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 466,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 467,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 468,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 469,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 470,
    OF_TABLE_FEATURE_PROP_HEADER = 471,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 472,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 473,
    OF_TABLE_FEATURE_PROP_MATCH = 474,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 475,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 476,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 477,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 478,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 479,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 480,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 481,
    OF_TABLE_FEATURES = 482,
    OF_TABLE_STATS_ENTRY = 483,
    OF_UINT32 = 484,
    OF_UINT64 = 485,
    OF_UINT8 = 486,
    ...
    /* List objects */
    OF_LIST_ACTION = 487,
    OF_LIST_ACTION_ID = 488,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 489,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 490,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 491,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 492,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 493,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 494,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 495,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 496,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 497,
    OF_LIST_BSN_INTERFACE = 498,
    OF_LIST_BSN_LACP_STATS_ENTRY = 499,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 500,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 501,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 502,
    OF_LIST_BSN_TLV = 503,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 504,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 505,
    OF_LIST_BUCKET = 506,
    OF_LIST_BUCKET_COUNTER = 507,
    OF_LIST_FLOW_STATS_ENTRY = 508,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 509,
    OF_LIST_GROUP_STATS_ENTRY = 510,
    OF_LIST_HELLO_ELEM = 511,
    OF_LIST_INSTRUCTION = 512,
    OF_LIST_INSTRUCTION_ID = 513,
    OF_LIST_METER_BAND = 514,
    OF_LIST_METER_BAND_STATS = 515,
    OF_LIST_METER_STATS = 516,
    OF_LIST_OXM = 517,
    OF_LIST_PACKET_QUEUE = 518,
    OF_LIST_PORT_DESC = 519,
    OF_LIST_PORT_STATS_ENTRY = 520,
    OF_LIST_QUEUE_PROP = 521,
    OF_LIST_QUEUE_STATS_ENTRY = 522,
    OF_LIST_TABLE_FEATURE_PROP = 523,
    OF_LIST_TABLE_FEATURES = 524,
    OF_LIST_TABLE_STATS_ENTRY = 525,
    OF_LIST_UINT32 = 526,
    OF_LIST_UINT64 = 527,
    OF_LIST_UINT8 = 528,
