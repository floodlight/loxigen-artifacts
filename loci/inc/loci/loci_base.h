...
typedef enum of_object_id_e {
    ...
    OF_BSN_SET_IP_MASK = 44,
    OF_BSN_SET_L2_TABLE_REPLY = 45,
    OF_BSN_SET_L2_TABLE_REQUEST = 46,
    OF_BSN_SET_LACP_REPLY = 47,
    OF_BSN_SET_LACP_REQUEST = 48,
    OF_BSN_SET_MIRRORING = 49,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 50,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 51,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 52,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 53,
    OF_BSN_SHELL_COMMAND = 54,
    OF_BSN_SHELL_OUTPUT = 55,
    OF_BSN_SHELL_STATUS = 56,
    OF_BSN_STATS_REPLY = 57,
    OF_BSN_STATS_REQUEST = 58,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 59,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 60,
    OF_BSN_TIME_REPLY = 61,
    OF_BSN_TIME_REQUEST = 62,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 63,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 64,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 65,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 66,
    OF_DESC_STATS_REPLY = 67,
    OF_DESC_STATS_REQUEST = 68,
    OF_ECHO_REPLY = 69,
    OF_ECHO_REQUEST = 70,
    OF_ERROR_MSG = 71,
    OF_EXPERIMENTER = 72,
    OF_EXPERIMENTER_ERROR_MSG = 73,
    OF_EXPERIMENTER_STATS_REPLY = 74,
    OF_EXPERIMENTER_STATS_REQUEST = 75,
    OF_FEATURES_REPLY = 76,
    OF_FEATURES_REQUEST = 77,
    OF_FLOW_ADD = 78,
    OF_FLOW_DELETE = 79,
    OF_FLOW_DELETE_STRICT = 80,
    OF_FLOW_MOD = 81,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 82,
    OF_FLOW_MODIFY = 83,
    OF_FLOW_MODIFY_STRICT = 84,
    OF_FLOW_REMOVED = 85,
    OF_FLOW_STATS_REPLY = 86,
    OF_FLOW_STATS_REQUEST = 87,
    OF_GET_CONFIG_REPLY = 88,
    OF_GET_CONFIG_REQUEST = 89,
    OF_GROUP_DESC_STATS_REPLY = 90,
    OF_GROUP_DESC_STATS_REQUEST = 91,
    OF_GROUP_FEATURES_STATS_REPLY = 92,
    OF_GROUP_FEATURES_STATS_REQUEST = 93,
    OF_GROUP_MOD = 94,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 95,
    OF_GROUP_STATS_REPLY = 96,
    OF_GROUP_STATS_REQUEST = 97,
    OF_HELLO = 98,
    OF_HELLO_FAILED_ERROR_MSG = 99,
    OF_METER_CONFIG_STATS_REPLY = 100,
    OF_METER_CONFIG_STATS_REQUEST = 101,
    OF_METER_FEATURES_STATS_REPLY = 102,
    OF_METER_FEATURES_STATS_REQUEST = 103,
    OF_METER_MOD = 104,
    OF_METER_MOD_FAILED_ERROR_MSG = 105,
    OF_METER_STATS_REPLY = 106,
    OF_METER_STATS_REQUEST = 107,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 108,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 109,
    OF_NICIRA_HEADER = 110,
    OF_PACKET_IN = 111,
    OF_PACKET_OUT = 112,
    OF_PORT_DESC_STATS_REPLY = 113,
    OF_PORT_DESC_STATS_REQUEST = 114,
    OF_PORT_MOD = 115,
    OF_PORT_MOD_FAILED_ERROR_MSG = 116,
    OF_PORT_STATS_REPLY = 117,
    OF_PORT_STATS_REQUEST = 118,
    OF_PORT_STATUS = 119,
    OF_QUEUE_GET_CONFIG_REPLY = 120,
    OF_QUEUE_GET_CONFIG_REQUEST = 121,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 122,
    OF_QUEUE_STATS_REPLY = 123,
    OF_QUEUE_STATS_REQUEST = 124,
    OF_ROLE_REPLY = 125,
    OF_ROLE_REQUEST = 126,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 127,
    OF_SET_CONFIG = 128,
    OF_STATS_REPLY = 129,
    OF_STATS_REQUEST = 130,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 131,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 132,
    OF_TABLE_FEATURES_STATS_REPLY = 133,
    OF_TABLE_FEATURES_STATS_REQUEST = 134,
    OF_TABLE_MOD = 135,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 136,
    OF_TABLE_STATS_REPLY = 137,
    OF_TABLE_STATS_REQUEST = 138,

    /* Non-message objects */
    OF_ACTION = 139,
    OF_ACTION_BSN = 140,
    OF_ACTION_BSN_MIRROR = 141,
    OF_ACTION_BSN_SET_TUNNEL_DST = 142,
    OF_ACTION_COPY_TTL_IN = 143,
    OF_ACTION_COPY_TTL_OUT = 144,
    OF_ACTION_DEC_MPLS_TTL = 145,
    OF_ACTION_DEC_NW_TTL = 146,
    OF_ACTION_ENQUEUE = 147,
    OF_ACTION_EXPERIMENTER = 148,
    OF_ACTION_GROUP = 149,
    OF_ACTION_HEADER = 150,
    OF_ACTION_ID = 151,
    OF_ACTION_ID_BSN = 152,
    OF_ACTION_ID_BSN_MIRROR = 153,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 154,
    OF_ACTION_ID_COPY_TTL_IN = 155,
    OF_ACTION_ID_COPY_TTL_OUT = 156,
    OF_ACTION_ID_DEC_MPLS_TTL = 157,
    OF_ACTION_ID_DEC_NW_TTL = 158,
    OF_ACTION_ID_EXPERIMENTER = 159,
    OF_ACTION_ID_GROUP = 160,
    OF_ACTION_ID_HEADER = 161,
    OF_ACTION_ID_NICIRA = 162,
    OF_ACTION_ID_NICIRA_DEC_TTL = 163,
    OF_ACTION_ID_OUTPUT = 164,
    OF_ACTION_ID_POP_MPLS = 165,
    OF_ACTION_ID_POP_PBB = 166,
    OF_ACTION_ID_POP_VLAN = 167,
    OF_ACTION_ID_PUSH_MPLS = 168,
    OF_ACTION_ID_PUSH_PBB = 169,
    OF_ACTION_ID_PUSH_VLAN = 170,
    OF_ACTION_ID_SET_FIELD = 171,
    OF_ACTION_ID_SET_MPLS_TTL = 172,
    OF_ACTION_ID_SET_NW_TTL = 173,
    OF_ACTION_ID_SET_QUEUE = 174,
    OF_ACTION_NICIRA = 175,
    OF_ACTION_NICIRA_DEC_TTL = 176,
    OF_ACTION_OUTPUT = 177,
    OF_ACTION_POP_MPLS = 178,
    OF_ACTION_POP_PBB = 179,
    OF_ACTION_POP_VLAN = 180,
    OF_ACTION_PUSH_MPLS = 181,
    OF_ACTION_PUSH_PBB = 182,
    OF_ACTION_PUSH_VLAN = 183,
    OF_ACTION_SET_DL_DST = 184,
    OF_ACTION_SET_DL_SRC = 185,
    OF_ACTION_SET_FIELD = 186,
    OF_ACTION_SET_MPLS_LABEL = 187,
    OF_ACTION_SET_MPLS_TC = 188,
    OF_ACTION_SET_MPLS_TTL = 189,
    OF_ACTION_SET_NW_DST = 190,
    OF_ACTION_SET_NW_ECN = 191,
    OF_ACTION_SET_NW_SRC = 192,
    OF_ACTION_SET_NW_TOS = 193,
    OF_ACTION_SET_NW_TTL = 194,
    OF_ACTION_SET_QUEUE = 195,
    OF_ACTION_SET_TP_DST = 196,
    OF_ACTION_SET_TP_SRC = 197,
    OF_ACTION_SET_VLAN_PCP = 198,
    OF_ACTION_SET_VLAN_VID = 199,
    OF_ACTION_STRIP_VLAN = 200,
    OF_BSN_INTERFACE = 201,
    OF_BSN_LACP_STATS_ENTRY = 202,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 203,
    OF_BSN_VPORT = 204,
    OF_BSN_VPORT_HEADER = 205,
    OF_BSN_VPORT_Q_IN_Q = 206,
    OF_BUCKET = 207,
    OF_BUCKET_COUNTER = 208,
    OF_EXPERIMENTER_STATS_HEADER = 209,
    OF_FLOW_STATS_ENTRY = 210,
    OF_GROUP_DESC_STATS_ENTRY = 211,
    OF_GROUP_STATS_ENTRY = 212,
    OF_HEADER = 213,
    OF_HELLO_ELEM = 214,
    OF_HELLO_ELEM_HEADER = 215,
    OF_HELLO_ELEM_VERSIONBITMAP = 216,
    OF_INSTRUCTION = 217,
    OF_INSTRUCTION_APPLY_ACTIONS = 218,
    OF_INSTRUCTION_BSN = 219,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 220,
    OF_INSTRUCTION_CLEAR_ACTIONS = 221,
    OF_INSTRUCTION_EXPERIMENTER = 222,
    OF_INSTRUCTION_GOTO_TABLE = 223,
    OF_INSTRUCTION_HEADER = 224,
    OF_INSTRUCTION_METER = 225,
    OF_INSTRUCTION_WRITE_ACTIONS = 226,
    OF_INSTRUCTION_WRITE_METADATA = 227,
    OF_MATCH_V1 = 228,
    OF_MATCH_V2 = 229,
    OF_MATCH_V3 = 230,
    OF_METER_BAND = 231,
    OF_METER_BAND_DROP = 232,
    OF_METER_BAND_DSCP_REMARK = 233,
    OF_METER_BAND_EXPERIMENTER = 234,
    OF_METER_BAND_HEADER = 235,
    OF_METER_BAND_STATS = 236,
    OF_METER_CONFIG = 237,
    OF_METER_FEATURES = 238,
    OF_METER_STATS = 239,
    OF_OXM = 240,
    OF_OXM_ARP_OP = 241,
    OF_OXM_ARP_OP_MASKED = 242,
    OF_OXM_ARP_SHA = 243,
    OF_OXM_ARP_SHA_MASKED = 244,
    OF_OXM_ARP_SPA = 245,
    OF_OXM_ARP_SPA_MASKED = 246,
    OF_OXM_ARP_THA = 247,
    OF_OXM_ARP_THA_MASKED = 248,
    OF_OXM_ARP_TPA = 249,
    OF_OXM_ARP_TPA_MASKED = 250,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 251,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 252,
    OF_OXM_BSN_IN_PORTS_128 = 253,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 254,
    OF_OXM_BSN_L3_DST_CLASS_ID = 255,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 256,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 257,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 258,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 259,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 260,
    OF_OXM_BSN_LAG_ID = 261,
    OF_OXM_BSN_LAG_ID_MASKED = 262,
    OF_OXM_BSN_VRF = 263,
    OF_OXM_BSN_VRF_MASKED = 264,
    OF_OXM_ETH_DST = 265,
    OF_OXM_ETH_DST_MASKED = 266,
    OF_OXM_ETH_SRC = 267,
    OF_OXM_ETH_SRC_MASKED = 268,
    OF_OXM_ETH_TYPE = 269,
    OF_OXM_ETH_TYPE_MASKED = 270,
    OF_OXM_HEADER = 271,
    OF_OXM_ICMPV4_CODE = 272,
    OF_OXM_ICMPV4_CODE_MASKED = 273,
    OF_OXM_ICMPV4_TYPE = 274,
    OF_OXM_ICMPV4_TYPE_MASKED = 275,
    OF_OXM_ICMPV6_CODE = 276,
    OF_OXM_ICMPV6_CODE_MASKED = 277,
    OF_OXM_ICMPV6_TYPE = 278,
    OF_OXM_ICMPV6_TYPE_MASKED = 279,
    OF_OXM_IN_PHY_PORT = 280,
    OF_OXM_IN_PHY_PORT_MASKED = 281,
    OF_OXM_IN_PORT = 282,
    OF_OXM_IN_PORT_MASKED = 283,
    OF_OXM_IP_DSCP = 284,
    OF_OXM_IP_DSCP_MASKED = 285,
    OF_OXM_IP_ECN = 286,
    OF_OXM_IP_ECN_MASKED = 287,
    OF_OXM_IP_PROTO = 288,
    OF_OXM_IP_PROTO_MASKED = 289,
    OF_OXM_IPV4_DST = 290,
    OF_OXM_IPV4_DST_MASKED = 291,
    OF_OXM_IPV4_SRC = 292,
    OF_OXM_IPV4_SRC_MASKED = 293,
    OF_OXM_IPV6_DST = 294,
    OF_OXM_IPV6_DST_MASKED = 295,
    OF_OXM_IPV6_FLABEL = 296,
    OF_OXM_IPV6_FLABEL_MASKED = 297,
    OF_OXM_IPV6_ND_SLL = 298,
    OF_OXM_IPV6_ND_SLL_MASKED = 299,
    OF_OXM_IPV6_ND_TARGET = 300,
    OF_OXM_IPV6_ND_TARGET_MASKED = 301,
    OF_OXM_IPV6_ND_TLL = 302,
    OF_OXM_IPV6_ND_TLL_MASKED = 303,
    OF_OXM_IPV6_SRC = 304,
    OF_OXM_IPV6_SRC_MASKED = 305,
    OF_OXM_METADATA = 306,
    OF_OXM_METADATA_MASKED = 307,
    OF_OXM_MPLS_LABEL = 308,
    OF_OXM_MPLS_LABEL_MASKED = 309,
    OF_OXM_MPLS_TC = 310,
    OF_OXM_MPLS_TC_MASKED = 311,
    OF_OXM_SCTP_DST = 312,
    OF_OXM_SCTP_DST_MASKED = 313,
    OF_OXM_SCTP_SRC = 314,
    OF_OXM_SCTP_SRC_MASKED = 315,
    OF_OXM_TCP_DST = 316,
    OF_OXM_TCP_DST_MASKED = 317,
    OF_OXM_TCP_SRC = 318,
    OF_OXM_TCP_SRC_MASKED = 319,
    OF_OXM_UDP_DST = 320,
    OF_OXM_UDP_DST_MASKED = 321,
    OF_OXM_UDP_SRC = 322,
    OF_OXM_UDP_SRC_MASKED = 323,
    OF_OXM_VLAN_PCP = 324,
    OF_OXM_VLAN_PCP_MASKED = 325,
    OF_OXM_VLAN_VID = 326,
    OF_OXM_VLAN_VID_MASKED = 327,
    OF_PACKET_QUEUE = 328,
    OF_PORT_DESC = 329,
    OF_PORT_STATS_ENTRY = 330,
    OF_QUEUE_PROP = 331,
    OF_QUEUE_PROP_EXPERIMENTER = 332,
    OF_QUEUE_PROP_HEADER = 333,
    OF_QUEUE_PROP_MAX_RATE = 334,
    OF_QUEUE_PROP_MIN_RATE = 335,
    OF_QUEUE_STATS_ENTRY = 336,
    OF_TABLE_FEATURE_PROP = 337,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 338,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 339,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 340,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 341,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 342,
    OF_TABLE_FEATURE_PROP_HEADER = 343,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 344,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 345,
    OF_TABLE_FEATURE_PROP_MATCH = 346,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 347,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 348,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 349,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 350,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 351,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 352,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 353,
    OF_TABLE_FEATURES = 354,
    OF_TABLE_STATS_ENTRY = 355,
    OF_UINT32 = 356,
    OF_UINT8 = 357,

    /* List objects */
    OF_LIST_ACTION = 358,
    OF_LIST_ACTION_ID = 359,
    OF_LIST_BSN_INTERFACE = 360,
    OF_LIST_BSN_LACP_STATS_ENTRY = 361,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 362,
    OF_LIST_BUCKET = 363,
    OF_LIST_BUCKET_COUNTER = 364,
    OF_LIST_FLOW_STATS_ENTRY = 365,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 366,
    OF_LIST_GROUP_STATS_ENTRY = 367,
    OF_LIST_HELLO_ELEM = 368,
    OF_LIST_INSTRUCTION = 369,
    OF_LIST_METER_BAND = 370,
    OF_LIST_METER_BAND_STATS = 371,
    OF_LIST_METER_STATS = 372,
    OF_LIST_OXM = 373,
    OF_LIST_PACKET_QUEUE = 374,
    OF_LIST_PORT_DESC = 375,
    OF_LIST_PORT_STATS_ENTRY = 376,
    OF_LIST_QUEUE_PROP = 377,
    OF_LIST_QUEUE_STATS_ENTRY = 378,
    OF_LIST_TABLE_FEATURE_PROP = 379,
    OF_LIST_TABLE_FEATURES = 380,
    OF_LIST_TABLE_STATS_ENTRY = 381,
    OF_LIST_UINT32 = 382,
    OF_LIST_UINT8 = 383,
...
#define OF_MESSAGE_OBJECT_COUNT 139
