...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_MPLS_CONTROL_WORD = 324,
    OF_BSN_TLV_MPLS_LABEL = 325,
    OF_BSN_TLV_MPLS_SEQUENCED = 326,
    OF_BSN_TLV_NAME = 327,
    OF_BSN_TLV_PARTNER_KEY = 328,
    OF_BSN_TLV_PARTNER_PORT_NUM = 329,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 330,
    OF_BSN_TLV_PARTNER_STATE = 331,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 332,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 333,
    OF_BSN_TLV_PORT = 334,
    OF_BSN_TLV_PRIORITY = 335,
    OF_BSN_TLV_QUEUE_ID = 336,
    OF_BSN_TLV_QUEUE_WEIGHT = 337,
    OF_BSN_TLV_REFERENCE = 338,
    OF_BSN_TLV_REPLY_PACKETS = 339,
    OF_BSN_TLV_REQUEST_PACKETS = 340,
    OF_BSN_TLV_RX_PACKETS = 341,
    OF_BSN_TLV_SAMPLING_RATE = 342,
    OF_BSN_TLV_SUB_AGENT_ID = 343,
    OF_BSN_TLV_TX_BYTES = 344,
    OF_BSN_TLV_TX_PACKETS = 345,
    OF_BSN_TLV_UDF_ANCHOR = 346,
    OF_BSN_TLV_UDF_ID = 347,
    OF_BSN_TLV_UDF_LENGTH = 348,
    OF_BSN_TLV_UDF_OFFSET = 349,
    OF_BSN_TLV_UDP_DST = 350,
    OF_BSN_TLV_UDP_SRC = 351,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 352,
    OF_BSN_TLV_VLAN_VID = 353,
    OF_BSN_TLV_VRF = 354,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 355,
    OF_BSN_VPORT = 356,
    OF_BSN_VPORT_L2GRE = 357,
    OF_BSN_VPORT_Q_IN_Q = 358,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 359,
    OF_BUCKET = 360,
    OF_BUCKET_COUNTER = 361,
    OF_BUNDLE_PROP = 362,
    OF_BUNDLE_PROP_EXPERIMENTER = 363,
    OF_FLOW_STATS_ENTRY = 364,
    OF_GROUP_DESC_STATS_ENTRY = 365,
    OF_GROUP_STATS_ENTRY = 366,
    OF_HELLO_ELEM = 367,
    OF_HELLO_ELEM_VERSIONBITMAP = 368,
    OF_INSTRUCTION = 369,
    OF_INSTRUCTION_APPLY_ACTIONS = 370,
    OF_INSTRUCTION_BSN = 371,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 372,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 373,
    ...
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 378,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 379,
    OF_INSTRUCTION_BSN_PERMIT = 380,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 381,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 382,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 383,
    OF_INSTRUCTION_CLEAR_ACTIONS = 384,
    OF_INSTRUCTION_EXPERIMENTER = 385,
    OF_INSTRUCTION_GOTO_TABLE = 386,
    OF_INSTRUCTION_ID = 387,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 388,
    OF_INSTRUCTION_ID_BSN = 389,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 390,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 391,
    OF_INSTRUCTION_ID_BSN_DENY = 392,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 393,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 394,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 395,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 396,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 397,
    OF_INSTRUCTION_ID_BSN_PERMIT = 398,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 399,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 400,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 401,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 402,
    OF_INSTRUCTION_ID_EXPERIMENTER = 403,
    OF_INSTRUCTION_ID_GOTO_TABLE = 404,
    OF_INSTRUCTION_ID_METER = 405,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 406,
    OF_INSTRUCTION_ID_WRITE_METADATA = 407,
    OF_INSTRUCTION_METER = 408,
    OF_INSTRUCTION_WRITE_ACTIONS = 409,
    OF_INSTRUCTION_WRITE_METADATA = 410,
    OF_MATCH_V1 = 411,
    OF_MATCH_V2 = 412,
    OF_MATCH_V3 = 413,
    OF_METER_BAND = 414,
    OF_METER_BAND_DROP = 415,
    OF_METER_BAND_DSCP_REMARK = 416,
    OF_METER_BAND_EXPERIMENTER = 417,
    OF_METER_BAND_STATS = 418,
    OF_METER_CONFIG = 419,
    OF_METER_FEATURES = 420,
    OF_METER_STATS = 421,
    OF_OXM = 422,
    OF_OXM_ARP_OP = 423,
    OF_OXM_ARP_OP_MASKED = 424,
    OF_OXM_ARP_SHA = 425,
    OF_OXM_ARP_SHA_MASKED = 426,
    OF_OXM_ARP_SPA = 427,
    OF_OXM_ARP_SPA_MASKED = 428,
    OF_OXM_ARP_THA = 429,
    OF_OXM_ARP_THA_MASKED = 430,
    OF_OXM_ARP_TPA = 431,
    OF_OXM_ARP_TPA_MASKED = 432,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 433,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 434,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 435,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 436,
    OF_OXM_BSN_IN_PORTS_128 = 437,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 438,
    OF_OXM_BSN_L2_CACHE_HIT = 439,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 440,
    OF_OXM_BSN_L3_DST_CLASS_ID = 441,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 442,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 443,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 444,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 445,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 446,
    OF_OXM_BSN_LAG_ID = 447,
    OF_OXM_BSN_LAG_ID_MASKED = 448,
    OF_OXM_BSN_TCP_FLAGS = 449,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 450,
    OF_OXM_BSN_UDF0 = 451,
    OF_OXM_BSN_UDF0_MASKED = 452,
    OF_OXM_BSN_UDF1 = 453,
    OF_OXM_BSN_UDF1_MASKED = 454,
    OF_OXM_BSN_UDF2 = 455,
    OF_OXM_BSN_UDF2_MASKED = 456,
    OF_OXM_BSN_UDF3 = 457,
    OF_OXM_BSN_UDF3_MASKED = 458,
    OF_OXM_BSN_UDF4 = 459,
    OF_OXM_BSN_UDF4_MASKED = 460,
    OF_OXM_BSN_UDF5 = 461,
    OF_OXM_BSN_UDF5_MASKED = 462,
    OF_OXM_BSN_UDF6 = 463,
    OF_OXM_BSN_UDF6_MASKED = 464,
    OF_OXM_BSN_UDF7 = 465,
    OF_OXM_BSN_UDF7_MASKED = 466,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 467,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 468,
    OF_OXM_BSN_VRF = 469,
    OF_OXM_BSN_VRF_MASKED = 470,
    OF_OXM_ETH_DST = 471,
    OF_OXM_ETH_DST_MASKED = 472,
    OF_OXM_ETH_SRC = 473,
    OF_OXM_ETH_SRC_MASKED = 474,
    OF_OXM_ETH_TYPE = 475,
    OF_OXM_ETH_TYPE_MASKED = 476,
    ...
    OF_OXM_TUNNEL_IPV4_DST = 533,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 534,
    OF_OXM_TUNNEL_IPV4_SRC = 535,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 536,
    OF_OXM_UDP_DST = 537,
    OF_OXM_UDP_DST_MASKED = 538,
    OF_OXM_UDP_SRC = 539,
    OF_OXM_UDP_SRC_MASKED = 540,
    OF_OXM_VLAN_PCP = 541,
    OF_OXM_VLAN_PCP_MASKED = 542,
    OF_OXM_VLAN_VID = 543,
    OF_OXM_VLAN_VID_MASKED = 544,
    OF_PACKET_QUEUE = 545,
    OF_PORT_DESC = 546,
    OF_PORT_DESC_PROP = 547,
    OF_PORT_DESC_PROP_ETHERNET = 548,
    OF_PORT_DESC_PROP_EXPERIMENTER = 549,
    OF_PORT_DESC_PROP_OPTICAL = 550,
    OF_PORT_MOD_PROP = 551,
    OF_PORT_MOD_PROP_ETHERNET = 552,
    OF_PORT_MOD_PROP_EXPERIMENTER = 553,
    OF_PORT_MOD_PROP_OPTICAL = 554,
    OF_PORT_STATS_ENTRY = 555,
    OF_PORT_STATS_PROP = 556,
    OF_PORT_STATS_PROP_ETHERNET = 557,
    OF_PORT_STATS_PROP_EXPERIMENTER = 558,
    OF_PORT_STATS_PROP_OPTICAL = 559,
    OF_QUEUE_DESC = 560,
    OF_QUEUE_DESC_PROP = 561,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 562,
    OF_QUEUE_DESC_PROP_MAX_RATE = 563,
    OF_QUEUE_DESC_PROP_MIN_RATE = 564,
    OF_QUEUE_PROP = 565,
    OF_QUEUE_PROP_EXPERIMENTER = 566,
    OF_QUEUE_PROP_MAX_RATE = 567,
    OF_QUEUE_PROP_MIN_RATE = 568,
    OF_QUEUE_STATS_ENTRY = 569,
    OF_QUEUE_STATS_PROP = 570,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 571,
    OF_ROLE_PROP = 572,
    OF_ROLE_PROP_EXPERIMENTER = 573,
    OF_TABLE_DESC = 574,
    OF_TABLE_FEATURE_PROP = 575,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 576,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 577,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 578,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 579,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 580,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 581,
    ...
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 609,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 610,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 611,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 612,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 613,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 614,
    OF_LIST_BSN_INTERFACE = 615,
    OF_LIST_BSN_LACP_STATS_ENTRY = 616,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 617,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 618,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 619,
    OF_LIST_BSN_TLV = 620,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 621,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 622,
    OF_LIST_BUCKET = 623,
    OF_LIST_BUCKET_COUNTER = 624,
    OF_LIST_BUNDLE_PROP = 625,
    OF_LIST_FLOW_STATS_ENTRY = 626,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 627,
    OF_LIST_GROUP_STATS_ENTRY = 628,
    OF_LIST_HELLO_ELEM = 629,
    OF_LIST_INSTRUCTION = 630,
    OF_LIST_INSTRUCTION_ID = 631,
    OF_LIST_METER_BAND = 632,
    OF_LIST_METER_BAND_STATS = 633,
    OF_LIST_METER_STATS = 634,
    OF_LIST_OXM = 635,
    OF_LIST_PACKET_QUEUE = 636,
    OF_LIST_PORT_DESC = 637,
    OF_LIST_PORT_DESC_PROP = 638,
    OF_LIST_PORT_MOD_PROP = 639,
    OF_LIST_PORT_STATS_ENTRY = 640,
    OF_LIST_PORT_STATS_PROP = 641,
    OF_LIST_QUEUE_DESC = 642,
    OF_LIST_QUEUE_DESC_PROP = 643,
    OF_LIST_QUEUE_PROP = 644,
    OF_LIST_QUEUE_STATS_ENTRY = 645,
    OF_LIST_QUEUE_STATS_PROP = 646,
    OF_LIST_ROLE_PROP = 647,
    OF_LIST_TABLE_DESC = 648,
    OF_LIST_TABLE_FEATURE_PROP = 649,
    OF_LIST_TABLE_FEATURES = 650,
    OF_LIST_TABLE_MOD_PROP = 651,
    OF_LIST_TABLE_STATS_ENTRY = 652,
    OF_LIST_UINT32 = 653,
    OF_LIST_UINT64 = 654,
    OF_LIST_UINT8 = 655,
