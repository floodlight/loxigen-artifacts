...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_UINT32 = 449,
    OF_BSN_TLV_UINT64_LIST = 450,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 451,
    OF_BSN_TLV_UNICAST_RATE = 452,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 453,
    OF_BSN_TLV_UNTAGGED = 454,
    OF_BSN_TLV_UPGRADE = 455,
    OF_BSN_TLV_URI_SCHEME = 456,
    OF_BSN_TLV_USE_PACKET_STATE = 457,
    OF_BSN_TLV_USER_CONFIGURED = 458,
    OF_BSN_TLV_VFI = 459,
    OF_BSN_TLV_VFP_CLASS_ID = 460,
    OF_BSN_TLV_VIRTUAL = 461,
    OF_BSN_TLV_VLAN_MAC_LIST = 462,
    OF_BSN_TLV_VLAN_PCP = 463,
    OF_BSN_TLV_VLAN_VID = 464,
    OF_BSN_TLV_VLAN_VID_MASK = 465,
    OF_BSN_TLV_VNI = 466,
    OF_BSN_TLV_VPN_KEY = 467,
    OF_BSN_TLV_VRF = 468,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 469,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 470,
    OF_BSN_VLAN_MAC = 471,
    OF_BSN_VPORT = 472,
    OF_BSN_VPORT_L2GRE = 473,
    OF_BSN_VPORT_Q_IN_Q = 474,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 475,
    OF_BUCKET = 476,
    OF_BUCKET_COUNTER = 477,
    OF_BUNDLE_PROP = 478,
    OF_BUNDLE_PROP_EXPERIMENTER = 479,
    OF_FLOW_STATS_ENTRY = 480,
    OF_GROUP_DESC_STATS_ENTRY = 481,
    OF_GROUP_STATS_ENTRY = 482,
    OF_HELLO_ELEM = 483,
    OF_HELLO_ELEM_VERSIONBITMAP = 484,
    OF_INSTRUCTION = 485,
    OF_INSTRUCTION_APPLY_ACTIONS = 486,
    OF_INSTRUCTION_BSN = 487,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 488,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 489,
    OF_INSTRUCTION_BSN_DENY = 490,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 491,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 492,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 493,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 494,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 495,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 496,
    OF_INSTRUCTION_BSN_HASH_SELECT = 497,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 498,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 499,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 500,
    OF_INSTRUCTION_BSN_PERMIT = 501,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 502,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 503,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 504,
    OF_INSTRUCTION_CLEAR_ACTIONS = 505,
    OF_INSTRUCTION_EXPERIMENTER = 506,
    OF_INSTRUCTION_GOTO_TABLE = 507,
    OF_INSTRUCTION_ID = 508,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 509,
    OF_INSTRUCTION_ID_BSN = 510,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 511,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 512,
    OF_INSTRUCTION_ID_BSN_DENY = 513,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 514,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 515,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 516,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 517,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 518,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 519,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 520,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 521,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 522,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 523,
    OF_INSTRUCTION_ID_BSN_PERMIT = 524,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 525,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 526,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 527,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 528,
    OF_INSTRUCTION_ID_EXPERIMENTER = 529,
    OF_INSTRUCTION_ID_GOTO_TABLE = 530,
    OF_INSTRUCTION_ID_METER = 531,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 532,
    OF_INSTRUCTION_ID_WRITE_METADATA = 533,
    OF_INSTRUCTION_METER = 534,
    OF_INSTRUCTION_WRITE_ACTIONS = 535,
    OF_INSTRUCTION_WRITE_METADATA = 536,
    OF_MATCH_V1 = 537,
    OF_MATCH_V2 = 538,
    OF_MATCH_V3 = 539,
    OF_METER_BAND = 540,
    OF_METER_BAND_DROP = 541,
    OF_METER_BAND_DSCP_REMARK = 542,
    OF_METER_BAND_EXPERIMENTER = 543,
    OF_METER_BAND_STATS = 544,
    OF_METER_CONFIG = 545,
    OF_METER_FEATURES = 546,
    OF_METER_STATS = 547,
    OF_OXM = 548,
    OF_OXM_ARP_OP = 549,
    OF_OXM_ARP_OP_MASKED = 550,
    OF_OXM_ARP_SHA = 551,
    OF_OXM_ARP_SHA_MASKED = 552,
    OF_OXM_ARP_SPA = 553,
    OF_OXM_ARP_SPA_MASKED = 554,
    OF_OXM_ARP_THA = 555,
    OF_OXM_ARP_THA_MASKED = 556,
    OF_OXM_ARP_TPA = 557,
    OF_OXM_ARP_TPA_MASKED = 558,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 559,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 560,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 561,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 562,
    OF_OXM_BSN_IFP_CLASS_ID = 563,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 564,
    OF_OXM_BSN_IN_PORTS_128 = 565,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 566,
    OF_OXM_BSN_IN_PORTS_512 = 567,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 568,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 569,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 570,
    OF_OXM_BSN_INNER_ETH_DST = 571,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 572,
    OF_OXM_BSN_INNER_ETH_SRC = 573,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 574,
    OF_OXM_BSN_INNER_VLAN_VID = 575,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 576,
    OF_OXM_BSN_IP_FRAGMENTATION = 577,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 578,
    OF_OXM_BSN_L2_CACHE_HIT = 579,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 580,
    OF_OXM_BSN_L3_DST_CLASS_ID = 581,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 582,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 583,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 584,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 585,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 586,
    OF_OXM_BSN_LAG_ID = 587,
    OF_OXM_BSN_LAG_ID_MASKED = 588,
    OF_OXM_BSN_TCP_FLAGS = 589,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 590,
    OF_OXM_BSN_UDF0 = 591,
    OF_OXM_BSN_UDF0_MASKED = 592,
    OF_OXM_BSN_UDF1 = 593,
    OF_OXM_BSN_UDF1_MASKED = 594,
    OF_OXM_BSN_UDF2 = 595,
    OF_OXM_BSN_UDF2_MASKED = 596,
    OF_OXM_BSN_UDF3 = 597,
    OF_OXM_BSN_UDF3_MASKED = 598,
    OF_OXM_BSN_UDF4 = 599,
    OF_OXM_BSN_UDF4_MASKED = 600,
    OF_OXM_BSN_UDF5 = 601,
    OF_OXM_BSN_UDF5_MASKED = 602,
    OF_OXM_BSN_UDF6 = 603,
    OF_OXM_BSN_UDF6_MASKED = 604,
    OF_OXM_BSN_UDF7 = 605,
    OF_OXM_BSN_UDF7_MASKED = 606,
    OF_OXM_BSN_VFI = 607,
    OF_OXM_BSN_VFI_MASKED = 608,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 609,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 610,
    OF_OXM_BSN_VRF = 611,
    OF_OXM_BSN_VRF_MASKED = 612,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 613,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 614,
    OF_OXM_CONN_TRACKING_IPV6_DST = 615,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 616,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 617,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 618,
    OF_OXM_CONN_TRACKING_LABEL = 619,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 620,
    OF_OXM_CONN_TRACKING_MARK = 621,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 622,
    OF_OXM_CONN_TRACKING_NW_DST = 623,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 624,
    OF_OXM_CONN_TRACKING_NW_PROTO = 625,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 626,
    OF_OXM_CONN_TRACKING_NW_SRC = 627,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 628,
    OF_OXM_CONN_TRACKING_STATE = 629,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 630,
    OF_OXM_CONN_TRACKING_TP_DST = 631,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 632,
    OF_OXM_CONN_TRACKING_TP_SRC = 633,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 634,
    OF_OXM_CONN_TRACKING_ZONE = 635,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 636,
    OF_OXM_ETH_DST = 637,
    OF_OXM_ETH_DST_MASKED = 638,
    OF_OXM_ETH_SRC = 639,
    OF_OXM_ETH_SRC_MASKED = 640,
    OF_OXM_ETH_TYPE = 641,
    OF_OXM_ETH_TYPE_MASKED = 642,
    OF_OXM_ICMPV4_CODE = 643,
    OF_OXM_ICMPV4_CODE_MASKED = 644,
    OF_OXM_ICMPV4_TYPE = 645,
    OF_OXM_ICMPV4_TYPE_MASKED = 646,
    OF_OXM_ICMPV6_CODE = 647,
    OF_OXM_ICMPV6_CODE_MASKED = 648,
    OF_OXM_ICMPV6_TYPE = 649,
    OF_OXM_ICMPV6_TYPE_MASKED = 650,
    OF_OXM_IN_PHY_PORT = 651,
    OF_OXM_IN_PHY_PORT_MASKED = 652,
    OF_OXM_IN_PORT = 653,
    OF_OXM_IN_PORT_MASKED = 654,
    OF_OXM_IP_DSCP = 655,
    OF_OXM_IP_DSCP_MASKED = 656,
    OF_OXM_IP_ECN = 657,
    OF_OXM_IP_ECN_MASKED = 658,
    OF_OXM_IP_PROTO = 659,
    OF_OXM_IP_PROTO_MASKED = 660,
    OF_OXM_IPV4_DST = 661,
    OF_OXM_IPV4_DST_MASKED = 662,
    OF_OXM_IPV4_SRC = 663,
    OF_OXM_IPV4_SRC_MASKED = 664,
    OF_OXM_IPV6_DST = 665,
    OF_OXM_IPV6_DST_MASKED = 666,
    OF_OXM_IPV6_EXTHDR = 667,
    OF_OXM_IPV6_EXTHDR_MASKED = 668,
    OF_OXM_IPV6_FLABEL = 669,
    OF_OXM_IPV6_FLABEL_MASKED = 670,
    OF_OXM_IPV6_ND_SLL = 671,
    OF_OXM_IPV6_ND_SLL_MASKED = 672,
    OF_OXM_IPV6_ND_TARGET = 673,
    OF_OXM_IPV6_ND_TARGET_MASKED = 674,
    OF_OXM_IPV6_ND_TLL = 675,
    OF_OXM_IPV6_ND_TLL_MASKED = 676,
    OF_OXM_IPV6_SRC = 677,
    OF_OXM_IPV6_SRC_MASKED = 678,
    OF_OXM_METADATA = 679,
    OF_OXM_METADATA_MASKED = 680,
    OF_OXM_MPLS_BOS = 681,
    OF_OXM_MPLS_BOS_MASKED = 682,
    OF_OXM_MPLS_LABEL = 683,
    OF_OXM_MPLS_LABEL_MASKED = 684,
    OF_OXM_MPLS_TC = 685,
    OF_OXM_MPLS_TC_MASKED = 686,
    OF_OXM_OVS_TCP_FLAGS = 687,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 688,
    OF_OXM_PBB_UCA = 689,
    OF_OXM_PBB_UCA_MASKED = 690,
    OF_OXM_SCTP_DST = 691,
    OF_OXM_SCTP_DST_MASKED = 692,
    OF_OXM_SCTP_SRC = 693,
    OF_OXM_SCTP_SRC_MASKED = 694,
    OF_OXM_TCP_DST = 695,
    OF_OXM_TCP_DST_MASKED = 696,
    OF_OXM_TCP_SRC = 697,
    OF_OXM_TCP_SRC_MASKED = 698,
    OF_OXM_TUNNEL_ID = 699,
    OF_OXM_TUNNEL_ID_MASKED = 700,
    OF_OXM_TUNNEL_IPV4_DST = 701,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 702,
    OF_OXM_TUNNEL_IPV4_SRC = 703,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 704,
    OF_OXM_UDP_DST = 705,
    OF_OXM_UDP_DST_MASKED = 706,
    OF_OXM_UDP_SRC = 707,
    OF_OXM_UDP_SRC_MASKED = 708,
    OF_OXM_VLAN_PCP = 709,
    OF_OXM_VLAN_PCP_MASKED = 710,
    OF_OXM_VLAN_VID = 711,
    OF_OXM_VLAN_VID_MASKED = 712,
    OF_PACKET_QUEUE = 713,
    OF_PORT_DESC = 714,
    OF_PORT_DESC_PROP = 715,
    OF_PORT_DESC_PROP_BSN = 716,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 717,
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 718,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 719,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 720,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 721,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 722,
    OF_PORT_DESC_PROP_BSN_UPLINK = 723,
    OF_PORT_DESC_PROP_ETHERNET = 724,
    OF_PORT_DESC_PROP_EXPERIMENTER = 725,
    OF_PORT_DESC_PROP_OPTICAL = 726,
    OF_PORT_MOD_PROP = 727,
    OF_PORT_MOD_PROP_ETHERNET = 728,
    OF_PORT_MOD_PROP_EXPERIMENTER = 729,
    OF_PORT_MOD_PROP_OPTICAL = 730,
    OF_PORT_STATS_ENTRY = 731,
    OF_PORT_STATS_PROP = 732,
    OF_PORT_STATS_PROP_ETHERNET = 733,
    OF_PORT_STATS_PROP_EXPERIMENTER = 734,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 735,
    OF_PORT_STATS_PROP_OPTICAL = 736,
    OF_QUEUE_DESC = 737,
    OF_QUEUE_DESC_PROP = 738,
    OF_QUEUE_DESC_PROP_BSN = 739,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 740,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 741,
    OF_QUEUE_DESC_PROP_MAX_RATE = 742,
    OF_QUEUE_DESC_PROP_MIN_RATE = 743,
    OF_QUEUE_PROP = 744,
    OF_QUEUE_PROP_EXPERIMENTER = 745,
    OF_QUEUE_PROP_MAX_RATE = 746,
    OF_QUEUE_PROP_MIN_RATE = 747,
    OF_QUEUE_STATS_ENTRY = 748,
    OF_QUEUE_STATS_PROP = 749,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 750,
    OF_ROLE_PROP = 751,
    OF_ROLE_PROP_EXPERIMENTER = 752,
    OF_TABLE_DESC = 753,
    OF_TABLE_FEATURE_PROP = 754,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 755,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 756,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 757,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 758,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 759,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 760,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 761,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 762,
    OF_TABLE_FEATURE_PROP_MATCH = 763,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 764,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 765,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 766,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 767,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 768,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 769,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 770,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 771,
    OF_TABLE_FEATURES = 772,
    OF_TABLE_MOD_PROP = 773,
    OF_TABLE_MOD_PROP_EVICTION = 774,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 775,
    OF_TABLE_MOD_PROP_VACANCY = 776,
    OF_TABLE_STATS_ENTRY = 777,
    OF_UINT32 = 778,
    OF_UINT64 = 779,
    OF_UINT8 = 780,
    ...
    /* List objects */
    OF_LIST_ACTION = 781,
    OF_LIST_ACTION_ID = 782,
    OF_LIST_ASYNC_CONFIG_PROP = 783,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 784,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 785,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 786,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 787,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 788,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 789,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 790,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 791,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 792,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 793,
    OF_LIST_BSN_INTERFACE = 794,
    OF_LIST_BSN_LACP_STATS_ENTRY = 795,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 796,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 797,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 798,
    OF_LIST_BSN_TLV = 799,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 800,
    OF_LIST_BSN_VLAN_MAC = 801,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 802,
    OF_LIST_BUCKET = 803,
    OF_LIST_BUCKET_COUNTER = 804,
    OF_LIST_BUNDLE_PROP = 805,
    OF_LIST_FLOW_STATS_ENTRY = 806,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 807,
    OF_LIST_GROUP_STATS_ENTRY = 808,
    OF_LIST_HELLO_ELEM = 809,
    OF_LIST_INSTRUCTION = 810,
    OF_LIST_INSTRUCTION_ID = 811,
    OF_LIST_METER_BAND = 812,
    OF_LIST_METER_BAND_STATS = 813,
    OF_LIST_METER_CONFIG = 814,
    OF_LIST_METER_STATS = 815,
    OF_LIST_OXM = 816,
    OF_LIST_PACKET_QUEUE = 817,
    OF_LIST_PORT_DESC = 818,
    OF_LIST_PORT_DESC_PROP = 819,
    OF_LIST_PORT_MOD_PROP = 820,
    OF_LIST_PORT_STATS_ENTRY = 821,
    OF_LIST_PORT_STATS_PROP = 822,
    OF_LIST_QUEUE_DESC = 823,
    OF_LIST_QUEUE_DESC_PROP = 824,
    OF_LIST_QUEUE_PROP = 825,
    OF_LIST_QUEUE_STATS_ENTRY = 826,
    OF_LIST_QUEUE_STATS_PROP = 827,
    OF_LIST_ROLE_PROP = 828,
    OF_LIST_TABLE_DESC = 829,
    OF_LIST_TABLE_FEATURE_PROP = 830,
    OF_LIST_TABLE_FEATURES = 831,
    OF_LIST_TABLE_MOD_PROP = 832,
    OF_LIST_TABLE_STATS_ENTRY = 833,
    OF_LIST_UINT32 = 834,
    OF_LIST_UINT64 = 835,
    OF_LIST_UINT8 = 836,
