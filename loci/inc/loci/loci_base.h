...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DSCP = 327,
    OF_BSN_TLV_ECN = 328,
    OF_BSN_TLV_EGRESS_ONLY = 329,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 330,
    OF_BSN_TLV_ENCAP = 331,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 332,
    OF_BSN_TLV_ETH_DST = 333,
    OF_BSN_TLV_ETH_SRC = 334,
    OF_BSN_TLV_ETH_TYPE = 335,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 336,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 337,
    OF_BSN_TLV_EXTERNAL_IP = 338,
    OF_BSN_TLV_EXTERNAL_MAC = 339,
    OF_BSN_TLV_EXTERNAL_NETMASK = 340,
    OF_BSN_TLV_FABRIC_PORT_ROLE = 341,
    OF_BSN_TLV_FLOOD = 342,
    OF_BSN_TLV_FLOW_CLASSIFIER = 343,
    OF_BSN_TLV_FLOW_CLASSIFY = 344,
    OF_BSN_TLV_FLOW_IDENTIFIER = 345,
    ...
    OF_BSN_TLV_IDENTIFIER = 361,
    OF_BSN_TLV_IDLE_NOTIFICATION = 362,
    OF_BSN_TLV_IDLE_TIME = 363,
    OF_BSN_TLV_IDLE_TIMEOUT = 364,
    OF_BSN_TLV_IGMP_SNOOPING = 365,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 366,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 367,
    OF_BSN_TLV_INTERNAL_MAC = 368,
    OF_BSN_TLV_INTERVAL = 369,
    OF_BSN_TLV_IP_PROTO = 370,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 371,
    OF_BSN_TLV_IPV4 = 372,
    OF_BSN_TLV_IPV4_DST = 373,
    OF_BSN_TLV_IPV4_NETMASK = 374,
    OF_BSN_TLV_IPV4_SRC = 375,
    OF_BSN_TLV_IPV6 = 376,
    OF_BSN_TLV_IPV6_DST = 377,
    OF_BSN_TLV_IPV6_PREFIX = 378,
    OF_BSN_TLV_IPV6_SRC = 379,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 380,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 381,
    OF_BSN_TLV_L3 = 382,
    OF_BSN_TLV_L3_DST_CLASS_ID = 383,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 384,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 385,
    OF_BSN_TLV_LAG_OPTIONS = 386,
    OF_BSN_TLV_LOOPBACK_MODE = 387,
    OF_BSN_TLV_LOOPBACK_PORT = 388,
    OF_BSN_TLV_LR_ALL_ENABLED = 389,
    OF_BSN_TLV_MAC = 390,
    OF_BSN_TLV_MAC_MASK = 391,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 392,
    OF_BSN_TLV_MISS_PACKETS = 393,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 394,
    OF_BSN_TLV_MPLS_LABEL = 395,
    OF_BSN_TLV_MPLS_SEQUENCED = 396,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 397,
    OF_BSN_TLV_MULTICAST_PACKET = 398,
    OF_BSN_TLV_MULTIPLIER = 399,
    OF_BSN_TLV_NAME = 400,
    OF_BSN_TLV_NDP_OFFLOAD = 401,
    OF_BSN_TLV_NDP_STATIC = 402,
    OF_BSN_TLV_NEGATE = 403,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 404,
    OF_BSN_TLV_NEXT_HOP_MAC = 405,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 406,
    OF_BSN_TLV_NO_ARP_RESPONSE = 407,
    OF_BSN_TLV_NO_NS_RESPONSE = 408,
    OF_BSN_TLV_OFFSET = 409,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 410,
    OF_BSN_TLV_OUTER_SRC_MAC = 411,
    OF_BSN_TLV_PARENT_PORT = 412,
    OF_BSN_TLV_PARTNER_KEY = 413,
    OF_BSN_TLV_PARTNER_PORT_NUM = 414,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 415,
    OF_BSN_TLV_PARTNER_STATE = 416,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 417,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 418,
    OF_BSN_TLV_PASSIVE = 419,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 420,
    OF_BSN_TLV_PIM_DR = 421,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 422,
    OF_BSN_TLV_PORT = 423,
    OF_BSN_TLV_PORT_MODE = 424,
    OF_BSN_TLV_PORT_SPEED_GBPS = 425,
    OF_BSN_TLV_PORT_USAGE = 426,
    OF_BSN_TLV_PORT_VXLAN_MODE = 427,
    OF_BSN_TLV_PRIORITY = 428,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 429,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 430,
    OF_BSN_TLV_QOS_PRIORITY = 431,
    OF_BSN_TLV_QUEUE_ID = 432,
    OF_BSN_TLV_QUEUE_WEIGHT = 433,
    OF_BSN_TLV_RATE_LIMIT = 434,
    OF_BSN_TLV_RATE_UNIT = 435,
    OF_BSN_TLV_RECORD_PACKETS = 436,
    OF_BSN_TLV_REFERENCE = 437,
    OF_BSN_TLV_REPLY_PACKETS = 438,
    OF_BSN_TLV_REQUEST_PACKETS = 439,
    OF_BSN_TLV_REST_SERVER = 440,
    OF_BSN_TLV_ROUTING_PARAM = 441,
    OF_BSN_TLV_RX_BYTES = 442,
    OF_BSN_TLV_RX_PACKETS = 443,
    OF_BSN_TLV_SAMPLING_RATE = 444,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 445,
    OF_BSN_TLV_STATUS = 446,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 447,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 448,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 449,
    OF_BSN_TLV_SUB_AGENT_ID = 450,
    OF_BSN_TLV_TCP_DST = 451,
    OF_BSN_TLV_TCP_FLAGS = 452,
    OF_BSN_TLV_TCP_SRC = 453,
    OF_BSN_TLV_TIMESTAMP = 454,
    OF_BSN_TLV_TTL = 455,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 456,
    OF_BSN_TLV_TX_BYTES = 457,
    OF_BSN_TLV_TX_PACKETS = 458,
    OF_BSN_TLV_UDF_ANCHOR = 459,
    OF_BSN_TLV_UDF_CAPABILITY = 460,
    OF_BSN_TLV_UDF_ID = 461,
    OF_BSN_TLV_UDF_LENGTH = 462,
    OF_BSN_TLV_UDF_OFFSET = 463,
    OF_BSN_TLV_UDP_DST = 464,
    OF_BSN_TLV_UDP_SRC = 465,
    OF_BSN_TLV_UINT32 = 466,
    OF_BSN_TLV_UINT64_LIST = 467,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 468,
    OF_BSN_TLV_UNICAST_RATE = 469,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 470,
    OF_BSN_TLV_UNTAGGED = 471,
    OF_BSN_TLV_UPGRADE = 472,
    OF_BSN_TLV_URI_SCHEME = 473,
    OF_BSN_TLV_USE_PACKET_STATE = 474,
    OF_BSN_TLV_USER_CONFIGURED = 475,
    OF_BSN_TLV_VFI = 476,
    OF_BSN_TLV_VFP_CLASS_ID = 477,
    OF_BSN_TLV_VIRTUAL = 478,
    OF_BSN_TLV_VLAN_MAC_LIST = 479,
    OF_BSN_TLV_VLAN_PCP = 480,
    OF_BSN_TLV_VLAN_VID = 481,
    OF_BSN_TLV_VLAN_VID_MASK = 482,
    OF_BSN_TLV_VNI = 483,
    OF_BSN_TLV_VPN_KEY = 484,
    OF_BSN_TLV_VRF = 485,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 486,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 487,
    OF_BSN_VLAN_MAC = 488,
    OF_BSN_VPORT = 489,
    OF_BSN_VPORT_L2GRE = 490,
    OF_BSN_VPORT_Q_IN_Q = 491,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 492,
    OF_BUCKET = 493,
    OF_BUCKET_COUNTER = 494,
    OF_BUNDLE_PROP = 495,
    OF_BUNDLE_PROP_EXPERIMENTER = 496,
    OF_FLOW_STATS_ENTRY = 497,
    OF_GROUP_DESC_STATS_ENTRY = 498,
    OF_GROUP_STATS_ENTRY = 499,
    OF_HELLO_ELEM = 500,
    OF_HELLO_ELEM_VERSIONBITMAP = 501,
    OF_INSTRUCTION = 502,
    OF_INSTRUCTION_APPLY_ACTIONS = 503,
    OF_INSTRUCTION_BSN = 504,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 505,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 506,
    OF_INSTRUCTION_BSN_DENY = 507,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 508,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 509,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 510,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 511,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 512,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 513,
    OF_INSTRUCTION_BSN_HASH_SELECT = 514,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 515,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 516,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 517,
    OF_INSTRUCTION_BSN_PERMIT = 518,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 519,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 520,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 521,
    OF_INSTRUCTION_CLEAR_ACTIONS = 522,
    OF_INSTRUCTION_EXPERIMENTER = 523,
    OF_INSTRUCTION_GOTO_TABLE = 524,
    OF_INSTRUCTION_ID = 525,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 526,
    OF_INSTRUCTION_ID_BSN = 527,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 528,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 529,
    OF_INSTRUCTION_ID_BSN_DENY = 530,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 531,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 532,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 533,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 534,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 535,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 536,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 537,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 538,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 539,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 540,
    OF_INSTRUCTION_ID_BSN_PERMIT = 541,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 542,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 543,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 544,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 545,
    OF_INSTRUCTION_ID_EXPERIMENTER = 546,
    OF_INSTRUCTION_ID_GOTO_TABLE = 547,
    OF_INSTRUCTION_ID_METER = 548,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 549,
    OF_INSTRUCTION_ID_WRITE_METADATA = 550,
    OF_INSTRUCTION_METER = 551,
    OF_INSTRUCTION_WRITE_ACTIONS = 552,
    OF_INSTRUCTION_WRITE_METADATA = 553,
    OF_MATCH_V1 = 554,
    OF_MATCH_V2 = 555,
    OF_MATCH_V3 = 556,
    OF_METER_BAND = 557,
    OF_METER_BAND_DROP = 558,
    OF_METER_BAND_DSCP_REMARK = 559,
    OF_METER_BAND_EXPERIMENTER = 560,
    OF_METER_BAND_STATS = 561,
    OF_METER_CONFIG = 562,
    OF_METER_FEATURES = 563,
    OF_METER_STATS = 564,
    OF_OXM = 565,
    OF_OXM_ARP_OP = 566,
    OF_OXM_ARP_OP_MASKED = 567,
    OF_OXM_ARP_SHA = 568,
    OF_OXM_ARP_SHA_MASKED = 569,
    OF_OXM_ARP_SPA = 570,
    OF_OXM_ARP_SPA_MASKED = 571,
    OF_OXM_ARP_THA = 572,
    OF_OXM_ARP_THA_MASKED = 573,
    OF_OXM_ARP_TPA = 574,
    OF_OXM_ARP_TPA_MASKED = 575,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 576,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 577,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 578,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 579,
    OF_OXM_BSN_IFP_CLASS_ID = 580,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 581,
    OF_OXM_BSN_IN_PORTS_128 = 582,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 583,
    OF_OXM_BSN_IN_PORTS_512 = 584,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 585,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 586,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 587,
    OF_OXM_BSN_INNER_ETH_DST = 588,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 589,
    OF_OXM_BSN_INNER_ETH_SRC = 590,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 591,
    OF_OXM_BSN_INNER_VLAN_VID = 592,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 593,
    OF_OXM_BSN_IP_FRAGMENTATION = 594,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 595,
    OF_OXM_BSN_L2_CACHE_HIT = 596,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 597,
    OF_OXM_BSN_L3_DST_CLASS_ID = 598,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 599,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 600,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 601,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 602,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 603,
    OF_OXM_BSN_LAG_ID = 604,
    OF_OXM_BSN_LAG_ID_MASKED = 605,
    OF_OXM_BSN_TCP_FLAGS = 606,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 607,
    OF_OXM_BSN_UDF0 = 608,
    OF_OXM_BSN_UDF0_MASKED = 609,
    OF_OXM_BSN_UDF1 = 610,
    OF_OXM_BSN_UDF1_MASKED = 611,
    OF_OXM_BSN_UDF2 = 612,
    OF_OXM_BSN_UDF2_MASKED = 613,
    OF_OXM_BSN_UDF3 = 614,
    OF_OXM_BSN_UDF3_MASKED = 615,
    OF_OXM_BSN_UDF4 = 616,
    OF_OXM_BSN_UDF4_MASKED = 617,
    OF_OXM_BSN_UDF5 = 618,
    OF_OXM_BSN_UDF5_MASKED = 619,
    OF_OXM_BSN_UDF6 = 620,
    OF_OXM_BSN_UDF6_MASKED = 621,
    OF_OXM_BSN_UDF7 = 622,
    OF_OXM_BSN_UDF7_MASKED = 623,
    OF_OXM_BSN_VFI = 624,
    OF_OXM_BSN_VFI_MASKED = 625,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 626,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 627,
    OF_OXM_BSN_VRF = 628,
    OF_OXM_BSN_VRF_MASKED = 629,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 630,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 631,
    OF_OXM_CONN_TRACKING_IPV6_DST = 632,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 633,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 634,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 635,
    OF_OXM_CONN_TRACKING_LABEL = 636,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 637,
    OF_OXM_CONN_TRACKING_MARK = 638,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 639,
    OF_OXM_CONN_TRACKING_NW_DST = 640,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 641,
    OF_OXM_CONN_TRACKING_NW_PROTO = 642,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 643,
    OF_OXM_CONN_TRACKING_NW_SRC = 644,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 645,
    OF_OXM_CONN_TRACKING_STATE = 646,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 647,
    OF_OXM_CONN_TRACKING_TP_DST = 648,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 649,
    OF_OXM_CONN_TRACKING_TP_SRC = 650,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 651,
    OF_OXM_CONN_TRACKING_ZONE = 652,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 653,
    OF_OXM_ETH_DST = 654,
    OF_OXM_ETH_DST_MASKED = 655,
    OF_OXM_ETH_SRC = 656,
    OF_OXM_ETH_SRC_MASKED = 657,
    OF_OXM_ETH_TYPE = 658,
    OF_OXM_ETH_TYPE_MASKED = 659,
    OF_OXM_ICMPV4_CODE = 660,
    OF_OXM_ICMPV4_CODE_MASKED = 661,
    OF_OXM_ICMPV4_TYPE = 662,
    OF_OXM_ICMPV4_TYPE_MASKED = 663,
    OF_OXM_ICMPV6_CODE = 664,
    OF_OXM_ICMPV6_CODE_MASKED = 665,
    OF_OXM_ICMPV6_TYPE = 666,
    OF_OXM_ICMPV6_TYPE_MASKED = 667,
    OF_OXM_IN_PHY_PORT = 668,
    OF_OXM_IN_PHY_PORT_MASKED = 669,
    OF_OXM_IN_PORT = 670,
    OF_OXM_IN_PORT_MASKED = 671,
    OF_OXM_IP_DSCP = 672,
    OF_OXM_IP_DSCP_MASKED = 673,
    OF_OXM_IP_ECN = 674,
    OF_OXM_IP_ECN_MASKED = 675,
    OF_OXM_IP_PROTO = 676,
    OF_OXM_IP_PROTO_MASKED = 677,
    OF_OXM_IPV4_DST = 678,
    OF_OXM_IPV4_DST_MASKED = 679,
    OF_OXM_IPV4_SRC = 680,
    OF_OXM_IPV4_SRC_MASKED = 681,
    OF_OXM_IPV6_DST = 682,
    OF_OXM_IPV6_DST_MASKED = 683,
    OF_OXM_IPV6_EXTHDR = 684,
    OF_OXM_IPV6_EXTHDR_MASKED = 685,
    OF_OXM_IPV6_FLABEL = 686,
    OF_OXM_IPV6_FLABEL_MASKED = 687,
    OF_OXM_IPV6_ND_SLL = 688,
    OF_OXM_IPV6_ND_SLL_MASKED = 689,
    OF_OXM_IPV6_ND_TARGET = 690,
    OF_OXM_IPV6_ND_TARGET_MASKED = 691,
    OF_OXM_IPV6_ND_TLL = 692,
    OF_OXM_IPV6_ND_TLL_MASKED = 693,
    OF_OXM_IPV6_SRC = 694,
    OF_OXM_IPV6_SRC_MASKED = 695,
    OF_OXM_METADATA = 696,
    OF_OXM_METADATA_MASKED = 697,
    OF_OXM_MPLS_BOS = 698,
    OF_OXM_MPLS_BOS_MASKED = 699,
    OF_OXM_MPLS_LABEL = 700,
    OF_OXM_MPLS_LABEL_MASKED = 701,
    OF_OXM_MPLS_TC = 702,
    OF_OXM_MPLS_TC_MASKED = 703,
    OF_OXM_OVS_TCP_FLAGS = 704,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 705,
    OF_OXM_PBB_UCA = 706,
    OF_OXM_PBB_UCA_MASKED = 707,
    OF_OXM_SCTP_DST = 708,
    OF_OXM_SCTP_DST_MASKED = 709,
    OF_OXM_SCTP_SRC = 710,
    OF_OXM_SCTP_SRC_MASKED = 711,
    OF_OXM_TCP_DST = 712,
    OF_OXM_TCP_DST_MASKED = 713,
    OF_OXM_TCP_SRC = 714,
    OF_OXM_TCP_SRC_MASKED = 715,
    OF_OXM_TUNNEL_ID = 716,
    OF_OXM_TUNNEL_ID_MASKED = 717,
    OF_OXM_TUNNEL_IPV4_DST = 718,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 719,
    OF_OXM_TUNNEL_IPV4_SRC = 720,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 721,
    OF_OXM_UDP_DST = 722,
    OF_OXM_UDP_DST_MASKED = 723,
    OF_OXM_UDP_SRC = 724,
    OF_OXM_UDP_SRC_MASKED = 725,
    OF_OXM_VLAN_PCP = 726,
    OF_OXM_VLAN_PCP_MASKED = 727,
    OF_OXM_VLAN_VID = 728,
    OF_OXM_VLAN_VID_MASKED = 729,
    OF_PACKET_QUEUE = 730,
    OF_PORT_DESC = 731,
    OF_PORT_DESC_PROP = 732,
    OF_PORT_DESC_PROP_BSN = 733,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 734,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 735,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 736,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 737,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 738,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 739,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 740,
    OF_PORT_DESC_PROP_BSN_UPLINK = 741,
    OF_PORT_DESC_PROP_ETHERNET = 742,
    OF_PORT_DESC_PROP_EXPERIMENTER = 743,
    OF_PORT_DESC_PROP_OPTICAL = 744,
    OF_PORT_MOD_PROP = 745,
    OF_PORT_MOD_PROP_ETHERNET = 746,
    OF_PORT_MOD_PROP_EXPERIMENTER = 747,
    OF_PORT_MOD_PROP_OPTICAL = 748,
    OF_PORT_STATS_ENTRY = 749,
    OF_PORT_STATS_PROP = 750,
    OF_PORT_STATS_PROP_ETHERNET = 751,
    OF_PORT_STATS_PROP_EXPERIMENTER = 752,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 753,
    OF_PORT_STATS_PROP_OPTICAL = 754,
    OF_QUEUE_DESC = 755,
    OF_QUEUE_DESC_PROP = 756,
    OF_QUEUE_DESC_PROP_BSN = 757,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 758,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 759,
    OF_QUEUE_DESC_PROP_MAX_RATE = 760,
    OF_QUEUE_DESC_PROP_MIN_RATE = 761,
    OF_QUEUE_PROP = 762,
    OF_QUEUE_PROP_EXPERIMENTER = 763,
    OF_QUEUE_PROP_MAX_RATE = 764,
    OF_QUEUE_PROP_MIN_RATE = 765,
    OF_QUEUE_STATS_ENTRY = 766,
    OF_QUEUE_STATS_PROP = 767,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 768,
    OF_ROLE_PROP = 769,
    OF_ROLE_PROP_EXPERIMENTER = 770,
    OF_TABLE_DESC = 771,
    OF_TABLE_FEATURE_PROP = 772,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 773,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 774,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 775,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 776,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 777,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 778,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 779,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 780,
    OF_TABLE_FEATURE_PROP_MATCH = 781,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 782,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 783,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 784,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 785,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 786,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 787,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 788,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 789,
    OF_TABLE_FEATURES = 790,
    OF_TABLE_MOD_PROP = 791,
    OF_TABLE_MOD_PROP_EVICTION = 792,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 793,
    OF_TABLE_MOD_PROP_VACANCY = 794,
    OF_TABLE_STATS_ENTRY = 795,
    OF_UINT32 = 796,
    OF_UINT64 = 797,
    OF_UINT8 = 798,
    ...
    /* List objects */
    OF_LIST_ACTION = 799,
    OF_LIST_ACTION_ID = 800,
    OF_LIST_ASYNC_CONFIG_PROP = 801,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 802,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 803,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 804,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 805,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 806,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 807,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 808,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 809,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 810,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 811,
    OF_LIST_BSN_INTERFACE = 812,
    OF_LIST_BSN_LACP_STATS_ENTRY = 813,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 814,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 815,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 816,
    OF_LIST_BSN_TLV = 817,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 818,
    OF_LIST_BSN_VLAN_MAC = 819,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 820,
    OF_LIST_BUCKET = 821,
    OF_LIST_BUCKET_COUNTER = 822,
    OF_LIST_BUNDLE_PROP = 823,
    OF_LIST_FLOW_STATS_ENTRY = 824,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 825,
    OF_LIST_GROUP_STATS_ENTRY = 826,
    OF_LIST_HELLO_ELEM = 827,
    OF_LIST_INSTRUCTION = 828,
    OF_LIST_INSTRUCTION_ID = 829,
    OF_LIST_METER_BAND = 830,
    OF_LIST_METER_BAND_STATS = 831,
    OF_LIST_METER_CONFIG = 832,
    OF_LIST_METER_STATS = 833,
    OF_LIST_OXM = 834,
    OF_LIST_PACKET_QUEUE = 835,
    OF_LIST_PORT_DESC = 836,
    OF_LIST_PORT_DESC_PROP = 837,
    OF_LIST_PORT_MOD_PROP = 838,
    OF_LIST_PORT_STATS_ENTRY = 839,
    OF_LIST_PORT_STATS_PROP = 840,
    OF_LIST_QUEUE_DESC = 841,
    OF_LIST_QUEUE_DESC_PROP = 842,
    OF_LIST_QUEUE_PROP = 843,
    OF_LIST_QUEUE_STATS_ENTRY = 844,
    OF_LIST_QUEUE_STATS_PROP = 845,
    OF_LIST_ROLE_PROP = 846,
    OF_LIST_TABLE_DESC = 847,
    OF_LIST_TABLE_FEATURE_PROP = 848,
    OF_LIST_TABLE_FEATURES = 849,
    OF_LIST_TABLE_MOD_PROP = 850,
    OF_LIST_TABLE_STATS_ENTRY = 851,
    OF_LIST_UINT32 = 852,
    OF_LIST_UINT64 = 853,
    OF_LIST_UINT8 = 854,
