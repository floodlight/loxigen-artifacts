...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 311,
    OF_BSN_TLV_BROADCAST_RATE = 312,
    OF_BSN_TLV_BUCKET = 313,
    OF_BSN_TLV_CIRCUIT_ID = 314,
    OF_BSN_TLV_CONVERGENCE_STATUS = 315,
    OF_BSN_TLV_CPU_LAG = 316,
    OF_BSN_TLV_CRC_ENABLED = 317,
    OF_BSN_TLV_DATA = 318,
    OF_BSN_TLV_DATA_MASK = 319,
    OF_BSN_TLV_DECAP = 320,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 321,
    OF_BSN_TLV_DROP = 322,
    OF_BSN_TLV_DSCP = 323,
    OF_BSN_TLV_ECN = 324,
    OF_BSN_TLV_EGRESS_ONLY = 325,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 326,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 327,
    OF_BSN_TLV_ETH_DST = 328,
    OF_BSN_TLV_ETH_SRC = 329,
    OF_BSN_TLV_ETH_TYPE = 330,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 331,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 332,
    OF_BSN_TLV_EXTERNAL_IP = 333,
    OF_BSN_TLV_EXTERNAL_MAC = 334,
    OF_BSN_TLV_EXTERNAL_NETMASK = 335,
    OF_BSN_TLV_GENERATION_ID = 336,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 337,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 338,
    OF_BSN_TLV_HASH_PACKET_FIELD = 339,
    OF_BSN_TLV_HASH_PACKET_TYPE = 340,
    OF_BSN_TLV_HASH_SEED = 341,
    OF_BSN_TLV_HASH_TYPE = 342,
    OF_BSN_TLV_HEADER_SIZE = 343,
    OF_BSN_TLV_ICMP_CODE = 344,
    OF_BSN_TLV_ICMP_ID = 345,
    OF_BSN_TLV_ICMP_TYPE = 346,
    OF_BSN_TLV_ICMPV6_CHKSUM = 347,
    OF_BSN_TLV_IDLE_NOTIFICATION = 348,
    OF_BSN_TLV_IDLE_TIME = 349,
    OF_BSN_TLV_IDLE_TIMEOUT = 350,
    OF_BSN_TLV_IGMP_SNOOPING = 351,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 352,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 353,
    OF_BSN_TLV_INTERNAL_MAC = 354,
    OF_BSN_TLV_INTERVAL = 355,
    OF_BSN_TLV_IP_PROTO = 356,
    OF_BSN_TLV_IPV4 = 357,
    OF_BSN_TLV_IPV4_DST = 358,
    OF_BSN_TLV_IPV4_NETMASK = 359,
    OF_BSN_TLV_IPV4_SRC = 360,
    OF_BSN_TLV_IPV6 = 361,
    OF_BSN_TLV_IPV6_DST = 362,
    OF_BSN_TLV_IPV6_PREFIX = 363,
    OF_BSN_TLV_IPV6_SRC = 364,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 365,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 366,
    OF_BSN_TLV_L3_DST_CLASS_ID = 367,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 368,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 369,
    OF_BSN_TLV_LOOPBACK_PORT = 370,
    OF_BSN_TLV_MAC = 371,
    OF_BSN_TLV_MAC_MASK = 372,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 373,
    OF_BSN_TLV_MISS_PACKETS = 374,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 375,
    OF_BSN_TLV_MPLS_LABEL = 376,
    OF_BSN_TLV_MPLS_SEQUENCED = 377,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 378,
    OF_BSN_TLV_NAME = 379,
    OF_BSN_TLV_NDP_OFFLOAD = 380,
    OF_BSN_TLV_NDP_STATIC = 381,
    OF_BSN_TLV_NEGATE = 382,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 383,
    OF_BSN_TLV_NEXT_HOP_MAC = 384,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 385,
    OF_BSN_TLV_OFFSET = 386,
    OF_BSN_TLV_PARENT_PORT = 387,
    OF_BSN_TLV_PARTNER_KEY = 388,
    OF_BSN_TLV_PARTNER_PORT_NUM = 389,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 390,
    OF_BSN_TLV_PARTNER_STATE = 391,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 392,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 393,
    OF_BSN_TLV_PORT = 394,
    OF_BSN_TLV_PORT_USAGE = 395,
    OF_BSN_TLV_PORT_VXLAN_MODE = 396,
    OF_BSN_TLV_PRIORITY = 397,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 398,
    OF_BSN_TLV_QOS_PRIORITY = 399,
    OF_BSN_TLV_QUEUE_ID = 400,
    OF_BSN_TLV_QUEUE_WEIGHT = 401,
    OF_BSN_TLV_RATE_LIMIT = 402,
    OF_BSN_TLV_RATE_UNIT = 403,
    OF_BSN_TLV_REFERENCE = 404,
    OF_BSN_TLV_REPLY_PACKETS = 405,
    OF_BSN_TLV_REQUEST_PACKETS = 406,
    OF_BSN_TLV_RX_BYTES = 407,
    OF_BSN_TLV_RX_PACKETS = 408,
    OF_BSN_TLV_SAMPLING_RATE = 409,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 410,
    OF_BSN_TLV_STATUS = 411,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 412,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 413,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 414,
    OF_BSN_TLV_SUB_AGENT_ID = 415,
    OF_BSN_TLV_TCP_DST = 416,
    OF_BSN_TLV_TCP_FLAGS = 417,
    OF_BSN_TLV_TCP_SRC = 418,
    OF_BSN_TLV_TTL = 419,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 420,
    OF_BSN_TLV_TX_BYTES = 421,
    OF_BSN_TLV_TX_PACKETS = 422,
    OF_BSN_TLV_UDF_ANCHOR = 423,
    OF_BSN_TLV_UDF_ID = 424,
    OF_BSN_TLV_UDF_LENGTH = 425,
    OF_BSN_TLV_UDF_OFFSET = 426,
    OF_BSN_TLV_UDP_DST = 427,
    OF_BSN_TLV_UDP_SRC = 428,
    OF_BSN_TLV_UINT64_LIST = 429,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 430,
    OF_BSN_TLV_UNICAST_RATE = 431,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 432,
    OF_BSN_TLV_UNTAGGED = 433,
    OF_BSN_TLV_USE_PACKET_STATE = 434,
    OF_BSN_TLV_VFI = 435,
    OF_BSN_TLV_VFP_CLASS_ID = 436,
    OF_BSN_TLV_VLAN_MAC_LIST = 437,
    OF_BSN_TLV_VLAN_PCP = 438,
    OF_BSN_TLV_VLAN_VID = 439,
    OF_BSN_TLV_VLAN_VID_MASK = 440,
    OF_BSN_TLV_VNI = 441,
    OF_BSN_TLV_VPN_KEY = 442,
    OF_BSN_TLV_VRF = 443,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 444,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 445,
    OF_BSN_VLAN_MAC = 446,
    OF_BSN_VPORT = 447,
    OF_BSN_VPORT_L2GRE = 448,
    OF_BSN_VPORT_Q_IN_Q = 449,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 450,
    OF_BUCKET = 451,
    OF_BUCKET_COUNTER = 452,
    OF_BUNDLE_PROP = 453,
    OF_BUNDLE_PROP_EXPERIMENTER = 454,
    OF_FLOW_STATS_ENTRY = 455,
    OF_GROUP_DESC_STATS_ENTRY = 456,
    OF_GROUP_STATS_ENTRY = 457,
    OF_HELLO_ELEM = 458,
    OF_HELLO_ELEM_VERSIONBITMAP = 459,
    OF_INSTRUCTION = 460,
    OF_INSTRUCTION_APPLY_ACTIONS = 461,
    OF_INSTRUCTION_BSN = 462,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 463,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 464,
    OF_INSTRUCTION_BSN_DENY = 465,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 466,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 467,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 468,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 469,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 470,
    OF_INSTRUCTION_BSN_HASH_SELECT = 471,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 472,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 473,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 474,
    OF_INSTRUCTION_BSN_PERMIT = 475,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 476,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 477,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 478,
    OF_INSTRUCTION_CLEAR_ACTIONS = 479,
    OF_INSTRUCTION_EXPERIMENTER = 480,
    OF_INSTRUCTION_GOTO_TABLE = 481,
    OF_INSTRUCTION_ID = 482,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 483,
    OF_INSTRUCTION_ID_BSN = 484,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 485,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 486,
    OF_INSTRUCTION_ID_BSN_DENY = 487,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 488,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 489,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 490,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 491,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 492,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 493,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 494,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 495,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 496,
    OF_INSTRUCTION_ID_BSN_PERMIT = 497,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 498,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 499,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 500,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 501,
    OF_INSTRUCTION_ID_EXPERIMENTER = 502,
    OF_INSTRUCTION_ID_GOTO_TABLE = 503,
    OF_INSTRUCTION_ID_METER = 504,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 505,
    OF_INSTRUCTION_ID_WRITE_METADATA = 506,
    OF_INSTRUCTION_METER = 507,
    OF_INSTRUCTION_WRITE_ACTIONS = 508,
    OF_INSTRUCTION_WRITE_METADATA = 509,
    OF_MATCH_V1 = 510,
    OF_MATCH_V2 = 511,
    OF_MATCH_V3 = 512,
    OF_METER_BAND = 513,
    OF_METER_BAND_DROP = 514,
    OF_METER_BAND_DSCP_REMARK = 515,
    OF_METER_BAND_EXPERIMENTER = 516,
    OF_METER_BAND_STATS = 517,
    OF_METER_CONFIG = 518,
    OF_METER_FEATURES = 519,
    OF_METER_STATS = 520,
    OF_OXM = 521,
    OF_OXM_ARP_OP = 522,
    OF_OXM_ARP_OP_MASKED = 523,
    OF_OXM_ARP_SHA = 524,
    OF_OXM_ARP_SHA_MASKED = 525,
    OF_OXM_ARP_SPA = 526,
    OF_OXM_ARP_SPA_MASKED = 527,
    OF_OXM_ARP_THA = 528,
    OF_OXM_ARP_THA_MASKED = 529,
    OF_OXM_ARP_TPA = 530,
    OF_OXM_ARP_TPA_MASKED = 531,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 532,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 533,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 534,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 535,
    OF_OXM_BSN_IN_PORTS_128 = 536,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 537,
    OF_OXM_BSN_IN_PORTS_512 = 538,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 539,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 540,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 541,
    OF_OXM_BSN_INNER_ETH_DST = 542,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 543,
    OF_OXM_BSN_INNER_ETH_SRC = 544,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 545,
    OF_OXM_BSN_INNER_VLAN_VID = 546,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 547,
    OF_OXM_BSN_IP_FRAGMENTATION = 548,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 549,
    OF_OXM_BSN_L2_CACHE_HIT = 550,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 551,
    OF_OXM_BSN_L3_DST_CLASS_ID = 552,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 553,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 554,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 555,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 556,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 557,
    OF_OXM_BSN_LAG_ID = 558,
    OF_OXM_BSN_LAG_ID_MASKED = 559,
    OF_OXM_BSN_TCP_FLAGS = 560,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 561,
    OF_OXM_BSN_UDF0 = 562,
    OF_OXM_BSN_UDF0_MASKED = 563,
    OF_OXM_BSN_UDF1 = 564,
    OF_OXM_BSN_UDF1_MASKED = 565,
    OF_OXM_BSN_UDF2 = 566,
    OF_OXM_BSN_UDF2_MASKED = 567,
    OF_OXM_BSN_UDF3 = 568,
    OF_OXM_BSN_UDF3_MASKED = 569,
    OF_OXM_BSN_UDF4 = 570,
    OF_OXM_BSN_UDF4_MASKED = 571,
    OF_OXM_BSN_UDF5 = 572,
    OF_OXM_BSN_UDF5_MASKED = 573,
    OF_OXM_BSN_UDF6 = 574,
    OF_OXM_BSN_UDF6_MASKED = 575,
    OF_OXM_BSN_UDF7 = 576,
    OF_OXM_BSN_UDF7_MASKED = 577,
    OF_OXM_BSN_VFI = 578,
    OF_OXM_BSN_VFI_MASKED = 579,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 580,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 581,
    OF_OXM_BSN_VRF = 582,
    OF_OXM_BSN_VRF_MASKED = 583,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 584,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 585,
    OF_OXM_ETH_DST = 586,
    OF_OXM_ETH_DST_MASKED = 587,
    OF_OXM_ETH_SRC = 588,
    OF_OXM_ETH_SRC_MASKED = 589,
    OF_OXM_ETH_TYPE = 590,
    OF_OXM_ETH_TYPE_MASKED = 591,
    OF_OXM_ICMPV4_CODE = 592,
    OF_OXM_ICMPV4_CODE_MASKED = 593,
    OF_OXM_ICMPV4_TYPE = 594,
    OF_OXM_ICMPV4_TYPE_MASKED = 595,
    OF_OXM_ICMPV6_CODE = 596,
    OF_OXM_ICMPV6_CODE_MASKED = 597,
    OF_OXM_ICMPV6_TYPE = 598,
    OF_OXM_ICMPV6_TYPE_MASKED = 599,
    OF_OXM_IN_PHY_PORT = 600,
    OF_OXM_IN_PHY_PORT_MASKED = 601,
    OF_OXM_IN_PORT = 602,
    OF_OXM_IN_PORT_MASKED = 603,
    OF_OXM_IP_DSCP = 604,
    OF_OXM_IP_DSCP_MASKED = 605,
    OF_OXM_IP_ECN = 606,
    OF_OXM_IP_ECN_MASKED = 607,
    OF_OXM_IP_PROTO = 608,
    OF_OXM_IP_PROTO_MASKED = 609,
    OF_OXM_IPV4_DST = 610,
    OF_OXM_IPV4_DST_MASKED = 611,
    OF_OXM_IPV4_SRC = 612,
    OF_OXM_IPV4_SRC_MASKED = 613,
    OF_OXM_IPV6_DST = 614,
    OF_OXM_IPV6_DST_MASKED = 615,
    OF_OXM_IPV6_EXTHDR = 616,
    OF_OXM_IPV6_EXTHDR_MASKED = 617,
    OF_OXM_IPV6_FLABEL = 618,
    OF_OXM_IPV6_FLABEL_MASKED = 619,
    OF_OXM_IPV6_ND_SLL = 620,
    OF_OXM_IPV6_ND_SLL_MASKED = 621,
    OF_OXM_IPV6_ND_TARGET = 622,
    OF_OXM_IPV6_ND_TARGET_MASKED = 623,
    OF_OXM_IPV6_ND_TLL = 624,
    OF_OXM_IPV6_ND_TLL_MASKED = 625,
    OF_OXM_IPV6_SRC = 626,
    OF_OXM_IPV6_SRC_MASKED = 627,
    OF_OXM_METADATA = 628,
    OF_OXM_METADATA_MASKED = 629,
    OF_OXM_MPLS_BOS = 630,
    OF_OXM_MPLS_BOS_MASKED = 631,
    OF_OXM_MPLS_LABEL = 632,
    OF_OXM_MPLS_LABEL_MASKED = 633,
    OF_OXM_MPLS_TC = 634,
    OF_OXM_MPLS_TC_MASKED = 635,
    OF_OXM_OVS_TCP_FLAGS = 636,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 637,
    OF_OXM_PBB_UCA = 638,
    OF_OXM_PBB_UCA_MASKED = 639,
    OF_OXM_SCTP_DST = 640,
    OF_OXM_SCTP_DST_MASKED = 641,
    OF_OXM_SCTP_SRC = 642,
    OF_OXM_SCTP_SRC_MASKED = 643,
    OF_OXM_TCP_DST = 644,
    OF_OXM_TCP_DST_MASKED = 645,
    OF_OXM_TCP_SRC = 646,
    OF_OXM_TCP_SRC_MASKED = 647,
    OF_OXM_TUNNEL_ID = 648,
    OF_OXM_TUNNEL_ID_MASKED = 649,
    OF_OXM_TUNNEL_IPV4_DST = 650,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 651,
    OF_OXM_TUNNEL_IPV4_SRC = 652,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 653,
    OF_OXM_UDP_DST = 654,
    OF_OXM_UDP_DST_MASKED = 655,
    OF_OXM_UDP_SRC = 656,
    OF_OXM_UDP_SRC_MASKED = 657,
    OF_OXM_VLAN_PCP = 658,
    OF_OXM_VLAN_PCP_MASKED = 659,
    OF_OXM_VLAN_VID = 660,
    OF_OXM_VLAN_VID_MASKED = 661,
    OF_PACKET_QUEUE = 662,
    OF_PORT_DESC = 663,
    OF_PORT_DESC_PROP = 664,
    OF_PORT_DESC_PROP_BSN = 665,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 666,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 667,
    OF_PORT_DESC_PROP_BSN_UPLINK = 668,
    OF_PORT_DESC_PROP_ETHERNET = 669,
    OF_PORT_DESC_PROP_EXPERIMENTER = 670,
    OF_PORT_DESC_PROP_OPTICAL = 671,
    OF_PORT_MOD_PROP = 672,
    OF_PORT_MOD_PROP_ETHERNET = 673,
    OF_PORT_MOD_PROP_EXPERIMENTER = 674,
    OF_PORT_MOD_PROP_OPTICAL = 675,
    OF_PORT_STATS_ENTRY = 676,
    OF_PORT_STATS_PROP = 677,
    OF_PORT_STATS_PROP_ETHERNET = 678,
    OF_PORT_STATS_PROP_EXPERIMENTER = 679,
    OF_PORT_STATS_PROP_OPTICAL = 680,
    OF_QUEUE_DESC = 681,
    OF_QUEUE_DESC_PROP = 682,
    OF_QUEUE_DESC_PROP_BSN = 683,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 684,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 685,
    OF_QUEUE_DESC_PROP_MAX_RATE = 686,
    OF_QUEUE_DESC_PROP_MIN_RATE = 687,
    OF_QUEUE_PROP = 688,
    OF_QUEUE_PROP_EXPERIMENTER = 689,
    OF_QUEUE_PROP_MAX_RATE = 690,
    OF_QUEUE_PROP_MIN_RATE = 691,
    OF_QUEUE_STATS_ENTRY = 692,
    OF_QUEUE_STATS_PROP = 693,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 694,
    OF_ROLE_PROP = 695,
    OF_ROLE_PROP_EXPERIMENTER = 696,
    OF_TABLE_DESC = 697,
    OF_TABLE_FEATURE_PROP = 698,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 699,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 700,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 701,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 702,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 703,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 704,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 705,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 706,
    OF_TABLE_FEATURE_PROP_MATCH = 707,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 708,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 709,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 710,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 711,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 712,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 713,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 714,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 715,
    OF_TABLE_FEATURES = 716,
    OF_TABLE_MOD_PROP = 717,
    OF_TABLE_MOD_PROP_EVICTION = 718,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 719,
    OF_TABLE_MOD_PROP_VACANCY = 720,
    OF_TABLE_STATS_ENTRY = 721,
    OF_UINT32 = 722,
    OF_UINT64 = 723,
    OF_UINT8 = 724,
    ...
    /* List objects */
    OF_LIST_ACTION = 725,
    OF_LIST_ACTION_ID = 726,
    OF_LIST_ASYNC_CONFIG_PROP = 727,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 728,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 729,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 730,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 731,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 732,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 733,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 734,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 735,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 736,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 737,
    OF_LIST_BSN_INTERFACE = 738,
    OF_LIST_BSN_LACP_STATS_ENTRY = 739,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 740,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 741,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 742,
    OF_LIST_BSN_TLV = 743,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 744,
    OF_LIST_BSN_VLAN_MAC = 745,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 746,
    OF_LIST_BUCKET = 747,
    OF_LIST_BUCKET_COUNTER = 748,
    OF_LIST_BUNDLE_PROP = 749,
    OF_LIST_FLOW_STATS_ENTRY = 750,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 751,
    OF_LIST_GROUP_STATS_ENTRY = 752,
    OF_LIST_HELLO_ELEM = 753,
    OF_LIST_INSTRUCTION = 754,
    OF_LIST_INSTRUCTION_ID = 755,
    OF_LIST_METER_BAND = 756,
    OF_LIST_METER_BAND_STATS = 757,
    OF_LIST_METER_CONFIG = 758,
    OF_LIST_METER_STATS = 759,
    OF_LIST_OXM = 760,
    OF_LIST_PACKET_QUEUE = 761,
    OF_LIST_PORT_DESC = 762,
    OF_LIST_PORT_DESC_PROP = 763,
    OF_LIST_PORT_MOD_PROP = 764,
    OF_LIST_PORT_STATS_ENTRY = 765,
    OF_LIST_PORT_STATS_PROP = 766,
    OF_LIST_QUEUE_DESC = 767,
    OF_LIST_QUEUE_DESC_PROP = 768,
    OF_LIST_QUEUE_PROP = 769,
    OF_LIST_QUEUE_STATS_ENTRY = 770,
    OF_LIST_QUEUE_STATS_PROP = 771,
    OF_LIST_ROLE_PROP = 772,
    OF_LIST_TABLE_DESC = 773,
    OF_LIST_TABLE_FEATURE_PROP = 774,
    OF_LIST_TABLE_FEATURES = 775,
    OF_LIST_TABLE_MOD_PROP = 776,
    OF_LIST_TABLE_STATS_ENTRY = 777,
    OF_LIST_UINT32 = 778,
    OF_LIST_UINT64 = 779,
    OF_LIST_UINT8 = 780,
