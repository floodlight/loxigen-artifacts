...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_IPV4_NETMASK = 316,
    OF_BSN_TLV_IPV4_SRC = 317,
    OF_BSN_TLV_MAC = 318,
    OF_BSN_TLV_MAC_MASK = 319,
    OF_BSN_TLV_MISS_PACKETS = 320,
    OF_BSN_TLV_NAME = 321,
    OF_BSN_TLV_PARTNER_KEY = 322,
    OF_BSN_TLV_PARTNER_PORT_NUM = 323,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 324,
    OF_BSN_TLV_PARTNER_STATE = 325,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 326,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 327,
    OF_BSN_TLV_PORT = 328,
    OF_BSN_TLV_PRIORITY = 329,
    OF_BSN_TLV_QUEUE_ID = 330,
    OF_BSN_TLV_QUEUE_WEIGHT = 331,
    OF_BSN_TLV_REFERENCE = 332,
    OF_BSN_TLV_REPLY_PACKETS = 333,
    OF_BSN_TLV_REQUEST_PACKETS = 334,
    OF_BSN_TLV_RX_PACKETS = 335,
    OF_BSN_TLV_SAMPLING_RATE = 336,
    OF_BSN_TLV_SUB_AGENT_ID = 337,
    OF_BSN_TLV_TX_BYTES = 338,
    OF_BSN_TLV_TX_PACKETS = 339,
    OF_BSN_TLV_UDF_ANCHOR = 340,
    OF_BSN_TLV_UDF_ID = 341,
    OF_BSN_TLV_UDF_LENGTH = 342,
    OF_BSN_TLV_UDF_OFFSET = 343,
    OF_BSN_TLV_UDP_DST = 344,
    OF_BSN_TLV_UDP_SRC = 345,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 346,
    OF_BSN_TLV_VLAN_VID = 347,
    OF_BSN_TLV_VRF = 348,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 349,
    OF_BSN_VPORT = 350,
    OF_BSN_VPORT_L2GRE = 351,
    OF_BSN_VPORT_Q_IN_Q = 352,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 353,
    OF_BUCKET = 354,
    OF_BUCKET_COUNTER = 355,
    OF_BUNDLE_PROP = 356,
    OF_BUNDLE_PROP_EXPERIMENTER = 357,
    OF_FLOW_STATS_ENTRY = 358,
    OF_GROUP_DESC_STATS_ENTRY = 359,
    OF_GROUP_STATS_ENTRY = 360,
    OF_HELLO_ELEM = 361,
    OF_HELLO_ELEM_VERSIONBITMAP = 362,
    OF_INSTRUCTION = 363,
    OF_INSTRUCTION_APPLY_ACTIONS = 364,
    OF_INSTRUCTION_BSN = 365,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 366,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 367,
    OF_INSTRUCTION_BSN_DENY = 368,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 369,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 370,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 371,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 372,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 373,
    OF_INSTRUCTION_BSN_PERMIT = 374,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 375,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 376,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 377,
    OF_INSTRUCTION_CLEAR_ACTIONS = 378,
    OF_INSTRUCTION_EXPERIMENTER = 379,
    OF_INSTRUCTION_GOTO_TABLE = 380,
    OF_INSTRUCTION_ID = 381,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 382,
    OF_INSTRUCTION_ID_BSN = 383,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 384,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 385,
    OF_INSTRUCTION_ID_BSN_DENY = 386,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 387,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 388,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 389,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 390,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 391,
    OF_INSTRUCTION_ID_BSN_PERMIT = 392,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 393,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 394,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 395,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 396,
    OF_INSTRUCTION_ID_EXPERIMENTER = 397,
    OF_INSTRUCTION_ID_GOTO_TABLE = 398,
    OF_INSTRUCTION_ID_METER = 399,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 400,
    OF_INSTRUCTION_ID_WRITE_METADATA = 401,
    OF_INSTRUCTION_METER = 402,
    OF_INSTRUCTION_WRITE_ACTIONS = 403,
    OF_INSTRUCTION_WRITE_METADATA = 404,
    OF_MATCH_V1 = 405,
    OF_MATCH_V2 = 406,
    OF_MATCH_V3 = 407,
    OF_METER_BAND = 408,
    OF_METER_BAND_DROP = 409,
    OF_METER_BAND_DSCP_REMARK = 410,
    OF_METER_BAND_EXPERIMENTER = 411,
    OF_METER_BAND_STATS = 412,
    OF_METER_CONFIG = 413,
    OF_METER_FEATURES = 414,
    OF_METER_STATS = 415,
    OF_OXM = 416,
    OF_OXM_ARP_OP = 417,
    OF_OXM_ARP_OP_MASKED = 418,
    OF_OXM_ARP_SHA = 419,
    OF_OXM_ARP_SHA_MASKED = 420,
    OF_OXM_ARP_SPA = 421,
    OF_OXM_ARP_SPA_MASKED = 422,
    OF_OXM_ARP_THA = 423,
    OF_OXM_ARP_THA_MASKED = 424,
    OF_OXM_ARP_TPA = 425,
    OF_OXM_ARP_TPA_MASKED = 426,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 427,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 428,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 429,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 430,
    OF_OXM_BSN_IN_PORTS_128 = 431,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 432,
    OF_OXM_BSN_L2_CACHE_HIT = 433,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 434,
    OF_OXM_BSN_L3_DST_CLASS_ID = 435,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 436,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 437,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 438,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 439,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 440,
    OF_OXM_BSN_LAG_ID = 441,
    OF_OXM_BSN_LAG_ID_MASKED = 442,
    OF_OXM_BSN_TCP_FLAGS = 443,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 444,
    OF_OXM_BSN_UDF0 = 445,
    OF_OXM_BSN_UDF0_MASKED = 446,
    OF_OXM_BSN_UDF1 = 447,
    OF_OXM_BSN_UDF1_MASKED = 448,
    OF_OXM_BSN_UDF2 = 449,
    OF_OXM_BSN_UDF2_MASKED = 450,
    OF_OXM_BSN_UDF3 = 451,
    OF_OXM_BSN_UDF3_MASKED = 452,
    OF_OXM_BSN_UDF4 = 453,
    OF_OXM_BSN_UDF4_MASKED = 454,
    OF_OXM_BSN_UDF5 = 455,
    OF_OXM_BSN_UDF5_MASKED = 456,
    OF_OXM_BSN_UDF6 = 457,
    OF_OXM_BSN_UDF6_MASKED = 458,
    OF_OXM_BSN_UDF7 = 459,
    OF_OXM_BSN_UDF7_MASKED = 460,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 461,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 462,
    OF_OXM_BSN_VRF = 463,
    OF_OXM_BSN_VRF_MASKED = 464,
    OF_OXM_ETH_DST = 465,
    OF_OXM_ETH_DST_MASKED = 466,
    OF_OXM_ETH_SRC = 467,
    OF_OXM_ETH_SRC_MASKED = 468,
    OF_OXM_ETH_TYPE = 469,
    OF_OXM_ETH_TYPE_MASKED = 470,
    OF_OXM_ICMPV4_CODE = 471,
    OF_OXM_ICMPV4_CODE_MASKED = 472,
    OF_OXM_ICMPV4_TYPE = 473,
    OF_OXM_ICMPV4_TYPE_MASKED = 474,
    OF_OXM_ICMPV6_CODE = 475,
    OF_OXM_ICMPV6_CODE_MASKED = 476,
    OF_OXM_ICMPV6_TYPE = 477,
    OF_OXM_ICMPV6_TYPE_MASKED = 478,
    OF_OXM_IN_PHY_PORT = 479,
    OF_OXM_IN_PHY_PORT_MASKED = 480,
    OF_OXM_IN_PORT = 481,
    OF_OXM_IN_PORT_MASKED = 482,
    OF_OXM_IP_DSCP = 483,
    OF_OXM_IP_DSCP_MASKED = 484,
    OF_OXM_IP_ECN = 485,
    OF_OXM_IP_ECN_MASKED = 486,
    OF_OXM_IP_PROTO = 487,
    OF_OXM_IP_PROTO_MASKED = 488,
    OF_OXM_IPV4_DST = 489,
    OF_OXM_IPV4_DST_MASKED = 490,
    OF_OXM_IPV4_SRC = 491,
    OF_OXM_IPV4_SRC_MASKED = 492,
    OF_OXM_IPV6_DST = 493,
    OF_OXM_IPV6_DST_MASKED = 494,
    OF_OXM_IPV6_EXTHDR = 495,
    OF_OXM_IPV6_EXTHDR_MASKED = 496,
    OF_OXM_IPV6_FLABEL = 497,
    OF_OXM_IPV6_FLABEL_MASKED = 498,
    OF_OXM_IPV6_ND_SLL = 499,
    OF_OXM_IPV6_ND_SLL_MASKED = 500,
    OF_OXM_IPV6_ND_TARGET = 501,
    OF_OXM_IPV6_ND_TARGET_MASKED = 502,
    OF_OXM_IPV6_ND_TLL = 503,
    OF_OXM_IPV6_ND_TLL_MASKED = 504,
    OF_OXM_IPV6_SRC = 505,
    OF_OXM_IPV6_SRC_MASKED = 506,
    OF_OXM_METADATA = 507,
    OF_OXM_METADATA_MASKED = 508,
    OF_OXM_MPLS_BOS = 509,
    OF_OXM_MPLS_BOS_MASKED = 510,
    OF_OXM_MPLS_LABEL = 511,
    OF_OXM_MPLS_LABEL_MASKED = 512,
    OF_OXM_MPLS_TC = 513,
    OF_OXM_MPLS_TC_MASKED = 514,
    OF_OXM_PBB_UCA = 515,
    OF_OXM_PBB_UCA_MASKED = 516,
    OF_OXM_SCTP_DST = 517,
    OF_OXM_SCTP_DST_MASKED = 518,
    OF_OXM_SCTP_SRC = 519,
    OF_OXM_SCTP_SRC_MASKED = 520,
    OF_OXM_TCP_DST = 521,
    OF_OXM_TCP_DST_MASKED = 522,
    OF_OXM_TCP_SRC = 523,
    OF_OXM_TCP_SRC_MASKED = 524,
    OF_OXM_TUNNEL_ID = 525,
    OF_OXM_TUNNEL_ID_MASKED = 526,
    OF_OXM_TUNNEL_IPV4_DST = 527,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 528,
    OF_OXM_TUNNEL_IPV4_SRC = 529,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 530,
    OF_OXM_UDP_DST = 531,
    ...
    OF_PORT_DESC_PROP_OPTICAL = 544,
    OF_PORT_MOD_PROP = 545,
    OF_PORT_MOD_PROP_ETHERNET = 546,
    OF_PORT_MOD_PROP_EXPERIMENTER = 547,
    OF_PORT_MOD_PROP_OPTICAL = 548,
    OF_PORT_STATS_ENTRY = 549,
    OF_PORT_STATS_PROP = 550,
    OF_PORT_STATS_PROP_ETHERNET = 551,
    OF_PORT_STATS_PROP_EXPERIMENTER = 552,
    OF_PORT_STATS_PROP_OPTICAL = 553,
    OF_QUEUE_DESC = 554,
    OF_QUEUE_DESC_PROP = 555,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 556,
    OF_QUEUE_DESC_PROP_MAX_RATE = 557,
    OF_QUEUE_DESC_PROP_MIN_RATE = 558,
    OF_QUEUE_PROP = 559,
    OF_QUEUE_PROP_EXPERIMENTER = 560,
    OF_QUEUE_PROP_MAX_RATE = 561,
    OF_QUEUE_PROP_MIN_RATE = 562,
    OF_QUEUE_STATS_ENTRY = 563,
    OF_QUEUE_STATS_PROP = 564,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 565,
    OF_ROLE_PROP = 566,
    OF_ROLE_PROP_EXPERIMENTER = 567,
    OF_TABLE_DESC = 568,
    OF_TABLE_FEATURE_PROP = 569,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 570,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 571,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 572,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 573,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 574,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 575,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 576,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 577,
    OF_TABLE_FEATURE_PROP_MATCH = 578,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 579,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 580,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 581,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 582,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 583,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 584,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 585,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 586,
    OF_TABLE_FEATURES = 587,
    OF_TABLE_MOD_PROP = 588,
    OF_TABLE_MOD_PROP_EVICTION = 589,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 590,
    OF_TABLE_MOD_PROP_VACANCY = 591,
    OF_TABLE_STATS_ENTRY = 592,
    OF_UINT32 = 593,
    OF_UINT64 = 594,
    OF_UINT8 = 595,
    ...
    /* List objects */
    OF_LIST_ACTION = 596,
    OF_LIST_ACTION_ID = 597,
    OF_LIST_ASYNC_CONFIG_PROP = 598,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 599,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 600,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 601,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 602,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 603,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 604,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 605,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 606,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 607,
    OF_LIST_BSN_INTERFACE = 608,
    OF_LIST_BSN_LACP_STATS_ENTRY = 609,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 610,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 611,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 612,
    OF_LIST_BSN_TLV = 613,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 614,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 615,
    OF_LIST_BUCKET = 616,
    OF_LIST_BUCKET_COUNTER = 617,
    OF_LIST_BUNDLE_PROP = 618,
    OF_LIST_FLOW_STATS_ENTRY = 619,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 620,
    OF_LIST_GROUP_STATS_ENTRY = 621,
    OF_LIST_HELLO_ELEM = 622,
    OF_LIST_INSTRUCTION = 623,
    OF_LIST_INSTRUCTION_ID = 624,
    OF_LIST_METER_BAND = 625,
    OF_LIST_METER_BAND_STATS = 626,
    OF_LIST_METER_STATS = 627,
    OF_LIST_OXM = 628,
    OF_LIST_PACKET_QUEUE = 629,
    OF_LIST_PORT_DESC = 630,
    OF_LIST_PORT_DESC_PROP = 631,
    OF_LIST_PORT_MOD_PROP = 632,
    OF_LIST_PORT_STATS_ENTRY = 633,
    OF_LIST_PORT_STATS_PROP = 634,
    OF_LIST_QUEUE_DESC = 635,
    OF_LIST_QUEUE_DESC_PROP = 636,
    OF_LIST_QUEUE_PROP = 637,
    OF_LIST_QUEUE_STATS_ENTRY = 638,
    OF_LIST_QUEUE_STATS_PROP = 639,
    OF_LIST_ROLE_PROP = 640,
    OF_LIST_TABLE_DESC = 641,
    OF_LIST_TABLE_FEATURE_PROP = 642,
    OF_LIST_TABLE_FEATURES = 643,
    OF_LIST_TABLE_MOD_PROP = 644,
    OF_LIST_TABLE_STATS_ENTRY = 645,
    OF_LIST_UINT32 = 646,
    OF_LIST_UINT64 = 647,
    OF_LIST_UINT8 = 648,
