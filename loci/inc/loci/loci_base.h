...
typedef enum of_object_id_e {
    ...
    OF_OXM_BSN_TCP_FLAGS = 365,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 366,
    OF_OXM_BSN_UDF0 = 367,
    OF_OXM_BSN_UDF0_MASKED = 368,
    OF_OXM_BSN_UDF1 = 369,
    OF_OXM_BSN_UDF1_MASKED = 370,
    OF_OXM_BSN_UDF2 = 371,
    OF_OXM_BSN_UDF2_MASKED = 372,
    OF_OXM_BSN_UDF3 = 373,
    OF_OXM_BSN_UDF3_MASKED = 374,
    OF_OXM_BSN_UDF4 = 375,
    OF_OXM_BSN_UDF4_MASKED = 376,
    OF_OXM_BSN_UDF5 = 377,
    OF_OXM_BSN_UDF5_MASKED = 378,
    OF_OXM_BSN_UDF6 = 379,
    OF_OXM_BSN_UDF6_MASKED = 380,
    OF_OXM_BSN_UDF7 = 381,
    OF_OXM_BSN_UDF7_MASKED = 382,
    OF_OXM_BSN_VRF = 383,
    OF_OXM_BSN_VRF_MASKED = 384,
    OF_OXM_ETH_DST = 385,
    OF_OXM_ETH_DST_MASKED = 386,
    OF_OXM_ETH_SRC = 387,
    OF_OXM_ETH_SRC_MASKED = 388,
    OF_OXM_ETH_TYPE = 389,
    OF_OXM_ETH_TYPE_MASKED = 390,
    OF_OXM_HEADER = 391,
    OF_OXM_ICMPV4_CODE = 392,
    OF_OXM_ICMPV4_CODE_MASKED = 393,
    OF_OXM_ICMPV4_TYPE = 394,
    OF_OXM_ICMPV4_TYPE_MASKED = 395,
    OF_OXM_ICMPV6_CODE = 396,
    OF_OXM_ICMPV6_CODE_MASKED = 397,
    OF_OXM_ICMPV6_TYPE = 398,
    OF_OXM_ICMPV6_TYPE_MASKED = 399,
    OF_OXM_IN_PHY_PORT = 400,
    OF_OXM_IN_PHY_PORT_MASKED = 401,
    OF_OXM_IN_PORT = 402,
    OF_OXM_IN_PORT_MASKED = 403,
    OF_OXM_IP_DSCP = 404,
    OF_OXM_IP_DSCP_MASKED = 405,
    OF_OXM_IP_ECN = 406,
    OF_OXM_IP_ECN_MASKED = 407,
    OF_OXM_IP_PROTO = 408,
    OF_OXM_IP_PROTO_MASKED = 409,
    OF_OXM_IPV4_DST = 410,
    OF_OXM_IPV4_DST_MASKED = 411,
    OF_OXM_IPV4_SRC = 412,
    OF_OXM_IPV4_SRC_MASKED = 413,
    OF_OXM_IPV6_DST = 414,
    OF_OXM_IPV6_DST_MASKED = 415,
    OF_OXM_IPV6_FLABEL = 416,
    OF_OXM_IPV6_FLABEL_MASKED = 417,
    OF_OXM_IPV6_ND_SLL = 418,
    OF_OXM_IPV6_ND_SLL_MASKED = 419,
    OF_OXM_IPV6_ND_TARGET = 420,
    OF_OXM_IPV6_ND_TARGET_MASKED = 421,
    OF_OXM_IPV6_ND_TLL = 422,
    OF_OXM_IPV6_ND_TLL_MASKED = 423,
    OF_OXM_IPV6_SRC = 424,
    OF_OXM_IPV6_SRC_MASKED = 425,
    OF_OXM_METADATA = 426,
    OF_OXM_METADATA_MASKED = 427,
    OF_OXM_MPLS_LABEL = 428,
    OF_OXM_MPLS_LABEL_MASKED = 429,
    OF_OXM_MPLS_TC = 430,
    OF_OXM_MPLS_TC_MASKED = 431,
    OF_OXM_SCTP_DST = 432,
    OF_OXM_SCTP_DST_MASKED = 433,
    OF_OXM_SCTP_SRC = 434,
    OF_OXM_SCTP_SRC_MASKED = 435,
    OF_OXM_TCP_DST = 436,
    OF_OXM_TCP_DST_MASKED = 437,
    OF_OXM_TCP_SRC = 438,
    OF_OXM_TCP_SRC_MASKED = 439,
    OF_OXM_UDP_DST = 440,
    OF_OXM_UDP_DST_MASKED = 441,
    OF_OXM_UDP_SRC = 442,
    OF_OXM_UDP_SRC_MASKED = 443,
    OF_OXM_VLAN_PCP = 444,
    OF_OXM_VLAN_PCP_MASKED = 445,
    OF_OXM_VLAN_VID = 446,
    OF_OXM_VLAN_VID_MASKED = 447,
    OF_PACKET_QUEUE = 448,
    OF_PORT_DESC = 449,
    OF_PORT_STATS_ENTRY = 450,
    OF_QUEUE_PROP = 451,
    OF_QUEUE_PROP_EXPERIMENTER = 452,
    OF_QUEUE_PROP_HEADER = 453,
    OF_QUEUE_PROP_MAX_RATE = 454,
    OF_QUEUE_PROP_MIN_RATE = 455,
    OF_QUEUE_STATS_ENTRY = 456,
    OF_TABLE_FEATURE_PROP = 457,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 458,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 459,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 460,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 461,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 462,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 463,
    OF_TABLE_FEATURE_PROP_HEADER = 464,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 465,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 466,
    OF_TABLE_FEATURE_PROP_MATCH = 467,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 468,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 469,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 470,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 471,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 472,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 473,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 474,
    OF_TABLE_FEATURES = 475,
    OF_TABLE_STATS_ENTRY = 476,
    OF_UINT32 = 477,
    OF_UINT64 = 478,
    OF_UINT8 = 479,
    ...
    /* List objects */
    OF_LIST_ACTION = 480,
    OF_LIST_ACTION_ID = 481,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 482,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 483,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 484,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 485,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 486,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 487,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 488,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 489,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 490,
    OF_LIST_BSN_INTERFACE = 491,
    OF_LIST_BSN_LACP_STATS_ENTRY = 492,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 493,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 494,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 495,
    OF_LIST_BSN_TLV = 496,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 497,
    OF_LIST_BUCKET = 498,
    OF_LIST_BUCKET_COUNTER = 499,
    OF_LIST_FLOW_STATS_ENTRY = 500,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 501,
    OF_LIST_GROUP_STATS_ENTRY = 502,
    OF_LIST_HELLO_ELEM = 503,
    OF_LIST_INSTRUCTION = 504,
    OF_LIST_INSTRUCTION_ID = 505,
    OF_LIST_METER_BAND = 506,
    OF_LIST_METER_BAND_STATS = 507,
    OF_LIST_METER_STATS = 508,
    OF_LIST_OXM = 509,
    OF_LIST_PACKET_QUEUE = 510,
    OF_LIST_PORT_DESC = 511,
    OF_LIST_PORT_STATS_ENTRY = 512,
    OF_LIST_QUEUE_PROP = 513,
    OF_LIST_QUEUE_STATS_ENTRY = 514,
    OF_LIST_TABLE_FEATURE_PROP = 515,
    OF_LIST_TABLE_FEATURES = 516,
    OF_LIST_TABLE_STATS_ENTRY = 517,
    OF_LIST_UINT32 = 518,
    OF_LIST_UINT64 = 519,
    OF_LIST_UINT8 = 520,
