...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DSCP = 322,
    OF_BSN_TLV_ECN = 323,
    OF_BSN_TLV_ETH_DST = 324,
    OF_BSN_TLV_ETH_SRC = 325,
    OF_BSN_TLV_ETH_TYPE = 326,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 327,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 328,
    OF_BSN_TLV_EXTERNAL_IP = 329,
    OF_BSN_TLV_EXTERNAL_MAC = 330,
    OF_BSN_TLV_EXTERNAL_NETMASK = 331,
    OF_BSN_TLV_GENERATION_ID = 332,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 333,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 334,
    OF_BSN_TLV_HASH_PACKET_FIELD = 335,
    OF_BSN_TLV_HASH_PACKET_TYPE = 336,
    OF_BSN_TLV_HASH_SEED = 337,
    OF_BSN_TLV_HASH_TYPE = 338,
    OF_BSN_TLV_HEADER_SIZE = 339,
    OF_BSN_TLV_ICMP_CODE = 340,
    OF_BSN_TLV_ICMP_ID = 341,
    OF_BSN_TLV_ICMP_TYPE = 342,
    OF_BSN_TLV_ICMPV6_CHKSUM = 343,
    OF_BSN_TLV_IDLE_NOTIFICATION = 344,
    OF_BSN_TLV_IDLE_TIME = 345,
    OF_BSN_TLV_IDLE_TIMEOUT = 346,
    OF_BSN_TLV_IGMP_SNOOPING = 347,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 348,
    OF_BSN_TLV_INTERNAL_MAC = 349,
    OF_BSN_TLV_INTERVAL = 350,
    OF_BSN_TLV_IP_PROTO = 351,
    OF_BSN_TLV_IPV4 = 352,
    OF_BSN_TLV_IPV4_DST = 353,
    OF_BSN_TLV_IPV4_NETMASK = 354,
    OF_BSN_TLV_IPV4_SRC = 355,
    OF_BSN_TLV_IPV6 = 356,
    OF_BSN_TLV_IPV6_DST = 357,
    OF_BSN_TLV_IPV6_PREFIX = 358,
    OF_BSN_TLV_IPV6_SRC = 359,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 360,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 361,
    OF_BSN_TLV_L3_DST_CLASS_ID = 362,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 363,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 364,
    OF_BSN_TLV_LOOPBACK_PORT = 365,
    OF_BSN_TLV_MAC = 366,
    OF_BSN_TLV_MAC_MASK = 367,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 368,
    OF_BSN_TLV_MISS_PACKETS = 369,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 370,
    OF_BSN_TLV_MPLS_LABEL = 371,
    OF_BSN_TLV_MPLS_SEQUENCED = 372,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 373,
    OF_BSN_TLV_NAME = 374,
    OF_BSN_TLV_NDP_OFFLOAD = 375,
    OF_BSN_TLV_NDP_STATIC = 376,
    OF_BSN_TLV_NEGATE = 377,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 378,
    OF_BSN_TLV_NEXT_HOP_MAC = 379,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 380,
    OF_BSN_TLV_OFFSET = 381,
    OF_BSN_TLV_PARENT_PORT = 382,
    OF_BSN_TLV_PARTNER_KEY = 383,
    OF_BSN_TLV_PARTNER_PORT_NUM = 384,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 385,
    OF_BSN_TLV_PARTNER_STATE = 386,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 387,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 388,
    OF_BSN_TLV_PORT = 389,
    OF_BSN_TLV_PORT_VXLAN_MODE = 390,
    OF_BSN_TLV_PRIORITY = 391,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 392,
    OF_BSN_TLV_QOS_PRIORITY = 393,
    OF_BSN_TLV_QUEUE_ID = 394,
    OF_BSN_TLV_QUEUE_WEIGHT = 395,
    OF_BSN_TLV_RATE_LIMIT = 396,
    OF_BSN_TLV_RATE_UNIT = 397,
    OF_BSN_TLV_REFERENCE = 398,
    OF_BSN_TLV_REPLY_PACKETS = 399,
    OF_BSN_TLV_REQUEST_PACKETS = 400,
    OF_BSN_TLV_RX_BYTES = 401,
    OF_BSN_TLV_RX_PACKETS = 402,
    OF_BSN_TLV_SAMPLING_RATE = 403,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 404,
    OF_BSN_TLV_STATUS = 405,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 406,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 407,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 408,
    OF_BSN_TLV_SUB_AGENT_ID = 409,
    OF_BSN_TLV_TCP_DST = 410,
    OF_BSN_TLV_TCP_FLAGS = 411,
    OF_BSN_TLV_TCP_SRC = 412,
    OF_BSN_TLV_TTL = 413,
    OF_BSN_TLV_TX_BYTES = 414,
    OF_BSN_TLV_TX_PACKETS = 415,
    OF_BSN_TLV_UDF_ANCHOR = 416,
    OF_BSN_TLV_UDF_ID = 417,
    OF_BSN_TLV_UDF_LENGTH = 418,
    OF_BSN_TLV_UDF_OFFSET = 419,
    OF_BSN_TLV_UDP_DST = 420,
    OF_BSN_TLV_UDP_SRC = 421,
    OF_BSN_TLV_UINT64_LIST = 422,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 423,
    OF_BSN_TLV_UNICAST_RATE = 424,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 425,
    OF_BSN_TLV_UNTAGGED = 426,
    OF_BSN_TLV_USE_PACKET_STATE = 427,
    OF_BSN_TLV_VFI = 428,
    OF_BSN_TLV_VFP_CLASS_ID = 429,
    OF_BSN_TLV_VLAN_MAC_LIST = 430,
    OF_BSN_TLV_VLAN_PCP = 431,
    OF_BSN_TLV_VLAN_VID = 432,
    OF_BSN_TLV_VLAN_VID_MASK = 433,
    OF_BSN_TLV_VNI = 434,
    OF_BSN_TLV_VPN_KEY = 435,
    OF_BSN_TLV_VRF = 436,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 437,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 438,
    OF_BSN_VLAN_MAC = 439,
    OF_BSN_VPORT = 440,
    OF_BSN_VPORT_L2GRE = 441,
    OF_BSN_VPORT_Q_IN_Q = 442,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 443,
    OF_BUCKET = 444,
    OF_BUCKET_COUNTER = 445,
    OF_BUNDLE_PROP = 446,
    OF_BUNDLE_PROP_EXPERIMENTER = 447,
    OF_FLOW_STATS_ENTRY = 448,
    OF_GROUP_DESC_STATS_ENTRY = 449,
    OF_GROUP_STATS_ENTRY = 450,
    OF_HELLO_ELEM = 451,
    OF_HELLO_ELEM_VERSIONBITMAP = 452,
    OF_INSTRUCTION = 453,
    OF_INSTRUCTION_APPLY_ACTIONS = 454,
    OF_INSTRUCTION_BSN = 455,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 456,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 457,
    OF_INSTRUCTION_BSN_DENY = 458,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 459,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 460,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 461,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 462,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 463,
    OF_INSTRUCTION_BSN_HASH_SELECT = 464,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 465,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 466,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 467,
    OF_INSTRUCTION_BSN_PERMIT = 468,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 469,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 470,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 471,
    OF_INSTRUCTION_CLEAR_ACTIONS = 472,
    OF_INSTRUCTION_EXPERIMENTER = 473,
    OF_INSTRUCTION_GOTO_TABLE = 474,
    OF_INSTRUCTION_ID = 475,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 476,
    OF_INSTRUCTION_ID_BSN = 477,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 478,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 479,
    OF_INSTRUCTION_ID_BSN_DENY = 480,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 481,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 482,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 483,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 484,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 485,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 486,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 487,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 488,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 489,
    OF_INSTRUCTION_ID_BSN_PERMIT = 490,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 491,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 492,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 493,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 494,
    OF_INSTRUCTION_ID_EXPERIMENTER = 495,
    OF_INSTRUCTION_ID_GOTO_TABLE = 496,
    OF_INSTRUCTION_ID_METER = 497,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 498,
    OF_INSTRUCTION_ID_WRITE_METADATA = 499,
    OF_INSTRUCTION_METER = 500,
    OF_INSTRUCTION_WRITE_ACTIONS = 501,
    OF_INSTRUCTION_WRITE_METADATA = 502,
    OF_MATCH_V1 = 503,
    OF_MATCH_V2 = 504,
    OF_MATCH_V3 = 505,
    OF_METER_BAND = 506,
    OF_METER_BAND_DROP = 507,
    OF_METER_BAND_DSCP_REMARK = 508,
    OF_METER_BAND_EXPERIMENTER = 509,
    OF_METER_BAND_STATS = 510,
    OF_METER_CONFIG = 511,
    OF_METER_FEATURES = 512,
    OF_METER_STATS = 513,
    OF_OXM = 514,
    OF_OXM_ARP_OP = 515,
    OF_OXM_ARP_OP_MASKED = 516,
    OF_OXM_ARP_SHA = 517,
    OF_OXM_ARP_SHA_MASKED = 518,
    OF_OXM_ARP_SPA = 519,
    OF_OXM_ARP_SPA_MASKED = 520,
    OF_OXM_ARP_THA = 521,
    OF_OXM_ARP_THA_MASKED = 522,
    OF_OXM_ARP_TPA = 523,
    OF_OXM_ARP_TPA_MASKED = 524,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 525,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 526,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 527,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 528,
    OF_OXM_BSN_IN_PORTS_128 = 529,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 530,
    OF_OXM_BSN_IN_PORTS_512 = 531,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 532,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 533,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 534,
    OF_OXM_BSN_INNER_ETH_DST = 535,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 536,
    OF_OXM_BSN_INNER_ETH_SRC = 537,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 538,
    OF_OXM_BSN_INNER_VLAN_VID = 539,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 540,
    OF_OXM_BSN_L2_CACHE_HIT = 541,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 542,
    OF_OXM_BSN_L3_DST_CLASS_ID = 543,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 544,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 545,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 546,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 547,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 548,
    OF_OXM_BSN_LAG_ID = 549,
    OF_OXM_BSN_LAG_ID_MASKED = 550,
    OF_OXM_BSN_TCP_FLAGS = 551,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 552,
    OF_OXM_BSN_UDF0 = 553,
    OF_OXM_BSN_UDF0_MASKED = 554,
    OF_OXM_BSN_UDF1 = 555,
    OF_OXM_BSN_UDF1_MASKED = 556,
    OF_OXM_BSN_UDF2 = 557,
    OF_OXM_BSN_UDF2_MASKED = 558,
    OF_OXM_BSN_UDF3 = 559,
    OF_OXM_BSN_UDF3_MASKED = 560,
    OF_OXM_BSN_UDF4 = 561,
    OF_OXM_BSN_UDF4_MASKED = 562,
    OF_OXM_BSN_UDF5 = 563,
    OF_OXM_BSN_UDF5_MASKED = 564,
    OF_OXM_BSN_UDF6 = 565,
    OF_OXM_BSN_UDF6_MASKED = 566,
    OF_OXM_BSN_UDF7 = 567,
    OF_OXM_BSN_UDF7_MASKED = 568,
    OF_OXM_BSN_VFI = 569,
    OF_OXM_BSN_VFI_MASKED = 570,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 571,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 572,
    OF_OXM_BSN_VRF = 573,
    OF_OXM_BSN_VRF_MASKED = 574,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 575,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 576,
    OF_OXM_ETH_DST = 577,
    OF_OXM_ETH_DST_MASKED = 578,
    OF_OXM_ETH_SRC = 579,
    OF_OXM_ETH_SRC_MASKED = 580,
    OF_OXM_ETH_TYPE = 581,
    OF_OXM_ETH_TYPE_MASKED = 582,
    OF_OXM_ICMPV4_CODE = 583,
    OF_OXM_ICMPV4_CODE_MASKED = 584,
    OF_OXM_ICMPV4_TYPE = 585,
    OF_OXM_ICMPV4_TYPE_MASKED = 586,
    OF_OXM_ICMPV6_CODE = 587,
    OF_OXM_ICMPV6_CODE_MASKED = 588,
    OF_OXM_ICMPV6_TYPE = 589,
    OF_OXM_ICMPV6_TYPE_MASKED = 590,
    OF_OXM_IN_PHY_PORT = 591,
    OF_OXM_IN_PHY_PORT_MASKED = 592,
    OF_OXM_IN_PORT = 593,
    OF_OXM_IN_PORT_MASKED = 594,
    OF_OXM_IP_DSCP = 595,
    OF_OXM_IP_DSCP_MASKED = 596,
    OF_OXM_IP_ECN = 597,
    OF_OXM_IP_ECN_MASKED = 598,
    OF_OXM_IP_PROTO = 599,
    OF_OXM_IP_PROTO_MASKED = 600,
    OF_OXM_IPV4_DST = 601,
    OF_OXM_IPV4_DST_MASKED = 602,
    OF_OXM_IPV4_SRC = 603,
    OF_OXM_IPV4_SRC_MASKED = 604,
    OF_OXM_IPV6_DST = 605,
    OF_OXM_IPV6_DST_MASKED = 606,
    OF_OXM_IPV6_EXTHDR = 607,
    OF_OXM_IPV6_EXTHDR_MASKED = 608,
    OF_OXM_IPV6_FLABEL = 609,
    OF_OXM_IPV6_FLABEL_MASKED = 610,
    OF_OXM_IPV6_ND_SLL = 611,
    OF_OXM_IPV6_ND_SLL_MASKED = 612,
    OF_OXM_IPV6_ND_TARGET = 613,
    OF_OXM_IPV6_ND_TARGET_MASKED = 614,
    OF_OXM_IPV6_ND_TLL = 615,
    OF_OXM_IPV6_ND_TLL_MASKED = 616,
    OF_OXM_IPV6_SRC = 617,
    OF_OXM_IPV6_SRC_MASKED = 618,
    OF_OXM_METADATA = 619,
    OF_OXM_METADATA_MASKED = 620,
    OF_OXM_MPLS_BOS = 621,
    OF_OXM_MPLS_BOS_MASKED = 622,
    OF_OXM_MPLS_LABEL = 623,
    OF_OXM_MPLS_LABEL_MASKED = 624,
    OF_OXM_MPLS_TC = 625,
    OF_OXM_MPLS_TC_MASKED = 626,
    OF_OXM_OVS_TCP_FLAGS = 627,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 628,
    OF_OXM_PBB_UCA = 629,
    OF_OXM_PBB_UCA_MASKED = 630,
    OF_OXM_SCTP_DST = 631,
    OF_OXM_SCTP_DST_MASKED = 632,
    OF_OXM_SCTP_SRC = 633,
    OF_OXM_SCTP_SRC_MASKED = 634,
    OF_OXM_TCP_DST = 635,
    OF_OXM_TCP_DST_MASKED = 636,
    OF_OXM_TCP_SRC = 637,
    OF_OXM_TCP_SRC_MASKED = 638,
    OF_OXM_TUNNEL_ID = 639,
    OF_OXM_TUNNEL_ID_MASKED = 640,
    OF_OXM_TUNNEL_IPV4_DST = 641,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 642,
    OF_OXM_TUNNEL_IPV4_SRC = 643,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 644,
    OF_OXM_UDP_DST = 645,
    OF_OXM_UDP_DST_MASKED = 646,
    OF_OXM_UDP_SRC = 647,
    OF_OXM_UDP_SRC_MASKED = 648,
    OF_OXM_VLAN_PCP = 649,
    OF_OXM_VLAN_PCP_MASKED = 650,
    OF_OXM_VLAN_VID = 651,
    OF_OXM_VLAN_VID_MASKED = 652,
    OF_PACKET_QUEUE = 653,
    OF_PORT_DESC = 654,
    OF_PORT_DESC_PROP = 655,
    OF_PORT_DESC_PROP_BSN = 656,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 657,
    OF_PORT_DESC_PROP_BSN_UPLINK = 658,
    OF_PORT_DESC_PROP_ETHERNET = 659,
    OF_PORT_DESC_PROP_EXPERIMENTER = 660,
    OF_PORT_DESC_PROP_OPTICAL = 661,
    OF_PORT_MOD_PROP = 662,
    OF_PORT_MOD_PROP_ETHERNET = 663,
    OF_PORT_MOD_PROP_EXPERIMENTER = 664,
    OF_PORT_MOD_PROP_OPTICAL = 665,
    OF_PORT_STATS_ENTRY = 666,
    OF_PORT_STATS_PROP = 667,
    OF_PORT_STATS_PROP_ETHERNET = 668,
    OF_PORT_STATS_PROP_EXPERIMENTER = 669,
    OF_PORT_STATS_PROP_OPTICAL = 670,
    OF_QUEUE_DESC = 671,
    OF_QUEUE_DESC_PROP = 672,
    OF_QUEUE_DESC_PROP_BSN = 673,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 674,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 675,
    OF_QUEUE_DESC_PROP_MAX_RATE = 676,
    OF_QUEUE_DESC_PROP_MIN_RATE = 677,
    OF_QUEUE_PROP = 678,
    OF_QUEUE_PROP_EXPERIMENTER = 679,
    OF_QUEUE_PROP_MAX_RATE = 680,
    OF_QUEUE_PROP_MIN_RATE = 681,
    OF_QUEUE_STATS_ENTRY = 682,
    OF_QUEUE_STATS_PROP = 683,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 684,
    OF_ROLE_PROP = 685,
    OF_ROLE_PROP_EXPERIMENTER = 686,
    OF_TABLE_DESC = 687,
    OF_TABLE_FEATURE_PROP = 688,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 689,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 690,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 691,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 692,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 693,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 694,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 695,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 696,
    OF_TABLE_FEATURE_PROP_MATCH = 697,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 698,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 699,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 700,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 701,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 702,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 703,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 704,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 705,
    OF_TABLE_FEATURES = 706,
    OF_TABLE_MOD_PROP = 707,
    OF_TABLE_MOD_PROP_EVICTION = 708,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 709,
    OF_TABLE_MOD_PROP_VACANCY = 710,
    OF_TABLE_STATS_ENTRY = 711,
    OF_UINT32 = 712,
    OF_UINT64 = 713,
    OF_UINT8 = 714,
    ...
    /* List objects */
    OF_LIST_ACTION = 715,
    OF_LIST_ACTION_ID = 716,
    OF_LIST_ASYNC_CONFIG_PROP = 717,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 718,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 719,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 720,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 721,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 722,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 723,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 724,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 725,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 726,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 727,
    OF_LIST_BSN_INTERFACE = 728,
    OF_LIST_BSN_LACP_STATS_ENTRY = 729,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 730,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 731,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 732,
    OF_LIST_BSN_TLV = 733,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 734,
    OF_LIST_BSN_VLAN_MAC = 735,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 736,
    OF_LIST_BUCKET = 737,
    OF_LIST_BUCKET_COUNTER = 738,
    OF_LIST_BUNDLE_PROP = 739,
    OF_LIST_FLOW_STATS_ENTRY = 740,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 741,
    OF_LIST_GROUP_STATS_ENTRY = 742,
    OF_LIST_HELLO_ELEM = 743,
    OF_LIST_INSTRUCTION = 744,
    OF_LIST_INSTRUCTION_ID = 745,
    OF_LIST_METER_BAND = 746,
    OF_LIST_METER_BAND_STATS = 747,
    OF_LIST_METER_CONFIG = 748,
    OF_LIST_METER_STATS = 749,
    OF_LIST_OXM = 750,
    OF_LIST_PACKET_QUEUE = 751,
    OF_LIST_PORT_DESC = 752,
    OF_LIST_PORT_DESC_PROP = 753,
    OF_LIST_PORT_MOD_PROP = 754,
    OF_LIST_PORT_STATS_ENTRY = 755,
    OF_LIST_PORT_STATS_PROP = 756,
    OF_LIST_QUEUE_DESC = 757,
    OF_LIST_QUEUE_DESC_PROP = 758,
    OF_LIST_QUEUE_PROP = 759,
    OF_LIST_QUEUE_STATS_ENTRY = 760,
    OF_LIST_QUEUE_STATS_PROP = 761,
    OF_LIST_ROLE_PROP = 762,
    OF_LIST_TABLE_DESC = 763,
    OF_LIST_TABLE_FEATURE_PROP = 764,
    OF_LIST_TABLE_FEATURES = 765,
    OF_LIST_TABLE_MOD_PROP = 766,
    OF_LIST_TABLE_STATS_ENTRY = 767,
    OF_LIST_UINT32 = 768,
    OF_LIST_UINT64 = 769,
    OF_LIST_UINT8 = 770,
