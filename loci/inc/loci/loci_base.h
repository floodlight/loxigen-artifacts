...
typedef enum of_object_id_e {
    ...
    OF_OXM_BSN_L2_CACHE_HIT = 453,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 454,
    OF_OXM_BSN_L3_DST_CLASS_ID = 455,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 456,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 457,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 458,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 459,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 460,
    OF_OXM_BSN_LAG_ID = 461,
    OF_OXM_BSN_LAG_ID_MASKED = 462,
    OF_OXM_BSN_TCP_FLAGS = 463,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 464,
    OF_OXM_BSN_UDF0 = 465,
    OF_OXM_BSN_UDF0_MASKED = 466,
    OF_OXM_BSN_UDF1 = 467,
    OF_OXM_BSN_UDF1_MASKED = 468,
    OF_OXM_BSN_UDF2 = 469,
    OF_OXM_BSN_UDF2_MASKED = 470,
    OF_OXM_BSN_UDF3 = 471,
    OF_OXM_BSN_UDF3_MASKED = 472,
    OF_OXM_BSN_UDF4 = 473,
    OF_OXM_BSN_UDF4_MASKED = 474,
    OF_OXM_BSN_UDF5 = 475,
    OF_OXM_BSN_UDF5_MASKED = 476,
    OF_OXM_BSN_UDF6 = 477,
    OF_OXM_BSN_UDF6_MASKED = 478,
    OF_OXM_BSN_UDF7 = 479,
    OF_OXM_BSN_UDF7_MASKED = 480,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 481,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 482,
    OF_OXM_BSN_VRF = 483,
    OF_OXM_BSN_VRF_MASKED = 484,
    OF_OXM_ETH_DST = 485,
    OF_OXM_ETH_DST_MASKED = 486,
    OF_OXM_ETH_SRC = 487,
    OF_OXM_ETH_SRC_MASKED = 488,
    OF_OXM_ETH_TYPE = 489,
    OF_OXM_ETH_TYPE_MASKED = 490,
    OF_OXM_ICMPV4_CODE = 491,
    OF_OXM_ICMPV4_CODE_MASKED = 492,
    OF_OXM_ICMPV4_TYPE = 493,
    OF_OXM_ICMPV4_TYPE_MASKED = 494,
    OF_OXM_ICMPV6_CODE = 495,
    OF_OXM_ICMPV6_CODE_MASKED = 496,
    OF_OXM_ICMPV6_TYPE = 497,
    OF_OXM_ICMPV6_TYPE_MASKED = 498,
    OF_OXM_IN_PHY_PORT = 499,
    OF_OXM_IN_PHY_PORT_MASKED = 500,
    OF_OXM_IN_PORT = 501,
    OF_OXM_IN_PORT_MASKED = 502,
    OF_OXM_IP_DSCP = 503,
    OF_OXM_IP_DSCP_MASKED = 504,
    OF_OXM_IP_ECN = 505,
    OF_OXM_IP_ECN_MASKED = 506,
    OF_OXM_IP_PROTO = 507,
    OF_OXM_IP_PROTO_MASKED = 508,
    OF_OXM_IPV4_DST = 509,
    OF_OXM_IPV4_DST_MASKED = 510,
    OF_OXM_IPV4_SRC = 511,
    OF_OXM_IPV4_SRC_MASKED = 512,
    OF_OXM_IPV6_DST = 513,
    OF_OXM_IPV6_DST_MASKED = 514,
    OF_OXM_IPV6_EXTHDR = 515,
    OF_OXM_IPV6_EXTHDR_MASKED = 516,
    OF_OXM_IPV6_FLABEL = 517,
    OF_OXM_IPV6_FLABEL_MASKED = 518,
    OF_OXM_IPV6_ND_SLL = 519,
    OF_OXM_IPV6_ND_SLL_MASKED = 520,
    OF_OXM_IPV6_ND_TARGET = 521,
    OF_OXM_IPV6_ND_TARGET_MASKED = 522,
    OF_OXM_IPV6_ND_TLL = 523,
    OF_OXM_IPV6_ND_TLL_MASKED = 524,
    OF_OXM_IPV6_SRC = 525,
    OF_OXM_IPV6_SRC_MASKED = 526,
    OF_OXM_METADATA = 527,
    OF_OXM_METADATA_MASKED = 528,
    OF_OXM_MPLS_BOS = 529,
    OF_OXM_MPLS_BOS_MASKED = 530,
    OF_OXM_MPLS_LABEL = 531,
    OF_OXM_MPLS_LABEL_MASKED = 532,
    OF_OXM_MPLS_TC = 533,
    OF_OXM_MPLS_TC_MASKED = 534,
    OF_OXM_PBB_UCA = 535,
    OF_OXM_PBB_UCA_MASKED = 536,
    OF_OXM_SCTP_DST = 537,
    OF_OXM_SCTP_DST_MASKED = 538,
    OF_OXM_SCTP_SRC = 539,
    OF_OXM_SCTP_SRC_MASKED = 540,
    OF_OXM_TCP_DST = 541,
    OF_OXM_TCP_DST_MASKED = 542,
    OF_OXM_TCP_SRC = 543,
    OF_OXM_TCP_SRC_MASKED = 544,
    OF_OXM_TUNNEL_ID = 545,
    OF_OXM_TUNNEL_ID_MASKED = 546,
    OF_OXM_TUNNEL_IPV4_DST = 547,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 548,
    OF_OXM_TUNNEL_IPV4_SRC = 549,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 550,
    OF_OXM_UDP_DST = 551,
    OF_OXM_UDP_DST_MASKED = 552,
    OF_OXM_UDP_SRC = 553,
    OF_OXM_UDP_SRC_MASKED = 554,
    OF_OXM_VLAN_PCP = 555,
    OF_OXM_VLAN_PCP_MASKED = 556,
    OF_OXM_VLAN_VID = 557,
    OF_OXM_VLAN_VID_MASKED = 558,
    OF_PACKET_QUEUE = 559,
    OF_PORT_DESC = 560,
    OF_PORT_DESC_PROP = 561,
    OF_PORT_DESC_PROP_ETHERNET = 562,
    OF_PORT_DESC_PROP_EXPERIMENTER = 563,
    OF_PORT_DESC_PROP_OPTICAL = 564,
    OF_PORT_MOD_PROP = 565,
    OF_PORT_MOD_PROP_ETHERNET = 566,
    OF_PORT_MOD_PROP_EXPERIMENTER = 567,
    OF_PORT_MOD_PROP_OPTICAL = 568,
    OF_PORT_STATS_ENTRY = 569,
    OF_PORT_STATS_PROP = 570,
    OF_PORT_STATS_PROP_ETHERNET = 571,
    OF_PORT_STATS_PROP_EXPERIMENTER = 572,
    OF_PORT_STATS_PROP_OPTICAL = 573,
    OF_QUEUE_DESC = 574,
    OF_QUEUE_DESC_PROP = 575,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 576,
    OF_QUEUE_DESC_PROP_MAX_RATE = 577,
    OF_QUEUE_DESC_PROP_MIN_RATE = 578,
    OF_QUEUE_PROP = 579,
    OF_QUEUE_PROP_EXPERIMENTER = 580,
    OF_QUEUE_PROP_MAX_RATE = 581,
    OF_QUEUE_PROP_MIN_RATE = 582,
    OF_QUEUE_STATS_ENTRY = 583,
    OF_QUEUE_STATS_PROP = 584,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 585,
    OF_ROLE_PROP = 586,
    OF_ROLE_PROP_EXPERIMENTER = 587,
    OF_TABLE_DESC = 588,
    OF_TABLE_FEATURE_PROP = 589,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 590,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 591,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 592,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 593,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 594,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 595,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 596,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 597,
    OF_TABLE_FEATURE_PROP_MATCH = 598,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 599,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 600,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 601,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 602,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 603,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 604,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 605,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 606,
    OF_TABLE_FEATURES = 607,
    OF_TABLE_MOD_PROP = 608,
    OF_TABLE_MOD_PROP_EVICTION = 609,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 610,
    OF_TABLE_MOD_PROP_VACANCY = 611,
    OF_TABLE_STATS_ENTRY = 612,
    OF_UINT32 = 613,
    OF_UINT64 = 614,
    OF_UINT8 = 615,
    ...
    /* List objects */
    OF_LIST_ACTION = 616,
    OF_LIST_ACTION_ID = 617,
    OF_LIST_ASYNC_CONFIG_PROP = 618,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 619,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 620,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 621,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 622,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 623,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 624,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 625,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 626,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 627,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 628,
    OF_LIST_BSN_INTERFACE = 629,
    OF_LIST_BSN_LACP_STATS_ENTRY = 630,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 631,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 632,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 633,
    OF_LIST_BSN_TLV = 634,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 635,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 636,
    OF_LIST_BUCKET = 637,
    OF_LIST_BUCKET_COUNTER = 638,
    OF_LIST_BUNDLE_PROP = 639,
    OF_LIST_FLOW_STATS_ENTRY = 640,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 641,
    OF_LIST_GROUP_STATS_ENTRY = 642,
    OF_LIST_HELLO_ELEM = 643,
    OF_LIST_INSTRUCTION = 644,
    OF_LIST_INSTRUCTION_ID = 645,
    OF_LIST_METER_BAND = 646,
    OF_LIST_METER_BAND_STATS = 647,
    OF_LIST_METER_STATS = 648,
    OF_LIST_OXM = 649,
    OF_LIST_PACKET_QUEUE = 650,
    OF_LIST_PORT_DESC = 651,
    OF_LIST_PORT_DESC_PROP = 652,
    OF_LIST_PORT_MOD_PROP = 653,
    OF_LIST_PORT_STATS_ENTRY = 654,
    OF_LIST_PORT_STATS_PROP = 655,
    OF_LIST_QUEUE_DESC = 656,
    OF_LIST_QUEUE_DESC_PROP = 657,
    OF_LIST_QUEUE_PROP = 658,
    OF_LIST_QUEUE_STATS_ENTRY = 659,
    OF_LIST_QUEUE_STATS_PROP = 660,
    OF_LIST_ROLE_PROP = 661,
    OF_LIST_TABLE_DESC = 662,
    OF_LIST_TABLE_FEATURE_PROP = 663,
    OF_LIST_TABLE_FEATURES = 664,
    OF_LIST_TABLE_MOD_PROP = 665,
    OF_LIST_TABLE_STATS_ENTRY = 666,
    OF_LIST_UINT32 = 667,
    OF_LIST_UINT64 = 668,
    OF_LIST_UINT8 = 669,
