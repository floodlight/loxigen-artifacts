...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_ENCAP = 335,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 336,
    OF_BSN_TLV_ETH_DST = 337,
    OF_BSN_TLV_ETH_SRC = 338,
    OF_BSN_TLV_ETH_TYPE = 339,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 340,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 341,
    OF_BSN_TLV_EXTERNAL_IP = 342,
    OF_BSN_TLV_EXTERNAL_MAC = 343,
    OF_BSN_TLV_EXTERNAL_NETMASK = 344,
    OF_BSN_TLV_FABRIC_PORT_ROLE = 345,
    OF_BSN_TLV_FAIL_COUNT = 346,
    OF_BSN_TLV_FLOOD = 347,
    OF_BSN_TLV_FLOW_CLASSIFIER = 348,
    OF_BSN_TLV_FLOW_CLASSIFY = 349,
    OF_BSN_TLV_FLOW_IDENTIFIER = 350,
    OF_BSN_TLV_FORCE_LINK_UP = 351,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 352,
    OF_BSN_TLV_GENERATION_ID = 353,
    OF_BSN_TLV_HASH_ALGORITHM = 354,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 355,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 356,
    OF_BSN_TLV_HASH_PACKET_FIELD = 357,
    OF_BSN_TLV_HASH_PACKET_TYPE = 358,
    OF_BSN_TLV_HASH_SEED = 359,
    OF_BSN_TLV_HASH_TYPE = 360,
    OF_BSN_TLV_HEADER_SIZE = 361,
    OF_BSN_TLV_ICMP_CODE = 362,
    OF_BSN_TLV_ICMP_ID = 363,
    OF_BSN_TLV_ICMP_TYPE = 364,
    OF_BSN_TLV_ICMPV6_CHKSUM = 365,
    OF_BSN_TLV_IDENTIFIER = 366,
    OF_BSN_TLV_IDLE_NOTIFICATION = 367,
    OF_BSN_TLV_IDLE_TIME = 368,
    OF_BSN_TLV_IDLE_TIMEOUT = 369,
    OF_BSN_TLV_IGMP_SNOOPING = 370,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 371,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 372,
    OF_BSN_TLV_INTERNAL_MAC = 373,
    OF_BSN_TLV_INTERVAL = 374,
    OF_BSN_TLV_IP_PROTO = 375,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 376,
    OF_BSN_TLV_IPV4 = 377,
    OF_BSN_TLV_IPV4_DST = 378,
    OF_BSN_TLV_IPV4_NETMASK = 379,
    OF_BSN_TLV_IPV4_SRC = 380,
    OF_BSN_TLV_IPV6 = 381,
    OF_BSN_TLV_IPV6_DST = 382,
    OF_BSN_TLV_IPV6_PREFIX = 383,
    OF_BSN_TLV_IPV6_SRC = 384,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 385,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 386,
    OF_BSN_TLV_L3 = 387,
    OF_BSN_TLV_L3_DST_CLASS_ID = 388,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 389,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 390,
    OF_BSN_TLV_LAG_OPTIONS = 391,
    OF_BSN_TLV_LINK_STATE = 392,
    OF_BSN_TLV_LOOPBACK_MODE = 393,
    OF_BSN_TLV_LOOPBACK_PORT = 394,
    OF_BSN_TLV_LOSSLESS = 395,
    OF_BSN_TLV_LR_ALL_ENABLED = 396,
    OF_BSN_TLV_MAC = 397,
    OF_BSN_TLV_MAC_MASK = 398,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 399,
    OF_BSN_TLV_MISS_PACKETS = 400,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 401,
    OF_BSN_TLV_MPLS_LABEL = 402,
    OF_BSN_TLV_MPLS_SEQUENCED = 403,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 404,
    OF_BSN_TLV_MULTICAST_PACKET = 405,
    OF_BSN_TLV_MULTIPLIER = 406,
    OF_BSN_TLV_NAME = 407,
    OF_BSN_TLV_NDP_OFFLOAD = 408,
    OF_BSN_TLV_NDP_STATIC = 409,
    OF_BSN_TLV_NEGATE = 410,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 411,
    OF_BSN_TLV_NEXT_HOP_MAC = 412,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 413,
    OF_BSN_TLV_NO_ARP_RESPONSE = 414,
    OF_BSN_TLV_NO_NS_RESPONSE = 415,
    OF_BSN_TLV_OFFSET = 416,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 417,
    OF_BSN_TLV_OUTER_SRC_MAC = 418,
    OF_BSN_TLV_PARENT_PORT = 419,
    OF_BSN_TLV_PARTNER_KEY = 420,
    OF_BSN_TLV_PARTNER_PORT_NUM = 421,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 422,
    OF_BSN_TLV_PARTNER_STATE = 423,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 424,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 425,
    OF_BSN_TLV_PASSIVE = 426,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 427,
    OF_BSN_TLV_PIM_DR = 428,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 429,
    OF_BSN_TLV_PORT = 430,
    OF_BSN_TLV_PORT_MODE = 431,
    OF_BSN_TLV_PORT_SPEED_GBPS = 432,
    OF_BSN_TLV_PORT_USAGE = 433,
    OF_BSN_TLV_PORT_VXLAN_MODE = 434,
    OF_BSN_TLV_PRESERVE_VLAN = 435,
    OF_BSN_TLV_PRIORITY = 436,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 437,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 438,
    OF_BSN_TLV_QOS_PRIORITY = 439,
    OF_BSN_TLV_QUEUE_ID = 440,
    OF_BSN_TLV_QUEUE_WEIGHT = 441,
    OF_BSN_TLV_RATE_LIMIT = 442,
    OF_BSN_TLV_RATE_UNIT = 443,
    OF_BSN_TLV_RECORD_PACKETS = 444,
    OF_BSN_TLV_REDUNDANT_MGMT = 445,
    OF_BSN_TLV_REFERENCE = 446,
    OF_BSN_TLV_REPLY_PACKETS = 447,
    OF_BSN_TLV_REQUEST_PACKETS = 448,
    OF_BSN_TLV_REST_SERVER = 449,
    OF_BSN_TLV_ROUTING_PARAM = 450,
    OF_BSN_TLV_RX_BYTES = 451,
    OF_BSN_TLV_RX_PACKETS = 452,
    OF_BSN_TLV_SAMPLING_RATE = 453,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 454,
    OF_BSN_TLV_SRC_MAC_CML = 455,
    OF_BSN_TLV_STATUS = 456,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 457,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 458,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 459,
    OF_BSN_TLV_SUB_AGENT_ID = 460,
    OF_BSN_TLV_TCP_DST = 461,
    OF_BSN_TLV_TCP_FLAGS = 462,
    OF_BSN_TLV_TCP_SRC = 463,
    OF_BSN_TLV_TIMESTAMP = 464,
    OF_BSN_TLV_TTL = 465,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 466,
    OF_BSN_TLV_TX_BYTES = 467,
    OF_BSN_TLV_TX_PACKETS = 468,
    OF_BSN_TLV_UDF_ANCHOR = 469,
    OF_BSN_TLV_UDF_CAPABILITY = 470,
    OF_BSN_TLV_UDF_ID = 471,
    OF_BSN_TLV_UDF_LENGTH = 472,
    OF_BSN_TLV_UDF_OFFSET = 473,
    OF_BSN_TLV_UDP_DST = 474,
    OF_BSN_TLV_UDP_SRC = 475,
    OF_BSN_TLV_UINT32 = 476,
    OF_BSN_TLV_UINT64_LIST = 477,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 478,
    OF_BSN_TLV_UNICAST_RATE = 479,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 480,
    OF_BSN_TLV_UNTAGGED = 481,
    OF_BSN_TLV_UPGRADE = 482,
    OF_BSN_TLV_URI_SCHEME = 483,
    OF_BSN_TLV_USE_PACKET_STATE = 484,
    OF_BSN_TLV_USER_CONFIGURED = 485,
    OF_BSN_TLV_VFI = 486,
    OF_BSN_TLV_VFP_CLASS_ID = 487,
    OF_BSN_TLV_VIRTUAL = 488,
    OF_BSN_TLV_VLAN_MAC_LIST = 489,
    OF_BSN_TLV_VLAN_PCP = 490,
    OF_BSN_TLV_VLAN_VID = 491,
    OF_BSN_TLV_VLAN_VID_MASK = 492,
    OF_BSN_TLV_VNI = 493,
    OF_BSN_TLV_VPN_KEY = 494,
    OF_BSN_TLV_VRF = 495,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 496,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 497,
    OF_BSN_VLAN_MAC = 498,
    OF_BSN_VPORT = 499,
    OF_BSN_VPORT_L2GRE = 500,
    OF_BSN_VPORT_Q_IN_Q = 501,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 502,
    OF_BUCKET = 503,
    OF_BUCKET_COUNTER = 504,
    OF_BUNDLE_PROP = 505,
    OF_BUNDLE_PROP_EXPERIMENTER = 506,
    OF_FLOW_STATS_ENTRY = 507,
    OF_GROUP_DESC_STATS_ENTRY = 508,
    OF_GROUP_STATS_ENTRY = 509,
    OF_HELLO_ELEM = 510,
    OF_HELLO_ELEM_VERSIONBITMAP = 511,
    OF_INSTRUCTION = 512,
    OF_INSTRUCTION_APPLY_ACTIONS = 513,
    OF_INSTRUCTION_BSN = 514,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 515,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 516,
    OF_INSTRUCTION_BSN_DENY = 517,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 518,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 519,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 520,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 521,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 522,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 523,
    OF_INSTRUCTION_BSN_HASH_SELECT = 524,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 525,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 526,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 527,
    OF_INSTRUCTION_BSN_PERMIT = 528,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 529,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 530,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 531,
    OF_INSTRUCTION_CLEAR_ACTIONS = 532,
    OF_INSTRUCTION_EXPERIMENTER = 533,
    OF_INSTRUCTION_GOTO_TABLE = 534,
    OF_INSTRUCTION_ID = 535,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 536,
    OF_INSTRUCTION_ID_BSN = 537,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 538,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 539,
    OF_INSTRUCTION_ID_BSN_DENY = 540,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 541,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 542,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 543,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 544,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 545,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 546,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 547,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 548,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 549,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 550,
    OF_INSTRUCTION_ID_BSN_PERMIT = 551,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 552,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 553,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 554,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 555,
    OF_INSTRUCTION_ID_EXPERIMENTER = 556,
    OF_INSTRUCTION_ID_GOTO_TABLE = 557,
    OF_INSTRUCTION_ID_METER = 558,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 559,
    OF_INSTRUCTION_ID_WRITE_METADATA = 560,
    OF_INSTRUCTION_METER = 561,
    OF_INSTRUCTION_WRITE_ACTIONS = 562,
    OF_INSTRUCTION_WRITE_METADATA = 563,
    OF_MATCH_V1 = 564,
    OF_MATCH_V2 = 565,
    OF_MATCH_V3 = 566,
    OF_METER_BAND = 567,
    OF_METER_BAND_DROP = 568,
    OF_METER_BAND_DSCP_REMARK = 569,
    OF_METER_BAND_EXPERIMENTER = 570,
    OF_METER_BAND_STATS = 571,
    OF_METER_CONFIG = 572,
    OF_METER_FEATURES = 573,
    OF_METER_STATS = 574,
    OF_OXM = 575,
    OF_OXM_ARP_OP = 576,
    OF_OXM_ARP_OP_MASKED = 577,
    OF_OXM_ARP_SHA = 578,
    OF_OXM_ARP_SHA_MASKED = 579,
    OF_OXM_ARP_SPA = 580,
    OF_OXM_ARP_SPA_MASKED = 581,
    OF_OXM_ARP_THA = 582,
    OF_OXM_ARP_THA_MASKED = 583,
    OF_OXM_ARP_TPA = 584,
    OF_OXM_ARP_TPA_MASKED = 585,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 586,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 587,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 588,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 589,
    OF_OXM_BSN_IFP_CLASS_ID = 590,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 591,
    OF_OXM_BSN_IN_PORTS_128 = 592,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 593,
    OF_OXM_BSN_IN_PORTS_512 = 594,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 595,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 596,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 597,
    OF_OXM_BSN_INNER_ETH_DST = 598,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 599,
    OF_OXM_BSN_INNER_ETH_SRC = 600,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 601,
    OF_OXM_BSN_INNER_VLAN_VID = 602,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 603,
    OF_OXM_BSN_IP_FRAGMENTATION = 604,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 605,
    OF_OXM_BSN_L2_CACHE_HIT = 606,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 607,
    OF_OXM_BSN_L3_DST_CLASS_ID = 608,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 609,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 610,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 611,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 612,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 613,
    OF_OXM_BSN_LAG_ID = 614,
    OF_OXM_BSN_LAG_ID_MASKED = 615,
    OF_OXM_BSN_TCP_FLAGS = 616,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 617,
    OF_OXM_BSN_UDF0 = 618,
    OF_OXM_BSN_UDF0_MASKED = 619,
    OF_OXM_BSN_UDF1 = 620,
    OF_OXM_BSN_UDF1_MASKED = 621,
    OF_OXM_BSN_UDF2 = 622,
    OF_OXM_BSN_UDF2_MASKED = 623,
    OF_OXM_BSN_UDF3 = 624,
    OF_OXM_BSN_UDF3_MASKED = 625,
    OF_OXM_BSN_UDF4 = 626,
    OF_OXM_BSN_UDF4_MASKED = 627,
    OF_OXM_BSN_UDF5 = 628,
    OF_OXM_BSN_UDF5_MASKED = 629,
    OF_OXM_BSN_UDF6 = 630,
    OF_OXM_BSN_UDF6_MASKED = 631,
    OF_OXM_BSN_UDF7 = 632,
    OF_OXM_BSN_UDF7_MASKED = 633,
    OF_OXM_BSN_VFI = 634,
    OF_OXM_BSN_VFI_MASKED = 635,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 636,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 637,
    OF_OXM_BSN_VRF = 638,
    OF_OXM_BSN_VRF_MASKED = 639,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 640,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 641,
    OF_OXM_CONN_TRACKING_IPV6_DST = 642,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 643,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 644,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 645,
    OF_OXM_CONN_TRACKING_LABEL = 646,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 647,
    OF_OXM_CONN_TRACKING_MARK = 648,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 649,
    OF_OXM_CONN_TRACKING_NW_DST = 650,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 651,
    OF_OXM_CONN_TRACKING_NW_PROTO = 652,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 653,
    OF_OXM_CONN_TRACKING_NW_SRC = 654,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 655,
    OF_OXM_CONN_TRACKING_STATE = 656,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 657,
    OF_OXM_CONN_TRACKING_TP_DST = 658,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 659,
    OF_OXM_CONN_TRACKING_TP_SRC = 660,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 661,
    OF_OXM_CONN_TRACKING_ZONE = 662,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 663,
    OF_OXM_ETH_DST = 664,
    OF_OXM_ETH_DST_MASKED = 665,
    OF_OXM_ETH_SRC = 666,
    OF_OXM_ETH_SRC_MASKED = 667,
    OF_OXM_ETH_TYPE = 668,
    OF_OXM_ETH_TYPE_MASKED = 669,
    OF_OXM_ICMPV4_CODE = 670,
    OF_OXM_ICMPV4_CODE_MASKED = 671,
    OF_OXM_ICMPV4_TYPE = 672,
    OF_OXM_ICMPV4_TYPE_MASKED = 673,
    OF_OXM_ICMPV6_CODE = 674,
    OF_OXM_ICMPV6_CODE_MASKED = 675,
    OF_OXM_ICMPV6_TYPE = 676,
    OF_OXM_ICMPV6_TYPE_MASKED = 677,
    OF_OXM_IN_PHY_PORT = 678,
    OF_OXM_IN_PHY_PORT_MASKED = 679,
    OF_OXM_IN_PORT = 680,
    OF_OXM_IN_PORT_MASKED = 681,
    OF_OXM_IP_DSCP = 682,
    OF_OXM_IP_DSCP_MASKED = 683,
    OF_OXM_IP_ECN = 684,
    OF_OXM_IP_ECN_MASKED = 685,
    OF_OXM_IP_PROTO = 686,
    OF_OXM_IP_PROTO_MASKED = 687,
    OF_OXM_IPV4_DST = 688,
    OF_OXM_IPV4_DST_MASKED = 689,
    OF_OXM_IPV4_SRC = 690,
    OF_OXM_IPV4_SRC_MASKED = 691,
    OF_OXM_IPV6_DST = 692,
    OF_OXM_IPV6_DST_MASKED = 693,
    OF_OXM_IPV6_EXTHDR = 694,
    OF_OXM_IPV6_EXTHDR_MASKED = 695,
    OF_OXM_IPV6_FLABEL = 696,
    OF_OXM_IPV6_FLABEL_MASKED = 697,
    OF_OXM_IPV6_ND_SLL = 698,
    OF_OXM_IPV6_ND_SLL_MASKED = 699,
    OF_OXM_IPV6_ND_TARGET = 700,
    OF_OXM_IPV6_ND_TARGET_MASKED = 701,
    OF_OXM_IPV6_ND_TLL = 702,
    OF_OXM_IPV6_ND_TLL_MASKED = 703,
    OF_OXM_IPV6_SRC = 704,
    OF_OXM_IPV6_SRC_MASKED = 705,
    OF_OXM_METADATA = 706,
    OF_OXM_METADATA_MASKED = 707,
    OF_OXM_MPLS_BOS = 708,
    OF_OXM_MPLS_BOS_MASKED = 709,
    OF_OXM_MPLS_LABEL = 710,
    OF_OXM_MPLS_LABEL_MASKED = 711,
    OF_OXM_MPLS_TC = 712,
    OF_OXM_MPLS_TC_MASKED = 713,
    OF_OXM_OVS_TCP_FLAGS = 714,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 715,
    OF_OXM_PBB_UCA = 716,
    OF_OXM_PBB_UCA_MASKED = 717,
    OF_OXM_SCTP_DST = 718,
    OF_OXM_SCTP_DST_MASKED = 719,
    OF_OXM_SCTP_SRC = 720,
    OF_OXM_SCTP_SRC_MASKED = 721,
    OF_OXM_TCP_DST = 722,
    OF_OXM_TCP_DST_MASKED = 723,
    OF_OXM_TCP_SRC = 724,
    OF_OXM_TCP_SRC_MASKED = 725,
    OF_OXM_TUNNEL_ID = 726,
    OF_OXM_TUNNEL_ID_MASKED = 727,
    OF_OXM_TUNNEL_IPV4_DST = 728,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 729,
    OF_OXM_TUNNEL_IPV4_SRC = 730,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 731,
    OF_OXM_UDP_DST = 732,
    OF_OXM_UDP_DST_MASKED = 733,
    OF_OXM_UDP_SRC = 734,
    OF_OXM_UDP_SRC_MASKED = 735,
    OF_OXM_VLAN_PCP = 736,
    OF_OXM_VLAN_PCP_MASKED = 737,
    OF_OXM_VLAN_VID = 738,
    OF_OXM_VLAN_VID_MASKED = 739,
    OF_PACKET_QUEUE = 740,
    OF_PORT_DESC = 741,
    OF_PORT_DESC_PROP = 742,
    OF_PORT_DESC_PROP_BSN = 743,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 744,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 745,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 746,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 747,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 748,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 749,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 750,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 751,
    OF_PORT_DESC_PROP_BSN_UPLINK = 752,
    OF_PORT_DESC_PROP_ETHERNET = 753,
    OF_PORT_DESC_PROP_EXPERIMENTER = 754,
    OF_PORT_DESC_PROP_OPTICAL = 755,
    OF_PORT_MOD_PROP = 756,
    OF_PORT_MOD_PROP_ETHERNET = 757,
    OF_PORT_MOD_PROP_EXPERIMENTER = 758,
    OF_PORT_MOD_PROP_OPTICAL = 759,
    OF_PORT_STATS_ENTRY = 760,
    OF_PORT_STATS_PROP = 761,
    OF_PORT_STATS_PROP_ETHERNET = 762,
    OF_PORT_STATS_PROP_EXPERIMENTER = 763,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 764,
    OF_PORT_STATS_PROP_OPTICAL = 765,
    OF_QUEUE_DESC = 766,
    OF_QUEUE_DESC_PROP = 767,
    OF_QUEUE_DESC_PROP_BSN = 768,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 769,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 770,
    OF_QUEUE_DESC_PROP_MAX_RATE = 771,
    OF_QUEUE_DESC_PROP_MIN_RATE = 772,
    OF_QUEUE_PROP = 773,
    OF_QUEUE_PROP_EXPERIMENTER = 774,
    OF_QUEUE_PROP_MAX_RATE = 775,
    OF_QUEUE_PROP_MIN_RATE = 776,
    OF_QUEUE_STATS_ENTRY = 777,
    OF_QUEUE_STATS_PROP = 778,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 779,
    OF_ROLE_PROP = 780,
    OF_ROLE_PROP_EXPERIMENTER = 781,
    OF_TABLE_DESC = 782,
    OF_TABLE_FEATURE_PROP = 783,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 784,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 785,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 786,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 787,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 788,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 789,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 790,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 791,
    OF_TABLE_FEATURE_PROP_MATCH = 792,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 793,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 794,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 795,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 796,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 797,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 798,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 799,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 800,
    OF_TABLE_FEATURES = 801,
    OF_TABLE_MOD_PROP = 802,
    OF_TABLE_MOD_PROP_EVICTION = 803,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 804,
    OF_TABLE_MOD_PROP_VACANCY = 805,
    OF_TABLE_STATS_ENTRY = 806,
    OF_UINT32 = 807,
    OF_UINT64 = 808,
    OF_UINT8 = 809,
    ...
    /* List objects */
    OF_LIST_ACTION = 810,
    OF_LIST_ACTION_ID = 811,
    OF_LIST_ASYNC_CONFIG_PROP = 812,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 813,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 814,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 815,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 816,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 817,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 818,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 819,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 820,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 821,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 822,
    OF_LIST_BSN_INTERFACE = 823,
    OF_LIST_BSN_LACP_STATS_ENTRY = 824,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 825,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 826,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 827,
    OF_LIST_BSN_TLV = 828,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 829,
    OF_LIST_BSN_VLAN_MAC = 830,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 831,
    OF_LIST_BUCKET = 832,
    OF_LIST_BUCKET_COUNTER = 833,
    OF_LIST_BUNDLE_PROP = 834,
    OF_LIST_FLOW_STATS_ENTRY = 835,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 836,
    OF_LIST_GROUP_STATS_ENTRY = 837,
    OF_LIST_HELLO_ELEM = 838,
    OF_LIST_INSTRUCTION = 839,
    OF_LIST_INSTRUCTION_ID = 840,
    OF_LIST_METER_BAND = 841,
    OF_LIST_METER_BAND_STATS = 842,
    OF_LIST_METER_CONFIG = 843,
    OF_LIST_METER_STATS = 844,
    OF_LIST_OXM = 845,
    OF_LIST_PACKET_QUEUE = 846,
    OF_LIST_PORT_DESC = 847,
    OF_LIST_PORT_DESC_PROP = 848,
    OF_LIST_PORT_MOD_PROP = 849,
    OF_LIST_PORT_STATS_ENTRY = 850,
    OF_LIST_PORT_STATS_PROP = 851,
    OF_LIST_QUEUE_DESC = 852,
    OF_LIST_QUEUE_DESC_PROP = 853,
    OF_LIST_QUEUE_PROP = 854,
    OF_LIST_QUEUE_STATS_ENTRY = 855,
    OF_LIST_QUEUE_STATS_PROP = 856,
    OF_LIST_ROLE_PROP = 857,
    OF_LIST_TABLE_DESC = 858,
    OF_LIST_TABLE_FEATURE_PROP = 859,
    OF_LIST_TABLE_FEATURES = 860,
    OF_LIST_TABLE_MOD_PROP = 861,
    OF_LIST_TABLE_STATS_ENTRY = 862,
    OF_LIST_UINT32 = 863,
    OF_LIST_UINT64 = 864,
    OF_LIST_UINT8 = 865,
