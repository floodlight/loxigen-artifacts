...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_VFI = 393,
    OF_BSN_TLV_VLAN_PCP = 394,
    OF_BSN_TLV_VLAN_VID = 395,
    OF_BSN_TLV_VLAN_VID_MASK = 396,
    OF_BSN_TLV_VNI = 397,
    OF_BSN_TLV_VRF = 398,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 399,
    OF_BSN_VPORT = 400,
    OF_BSN_VPORT_L2GRE = 401,
    OF_BSN_VPORT_Q_IN_Q = 402,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 403,
    OF_BUCKET = 404,
    OF_BUCKET_COUNTER = 405,
    OF_BUNDLE_PROP = 406,
    OF_BUNDLE_PROP_EXPERIMENTER = 407,
    OF_FLOW_STATS_ENTRY = 408,
    OF_GROUP_DESC_STATS_ENTRY = 409,
    OF_GROUP_STATS_ENTRY = 410,
    OF_HELLO_ELEM = 411,
    OF_HELLO_ELEM_VERSIONBITMAP = 412,
    OF_INSTRUCTION = 413,
    OF_INSTRUCTION_APPLY_ACTIONS = 414,
    OF_INSTRUCTION_BSN = 415,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 416,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 417,
    OF_INSTRUCTION_BSN_DENY = 418,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 419,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 420,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 421,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 422,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 423,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 424,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 425,
    OF_INSTRUCTION_BSN_PERMIT = 426,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 427,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 428,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 429,
    OF_INSTRUCTION_CLEAR_ACTIONS = 430,
    OF_INSTRUCTION_EXPERIMENTER = 431,
    OF_INSTRUCTION_GOTO_TABLE = 432,
    OF_INSTRUCTION_ID = 433,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 434,
    OF_INSTRUCTION_ID_BSN = 435,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 436,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 437,
    OF_INSTRUCTION_ID_BSN_DENY = 438,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 439,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 440,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 441,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 442,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 443,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 444,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 445,
    OF_INSTRUCTION_ID_BSN_PERMIT = 446,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 447,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 448,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 449,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 450,
    OF_INSTRUCTION_ID_EXPERIMENTER = 451,
    OF_INSTRUCTION_ID_GOTO_TABLE = 452,
    OF_INSTRUCTION_ID_METER = 453,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 454,
    OF_INSTRUCTION_ID_WRITE_METADATA = 455,
    OF_INSTRUCTION_METER = 456,
    OF_INSTRUCTION_WRITE_ACTIONS = 457,
    OF_INSTRUCTION_WRITE_METADATA = 458,
    OF_MATCH_V1 = 459,
    OF_MATCH_V2 = 460,
    OF_MATCH_V3 = 461,
    OF_METER_BAND = 462,
    OF_METER_BAND_DROP = 463,
    OF_METER_BAND_DSCP_REMARK = 464,
    OF_METER_BAND_EXPERIMENTER = 465,
    OF_METER_BAND_STATS = 466,
    OF_METER_CONFIG = 467,
    OF_METER_FEATURES = 468,
    OF_METER_STATS = 469,
    OF_OXM = 470,
    OF_OXM_ARP_OP = 471,
    OF_OXM_ARP_OP_MASKED = 472,
    OF_OXM_ARP_SHA = 473,
    OF_OXM_ARP_SHA_MASKED = 474,
    OF_OXM_ARP_SPA = 475,
    OF_OXM_ARP_SPA_MASKED = 476,
    OF_OXM_ARP_THA = 477,
    OF_OXM_ARP_THA_MASKED = 478,
    OF_OXM_ARP_TPA = 479,
    OF_OXM_ARP_TPA_MASKED = 480,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 481,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 482,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 483,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 484,
    OF_OXM_BSN_IN_PORTS_128 = 485,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 486,
    OF_OXM_BSN_IN_PORTS_512 = 487,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 488,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 489,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 490,
    OF_OXM_BSN_INNER_ETH_DST = 491,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 492,
    OF_OXM_BSN_INNER_ETH_SRC = 493,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 494,
    OF_OXM_BSN_INNER_VLAN_VID = 495,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 496,
    OF_OXM_BSN_L2_CACHE_HIT = 497,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 498,
    OF_OXM_BSN_L3_DST_CLASS_ID = 499,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 500,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 501,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 502,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 503,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 504,
    OF_OXM_BSN_LAG_ID = 505,
    OF_OXM_BSN_LAG_ID_MASKED = 506,
    OF_OXM_BSN_TCP_FLAGS = 507,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 508,
    OF_OXM_BSN_UDF0 = 509,
    OF_OXM_BSN_UDF0_MASKED = 510,
    OF_OXM_BSN_UDF1 = 511,
    OF_OXM_BSN_UDF1_MASKED = 512,
    OF_OXM_BSN_UDF2 = 513,
    OF_OXM_BSN_UDF2_MASKED = 514,
    OF_OXM_BSN_UDF3 = 515,
    OF_OXM_BSN_UDF3_MASKED = 516,
    OF_OXM_BSN_UDF4 = 517,
    OF_OXM_BSN_UDF4_MASKED = 518,
    OF_OXM_BSN_UDF5 = 519,
    OF_OXM_BSN_UDF5_MASKED = 520,
    OF_OXM_BSN_UDF6 = 521,
    OF_OXM_BSN_UDF6_MASKED = 522,
    OF_OXM_BSN_UDF7 = 523,
    OF_OXM_BSN_UDF7_MASKED = 524,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 525,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 526,
    OF_OXM_BSN_VRF = 527,
    OF_OXM_BSN_VRF_MASKED = 528,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 529,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 530,
    OF_OXM_ETH_DST = 531,
    OF_OXM_ETH_DST_MASKED = 532,
    OF_OXM_ETH_SRC = 533,
    OF_OXM_ETH_SRC_MASKED = 534,
    OF_OXM_ETH_TYPE = 535,
    OF_OXM_ETH_TYPE_MASKED = 536,
    OF_OXM_ICMPV4_CODE = 537,
    OF_OXM_ICMPV4_CODE_MASKED = 538,
    OF_OXM_ICMPV4_TYPE = 539,
    OF_OXM_ICMPV4_TYPE_MASKED = 540,
    OF_OXM_ICMPV6_CODE = 541,
    OF_OXM_ICMPV6_CODE_MASKED = 542,
    OF_OXM_ICMPV6_TYPE = 543,
    OF_OXM_ICMPV6_TYPE_MASKED = 544,
    OF_OXM_IN_PHY_PORT = 545,
    OF_OXM_IN_PHY_PORT_MASKED = 546,
    OF_OXM_IN_PORT = 547,
    OF_OXM_IN_PORT_MASKED = 548,
    OF_OXM_IP_DSCP = 549,
    OF_OXM_IP_DSCP_MASKED = 550,
    OF_OXM_IP_ECN = 551,
    OF_OXM_IP_ECN_MASKED = 552,
    OF_OXM_IP_PROTO = 553,
    OF_OXM_IP_PROTO_MASKED = 554,
    OF_OXM_IPV4_DST = 555,
    OF_OXM_IPV4_DST_MASKED = 556,
    OF_OXM_IPV4_SRC = 557,
    OF_OXM_IPV4_SRC_MASKED = 558,
    OF_OXM_IPV6_DST = 559,
    OF_OXM_IPV6_DST_MASKED = 560,
    OF_OXM_IPV6_EXTHDR = 561,
    OF_OXM_IPV6_EXTHDR_MASKED = 562,
    OF_OXM_IPV6_FLABEL = 563,
    OF_OXM_IPV6_FLABEL_MASKED = 564,
    OF_OXM_IPV6_ND_SLL = 565,
    OF_OXM_IPV6_ND_SLL_MASKED = 566,
    OF_OXM_IPV6_ND_TARGET = 567,
    OF_OXM_IPV6_ND_TARGET_MASKED = 568,
    OF_OXM_IPV6_ND_TLL = 569,
    OF_OXM_IPV6_ND_TLL_MASKED = 570,
    OF_OXM_IPV6_SRC = 571,
    OF_OXM_IPV6_SRC_MASKED = 572,
    OF_OXM_METADATA = 573,
    OF_OXM_METADATA_MASKED = 574,
    OF_OXM_MPLS_BOS = 575,
    OF_OXM_MPLS_BOS_MASKED = 576,
    OF_OXM_MPLS_LABEL = 577,
    OF_OXM_MPLS_LABEL_MASKED = 578,
    OF_OXM_MPLS_TC = 579,
    OF_OXM_MPLS_TC_MASKED = 580,
    OF_OXM_PBB_UCA = 581,
    OF_OXM_PBB_UCA_MASKED = 582,
    OF_OXM_SCTP_DST = 583,
    OF_OXM_SCTP_DST_MASKED = 584,
    OF_OXM_SCTP_SRC = 585,
    OF_OXM_SCTP_SRC_MASKED = 586,
    OF_OXM_TCP_DST = 587,
    OF_OXM_TCP_DST_MASKED = 588,
    OF_OXM_TCP_SRC = 589,
    OF_OXM_TCP_SRC_MASKED = 590,
    OF_OXM_TUNNEL_ID = 591,
    OF_OXM_TUNNEL_ID_MASKED = 592,
    OF_OXM_TUNNEL_IPV4_DST = 593,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 594,
    OF_OXM_TUNNEL_IPV4_SRC = 595,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 596,
    OF_OXM_UDP_DST = 597,
    OF_OXM_UDP_DST_MASKED = 598,
    OF_OXM_UDP_SRC = 599,
    OF_OXM_UDP_SRC_MASKED = 600,
    OF_OXM_VLAN_PCP = 601,
    OF_OXM_VLAN_PCP_MASKED = 602,
    OF_OXM_VLAN_VID = 603,
    OF_OXM_VLAN_VID_MASKED = 604,
    OF_PACKET_QUEUE = 605,
    OF_PORT_DESC = 606,
    OF_PORT_DESC_PROP = 607,
    OF_PORT_DESC_PROP_BSN = 608,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 609,
    OF_PORT_DESC_PROP_BSN_UPLINK = 610,
    OF_PORT_DESC_PROP_ETHERNET = 611,
    OF_PORT_DESC_PROP_EXPERIMENTER = 612,
    OF_PORT_DESC_PROP_OPTICAL = 613,
    OF_PORT_MOD_PROP = 614,
    OF_PORT_MOD_PROP_ETHERNET = 615,
    OF_PORT_MOD_PROP_EXPERIMENTER = 616,
    OF_PORT_MOD_PROP_OPTICAL = 617,
    OF_PORT_STATS_ENTRY = 618,
    OF_PORT_STATS_PROP = 619,
    OF_PORT_STATS_PROP_ETHERNET = 620,
    OF_PORT_STATS_PROP_EXPERIMENTER = 621,
    OF_PORT_STATS_PROP_OPTICAL = 622,
    OF_QUEUE_DESC = 623,
    OF_QUEUE_DESC_PROP = 624,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 625,
    OF_QUEUE_DESC_PROP_MAX_RATE = 626,
    OF_QUEUE_DESC_PROP_MIN_RATE = 627,
    OF_QUEUE_PROP = 628,
    OF_QUEUE_PROP_EXPERIMENTER = 629,
    OF_QUEUE_PROP_MAX_RATE = 630,
    OF_QUEUE_PROP_MIN_RATE = 631,
    OF_QUEUE_STATS_ENTRY = 632,
    OF_QUEUE_STATS_PROP = 633,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 634,
    OF_ROLE_PROP = 635,
    OF_ROLE_PROP_EXPERIMENTER = 636,
    OF_TABLE_DESC = 637,
    OF_TABLE_FEATURE_PROP = 638,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 639,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 640,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 641,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 642,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 643,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 644,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 645,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 646,
    OF_TABLE_FEATURE_PROP_MATCH = 647,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 648,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 649,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 650,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 651,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 652,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 653,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 654,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 655,
    OF_TABLE_FEATURES = 656,
    OF_TABLE_MOD_PROP = 657,
    OF_TABLE_MOD_PROP_EVICTION = 658,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 659,
    OF_TABLE_MOD_PROP_VACANCY = 660,
    OF_TABLE_STATS_ENTRY = 661,
    OF_UINT32 = 662,
    OF_UINT64 = 663,
    OF_UINT8 = 664,
    ...
    /* List objects */
    OF_LIST_ACTION = 665,
    OF_LIST_ACTION_ID = 666,
    OF_LIST_ASYNC_CONFIG_PROP = 667,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 668,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 669,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 670,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 671,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 672,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 673,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 674,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 675,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 676,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 677,
    OF_LIST_BSN_INTERFACE = 678,
    OF_LIST_BSN_LACP_STATS_ENTRY = 679,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 680,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 681,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 682,
    OF_LIST_BSN_TLV = 683,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 684,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 685,
    OF_LIST_BUCKET = 686,
    OF_LIST_BUCKET_COUNTER = 687,
    OF_LIST_BUNDLE_PROP = 688,
    OF_LIST_FLOW_STATS_ENTRY = 689,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 690,
    OF_LIST_GROUP_STATS_ENTRY = 691,
    OF_LIST_HELLO_ELEM = 692,
    OF_LIST_INSTRUCTION = 693,
    OF_LIST_INSTRUCTION_ID = 694,
    OF_LIST_METER_BAND = 695,
    OF_LIST_METER_BAND_STATS = 696,
    OF_LIST_METER_CONFIG = 697,
    OF_LIST_METER_STATS = 698,
    OF_LIST_OXM = 699,
    OF_LIST_PACKET_QUEUE = 700,
    OF_LIST_PORT_DESC = 701,
    OF_LIST_PORT_DESC_PROP = 702,
    OF_LIST_PORT_MOD_PROP = 703,
    OF_LIST_PORT_STATS_ENTRY = 704,
    OF_LIST_PORT_STATS_PROP = 705,
    OF_LIST_QUEUE_DESC = 706,
    OF_LIST_QUEUE_DESC_PROP = 707,
    OF_LIST_QUEUE_PROP = 708,
    OF_LIST_QUEUE_STATS_ENTRY = 709,
    OF_LIST_QUEUE_STATS_PROP = 710,
    OF_LIST_ROLE_PROP = 711,
    OF_LIST_TABLE_DESC = 712,
    OF_LIST_TABLE_FEATURE_PROP = 713,
    OF_LIST_TABLE_FEATURES = 714,
    OF_LIST_TABLE_MOD_PROP = 715,
    OF_LIST_TABLE_STATS_ENTRY = 716,
    OF_LIST_UINT32 = 717,
    OF_LIST_UINT64 = 718,
    OF_LIST_UINT8 = 719,
