...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_LCORE = 407,
    OF_BSN_TLV_LINK_UP = 408,
    OF_BSN_TLV_LOAD = 409,
    OF_BSN_TLV_LOOKUP_COUNT = 410,
    OF_BSN_TLV_LOOPBACK_MODE = 411,
    OF_BSN_TLV_LOOPBACK_PORT = 412,
    OF_BSN_TLV_LOSSLESS = 413,
    OF_BSN_TLV_LR_ALL_ENABLED = 414,
    OF_BSN_TLV_MAC = 415,
    OF_BSN_TLV_MAC_MASK = 416,
    OF_BSN_TLV_MATCHED_COUNT = 417,
    OF_BSN_TLV_MAX_COUNT = 418,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 419,
    OF_BSN_TLV_METADATA = 420,
    OF_BSN_TLV_MGMT = 421,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 422,
    OF_BSN_TLV_MISS_PACKETS = 423,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 424,
    OF_BSN_TLV_MPLS_LABEL = 425,
    OF_BSN_TLV_MPLS_SEQUENCED = 426,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 427,
    OF_BSN_TLV_MULTICAST_PACKET = 428,
    OF_BSN_TLV_MULTIPLIER = 429,
    OF_BSN_TLV_NAME = 430,
    OF_BSN_TLV_NDP_OFFLOAD = 431,
    OF_BSN_TLV_NDP_STATIC = 432,
    OF_BSN_TLV_NEGATE = 433,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 434,
    OF_BSN_TLV_NEXT_HOP_MAC = 435,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 436,
    OF_BSN_TLV_NO_ARP_RESPONSE = 437,
    OF_BSN_TLV_NO_DROP = 438,
    OF_BSN_TLV_NO_NS_RESPONSE = 439,
    OF_BSN_TLV_OFFSET = 440,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 441,
    OF_BSN_TLV_OUTER_SRC_MAC = 442,
    OF_BSN_TLV_PACKET_FIELD = 443,
    OF_BSN_TLV_PARENT_PORT = 444,
    OF_BSN_TLV_PARTNER_KEY = 445,
    OF_BSN_TLV_PARTNER_PORT_NUM = 446,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 447,
    OF_BSN_TLV_PARTNER_STATE = 448,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 449,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 450,
    OF_BSN_TLV_PASSIVE = 451,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 452,
    OF_BSN_TLV_PIM_DR = 453,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 454,
    OF_BSN_TLV_PORT = 455,
    OF_BSN_TLV_PORT_MODE = 456,
    OF_BSN_TLV_PORT_SPEED_GBPS = 457,
    OF_BSN_TLV_PORT_USAGE = 458,
    OF_BSN_TLV_PORT_VXLAN_MODE = 459,
    OF_BSN_TLV_PRESERVE_VLAN = 460,
    OF_BSN_TLV_PRIORITY = 461,
    OF_BSN_TLV_PUSH_TWO_PER_POLICY = 462,
    OF_BSN_TLV_PUSH_TWO_TAGS_CAPABILITY = 463,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 464,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 465,
    OF_BSN_TLV_QOS_PRIORITY = 466,
    OF_BSN_TLV_QUEUE_ID = 467,
    OF_BSN_TLV_QUEUE_WEIGHT = 468,
    OF_BSN_TLV_RATE_LIMIT = 469,
    OF_BSN_TLV_RATE_UNIT = 470,
    OF_BSN_TLV_RECORD_PACKETS = 471,
    OF_BSN_TLV_REDUNDANT_MGMT = 472,
    OF_BSN_TLV_REFERENCE = 473,
    OF_BSN_TLV_REMOTE_ID = 474,
    OF_BSN_TLV_REPLY_PACKETS = 475,
    OF_BSN_TLV_REQUEST_PACKETS = 476,
    OF_BSN_TLV_REST_SERVER = 477,
    OF_BSN_TLV_ROUTING_PARAM = 478,
    OF_BSN_TLV_RX_BYTES = 479,
    OF_BSN_TLV_RX_PACKETS = 480,
    OF_BSN_TLV_SAMPLING_RATE = 481,
    OF_BSN_TLV_SCTP_DST = 482,
    OF_BSN_TLV_SCTP_SRC = 483,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 484,
    OF_BSN_TLV_SOCKET = 485,
    OF_BSN_TLV_SRC_MAC_CML = 486,
    OF_BSN_TLV_STATUS = 487,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 488,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 489,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 490,
    OF_BSN_TLV_SUB_AGENT_ID = 491,
    OF_BSN_TLV_TCP_DST = 492,
    OF_BSN_TLV_TCP_FLAGS = 493,
    OF_BSN_TLV_TCP_SRC = 494,
    OF_BSN_TLV_THREAD = 495,
    OF_BSN_TLV_TIMESTAMP = 496,
    OF_BSN_TLV_TTL = 497,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 498,
    OF_BSN_TLV_TX_BYTES = 499,
    OF_BSN_TLV_TX_PACKETS = 500,
    OF_BSN_TLV_UDF_ANCHOR = 501,
    OF_BSN_TLV_UDF_CAPABILITY = 502,
    OF_BSN_TLV_UDF_DATA = 503,
    OF_BSN_TLV_UDF_ID = 504,
    OF_BSN_TLV_UDF_LENGTH = 505,
    OF_BSN_TLV_UDF_OFFSET = 506,
    OF_BSN_TLV_UDP_DST = 507,
    OF_BSN_TLV_UDP_SRC = 508,
    OF_BSN_TLV_UINT32 = 509,
    OF_BSN_TLV_UINT64_LIST = 510,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 511,
    OF_BSN_TLV_UNICAST_RATE = 512,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 513,
    OF_BSN_TLV_UNTAGGED = 514,
    OF_BSN_TLV_UPGRADE = 515,
    OF_BSN_TLV_URI_SCHEME = 516,
    OF_BSN_TLV_USE_PACKET_STATE = 517,
    OF_BSN_TLV_USER_CONFIGURED = 518,
    OF_BSN_TLV_VFI = 519,
    OF_BSN_TLV_VFP_CLASS_ID = 520,
    OF_BSN_TLV_VIRTUAL = 521,
    OF_BSN_TLV_VLAN_MAC_LIST = 522,
    OF_BSN_TLV_VLAN_PCP = 523,
    OF_BSN_TLV_VLAN_VID = 524,
    OF_BSN_TLV_VLAN_VID_MASK = 525,
    OF_BSN_TLV_VNI = 526,
    OF_BSN_TLV_VPN_KEY = 527,
    OF_BSN_TLV_VRF = 528,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 529,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 530,
    OF_BSN_VLAN_MAC = 531,
    OF_BSN_VPORT = 532,
    OF_BSN_VPORT_L2GRE = 533,
    OF_BSN_VPORT_Q_IN_Q = 534,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 535,
    OF_BUCKET = 536,
    OF_BUCKET_COUNTER = 537,
    OF_BUNDLE_PROP = 538,
    OF_BUNDLE_PROP_EXPERIMENTER = 539,
    OF_FLOW_STATS_ENTRY = 540,
    OF_GROUP_DESC_STATS_ENTRY = 541,
    OF_GROUP_STATS_ENTRY = 542,
    OF_HELLO_ELEM = 543,
    OF_HELLO_ELEM_VERSIONBITMAP = 544,
    OF_INSTRUCTION = 545,
    OF_INSTRUCTION_APPLY_ACTIONS = 546,
    OF_INSTRUCTION_BSN = 547,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 548,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 549,
    OF_INSTRUCTION_BSN_DENY = 550,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 551,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 552,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 553,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 554,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 555,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 556,
    OF_INSTRUCTION_BSN_HASH_SELECT = 557,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 558,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 559,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 560,
    OF_INSTRUCTION_BSN_PERMIT = 561,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 562,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 563,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 564,
    OF_INSTRUCTION_CLEAR_ACTIONS = 565,
    OF_INSTRUCTION_EXPERIMENTER = 566,
    OF_INSTRUCTION_GOTO_TABLE = 567,
    OF_INSTRUCTION_ID = 568,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 569,
    OF_INSTRUCTION_ID_BSN = 570,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 571,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 572,
    OF_INSTRUCTION_ID_BSN_DENY = 573,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 574,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 575,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 576,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 577,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 578,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 579,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 580,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 581,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 582,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 583,
    OF_INSTRUCTION_ID_BSN_PERMIT = 584,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 585,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 586,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 587,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 588,
    OF_INSTRUCTION_ID_EXPERIMENTER = 589,
    OF_INSTRUCTION_ID_GOTO_TABLE = 590,
    OF_INSTRUCTION_ID_METER = 591,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 592,
    OF_INSTRUCTION_ID_WRITE_METADATA = 593,
    OF_INSTRUCTION_METER = 594,
    OF_INSTRUCTION_WRITE_ACTIONS = 595,
    OF_INSTRUCTION_WRITE_METADATA = 596,
    OF_MATCH_V1 = 597,
    OF_MATCH_V2 = 598,
    OF_MATCH_V3 = 599,
    OF_METER_BAND = 600,
    OF_METER_BAND_DROP = 601,
    OF_METER_BAND_DSCP_REMARK = 602,
    OF_METER_BAND_EXPERIMENTER = 603,
    OF_METER_BAND_STATS = 604,
    OF_METER_CONFIG = 605,
    OF_METER_FEATURES = 606,
    OF_METER_STATS = 607,
    OF_OXM = 608,
    OF_OXM_ARP_OP = 609,
    OF_OXM_ARP_OP_MASKED = 610,
    OF_OXM_ARP_SHA = 611,
    OF_OXM_ARP_SHA_MASKED = 612,
    OF_OXM_ARP_SPA = 613,
    OF_OXM_ARP_SPA_MASKED = 614,
    OF_OXM_ARP_THA = 615,
    OF_OXM_ARP_THA_MASKED = 616,
    OF_OXM_ARP_TPA = 617,
    OF_OXM_ARP_TPA_MASKED = 618,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 619,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 620,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 621,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 622,
    OF_OXM_BSN_IFP_CLASS_ID = 623,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 624,
    OF_OXM_BSN_IN_PORTS_128 = 625,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 626,
    OF_OXM_BSN_IN_PORTS_512 = 627,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 628,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 629,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 630,
    OF_OXM_BSN_INNER_ETH_DST = 631,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 632,
    OF_OXM_BSN_INNER_ETH_SRC = 633,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 634,
    OF_OXM_BSN_INNER_VLAN_VID = 635,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 636,
    OF_OXM_BSN_IP_FRAGMENTATION = 637,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 638,
    OF_OXM_BSN_L2_CACHE_HIT = 639,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 640,
    OF_OXM_BSN_L3_DST_CLASS_ID = 641,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 642,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 643,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 644,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 645,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 646,
    OF_OXM_BSN_LAG_ID = 647,
    OF_OXM_BSN_LAG_ID_MASKED = 648,
    OF_OXM_BSN_TCP_FLAGS = 649,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 650,
    OF_OXM_BSN_UDF0 = 651,
    OF_OXM_BSN_UDF0_MASKED = 652,
    OF_OXM_BSN_UDF1 = 653,
    OF_OXM_BSN_UDF1_MASKED = 654,
    OF_OXM_BSN_UDF2 = 655,
    OF_OXM_BSN_UDF2_MASKED = 656,
    OF_OXM_BSN_UDF3 = 657,
    OF_OXM_BSN_UDF3_MASKED = 658,
    OF_OXM_BSN_UDF4 = 659,
    OF_OXM_BSN_UDF4_MASKED = 660,
    OF_OXM_BSN_UDF5 = 661,
    OF_OXM_BSN_UDF5_MASKED = 662,
    OF_OXM_BSN_UDF6 = 663,
    OF_OXM_BSN_UDF6_MASKED = 664,
    OF_OXM_BSN_UDF7 = 665,
    OF_OXM_BSN_UDF7_MASKED = 666,
    OF_OXM_BSN_VFI = 667,
    OF_OXM_BSN_VFI_MASKED = 668,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 669,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 670,
    OF_OXM_BSN_VRF = 671,
    OF_OXM_BSN_VRF_MASKED = 672,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 673,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 674,
    OF_OXM_CONN_TRACKING_IPV6_DST = 675,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 676,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 677,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 678,
    OF_OXM_CONN_TRACKING_LABEL = 679,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 680,
    OF_OXM_CONN_TRACKING_MARK = 681,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 682,
    OF_OXM_CONN_TRACKING_NW_DST = 683,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 684,
    OF_OXM_CONN_TRACKING_NW_PROTO = 685,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 686,
    OF_OXM_CONN_TRACKING_NW_SRC = 687,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 688,
    OF_OXM_CONN_TRACKING_STATE = 689,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 690,
    OF_OXM_CONN_TRACKING_TP_DST = 691,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 692,
    OF_OXM_CONN_TRACKING_TP_SRC = 693,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 694,
    OF_OXM_CONN_TRACKING_ZONE = 695,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 696,
    OF_OXM_ETH_DST = 697,
    OF_OXM_ETH_DST_MASKED = 698,
    OF_OXM_ETH_SRC = 699,
    OF_OXM_ETH_SRC_MASKED = 700,
    OF_OXM_ETH_TYPE = 701,
    OF_OXM_ETH_TYPE_MASKED = 702,
    OF_OXM_ICMPV4_CODE = 703,
    OF_OXM_ICMPV4_CODE_MASKED = 704,
    OF_OXM_ICMPV4_TYPE = 705,
    OF_OXM_ICMPV4_TYPE_MASKED = 706,
    OF_OXM_ICMPV6_CODE = 707,
    OF_OXM_ICMPV6_CODE_MASKED = 708,
    OF_OXM_ICMPV6_TYPE = 709,
    OF_OXM_ICMPV6_TYPE_MASKED = 710,
    OF_OXM_IN_PHY_PORT = 711,
    OF_OXM_IN_PHY_PORT_MASKED = 712,
    OF_OXM_IN_PORT = 713,
    OF_OXM_IN_PORT_MASKED = 714,
    OF_OXM_IP_DSCP = 715,
    OF_OXM_IP_DSCP_MASKED = 716,
    OF_OXM_IP_ECN = 717,
    OF_OXM_IP_ECN_MASKED = 718,
    OF_OXM_IP_PROTO = 719,
    OF_OXM_IP_PROTO_MASKED = 720,
    OF_OXM_IPV4_DST = 721,
    OF_OXM_IPV4_DST_MASKED = 722,
    OF_OXM_IPV4_SRC = 723,
    OF_OXM_IPV4_SRC_MASKED = 724,
    OF_OXM_IPV6_DST = 725,
    OF_OXM_IPV6_DST_MASKED = 726,
    OF_OXM_IPV6_EXTHDR = 727,
    OF_OXM_IPV6_EXTHDR_MASKED = 728,
    OF_OXM_IPV6_FLABEL = 729,
    OF_OXM_IPV6_FLABEL_MASKED = 730,
    OF_OXM_IPV6_ND_SLL = 731,
    OF_OXM_IPV6_ND_SLL_MASKED = 732,
    OF_OXM_IPV6_ND_TARGET = 733,
    OF_OXM_IPV6_ND_TARGET_MASKED = 734,
    OF_OXM_IPV6_ND_TLL = 735,
    OF_OXM_IPV6_ND_TLL_MASKED = 736,
    OF_OXM_IPV6_SRC = 737,
    OF_OXM_IPV6_SRC_MASKED = 738,
    OF_OXM_METADATA = 739,
    OF_OXM_METADATA_MASKED = 740,
    OF_OXM_MPLS_BOS = 741,
    OF_OXM_MPLS_BOS_MASKED = 742,
    OF_OXM_MPLS_LABEL = 743,
    OF_OXM_MPLS_LABEL_MASKED = 744,
    OF_OXM_MPLS_TC = 745,
    OF_OXM_MPLS_TC_MASKED = 746,
    OF_OXM_OVS_TCP_FLAGS = 747,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 748,
    OF_OXM_PBB_UCA = 749,
    OF_OXM_PBB_UCA_MASKED = 750,
    OF_OXM_SCTP_DST = 751,
    OF_OXM_SCTP_DST_MASKED = 752,
    OF_OXM_SCTP_SRC = 753,
    OF_OXM_SCTP_SRC_MASKED = 754,
    OF_OXM_TCP_DST = 755,
    OF_OXM_TCP_DST_MASKED = 756,
    OF_OXM_TCP_SRC = 757,
    OF_OXM_TCP_SRC_MASKED = 758,
    OF_OXM_TUNNEL_ID = 759,
    OF_OXM_TUNNEL_ID_MASKED = 760,
    OF_OXM_TUNNEL_IPV4_DST = 761,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 762,
    OF_OXM_TUNNEL_IPV4_SRC = 763,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 764,
    OF_OXM_UDP_DST = 765,
    OF_OXM_UDP_DST_MASKED = 766,
    OF_OXM_UDP_SRC = 767,
    OF_OXM_UDP_SRC_MASKED = 768,
    OF_OXM_VLAN_PCP = 769,
    OF_OXM_VLAN_PCP_MASKED = 770,
    OF_OXM_VLAN_VID = 771,
    OF_OXM_VLAN_VID_MASKED = 772,
    OF_PACKET_QUEUE = 773,
    OF_PORT_DESC = 774,
    OF_PORT_DESC_PROP = 775,
    OF_PORT_DESC_PROP_BSN = 776,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 777,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 778,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 779,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 780,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 781,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 782,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 783,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 784,
    OF_PORT_DESC_PROP_BSN_UPLINK = 785,
    OF_PORT_DESC_PROP_ETHERNET = 786,
    OF_PORT_DESC_PROP_EXPERIMENTER = 787,
    OF_PORT_DESC_PROP_OPTICAL = 788,
    OF_PORT_MOD_PROP = 789,
    OF_PORT_MOD_PROP_ETHERNET = 790,
    OF_PORT_MOD_PROP_EXPERIMENTER = 791,
    OF_PORT_MOD_PROP_OPTICAL = 792,
    OF_PORT_STATS_ENTRY = 793,
    OF_PORT_STATS_PROP = 794,
    OF_PORT_STATS_PROP_ETHERNET = 795,
    OF_PORT_STATS_PROP_EXPERIMENTER = 796,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 797,
    OF_PORT_STATS_PROP_OPTICAL = 798,
    OF_QUEUE_DESC = 799,
    OF_QUEUE_DESC_PROP = 800,
    OF_QUEUE_DESC_PROP_BSN = 801,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 802,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 803,
    OF_QUEUE_DESC_PROP_MAX_RATE = 804,
    OF_QUEUE_DESC_PROP_MIN_RATE = 805,
    OF_QUEUE_PROP = 806,
    OF_QUEUE_PROP_EXPERIMENTER = 807,
    OF_QUEUE_PROP_MAX_RATE = 808,
    OF_QUEUE_PROP_MIN_RATE = 809,
    OF_QUEUE_STATS_ENTRY = 810,
    OF_QUEUE_STATS_PROP = 811,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 812,
    OF_ROLE_PROP = 813,
    OF_ROLE_PROP_EXPERIMENTER = 814,
    OF_TABLE_DESC = 815,
    OF_TABLE_FEATURE_PROP = 816,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 817,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 818,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 819,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 820,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 821,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 822,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 823,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 824,
    OF_TABLE_FEATURE_PROP_MATCH = 825,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 826,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 827,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 828,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 829,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 830,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 831,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 832,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 833,
    OF_TABLE_FEATURES = 834,
    OF_TABLE_MOD_PROP = 835,
    OF_TABLE_MOD_PROP_EVICTION = 836,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 837,
    OF_TABLE_MOD_PROP_VACANCY = 838,
    OF_TABLE_STATS_ENTRY = 839,
    OF_UINT32 = 840,
    OF_UINT64 = 841,
    OF_UINT8 = 842,
    ...
    /* List objects */
    OF_LIST_ACTION = 843,
    OF_LIST_ACTION_ID = 844,
    OF_LIST_ASYNC_CONFIG_PROP = 845,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 846,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 847,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 848,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 849,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 850,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 851,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 852,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 853,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 854,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 855,
    OF_LIST_BSN_INTERFACE = 856,
    OF_LIST_BSN_LACP_STATS_ENTRY = 857,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 858,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 859,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 860,
    OF_LIST_BSN_TLV = 861,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 862,
    OF_LIST_BSN_VLAN_MAC = 863,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 864,
    OF_LIST_BUCKET = 865,
    OF_LIST_BUCKET_COUNTER = 866,
    OF_LIST_BUNDLE_PROP = 867,
    OF_LIST_FLOW_STATS_ENTRY = 868,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 869,
    OF_LIST_GROUP_STATS_ENTRY = 870,
    OF_LIST_HELLO_ELEM = 871,
    OF_LIST_INSTRUCTION = 872,
    OF_LIST_INSTRUCTION_ID = 873,
    OF_LIST_METER_BAND = 874,
    OF_LIST_METER_BAND_STATS = 875,
    OF_LIST_METER_CONFIG = 876,
    OF_LIST_METER_STATS = 877,
    OF_LIST_OXM = 878,
    OF_LIST_PACKET_QUEUE = 879,
    OF_LIST_PORT_DESC = 880,
    OF_LIST_PORT_DESC_PROP = 881,
    OF_LIST_PORT_MOD_PROP = 882,
    OF_LIST_PORT_STATS_ENTRY = 883,
    OF_LIST_PORT_STATS_PROP = 884,
    OF_LIST_QUEUE_DESC = 885,
    OF_LIST_QUEUE_DESC_PROP = 886,
    OF_LIST_QUEUE_PROP = 887,
    OF_LIST_QUEUE_STATS_ENTRY = 888,
    OF_LIST_QUEUE_STATS_PROP = 889,
    OF_LIST_ROLE_PROP = 890,
    OF_LIST_TABLE_DESC = 891,
    OF_LIST_TABLE_FEATURE_PROP = 892,
    OF_LIST_TABLE_FEATURES = 893,
    OF_LIST_TABLE_MOD_PROP = 894,
    OF_LIST_TABLE_STATS_ENTRY = 895,
    OF_LIST_UINT32 = 896,
    OF_LIST_UINT64 = 897,
    OF_LIST_UINT8 = 898,
