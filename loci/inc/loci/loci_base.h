...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_NAME = 364,
    OF_BSN_TLV_NEGATE = 365,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 366,
    OF_BSN_TLV_NEXT_HOP_MAC = 367,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 368,
    OF_BSN_TLV_OFFSET = 369,
    OF_BSN_TLV_PARENT_PORT = 370,
    OF_BSN_TLV_PARTNER_KEY = 371,
    OF_BSN_TLV_PARTNER_PORT_NUM = 372,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 373,
    OF_BSN_TLV_PARTNER_STATE = 374,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 375,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 376,
    OF_BSN_TLV_PORT = 377,
    OF_BSN_TLV_PORT_VXLAN_MODE = 378,
    OF_BSN_TLV_PRIORITY = 379,
    OF_BSN_TLV_QOS_PRIORITY = 380,
    OF_BSN_TLV_QUEUE_ID = 381,
    OF_BSN_TLV_QUEUE_WEIGHT = 382,
    OF_BSN_TLV_RATE_LIMIT = 383,
    OF_BSN_TLV_RATE_UNIT = 384,
    OF_BSN_TLV_REFERENCE = 385,
    OF_BSN_TLV_REPLY_PACKETS = 386,
    OF_BSN_TLV_REQUEST_PACKETS = 387,
    OF_BSN_TLV_RX_BYTES = 388,
    OF_BSN_TLV_RX_PACKETS = 389,
    OF_BSN_TLV_SAMPLING_RATE = 390,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 391,
    OF_BSN_TLV_STATUS = 392,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 393,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 394,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 395,
    OF_BSN_TLV_SUB_AGENT_ID = 396,
    OF_BSN_TLV_TCP_DST = 397,
    OF_BSN_TLV_TCP_SRC = 398,
    OF_BSN_TLV_TTL = 399,
    OF_BSN_TLV_TX_BYTES = 400,
    OF_BSN_TLV_TX_PACKETS = 401,
    OF_BSN_TLV_UDF_ANCHOR = 402,
    OF_BSN_TLV_UDF_ID = 403,
    OF_BSN_TLV_UDF_LENGTH = 404,
    OF_BSN_TLV_UDF_OFFSET = 405,
    OF_BSN_TLV_UDP_DST = 406,
    OF_BSN_TLV_UDP_SRC = 407,
    OF_BSN_TLV_UINT64_LIST = 408,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 409,
    OF_BSN_TLV_UNICAST_RATE = 410,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 411,
    OF_BSN_TLV_UNTAGGED = 412,
    OF_BSN_TLV_USE_PACKET_STATE = 413,
    OF_BSN_TLV_VFI = 414,
    OF_BSN_TLV_VFP_CLASS_ID = 415,
    OF_BSN_TLV_VLAN_MAC_LIST = 416,
    OF_BSN_TLV_VLAN_PCP = 417,
    OF_BSN_TLV_VLAN_VID = 418,
    OF_BSN_TLV_VLAN_VID_MASK = 419,
    OF_BSN_TLV_VNI = 420,
    OF_BSN_TLV_VPN_KEY = 421,
    OF_BSN_TLV_VRF = 422,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 423,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 424,
    OF_BSN_VLAN_MAC = 425,
    OF_BSN_VPORT = 426,
    OF_BSN_VPORT_L2GRE = 427,
    OF_BSN_VPORT_Q_IN_Q = 428,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 429,
    OF_BUCKET = 430,
    OF_BUCKET_COUNTER = 431,
    OF_BUNDLE_PROP = 432,
    OF_BUNDLE_PROP_EXPERIMENTER = 433,
    OF_FLOW_STATS_ENTRY = 434,
    OF_GROUP_DESC_STATS_ENTRY = 435,
    OF_GROUP_STATS_ENTRY = 436,
    OF_HELLO_ELEM = 437,
    OF_HELLO_ELEM_VERSIONBITMAP = 438,
    OF_INSTRUCTION = 439,
    OF_INSTRUCTION_APPLY_ACTIONS = 440,
    OF_INSTRUCTION_BSN = 441,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 442,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 443,
    OF_INSTRUCTION_BSN_DENY = 444,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 445,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 446,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 447,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 448,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 449,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 450,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 451,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 452,
    OF_INSTRUCTION_BSN_PERMIT = 453,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 454,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 455,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 456,
    OF_INSTRUCTION_CLEAR_ACTIONS = 457,
    OF_INSTRUCTION_EXPERIMENTER = 458,
    OF_INSTRUCTION_GOTO_TABLE = 459,
    OF_INSTRUCTION_ID = 460,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 461,
    OF_INSTRUCTION_ID_BSN = 462,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 463,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 464,
    OF_INSTRUCTION_ID_BSN_DENY = 465,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 466,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 467,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 468,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 469,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 470,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 471,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 472,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 473,
    OF_INSTRUCTION_ID_BSN_PERMIT = 474,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 475,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 476,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 477,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 478,
    OF_INSTRUCTION_ID_EXPERIMENTER = 479,
    OF_INSTRUCTION_ID_GOTO_TABLE = 480,
    OF_INSTRUCTION_ID_METER = 481,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 482,
    OF_INSTRUCTION_ID_WRITE_METADATA = 483,
    OF_INSTRUCTION_METER = 484,
    OF_INSTRUCTION_WRITE_ACTIONS = 485,
    OF_INSTRUCTION_WRITE_METADATA = 486,
    OF_MATCH_V1 = 487,
    OF_MATCH_V2 = 488,
    OF_MATCH_V3 = 489,
    OF_METER_BAND = 490,
    OF_METER_BAND_DROP = 491,
    OF_METER_BAND_DSCP_REMARK = 492,
    OF_METER_BAND_EXPERIMENTER = 493,
    OF_METER_BAND_STATS = 494,
    OF_METER_CONFIG = 495,
    OF_METER_FEATURES = 496,
    OF_METER_STATS = 497,
    OF_OXM = 498,
    OF_OXM_ARP_OP = 499,
    OF_OXM_ARP_OP_MASKED = 500,
    OF_OXM_ARP_SHA = 501,
    OF_OXM_ARP_SHA_MASKED = 502,
    OF_OXM_ARP_SPA = 503,
    OF_OXM_ARP_SPA_MASKED = 504,
    OF_OXM_ARP_THA = 505,
    OF_OXM_ARP_THA_MASKED = 506,
    OF_OXM_ARP_TPA = 507,
    OF_OXM_ARP_TPA_MASKED = 508,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 509,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 510,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 511,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 512,
    OF_OXM_BSN_IN_PORTS_128 = 513,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 514,
    OF_OXM_BSN_IN_PORTS_512 = 515,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 516,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 517,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 518,
    OF_OXM_BSN_INNER_ETH_DST = 519,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 520,
    OF_OXM_BSN_INNER_ETH_SRC = 521,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 522,
    OF_OXM_BSN_INNER_VLAN_VID = 523,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 524,
    OF_OXM_BSN_L2_CACHE_HIT = 525,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 526,
    OF_OXM_BSN_L3_DST_CLASS_ID = 527,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 528,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 529,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 530,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 531,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 532,
    OF_OXM_BSN_LAG_ID = 533,
    OF_OXM_BSN_LAG_ID_MASKED = 534,
    OF_OXM_BSN_TCP_FLAGS = 535,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 536,
    OF_OXM_BSN_UDF0 = 537,
    OF_OXM_BSN_UDF0_MASKED = 538,
    OF_OXM_BSN_UDF1 = 539,
    OF_OXM_BSN_UDF1_MASKED = 540,
    OF_OXM_BSN_UDF2 = 541,
    OF_OXM_BSN_UDF2_MASKED = 542,
    OF_OXM_BSN_UDF3 = 543,
    OF_OXM_BSN_UDF3_MASKED = 544,
    OF_OXM_BSN_UDF4 = 545,
    OF_OXM_BSN_UDF4_MASKED = 546,
    OF_OXM_BSN_UDF5 = 547,
    OF_OXM_BSN_UDF5_MASKED = 548,
    OF_OXM_BSN_UDF6 = 549,
    OF_OXM_BSN_UDF6_MASKED = 550,
    OF_OXM_BSN_UDF7 = 551,
    OF_OXM_BSN_UDF7_MASKED = 552,
    OF_OXM_BSN_VFI = 553,
    OF_OXM_BSN_VFI_MASKED = 554,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 555,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 556,
    OF_OXM_BSN_VRF = 557,
    OF_OXM_BSN_VRF_MASKED = 558,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 559,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 560,
    OF_OXM_ETH_DST = 561,
    OF_OXM_ETH_DST_MASKED = 562,
    OF_OXM_ETH_SRC = 563,
    OF_OXM_ETH_SRC_MASKED = 564,
    OF_OXM_ETH_TYPE = 565,
    OF_OXM_ETH_TYPE_MASKED = 566,
    OF_OXM_ICMPV4_CODE = 567,
    OF_OXM_ICMPV4_CODE_MASKED = 568,
    OF_OXM_ICMPV4_TYPE = 569,
    OF_OXM_ICMPV4_TYPE_MASKED = 570,
    OF_OXM_ICMPV6_CODE = 571,
    OF_OXM_ICMPV6_CODE_MASKED = 572,
    OF_OXM_ICMPV6_TYPE = 573,
    OF_OXM_ICMPV6_TYPE_MASKED = 574,
    OF_OXM_IN_PHY_PORT = 575,
    OF_OXM_IN_PHY_PORT_MASKED = 576,
    OF_OXM_IN_PORT = 577,
    OF_OXM_IN_PORT_MASKED = 578,
    OF_OXM_IP_DSCP = 579,
    OF_OXM_IP_DSCP_MASKED = 580,
    OF_OXM_IP_ECN = 581,
    OF_OXM_IP_ECN_MASKED = 582,
    OF_OXM_IP_PROTO = 583,
    OF_OXM_IP_PROTO_MASKED = 584,
    OF_OXM_IPV4_DST = 585,
    OF_OXM_IPV4_DST_MASKED = 586,
    OF_OXM_IPV4_SRC = 587,
    OF_OXM_IPV4_SRC_MASKED = 588,
    OF_OXM_IPV6_DST = 589,
    OF_OXM_IPV6_DST_MASKED = 590,
    OF_OXM_IPV6_EXTHDR = 591,
    OF_OXM_IPV6_EXTHDR_MASKED = 592,
    OF_OXM_IPV6_FLABEL = 593,
    OF_OXM_IPV6_FLABEL_MASKED = 594,
    OF_OXM_IPV6_ND_SLL = 595,
    OF_OXM_IPV6_ND_SLL_MASKED = 596,
    OF_OXM_IPV6_ND_TARGET = 597,
    OF_OXM_IPV6_ND_TARGET_MASKED = 598,
    OF_OXM_IPV6_ND_TLL = 599,
    OF_OXM_IPV6_ND_TLL_MASKED = 600,
    OF_OXM_IPV6_SRC = 601,
    OF_OXM_IPV6_SRC_MASKED = 602,
    OF_OXM_METADATA = 603,
    OF_OXM_METADATA_MASKED = 604,
    OF_OXM_MPLS_BOS = 605,
    OF_OXM_MPLS_BOS_MASKED = 606,
    OF_OXM_MPLS_LABEL = 607,
    OF_OXM_MPLS_LABEL_MASKED = 608,
    OF_OXM_MPLS_TC = 609,
    OF_OXM_MPLS_TC_MASKED = 610,
    OF_OXM_PBB_UCA = 611,
    OF_OXM_PBB_UCA_MASKED = 612,
    OF_OXM_SCTP_DST = 613,
    OF_OXM_SCTP_DST_MASKED = 614,
    OF_OXM_SCTP_SRC = 615,
    OF_OXM_SCTP_SRC_MASKED = 616,
    OF_OXM_TCP_DST = 617,
    OF_OXM_TCP_DST_MASKED = 618,
    OF_OXM_TCP_SRC = 619,
    OF_OXM_TCP_SRC_MASKED = 620,
    OF_OXM_TUNNEL_ID = 621,
    OF_OXM_TUNNEL_ID_MASKED = 622,
    OF_OXM_TUNNEL_IPV4_DST = 623,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 624,
    OF_OXM_TUNNEL_IPV4_SRC = 625,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 626,
    OF_OXM_UDP_DST = 627,
    OF_OXM_UDP_DST_MASKED = 628,
    OF_OXM_UDP_SRC = 629,
    OF_OXM_UDP_SRC_MASKED = 630,
    OF_OXM_VLAN_PCP = 631,
    OF_OXM_VLAN_PCP_MASKED = 632,
    OF_OXM_VLAN_VID = 633,
    OF_OXM_VLAN_VID_MASKED = 634,
    OF_PACKET_QUEUE = 635,
    OF_PORT_DESC = 636,
    OF_PORT_DESC_PROP = 637,
    OF_PORT_DESC_PROP_BSN = 638,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 639,
    OF_PORT_DESC_PROP_BSN_UPLINK = 640,
    OF_PORT_DESC_PROP_ETHERNET = 641,
    OF_PORT_DESC_PROP_EXPERIMENTER = 642,
    OF_PORT_DESC_PROP_OPTICAL = 643,
    OF_PORT_MOD_PROP = 644,
    OF_PORT_MOD_PROP_ETHERNET = 645,
    OF_PORT_MOD_PROP_EXPERIMENTER = 646,
    OF_PORT_MOD_PROP_OPTICAL = 647,
    OF_PORT_STATS_ENTRY = 648,
    OF_PORT_STATS_PROP = 649,
    OF_PORT_STATS_PROP_ETHERNET = 650,
    OF_PORT_STATS_PROP_EXPERIMENTER = 651,
    OF_PORT_STATS_PROP_OPTICAL = 652,
    OF_QUEUE_DESC = 653,
    OF_QUEUE_DESC_PROP = 654,
    OF_QUEUE_DESC_PROP_BSN = 655,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 656,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 657,
    OF_QUEUE_DESC_PROP_MAX_RATE = 658,
    OF_QUEUE_DESC_PROP_MIN_RATE = 659,
    OF_QUEUE_PROP = 660,
    OF_QUEUE_PROP_EXPERIMENTER = 661,
    OF_QUEUE_PROP_MAX_RATE = 662,
    OF_QUEUE_PROP_MIN_RATE = 663,
    OF_QUEUE_STATS_ENTRY = 664,
    OF_QUEUE_STATS_PROP = 665,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 666,
    OF_ROLE_PROP = 667,
    OF_ROLE_PROP_EXPERIMENTER = 668,
    OF_TABLE_DESC = 669,
    OF_TABLE_FEATURE_PROP = 670,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 671,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 672,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 673,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 674,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 675,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 676,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 677,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 678,
    OF_TABLE_FEATURE_PROP_MATCH = 679,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 680,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 681,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 682,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 683,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 684,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 685,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 686,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 687,
    OF_TABLE_FEATURES = 688,
    OF_TABLE_MOD_PROP = 689,
    OF_TABLE_MOD_PROP_EVICTION = 690,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 691,
    OF_TABLE_MOD_PROP_VACANCY = 692,
    OF_TABLE_STATS_ENTRY = 693,
    OF_UINT32 = 694,
    OF_UINT64 = 695,
    OF_UINT8 = 696,
    ...
    /* List objects */
    OF_LIST_ACTION = 697,
    OF_LIST_ACTION_ID = 698,
    OF_LIST_ASYNC_CONFIG_PROP = 699,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 700,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 701,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 702,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 703,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 704,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 705,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 706,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 707,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 708,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 709,
    OF_LIST_BSN_INTERFACE = 710,
    OF_LIST_BSN_LACP_STATS_ENTRY = 711,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 712,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 713,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 714,
    OF_LIST_BSN_TLV = 715,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 716,
    OF_LIST_BSN_VLAN_MAC = 717,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 718,
    OF_LIST_BUCKET = 719,
    OF_LIST_BUCKET_COUNTER = 720,
    OF_LIST_BUNDLE_PROP = 721,
    OF_LIST_FLOW_STATS_ENTRY = 722,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 723,
    OF_LIST_GROUP_STATS_ENTRY = 724,
    OF_LIST_HELLO_ELEM = 725,
    OF_LIST_INSTRUCTION = 726,
    OF_LIST_INSTRUCTION_ID = 727,
    OF_LIST_METER_BAND = 728,
    OF_LIST_METER_BAND_STATS = 729,
    OF_LIST_METER_CONFIG = 730,
    OF_LIST_METER_STATS = 731,
    OF_LIST_OXM = 732,
    OF_LIST_PACKET_QUEUE = 733,
    OF_LIST_PORT_DESC = 734,
    OF_LIST_PORT_DESC_PROP = 735,
    OF_LIST_PORT_MOD_PROP = 736,
    OF_LIST_PORT_STATS_ENTRY = 737,
    OF_LIST_PORT_STATS_PROP = 738,
    OF_LIST_QUEUE_DESC = 739,
    OF_LIST_QUEUE_DESC_PROP = 740,
    OF_LIST_QUEUE_PROP = 741,
    OF_LIST_QUEUE_STATS_ENTRY = 742,
    OF_LIST_QUEUE_STATS_PROP = 743,
    OF_LIST_ROLE_PROP = 744,
    OF_LIST_TABLE_DESC = 745,
    OF_LIST_TABLE_FEATURE_PROP = 746,
    OF_LIST_TABLE_FEATURES = 747,
    OF_LIST_TABLE_MOD_PROP = 748,
    OF_LIST_TABLE_STATS_ENTRY = 749,
    OF_LIST_UINT32 = 750,
    OF_LIST_UINT64 = 751,
    OF_LIST_UINT8 = 752,
