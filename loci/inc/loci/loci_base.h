...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_CRC_ENABLED = 263,
    OF_BSN_TLV_ETH_DST = 264,
    OF_BSN_TLV_ETH_SRC = 265,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 266,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 267,
    OF_BSN_TLV_EXTERNAL_IP = 268,
    OF_BSN_TLV_EXTERNAL_MAC = 269,
    OF_BSN_TLV_EXTERNAL_NETMASK = 270,
    OF_BSN_TLV_HEADER = 271,
    OF_BSN_TLV_HEADER_SIZE = 272,
    OF_BSN_TLV_IDLE_NOTIFICATION = 273,
    OF_BSN_TLV_IDLE_TIME = 274,
    OF_BSN_TLV_IDLE_TIMEOUT = 275,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 276,
    OF_BSN_TLV_INTERNAL_MAC = 277,
    OF_BSN_TLV_IPV4 = 278,
    OF_BSN_TLV_IPV4_DST = 279,
    OF_BSN_TLV_IPV4_SRC = 280,
    OF_BSN_TLV_MAC = 281,
    OF_BSN_TLV_MISS_PACKETS = 282,
    OF_BSN_TLV_PORT = 283,
    OF_BSN_TLV_QUEUE_ID = 284,
    OF_BSN_TLV_QUEUE_WEIGHT = 285,
    OF_BSN_TLV_REPLY_PACKETS = 286,
    OF_BSN_TLV_REQUEST_PACKETS = 287,
    OF_BSN_TLV_RX_PACKETS = 288,
    OF_BSN_TLV_SAMPLING_RATE = 289,
    OF_BSN_TLV_SUB_AGENT_ID = 290,
    OF_BSN_TLV_TX_BYTES = 291,
    OF_BSN_TLV_TX_PACKETS = 292,
    OF_BSN_TLV_UDF_ANCHOR = 293,
    OF_BSN_TLV_UDF_ID = 294,
    OF_BSN_TLV_UDF_LENGTH = 295,
    OF_BSN_TLV_UDF_OFFSET = 296,
    OF_BSN_TLV_UDP_DST = 297,
    OF_BSN_TLV_UDP_SRC = 298,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 299,
    OF_BSN_TLV_VLAN_VID = 300,
    OF_BSN_TLV_VRF = 301,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 302,
    OF_BSN_VPORT = 303,
    OF_BSN_VPORT_HEADER = 304,
    OF_BSN_VPORT_L2GRE = 305,
    OF_BSN_VPORT_Q_IN_Q = 306,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 307,
    OF_BUCKET = 308,
    OF_BUCKET_COUNTER = 309,
    OF_FLOW_STATS_ENTRY = 310,
    OF_GROUP_DESC_STATS_ENTRY = 311,
    OF_GROUP_STATS_ENTRY = 312,
    OF_HELLO_ELEM = 313,
    OF_HELLO_ELEM_HEADER = 314,
    OF_HELLO_ELEM_VERSIONBITMAP = 315,
    OF_INSTRUCTION = 316,
    OF_INSTRUCTION_APPLY_ACTIONS = 317,
    OF_INSTRUCTION_BSN = 318,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 319,
    OF_INSTRUCTION_BSN_DENY = 320,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 321,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 322,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 323,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 324,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 325,
    OF_INSTRUCTION_BSN_PERMIT = 326,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 327,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 328,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 329,
    OF_INSTRUCTION_CLEAR_ACTIONS = 330,
    OF_INSTRUCTION_EXPERIMENTER = 331,
    OF_INSTRUCTION_GOTO_TABLE = 332,
    OF_INSTRUCTION_HEADER = 333,
    OF_INSTRUCTION_ID = 334,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 335,
    OF_INSTRUCTION_ID_BSN = 336,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 337,
    OF_INSTRUCTION_ID_BSN_DENY = 338,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 339,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 340,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 341,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 342,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 343,
    OF_INSTRUCTION_ID_BSN_PERMIT = 344,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 345,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 346,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 347,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 348,
    OF_INSTRUCTION_ID_EXPERIMENTER = 349,
    OF_INSTRUCTION_ID_GOTO_TABLE = 350,
    OF_INSTRUCTION_ID_HEADER = 351,
    OF_INSTRUCTION_ID_METER = 352,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 353,
    OF_INSTRUCTION_ID_WRITE_METADATA = 354,
    OF_INSTRUCTION_METER = 355,
    OF_INSTRUCTION_WRITE_ACTIONS = 356,
    OF_INSTRUCTION_WRITE_METADATA = 357,
    OF_MATCH_V1 = 358,
    OF_MATCH_V2 = 359,
    OF_MATCH_V3 = 360,
    OF_METER_BAND = 361,
    OF_METER_BAND_DROP = 362,
    OF_METER_BAND_DSCP_REMARK = 363,
    OF_METER_BAND_EXPERIMENTER = 364,
    OF_METER_BAND_HEADER = 365,
    OF_METER_BAND_STATS = 366,
    OF_METER_CONFIG = 367,
    OF_METER_FEATURES = 368,
    OF_METER_STATS = 369,
    OF_OXM = 370,
    OF_OXM_ARP_OP = 371,
    OF_OXM_ARP_OP_MASKED = 372,
    OF_OXM_ARP_SHA = 373,
    OF_OXM_ARP_SHA_MASKED = 374,
    OF_OXM_ARP_SPA = 375,
    OF_OXM_ARP_SPA_MASKED = 376,
    OF_OXM_ARP_THA = 377,
    OF_OXM_ARP_THA_MASKED = 378,
    OF_OXM_ARP_TPA = 379,
    OF_OXM_ARP_TPA_MASKED = 380,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 381,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 382,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 383,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 384,
    OF_OXM_BSN_IN_PORTS_128 = 385,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 386,
    OF_OXM_BSN_L3_DST_CLASS_ID = 387,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 388,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 389,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 390,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 391,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 392,
    OF_OXM_BSN_LAG_ID = 393,
    OF_OXM_BSN_LAG_ID_MASKED = 394,
    OF_OXM_BSN_TCP_FLAGS = 395,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 396,
    OF_OXM_BSN_UDF0 = 397,
    OF_OXM_BSN_UDF0_MASKED = 398,
    OF_OXM_BSN_UDF1 = 399,
    OF_OXM_BSN_UDF1_MASKED = 400,
    OF_OXM_BSN_UDF2 = 401,
    OF_OXM_BSN_UDF2_MASKED = 402,
    OF_OXM_BSN_UDF3 = 403,
    OF_OXM_BSN_UDF3_MASKED = 404,
    OF_OXM_BSN_UDF4 = 405,
    OF_OXM_BSN_UDF4_MASKED = 406,
    OF_OXM_BSN_UDF5 = 407,
    OF_OXM_BSN_UDF5_MASKED = 408,
    OF_OXM_BSN_UDF6 = 409,
    OF_OXM_BSN_UDF6_MASKED = 410,
    OF_OXM_BSN_UDF7 = 411,
    OF_OXM_BSN_UDF7_MASKED = 412,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 413,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 414,
    OF_OXM_BSN_VRF = 415,
    OF_OXM_BSN_VRF_MASKED = 416,
    OF_OXM_ETH_DST = 417,
    OF_OXM_ETH_DST_MASKED = 418,
    OF_OXM_ETH_SRC = 419,
    OF_OXM_ETH_SRC_MASKED = 420,
    OF_OXM_ETH_TYPE = 421,
    OF_OXM_ETH_TYPE_MASKED = 422,
    OF_OXM_HEADER = 423,
    OF_OXM_ICMPV4_CODE = 424,
    OF_OXM_ICMPV4_CODE_MASKED = 425,
    OF_OXM_ICMPV4_TYPE = 426,
    OF_OXM_ICMPV4_TYPE_MASKED = 427,
    OF_OXM_ICMPV6_CODE = 428,
    OF_OXM_ICMPV6_CODE_MASKED = 429,
    OF_OXM_ICMPV6_TYPE = 430,
    OF_OXM_ICMPV6_TYPE_MASKED = 431,
    OF_OXM_IN_PHY_PORT = 432,
    OF_OXM_IN_PHY_PORT_MASKED = 433,
    OF_OXM_IN_PORT = 434,
    OF_OXM_IN_PORT_MASKED = 435,
    OF_OXM_IP_DSCP = 436,
    OF_OXM_IP_DSCP_MASKED = 437,
    OF_OXM_IP_ECN = 438,
    OF_OXM_IP_ECN_MASKED = 439,
    OF_OXM_IP_PROTO = 440,
    OF_OXM_IP_PROTO_MASKED = 441,
    OF_OXM_IPV4_DST = 442,
    OF_OXM_IPV4_DST_MASKED = 443,
    OF_OXM_IPV4_SRC = 444,
    OF_OXM_IPV4_SRC_MASKED = 445,
    OF_OXM_IPV6_DST = 446,
    OF_OXM_IPV6_DST_MASKED = 447,
    OF_OXM_IPV6_FLABEL = 448,
    OF_OXM_IPV6_FLABEL_MASKED = 449,
    OF_OXM_IPV6_ND_SLL = 450,
    OF_OXM_IPV6_ND_SLL_MASKED = 451,
    OF_OXM_IPV6_ND_TARGET = 452,
    OF_OXM_IPV6_ND_TARGET_MASKED = 453,
    OF_OXM_IPV6_ND_TLL = 454,
    OF_OXM_IPV6_ND_TLL_MASKED = 455,
    OF_OXM_IPV6_SRC = 456,
    OF_OXM_IPV6_SRC_MASKED = 457,
    OF_OXM_METADATA = 458,
    OF_OXM_METADATA_MASKED = 459,
    OF_OXM_MPLS_BOS = 460,
    OF_OXM_MPLS_BOS_MASKED = 461,
    OF_OXM_MPLS_LABEL = 462,
    OF_OXM_MPLS_LABEL_MASKED = 463,
    OF_OXM_MPLS_TC = 464,
    OF_OXM_MPLS_TC_MASKED = 465,
    OF_OXM_SCTP_DST = 466,
    OF_OXM_SCTP_DST_MASKED = 467,
    OF_OXM_SCTP_SRC = 468,
    OF_OXM_SCTP_SRC_MASKED = 469,
    OF_OXM_TCP_DST = 470,
    OF_OXM_TCP_DST_MASKED = 471,
    OF_OXM_TCP_SRC = 472,
    OF_OXM_TCP_SRC_MASKED = 473,
    OF_OXM_TUNNEL_ID = 474,
    OF_OXM_TUNNEL_ID_MASKED = 475,
    OF_OXM_UDP_DST = 476,
    OF_OXM_UDP_DST_MASKED = 477,
    OF_OXM_UDP_SRC = 478,
    OF_OXM_UDP_SRC_MASKED = 479,
    OF_OXM_VLAN_PCP = 480,
    OF_OXM_VLAN_PCP_MASKED = 481,
    OF_OXM_VLAN_VID = 482,
    OF_OXM_VLAN_VID_MASKED = 483,
    OF_PACKET_QUEUE = 484,
    OF_PORT_DESC = 485,
    OF_PORT_STATS_ENTRY = 486,
    OF_QUEUE_PROP = 487,
    OF_QUEUE_PROP_EXPERIMENTER = 488,
    OF_QUEUE_PROP_HEADER = 489,
    OF_QUEUE_PROP_MAX_RATE = 490,
    OF_QUEUE_PROP_MIN_RATE = 491,
    OF_QUEUE_STATS_ENTRY = 492,
    OF_TABLE_FEATURE_PROP = 493,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 494,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 495,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 496,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 497,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 498,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 499,
    OF_TABLE_FEATURE_PROP_HEADER = 500,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 501,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 502,
    OF_TABLE_FEATURE_PROP_MATCH = 503,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 504,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 505,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 506,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 507,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 508,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 509,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 510,
    OF_TABLE_FEATURES = 511,
    OF_TABLE_STATS_ENTRY = 512,
    OF_UINT32 = 513,
    OF_UINT64 = 514,
    OF_UINT8 = 515,
    ...
    /* List objects */
    OF_LIST_ACTION = 516,
    OF_LIST_ACTION_ID = 517,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 518,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 519,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 520,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 521,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 522,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 523,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 524,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 525,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 526,
    OF_LIST_BSN_INTERFACE = 527,
    OF_LIST_BSN_LACP_STATS_ENTRY = 528,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 529,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 530,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 531,
    OF_LIST_BSN_TLV = 532,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 533,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 534,
    OF_LIST_BUCKET = 535,
    OF_LIST_BUCKET_COUNTER = 536,
    OF_LIST_FLOW_STATS_ENTRY = 537,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 538,
    OF_LIST_GROUP_STATS_ENTRY = 539,
    OF_LIST_HELLO_ELEM = 540,
    OF_LIST_INSTRUCTION = 541,
    OF_LIST_INSTRUCTION_ID = 542,
    OF_LIST_METER_BAND = 543,
    OF_LIST_METER_BAND_STATS = 544,
    OF_LIST_METER_STATS = 545,
    OF_LIST_OXM = 546,
    OF_LIST_PACKET_QUEUE = 547,
    OF_LIST_PORT_DESC = 548,
    OF_LIST_PORT_STATS_ENTRY = 549,
    OF_LIST_QUEUE_PROP = 550,
    OF_LIST_QUEUE_STATS_ENTRY = 551,
    OF_LIST_TABLE_FEATURE_PROP = 552,
    OF_LIST_TABLE_FEATURES = 553,
    OF_LIST_TABLE_STATS_ENTRY = 554,
    OF_LIST_UINT32 = 555,
    OF_LIST_UINT64 = 556,
    OF_LIST_UINT8 = 557,
