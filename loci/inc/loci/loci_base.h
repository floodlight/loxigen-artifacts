...
typedef enum of_object_id_e {
    ...
    OF_LIST_METER_STATS = 680,
    OF_LIST_OXM = 681,
    OF_LIST_PACKET_QUEUE = 682,
    OF_LIST_PORT_DESC = 683,
    OF_LIST_PORT_DESC_PROP = 684,
    OF_LIST_PORT_MOD_PROP = 685,
    OF_LIST_PORT_STATS_ENTRY = 686,
    OF_LIST_PORT_STATS_PROP = 687,
    OF_LIST_QUEUE_DESC = 688,
    OF_LIST_QUEUE_DESC_PROP = 689,
    OF_LIST_QUEUE_PROP = 690,
    OF_LIST_QUEUE_STATS_ENTRY = 691,
    OF_LIST_QUEUE_STATS_PROP = 692,
    OF_LIST_ROLE_PROP = 693,
    OF_LIST_TABLE_DESC = 694,
    OF_LIST_TABLE_FEATURE_PROP = 695,
    OF_LIST_TABLE_FEATURES = 696,
    OF_LIST_TABLE_MOD_PROP = 697,
    OF_LIST_TABLE_STATS_ENTRY = 698,
    OF_LIST_UINT32 = 699,
    OF_LIST_UINT64 = 700,
    OF_LIST_UINT8 = 701,
