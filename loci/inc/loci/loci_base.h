...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_IPV6 = 351,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 352,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 353,
    OF_BSN_TLV_LOOPBACK_PORT = 354,
    OF_BSN_TLV_MAC = 355,
    OF_BSN_TLV_MAC_MASK = 356,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 357,
    OF_BSN_TLV_MISS_PACKETS = 358,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 359,
    OF_BSN_TLV_MPLS_LABEL = 360,
    OF_BSN_TLV_MPLS_SEQUENCED = 361,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 362,
    OF_BSN_TLV_NAME = 363,
    OF_BSN_TLV_NEGATE = 364,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 365,
    OF_BSN_TLV_NEXT_HOP_MAC = 366,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 367,
    OF_BSN_TLV_OFFSET = 368,
    OF_BSN_TLV_PARENT_PORT = 369,
    OF_BSN_TLV_PARTNER_KEY = 370,
    OF_BSN_TLV_PARTNER_PORT_NUM = 371,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 372,
    OF_BSN_TLV_PARTNER_STATE = 373,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 374,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 375,
    OF_BSN_TLV_PORT = 376,
    OF_BSN_TLV_PORT_VXLAN_MODE = 377,
    OF_BSN_TLV_PRIORITY = 378,
    OF_BSN_TLV_QOS_PRIORITY = 379,
    OF_BSN_TLV_QUEUE_ID = 380,
    OF_BSN_TLV_QUEUE_WEIGHT = 381,
    OF_BSN_TLV_RATE_LIMIT = 382,
    OF_BSN_TLV_RATE_UNIT = 383,
    OF_BSN_TLV_REFERENCE = 384,
    OF_BSN_TLV_REPLY_PACKETS = 385,
    OF_BSN_TLV_REQUEST_PACKETS = 386,
    OF_BSN_TLV_RX_BYTES = 387,
    OF_BSN_TLV_RX_PACKETS = 388,
    OF_BSN_TLV_SAMPLING_RATE = 389,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 390,
    OF_BSN_TLV_STATUS = 391,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 392,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 393,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 394,
    OF_BSN_TLV_SUB_AGENT_ID = 395,
    OF_BSN_TLV_TCP_DST = 396,
    OF_BSN_TLV_TCP_SRC = 397,
    OF_BSN_TLV_TTL = 398,
    OF_BSN_TLV_TX_BYTES = 399,
    OF_BSN_TLV_TX_PACKETS = 400,
    OF_BSN_TLV_UDF_ANCHOR = 401,
    OF_BSN_TLV_UDF_ID = 402,
    OF_BSN_TLV_UDF_LENGTH = 403,
    OF_BSN_TLV_UDF_OFFSET = 404,
    OF_BSN_TLV_UDP_DST = 405,
    OF_BSN_TLV_UDP_SRC = 406,
    OF_BSN_TLV_UINT64_LIST = 407,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 408,
    OF_BSN_TLV_UNICAST_RATE = 409,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 410,
    OF_BSN_TLV_UNTAGGED = 411,
    OF_BSN_TLV_USE_PACKET_STATE = 412,
    OF_BSN_TLV_VFI = 413,
    OF_BSN_TLV_VFP_CLASS_ID = 414,
    OF_BSN_TLV_VLAN_MAC_LIST = 415,
    OF_BSN_TLV_VLAN_PCP = 416,
    OF_BSN_TLV_VLAN_VID = 417,
    OF_BSN_TLV_VLAN_VID_MASK = 418,
    OF_BSN_TLV_VNI = 419,
    OF_BSN_TLV_VPN_KEY = 420,
    OF_BSN_TLV_VRF = 421,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 422,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 423,
    OF_BSN_VLAN_MAC = 424,
    OF_BSN_VPORT = 425,
    OF_BSN_VPORT_L2GRE = 426,
    OF_BSN_VPORT_Q_IN_Q = 427,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 428,
    OF_BUCKET = 429,
    OF_BUCKET_COUNTER = 430,
    OF_BUNDLE_PROP = 431,
    OF_BUNDLE_PROP_EXPERIMENTER = 432,
    OF_FLOW_STATS_ENTRY = 433,
    OF_GROUP_DESC_STATS_ENTRY = 434,
    OF_GROUP_STATS_ENTRY = 435,
    OF_HELLO_ELEM = 436,
    OF_HELLO_ELEM_VERSIONBITMAP = 437,
    OF_INSTRUCTION = 438,
    OF_INSTRUCTION_APPLY_ACTIONS = 439,
    OF_INSTRUCTION_BSN = 440,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 441,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 442,
    OF_INSTRUCTION_BSN_DENY = 443,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 444,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 445,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 446,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 447,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 448,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 449,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 450,
    OF_INSTRUCTION_BSN_PERMIT = 451,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 452,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 453,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 454,
    OF_INSTRUCTION_CLEAR_ACTIONS = 455,
    OF_INSTRUCTION_EXPERIMENTER = 456,
    OF_INSTRUCTION_GOTO_TABLE = 457,
    OF_INSTRUCTION_ID = 458,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 459,
    OF_INSTRUCTION_ID_BSN = 460,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 461,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 462,
    OF_INSTRUCTION_ID_BSN_DENY = 463,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 464,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 465,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 466,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 467,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 468,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 469,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 470,
    OF_INSTRUCTION_ID_BSN_PERMIT = 471,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 472,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 473,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 474,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 475,
    OF_INSTRUCTION_ID_EXPERIMENTER = 476,
    OF_INSTRUCTION_ID_GOTO_TABLE = 477,
    OF_INSTRUCTION_ID_METER = 478,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 479,
    OF_INSTRUCTION_ID_WRITE_METADATA = 480,
    OF_INSTRUCTION_METER = 481,
    OF_INSTRUCTION_WRITE_ACTIONS = 482,
    OF_INSTRUCTION_WRITE_METADATA = 483,
    OF_MATCH_V1 = 484,
    OF_MATCH_V2 = 485,
    OF_MATCH_V3 = 486,
    OF_METER_BAND = 487,
    OF_METER_BAND_DROP = 488,
    OF_METER_BAND_DSCP_REMARK = 489,
    OF_METER_BAND_EXPERIMENTER = 490,
    OF_METER_BAND_STATS = 491,
    OF_METER_CONFIG = 492,
    OF_METER_FEATURES = 493,
    OF_METER_STATS = 494,
    OF_OXM = 495,
    OF_OXM_ARP_OP = 496,
    OF_OXM_ARP_OP_MASKED = 497,
    OF_OXM_ARP_SHA = 498,
    OF_OXM_ARP_SHA_MASKED = 499,
    OF_OXM_ARP_SPA = 500,
    OF_OXM_ARP_SPA_MASKED = 501,
    OF_OXM_ARP_THA = 502,
    OF_OXM_ARP_THA_MASKED = 503,
    OF_OXM_ARP_TPA = 504,
    OF_OXM_ARP_TPA_MASKED = 505,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 506,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 507,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 508,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 509,
    OF_OXM_BSN_IN_PORTS_128 = 510,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 511,
    OF_OXM_BSN_IN_PORTS_512 = 512,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 513,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 514,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 515,
    OF_OXM_BSN_INNER_ETH_DST = 516,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 517,
    OF_OXM_BSN_INNER_ETH_SRC = 518,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 519,
    OF_OXM_BSN_INNER_VLAN_VID = 520,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 521,
    OF_OXM_BSN_L2_CACHE_HIT = 522,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 523,
    OF_OXM_BSN_L3_DST_CLASS_ID = 524,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 525,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 526,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 527,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 528,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 529,
    OF_OXM_BSN_LAG_ID = 530,
    OF_OXM_BSN_LAG_ID_MASKED = 531,
    OF_OXM_BSN_TCP_FLAGS = 532,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 533,
    OF_OXM_BSN_UDF0 = 534,
    OF_OXM_BSN_UDF0_MASKED = 535,
    OF_OXM_BSN_UDF1 = 536,
    OF_OXM_BSN_UDF1_MASKED = 537,
    OF_OXM_BSN_UDF2 = 538,
    OF_OXM_BSN_UDF2_MASKED = 539,
    OF_OXM_BSN_UDF3 = 540,
    OF_OXM_BSN_UDF3_MASKED = 541,
    OF_OXM_BSN_UDF4 = 542,
    OF_OXM_BSN_UDF4_MASKED = 543,
    OF_OXM_BSN_UDF5 = 544,
    OF_OXM_BSN_UDF5_MASKED = 545,
    OF_OXM_BSN_UDF6 = 546,
    OF_OXM_BSN_UDF6_MASKED = 547,
    OF_OXM_BSN_UDF7 = 548,
    OF_OXM_BSN_UDF7_MASKED = 549,
    OF_OXM_BSN_VFI = 550,
    OF_OXM_BSN_VFI_MASKED = 551,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 552,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 553,
    OF_OXM_BSN_VRF = 554,
    OF_OXM_BSN_VRF_MASKED = 555,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 556,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 557,
    OF_OXM_ETH_DST = 558,
    OF_OXM_ETH_DST_MASKED = 559,
    OF_OXM_ETH_SRC = 560,
    OF_OXM_ETH_SRC_MASKED = 561,
    OF_OXM_ETH_TYPE = 562,
    OF_OXM_ETH_TYPE_MASKED = 563,
    OF_OXM_ICMPV4_CODE = 564,
    OF_OXM_ICMPV4_CODE_MASKED = 565,
    OF_OXM_ICMPV4_TYPE = 566,
    OF_OXM_ICMPV4_TYPE_MASKED = 567,
    OF_OXM_ICMPV6_CODE = 568,
    OF_OXM_ICMPV6_CODE_MASKED = 569,
    OF_OXM_ICMPV6_TYPE = 570,
    OF_OXM_ICMPV6_TYPE_MASKED = 571,
    OF_OXM_IN_PHY_PORT = 572,
    OF_OXM_IN_PHY_PORT_MASKED = 573,
    OF_OXM_IN_PORT = 574,
    OF_OXM_IN_PORT_MASKED = 575,
    OF_OXM_IP_DSCP = 576,
    OF_OXM_IP_DSCP_MASKED = 577,
    OF_OXM_IP_ECN = 578,
    OF_OXM_IP_ECN_MASKED = 579,
    OF_OXM_IP_PROTO = 580,
    OF_OXM_IP_PROTO_MASKED = 581,
    OF_OXM_IPV4_DST = 582,
    OF_OXM_IPV4_DST_MASKED = 583,
    OF_OXM_IPV4_SRC = 584,
    OF_OXM_IPV4_SRC_MASKED = 585,
    OF_OXM_IPV6_DST = 586,
    OF_OXM_IPV6_DST_MASKED = 587,
    OF_OXM_IPV6_EXTHDR = 588,
    OF_OXM_IPV6_EXTHDR_MASKED = 589,
    OF_OXM_IPV6_FLABEL = 590,
    OF_OXM_IPV6_FLABEL_MASKED = 591,
    OF_OXM_IPV6_ND_SLL = 592,
    OF_OXM_IPV6_ND_SLL_MASKED = 593,
    OF_OXM_IPV6_ND_TARGET = 594,
    OF_OXM_IPV6_ND_TARGET_MASKED = 595,
    OF_OXM_IPV6_ND_TLL = 596,
    OF_OXM_IPV6_ND_TLL_MASKED = 597,
    OF_OXM_IPV6_SRC = 598,
    OF_OXM_IPV6_SRC_MASKED = 599,
    OF_OXM_METADATA = 600,
    OF_OXM_METADATA_MASKED = 601,
    OF_OXM_MPLS_BOS = 602,
    OF_OXM_MPLS_BOS_MASKED = 603,
    OF_OXM_MPLS_LABEL = 604,
    OF_OXM_MPLS_LABEL_MASKED = 605,
    OF_OXM_MPLS_TC = 606,
    OF_OXM_MPLS_TC_MASKED = 607,
    OF_OXM_PBB_UCA = 608,
    OF_OXM_PBB_UCA_MASKED = 609,
    OF_OXM_SCTP_DST = 610,
    OF_OXM_SCTP_DST_MASKED = 611,
    OF_OXM_SCTP_SRC = 612,
    OF_OXM_SCTP_SRC_MASKED = 613,
    OF_OXM_TCP_DST = 614,
    OF_OXM_TCP_DST_MASKED = 615,
    OF_OXM_TCP_SRC = 616,
    OF_OXM_TCP_SRC_MASKED = 617,
    OF_OXM_TUNNEL_ID = 618,
    OF_OXM_TUNNEL_ID_MASKED = 619,
    OF_OXM_TUNNEL_IPV4_DST = 620,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 621,
    OF_OXM_TUNNEL_IPV4_SRC = 622,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 623,
    OF_OXM_UDP_DST = 624,
    OF_OXM_UDP_DST_MASKED = 625,
    OF_OXM_UDP_SRC = 626,
    OF_OXM_UDP_SRC_MASKED = 627,
    OF_OXM_VLAN_PCP = 628,
    OF_OXM_VLAN_PCP_MASKED = 629,
    OF_OXM_VLAN_VID = 630,
    OF_OXM_VLAN_VID_MASKED = 631,
    OF_PACKET_QUEUE = 632,
    OF_PORT_DESC = 633,
    OF_PORT_DESC_PROP = 634,
    OF_PORT_DESC_PROP_BSN = 635,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 636,
    OF_PORT_DESC_PROP_BSN_UPLINK = 637,
    OF_PORT_DESC_PROP_ETHERNET = 638,
    OF_PORT_DESC_PROP_EXPERIMENTER = 639,
    OF_PORT_DESC_PROP_OPTICAL = 640,
    OF_PORT_MOD_PROP = 641,
    OF_PORT_MOD_PROP_ETHERNET = 642,
    OF_PORT_MOD_PROP_EXPERIMENTER = 643,
    OF_PORT_MOD_PROP_OPTICAL = 644,
    OF_PORT_STATS_ENTRY = 645,
    OF_PORT_STATS_PROP = 646,
    OF_PORT_STATS_PROP_ETHERNET = 647,
    OF_PORT_STATS_PROP_EXPERIMENTER = 648,
    OF_PORT_STATS_PROP_OPTICAL = 649,
    OF_QUEUE_DESC = 650,
    OF_QUEUE_DESC_PROP = 651,
    OF_QUEUE_DESC_PROP_BSN = 652,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 653,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 654,
    OF_QUEUE_DESC_PROP_MAX_RATE = 655,
    OF_QUEUE_DESC_PROP_MIN_RATE = 656,
    OF_QUEUE_PROP = 657,
    OF_QUEUE_PROP_EXPERIMENTER = 658,
    OF_QUEUE_PROP_MAX_RATE = 659,
    OF_QUEUE_PROP_MIN_RATE = 660,
    OF_QUEUE_STATS_ENTRY = 661,
    OF_QUEUE_STATS_PROP = 662,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 663,
    OF_ROLE_PROP = 664,
    OF_ROLE_PROP_EXPERIMENTER = 665,
    OF_TABLE_DESC = 666,
    OF_TABLE_FEATURE_PROP = 667,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 668,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 669,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 670,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 671,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 672,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 673,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 674,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 675,
    OF_TABLE_FEATURE_PROP_MATCH = 676,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 677,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 678,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 679,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 680,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 681,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 682,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 683,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 684,
    OF_TABLE_FEATURES = 685,
    OF_TABLE_MOD_PROP = 686,
    OF_TABLE_MOD_PROP_EVICTION = 687,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 688,
    OF_TABLE_MOD_PROP_VACANCY = 689,
    OF_TABLE_STATS_ENTRY = 690,
    OF_UINT32 = 691,
    OF_UINT64 = 692,
    OF_UINT8 = 693,
    ...
    /* List objects */
    OF_LIST_ACTION = 694,
    OF_LIST_ACTION_ID = 695,
    OF_LIST_ASYNC_CONFIG_PROP = 696,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 697,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 698,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 699,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 700,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 701,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 702,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 703,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 704,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 705,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 706,
    OF_LIST_BSN_INTERFACE = 707,
    OF_LIST_BSN_LACP_STATS_ENTRY = 708,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 709,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 710,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 711,
    OF_LIST_BSN_TLV = 712,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 713,
    OF_LIST_BSN_VLAN_MAC = 714,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 715,
    OF_LIST_BUCKET = 716,
    OF_LIST_BUCKET_COUNTER = 717,
    OF_LIST_BUNDLE_PROP = 718,
    OF_LIST_FLOW_STATS_ENTRY = 719,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 720,
    OF_LIST_GROUP_STATS_ENTRY = 721,
    OF_LIST_HELLO_ELEM = 722,
    OF_LIST_INSTRUCTION = 723,
    OF_LIST_INSTRUCTION_ID = 724,
    OF_LIST_METER_BAND = 725,
    OF_LIST_METER_BAND_STATS = 726,
    OF_LIST_METER_CONFIG = 727,
    OF_LIST_METER_STATS = 728,
    OF_LIST_OXM = 729,
    OF_LIST_PACKET_QUEUE = 730,
    OF_LIST_PORT_DESC = 731,
    OF_LIST_PORT_DESC_PROP = 732,
    OF_LIST_PORT_MOD_PROP = 733,
    OF_LIST_PORT_STATS_ENTRY = 734,
    OF_LIST_PORT_STATS_PROP = 735,
    OF_LIST_QUEUE_DESC = 736,
    OF_LIST_QUEUE_DESC_PROP = 737,
    OF_LIST_QUEUE_PROP = 738,
    OF_LIST_QUEUE_STATS_ENTRY = 739,
    OF_LIST_QUEUE_STATS_PROP = 740,
    OF_LIST_ROLE_PROP = 741,
    OF_LIST_TABLE_DESC = 742,
    OF_LIST_TABLE_FEATURE_PROP = 743,
    OF_LIST_TABLE_FEATURES = 744,
    OF_LIST_TABLE_MOD_PROP = 745,
    OF_LIST_TABLE_STATS_ENTRY = 746,
    OF_LIST_UINT32 = 747,
    OF_LIST_UINT64 = 748,
    OF_LIST_UINT8 = 749,
