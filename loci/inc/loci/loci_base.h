...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_MAC = 316,
    OF_BSN_TLV_MAC_MASK = 317,
    OF_BSN_TLV_MISS_PACKETS = 318,
    OF_BSN_TLV_NAME = 319,
    OF_BSN_TLV_PARTNER_KEY = 320,
    OF_BSN_TLV_PARTNER_PORT_NUM = 321,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 322,
    OF_BSN_TLV_PARTNER_STATE = 323,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 324,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 325,
    OF_BSN_TLV_PORT = 326,
    OF_BSN_TLV_PRIORITY = 327,
    OF_BSN_TLV_QUEUE_ID = 328,
    OF_BSN_TLV_QUEUE_WEIGHT = 329,
    OF_BSN_TLV_REPLY_PACKETS = 330,
    OF_BSN_TLV_REQUEST_PACKETS = 331,
    OF_BSN_TLV_RX_PACKETS = 332,
    OF_BSN_TLV_SAMPLING_RATE = 333,
    OF_BSN_TLV_SUB_AGENT_ID = 334,
    OF_BSN_TLV_TX_BYTES = 335,
    OF_BSN_TLV_TX_PACKETS = 336,
    OF_BSN_TLV_UDF_ANCHOR = 337,
    OF_BSN_TLV_UDF_ID = 338,
    OF_BSN_TLV_UDF_LENGTH = 339,
    OF_BSN_TLV_UDF_OFFSET = 340,
    OF_BSN_TLV_UDP_DST = 341,
    OF_BSN_TLV_UDP_SRC = 342,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 343,
    OF_BSN_TLV_VLAN_VID = 344,
    OF_BSN_TLV_VRF = 345,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 346,
    OF_BSN_VPORT = 347,
    OF_BSN_VPORT_L2GRE = 348,
    OF_BSN_VPORT_Q_IN_Q = 349,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 350,
    OF_BUCKET = 351,
    OF_BUCKET_COUNTER = 352,
    OF_BUNDLE_PROP = 353,
    OF_BUNDLE_PROP_EXPERIMENTER = 354,
    ...
    OF_INSTRUCTION_ID = 377,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 378,
    OF_INSTRUCTION_ID_BSN = 379,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 380,
    OF_INSTRUCTION_ID_BSN_DENY = 381,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 382,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 383,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 384,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 385,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 386,
    OF_INSTRUCTION_ID_BSN_PERMIT = 387,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 388,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 389,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 390,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 391,
    OF_INSTRUCTION_ID_EXPERIMENTER = 392,
    OF_INSTRUCTION_ID_GOTO_TABLE = 393,
    OF_INSTRUCTION_ID_METER = 394,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 395,
    OF_INSTRUCTION_ID_WRITE_METADATA = 396,
    OF_INSTRUCTION_METER = 397,
    OF_INSTRUCTION_WRITE_ACTIONS = 398,
    OF_INSTRUCTION_WRITE_METADATA = 399,
    OF_MATCH_V1 = 400,
    OF_MATCH_V2 = 401,
    OF_MATCH_V3 = 402,
    OF_METER_BAND = 403,
    OF_METER_BAND_DROP = 404,
    OF_METER_BAND_DSCP_REMARK = 405,
    OF_METER_BAND_EXPERIMENTER = 406,
    OF_METER_BAND_STATS = 407,
    OF_METER_CONFIG = 408,
    OF_METER_FEATURES = 409,
    OF_METER_STATS = 410,
    OF_OXM = 411,
    OF_OXM_ARP_OP = 412,
    OF_OXM_ARP_OP_MASKED = 413,
    OF_OXM_ARP_SHA = 414,
    OF_OXM_ARP_SHA_MASKED = 415,
    OF_OXM_ARP_SPA = 416,
    OF_OXM_ARP_SPA_MASKED = 417,
    OF_OXM_ARP_THA = 418,
    OF_OXM_ARP_THA_MASKED = 419,
    OF_OXM_ARP_TPA = 420,
    OF_OXM_ARP_TPA_MASKED = 421,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 422,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 423,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 424,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 425,
    OF_OXM_BSN_IN_PORTS_128 = 426,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 427,
    OF_OXM_BSN_L2_CACHE_HIT = 428,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 429,
    OF_OXM_BSN_L3_DST_CLASS_ID = 430,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 431,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 432,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 433,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 434,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 435,
    OF_OXM_BSN_LAG_ID = 436,
    OF_OXM_BSN_LAG_ID_MASKED = 437,
    OF_OXM_BSN_TCP_FLAGS = 438,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 439,
    OF_OXM_BSN_UDF0 = 440,
    OF_OXM_BSN_UDF0_MASKED = 441,
    OF_OXM_BSN_UDF1 = 442,
    OF_OXM_BSN_UDF1_MASKED = 443,
    OF_OXM_BSN_UDF2 = 444,
    OF_OXM_BSN_UDF2_MASKED = 445,
    OF_OXM_BSN_UDF3 = 446,
    OF_OXM_BSN_UDF3_MASKED = 447,
    OF_OXM_BSN_UDF4 = 448,
    OF_OXM_BSN_UDF4_MASKED = 449,
    OF_OXM_BSN_UDF5 = 450,
    OF_OXM_BSN_UDF5_MASKED = 451,
    OF_OXM_BSN_UDF6 = 452,
    OF_OXM_BSN_UDF6_MASKED = 453,
    OF_OXM_BSN_UDF7 = 454,
    OF_OXM_BSN_UDF7_MASKED = 455,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 456,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 457,
    OF_OXM_BSN_VRF = 458,
    ...
    OF_OXM_ICMPV4_CODE = 466,
    OF_OXM_ICMPV4_CODE_MASKED = 467,
    OF_OXM_ICMPV4_TYPE = 468,
    OF_OXM_ICMPV4_TYPE_MASKED = 469,
    OF_OXM_ICMPV6_CODE = 470,
    OF_OXM_ICMPV6_CODE_MASKED = 471,
    OF_OXM_ICMPV6_TYPE = 472,
    OF_OXM_ICMPV6_TYPE_MASKED = 473,
    OF_OXM_IN_PHY_PORT = 474,
    OF_OXM_IN_PHY_PORT_MASKED = 475,
    OF_OXM_IN_PORT = 476,
    OF_OXM_IN_PORT_MASKED = 477,
    OF_OXM_IP_DSCP = 478,
    OF_OXM_IP_DSCP_MASKED = 479,
    OF_OXM_IP_ECN = 480,
    OF_OXM_IP_ECN_MASKED = 481,
    OF_OXM_IP_PROTO = 482,
    OF_OXM_IP_PROTO_MASKED = 483,
    OF_OXM_IPV4_DST = 484,
    OF_OXM_IPV4_DST_MASKED = 485,
    OF_OXM_IPV4_SRC = 486,
    OF_OXM_IPV4_SRC_MASKED = 487,
    OF_OXM_IPV6_DST = 488,
    OF_OXM_IPV6_DST_MASKED = 489,
    OF_OXM_IPV6_EXTHDR = 490,
    OF_OXM_IPV6_EXTHDR_MASKED = 491,
    ...
    OF_OXM_PBB_UCA = 510,
    OF_OXM_PBB_UCA_MASKED = 511,
    OF_OXM_SCTP_DST = 512,
    OF_OXM_SCTP_DST_MASKED = 513,
    OF_OXM_SCTP_SRC = 514,
    OF_OXM_SCTP_SRC_MASKED = 515,
    OF_OXM_TCP_DST = 516,
    OF_OXM_TCP_DST_MASKED = 517,
    OF_OXM_TCP_SRC = 518,
    OF_OXM_TCP_SRC_MASKED = 519,
    OF_OXM_TUNNEL_ID = 520,
    OF_OXM_TUNNEL_ID_MASKED = 521,
    OF_OXM_UDP_DST = 522,
    OF_OXM_UDP_DST_MASKED = 523,
    OF_OXM_UDP_SRC = 524,
    OF_OXM_UDP_SRC_MASKED = 525,
    OF_OXM_VLAN_PCP = 526,
    OF_OXM_VLAN_PCP_MASKED = 527,
    OF_OXM_VLAN_VID = 528,
    OF_OXM_VLAN_VID_MASKED = 529,
    OF_PACKET_QUEUE = 530,
    OF_PORT_DESC = 531,
    OF_PORT_DESC_PROP = 532,
    OF_PORT_DESC_PROP_ETHERNET = 533,
    OF_PORT_DESC_PROP_EXPERIMENTER = 534,
    ...
    OF_PORT_STATS_PROP_OPTICAL = 544,
    OF_QUEUE_DESC = 545,
    OF_QUEUE_DESC_PROP = 546,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 547,
    OF_QUEUE_DESC_PROP_MAX_RATE = 548,
    OF_QUEUE_DESC_PROP_MIN_RATE = 549,
    OF_QUEUE_PROP = 550,
    OF_QUEUE_PROP_EXPERIMENTER = 551,
    OF_QUEUE_PROP_MAX_RATE = 552,
    OF_QUEUE_PROP_MIN_RATE = 553,
    OF_QUEUE_STATS_ENTRY = 554,
    OF_QUEUE_STATS_PROP = 555,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 556,
    OF_ROLE_PROP = 557,
    OF_ROLE_PROP_EXPERIMENTER = 558,
    OF_TABLE_DESC = 559,
    ...
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 567,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 568,
    OF_TABLE_FEATURE_PROP_MATCH = 569,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 570,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 571,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 572,
    ...
    OF_TABLE_MOD_PROP = 579,
    OF_TABLE_MOD_PROP_EVICTION = 580,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 581,
    OF_TABLE_MOD_PROP_VACANCY = 582,
    OF_TABLE_STATS_ENTRY = 583,
    OF_UINT32 = 584,
    OF_UINT64 = 585,
    OF_UINT8 = 586,
    ...
    /* List objects */
    OF_LIST_ACTION = 587,
    OF_LIST_ACTION_ID = 588,
    OF_LIST_ASYNC_CONFIG_PROP = 589,
    ...
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 606,
    OF_LIST_BUCKET = 607,
    OF_LIST_BUCKET_COUNTER = 608,
    OF_LIST_BUNDLE_PROP = 609,
    OF_LIST_FLOW_STATS_ENTRY = 610,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 611,
    OF_LIST_GROUP_STATS_ENTRY = 612,
    OF_LIST_HELLO_ELEM = 613,
    OF_LIST_INSTRUCTION = 614,
    OF_LIST_INSTRUCTION_ID = 615,
    OF_LIST_METER_BAND = 616,
    OF_LIST_METER_BAND_STATS = 617,
    OF_LIST_METER_STATS = 618,
    OF_LIST_OXM = 619,
    OF_LIST_PACKET_QUEUE = 620,
    OF_LIST_PORT_DESC = 621,
    OF_LIST_PORT_DESC_PROP = 622,
    OF_LIST_PORT_MOD_PROP = 623,
    OF_LIST_PORT_STATS_ENTRY = 624,
    OF_LIST_PORT_STATS_PROP = 625,
    OF_LIST_QUEUE_DESC = 626,
    OF_LIST_QUEUE_DESC_PROP = 627,
    OF_LIST_QUEUE_PROP = 628,
    OF_LIST_QUEUE_STATS_ENTRY = 629,
    OF_LIST_QUEUE_STATS_PROP = 630,
    OF_LIST_ROLE_PROP = 631,
    OF_LIST_TABLE_DESC = 632,
    OF_LIST_TABLE_FEATURE_PROP = 633,
    OF_LIST_TABLE_FEATURES = 634,
    OF_LIST_TABLE_MOD_PROP = 635,
    OF_LIST_TABLE_STATS_ENTRY = 636,
    OF_LIST_UINT32 = 637,
    OF_LIST_UINT64 = 638,
    OF_LIST_UINT8 = 639,
