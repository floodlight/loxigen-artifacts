...
typedef enum of_object_id_e {
    ...
    OF_EXPERIMENTER_STATS_HEADER = 269,
    OF_FLOW_STATS_ENTRY = 270,
    OF_GROUP_DESC_STATS_ENTRY = 271,
    OF_GROUP_STATS_ENTRY = 272,
    OF_HEADER = 273,
    OF_HELLO_ELEM = 274,
    OF_HELLO_ELEM_HEADER = 275,
    OF_HELLO_ELEM_VERSIONBITMAP = 276,
    OF_INSTRUCTION = 277,
    OF_INSTRUCTION_APPLY_ACTIONS = 278,
    OF_INSTRUCTION_BSN = 279,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 280,
    OF_INSTRUCTION_BSN_DENY = 281,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 282,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 283,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 284,
    OF_INSTRUCTION_BSN_PERMIT = 285,
    OF_INSTRUCTION_CLEAR_ACTIONS = 286,
    OF_INSTRUCTION_EXPERIMENTER = 287,
    OF_INSTRUCTION_GOTO_TABLE = 288,
    OF_INSTRUCTION_HEADER = 289,
    OF_INSTRUCTION_ID = 290,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 291,
    OF_INSTRUCTION_ID_BSN = 292,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 293,
    OF_INSTRUCTION_ID_BSN_DENY = 294,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 295,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 296,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 297,
    OF_INSTRUCTION_ID_BSN_PERMIT = 298,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 299,
    OF_INSTRUCTION_ID_EXPERIMENTER = 300,
    OF_INSTRUCTION_ID_GOTO_TABLE = 301,
    OF_INSTRUCTION_ID_HEADER = 302,
    OF_INSTRUCTION_ID_METER = 303,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 304,
    OF_INSTRUCTION_ID_WRITE_METADATA = 305,
    OF_INSTRUCTION_METER = 306,
    OF_INSTRUCTION_WRITE_ACTIONS = 307,
    OF_INSTRUCTION_WRITE_METADATA = 308,
    OF_MATCH_V1 = 309,
    OF_MATCH_V2 = 310,
    OF_MATCH_V3 = 311,
    OF_METER_BAND = 312,
    OF_METER_BAND_DROP = 313,
    OF_METER_BAND_DSCP_REMARK = 314,
    OF_METER_BAND_EXPERIMENTER = 315,
    OF_METER_BAND_HEADER = 316,
    OF_METER_BAND_STATS = 317,
    OF_METER_CONFIG = 318,
    OF_METER_FEATURES = 319,
    OF_METER_STATS = 320,
    OF_OXM = 321,
    OF_OXM_ARP_OP = 322,
    OF_OXM_ARP_OP_MASKED = 323,
    OF_OXM_ARP_SHA = 324,
    OF_OXM_ARP_SHA_MASKED = 325,
    OF_OXM_ARP_SPA = 326,
    OF_OXM_ARP_SPA_MASKED = 327,
    OF_OXM_ARP_THA = 328,
    OF_OXM_ARP_THA_MASKED = 329,
    OF_OXM_ARP_TPA = 330,
    OF_OXM_ARP_TPA_MASKED = 331,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 332,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 333,
    OF_OXM_BSN_IN_PORTS_128 = 334,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 335,
    OF_OXM_BSN_L3_DST_CLASS_ID = 336,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 337,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 338,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 339,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 340,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 341,
    OF_OXM_BSN_LAG_ID = 342,
    OF_OXM_BSN_LAG_ID_MASKED = 343,
    OF_OXM_BSN_VRF = 344,
    OF_OXM_BSN_VRF_MASKED = 345,
    OF_OXM_ETH_DST = 346,
    OF_OXM_ETH_DST_MASKED = 347,
    OF_OXM_ETH_SRC = 348,
    OF_OXM_ETH_SRC_MASKED = 349,
    OF_OXM_ETH_TYPE = 350,
    OF_OXM_ETH_TYPE_MASKED = 351,
    OF_OXM_HEADER = 352,
    OF_OXM_ICMPV4_CODE = 353,
    OF_OXM_ICMPV4_CODE_MASKED = 354,
    OF_OXM_ICMPV4_TYPE = 355,
    OF_OXM_ICMPV4_TYPE_MASKED = 356,
    OF_OXM_ICMPV6_CODE = 357,
    OF_OXM_ICMPV6_CODE_MASKED = 358,
    OF_OXM_ICMPV6_TYPE = 359,
    OF_OXM_ICMPV6_TYPE_MASKED = 360,
    OF_OXM_IN_PHY_PORT = 361,
    OF_OXM_IN_PHY_PORT_MASKED = 362,
    OF_OXM_IN_PORT = 363,
    OF_OXM_IN_PORT_MASKED = 364,
    OF_OXM_IP_DSCP = 365,
    OF_OXM_IP_DSCP_MASKED = 366,
    OF_OXM_IP_ECN = 367,
    OF_OXM_IP_ECN_MASKED = 368,
    OF_OXM_IP_PROTO = 369,
    OF_OXM_IP_PROTO_MASKED = 370,
    OF_OXM_IPV4_DST = 371,
    OF_OXM_IPV4_DST_MASKED = 372,
    OF_OXM_IPV4_SRC = 373,
    OF_OXM_IPV4_SRC_MASKED = 374,
    OF_OXM_IPV6_DST = 375,
    OF_OXM_IPV6_DST_MASKED = 376,
    OF_OXM_IPV6_FLABEL = 377,
    OF_OXM_IPV6_FLABEL_MASKED = 378,
    OF_OXM_IPV6_ND_SLL = 379,
    OF_OXM_IPV6_ND_SLL_MASKED = 380,
    OF_OXM_IPV6_ND_TARGET = 381,
    OF_OXM_IPV6_ND_TARGET_MASKED = 382,
    OF_OXM_IPV6_ND_TLL = 383,
    OF_OXM_IPV6_ND_TLL_MASKED = 384,
    OF_OXM_IPV6_SRC = 385,
    OF_OXM_IPV6_SRC_MASKED = 386,
    OF_OXM_METADATA = 387,
    OF_OXM_METADATA_MASKED = 388,
    OF_OXM_MPLS_LABEL = 389,
    OF_OXM_MPLS_LABEL_MASKED = 390,
    OF_OXM_MPLS_TC = 391,
    OF_OXM_MPLS_TC_MASKED = 392,
    OF_OXM_SCTP_DST = 393,
    OF_OXM_SCTP_DST_MASKED = 394,
    OF_OXM_SCTP_SRC = 395,
    OF_OXM_SCTP_SRC_MASKED = 396,
    OF_OXM_TCP_DST = 397,
    OF_OXM_TCP_DST_MASKED = 398,
    OF_OXM_TCP_SRC = 399,
    OF_OXM_TCP_SRC_MASKED = 400,
    OF_OXM_UDP_DST = 401,
    OF_OXM_UDP_DST_MASKED = 402,
    OF_OXM_UDP_SRC = 403,
    OF_OXM_UDP_SRC_MASKED = 404,
    OF_OXM_VLAN_PCP = 405,
    OF_OXM_VLAN_PCP_MASKED = 406,
    OF_OXM_VLAN_VID = 407,
    OF_OXM_VLAN_VID_MASKED = 408,
    OF_PACKET_QUEUE = 409,
    OF_PORT_DESC = 410,
    OF_PORT_STATS_ENTRY = 411,
    OF_QUEUE_PROP = 412,
    OF_QUEUE_PROP_EXPERIMENTER = 413,
    OF_QUEUE_PROP_HEADER = 414,
    OF_QUEUE_PROP_MAX_RATE = 415,
    OF_QUEUE_PROP_MIN_RATE = 416,
    OF_QUEUE_STATS_ENTRY = 417,
    OF_TABLE_FEATURE_PROP = 418,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 419,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 420,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 421,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 422,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 423,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 424,
    OF_TABLE_FEATURE_PROP_HEADER = 425,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 426,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 427,
    OF_TABLE_FEATURE_PROP_MATCH = 428,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 429,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 430,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 431,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 432,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 433,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 434,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 435,
    OF_TABLE_FEATURES = 436,
    OF_TABLE_STATS_ENTRY = 437,
    OF_UINT32 = 438,
    OF_UINT64 = 439,
    OF_UINT8 = 440,
    ...
    /* List objects */
    OF_LIST_ACTION = 441,
    OF_LIST_ACTION_ID = 442,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 443,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 444,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 445,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 446,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 447,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 448,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 449,
    OF_LIST_BSN_INTERFACE = 450,
    OF_LIST_BSN_LACP_STATS_ENTRY = 451,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 452,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 453,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 454,
    OF_LIST_BSN_TLV = 455,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 456,
    OF_LIST_BUCKET = 457,
    OF_LIST_BUCKET_COUNTER = 458,
    OF_LIST_FLOW_STATS_ENTRY = 459,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 460,
    OF_LIST_GROUP_STATS_ENTRY = 461,
    OF_LIST_HELLO_ELEM = 462,
    OF_LIST_INSTRUCTION = 463,
    OF_LIST_INSTRUCTION_ID = 464,
    OF_LIST_METER_BAND = 465,
    OF_LIST_METER_BAND_STATS = 466,
    OF_LIST_METER_STATS = 467,
    OF_LIST_OXM = 468,
    OF_LIST_PACKET_QUEUE = 469,
    OF_LIST_PORT_DESC = 470,
    OF_LIST_PORT_STATS_ENTRY = 471,
    OF_LIST_QUEUE_PROP = 472,
    OF_LIST_QUEUE_STATS_ENTRY = 473,
    OF_LIST_TABLE_FEATURE_PROP = 474,
    OF_LIST_TABLE_FEATURES = 475,
    OF_LIST_TABLE_STATS_ENTRY = 476,
    OF_LIST_UINT32 = 477,
    OF_LIST_UINT64 = 478,
    OF_LIST_UINT8 = 479,
