...
typedef enum of_object_id_e {
    ...
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 528,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 529,
    OF_OXM_BSN_VRF = 530,
    OF_OXM_BSN_VRF_MASKED = 531,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 532,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 533,
    OF_OXM_ETH_DST = 534,
    OF_OXM_ETH_DST_MASKED = 535,
    OF_OXM_ETH_SRC = 536,
    OF_OXM_ETH_SRC_MASKED = 537,
    OF_OXM_ETH_TYPE = 538,
    OF_OXM_ETH_TYPE_MASKED = 539,
    OF_OXM_ICMPV4_CODE = 540,
    OF_OXM_ICMPV4_CODE_MASKED = 541,
    OF_OXM_ICMPV4_TYPE = 542,
    OF_OXM_ICMPV4_TYPE_MASKED = 543,
    OF_OXM_ICMPV6_CODE = 544,
    OF_OXM_ICMPV6_CODE_MASKED = 545,
    OF_OXM_ICMPV6_TYPE = 546,
    OF_OXM_ICMPV6_TYPE_MASKED = 547,
    OF_OXM_IN_PHY_PORT = 548,
    OF_OXM_IN_PHY_PORT_MASKED = 549,
    OF_OXM_IN_PORT = 550,
    OF_OXM_IN_PORT_MASKED = 551,
    OF_OXM_IP_DSCP = 552,
    OF_OXM_IP_DSCP_MASKED = 553,
    OF_OXM_IP_ECN = 554,
    OF_OXM_IP_ECN_MASKED = 555,
    OF_OXM_IP_PROTO = 556,
    OF_OXM_IP_PROTO_MASKED = 557,
    OF_OXM_IPV4_DST = 558,
    OF_OXM_IPV4_DST_MASKED = 559,
    OF_OXM_IPV4_SRC = 560,
    OF_OXM_IPV4_SRC_MASKED = 561,
    OF_OXM_IPV6_DST = 562,
    OF_OXM_IPV6_DST_MASKED = 563,
    OF_OXM_IPV6_EXTHDR = 564,
    OF_OXM_IPV6_EXTHDR_MASKED = 565,
    OF_OXM_IPV6_FLABEL = 566,
    OF_OXM_IPV6_FLABEL_MASKED = 567,
    OF_OXM_IPV6_ND_SLL = 568,
    OF_OXM_IPV6_ND_SLL_MASKED = 569,
    OF_OXM_IPV6_ND_TARGET = 570,
    OF_OXM_IPV6_ND_TARGET_MASKED = 571,
    OF_OXM_IPV6_ND_TLL = 572,
    OF_OXM_IPV6_ND_TLL_MASKED = 573,
    OF_OXM_IPV6_SRC = 574,
    OF_OXM_IPV6_SRC_MASKED = 575,
    OF_OXM_METADATA = 576,
    OF_OXM_METADATA_MASKED = 577,
    OF_OXM_MPLS_BOS = 578,
    OF_OXM_MPLS_BOS_MASKED = 579,
    OF_OXM_MPLS_LABEL = 580,
    OF_OXM_MPLS_LABEL_MASKED = 581,
    OF_OXM_MPLS_TC = 582,
    OF_OXM_MPLS_TC_MASKED = 583,
    OF_OXM_PBB_UCA = 584,
    OF_OXM_PBB_UCA_MASKED = 585,
    OF_OXM_SCTP_DST = 586,
    OF_OXM_SCTP_DST_MASKED = 587,
    OF_OXM_SCTP_SRC = 588,
    OF_OXM_SCTP_SRC_MASKED = 589,
    OF_OXM_TCP_DST = 590,
    OF_OXM_TCP_DST_MASKED = 591,
    OF_OXM_TCP_SRC = 592,
    OF_OXM_TCP_SRC_MASKED = 593,
    OF_OXM_TUNNEL_ID = 594,
    OF_OXM_TUNNEL_ID_MASKED = 595,
    OF_OXM_TUNNEL_IPV4_DST = 596,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 597,
    OF_OXM_TUNNEL_IPV4_SRC = 598,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 599,
    OF_OXM_UDP_DST = 600,
    OF_OXM_UDP_DST_MASKED = 601,
    OF_OXM_UDP_SRC = 602,
    OF_OXM_UDP_SRC_MASKED = 603,
    OF_OXM_VLAN_PCP = 604,
    OF_OXM_VLAN_PCP_MASKED = 605,
    OF_OXM_VLAN_VID = 606,
    OF_OXM_VLAN_VID_MASKED = 607,
    OF_PACKET_QUEUE = 608,
    OF_PORT_DESC = 609,
    OF_PORT_DESC_PROP = 610,
    OF_PORT_DESC_PROP_BSN = 611,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 612,
    OF_PORT_DESC_PROP_BSN_UPLINK = 613,
    OF_PORT_DESC_PROP_ETHERNET = 614,
    OF_PORT_DESC_PROP_EXPERIMENTER = 615,
    OF_PORT_DESC_PROP_OPTICAL = 616,
    OF_PORT_MOD_PROP = 617,
    OF_PORT_MOD_PROP_ETHERNET = 618,
    OF_PORT_MOD_PROP_EXPERIMENTER = 619,
    OF_PORT_MOD_PROP_OPTICAL = 620,
    OF_PORT_STATS_ENTRY = 621,
    OF_PORT_STATS_PROP = 622,
    OF_PORT_STATS_PROP_ETHERNET = 623,
    OF_PORT_STATS_PROP_EXPERIMENTER = 624,
    OF_PORT_STATS_PROP_OPTICAL = 625,
    OF_QUEUE_DESC = 626,
    OF_QUEUE_DESC_PROP = 627,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 628,
    OF_QUEUE_DESC_PROP_MAX_RATE = 629,
    OF_QUEUE_DESC_PROP_MIN_RATE = 630,
    OF_QUEUE_PROP = 631,
    OF_QUEUE_PROP_EXPERIMENTER = 632,
    OF_QUEUE_PROP_MAX_RATE = 633,
    OF_QUEUE_PROP_MIN_RATE = 634,
    OF_QUEUE_STATS_ENTRY = 635,
    OF_QUEUE_STATS_PROP = 636,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 637,
    OF_ROLE_PROP = 638,
    OF_ROLE_PROP_EXPERIMENTER = 639,
    OF_TABLE_DESC = 640,
    OF_TABLE_FEATURE_PROP = 641,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 642,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 643,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 644,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 645,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 646,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 647,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 648,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 649,
    OF_TABLE_FEATURE_PROP_MATCH = 650,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 651,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 652,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 653,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 654,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 655,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 656,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 657,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 658,
    OF_TABLE_FEATURES = 659,
    OF_TABLE_MOD_PROP = 660,
    OF_TABLE_MOD_PROP_EVICTION = 661,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 662,
    OF_TABLE_MOD_PROP_VACANCY = 663,
    OF_TABLE_STATS_ENTRY = 664,
    OF_UINT32 = 665,
    OF_UINT64 = 666,
    OF_UINT8 = 667,
    ...
    /* List objects */
    OF_LIST_ACTION = 668,
    OF_LIST_ACTION_ID = 669,
    OF_LIST_ASYNC_CONFIG_PROP = 670,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 671,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 672,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 673,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 674,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 675,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 676,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 677,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 678,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 679,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 680,
    OF_LIST_BSN_INTERFACE = 681,
    OF_LIST_BSN_LACP_STATS_ENTRY = 682,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 683,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 684,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 685,
    OF_LIST_BSN_TLV = 686,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 687,
    OF_LIST_BSN_VLAN_MAC = 688,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 689,
    OF_LIST_BUCKET = 690,
    OF_LIST_BUCKET_COUNTER = 691,
    OF_LIST_BUNDLE_PROP = 692,
    OF_LIST_FLOW_STATS_ENTRY = 693,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 694,
    OF_LIST_GROUP_STATS_ENTRY = 695,
    OF_LIST_HELLO_ELEM = 696,
    OF_LIST_INSTRUCTION = 697,
    OF_LIST_INSTRUCTION_ID = 698,
    OF_LIST_METER_BAND = 699,
    OF_LIST_METER_BAND_STATS = 700,
    OF_LIST_METER_CONFIG = 701,
    OF_LIST_METER_STATS = 702,
    OF_LIST_OXM = 703,
    OF_LIST_PACKET_QUEUE = 704,
    OF_LIST_PORT_DESC = 705,
    OF_LIST_PORT_DESC_PROP = 706,
    OF_LIST_PORT_MOD_PROP = 707,
    OF_LIST_PORT_STATS_ENTRY = 708,
    OF_LIST_PORT_STATS_PROP = 709,
    OF_LIST_QUEUE_DESC = 710,
    OF_LIST_QUEUE_DESC_PROP = 711,
    OF_LIST_QUEUE_PROP = 712,
    OF_LIST_QUEUE_STATS_ENTRY = 713,
    OF_LIST_QUEUE_STATS_PROP = 714,
    OF_LIST_ROLE_PROP = 715,
    OF_LIST_TABLE_DESC = 716,
    OF_LIST_TABLE_FEATURE_PROP = 717,
    OF_LIST_TABLE_FEATURES = 718,
    OF_LIST_TABLE_MOD_PROP = 719,
    OF_LIST_TABLE_STATS_ENTRY = 720,
    OF_LIST_UINT32 = 721,
    OF_LIST_UINT64 = 722,
    OF_LIST_UINT8 = 723,
