...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 274,
    OF_INSTRUCTION_CLEAR_ACTIONS = 275,
    OF_INSTRUCTION_EXPERIMENTER = 276,
    OF_INSTRUCTION_GOTO_TABLE = 277,
    OF_INSTRUCTION_HEADER = 278,
    OF_INSTRUCTION_ID = 279,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 280,
    OF_INSTRUCTION_ID_BSN = 281,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 282,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 283,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 284,
    OF_INSTRUCTION_ID_EXPERIMENTER = 285,
    OF_INSTRUCTION_ID_GOTO_TABLE = 286,
    OF_INSTRUCTION_ID_HEADER = 287,
    OF_INSTRUCTION_ID_METER = 288,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 289,
    OF_INSTRUCTION_ID_WRITE_METADATA = 290,
    OF_INSTRUCTION_METER = 291,
    OF_INSTRUCTION_WRITE_ACTIONS = 292,
    OF_INSTRUCTION_WRITE_METADATA = 293,
    OF_MATCH_V1 = 294,
    OF_MATCH_V2 = 295,
    OF_MATCH_V3 = 296,
    OF_METER_BAND = 297,
    OF_METER_BAND_DROP = 298,
    OF_METER_BAND_DSCP_REMARK = 299,
    OF_METER_BAND_EXPERIMENTER = 300,
    OF_METER_BAND_HEADER = 301,
    OF_METER_BAND_STATS = 302,
    OF_METER_CONFIG = 303,
    OF_METER_FEATURES = 304,
    OF_METER_STATS = 305,
    OF_OXM = 306,
    OF_OXM_ARP_OP = 307,
    OF_OXM_ARP_OP_MASKED = 308,
    OF_OXM_ARP_SHA = 309,
    OF_OXM_ARP_SHA_MASKED = 310,
    OF_OXM_ARP_SPA = 311,
    OF_OXM_ARP_SPA_MASKED = 312,
    OF_OXM_ARP_THA = 313,
    OF_OXM_ARP_THA_MASKED = 314,
    OF_OXM_ARP_TPA = 315,
    OF_OXM_ARP_TPA_MASKED = 316,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 317,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 318,
    OF_OXM_BSN_IN_PORTS_128 = 319,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 320,
    OF_OXM_BSN_L3_DST_CLASS_ID = 321,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 322,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 323,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 324,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 325,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 326,
    OF_OXM_BSN_LAG_ID = 327,
    OF_OXM_BSN_LAG_ID_MASKED = 328,
    OF_OXM_BSN_VRF = 329,
    OF_OXM_BSN_VRF_MASKED = 330,
    OF_OXM_ETH_DST = 331,
    OF_OXM_ETH_DST_MASKED = 332,
    OF_OXM_ETH_SRC = 333,
    OF_OXM_ETH_SRC_MASKED = 334,
    OF_OXM_ETH_TYPE = 335,
    OF_OXM_ETH_TYPE_MASKED = 336,
    OF_OXM_HEADER = 337,
    OF_OXM_ICMPV4_CODE = 338,
    OF_OXM_ICMPV4_CODE_MASKED = 339,
    OF_OXM_ICMPV4_TYPE = 340,
    OF_OXM_ICMPV4_TYPE_MASKED = 341,
    OF_OXM_ICMPV6_CODE = 342,
    OF_OXM_ICMPV6_CODE_MASKED = 343,
    OF_OXM_ICMPV6_TYPE = 344,
    OF_OXM_ICMPV6_TYPE_MASKED = 345,
    OF_OXM_IN_PHY_PORT = 346,
    OF_OXM_IN_PHY_PORT_MASKED = 347,
    OF_OXM_IN_PORT = 348,
    OF_OXM_IN_PORT_MASKED = 349,
    OF_OXM_IP_DSCP = 350,
    OF_OXM_IP_DSCP_MASKED = 351,
    OF_OXM_IP_ECN = 352,
    OF_OXM_IP_ECN_MASKED = 353,
    OF_OXM_IP_PROTO = 354,
    OF_OXM_IP_PROTO_MASKED = 355,
    OF_OXM_IPV4_DST = 356,
    OF_OXM_IPV4_DST_MASKED = 357,
    OF_OXM_IPV4_SRC = 358,
    OF_OXM_IPV4_SRC_MASKED = 359,
    OF_OXM_IPV6_DST = 360,
    OF_OXM_IPV6_DST_MASKED = 361,
    OF_OXM_IPV6_FLABEL = 362,
    OF_OXM_IPV6_FLABEL_MASKED = 363,
    OF_OXM_IPV6_ND_SLL = 364,
    OF_OXM_IPV6_ND_SLL_MASKED = 365,
    OF_OXM_IPV6_ND_TARGET = 366,
    OF_OXM_IPV6_ND_TARGET_MASKED = 367,
    OF_OXM_IPV6_ND_TLL = 368,
    OF_OXM_IPV6_ND_TLL_MASKED = 369,
    OF_OXM_IPV6_SRC = 370,
    OF_OXM_IPV6_SRC_MASKED = 371,
    OF_OXM_METADATA = 372,
    OF_OXM_METADATA_MASKED = 373,
    OF_OXM_MPLS_LABEL = 374,
    OF_OXM_MPLS_LABEL_MASKED = 375,
    OF_OXM_MPLS_TC = 376,
    OF_OXM_MPLS_TC_MASKED = 377,
    OF_OXM_SCTP_DST = 378,
    OF_OXM_SCTP_DST_MASKED = 379,
    OF_OXM_SCTP_SRC = 380,
    OF_OXM_SCTP_SRC_MASKED = 381,
    OF_OXM_TCP_DST = 382,
    OF_OXM_TCP_DST_MASKED = 383,
    OF_OXM_TCP_SRC = 384,
    OF_OXM_TCP_SRC_MASKED = 385,
    OF_OXM_UDP_DST = 386,
    OF_OXM_UDP_DST_MASKED = 387,
    OF_OXM_UDP_SRC = 388,
    OF_OXM_UDP_SRC_MASKED = 389,
    OF_OXM_VLAN_PCP = 390,
    OF_OXM_VLAN_PCP_MASKED = 391,
    OF_OXM_VLAN_VID = 392,
    OF_OXM_VLAN_VID_MASKED = 393,
    OF_PACKET_QUEUE = 394,
    OF_PORT_DESC = 395,
    OF_PORT_STATS_ENTRY = 396,
    OF_QUEUE_PROP = 397,
    OF_QUEUE_PROP_EXPERIMENTER = 398,
    OF_QUEUE_PROP_HEADER = 399,
    OF_QUEUE_PROP_MAX_RATE = 400,
    OF_QUEUE_PROP_MIN_RATE = 401,
    OF_QUEUE_STATS_ENTRY = 402,
    OF_TABLE_FEATURE_PROP = 403,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 404,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 405,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 406,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 407,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 408,
    OF_TABLE_FEATURE_PROP_HEADER = 409,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 410,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 411,
    OF_TABLE_FEATURE_PROP_MATCH = 412,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 413,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 414,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 415,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 416,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 417,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 418,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 419,
    OF_TABLE_FEATURES = 420,
    OF_TABLE_STATS_ENTRY = 421,
    OF_UINT32 = 422,
    OF_UINT64 = 423,
    OF_UINT8 = 424,
    ...
    /* List objects */
    OF_LIST_ACTION = 425,
    OF_LIST_ACTION_ID = 426,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 427,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 428,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 429,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 430,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 431,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 432,
    OF_LIST_BSN_INTERFACE = 433,
    OF_LIST_BSN_LACP_STATS_ENTRY = 434,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 435,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 436,
    OF_LIST_BSN_TLV = 437,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 438,
    OF_LIST_BUCKET = 439,
    OF_LIST_BUCKET_COUNTER = 440,
    OF_LIST_FLOW_STATS_ENTRY = 441,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 442,
    OF_LIST_GROUP_STATS_ENTRY = 443,
    OF_LIST_HELLO_ELEM = 444,
    OF_LIST_INSTRUCTION = 445,
    OF_LIST_METER_BAND = 446,
    OF_LIST_METER_BAND_STATS = 447,
    OF_LIST_METER_STATS = 448,
    OF_LIST_OXM = 449,
    OF_LIST_PACKET_QUEUE = 450,
    OF_LIST_PORT_DESC = 451,
    OF_LIST_PORT_STATS_ENTRY = 452,
    OF_LIST_QUEUE_PROP = 453,
    OF_LIST_QUEUE_STATS_ENTRY = 454,
    OF_LIST_TABLE_FEATURE_PROP = 455,
    OF_LIST_TABLE_FEATURES = 456,
    OF_LIST_TABLE_STATS_ENTRY = 457,
    OF_LIST_UINT32 = 458,
    OF_LIST_UINT64 = 459,
    OF_LIST_UINT8 = 460,
