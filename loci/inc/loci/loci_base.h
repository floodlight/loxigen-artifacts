...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PDUA_RX_INSTANCE = 409,
    OF_BSN_TLV_PORT = 410,
    OF_BSN_TLV_PORT_SPEED_GBPS = 411,
    OF_BSN_TLV_PORT_USAGE = 412,
    OF_BSN_TLV_PORT_VXLAN_MODE = 413,
    OF_BSN_TLV_PRIORITY = 414,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 415,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 416,
    OF_BSN_TLV_QOS_PRIORITY = 417,
    OF_BSN_TLV_QUEUE_ID = 418,
    OF_BSN_TLV_QUEUE_WEIGHT = 419,
    OF_BSN_TLV_RATE_LIMIT = 420,
    OF_BSN_TLV_RATE_UNIT = 421,
    OF_BSN_TLV_RECORD_PACKETS = 422,
    OF_BSN_TLV_REFERENCE = 423,
    OF_BSN_TLV_REPLY_PACKETS = 424,
    OF_BSN_TLV_REQUEST_PACKETS = 425,
    OF_BSN_TLV_REST_SERVER = 426,
    OF_BSN_TLV_ROUTING_PARAM = 427,
    OF_BSN_TLV_RX_BYTES = 428,
    OF_BSN_TLV_RX_PACKETS = 429,
    OF_BSN_TLV_SAMPLING_RATE = 430,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 431,
    OF_BSN_TLV_STATUS = 432,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 433,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 434,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 435,
    OF_BSN_TLV_SUB_AGENT_ID = 436,
    OF_BSN_TLV_TCP_DST = 437,
    OF_BSN_TLV_TCP_FLAGS = 438,
    OF_BSN_TLV_TCP_SRC = 439,
    OF_BSN_TLV_TIMESTAMP = 440,
    OF_BSN_TLV_TTL = 441,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 442,
    OF_BSN_TLV_TX_BYTES = 443,
    OF_BSN_TLV_TX_PACKETS = 444,
    OF_BSN_TLV_UDF_ANCHOR = 445,
    OF_BSN_TLV_UDF_ID = 446,
    OF_BSN_TLV_UDF_LENGTH = 447,
    OF_BSN_TLV_UDF_OFFSET = 448,
    OF_BSN_TLV_UDP_DST = 449,
    OF_BSN_TLV_UDP_SRC = 450,
    OF_BSN_TLV_UINT32 = 451,
    OF_BSN_TLV_UINT64_LIST = 452,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 453,
    OF_BSN_TLV_UNICAST_RATE = 454,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 455,
    OF_BSN_TLV_UNTAGGED = 456,
    OF_BSN_TLV_UPGRADE = 457,
    OF_BSN_TLV_URI_SCHEME = 458,
    OF_BSN_TLV_USE_PACKET_STATE = 459,
    OF_BSN_TLV_USER_CONFIGURED = 460,
    OF_BSN_TLV_VFI = 461,
    OF_BSN_TLV_VFP_CLASS_ID = 462,
    OF_BSN_TLV_VIRTUAL = 463,
    OF_BSN_TLV_VLAN_MAC_LIST = 464,
    OF_BSN_TLV_VLAN_PCP = 465,
    OF_BSN_TLV_VLAN_VID = 466,
    OF_BSN_TLV_VLAN_VID_MASK = 467,
    OF_BSN_TLV_VNI = 468,
    OF_BSN_TLV_VPN_KEY = 469,
    OF_BSN_TLV_VRF = 470,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 471,
    OF_BSN_UNIT = 472,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 473,
    OF_BSN_VLAN_MAC = 474,
    OF_BSN_VPORT = 475,
    OF_BSN_VPORT_L2GRE = 476,
    OF_BSN_VPORT_Q_IN_Q = 477,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 478,
    OF_BUCKET = 479,
    OF_BUCKET_COUNTER = 480,
    OF_BUNDLE_PROP = 481,
    OF_BUNDLE_PROP_EXPERIMENTER = 482,
    OF_FLOW_STATS_ENTRY = 483,
    OF_GROUP_DESC_STATS_ENTRY = 484,
    OF_GROUP_STATS_ENTRY = 485,
    OF_HELLO_ELEM = 486,
    OF_HELLO_ELEM_VERSIONBITMAP = 487,
    OF_INSTRUCTION = 488,
    OF_INSTRUCTION_APPLY_ACTIONS = 489,
    OF_INSTRUCTION_BSN = 490,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 491,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 492,
    OF_INSTRUCTION_BSN_DENY = 493,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 494,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 495,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 496,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 497,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 498,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 499,
    OF_INSTRUCTION_BSN_HASH_SELECT = 500,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 501,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 502,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 503,
    OF_INSTRUCTION_BSN_PERMIT = 504,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 505,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 506,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 507,
    OF_INSTRUCTION_CLEAR_ACTIONS = 508,
    OF_INSTRUCTION_EXPERIMENTER = 509,
    OF_INSTRUCTION_GOTO_TABLE = 510,
    OF_INSTRUCTION_ID = 511,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 512,
    OF_INSTRUCTION_ID_BSN = 513,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 514,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 515,
    OF_INSTRUCTION_ID_BSN_DENY = 516,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 517,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 518,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 519,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 520,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 521,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 522,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 523,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 524,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 525,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 526,
    OF_INSTRUCTION_ID_BSN_PERMIT = 527,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 528,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 529,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 530,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 531,
    OF_INSTRUCTION_ID_EXPERIMENTER = 532,
    OF_INSTRUCTION_ID_GOTO_TABLE = 533,
    OF_INSTRUCTION_ID_METER = 534,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 535,
    OF_INSTRUCTION_ID_WRITE_METADATA = 536,
    OF_INSTRUCTION_METER = 537,
    OF_INSTRUCTION_WRITE_ACTIONS = 538,
    OF_INSTRUCTION_WRITE_METADATA = 539,
    OF_MATCH_V1 = 540,
    OF_MATCH_V2 = 541,
    OF_MATCH_V3 = 542,
    OF_METER_BAND = 543,
    OF_METER_BAND_DROP = 544,
    OF_METER_BAND_DSCP_REMARK = 545,
    OF_METER_BAND_EXPERIMENTER = 546,
    OF_METER_BAND_STATS = 547,
    OF_METER_CONFIG = 548,
    OF_METER_FEATURES = 549,
    OF_METER_STATS = 550,
    OF_OXM = 551,
    OF_OXM_ARP_OP = 552,
    OF_OXM_ARP_OP_MASKED = 553,
    OF_OXM_ARP_SHA = 554,
    OF_OXM_ARP_SHA_MASKED = 555,
    OF_OXM_ARP_SPA = 556,
    OF_OXM_ARP_SPA_MASKED = 557,
    OF_OXM_ARP_THA = 558,
    OF_OXM_ARP_THA_MASKED = 559,
    OF_OXM_ARP_TPA = 560,
    OF_OXM_ARP_TPA_MASKED = 561,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 562,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 563,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 564,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 565,
    OF_OXM_BSN_IFP_CLASS_ID = 566,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 567,
    OF_OXM_BSN_IN_PORTS_128 = 568,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 569,
    OF_OXM_BSN_IN_PORTS_512 = 570,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 571,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 572,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 573,
    OF_OXM_BSN_INNER_ETH_DST = 574,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 575,
    OF_OXM_BSN_INNER_ETH_SRC = 576,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 577,
    OF_OXM_BSN_INNER_VLAN_VID = 578,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 579,
    OF_OXM_BSN_IP_FRAGMENTATION = 580,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 581,
    OF_OXM_BSN_L2_CACHE_HIT = 582,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 583,
    OF_OXM_BSN_L3_DST_CLASS_ID = 584,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 585,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 586,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 587,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 588,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 589,
    OF_OXM_BSN_LAG_ID = 590,
    OF_OXM_BSN_LAG_ID_MASKED = 591,
    OF_OXM_BSN_TCP_FLAGS = 592,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 593,
    OF_OXM_BSN_UDF0 = 594,
    OF_OXM_BSN_UDF0_MASKED = 595,
    OF_OXM_BSN_UDF1 = 596,
    OF_OXM_BSN_UDF1_MASKED = 597,
    OF_OXM_BSN_UDF2 = 598,
    OF_OXM_BSN_UDF2_MASKED = 599,
    OF_OXM_BSN_UDF3 = 600,
    OF_OXM_BSN_UDF3_MASKED = 601,
    OF_OXM_BSN_UDF4 = 602,
    OF_OXM_BSN_UDF4_MASKED = 603,
    OF_OXM_BSN_UDF5 = 604,
    OF_OXM_BSN_UDF5_MASKED = 605,
    OF_OXM_BSN_UDF6 = 606,
    OF_OXM_BSN_UDF6_MASKED = 607,
    OF_OXM_BSN_UDF7 = 608,
    OF_OXM_BSN_UDF7_MASKED = 609,
    OF_OXM_BSN_VFI = 610,
    OF_OXM_BSN_VFI_MASKED = 611,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 612,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 613,
    OF_OXM_BSN_VRF = 614,
    OF_OXM_BSN_VRF_MASKED = 615,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 616,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 617,
    OF_OXM_CONN_TRACKING_IPV6_DST = 618,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 619,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 620,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 621,
    OF_OXM_CONN_TRACKING_LABEL = 622,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 623,
    OF_OXM_CONN_TRACKING_MARK = 624,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 625,
    OF_OXM_CONN_TRACKING_NW_DST = 626,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 627,
    OF_OXM_CONN_TRACKING_NW_PROTO = 628,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 629,
    OF_OXM_CONN_TRACKING_NW_SRC = 630,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 631,
    OF_OXM_CONN_TRACKING_STATE = 632,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 633,
    OF_OXM_CONN_TRACKING_TP_DST = 634,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 635,
    OF_OXM_CONN_TRACKING_TP_SRC = 636,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 637,
    OF_OXM_CONN_TRACKING_ZONE = 638,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 639,
    OF_OXM_ETH_DST = 640,
    OF_OXM_ETH_DST_MASKED = 641,
    OF_OXM_ETH_SRC = 642,
    OF_OXM_ETH_SRC_MASKED = 643,
    OF_OXM_ETH_TYPE = 644,
    OF_OXM_ETH_TYPE_MASKED = 645,
    OF_OXM_ICMPV4_CODE = 646,
    OF_OXM_ICMPV4_CODE_MASKED = 647,
    OF_OXM_ICMPV4_TYPE = 648,
    OF_OXM_ICMPV4_TYPE_MASKED = 649,
    OF_OXM_ICMPV6_CODE = 650,
    OF_OXM_ICMPV6_CODE_MASKED = 651,
    OF_OXM_ICMPV6_TYPE = 652,
    OF_OXM_ICMPV6_TYPE_MASKED = 653,
    OF_OXM_IN_PHY_PORT = 654,
    OF_OXM_IN_PHY_PORT_MASKED = 655,
    OF_OXM_IN_PORT = 656,
    OF_OXM_IN_PORT_MASKED = 657,
    OF_OXM_IP_DSCP = 658,
    OF_OXM_IP_DSCP_MASKED = 659,
    OF_OXM_IP_ECN = 660,
    OF_OXM_IP_ECN_MASKED = 661,
    OF_OXM_IP_PROTO = 662,
    OF_OXM_IP_PROTO_MASKED = 663,
    OF_OXM_IPV4_DST = 664,
    OF_OXM_IPV4_DST_MASKED = 665,
    OF_OXM_IPV4_SRC = 666,
    OF_OXM_IPV4_SRC_MASKED = 667,
    OF_OXM_IPV6_DST = 668,
    OF_OXM_IPV6_DST_MASKED = 669,
    OF_OXM_IPV6_EXTHDR = 670,
    OF_OXM_IPV6_EXTHDR_MASKED = 671,
    OF_OXM_IPV6_FLABEL = 672,
    OF_OXM_IPV6_FLABEL_MASKED = 673,
    OF_OXM_IPV6_ND_SLL = 674,
    OF_OXM_IPV6_ND_SLL_MASKED = 675,
    OF_OXM_IPV6_ND_TARGET = 676,
    OF_OXM_IPV6_ND_TARGET_MASKED = 677,
    OF_OXM_IPV6_ND_TLL = 678,
    OF_OXM_IPV6_ND_TLL_MASKED = 679,
    OF_OXM_IPV6_SRC = 680,
    OF_OXM_IPV6_SRC_MASKED = 681,
    OF_OXM_METADATA = 682,
    OF_OXM_METADATA_MASKED = 683,
    OF_OXM_MPLS_BOS = 684,
    OF_OXM_MPLS_BOS_MASKED = 685,
    OF_OXM_MPLS_LABEL = 686,
    OF_OXM_MPLS_LABEL_MASKED = 687,
    OF_OXM_MPLS_TC = 688,
    OF_OXM_MPLS_TC_MASKED = 689,
    OF_OXM_OVS_TCP_FLAGS = 690,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 691,
    OF_OXM_PBB_UCA = 692,
    OF_OXM_PBB_UCA_MASKED = 693,
    OF_OXM_SCTP_DST = 694,
    OF_OXM_SCTP_DST_MASKED = 695,
    OF_OXM_SCTP_SRC = 696,
    OF_OXM_SCTP_SRC_MASKED = 697,
    OF_OXM_TCP_DST = 698,
    OF_OXM_TCP_DST_MASKED = 699,
    OF_OXM_TCP_SRC = 700,
    OF_OXM_TCP_SRC_MASKED = 701,
    OF_OXM_TUNNEL_ID = 702,
    OF_OXM_TUNNEL_ID_MASKED = 703,
    OF_OXM_TUNNEL_IPV4_DST = 704,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 705,
    OF_OXM_TUNNEL_IPV4_SRC = 706,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 707,
    OF_OXM_UDP_DST = 708,
    OF_OXM_UDP_DST_MASKED = 709,
    OF_OXM_UDP_SRC = 710,
    OF_OXM_UDP_SRC_MASKED = 711,
    OF_OXM_VLAN_PCP = 712,
    OF_OXM_VLAN_PCP_MASKED = 713,
    OF_OXM_VLAN_VID = 714,
    OF_OXM_VLAN_VID_MASKED = 715,
    OF_PACKET_QUEUE = 716,
    OF_PORT_DESC = 717,
    OF_PORT_DESC_PROP = 718,
    OF_PORT_DESC_PROP_BSN = 719,
    OF_PORT_DESC_PROP_BSN_ALARM = 720,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 721,
    OF_PORT_DESC_PROP_BSN_DIAG = 722,
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 723,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 724,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 725,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 726,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 727,
    OF_PORT_DESC_PROP_BSN_UPLINK = 728,
    OF_PORT_DESC_PROP_ETHERNET = 729,
    OF_PORT_DESC_PROP_EXPERIMENTER = 730,
    OF_PORT_DESC_PROP_OPTICAL = 731,
    OF_PORT_MOD_PROP = 732,
    OF_PORT_MOD_PROP_ETHERNET = 733,
    OF_PORT_MOD_PROP_EXPERIMENTER = 734,
    OF_PORT_MOD_PROP_OPTICAL = 735,
    OF_PORT_STATS_ENTRY = 736,
    OF_PORT_STATS_PROP = 737,
    OF_PORT_STATS_PROP_ETHERNET = 738,
    OF_PORT_STATS_PROP_EXPERIMENTER = 739,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 740,
    OF_PORT_STATS_PROP_OPTICAL = 741,
    OF_QUEUE_DESC = 742,
    OF_QUEUE_DESC_PROP = 743,
    OF_QUEUE_DESC_PROP_BSN = 744,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 745,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 746,
    OF_QUEUE_DESC_PROP_MAX_RATE = 747,
    OF_QUEUE_DESC_PROP_MIN_RATE = 748,
    OF_QUEUE_PROP = 749,
    OF_QUEUE_PROP_EXPERIMENTER = 750,
    OF_QUEUE_PROP_MAX_RATE = 751,
    OF_QUEUE_PROP_MIN_RATE = 752,
    OF_QUEUE_STATS_ENTRY = 753,
    OF_QUEUE_STATS_PROP = 754,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 755,
    OF_ROLE_PROP = 756,
    OF_ROLE_PROP_EXPERIMENTER = 757,
    OF_TABLE_DESC = 758,
    OF_TABLE_FEATURE_PROP = 759,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 760,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 761,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 762,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 763,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 764,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 765,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 766,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 767,
    OF_TABLE_FEATURE_PROP_MATCH = 768,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 769,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 770,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 771,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 772,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 773,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 774,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 775,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 776,
    OF_TABLE_FEATURES = 777,
    OF_TABLE_MOD_PROP = 778,
    OF_TABLE_MOD_PROP_EVICTION = 779,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 780,
    OF_TABLE_MOD_PROP_VACANCY = 781,
    OF_TABLE_STATS_ENTRY = 782,
    OF_UINT32 = 783,
    OF_UINT64 = 784,
    OF_UINT8 = 785,
    OFP_BSN_MODULE_EEPROM_TRANSCEIVER = 786,

    /* List objects */
    OF_LIST_ACTION = 787,
    OF_LIST_ACTION_ID = 788,
    OF_LIST_ASYNC_CONFIG_PROP = 789,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 790,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 791,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 792,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 793,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 794,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 795,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 796,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 797,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 798,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 799,
    OF_LIST_BSN_INTERFACE = 800,
    OF_LIST_BSN_LACP_STATS_ENTRY = 801,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 802,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 803,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 804,
    OF_LIST_BSN_TLV = 805,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 806,
    OF_LIST_BSN_VLAN_MAC = 807,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 808,
    OF_LIST_BUCKET = 809,
    OF_LIST_BUCKET_COUNTER = 810,
    OF_LIST_BUNDLE_PROP = 811,
    OF_LIST_FLOW_STATS_ENTRY = 812,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 813,
    OF_LIST_GROUP_STATS_ENTRY = 814,
    OF_LIST_HELLO_ELEM = 815,
    OF_LIST_INSTRUCTION = 816,
    OF_LIST_INSTRUCTION_ID = 817,
    OF_LIST_METER_BAND = 818,
    OF_LIST_METER_BAND_STATS = 819,
    OF_LIST_METER_CONFIG = 820,
    OF_LIST_METER_STATS = 821,
    OF_LIST_OXM = 822,
    OF_LIST_PACKET_QUEUE = 823,
    OF_LIST_PORT_DESC = 824,
    OF_LIST_PORT_DESC_PROP = 825,
    OF_LIST_PORT_MOD_PROP = 826,
    OF_LIST_PORT_STATS_ENTRY = 827,
    OF_LIST_PORT_STATS_PROP = 828,
    OF_LIST_QUEUE_DESC = 829,
    OF_LIST_QUEUE_DESC_PROP = 830,
    OF_LIST_QUEUE_PROP = 831,
    OF_LIST_QUEUE_STATS_ENTRY = 832,
    OF_LIST_QUEUE_STATS_PROP = 833,
    OF_LIST_ROLE_PROP = 834,
    OF_LIST_TABLE_DESC = 835,
    OF_LIST_TABLE_FEATURE_PROP = 836,
    OF_LIST_TABLE_FEATURES = 837,
    OF_LIST_TABLE_MOD_PROP = 838,
    OF_LIST_TABLE_STATS_ENTRY = 839,
    OF_LIST_UINT32 = 840,
    OF_LIST_UINT64 = 841,
    OF_LIST_UINT8 = 842,
