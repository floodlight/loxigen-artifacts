...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 264,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 265,
    OF_BSN_TLV_EXTERNAL_IP = 266,
    OF_BSN_TLV_EXTERNAL_MAC = 267,
    OF_BSN_TLV_EXTERNAL_NETMASK = 268,
    OF_BSN_TLV_HEADER = 269,
    OF_BSN_TLV_IDLE_NOTIFICATION = 270,
    OF_BSN_TLV_IDLE_TIME = 271,
    OF_BSN_TLV_IDLE_TIMEOUT = 272,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 273,
    OF_BSN_TLV_INTERNAL_MAC = 274,
    OF_BSN_TLV_IPV4 = 275,
    OF_BSN_TLV_MAC = 276,
    OF_BSN_TLV_MISS_PACKETS = 277,
    OF_BSN_TLV_PORT = 278,
    OF_BSN_TLV_QUEUE_ID = 279,
    OF_BSN_TLV_QUEUE_WEIGHT = 280,
    OF_BSN_TLV_REPLY_PACKETS = 281,
    OF_BSN_TLV_REQUEST_PACKETS = 282,
    OF_BSN_TLV_RX_PACKETS = 283,
    OF_BSN_TLV_TX_PACKETS = 284,
    OF_BSN_TLV_UDF_ANCHOR = 285,
    OF_BSN_TLV_UDF_ID = 286,
    OF_BSN_TLV_UDF_LENGTH = 287,
    OF_BSN_TLV_UDF_OFFSET = 288,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 289,
    OF_BSN_TLV_VLAN_VID = 290,
    OF_BSN_TLV_VRF = 291,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 292,
    OF_BSN_VPORT = 293,
    OF_BSN_VPORT_HEADER = 294,
    OF_BSN_VPORT_L2GRE = 295,
    OF_BSN_VPORT_Q_IN_Q = 296,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 297,
    OF_BUCKET = 298,
    OF_BUCKET_COUNTER = 299,
    OF_FLOW_STATS_ENTRY = 300,
    OF_GROUP_DESC_STATS_ENTRY = 301,
    OF_GROUP_STATS_ENTRY = 302,
    OF_HELLO_ELEM = 303,
    OF_HELLO_ELEM_HEADER = 304,
    OF_HELLO_ELEM_VERSIONBITMAP = 305,
    OF_INSTRUCTION = 306,
    OF_INSTRUCTION_APPLY_ACTIONS = 307,
    OF_INSTRUCTION_BSN = 308,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 309,
    OF_INSTRUCTION_BSN_DENY = 310,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 311,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 312,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 313,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 314,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 315,
    OF_INSTRUCTION_BSN_PERMIT = 316,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 317,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 318,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 319,
    OF_INSTRUCTION_CLEAR_ACTIONS = 320,
    OF_INSTRUCTION_EXPERIMENTER = 321,
    OF_INSTRUCTION_GOTO_TABLE = 322,
    OF_INSTRUCTION_HEADER = 323,
    OF_INSTRUCTION_ID = 324,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 325,
    OF_INSTRUCTION_ID_BSN = 326,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 327,
    OF_INSTRUCTION_ID_BSN_DENY = 328,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 329,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 330,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 331,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 332,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 333,
    OF_INSTRUCTION_ID_BSN_PERMIT = 334,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 335,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 336,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 337,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 338,
    OF_INSTRUCTION_ID_EXPERIMENTER = 339,
    OF_INSTRUCTION_ID_GOTO_TABLE = 340,
    OF_INSTRUCTION_ID_HEADER = 341,
    OF_INSTRUCTION_ID_METER = 342,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 343,
    OF_INSTRUCTION_ID_WRITE_METADATA = 344,
    OF_INSTRUCTION_METER = 345,
    OF_INSTRUCTION_WRITE_ACTIONS = 346,
    OF_INSTRUCTION_WRITE_METADATA = 347,
    OF_MATCH_V1 = 348,
    OF_MATCH_V2 = 349,
    OF_MATCH_V3 = 350,
    OF_METER_BAND = 351,
    OF_METER_BAND_DROP = 352,
    OF_METER_BAND_DSCP_REMARK = 353,
    OF_METER_BAND_EXPERIMENTER = 354,
    OF_METER_BAND_HEADER = 355,
    OF_METER_BAND_STATS = 356,
    OF_METER_CONFIG = 357,
    OF_METER_FEATURES = 358,
    OF_METER_STATS = 359,
    OF_OXM = 360,
    OF_OXM_ARP_OP = 361,
    OF_OXM_ARP_OP_MASKED = 362,
    OF_OXM_ARP_SHA = 363,
    OF_OXM_ARP_SHA_MASKED = 364,
    OF_OXM_ARP_SPA = 365,
    OF_OXM_ARP_SPA_MASKED = 366,
    OF_OXM_ARP_THA = 367,
    OF_OXM_ARP_THA_MASKED = 368,
    OF_OXM_ARP_TPA = 369,
    OF_OXM_ARP_TPA_MASKED = 370,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 371,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 372,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 373,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 374,
    OF_OXM_BSN_IN_PORTS_128 = 375,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 376,
    OF_OXM_BSN_L3_DST_CLASS_ID = 377,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 378,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 379,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 380,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 381,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 382,
    OF_OXM_BSN_LAG_ID = 383,
    OF_OXM_BSN_LAG_ID_MASKED = 384,
    OF_OXM_BSN_TCP_FLAGS = 385,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 386,
    OF_OXM_BSN_UDF0 = 387,
    OF_OXM_BSN_UDF0_MASKED = 388,
    OF_OXM_BSN_UDF1 = 389,
    OF_OXM_BSN_UDF1_MASKED = 390,
    OF_OXM_BSN_UDF2 = 391,
    OF_OXM_BSN_UDF2_MASKED = 392,
    OF_OXM_BSN_UDF3 = 393,
    OF_OXM_BSN_UDF3_MASKED = 394,
    OF_OXM_BSN_UDF4 = 395,
    OF_OXM_BSN_UDF4_MASKED = 396,
    OF_OXM_BSN_UDF5 = 397,
    OF_OXM_BSN_UDF5_MASKED = 398,
    OF_OXM_BSN_UDF6 = 399,
    OF_OXM_BSN_UDF6_MASKED = 400,
    OF_OXM_BSN_UDF7 = 401,
    OF_OXM_BSN_UDF7_MASKED = 402,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 403,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 404,
    OF_OXM_BSN_VRF = 405,
    OF_OXM_BSN_VRF_MASKED = 406,
    OF_OXM_ETH_DST = 407,
    OF_OXM_ETH_DST_MASKED = 408,
    OF_OXM_ETH_SRC = 409,
    OF_OXM_ETH_SRC_MASKED = 410,
    OF_OXM_ETH_TYPE = 411,
    OF_OXM_ETH_TYPE_MASKED = 412,
    OF_OXM_HEADER = 413,
    OF_OXM_ICMPV4_CODE = 414,
    OF_OXM_ICMPV4_CODE_MASKED = 415,
    OF_OXM_ICMPV4_TYPE = 416,
    OF_OXM_ICMPV4_TYPE_MASKED = 417,
    OF_OXM_ICMPV6_CODE = 418,
    OF_OXM_ICMPV6_CODE_MASKED = 419,
    OF_OXM_ICMPV6_TYPE = 420,
    OF_OXM_ICMPV6_TYPE_MASKED = 421,
    OF_OXM_IN_PHY_PORT = 422,
    OF_OXM_IN_PHY_PORT_MASKED = 423,
    OF_OXM_IN_PORT = 424,
    OF_OXM_IN_PORT_MASKED = 425,
    OF_OXM_IP_DSCP = 426,
    OF_OXM_IP_DSCP_MASKED = 427,
    OF_OXM_IP_ECN = 428,
    OF_OXM_IP_ECN_MASKED = 429,
    OF_OXM_IP_PROTO = 430,
    OF_OXM_IP_PROTO_MASKED = 431,
    OF_OXM_IPV4_DST = 432,
    OF_OXM_IPV4_DST_MASKED = 433,
    OF_OXM_IPV4_SRC = 434,
    OF_OXM_IPV4_SRC_MASKED = 435,
    OF_OXM_IPV6_DST = 436,
    OF_OXM_IPV6_DST_MASKED = 437,
    OF_OXM_IPV6_FLABEL = 438,
    OF_OXM_IPV6_FLABEL_MASKED = 439,
    OF_OXM_IPV6_ND_SLL = 440,
    OF_OXM_IPV6_ND_SLL_MASKED = 441,
    OF_OXM_IPV6_ND_TARGET = 442,
    OF_OXM_IPV6_ND_TARGET_MASKED = 443,
    OF_OXM_IPV6_ND_TLL = 444,
    OF_OXM_IPV6_ND_TLL_MASKED = 445,
    OF_OXM_IPV6_SRC = 446,
    OF_OXM_IPV6_SRC_MASKED = 447,
    OF_OXM_METADATA = 448,
    OF_OXM_METADATA_MASKED = 449,
    OF_OXM_MPLS_LABEL = 450,
    OF_OXM_MPLS_LABEL_MASKED = 451,
    OF_OXM_MPLS_TC = 452,
    OF_OXM_MPLS_TC_MASKED = 453,
    OF_OXM_SCTP_DST = 454,
    OF_OXM_SCTP_DST_MASKED = 455,
    OF_OXM_SCTP_SRC = 456,
    OF_OXM_SCTP_SRC_MASKED = 457,
    OF_OXM_TCP_DST = 458,
    OF_OXM_TCP_DST_MASKED = 459,
    OF_OXM_TCP_SRC = 460,
    OF_OXM_TCP_SRC_MASKED = 461,
    OF_OXM_TUNNEL_ID = 462,
    OF_OXM_TUNNEL_ID_MASKED = 463,
    OF_OXM_UDP_DST = 464,
    OF_OXM_UDP_DST_MASKED = 465,
    OF_OXM_UDP_SRC = 466,
    OF_OXM_UDP_SRC_MASKED = 467,
    OF_OXM_VLAN_PCP = 468,
    OF_OXM_VLAN_PCP_MASKED = 469,
    OF_OXM_VLAN_VID = 470,
    OF_OXM_VLAN_VID_MASKED = 471,
    OF_PACKET_QUEUE = 472,
    OF_PORT_DESC = 473,
    OF_PORT_STATS_ENTRY = 474,
    OF_QUEUE_PROP = 475,
    OF_QUEUE_PROP_EXPERIMENTER = 476,
    OF_QUEUE_PROP_HEADER = 477,
    OF_QUEUE_PROP_MAX_RATE = 478,
    OF_QUEUE_PROP_MIN_RATE = 479,
    OF_QUEUE_STATS_ENTRY = 480,
    OF_TABLE_FEATURE_PROP = 481,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 482,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 483,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 484,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 485,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 486,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 487,
    OF_TABLE_FEATURE_PROP_HEADER = 488,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 489,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 490,
    OF_TABLE_FEATURE_PROP_MATCH = 491,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 492,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 493,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 494,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 495,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 496,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 497,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 498,
    OF_TABLE_FEATURES = 499,
    OF_TABLE_STATS_ENTRY = 500,
    OF_UINT32 = 501,
    OF_UINT64 = 502,
    OF_UINT8 = 503,
    ...
    /* List objects */
    OF_LIST_ACTION = 504,
    OF_LIST_ACTION_ID = 505,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 506,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 507,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 508,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 509,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 510,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 511,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 512,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 513,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 514,
    OF_LIST_BSN_INTERFACE = 515,
    OF_LIST_BSN_LACP_STATS_ENTRY = 516,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 517,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 518,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 519,
    OF_LIST_BSN_TLV = 520,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 521,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 522,
    OF_LIST_BUCKET = 523,
    OF_LIST_BUCKET_COUNTER = 524,
    OF_LIST_FLOW_STATS_ENTRY = 525,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 526,
    OF_LIST_GROUP_STATS_ENTRY = 527,
    OF_LIST_HELLO_ELEM = 528,
    OF_LIST_INSTRUCTION = 529,
    OF_LIST_INSTRUCTION_ID = 530,
    OF_LIST_METER_BAND = 531,
    OF_LIST_METER_BAND_STATS = 532,
    OF_LIST_METER_STATS = 533,
    OF_LIST_OXM = 534,
    OF_LIST_PACKET_QUEUE = 535,
    OF_LIST_PORT_DESC = 536,
    OF_LIST_PORT_STATS_ENTRY = 537,
    OF_LIST_QUEUE_PROP = 538,
    OF_LIST_QUEUE_STATS_ENTRY = 539,
    OF_LIST_TABLE_FEATURE_PROP = 540,
    OF_LIST_TABLE_FEATURES = 541,
    OF_LIST_TABLE_STATS_ENTRY = 542,
    OF_LIST_UINT32 = 543,
    OF_LIST_UINT64 = 544,
    OF_LIST_UINT8 = 545,
