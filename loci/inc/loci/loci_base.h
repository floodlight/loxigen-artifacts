...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_USE_PACKET_STATE = 399,
    OF_BSN_TLV_VFI = 400,
    OF_BSN_TLV_VLAN_MAC_LIST = 401,
    OF_BSN_TLV_VLAN_PCP = 402,
    OF_BSN_TLV_VLAN_VID = 403,
    OF_BSN_TLV_VLAN_VID_MASK = 404,
    OF_BSN_TLV_VNI = 405,
    OF_BSN_TLV_VRF = 406,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 407,
    OF_BSN_VLAN_MAC = 408,
    OF_BSN_VPORT = 409,
    OF_BSN_VPORT_L2GRE = 410,
    OF_BSN_VPORT_Q_IN_Q = 411,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 412,
    OF_BUCKET = 413,
    OF_BUCKET_COUNTER = 414,
    OF_BUNDLE_PROP = 415,
    OF_BUNDLE_PROP_EXPERIMENTER = 416,
    OF_FLOW_STATS_ENTRY = 417,
    OF_GROUP_DESC_STATS_ENTRY = 418,
    OF_GROUP_STATS_ENTRY = 419,
    OF_HELLO_ELEM = 420,
    OF_HELLO_ELEM_VERSIONBITMAP = 421,
    OF_INSTRUCTION = 422,
    OF_INSTRUCTION_APPLY_ACTIONS = 423,
    OF_INSTRUCTION_BSN = 424,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 425,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 426,
    OF_INSTRUCTION_BSN_DENY = 427,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 428,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 429,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 430,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 431,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 432,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 433,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 434,
    OF_INSTRUCTION_BSN_PERMIT = 435,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 436,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 437,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 438,
    OF_INSTRUCTION_CLEAR_ACTIONS = 439,
    OF_INSTRUCTION_EXPERIMENTER = 440,
    OF_INSTRUCTION_GOTO_TABLE = 441,
    OF_INSTRUCTION_ID = 442,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 443,
    OF_INSTRUCTION_ID_BSN = 444,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 445,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 446,
    OF_INSTRUCTION_ID_BSN_DENY = 447,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 448,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 449,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 450,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 451,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 452,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 453,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 454,
    OF_INSTRUCTION_ID_BSN_PERMIT = 455,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 456,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 457,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 458,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 459,
    OF_INSTRUCTION_ID_EXPERIMENTER = 460,
    OF_INSTRUCTION_ID_GOTO_TABLE = 461,
    OF_INSTRUCTION_ID_METER = 462,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 463,
    OF_INSTRUCTION_ID_WRITE_METADATA = 464,
    OF_INSTRUCTION_METER = 465,
    OF_INSTRUCTION_WRITE_ACTIONS = 466,
    OF_INSTRUCTION_WRITE_METADATA = 467,
    OF_MATCH_V1 = 468,
    OF_MATCH_V2 = 469,
    OF_MATCH_V3 = 470,
    OF_METER_BAND = 471,
    OF_METER_BAND_DROP = 472,
    OF_METER_BAND_DSCP_REMARK = 473,
    OF_METER_BAND_EXPERIMENTER = 474,
    OF_METER_BAND_STATS = 475,
    OF_METER_CONFIG = 476,
    OF_METER_FEATURES = 477,
    OF_METER_STATS = 478,
    OF_OXM = 479,
    OF_OXM_ARP_OP = 480,
    OF_OXM_ARP_OP_MASKED = 481,
    OF_OXM_ARP_SHA = 482,
    OF_OXM_ARP_SHA_MASKED = 483,
    OF_OXM_ARP_SPA = 484,
    OF_OXM_ARP_SPA_MASKED = 485,
    OF_OXM_ARP_THA = 486,
    OF_OXM_ARP_THA_MASKED = 487,
    OF_OXM_ARP_TPA = 488,
    OF_OXM_ARP_TPA_MASKED = 489,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 490,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 491,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 492,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 493,
    OF_OXM_BSN_IN_PORTS_128 = 494,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 495,
    OF_OXM_BSN_IN_PORTS_512 = 496,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 497,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 498,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 499,
    OF_OXM_BSN_INNER_ETH_DST = 500,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 501,
    OF_OXM_BSN_INNER_ETH_SRC = 502,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 503,
    OF_OXM_BSN_INNER_VLAN_VID = 504,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 505,
    OF_OXM_BSN_L2_CACHE_HIT = 506,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 507,
    OF_OXM_BSN_L3_DST_CLASS_ID = 508,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 509,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 510,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 511,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 512,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 513,
    OF_OXM_BSN_LAG_ID = 514,
    OF_OXM_BSN_LAG_ID_MASKED = 515,
    OF_OXM_BSN_TCP_FLAGS = 516,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 517,
    OF_OXM_BSN_UDF0 = 518,
    OF_OXM_BSN_UDF0_MASKED = 519,
    OF_OXM_BSN_UDF1 = 520,
    OF_OXM_BSN_UDF1_MASKED = 521,
    OF_OXM_BSN_UDF2 = 522,
    OF_OXM_BSN_UDF2_MASKED = 523,
    OF_OXM_BSN_UDF3 = 524,
    OF_OXM_BSN_UDF3_MASKED = 525,
    OF_OXM_BSN_UDF4 = 526,
    OF_OXM_BSN_UDF4_MASKED = 527,
    OF_OXM_BSN_UDF5 = 528,
    OF_OXM_BSN_UDF5_MASKED = 529,
    OF_OXM_BSN_UDF6 = 530,
    OF_OXM_BSN_UDF6_MASKED = 531,
    OF_OXM_BSN_UDF7 = 532,
    OF_OXM_BSN_UDF7_MASKED = 533,
    OF_OXM_BSN_VFI = 534,
    OF_OXM_BSN_VFI_MASKED = 535,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 536,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 537,
    OF_OXM_BSN_VRF = 538,
    OF_OXM_BSN_VRF_MASKED = 539,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 540,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 541,
    OF_OXM_ETH_DST = 542,
    OF_OXM_ETH_DST_MASKED = 543,
    OF_OXM_ETH_SRC = 544,
    OF_OXM_ETH_SRC_MASKED = 545,
    OF_OXM_ETH_TYPE = 546,
    OF_OXM_ETH_TYPE_MASKED = 547,
    OF_OXM_ICMPV4_CODE = 548,
    OF_OXM_ICMPV4_CODE_MASKED = 549,
    OF_OXM_ICMPV4_TYPE = 550,
    OF_OXM_ICMPV4_TYPE_MASKED = 551,
    OF_OXM_ICMPV6_CODE = 552,
    OF_OXM_ICMPV6_CODE_MASKED = 553,
    OF_OXM_ICMPV6_TYPE = 554,
    OF_OXM_ICMPV6_TYPE_MASKED = 555,
    OF_OXM_IN_PHY_PORT = 556,
    OF_OXM_IN_PHY_PORT_MASKED = 557,
    OF_OXM_IN_PORT = 558,
    OF_OXM_IN_PORT_MASKED = 559,
    OF_OXM_IP_DSCP = 560,
    OF_OXM_IP_DSCP_MASKED = 561,
    OF_OXM_IP_ECN = 562,
    OF_OXM_IP_ECN_MASKED = 563,
    OF_OXM_IP_PROTO = 564,
    OF_OXM_IP_PROTO_MASKED = 565,
    OF_OXM_IPV4_DST = 566,
    OF_OXM_IPV4_DST_MASKED = 567,
    OF_OXM_IPV4_SRC = 568,
    OF_OXM_IPV4_SRC_MASKED = 569,
    OF_OXM_IPV6_DST = 570,
    OF_OXM_IPV6_DST_MASKED = 571,
    OF_OXM_IPV6_EXTHDR = 572,
    OF_OXM_IPV6_EXTHDR_MASKED = 573,
    OF_OXM_IPV6_FLABEL = 574,
    OF_OXM_IPV6_FLABEL_MASKED = 575,
    OF_OXM_IPV6_ND_SLL = 576,
    OF_OXM_IPV6_ND_SLL_MASKED = 577,
    OF_OXM_IPV6_ND_TARGET = 578,
    OF_OXM_IPV6_ND_TARGET_MASKED = 579,
    OF_OXM_IPV6_ND_TLL = 580,
    OF_OXM_IPV6_ND_TLL_MASKED = 581,
    OF_OXM_IPV6_SRC = 582,
    OF_OXM_IPV6_SRC_MASKED = 583,
    OF_OXM_METADATA = 584,
    OF_OXM_METADATA_MASKED = 585,
    OF_OXM_MPLS_BOS = 586,
    OF_OXM_MPLS_BOS_MASKED = 587,
    OF_OXM_MPLS_LABEL = 588,
    OF_OXM_MPLS_LABEL_MASKED = 589,
    OF_OXM_MPLS_TC = 590,
    OF_OXM_MPLS_TC_MASKED = 591,
    OF_OXM_PBB_UCA = 592,
    OF_OXM_PBB_UCA_MASKED = 593,
    OF_OXM_SCTP_DST = 594,
    OF_OXM_SCTP_DST_MASKED = 595,
    OF_OXM_SCTP_SRC = 596,
    OF_OXM_SCTP_SRC_MASKED = 597,
    OF_OXM_TCP_DST = 598,
    OF_OXM_TCP_DST_MASKED = 599,
    OF_OXM_TCP_SRC = 600,
    OF_OXM_TCP_SRC_MASKED = 601,
    OF_OXM_TUNNEL_ID = 602,
    OF_OXM_TUNNEL_ID_MASKED = 603,
    OF_OXM_TUNNEL_IPV4_DST = 604,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 605,
    OF_OXM_TUNNEL_IPV4_SRC = 606,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 607,
    OF_OXM_UDP_DST = 608,
    OF_OXM_UDP_DST_MASKED = 609,
    OF_OXM_UDP_SRC = 610,
    OF_OXM_UDP_SRC_MASKED = 611,
    OF_OXM_VLAN_PCP = 612,
    OF_OXM_VLAN_PCP_MASKED = 613,
    OF_OXM_VLAN_VID = 614,
    OF_OXM_VLAN_VID_MASKED = 615,
    OF_PACKET_QUEUE = 616,
    OF_PORT_DESC = 617,
    OF_PORT_DESC_PROP = 618,
    OF_PORT_DESC_PROP_BSN = 619,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 620,
    OF_PORT_DESC_PROP_BSN_UPLINK = 621,
    OF_PORT_DESC_PROP_ETHERNET = 622,
    OF_PORT_DESC_PROP_EXPERIMENTER = 623,
    OF_PORT_DESC_PROP_OPTICAL = 624,
    OF_PORT_MOD_PROP = 625,
    OF_PORT_MOD_PROP_ETHERNET = 626,
    OF_PORT_MOD_PROP_EXPERIMENTER = 627,
    OF_PORT_MOD_PROP_OPTICAL = 628,
    OF_PORT_STATS_ENTRY = 629,
    OF_PORT_STATS_PROP = 630,
    OF_PORT_STATS_PROP_ETHERNET = 631,
    OF_PORT_STATS_PROP_EXPERIMENTER = 632,
    OF_PORT_STATS_PROP_OPTICAL = 633,
    OF_QUEUE_DESC = 634,
    OF_QUEUE_DESC_PROP = 635,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 636,
    OF_QUEUE_DESC_PROP_MAX_RATE = 637,
    OF_QUEUE_DESC_PROP_MIN_RATE = 638,
    OF_QUEUE_PROP = 639,
    OF_QUEUE_PROP_EXPERIMENTER = 640,
    OF_QUEUE_PROP_MAX_RATE = 641,
    OF_QUEUE_PROP_MIN_RATE = 642,
    OF_QUEUE_STATS_ENTRY = 643,
    OF_QUEUE_STATS_PROP = 644,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 645,
    OF_ROLE_PROP = 646,
    OF_ROLE_PROP_EXPERIMENTER = 647,
    OF_TABLE_DESC = 648,
    OF_TABLE_FEATURE_PROP = 649,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 650,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 651,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 652,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 653,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 654,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 655,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 656,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 657,
    OF_TABLE_FEATURE_PROP_MATCH = 658,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 659,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 660,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 661,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 662,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 663,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 664,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 665,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 666,
    OF_TABLE_FEATURES = 667,
    OF_TABLE_MOD_PROP = 668,
    OF_TABLE_MOD_PROP_EVICTION = 669,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 670,
    OF_TABLE_MOD_PROP_VACANCY = 671,
    OF_TABLE_STATS_ENTRY = 672,
    OF_UINT32 = 673,
    OF_UINT64 = 674,
    OF_UINT8 = 675,
    ...
    /* List objects */
    OF_LIST_ACTION = 676,
    OF_LIST_ACTION_ID = 677,
    OF_LIST_ASYNC_CONFIG_PROP = 678,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 679,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 680,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 681,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 682,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 683,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 684,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 685,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 686,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 687,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 688,
    OF_LIST_BSN_INTERFACE = 689,
    OF_LIST_BSN_LACP_STATS_ENTRY = 690,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 691,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 692,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 693,
    OF_LIST_BSN_TLV = 694,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 695,
    OF_LIST_BSN_VLAN_MAC = 696,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 697,
    OF_LIST_BUCKET = 698,
    OF_LIST_BUCKET_COUNTER = 699,
    OF_LIST_BUNDLE_PROP = 700,
    OF_LIST_FLOW_STATS_ENTRY = 701,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 702,
    OF_LIST_GROUP_STATS_ENTRY = 703,
    OF_LIST_HELLO_ELEM = 704,
    OF_LIST_INSTRUCTION = 705,
    OF_LIST_INSTRUCTION_ID = 706,
    OF_LIST_METER_BAND = 707,
    OF_LIST_METER_BAND_STATS = 708,
    OF_LIST_METER_CONFIG = 709,
    OF_LIST_METER_STATS = 710,
    OF_LIST_OXM = 711,
    OF_LIST_PACKET_QUEUE = 712,
    OF_LIST_PORT_DESC = 713,
    OF_LIST_PORT_DESC_PROP = 714,
    OF_LIST_PORT_MOD_PROP = 715,
    OF_LIST_PORT_STATS_ENTRY = 716,
    OF_LIST_PORT_STATS_PROP = 717,
    OF_LIST_QUEUE_DESC = 718,
    OF_LIST_QUEUE_DESC_PROP = 719,
    OF_LIST_QUEUE_PROP = 720,
    OF_LIST_QUEUE_STATS_ENTRY = 721,
    OF_LIST_QUEUE_STATS_PROP = 722,
    OF_LIST_ROLE_PROP = 723,
    OF_LIST_TABLE_DESC = 724,
    OF_LIST_TABLE_FEATURE_PROP = 725,
    OF_LIST_TABLE_FEATURES = 726,
    OF_LIST_TABLE_MOD_PROP = 727,
    OF_LIST_TABLE_STATS_ENTRY = 728,
    OF_LIST_UINT32 = 729,
    OF_LIST_UINT64 = 730,
    OF_LIST_UINT8 = 731,
