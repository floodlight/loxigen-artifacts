...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 263,
    OF_INSTRUCTION_CLEAR_ACTIONS = 264,
    OF_INSTRUCTION_EXPERIMENTER = 265,
    OF_INSTRUCTION_GOTO_TABLE = 266,
    OF_INSTRUCTION_HEADER = 267,
    OF_INSTRUCTION_ID = 268,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 269,
    OF_INSTRUCTION_ID_BSN = 270,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 271,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 272,
    OF_INSTRUCTION_ID_EXPERIMENTER = 273,
    OF_INSTRUCTION_ID_GOTO_TABLE = 274,
    OF_INSTRUCTION_ID_HEADER = 275,
    OF_INSTRUCTION_ID_METER = 276,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 277,
    OF_INSTRUCTION_ID_WRITE_METADATA = 278,
    OF_INSTRUCTION_METER = 279,
    OF_INSTRUCTION_WRITE_ACTIONS = 280,
    OF_INSTRUCTION_WRITE_METADATA = 281,
    OF_MATCH_V1 = 282,
    OF_MATCH_V2 = 283,
    OF_MATCH_V3 = 284,
    OF_METER_BAND = 285,
    OF_METER_BAND_DROP = 286,
    OF_METER_BAND_DSCP_REMARK = 287,
    OF_METER_BAND_EXPERIMENTER = 288,
    OF_METER_BAND_HEADER = 289,
    OF_METER_BAND_STATS = 290,
    OF_METER_CONFIG = 291,
    OF_METER_FEATURES = 292,
    OF_METER_STATS = 293,
    OF_OXM = 294,
    OF_OXM_ARP_OP = 295,
    OF_OXM_ARP_OP_MASKED = 296,
    OF_OXM_ARP_SHA = 297,
    OF_OXM_ARP_SHA_MASKED = 298,
    OF_OXM_ARP_SPA = 299,
    OF_OXM_ARP_SPA_MASKED = 300,
    OF_OXM_ARP_THA = 301,
    OF_OXM_ARP_THA_MASKED = 302,
    OF_OXM_ARP_TPA = 303,
    OF_OXM_ARP_TPA_MASKED = 304,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 305,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 306,
    OF_OXM_BSN_IN_PORTS_128 = 307,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 308,
    OF_OXM_BSN_L3_DST_CLASS_ID = 309,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 310,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 311,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 312,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 313,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 314,
    OF_OXM_BSN_LAG_ID = 315,
    OF_OXM_BSN_LAG_ID_MASKED = 316,
    OF_OXM_BSN_VRF = 317,
    OF_OXM_BSN_VRF_MASKED = 318,
    OF_OXM_ETH_DST = 319,
    OF_OXM_ETH_DST_MASKED = 320,
    OF_OXM_ETH_SRC = 321,
    OF_OXM_ETH_SRC_MASKED = 322,
    OF_OXM_ETH_TYPE = 323,
    OF_OXM_ETH_TYPE_MASKED = 324,
    OF_OXM_HEADER = 325,
    OF_OXM_ICMPV4_CODE = 326,
    OF_OXM_ICMPV4_CODE_MASKED = 327,
    OF_OXM_ICMPV4_TYPE = 328,
    OF_OXM_ICMPV4_TYPE_MASKED = 329,
    OF_OXM_ICMPV6_CODE = 330,
    OF_OXM_ICMPV6_CODE_MASKED = 331,
    OF_OXM_ICMPV6_TYPE = 332,
    OF_OXM_ICMPV6_TYPE_MASKED = 333,
    OF_OXM_IN_PHY_PORT = 334,
    OF_OXM_IN_PHY_PORT_MASKED = 335,
    OF_OXM_IN_PORT = 336,
    OF_OXM_IN_PORT_MASKED = 337,
    OF_OXM_IP_DSCP = 338,
    OF_OXM_IP_DSCP_MASKED = 339,
    OF_OXM_IP_ECN = 340,
    OF_OXM_IP_ECN_MASKED = 341,
    OF_OXM_IP_PROTO = 342,
    OF_OXM_IP_PROTO_MASKED = 343,
    OF_OXM_IPV4_DST = 344,
    OF_OXM_IPV4_DST_MASKED = 345,
    OF_OXM_IPV4_SRC = 346,
    OF_OXM_IPV4_SRC_MASKED = 347,
    OF_OXM_IPV6_DST = 348,
    OF_OXM_IPV6_DST_MASKED = 349,
    OF_OXM_IPV6_FLABEL = 350,
    OF_OXM_IPV6_FLABEL_MASKED = 351,
    OF_OXM_IPV6_ND_SLL = 352,
    OF_OXM_IPV6_ND_SLL_MASKED = 353,
    OF_OXM_IPV6_ND_TARGET = 354,
    OF_OXM_IPV6_ND_TARGET_MASKED = 355,
    OF_OXM_IPV6_ND_TLL = 356,
    OF_OXM_IPV6_ND_TLL_MASKED = 357,
    OF_OXM_IPV6_SRC = 358,
    OF_OXM_IPV6_SRC_MASKED = 359,
    OF_OXM_METADATA = 360,
    OF_OXM_METADATA_MASKED = 361,
    OF_OXM_MPLS_LABEL = 362,
    OF_OXM_MPLS_LABEL_MASKED = 363,
    OF_OXM_MPLS_TC = 364,
    OF_OXM_MPLS_TC_MASKED = 365,
    OF_OXM_SCTP_DST = 366,
    OF_OXM_SCTP_DST_MASKED = 367,
    OF_OXM_SCTP_SRC = 368,
    OF_OXM_SCTP_SRC_MASKED = 369,
    OF_OXM_TCP_DST = 370,
    OF_OXM_TCP_DST_MASKED = 371,
    OF_OXM_TCP_SRC = 372,
    OF_OXM_TCP_SRC_MASKED = 373,
    OF_OXM_UDP_DST = 374,
    OF_OXM_UDP_DST_MASKED = 375,
    OF_OXM_UDP_SRC = 376,
    OF_OXM_UDP_SRC_MASKED = 377,
    OF_OXM_VLAN_PCP = 378,
    OF_OXM_VLAN_PCP_MASKED = 379,
    OF_OXM_VLAN_VID = 380,
    OF_OXM_VLAN_VID_MASKED = 381,
    OF_PACKET_QUEUE = 382,
    OF_PORT_DESC = 383,
    OF_PORT_STATS_ENTRY = 384,
    OF_QUEUE_PROP = 385,
    OF_QUEUE_PROP_EXPERIMENTER = 386,
    OF_QUEUE_PROP_HEADER = 387,
    OF_QUEUE_PROP_MAX_RATE = 388,
    OF_QUEUE_PROP_MIN_RATE = 389,
    OF_QUEUE_STATS_ENTRY = 390,
    OF_TABLE_FEATURE_PROP = 391,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 392,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 393,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 394,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 395,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 396,
    OF_TABLE_FEATURE_PROP_HEADER = 397,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 398,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 399,
    OF_TABLE_FEATURE_PROP_MATCH = 400,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 401,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 402,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 403,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 404,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 405,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 406,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 407,
    OF_TABLE_FEATURES = 408,
    OF_TABLE_STATS_ENTRY = 409,
    OF_UINT32 = 410,
    OF_UINT64 = 411,
    OF_UINT8 = 412,
    ...
    /* List objects */
    OF_LIST_ACTION = 413,
    OF_LIST_ACTION_ID = 414,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 415,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 416,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 417,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 418,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 419,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 420,
    OF_LIST_BSN_INTERFACE = 421,
    OF_LIST_BSN_LACP_STATS_ENTRY = 422,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 423,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 424,
    OF_LIST_BSN_TLV = 425,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 426,
    OF_LIST_BUCKET = 427,
    OF_LIST_BUCKET_COUNTER = 428,
    OF_LIST_FLOW_STATS_ENTRY = 429,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 430,
    OF_LIST_GROUP_STATS_ENTRY = 431,
    OF_LIST_HELLO_ELEM = 432,
    OF_LIST_INSTRUCTION = 433,
    OF_LIST_METER_BAND = 434,
    OF_LIST_METER_BAND_STATS = 435,
    OF_LIST_METER_STATS = 436,
    OF_LIST_OXM = 437,
    OF_LIST_PACKET_QUEUE = 438,
    OF_LIST_PORT_DESC = 439,
    OF_LIST_PORT_STATS_ENTRY = 440,
    OF_LIST_QUEUE_PROP = 441,
    OF_LIST_QUEUE_STATS_ENTRY = 442,
    OF_LIST_TABLE_FEATURE_PROP = 443,
    OF_LIST_TABLE_FEATURES = 444,
    OF_LIST_TABLE_STATS_ENTRY = 445,
    OF_LIST_UINT32 = 446,
    OF_LIST_UINT64 = 447,
    OF_LIST_UINT8 = 448,
