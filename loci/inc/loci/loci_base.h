...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_FABRIC_PORT_ROLE = 338,
    OF_BSN_TLV_FLOOD = 339,
    OF_BSN_TLV_FORCE_LINK_UP = 340,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 341,
    OF_BSN_TLV_GENERATION_ID = 342,
    OF_BSN_TLV_HASH_ALGORITHM = 343,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 344,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 345,
    OF_BSN_TLV_HASH_PACKET_FIELD = 346,
    OF_BSN_TLV_HASH_PACKET_TYPE = 347,
    OF_BSN_TLV_HASH_SEED = 348,
    OF_BSN_TLV_HASH_TYPE = 349,
    OF_BSN_TLV_HEADER_SIZE = 350,
    OF_BSN_TLV_ICMP_CODE = 351,
    OF_BSN_TLV_ICMP_ID = 352,
    OF_BSN_TLV_ICMP_TYPE = 353,
    OF_BSN_TLV_ICMPV6_CHKSUM = 354,
    OF_BSN_TLV_IDLE_NOTIFICATION = 355,
    OF_BSN_TLV_IDLE_TIME = 356,
    OF_BSN_TLV_IDLE_TIMEOUT = 357,
    OF_BSN_TLV_IGMP_SNOOPING = 358,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 359,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 360,
    OF_BSN_TLV_INTERNAL_MAC = 361,
    OF_BSN_TLV_INTERVAL = 362,
    OF_BSN_TLV_IP_PROTO = 363,
    OF_BSN_TLV_IPV4 = 364,
    OF_BSN_TLV_IPV4_DST = 365,
    OF_BSN_TLV_IPV4_NETMASK = 366,
    OF_BSN_TLV_IPV4_SRC = 367,
    OF_BSN_TLV_IPV6 = 368,
    OF_BSN_TLV_IPV6_DST = 369,
    OF_BSN_TLV_IPV6_PREFIX = 370,
    OF_BSN_TLV_IPV6_SRC = 371,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 372,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 373,
    OF_BSN_TLV_L3_DST_CLASS_ID = 374,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 375,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 376,
    OF_BSN_TLV_LAG_OPTIONS = 377,
    OF_BSN_TLV_LOOPBACK_MODE = 378,
    OF_BSN_TLV_LOOPBACK_PORT = 379,
    OF_BSN_TLV_MAC = 380,
    OF_BSN_TLV_MAC_MASK = 381,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 382,
    OF_BSN_TLV_MISS_PACKETS = 383,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 384,
    OF_BSN_TLV_MPLS_LABEL = 385,
    OF_BSN_TLV_MPLS_SEQUENCED = 386,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 387,
    OF_BSN_TLV_NAME = 388,
    OF_BSN_TLV_NDP_OFFLOAD = 389,
    OF_BSN_TLV_NDP_STATIC = 390,
    OF_BSN_TLV_NEGATE = 391,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 392,
    OF_BSN_TLV_NEXT_HOP_MAC = 393,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 394,
    OF_BSN_TLV_NO_ARP_RESPONSE = 395,
    OF_BSN_TLV_NO_NS_RESPONSE = 396,
    OF_BSN_TLV_OFFSET = 397,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 398,
    OF_BSN_TLV_OUTER_SRC_MAC = 399,
    OF_BSN_TLV_PARENT_PORT = 400,
    OF_BSN_TLV_PARTNER_KEY = 401,
    OF_BSN_TLV_PARTNER_PORT_NUM = 402,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 403,
    OF_BSN_TLV_PARTNER_STATE = 404,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 405,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 406,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 407,
    OF_BSN_TLV_PORT = 408,
    OF_BSN_TLV_PORT_SPEED_GBPS = 409,
    OF_BSN_TLV_PORT_USAGE = 410,
    OF_BSN_TLV_PORT_VXLAN_MODE = 411,
    OF_BSN_TLV_PRIORITY = 412,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 413,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 414,
    OF_BSN_TLV_QOS_PRIORITY = 415,
    OF_BSN_TLV_QUEUE_ID = 416,
    OF_BSN_TLV_QUEUE_WEIGHT = 417,
    OF_BSN_TLV_RATE_LIMIT = 418,
    OF_BSN_TLV_RATE_UNIT = 419,
    OF_BSN_TLV_RECORD_PACKETS = 420,
    OF_BSN_TLV_REFERENCE = 421,
    OF_BSN_TLV_REPLY_PACKETS = 422,
    OF_BSN_TLV_REQUEST_PACKETS = 423,
    OF_BSN_TLV_REST_SERVER = 424,
    OF_BSN_TLV_ROUTING_PARAM = 425,
    OF_BSN_TLV_RX_BYTES = 426,
    OF_BSN_TLV_RX_PACKETS = 427,
    OF_BSN_TLV_SAMPLING_RATE = 428,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 429,
    OF_BSN_TLV_STATUS = 430,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 431,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 432,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 433,
    OF_BSN_TLV_SUB_AGENT_ID = 434,
    OF_BSN_TLV_TCP_DST = 435,
    OF_BSN_TLV_TCP_FLAGS = 436,
    OF_BSN_TLV_TCP_SRC = 437,
    OF_BSN_TLV_TIMESTAMP = 438,
    OF_BSN_TLV_TTL = 439,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 440,
    OF_BSN_TLV_TX_BYTES = 441,
    OF_BSN_TLV_TX_PACKETS = 442,
    OF_BSN_TLV_UDF_ANCHOR = 443,
    OF_BSN_TLV_UDF_ID = 444,
    OF_BSN_TLV_UDF_LENGTH = 445,
    OF_BSN_TLV_UDF_OFFSET = 446,
    OF_BSN_TLV_UDP_DST = 447,
    OF_BSN_TLV_UDP_SRC = 448,
    OF_BSN_TLV_UINT64_LIST = 449,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 450,
    OF_BSN_TLV_UNICAST_RATE = 451,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 452,
    OF_BSN_TLV_UNTAGGED = 453,
    OF_BSN_TLV_UPGRADE = 454,
    OF_BSN_TLV_URI_SCHEME = 455,
    OF_BSN_TLV_USE_PACKET_STATE = 456,
    OF_BSN_TLV_VFI = 457,
    OF_BSN_TLV_VFP_CLASS_ID = 458,
    OF_BSN_TLV_VIRTUAL = 459,
    OF_BSN_TLV_VLAN_MAC_LIST = 460,
    OF_BSN_TLV_VLAN_PCP = 461,
    OF_BSN_TLV_VLAN_VID = 462,
    OF_BSN_TLV_VLAN_VID_MASK = 463,
    OF_BSN_TLV_VNI = 464,
    OF_BSN_TLV_VPN_KEY = 465,
    OF_BSN_TLV_VRF = 466,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 467,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 468,
    OF_BSN_VLAN_MAC = 469,
    OF_BSN_VPORT = 470,
    OF_BSN_VPORT_L2GRE = 471,
    OF_BSN_VPORT_Q_IN_Q = 472,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 473,
    OF_BUCKET = 474,
    OF_BUCKET_COUNTER = 475,
    OF_BUNDLE_PROP = 476,
    OF_BUNDLE_PROP_EXPERIMENTER = 477,
    OF_FLOW_STATS_ENTRY = 478,
    OF_GROUP_DESC_STATS_ENTRY = 479,
    OF_GROUP_STATS_ENTRY = 480,
    OF_HELLO_ELEM = 481,
    OF_HELLO_ELEM_VERSIONBITMAP = 482,
    OF_INSTRUCTION = 483,
    OF_INSTRUCTION_APPLY_ACTIONS = 484,
    OF_INSTRUCTION_BSN = 485,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 486,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 487,
    OF_INSTRUCTION_BSN_DENY = 488,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 489,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 490,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 491,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 492,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 493,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 494,
    OF_INSTRUCTION_BSN_HASH_SELECT = 495,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 496,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 497,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 498,
    OF_INSTRUCTION_BSN_PERMIT = 499,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 500,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 501,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 502,
    OF_INSTRUCTION_CLEAR_ACTIONS = 503,
    OF_INSTRUCTION_EXPERIMENTER = 504,
    OF_INSTRUCTION_GOTO_TABLE = 505,
    OF_INSTRUCTION_ID = 506,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 507,
    OF_INSTRUCTION_ID_BSN = 508,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 509,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 510,
    OF_INSTRUCTION_ID_BSN_DENY = 511,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 512,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 513,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 514,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 515,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 516,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 517,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 518,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 519,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 520,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 521,
    OF_INSTRUCTION_ID_BSN_PERMIT = 522,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 523,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 524,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 525,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 526,
    OF_INSTRUCTION_ID_EXPERIMENTER = 527,
    OF_INSTRUCTION_ID_GOTO_TABLE = 528,
    OF_INSTRUCTION_ID_METER = 529,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 530,
    OF_INSTRUCTION_ID_WRITE_METADATA = 531,
    OF_INSTRUCTION_METER = 532,
    OF_INSTRUCTION_WRITE_ACTIONS = 533,
    OF_INSTRUCTION_WRITE_METADATA = 534,
    OF_MATCH_V1 = 535,
    OF_MATCH_V2 = 536,
    OF_MATCH_V3 = 537,
    OF_METER_BAND = 538,
    OF_METER_BAND_DROP = 539,
    OF_METER_BAND_DSCP_REMARK = 540,
    OF_METER_BAND_EXPERIMENTER = 541,
    OF_METER_BAND_STATS = 542,
    OF_METER_CONFIG = 543,
    OF_METER_FEATURES = 544,
    OF_METER_STATS = 545,
    OF_OXM = 546,
    OF_OXM_ARP_OP = 547,
    OF_OXM_ARP_OP_MASKED = 548,
    OF_OXM_ARP_SHA = 549,
    OF_OXM_ARP_SHA_MASKED = 550,
    OF_OXM_ARP_SPA = 551,
    OF_OXM_ARP_SPA_MASKED = 552,
    OF_OXM_ARP_THA = 553,
    OF_OXM_ARP_THA_MASKED = 554,
    OF_OXM_ARP_TPA = 555,
    OF_OXM_ARP_TPA_MASKED = 556,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 557,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 558,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 559,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 560,
    OF_OXM_BSN_IFP_CLASS_ID = 561,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 562,
    OF_OXM_BSN_IN_PORTS_128 = 563,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 564,
    OF_OXM_BSN_IN_PORTS_512 = 565,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 566,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 567,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 568,
    OF_OXM_BSN_INNER_ETH_DST = 569,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 570,
    OF_OXM_BSN_INNER_ETH_SRC = 571,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 572,
    OF_OXM_BSN_INNER_VLAN_VID = 573,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 574,
    OF_OXM_BSN_IP_FRAGMENTATION = 575,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 576,
    OF_OXM_BSN_L2_CACHE_HIT = 577,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 578,
    OF_OXM_BSN_L3_DST_CLASS_ID = 579,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 580,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 581,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 582,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 583,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 584,
    OF_OXM_BSN_LAG_ID = 585,
    OF_OXM_BSN_LAG_ID_MASKED = 586,
    OF_OXM_BSN_TCP_FLAGS = 587,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 588,
    OF_OXM_BSN_UDF0 = 589,
    OF_OXM_BSN_UDF0_MASKED = 590,
    OF_OXM_BSN_UDF1 = 591,
    OF_OXM_BSN_UDF1_MASKED = 592,
    OF_OXM_BSN_UDF2 = 593,
    OF_OXM_BSN_UDF2_MASKED = 594,
    OF_OXM_BSN_UDF3 = 595,
    OF_OXM_BSN_UDF3_MASKED = 596,
    OF_OXM_BSN_UDF4 = 597,
    OF_OXM_BSN_UDF4_MASKED = 598,
    OF_OXM_BSN_UDF5 = 599,
    OF_OXM_BSN_UDF5_MASKED = 600,
    OF_OXM_BSN_UDF6 = 601,
    OF_OXM_BSN_UDF6_MASKED = 602,
    OF_OXM_BSN_UDF7 = 603,
    OF_OXM_BSN_UDF7_MASKED = 604,
    OF_OXM_BSN_VFI = 605,
    OF_OXM_BSN_VFI_MASKED = 606,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 607,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 608,
    OF_OXM_BSN_VRF = 609,
    OF_OXM_BSN_VRF_MASKED = 610,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 611,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 612,
    OF_OXM_CONN_TRACKING_IPV6_DST = 613,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 614,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 615,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 616,
    OF_OXM_CONN_TRACKING_LABEL = 617,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 618,
    OF_OXM_CONN_TRACKING_MARK = 619,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 620,
    OF_OXM_CONN_TRACKING_NW_DST = 621,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 622,
    OF_OXM_CONN_TRACKING_NW_PROTO = 623,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 624,
    OF_OXM_CONN_TRACKING_NW_SRC = 625,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 626,
    OF_OXM_CONN_TRACKING_STATE = 627,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 628,
    OF_OXM_CONN_TRACKING_TP_DST = 629,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 630,
    OF_OXM_CONN_TRACKING_TP_SRC = 631,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 632,
    OF_OXM_CONN_TRACKING_ZONE = 633,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 634,
    OF_OXM_ETH_DST = 635,
    OF_OXM_ETH_DST_MASKED = 636,
    OF_OXM_ETH_SRC = 637,
    OF_OXM_ETH_SRC_MASKED = 638,
    OF_OXM_ETH_TYPE = 639,
    OF_OXM_ETH_TYPE_MASKED = 640,
    OF_OXM_ICMPV4_CODE = 641,
    OF_OXM_ICMPV4_CODE_MASKED = 642,
    OF_OXM_ICMPV4_TYPE = 643,
    OF_OXM_ICMPV4_TYPE_MASKED = 644,
    OF_OXM_ICMPV6_CODE = 645,
    OF_OXM_ICMPV6_CODE_MASKED = 646,
    OF_OXM_ICMPV6_TYPE = 647,
    OF_OXM_ICMPV6_TYPE_MASKED = 648,
    OF_OXM_IN_PHY_PORT = 649,
    OF_OXM_IN_PHY_PORT_MASKED = 650,
    OF_OXM_IN_PORT = 651,
    OF_OXM_IN_PORT_MASKED = 652,
    OF_OXM_IP_DSCP = 653,
    OF_OXM_IP_DSCP_MASKED = 654,
    OF_OXM_IP_ECN = 655,
    OF_OXM_IP_ECN_MASKED = 656,
    OF_OXM_IP_PROTO = 657,
    OF_OXM_IP_PROTO_MASKED = 658,
    OF_OXM_IPV4_DST = 659,
    OF_OXM_IPV4_DST_MASKED = 660,
    OF_OXM_IPV4_SRC = 661,
    OF_OXM_IPV4_SRC_MASKED = 662,
    OF_OXM_IPV6_DST = 663,
    OF_OXM_IPV6_DST_MASKED = 664,
    OF_OXM_IPV6_EXTHDR = 665,
    OF_OXM_IPV6_EXTHDR_MASKED = 666,
    OF_OXM_IPV6_FLABEL = 667,
    OF_OXM_IPV6_FLABEL_MASKED = 668,
    OF_OXM_IPV6_ND_SLL = 669,
    OF_OXM_IPV6_ND_SLL_MASKED = 670,
    OF_OXM_IPV6_ND_TARGET = 671,
    OF_OXM_IPV6_ND_TARGET_MASKED = 672,
    OF_OXM_IPV6_ND_TLL = 673,
    OF_OXM_IPV6_ND_TLL_MASKED = 674,
    OF_OXM_IPV6_SRC = 675,
    OF_OXM_IPV6_SRC_MASKED = 676,
    OF_OXM_METADATA = 677,
    OF_OXM_METADATA_MASKED = 678,
    OF_OXM_MPLS_BOS = 679,
    OF_OXM_MPLS_BOS_MASKED = 680,
    OF_OXM_MPLS_LABEL = 681,
    OF_OXM_MPLS_LABEL_MASKED = 682,
    OF_OXM_MPLS_TC = 683,
    OF_OXM_MPLS_TC_MASKED = 684,
    OF_OXM_OVS_TCP_FLAGS = 685,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 686,
    OF_OXM_PBB_UCA = 687,
    OF_OXM_PBB_UCA_MASKED = 688,
    OF_OXM_SCTP_DST = 689,
    OF_OXM_SCTP_DST_MASKED = 690,
    OF_OXM_SCTP_SRC = 691,
    OF_OXM_SCTP_SRC_MASKED = 692,
    OF_OXM_TCP_DST = 693,
    OF_OXM_TCP_DST_MASKED = 694,
    OF_OXM_TCP_SRC = 695,
    OF_OXM_TCP_SRC_MASKED = 696,
    OF_OXM_TUNNEL_ID = 697,
    OF_OXM_TUNNEL_ID_MASKED = 698,
    OF_OXM_TUNNEL_IPV4_DST = 699,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 700,
    OF_OXM_TUNNEL_IPV4_SRC = 701,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 702,
    OF_OXM_TUNNEL_IPV6_DST = 703,
    OF_OXM_TUNNEL_IPV6_DST_MASKED = 704,
    OF_OXM_TUNNEL_IPV6_SRC = 705,
    OF_OXM_TUNNEL_IPV6_SRC_MASKED = 706,
    OF_OXM_UDP_DST = 707,
    OF_OXM_UDP_DST_MASKED = 708,
    OF_OXM_UDP_SRC = 709,
    OF_OXM_UDP_SRC_MASKED = 710,
    OF_OXM_VLAN_PCP = 711,
    OF_OXM_VLAN_PCP_MASKED = 712,
    OF_OXM_VLAN_VID = 713,
    OF_OXM_VLAN_VID_MASKED = 714,
    OF_PACKET_QUEUE = 715,
    OF_PORT_DESC = 716,
    OF_PORT_DESC_PROP = 717,
    OF_PORT_DESC_PROP_BSN = 718,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 719,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 720,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 721,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 722,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 723,
    OF_PORT_DESC_PROP_BSN_UPLINK = 724,
    OF_PORT_DESC_PROP_ETHERNET = 725,
    OF_PORT_DESC_PROP_EXPERIMENTER = 726,
    OF_PORT_DESC_PROP_OPTICAL = 727,
    OF_PORT_MOD_PROP = 728,
    OF_PORT_MOD_PROP_ETHERNET = 729,
    OF_PORT_MOD_PROP_EXPERIMENTER = 730,
    OF_PORT_MOD_PROP_OPTICAL = 731,
    OF_PORT_STATS_ENTRY = 732,
    OF_PORT_STATS_PROP = 733,
    OF_PORT_STATS_PROP_ETHERNET = 734,
    OF_PORT_STATS_PROP_EXPERIMENTER = 735,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 736,
    OF_PORT_STATS_PROP_OPTICAL = 737,
    OF_QUEUE_DESC = 738,
    OF_QUEUE_DESC_PROP = 739,
    OF_QUEUE_DESC_PROP_BSN = 740,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 741,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 742,
    OF_QUEUE_DESC_PROP_MAX_RATE = 743,
    OF_QUEUE_DESC_PROP_MIN_RATE = 744,
    OF_QUEUE_PROP = 745,
    OF_QUEUE_PROP_EXPERIMENTER = 746,
    OF_QUEUE_PROP_MAX_RATE = 747,
    OF_QUEUE_PROP_MIN_RATE = 748,
    OF_QUEUE_STATS_ENTRY = 749,
    OF_QUEUE_STATS_PROP = 750,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 751,
    OF_ROLE_PROP = 752,
    OF_ROLE_PROP_EXPERIMENTER = 753,
    OF_TABLE_DESC = 754,
    OF_TABLE_FEATURE_PROP = 755,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 756,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 757,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 758,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 759,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 760,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 761,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 762,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 763,
    OF_TABLE_FEATURE_PROP_MATCH = 764,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 765,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 766,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 767,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 768,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 769,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 770,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 771,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 772,
    OF_TABLE_FEATURES = 773,
    OF_TABLE_MOD_PROP = 774,
    OF_TABLE_MOD_PROP_EVICTION = 775,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 776,
    OF_TABLE_MOD_PROP_VACANCY = 777,
    OF_TABLE_STATS_ENTRY = 778,
    OF_UINT32 = 779,
    OF_UINT64 = 780,
    OF_UINT8 = 781,
    ...
    /* List objects */
    OF_LIST_ACTION = 782,
    OF_LIST_ACTION_ID = 783,
    OF_LIST_ASYNC_CONFIG_PROP = 784,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 785,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 786,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 787,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 788,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 789,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 790,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 791,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 792,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 793,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 794,
    OF_LIST_BSN_INTERFACE = 795,
    OF_LIST_BSN_LACP_STATS_ENTRY = 796,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 797,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 798,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 799,
    OF_LIST_BSN_TLV = 800,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 801,
    OF_LIST_BSN_VLAN_MAC = 802,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 803,
    OF_LIST_BUCKET = 804,
    OF_LIST_BUCKET_COUNTER = 805,
    OF_LIST_BUNDLE_PROP = 806,
    OF_LIST_FLOW_STATS_ENTRY = 807,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 808,
    OF_LIST_GROUP_STATS_ENTRY = 809,
    OF_LIST_HELLO_ELEM = 810,
    OF_LIST_INSTRUCTION = 811,
    OF_LIST_INSTRUCTION_ID = 812,
    OF_LIST_METER_BAND = 813,
    OF_LIST_METER_BAND_STATS = 814,
    OF_LIST_METER_CONFIG = 815,
    OF_LIST_METER_STATS = 816,
    OF_LIST_OXM = 817,
    OF_LIST_PACKET_QUEUE = 818,
    OF_LIST_PORT_DESC = 819,
    OF_LIST_PORT_DESC_PROP = 820,
    OF_LIST_PORT_MOD_PROP = 821,
    OF_LIST_PORT_STATS_ENTRY = 822,
    OF_LIST_PORT_STATS_PROP = 823,
    OF_LIST_QUEUE_DESC = 824,
    OF_LIST_QUEUE_DESC_PROP = 825,
    OF_LIST_QUEUE_PROP = 826,
    OF_LIST_QUEUE_STATS_ENTRY = 827,
    OF_LIST_QUEUE_STATS_PROP = 828,
    OF_LIST_ROLE_PROP = 829,
    OF_LIST_TABLE_DESC = 830,
    OF_LIST_TABLE_FEATURE_PROP = 831,
    OF_LIST_TABLE_FEATURES = 832,
    OF_LIST_TABLE_MOD_PROP = 833,
    OF_LIST_TABLE_STATS_ENTRY = 834,
    OF_LIST_UINT32 = 835,
    OF_LIST_UINT64 = 836,
    OF_LIST_UINT8 = 837,
...
/* Mask/value check/set macros for tunnel_ipv6_src */

/**
 * Set the mask for an exact match of tunnel_ipv6_src
 */
#define OF_MATCH_MASK_TUNNEL_IPV6_SRC_EXACT_SET(_match)   \
    MEMSET(&(_match)->masks.tunnel_ipv6_src, 0xff, \
        sizeof(((_match)->masks).tunnel_ipv6_src))

/**
 * Clear the mask for tunnel_ipv6_src making that field inactive for the match
 */
#define OF_MATCH_MASK_TUNNEL_IPV6_SRC_CLEAR(_match) \
    MEMSET(&(_match)->masks.tunnel_ipv6_src, 0, \
        sizeof(((_match)->masks).tunnel_ipv6_src))

/**
 * Test whether the match is exact for tunnel_ipv6_src
 */
#define OF_MATCH_MASK_TUNNEL_IPV6_SRC_EXACT_TEST(_match) \
    OF_VARIABLE_IS_ALL_ONES(&(((_match)->masks).tunnel_ipv6_src))

/**
 * Test whether key tunnel_ipv6_src is being checked in the match
 */
#define OF_MATCH_MASK_TUNNEL_IPV6_SRC_ACTIVE_TEST(_match) \
    OF_VARIABLE_IS_NON_ZERO(&(((_match)->masks).tunnel_ipv6_src))
...
/* Mask/value check/set macros for tunnel_ipv6_dst */

/**
 * Set the mask for an exact match of tunnel_ipv6_dst
 */
#define OF_MATCH_MASK_TUNNEL_IPV6_DST_EXACT_SET(_match)   \
    MEMSET(&(_match)->masks.tunnel_ipv6_dst, 0xff, \
        sizeof(((_match)->masks).tunnel_ipv6_dst))

/**
 * Clear the mask for tunnel_ipv6_dst making that field inactive for the match
 */
#define OF_MATCH_MASK_TUNNEL_IPV6_DST_CLEAR(_match) \
    MEMSET(&(_match)->masks.tunnel_ipv6_dst, 0, \
        sizeof(((_match)->masks).tunnel_ipv6_dst))

/**
 * Test whether the match is exact for tunnel_ipv6_dst
 */
#define OF_MATCH_MASK_TUNNEL_IPV6_DST_EXACT_TEST(_match) \
    OF_VARIABLE_IS_ALL_ONES(&(((_match)->masks).tunnel_ipv6_dst))

/**
 * Test whether key tunnel_ipv6_dst is being checked in the match
 */
#define OF_MATCH_MASK_TUNNEL_IPV6_DST_ACTIVE_TEST(_match) \
    OF_VARIABLE_IS_NON_ZERO(&(((_match)->masks).tunnel_ipv6_dst))
