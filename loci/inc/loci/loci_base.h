...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_MCG_TYPE_VXLAN = 420,
    OF_BSN_TLV_METADATA = 421,
    OF_BSN_TLV_MGMT = 422,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 423,
    OF_BSN_TLV_MISS_PACKETS = 424,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 425,
    OF_BSN_TLV_MPLS_LABEL = 426,
    OF_BSN_TLV_MPLS_SEQUENCED = 427,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 428,
    OF_BSN_TLV_MULTICAST_PACKET = 429,
    OF_BSN_TLV_MULTIPLIER = 430,
    OF_BSN_TLV_NAME = 431,
    OF_BSN_TLV_NDP_OFFLOAD = 432,
    OF_BSN_TLV_NDP_STATIC = 433,
    OF_BSN_TLV_NEGATE = 434,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 435,
    OF_BSN_TLV_NEXT_HOP_MAC = 436,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 437,
    OF_BSN_TLV_NO_ARP_RESPONSE = 438,
    OF_BSN_TLV_NO_DROP = 439,
    OF_BSN_TLV_NO_NS_RESPONSE = 440,
    OF_BSN_TLV_OFFSET = 441,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 442,
    OF_BSN_TLV_OUTER_SRC_MAC = 443,
    OF_BSN_TLV_PACKET_FIELD = 444,
    OF_BSN_TLV_PARENT_PORT = 445,
    OF_BSN_TLV_PARTNER_KEY = 446,
    OF_BSN_TLV_PARTNER_PORT_NUM = 447,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 448,
    OF_BSN_TLV_PARTNER_STATE = 449,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 450,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 451,
    OF_BSN_TLV_PASSIVE = 452,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 453,
    OF_BSN_TLV_PIM_DR = 454,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 455,
    OF_BSN_TLV_PORT = 456,
    OF_BSN_TLV_PORT_MODE = 457,
    OF_BSN_TLV_PORT_SPEED_GBPS = 458,
    OF_BSN_TLV_PORT_USAGE = 459,
    OF_BSN_TLV_PORT_VXLAN_MODE = 460,
    OF_BSN_TLV_PRESERVE_VLAN = 461,
    OF_BSN_TLV_PRIORITY = 462,
    OF_BSN_TLV_PUSH_TWO_PER_POLICY = 463,
    OF_BSN_TLV_PUSH_TWO_TAGS_CAPABILITY = 464,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 465,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 466,
    OF_BSN_TLV_QOS_PRIORITY = 467,
    OF_BSN_TLV_QUEUE_ID = 468,
    OF_BSN_TLV_QUEUE_WEIGHT = 469,
    OF_BSN_TLV_RATE_LIMIT = 470,
    OF_BSN_TLV_RATE_UNIT = 471,
    OF_BSN_TLV_RECORD_PACKETS = 472,
    OF_BSN_TLV_REDUNDANT_MGMT = 473,
    OF_BSN_TLV_REFERENCE = 474,
    OF_BSN_TLV_REMOTE_ID = 475,
    OF_BSN_TLV_REPLY_PACKETS = 476,
    OF_BSN_TLV_REQUEST_PACKETS = 477,
    OF_BSN_TLV_REST_SERVER = 478,
    OF_BSN_TLV_ROUTING_PARAM = 479,
    OF_BSN_TLV_RX_BYTES = 480,
    OF_BSN_TLV_RX_PACKETS = 481,
    OF_BSN_TLV_SAMPLING_RATE = 482,
    OF_BSN_TLV_SCTP_DST = 483,
    OF_BSN_TLV_SCTP_SRC = 484,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 485,
    OF_BSN_TLV_SOCKET = 486,
    OF_BSN_TLV_SRC_MAC_CML = 487,
    OF_BSN_TLV_STATUS = 488,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 489,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 490,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 491,
    OF_BSN_TLV_SUB_AGENT_ID = 492,
    OF_BSN_TLV_SWL_FEATURE = 493,
    OF_BSN_TLV_TCP_DST = 494,
    OF_BSN_TLV_TCP_FLAGS = 495,
    OF_BSN_TLV_TCP_SRC = 496,
    OF_BSN_TLV_THREAD = 497,
    OF_BSN_TLV_TIMESTAMP = 498,
    OF_BSN_TLV_TTL = 499,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 500,
    OF_BSN_TLV_TX_BYTES = 501,
    OF_BSN_TLV_TX_PACKETS = 502,
    OF_BSN_TLV_UDF_ANCHOR = 503,
    OF_BSN_TLV_UDF_CAPABILITY = 504,
    OF_BSN_TLV_UDF_DATA = 505,
    OF_BSN_TLV_UDF_ID = 506,
    OF_BSN_TLV_UDF_LENGTH = 507,
    OF_BSN_TLV_UDF_OFFSET = 508,
    OF_BSN_TLV_UDP_DST = 509,
    OF_BSN_TLV_UDP_SRC = 510,
    OF_BSN_TLV_UINT32 = 511,
    OF_BSN_TLV_UINT64_LIST = 512,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 513,
    OF_BSN_TLV_UNICAST_RATE = 514,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 515,
    OF_BSN_TLV_UNTAGGED = 516,
    OF_BSN_TLV_UPGRADE = 517,
    OF_BSN_TLV_URI_SCHEME = 518,
    OF_BSN_TLV_USE_PACKET_STATE = 519,
    OF_BSN_TLV_USER_CONFIGURED = 520,
    OF_BSN_TLV_VFI = 521,
    OF_BSN_TLV_VFP_CLASS_ID = 522,
    OF_BSN_TLV_VIRTUAL = 523,
    OF_BSN_TLV_VLAN_MAC_LIST = 524,
    OF_BSN_TLV_VLAN_PCP = 525,
    OF_BSN_TLV_VLAN_VID = 526,
    OF_BSN_TLV_VLAN_VID_MASK = 527,
    OF_BSN_TLV_VNI = 528,
    OF_BSN_TLV_VPN_KEY = 529,
    OF_BSN_TLV_VRF = 530,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 531,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 532,
    OF_BSN_VLAN_MAC = 533,
    OF_BSN_VPORT = 534,
    OF_BSN_VPORT_L2GRE = 535,
    OF_BSN_VPORT_Q_IN_Q = 536,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 537,
    OF_BUCKET = 538,
    OF_BUCKET_COUNTER = 539,
    OF_BUNDLE_PROP = 540,
    OF_BUNDLE_PROP_EXPERIMENTER = 541,
    OF_FLOW_STATS_ENTRY = 542,
    OF_GROUP_DESC_STATS_ENTRY = 543,
    OF_GROUP_STATS_ENTRY = 544,
    OF_HELLO_ELEM = 545,
    OF_HELLO_ELEM_VERSIONBITMAP = 546,
    OF_INSTRUCTION = 547,
    OF_INSTRUCTION_APPLY_ACTIONS = 548,
    OF_INSTRUCTION_BSN = 549,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 550,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 551,
    OF_INSTRUCTION_BSN_DENY = 552,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 553,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 554,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 555,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 556,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 557,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 558,
    OF_INSTRUCTION_BSN_HASH_SELECT = 559,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 560,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 561,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 562,
    OF_INSTRUCTION_BSN_PERMIT = 563,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 564,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 565,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 566,
    OF_INSTRUCTION_CLEAR_ACTIONS = 567,
    OF_INSTRUCTION_EXPERIMENTER = 568,
    OF_INSTRUCTION_GOTO_TABLE = 569,
    OF_INSTRUCTION_ID = 570,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 571,
    OF_INSTRUCTION_ID_BSN = 572,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 573,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 574,
    OF_INSTRUCTION_ID_BSN_DENY = 575,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 576,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 577,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 578,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 579,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 580,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 581,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 582,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 583,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 584,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 585,
    OF_INSTRUCTION_ID_BSN_PERMIT = 586,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 587,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 588,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 589,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 590,
    OF_INSTRUCTION_ID_EXPERIMENTER = 591,
    OF_INSTRUCTION_ID_GOTO_TABLE = 592,
    OF_INSTRUCTION_ID_METER = 593,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 594,
    OF_INSTRUCTION_ID_WRITE_METADATA = 595,
    OF_INSTRUCTION_METER = 596,
    OF_INSTRUCTION_WRITE_ACTIONS = 597,
    OF_INSTRUCTION_WRITE_METADATA = 598,
    OF_MATCH_V1 = 599,
    OF_MATCH_V2 = 600,
    OF_MATCH_V3 = 601,
    OF_METER_BAND = 602,
    OF_METER_BAND_DROP = 603,
    OF_METER_BAND_DSCP_REMARK = 604,
    OF_METER_BAND_EXPERIMENTER = 605,
    OF_METER_BAND_STATS = 606,
    OF_METER_CONFIG = 607,
    OF_METER_FEATURES = 608,
    OF_METER_STATS = 609,
    OF_OXM = 610,
    OF_OXM_ARP_OP = 611,
    OF_OXM_ARP_OP_MASKED = 612,
    OF_OXM_ARP_SHA = 613,
    OF_OXM_ARP_SHA_MASKED = 614,
    OF_OXM_ARP_SPA = 615,
    OF_OXM_ARP_SPA_MASKED = 616,
    OF_OXM_ARP_THA = 617,
    OF_OXM_ARP_THA_MASKED = 618,
    OF_OXM_ARP_TPA = 619,
    OF_OXM_ARP_TPA_MASKED = 620,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 621,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 622,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 623,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 624,
    OF_OXM_BSN_IFP_CLASS_ID = 625,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 626,
    OF_OXM_BSN_IN_PORTS_128 = 627,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 628,
    OF_OXM_BSN_IN_PORTS_512 = 629,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 630,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 631,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 632,
    OF_OXM_BSN_INNER_ETH_DST = 633,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 634,
    OF_OXM_BSN_INNER_ETH_SRC = 635,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 636,
    OF_OXM_BSN_INNER_VLAN_VID = 637,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 638,
    OF_OXM_BSN_IP_FRAGMENTATION = 639,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 640,
    OF_OXM_BSN_L2_CACHE_HIT = 641,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 642,
    OF_OXM_BSN_L3_DST_CLASS_ID = 643,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 644,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 645,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 646,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 647,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 648,
    OF_OXM_BSN_LAG_ID = 649,
    OF_OXM_BSN_LAG_ID_MASKED = 650,
    OF_OXM_BSN_TCP_FLAGS = 651,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 652,
    OF_OXM_BSN_UDF0 = 653,
    OF_OXM_BSN_UDF0_MASKED = 654,
    OF_OXM_BSN_UDF1 = 655,
    OF_OXM_BSN_UDF1_MASKED = 656,
    OF_OXM_BSN_UDF2 = 657,
    OF_OXM_BSN_UDF2_MASKED = 658,
    OF_OXM_BSN_UDF3 = 659,
    OF_OXM_BSN_UDF3_MASKED = 660,
    OF_OXM_BSN_UDF4 = 661,
    OF_OXM_BSN_UDF4_MASKED = 662,
    OF_OXM_BSN_UDF5 = 663,
    OF_OXM_BSN_UDF5_MASKED = 664,
    OF_OXM_BSN_UDF6 = 665,
    OF_OXM_BSN_UDF6_MASKED = 666,
    OF_OXM_BSN_UDF7 = 667,
    OF_OXM_BSN_UDF7_MASKED = 668,
    OF_OXM_BSN_VFI = 669,
    OF_OXM_BSN_VFI_MASKED = 670,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 671,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 672,
    OF_OXM_BSN_VRF = 673,
    OF_OXM_BSN_VRF_MASKED = 674,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 675,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 676,
    OF_OXM_CONN_TRACKING_IPV6_DST = 677,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 678,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 679,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 680,
    OF_OXM_CONN_TRACKING_LABEL = 681,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 682,
    OF_OXM_CONN_TRACKING_MARK = 683,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 684,
    OF_OXM_CONN_TRACKING_NW_DST = 685,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 686,
    OF_OXM_CONN_TRACKING_NW_PROTO = 687,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 688,
    OF_OXM_CONN_TRACKING_NW_SRC = 689,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 690,
    OF_OXM_CONN_TRACKING_STATE = 691,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 692,
    OF_OXM_CONN_TRACKING_TP_DST = 693,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 694,
    OF_OXM_CONN_TRACKING_TP_SRC = 695,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 696,
    OF_OXM_CONN_TRACKING_ZONE = 697,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 698,
    OF_OXM_ETH_DST = 699,
    OF_OXM_ETH_DST_MASKED = 700,
    OF_OXM_ETH_SRC = 701,
    OF_OXM_ETH_SRC_MASKED = 702,
    OF_OXM_ETH_TYPE = 703,
    OF_OXM_ETH_TYPE_MASKED = 704,
    OF_OXM_ICMPV4_CODE = 705,
    OF_OXM_ICMPV4_CODE_MASKED = 706,
    OF_OXM_ICMPV4_TYPE = 707,
    OF_OXM_ICMPV4_TYPE_MASKED = 708,
    OF_OXM_ICMPV6_CODE = 709,
    OF_OXM_ICMPV6_CODE_MASKED = 710,
    OF_OXM_ICMPV6_TYPE = 711,
    OF_OXM_ICMPV6_TYPE_MASKED = 712,
    OF_OXM_IN_PHY_PORT = 713,
    OF_OXM_IN_PHY_PORT_MASKED = 714,
    OF_OXM_IN_PORT = 715,
    OF_OXM_IN_PORT_MASKED = 716,
    OF_OXM_IP_DSCP = 717,
    OF_OXM_IP_DSCP_MASKED = 718,
    OF_OXM_IP_ECN = 719,
    OF_OXM_IP_ECN_MASKED = 720,
    OF_OXM_IP_PROTO = 721,
    OF_OXM_IP_PROTO_MASKED = 722,
    OF_OXM_IPV4_DST = 723,
    OF_OXM_IPV4_DST_MASKED = 724,
    OF_OXM_IPV4_SRC = 725,
    OF_OXM_IPV4_SRC_MASKED = 726,
    OF_OXM_IPV6_DST = 727,
    OF_OXM_IPV6_DST_MASKED = 728,
    OF_OXM_IPV6_EXTHDR = 729,
    OF_OXM_IPV6_EXTHDR_MASKED = 730,
    OF_OXM_IPV6_FLABEL = 731,
    OF_OXM_IPV6_FLABEL_MASKED = 732,
    OF_OXM_IPV6_ND_SLL = 733,
    OF_OXM_IPV6_ND_SLL_MASKED = 734,
    OF_OXM_IPV6_ND_TARGET = 735,
    OF_OXM_IPV6_ND_TARGET_MASKED = 736,
    OF_OXM_IPV6_ND_TLL = 737,
    OF_OXM_IPV6_ND_TLL_MASKED = 738,
    OF_OXM_IPV6_SRC = 739,
    OF_OXM_IPV6_SRC_MASKED = 740,
    OF_OXM_METADATA = 741,
    OF_OXM_METADATA_MASKED = 742,
    OF_OXM_MPLS_BOS = 743,
    OF_OXM_MPLS_BOS_MASKED = 744,
    OF_OXM_MPLS_LABEL = 745,
    OF_OXM_MPLS_LABEL_MASKED = 746,
    OF_OXM_MPLS_TC = 747,
    OF_OXM_MPLS_TC_MASKED = 748,
    OF_OXM_OVS_TCP_FLAGS = 749,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 750,
    OF_OXM_PBB_UCA = 751,
    OF_OXM_PBB_UCA_MASKED = 752,
    OF_OXM_SCTP_DST = 753,
    OF_OXM_SCTP_DST_MASKED = 754,
    OF_OXM_SCTP_SRC = 755,
    OF_OXM_SCTP_SRC_MASKED = 756,
    OF_OXM_TCP_DST = 757,
    OF_OXM_TCP_DST_MASKED = 758,
    OF_OXM_TCP_SRC = 759,
    OF_OXM_TCP_SRC_MASKED = 760,
    OF_OXM_TUNNEL_ID = 761,
    OF_OXM_TUNNEL_ID_MASKED = 762,
    OF_OXM_TUNNEL_IPV4_DST = 763,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 764,
    OF_OXM_TUNNEL_IPV4_SRC = 765,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 766,
    OF_OXM_UDP_DST = 767,
    OF_OXM_UDP_DST_MASKED = 768,
    OF_OXM_UDP_SRC = 769,
    OF_OXM_UDP_SRC_MASKED = 770,
    OF_OXM_VLAN_PCP = 771,
    OF_OXM_VLAN_PCP_MASKED = 772,
    OF_OXM_VLAN_VID = 773,
    OF_OXM_VLAN_VID_MASKED = 774,
    OF_PACKET_QUEUE = 775,
    OF_PORT_DESC = 776,
    OF_PORT_DESC_PROP = 777,
    OF_PORT_DESC_PROP_BSN = 778,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 779,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 780,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 781,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 782,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 783,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 784,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 785,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 786,
    OF_PORT_DESC_PROP_BSN_UPLINK = 787,
    OF_PORT_DESC_PROP_ETHERNET = 788,
    OF_PORT_DESC_PROP_EXPERIMENTER = 789,
    OF_PORT_DESC_PROP_OPTICAL = 790,
    OF_PORT_MOD_PROP = 791,
    OF_PORT_MOD_PROP_ETHERNET = 792,
    OF_PORT_MOD_PROP_EXPERIMENTER = 793,
    OF_PORT_MOD_PROP_OPTICAL = 794,
    OF_PORT_STATS_ENTRY = 795,
    OF_PORT_STATS_PROP = 796,
    OF_PORT_STATS_PROP_ETHERNET = 797,
    OF_PORT_STATS_PROP_EXPERIMENTER = 798,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 799,
    OF_PORT_STATS_PROP_OPTICAL = 800,
    OF_QUEUE_DESC = 801,
    OF_QUEUE_DESC_PROP = 802,
    OF_QUEUE_DESC_PROP_BSN = 803,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 804,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 805,
    OF_QUEUE_DESC_PROP_MAX_RATE = 806,
    OF_QUEUE_DESC_PROP_MIN_RATE = 807,
    OF_QUEUE_PROP = 808,
    OF_QUEUE_PROP_EXPERIMENTER = 809,
    OF_QUEUE_PROP_MAX_RATE = 810,
    OF_QUEUE_PROP_MIN_RATE = 811,
    OF_QUEUE_STATS_ENTRY = 812,
    OF_QUEUE_STATS_PROP = 813,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 814,
    OF_ROLE_PROP = 815,
    OF_ROLE_PROP_EXPERIMENTER = 816,
    OF_TABLE_DESC = 817,
    OF_TABLE_FEATURE_PROP = 818,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 819,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 820,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 821,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 822,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 823,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 824,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 825,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 826,
    OF_TABLE_FEATURE_PROP_MATCH = 827,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 828,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 829,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 830,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 831,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 832,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 833,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 834,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 835,
    OF_TABLE_FEATURES = 836,
    OF_TABLE_MOD_PROP = 837,
    OF_TABLE_MOD_PROP_EVICTION = 838,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 839,
    OF_TABLE_MOD_PROP_VACANCY = 840,
    OF_TABLE_STATS_ENTRY = 841,
    OF_UINT32 = 842,
    OF_UINT64 = 843,
    OF_UINT8 = 844,
    ...
    /* List objects */
    OF_LIST_ACTION = 845,
    OF_LIST_ACTION_ID = 846,
    OF_LIST_ASYNC_CONFIG_PROP = 847,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 848,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 849,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 850,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 851,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 852,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 853,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 854,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 855,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 856,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 857,
    OF_LIST_BSN_INTERFACE = 858,
    OF_LIST_BSN_LACP_STATS_ENTRY = 859,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 860,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 861,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 862,
    OF_LIST_BSN_TLV = 863,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 864,
    OF_LIST_BSN_VLAN_MAC = 865,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 866,
    OF_LIST_BUCKET = 867,
    OF_LIST_BUCKET_COUNTER = 868,
    OF_LIST_BUNDLE_PROP = 869,
    OF_LIST_FLOW_STATS_ENTRY = 870,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 871,
    OF_LIST_GROUP_STATS_ENTRY = 872,
    OF_LIST_HELLO_ELEM = 873,
    OF_LIST_INSTRUCTION = 874,
    OF_LIST_INSTRUCTION_ID = 875,
    OF_LIST_METER_BAND = 876,
    OF_LIST_METER_BAND_STATS = 877,
    OF_LIST_METER_CONFIG = 878,
    OF_LIST_METER_STATS = 879,
    OF_LIST_OXM = 880,
    OF_LIST_PACKET_QUEUE = 881,
    OF_LIST_PORT_DESC = 882,
    OF_LIST_PORT_DESC_PROP = 883,
    OF_LIST_PORT_MOD_PROP = 884,
    OF_LIST_PORT_STATS_ENTRY = 885,
    OF_LIST_PORT_STATS_PROP = 886,
    OF_LIST_QUEUE_DESC = 887,
    OF_LIST_QUEUE_DESC_PROP = 888,
    OF_LIST_QUEUE_PROP = 889,
    OF_LIST_QUEUE_STATS_ENTRY = 890,
    OF_LIST_QUEUE_STATS_PROP = 891,
    OF_LIST_ROLE_PROP = 892,
    OF_LIST_TABLE_DESC = 893,
    OF_LIST_TABLE_FEATURE_PROP = 894,
    OF_LIST_TABLE_FEATURES = 895,
    OF_LIST_TABLE_MOD_PROP = 896,
    OF_LIST_TABLE_STATS_ENTRY = 897,
    OF_LIST_UINT32 = 898,
    OF_LIST_UINT64 = 899,
    OF_LIST_UINT8 = 900,
