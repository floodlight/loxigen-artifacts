...
typedef enum of_object_id_e {
    ...
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 112,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 113,
    OF_BSN_VRF_COUNTER_STATS_REPLY = 114,
    OF_BSN_VRF_COUNTER_STATS_REQUEST = 115,
    OF_BUNDLE_ADD_MSG = 116,
    OF_BUNDLE_CTRL_MSG = 117,
    OF_BUNDLE_FAILED_ERROR_MSG = 118,
    OF_DESC_STATS_REPLY = 119,
    OF_DESC_STATS_REQUEST = 120,
    OF_ECHO_REPLY = 121,
    OF_ECHO_REQUEST = 122,
    OF_ERROR_MSG = 123,
    OF_EXPERIMENTER = 124,
    OF_EXPERIMENTER_ERROR_MSG = 125,
    OF_EXPERIMENTER_STATS_REPLY = 126,
    OF_EXPERIMENTER_STATS_REQUEST = 127,
    OF_FEATURES_REPLY = 128,
    OF_FEATURES_REQUEST = 129,
    OF_FLOW_ADD = 130,
    OF_FLOW_DELETE = 131,
    OF_FLOW_DELETE_STRICT = 132,
    OF_FLOW_MOD = 133,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 134,
    OF_FLOW_MODIFY = 135,
    OF_FLOW_MODIFY_STRICT = 136,
    OF_FLOW_MONITOR_FAILED_ERROR_MSG = 137,
    OF_FLOW_REMOVED = 138,
    OF_FLOW_STATS_REPLY = 139,
    OF_FLOW_STATS_REQUEST = 140,
    OF_GET_CONFIG_REPLY = 141,
    OF_GET_CONFIG_REQUEST = 142,
    OF_GROUP_ADD = 143,
    OF_GROUP_DELETE = 144,
    OF_GROUP_DESC_STATS_REPLY = 145,
    OF_GROUP_DESC_STATS_REQUEST = 146,
    OF_GROUP_FEATURES_STATS_REPLY = 147,
    OF_GROUP_FEATURES_STATS_REQUEST = 148,
    OF_GROUP_MOD = 149,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 150,
    OF_GROUP_MODIFY = 151,
    OF_GROUP_STATS_REPLY = 152,
    OF_GROUP_STATS_REQUEST = 153,
    OF_HEADER = 154,
    OF_HELLO = 155,
    OF_HELLO_FAILED_ERROR_MSG = 156,
    OF_METER_CONFIG_STATS_REPLY = 157,
    OF_METER_CONFIG_STATS_REQUEST = 158,
    OF_METER_FEATURES_STATS_REPLY = 159,
    OF_METER_FEATURES_STATS_REQUEST = 160,
    OF_METER_MOD = 161,
    OF_METER_MOD_FAILED_ERROR_MSG = 162,
    OF_METER_STATS_REPLY = 163,
    OF_METER_STATS_REQUEST = 164,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 165,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 166,
    OF_NICIRA_HEADER = 167,
    OF_PACKET_IN = 168,
    OF_PACKET_OUT = 169,
    OF_PORT_DESC_STATS_REPLY = 170,
    OF_PORT_DESC_STATS_REQUEST = 171,
    OF_PORT_MOD = 172,
    OF_PORT_MOD_FAILED_ERROR_MSG = 173,
    OF_PORT_STATS_REPLY = 174,
    OF_PORT_STATS_REQUEST = 175,
    OF_PORT_STATUS = 176,
    OF_QUEUE_DESC_STATS_REPLY = 177,
    OF_QUEUE_DESC_STATS_REQUEST = 178,
    OF_QUEUE_GET_CONFIG_REPLY = 179,
    OF_QUEUE_GET_CONFIG_REQUEST = 180,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 181,
    OF_QUEUE_STATS_REPLY = 182,
    OF_QUEUE_STATS_REQUEST = 183,
    OF_REQUESTFORWARD = 184,
    OF_ROLE_REPLY = 185,
    OF_ROLE_REQUEST = 186,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 187,
    OF_ROLE_STATUS = 188,
    OF_SET_CONFIG = 189,
    OF_STATS_REPLY = 190,
    OF_STATS_REQUEST = 191,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 192,
    OF_TABLE_DESC_STATS_REPLY = 193,
    OF_TABLE_DESC_STATS_REQUEST = 194,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 195,
    OF_TABLE_FEATURES_STATS_REPLY = 196,
    OF_TABLE_FEATURES_STATS_REQUEST = 197,
    OF_TABLE_MOD = 198,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 199,
    OF_TABLE_STATS_REPLY = 200,
    OF_TABLE_STATS_REQUEST = 201,
    OF_TABLE_STATUS = 202,

    /* Non-message objects */
    OF_ACTION = 203,
    OF_ACTION_BSN = 204,
    OF_ACTION_BSN_CHECKSUM = 205,
    OF_ACTION_BSN_GENTABLE = 206,
    OF_ACTION_BSN_MIRROR = 207,
    OF_ACTION_BSN_SET_TUNNEL_DST = 208,
    OF_ACTION_COPY_TTL_IN = 209,
    OF_ACTION_COPY_TTL_OUT = 210,
    OF_ACTION_DEC_MPLS_TTL = 211,
    OF_ACTION_DEC_NW_TTL = 212,
    OF_ACTION_ENQUEUE = 213,
    OF_ACTION_EXPERIMENTER = 214,
    OF_ACTION_GROUP = 215,
    OF_ACTION_ID = 216,
    OF_ACTION_ID_BSN = 217,
    OF_ACTION_ID_BSN_CHECKSUM = 218,
    OF_ACTION_ID_BSN_GENTABLE = 219,
    OF_ACTION_ID_BSN_MIRROR = 220,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 221,
    OF_ACTION_ID_COPY_TTL_IN = 222,
    OF_ACTION_ID_COPY_TTL_OUT = 223,
    OF_ACTION_ID_DEC_MPLS_TTL = 224,
    OF_ACTION_ID_DEC_NW_TTL = 225,
    OF_ACTION_ID_EXPERIMENTER = 226,
    OF_ACTION_ID_GROUP = 227,
    OF_ACTION_ID_NICIRA = 228,
    OF_ACTION_ID_NICIRA_DEC_TTL = 229,
    OF_ACTION_ID_OUTPUT = 230,
    OF_ACTION_ID_POP_MPLS = 231,
    OF_ACTION_ID_POP_PBB = 232,
    OF_ACTION_ID_POP_VLAN = 233,
    OF_ACTION_ID_PUSH_MPLS = 234,
    OF_ACTION_ID_PUSH_PBB = 235,
    OF_ACTION_ID_PUSH_VLAN = 236,
    OF_ACTION_ID_SET_FIELD = 237,
    OF_ACTION_ID_SET_MPLS_TTL = 238,
    OF_ACTION_ID_SET_NW_TTL = 239,
    OF_ACTION_ID_SET_QUEUE = 240,
    OF_ACTION_NICIRA = 241,
    OF_ACTION_NICIRA_DEC_TTL = 242,
    OF_ACTION_OUTPUT = 243,
    OF_ACTION_POP_MPLS = 244,
    OF_ACTION_POP_PBB = 245,
    OF_ACTION_POP_VLAN = 246,
    OF_ACTION_PUSH_MPLS = 247,
    OF_ACTION_PUSH_PBB = 248,
    OF_ACTION_PUSH_VLAN = 249,
    OF_ACTION_SET_DL_DST = 250,
    OF_ACTION_SET_DL_SRC = 251,
    OF_ACTION_SET_FIELD = 252,
    OF_ACTION_SET_MPLS_LABEL = 253,
    OF_ACTION_SET_MPLS_TC = 254,
    OF_ACTION_SET_MPLS_TTL = 255,
    OF_ACTION_SET_NW_DST = 256,
    OF_ACTION_SET_NW_ECN = 257,
    OF_ACTION_SET_NW_SRC = 258,
    OF_ACTION_SET_NW_TOS = 259,
    OF_ACTION_SET_NW_TTL = 260,
    OF_ACTION_SET_QUEUE = 261,
    OF_ACTION_SET_TP_DST = 262,
    OF_ACTION_SET_TP_SRC = 263,
    OF_ACTION_SET_VLAN_PCP = 264,
    OF_ACTION_SET_VLAN_VID = 265,
    OF_ACTION_STRIP_VLAN = 266,
    OF_ASYNC_CONFIG_PROP = 267,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_MASTER = 268,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_SLAVE = 269,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_MASTER = 270,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_SLAVE = 271,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_MASTER = 272,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_SLAVE = 273,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_MASTER = 274,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_SLAVE = 275,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_MASTER = 276,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_SLAVE = 277,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_MASTER = 278,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_SLAVE = 279,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_MASTER = 280,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_SLAVE = 281,
    OF_BSN_CONTROLLER_CONNECTION = 282,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 283,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 284,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 285,
    OF_BSN_GENERIC_STATS_ENTRY = 286,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 287,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 288,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 289,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 290,
    OF_BSN_GENTABLE_STATS_ENTRY = 291,
    OF_BSN_INTERFACE = 292,
    OF_BSN_LACP_STATS_ENTRY = 293,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 294,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 295,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 296,
    OF_BSN_TLV = 297,
    OF_BSN_TLV_ACTOR_KEY = 298,
    OF_BSN_TLV_ACTOR_PORT_NUM = 299,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 300,
    OF_BSN_TLV_ACTOR_STATE = 301,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 302,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 303,
    OF_BSN_TLV_ANCHOR = 304,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 305,
    OF_BSN_TLV_BUCKET = 306,
    OF_BSN_TLV_CIRCUIT_ID = 307,
    OF_BSN_TLV_CONVERGENCE_STATUS = 308,
    OF_BSN_TLV_CRC_ENABLED = 309,
    OF_BSN_TLV_DATA = 310,
    OF_BSN_TLV_ETH_DST = 311,
    OF_BSN_TLV_ETH_SRC = 312,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 313,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 314,
    OF_BSN_TLV_EXTERNAL_IP = 315,
    OF_BSN_TLV_EXTERNAL_MAC = 316,
    OF_BSN_TLV_EXTERNAL_NETMASK = 317,
    OF_BSN_TLV_GENERATION_ID = 318,
    OF_BSN_TLV_HEADER_SIZE = 319,
    OF_BSN_TLV_ICMP_CODE = 320,
    OF_BSN_TLV_ICMP_ID = 321,
    OF_BSN_TLV_ICMP_TYPE = 322,
    OF_BSN_TLV_IDLE_NOTIFICATION = 323,
    OF_BSN_TLV_IDLE_TIME = 324,
    OF_BSN_TLV_IDLE_TIMEOUT = 325,
    OF_BSN_TLV_IGMP_SNOOPING = 326,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 327,
    OF_BSN_TLV_INTERNAL_MAC = 328,
    OF_BSN_TLV_INTERVAL = 329,
    OF_BSN_TLV_IP_PROTO = 330,
    OF_BSN_TLV_IPV4 = 331,
    OF_BSN_TLV_IPV4_DST = 332,
    OF_BSN_TLV_IPV4_NETMASK = 333,
    OF_BSN_TLV_IPV4_SRC = 334,
    OF_BSN_TLV_IPV6 = 335,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 336,
    OF_BSN_TLV_MAC = 337,
    OF_BSN_TLV_MAC_MASK = 338,
    OF_BSN_TLV_MISS_PACKETS = 339,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 340,
    OF_BSN_TLV_MPLS_LABEL = 341,
    OF_BSN_TLV_MPLS_SEQUENCED = 342,
    OF_BSN_TLV_NAME = 343,
    OF_BSN_TLV_NEGATE = 344,
    OF_BSN_TLV_OFFSET = 345,
    OF_BSN_TLV_PARTNER_KEY = 346,
    OF_BSN_TLV_PARTNER_PORT_NUM = 347,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 348,
    OF_BSN_TLV_PARTNER_STATE = 349,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 350,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 351,
    OF_BSN_TLV_PORT = 352,
    OF_BSN_TLV_PRIORITY = 353,
    OF_BSN_TLV_QUEUE_ID = 354,
    OF_BSN_TLV_QUEUE_WEIGHT = 355,
    OF_BSN_TLV_REFERENCE = 356,
    OF_BSN_TLV_REPLY_PACKETS = 357,
    OF_BSN_TLV_REQUEST_PACKETS = 358,
    OF_BSN_TLV_RX_BYTES = 359,
    OF_BSN_TLV_RX_PACKETS = 360,
    OF_BSN_TLV_SAMPLING_RATE = 361,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 362,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 363,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 364,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 365,
    OF_BSN_TLV_SUB_AGENT_ID = 366,
    OF_BSN_TLV_TCP_DST = 367,
    OF_BSN_TLV_TCP_SRC = 368,
    OF_BSN_TLV_TX_BYTES = 369,
    OF_BSN_TLV_TX_PACKETS = 370,
    OF_BSN_TLV_UDF_ANCHOR = 371,
    OF_BSN_TLV_UDF_ID = 372,
    OF_BSN_TLV_UDF_LENGTH = 373,
    OF_BSN_TLV_UDF_OFFSET = 374,
    OF_BSN_TLV_UDP_DST = 375,
    OF_BSN_TLV_UDP_SRC = 376,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 377,
    OF_BSN_TLV_VLAN_PCP = 378,
    OF_BSN_TLV_VLAN_VID = 379,
    OF_BSN_TLV_VLAN_VID_MASK = 380,
    OF_BSN_TLV_VRF = 381,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 382,
    OF_BSN_VPORT = 383,
    OF_BSN_VPORT_L2GRE = 384,
    OF_BSN_VPORT_Q_IN_Q = 385,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 386,
    OF_BUCKET = 387,
    OF_BUCKET_COUNTER = 388,
    OF_BUNDLE_PROP = 389,
    OF_BUNDLE_PROP_EXPERIMENTER = 390,
    OF_FLOW_STATS_ENTRY = 391,
    OF_GROUP_DESC_STATS_ENTRY = 392,
    OF_GROUP_STATS_ENTRY = 393,
    OF_HELLO_ELEM = 394,
    OF_HELLO_ELEM_VERSIONBITMAP = 395,
    OF_INSTRUCTION = 396,
    OF_INSTRUCTION_APPLY_ACTIONS = 397,
    OF_INSTRUCTION_BSN = 398,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 399,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 400,
    OF_INSTRUCTION_BSN_DENY = 401,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 402,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 403,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 404,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 405,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 406,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 407,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 408,
    OF_INSTRUCTION_BSN_PERMIT = 409,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 410,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 411,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 412,
    OF_INSTRUCTION_CLEAR_ACTIONS = 413,
    OF_INSTRUCTION_EXPERIMENTER = 414,
    OF_INSTRUCTION_GOTO_TABLE = 415,
    OF_INSTRUCTION_ID = 416,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 417,
    OF_INSTRUCTION_ID_BSN = 418,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 419,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 420,
    OF_INSTRUCTION_ID_BSN_DENY = 421,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 422,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 423,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 424,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 425,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 426,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 427,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 428,
    OF_INSTRUCTION_ID_BSN_PERMIT = 429,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 430,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 431,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 432,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 433,
    OF_INSTRUCTION_ID_EXPERIMENTER = 434,
    OF_INSTRUCTION_ID_GOTO_TABLE = 435,
    OF_INSTRUCTION_ID_METER = 436,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 437,
    OF_INSTRUCTION_ID_WRITE_METADATA = 438,
    OF_INSTRUCTION_METER = 439,
    OF_INSTRUCTION_WRITE_ACTIONS = 440,
    OF_INSTRUCTION_WRITE_METADATA = 441,
    OF_MATCH_V1 = 442,
    OF_MATCH_V2 = 443,
    OF_MATCH_V3 = 444,
    OF_METER_BAND = 445,
    OF_METER_BAND_DROP = 446,
    OF_METER_BAND_DSCP_REMARK = 447,
    OF_METER_BAND_EXPERIMENTER = 448,
    OF_METER_BAND_STATS = 449,
    OF_METER_CONFIG = 450,
    OF_METER_FEATURES = 451,
    OF_METER_STATS = 452,
    OF_OXM = 453,
    OF_OXM_ARP_OP = 454,
    OF_OXM_ARP_OP_MASKED = 455,
    OF_OXM_ARP_SHA = 456,
    OF_OXM_ARP_SHA_MASKED = 457,
    OF_OXM_ARP_SPA = 458,
    OF_OXM_ARP_SPA_MASKED = 459,
    OF_OXM_ARP_THA = 460,
    OF_OXM_ARP_THA_MASKED = 461,
    OF_OXM_ARP_TPA = 462,
    OF_OXM_ARP_TPA_MASKED = 463,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 464,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 465,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 466,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 467,
    OF_OXM_BSN_IN_PORTS_128 = 468,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 469,
    OF_OXM_BSN_IN_PORTS_512 = 470,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 471,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 472,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 473,
    OF_OXM_BSN_INNER_ETH_DST = 474,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 475,
    OF_OXM_BSN_INNER_ETH_SRC = 476,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 477,
    OF_OXM_BSN_INNER_VLAN_VID = 478,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 479,
    OF_OXM_BSN_L2_CACHE_HIT = 480,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 481,
    OF_OXM_BSN_L3_DST_CLASS_ID = 482,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 483,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 484,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 485,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 486,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 487,
    OF_OXM_BSN_LAG_ID = 488,
    OF_OXM_BSN_LAG_ID_MASKED = 489,
    OF_OXM_BSN_TCP_FLAGS = 490,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 491,
    OF_OXM_BSN_UDF0 = 492,
    OF_OXM_BSN_UDF0_MASKED = 493,
    OF_OXM_BSN_UDF1 = 494,
    OF_OXM_BSN_UDF1_MASKED = 495,
    OF_OXM_BSN_UDF2 = 496,
    OF_OXM_BSN_UDF2_MASKED = 497,
    OF_OXM_BSN_UDF3 = 498,
    OF_OXM_BSN_UDF3_MASKED = 499,
    OF_OXM_BSN_UDF4 = 500,
    OF_OXM_BSN_UDF4_MASKED = 501,
    OF_OXM_BSN_UDF5 = 502,
    OF_OXM_BSN_UDF5_MASKED = 503,
    OF_OXM_BSN_UDF6 = 504,
    OF_OXM_BSN_UDF6_MASKED = 505,
    OF_OXM_BSN_UDF7 = 506,
    OF_OXM_BSN_UDF7_MASKED = 507,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 508,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 509,
    OF_OXM_BSN_VRF = 510,
    OF_OXM_BSN_VRF_MASKED = 511,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 512,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 513,
    OF_OXM_ETH_DST = 514,
    OF_OXM_ETH_DST_MASKED = 515,
    OF_OXM_ETH_SRC = 516,
    OF_OXM_ETH_SRC_MASKED = 517,
    OF_OXM_ETH_TYPE = 518,
    OF_OXM_ETH_TYPE_MASKED = 519,
    OF_OXM_ICMPV4_CODE = 520,
    OF_OXM_ICMPV4_CODE_MASKED = 521,
    OF_OXM_ICMPV4_TYPE = 522,
    OF_OXM_ICMPV4_TYPE_MASKED = 523,
    OF_OXM_ICMPV6_CODE = 524,
    OF_OXM_ICMPV6_CODE_MASKED = 525,
    OF_OXM_ICMPV6_TYPE = 526,
    OF_OXM_ICMPV6_TYPE_MASKED = 527,
    OF_OXM_IN_PHY_PORT = 528,
    OF_OXM_IN_PHY_PORT_MASKED = 529,
    OF_OXM_IN_PORT = 530,
    OF_OXM_IN_PORT_MASKED = 531,
    OF_OXM_IP_DSCP = 532,
    OF_OXM_IP_DSCP_MASKED = 533,
    OF_OXM_IP_ECN = 534,
    OF_OXM_IP_ECN_MASKED = 535,
    OF_OXM_IP_PROTO = 536,
    OF_OXM_IP_PROTO_MASKED = 537,
    OF_OXM_IPV4_DST = 538,
    OF_OXM_IPV4_DST_MASKED = 539,
    OF_OXM_IPV4_SRC = 540,
    OF_OXM_IPV4_SRC_MASKED = 541,
    OF_OXM_IPV6_DST = 542,
    OF_OXM_IPV6_DST_MASKED = 543,
    OF_OXM_IPV6_EXTHDR = 544,
    OF_OXM_IPV6_EXTHDR_MASKED = 545,
    OF_OXM_IPV6_FLABEL = 546,
    OF_OXM_IPV6_FLABEL_MASKED = 547,
    OF_OXM_IPV6_ND_SLL = 548,
    OF_OXM_IPV6_ND_SLL_MASKED = 549,
    OF_OXM_IPV6_ND_TARGET = 550,
    OF_OXM_IPV6_ND_TARGET_MASKED = 551,
    OF_OXM_IPV6_ND_TLL = 552,
    OF_OXM_IPV6_ND_TLL_MASKED = 553,
    OF_OXM_IPV6_SRC = 554,
    OF_OXM_IPV6_SRC_MASKED = 555,
    OF_OXM_METADATA = 556,
    OF_OXM_METADATA_MASKED = 557,
    OF_OXM_MPLS_BOS = 558,
    OF_OXM_MPLS_BOS_MASKED = 559,
    OF_OXM_MPLS_LABEL = 560,
    OF_OXM_MPLS_LABEL_MASKED = 561,
    OF_OXM_MPLS_TC = 562,
    OF_OXM_MPLS_TC_MASKED = 563,
    OF_OXM_PBB_UCA = 564,
    OF_OXM_PBB_UCA_MASKED = 565,
    OF_OXM_SCTP_DST = 566,
    OF_OXM_SCTP_DST_MASKED = 567,
    OF_OXM_SCTP_SRC = 568,
    OF_OXM_SCTP_SRC_MASKED = 569,
    OF_OXM_TCP_DST = 570,
    OF_OXM_TCP_DST_MASKED = 571,
    OF_OXM_TCP_SRC = 572,
    OF_OXM_TCP_SRC_MASKED = 573,
    OF_OXM_TUNNEL_ID = 574,
    OF_OXM_TUNNEL_ID_MASKED = 575,
    OF_OXM_TUNNEL_IPV4_DST = 576,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 577,
    OF_OXM_TUNNEL_IPV4_SRC = 578,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 579,
    OF_OXM_UDP_DST = 580,
    OF_OXM_UDP_DST_MASKED = 581,
    OF_OXM_UDP_SRC = 582,
    OF_OXM_UDP_SRC_MASKED = 583,
    OF_OXM_VLAN_PCP = 584,
    OF_OXM_VLAN_PCP_MASKED = 585,
    OF_OXM_VLAN_VID = 586,
    OF_OXM_VLAN_VID_MASKED = 587,
    OF_PACKET_QUEUE = 588,
    OF_PORT_DESC = 589,
    OF_PORT_DESC_PROP = 590,
    OF_PORT_DESC_PROP_BSN = 591,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 592,
    OF_PORT_DESC_PROP_BSN_UPLINK = 593,
    OF_PORT_DESC_PROP_ETHERNET = 594,
    OF_PORT_DESC_PROP_EXPERIMENTER = 595,
    OF_PORT_DESC_PROP_OPTICAL = 596,
    OF_PORT_MOD_PROP = 597,
    OF_PORT_MOD_PROP_ETHERNET = 598,
    OF_PORT_MOD_PROP_EXPERIMENTER = 599,
    OF_PORT_MOD_PROP_OPTICAL = 600,
    OF_PORT_STATS_ENTRY = 601,
    OF_PORT_STATS_PROP = 602,
    OF_PORT_STATS_PROP_ETHERNET = 603,
    OF_PORT_STATS_PROP_EXPERIMENTER = 604,
    OF_PORT_STATS_PROP_OPTICAL = 605,
    OF_QUEUE_DESC = 606,
    OF_QUEUE_DESC_PROP = 607,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 608,
    OF_QUEUE_DESC_PROP_MAX_RATE = 609,
    OF_QUEUE_DESC_PROP_MIN_RATE = 610,
    OF_QUEUE_PROP = 611,
    OF_QUEUE_PROP_EXPERIMENTER = 612,
    OF_QUEUE_PROP_MAX_RATE = 613,
    OF_QUEUE_PROP_MIN_RATE = 614,
    OF_QUEUE_STATS_ENTRY = 615,
    OF_QUEUE_STATS_PROP = 616,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 617,
    OF_ROLE_PROP = 618,
    OF_ROLE_PROP_EXPERIMENTER = 619,
    OF_TABLE_DESC = 620,
    OF_TABLE_FEATURE_PROP = 621,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 622,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 623,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 624,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 625,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 626,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 627,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 628,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 629,
    OF_TABLE_FEATURE_PROP_MATCH = 630,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 631,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 632,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 633,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 634,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 635,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 636,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 637,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 638,
    OF_TABLE_FEATURES = 639,
    OF_TABLE_MOD_PROP = 640,
    OF_TABLE_MOD_PROP_EVICTION = 641,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 642,
    OF_TABLE_MOD_PROP_VACANCY = 643,
    OF_TABLE_STATS_ENTRY = 644,
    OF_UINT32 = 645,
    OF_UINT64 = 646,
    OF_UINT8 = 647,
    ...
    /* List objects */
    OF_LIST_ACTION = 648,
    OF_LIST_ACTION_ID = 649,
    OF_LIST_ASYNC_CONFIG_PROP = 650,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 651,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 652,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 653,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 654,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 655,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 656,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 657,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 658,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 659,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 660,
    OF_LIST_BSN_INTERFACE = 661,
    OF_LIST_BSN_LACP_STATS_ENTRY = 662,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 663,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 664,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 665,
    OF_LIST_BSN_TLV = 666,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 667,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 668,
    OF_LIST_BUCKET = 669,
    OF_LIST_BUCKET_COUNTER = 670,
    OF_LIST_BUNDLE_PROP = 671,
    OF_LIST_FLOW_STATS_ENTRY = 672,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 673,
    OF_LIST_GROUP_STATS_ENTRY = 674,
    OF_LIST_HELLO_ELEM = 675,
    OF_LIST_INSTRUCTION = 676,
    OF_LIST_INSTRUCTION_ID = 677,
    OF_LIST_METER_BAND = 678,
    OF_LIST_METER_BAND_STATS = 679,
    OF_LIST_METER_CONFIG = 680,
    OF_LIST_METER_STATS = 681,
    OF_LIST_OXM = 682,
    OF_LIST_PACKET_QUEUE = 683,
    OF_LIST_PORT_DESC = 684,
    OF_LIST_PORT_DESC_PROP = 685,
    OF_LIST_PORT_MOD_PROP = 686,
    OF_LIST_PORT_STATS_ENTRY = 687,
    OF_LIST_PORT_STATS_PROP = 688,
    OF_LIST_QUEUE_DESC = 689,
    OF_LIST_QUEUE_DESC_PROP = 690,
    OF_LIST_QUEUE_PROP = 691,
    OF_LIST_QUEUE_STATS_ENTRY = 692,
    OF_LIST_QUEUE_STATS_PROP = 693,
    OF_LIST_ROLE_PROP = 694,
    OF_LIST_TABLE_DESC = 695,
    OF_LIST_TABLE_FEATURE_PROP = 696,
    OF_LIST_TABLE_FEATURES = 697,
    OF_LIST_TABLE_MOD_PROP = 698,
    OF_LIST_TABLE_STATS_ENTRY = 699,
    OF_LIST_UINT32 = 700,
    OF_LIST_UINT64 = 701,
    OF_LIST_UINT8 = 702,
...
#define OF_MESSAGE_OBJECT_COUNT 203
