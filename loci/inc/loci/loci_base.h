...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_ACTOR_STATE = 266,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 267,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 268,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 269,
    OF_BSN_TLV_CIRCUIT_ID = 270,
    OF_BSN_TLV_CONVERGENCE_STATUS = 271,
    OF_BSN_TLV_CRC_ENABLED = 272,
    OF_BSN_TLV_ETH_DST = 273,
    OF_BSN_TLV_ETH_SRC = 274,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 275,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 276,
    OF_BSN_TLV_EXTERNAL_IP = 277,
    OF_BSN_TLV_EXTERNAL_MAC = 278,
    OF_BSN_TLV_EXTERNAL_NETMASK = 279,
    OF_BSN_TLV_HEADER = 280,
    OF_BSN_TLV_HEADER_SIZE = 281,
    OF_BSN_TLV_IDLE_NOTIFICATION = 282,
    OF_BSN_TLV_IDLE_TIME = 283,
    OF_BSN_TLV_IDLE_TIMEOUT = 284,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 285,
    OF_BSN_TLV_INTERNAL_MAC = 286,
    OF_BSN_TLV_IPV4 = 287,
    OF_BSN_TLV_IPV4_DST = 288,
    OF_BSN_TLV_IPV4_SRC = 289,
    OF_BSN_TLV_MAC = 290,
    OF_BSN_TLV_MISS_PACKETS = 291,
    OF_BSN_TLV_NAME = 292,
    OF_BSN_TLV_PARTNER_KEY = 293,
    OF_BSN_TLV_PARTNER_PORT_NUM = 294,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 295,
    OF_BSN_TLV_PARTNER_STATE = 296,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 297,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 298,
    OF_BSN_TLV_PORT = 299,
    OF_BSN_TLV_QUEUE_ID = 300,
    OF_BSN_TLV_QUEUE_WEIGHT = 301,
    OF_BSN_TLV_REPLY_PACKETS = 302,
    OF_BSN_TLV_REQUEST_PACKETS = 303,
    OF_BSN_TLV_RX_PACKETS = 304,
    OF_BSN_TLV_SAMPLING_RATE = 305,
    OF_BSN_TLV_SUB_AGENT_ID = 306,
    OF_BSN_TLV_TX_BYTES = 307,
    OF_BSN_TLV_TX_PACKETS = 308,
    OF_BSN_TLV_UDF_ANCHOR = 309,
    OF_BSN_TLV_UDF_ID = 310,
    OF_BSN_TLV_UDF_LENGTH = 311,
    OF_BSN_TLV_UDF_OFFSET = 312,
    OF_BSN_TLV_UDP_DST = 313,
    OF_BSN_TLV_UDP_SRC = 314,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 315,
    OF_BSN_TLV_VLAN_VID = 316,
    OF_BSN_TLV_VRF = 317,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 318,
    OF_BSN_VPORT = 319,
    OF_BSN_VPORT_HEADER = 320,
    OF_BSN_VPORT_L2GRE = 321,
    OF_BSN_VPORT_Q_IN_Q = 322,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 323,
    OF_BUCKET = 324,
    OF_BUCKET_COUNTER = 325,
    OF_FLOW_STATS_ENTRY = 326,
    OF_GROUP_DESC_STATS_ENTRY = 327,
    OF_GROUP_STATS_ENTRY = 328,
    OF_HELLO_ELEM = 329,
    OF_HELLO_ELEM_HEADER = 330,
    OF_HELLO_ELEM_VERSIONBITMAP = 331,
    OF_INSTRUCTION = 332,
    OF_INSTRUCTION_APPLY_ACTIONS = 333,
    OF_INSTRUCTION_BSN = 334,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 335,
    OF_INSTRUCTION_BSN_DENY = 336,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 337,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 338,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 339,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 340,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 341,
    OF_INSTRUCTION_BSN_PERMIT = 342,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 343,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 344,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 345,
    OF_INSTRUCTION_CLEAR_ACTIONS = 346,
    OF_INSTRUCTION_EXPERIMENTER = 347,
    OF_INSTRUCTION_GOTO_TABLE = 348,
    OF_INSTRUCTION_HEADER = 349,
    OF_INSTRUCTION_ID = 350,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 351,
    OF_INSTRUCTION_ID_BSN = 352,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 353,
