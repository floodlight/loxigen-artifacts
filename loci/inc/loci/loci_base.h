...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_LR_ALL_ENABLED = 391,
    OF_BSN_TLV_MAC = 392,
    OF_BSN_TLV_MAC_MASK = 393,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 394,
    OF_BSN_TLV_MISS_PACKETS = 395,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 396,
    OF_BSN_TLV_MPLS_LABEL = 397,
    OF_BSN_TLV_MPLS_SEQUENCED = 398,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 399,
    OF_BSN_TLV_MULTICAST_PACKET = 400,
    OF_BSN_TLV_MULTIPLIER = 401,
    OF_BSN_TLV_NAME = 402,
    OF_BSN_TLV_NDP_OFFLOAD = 403,
    OF_BSN_TLV_NDP_STATIC = 404,
    OF_BSN_TLV_NEGATE = 405,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 406,
    OF_BSN_TLV_NEXT_HOP_MAC = 407,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 408,
    OF_BSN_TLV_NO_ARP_RESPONSE = 409,
    OF_BSN_TLV_NO_NS_RESPONSE = 410,
    OF_BSN_TLV_OFFSET = 411,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 412,
    OF_BSN_TLV_OUTER_SRC_MAC = 413,
    OF_BSN_TLV_PARENT_PORT = 414,
    OF_BSN_TLV_PARTNER_KEY = 415,
    OF_BSN_TLV_PARTNER_PORT_NUM = 416,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 417,
    OF_BSN_TLV_PARTNER_STATE = 418,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 419,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 420,
    OF_BSN_TLV_PASSIVE = 421,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 422,
    OF_BSN_TLV_PIM_DR = 423,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 424,
    OF_BSN_TLV_PORT = 425,
    OF_BSN_TLV_PORT_MODE = 426,
    OF_BSN_TLV_PORT_SPEED_GBPS = 427,
    OF_BSN_TLV_PORT_USAGE = 428,
    OF_BSN_TLV_PORT_VXLAN_MODE = 429,
    OF_BSN_TLV_PRESERVE_VLAN = 430,
    OF_BSN_TLV_PRIORITY = 431,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 432,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 433,
    OF_BSN_TLV_QOS_PRIORITY = 434,
    OF_BSN_TLV_QUEUE_ID = 435,
    OF_BSN_TLV_QUEUE_WEIGHT = 436,
    OF_BSN_TLV_RATE_LIMIT = 437,
    OF_BSN_TLV_RATE_UNIT = 438,
    OF_BSN_TLV_RECORD_PACKETS = 439,
    OF_BSN_TLV_REFERENCE = 440,
    OF_BSN_TLV_REPLY_PACKETS = 441,
    OF_BSN_TLV_REQUEST_PACKETS = 442,
    OF_BSN_TLV_REST_SERVER = 443,
    OF_BSN_TLV_ROUTING_PARAM = 444,
    OF_BSN_TLV_RX_BYTES = 445,
    OF_BSN_TLV_RX_PACKETS = 446,
    OF_BSN_TLV_SAMPLING_RATE = 447,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 448,
    OF_BSN_TLV_STATUS = 449,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 450,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 451,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 452,
    OF_BSN_TLV_SUB_AGENT_ID = 453,
    OF_BSN_TLV_TCP_DST = 454,
    OF_BSN_TLV_TCP_FLAGS = 455,
    OF_BSN_TLV_TCP_SRC = 456,
    OF_BSN_TLV_TIMESTAMP = 457,
    OF_BSN_TLV_TTL = 458,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 459,
    OF_BSN_TLV_TX_BYTES = 460,
    OF_BSN_TLV_TX_PACKETS = 461,
    OF_BSN_TLV_UDF_ANCHOR = 462,
    OF_BSN_TLV_UDF_CAPABILITY = 463,
    OF_BSN_TLV_UDF_ID = 464,
    OF_BSN_TLV_UDF_LENGTH = 465,
    OF_BSN_TLV_UDF_OFFSET = 466,
    OF_BSN_TLV_UDP_DST = 467,
    OF_BSN_TLV_UDP_SRC = 468,
    OF_BSN_TLV_UINT32 = 469,
    OF_BSN_TLV_UINT64_LIST = 470,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 471,
    OF_BSN_TLV_UNICAST_RATE = 472,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 473,
    OF_BSN_TLV_UNTAGGED = 474,
    OF_BSN_TLV_UPGRADE = 475,
    OF_BSN_TLV_URI_SCHEME = 476,
    OF_BSN_TLV_USE_PACKET_STATE = 477,
    OF_BSN_TLV_USER_CONFIGURED = 478,
    OF_BSN_TLV_VFI = 479,
    OF_BSN_TLV_VFP_CLASS_ID = 480,
    OF_BSN_TLV_VIRTUAL = 481,
    OF_BSN_TLV_VLAN_MAC_LIST = 482,
    OF_BSN_TLV_VLAN_PCP = 483,
    OF_BSN_TLV_VLAN_VID = 484,
    OF_BSN_TLV_VLAN_VID_MASK = 485,
    OF_BSN_TLV_VNI = 486,
    OF_BSN_TLV_VPN_KEY = 487,
    OF_BSN_TLV_VRF = 488,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 489,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 490,
    OF_BSN_VLAN_MAC = 491,
    OF_BSN_VPORT = 492,
    OF_BSN_VPORT_L2GRE = 493,
    OF_BSN_VPORT_Q_IN_Q = 494,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 495,
    OF_BUCKET = 496,
    OF_BUCKET_COUNTER = 497,
    OF_BUNDLE_PROP = 498,
    OF_BUNDLE_PROP_EXPERIMENTER = 499,
    OF_FLOW_STATS_ENTRY = 500,
    OF_GROUP_DESC_STATS_ENTRY = 501,
    OF_GROUP_STATS_ENTRY = 502,
    OF_HELLO_ELEM = 503,
    OF_HELLO_ELEM_VERSIONBITMAP = 504,
    OF_INSTRUCTION = 505,
    OF_INSTRUCTION_APPLY_ACTIONS = 506,
    OF_INSTRUCTION_BSN = 507,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 508,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 509,
    OF_INSTRUCTION_BSN_DENY = 510,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 511,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 512,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 513,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 514,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 515,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 516,
    OF_INSTRUCTION_BSN_HASH_SELECT = 517,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 518,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 519,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 520,
    OF_INSTRUCTION_BSN_PERMIT = 521,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 522,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 523,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 524,
    OF_INSTRUCTION_CLEAR_ACTIONS = 525,
    OF_INSTRUCTION_EXPERIMENTER = 526,
    OF_INSTRUCTION_GOTO_TABLE = 527,
    OF_INSTRUCTION_ID = 528,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 529,
    OF_INSTRUCTION_ID_BSN = 530,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 531,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 532,
    OF_INSTRUCTION_ID_BSN_DENY = 533,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 534,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 535,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 536,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 537,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 538,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 539,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 540,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 541,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 542,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 543,
    OF_INSTRUCTION_ID_BSN_PERMIT = 544,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 545,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 546,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 547,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 548,
    OF_INSTRUCTION_ID_EXPERIMENTER = 549,
    OF_INSTRUCTION_ID_GOTO_TABLE = 550,
    OF_INSTRUCTION_ID_METER = 551,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 552,
    OF_INSTRUCTION_ID_WRITE_METADATA = 553,
    OF_INSTRUCTION_METER = 554,
    OF_INSTRUCTION_WRITE_ACTIONS = 555,
    OF_INSTRUCTION_WRITE_METADATA = 556,
    OF_MATCH_V1 = 557,
    OF_MATCH_V2 = 558,
    OF_MATCH_V3 = 559,
    OF_METER_BAND = 560,
    OF_METER_BAND_DROP = 561,
    OF_METER_BAND_DSCP_REMARK = 562,
    OF_METER_BAND_EXPERIMENTER = 563,
    OF_METER_BAND_STATS = 564,
    OF_METER_CONFIG = 565,
    OF_METER_FEATURES = 566,
    OF_METER_STATS = 567,
    OF_OXM = 568,
    OF_OXM_ARP_OP = 569,
    OF_OXM_ARP_OP_MASKED = 570,
    OF_OXM_ARP_SHA = 571,
    OF_OXM_ARP_SHA_MASKED = 572,
    OF_OXM_ARP_SPA = 573,
    OF_OXM_ARP_SPA_MASKED = 574,
    OF_OXM_ARP_THA = 575,
    OF_OXM_ARP_THA_MASKED = 576,
    OF_OXM_ARP_TPA = 577,
    OF_OXM_ARP_TPA_MASKED = 578,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 579,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 580,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 581,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 582,
    OF_OXM_BSN_IFP_CLASS_ID = 583,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 584,
    OF_OXM_BSN_IN_PORTS_128 = 585,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 586,
    OF_OXM_BSN_IN_PORTS_512 = 587,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 588,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 589,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 590,
    OF_OXM_BSN_INNER_ETH_DST = 591,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 592,
    OF_OXM_BSN_INNER_ETH_SRC = 593,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 594,
    OF_OXM_BSN_INNER_VLAN_VID = 595,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 596,
    OF_OXM_BSN_IP_FRAGMENTATION = 597,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 598,
    OF_OXM_BSN_L2_CACHE_HIT = 599,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 600,
    OF_OXM_BSN_L3_DST_CLASS_ID = 601,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 602,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 603,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 604,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 605,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 606,
    OF_OXM_BSN_LAG_ID = 607,
    OF_OXM_BSN_LAG_ID_MASKED = 608,
    OF_OXM_BSN_TCP_FLAGS = 609,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 610,
    OF_OXM_BSN_UDF0 = 611,
    OF_OXM_BSN_UDF0_MASKED = 612,
    OF_OXM_BSN_UDF1 = 613,
    OF_OXM_BSN_UDF1_MASKED = 614,
    OF_OXM_BSN_UDF2 = 615,
    OF_OXM_BSN_UDF2_MASKED = 616,
    OF_OXM_BSN_UDF3 = 617,
    OF_OXM_BSN_UDF3_MASKED = 618,
    OF_OXM_BSN_UDF4 = 619,
    OF_OXM_BSN_UDF4_MASKED = 620,
    OF_OXM_BSN_UDF5 = 621,
    OF_OXM_BSN_UDF5_MASKED = 622,
    OF_OXM_BSN_UDF6 = 623,
    OF_OXM_BSN_UDF6_MASKED = 624,
    OF_OXM_BSN_UDF7 = 625,
    OF_OXM_BSN_UDF7_MASKED = 626,
    OF_OXM_BSN_VFI = 627,
    OF_OXM_BSN_VFI_MASKED = 628,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 629,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 630,
    OF_OXM_BSN_VRF = 631,
    OF_OXM_BSN_VRF_MASKED = 632,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 633,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 634,
    OF_OXM_CONN_TRACKING_IPV6_DST = 635,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 636,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 637,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 638,
    OF_OXM_CONN_TRACKING_LABEL = 639,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 640,
    OF_OXM_CONN_TRACKING_MARK = 641,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 642,
    OF_OXM_CONN_TRACKING_NW_DST = 643,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 644,
    OF_OXM_CONN_TRACKING_NW_PROTO = 645,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 646,
    OF_OXM_CONN_TRACKING_NW_SRC = 647,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 648,
    OF_OXM_CONN_TRACKING_STATE = 649,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 650,
    OF_OXM_CONN_TRACKING_TP_DST = 651,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 652,
    OF_OXM_CONN_TRACKING_TP_SRC = 653,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 654,
    OF_OXM_CONN_TRACKING_ZONE = 655,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 656,
    OF_OXM_ETH_DST = 657,
    OF_OXM_ETH_DST_MASKED = 658,
    OF_OXM_ETH_SRC = 659,
    OF_OXM_ETH_SRC_MASKED = 660,
    OF_OXM_ETH_TYPE = 661,
    OF_OXM_ETH_TYPE_MASKED = 662,
    OF_OXM_ICMPV4_CODE = 663,
    OF_OXM_ICMPV4_CODE_MASKED = 664,
    OF_OXM_ICMPV4_TYPE = 665,
    OF_OXM_ICMPV4_TYPE_MASKED = 666,
    OF_OXM_ICMPV6_CODE = 667,
    OF_OXM_ICMPV6_CODE_MASKED = 668,
    OF_OXM_ICMPV6_TYPE = 669,
    OF_OXM_ICMPV6_TYPE_MASKED = 670,
    OF_OXM_IN_PHY_PORT = 671,
    OF_OXM_IN_PHY_PORT_MASKED = 672,
    OF_OXM_IN_PORT = 673,
    OF_OXM_IN_PORT_MASKED = 674,
    OF_OXM_IP_DSCP = 675,
    OF_OXM_IP_DSCP_MASKED = 676,
    OF_OXM_IP_ECN = 677,
    OF_OXM_IP_ECN_MASKED = 678,
    OF_OXM_IP_PROTO = 679,
    OF_OXM_IP_PROTO_MASKED = 680,
    OF_OXM_IPV4_DST = 681,
    OF_OXM_IPV4_DST_MASKED = 682,
    OF_OXM_IPV4_SRC = 683,
    OF_OXM_IPV4_SRC_MASKED = 684,
    OF_OXM_IPV6_DST = 685,
    OF_OXM_IPV6_DST_MASKED = 686,
    OF_OXM_IPV6_EXTHDR = 687,
    OF_OXM_IPV6_EXTHDR_MASKED = 688,
    OF_OXM_IPV6_FLABEL = 689,
    OF_OXM_IPV6_FLABEL_MASKED = 690,
    OF_OXM_IPV6_ND_SLL = 691,
    OF_OXM_IPV6_ND_SLL_MASKED = 692,
    OF_OXM_IPV6_ND_TARGET = 693,
    OF_OXM_IPV6_ND_TARGET_MASKED = 694,
    OF_OXM_IPV6_ND_TLL = 695,
    OF_OXM_IPV6_ND_TLL_MASKED = 696,
    OF_OXM_IPV6_SRC = 697,
    OF_OXM_IPV6_SRC_MASKED = 698,
    OF_OXM_METADATA = 699,
    OF_OXM_METADATA_MASKED = 700,
    OF_OXM_MPLS_BOS = 701,
    OF_OXM_MPLS_BOS_MASKED = 702,
    OF_OXM_MPLS_LABEL = 703,
    OF_OXM_MPLS_LABEL_MASKED = 704,
    OF_OXM_MPLS_TC = 705,
    OF_OXM_MPLS_TC_MASKED = 706,
    OF_OXM_OVS_TCP_FLAGS = 707,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 708,
    OF_OXM_PBB_UCA = 709,
    OF_OXM_PBB_UCA_MASKED = 710,
    OF_OXM_SCTP_DST = 711,
    OF_OXM_SCTP_DST_MASKED = 712,
    OF_OXM_SCTP_SRC = 713,
    OF_OXM_SCTP_SRC_MASKED = 714,
    OF_OXM_TCP_DST = 715,
    OF_OXM_TCP_DST_MASKED = 716,
    OF_OXM_TCP_SRC = 717,
    OF_OXM_TCP_SRC_MASKED = 718,
    OF_OXM_TUNNEL_ID = 719,
    OF_OXM_TUNNEL_ID_MASKED = 720,
    OF_OXM_TUNNEL_IPV4_DST = 721,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 722,
    OF_OXM_TUNNEL_IPV4_SRC = 723,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 724,
    OF_OXM_UDP_DST = 725,
    OF_OXM_UDP_DST_MASKED = 726,
    OF_OXM_UDP_SRC = 727,
    OF_OXM_UDP_SRC_MASKED = 728,
    OF_OXM_VLAN_PCP = 729,
    OF_OXM_VLAN_PCP_MASKED = 730,
    OF_OXM_VLAN_VID = 731,
    OF_OXM_VLAN_VID_MASKED = 732,
    OF_PACKET_QUEUE = 733,
    OF_PORT_DESC = 734,
    OF_PORT_DESC_PROP = 735,
    OF_PORT_DESC_PROP_BSN = 736,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 737,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 738,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 739,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 740,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 741,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 742,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 743,
    OF_PORT_DESC_PROP_BSN_UPLINK = 744,
    OF_PORT_DESC_PROP_ETHERNET = 745,
    OF_PORT_DESC_PROP_EXPERIMENTER = 746,
    OF_PORT_DESC_PROP_OPTICAL = 747,
    OF_PORT_MOD_PROP = 748,
    OF_PORT_MOD_PROP_ETHERNET = 749,
    OF_PORT_MOD_PROP_EXPERIMENTER = 750,
    OF_PORT_MOD_PROP_OPTICAL = 751,
    OF_PORT_STATS_ENTRY = 752,
    OF_PORT_STATS_PROP = 753,
    OF_PORT_STATS_PROP_ETHERNET = 754,
    OF_PORT_STATS_PROP_EXPERIMENTER = 755,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 756,
    OF_PORT_STATS_PROP_OPTICAL = 757,
    OF_QUEUE_DESC = 758,
    OF_QUEUE_DESC_PROP = 759,
    OF_QUEUE_DESC_PROP_BSN = 760,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 761,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 762,
    OF_QUEUE_DESC_PROP_MAX_RATE = 763,
    OF_QUEUE_DESC_PROP_MIN_RATE = 764,
    OF_QUEUE_PROP = 765,
    OF_QUEUE_PROP_EXPERIMENTER = 766,
    OF_QUEUE_PROP_MAX_RATE = 767,
    OF_QUEUE_PROP_MIN_RATE = 768,
    OF_QUEUE_STATS_ENTRY = 769,
    OF_QUEUE_STATS_PROP = 770,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 771,
    OF_ROLE_PROP = 772,
    OF_ROLE_PROP_EXPERIMENTER = 773,
    OF_TABLE_DESC = 774,
    OF_TABLE_FEATURE_PROP = 775,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 776,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 777,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 778,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 779,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 780,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 781,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 782,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 783,
    OF_TABLE_FEATURE_PROP_MATCH = 784,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 785,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 786,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 787,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 788,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 789,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 790,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 791,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 792,
    OF_TABLE_FEATURES = 793,
    OF_TABLE_MOD_PROP = 794,
    OF_TABLE_MOD_PROP_EVICTION = 795,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 796,
    OF_TABLE_MOD_PROP_VACANCY = 797,
    OF_TABLE_STATS_ENTRY = 798,
    OF_UINT32 = 799,
    OF_UINT64 = 800,
    OF_UINT8 = 801,
    ...
    /* List objects */
    OF_LIST_ACTION = 802,
    OF_LIST_ACTION_ID = 803,
    OF_LIST_ASYNC_CONFIG_PROP = 804,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 805,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 806,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 807,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 808,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 809,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 810,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 811,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 812,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 813,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 814,
    OF_LIST_BSN_INTERFACE = 815,
    OF_LIST_BSN_LACP_STATS_ENTRY = 816,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 817,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 818,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 819,
    OF_LIST_BSN_TLV = 820,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 821,
    OF_LIST_BSN_VLAN_MAC = 822,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 823,
    OF_LIST_BUCKET = 824,
    OF_LIST_BUCKET_COUNTER = 825,
    OF_LIST_BUNDLE_PROP = 826,
    OF_LIST_FLOW_STATS_ENTRY = 827,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 828,
    OF_LIST_GROUP_STATS_ENTRY = 829,
    OF_LIST_HELLO_ELEM = 830,
    OF_LIST_INSTRUCTION = 831,
    OF_LIST_INSTRUCTION_ID = 832,
    OF_LIST_METER_BAND = 833,
    OF_LIST_METER_BAND_STATS = 834,
    OF_LIST_METER_CONFIG = 835,
    OF_LIST_METER_STATS = 836,
    OF_LIST_OXM = 837,
    OF_LIST_PACKET_QUEUE = 838,
    OF_LIST_PORT_DESC = 839,
    OF_LIST_PORT_DESC_PROP = 840,
    OF_LIST_PORT_MOD_PROP = 841,
    OF_LIST_PORT_STATS_ENTRY = 842,
    OF_LIST_PORT_STATS_PROP = 843,
    OF_LIST_QUEUE_DESC = 844,
    OF_LIST_QUEUE_DESC_PROP = 845,
    OF_LIST_QUEUE_PROP = 846,
    OF_LIST_QUEUE_STATS_ENTRY = 847,
    OF_LIST_QUEUE_STATS_PROP = 848,
    OF_LIST_ROLE_PROP = 849,
    OF_LIST_TABLE_DESC = 850,
    OF_LIST_TABLE_FEATURE_PROP = 851,
    OF_LIST_TABLE_FEATURES = 852,
    OF_LIST_TABLE_MOD_PROP = 853,
    OF_LIST_TABLE_STATS_ENTRY = 854,
    OF_LIST_UINT32 = 855,
    OF_LIST_UINT64 = 856,
    OF_LIST_UINT8 = 857,
