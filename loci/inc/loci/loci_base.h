...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_URI_SCHEME = 453,
    OF_BSN_TLV_USE_PACKET_STATE = 454,
    OF_BSN_TLV_VFI = 455,
    OF_BSN_TLV_VFP_CLASS_ID = 456,
    OF_BSN_TLV_VIRTUAL = 457,
    OF_BSN_TLV_VLAN_MAC_LIST = 458,
    OF_BSN_TLV_VLAN_PCP = 459,
    OF_BSN_TLV_VLAN_VID = 460,
    OF_BSN_TLV_VLAN_VID_MASK = 461,
    OF_BSN_TLV_VNI = 462,
    OF_BSN_TLV_VPN_KEY = 463,
    OF_BSN_TLV_VRF = 464,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 465,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 466,
    OF_BSN_VLAN_MAC = 467,
    OF_BSN_VPORT = 468,
    OF_BSN_VPORT_L2GRE = 469,
    OF_BSN_VPORT_Q_IN_Q = 470,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 471,
    OF_BUCKET = 472,
    OF_BUCKET_COUNTER = 473,
    OF_BUNDLE_PROP = 474,
    OF_BUNDLE_PROP_EXPERIMENTER = 475,
    OF_FLOW_STATS_ENTRY = 476,
    OF_GROUP_DESC_STATS_ENTRY = 477,
    OF_GROUP_STATS_ENTRY = 478,
    OF_HELLO_ELEM = 479,
    OF_HELLO_ELEM_VERSIONBITMAP = 480,
    OF_INSTRUCTION = 481,
    OF_INSTRUCTION_APPLY_ACTIONS = 482,
    OF_INSTRUCTION_BSN = 483,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 484,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 485,
    OF_INSTRUCTION_BSN_DENY = 486,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 487,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 488,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 489,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 490,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 491,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 492,
    OF_INSTRUCTION_BSN_HASH_SELECT = 493,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 494,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 495,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 496,
    OF_INSTRUCTION_BSN_PERMIT = 497,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 498,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 499,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 500,
    OF_INSTRUCTION_CLEAR_ACTIONS = 501,
    OF_INSTRUCTION_EXPERIMENTER = 502,
    OF_INSTRUCTION_GOTO_TABLE = 503,
    OF_INSTRUCTION_ID = 504,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 505,
    OF_INSTRUCTION_ID_BSN = 506,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 507,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 508,
    OF_INSTRUCTION_ID_BSN_DENY = 509,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 510,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 511,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 512,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 513,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 514,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 515,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 516,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 517,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 518,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 519,
    OF_INSTRUCTION_ID_BSN_PERMIT = 520,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 521,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 522,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 523,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 524,
    OF_INSTRUCTION_ID_EXPERIMENTER = 525,
    OF_INSTRUCTION_ID_GOTO_TABLE = 526,
    OF_INSTRUCTION_ID_METER = 527,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 528,
    OF_INSTRUCTION_ID_WRITE_METADATA = 529,
    OF_INSTRUCTION_METER = 530,
    OF_INSTRUCTION_WRITE_ACTIONS = 531,
    OF_INSTRUCTION_WRITE_METADATA = 532,
    OF_MATCH_V1 = 533,
    OF_MATCH_V2 = 534,
    OF_MATCH_V3 = 535,
    OF_METER_BAND = 536,
    OF_METER_BAND_DROP = 537,
    OF_METER_BAND_DSCP_REMARK = 538,
    OF_METER_BAND_EXPERIMENTER = 539,
    OF_METER_BAND_STATS = 540,
    OF_METER_CONFIG = 541,
    OF_METER_FEATURES = 542,
    OF_METER_STATS = 543,
    OF_OXM = 544,
    OF_OXM_ARP_OP = 545,
    OF_OXM_ARP_OP_MASKED = 546,
    OF_OXM_ARP_SHA = 547,
    OF_OXM_ARP_SHA_MASKED = 548,
    OF_OXM_ARP_SPA = 549,
    OF_OXM_ARP_SPA_MASKED = 550,
    OF_OXM_ARP_THA = 551,
    OF_OXM_ARP_THA_MASKED = 552,
    OF_OXM_ARP_TPA = 553,
    OF_OXM_ARP_TPA_MASKED = 554,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 555,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 556,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 557,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 558,
    OF_OXM_BSN_IFP_CLASS_ID = 559,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 560,
    OF_OXM_BSN_IN_PORTS_128 = 561,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 562,
    OF_OXM_BSN_IN_PORTS_512 = 563,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 564,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 565,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 566,
    OF_OXM_BSN_INNER_ETH_DST = 567,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 568,
    OF_OXM_BSN_INNER_ETH_SRC = 569,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 570,
    OF_OXM_BSN_INNER_VLAN_VID = 571,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 572,
    OF_OXM_BSN_IP_FRAGMENTATION = 573,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 574,
    OF_OXM_BSN_L2_CACHE_HIT = 575,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 576,
    OF_OXM_BSN_L3_DST_CLASS_ID = 577,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 578,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 579,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 580,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 581,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 582,
    OF_OXM_BSN_LAG_ID = 583,
    OF_OXM_BSN_LAG_ID_MASKED = 584,
    OF_OXM_BSN_TCP_FLAGS = 585,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 586,
    OF_OXM_BSN_UDF0 = 587,
    OF_OXM_BSN_UDF0_MASKED = 588,
    OF_OXM_BSN_UDF1 = 589,
    OF_OXM_BSN_UDF1_MASKED = 590,
    OF_OXM_BSN_UDF2 = 591,
    OF_OXM_BSN_UDF2_MASKED = 592,
    OF_OXM_BSN_UDF3 = 593,
    OF_OXM_BSN_UDF3_MASKED = 594,
    OF_OXM_BSN_UDF4 = 595,
    OF_OXM_BSN_UDF4_MASKED = 596,
    OF_OXM_BSN_UDF5 = 597,
    OF_OXM_BSN_UDF5_MASKED = 598,
    OF_OXM_BSN_UDF6 = 599,
    OF_OXM_BSN_UDF6_MASKED = 600,
    OF_OXM_BSN_UDF7 = 601,
    OF_OXM_BSN_UDF7_MASKED = 602,
    OF_OXM_BSN_VFI = 603,
    OF_OXM_BSN_VFI_MASKED = 604,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 605,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 606,
    OF_OXM_BSN_VRF = 607,
    OF_OXM_BSN_VRF_MASKED = 608,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 609,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 610,
    OF_OXM_CONN_TRACKING_IPV6_DST = 611,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 612,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 613,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 614,
    OF_OXM_CONN_TRACKING_LABEL = 615,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 616,
    OF_OXM_CONN_TRACKING_MARK = 617,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 618,
    OF_OXM_CONN_TRACKING_NW_DST = 619,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 620,
    OF_OXM_CONN_TRACKING_NW_PROTO = 621,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 622,
    OF_OXM_CONN_TRACKING_NW_SRC = 623,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 624,
    OF_OXM_CONN_TRACKING_STATE = 625,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 626,
    OF_OXM_CONN_TRACKING_TP_DST = 627,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 628,
    OF_OXM_CONN_TRACKING_TP_SRC = 629,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 630,
    OF_OXM_CONN_TRACKING_ZONE = 631,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 632,
    OF_OXM_ETH_DST = 633,
    OF_OXM_ETH_DST_MASKED = 634,
    OF_OXM_ETH_SRC = 635,
    OF_OXM_ETH_SRC_MASKED = 636,
    OF_OXM_ETH_TYPE = 637,
    OF_OXM_ETH_TYPE_MASKED = 638,
    OF_OXM_ICMPV4_CODE = 639,
    OF_OXM_ICMPV4_CODE_MASKED = 640,
    OF_OXM_ICMPV4_TYPE = 641,
    OF_OXM_ICMPV4_TYPE_MASKED = 642,
    OF_OXM_ICMPV6_CODE = 643,
    OF_OXM_ICMPV6_CODE_MASKED = 644,
    OF_OXM_ICMPV6_TYPE = 645,
    OF_OXM_ICMPV6_TYPE_MASKED = 646,
    OF_OXM_IN_PHY_PORT = 647,
    OF_OXM_IN_PHY_PORT_MASKED = 648,
    OF_OXM_IN_PORT = 649,
    OF_OXM_IN_PORT_MASKED = 650,
    OF_OXM_IP_DSCP = 651,
    OF_OXM_IP_DSCP_MASKED = 652,
    OF_OXM_IP_ECN = 653,
    OF_OXM_IP_ECN_MASKED = 654,
    OF_OXM_IP_PROTO = 655,
    OF_OXM_IP_PROTO_MASKED = 656,
    OF_OXM_IPV4_DST = 657,
    OF_OXM_IPV4_DST_MASKED = 658,
    OF_OXM_IPV4_SRC = 659,
    OF_OXM_IPV4_SRC_MASKED = 660,
    OF_OXM_IPV6_DST = 661,
    OF_OXM_IPV6_DST_MASKED = 662,
    OF_OXM_IPV6_EXTHDR = 663,
    OF_OXM_IPV6_EXTHDR_MASKED = 664,
    OF_OXM_IPV6_FLABEL = 665,
    OF_OXM_IPV6_FLABEL_MASKED = 666,
    OF_OXM_IPV6_ND_SLL = 667,
    OF_OXM_IPV6_ND_SLL_MASKED = 668,
    OF_OXM_IPV6_ND_TARGET = 669,
    OF_OXM_IPV6_ND_TARGET_MASKED = 670,
    OF_OXM_IPV6_ND_TLL = 671,
    OF_OXM_IPV6_ND_TLL_MASKED = 672,
    OF_OXM_IPV6_SRC = 673,
    OF_OXM_IPV6_SRC_MASKED = 674,
    OF_OXM_METADATA = 675,
    OF_OXM_METADATA_MASKED = 676,
    OF_OXM_MPLS_BOS = 677,
    OF_OXM_MPLS_BOS_MASKED = 678,
    OF_OXM_MPLS_LABEL = 679,
    OF_OXM_MPLS_LABEL_MASKED = 680,
    OF_OXM_MPLS_TC = 681,
    OF_OXM_MPLS_TC_MASKED = 682,
    OF_OXM_OVS_TCP_FLAGS = 683,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 684,
    OF_OXM_PBB_UCA = 685,
    OF_OXM_PBB_UCA_MASKED = 686,
    OF_OXM_SCTP_DST = 687,
    OF_OXM_SCTP_DST_MASKED = 688,
    OF_OXM_SCTP_SRC = 689,
    OF_OXM_SCTP_SRC_MASKED = 690,
    OF_OXM_TCP_DST = 691,
    OF_OXM_TCP_DST_MASKED = 692,
    OF_OXM_TCP_SRC = 693,
    OF_OXM_TCP_SRC_MASKED = 694,
    OF_OXM_TUNNEL_ID = 695,
    OF_OXM_TUNNEL_ID_MASKED = 696,
    OF_OXM_TUNNEL_IPV4_DST = 697,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 698,
    OF_OXM_TUNNEL_IPV4_SRC = 699,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 700,
    OF_OXM_UDP_DST = 701,
    OF_OXM_UDP_DST_MASKED = 702,
    OF_OXM_UDP_SRC = 703,
    OF_OXM_UDP_SRC_MASKED = 704,
    OF_OXM_VLAN_PCP = 705,
    OF_OXM_VLAN_PCP_MASKED = 706,
    OF_OXM_VLAN_VID = 707,
    OF_OXM_VLAN_VID_MASKED = 708,
    OF_PACKET_QUEUE = 709,
    OF_PORT_DESC = 710,
    OF_PORT_DESC_PROP = 711,
    OF_PORT_DESC_PROP_BSN = 712,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 713,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 714,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 715,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 716,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 717,
    OF_PORT_DESC_PROP_BSN_UPLINK = 718,
    OF_PORT_DESC_PROP_ETHERNET = 719,
    OF_PORT_DESC_PROP_EXPERIMENTER = 720,
    OF_PORT_DESC_PROP_OPTICAL = 721,
    OF_PORT_MOD_PROP = 722,
    OF_PORT_MOD_PROP_ETHERNET = 723,
    OF_PORT_MOD_PROP_EXPERIMENTER = 724,
    OF_PORT_MOD_PROP_OPTICAL = 725,
    OF_PORT_STATS_ENTRY = 726,
    OF_PORT_STATS_PROP = 727,
    OF_PORT_STATS_PROP_ETHERNET = 728,
    OF_PORT_STATS_PROP_EXPERIMENTER = 729,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 730,
    OF_PORT_STATS_PROP_OPTICAL = 731,
    OF_QUEUE_DESC = 732,
    OF_QUEUE_DESC_PROP = 733,
    OF_QUEUE_DESC_PROP_BSN = 734,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 735,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 736,
    OF_QUEUE_DESC_PROP_MAX_RATE = 737,
    OF_QUEUE_DESC_PROP_MIN_RATE = 738,
    OF_QUEUE_PROP = 739,
    OF_QUEUE_PROP_EXPERIMENTER = 740,
    OF_QUEUE_PROP_MAX_RATE = 741,
    OF_QUEUE_PROP_MIN_RATE = 742,
    OF_QUEUE_STATS_ENTRY = 743,
    OF_QUEUE_STATS_PROP = 744,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 745,
    OF_ROLE_PROP = 746,
    OF_ROLE_PROP_EXPERIMENTER = 747,
    OF_TABLE_DESC = 748,
    OF_TABLE_FEATURE_PROP = 749,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 750,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 751,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 752,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 753,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 754,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 755,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 756,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 757,
    OF_TABLE_FEATURE_PROP_MATCH = 758,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 759,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 760,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 761,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 762,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 763,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 764,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 765,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 766,
    OF_TABLE_FEATURES = 767,
    OF_TABLE_MOD_PROP = 768,
    OF_TABLE_MOD_PROP_EVICTION = 769,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 770,
    OF_TABLE_MOD_PROP_VACANCY = 771,
    OF_TABLE_STATS_ENTRY = 772,
    OF_UINT32 = 773,
    OF_UINT64 = 774,
    OF_UINT8 = 775,
    ...
    /* List objects */
    OF_LIST_ACTION = 776,
    OF_LIST_ACTION_ID = 777,
    OF_LIST_ASYNC_CONFIG_PROP = 778,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 779,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 780,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 781,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 782,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 783,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 784,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 785,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 786,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 787,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 788,
    OF_LIST_BSN_INTERFACE = 789,
    OF_LIST_BSN_LACP_STATS_ENTRY = 790,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 791,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 792,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 793,
    OF_LIST_BSN_TLV = 794,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 795,
    OF_LIST_BSN_VLAN_MAC = 796,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 797,
    OF_LIST_BUCKET = 798,
    OF_LIST_BUCKET_COUNTER = 799,
    OF_LIST_BUNDLE_PROP = 800,
    OF_LIST_FLOW_STATS_ENTRY = 801,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 802,
    OF_LIST_GROUP_STATS_ENTRY = 803,
    OF_LIST_HELLO_ELEM = 804,
    OF_LIST_INSTRUCTION = 805,
    OF_LIST_INSTRUCTION_ID = 806,
    OF_LIST_METER_BAND = 807,
    OF_LIST_METER_BAND_STATS = 808,
    OF_LIST_METER_CONFIG = 809,
    OF_LIST_METER_STATS = 810,
    OF_LIST_OXM = 811,
    OF_LIST_PACKET_QUEUE = 812,
    OF_LIST_PORT_DESC = 813,
    OF_LIST_PORT_DESC_PROP = 814,
    OF_LIST_PORT_MOD_PROP = 815,
    OF_LIST_PORT_STATS_ENTRY = 816,
    OF_LIST_PORT_STATS_PROP = 817,
    OF_LIST_QUEUE_DESC = 818,
    OF_LIST_QUEUE_DESC_PROP = 819,
    OF_LIST_QUEUE_PROP = 820,
    OF_LIST_QUEUE_STATS_ENTRY = 821,
    OF_LIST_QUEUE_STATS_PROP = 822,
    OF_LIST_ROLE_PROP = 823,
    OF_LIST_TABLE_DESC = 824,
    OF_LIST_TABLE_FEATURE_PROP = 825,
    OF_LIST_TABLE_FEATURES = 826,
    OF_LIST_TABLE_MOD_PROP = 827,
    OF_LIST_TABLE_STATS_ENTRY = 828,
    OF_LIST_UINT32 = 829,
    OF_LIST_UINT64 = 830,
    OF_LIST_UINT8 = 831,
