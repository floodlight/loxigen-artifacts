...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_FLOOD = 338,
    OF_BSN_TLV_FORCE_LINK_UP = 339,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 340,
    OF_BSN_TLV_GENERATION_ID = 341,
    OF_BSN_TLV_HASH_ALGORITHM = 342,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 343,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 344,
    OF_BSN_TLV_HASH_PACKET_FIELD = 345,
    OF_BSN_TLV_HASH_PACKET_TYPE = 346,
    OF_BSN_TLV_HASH_SEED = 347,
    OF_BSN_TLV_HASH_TYPE = 348,
    OF_BSN_TLV_HEADER_SIZE = 349,
    OF_BSN_TLV_ICMP_CODE = 350,
    OF_BSN_TLV_ICMP_ID = 351,
    OF_BSN_TLV_ICMP_TYPE = 352,
    OF_BSN_TLV_ICMPV6_CHKSUM = 353,
    OF_BSN_TLV_IDLE_NOTIFICATION = 354,
    OF_BSN_TLV_IDLE_TIME = 355,
    OF_BSN_TLV_IDLE_TIMEOUT = 356,
    OF_BSN_TLV_IGMP_SNOOPING = 357,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 358,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 359,
    OF_BSN_TLV_INTERNAL_MAC = 360,
    OF_BSN_TLV_INTERVAL = 361,
    OF_BSN_TLV_IP_PROTO = 362,
    OF_BSN_TLV_IPV4 = 363,
    OF_BSN_TLV_IPV4_DST = 364,
    OF_BSN_TLV_IPV4_NETMASK = 365,
    OF_BSN_TLV_IPV4_SRC = 366,
    OF_BSN_TLV_IPV6 = 367,
    OF_BSN_TLV_IPV6_DST = 368,
    OF_BSN_TLV_IPV6_PREFIX = 369,
    OF_BSN_TLV_IPV6_SRC = 370,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 371,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 372,
    OF_BSN_TLV_L3_DST_CLASS_ID = 373,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 374,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 375,
    OF_BSN_TLV_LAG_OPTIONS = 376,
    OF_BSN_TLV_LOOPBACK_MODE = 377,
    OF_BSN_TLV_LOOPBACK_PORT = 378,
    OF_BSN_TLV_MAC = 379,
    OF_BSN_TLV_MAC_MASK = 380,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 381,
    OF_BSN_TLV_MISS_PACKETS = 382,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 383,
    OF_BSN_TLV_MPLS_LABEL = 384,
    OF_BSN_TLV_MPLS_SEQUENCED = 385,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 386,
    OF_BSN_TLV_NAME = 387,
    OF_BSN_TLV_NDP_OFFLOAD = 388,
    OF_BSN_TLV_NDP_STATIC = 389,
    OF_BSN_TLV_NEGATE = 390,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 391,
    OF_BSN_TLV_NEXT_HOP_MAC = 392,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 393,
    OF_BSN_TLV_NO_ARP_RESPONSE = 394,
    OF_BSN_TLV_NO_NS_RESPONSE = 395,
    OF_BSN_TLV_OFFSET = 396,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 397,
    OF_BSN_TLV_OUTER_SRC_MAC = 398,
    OF_BSN_TLV_PARENT_PORT = 399,
    OF_BSN_TLV_PARTNER_KEY = 400,
    OF_BSN_TLV_PARTNER_PORT_NUM = 401,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 402,
    OF_BSN_TLV_PARTNER_STATE = 403,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 404,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 405,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 406,
    OF_BSN_TLV_PORT = 407,
    OF_BSN_TLV_PORT_SPEED_GBPS = 408,
    OF_BSN_TLV_PORT_USAGE = 409,
    OF_BSN_TLV_PORT_VXLAN_MODE = 410,
    OF_BSN_TLV_PRIORITY = 411,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 412,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 413,
    OF_BSN_TLV_QOS_PRIORITY = 414,
    OF_BSN_TLV_QUEUE_ID = 415,
    OF_BSN_TLV_QUEUE_WEIGHT = 416,
    OF_BSN_TLV_RATE_LIMIT = 417,
    OF_BSN_TLV_RATE_UNIT = 418,
    OF_BSN_TLV_RECORD_PACKETS = 419,
    OF_BSN_TLV_REFERENCE = 420,
    OF_BSN_TLV_REPLY_PACKETS = 421,
    OF_BSN_TLV_REQUEST_PACKETS = 422,
    OF_BSN_TLV_REST_SERVER = 423,
    OF_BSN_TLV_ROUTING_PARAM = 424,
    OF_BSN_TLV_RX_BYTES = 425,
    OF_BSN_TLV_RX_PACKETS = 426,
    OF_BSN_TLV_SAMPLING_RATE = 427,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 428,
    OF_BSN_TLV_STATUS = 429,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 430,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 431,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 432,
    OF_BSN_TLV_SUB_AGENT_ID = 433,
    OF_BSN_TLV_TCP_DST = 434,
    OF_BSN_TLV_TCP_FLAGS = 435,
    OF_BSN_TLV_TCP_SRC = 436,
    OF_BSN_TLV_TIMESTAMP = 437,
    OF_BSN_TLV_TTL = 438,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 439,
    OF_BSN_TLV_TX_BYTES = 440,
    OF_BSN_TLV_TX_PACKETS = 441,
    OF_BSN_TLV_UDF_ANCHOR = 442,
    OF_BSN_TLV_UDF_ID = 443,
    OF_BSN_TLV_UDF_LENGTH = 444,
    OF_BSN_TLV_UDF_OFFSET = 445,
    OF_BSN_TLV_UDP_DST = 446,
    OF_BSN_TLV_UDP_SRC = 447,
    OF_BSN_TLV_UINT64_LIST = 448,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 449,
    OF_BSN_TLV_UNICAST_RATE = 450,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 451,
    OF_BSN_TLV_UNTAGGED = 452,
    OF_BSN_TLV_UPGRADE_STAGE = 453,
    OF_BSN_TLV_URI_SCHEME = 454,
    OF_BSN_TLV_USE_PACKET_STATE = 455,
    OF_BSN_TLV_VFI = 456,
    OF_BSN_TLV_VFP_CLASS_ID = 457,
    OF_BSN_TLV_VIRTUAL = 458,
    OF_BSN_TLV_VLAN_MAC_LIST = 459,
    OF_BSN_TLV_VLAN_PCP = 460,
    OF_BSN_TLV_VLAN_VID = 461,
    OF_BSN_TLV_VLAN_VID_MASK = 462,
    OF_BSN_TLV_VNI = 463,
    OF_BSN_TLV_VPN_KEY = 464,
    OF_BSN_TLV_VRF = 465,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 466,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 467,
    OF_BSN_VLAN_MAC = 468,
    OF_BSN_VPORT = 469,
    OF_BSN_VPORT_L2GRE = 470,
    OF_BSN_VPORT_Q_IN_Q = 471,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 472,
    OF_BUCKET = 473,
    OF_BUCKET_COUNTER = 474,
    OF_BUNDLE_PROP = 475,
    OF_BUNDLE_PROP_EXPERIMENTER = 476,
    OF_FLOW_STATS_ENTRY = 477,
    OF_GROUP_DESC_STATS_ENTRY = 478,
    OF_GROUP_STATS_ENTRY = 479,
    OF_HELLO_ELEM = 480,
    OF_HELLO_ELEM_VERSIONBITMAP = 481,
    OF_INSTRUCTION = 482,
    OF_INSTRUCTION_APPLY_ACTIONS = 483,
    OF_INSTRUCTION_BSN = 484,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 485,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 486,
    OF_INSTRUCTION_BSN_DENY = 487,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 488,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 489,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 490,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 491,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 492,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 493,
    OF_INSTRUCTION_BSN_HASH_SELECT = 494,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 495,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 496,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 497,
    OF_INSTRUCTION_BSN_PERMIT = 498,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 499,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 500,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 501,
    OF_INSTRUCTION_CLEAR_ACTIONS = 502,
    OF_INSTRUCTION_EXPERIMENTER = 503,
    OF_INSTRUCTION_GOTO_TABLE = 504,
    OF_INSTRUCTION_ID = 505,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 506,
    OF_INSTRUCTION_ID_BSN = 507,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 508,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 509,
    OF_INSTRUCTION_ID_BSN_DENY = 510,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 511,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 512,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 513,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 514,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 515,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 516,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 517,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 518,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 519,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 520,
    OF_INSTRUCTION_ID_BSN_PERMIT = 521,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 522,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 523,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 524,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 525,
    OF_INSTRUCTION_ID_EXPERIMENTER = 526,
    OF_INSTRUCTION_ID_GOTO_TABLE = 527,
    OF_INSTRUCTION_ID_METER = 528,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 529,
    OF_INSTRUCTION_ID_WRITE_METADATA = 530,
    OF_INSTRUCTION_METER = 531,
    OF_INSTRUCTION_WRITE_ACTIONS = 532,
    OF_INSTRUCTION_WRITE_METADATA = 533,
    OF_MATCH_V1 = 534,
    OF_MATCH_V2 = 535,
    OF_MATCH_V3 = 536,
    OF_METER_BAND = 537,
    OF_METER_BAND_DROP = 538,
    OF_METER_BAND_DSCP_REMARK = 539,
    OF_METER_BAND_EXPERIMENTER = 540,
    OF_METER_BAND_STATS = 541,
    OF_METER_CONFIG = 542,
    OF_METER_FEATURES = 543,
    OF_METER_STATS = 544,
    OF_OXM = 545,
    OF_OXM_ARP_OP = 546,
    OF_OXM_ARP_OP_MASKED = 547,
    OF_OXM_ARP_SHA = 548,
    OF_OXM_ARP_SHA_MASKED = 549,
    OF_OXM_ARP_SPA = 550,
    OF_OXM_ARP_SPA_MASKED = 551,
    OF_OXM_ARP_THA = 552,
    OF_OXM_ARP_THA_MASKED = 553,
    OF_OXM_ARP_TPA = 554,
    OF_OXM_ARP_TPA_MASKED = 555,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 556,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 557,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 558,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 559,
    OF_OXM_BSN_IFP_CLASS_ID = 560,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 561,
    OF_OXM_BSN_IN_PORTS_128 = 562,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 563,
    OF_OXM_BSN_IN_PORTS_512 = 564,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 565,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 566,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 567,
    OF_OXM_BSN_INNER_ETH_DST = 568,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 569,
    OF_OXM_BSN_INNER_ETH_SRC = 570,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 571,
    OF_OXM_BSN_INNER_VLAN_VID = 572,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 573,
    OF_OXM_BSN_IP_FRAGMENTATION = 574,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 575,
    OF_OXM_BSN_L2_CACHE_HIT = 576,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 577,
    OF_OXM_BSN_L3_DST_CLASS_ID = 578,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 579,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 580,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 581,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 582,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 583,
    OF_OXM_BSN_LAG_ID = 584,
    OF_OXM_BSN_LAG_ID_MASKED = 585,
    OF_OXM_BSN_TCP_FLAGS = 586,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 587,
    OF_OXM_BSN_UDF0 = 588,
    OF_OXM_BSN_UDF0_MASKED = 589,
    OF_OXM_BSN_UDF1 = 590,
    OF_OXM_BSN_UDF1_MASKED = 591,
    OF_OXM_BSN_UDF2 = 592,
    OF_OXM_BSN_UDF2_MASKED = 593,
    OF_OXM_BSN_UDF3 = 594,
    OF_OXM_BSN_UDF3_MASKED = 595,
    OF_OXM_BSN_UDF4 = 596,
    OF_OXM_BSN_UDF4_MASKED = 597,
    OF_OXM_BSN_UDF5 = 598,
    OF_OXM_BSN_UDF5_MASKED = 599,
    OF_OXM_BSN_UDF6 = 600,
    OF_OXM_BSN_UDF6_MASKED = 601,
    OF_OXM_BSN_UDF7 = 602,
    OF_OXM_BSN_UDF7_MASKED = 603,
    OF_OXM_BSN_VFI = 604,
    OF_OXM_BSN_VFI_MASKED = 605,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 606,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 607,
    OF_OXM_BSN_VRF = 608,
    OF_OXM_BSN_VRF_MASKED = 609,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 610,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 611,
    OF_OXM_CONN_TRACKING_IPV6_DST = 612,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 613,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 614,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 615,
    OF_OXM_CONN_TRACKING_LABEL = 616,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 617,
    OF_OXM_CONN_TRACKING_MARK = 618,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 619,
    OF_OXM_CONN_TRACKING_NW_DST = 620,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 621,
    OF_OXM_CONN_TRACKING_NW_PROTO = 622,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 623,
    OF_OXM_CONN_TRACKING_NW_SRC = 624,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 625,
    OF_OXM_CONN_TRACKING_STATE = 626,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 627,
    OF_OXM_CONN_TRACKING_TP_DST = 628,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 629,
    OF_OXM_CONN_TRACKING_TP_SRC = 630,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 631,
    OF_OXM_CONN_TRACKING_ZONE = 632,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 633,
    OF_OXM_ETH_DST = 634,
    OF_OXM_ETH_DST_MASKED = 635,
    OF_OXM_ETH_SRC = 636,
    OF_OXM_ETH_SRC_MASKED = 637,
    OF_OXM_ETH_TYPE = 638,
    OF_OXM_ETH_TYPE_MASKED = 639,
    OF_OXM_ICMPV4_CODE = 640,
    OF_OXM_ICMPV4_CODE_MASKED = 641,
    OF_OXM_ICMPV4_TYPE = 642,
    OF_OXM_ICMPV4_TYPE_MASKED = 643,
    OF_OXM_ICMPV6_CODE = 644,
    OF_OXM_ICMPV6_CODE_MASKED = 645,
    OF_OXM_ICMPV6_TYPE = 646,
    OF_OXM_ICMPV6_TYPE_MASKED = 647,
    OF_OXM_IN_PHY_PORT = 648,
    OF_OXM_IN_PHY_PORT_MASKED = 649,
    OF_OXM_IN_PORT = 650,
    OF_OXM_IN_PORT_MASKED = 651,
    OF_OXM_IP_DSCP = 652,
    OF_OXM_IP_DSCP_MASKED = 653,
    OF_OXM_IP_ECN = 654,
    OF_OXM_IP_ECN_MASKED = 655,
    OF_OXM_IP_PROTO = 656,
    OF_OXM_IP_PROTO_MASKED = 657,
    OF_OXM_IPV4_DST = 658,
    OF_OXM_IPV4_DST_MASKED = 659,
    OF_OXM_IPV4_SRC = 660,
    OF_OXM_IPV4_SRC_MASKED = 661,
    OF_OXM_IPV6_DST = 662,
    OF_OXM_IPV6_DST_MASKED = 663,
    OF_OXM_IPV6_EXTHDR = 664,
    OF_OXM_IPV6_EXTHDR_MASKED = 665,
    OF_OXM_IPV6_FLABEL = 666,
    OF_OXM_IPV6_FLABEL_MASKED = 667,
    OF_OXM_IPV6_ND_SLL = 668,
    OF_OXM_IPV6_ND_SLL_MASKED = 669,
    OF_OXM_IPV6_ND_TARGET = 670,
    OF_OXM_IPV6_ND_TARGET_MASKED = 671,
    OF_OXM_IPV6_ND_TLL = 672,
    OF_OXM_IPV6_ND_TLL_MASKED = 673,
    OF_OXM_IPV6_SRC = 674,
    OF_OXM_IPV6_SRC_MASKED = 675,
    OF_OXM_METADATA = 676,
    OF_OXM_METADATA_MASKED = 677,
    OF_OXM_MPLS_BOS = 678,
    OF_OXM_MPLS_BOS_MASKED = 679,
    OF_OXM_MPLS_LABEL = 680,
    OF_OXM_MPLS_LABEL_MASKED = 681,
    OF_OXM_MPLS_TC = 682,
    OF_OXM_MPLS_TC_MASKED = 683,
    OF_OXM_OVS_TCP_FLAGS = 684,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 685,
    OF_OXM_PBB_UCA = 686,
    OF_OXM_PBB_UCA_MASKED = 687,
    OF_OXM_SCTP_DST = 688,
    OF_OXM_SCTP_DST_MASKED = 689,
    OF_OXM_SCTP_SRC = 690,
    OF_OXM_SCTP_SRC_MASKED = 691,
    OF_OXM_TCP_DST = 692,
    OF_OXM_TCP_DST_MASKED = 693,
    OF_OXM_TCP_SRC = 694,
    OF_OXM_TCP_SRC_MASKED = 695,
    OF_OXM_TUNNEL_ID = 696,
    OF_OXM_TUNNEL_ID_MASKED = 697,
    OF_OXM_TUNNEL_IPV4_DST = 698,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 699,
    OF_OXM_TUNNEL_IPV4_SRC = 700,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 701,
    OF_OXM_UDP_DST = 702,
    OF_OXM_UDP_DST_MASKED = 703,
    OF_OXM_UDP_SRC = 704,
    OF_OXM_UDP_SRC_MASKED = 705,
    OF_OXM_VLAN_PCP = 706,
    OF_OXM_VLAN_PCP_MASKED = 707,
    OF_OXM_VLAN_VID = 708,
    OF_OXM_VLAN_VID_MASKED = 709,
    OF_PACKET_QUEUE = 710,
    OF_PORT_DESC = 711,
    OF_PORT_DESC_PROP = 712,
    OF_PORT_DESC_PROP_BSN = 713,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 714,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 715,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 716,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 717,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 718,
    OF_PORT_DESC_PROP_BSN_UPLINK = 719,
    OF_PORT_DESC_PROP_ETHERNET = 720,
    OF_PORT_DESC_PROP_EXPERIMENTER = 721,
    OF_PORT_DESC_PROP_OPTICAL = 722,
    OF_PORT_MOD_PROP = 723,
    OF_PORT_MOD_PROP_ETHERNET = 724,
    OF_PORT_MOD_PROP_EXPERIMENTER = 725,
    OF_PORT_MOD_PROP_OPTICAL = 726,
    OF_PORT_STATS_ENTRY = 727,
    OF_PORT_STATS_PROP = 728,
    OF_PORT_STATS_PROP_ETHERNET = 729,
    OF_PORT_STATS_PROP_EXPERIMENTER = 730,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 731,
    OF_PORT_STATS_PROP_OPTICAL = 732,
    OF_QUEUE_DESC = 733,
    OF_QUEUE_DESC_PROP = 734,
    OF_QUEUE_DESC_PROP_BSN = 735,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 736,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 737,
    OF_QUEUE_DESC_PROP_MAX_RATE = 738,
    OF_QUEUE_DESC_PROP_MIN_RATE = 739,
    OF_QUEUE_PROP = 740,
    OF_QUEUE_PROP_EXPERIMENTER = 741,
    OF_QUEUE_PROP_MAX_RATE = 742,
    OF_QUEUE_PROP_MIN_RATE = 743,
    OF_QUEUE_STATS_ENTRY = 744,
    OF_QUEUE_STATS_PROP = 745,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 746,
    OF_ROLE_PROP = 747,
    OF_ROLE_PROP_EXPERIMENTER = 748,
    OF_TABLE_DESC = 749,
    OF_TABLE_FEATURE_PROP = 750,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 751,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 752,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 753,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 754,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 755,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 756,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 757,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 758,
    OF_TABLE_FEATURE_PROP_MATCH = 759,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 760,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 761,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 762,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 763,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 764,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 765,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 766,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 767,
    OF_TABLE_FEATURES = 768,
    OF_TABLE_MOD_PROP = 769,
    OF_TABLE_MOD_PROP_EVICTION = 770,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 771,
    OF_TABLE_MOD_PROP_VACANCY = 772,
    OF_TABLE_STATS_ENTRY = 773,
    OF_UINT32 = 774,
    OF_UINT64 = 775,
    OF_UINT8 = 776,
    ...
    /* List objects */
    OF_LIST_ACTION = 777,
    OF_LIST_ACTION_ID = 778,
    OF_LIST_ASYNC_CONFIG_PROP = 779,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 780,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 781,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 782,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 783,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 784,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 785,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 786,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 787,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 788,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 789,
    OF_LIST_BSN_INTERFACE = 790,
    OF_LIST_BSN_LACP_STATS_ENTRY = 791,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 792,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 793,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 794,
    OF_LIST_BSN_TLV = 795,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 796,
    OF_LIST_BSN_VLAN_MAC = 797,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 798,
    OF_LIST_BUCKET = 799,
    OF_LIST_BUCKET_COUNTER = 800,
    OF_LIST_BUNDLE_PROP = 801,
    OF_LIST_FLOW_STATS_ENTRY = 802,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 803,
    OF_LIST_GROUP_STATS_ENTRY = 804,
    OF_LIST_HELLO_ELEM = 805,
    OF_LIST_INSTRUCTION = 806,
    OF_LIST_INSTRUCTION_ID = 807,
    OF_LIST_METER_BAND = 808,
    OF_LIST_METER_BAND_STATS = 809,
    OF_LIST_METER_CONFIG = 810,
    OF_LIST_METER_STATS = 811,
    OF_LIST_OXM = 812,
    OF_LIST_PACKET_QUEUE = 813,
    OF_LIST_PORT_DESC = 814,
    OF_LIST_PORT_DESC_PROP = 815,
    OF_LIST_PORT_MOD_PROP = 816,
    OF_LIST_PORT_STATS_ENTRY = 817,
    OF_LIST_PORT_STATS_PROP = 818,
    OF_LIST_QUEUE_DESC = 819,
    OF_LIST_QUEUE_DESC_PROP = 820,
    OF_LIST_QUEUE_PROP = 821,
    OF_LIST_QUEUE_STATS_ENTRY = 822,
    OF_LIST_QUEUE_STATS_PROP = 823,
    OF_LIST_ROLE_PROP = 824,
    OF_LIST_TABLE_DESC = 825,
    OF_LIST_TABLE_FEATURE_PROP = 826,
    OF_LIST_TABLE_FEATURES = 827,
    OF_LIST_TABLE_MOD_PROP = 828,
    OF_LIST_TABLE_STATS_ENTRY = 829,
    OF_LIST_UINT32 = 830,
    OF_LIST_UINT64 = 831,
    OF_LIST_UINT8 = 832,
