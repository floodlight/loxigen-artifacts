...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_CLEAR_ACTIONS = 312,
    OF_INSTRUCTION_EXPERIMENTER = 313,
    OF_INSTRUCTION_GOTO_TABLE = 314,
    OF_INSTRUCTION_HEADER = 315,
    OF_INSTRUCTION_ID = 316,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 317,
    OF_INSTRUCTION_ID_BSN = 318,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 319,
    OF_INSTRUCTION_ID_BSN_DENY = 320,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 321,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 322,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 323,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 324,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 325,
    OF_INSTRUCTION_ID_BSN_PERMIT = 326,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 327,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 328,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 329,
    OF_INSTRUCTION_ID_EXPERIMENTER = 330,
    OF_INSTRUCTION_ID_GOTO_TABLE = 331,
    OF_INSTRUCTION_ID_HEADER = 332,
    OF_INSTRUCTION_ID_METER = 333,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 334,
    OF_INSTRUCTION_ID_WRITE_METADATA = 335,
    OF_INSTRUCTION_METER = 336,
    OF_INSTRUCTION_WRITE_ACTIONS = 337,
    OF_INSTRUCTION_WRITE_METADATA = 338,
    OF_MATCH_V1 = 339,
    OF_MATCH_V2 = 340,
    OF_MATCH_V3 = 341,
    OF_METER_BAND = 342,
    OF_METER_BAND_DROP = 343,
    OF_METER_BAND_DSCP_REMARK = 344,
    OF_METER_BAND_EXPERIMENTER = 345,
    OF_METER_BAND_HEADER = 346,
    OF_METER_BAND_STATS = 347,
    OF_METER_CONFIG = 348,
    OF_METER_FEATURES = 349,
    OF_METER_STATS = 350,
    OF_OXM = 351,
    OF_OXM_ARP_OP = 352,
    OF_OXM_ARP_OP_MASKED = 353,
    OF_OXM_ARP_SHA = 354,
    OF_OXM_ARP_SHA_MASKED = 355,
    OF_OXM_ARP_SPA = 356,
    OF_OXM_ARP_SPA_MASKED = 357,
    OF_OXM_ARP_THA = 358,
    OF_OXM_ARP_THA_MASKED = 359,
    OF_OXM_ARP_TPA = 360,
    OF_OXM_ARP_TPA_MASKED = 361,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 362,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 363,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 364,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 365,
    OF_OXM_BSN_IN_PORTS_128 = 366,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 367,
    OF_OXM_BSN_L3_DST_CLASS_ID = 368,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 369,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 370,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 371,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 372,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 373,
    OF_OXM_BSN_LAG_ID = 374,
    OF_OXM_BSN_LAG_ID_MASKED = 375,
    OF_OXM_BSN_TCP_FLAGS = 376,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 377,
    OF_OXM_BSN_UDF0 = 378,
    OF_OXM_BSN_UDF0_MASKED = 379,
    OF_OXM_BSN_UDF1 = 380,
    OF_OXM_BSN_UDF1_MASKED = 381,
    OF_OXM_BSN_UDF2 = 382,
    OF_OXM_BSN_UDF2_MASKED = 383,
    OF_OXM_BSN_UDF3 = 384,
    OF_OXM_BSN_UDF3_MASKED = 385,
    OF_OXM_BSN_UDF4 = 386,
    OF_OXM_BSN_UDF4_MASKED = 387,
    OF_OXM_BSN_UDF5 = 388,
    OF_OXM_BSN_UDF5_MASKED = 389,
    OF_OXM_BSN_UDF6 = 390,
    OF_OXM_BSN_UDF6_MASKED = 391,
    OF_OXM_BSN_UDF7 = 392,
    OF_OXM_BSN_UDF7_MASKED = 393,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 394,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 395,
    OF_OXM_BSN_VRF = 396,
    OF_OXM_BSN_VRF_MASKED = 397,
    OF_OXM_ETH_DST = 398,
    OF_OXM_ETH_DST_MASKED = 399,
    OF_OXM_ETH_SRC = 400,
    OF_OXM_ETH_SRC_MASKED = 401,
    OF_OXM_ETH_TYPE = 402,
    OF_OXM_ETH_TYPE_MASKED = 403,
    OF_OXM_HEADER = 404,
    OF_OXM_ICMPV4_CODE = 405,
    OF_OXM_ICMPV4_CODE_MASKED = 406,
    OF_OXM_ICMPV4_TYPE = 407,
    OF_OXM_ICMPV4_TYPE_MASKED = 408,
    OF_OXM_ICMPV6_CODE = 409,
    OF_OXM_ICMPV6_CODE_MASKED = 410,
    OF_OXM_ICMPV6_TYPE = 411,
    OF_OXM_ICMPV6_TYPE_MASKED = 412,
    OF_OXM_IN_PHY_PORT = 413,
    OF_OXM_IN_PHY_PORT_MASKED = 414,
    OF_OXM_IN_PORT = 415,
    OF_OXM_IN_PORT_MASKED = 416,
    OF_OXM_IP_DSCP = 417,
    OF_OXM_IP_DSCP_MASKED = 418,
    OF_OXM_IP_ECN = 419,
    OF_OXM_IP_ECN_MASKED = 420,
    OF_OXM_IP_PROTO = 421,
    OF_OXM_IP_PROTO_MASKED = 422,
    OF_OXM_IPV4_DST = 423,
    OF_OXM_IPV4_DST_MASKED = 424,
    OF_OXM_IPV4_SRC = 425,
    OF_OXM_IPV4_SRC_MASKED = 426,
    OF_OXM_IPV6_DST = 427,
    OF_OXM_IPV6_DST_MASKED = 428,
    OF_OXM_IPV6_FLABEL = 429,
    OF_OXM_IPV6_FLABEL_MASKED = 430,
    OF_OXM_IPV6_ND_SLL = 431,
    OF_OXM_IPV6_ND_SLL_MASKED = 432,
    OF_OXM_IPV6_ND_TARGET = 433,
    OF_OXM_IPV6_ND_TARGET_MASKED = 434,
    OF_OXM_IPV6_ND_TLL = 435,
    OF_OXM_IPV6_ND_TLL_MASKED = 436,
    OF_OXM_IPV6_SRC = 437,
    OF_OXM_IPV6_SRC_MASKED = 438,
    OF_OXM_METADATA = 439,
    OF_OXM_METADATA_MASKED = 440,
    OF_OXM_MPLS_LABEL = 441,
    OF_OXM_MPLS_LABEL_MASKED = 442,
    OF_OXM_MPLS_TC = 443,
    OF_OXM_MPLS_TC_MASKED = 444,
    OF_OXM_SCTP_DST = 445,
    OF_OXM_SCTP_DST_MASKED = 446,
    OF_OXM_SCTP_SRC = 447,
    OF_OXM_SCTP_SRC_MASKED = 448,
    OF_OXM_TCP_DST = 449,
    OF_OXM_TCP_DST_MASKED = 450,
    OF_OXM_TCP_SRC = 451,
    OF_OXM_TCP_SRC_MASKED = 452,
    OF_OXM_TUNNEL_ID = 453,
    OF_OXM_TUNNEL_ID_MASKED = 454,
    OF_OXM_UDP_DST = 455,
    OF_OXM_UDP_DST_MASKED = 456,
    OF_OXM_UDP_SRC = 457,
    OF_OXM_UDP_SRC_MASKED = 458,
    OF_OXM_VLAN_PCP = 459,
    OF_OXM_VLAN_PCP_MASKED = 460,
    OF_OXM_VLAN_VID = 461,
    OF_OXM_VLAN_VID_MASKED = 462,
    OF_PACKET_QUEUE = 463,
    OF_PORT_DESC = 464,
    OF_PORT_STATS_ENTRY = 465,
    OF_QUEUE_PROP = 466,
    OF_QUEUE_PROP_EXPERIMENTER = 467,
    OF_QUEUE_PROP_HEADER = 468,
    OF_QUEUE_PROP_MAX_RATE = 469,
    OF_QUEUE_PROP_MIN_RATE = 470,
    OF_QUEUE_STATS_ENTRY = 471,
    OF_TABLE_FEATURE_PROP = 472,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 473,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 474,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 475,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 476,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 477,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 478,
    OF_TABLE_FEATURE_PROP_HEADER = 479,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 480,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 481,
    OF_TABLE_FEATURE_PROP_MATCH = 482,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 483,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 484,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 485,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 486,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 487,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 488,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 489,
    OF_TABLE_FEATURES = 490,
    OF_TABLE_STATS_ENTRY = 491,
    OF_UINT32 = 492,
    OF_UINT64 = 493,
    OF_UINT8 = 494,
    ...
    /* List objects */
    OF_LIST_ACTION = 495,
    OF_LIST_ACTION_ID = 496,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 497,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 498,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 499,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 500,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 501,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 502,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 503,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 504,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 505,
    OF_LIST_BSN_INTERFACE = 506,
    OF_LIST_BSN_LACP_STATS_ENTRY = 507,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 508,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 509,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 510,
    OF_LIST_BSN_TLV = 511,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 512,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 513,
    OF_LIST_BUCKET = 514,
    OF_LIST_BUCKET_COUNTER = 515,
    OF_LIST_FLOW_STATS_ENTRY = 516,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 517,
    OF_LIST_GROUP_STATS_ENTRY = 518,
    OF_LIST_HELLO_ELEM = 519,
    OF_LIST_INSTRUCTION = 520,
    OF_LIST_INSTRUCTION_ID = 521,
    OF_LIST_METER_BAND = 522,
    OF_LIST_METER_BAND_STATS = 523,
    OF_LIST_METER_STATS = 524,
    OF_LIST_OXM = 525,
    OF_LIST_PACKET_QUEUE = 526,
    OF_LIST_PORT_DESC = 527,
    OF_LIST_PORT_STATS_ENTRY = 528,
    OF_LIST_QUEUE_PROP = 529,
    OF_LIST_QUEUE_STATS_ENTRY = 530,
    OF_LIST_TABLE_FEATURE_PROP = 531,
    OF_LIST_TABLE_FEATURES = 532,
    OF_LIST_TABLE_STATS_ENTRY = 533,
    OF_LIST_UINT32 = 534,
    OF_LIST_UINT64 = 535,
    OF_LIST_UINT8 = 536,
