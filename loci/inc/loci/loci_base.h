...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_REPLY_PACKETS = 332,
    OF_BSN_TLV_REQUEST_PACKETS = 333,
    OF_BSN_TLV_RX_PACKETS = 334,
    OF_BSN_TLV_SAMPLING_RATE = 335,
    OF_BSN_TLV_SUB_AGENT_ID = 336,
    OF_BSN_TLV_TX_BYTES = 337,
    OF_BSN_TLV_TX_PACKETS = 338,
    OF_BSN_TLV_UDF_ANCHOR = 339,
    OF_BSN_TLV_UDF_ID = 340,
    OF_BSN_TLV_UDF_LENGTH = 341,
    OF_BSN_TLV_UDF_OFFSET = 342,
    OF_BSN_TLV_UDP_DST = 343,
    OF_BSN_TLV_UDP_SRC = 344,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 345,
    OF_BSN_TLV_VLAN_VID = 346,
    OF_BSN_TLV_VRF = 347,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 348,
    OF_BSN_VPORT = 349,
    OF_BSN_VPORT_L2GRE = 350,
    OF_BSN_VPORT_Q_IN_Q = 351,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 352,
    OF_BUCKET = 353,
    OF_BUCKET_COUNTER = 354,
    OF_BUNDLE_PROP = 355,
    OF_BUNDLE_PROP_EXPERIMENTER = 356,
    OF_FLOW_STATS_ENTRY = 357,
    OF_GROUP_DESC_STATS_ENTRY = 358,
    OF_GROUP_STATS_ENTRY = 359,
    OF_HELLO_ELEM = 360,
    OF_HELLO_ELEM_VERSIONBITMAP = 361,
    OF_INSTRUCTION = 362,
    OF_INSTRUCTION_APPLY_ACTIONS = 363,
    OF_INSTRUCTION_BSN = 364,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 365,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 366,
    OF_INSTRUCTION_BSN_DENY = 367,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 368,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 369,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 370,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 371,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 372,
    OF_INSTRUCTION_BSN_PERMIT = 373,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 374,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 375,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 376,
    OF_INSTRUCTION_CLEAR_ACTIONS = 377,
    OF_INSTRUCTION_EXPERIMENTER = 378,
    OF_INSTRUCTION_GOTO_TABLE = 379,
    OF_INSTRUCTION_ID = 380,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 381,
    OF_INSTRUCTION_ID_BSN = 382,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 383,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 384,
    OF_INSTRUCTION_ID_BSN_DENY = 385,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 386,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 387,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 388,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 389,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 390,
    OF_INSTRUCTION_ID_BSN_PERMIT = 391,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 392,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 393,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 394,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 395,
    OF_INSTRUCTION_ID_EXPERIMENTER = 396,
    OF_INSTRUCTION_ID_GOTO_TABLE = 397,
    ...
    OF_METER_BAND_STATS = 411,
    OF_METER_CONFIG = 412,
    OF_METER_FEATURES = 413,
    OF_METER_STATS = 414,
    OF_OXM = 415,
    OF_OXM_ARP_OP = 416,
    OF_OXM_ARP_OP_MASKED = 417,
    OF_OXM_ARP_SHA = 418,
    OF_OXM_ARP_SHA_MASKED = 419,
    OF_OXM_ARP_SPA = 420,
    OF_OXM_ARP_SPA_MASKED = 421,
    OF_OXM_ARP_THA = 422,
    OF_OXM_ARP_THA_MASKED = 423,
    OF_OXM_ARP_TPA = 424,
    OF_OXM_ARP_TPA_MASKED = 425,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 426,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 427,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 428,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 429,
    OF_OXM_BSN_IN_PORTS_128 = 430,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 431,
    OF_OXM_BSN_L2_CACHE_HIT = 432,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 433,
    ...
    OF_OXM_BSN_TCP_FLAGS = 442,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 443,
    OF_OXM_BSN_UDF0 = 444,
    OF_OXM_BSN_UDF0_MASKED = 445,
    OF_OXM_BSN_UDF1 = 446,
    OF_OXM_BSN_UDF1_MASKED = 447,
    OF_OXM_BSN_UDF2 = 448,
    OF_OXM_BSN_UDF2_MASKED = 449,
    OF_OXM_BSN_UDF3 = 450,
    OF_OXM_BSN_UDF3_MASKED = 451,
    OF_OXM_BSN_UDF4 = 452,
    OF_OXM_BSN_UDF4_MASKED = 453,
    OF_OXM_BSN_UDF5 = 454,
    OF_OXM_BSN_UDF5_MASKED = 455,
    OF_OXM_BSN_UDF6 = 456,
    OF_OXM_BSN_UDF6_MASKED = 457,
    OF_OXM_BSN_UDF7 = 458,
    OF_OXM_BSN_UDF7_MASKED = 459,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 460,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 461,
    OF_OXM_BSN_VRF = 462,
    OF_OXM_BSN_VRF_MASKED = 463,
    OF_OXM_ETH_DST = 464,
    OF_OXM_ETH_DST_MASKED = 465,
    OF_OXM_ETH_SRC = 466,
    OF_OXM_ETH_SRC_MASKED = 467,
    OF_OXM_ETH_TYPE = 468,
    OF_OXM_ETH_TYPE_MASKED = 469,
    OF_OXM_ICMPV4_CODE = 470,
    OF_OXM_ICMPV4_CODE_MASKED = 471,
    OF_OXM_ICMPV4_TYPE = 472,
    OF_OXM_ICMPV4_TYPE_MASKED = 473,
    OF_OXM_ICMPV6_CODE = 474,
    OF_OXM_ICMPV6_CODE_MASKED = 475,
    OF_OXM_ICMPV6_TYPE = 476,
    OF_OXM_ICMPV6_TYPE_MASKED = 477,
    OF_OXM_IN_PHY_PORT = 478,
    OF_OXM_IN_PHY_PORT_MASKED = 479,
    OF_OXM_IN_PORT = 480,
    OF_OXM_IN_PORT_MASKED = 481,
    OF_OXM_IP_DSCP = 482,
    OF_OXM_IP_DSCP_MASKED = 483,
    OF_OXM_IP_ECN = 484,
    OF_OXM_IP_ECN_MASKED = 485,
    OF_OXM_IP_PROTO = 486,
    OF_OXM_IP_PROTO_MASKED = 487,
    OF_OXM_IPV4_DST = 488,
    OF_OXM_IPV4_DST_MASKED = 489,
    OF_OXM_IPV4_SRC = 490,
    OF_OXM_IPV4_SRC_MASKED = 491,
    OF_OXM_IPV6_DST = 492,
    OF_OXM_IPV6_DST_MASKED = 493,
    OF_OXM_IPV6_EXTHDR = 494,
    OF_OXM_IPV6_EXTHDR_MASKED = 495,
    OF_OXM_IPV6_FLABEL = 496,
    OF_OXM_IPV6_FLABEL_MASKED = 497,
    OF_OXM_IPV6_ND_SLL = 498,
    OF_OXM_IPV6_ND_SLL_MASKED = 499,
    OF_OXM_IPV6_ND_TARGET = 500,
    OF_OXM_IPV6_ND_TARGET_MASKED = 501,
    OF_OXM_IPV6_ND_TLL = 502,
    OF_OXM_IPV6_ND_TLL_MASKED = 503,
    OF_OXM_IPV6_SRC = 504,
    OF_OXM_IPV6_SRC_MASKED = 505,
    OF_OXM_METADATA = 506,
    OF_OXM_METADATA_MASKED = 507,
    OF_OXM_MPLS_BOS = 508,
    OF_OXM_MPLS_BOS_MASKED = 509,
    OF_OXM_MPLS_LABEL = 510,
    OF_OXM_MPLS_LABEL_MASKED = 511,
    OF_OXM_MPLS_TC = 512,
    OF_OXM_MPLS_TC_MASKED = 513,
    OF_OXM_PBB_UCA = 514,
    OF_OXM_PBB_UCA_MASKED = 515,
    OF_OXM_SCTP_DST = 516,
    OF_OXM_SCTP_DST_MASKED = 517,
    OF_OXM_SCTP_SRC = 518,
    OF_OXM_SCTP_SRC_MASKED = 519,
    OF_OXM_TCP_DST = 520,
    OF_OXM_TCP_DST_MASKED = 521,
    OF_OXM_TCP_SRC = 522,
    OF_OXM_TCP_SRC_MASKED = 523,
    OF_OXM_TUNNEL_ID = 524,
    OF_OXM_TUNNEL_ID_MASKED = 525,
    OF_OXM_TUNNEL_IPV4_DST = 526,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 527,
    OF_OXM_TUNNEL_IPV4_SRC = 528,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 529,
    OF_OXM_UDP_DST = 530,
    OF_OXM_UDP_DST_MASKED = 531,
    OF_OXM_UDP_SRC = 532,
    OF_OXM_UDP_SRC_MASKED = 533,
    OF_OXM_VLAN_PCP = 534,
    OF_OXM_VLAN_PCP_MASKED = 535,
    OF_OXM_VLAN_VID = 536,
    OF_OXM_VLAN_VID_MASKED = 537,
    OF_PACKET_QUEUE = 538,
    OF_PORT_DESC = 539,
    OF_PORT_DESC_PROP = 540,
    OF_PORT_DESC_PROP_ETHERNET = 541,
    OF_PORT_DESC_PROP_EXPERIMENTER = 542,
    OF_PORT_DESC_PROP_OPTICAL = 543,
    OF_PORT_MOD_PROP = 544,
    OF_PORT_MOD_PROP_ETHERNET = 545,
    OF_PORT_MOD_PROP_EXPERIMENTER = 546,
    OF_PORT_MOD_PROP_OPTICAL = 547,
    OF_PORT_STATS_ENTRY = 548,
    OF_PORT_STATS_PROP = 549,
    OF_PORT_STATS_PROP_ETHERNET = 550,
    OF_PORT_STATS_PROP_EXPERIMENTER = 551,
    OF_PORT_STATS_PROP_OPTICAL = 552,
    OF_QUEUE_DESC = 553,
    OF_QUEUE_DESC_PROP = 554,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 555,
    OF_QUEUE_DESC_PROP_MAX_RATE = 556,
    OF_QUEUE_DESC_PROP_MIN_RATE = 557,
    OF_QUEUE_PROP = 558,
    OF_QUEUE_PROP_EXPERIMENTER = 559,
    OF_QUEUE_PROP_MAX_RATE = 560,
    OF_QUEUE_PROP_MIN_RATE = 561,
    OF_QUEUE_STATS_ENTRY = 562,
    OF_QUEUE_STATS_PROP = 563,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 564,
    OF_ROLE_PROP = 565,
    OF_ROLE_PROP_EXPERIMENTER = 566,
    OF_TABLE_DESC = 567,
    OF_TABLE_FEATURE_PROP = 568,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 569,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 570,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 571,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 572,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 573,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 574,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 575,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 576,
    OF_TABLE_FEATURE_PROP_MATCH = 577,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 578,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 579,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 580,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 581,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 582,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 583,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 584,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 585,
    OF_TABLE_FEATURES = 586,
    OF_TABLE_MOD_PROP = 587,
    OF_TABLE_MOD_PROP_EVICTION = 588,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 589,
    OF_TABLE_MOD_PROP_VACANCY = 590,
    OF_TABLE_STATS_ENTRY = 591,
    OF_UINT32 = 592,
    OF_UINT64 = 593,
    OF_UINT8 = 594,
    ...
    /* List objects */
    OF_LIST_ACTION = 595,
    OF_LIST_ACTION_ID = 596,
    OF_LIST_ASYNC_CONFIG_PROP = 597,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 598,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 599,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 600,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 601,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 602,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 603,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 604,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 605,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 606,
    OF_LIST_BSN_INTERFACE = 607,
    OF_LIST_BSN_LACP_STATS_ENTRY = 608,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 609,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 610,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 611,
    OF_LIST_BSN_TLV = 612,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 613,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 614,
    OF_LIST_BUCKET = 615,
    OF_LIST_BUCKET_COUNTER = 616,
    OF_LIST_BUNDLE_PROP = 617,
    OF_LIST_FLOW_STATS_ENTRY = 618,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 619,
    OF_LIST_GROUP_STATS_ENTRY = 620,
    OF_LIST_HELLO_ELEM = 621,
    OF_LIST_INSTRUCTION = 622,
    OF_LIST_INSTRUCTION_ID = 623,
    OF_LIST_METER_BAND = 624,
    OF_LIST_METER_BAND_STATS = 625,
    OF_LIST_METER_STATS = 626,
    OF_LIST_OXM = 627,
    OF_LIST_PACKET_QUEUE = 628,
    OF_LIST_PORT_DESC = 629,
    OF_LIST_PORT_DESC_PROP = 630,
    OF_LIST_PORT_MOD_PROP = 631,
    OF_LIST_PORT_STATS_ENTRY = 632,
    OF_LIST_PORT_STATS_PROP = 633,
    OF_LIST_QUEUE_DESC = 634,
    OF_LIST_QUEUE_DESC_PROP = 635,
    OF_LIST_QUEUE_PROP = 636,
    OF_LIST_QUEUE_STATS_ENTRY = 637,
    OF_LIST_QUEUE_STATS_PROP = 638,
    OF_LIST_ROLE_PROP = 639,
    OF_LIST_TABLE_DESC = 640,
    OF_LIST_TABLE_FEATURE_PROP = 641,
    OF_LIST_TABLE_FEATURES = 642,
    OF_LIST_TABLE_MOD_PROP = 643,
    OF_LIST_TABLE_STATS_ENTRY = 644,
    OF_LIST_UINT32 = 645,
    OF_LIST_UINT64 = 646,
    OF_LIST_UINT8 = 647,
