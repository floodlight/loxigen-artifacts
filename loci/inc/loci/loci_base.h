...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_NAME = 348,
    OF_BSN_TLV_NEGATE = 349,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 350,
    OF_BSN_TLV_OFFSET = 351,
    OF_BSN_TLV_PARTNER_KEY = 352,
    OF_BSN_TLV_PARTNER_PORT_NUM = 353,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 354,
    OF_BSN_TLV_PARTNER_STATE = 355,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 356,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 357,
    OF_BSN_TLV_PORT = 358,
    OF_BSN_TLV_PORT_VXLAN_MODE = 359,
    OF_BSN_TLV_PRIORITY = 360,
    OF_BSN_TLV_QUEUE_ID = 361,
    OF_BSN_TLV_QUEUE_WEIGHT = 362,
    OF_BSN_TLV_RATE_UNIT = 363,
    OF_BSN_TLV_REFERENCE = 364,
    OF_BSN_TLV_REPLY_PACKETS = 365,
    OF_BSN_TLV_REQUEST_PACKETS = 366,
    OF_BSN_TLV_RX_BYTES = 367,
    OF_BSN_TLV_RX_PACKETS = 368,
    OF_BSN_TLV_SAMPLING_RATE = 369,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 370,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 371,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 372,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 373,
    OF_BSN_TLV_SUB_AGENT_ID = 374,
    OF_BSN_TLV_TCP_DST = 375,
    OF_BSN_TLV_TCP_SRC = 376,
    OF_BSN_TLV_TX_BYTES = 377,
    OF_BSN_TLV_TX_PACKETS = 378,
    OF_BSN_TLV_UDF_ANCHOR = 379,
    OF_BSN_TLV_UDF_ID = 380,
    OF_BSN_TLV_UDF_LENGTH = 381,
    OF_BSN_TLV_UDF_OFFSET = 382,
    OF_BSN_TLV_UDP_DST = 383,
    OF_BSN_TLV_UDP_SRC = 384,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 385,
    OF_BSN_TLV_UNICAST_RATE = 386,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 387,
    OF_BSN_TLV_VLAN_PCP = 388,
    OF_BSN_TLV_VLAN_VID = 389,
    OF_BSN_TLV_VLAN_VID_MASK = 390,
    OF_BSN_TLV_VNI = 391,
    OF_BSN_TLV_VRF = 392,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 393,
    OF_BSN_VPORT = 394,
    OF_BSN_VPORT_L2GRE = 395,
    OF_BSN_VPORT_Q_IN_Q = 396,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 397,
    OF_BUCKET = 398,
    OF_BUCKET_COUNTER = 399,
    OF_BUNDLE_PROP = 400,
    OF_BUNDLE_PROP_EXPERIMENTER = 401,
    OF_FLOW_STATS_ENTRY = 402,
    OF_GROUP_DESC_STATS_ENTRY = 403,
    OF_GROUP_STATS_ENTRY = 404,
    OF_HELLO_ELEM = 405,
    OF_HELLO_ELEM_VERSIONBITMAP = 406,
    OF_INSTRUCTION = 407,
    OF_INSTRUCTION_APPLY_ACTIONS = 408,
    OF_INSTRUCTION_BSN = 409,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 410,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 411,
    OF_INSTRUCTION_BSN_DENY = 412,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 413,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 414,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 415,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 416,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 417,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 418,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 419,
    OF_INSTRUCTION_BSN_PERMIT = 420,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 421,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 422,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 423,
    OF_INSTRUCTION_CLEAR_ACTIONS = 424,
    OF_INSTRUCTION_EXPERIMENTER = 425,
    OF_INSTRUCTION_GOTO_TABLE = 426,
    OF_INSTRUCTION_ID = 427,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 428,
    OF_INSTRUCTION_ID_BSN = 429,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 430,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 431,
    OF_INSTRUCTION_ID_BSN_DENY = 432,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 433,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 434,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 435,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 436,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 437,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 438,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 439,
    OF_INSTRUCTION_ID_BSN_PERMIT = 440,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 441,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 442,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 443,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 444,
    OF_INSTRUCTION_ID_EXPERIMENTER = 445,
    OF_INSTRUCTION_ID_GOTO_TABLE = 446,
    OF_INSTRUCTION_ID_METER = 447,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 448,
    OF_INSTRUCTION_ID_WRITE_METADATA = 449,
    OF_INSTRUCTION_METER = 450,
    OF_INSTRUCTION_WRITE_ACTIONS = 451,
    OF_INSTRUCTION_WRITE_METADATA = 452,
    OF_MATCH_V1 = 453,
    OF_MATCH_V2 = 454,
    OF_MATCH_V3 = 455,
    OF_METER_BAND = 456,
    OF_METER_BAND_DROP = 457,
    OF_METER_BAND_DSCP_REMARK = 458,
    OF_METER_BAND_EXPERIMENTER = 459,
    OF_METER_BAND_STATS = 460,
    OF_METER_CONFIG = 461,
    OF_METER_FEATURES = 462,
    OF_METER_STATS = 463,
    OF_OXM = 464,
    OF_OXM_ARP_OP = 465,
    OF_OXM_ARP_OP_MASKED = 466,
    OF_OXM_ARP_SHA = 467,
    OF_OXM_ARP_SHA_MASKED = 468,
    OF_OXM_ARP_SPA = 469,
    OF_OXM_ARP_SPA_MASKED = 470,
    OF_OXM_ARP_THA = 471,
    OF_OXM_ARP_THA_MASKED = 472,
    OF_OXM_ARP_TPA = 473,
    OF_OXM_ARP_TPA_MASKED = 474,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 475,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 476,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 477,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 478,
    OF_OXM_BSN_IN_PORTS_128 = 479,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 480,
    OF_OXM_BSN_IN_PORTS_512 = 481,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 482,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 483,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 484,
    OF_OXM_BSN_INNER_ETH_DST = 485,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 486,
    OF_OXM_BSN_INNER_ETH_SRC = 487,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 488,
    OF_OXM_BSN_INNER_VLAN_VID = 489,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 490,
    OF_OXM_BSN_L2_CACHE_HIT = 491,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 492,
    OF_OXM_BSN_L3_DST_CLASS_ID = 493,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 494,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 495,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 496,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 497,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 498,
    OF_OXM_BSN_LAG_ID = 499,
    OF_OXM_BSN_LAG_ID_MASKED = 500,
    OF_OXM_BSN_TCP_FLAGS = 501,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 502,
    OF_OXM_BSN_UDF0 = 503,
    OF_OXM_BSN_UDF0_MASKED = 504,
    OF_OXM_BSN_UDF1 = 505,
    OF_OXM_BSN_UDF1_MASKED = 506,
    OF_OXM_BSN_UDF2 = 507,
    OF_OXM_BSN_UDF2_MASKED = 508,
    OF_OXM_BSN_UDF3 = 509,
    OF_OXM_BSN_UDF3_MASKED = 510,
    OF_OXM_BSN_UDF4 = 511,
    OF_OXM_BSN_UDF4_MASKED = 512,
    OF_OXM_BSN_UDF5 = 513,
    OF_OXM_BSN_UDF5_MASKED = 514,
    OF_OXM_BSN_UDF6 = 515,
    OF_OXM_BSN_UDF6_MASKED = 516,
    OF_OXM_BSN_UDF7 = 517,
    OF_OXM_BSN_UDF7_MASKED = 518,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 519,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 520,
    OF_OXM_BSN_VRF = 521,
    OF_OXM_BSN_VRF_MASKED = 522,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 523,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 524,
    OF_OXM_ETH_DST = 525,
    OF_OXM_ETH_DST_MASKED = 526,
    OF_OXM_ETH_SRC = 527,
    OF_OXM_ETH_SRC_MASKED = 528,
    OF_OXM_ETH_TYPE = 529,
    OF_OXM_ETH_TYPE_MASKED = 530,
    OF_OXM_ICMPV4_CODE = 531,
    OF_OXM_ICMPV4_CODE_MASKED = 532,
    OF_OXM_ICMPV4_TYPE = 533,
    OF_OXM_ICMPV4_TYPE_MASKED = 534,
    OF_OXM_ICMPV6_CODE = 535,
    OF_OXM_ICMPV6_CODE_MASKED = 536,
    OF_OXM_ICMPV6_TYPE = 537,
    OF_OXM_ICMPV6_TYPE_MASKED = 538,
    OF_OXM_IN_PHY_PORT = 539,
    OF_OXM_IN_PHY_PORT_MASKED = 540,
    OF_OXM_IN_PORT = 541,
    OF_OXM_IN_PORT_MASKED = 542,
    OF_OXM_IP_DSCP = 543,
    OF_OXM_IP_DSCP_MASKED = 544,
    OF_OXM_IP_ECN = 545,
    OF_OXM_IP_ECN_MASKED = 546,
    OF_OXM_IP_PROTO = 547,
    OF_OXM_IP_PROTO_MASKED = 548,
    OF_OXM_IPV4_DST = 549,
    OF_OXM_IPV4_DST_MASKED = 550,
    OF_OXM_IPV4_SRC = 551,
    OF_OXM_IPV4_SRC_MASKED = 552,
    OF_OXM_IPV6_DST = 553,
    OF_OXM_IPV6_DST_MASKED = 554,
    OF_OXM_IPV6_EXTHDR = 555,
    OF_OXM_IPV6_EXTHDR_MASKED = 556,
    OF_OXM_IPV6_FLABEL = 557,
    OF_OXM_IPV6_FLABEL_MASKED = 558,
    OF_OXM_IPV6_ND_SLL = 559,
    OF_OXM_IPV6_ND_SLL_MASKED = 560,
    OF_OXM_IPV6_ND_TARGET = 561,
    OF_OXM_IPV6_ND_TARGET_MASKED = 562,
    OF_OXM_IPV6_ND_TLL = 563,
    OF_OXM_IPV6_ND_TLL_MASKED = 564,
    OF_OXM_IPV6_SRC = 565,
    OF_OXM_IPV6_SRC_MASKED = 566,
    OF_OXM_METADATA = 567,
    OF_OXM_METADATA_MASKED = 568,
    OF_OXM_MPLS_BOS = 569,
    OF_OXM_MPLS_BOS_MASKED = 570,
    OF_OXM_MPLS_LABEL = 571,
    OF_OXM_MPLS_LABEL_MASKED = 572,
    OF_OXM_MPLS_TC = 573,
    OF_OXM_MPLS_TC_MASKED = 574,
    OF_OXM_PBB_UCA = 575,
    OF_OXM_PBB_UCA_MASKED = 576,
    OF_OXM_SCTP_DST = 577,
    OF_OXM_SCTP_DST_MASKED = 578,
    OF_OXM_SCTP_SRC = 579,
    OF_OXM_SCTP_SRC_MASKED = 580,
    OF_OXM_TCP_DST = 581,
    OF_OXM_TCP_DST_MASKED = 582,
    OF_OXM_TCP_SRC = 583,
    OF_OXM_TCP_SRC_MASKED = 584,
    OF_OXM_TUNNEL_ID = 585,
    OF_OXM_TUNNEL_ID_MASKED = 586,
    OF_OXM_TUNNEL_IPV4_DST = 587,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 588,
    OF_OXM_TUNNEL_IPV4_SRC = 589,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 590,
    OF_OXM_UDP_DST = 591,
    OF_OXM_UDP_DST_MASKED = 592,
    OF_OXM_UDP_SRC = 593,
    OF_OXM_UDP_SRC_MASKED = 594,
    OF_OXM_VLAN_PCP = 595,
    OF_OXM_VLAN_PCP_MASKED = 596,
    OF_OXM_VLAN_VID = 597,
    OF_OXM_VLAN_VID_MASKED = 598,
    OF_PACKET_QUEUE = 599,
    OF_PORT_DESC = 600,
    OF_PORT_DESC_PROP = 601,
    OF_PORT_DESC_PROP_BSN = 602,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 603,
    OF_PORT_DESC_PROP_BSN_UPLINK = 604,
    OF_PORT_DESC_PROP_ETHERNET = 605,
    OF_PORT_DESC_PROP_EXPERIMENTER = 606,
    OF_PORT_DESC_PROP_OPTICAL = 607,
    OF_PORT_MOD_PROP = 608,
    OF_PORT_MOD_PROP_ETHERNET = 609,
    OF_PORT_MOD_PROP_EXPERIMENTER = 610,
    OF_PORT_MOD_PROP_OPTICAL = 611,
    OF_PORT_STATS_ENTRY = 612,
    OF_PORT_STATS_PROP = 613,
    OF_PORT_STATS_PROP_ETHERNET = 614,
    OF_PORT_STATS_PROP_EXPERIMENTER = 615,
    OF_PORT_STATS_PROP_OPTICAL = 616,
    OF_QUEUE_DESC = 617,
    OF_QUEUE_DESC_PROP = 618,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 619,
    OF_QUEUE_DESC_PROP_MAX_RATE = 620,
    OF_QUEUE_DESC_PROP_MIN_RATE = 621,
    OF_QUEUE_PROP = 622,
    OF_QUEUE_PROP_EXPERIMENTER = 623,
    OF_QUEUE_PROP_MAX_RATE = 624,
    OF_QUEUE_PROP_MIN_RATE = 625,
    OF_QUEUE_STATS_ENTRY = 626,
    OF_QUEUE_STATS_PROP = 627,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 628,
    OF_ROLE_PROP = 629,
    OF_ROLE_PROP_EXPERIMENTER = 630,
    OF_TABLE_DESC = 631,
    OF_TABLE_FEATURE_PROP = 632,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 633,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 634,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 635,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 636,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 637,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 638,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 639,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 640,
    OF_TABLE_FEATURE_PROP_MATCH = 641,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 642,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 643,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 644,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 645,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 646,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 647,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 648,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 649,
    OF_TABLE_FEATURES = 650,
    OF_TABLE_MOD_PROP = 651,
    OF_TABLE_MOD_PROP_EVICTION = 652,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 653,
    OF_TABLE_MOD_PROP_VACANCY = 654,
    OF_TABLE_STATS_ENTRY = 655,
    OF_UINT32 = 656,
    OF_UINT64 = 657,
    OF_UINT8 = 658,
    ...
    /* List objects */
    OF_LIST_ACTION = 659,
    OF_LIST_ACTION_ID = 660,
    OF_LIST_ASYNC_CONFIG_PROP = 661,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 662,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 663,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 664,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 665,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 666,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 667,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 668,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 669,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 670,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 671,
    OF_LIST_BSN_INTERFACE = 672,
    OF_LIST_BSN_LACP_STATS_ENTRY = 673,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 674,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 675,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 676,
    OF_LIST_BSN_TLV = 677,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 678,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 679,
    OF_LIST_BUCKET = 680,
    OF_LIST_BUCKET_COUNTER = 681,
    OF_LIST_BUNDLE_PROP = 682,
    OF_LIST_FLOW_STATS_ENTRY = 683,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 684,
    OF_LIST_GROUP_STATS_ENTRY = 685,
    OF_LIST_HELLO_ELEM = 686,
    OF_LIST_INSTRUCTION = 687,
    OF_LIST_INSTRUCTION_ID = 688,
    OF_LIST_METER_BAND = 689,
    OF_LIST_METER_BAND_STATS = 690,
    OF_LIST_METER_CONFIG = 691,
    OF_LIST_METER_STATS = 692,
    OF_LIST_OXM = 693,
    OF_LIST_PACKET_QUEUE = 694,
    OF_LIST_PORT_DESC = 695,
    OF_LIST_PORT_DESC_PROP = 696,
    OF_LIST_PORT_MOD_PROP = 697,
    OF_LIST_PORT_STATS_ENTRY = 698,
    OF_LIST_PORT_STATS_PROP = 699,
    OF_LIST_QUEUE_DESC = 700,
    OF_LIST_QUEUE_DESC_PROP = 701,
    OF_LIST_QUEUE_PROP = 702,
    OF_LIST_QUEUE_STATS_ENTRY = 703,
    OF_LIST_QUEUE_STATS_PROP = 704,
    OF_LIST_ROLE_PROP = 705,
    OF_LIST_TABLE_DESC = 706,
    OF_LIST_TABLE_FEATURE_PROP = 707,
    OF_LIST_TABLE_FEATURES = 708,
    OF_LIST_TABLE_MOD_PROP = 709,
    OF_LIST_TABLE_STATS_ENTRY = 710,
    OF_LIST_UINT32 = 711,
    OF_LIST_UINT64 = 712,
    OF_LIST_UINT8 = 713,
