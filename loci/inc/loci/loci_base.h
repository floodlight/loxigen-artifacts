...
typedef enum of_object_id_e {
    ...
    OF_DESC_STATS_REPLY = 104,
    OF_DESC_STATS_REQUEST = 105,
    OF_ECHO_REPLY = 106,
    OF_ECHO_REQUEST = 107,
    OF_ERROR_MSG = 108,
    OF_EXPERIMENTER = 109,
    OF_EXPERIMENTER_ERROR_MSG = 110,
    ...
    OF_HEADER = 138,
    OF_HELLO = 139,
    OF_HELLO_FAILED_ERROR_MSG = 140,
    OF_METER_CONFIG_STATS_REPLY = 141,
    OF_METER_CONFIG_STATS_REQUEST = 142,
    OF_METER_FEATURES_STATS_REPLY = 143,
    OF_METER_FEATURES_STATS_REQUEST = 144,
    OF_METER_MOD = 145,
    OF_METER_MOD_FAILED_ERROR_MSG = 146,
    OF_METER_STATS_REPLY = 147,
    OF_METER_STATS_REQUEST = 148,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 149,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 150,
    OF_NICIRA_HEADER = 151,
    OF_PACKET_IN = 152,
    OF_PACKET_OUT = 153,
    OF_PORT_DESC_STATS_REPLY = 154,
    OF_PORT_DESC_STATS_REQUEST = 155,
    OF_PORT_MOD = 156,
    OF_PORT_MOD_FAILED_ERROR_MSG = 157,
    OF_PORT_STATS_REPLY = 158,
    OF_PORT_STATS_REQUEST = 159,
    OF_PORT_STATUS = 160,
    OF_QUEUE_GET_CONFIG_REPLY = 161,
    OF_QUEUE_GET_CONFIG_REQUEST = 162,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 163,
    OF_QUEUE_STATS_REPLY = 164,
    OF_QUEUE_STATS_REQUEST = 165,
    OF_ROLE_REPLY = 166,
    OF_ROLE_REQUEST = 167,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 168,
    OF_SET_CONFIG = 169,
    OF_STATS_REPLY = 170,
    OF_STATS_REQUEST = 171,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 172,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 173,
    OF_TABLE_FEATURES_STATS_REPLY = 174,
    OF_TABLE_FEATURES_STATS_REQUEST = 175,
    OF_TABLE_MOD = 176,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 177,
    OF_TABLE_STATS_REPLY = 178,
    OF_TABLE_STATS_REQUEST = 179,

    /* Non-message objects */
    OF_ACTION = 180,
    OF_ACTION_BSN = 181,
    OF_ACTION_BSN_MIRROR = 182,
    OF_ACTION_BSN_SET_TUNNEL_DST = 183,
    OF_ACTION_COPY_TTL_IN = 184,
    OF_ACTION_COPY_TTL_OUT = 185,
    OF_ACTION_DEC_MPLS_TTL = 186,
    OF_ACTION_DEC_NW_TTL = 187,
    OF_ACTION_ENQUEUE = 188,
    OF_ACTION_EXPERIMENTER = 189,
    OF_ACTION_GROUP = 190,
    OF_ACTION_HEADER = 191,
    OF_ACTION_ID = 192,
    OF_ACTION_ID_BSN = 193,
    OF_ACTION_ID_BSN_MIRROR = 194,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 195,
    OF_ACTION_ID_COPY_TTL_IN = 196,
    OF_ACTION_ID_COPY_TTL_OUT = 197,
    OF_ACTION_ID_DEC_MPLS_TTL = 198,
    OF_ACTION_ID_DEC_NW_TTL = 199,
    OF_ACTION_ID_EXPERIMENTER = 200,
    OF_ACTION_ID_GROUP = 201,
    OF_ACTION_ID_HEADER = 202,
    OF_ACTION_ID_NICIRA = 203,
    OF_ACTION_ID_NICIRA_DEC_TTL = 204,
    OF_ACTION_ID_OUTPUT = 205,
    OF_ACTION_ID_POP_MPLS = 206,
    OF_ACTION_ID_POP_PBB = 207,
    OF_ACTION_ID_POP_VLAN = 208,
    OF_ACTION_ID_PUSH_MPLS = 209,
    OF_ACTION_ID_PUSH_PBB = 210,
    OF_ACTION_ID_PUSH_VLAN = 211,
    OF_ACTION_ID_SET_FIELD = 212,
    OF_ACTION_ID_SET_MPLS_TTL = 213,
    OF_ACTION_ID_SET_NW_TTL = 214,
    OF_ACTION_ID_SET_QUEUE = 215,
    OF_ACTION_NICIRA = 216,
    OF_ACTION_NICIRA_DEC_TTL = 217,
    OF_ACTION_OUTPUT = 218,
    OF_ACTION_POP_MPLS = 219,
    OF_ACTION_POP_PBB = 220,
    OF_ACTION_POP_VLAN = 221,
    OF_ACTION_PUSH_MPLS = 222,
    OF_ACTION_PUSH_PBB = 223,
    OF_ACTION_PUSH_VLAN = 224,
    OF_ACTION_SET_DL_DST = 225,
    OF_ACTION_SET_DL_SRC = 226,
    OF_ACTION_SET_FIELD = 227,
    OF_ACTION_SET_MPLS_LABEL = 228,
    OF_ACTION_SET_MPLS_TC = 229,
    OF_ACTION_SET_MPLS_TTL = 230,
    OF_ACTION_SET_NW_DST = 231,
    OF_ACTION_SET_NW_ECN = 232,
    OF_ACTION_SET_NW_SRC = 233,
    OF_ACTION_SET_NW_TOS = 234,
    OF_ACTION_SET_NW_TTL = 235,
    OF_ACTION_SET_QUEUE = 236,
    OF_ACTION_SET_TP_DST = 237,
    OF_ACTION_SET_TP_SRC = 238,
    OF_ACTION_SET_VLAN_PCP = 239,
    OF_ACTION_SET_VLAN_VID = 240,
    OF_ACTION_STRIP_VLAN = 241,
    OF_BSN_CONTROLLER_CONNECTION = 242,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 243,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 244,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 245,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 246,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 247,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 248,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 249,
    OF_BSN_GENTABLE_STATS_ENTRY = 250,
    OF_BSN_INTERFACE = 251,
    OF_BSN_LACP_STATS_ENTRY = 252,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 253,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 254,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 255,
    OF_BSN_TLV = 256,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 257,
    OF_BSN_TLV_CIRCUIT_ID = 258,
    OF_BSN_TLV_CRC_ENABLED = 259,
    OF_BSN_TLV_HEADER = 260,
    OF_BSN_TLV_IDLE_NOTIFICATION = 261,
    OF_BSN_TLV_IDLE_TIME = 262,
    OF_BSN_TLV_IDLE_TIMEOUT = 263,
    OF_BSN_TLV_IPV4 = 264,
    OF_BSN_TLV_MAC = 265,
    OF_BSN_TLV_MISS_PACKETS = 266,
    OF_BSN_TLV_PORT = 267,
    OF_BSN_TLV_QUEUE_ID = 268,
    OF_BSN_TLV_QUEUE_WEIGHT = 269,
    OF_BSN_TLV_REPLY_PACKETS = 270,
    OF_BSN_TLV_REQUEST_PACKETS = 271,
    OF_BSN_TLV_RX_PACKETS = 272,
    OF_BSN_TLV_TX_PACKETS = 273,
    OF_BSN_TLV_UDF_ANCHOR = 274,
    OF_BSN_TLV_UDF_ID = 275,
    OF_BSN_TLV_UDF_LENGTH = 276,
    OF_BSN_TLV_UDF_OFFSET = 277,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 278,
    OF_BSN_TLV_VLAN_VID = 279,
    OF_BSN_TLV_VRF = 280,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 281,
    OF_BSN_VPORT = 282,
    OF_BSN_VPORT_HEADER = 283,
    OF_BSN_VPORT_L2GRE = 284,
    OF_BSN_VPORT_Q_IN_Q = 285,
    OF_BUCKET = 286,
    OF_BUCKET_COUNTER = 287,
    OF_FLOW_STATS_ENTRY = 288,
    OF_GROUP_DESC_STATS_ENTRY = 289,
    OF_GROUP_STATS_ENTRY = 290,
    OF_HELLO_ELEM = 291,
    OF_HELLO_ELEM_HEADER = 292,
    OF_HELLO_ELEM_VERSIONBITMAP = 293,
    OF_INSTRUCTION = 294,
    OF_INSTRUCTION_APPLY_ACTIONS = 295,
    OF_INSTRUCTION_BSN = 296,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 297,
    OF_INSTRUCTION_BSN_DENY = 298,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 299,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 300,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 301,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 302,
    OF_INSTRUCTION_BSN_PERMIT = 303,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 304,
    OF_INSTRUCTION_CLEAR_ACTIONS = 305,
    OF_INSTRUCTION_EXPERIMENTER = 306,
    OF_INSTRUCTION_GOTO_TABLE = 307,
    OF_INSTRUCTION_HEADER = 308,
    OF_INSTRUCTION_ID = 309,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 310,
    OF_INSTRUCTION_ID_BSN = 311,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 312,
    OF_INSTRUCTION_ID_BSN_DENY = 313,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 314,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 315,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 316,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 317,
    OF_INSTRUCTION_ID_BSN_PERMIT = 318,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 319,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 320,
    OF_INSTRUCTION_ID_EXPERIMENTER = 321,
    OF_INSTRUCTION_ID_GOTO_TABLE = 322,
    OF_INSTRUCTION_ID_HEADER = 323,
    OF_INSTRUCTION_ID_METER = 324,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 325,
    OF_INSTRUCTION_ID_WRITE_METADATA = 326,
    OF_INSTRUCTION_METER = 327,
    OF_INSTRUCTION_WRITE_ACTIONS = 328,
    OF_INSTRUCTION_WRITE_METADATA = 329,
    OF_MATCH_V1 = 330,
    OF_MATCH_V2 = 331,
    OF_MATCH_V3 = 332,
    OF_METER_BAND = 333,
    OF_METER_BAND_DROP = 334,
    OF_METER_BAND_DSCP_REMARK = 335,
    OF_METER_BAND_EXPERIMENTER = 336,
    OF_METER_BAND_HEADER = 337,
    OF_METER_BAND_STATS = 338,
    OF_METER_CONFIG = 339,
    OF_METER_FEATURES = 340,
    OF_METER_STATS = 341,
    OF_OXM = 342,
    OF_OXM_ARP_OP = 343,
    OF_OXM_ARP_OP_MASKED = 344,
    OF_OXM_ARP_SHA = 345,
    OF_OXM_ARP_SHA_MASKED = 346,
    OF_OXM_ARP_SPA = 347,
    OF_OXM_ARP_SPA_MASKED = 348,
    OF_OXM_ARP_THA = 349,
    OF_OXM_ARP_THA_MASKED = 350,
    OF_OXM_ARP_TPA = 351,
    OF_OXM_ARP_TPA_MASKED = 352,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 353,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 354,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 355,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 356,
    OF_OXM_BSN_IN_PORTS_128 = 357,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 358,
    OF_OXM_BSN_L3_DST_CLASS_ID = 359,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 360,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 361,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 362,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 363,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 364,
    OF_OXM_BSN_LAG_ID = 365,
    OF_OXM_BSN_LAG_ID_MASKED = 366,
    OF_OXM_BSN_TCP_FLAGS = 367,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 368,
    OF_OXM_BSN_UDF0 = 369,
    OF_OXM_BSN_UDF0_MASKED = 370,
    OF_OXM_BSN_UDF1 = 371,
    OF_OXM_BSN_UDF1_MASKED = 372,
    OF_OXM_BSN_UDF2 = 373,
    OF_OXM_BSN_UDF2_MASKED = 374,
    OF_OXM_BSN_UDF3 = 375,
    OF_OXM_BSN_UDF3_MASKED = 376,
    OF_OXM_BSN_UDF4 = 377,
    OF_OXM_BSN_UDF4_MASKED = 378,
    OF_OXM_BSN_UDF5 = 379,
    OF_OXM_BSN_UDF5_MASKED = 380,
    OF_OXM_BSN_UDF6 = 381,
    OF_OXM_BSN_UDF6_MASKED = 382,
    OF_OXM_BSN_UDF7 = 383,
    OF_OXM_BSN_UDF7_MASKED = 384,
    OF_OXM_BSN_VRF = 385,
    OF_OXM_BSN_VRF_MASKED = 386,
    OF_OXM_ETH_DST = 387,
    OF_OXM_ETH_DST_MASKED = 388,
    OF_OXM_ETH_SRC = 389,
    OF_OXM_ETH_SRC_MASKED = 390,
    OF_OXM_ETH_TYPE = 391,
    OF_OXM_ETH_TYPE_MASKED = 392,
    OF_OXM_HEADER = 393,
    OF_OXM_ICMPV4_CODE = 394,
    OF_OXM_ICMPV4_CODE_MASKED = 395,
    OF_OXM_ICMPV4_TYPE = 396,
    OF_OXM_ICMPV4_TYPE_MASKED = 397,
    OF_OXM_ICMPV6_CODE = 398,
    OF_OXM_ICMPV6_CODE_MASKED = 399,
    OF_OXM_ICMPV6_TYPE = 400,
    OF_OXM_ICMPV6_TYPE_MASKED = 401,
    OF_OXM_IN_PHY_PORT = 402,
    OF_OXM_IN_PHY_PORT_MASKED = 403,
    OF_OXM_IN_PORT = 404,
    OF_OXM_IN_PORT_MASKED = 405,
    OF_OXM_IP_DSCP = 406,
    OF_OXM_IP_DSCP_MASKED = 407,
    OF_OXM_IP_ECN = 408,
    OF_OXM_IP_ECN_MASKED = 409,
    OF_OXM_IP_PROTO = 410,
    OF_OXM_IP_PROTO_MASKED = 411,
    OF_OXM_IPV4_DST = 412,
    OF_OXM_IPV4_DST_MASKED = 413,
    OF_OXM_IPV4_SRC = 414,
    OF_OXM_IPV4_SRC_MASKED = 415,
    OF_OXM_IPV6_DST = 416,
    OF_OXM_IPV6_DST_MASKED = 417,
    OF_OXM_IPV6_FLABEL = 418,
    OF_OXM_IPV6_FLABEL_MASKED = 419,
    OF_OXM_IPV6_ND_SLL = 420,
    OF_OXM_IPV6_ND_SLL_MASKED = 421,
    OF_OXM_IPV6_ND_TARGET = 422,
    OF_OXM_IPV6_ND_TARGET_MASKED = 423,
    OF_OXM_IPV6_ND_TLL = 424,
    OF_OXM_IPV6_ND_TLL_MASKED = 425,
    OF_OXM_IPV6_SRC = 426,
    OF_OXM_IPV6_SRC_MASKED = 427,
    OF_OXM_METADATA = 428,
    OF_OXM_METADATA_MASKED = 429,
    OF_OXM_MPLS_LABEL = 430,
    OF_OXM_MPLS_LABEL_MASKED = 431,
    OF_OXM_MPLS_TC = 432,
    OF_OXM_MPLS_TC_MASKED = 433,
    OF_OXM_SCTP_DST = 434,
    OF_OXM_SCTP_DST_MASKED = 435,
    OF_OXM_SCTP_SRC = 436,
    OF_OXM_SCTP_SRC_MASKED = 437,
    OF_OXM_TCP_DST = 438,
    OF_OXM_TCP_DST_MASKED = 439,
    OF_OXM_TCP_SRC = 440,
    OF_OXM_TCP_SRC_MASKED = 441,
    OF_OXM_TUNNEL_ID = 442,
    OF_OXM_TUNNEL_ID_MASKED = 443,
    OF_OXM_UDP_DST = 444,
    OF_OXM_UDP_DST_MASKED = 445,
    OF_OXM_UDP_SRC = 446,
    OF_OXM_UDP_SRC_MASKED = 447,
    OF_OXM_VLAN_PCP = 448,
    OF_OXM_VLAN_PCP_MASKED = 449,
    OF_OXM_VLAN_VID = 450,
    OF_OXM_VLAN_VID_MASKED = 451,
    OF_PACKET_QUEUE = 452,
    OF_PORT_DESC = 453,
    OF_PORT_STATS_ENTRY = 454,
    OF_QUEUE_PROP = 455,
    OF_QUEUE_PROP_EXPERIMENTER = 456,
    OF_QUEUE_PROP_HEADER = 457,
    OF_QUEUE_PROP_MAX_RATE = 458,
    OF_QUEUE_PROP_MIN_RATE = 459,
    OF_QUEUE_STATS_ENTRY = 460,
    OF_TABLE_FEATURE_PROP = 461,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 462,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 463,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 464,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 465,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 466,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 467,
    OF_TABLE_FEATURE_PROP_HEADER = 468,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 469,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 470,
    OF_TABLE_FEATURE_PROP_MATCH = 471,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 472,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 473,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 474,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 475,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 476,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 477,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 478,
    OF_TABLE_FEATURES = 479,
    OF_TABLE_STATS_ENTRY = 480,
    OF_UINT32 = 481,
    OF_UINT64 = 482,
    OF_UINT8 = 483,
    ...
    /* List objects */
    OF_LIST_ACTION = 484,
    OF_LIST_ACTION_ID = 485,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 486,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 487,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 488,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 489,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 490,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 491,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 492,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 493,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 494,
    OF_LIST_BSN_INTERFACE = 495,
    OF_LIST_BSN_LACP_STATS_ENTRY = 496,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 497,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 498,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 499,
    OF_LIST_BSN_TLV = 500,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 501,
    OF_LIST_BUCKET = 502,
    OF_LIST_BUCKET_COUNTER = 503,
    OF_LIST_FLOW_STATS_ENTRY = 504,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 505,
    OF_LIST_GROUP_STATS_ENTRY = 506,
    OF_LIST_HELLO_ELEM = 507,
    OF_LIST_INSTRUCTION = 508,
    OF_LIST_INSTRUCTION_ID = 509,
    OF_LIST_METER_BAND = 510,
    OF_LIST_METER_BAND_STATS = 511,
    OF_LIST_METER_STATS = 512,
    OF_LIST_OXM = 513,
    OF_LIST_PACKET_QUEUE = 514,
    OF_LIST_PORT_DESC = 515,
    OF_LIST_PORT_STATS_ENTRY = 516,
    OF_LIST_QUEUE_PROP = 517,
    OF_LIST_QUEUE_STATS_ENTRY = 518,
    OF_LIST_TABLE_FEATURE_PROP = 519,
    OF_LIST_TABLE_FEATURES = 520,
    OF_LIST_TABLE_STATS_ENTRY = 521,
    OF_LIST_UINT32 = 522,
    OF_LIST_UINT64 = 523,
    OF_LIST_UINT8 = 524,
...
#define OF_MESSAGE_OBJECT_COUNT 180
