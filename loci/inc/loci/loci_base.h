...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_QUEUE_ID = 371,
    OF_BSN_TLV_QUEUE_WEIGHT = 372,
    OF_BSN_TLV_RATE_UNIT = 373,
    OF_BSN_TLV_REFERENCE = 374,
    OF_BSN_TLV_REPLY_PACKETS = 375,
    OF_BSN_TLV_REQUEST_PACKETS = 376,
    OF_BSN_TLV_RX_BYTES = 377,
    OF_BSN_TLV_RX_PACKETS = 378,
    OF_BSN_TLV_SAMPLING_RATE = 379,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 380,
    OF_BSN_TLV_STATUS = 381,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 382,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 383,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 384,
    OF_BSN_TLV_SUB_AGENT_ID = 385,
    OF_BSN_TLV_TCP_DST = 386,
    OF_BSN_TLV_TCP_SRC = 387,
    OF_BSN_TLV_TX_BYTES = 388,
    OF_BSN_TLV_TX_PACKETS = 389,
    OF_BSN_TLV_UDF_ANCHOR = 390,
    OF_BSN_TLV_UDF_ID = 391,
    OF_BSN_TLV_UDF_LENGTH = 392,
    OF_BSN_TLV_UDF_OFFSET = 393,
    OF_BSN_TLV_UDP_DST = 394,
    OF_BSN_TLV_UDP_SRC = 395,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 396,
    OF_BSN_TLV_UNICAST_RATE = 397,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 398,
    OF_BSN_TLV_UNTAGGED = 399,
    OF_BSN_TLV_USE_PACKET_STATE = 400,
    OF_BSN_TLV_VFI = 401,
    OF_BSN_TLV_VFP_CLASS_ID = 402,
    OF_BSN_TLV_VLAN_MAC_LIST = 403,
    OF_BSN_TLV_VLAN_PCP = 404,
    OF_BSN_TLV_VLAN_VID = 405,
    OF_BSN_TLV_VLAN_VID_MASK = 406,
    OF_BSN_TLV_VNI = 407,
    OF_BSN_TLV_VRF = 408,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 409,
    OF_BSN_VLAN_MAC = 410,
    OF_BSN_VPORT = 411,
    OF_BSN_VPORT_L2GRE = 412,
    OF_BSN_VPORT_Q_IN_Q = 413,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 414,
    OF_BUCKET = 415,
    OF_BUCKET_COUNTER = 416,
    OF_BUNDLE_PROP = 417,
    OF_BUNDLE_PROP_EXPERIMENTER = 418,
    OF_FLOW_STATS_ENTRY = 419,
    OF_GROUP_DESC_STATS_ENTRY = 420,
    OF_GROUP_STATS_ENTRY = 421,
    OF_HELLO_ELEM = 422,
    OF_HELLO_ELEM_VERSIONBITMAP = 423,
    OF_INSTRUCTION = 424,
    OF_INSTRUCTION_APPLY_ACTIONS = 425,
    OF_INSTRUCTION_BSN = 426,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 427,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 428,
    OF_INSTRUCTION_BSN_DENY = 429,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 430,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 431,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 432,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 433,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 434,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 435,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 436,
    OF_INSTRUCTION_BSN_PERMIT = 437,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 438,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 439,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 440,
    OF_INSTRUCTION_CLEAR_ACTIONS = 441,
    OF_INSTRUCTION_EXPERIMENTER = 442,
    OF_INSTRUCTION_GOTO_TABLE = 443,
    OF_INSTRUCTION_ID = 444,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 445,
    OF_INSTRUCTION_ID_BSN = 446,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 447,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 448,
    OF_INSTRUCTION_ID_BSN_DENY = 449,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 450,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 451,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 452,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 453,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 454,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 455,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 456,
    OF_INSTRUCTION_ID_BSN_PERMIT = 457,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 458,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 459,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 460,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 461,
    OF_INSTRUCTION_ID_EXPERIMENTER = 462,
    OF_INSTRUCTION_ID_GOTO_TABLE = 463,
    OF_INSTRUCTION_ID_METER = 464,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 465,
    OF_INSTRUCTION_ID_WRITE_METADATA = 466,
    OF_INSTRUCTION_METER = 467,
    OF_INSTRUCTION_WRITE_ACTIONS = 468,
    OF_INSTRUCTION_WRITE_METADATA = 469,
    OF_MATCH_V1 = 470,
    OF_MATCH_V2 = 471,
    OF_MATCH_V3 = 472,
    OF_METER_BAND = 473,
    OF_METER_BAND_DROP = 474,
    OF_METER_BAND_DSCP_REMARK = 475,
    OF_METER_BAND_EXPERIMENTER = 476,
    OF_METER_BAND_STATS = 477,
    OF_METER_CONFIG = 478,
    OF_METER_FEATURES = 479,
    OF_METER_STATS = 480,
    OF_OXM = 481,
    OF_OXM_ARP_OP = 482,
    OF_OXM_ARP_OP_MASKED = 483,
    OF_OXM_ARP_SHA = 484,
    OF_OXM_ARP_SHA_MASKED = 485,
    OF_OXM_ARP_SPA = 486,
    OF_OXM_ARP_SPA_MASKED = 487,
    OF_OXM_ARP_THA = 488,
    OF_OXM_ARP_THA_MASKED = 489,
    OF_OXM_ARP_TPA = 490,
    OF_OXM_ARP_TPA_MASKED = 491,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 492,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 493,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 494,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 495,
    OF_OXM_BSN_IN_PORTS_128 = 496,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 497,
    OF_OXM_BSN_IN_PORTS_512 = 498,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 499,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 500,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 501,
    OF_OXM_BSN_INNER_ETH_DST = 502,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 503,
    OF_OXM_BSN_INNER_ETH_SRC = 504,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 505,
    OF_OXM_BSN_INNER_VLAN_VID = 506,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 507,
    OF_OXM_BSN_L2_CACHE_HIT = 508,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 509,
    OF_OXM_BSN_L3_DST_CLASS_ID = 510,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 511,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 512,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 513,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 514,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 515,
    OF_OXM_BSN_LAG_ID = 516,
    OF_OXM_BSN_LAG_ID_MASKED = 517,
    OF_OXM_BSN_TCP_FLAGS = 518,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 519,
    OF_OXM_BSN_UDF0 = 520,
    OF_OXM_BSN_UDF0_MASKED = 521,
    OF_OXM_BSN_UDF1 = 522,
    OF_OXM_BSN_UDF1_MASKED = 523,
    OF_OXM_BSN_UDF2 = 524,
    OF_OXM_BSN_UDF2_MASKED = 525,
    OF_OXM_BSN_UDF3 = 526,
    OF_OXM_BSN_UDF3_MASKED = 527,
    OF_OXM_BSN_UDF4 = 528,
    OF_OXM_BSN_UDF4_MASKED = 529,
    OF_OXM_BSN_UDF5 = 530,
    OF_OXM_BSN_UDF5_MASKED = 531,
    OF_OXM_BSN_UDF6 = 532,
    OF_OXM_BSN_UDF6_MASKED = 533,
    OF_OXM_BSN_UDF7 = 534,
    OF_OXM_BSN_UDF7_MASKED = 535,
    OF_OXM_BSN_VFI = 536,
    OF_OXM_BSN_VFI_MASKED = 537,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 538,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 539,
    OF_OXM_BSN_VRF = 540,
    OF_OXM_BSN_VRF_MASKED = 541,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 542,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 543,
    OF_OXM_ETH_DST = 544,
    OF_OXM_ETH_DST_MASKED = 545,
    OF_OXM_ETH_SRC = 546,
    OF_OXM_ETH_SRC_MASKED = 547,
    OF_OXM_ETH_TYPE = 548,
    OF_OXM_ETH_TYPE_MASKED = 549,
    OF_OXM_ICMPV4_CODE = 550,
    OF_OXM_ICMPV4_CODE_MASKED = 551,
    OF_OXM_ICMPV4_TYPE = 552,
    OF_OXM_ICMPV4_TYPE_MASKED = 553,
    OF_OXM_ICMPV6_CODE = 554,
    OF_OXM_ICMPV6_CODE_MASKED = 555,
    OF_OXM_ICMPV6_TYPE = 556,
    OF_OXM_ICMPV6_TYPE_MASKED = 557,
    OF_OXM_IN_PHY_PORT = 558,
    OF_OXM_IN_PHY_PORT_MASKED = 559,
    OF_OXM_IN_PORT = 560,
    OF_OXM_IN_PORT_MASKED = 561,
    OF_OXM_IP_DSCP = 562,
    OF_OXM_IP_DSCP_MASKED = 563,
    OF_OXM_IP_ECN = 564,
    OF_OXM_IP_ECN_MASKED = 565,
    OF_OXM_IP_PROTO = 566,
    OF_OXM_IP_PROTO_MASKED = 567,
    OF_OXM_IPV4_DST = 568,
    OF_OXM_IPV4_DST_MASKED = 569,
    OF_OXM_IPV4_SRC = 570,
    OF_OXM_IPV4_SRC_MASKED = 571,
    OF_OXM_IPV6_DST = 572,
    OF_OXM_IPV6_DST_MASKED = 573,
    OF_OXM_IPV6_EXTHDR = 574,
    OF_OXM_IPV6_EXTHDR_MASKED = 575,
    OF_OXM_IPV6_FLABEL = 576,
    OF_OXM_IPV6_FLABEL_MASKED = 577,
    OF_OXM_IPV6_ND_SLL = 578,
    OF_OXM_IPV6_ND_SLL_MASKED = 579,
    OF_OXM_IPV6_ND_TARGET = 580,
    OF_OXM_IPV6_ND_TARGET_MASKED = 581,
    OF_OXM_IPV6_ND_TLL = 582,
    OF_OXM_IPV6_ND_TLL_MASKED = 583,
    OF_OXM_IPV6_SRC = 584,
    OF_OXM_IPV6_SRC_MASKED = 585,
    OF_OXM_METADATA = 586,
    OF_OXM_METADATA_MASKED = 587,
    OF_OXM_MPLS_BOS = 588,
    OF_OXM_MPLS_BOS_MASKED = 589,
    OF_OXM_MPLS_LABEL = 590,
    OF_OXM_MPLS_LABEL_MASKED = 591,
    OF_OXM_MPLS_TC = 592,
    OF_OXM_MPLS_TC_MASKED = 593,
    OF_OXM_PBB_UCA = 594,
    OF_OXM_PBB_UCA_MASKED = 595,
    OF_OXM_SCTP_DST = 596,
    OF_OXM_SCTP_DST_MASKED = 597,
    OF_OXM_SCTP_SRC = 598,
    OF_OXM_SCTP_SRC_MASKED = 599,
    OF_OXM_TCP_DST = 600,
    OF_OXM_TCP_DST_MASKED = 601,
    OF_OXM_TCP_SRC = 602,
    OF_OXM_TCP_SRC_MASKED = 603,
    OF_OXM_TUNNEL_ID = 604,
    OF_OXM_TUNNEL_ID_MASKED = 605,
    OF_OXM_TUNNEL_IPV4_DST = 606,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 607,
    OF_OXM_TUNNEL_IPV4_SRC = 608,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 609,
    OF_OXM_UDP_DST = 610,
    OF_OXM_UDP_DST_MASKED = 611,
    OF_OXM_UDP_SRC = 612,
    OF_OXM_UDP_SRC_MASKED = 613,
    OF_OXM_VLAN_PCP = 614,
    OF_OXM_VLAN_PCP_MASKED = 615,
    OF_OXM_VLAN_VID = 616,
    OF_OXM_VLAN_VID_MASKED = 617,
    OF_PACKET_QUEUE = 618,
    OF_PORT_DESC = 619,
    OF_PORT_DESC_PROP = 620,
    OF_PORT_DESC_PROP_BSN = 621,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 622,
    OF_PORT_DESC_PROP_BSN_UPLINK = 623,
    OF_PORT_DESC_PROP_ETHERNET = 624,
    OF_PORT_DESC_PROP_EXPERIMENTER = 625,
    OF_PORT_DESC_PROP_OPTICAL = 626,
    OF_PORT_MOD_PROP = 627,
    OF_PORT_MOD_PROP_ETHERNET = 628,
    OF_PORT_MOD_PROP_EXPERIMENTER = 629,
    OF_PORT_MOD_PROP_OPTICAL = 630,
    OF_PORT_STATS_ENTRY = 631,
    OF_PORT_STATS_PROP = 632,
    OF_PORT_STATS_PROP_ETHERNET = 633,
    OF_PORT_STATS_PROP_EXPERIMENTER = 634,
    OF_PORT_STATS_PROP_OPTICAL = 635,
    OF_QUEUE_DESC = 636,
    OF_QUEUE_DESC_PROP = 637,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 638,
    OF_QUEUE_DESC_PROP_MAX_RATE = 639,
    OF_QUEUE_DESC_PROP_MIN_RATE = 640,
    OF_QUEUE_PROP = 641,
    OF_QUEUE_PROP_EXPERIMENTER = 642,
    OF_QUEUE_PROP_MAX_RATE = 643,
    OF_QUEUE_PROP_MIN_RATE = 644,
    OF_QUEUE_STATS_ENTRY = 645,
    OF_QUEUE_STATS_PROP = 646,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 647,
    OF_ROLE_PROP = 648,
    OF_ROLE_PROP_EXPERIMENTER = 649,
    OF_TABLE_DESC = 650,
    OF_TABLE_FEATURE_PROP = 651,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 652,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 653,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 654,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 655,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 656,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 657,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 658,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 659,
    OF_TABLE_FEATURE_PROP_MATCH = 660,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 661,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 662,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 663,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 664,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 665,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 666,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 667,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 668,
    OF_TABLE_FEATURES = 669,
    OF_TABLE_MOD_PROP = 670,
    OF_TABLE_MOD_PROP_EVICTION = 671,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 672,
    OF_TABLE_MOD_PROP_VACANCY = 673,
    OF_TABLE_STATS_ENTRY = 674,
    OF_UINT32 = 675,
    OF_UINT64 = 676,
    OF_UINT8 = 677,
    ...
    /* List objects */
    OF_LIST_ACTION = 678,
    OF_LIST_ACTION_ID = 679,
    OF_LIST_ASYNC_CONFIG_PROP = 680,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 681,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 682,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 683,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 684,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 685,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 686,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 687,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 688,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 689,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 690,
    OF_LIST_BSN_INTERFACE = 691,
    OF_LIST_BSN_LACP_STATS_ENTRY = 692,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 693,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 694,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 695,
    OF_LIST_BSN_TLV = 696,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 697,
    OF_LIST_BSN_VLAN_MAC = 698,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 699,
    OF_LIST_BUCKET = 700,
    OF_LIST_BUCKET_COUNTER = 701,
    OF_LIST_BUNDLE_PROP = 702,
    OF_LIST_FLOW_STATS_ENTRY = 703,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 704,
    OF_LIST_GROUP_STATS_ENTRY = 705,
    OF_LIST_HELLO_ELEM = 706,
    OF_LIST_INSTRUCTION = 707,
    OF_LIST_INSTRUCTION_ID = 708,
    OF_LIST_METER_BAND = 709,
    OF_LIST_METER_BAND_STATS = 710,
    OF_LIST_METER_CONFIG = 711,
    OF_LIST_METER_STATS = 712,
    OF_LIST_OXM = 713,
    OF_LIST_PACKET_QUEUE = 714,
    OF_LIST_PORT_DESC = 715,
    OF_LIST_PORT_DESC_PROP = 716,
    OF_LIST_PORT_MOD_PROP = 717,
    OF_LIST_PORT_STATS_ENTRY = 718,
    OF_LIST_PORT_STATS_PROP = 719,
    OF_LIST_QUEUE_DESC = 720,
    OF_LIST_QUEUE_DESC_PROP = 721,
    OF_LIST_QUEUE_PROP = 722,
    OF_LIST_QUEUE_STATS_ENTRY = 723,
    OF_LIST_QUEUE_STATS_PROP = 724,
    OF_LIST_ROLE_PROP = 725,
    OF_LIST_TABLE_DESC = 726,
    OF_LIST_TABLE_FEATURE_PROP = 727,
    OF_LIST_TABLE_FEATURES = 728,
    OF_LIST_TABLE_MOD_PROP = 729,
    OF_LIST_TABLE_STATS_ENTRY = 730,
    OF_LIST_UINT32 = 731,
    OF_LIST_UINT64 = 732,
    OF_LIST_UINT8 = 733,
