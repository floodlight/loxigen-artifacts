...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_NAME = 390,
    OF_BSN_TLV_NDP_OFFLOAD = 391,
    OF_BSN_TLV_NDP_STATIC = 392,
    OF_BSN_TLV_NEGATE = 393,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 394,
    OF_BSN_TLV_NEXT_HOP_MAC = 395,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 396,
    OF_BSN_TLV_NO_ARP_RESPONSE = 397,
    OF_BSN_TLV_NO_NS_RESPONSE = 398,
    OF_BSN_TLV_OFFSET = 399,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 400,
    OF_BSN_TLV_OUTER_SRC_MAC = 401,
    OF_BSN_TLV_PARENT_PORT = 402,
    OF_BSN_TLV_PARTNER_KEY = 403,
    OF_BSN_TLV_PARTNER_PORT_NUM = 404,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 405,
    OF_BSN_TLV_PARTNER_STATE = 406,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 407,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 408,
    OF_BSN_TLV_PASSIVE = 409,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 410,
    OF_BSN_TLV_PIM_DR = 411,
    OF_BSN_TLV_PIM_PACKET_TYPE = 412,
    OF_BSN_TLV_PORT = 413,
