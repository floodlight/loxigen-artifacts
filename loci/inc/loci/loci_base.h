...
typedef enum of_object_id_e {
    ...
    OF_OXM_CONN_TRACKING_IPV6_DST = 608,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 609,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 610,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 611,
    OF_OXM_CONN_TRACKING_LABEL = 612,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 613,
    OF_OXM_CONN_TRACKING_MARK = 614,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 615,
    OF_OXM_CONN_TRACKING_NW_DST = 616,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 617,
    OF_OXM_CONN_TRACKING_NW_PROTO = 618,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 619,
    OF_OXM_CONN_TRACKING_NW_SRC = 620,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 621,
    OF_OXM_CONN_TRACKING_STATE = 622,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 623,
    OF_OXM_CONN_TRACKING_TP_DST = 624,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 625,
    OF_OXM_CONN_TRACKING_TP_SRC = 626,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 627,
    OF_OXM_CONN_TRACKING_ZONE = 628,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 629,
    OF_OXM_ETH_DST = 630,
    OF_OXM_ETH_DST_MASKED = 631,
    OF_OXM_ETH_SRC = 632,
    OF_OXM_ETH_SRC_MASKED = 633,
    OF_OXM_ETH_TYPE = 634,
    OF_OXM_ETH_TYPE_MASKED = 635,
    OF_OXM_ICMPV4_CODE = 636,
    OF_OXM_ICMPV4_CODE_MASKED = 637,
    OF_OXM_ICMPV4_TYPE = 638,
    OF_OXM_ICMPV4_TYPE_MASKED = 639,
    OF_OXM_ICMPV6_CODE = 640,
    OF_OXM_ICMPV6_CODE_MASKED = 641,
    OF_OXM_ICMPV6_TYPE = 642,
    OF_OXM_ICMPV6_TYPE_MASKED = 643,
    OF_OXM_IN_PHY_PORT = 644,
    OF_OXM_IN_PHY_PORT_MASKED = 645,
    OF_OXM_IN_PORT = 646,
    OF_OXM_IN_PORT_MASKED = 647,
    OF_OXM_IP_DSCP = 648,
    OF_OXM_IP_DSCP_MASKED = 649,
    OF_OXM_IP_ECN = 650,
    OF_OXM_IP_ECN_MASKED = 651,
    OF_OXM_IP_PROTO = 652,
    OF_OXM_IP_PROTO_MASKED = 653,
    OF_OXM_IPV4_DST = 654,
    OF_OXM_IPV4_DST_MASKED = 655,
    OF_OXM_IPV4_SRC = 656,
    OF_OXM_IPV4_SRC_MASKED = 657,
    OF_OXM_IPV6_DST = 658,
    OF_OXM_IPV6_DST_MASKED = 659,
    OF_OXM_IPV6_EXTHDR = 660,
    OF_OXM_IPV6_EXTHDR_MASKED = 661,
    OF_OXM_IPV6_FLABEL = 662,
    OF_OXM_IPV6_FLABEL_MASKED = 663,
    OF_OXM_IPV6_ND_SLL = 664,
    OF_OXM_IPV6_ND_SLL_MASKED = 665,
    OF_OXM_IPV6_ND_TARGET = 666,
    OF_OXM_IPV6_ND_TARGET_MASKED = 667,
    OF_OXM_IPV6_ND_TLL = 668,
    OF_OXM_IPV6_ND_TLL_MASKED = 669,
    OF_OXM_IPV6_SRC = 670,
    OF_OXM_IPV6_SRC_MASKED = 671,
    OF_OXM_METADATA = 672,
    OF_OXM_METADATA_MASKED = 673,
    OF_OXM_MPLS_BOS = 674,
    OF_OXM_MPLS_BOS_MASKED = 675,
    OF_OXM_MPLS_LABEL = 676,
    OF_OXM_MPLS_LABEL_MASKED = 677,
    OF_OXM_MPLS_TC = 678,
    OF_OXM_MPLS_TC_MASKED = 679,
    OF_OXM_OVS_TCP_FLAGS = 680,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 681,
    OF_OXM_PBB_UCA = 682,
    OF_OXM_PBB_UCA_MASKED = 683,
    OF_OXM_SCTP_DST = 684,
    OF_OXM_SCTP_DST_MASKED = 685,
    OF_OXM_SCTP_SRC = 686,
    OF_OXM_SCTP_SRC_MASKED = 687,
    OF_OXM_TCP_DST = 688,
    OF_OXM_TCP_DST_MASKED = 689,
    OF_OXM_TCP_SRC = 690,
    OF_OXM_TCP_SRC_MASKED = 691,
    OF_OXM_TUNNEL_ID = 692,
    OF_OXM_TUNNEL_ID_MASKED = 693,
    OF_OXM_TUNNEL_IPV4_DST = 694,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 695,
    OF_OXM_TUNNEL_IPV4_SRC = 696,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 697,
    OF_OXM_UDP_DST = 698,
    OF_OXM_UDP_DST_MASKED = 699,
    OF_OXM_UDP_SRC = 700,
    OF_OXM_UDP_SRC_MASKED = 701,
    OF_OXM_VLAN_PCP = 702,
    OF_OXM_VLAN_PCP_MASKED = 703,
    OF_OXM_VLAN_VID = 704,
    OF_OXM_VLAN_VID_MASKED = 705,
    OF_PACKET_QUEUE = 706,
    OF_PORT_DESC = 707,
    OF_PORT_DESC_PROP = 708,
    OF_PORT_DESC_PROP_BSN = 709,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 710,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 711,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 712,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 713,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 714,
    OF_PORT_DESC_PROP_BSN_UPLINK = 715,
    OF_PORT_DESC_PROP_ETHERNET = 716,
    OF_PORT_DESC_PROP_EXPERIMENTER = 717,
    OF_PORT_DESC_PROP_OPTICAL = 718,
    OF_PORT_MOD_PROP = 719,
    OF_PORT_MOD_PROP_ETHERNET = 720,
    OF_PORT_MOD_PROP_EXPERIMENTER = 721,
    OF_PORT_MOD_PROP_OPTICAL = 722,
    OF_PORT_STATS_ENTRY = 723,
    OF_PORT_STATS_PROP = 724,
    OF_PORT_STATS_PROP_ETHERNET = 725,
    OF_PORT_STATS_PROP_EXPERIMENTER = 726,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 727,
    OF_PORT_STATS_PROP_OPTICAL = 728,
    OF_QUEUE_DESC = 729,
    OF_QUEUE_DESC_PROP = 730,
    OF_QUEUE_DESC_PROP_BSN = 731,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 732,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 733,
    OF_QUEUE_DESC_PROP_MAX_RATE = 734,
    OF_QUEUE_DESC_PROP_MIN_RATE = 735,
    OF_QUEUE_PROP = 736,
    OF_QUEUE_PROP_EXPERIMENTER = 737,
    OF_QUEUE_PROP_MAX_RATE = 738,
    OF_QUEUE_PROP_MIN_RATE = 739,
    OF_QUEUE_STATS_ENTRY = 740,
    OF_QUEUE_STATS_PROP = 741,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 742,
    OF_ROLE_PROP = 743,
    OF_ROLE_PROP_EXPERIMENTER = 744,
    OF_TABLE_DESC = 745,
    OF_TABLE_FEATURE_PROP = 746,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 747,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 748,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 749,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 750,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 751,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 752,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 753,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 754,
    OF_TABLE_FEATURE_PROP_MATCH = 755,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 756,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 757,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 758,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 759,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 760,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 761,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 762,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 763,
    OF_TABLE_FEATURES = 764,
    OF_TABLE_MOD_PROP = 765,
    OF_TABLE_MOD_PROP_EVICTION = 766,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 767,
    OF_TABLE_MOD_PROP_VACANCY = 768,
    OF_TABLE_STATS_ENTRY = 769,
    OF_UINT32 = 770,
    OF_UINT64 = 771,
    OF_UINT8 = 772,
    ...
    /* List objects */
    OF_LIST_ACTION = 773,
    OF_LIST_ACTION_ID = 774,
    OF_LIST_ASYNC_CONFIG_PROP = 775,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 776,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 777,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 778,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 779,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 780,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 781,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 782,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 783,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 784,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 785,
    OF_LIST_BSN_INTERFACE = 786,
    OF_LIST_BSN_LACP_STATS_ENTRY = 787,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 788,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 789,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 790,
    OF_LIST_BSN_TLV = 791,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 792,
    OF_LIST_BSN_VLAN_MAC = 793,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 794,
    OF_LIST_BUCKET = 795,
    OF_LIST_BUCKET_COUNTER = 796,
    OF_LIST_BUNDLE_PROP = 797,
    OF_LIST_FLOW_STATS_ENTRY = 798,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 799,
    OF_LIST_GROUP_STATS_ENTRY = 800,
    OF_LIST_HELLO_ELEM = 801,
    OF_LIST_INSTRUCTION = 802,
    OF_LIST_INSTRUCTION_ID = 803,
    OF_LIST_METER_BAND = 804,
    OF_LIST_METER_BAND_STATS = 805,
    OF_LIST_METER_CONFIG = 806,
    OF_LIST_METER_STATS = 807,
    OF_LIST_OXM = 808,
    OF_LIST_PACKET_QUEUE = 809,
    OF_LIST_PORT_DESC = 810,
    OF_LIST_PORT_DESC_PROP = 811,
    OF_LIST_PORT_MOD_PROP = 812,
    OF_LIST_PORT_STATS_ENTRY = 813,
    OF_LIST_PORT_STATS_PROP = 814,
    OF_LIST_QUEUE_DESC = 815,
    OF_LIST_QUEUE_DESC_PROP = 816,
    OF_LIST_QUEUE_PROP = 817,
    OF_LIST_QUEUE_STATS_ENTRY = 818,
    OF_LIST_QUEUE_STATS_PROP = 819,
    OF_LIST_ROLE_PROP = 820,
    OF_LIST_TABLE_DESC = 821,
    OF_LIST_TABLE_FEATURE_PROP = 822,
    OF_LIST_TABLE_FEATURES = 823,
    OF_LIST_TABLE_MOD_PROP = 824,
    OF_LIST_TABLE_STATS_ENTRY = 825,
    OF_LIST_UINT32 = 826,
    OF_LIST_UINT64 = 827,
    OF_LIST_UINT8 = 828,
