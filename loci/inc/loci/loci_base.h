...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_LOOPBACK_MODE = 404,
    OF_BSN_TLV_LOOPBACK_PORT = 405,
    OF_BSN_TLV_LOSSLESS = 406,
    OF_BSN_TLV_LR_ALL_ENABLED = 407,
    OF_BSN_TLV_MAC = 408,
    OF_BSN_TLV_MAC_MASK = 409,
    OF_BSN_TLV_MAX_COUNT = 410,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 411,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 412,
    OF_BSN_TLV_MISS_PACKETS = 413,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 414,
    OF_BSN_TLV_MPLS_LABEL = 415,
    OF_BSN_TLV_MPLS_SEQUENCED = 416,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 417,
    OF_BSN_TLV_MULTICAST_PACKET = 418,
    OF_BSN_TLV_MULTIPLIER = 419,
    OF_BSN_TLV_NAME = 420,
    OF_BSN_TLV_NDP_OFFLOAD = 421,
    OF_BSN_TLV_NDP_STATIC = 422,
    OF_BSN_TLV_NEGATE = 423,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 424,
    OF_BSN_TLV_NEXT_HOP_MAC = 425,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 426,
    OF_BSN_TLV_NO_ARP_RESPONSE = 427,
    OF_BSN_TLV_NO_NS_RESPONSE = 428,
    OF_BSN_TLV_OFFSET = 429,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 430,
    OF_BSN_TLV_OUTER_SRC_MAC = 431,
    OF_BSN_TLV_PARENT_PORT = 432,
    OF_BSN_TLV_PARTNER_KEY = 433,
    OF_BSN_TLV_PARTNER_PORT_NUM = 434,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 435,
    OF_BSN_TLV_PARTNER_STATE = 436,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 437,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 438,
    OF_BSN_TLV_PASSIVE = 439,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 440,
    OF_BSN_TLV_PIM_DR = 441,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 442,
    OF_BSN_TLV_PORT = 443,
    OF_BSN_TLV_PORT_MODE = 444,
    OF_BSN_TLV_PORT_SPEED_GBPS = 445,
    OF_BSN_TLV_PORT_USAGE = 446,
    OF_BSN_TLV_PORT_VXLAN_MODE = 447,
    OF_BSN_TLV_PRESERVE_VLAN = 448,
    OF_BSN_TLV_PRIORITY = 449,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 450,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 451,
    OF_BSN_TLV_QOS_PRIORITY = 452,
    OF_BSN_TLV_QUEUE_ID = 453,
    OF_BSN_TLV_QUEUE_WEIGHT = 454,
    OF_BSN_TLV_RATE_LIMIT = 455,
    OF_BSN_TLV_RATE_UNIT = 456,
    OF_BSN_TLV_RECORD_PACKETS = 457,
    OF_BSN_TLV_REDUNDANT_MGMT = 458,
    OF_BSN_TLV_REFERENCE = 459,
    OF_BSN_TLV_REPLY_PACKETS = 460,
    OF_BSN_TLV_REQUEST_PACKETS = 461,
    OF_BSN_TLV_REST_SERVER = 462,
    OF_BSN_TLV_ROUTING_PARAM = 463,
    OF_BSN_TLV_RX_BYTES = 464,
    OF_BSN_TLV_RX_PACKETS = 465,
    OF_BSN_TLV_SAMPLING_RATE = 466,
    OF_BSN_TLV_SCTP_DST = 467,
    OF_BSN_TLV_SCTP_SRC = 468,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 469,
    OF_BSN_TLV_SRC_MAC_CML = 470,
    OF_BSN_TLV_STATUS = 471,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 472,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 473,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 474,
    OF_BSN_TLV_SUB_AGENT_ID = 475,
    OF_BSN_TLV_TCP_DST = 476,
    OF_BSN_TLV_TCP_FLAGS = 477,
    OF_BSN_TLV_TCP_SRC = 478,
    OF_BSN_TLV_TIMESTAMP = 479,
    OF_BSN_TLV_TTL = 480,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 481,
    OF_BSN_TLV_TX_BYTES = 482,
    OF_BSN_TLV_TX_PACKETS = 483,
    OF_BSN_TLV_UDF_ANCHOR = 484,
    OF_BSN_TLV_UDF_CAPABILITY = 485,
    OF_BSN_TLV_UDF_DATA = 486,
    OF_BSN_TLV_UDF_ID = 487,
    OF_BSN_TLV_UDF_LENGTH = 488,
    OF_BSN_TLV_UDF_OFFSET = 489,
    OF_BSN_TLV_UDP_DST = 490,
    OF_BSN_TLV_UDP_SRC = 491,
    OF_BSN_TLV_UINT32 = 492,
    OF_BSN_TLV_UINT64_LIST = 493,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 494,
    OF_BSN_TLV_UNICAST_RATE = 495,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 496,
    OF_BSN_TLV_UNTAGGED = 497,
    OF_BSN_TLV_UPGRADE = 498,
    OF_BSN_TLV_URI_SCHEME = 499,
    OF_BSN_TLV_USE_PACKET_STATE = 500,
    OF_BSN_TLV_USER_CONFIGURED = 501,
    OF_BSN_TLV_VFI = 502,
    OF_BSN_TLV_VFP_CLASS_ID = 503,
    OF_BSN_TLV_VIRTUAL = 504,
    OF_BSN_TLV_VLAN_MAC_LIST = 505,
    OF_BSN_TLV_VLAN_PCP = 506,
    OF_BSN_TLV_VLAN_VID = 507,
    OF_BSN_TLV_VLAN_VID_MASK = 508,
    OF_BSN_TLV_VNI = 509,
    OF_BSN_TLV_VPN_KEY = 510,
    OF_BSN_TLV_VRF = 511,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 512,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 513,
    OF_BSN_VLAN_MAC = 514,
    OF_BSN_VPORT = 515,
    OF_BSN_VPORT_L2GRE = 516,
    OF_BSN_VPORT_Q_IN_Q = 517,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 518,
    OF_BUCKET = 519,
    OF_BUCKET_COUNTER = 520,
    OF_BUNDLE_PROP = 521,
    OF_BUNDLE_PROP_EXPERIMENTER = 522,
    OF_FLOW_STATS_ENTRY = 523,
    OF_GROUP_DESC_STATS_ENTRY = 524,
    OF_GROUP_STATS_ENTRY = 525,
    OF_HELLO_ELEM = 526,
    OF_HELLO_ELEM_VERSIONBITMAP = 527,
    OF_INSTRUCTION = 528,
    OF_INSTRUCTION_APPLY_ACTIONS = 529,
    OF_INSTRUCTION_BSN = 530,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 531,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 532,
    OF_INSTRUCTION_BSN_DENY = 533,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 534,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 535,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 536,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 537,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 538,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 539,
    OF_INSTRUCTION_BSN_HASH_SELECT = 540,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 541,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 542,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 543,
    OF_INSTRUCTION_BSN_PERMIT = 544,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 545,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 546,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 547,
    OF_INSTRUCTION_CLEAR_ACTIONS = 548,
    OF_INSTRUCTION_EXPERIMENTER = 549,
    OF_INSTRUCTION_GOTO_TABLE = 550,
    OF_INSTRUCTION_ID = 551,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 552,
    OF_INSTRUCTION_ID_BSN = 553,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 554,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 555,
    OF_INSTRUCTION_ID_BSN_DENY = 556,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 557,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 558,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 559,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 560,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 561,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 562,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 563,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 564,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 565,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 566,
    OF_INSTRUCTION_ID_BSN_PERMIT = 567,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 568,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 569,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 570,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 571,
    OF_INSTRUCTION_ID_EXPERIMENTER = 572,
    OF_INSTRUCTION_ID_GOTO_TABLE = 573,
    OF_INSTRUCTION_ID_METER = 574,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 575,
    OF_INSTRUCTION_ID_WRITE_METADATA = 576,
    OF_INSTRUCTION_METER = 577,
    OF_INSTRUCTION_WRITE_ACTIONS = 578,
    OF_INSTRUCTION_WRITE_METADATA = 579,
    OF_MATCH_V1 = 580,
    OF_MATCH_V2 = 581,
    OF_MATCH_V3 = 582,
    OF_METER_BAND = 583,
    OF_METER_BAND_DROP = 584,
    OF_METER_BAND_DSCP_REMARK = 585,
    OF_METER_BAND_EXPERIMENTER = 586,
    OF_METER_BAND_STATS = 587,
    OF_METER_CONFIG = 588,
    OF_METER_FEATURES = 589,
    OF_METER_STATS = 590,
    OF_OXM = 591,
    OF_OXM_ARP_OP = 592,
    OF_OXM_ARP_OP_MASKED = 593,
    OF_OXM_ARP_SHA = 594,
    OF_OXM_ARP_SHA_MASKED = 595,
    OF_OXM_ARP_SPA = 596,
    OF_OXM_ARP_SPA_MASKED = 597,
    OF_OXM_ARP_THA = 598,
    OF_OXM_ARP_THA_MASKED = 599,
    OF_OXM_ARP_TPA = 600,
    OF_OXM_ARP_TPA_MASKED = 601,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 602,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 603,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 604,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 605,
    OF_OXM_BSN_IFP_CLASS_ID = 606,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 607,
    OF_OXM_BSN_IN_PORTS_128 = 608,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 609,
    OF_OXM_BSN_IN_PORTS_512 = 610,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 611,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 612,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 613,
    OF_OXM_BSN_INNER_ETH_DST = 614,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 615,
    OF_OXM_BSN_INNER_ETH_SRC = 616,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 617,
    OF_OXM_BSN_INNER_VLAN_VID = 618,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 619,
    OF_OXM_BSN_IP_FRAGMENTATION = 620,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 621,
    OF_OXM_BSN_L2_CACHE_HIT = 622,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 623,
    OF_OXM_BSN_L3_DST_CLASS_ID = 624,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 625,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 626,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 627,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 628,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 629,
    OF_OXM_BSN_LAG_ID = 630,
    OF_OXM_BSN_LAG_ID_MASKED = 631,
    OF_OXM_BSN_TCP_FLAGS = 632,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 633,
    OF_OXM_BSN_UDF0 = 634,
    OF_OXM_BSN_UDF0_MASKED = 635,
    OF_OXM_BSN_UDF1 = 636,
    OF_OXM_BSN_UDF1_MASKED = 637,
    OF_OXM_BSN_UDF2 = 638,
    OF_OXM_BSN_UDF2_MASKED = 639,
    OF_OXM_BSN_UDF3 = 640,
    OF_OXM_BSN_UDF3_MASKED = 641,
    OF_OXM_BSN_UDF4 = 642,
    OF_OXM_BSN_UDF4_MASKED = 643,
    OF_OXM_BSN_UDF5 = 644,
    OF_OXM_BSN_UDF5_MASKED = 645,
    OF_OXM_BSN_UDF6 = 646,
    OF_OXM_BSN_UDF6_MASKED = 647,
    OF_OXM_BSN_UDF7 = 648,
    OF_OXM_BSN_UDF7_MASKED = 649,
    OF_OXM_BSN_VFI = 650,
    OF_OXM_BSN_VFI_MASKED = 651,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 652,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 653,
    OF_OXM_BSN_VRF = 654,
    OF_OXM_BSN_VRF_MASKED = 655,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 656,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 657,
    OF_OXM_CONN_TRACKING_IPV6_DST = 658,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 659,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 660,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 661,
    OF_OXM_CONN_TRACKING_LABEL = 662,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 663,
    OF_OXM_CONN_TRACKING_MARK = 664,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 665,
    OF_OXM_CONN_TRACKING_NW_DST = 666,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 667,
    OF_OXM_CONN_TRACKING_NW_PROTO = 668,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 669,
    OF_OXM_CONN_TRACKING_NW_SRC = 670,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 671,
    OF_OXM_CONN_TRACKING_STATE = 672,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 673,
    OF_OXM_CONN_TRACKING_TP_DST = 674,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 675,
    OF_OXM_CONN_TRACKING_TP_SRC = 676,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 677,
    OF_OXM_CONN_TRACKING_ZONE = 678,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 679,
    OF_OXM_ETH_DST = 680,
    OF_OXM_ETH_DST_MASKED = 681,
    OF_OXM_ETH_SRC = 682,
    OF_OXM_ETH_SRC_MASKED = 683,
    OF_OXM_ETH_TYPE = 684,
    OF_OXM_ETH_TYPE_MASKED = 685,
    OF_OXM_ICMPV4_CODE = 686,
    OF_OXM_ICMPV4_CODE_MASKED = 687,
    OF_OXM_ICMPV4_TYPE = 688,
    OF_OXM_ICMPV4_TYPE_MASKED = 689,
    OF_OXM_ICMPV6_CODE = 690,
    OF_OXM_ICMPV6_CODE_MASKED = 691,
    OF_OXM_ICMPV6_TYPE = 692,
    OF_OXM_ICMPV6_TYPE_MASKED = 693,
    OF_OXM_IN_PHY_PORT = 694,
    OF_OXM_IN_PHY_PORT_MASKED = 695,
    OF_OXM_IN_PORT = 696,
    OF_OXM_IN_PORT_MASKED = 697,
    OF_OXM_IP_DSCP = 698,
    OF_OXM_IP_DSCP_MASKED = 699,
    OF_OXM_IP_ECN = 700,
    OF_OXM_IP_ECN_MASKED = 701,
    OF_OXM_IP_PROTO = 702,
    OF_OXM_IP_PROTO_MASKED = 703,
    OF_OXM_IPV4_DST = 704,
    OF_OXM_IPV4_DST_MASKED = 705,
    OF_OXM_IPV4_SRC = 706,
    OF_OXM_IPV4_SRC_MASKED = 707,
    OF_OXM_IPV6_DST = 708,
    OF_OXM_IPV6_DST_MASKED = 709,
    OF_OXM_IPV6_EXTHDR = 710,
    OF_OXM_IPV6_EXTHDR_MASKED = 711,
    OF_OXM_IPV6_FLABEL = 712,
    OF_OXM_IPV6_FLABEL_MASKED = 713,
    OF_OXM_IPV6_ND_SLL = 714,
    OF_OXM_IPV6_ND_SLL_MASKED = 715,
    OF_OXM_IPV6_ND_TARGET = 716,
    OF_OXM_IPV6_ND_TARGET_MASKED = 717,
    OF_OXM_IPV6_ND_TLL = 718,
    OF_OXM_IPV6_ND_TLL_MASKED = 719,
    OF_OXM_IPV6_SRC = 720,
    OF_OXM_IPV6_SRC_MASKED = 721,
    OF_OXM_METADATA = 722,
    OF_OXM_METADATA_MASKED = 723,
    OF_OXM_MPLS_BOS = 724,
    OF_OXM_MPLS_BOS_MASKED = 725,
    OF_OXM_MPLS_LABEL = 726,
    OF_OXM_MPLS_LABEL_MASKED = 727,
    OF_OXM_MPLS_TC = 728,
    OF_OXM_MPLS_TC_MASKED = 729,
    OF_OXM_OVS_TCP_FLAGS = 730,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 731,
    OF_OXM_PBB_UCA = 732,
    OF_OXM_PBB_UCA_MASKED = 733,
    OF_OXM_SCTP_DST = 734,
    OF_OXM_SCTP_DST_MASKED = 735,
    OF_OXM_SCTP_SRC = 736,
    OF_OXM_SCTP_SRC_MASKED = 737,
    OF_OXM_TCP_DST = 738,
    OF_OXM_TCP_DST_MASKED = 739,
    OF_OXM_TCP_SRC = 740,
    OF_OXM_TCP_SRC_MASKED = 741,
    OF_OXM_TUNNEL_ID = 742,
    OF_OXM_TUNNEL_ID_MASKED = 743,
    OF_OXM_TUNNEL_IPV4_DST = 744,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 745,
    OF_OXM_TUNNEL_IPV4_SRC = 746,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 747,
    OF_OXM_UDP_DST = 748,
    OF_OXM_UDP_DST_MASKED = 749,
    OF_OXM_UDP_SRC = 750,
    OF_OXM_UDP_SRC_MASKED = 751,
    OF_OXM_VLAN_PCP = 752,
    OF_OXM_VLAN_PCP_MASKED = 753,
    OF_OXM_VLAN_VID = 754,
    OF_OXM_VLAN_VID_MASKED = 755,
    OF_PACKET_QUEUE = 756,
    OF_PORT_DESC = 757,
    OF_PORT_DESC_PROP = 758,
    OF_PORT_DESC_PROP_BSN = 759,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 760,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 761,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 762,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 763,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 764,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 765,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 766,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 767,
    OF_PORT_DESC_PROP_BSN_UPLINK = 768,
    OF_PORT_DESC_PROP_ETHERNET = 769,
    OF_PORT_DESC_PROP_EXPERIMENTER = 770,
    OF_PORT_DESC_PROP_OPTICAL = 771,
    OF_PORT_MOD_PROP = 772,
    OF_PORT_MOD_PROP_ETHERNET = 773,
    OF_PORT_MOD_PROP_EXPERIMENTER = 774,
    OF_PORT_MOD_PROP_OPTICAL = 775,
    OF_PORT_STATS_ENTRY = 776,
    OF_PORT_STATS_PROP = 777,
    OF_PORT_STATS_PROP_ETHERNET = 778,
    OF_PORT_STATS_PROP_EXPERIMENTER = 779,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 780,
    OF_PORT_STATS_PROP_OPTICAL = 781,
    OF_QUEUE_DESC = 782,
    OF_QUEUE_DESC_PROP = 783,
    OF_QUEUE_DESC_PROP_BSN = 784,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 785,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 786,
    OF_QUEUE_DESC_PROP_MAX_RATE = 787,
    OF_QUEUE_DESC_PROP_MIN_RATE = 788,
    OF_QUEUE_PROP = 789,
    OF_QUEUE_PROP_EXPERIMENTER = 790,
    OF_QUEUE_PROP_MAX_RATE = 791,
    OF_QUEUE_PROP_MIN_RATE = 792,
    OF_QUEUE_STATS_ENTRY = 793,
    OF_QUEUE_STATS_PROP = 794,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 795,
    OF_ROLE_PROP = 796,
    OF_ROLE_PROP_EXPERIMENTER = 797,
    OF_TABLE_DESC = 798,
    OF_TABLE_FEATURE_PROP = 799,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 800,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 801,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 802,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 803,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 804,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 805,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 806,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 807,
    OF_TABLE_FEATURE_PROP_MATCH = 808,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 809,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 810,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 811,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 812,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 813,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 814,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 815,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 816,
    OF_TABLE_FEATURES = 817,
    OF_TABLE_MOD_PROP = 818,
    OF_TABLE_MOD_PROP_EVICTION = 819,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 820,
    OF_TABLE_MOD_PROP_VACANCY = 821,
    OF_TABLE_STATS_ENTRY = 822,
    OF_UINT32 = 823,
    OF_UINT64 = 824,
    OF_UINT8 = 825,
    ...
    /* List objects */
    OF_LIST_ACTION = 826,
    OF_LIST_ACTION_ID = 827,
    OF_LIST_ASYNC_CONFIG_PROP = 828,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 829,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 830,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 831,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 832,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 833,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 834,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 835,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 836,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 837,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 838,
    OF_LIST_BSN_INTERFACE = 839,
    OF_LIST_BSN_LACP_STATS_ENTRY = 840,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 841,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 842,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 843,
    OF_LIST_BSN_TLV = 844,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 845,
    OF_LIST_BSN_VLAN_MAC = 846,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 847,
    OF_LIST_BUCKET = 848,
    OF_LIST_BUCKET_COUNTER = 849,
    OF_LIST_BUNDLE_PROP = 850,
    OF_LIST_FLOW_STATS_ENTRY = 851,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 852,
    OF_LIST_GROUP_STATS_ENTRY = 853,
    OF_LIST_HELLO_ELEM = 854,
    OF_LIST_INSTRUCTION = 855,
    OF_LIST_INSTRUCTION_ID = 856,
    OF_LIST_METER_BAND = 857,
    OF_LIST_METER_BAND_STATS = 858,
    OF_LIST_METER_CONFIG = 859,
    OF_LIST_METER_STATS = 860,
    OF_LIST_OXM = 861,
    OF_LIST_PACKET_QUEUE = 862,
    OF_LIST_PORT_DESC = 863,
    OF_LIST_PORT_DESC_PROP = 864,
    OF_LIST_PORT_MOD_PROP = 865,
    OF_LIST_PORT_STATS_ENTRY = 866,
    OF_LIST_PORT_STATS_PROP = 867,
    OF_LIST_QUEUE_DESC = 868,
    OF_LIST_QUEUE_DESC_PROP = 869,
    OF_LIST_QUEUE_PROP = 870,
    OF_LIST_QUEUE_STATS_ENTRY = 871,
    OF_LIST_QUEUE_STATS_PROP = 872,
    OF_LIST_ROLE_PROP = 873,
    OF_LIST_TABLE_DESC = 874,
    OF_LIST_TABLE_FEATURE_PROP = 875,
    OF_LIST_TABLE_FEATURES = 876,
    OF_LIST_TABLE_MOD_PROP = 877,
    OF_LIST_TABLE_STATS_ENTRY = 878,
    OF_LIST_UINT32 = 879,
    OF_LIST_UINT64 = 880,
    OF_LIST_UINT8 = 881,
