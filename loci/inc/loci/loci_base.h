...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_EXTERNAL_IP = 265,
    OF_BSN_TLV_EXTERNAL_MAC = 266,
    OF_BSN_TLV_EXTERNAL_NETMASK = 267,
    OF_BSN_TLV_HEADER = 268,
    OF_BSN_TLV_IDLE_NOTIFICATION = 269,
    OF_BSN_TLV_IDLE_TIME = 270,
    OF_BSN_TLV_IDLE_TIMEOUT = 271,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 272,
    OF_BSN_TLV_INTERNAL_MAC = 273,
    OF_BSN_TLV_IPV4 = 274,
    OF_BSN_TLV_MAC = 275,
    OF_BSN_TLV_MISS_PACKETS = 276,
    OF_BSN_TLV_PORT = 277,
    OF_BSN_TLV_QUEUE_ID = 278,
    OF_BSN_TLV_QUEUE_WEIGHT = 279,
    OF_BSN_TLV_REPLY_PACKETS = 280,
    OF_BSN_TLV_REQUEST_PACKETS = 281,
    OF_BSN_TLV_RX_PACKETS = 282,
    OF_BSN_TLV_TX_PACKETS = 283,
    OF_BSN_TLV_UDF_ANCHOR = 284,
    OF_BSN_TLV_UDF_ID = 285,
    OF_BSN_TLV_UDF_LENGTH = 286,
    OF_BSN_TLV_UDF_OFFSET = 287,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 288,
    OF_BSN_TLV_VLAN_VID = 289,
    OF_BSN_TLV_VRF = 290,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 291,
    OF_BSN_VPORT = 292,
    OF_BSN_VPORT_HEADER = 293,
    OF_BSN_VPORT_L2GRE = 294,
    OF_BSN_VPORT_Q_IN_Q = 295,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 296,
    OF_BUCKET = 297,
    OF_BUCKET_COUNTER = 298,
    OF_FLOW_STATS_ENTRY = 299,
    OF_GROUP_DESC_STATS_ENTRY = 300,
    OF_GROUP_STATS_ENTRY = 301,
    OF_HELLO_ELEM = 302,
    OF_HELLO_ELEM_HEADER = 303,
    OF_HELLO_ELEM_VERSIONBITMAP = 304,
    OF_INSTRUCTION = 305,
    OF_INSTRUCTION_APPLY_ACTIONS = 306,
    OF_INSTRUCTION_BSN = 307,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 308,
    OF_INSTRUCTION_BSN_DENY = 309,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 310,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 311,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 312,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 313,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 314,
    OF_INSTRUCTION_BSN_PERMIT = 315,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 316,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 317,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 318,
    OF_INSTRUCTION_CLEAR_ACTIONS = 319,
    OF_INSTRUCTION_EXPERIMENTER = 320,
    OF_INSTRUCTION_GOTO_TABLE = 321,
    OF_INSTRUCTION_HEADER = 322,
    OF_INSTRUCTION_ID = 323,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 324,
    OF_INSTRUCTION_ID_BSN = 325,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 326,
    OF_INSTRUCTION_ID_BSN_DENY = 327,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 328,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 329,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 330,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 331,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 332,
    OF_INSTRUCTION_ID_BSN_PERMIT = 333,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 334,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 335,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 336,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 337,
    OF_INSTRUCTION_ID_EXPERIMENTER = 338,
    OF_INSTRUCTION_ID_GOTO_TABLE = 339,
    OF_INSTRUCTION_ID_HEADER = 340,
    OF_INSTRUCTION_ID_METER = 341,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 342,
    OF_INSTRUCTION_ID_WRITE_METADATA = 343,
    OF_INSTRUCTION_METER = 344,
    OF_INSTRUCTION_WRITE_ACTIONS = 345,
    OF_INSTRUCTION_WRITE_METADATA = 346,
    OF_MATCH_V1 = 347,
    OF_MATCH_V2 = 348,
    OF_MATCH_V3 = 349,
    OF_METER_BAND = 350,
    OF_METER_BAND_DROP = 351,
    OF_METER_BAND_DSCP_REMARK = 352,
    OF_METER_BAND_EXPERIMENTER = 353,
    OF_METER_BAND_HEADER = 354,
    OF_METER_BAND_STATS = 355,
    OF_METER_CONFIG = 356,
    OF_METER_FEATURES = 357,
    OF_METER_STATS = 358,
    OF_OXM = 359,
    OF_OXM_ARP_OP = 360,
    OF_OXM_ARP_OP_MASKED = 361,
    OF_OXM_ARP_SHA = 362,
    OF_OXM_ARP_SHA_MASKED = 363,
    OF_OXM_ARP_SPA = 364,
    OF_OXM_ARP_SPA_MASKED = 365,
    OF_OXM_ARP_THA = 366,
    OF_OXM_ARP_THA_MASKED = 367,
    OF_OXM_ARP_TPA = 368,
    OF_OXM_ARP_TPA_MASKED = 369,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 370,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 371,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 372,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 373,
    OF_OXM_BSN_IN_PORTS_128 = 374,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 375,
    OF_OXM_BSN_L3_DST_CLASS_ID = 376,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 377,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 378,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 379,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 380,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 381,
    OF_OXM_BSN_LAG_ID = 382,
    OF_OXM_BSN_LAG_ID_MASKED = 383,
    OF_OXM_BSN_TCP_FLAGS = 384,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 385,
    OF_OXM_BSN_UDF0 = 386,
    OF_OXM_BSN_UDF0_MASKED = 387,
    OF_OXM_BSN_UDF1 = 388,
    OF_OXM_BSN_UDF1_MASKED = 389,
    OF_OXM_BSN_UDF2 = 390,
    OF_OXM_BSN_UDF2_MASKED = 391,
    OF_OXM_BSN_UDF3 = 392,
    OF_OXM_BSN_UDF3_MASKED = 393,
    OF_OXM_BSN_UDF4 = 394,
    OF_OXM_BSN_UDF4_MASKED = 395,
    OF_OXM_BSN_UDF5 = 396,
    OF_OXM_BSN_UDF5_MASKED = 397,
    OF_OXM_BSN_UDF6 = 398,
    OF_OXM_BSN_UDF6_MASKED = 399,
    OF_OXM_BSN_UDF7 = 400,
    OF_OXM_BSN_UDF7_MASKED = 401,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 402,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 403,
    OF_OXM_BSN_VRF = 404,
    OF_OXM_BSN_VRF_MASKED = 405,
    OF_OXM_ETH_DST = 406,
    OF_OXM_ETH_DST_MASKED = 407,
    OF_OXM_ETH_SRC = 408,
    OF_OXM_ETH_SRC_MASKED = 409,
    OF_OXM_ETH_TYPE = 410,
    OF_OXM_ETH_TYPE_MASKED = 411,
    OF_OXM_HEADER = 412,
    OF_OXM_ICMPV4_CODE = 413,
    OF_OXM_ICMPV4_CODE_MASKED = 414,
    OF_OXM_ICMPV4_TYPE = 415,
    OF_OXM_ICMPV4_TYPE_MASKED = 416,
    OF_OXM_ICMPV6_CODE = 417,
    OF_OXM_ICMPV6_CODE_MASKED = 418,
    OF_OXM_ICMPV6_TYPE = 419,
    OF_OXM_ICMPV6_TYPE_MASKED = 420,
    OF_OXM_IN_PHY_PORT = 421,
    OF_OXM_IN_PHY_PORT_MASKED = 422,
    OF_OXM_IN_PORT = 423,
    OF_OXM_IN_PORT_MASKED = 424,
    OF_OXM_IP_DSCP = 425,
    OF_OXM_IP_DSCP_MASKED = 426,
    OF_OXM_IP_ECN = 427,
    OF_OXM_IP_ECN_MASKED = 428,
    OF_OXM_IP_PROTO = 429,
    OF_OXM_IP_PROTO_MASKED = 430,
    OF_OXM_IPV4_DST = 431,
    OF_OXM_IPV4_DST_MASKED = 432,
    OF_OXM_IPV4_SRC = 433,
    OF_OXM_IPV4_SRC_MASKED = 434,
    OF_OXM_IPV6_DST = 435,
    OF_OXM_IPV6_DST_MASKED = 436,
    OF_OXM_IPV6_FLABEL = 437,
    OF_OXM_IPV6_FLABEL_MASKED = 438,
    OF_OXM_IPV6_ND_SLL = 439,
    OF_OXM_IPV6_ND_SLL_MASKED = 440,
    OF_OXM_IPV6_ND_TARGET = 441,
    OF_OXM_IPV6_ND_TARGET_MASKED = 442,
    OF_OXM_IPV6_ND_TLL = 443,
    OF_OXM_IPV6_ND_TLL_MASKED = 444,
    OF_OXM_IPV6_SRC = 445,
    OF_OXM_IPV6_SRC_MASKED = 446,
    OF_OXM_METADATA = 447,
    OF_OXM_METADATA_MASKED = 448,
    OF_OXM_MPLS_LABEL = 449,
    OF_OXM_MPLS_LABEL_MASKED = 450,
    OF_OXM_MPLS_TC = 451,
    OF_OXM_MPLS_TC_MASKED = 452,
    OF_OXM_SCTP_DST = 453,
    OF_OXM_SCTP_DST_MASKED = 454,
    OF_OXM_SCTP_SRC = 455,
    OF_OXM_SCTP_SRC_MASKED = 456,
    OF_OXM_TCP_DST = 457,
    OF_OXM_TCP_DST_MASKED = 458,
    OF_OXM_TCP_SRC = 459,
    OF_OXM_TCP_SRC_MASKED = 460,
    OF_OXM_TUNNEL_ID = 461,
    OF_OXM_TUNNEL_ID_MASKED = 462,
    OF_OXM_UDP_DST = 463,
    OF_OXM_UDP_DST_MASKED = 464,
    OF_OXM_UDP_SRC = 465,
    OF_OXM_UDP_SRC_MASKED = 466,
    OF_OXM_VLAN_PCP = 467,
    OF_OXM_VLAN_PCP_MASKED = 468,
    OF_OXM_VLAN_VID = 469,
    OF_OXM_VLAN_VID_MASKED = 470,
    OF_PACKET_QUEUE = 471,
    OF_PORT_DESC = 472,
    OF_PORT_STATS_ENTRY = 473,
    OF_QUEUE_PROP = 474,
    OF_QUEUE_PROP_EXPERIMENTER = 475,
    OF_QUEUE_PROP_HEADER = 476,
    OF_QUEUE_PROP_MAX_RATE = 477,
    OF_QUEUE_PROP_MIN_RATE = 478,
    OF_QUEUE_STATS_ENTRY = 479,
    OF_TABLE_FEATURE_PROP = 480,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 481,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 482,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 483,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 484,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 485,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 486,
    OF_TABLE_FEATURE_PROP_HEADER = 487,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 488,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 489,
    OF_TABLE_FEATURE_PROP_MATCH = 490,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 491,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 492,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 493,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 494,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 495,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 496,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 497,
    OF_TABLE_FEATURES = 498,
    OF_TABLE_STATS_ENTRY = 499,
    OF_UINT32 = 500,
    OF_UINT64 = 501,
    OF_UINT8 = 502,
    ...
    /* List objects */
    OF_LIST_ACTION = 503,
    OF_LIST_ACTION_ID = 504,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 505,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 506,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 507,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 508,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 509,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 510,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 511,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 512,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 513,
    OF_LIST_BSN_INTERFACE = 514,
    OF_LIST_BSN_LACP_STATS_ENTRY = 515,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 516,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 517,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 518,
    OF_LIST_BSN_TLV = 519,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 520,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 521,
    OF_LIST_BUCKET = 522,
    OF_LIST_BUCKET_COUNTER = 523,
    OF_LIST_FLOW_STATS_ENTRY = 524,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 525,
    OF_LIST_GROUP_STATS_ENTRY = 526,
    OF_LIST_HELLO_ELEM = 527,
    OF_LIST_INSTRUCTION = 528,
    OF_LIST_INSTRUCTION_ID = 529,
    OF_LIST_METER_BAND = 530,
    OF_LIST_METER_BAND_STATS = 531,
    OF_LIST_METER_STATS = 532,
    OF_LIST_OXM = 533,
    OF_LIST_PACKET_QUEUE = 534,
    OF_LIST_PORT_DESC = 535,
    OF_LIST_PORT_STATS_ENTRY = 536,
    OF_LIST_QUEUE_PROP = 537,
    OF_LIST_QUEUE_STATS_ENTRY = 538,
    OF_LIST_TABLE_FEATURE_PROP = 539,
    OF_LIST_TABLE_FEATURES = 540,
    OF_LIST_TABLE_STATS_ENTRY = 541,
    OF_LIST_UINT32 = 542,
    OF_LIST_UINT64 = 543,
    OF_LIST_UINT8 = 544,
