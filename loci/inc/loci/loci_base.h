...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 282,
    OF_INSTRUCTION_CLEAR_ACTIONS = 283,
    OF_INSTRUCTION_EXPERIMENTER = 284,
    OF_INSTRUCTION_GOTO_TABLE = 285,
    OF_INSTRUCTION_HEADER = 286,
    OF_INSTRUCTION_ID = 287,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 288,
    OF_INSTRUCTION_ID_BSN = 289,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 290,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 291,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 292,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 293,
    OF_INSTRUCTION_ID_EXPERIMENTER = 294,
    OF_INSTRUCTION_ID_GOTO_TABLE = 295,
    OF_INSTRUCTION_ID_HEADER = 296,
    OF_INSTRUCTION_ID_METER = 297,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 298,
    OF_INSTRUCTION_ID_WRITE_METADATA = 299,
    OF_INSTRUCTION_METER = 300,
    OF_INSTRUCTION_WRITE_ACTIONS = 301,
    OF_INSTRUCTION_WRITE_METADATA = 302,
    OF_MATCH_V1 = 303,
    OF_MATCH_V2 = 304,
    OF_MATCH_V3 = 305,
    OF_METER_BAND = 306,
    OF_METER_BAND_DROP = 307,
    OF_METER_BAND_DSCP_REMARK = 308,
    OF_METER_BAND_EXPERIMENTER = 309,
    OF_METER_BAND_HEADER = 310,
    OF_METER_BAND_STATS = 311,
    OF_METER_CONFIG = 312,
    OF_METER_FEATURES = 313,
    OF_METER_STATS = 314,
    OF_OXM = 315,
    OF_OXM_ARP_OP = 316,
    OF_OXM_ARP_OP_MASKED = 317,
    OF_OXM_ARP_SHA = 318,
    OF_OXM_ARP_SHA_MASKED = 319,
    OF_OXM_ARP_SPA = 320,
    OF_OXM_ARP_SPA_MASKED = 321,
    OF_OXM_ARP_THA = 322,
    OF_OXM_ARP_THA_MASKED = 323,
    OF_OXM_ARP_TPA = 324,
    OF_OXM_ARP_TPA_MASKED = 325,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 326,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 327,
    OF_OXM_BSN_IN_PORTS_128 = 328,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 329,
    OF_OXM_BSN_L3_DST_CLASS_ID = 330,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 331,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 332,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 333,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 334,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 335,
    OF_OXM_BSN_LAG_ID = 336,
    OF_OXM_BSN_LAG_ID_MASKED = 337,
    OF_OXM_BSN_VRF = 338,
    OF_OXM_BSN_VRF_MASKED = 339,
    OF_OXM_ETH_DST = 340,
    OF_OXM_ETH_DST_MASKED = 341,
    OF_OXM_ETH_SRC = 342,
    OF_OXM_ETH_SRC_MASKED = 343,
    OF_OXM_ETH_TYPE = 344,
    OF_OXM_ETH_TYPE_MASKED = 345,
    OF_OXM_HEADER = 346,
    OF_OXM_ICMPV4_CODE = 347,
    OF_OXM_ICMPV4_CODE_MASKED = 348,
    OF_OXM_ICMPV4_TYPE = 349,
    OF_OXM_ICMPV4_TYPE_MASKED = 350,
    OF_OXM_ICMPV6_CODE = 351,
    OF_OXM_ICMPV6_CODE_MASKED = 352,
    OF_OXM_ICMPV6_TYPE = 353,
    OF_OXM_ICMPV6_TYPE_MASKED = 354,
    OF_OXM_IN_PHY_PORT = 355,
    OF_OXM_IN_PHY_PORT_MASKED = 356,
    OF_OXM_IN_PORT = 357,
    OF_OXM_IN_PORT_MASKED = 358,
    OF_OXM_IP_DSCP = 359,
    OF_OXM_IP_DSCP_MASKED = 360,
    OF_OXM_IP_ECN = 361,
    OF_OXM_IP_ECN_MASKED = 362,
    OF_OXM_IP_PROTO = 363,
    OF_OXM_IP_PROTO_MASKED = 364,
    OF_OXM_IPV4_DST = 365,
    OF_OXM_IPV4_DST_MASKED = 366,
    OF_OXM_IPV4_SRC = 367,
    OF_OXM_IPV4_SRC_MASKED = 368,
    OF_OXM_IPV6_DST = 369,
    OF_OXM_IPV6_DST_MASKED = 370,
    OF_OXM_IPV6_FLABEL = 371,
    OF_OXM_IPV6_FLABEL_MASKED = 372,
    OF_OXM_IPV6_ND_SLL = 373,
    OF_OXM_IPV6_ND_SLL_MASKED = 374,
    OF_OXM_IPV6_ND_TARGET = 375,
    OF_OXM_IPV6_ND_TARGET_MASKED = 376,
    OF_OXM_IPV6_ND_TLL = 377,
    OF_OXM_IPV6_ND_TLL_MASKED = 378,
    OF_OXM_IPV6_SRC = 379,
    OF_OXM_IPV6_SRC_MASKED = 380,
    OF_OXM_METADATA = 381,
    OF_OXM_METADATA_MASKED = 382,
    OF_OXM_MPLS_LABEL = 383,
    OF_OXM_MPLS_LABEL_MASKED = 384,
    OF_OXM_MPLS_TC = 385,
    OF_OXM_MPLS_TC_MASKED = 386,
    OF_OXM_SCTP_DST = 387,
    OF_OXM_SCTP_DST_MASKED = 388,
    OF_OXM_SCTP_SRC = 389,
    OF_OXM_SCTP_SRC_MASKED = 390,
    OF_OXM_TCP_DST = 391,
    OF_OXM_TCP_DST_MASKED = 392,
    OF_OXM_TCP_SRC = 393,
    OF_OXM_TCP_SRC_MASKED = 394,
    OF_OXM_UDP_DST = 395,
    OF_OXM_UDP_DST_MASKED = 396,
    OF_OXM_UDP_SRC = 397,
    OF_OXM_UDP_SRC_MASKED = 398,
    OF_OXM_VLAN_PCP = 399,
    OF_OXM_VLAN_PCP_MASKED = 400,
    OF_OXM_VLAN_VID = 401,
    OF_OXM_VLAN_VID_MASKED = 402,
    OF_PACKET_QUEUE = 403,
    OF_PORT_DESC = 404,
    OF_PORT_STATS_ENTRY = 405,
    OF_QUEUE_PROP = 406,
    OF_QUEUE_PROP_EXPERIMENTER = 407,
    OF_QUEUE_PROP_HEADER = 408,
    OF_QUEUE_PROP_MAX_RATE = 409,
    OF_QUEUE_PROP_MIN_RATE = 410,
    OF_QUEUE_STATS_ENTRY = 411,
    OF_TABLE_FEATURE_PROP = 412,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 413,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 414,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 415,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 416,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 417,
    OF_TABLE_FEATURE_PROP_HEADER = 418,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 419,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 420,
    OF_TABLE_FEATURE_PROP_MATCH = 421,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 422,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 423,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 424,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 425,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 426,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 427,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 428,
    OF_TABLE_FEATURES = 429,
    OF_TABLE_STATS_ENTRY = 430,
    OF_UINT32 = 431,
    OF_UINT64 = 432,
    OF_UINT8 = 433,
    ...
    /* List objects */
    OF_LIST_ACTION = 434,
    OF_LIST_ACTION_ID = 435,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 436,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 437,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 438,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 439,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 440,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 441,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 442,
    OF_LIST_BSN_INTERFACE = 443,
    OF_LIST_BSN_LACP_STATS_ENTRY = 444,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 445,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 446,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 447,
    OF_LIST_BSN_TLV = 448,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 449,
    OF_LIST_BUCKET = 450,
    OF_LIST_BUCKET_COUNTER = 451,
    OF_LIST_FLOW_STATS_ENTRY = 452,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 453,
    OF_LIST_GROUP_STATS_ENTRY = 454,
    OF_LIST_HELLO_ELEM = 455,
    OF_LIST_INSTRUCTION = 456,
    OF_LIST_METER_BAND = 457,
    OF_LIST_METER_BAND_STATS = 458,
    OF_LIST_METER_STATS = 459,
    OF_LIST_OXM = 460,
    OF_LIST_PACKET_QUEUE = 461,
    OF_LIST_PORT_DESC = 462,
    OF_LIST_PORT_STATS_ENTRY = 463,
    OF_LIST_QUEUE_PROP = 464,
    OF_LIST_QUEUE_STATS_ENTRY = 465,
    OF_LIST_TABLE_FEATURE_PROP = 466,
    OF_LIST_TABLE_FEATURES = 467,
    OF_LIST_TABLE_STATS_ENTRY = 468,
    OF_LIST_UINT32 = 469,
    OF_LIST_UINT64 = 470,
    OF_LIST_UINT8 = 471,
