...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_ADMIN_STATE = 310,
    OF_BSN_TLV_ANALYTICS = 311,
    OF_BSN_TLV_ANCHOR = 312,
    OF_BSN_TLV_APPLY_BYTES = 313,
    OF_BSN_TLV_APPLY_PACKETS = 314,
    OF_BSN_TLV_ARP_SPA = 315,
    OF_BSN_TLV_ARP_TPA = 316,
    OF_BSN_TLV_AUTO_NEGOTIATION = 317,
    OF_BSN_TLV_BFD_ENDPOINT = 318,
    OF_BSN_TLV_BFD_STATE = 319,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 320,
    OF_BSN_TLV_BROADCAST_RATE = 321,
    OF_BSN_TLV_BUCKET = 322,
    OF_BSN_TLV_CIRCUIT_ID = 323,
    OF_BSN_TLV_CONVERGENCE_STATUS = 324,
    OF_BSN_TLV_CPU_LAG = 325,
    OF_BSN_TLV_CRC_ENABLED = 326,
    OF_BSN_TLV_DATA = 327,
    OF_BSN_TLV_DATA_MASK = 328,
    OF_BSN_TLV_DECAP = 329,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 330,
    OF_BSN_TLV_DISABLE_XMIT = 331,
    OF_BSN_TLV_DNS_ANALYTICS = 332,
    OF_BSN_TLV_DROP = 333,
    OF_BSN_TLV_DROP_CONTROL = 334,
    OF_BSN_TLV_DSCP = 335,
    OF_BSN_TLV_ECN = 336,
    OF_BSN_TLV_EGRESS_ONLY = 337,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 338,
    OF_BSN_TLV_EGRESS_SAMPLING_RATE = 339,
    OF_BSN_TLV_ENCAP = 340,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 341,
    OF_BSN_TLV_ETH_DST = 342,
    OF_BSN_TLV_ETH_SRC = 343,
    OF_BSN_TLV_ETH_TYPE = 344,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 345,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 346,
    OF_BSN_TLV_EXTERNAL_IP = 347,
    OF_BSN_TLV_EXTERNAL_MAC = 348,
    OF_BSN_TLV_EXTERNAL_NETMASK = 349,
    OF_BSN_TLV_FABRIC_PORT_ROLE = 350,
    OF_BSN_TLV_FAIL_COUNT = 351,
    OF_BSN_TLV_FLOOD = 352,
    OF_BSN_TLV_FLOW_CLASSIFIER = 353,
    OF_BSN_TLV_FLOW_CLASSIFY = 354,
    OF_BSN_TLV_FLOW_IDENTIFIER = 355,
    OF_BSN_TLV_FORCE_LINK_UP = 356,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 357,
    OF_BSN_TLV_FREE_COUNT = 358,
    OF_BSN_TLV_GENERATION_ID = 359,
    OF_BSN_TLV_HASH_ALGORITHM = 360,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 361,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 362,
    OF_BSN_TLV_HASH_PACKET_FIELD = 363,
    OF_BSN_TLV_HASH_PACKET_TYPE = 364,
    OF_BSN_TLV_HASH_SEED = 365,
    OF_BSN_TLV_HASH_TYPE = 366,
    OF_BSN_TLV_HEADER_SIZE = 367,
    OF_BSN_TLV_ICMP_CODE = 368,
    OF_BSN_TLV_ICMP_ID = 369,
    OF_BSN_TLV_ICMP_TYPE = 370,
    OF_BSN_TLV_ICMPV6_CHKSUM = 371,
    OF_BSN_TLV_ICMPV6_CODE = 372,
    OF_BSN_TLV_ICMPV6_TYPE = 373,
    OF_BSN_TLV_IDENTIFIER = 374,
    OF_BSN_TLV_IDLE_NOTIFICATION = 375,
    OF_BSN_TLV_IDLE_TIME = 376,
    OF_BSN_TLV_IDLE_TIMEOUT = 377,
    OF_BSN_TLV_IFP_CLASS_ID = 378,
    OF_BSN_TLV_IGMP_SNOOPING = 379,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 380,
    OF_BSN_TLV_INNER_VLAN_VID = 381,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 382,
    OF_BSN_TLV_INTERNAL_MAC = 383,
    OF_BSN_TLV_INTERVAL = 384,
    OF_BSN_TLV_IP_FRAGMENTATION = 385,
    OF_BSN_TLV_IP_PROTO = 386,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 387,
    OF_BSN_TLV_IPV4 = 388,
    OF_BSN_TLV_IPV4_DST = 389,
    OF_BSN_TLV_IPV4_NETMASK = 390,
    OF_BSN_TLV_IPV4_SRC = 391,
    OF_BSN_TLV_IPV6 = 392,
    OF_BSN_TLV_IPV6_DST = 393,
    OF_BSN_TLV_IPV6_PREFIX = 394,
    OF_BSN_TLV_IPV6_SRC = 395,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 396,
    OF_BSN_TLV_L2_CACHE_HIT = 397,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 398,
    OF_BSN_TLV_L3 = 399,
    OF_BSN_TLV_L3_DST_CLASS_ID = 400,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 401,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 402,
    OF_BSN_TLV_LAG_OPTIONS = 403,
    OF_BSN_TLV_LCORE = 404,
    OF_BSN_TLV_LINK_UP = 405,
    OF_BSN_TLV_LOAD = 406,
    OF_BSN_TLV_LOOKUP_COUNT = 407,
    OF_BSN_TLV_LOOPBACK_MODE = 408,
    OF_BSN_TLV_LOOPBACK_PORT = 409,
    OF_BSN_TLV_LOSSLESS = 410,
    OF_BSN_TLV_LR_ALL_ENABLED = 411,
    OF_BSN_TLV_MAC = 412,
    OF_BSN_TLV_MAC_MASK = 413,
    OF_BSN_TLV_MATCHED_COUNT = 414,
    OF_BSN_TLV_MAX_COUNT = 415,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 416,
    OF_BSN_TLV_METADATA = 417,
    OF_BSN_TLV_MGMT = 418,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 419,
    OF_BSN_TLV_MISS_PACKETS = 420,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 421,
    OF_BSN_TLV_MPLS_LABEL = 422,
    OF_BSN_TLV_MPLS_SEQUENCED = 423,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 424,
    OF_BSN_TLV_MULTICAST_PACKET = 425,
    OF_BSN_TLV_MULTIPLIER = 426,
    OF_BSN_TLV_NAME = 427,
    OF_BSN_TLV_NDP_OFFLOAD = 428,
    OF_BSN_TLV_NDP_STATIC = 429,
    OF_BSN_TLV_NEGATE = 430,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 431,
    OF_BSN_TLV_NEXT_HOP_MAC = 432,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 433,
    OF_BSN_TLV_NO_ARP_RESPONSE = 434,
    OF_BSN_TLV_NO_NS_RESPONSE = 435,
    OF_BSN_TLV_OFFSET = 436,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 437,
    OF_BSN_TLV_OUTER_SRC_MAC = 438,
    OF_BSN_TLV_PACKET_FIELD = 439,
    OF_BSN_TLV_PARENT_PORT = 440,
    OF_BSN_TLV_PARTNER_KEY = 441,
    OF_BSN_TLV_PARTNER_PORT_NUM = 442,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 443,
    OF_BSN_TLV_PARTNER_STATE = 444,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 445,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 446,
    OF_BSN_TLV_PASSIVE = 447,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 448,
    OF_BSN_TLV_PIM_DR = 449,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 450,
    OF_BSN_TLV_PORT = 451,
    OF_BSN_TLV_PORT_MODE = 452,
    OF_BSN_TLV_PORT_SPEED_GBPS = 453,
    OF_BSN_TLV_PORT_USAGE = 454,
    OF_BSN_TLV_PORT_VXLAN_MODE = 455,
    OF_BSN_TLV_PRESERVE_VLAN = 456,
    OF_BSN_TLV_PRIORITY = 457,
    OF_BSN_TLV_PUSH_TWO_PER_POLICY = 458,
    OF_BSN_TLV_PUSH_TWO_TAGS_CAPABILITY = 459,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 460,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 461,
    OF_BSN_TLV_QOS_PRIORITY = 462,
    OF_BSN_TLV_QUEUE_ID = 463,
    OF_BSN_TLV_QUEUE_WEIGHT = 464,
    OF_BSN_TLV_RATE_LIMIT = 465,
    OF_BSN_TLV_RATE_UNIT = 466,
    OF_BSN_TLV_RECORD_PACKETS = 467,
    OF_BSN_TLV_REDUNDANT_MGMT = 468,
    OF_BSN_TLV_REFERENCE = 469,
    OF_BSN_TLV_REPLY_PACKETS = 470,
    OF_BSN_TLV_REQUEST_PACKETS = 471,
    OF_BSN_TLV_REST_SERVER = 472,
    OF_BSN_TLV_ROUTING_PARAM = 473,
    OF_BSN_TLV_RX_BYTES = 474,
    OF_BSN_TLV_RX_PACKETS = 475,
    OF_BSN_TLV_SAMPLING_RATE = 476,
    OF_BSN_TLV_SCTP_DST = 477,
    OF_BSN_TLV_SCTP_SRC = 478,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 479,
    OF_BSN_TLV_SOCKET = 480,
    OF_BSN_TLV_SRC_MAC_CML = 481,
    OF_BSN_TLV_STATUS = 482,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 483,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 484,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 485,
    OF_BSN_TLV_SUB_AGENT_ID = 486,
    OF_BSN_TLV_TCP_DST = 487,
    OF_BSN_TLV_TCP_FLAGS = 488,
    OF_BSN_TLV_TCP_SRC = 489,
    OF_BSN_TLV_THREAD = 490,
    OF_BSN_TLV_TIMESTAMP = 491,
    OF_BSN_TLV_TTL = 492,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 493,
    OF_BSN_TLV_TX_BYTES = 494,
    OF_BSN_TLV_TX_PACKETS = 495,
    OF_BSN_TLV_UDF_ANCHOR = 496,
    OF_BSN_TLV_UDF_CAPABILITY = 497,
    OF_BSN_TLV_UDF_DATA = 498,
    OF_BSN_TLV_UDF_ID = 499,
    OF_BSN_TLV_UDF_LENGTH = 500,
    OF_BSN_TLV_UDF_OFFSET = 501,
    OF_BSN_TLV_UDP_DST = 502,
    OF_BSN_TLV_UDP_SRC = 503,
    OF_BSN_TLV_UINT32 = 504,
    OF_BSN_TLV_UINT64_LIST = 505,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 506,
    OF_BSN_TLV_UNICAST_RATE = 507,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 508,
    OF_BSN_TLV_UNTAGGED = 509,
    OF_BSN_TLV_UPGRADE = 510,
    OF_BSN_TLV_URI_SCHEME = 511,
    OF_BSN_TLV_USE_PACKET_STATE = 512,
    OF_BSN_TLV_USER_CONFIGURED = 513,
    OF_BSN_TLV_VFI = 514,
    OF_BSN_TLV_VFP_CLASS_ID = 515,
    OF_BSN_TLV_VIRTUAL = 516,
    OF_BSN_TLV_VLAN_MAC_LIST = 517,
    OF_BSN_TLV_VLAN_PCP = 518,
    OF_BSN_TLV_VLAN_VID = 519,
    OF_BSN_TLV_VLAN_VID_MASK = 520,
    OF_BSN_TLV_VNI = 521,
    OF_BSN_TLV_VPN_KEY = 522,
    OF_BSN_TLV_VRF = 523,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 524,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 525,
    OF_BSN_VLAN_MAC = 526,
    OF_BSN_VPORT = 527,
    OF_BSN_VPORT_L2GRE = 528,
    OF_BSN_VPORT_Q_IN_Q = 529,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 530,
    OF_BUCKET = 531,
    OF_BUCKET_COUNTER = 532,
    OF_BUNDLE_PROP = 533,
    OF_BUNDLE_PROP_EXPERIMENTER = 534,
    OF_FLOW_STATS_ENTRY = 535,
    OF_GROUP_DESC_STATS_ENTRY = 536,
    OF_GROUP_STATS_ENTRY = 537,
    OF_HELLO_ELEM = 538,
    OF_HELLO_ELEM_VERSIONBITMAP = 539,
    OF_INSTRUCTION = 540,
    OF_INSTRUCTION_APPLY_ACTIONS = 541,
    OF_INSTRUCTION_BSN = 542,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 543,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 544,
    OF_INSTRUCTION_BSN_DENY = 545,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 546,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 547,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 548,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 549,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 550,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 551,
    OF_INSTRUCTION_BSN_HASH_SELECT = 552,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 553,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 554,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 555,
    OF_INSTRUCTION_BSN_PERMIT = 556,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 557,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 558,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 559,
    OF_INSTRUCTION_CLEAR_ACTIONS = 560,
    OF_INSTRUCTION_EXPERIMENTER = 561,
    OF_INSTRUCTION_GOTO_TABLE = 562,
    OF_INSTRUCTION_ID = 563,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 564,
    OF_INSTRUCTION_ID_BSN = 565,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 566,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 567,
    OF_INSTRUCTION_ID_BSN_DENY = 568,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 569,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 570,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 571,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 572,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 573,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 574,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 575,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 576,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 577,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 578,
    OF_INSTRUCTION_ID_BSN_PERMIT = 579,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 580,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 581,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 582,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 583,
    OF_INSTRUCTION_ID_EXPERIMENTER = 584,
    OF_INSTRUCTION_ID_GOTO_TABLE = 585,
    OF_INSTRUCTION_ID_METER = 586,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 587,
    OF_INSTRUCTION_ID_WRITE_METADATA = 588,
    OF_INSTRUCTION_METER = 589,
    OF_INSTRUCTION_WRITE_ACTIONS = 590,
    OF_INSTRUCTION_WRITE_METADATA = 591,
    OF_MATCH_V1 = 592,
    OF_MATCH_V2 = 593,
    OF_MATCH_V3 = 594,
    OF_METER_BAND = 595,
    OF_METER_BAND_DROP = 596,
    OF_METER_BAND_DSCP_REMARK = 597,
    OF_METER_BAND_EXPERIMENTER = 598,
    OF_METER_BAND_STATS = 599,
    OF_METER_CONFIG = 600,
    OF_METER_FEATURES = 601,
    OF_METER_STATS = 602,
    OF_OXM = 603,
    OF_OXM_ARP_OP = 604,
    OF_OXM_ARP_OP_MASKED = 605,
    OF_OXM_ARP_SHA = 606,
    OF_OXM_ARP_SHA_MASKED = 607,
    OF_OXM_ARP_SPA = 608,
    OF_OXM_ARP_SPA_MASKED = 609,
    OF_OXM_ARP_THA = 610,
    OF_OXM_ARP_THA_MASKED = 611,
    OF_OXM_ARP_TPA = 612,
    OF_OXM_ARP_TPA_MASKED = 613,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 614,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 615,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 616,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 617,
    OF_OXM_BSN_IFP_CLASS_ID = 618,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 619,
    OF_OXM_BSN_IN_PORTS_128 = 620,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 621,
    OF_OXM_BSN_IN_PORTS_512 = 622,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 623,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 624,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 625,
    OF_OXM_BSN_INNER_ETH_DST = 626,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 627,
    OF_OXM_BSN_INNER_ETH_SRC = 628,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 629,
    OF_OXM_BSN_INNER_VLAN_VID = 630,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 631,
    OF_OXM_BSN_IP_FRAGMENTATION = 632,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 633,
    OF_OXM_BSN_L2_CACHE_HIT = 634,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 635,
    OF_OXM_BSN_L3_DST_CLASS_ID = 636,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 637,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 638,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 639,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 640,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 641,
    OF_OXM_BSN_LAG_ID = 642,
    OF_OXM_BSN_LAG_ID_MASKED = 643,
    OF_OXM_BSN_TCP_FLAGS = 644,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 645,
    OF_OXM_BSN_UDF0 = 646,
    OF_OXM_BSN_UDF0_MASKED = 647,
    OF_OXM_BSN_UDF1 = 648,
    OF_OXM_BSN_UDF1_MASKED = 649,
    OF_OXM_BSN_UDF2 = 650,
    OF_OXM_BSN_UDF2_MASKED = 651,
    OF_OXM_BSN_UDF3 = 652,
    OF_OXM_BSN_UDF3_MASKED = 653,
    OF_OXM_BSN_UDF4 = 654,
    OF_OXM_BSN_UDF4_MASKED = 655,
    OF_OXM_BSN_UDF5 = 656,
    OF_OXM_BSN_UDF5_MASKED = 657,
    OF_OXM_BSN_UDF6 = 658,
    OF_OXM_BSN_UDF6_MASKED = 659,
    OF_OXM_BSN_UDF7 = 660,
    OF_OXM_BSN_UDF7_MASKED = 661,
    OF_OXM_BSN_VFI = 662,
    OF_OXM_BSN_VFI_MASKED = 663,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 664,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 665,
    OF_OXM_BSN_VRF = 666,
    OF_OXM_BSN_VRF_MASKED = 667,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 668,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 669,
    OF_OXM_CONN_TRACKING_IPV6_DST = 670,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 671,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 672,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 673,
    OF_OXM_CONN_TRACKING_LABEL = 674,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 675,
    OF_OXM_CONN_TRACKING_MARK = 676,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 677,
    OF_OXM_CONN_TRACKING_NW_DST = 678,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 679,
    OF_OXM_CONN_TRACKING_NW_PROTO = 680,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 681,
    OF_OXM_CONN_TRACKING_NW_SRC = 682,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 683,
    OF_OXM_CONN_TRACKING_STATE = 684,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 685,
    OF_OXM_CONN_TRACKING_TP_DST = 686,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 687,
    OF_OXM_CONN_TRACKING_TP_SRC = 688,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 689,
    OF_OXM_CONN_TRACKING_ZONE = 690,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 691,
    OF_OXM_ETH_DST = 692,
    OF_OXM_ETH_DST_MASKED = 693,
    OF_OXM_ETH_SRC = 694,
    OF_OXM_ETH_SRC_MASKED = 695,
    OF_OXM_ETH_TYPE = 696,
    OF_OXM_ETH_TYPE_MASKED = 697,
    OF_OXM_ICMPV4_CODE = 698,
    OF_OXM_ICMPV4_CODE_MASKED = 699,
    OF_OXM_ICMPV4_TYPE = 700,
    OF_OXM_ICMPV4_TYPE_MASKED = 701,
    OF_OXM_ICMPV6_CODE = 702,
    OF_OXM_ICMPV6_CODE_MASKED = 703,
    OF_OXM_ICMPV6_TYPE = 704,
    OF_OXM_ICMPV6_TYPE_MASKED = 705,
    OF_OXM_IN_PHY_PORT = 706,
    OF_OXM_IN_PHY_PORT_MASKED = 707,
    OF_OXM_IN_PORT = 708,
    OF_OXM_IN_PORT_MASKED = 709,
    OF_OXM_IP_DSCP = 710,
    OF_OXM_IP_DSCP_MASKED = 711,
    OF_OXM_IP_ECN = 712,
    OF_OXM_IP_ECN_MASKED = 713,
    OF_OXM_IP_PROTO = 714,
    OF_OXM_IP_PROTO_MASKED = 715,
    OF_OXM_IPV4_DST = 716,
    OF_OXM_IPV4_DST_MASKED = 717,
    OF_OXM_IPV4_SRC = 718,
    OF_OXM_IPV4_SRC_MASKED = 719,
    OF_OXM_IPV6_DST = 720,
    OF_OXM_IPV6_DST_MASKED = 721,
    OF_OXM_IPV6_EXTHDR = 722,
    OF_OXM_IPV6_EXTHDR_MASKED = 723,
    OF_OXM_IPV6_FLABEL = 724,
    OF_OXM_IPV6_FLABEL_MASKED = 725,
    OF_OXM_IPV6_ND_SLL = 726,
    OF_OXM_IPV6_ND_SLL_MASKED = 727,
    OF_OXM_IPV6_ND_TARGET = 728,
    OF_OXM_IPV6_ND_TARGET_MASKED = 729,
    OF_OXM_IPV6_ND_TLL = 730,
    OF_OXM_IPV6_ND_TLL_MASKED = 731,
    OF_OXM_IPV6_SRC = 732,
    OF_OXM_IPV6_SRC_MASKED = 733,
    OF_OXM_METADATA = 734,
    OF_OXM_METADATA_MASKED = 735,
    OF_OXM_MPLS_BOS = 736,
    OF_OXM_MPLS_BOS_MASKED = 737,
    OF_OXM_MPLS_LABEL = 738,
    OF_OXM_MPLS_LABEL_MASKED = 739,
    OF_OXM_MPLS_TC = 740,
    OF_OXM_MPLS_TC_MASKED = 741,
    OF_OXM_OVS_TCP_FLAGS = 742,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 743,
    OF_OXM_PBB_UCA = 744,
    OF_OXM_PBB_UCA_MASKED = 745,
    OF_OXM_SCTP_DST = 746,
    OF_OXM_SCTP_DST_MASKED = 747,
    OF_OXM_SCTP_SRC = 748,
    OF_OXM_SCTP_SRC_MASKED = 749,
    OF_OXM_TCP_DST = 750,
    OF_OXM_TCP_DST_MASKED = 751,
    OF_OXM_TCP_SRC = 752,
    OF_OXM_TCP_SRC_MASKED = 753,
    OF_OXM_TUNNEL_ID = 754,
    OF_OXM_TUNNEL_ID_MASKED = 755,
    OF_OXM_TUNNEL_IPV4_DST = 756,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 757,
    OF_OXM_TUNNEL_IPV4_SRC = 758,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 759,
    OF_OXM_UDP_DST = 760,
    OF_OXM_UDP_DST_MASKED = 761,
    OF_OXM_UDP_SRC = 762,
    OF_OXM_UDP_SRC_MASKED = 763,
    OF_OXM_VLAN_PCP = 764,
    OF_OXM_VLAN_PCP_MASKED = 765,
    OF_OXM_VLAN_VID = 766,
    OF_OXM_VLAN_VID_MASKED = 767,
    OF_PACKET_QUEUE = 768,
    OF_PORT_DESC = 769,
    OF_PORT_DESC_PROP = 770,
    OF_PORT_DESC_PROP_BSN = 771,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 772,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 773,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 774,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 775,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 776,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 777,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 778,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 779,
    OF_PORT_DESC_PROP_BSN_UPLINK = 780,
    OF_PORT_DESC_PROP_ETHERNET = 781,
    OF_PORT_DESC_PROP_EXPERIMENTER = 782,
    OF_PORT_DESC_PROP_OPTICAL = 783,
    OF_PORT_MOD_PROP = 784,
    OF_PORT_MOD_PROP_ETHERNET = 785,
    OF_PORT_MOD_PROP_EXPERIMENTER = 786,
    OF_PORT_MOD_PROP_OPTICAL = 787,
    OF_PORT_STATS_ENTRY = 788,
    OF_PORT_STATS_PROP = 789,
    OF_PORT_STATS_PROP_ETHERNET = 790,
    OF_PORT_STATS_PROP_EXPERIMENTER = 791,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 792,
    OF_PORT_STATS_PROP_OPTICAL = 793,
    OF_QUEUE_DESC = 794,
    OF_QUEUE_DESC_PROP = 795,
    OF_QUEUE_DESC_PROP_BSN = 796,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 797,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 798,
    OF_QUEUE_DESC_PROP_MAX_RATE = 799,
    OF_QUEUE_DESC_PROP_MIN_RATE = 800,
    OF_QUEUE_PROP = 801,
    OF_QUEUE_PROP_EXPERIMENTER = 802,
    OF_QUEUE_PROP_MAX_RATE = 803,
    OF_QUEUE_PROP_MIN_RATE = 804,
    OF_QUEUE_STATS_ENTRY = 805,
    OF_QUEUE_STATS_PROP = 806,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 807,
    OF_ROLE_PROP = 808,
    OF_ROLE_PROP_EXPERIMENTER = 809,
    OF_TABLE_DESC = 810,
    OF_TABLE_FEATURE_PROP = 811,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 812,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 813,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 814,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 815,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 816,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 817,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 818,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 819,
    OF_TABLE_FEATURE_PROP_MATCH = 820,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 821,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 822,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 823,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 824,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 825,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 826,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 827,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 828,
    OF_TABLE_FEATURES = 829,
    OF_TABLE_MOD_PROP = 830,
    OF_TABLE_MOD_PROP_EVICTION = 831,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 832,
    OF_TABLE_MOD_PROP_VACANCY = 833,
    OF_TABLE_STATS_ENTRY = 834,
    OF_UINT32 = 835,
    OF_UINT64 = 836,
    OF_UINT8 = 837,
    ...
    /* List objects */
    OF_LIST_ACTION = 838,
    OF_LIST_ACTION_ID = 839,
    OF_LIST_ASYNC_CONFIG_PROP = 840,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 841,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 842,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 843,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 844,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 845,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 846,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 847,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 848,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 849,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 850,
    OF_LIST_BSN_INTERFACE = 851,
    OF_LIST_BSN_LACP_STATS_ENTRY = 852,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 853,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 854,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 855,
    OF_LIST_BSN_TLV = 856,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 857,
    OF_LIST_BSN_VLAN_MAC = 858,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 859,
    OF_LIST_BUCKET = 860,
    OF_LIST_BUCKET_COUNTER = 861,
    OF_LIST_BUNDLE_PROP = 862,
    OF_LIST_FLOW_STATS_ENTRY = 863,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 864,
    OF_LIST_GROUP_STATS_ENTRY = 865,
    OF_LIST_HELLO_ELEM = 866,
    OF_LIST_INSTRUCTION = 867,
    OF_LIST_INSTRUCTION_ID = 868,
    OF_LIST_METER_BAND = 869,
    OF_LIST_METER_BAND_STATS = 870,
    OF_LIST_METER_CONFIG = 871,
    OF_LIST_METER_STATS = 872,
    OF_LIST_OXM = 873,
    OF_LIST_PACKET_QUEUE = 874,
    OF_LIST_PORT_DESC = 875,
    OF_LIST_PORT_DESC_PROP = 876,
    OF_LIST_PORT_MOD_PROP = 877,
    OF_LIST_PORT_STATS_ENTRY = 878,
    OF_LIST_PORT_STATS_PROP = 879,
    OF_LIST_QUEUE_DESC = 880,
    OF_LIST_QUEUE_DESC_PROP = 881,
    OF_LIST_QUEUE_PROP = 882,
    OF_LIST_QUEUE_STATS_ENTRY = 883,
    OF_LIST_QUEUE_STATS_PROP = 884,
    OF_LIST_ROLE_PROP = 885,
    OF_LIST_TABLE_DESC = 886,
    OF_LIST_TABLE_FEATURE_PROP = 887,
    OF_LIST_TABLE_FEATURES = 888,
    OF_LIST_TABLE_MOD_PROP = 889,
    OF_LIST_TABLE_STATS_ENTRY = 890,
    OF_LIST_UINT32 = 891,
    OF_LIST_UINT64 = 892,
    OF_LIST_UINT8 = 893,
