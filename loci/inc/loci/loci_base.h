...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV = 236,
    OF_BSN_TLV_HEADER = 237,
    OF_BSN_TLV_IDLE_NOTIFICATION = 238,
    OF_BSN_TLV_IDLE_TIME = 239,
    OF_BSN_TLV_IPV4 = 240,
    OF_BSN_TLV_MAC = 241,
    OF_BSN_TLV_PORT = 242,
    OF_BSN_TLV_RX_PACKETS = 243,
    OF_BSN_TLV_TX_PACKETS = 244,
    OF_BSN_TLV_VLAN_VID = 245,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 246,
    OF_BSN_VPORT = 247,
    OF_BSN_VPORT_HEADER = 248,
    OF_BSN_VPORT_Q_IN_Q = 249,
    OF_BUCKET = 250,
    OF_BUCKET_COUNTER = 251,
    OF_EXPERIMENTER_STATS_HEADER = 252,
    OF_FLOW_STATS_ENTRY = 253,
    OF_GROUP_DESC_STATS_ENTRY = 254,
    OF_GROUP_STATS_ENTRY = 255,
    OF_HEADER = 256,
    OF_HELLO_ELEM = 257,
    OF_HELLO_ELEM_HEADER = 258,
    OF_HELLO_ELEM_VERSIONBITMAP = 259,
    OF_INSTRUCTION = 260,
    OF_INSTRUCTION_APPLY_ACTIONS = 261,
    OF_INSTRUCTION_BSN = 262,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 263,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 264,
    OF_INSTRUCTION_CLEAR_ACTIONS = 265,
    OF_INSTRUCTION_EXPERIMENTER = 266,
    OF_INSTRUCTION_GOTO_TABLE = 267,
    OF_INSTRUCTION_HEADER = 268,
    OF_INSTRUCTION_ID = 269,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 270,
    OF_INSTRUCTION_ID_BSN = 271,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 272,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 273,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 274,
    OF_INSTRUCTION_ID_EXPERIMENTER = 275,
    OF_INSTRUCTION_ID_GOTO_TABLE = 276,
    OF_INSTRUCTION_ID_HEADER = 277,
    OF_INSTRUCTION_ID_METER = 278,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 279,
    OF_INSTRUCTION_ID_WRITE_METADATA = 280,
    OF_INSTRUCTION_METER = 281,
    OF_INSTRUCTION_WRITE_ACTIONS = 282,
    OF_INSTRUCTION_WRITE_METADATA = 283,
    OF_MATCH_V1 = 284,
    OF_MATCH_V2 = 285,
    OF_MATCH_V3 = 286,
    OF_METER_BAND = 287,
    OF_METER_BAND_DROP = 288,
    OF_METER_BAND_DSCP_REMARK = 289,
    OF_METER_BAND_EXPERIMENTER = 290,
    OF_METER_BAND_HEADER = 291,
    OF_METER_BAND_STATS = 292,
    OF_METER_CONFIG = 293,
    OF_METER_FEATURES = 294,
    OF_METER_STATS = 295,
    OF_OXM = 296,
    OF_OXM_ARP_OP = 297,
    OF_OXM_ARP_OP_MASKED = 298,
    OF_OXM_ARP_SHA = 299,
    OF_OXM_ARP_SHA_MASKED = 300,
    OF_OXM_ARP_SPA = 301,
    OF_OXM_ARP_SPA_MASKED = 302,
    OF_OXM_ARP_THA = 303,
    OF_OXM_ARP_THA_MASKED = 304,
    OF_OXM_ARP_TPA = 305,
    OF_OXM_ARP_TPA_MASKED = 306,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 307,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 308,
    OF_OXM_BSN_IN_PORTS_128 = 309,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 310,
    OF_OXM_BSN_L3_DST_CLASS_ID = 311,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 312,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 313,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 314,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 315,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 316,
    OF_OXM_BSN_LAG_ID = 317,
    OF_OXM_BSN_LAG_ID_MASKED = 318,
    OF_OXM_BSN_VRF = 319,
    OF_OXM_BSN_VRF_MASKED = 320,
    OF_OXM_ETH_DST = 321,
    OF_OXM_ETH_DST_MASKED = 322,
    OF_OXM_ETH_SRC = 323,
    OF_OXM_ETH_SRC_MASKED = 324,
    OF_OXM_ETH_TYPE = 325,
    OF_OXM_ETH_TYPE_MASKED = 326,
    OF_OXM_HEADER = 327,
    OF_OXM_ICMPV4_CODE = 328,
    OF_OXM_ICMPV4_CODE_MASKED = 329,
    OF_OXM_ICMPV4_TYPE = 330,
    OF_OXM_ICMPV4_TYPE_MASKED = 331,
    OF_OXM_ICMPV6_CODE = 332,
    OF_OXM_ICMPV6_CODE_MASKED = 333,
    OF_OXM_ICMPV6_TYPE = 334,
    OF_OXM_ICMPV6_TYPE_MASKED = 335,
    OF_OXM_IN_PHY_PORT = 336,
    OF_OXM_IN_PHY_PORT_MASKED = 337,
    OF_OXM_IN_PORT = 338,
    OF_OXM_IN_PORT_MASKED = 339,
    OF_OXM_IP_DSCP = 340,
    OF_OXM_IP_DSCP_MASKED = 341,
    OF_OXM_IP_ECN = 342,
    OF_OXM_IP_ECN_MASKED = 343,
    OF_OXM_IP_PROTO = 344,
    OF_OXM_IP_PROTO_MASKED = 345,
    OF_OXM_IPV4_DST = 346,
    OF_OXM_IPV4_DST_MASKED = 347,
    OF_OXM_IPV4_SRC = 348,
    OF_OXM_IPV4_SRC_MASKED = 349,
    OF_OXM_IPV6_DST = 350,
    OF_OXM_IPV6_DST_MASKED = 351,
    OF_OXM_IPV6_FLABEL = 352,
    OF_OXM_IPV6_FLABEL_MASKED = 353,
    OF_OXM_IPV6_ND_SLL = 354,
    OF_OXM_IPV6_ND_SLL_MASKED = 355,
    OF_OXM_IPV6_ND_TARGET = 356,
    OF_OXM_IPV6_ND_TARGET_MASKED = 357,
    OF_OXM_IPV6_ND_TLL = 358,
    OF_OXM_IPV6_ND_TLL_MASKED = 359,
    OF_OXM_IPV6_SRC = 360,
    OF_OXM_IPV6_SRC_MASKED = 361,
    OF_OXM_METADATA = 362,
    OF_OXM_METADATA_MASKED = 363,
    OF_OXM_MPLS_LABEL = 364,
    OF_OXM_MPLS_LABEL_MASKED = 365,
    OF_OXM_MPLS_TC = 366,
    OF_OXM_MPLS_TC_MASKED = 367,
    OF_OXM_SCTP_DST = 368,
    OF_OXM_SCTP_DST_MASKED = 369,
    OF_OXM_SCTP_SRC = 370,
    OF_OXM_SCTP_SRC_MASKED = 371,
    OF_OXM_TCP_DST = 372,
    OF_OXM_TCP_DST_MASKED = 373,
    OF_OXM_TCP_SRC = 374,
    OF_OXM_TCP_SRC_MASKED = 375,
    OF_OXM_UDP_DST = 376,
    OF_OXM_UDP_DST_MASKED = 377,
    OF_OXM_UDP_SRC = 378,
    OF_OXM_UDP_SRC_MASKED = 379,
    OF_OXM_VLAN_PCP = 380,
    OF_OXM_VLAN_PCP_MASKED = 381,
    OF_OXM_VLAN_VID = 382,
    OF_OXM_VLAN_VID_MASKED = 383,
    OF_PACKET_QUEUE = 384,
    OF_PORT_DESC = 385,
    OF_PORT_STATS_ENTRY = 386,
    OF_QUEUE_PROP = 387,
    OF_QUEUE_PROP_EXPERIMENTER = 388,
    OF_QUEUE_PROP_HEADER = 389,
    OF_QUEUE_PROP_MAX_RATE = 390,
    OF_QUEUE_PROP_MIN_RATE = 391,
    OF_QUEUE_STATS_ENTRY = 392,
    OF_TABLE_FEATURE_PROP = 393,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 394,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 395,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 396,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 397,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 398,
    OF_TABLE_FEATURE_PROP_HEADER = 399,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 400,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 401,
    OF_TABLE_FEATURE_PROP_MATCH = 402,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 403,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 404,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 405,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 406,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 407,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 408,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 409,
    OF_TABLE_FEATURES = 410,
    OF_TABLE_STATS_ENTRY = 411,
    OF_UINT32 = 412,
    OF_UINT64 = 413,
    OF_UINT8 = 414,
    ...
    /* List objects */
    OF_LIST_ACTION = 415,
    OF_LIST_ACTION_ID = 416,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 417,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 418,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 419,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 420,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 421,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 422,
    OF_LIST_BSN_INTERFACE = 423,
    OF_LIST_BSN_LACP_STATS_ENTRY = 424,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 425,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 426,
    OF_LIST_BSN_TLV = 427,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 428,
    OF_LIST_BUCKET = 429,
    OF_LIST_BUCKET_COUNTER = 430,
    OF_LIST_FLOW_STATS_ENTRY = 431,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 432,
    OF_LIST_GROUP_STATS_ENTRY = 433,
    OF_LIST_HELLO_ELEM = 434,
    OF_LIST_INSTRUCTION = 435,
    OF_LIST_METER_BAND = 436,
    OF_LIST_METER_BAND_STATS = 437,
    OF_LIST_METER_STATS = 438,
    OF_LIST_OXM = 439,
    OF_LIST_PACKET_QUEUE = 440,
    OF_LIST_PORT_DESC = 441,
    OF_LIST_PORT_STATS_ENTRY = 442,
    OF_LIST_QUEUE_PROP = 443,
    OF_LIST_QUEUE_STATS_ENTRY = 444,
    OF_LIST_TABLE_FEATURE_PROP = 445,
    OF_LIST_TABLE_FEATURES = 446,
    OF_LIST_TABLE_STATS_ENTRY = 447,
    OF_LIST_UINT32 = 448,
    OF_LIST_UINT64 = 449,
    OF_LIST_UINT8 = 450,
