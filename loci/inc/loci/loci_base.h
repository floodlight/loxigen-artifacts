...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PORT = 419,
    OF_BSN_TLV_PORT_SPEED_GBPS = 420,
    OF_BSN_TLV_PORT_USAGE = 421,
    OF_BSN_TLV_PORT_VXLAN_MODE = 422,
    OF_BSN_TLV_PRIORITY = 423,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 424,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 425,
    OF_BSN_TLV_QOS_PRIORITY = 426,
    OF_BSN_TLV_QUEUE_ID = 427,
    OF_BSN_TLV_QUEUE_WEIGHT = 428,
    OF_BSN_TLV_RATE_LIMIT = 429,
    OF_BSN_TLV_RATE_UNIT = 430,
    OF_BSN_TLV_RECORD_PACKETS = 431,
    OF_BSN_TLV_REFERENCE = 432,
    OF_BSN_TLV_REPLY_PACKETS = 433,
    OF_BSN_TLV_REQUEST_PACKETS = 434,
    OF_BSN_TLV_REST_SERVER = 435,
    OF_BSN_TLV_ROUTING_PARAM = 436,
    OF_BSN_TLV_RX_BYTES = 437,
    OF_BSN_TLV_RX_PACKETS = 438,
    OF_BSN_TLV_SAMPLING_RATE = 439,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 440,
    OF_BSN_TLV_STATUS = 441,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 442,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 443,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 444,
    OF_BSN_TLV_SUB_AGENT_ID = 445,
    OF_BSN_TLV_TCP_DST = 446,
    OF_BSN_TLV_TCP_FLAGS = 447,
    OF_BSN_TLV_TCP_SRC = 448,
    OF_BSN_TLV_TIMESTAMP = 449,
    OF_BSN_TLV_TTL = 450,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 451,
    OF_BSN_TLV_TX_BYTES = 452,
    OF_BSN_TLV_TX_PACKETS = 453,
    OF_BSN_TLV_UDF_ANCHOR = 454,
    OF_BSN_TLV_UDF_ID = 455,
    OF_BSN_TLV_UDF_LENGTH = 456,
    OF_BSN_TLV_UDF_OFFSET = 457,
    OF_BSN_TLV_UDP_DST = 458,
    OF_BSN_TLV_UDP_SRC = 459,
    OF_BSN_TLV_UINT32 = 460,
    OF_BSN_TLV_UINT64_LIST = 461,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 462,
    OF_BSN_TLV_UNICAST_RATE = 463,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 464,
    OF_BSN_TLV_UNTAGGED = 465,
    OF_BSN_TLV_UPGRADE = 466,
    OF_BSN_TLV_URI_SCHEME = 467,
    OF_BSN_TLV_USE_PACKET_STATE = 468,
    OF_BSN_TLV_USER_CONFIGURED = 469,
    OF_BSN_TLV_VFI = 470,
    OF_BSN_TLV_VFP_CLASS_ID = 471,
    OF_BSN_TLV_VIRTUAL = 472,
    OF_BSN_TLV_VLAN_MAC_LIST = 473,
    OF_BSN_TLV_VLAN_PCP = 474,
    OF_BSN_TLV_VLAN_VID = 475,
    OF_BSN_TLV_VLAN_VID_MASK = 476,
    OF_BSN_TLV_VNI = 477,
    OF_BSN_TLV_VPN_KEY = 478,
    OF_BSN_TLV_VRF = 479,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 480,
    OF_BSN_UNIT = 481,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 482,
    OF_BSN_VLAN_MAC = 483,
    OF_BSN_VPORT = 484,
    OF_BSN_VPORT_L2GRE = 485,
    OF_BSN_VPORT_Q_IN_Q = 486,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 487,
    OF_BUCKET = 488,
    OF_BUCKET_COUNTER = 489,
    OF_BUNDLE_PROP = 490,
    OF_BUNDLE_PROP_EXPERIMENTER = 491,
    OF_FLOW_STATS_ENTRY = 492,
    OF_GROUP_DESC_STATS_ENTRY = 493,
    OF_GROUP_STATS_ENTRY = 494,
    OF_HELLO_ELEM = 495,
    OF_HELLO_ELEM_VERSIONBITMAP = 496,
    OF_INSTRUCTION = 497,
    OF_INSTRUCTION_APPLY_ACTIONS = 498,
    OF_INSTRUCTION_BSN = 499,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 500,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 501,
    OF_INSTRUCTION_BSN_DENY = 502,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 503,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 504,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 505,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 506,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 507,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 508,
    OF_INSTRUCTION_BSN_HASH_SELECT = 509,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 510,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 511,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 512,
    OF_INSTRUCTION_BSN_PERMIT = 513,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 514,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 515,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 516,
    OF_INSTRUCTION_CLEAR_ACTIONS = 517,
    OF_INSTRUCTION_EXPERIMENTER = 518,
    OF_INSTRUCTION_GOTO_TABLE = 519,
    OF_INSTRUCTION_ID = 520,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 521,
    OF_INSTRUCTION_ID_BSN = 522,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 523,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 524,
    OF_INSTRUCTION_ID_BSN_DENY = 525,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 526,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 527,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 528,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 529,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 530,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 531,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 532,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 533,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 534,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 535,
    OF_INSTRUCTION_ID_BSN_PERMIT = 536,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 537,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 538,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 539,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 540,
    OF_INSTRUCTION_ID_EXPERIMENTER = 541,
    OF_INSTRUCTION_ID_GOTO_TABLE = 542,
    OF_INSTRUCTION_ID_METER = 543,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 544,
    OF_INSTRUCTION_ID_WRITE_METADATA = 545,
    OF_INSTRUCTION_METER = 546,
    OF_INSTRUCTION_WRITE_ACTIONS = 547,
    OF_INSTRUCTION_WRITE_METADATA = 548,
    OF_MATCH_V1 = 549,
    OF_MATCH_V2 = 550,
    OF_MATCH_V3 = 551,
    OF_METER_BAND = 552,
    OF_METER_BAND_DROP = 553,
    OF_METER_BAND_DSCP_REMARK = 554,
    OF_METER_BAND_EXPERIMENTER = 555,
    OF_METER_BAND_STATS = 556,
    OF_METER_CONFIG = 557,
    OF_METER_FEATURES = 558,
    OF_METER_STATS = 559,
    OF_OXM = 560,
    OF_OXM_ARP_OP = 561,
    OF_OXM_ARP_OP_MASKED = 562,
    OF_OXM_ARP_SHA = 563,
    OF_OXM_ARP_SHA_MASKED = 564,
    OF_OXM_ARP_SPA = 565,
    OF_OXM_ARP_SPA_MASKED = 566,
    OF_OXM_ARP_THA = 567,
    OF_OXM_ARP_THA_MASKED = 568,
    OF_OXM_ARP_TPA = 569,
    OF_OXM_ARP_TPA_MASKED = 570,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 571,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 572,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 573,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 574,
    OF_OXM_BSN_IFP_CLASS_ID = 575,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 576,
    OF_OXM_BSN_IN_PORTS_128 = 577,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 578,
    OF_OXM_BSN_IN_PORTS_512 = 579,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 580,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 581,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 582,
    OF_OXM_BSN_INNER_ETH_DST = 583,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 584,
    OF_OXM_BSN_INNER_ETH_SRC = 585,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 586,
    OF_OXM_BSN_INNER_VLAN_VID = 587,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 588,
    OF_OXM_BSN_IP_FRAGMENTATION = 589,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 590,
    OF_OXM_BSN_L2_CACHE_HIT = 591,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 592,
    OF_OXM_BSN_L3_DST_CLASS_ID = 593,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 594,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 595,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 596,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 597,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 598,
    OF_OXM_BSN_LAG_ID = 599,
    OF_OXM_BSN_LAG_ID_MASKED = 600,
    OF_OXM_BSN_TCP_FLAGS = 601,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 602,
    OF_OXM_BSN_UDF0 = 603,
    OF_OXM_BSN_UDF0_MASKED = 604,
    OF_OXM_BSN_UDF1 = 605,
    OF_OXM_BSN_UDF1_MASKED = 606,
    OF_OXM_BSN_UDF2 = 607,
    OF_OXM_BSN_UDF2_MASKED = 608,
    OF_OXM_BSN_UDF3 = 609,
    OF_OXM_BSN_UDF3_MASKED = 610,
    OF_OXM_BSN_UDF4 = 611,
    OF_OXM_BSN_UDF4_MASKED = 612,
    OF_OXM_BSN_UDF5 = 613,
    OF_OXM_BSN_UDF5_MASKED = 614,
    OF_OXM_BSN_UDF6 = 615,
    OF_OXM_BSN_UDF6_MASKED = 616,
    OF_OXM_BSN_UDF7 = 617,
    OF_OXM_BSN_UDF7_MASKED = 618,
    OF_OXM_BSN_VFI = 619,
    OF_OXM_BSN_VFI_MASKED = 620,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 621,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 622,
    OF_OXM_BSN_VRF = 623,
    OF_OXM_BSN_VRF_MASKED = 624,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 625,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 626,
    OF_OXM_CONN_TRACKING_IPV6_DST = 627,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 628,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 629,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 630,
    OF_OXM_CONN_TRACKING_LABEL = 631,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 632,
    OF_OXM_CONN_TRACKING_MARK = 633,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 634,
    OF_OXM_CONN_TRACKING_NW_DST = 635,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 636,
    OF_OXM_CONN_TRACKING_NW_PROTO = 637,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 638,
    OF_OXM_CONN_TRACKING_NW_SRC = 639,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 640,
    OF_OXM_CONN_TRACKING_STATE = 641,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 642,
    OF_OXM_CONN_TRACKING_TP_DST = 643,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 644,
    OF_OXM_CONN_TRACKING_TP_SRC = 645,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 646,
    OF_OXM_CONN_TRACKING_ZONE = 647,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 648,
    OF_OXM_ETH_DST = 649,
    OF_OXM_ETH_DST_MASKED = 650,
    OF_OXM_ETH_SRC = 651,
    OF_OXM_ETH_SRC_MASKED = 652,
    OF_OXM_ETH_TYPE = 653,
    OF_OXM_ETH_TYPE_MASKED = 654,
    OF_OXM_ICMPV4_CODE = 655,
    OF_OXM_ICMPV4_CODE_MASKED = 656,
    OF_OXM_ICMPV4_TYPE = 657,
    OF_OXM_ICMPV4_TYPE_MASKED = 658,
    OF_OXM_ICMPV6_CODE = 659,
    OF_OXM_ICMPV6_CODE_MASKED = 660,
    OF_OXM_ICMPV6_TYPE = 661,
    OF_OXM_ICMPV6_TYPE_MASKED = 662,
    OF_OXM_IN_PHY_PORT = 663,
    OF_OXM_IN_PHY_PORT_MASKED = 664,
    OF_OXM_IN_PORT = 665,
    OF_OXM_IN_PORT_MASKED = 666,
    OF_OXM_IP_DSCP = 667,
    OF_OXM_IP_DSCP_MASKED = 668,
    OF_OXM_IP_ECN = 669,
    OF_OXM_IP_ECN_MASKED = 670,
    OF_OXM_IP_PROTO = 671,
    OF_OXM_IP_PROTO_MASKED = 672,
    OF_OXM_IPV4_DST = 673,
    OF_OXM_IPV4_DST_MASKED = 674,
    OF_OXM_IPV4_SRC = 675,
    OF_OXM_IPV4_SRC_MASKED = 676,
    OF_OXM_IPV6_DST = 677,
    OF_OXM_IPV6_DST_MASKED = 678,
    OF_OXM_IPV6_EXTHDR = 679,
    OF_OXM_IPV6_EXTHDR_MASKED = 680,
    OF_OXM_IPV6_FLABEL = 681,
    OF_OXM_IPV6_FLABEL_MASKED = 682,
    OF_OXM_IPV6_ND_SLL = 683,
    OF_OXM_IPV6_ND_SLL_MASKED = 684,
    OF_OXM_IPV6_ND_TARGET = 685,
    OF_OXM_IPV6_ND_TARGET_MASKED = 686,
    OF_OXM_IPV6_ND_TLL = 687,
    OF_OXM_IPV6_ND_TLL_MASKED = 688,
    OF_OXM_IPV6_SRC = 689,
    OF_OXM_IPV6_SRC_MASKED = 690,
    OF_OXM_METADATA = 691,
    OF_OXM_METADATA_MASKED = 692,
    OF_OXM_MPLS_BOS = 693,
    OF_OXM_MPLS_BOS_MASKED = 694,
    OF_OXM_MPLS_LABEL = 695,
    OF_OXM_MPLS_LABEL_MASKED = 696,
    OF_OXM_MPLS_TC = 697,
    OF_OXM_MPLS_TC_MASKED = 698,
    OF_OXM_OVS_TCP_FLAGS = 699,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 700,
    OF_OXM_PBB_UCA = 701,
    OF_OXM_PBB_UCA_MASKED = 702,
    OF_OXM_SCTP_DST = 703,
    OF_OXM_SCTP_DST_MASKED = 704,
    OF_OXM_SCTP_SRC = 705,
    OF_OXM_SCTP_SRC_MASKED = 706,
    OF_OXM_TCP_DST = 707,
    OF_OXM_TCP_DST_MASKED = 708,
    OF_OXM_TCP_SRC = 709,
    OF_OXM_TCP_SRC_MASKED = 710,
    OF_OXM_TUNNEL_ID = 711,
    OF_OXM_TUNNEL_ID_MASKED = 712,
    OF_OXM_TUNNEL_IPV4_DST = 713,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 714,
    OF_OXM_TUNNEL_IPV4_SRC = 715,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 716,
    OF_OXM_UDP_DST = 717,
    OF_OXM_UDP_DST_MASKED = 718,
    OF_OXM_UDP_SRC = 719,
    OF_OXM_UDP_SRC_MASKED = 720,
    OF_OXM_VLAN_PCP = 721,
    OF_OXM_VLAN_PCP_MASKED = 722,
    OF_OXM_VLAN_VID = 723,
    OF_OXM_VLAN_VID_MASKED = 724,
    OF_PACKET_QUEUE = 725,
    OF_PORT_DESC = 726,
    OF_PORT_DESC_PROP = 727,
    OF_PORT_DESC_PROP_BSN = 728,
    OF_PORT_DESC_PROP_BSN_ALARM = 729,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 730,
    OF_PORT_DESC_PROP_BSN_DIAG = 731,
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 732,
    ...
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 736,
    OF_PORT_DESC_PROP_BSN_UPLINK = 737,
    OF_PORT_DESC_PROP_ETHERNET = 738,
    OF_PORT_DESC_PROP_EXPERIMENTER = 739,
    OF_PORT_DESC_PROP_OPTICAL = 740,
    OF_PORT_MOD_PROP = 741,
    OF_PORT_MOD_PROP_ETHERNET = 742,
    OF_PORT_MOD_PROP_EXPERIMENTER = 743,
    OF_PORT_MOD_PROP_OPTICAL = 744,
    OF_PORT_STATS_ENTRY = 745,
    OF_PORT_STATS_PROP = 746,
    OF_PORT_STATS_PROP_ETHERNET = 747,
    OF_PORT_STATS_PROP_EXPERIMENTER = 748,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 749,
    OF_PORT_STATS_PROP_OPTICAL = 750,
    OF_QUEUE_DESC = 751,
    OF_QUEUE_DESC_PROP = 752,
    OF_QUEUE_DESC_PROP_BSN = 753,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 754,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 755,
    OF_QUEUE_DESC_PROP_MAX_RATE = 756,
    OF_QUEUE_DESC_PROP_MIN_RATE = 757,
    OF_QUEUE_PROP = 758,
    OF_QUEUE_PROP_EXPERIMENTER = 759,
    OF_QUEUE_PROP_MAX_RATE = 760,
    OF_QUEUE_PROP_MIN_RATE = 761,
    OF_QUEUE_STATS_ENTRY = 762,
    OF_QUEUE_STATS_PROP = 763,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 764,
    OF_ROLE_PROP = 765,
    OF_ROLE_PROP_EXPERIMENTER = 766,
    OF_TABLE_DESC = 767,
    OF_TABLE_FEATURE_PROP = 768,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 769,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 770,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 771,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 772,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 773,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 774,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 775,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 776,
    OF_TABLE_FEATURE_PROP_MATCH = 777,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 778,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 779,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 780,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 781,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 782,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 783,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 784,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 785,
    OF_TABLE_FEATURES = 786,
    OF_TABLE_MOD_PROP = 787,
    OF_TABLE_MOD_PROP_EVICTION = 788,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 789,
    OF_TABLE_MOD_PROP_VACANCY = 790,
    OF_TABLE_STATS_ENTRY = 791,
    OF_UINT32 = 792,
    OF_UINT64 = 793,
    OF_UINT8 = 794,
    OFP_BSN_MODULE_EEPROM_TRANSCEIVER = 795,
