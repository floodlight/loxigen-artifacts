...
typedef enum of_object_id_e {
    ...
    OF_BSN_TIME_REPLY = 105,
    OF_BSN_TIME_REQUEST = 106,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 107,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 108,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 109,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 110,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 111,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 112,
    OF_BSN_VRF_COUNTER_STATS_REPLY = 113,
    OF_BSN_VRF_COUNTER_STATS_REQUEST = 114,
    OF_BUNDLE_ADD_MSG = 115,
    OF_BUNDLE_CTRL_MSG = 116,
    OF_BUNDLE_FAILED_ERROR_MSG = 117,
    OF_DESC_STATS_REPLY = 118,
    OF_DESC_STATS_REQUEST = 119,
    OF_ECHO_REPLY = 120,
    OF_ECHO_REQUEST = 121,
    OF_ERROR_MSG = 122,
    OF_EXPERIMENTER = 123,
    OF_EXPERIMENTER_ERROR_MSG = 124,
    OF_EXPERIMENTER_STATS_REPLY = 125,
    OF_EXPERIMENTER_STATS_REQUEST = 126,
    OF_FEATURES_REPLY = 127,
    OF_FEATURES_REQUEST = 128,
    OF_FLOW_ADD = 129,
    OF_FLOW_DELETE = 130,
    OF_FLOW_DELETE_STRICT = 131,
    OF_FLOW_MOD = 132,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 133,
    OF_FLOW_MODIFY = 134,
    OF_FLOW_MODIFY_STRICT = 135,
    OF_FLOW_MONITOR_FAILED_ERROR_MSG = 136,
    OF_FLOW_REMOVED = 137,
    OF_FLOW_STATS_REPLY = 138,
    OF_FLOW_STATS_REQUEST = 139,
    OF_GET_CONFIG_REPLY = 140,
    OF_GET_CONFIG_REQUEST = 141,
    OF_GROUP_ADD = 142,
    OF_GROUP_DELETE = 143,
    OF_GROUP_DESC_STATS_REPLY = 144,
    OF_GROUP_DESC_STATS_REQUEST = 145,
    OF_GROUP_FEATURES_STATS_REPLY = 146,
    OF_GROUP_FEATURES_STATS_REQUEST = 147,
    OF_GROUP_MOD = 148,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 149,
    OF_GROUP_MODIFY = 150,
    OF_GROUP_STATS_REPLY = 151,
    OF_GROUP_STATS_REQUEST = 152,
    OF_HEADER = 153,
    OF_HELLO = 154,
    OF_HELLO_FAILED_ERROR_MSG = 155,
    OF_METER_CONFIG_STATS_REPLY = 156,
    OF_METER_CONFIG_STATS_REQUEST = 157,
    OF_METER_FEATURES_STATS_REPLY = 158,
    OF_METER_FEATURES_STATS_REQUEST = 159,
    OF_METER_MOD = 160,
    OF_METER_MOD_FAILED_ERROR_MSG = 161,
    OF_METER_STATS_REPLY = 162,
    OF_METER_STATS_REQUEST = 163,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 164,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 165,
    OF_NICIRA_HEADER = 166,
    OF_PACKET_IN = 167,
    OF_PACKET_OUT = 168,
    OF_PORT_DESC_STATS_REPLY = 169,
    OF_PORT_DESC_STATS_REQUEST = 170,
    OF_PORT_MOD = 171,
    OF_PORT_MOD_FAILED_ERROR_MSG = 172,
    OF_PORT_STATS_REPLY = 173,
    OF_PORT_STATS_REQUEST = 174,
    OF_PORT_STATUS = 175,
    OF_QUEUE_DESC_STATS_REPLY = 176,
    OF_QUEUE_DESC_STATS_REQUEST = 177,
    OF_QUEUE_GET_CONFIG_REPLY = 178,
    OF_QUEUE_GET_CONFIG_REQUEST = 179,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 180,
    OF_QUEUE_STATS_REPLY = 181,
    OF_QUEUE_STATS_REQUEST = 182,
    OF_REQUESTFORWARD = 183,
    OF_ROLE_REPLY = 184,
    OF_ROLE_REQUEST = 185,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 186,
    OF_ROLE_STATUS = 187,
    OF_SET_CONFIG = 188,
    OF_STATS_REPLY = 189,
    OF_STATS_REQUEST = 190,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 191,
    OF_TABLE_DESC_STATS_REPLY = 192,
    OF_TABLE_DESC_STATS_REQUEST = 193,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 194,
    OF_TABLE_FEATURES_STATS_REPLY = 195,
    OF_TABLE_FEATURES_STATS_REQUEST = 196,
    OF_TABLE_MOD = 197,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 198,
    OF_TABLE_STATS_REPLY = 199,
    OF_TABLE_STATS_REQUEST = 200,
    OF_TABLE_STATUS = 201,

    /* Non-message objects */
    OF_ACTION = 202,
    OF_ACTION_BSN = 203,
    OF_ACTION_BSN_CHECKSUM = 204,
    OF_ACTION_BSN_GENTABLE = 205,
    OF_ACTION_BSN_MIRROR = 206,
    OF_ACTION_BSN_SET_TUNNEL_DST = 207,
    OF_ACTION_COPY_TTL_IN = 208,
    OF_ACTION_COPY_TTL_OUT = 209,
    OF_ACTION_DEC_MPLS_TTL = 210,
    OF_ACTION_DEC_NW_TTL = 211,
    OF_ACTION_ENQUEUE = 212,
    OF_ACTION_EXPERIMENTER = 213,
    OF_ACTION_GROUP = 214,
    OF_ACTION_ID = 215,
    OF_ACTION_ID_BSN = 216,
    OF_ACTION_ID_BSN_CHECKSUM = 217,
    OF_ACTION_ID_BSN_GENTABLE = 218,
    OF_ACTION_ID_BSN_MIRROR = 219,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 220,
    OF_ACTION_ID_COPY_TTL_IN = 221,
    OF_ACTION_ID_COPY_TTL_OUT = 222,
    OF_ACTION_ID_DEC_MPLS_TTL = 223,
    OF_ACTION_ID_DEC_NW_TTL = 224,
    OF_ACTION_ID_EXPERIMENTER = 225,
    OF_ACTION_ID_GROUP = 226,
    OF_ACTION_ID_NICIRA = 227,
    OF_ACTION_ID_NICIRA_DEC_TTL = 228,
    OF_ACTION_ID_OUTPUT = 229,
    OF_ACTION_ID_POP_MPLS = 230,
    OF_ACTION_ID_POP_PBB = 231,
    OF_ACTION_ID_POP_VLAN = 232,
    OF_ACTION_ID_PUSH_MPLS = 233,
    OF_ACTION_ID_PUSH_PBB = 234,
    OF_ACTION_ID_PUSH_VLAN = 235,
    OF_ACTION_ID_SET_FIELD = 236,
    OF_ACTION_ID_SET_MPLS_TTL = 237,
    OF_ACTION_ID_SET_NW_TTL = 238,
    OF_ACTION_ID_SET_QUEUE = 239,
    OF_ACTION_NICIRA = 240,
    OF_ACTION_NICIRA_DEC_TTL = 241,
    OF_ACTION_OUTPUT = 242,
    OF_ACTION_POP_MPLS = 243,
    OF_ACTION_POP_PBB = 244,
    OF_ACTION_POP_VLAN = 245,
    OF_ACTION_PUSH_MPLS = 246,
    OF_ACTION_PUSH_PBB = 247,
    OF_ACTION_PUSH_VLAN = 248,
    OF_ACTION_SET_DL_DST = 249,
    OF_ACTION_SET_DL_SRC = 250,
    OF_ACTION_SET_FIELD = 251,
    OF_ACTION_SET_MPLS_LABEL = 252,
    OF_ACTION_SET_MPLS_TC = 253,
    OF_ACTION_SET_MPLS_TTL = 254,
    OF_ACTION_SET_NW_DST = 255,
    OF_ACTION_SET_NW_ECN = 256,
    OF_ACTION_SET_NW_SRC = 257,
    OF_ACTION_SET_NW_TOS = 258,
    OF_ACTION_SET_NW_TTL = 259,
    OF_ACTION_SET_QUEUE = 260,
    OF_ACTION_SET_TP_DST = 261,
    OF_ACTION_SET_TP_SRC = 262,
    OF_ACTION_SET_VLAN_PCP = 263,
    OF_ACTION_SET_VLAN_VID = 264,
    OF_ACTION_STRIP_VLAN = 265,
    OF_ASYNC_CONFIG_PROP = 266,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_MASTER = 267,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_SLAVE = 268,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_MASTER = 269,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_SLAVE = 270,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_MASTER = 271,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_SLAVE = 272,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_MASTER = 273,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_SLAVE = 274,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_MASTER = 275,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_SLAVE = 276,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_MASTER = 277,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_SLAVE = 278,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_MASTER = 279,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_SLAVE = 280,
    OF_BSN_CONTROLLER_CONNECTION = 281,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 282,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 283,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 284,
    OF_BSN_GENERIC_STATS_ENTRY = 285,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 286,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 287,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 288,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 289,
    OF_BSN_GENTABLE_STATS_ENTRY = 290,
    OF_BSN_INTERFACE = 291,
    OF_BSN_LACP_STATS_ENTRY = 292,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 293,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 294,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 295,
    OF_BSN_TLV = 296,
    OF_BSN_TLV_ACTOR_KEY = 297,
    OF_BSN_TLV_ACTOR_PORT_NUM = 298,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 299,
    OF_BSN_TLV_ACTOR_STATE = 300,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 301,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 302,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 303,
    OF_BSN_TLV_BUCKET = 304,
    OF_BSN_TLV_CIRCUIT_ID = 305,
    OF_BSN_TLV_CONVERGENCE_STATUS = 306,
    OF_BSN_TLV_CRC_ENABLED = 307,
    OF_BSN_TLV_DATA = 308,
    OF_BSN_TLV_ETH_DST = 309,
    OF_BSN_TLV_ETH_SRC = 310,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 311,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 312,
    OF_BSN_TLV_EXTERNAL_IP = 313,
    OF_BSN_TLV_EXTERNAL_MAC = 314,
    OF_BSN_TLV_EXTERNAL_NETMASK = 315,
    OF_BSN_TLV_HEADER_SIZE = 316,
    OF_BSN_TLV_ICMP_CODE = 317,
    OF_BSN_TLV_ICMP_ID = 318,
    OF_BSN_TLV_ICMP_TYPE = 319,
    OF_BSN_TLV_IDLE_NOTIFICATION = 320,
    OF_BSN_TLV_IDLE_TIME = 321,
    OF_BSN_TLV_IDLE_TIMEOUT = 322,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 323,
    OF_BSN_TLV_INTERNAL_MAC = 324,
    OF_BSN_TLV_INTERVAL = 325,
    OF_BSN_TLV_IP_PROTO = 326,
    OF_BSN_TLV_IPV4 = 327,
    OF_BSN_TLV_IPV4_DST = 328,
    OF_BSN_TLV_IPV4_NETMASK = 329,
    OF_BSN_TLV_IPV4_SRC = 330,
    OF_BSN_TLV_MAC = 331,
    OF_BSN_TLV_MAC_MASK = 332,
    OF_BSN_TLV_MISS_PACKETS = 333,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 334,
    OF_BSN_TLV_MPLS_LABEL = 335,
    OF_BSN_TLV_MPLS_SEQUENCED = 336,
    OF_BSN_TLV_NAME = 337,
    OF_BSN_TLV_PARTNER_KEY = 338,
    OF_BSN_TLV_PARTNER_PORT_NUM = 339,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 340,
    OF_BSN_TLV_PARTNER_STATE = 341,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 342,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 343,
    OF_BSN_TLV_PORT = 344,
    OF_BSN_TLV_PRIORITY = 345,
    OF_BSN_TLV_QUEUE_ID = 346,
    OF_BSN_TLV_QUEUE_WEIGHT = 347,
    OF_BSN_TLV_REFERENCE = 348,
    OF_BSN_TLV_REPLY_PACKETS = 349,
    OF_BSN_TLV_REQUEST_PACKETS = 350,
    OF_BSN_TLV_RX_BYTES = 351,
    OF_BSN_TLV_RX_PACKETS = 352,
    OF_BSN_TLV_SAMPLING_RATE = 353,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 354,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 355,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 356,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 357,
    OF_BSN_TLV_SUB_AGENT_ID = 358,
    OF_BSN_TLV_TCP_DST = 359,
    OF_BSN_TLV_TCP_SRC = 360,
    OF_BSN_TLV_TX_BYTES = 361,
    OF_BSN_TLV_TX_PACKETS = 362,
    OF_BSN_TLV_UDF_ANCHOR = 363,
    OF_BSN_TLV_UDF_ID = 364,
    OF_BSN_TLV_UDF_LENGTH = 365,
    OF_BSN_TLV_UDF_OFFSET = 366,
    OF_BSN_TLV_UDP_DST = 367,
    OF_BSN_TLV_UDP_SRC = 368,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 369,
    OF_BSN_TLV_VLAN_PCP = 370,
    OF_BSN_TLV_VLAN_VID = 371,
    OF_BSN_TLV_VRF = 372,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 373,
    OF_BSN_VPORT = 374,
    OF_BSN_VPORT_L2GRE = 375,
    OF_BSN_VPORT_Q_IN_Q = 376,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 377,
    OF_BUCKET = 378,
    OF_BUCKET_COUNTER = 379,
    OF_BUNDLE_PROP = 380,
    OF_BUNDLE_PROP_EXPERIMENTER = 381,
    OF_FLOW_STATS_ENTRY = 382,
    OF_GROUP_DESC_STATS_ENTRY = 383,
    OF_GROUP_STATS_ENTRY = 384,
    OF_HELLO_ELEM = 385,
    OF_HELLO_ELEM_VERSIONBITMAP = 386,
    OF_INSTRUCTION = 387,
    OF_INSTRUCTION_APPLY_ACTIONS = 388,
    OF_INSTRUCTION_BSN = 389,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 390,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 391,
    OF_INSTRUCTION_BSN_DENY = 392,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 393,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 394,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 395,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 396,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 397,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 398,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 399,
    OF_INSTRUCTION_BSN_PERMIT = 400,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 401,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 402,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 403,
    OF_INSTRUCTION_CLEAR_ACTIONS = 404,
    OF_INSTRUCTION_EXPERIMENTER = 405,
    OF_INSTRUCTION_GOTO_TABLE = 406,
    OF_INSTRUCTION_ID = 407,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 408,
    OF_INSTRUCTION_ID_BSN = 409,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 410,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 411,
    OF_INSTRUCTION_ID_BSN_DENY = 412,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 413,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 414,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 415,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 416,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 417,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 418,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 419,
    OF_INSTRUCTION_ID_BSN_PERMIT = 420,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 421,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 422,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 423,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 424,
    OF_INSTRUCTION_ID_EXPERIMENTER = 425,
    OF_INSTRUCTION_ID_GOTO_TABLE = 426,
    OF_INSTRUCTION_ID_METER = 427,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 428,
    OF_INSTRUCTION_ID_WRITE_METADATA = 429,
    OF_INSTRUCTION_METER = 430,
    OF_INSTRUCTION_WRITE_ACTIONS = 431,
    OF_INSTRUCTION_WRITE_METADATA = 432,
    OF_MATCH_V1 = 433,
    OF_MATCH_V2 = 434,
    OF_MATCH_V3 = 435,
    OF_METER_BAND = 436,
    OF_METER_BAND_DROP = 437,
    OF_METER_BAND_DSCP_REMARK = 438,
    OF_METER_BAND_EXPERIMENTER = 439,
    OF_METER_BAND_STATS = 440,
    OF_METER_CONFIG = 441,
    OF_METER_FEATURES = 442,
    OF_METER_STATS = 443,
    OF_OXM = 444,
    OF_OXM_ARP_OP = 445,
    OF_OXM_ARP_OP_MASKED = 446,
    OF_OXM_ARP_SHA = 447,
    OF_OXM_ARP_SHA_MASKED = 448,
    OF_OXM_ARP_SPA = 449,
    OF_OXM_ARP_SPA_MASKED = 450,
    OF_OXM_ARP_THA = 451,
    OF_OXM_ARP_THA_MASKED = 452,
    OF_OXM_ARP_TPA = 453,
    OF_OXM_ARP_TPA_MASKED = 454,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 455,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 456,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 457,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 458,
    OF_OXM_BSN_IN_PORTS_128 = 459,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 460,
    OF_OXM_BSN_IN_PORTS_512 = 461,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 462,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 463,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 464,
    OF_OXM_BSN_INNER_ETH_DST = 465,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 466,
    OF_OXM_BSN_INNER_ETH_SRC = 467,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 468,
    OF_OXM_BSN_L2_CACHE_HIT = 469,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 470,
    OF_OXM_BSN_L3_DST_CLASS_ID = 471,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 472,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 473,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 474,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 475,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 476,
    OF_OXM_BSN_LAG_ID = 477,
    OF_OXM_BSN_LAG_ID_MASKED = 478,
    OF_OXM_BSN_TCP_FLAGS = 479,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 480,
    OF_OXM_BSN_UDF0 = 481,
    OF_OXM_BSN_UDF0_MASKED = 482,
    OF_OXM_BSN_UDF1 = 483,
    OF_OXM_BSN_UDF1_MASKED = 484,
    OF_OXM_BSN_UDF2 = 485,
    OF_OXM_BSN_UDF2_MASKED = 486,
    OF_OXM_BSN_UDF3 = 487,
    OF_OXM_BSN_UDF3_MASKED = 488,
    OF_OXM_BSN_UDF4 = 489,
    OF_OXM_BSN_UDF4_MASKED = 490,
    OF_OXM_BSN_UDF5 = 491,
    OF_OXM_BSN_UDF5_MASKED = 492,
    OF_OXM_BSN_UDF6 = 493,
    OF_OXM_BSN_UDF6_MASKED = 494,
    OF_OXM_BSN_UDF7 = 495,
    OF_OXM_BSN_UDF7_MASKED = 496,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 497,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 498,
    OF_OXM_BSN_VRF = 499,
    OF_OXM_BSN_VRF_MASKED = 500,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 501,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 502,
    OF_OXM_ETH_DST = 503,
    OF_OXM_ETH_DST_MASKED = 504,
    OF_OXM_ETH_SRC = 505,
    OF_OXM_ETH_SRC_MASKED = 506,
    OF_OXM_ETH_TYPE = 507,
    OF_OXM_ETH_TYPE_MASKED = 508,
    OF_OXM_ICMPV4_CODE = 509,
    OF_OXM_ICMPV4_CODE_MASKED = 510,
    OF_OXM_ICMPV4_TYPE = 511,
    OF_OXM_ICMPV4_TYPE_MASKED = 512,
    OF_OXM_ICMPV6_CODE = 513,
    OF_OXM_ICMPV6_CODE_MASKED = 514,
    OF_OXM_ICMPV6_TYPE = 515,
    OF_OXM_ICMPV6_TYPE_MASKED = 516,
    OF_OXM_IN_PHY_PORT = 517,
    OF_OXM_IN_PHY_PORT_MASKED = 518,
    OF_OXM_IN_PORT = 519,
    OF_OXM_IN_PORT_MASKED = 520,
    OF_OXM_IP_DSCP = 521,
    OF_OXM_IP_DSCP_MASKED = 522,
    OF_OXM_IP_ECN = 523,
    OF_OXM_IP_ECN_MASKED = 524,
    OF_OXM_IP_PROTO = 525,
    OF_OXM_IP_PROTO_MASKED = 526,
    OF_OXM_IPV4_DST = 527,
    OF_OXM_IPV4_DST_MASKED = 528,
    OF_OXM_IPV4_SRC = 529,
    OF_OXM_IPV4_SRC_MASKED = 530,
    OF_OXM_IPV6_DST = 531,
    OF_OXM_IPV6_DST_MASKED = 532,
    OF_OXM_IPV6_EXTHDR = 533,
    OF_OXM_IPV6_EXTHDR_MASKED = 534,
    OF_OXM_IPV6_FLABEL = 535,
    OF_OXM_IPV6_FLABEL_MASKED = 536,
    OF_OXM_IPV6_ND_SLL = 537,
    OF_OXM_IPV6_ND_SLL_MASKED = 538,
    OF_OXM_IPV6_ND_TARGET = 539,
    OF_OXM_IPV6_ND_TARGET_MASKED = 540,
    OF_OXM_IPV6_ND_TLL = 541,
    OF_OXM_IPV6_ND_TLL_MASKED = 542,
    OF_OXM_IPV6_SRC = 543,
    OF_OXM_IPV6_SRC_MASKED = 544,
    OF_OXM_METADATA = 545,
    OF_OXM_METADATA_MASKED = 546,
    OF_OXM_MPLS_BOS = 547,
    OF_OXM_MPLS_BOS_MASKED = 548,
    OF_OXM_MPLS_LABEL = 549,
    OF_OXM_MPLS_LABEL_MASKED = 550,
    OF_OXM_MPLS_TC = 551,
    OF_OXM_MPLS_TC_MASKED = 552,
    OF_OXM_PBB_UCA = 553,
    OF_OXM_PBB_UCA_MASKED = 554,
    OF_OXM_SCTP_DST = 555,
    OF_OXM_SCTP_DST_MASKED = 556,
    OF_OXM_SCTP_SRC = 557,
    OF_OXM_SCTP_SRC_MASKED = 558,
    OF_OXM_TCP_DST = 559,
    OF_OXM_TCP_DST_MASKED = 560,
    OF_OXM_TCP_SRC = 561,
    OF_OXM_TCP_SRC_MASKED = 562,
    OF_OXM_TUNNEL_ID = 563,
    OF_OXM_TUNNEL_ID_MASKED = 564,
    OF_OXM_TUNNEL_IPV4_DST = 565,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 566,
    OF_OXM_TUNNEL_IPV4_SRC = 567,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 568,
    OF_OXM_UDP_DST = 569,
    OF_OXM_UDP_DST_MASKED = 570,
    OF_OXM_UDP_SRC = 571,
    OF_OXM_UDP_SRC_MASKED = 572,
    OF_OXM_VLAN_PCP = 573,
    OF_OXM_VLAN_PCP_MASKED = 574,
    OF_OXM_VLAN_VID = 575,
    OF_OXM_VLAN_VID_MASKED = 576,
    OF_PACKET_QUEUE = 577,
    OF_PORT_DESC = 578,
    OF_PORT_DESC_PROP = 579,
    OF_PORT_DESC_PROP_BSN = 580,
    OF_PORT_DESC_PROP_BSN_UPLINK = 581,
    OF_PORT_DESC_PROP_ETHERNET = 582,
    OF_PORT_DESC_PROP_EXPERIMENTER = 583,
    OF_PORT_DESC_PROP_OPTICAL = 584,
    OF_PORT_MOD_PROP = 585,
    OF_PORT_MOD_PROP_ETHERNET = 586,
    OF_PORT_MOD_PROP_EXPERIMENTER = 587,
    OF_PORT_MOD_PROP_OPTICAL = 588,
    OF_PORT_STATS_ENTRY = 589,
    OF_PORT_STATS_PROP = 590,
    OF_PORT_STATS_PROP_ETHERNET = 591,
    OF_PORT_STATS_PROP_EXPERIMENTER = 592,
    OF_PORT_STATS_PROP_OPTICAL = 593,
    OF_QUEUE_DESC = 594,
    OF_QUEUE_DESC_PROP = 595,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 596,
    OF_QUEUE_DESC_PROP_MAX_RATE = 597,
    OF_QUEUE_DESC_PROP_MIN_RATE = 598,
    OF_QUEUE_PROP = 599,
    OF_QUEUE_PROP_EXPERIMENTER = 600,
    OF_QUEUE_PROP_MAX_RATE = 601,
    OF_QUEUE_PROP_MIN_RATE = 602,
    OF_QUEUE_STATS_ENTRY = 603,
    OF_QUEUE_STATS_PROP = 604,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 605,
    OF_ROLE_PROP = 606,
    OF_ROLE_PROP_EXPERIMENTER = 607,
    OF_TABLE_DESC = 608,
    OF_TABLE_FEATURE_PROP = 609,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 610,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 611,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 612,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 613,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 614,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 615,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 616,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 617,
    OF_TABLE_FEATURE_PROP_MATCH = 618,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 619,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 620,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 621,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 622,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 623,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 624,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 625,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 626,
    OF_TABLE_FEATURES = 627,
    OF_TABLE_MOD_PROP = 628,
    OF_TABLE_MOD_PROP_EVICTION = 629,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 630,
    OF_TABLE_MOD_PROP_VACANCY = 631,
    OF_TABLE_STATS_ENTRY = 632,
    OF_UINT32 = 633,
    OF_UINT64 = 634,
    OF_UINT8 = 635,
    ...
    /* List objects */
    OF_LIST_ACTION = 636,
    OF_LIST_ACTION_ID = 637,
    OF_LIST_ASYNC_CONFIG_PROP = 638,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 639,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 640,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 641,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 642,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 643,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 644,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 645,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 646,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 647,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 648,
    OF_LIST_BSN_INTERFACE = 649,
    OF_LIST_BSN_LACP_STATS_ENTRY = 650,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 651,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 652,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 653,
    OF_LIST_BSN_TLV = 654,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 655,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 656,
    OF_LIST_BUCKET = 657,
    OF_LIST_BUCKET_COUNTER = 658,
    OF_LIST_BUNDLE_PROP = 659,
    OF_LIST_FLOW_STATS_ENTRY = 660,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 661,
    OF_LIST_GROUP_STATS_ENTRY = 662,
    OF_LIST_HELLO_ELEM = 663,
    OF_LIST_INSTRUCTION = 664,
    OF_LIST_INSTRUCTION_ID = 665,
    OF_LIST_METER_BAND = 666,
    OF_LIST_METER_BAND_STATS = 667,
    OF_LIST_METER_STATS = 668,
    OF_LIST_OXM = 669,
    OF_LIST_PACKET_QUEUE = 670,
    OF_LIST_PORT_DESC = 671,
    OF_LIST_PORT_DESC_PROP = 672,
    OF_LIST_PORT_MOD_PROP = 673,
    OF_LIST_PORT_STATS_ENTRY = 674,
    OF_LIST_PORT_STATS_PROP = 675,
    OF_LIST_QUEUE_DESC = 676,
    OF_LIST_QUEUE_DESC_PROP = 677,
    OF_LIST_QUEUE_PROP = 678,
    OF_LIST_QUEUE_STATS_ENTRY = 679,
    OF_LIST_QUEUE_STATS_PROP = 680,
    OF_LIST_ROLE_PROP = 681,
    OF_LIST_TABLE_DESC = 682,
    OF_LIST_TABLE_FEATURE_PROP = 683,
    OF_LIST_TABLE_FEATURES = 684,
    OF_LIST_TABLE_MOD_PROP = 685,
    OF_LIST_TABLE_STATS_ENTRY = 686,
    OF_LIST_UINT32 = 687,
    OF_LIST_UINT64 = 688,
    OF_LIST_UINT8 = 689,
...
#define OF_MESSAGE_OBJECT_COUNT 202
