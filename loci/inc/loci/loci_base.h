...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 324,
    OF_BSN_TLV_INTERNAL_MAC = 325,
    OF_BSN_TLV_INTERVAL = 326,
    OF_BSN_TLV_IP_PROTO = 327,
    OF_BSN_TLV_IPV4 = 328,
    OF_BSN_TLV_IPV4_DST = 329,
    OF_BSN_TLV_IPV4_NETMASK = 330,
    OF_BSN_TLV_IPV4_SRC = 331,
    OF_BSN_TLV_MAC = 332,
    OF_BSN_TLV_MAC_MASK = 333,
    OF_BSN_TLV_MISS_PACKETS = 334,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 335,
    OF_BSN_TLV_MPLS_LABEL = 336,
    OF_BSN_TLV_MPLS_SEQUENCED = 337,
    OF_BSN_TLV_NAME = 338,
    OF_BSN_TLV_PARTNER_KEY = 339,
    OF_BSN_TLV_PARTNER_PORT_NUM = 340,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 341,
    OF_BSN_TLV_PARTNER_STATE = 342,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 343,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 344,
    OF_BSN_TLV_PORT = 345,
    OF_BSN_TLV_PRIORITY = 346,
    OF_BSN_TLV_QUEUE_ID = 347,
    OF_BSN_TLV_QUEUE_WEIGHT = 348,
    OF_BSN_TLV_REFERENCE = 349,
    OF_BSN_TLV_REPLY_PACKETS = 350,
    OF_BSN_TLV_REQUEST_PACKETS = 351,
    OF_BSN_TLV_RX_BYTES = 352,
    OF_BSN_TLV_RX_PACKETS = 353,
    OF_BSN_TLV_SAMPLING_RATE = 354,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 355,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 356,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 357,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 358,
    OF_BSN_TLV_SUB_AGENT_ID = 359,
    OF_BSN_TLV_TCP_DST = 360,
    OF_BSN_TLV_TCP_SRC = 361,
    OF_BSN_TLV_TX_BYTES = 362,
    OF_BSN_TLV_TX_PACKETS = 363,
    OF_BSN_TLV_UDF_ANCHOR = 364,
    OF_BSN_TLV_UDF_ID = 365,
    OF_BSN_TLV_UDF_LENGTH = 366,
    OF_BSN_TLV_UDF_OFFSET = 367,
    OF_BSN_TLV_UDP_DST = 368,
    OF_BSN_TLV_UDP_SRC = 369,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 370,
    OF_BSN_TLV_VLAN_PCP = 371,
    OF_BSN_TLV_VLAN_VID = 372,
    OF_BSN_TLV_VLAN_VID_MASK = 373,
    OF_BSN_TLV_VRF = 374,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 375,
    OF_BSN_VPORT = 376,
    OF_BSN_VPORT_L2GRE = 377,
    OF_BSN_VPORT_Q_IN_Q = 378,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 379,
    OF_BUCKET = 380,
    OF_BUCKET_COUNTER = 381,
    OF_BUNDLE_PROP = 382,
    OF_BUNDLE_PROP_EXPERIMENTER = 383,
    OF_FLOW_STATS_ENTRY = 384,
    OF_GROUP_DESC_STATS_ENTRY = 385,
    OF_GROUP_STATS_ENTRY = 386,
    OF_HELLO_ELEM = 387,
    OF_HELLO_ELEM_VERSIONBITMAP = 388,
    OF_INSTRUCTION = 389,
    OF_INSTRUCTION_APPLY_ACTIONS = 390,
    OF_INSTRUCTION_BSN = 391,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 392,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 393,
    OF_INSTRUCTION_BSN_DENY = 394,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 395,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 396,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 397,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 398,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 399,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 400,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 401,
    OF_INSTRUCTION_BSN_PERMIT = 402,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 403,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 404,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 405,
    OF_INSTRUCTION_CLEAR_ACTIONS = 406,
    OF_INSTRUCTION_EXPERIMENTER = 407,
    OF_INSTRUCTION_GOTO_TABLE = 408,
    OF_INSTRUCTION_ID = 409,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 410,
    OF_INSTRUCTION_ID_BSN = 411,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 412,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 413,
    OF_INSTRUCTION_ID_BSN_DENY = 414,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 415,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 416,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 417,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 418,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 419,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 420,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 421,
    OF_INSTRUCTION_ID_BSN_PERMIT = 422,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 423,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 424,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 425,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 426,
    OF_INSTRUCTION_ID_EXPERIMENTER = 427,
    OF_INSTRUCTION_ID_GOTO_TABLE = 428,
    OF_INSTRUCTION_ID_METER = 429,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 430,
    OF_INSTRUCTION_ID_WRITE_METADATA = 431,
    OF_INSTRUCTION_METER = 432,
    OF_INSTRUCTION_WRITE_ACTIONS = 433,
    OF_INSTRUCTION_WRITE_METADATA = 434,
    OF_MATCH_V1 = 435,
    OF_MATCH_V2 = 436,
    OF_MATCH_V3 = 437,
    OF_METER_BAND = 438,
    OF_METER_BAND_DROP = 439,
    OF_METER_BAND_DSCP_REMARK = 440,
    OF_METER_BAND_EXPERIMENTER = 441,
    OF_METER_BAND_STATS = 442,
    OF_METER_CONFIG = 443,
    OF_METER_FEATURES = 444,
    OF_METER_STATS = 445,
    OF_OXM = 446,
    OF_OXM_ARP_OP = 447,
    OF_OXM_ARP_OP_MASKED = 448,
    OF_OXM_ARP_SHA = 449,
    OF_OXM_ARP_SHA_MASKED = 450,
    OF_OXM_ARP_SPA = 451,
    OF_OXM_ARP_SPA_MASKED = 452,
    OF_OXM_ARP_THA = 453,
    OF_OXM_ARP_THA_MASKED = 454,
    OF_OXM_ARP_TPA = 455,
    OF_OXM_ARP_TPA_MASKED = 456,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 457,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 458,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 459,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 460,
    OF_OXM_BSN_IN_PORTS_128 = 461,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 462,
    OF_OXM_BSN_IN_PORTS_512 = 463,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 464,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 465,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 466,
    OF_OXM_BSN_INNER_ETH_DST = 467,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 468,
    OF_OXM_BSN_INNER_ETH_SRC = 469,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 470,
    OF_OXM_BSN_L2_CACHE_HIT = 471,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 472,
    OF_OXM_BSN_L3_DST_CLASS_ID = 473,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 474,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 475,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 476,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 477,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 478,
    OF_OXM_BSN_LAG_ID = 479,
    OF_OXM_BSN_LAG_ID_MASKED = 480,
    OF_OXM_BSN_TCP_FLAGS = 481,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 482,
    OF_OXM_BSN_UDF0 = 483,
    OF_OXM_BSN_UDF0_MASKED = 484,
    OF_OXM_BSN_UDF1 = 485,
    OF_OXM_BSN_UDF1_MASKED = 486,
    OF_OXM_BSN_UDF2 = 487,
    OF_OXM_BSN_UDF2_MASKED = 488,
    OF_OXM_BSN_UDF3 = 489,
    OF_OXM_BSN_UDF3_MASKED = 490,
    OF_OXM_BSN_UDF4 = 491,
    OF_OXM_BSN_UDF4_MASKED = 492,
    OF_OXM_BSN_UDF5 = 493,
    OF_OXM_BSN_UDF5_MASKED = 494,
    OF_OXM_BSN_UDF6 = 495,
    OF_OXM_BSN_UDF6_MASKED = 496,
    OF_OXM_BSN_UDF7 = 497,
    OF_OXM_BSN_UDF7_MASKED = 498,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 499,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 500,
    OF_OXM_BSN_VRF = 501,
    OF_OXM_BSN_VRF_MASKED = 502,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 503,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 504,
    OF_OXM_ETH_DST = 505,
    OF_OXM_ETH_DST_MASKED = 506,
    OF_OXM_ETH_SRC = 507,
    OF_OXM_ETH_SRC_MASKED = 508,
    OF_OXM_ETH_TYPE = 509,
    OF_OXM_ETH_TYPE_MASKED = 510,
    OF_OXM_ICMPV4_CODE = 511,
    OF_OXM_ICMPV4_CODE_MASKED = 512,
    OF_OXM_ICMPV4_TYPE = 513,
    OF_OXM_ICMPV4_TYPE_MASKED = 514,
    OF_OXM_ICMPV6_CODE = 515,
    OF_OXM_ICMPV6_CODE_MASKED = 516,
    OF_OXM_ICMPV6_TYPE = 517,
    OF_OXM_ICMPV6_TYPE_MASKED = 518,
    OF_OXM_IN_PHY_PORT = 519,
    OF_OXM_IN_PHY_PORT_MASKED = 520,
    OF_OXM_IN_PORT = 521,
    OF_OXM_IN_PORT_MASKED = 522,
    OF_OXM_IP_DSCP = 523,
    OF_OXM_IP_DSCP_MASKED = 524,
    OF_OXM_IP_ECN = 525,
    OF_OXM_IP_ECN_MASKED = 526,
    OF_OXM_IP_PROTO = 527,
    OF_OXM_IP_PROTO_MASKED = 528,
    OF_OXM_IPV4_DST = 529,
    OF_OXM_IPV4_DST_MASKED = 530,
    OF_OXM_IPV4_SRC = 531,
    OF_OXM_IPV4_SRC_MASKED = 532,
    OF_OXM_IPV6_DST = 533,
    OF_OXM_IPV6_DST_MASKED = 534,
    OF_OXM_IPV6_EXTHDR = 535,
    OF_OXM_IPV6_EXTHDR_MASKED = 536,
    OF_OXM_IPV6_FLABEL = 537,
    OF_OXM_IPV6_FLABEL_MASKED = 538,
    OF_OXM_IPV6_ND_SLL = 539,
    OF_OXM_IPV6_ND_SLL_MASKED = 540,
    OF_OXM_IPV6_ND_TARGET = 541,
    OF_OXM_IPV6_ND_TARGET_MASKED = 542,
    OF_OXM_IPV6_ND_TLL = 543,
    OF_OXM_IPV6_ND_TLL_MASKED = 544,
    OF_OXM_IPV6_SRC = 545,
    OF_OXM_IPV6_SRC_MASKED = 546,
    OF_OXM_METADATA = 547,
    OF_OXM_METADATA_MASKED = 548,
    OF_OXM_MPLS_BOS = 549,
    OF_OXM_MPLS_BOS_MASKED = 550,
    OF_OXM_MPLS_LABEL = 551,
    OF_OXM_MPLS_LABEL_MASKED = 552,
    OF_OXM_MPLS_TC = 553,
    OF_OXM_MPLS_TC_MASKED = 554,
    OF_OXM_PBB_UCA = 555,
    OF_OXM_PBB_UCA_MASKED = 556,
    OF_OXM_SCTP_DST = 557,
    OF_OXM_SCTP_DST_MASKED = 558,
    OF_OXM_SCTP_SRC = 559,
    OF_OXM_SCTP_SRC_MASKED = 560,
    OF_OXM_TCP_DST = 561,
    OF_OXM_TCP_DST_MASKED = 562,
    OF_OXM_TCP_SRC = 563,
    OF_OXM_TCP_SRC_MASKED = 564,
    OF_OXM_TUNNEL_ID = 565,
    OF_OXM_TUNNEL_ID_MASKED = 566,
    OF_OXM_TUNNEL_IPV4_DST = 567,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 568,
    OF_OXM_TUNNEL_IPV4_SRC = 569,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 570,
    OF_OXM_UDP_DST = 571,
    OF_OXM_UDP_DST_MASKED = 572,
    OF_OXM_UDP_SRC = 573,
    OF_OXM_UDP_SRC_MASKED = 574,
    OF_OXM_VLAN_PCP = 575,
    OF_OXM_VLAN_PCP_MASKED = 576,
    OF_OXM_VLAN_VID = 577,
    OF_OXM_VLAN_VID_MASKED = 578,
    OF_PACKET_QUEUE = 579,
    OF_PORT_DESC = 580,
    OF_PORT_DESC_PROP = 581,
    OF_PORT_DESC_PROP_BSN = 582,
    OF_PORT_DESC_PROP_BSN_UPLINK = 583,
    OF_PORT_DESC_PROP_ETHERNET = 584,
    OF_PORT_DESC_PROP_EXPERIMENTER = 585,
    OF_PORT_DESC_PROP_OPTICAL = 586,
    OF_PORT_MOD_PROP = 587,
    OF_PORT_MOD_PROP_ETHERNET = 588,
    OF_PORT_MOD_PROP_EXPERIMENTER = 589,
    OF_PORT_MOD_PROP_OPTICAL = 590,
    OF_PORT_STATS_ENTRY = 591,
    OF_PORT_STATS_PROP = 592,
    OF_PORT_STATS_PROP_ETHERNET = 593,
    OF_PORT_STATS_PROP_EXPERIMENTER = 594,
    OF_PORT_STATS_PROP_OPTICAL = 595,
    OF_QUEUE_DESC = 596,
    OF_QUEUE_DESC_PROP = 597,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 598,
    OF_QUEUE_DESC_PROP_MAX_RATE = 599,
    OF_QUEUE_DESC_PROP_MIN_RATE = 600,
    OF_QUEUE_PROP = 601,
    OF_QUEUE_PROP_EXPERIMENTER = 602,
    OF_QUEUE_PROP_MAX_RATE = 603,
    OF_QUEUE_PROP_MIN_RATE = 604,
    OF_QUEUE_STATS_ENTRY = 605,
    OF_QUEUE_STATS_PROP = 606,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 607,
    OF_ROLE_PROP = 608,
    OF_ROLE_PROP_EXPERIMENTER = 609,
    OF_TABLE_DESC = 610,
    OF_TABLE_FEATURE_PROP = 611,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 612,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 613,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 614,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 615,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 616,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 617,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 618,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 619,
    OF_TABLE_FEATURE_PROP_MATCH = 620,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 621,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 622,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 623,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 624,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 625,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 626,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 627,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 628,
    OF_TABLE_FEATURES = 629,
    OF_TABLE_MOD_PROP = 630,
    OF_TABLE_MOD_PROP_EVICTION = 631,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 632,
    OF_TABLE_MOD_PROP_VACANCY = 633,
    OF_TABLE_STATS_ENTRY = 634,
    OF_UINT32 = 635,
    OF_UINT64 = 636,
    OF_UINT8 = 637,
    ...
    /* List objects */
    OF_LIST_ACTION = 638,
    OF_LIST_ACTION_ID = 639,
    OF_LIST_ASYNC_CONFIG_PROP = 640,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 641,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 642,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 643,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 644,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 645,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 646,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 647,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 648,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 649,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 650,
    OF_LIST_BSN_INTERFACE = 651,
    OF_LIST_BSN_LACP_STATS_ENTRY = 652,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 653,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 654,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 655,
    OF_LIST_BSN_TLV = 656,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 657,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 658,
    OF_LIST_BUCKET = 659,
    OF_LIST_BUCKET_COUNTER = 660,
    OF_LIST_BUNDLE_PROP = 661,
    OF_LIST_FLOW_STATS_ENTRY = 662,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 663,
    OF_LIST_GROUP_STATS_ENTRY = 664,
    OF_LIST_HELLO_ELEM = 665,
    OF_LIST_INSTRUCTION = 666,
    OF_LIST_INSTRUCTION_ID = 667,
    OF_LIST_METER_BAND = 668,
    OF_LIST_METER_BAND_STATS = 669,
    OF_LIST_METER_STATS = 670,
    OF_LIST_OXM = 671,
    OF_LIST_PACKET_QUEUE = 672,
    OF_LIST_PORT_DESC = 673,
    OF_LIST_PORT_DESC_PROP = 674,
    OF_LIST_PORT_MOD_PROP = 675,
    OF_LIST_PORT_STATS_ENTRY = 676,
    OF_LIST_PORT_STATS_PROP = 677,
    OF_LIST_QUEUE_DESC = 678,
    OF_LIST_QUEUE_DESC_PROP = 679,
    OF_LIST_QUEUE_PROP = 680,
    OF_LIST_QUEUE_STATS_ENTRY = 681,
    OF_LIST_QUEUE_STATS_PROP = 682,
    OF_LIST_ROLE_PROP = 683,
    OF_LIST_TABLE_DESC = 684,
    OF_LIST_TABLE_FEATURE_PROP = 685,
    OF_LIST_TABLE_FEATURES = 686,
    OF_LIST_TABLE_MOD_PROP = 687,
    OF_LIST_TABLE_STATS_ENTRY = 688,
    OF_LIST_UINT32 = 689,
    OF_LIST_UINT64 = 690,
    OF_LIST_UINT8 = 691,
