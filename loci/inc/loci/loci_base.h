...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_VRF = 373,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 374,
    OF_BSN_VPORT = 375,
    OF_BSN_VPORT_L2GRE = 376,
    OF_BSN_VPORT_Q_IN_Q = 377,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 378,
    OF_BUCKET = 379,
    OF_BUCKET_COUNTER = 380,
    OF_BUNDLE_PROP = 381,
    OF_BUNDLE_PROP_EXPERIMENTER = 382,
    OF_FLOW_STATS_ENTRY = 383,
    OF_GROUP_DESC_STATS_ENTRY = 384,
    OF_GROUP_STATS_ENTRY = 385,
    OF_HELLO_ELEM = 386,
    OF_HELLO_ELEM_VERSIONBITMAP = 387,
    OF_INSTRUCTION = 388,
    OF_INSTRUCTION_APPLY_ACTIONS = 389,
    OF_INSTRUCTION_BSN = 390,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 391,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 392,
    OF_INSTRUCTION_BSN_DENY = 393,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 394,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 395,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 396,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 397,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 398,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 399,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 400,
    OF_INSTRUCTION_BSN_PERMIT = 401,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 402,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 403,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 404,
    OF_INSTRUCTION_CLEAR_ACTIONS = 405,
    OF_INSTRUCTION_EXPERIMENTER = 406,
    OF_INSTRUCTION_GOTO_TABLE = 407,
    OF_INSTRUCTION_ID = 408,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 409,
    OF_INSTRUCTION_ID_BSN = 410,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 411,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 412,
    OF_INSTRUCTION_ID_BSN_DENY = 413,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 414,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 415,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 416,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 417,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 418,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 419,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 420,
    OF_INSTRUCTION_ID_BSN_PERMIT = 421,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 422,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 423,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 424,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 425,
    OF_INSTRUCTION_ID_EXPERIMENTER = 426,
    OF_INSTRUCTION_ID_GOTO_TABLE = 427,
    OF_INSTRUCTION_ID_METER = 428,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 429,
    OF_INSTRUCTION_ID_WRITE_METADATA = 430,
    OF_INSTRUCTION_METER = 431,
    OF_INSTRUCTION_WRITE_ACTIONS = 432,
    OF_INSTRUCTION_WRITE_METADATA = 433,
    OF_MATCH_V1 = 434,
    OF_MATCH_V2 = 435,
    OF_MATCH_V3 = 436,
    OF_METER_BAND = 437,
    OF_METER_BAND_DROP = 438,
    OF_METER_BAND_DSCP_REMARK = 439,
    OF_METER_BAND_EXPERIMENTER = 440,
    OF_METER_BAND_STATS = 441,
    OF_METER_CONFIG = 442,
    OF_METER_FEATURES = 443,
    OF_METER_STATS = 444,
    OF_OXM = 445,
    OF_OXM_ARP_OP = 446,
    OF_OXM_ARP_OP_MASKED = 447,
    OF_OXM_ARP_SHA = 448,
    OF_OXM_ARP_SHA_MASKED = 449,
    OF_OXM_ARP_SPA = 450,
    OF_OXM_ARP_SPA_MASKED = 451,
    OF_OXM_ARP_THA = 452,
    OF_OXM_ARP_THA_MASKED = 453,
    OF_OXM_ARP_TPA = 454,
    OF_OXM_ARP_TPA_MASKED = 455,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 456,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 457,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 458,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 459,
    OF_OXM_BSN_IN_PORTS_128 = 460,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 461,
    OF_OXM_BSN_IN_PORTS_512 = 462,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 463,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 464,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 465,
    OF_OXM_BSN_INNER_ETH_DST = 466,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 467,
    OF_OXM_BSN_INNER_ETH_SRC = 468,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 469,
    OF_OXM_BSN_L2_CACHE_HIT = 470,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 471,
    OF_OXM_BSN_L3_DST_CLASS_ID = 472,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 473,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 474,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 475,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 476,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 477,
    OF_OXM_BSN_LAG_ID = 478,
    OF_OXM_BSN_LAG_ID_MASKED = 479,
    OF_OXM_BSN_TCP_FLAGS = 480,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 481,
    OF_OXM_BSN_UDF0 = 482,
    OF_OXM_BSN_UDF0_MASKED = 483,
    OF_OXM_BSN_UDF1 = 484,
    OF_OXM_BSN_UDF1_MASKED = 485,
    OF_OXM_BSN_UDF2 = 486,
    OF_OXM_BSN_UDF2_MASKED = 487,
    OF_OXM_BSN_UDF3 = 488,
    OF_OXM_BSN_UDF3_MASKED = 489,
    OF_OXM_BSN_UDF4 = 490,
    OF_OXM_BSN_UDF4_MASKED = 491,
    OF_OXM_BSN_UDF5 = 492,
    OF_OXM_BSN_UDF5_MASKED = 493,
    OF_OXM_BSN_UDF6 = 494,
    OF_OXM_BSN_UDF6_MASKED = 495,
    OF_OXM_BSN_UDF7 = 496,
    OF_OXM_BSN_UDF7_MASKED = 497,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 498,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 499,
    OF_OXM_BSN_VRF = 500,
    OF_OXM_BSN_VRF_MASKED = 501,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 502,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 503,
    OF_OXM_ETH_DST = 504,
    OF_OXM_ETH_DST_MASKED = 505,
    OF_OXM_ETH_SRC = 506,
    OF_OXM_ETH_SRC_MASKED = 507,
    OF_OXM_ETH_TYPE = 508,
    OF_OXM_ETH_TYPE_MASKED = 509,
    OF_OXM_ICMPV4_CODE = 510,
    OF_OXM_ICMPV4_CODE_MASKED = 511,
    OF_OXM_ICMPV4_TYPE = 512,
    OF_OXM_ICMPV4_TYPE_MASKED = 513,
    OF_OXM_ICMPV6_CODE = 514,
    OF_OXM_ICMPV6_CODE_MASKED = 515,
    OF_OXM_ICMPV6_TYPE = 516,
    OF_OXM_ICMPV6_TYPE_MASKED = 517,
    OF_OXM_IN_PHY_PORT = 518,
    OF_OXM_IN_PHY_PORT_MASKED = 519,
    OF_OXM_IN_PORT = 520,
    OF_OXM_IN_PORT_MASKED = 521,
    OF_OXM_IP_DSCP = 522,
    OF_OXM_IP_DSCP_MASKED = 523,
    OF_OXM_IP_ECN = 524,
    OF_OXM_IP_ECN_MASKED = 525,
    OF_OXM_IP_PROTO = 526,
    OF_OXM_IP_PROTO_MASKED = 527,
    OF_OXM_IPV4_DST = 528,
    OF_OXM_IPV4_DST_MASKED = 529,
    OF_OXM_IPV4_SRC = 530,
    OF_OXM_IPV4_SRC_MASKED = 531,
    OF_OXM_IPV6_DST = 532,
    OF_OXM_IPV6_DST_MASKED = 533,
    OF_OXM_IPV6_EXTHDR = 534,
    OF_OXM_IPV6_EXTHDR_MASKED = 535,
    OF_OXM_IPV6_FLABEL = 536,
    OF_OXM_IPV6_FLABEL_MASKED = 537,
    OF_OXM_IPV6_ND_SLL = 538,
    OF_OXM_IPV6_ND_SLL_MASKED = 539,
    OF_OXM_IPV6_ND_TARGET = 540,
    OF_OXM_IPV6_ND_TARGET_MASKED = 541,
    OF_OXM_IPV6_ND_TLL = 542,
    OF_OXM_IPV6_ND_TLL_MASKED = 543,
    OF_OXM_IPV6_SRC = 544,
    OF_OXM_IPV6_SRC_MASKED = 545,
    OF_OXM_METADATA = 546,
    OF_OXM_METADATA_MASKED = 547,
    OF_OXM_MPLS_BOS = 548,
    OF_OXM_MPLS_BOS_MASKED = 549,
    OF_OXM_MPLS_LABEL = 550,
    OF_OXM_MPLS_LABEL_MASKED = 551,
    OF_OXM_MPLS_TC = 552,
    OF_OXM_MPLS_TC_MASKED = 553,
    OF_OXM_PBB_UCA = 554,
    OF_OXM_PBB_UCA_MASKED = 555,
    OF_OXM_SCTP_DST = 556,
    OF_OXM_SCTP_DST_MASKED = 557,
    OF_OXM_SCTP_SRC = 558,
    OF_OXM_SCTP_SRC_MASKED = 559,
    OF_OXM_TCP_DST = 560,
    OF_OXM_TCP_DST_MASKED = 561,
    OF_OXM_TCP_SRC = 562,
    OF_OXM_TCP_SRC_MASKED = 563,
    OF_OXM_TUNNEL_ID = 564,
    OF_OXM_TUNNEL_ID_MASKED = 565,
    OF_OXM_TUNNEL_IPV4_DST = 566,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 567,
    OF_OXM_TUNNEL_IPV4_SRC = 568,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 569,
    OF_OXM_UDP_DST = 570,
    OF_OXM_UDP_DST_MASKED = 571,
    OF_OXM_UDP_SRC = 572,
    OF_OXM_UDP_SRC_MASKED = 573,
    OF_OXM_VLAN_PCP = 574,
    OF_OXM_VLAN_PCP_MASKED = 575,
    OF_OXM_VLAN_VID = 576,
    OF_OXM_VLAN_VID_MASKED = 577,
    OF_PACKET_QUEUE = 578,
    OF_PORT_DESC = 579,
    OF_PORT_DESC_PROP = 580,
    OF_PORT_DESC_PROP_BSN = 581,
    OF_PORT_DESC_PROP_BSN_UPLINK = 582,
    OF_PORT_DESC_PROP_ETHERNET = 583,
    OF_PORT_DESC_PROP_EXPERIMENTER = 584,
    OF_PORT_DESC_PROP_OPTICAL = 585,
    OF_PORT_MOD_PROP = 586,
    OF_PORT_MOD_PROP_ETHERNET = 587,
    OF_PORT_MOD_PROP_EXPERIMENTER = 588,
    OF_PORT_MOD_PROP_OPTICAL = 589,
    OF_PORT_STATS_ENTRY = 590,
    OF_PORT_STATS_PROP = 591,
    OF_PORT_STATS_PROP_ETHERNET = 592,
    OF_PORT_STATS_PROP_EXPERIMENTER = 593,
    OF_PORT_STATS_PROP_OPTICAL = 594,
    OF_QUEUE_DESC = 595,
    OF_QUEUE_DESC_PROP = 596,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 597,
    OF_QUEUE_DESC_PROP_MAX_RATE = 598,
    OF_QUEUE_DESC_PROP_MIN_RATE = 599,
    OF_QUEUE_PROP = 600,
    OF_QUEUE_PROP_EXPERIMENTER = 601,
    OF_QUEUE_PROP_MAX_RATE = 602,
    OF_QUEUE_PROP_MIN_RATE = 603,
    OF_QUEUE_STATS_ENTRY = 604,
    OF_QUEUE_STATS_PROP = 605,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 606,
    OF_ROLE_PROP = 607,
    OF_ROLE_PROP_EXPERIMENTER = 608,
    OF_TABLE_DESC = 609,
    OF_TABLE_FEATURE_PROP = 610,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 611,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 612,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 613,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 614,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 615,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 616,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 617,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 618,
    OF_TABLE_FEATURE_PROP_MATCH = 619,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 620,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 621,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 622,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 623,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 624,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 625,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 626,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 627,
    OF_TABLE_FEATURES = 628,
    OF_TABLE_MOD_PROP = 629,
    OF_TABLE_MOD_PROP_EVICTION = 630,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 631,
    OF_TABLE_MOD_PROP_VACANCY = 632,
    OF_TABLE_STATS_ENTRY = 633,
    OF_UINT32 = 634,
    OF_UINT64 = 635,
    OF_UINT8 = 636,
    ...
    /* List objects */
    OF_LIST_ACTION = 637,
    OF_LIST_ACTION_ID = 638,
    OF_LIST_ASYNC_CONFIG_PROP = 639,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 640,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 641,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 642,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 643,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 644,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 645,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 646,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 647,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 648,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 649,
    OF_LIST_BSN_INTERFACE = 650,
    OF_LIST_BSN_LACP_STATS_ENTRY = 651,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 652,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 653,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 654,
    OF_LIST_BSN_TLV = 655,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 656,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 657,
    OF_LIST_BUCKET = 658,
    OF_LIST_BUCKET_COUNTER = 659,
    OF_LIST_BUNDLE_PROP = 660,
    OF_LIST_FLOW_STATS_ENTRY = 661,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 662,
    OF_LIST_GROUP_STATS_ENTRY = 663,
    OF_LIST_HELLO_ELEM = 664,
    OF_LIST_INSTRUCTION = 665,
    OF_LIST_INSTRUCTION_ID = 666,
    OF_LIST_METER_BAND = 667,
    OF_LIST_METER_BAND_STATS = 668,
    OF_LIST_METER_STATS = 669,
    OF_LIST_OXM = 670,
    OF_LIST_PACKET_QUEUE = 671,
    OF_LIST_PORT_DESC = 672,
    OF_LIST_PORT_DESC_PROP = 673,
    OF_LIST_PORT_MOD_PROP = 674,
    OF_LIST_PORT_STATS_ENTRY = 675,
    OF_LIST_PORT_STATS_PROP = 676,
    OF_LIST_QUEUE_DESC = 677,
    OF_LIST_QUEUE_DESC_PROP = 678,
    OF_LIST_QUEUE_PROP = 679,
    OF_LIST_QUEUE_STATS_ENTRY = 680,
    OF_LIST_QUEUE_STATS_PROP = 681,
    OF_LIST_ROLE_PROP = 682,
    OF_LIST_TABLE_DESC = 683,
    OF_LIST_TABLE_FEATURE_PROP = 684,
    OF_LIST_TABLE_FEATURES = 685,
    OF_LIST_TABLE_MOD_PROP = 686,
    OF_LIST_TABLE_STATS_ENTRY = 687,
    OF_LIST_UINT32 = 688,
    OF_LIST_UINT64 = 689,
    OF_LIST_UINT8 = 690,
