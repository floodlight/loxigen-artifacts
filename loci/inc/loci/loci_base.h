...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DATA = 311,
    OF_BSN_TLV_ETH_DST = 312,
    OF_BSN_TLV_ETH_SRC = 313,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 314,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 315,
    OF_BSN_TLV_EXTERNAL_IP = 316,
    OF_BSN_TLV_EXTERNAL_MAC = 317,
    OF_BSN_TLV_EXTERNAL_NETMASK = 318,
    OF_BSN_TLV_GENERATION_ID = 319,
    OF_BSN_TLV_HEADER_SIZE = 320,
    OF_BSN_TLV_ICMP_CODE = 321,
    OF_BSN_TLV_ICMP_ID = 322,
    OF_BSN_TLV_ICMP_TYPE = 323,
    OF_BSN_TLV_IDLE_NOTIFICATION = 324,
    OF_BSN_TLV_IDLE_TIME = 325,
    OF_BSN_TLV_IDLE_TIMEOUT = 326,
    OF_BSN_TLV_IGMP_SNOOPING = 327,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 328,
    OF_BSN_TLV_INTERNAL_MAC = 329,
    OF_BSN_TLV_INTERVAL = 330,
    OF_BSN_TLV_IP_PROTO = 331,
    OF_BSN_TLV_IPV4 = 332,
    OF_BSN_TLV_IPV4_DST = 333,
    OF_BSN_TLV_IPV4_NETMASK = 334,
    OF_BSN_TLV_IPV4_SRC = 335,
    OF_BSN_TLV_IPV6 = 336,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 337,
    OF_BSN_TLV_MAC = 338,
    OF_BSN_TLV_MAC_MASK = 339,
    OF_BSN_TLV_MISS_PACKETS = 340,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 341,
    OF_BSN_TLV_MPLS_LABEL = 342,
    OF_BSN_TLV_MPLS_SEQUENCED = 343,
    OF_BSN_TLV_NAME = 344,
    OF_BSN_TLV_NEGATE = 345,
    OF_BSN_TLV_OFFSET = 346,
    OF_BSN_TLV_PARTNER_KEY = 347,
    OF_BSN_TLV_PARTNER_PORT_NUM = 348,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 349,
    OF_BSN_TLV_PARTNER_STATE = 350,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 351,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 352,
    OF_BSN_TLV_PORT = 353,
    OF_BSN_TLV_PRIORITY = 354,
    OF_BSN_TLV_QUEUE_ID = 355,
    OF_BSN_TLV_QUEUE_WEIGHT = 356,
    OF_BSN_TLV_REFERENCE = 357,
    OF_BSN_TLV_REPLY_PACKETS = 358,
    OF_BSN_TLV_REQUEST_PACKETS = 359,
    OF_BSN_TLV_RX_BYTES = 360,
    OF_BSN_TLV_RX_PACKETS = 361,
    OF_BSN_TLV_SAMPLING_RATE = 362,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 363,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 364,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 365,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 366,
    OF_BSN_TLV_SUB_AGENT_ID = 367,
    OF_BSN_TLV_TCP_DST = 368,
    OF_BSN_TLV_TCP_SRC = 369,
    OF_BSN_TLV_TX_BYTES = 370,
    OF_BSN_TLV_TX_PACKETS = 371,
    OF_BSN_TLV_UDF_ANCHOR = 372,
    OF_BSN_TLV_UDF_ID = 373,
    OF_BSN_TLV_UDF_LENGTH = 374,
    OF_BSN_TLV_UDF_OFFSET = 375,
    OF_BSN_TLV_UDP_DST = 376,
    OF_BSN_TLV_UDP_SRC = 377,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 378,
    OF_BSN_TLV_VLAN_PCP = 379,
    OF_BSN_TLV_VLAN_VID = 380,
    OF_BSN_TLV_VLAN_VID_MASK = 381,
    OF_BSN_TLV_VRF = 382,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 383,
    OF_BSN_VPORT = 384,
    OF_BSN_VPORT_L2GRE = 385,
    OF_BSN_VPORT_Q_IN_Q = 386,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 387,
    OF_BUCKET = 388,
    OF_BUCKET_COUNTER = 389,
    OF_BUNDLE_PROP = 390,
    OF_BUNDLE_PROP_EXPERIMENTER = 391,
    OF_FLOW_STATS_ENTRY = 392,
    OF_GROUP_DESC_STATS_ENTRY = 393,
    OF_GROUP_STATS_ENTRY = 394,
    OF_HELLO_ELEM = 395,
    OF_HELLO_ELEM_VERSIONBITMAP = 396,
    OF_INSTRUCTION = 397,
    OF_INSTRUCTION_APPLY_ACTIONS = 398,
    OF_INSTRUCTION_BSN = 399,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 400,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 401,
    OF_INSTRUCTION_BSN_DENY = 402,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 403,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 404,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 405,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 406,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 407,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 408,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 409,
    OF_INSTRUCTION_BSN_PERMIT = 410,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 411,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 412,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 413,
    OF_INSTRUCTION_CLEAR_ACTIONS = 414,
    OF_INSTRUCTION_EXPERIMENTER = 415,
    OF_INSTRUCTION_GOTO_TABLE = 416,
    OF_INSTRUCTION_ID = 417,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 418,
    OF_INSTRUCTION_ID_BSN = 419,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 420,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 421,
    OF_INSTRUCTION_ID_BSN_DENY = 422,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 423,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 424,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 425,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 426,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 427,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 428,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 429,
    OF_INSTRUCTION_ID_BSN_PERMIT = 430,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 431,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 432,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 433,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 434,
    OF_INSTRUCTION_ID_EXPERIMENTER = 435,
    OF_INSTRUCTION_ID_GOTO_TABLE = 436,
    OF_INSTRUCTION_ID_METER = 437,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 438,
    OF_INSTRUCTION_ID_WRITE_METADATA = 439,
    OF_INSTRUCTION_METER = 440,
    OF_INSTRUCTION_WRITE_ACTIONS = 441,
    OF_INSTRUCTION_WRITE_METADATA = 442,
    OF_MATCH_V1 = 443,
    OF_MATCH_V2 = 444,
    OF_MATCH_V3 = 445,
    OF_METER_BAND = 446,
    OF_METER_BAND_DROP = 447,
    OF_METER_BAND_DSCP_REMARK = 448,
    OF_METER_BAND_EXPERIMENTER = 449,
    OF_METER_BAND_STATS = 450,
    OF_METER_CONFIG = 451,
    OF_METER_FEATURES = 452,
    OF_METER_STATS = 453,
    OF_OXM = 454,
    OF_OXM_ARP_OP = 455,
    OF_OXM_ARP_OP_MASKED = 456,
    OF_OXM_ARP_SHA = 457,
    OF_OXM_ARP_SHA_MASKED = 458,
    OF_OXM_ARP_SPA = 459,
    OF_OXM_ARP_SPA_MASKED = 460,
    OF_OXM_ARP_THA = 461,
    OF_OXM_ARP_THA_MASKED = 462,
    OF_OXM_ARP_TPA = 463,
    OF_OXM_ARP_TPA_MASKED = 464,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 465,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 466,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 467,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 468,
    OF_OXM_BSN_IN_PORTS_128 = 469,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 470,
    OF_OXM_BSN_IN_PORTS_512 = 471,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 472,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 473,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 474,
    OF_OXM_BSN_INNER_ETH_DST = 475,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 476,
    OF_OXM_BSN_INNER_ETH_SRC = 477,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 478,
    OF_OXM_BSN_INNER_VLAN_VID = 479,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 480,
    OF_OXM_BSN_L2_CACHE_HIT = 481,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 482,
    OF_OXM_BSN_L3_DST_CLASS_ID = 483,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 484,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 485,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 486,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 487,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 488,
    OF_OXM_BSN_LAG_ID = 489,
    OF_OXM_BSN_LAG_ID_MASKED = 490,
    OF_OXM_BSN_TCP_FLAGS = 491,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 492,
    OF_OXM_BSN_UDF0 = 493,
    OF_OXM_BSN_UDF0_MASKED = 494,
    OF_OXM_BSN_UDF1 = 495,
    OF_OXM_BSN_UDF1_MASKED = 496,
    OF_OXM_BSN_UDF2 = 497,
    OF_OXM_BSN_UDF2_MASKED = 498,
    OF_OXM_BSN_UDF3 = 499,
    OF_OXM_BSN_UDF3_MASKED = 500,
    OF_OXM_BSN_UDF4 = 501,
    OF_OXM_BSN_UDF4_MASKED = 502,
    OF_OXM_BSN_UDF5 = 503,
    OF_OXM_BSN_UDF5_MASKED = 504,
    OF_OXM_BSN_UDF6 = 505,
    OF_OXM_BSN_UDF6_MASKED = 506,
    OF_OXM_BSN_UDF7 = 507,
    OF_OXM_BSN_UDF7_MASKED = 508,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 509,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 510,
    OF_OXM_BSN_VRF = 511,
    OF_OXM_BSN_VRF_MASKED = 512,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 513,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 514,
    OF_OXM_ETH_DST = 515,
    OF_OXM_ETH_DST_MASKED = 516,
    OF_OXM_ETH_SRC = 517,
    OF_OXM_ETH_SRC_MASKED = 518,
    OF_OXM_ETH_TYPE = 519,
    OF_OXM_ETH_TYPE_MASKED = 520,
    OF_OXM_ICMPV4_CODE = 521,
    OF_OXM_ICMPV4_CODE_MASKED = 522,
    OF_OXM_ICMPV4_TYPE = 523,
    OF_OXM_ICMPV4_TYPE_MASKED = 524,
    OF_OXM_ICMPV6_CODE = 525,
    OF_OXM_ICMPV6_CODE_MASKED = 526,
    OF_OXM_ICMPV6_TYPE = 527,
    OF_OXM_ICMPV6_TYPE_MASKED = 528,
    OF_OXM_IN_PHY_PORT = 529,
    OF_OXM_IN_PHY_PORT_MASKED = 530,
    OF_OXM_IN_PORT = 531,
    OF_OXM_IN_PORT_MASKED = 532,
    OF_OXM_IP_DSCP = 533,
    OF_OXM_IP_DSCP_MASKED = 534,
    OF_OXM_IP_ECN = 535,
    OF_OXM_IP_ECN_MASKED = 536,
    OF_OXM_IP_PROTO = 537,
    OF_OXM_IP_PROTO_MASKED = 538,
    OF_OXM_IPV4_DST = 539,
    OF_OXM_IPV4_DST_MASKED = 540,
    OF_OXM_IPV4_SRC = 541,
    OF_OXM_IPV4_SRC_MASKED = 542,
    OF_OXM_IPV6_DST = 543,
    OF_OXM_IPV6_DST_MASKED = 544,
    OF_OXM_IPV6_EXTHDR = 545,
    OF_OXM_IPV6_EXTHDR_MASKED = 546,
    OF_OXM_IPV6_FLABEL = 547,
    OF_OXM_IPV6_FLABEL_MASKED = 548,
    OF_OXM_IPV6_ND_SLL = 549,
    OF_OXM_IPV6_ND_SLL_MASKED = 550,
    OF_OXM_IPV6_ND_TARGET = 551,
    OF_OXM_IPV6_ND_TARGET_MASKED = 552,
    OF_OXM_IPV6_ND_TLL = 553,
    OF_OXM_IPV6_ND_TLL_MASKED = 554,
    OF_OXM_IPV6_SRC = 555,
    OF_OXM_IPV6_SRC_MASKED = 556,
    OF_OXM_METADATA = 557,
    OF_OXM_METADATA_MASKED = 558,
    OF_OXM_MPLS_BOS = 559,
    OF_OXM_MPLS_BOS_MASKED = 560,
    OF_OXM_MPLS_LABEL = 561,
    OF_OXM_MPLS_LABEL_MASKED = 562,
    OF_OXM_MPLS_TC = 563,
    OF_OXM_MPLS_TC_MASKED = 564,
    OF_OXM_PBB_UCA = 565,
    OF_OXM_PBB_UCA_MASKED = 566,
    OF_OXM_SCTP_DST = 567,
    OF_OXM_SCTP_DST_MASKED = 568,
    OF_OXM_SCTP_SRC = 569,
    OF_OXM_SCTP_SRC_MASKED = 570,
    OF_OXM_TCP_DST = 571,
    OF_OXM_TCP_DST_MASKED = 572,
    OF_OXM_TCP_SRC = 573,
    OF_OXM_TCP_SRC_MASKED = 574,
    OF_OXM_TUNNEL_ID = 575,
    OF_OXM_TUNNEL_ID_MASKED = 576,
    OF_OXM_TUNNEL_IPV4_DST = 577,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 578,
    OF_OXM_TUNNEL_IPV4_SRC = 579,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 580,
    OF_OXM_UDP_DST = 581,
    OF_OXM_UDP_DST_MASKED = 582,
    OF_OXM_UDP_SRC = 583,
    OF_OXM_UDP_SRC_MASKED = 584,
    OF_OXM_VLAN_PCP = 585,
    OF_OXM_VLAN_PCP_MASKED = 586,
    OF_OXM_VLAN_VID = 587,
    OF_OXM_VLAN_VID_MASKED = 588,
    OF_PACKET_QUEUE = 589,
    OF_PORT_DESC = 590,
    OF_PORT_DESC_PROP = 591,
    OF_PORT_DESC_PROP_BSN = 592,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 593,
    OF_PORT_DESC_PROP_BSN_UPLINK = 594,
    OF_PORT_DESC_PROP_ETHERNET = 595,
    OF_PORT_DESC_PROP_EXPERIMENTER = 596,
    OF_PORT_DESC_PROP_OPTICAL = 597,
    OF_PORT_MOD_PROP = 598,
    OF_PORT_MOD_PROP_ETHERNET = 599,
    OF_PORT_MOD_PROP_EXPERIMENTER = 600,
    OF_PORT_MOD_PROP_OPTICAL = 601,
    OF_PORT_STATS_ENTRY = 602,
    OF_PORT_STATS_PROP = 603,
    OF_PORT_STATS_PROP_ETHERNET = 604,
    OF_PORT_STATS_PROP_EXPERIMENTER = 605,
    OF_PORT_STATS_PROP_OPTICAL = 606,
    OF_QUEUE_DESC = 607,
    OF_QUEUE_DESC_PROP = 608,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 609,
    OF_QUEUE_DESC_PROP_MAX_RATE = 610,
    OF_QUEUE_DESC_PROP_MIN_RATE = 611,
    OF_QUEUE_PROP = 612,
    OF_QUEUE_PROP_EXPERIMENTER = 613,
    OF_QUEUE_PROP_MAX_RATE = 614,
    OF_QUEUE_PROP_MIN_RATE = 615,
    OF_QUEUE_STATS_ENTRY = 616,
    OF_QUEUE_STATS_PROP = 617,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 618,
    OF_ROLE_PROP = 619,
    OF_ROLE_PROP_EXPERIMENTER = 620,
    OF_TABLE_DESC = 621,
    OF_TABLE_FEATURE_PROP = 622,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 623,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 624,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 625,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 626,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 627,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 628,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 629,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 630,
    OF_TABLE_FEATURE_PROP_MATCH = 631,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 632,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 633,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 634,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 635,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 636,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 637,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 638,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 639,
    OF_TABLE_FEATURES = 640,
    OF_TABLE_MOD_PROP = 641,
    OF_TABLE_MOD_PROP_EVICTION = 642,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 643,
    OF_TABLE_MOD_PROP_VACANCY = 644,
    OF_TABLE_STATS_ENTRY = 645,
    OF_UINT32 = 646,
    OF_UINT64 = 647,
    OF_UINT8 = 648,
    ...
    /* List objects */
    OF_LIST_ACTION = 649,
    OF_LIST_ACTION_ID = 650,
    OF_LIST_ASYNC_CONFIG_PROP = 651,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 652,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 653,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 654,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 655,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 656,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 657,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 658,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 659,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 660,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 661,
    OF_LIST_BSN_INTERFACE = 662,
    OF_LIST_BSN_LACP_STATS_ENTRY = 663,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 664,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 665,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 666,
    OF_LIST_BSN_TLV = 667,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 668,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 669,
    OF_LIST_BUCKET = 670,
    OF_LIST_BUCKET_COUNTER = 671,
    OF_LIST_BUNDLE_PROP = 672,
    OF_LIST_FLOW_STATS_ENTRY = 673,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 674,
    OF_LIST_GROUP_STATS_ENTRY = 675,
    OF_LIST_HELLO_ELEM = 676,
    OF_LIST_INSTRUCTION = 677,
    OF_LIST_INSTRUCTION_ID = 678,
    OF_LIST_METER_BAND = 679,
    OF_LIST_METER_BAND_STATS = 680,
    OF_LIST_METER_CONFIG = 681,
    OF_LIST_METER_STATS = 682,
    OF_LIST_OXM = 683,
    OF_LIST_PACKET_QUEUE = 684,
    OF_LIST_PORT_DESC = 685,
    OF_LIST_PORT_DESC_PROP = 686,
    OF_LIST_PORT_MOD_PROP = 687,
    OF_LIST_PORT_STATS_ENTRY = 688,
    OF_LIST_PORT_STATS_PROP = 689,
    OF_LIST_QUEUE_DESC = 690,
    OF_LIST_QUEUE_DESC_PROP = 691,
    OF_LIST_QUEUE_PROP = 692,
    OF_LIST_QUEUE_STATS_ENTRY = 693,
    OF_LIST_QUEUE_STATS_PROP = 694,
    OF_LIST_ROLE_PROP = 695,
    OF_LIST_TABLE_DESC = 696,
    OF_LIST_TABLE_FEATURE_PROP = 697,
    OF_LIST_TABLE_FEATURES = 698,
    OF_LIST_TABLE_MOD_PROP = 699,
    OF_LIST_TABLE_STATS_ENTRY = 700,
    OF_LIST_UINT32 = 701,
    OF_LIST_UINT64 = 702,
    OF_LIST_UINT8 = 703,
