...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_GENERATION_ID = 338,
    OF_BSN_TLV_HASH_ALGORITHM = 339,
    ...
    OF_BSN_TLV_LOOPBACK_MODE = 373,
    OF_BSN_TLV_LOOPBACK_PORT = 374,
    OF_BSN_TLV_MAC = 375,
    OF_BSN_TLV_MAC_MASK = 376,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 377,
    OF_BSN_TLV_MISS_PACKETS = 378,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 379,
    OF_BSN_TLV_MPLS_LABEL = 380,
    OF_BSN_TLV_MPLS_SEQUENCED = 381,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 382,
    OF_BSN_TLV_NAME = 383,
    OF_BSN_TLV_NDP_OFFLOAD = 384,
    OF_BSN_TLV_NDP_STATIC = 385,
    OF_BSN_TLV_NEGATE = 386,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 387,
    OF_BSN_TLV_NEXT_HOP_MAC = 388,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 389,
    OF_BSN_TLV_NO_ARP_RESPONSE = 390,
    OF_BSN_TLV_NO_NS_RESPONSE = 391,
    OF_BSN_TLV_OFFSET = 392,
    OF_BSN_TLV_PARENT_PORT = 393,
    OF_BSN_TLV_PARTNER_KEY = 394,
    OF_BSN_TLV_PARTNER_PORT_NUM = 395,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 396,
    OF_BSN_TLV_PARTNER_STATE = 397,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 398,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 399,
    OF_BSN_TLV_PORT = 400,
    OF_BSN_TLV_PORT_USAGE = 401,
    OF_BSN_TLV_PORT_VXLAN_MODE = 402,
    OF_BSN_TLV_PRIORITY = 403,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 404,
    OF_BSN_TLV_QOS_PRIORITY = 405,
    OF_BSN_TLV_QUEUE_ID = 406,
    OF_BSN_TLV_QUEUE_WEIGHT = 407,
    OF_BSN_TLV_RATE_LIMIT = 408,
    OF_BSN_TLV_RATE_UNIT = 409,
    OF_BSN_TLV_REFERENCE = 410,
    OF_BSN_TLV_REPLY_PACKETS = 411,
    OF_BSN_TLV_REQUEST_PACKETS = 412,
    OF_BSN_TLV_RX_BYTES = 413,
    OF_BSN_TLV_RX_PACKETS = 414,
    OF_BSN_TLV_SAMPLING_RATE = 415,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 416,
    OF_BSN_TLV_STATUS = 417,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 418,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 419,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 420,
    OF_BSN_TLV_SUB_AGENT_ID = 421,
    OF_BSN_TLV_TCP_DST = 422,
    OF_BSN_TLV_TCP_FLAGS = 423,
    OF_BSN_TLV_TCP_SRC = 424,
    OF_BSN_TLV_TTL = 425,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 426,
    OF_BSN_TLV_TX_BYTES = 427,
    OF_BSN_TLV_TX_PACKETS = 428,
    OF_BSN_TLV_UDF_ANCHOR = 429,
    OF_BSN_TLV_UDF_ID = 430,
    OF_BSN_TLV_UDF_LENGTH = 431,
    OF_BSN_TLV_UDF_OFFSET = 432,
    OF_BSN_TLV_UDP_DST = 433,
    OF_BSN_TLV_UDP_SRC = 434,
    OF_BSN_TLV_UINT64_LIST = 435,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 436,
    OF_BSN_TLV_UNICAST_RATE = 437,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 438,
    OF_BSN_TLV_UNTAGGED = 439,
    OF_BSN_TLV_USE_PACKET_STATE = 440,
    OF_BSN_TLV_VFI = 441,
    OF_BSN_TLV_VFP_CLASS_ID = 442,
    OF_BSN_TLV_VLAN_MAC_LIST = 443,
    OF_BSN_TLV_VLAN_PCP = 444,
    OF_BSN_TLV_VLAN_VID = 445,
    OF_BSN_TLV_VLAN_VID_MASK = 446,
    OF_BSN_TLV_VNI = 447,
    OF_BSN_TLV_VPN_KEY = 448,
    OF_BSN_TLV_VRF = 449,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 450,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 451,
    OF_BSN_VLAN_MAC = 452,
    OF_BSN_VPORT = 453,
    OF_BSN_VPORT_L2GRE = 454,
    OF_BSN_VPORT_Q_IN_Q = 455,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 456,
    OF_BUCKET = 457,
    OF_BUCKET_COUNTER = 458,
    OF_BUNDLE_PROP = 459,
    OF_BUNDLE_PROP_EXPERIMENTER = 460,
    OF_FLOW_STATS_ENTRY = 461,
    OF_GROUP_DESC_STATS_ENTRY = 462,
    OF_GROUP_STATS_ENTRY = 463,
    OF_HELLO_ELEM = 464,
    OF_HELLO_ELEM_VERSIONBITMAP = 465,
    OF_INSTRUCTION = 466,
    OF_INSTRUCTION_APPLY_ACTIONS = 467,
    OF_INSTRUCTION_BSN = 468,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 469,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 470,
    OF_INSTRUCTION_BSN_DENY = 471,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 472,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 473,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 474,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 475,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 476,
    OF_INSTRUCTION_BSN_HASH_SELECT = 477,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 478,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 479,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 480,
    OF_INSTRUCTION_BSN_PERMIT = 481,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 482,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 483,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 484,
    OF_INSTRUCTION_CLEAR_ACTIONS = 485,
    OF_INSTRUCTION_EXPERIMENTER = 486,
    OF_INSTRUCTION_GOTO_TABLE = 487,
    OF_INSTRUCTION_ID = 488,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 489,
    OF_INSTRUCTION_ID_BSN = 490,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 491,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 492,
    OF_INSTRUCTION_ID_BSN_DENY = 493,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 494,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 495,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 496,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 497,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 498,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 499,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 500,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 501,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 502,
    OF_INSTRUCTION_ID_BSN_PERMIT = 503,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 504,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 505,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 506,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 507,
    OF_INSTRUCTION_ID_EXPERIMENTER = 508,
    OF_INSTRUCTION_ID_GOTO_TABLE = 509,
    OF_INSTRUCTION_ID_METER = 510,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 511,
    OF_INSTRUCTION_ID_WRITE_METADATA = 512,
    OF_INSTRUCTION_METER = 513,
    OF_INSTRUCTION_WRITE_ACTIONS = 514,
    OF_INSTRUCTION_WRITE_METADATA = 515,
    OF_MATCH_V1 = 516,
    OF_MATCH_V2 = 517,
    OF_MATCH_V3 = 518,
    OF_METER_BAND = 519,
    OF_METER_BAND_DROP = 520,
    OF_METER_BAND_DSCP_REMARK = 521,
    OF_METER_BAND_EXPERIMENTER = 522,
    OF_METER_BAND_STATS = 523,
    OF_METER_CONFIG = 524,
    OF_METER_FEATURES = 525,
    OF_METER_STATS = 526,
    OF_OXM = 527,
    OF_OXM_ARP_OP = 528,
    OF_OXM_ARP_OP_MASKED = 529,
    OF_OXM_ARP_SHA = 530,
    OF_OXM_ARP_SHA_MASKED = 531,
    OF_OXM_ARP_SPA = 532,
    OF_OXM_ARP_SPA_MASKED = 533,
    OF_OXM_ARP_THA = 534,
    OF_OXM_ARP_THA_MASKED = 535,
    OF_OXM_ARP_TPA = 536,
    OF_OXM_ARP_TPA_MASKED = 537,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 538,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 539,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 540,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 541,
    OF_OXM_BSN_IN_PORTS_128 = 542,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 543,
    OF_OXM_BSN_IN_PORTS_512 = 544,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 545,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 546,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 547,
    OF_OXM_BSN_INNER_ETH_DST = 548,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 549,
    OF_OXM_BSN_INNER_ETH_SRC = 550,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 551,
    OF_OXM_BSN_INNER_VLAN_VID = 552,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 553,
    OF_OXM_BSN_IP_FRAGMENTATION = 554,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 555,
    OF_OXM_BSN_L2_CACHE_HIT = 556,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 557,
    OF_OXM_BSN_L3_DST_CLASS_ID = 558,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 559,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 560,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 561,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 562,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 563,
    OF_OXM_BSN_LAG_ID = 564,
    OF_OXM_BSN_LAG_ID_MASKED = 565,
    OF_OXM_BSN_TCP_FLAGS = 566,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 567,
    OF_OXM_BSN_UDF0 = 568,
    OF_OXM_BSN_UDF0_MASKED = 569,
    OF_OXM_BSN_UDF1 = 570,
    OF_OXM_BSN_UDF1_MASKED = 571,
    OF_OXM_BSN_UDF2 = 572,
    OF_OXM_BSN_UDF2_MASKED = 573,
    OF_OXM_BSN_UDF3 = 574,
    OF_OXM_BSN_UDF3_MASKED = 575,
    OF_OXM_BSN_UDF4 = 576,
    OF_OXM_BSN_UDF4_MASKED = 577,
    OF_OXM_BSN_UDF5 = 578,
    OF_OXM_BSN_UDF5_MASKED = 579,
    OF_OXM_BSN_UDF6 = 580,
    OF_OXM_BSN_UDF6_MASKED = 581,
    OF_OXM_BSN_UDF7 = 582,
    OF_OXM_BSN_UDF7_MASKED = 583,
    OF_OXM_BSN_VFI = 584,
    OF_OXM_BSN_VFI_MASKED = 585,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 586,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 587,
    OF_OXM_BSN_VRF = 588,
    OF_OXM_BSN_VRF_MASKED = 589,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 590,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 591,
    OF_OXM_ETH_DST = 592,
    OF_OXM_ETH_DST_MASKED = 593,
    OF_OXM_ETH_SRC = 594,
    OF_OXM_ETH_SRC_MASKED = 595,
    OF_OXM_ETH_TYPE = 596,
    OF_OXM_ETH_TYPE_MASKED = 597,
    OF_OXM_ICMPV4_CODE = 598,
    OF_OXM_ICMPV4_CODE_MASKED = 599,
    OF_OXM_ICMPV4_TYPE = 600,
    OF_OXM_ICMPV4_TYPE_MASKED = 601,
    OF_OXM_ICMPV6_CODE = 602,
    OF_OXM_ICMPV6_CODE_MASKED = 603,
    OF_OXM_ICMPV6_TYPE = 604,
    OF_OXM_ICMPV6_TYPE_MASKED = 605,
    OF_OXM_IN_PHY_PORT = 606,
    OF_OXM_IN_PHY_PORT_MASKED = 607,
    OF_OXM_IN_PORT = 608,
    OF_OXM_IN_PORT_MASKED = 609,
    OF_OXM_IP_DSCP = 610,
    OF_OXM_IP_DSCP_MASKED = 611,
    OF_OXM_IP_ECN = 612,
    OF_OXM_IP_ECN_MASKED = 613,
    OF_OXM_IP_PROTO = 614,
    OF_OXM_IP_PROTO_MASKED = 615,
    OF_OXM_IPV4_DST = 616,
    OF_OXM_IPV4_DST_MASKED = 617,
    OF_OXM_IPV4_SRC = 618,
    OF_OXM_IPV4_SRC_MASKED = 619,
    OF_OXM_IPV6_DST = 620,
    OF_OXM_IPV6_DST_MASKED = 621,
    OF_OXM_IPV6_EXTHDR = 622,
    OF_OXM_IPV6_EXTHDR_MASKED = 623,
    OF_OXM_IPV6_FLABEL = 624,
    OF_OXM_IPV6_FLABEL_MASKED = 625,
    OF_OXM_IPV6_ND_SLL = 626,
    OF_OXM_IPV6_ND_SLL_MASKED = 627,
    OF_OXM_IPV6_ND_TARGET = 628,
    OF_OXM_IPV6_ND_TARGET_MASKED = 629,
    OF_OXM_IPV6_ND_TLL = 630,
    OF_OXM_IPV6_ND_TLL_MASKED = 631,
    OF_OXM_IPV6_SRC = 632,
    OF_OXM_IPV6_SRC_MASKED = 633,
    OF_OXM_METADATA = 634,
    OF_OXM_METADATA_MASKED = 635,
    OF_OXM_MPLS_BOS = 636,
    OF_OXM_MPLS_BOS_MASKED = 637,
    OF_OXM_MPLS_LABEL = 638,
    OF_OXM_MPLS_LABEL_MASKED = 639,
    OF_OXM_MPLS_TC = 640,
    OF_OXM_MPLS_TC_MASKED = 641,
    OF_OXM_OVS_TCP_FLAGS = 642,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 643,
    OF_OXM_PBB_UCA = 644,
    OF_OXM_PBB_UCA_MASKED = 645,
    OF_OXM_SCTP_DST = 646,
    OF_OXM_SCTP_DST_MASKED = 647,
    OF_OXM_SCTP_SRC = 648,
    OF_OXM_SCTP_SRC_MASKED = 649,
    OF_OXM_TCP_DST = 650,
    OF_OXM_TCP_DST_MASKED = 651,
    OF_OXM_TCP_SRC = 652,
    OF_OXM_TCP_SRC_MASKED = 653,
    OF_OXM_TUNNEL_ID = 654,
    OF_OXM_TUNNEL_ID_MASKED = 655,
    OF_OXM_TUNNEL_IPV4_DST = 656,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 657,
    OF_OXM_TUNNEL_IPV4_SRC = 658,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 659,
    OF_OXM_UDP_DST = 660,
    OF_OXM_UDP_DST_MASKED = 661,
    OF_OXM_UDP_SRC = 662,
    OF_OXM_UDP_SRC_MASKED = 663,
    OF_OXM_VLAN_PCP = 664,
    OF_OXM_VLAN_PCP_MASKED = 665,
    OF_OXM_VLAN_VID = 666,
    OF_OXM_VLAN_VID_MASKED = 667,
    OF_PACKET_QUEUE = 668,
    OF_PORT_DESC = 669,
    OF_PORT_DESC_PROP = 670,
    OF_PORT_DESC_PROP_BSN = 671,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 672,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 673,
    OF_PORT_DESC_PROP_BSN_UPLINK = 674,
    OF_PORT_DESC_PROP_ETHERNET = 675,
    OF_PORT_DESC_PROP_EXPERIMENTER = 676,
    OF_PORT_DESC_PROP_OPTICAL = 677,
    OF_PORT_MOD_PROP = 678,
    OF_PORT_MOD_PROP_ETHERNET = 679,
    OF_PORT_MOD_PROP_EXPERIMENTER = 680,
    OF_PORT_MOD_PROP_OPTICAL = 681,
    OF_PORT_STATS_ENTRY = 682,
    OF_PORT_STATS_PROP = 683,
    OF_PORT_STATS_PROP_ETHERNET = 684,
    OF_PORT_STATS_PROP_EXPERIMENTER = 685,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 686,
    OF_PORT_STATS_PROP_OPTICAL = 687,
    OF_QUEUE_DESC = 688,
    OF_QUEUE_DESC_PROP = 689,
    OF_QUEUE_DESC_PROP_BSN = 690,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 691,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 692,
    OF_QUEUE_DESC_PROP_MAX_RATE = 693,
    OF_QUEUE_DESC_PROP_MIN_RATE = 694,
    OF_QUEUE_PROP = 695,
    OF_QUEUE_PROP_EXPERIMENTER = 696,
    OF_QUEUE_PROP_MAX_RATE = 697,
    OF_QUEUE_PROP_MIN_RATE = 698,
    OF_QUEUE_STATS_ENTRY = 699,
    OF_QUEUE_STATS_PROP = 700,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 701,
    OF_ROLE_PROP = 702,
    OF_ROLE_PROP_EXPERIMENTER = 703,
    OF_TABLE_DESC = 704,
    OF_TABLE_FEATURE_PROP = 705,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 706,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 707,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 708,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 709,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 710,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 711,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 712,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 713,
    OF_TABLE_FEATURE_PROP_MATCH = 714,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 715,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 716,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 717,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 718,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 719,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 720,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 721,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 722,
    OF_TABLE_FEATURES = 723,
    OF_TABLE_MOD_PROP = 724,
    OF_TABLE_MOD_PROP_EVICTION = 725,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 726,
    OF_TABLE_MOD_PROP_VACANCY = 727,
    OF_TABLE_STATS_ENTRY = 728,
    OF_UINT32 = 729,
    OF_UINT64 = 730,
    OF_UINT8 = 731,
    ...
    /* List objects */
    OF_LIST_ACTION = 732,
    OF_LIST_ACTION_ID = 733,
    OF_LIST_ASYNC_CONFIG_PROP = 734,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 735,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 736,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 737,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 738,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 739,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 740,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 741,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 742,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 743,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 744,
    OF_LIST_BSN_INTERFACE = 745,
    OF_LIST_BSN_LACP_STATS_ENTRY = 746,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 747,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 748,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 749,
    OF_LIST_BSN_TLV = 750,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 751,
    OF_LIST_BSN_VLAN_MAC = 752,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 753,
    OF_LIST_BUCKET = 754,
    OF_LIST_BUCKET_COUNTER = 755,
    OF_LIST_BUNDLE_PROP = 756,
    OF_LIST_FLOW_STATS_ENTRY = 757,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 758,
    OF_LIST_GROUP_STATS_ENTRY = 759,
    OF_LIST_HELLO_ELEM = 760,
    OF_LIST_INSTRUCTION = 761,
    OF_LIST_INSTRUCTION_ID = 762,
    OF_LIST_METER_BAND = 763,
    OF_LIST_METER_BAND_STATS = 764,
    OF_LIST_METER_CONFIG = 765,
    OF_LIST_METER_STATS = 766,
    OF_LIST_OXM = 767,
    OF_LIST_PACKET_QUEUE = 768,
    OF_LIST_PORT_DESC = 769,
    OF_LIST_PORT_DESC_PROP = 770,
    OF_LIST_PORT_MOD_PROP = 771,
    OF_LIST_PORT_STATS_ENTRY = 772,
    OF_LIST_PORT_STATS_PROP = 773,
    OF_LIST_QUEUE_DESC = 774,
    OF_LIST_QUEUE_DESC_PROP = 775,
    OF_LIST_QUEUE_PROP = 776,
    OF_LIST_QUEUE_STATS_ENTRY = 777,
    OF_LIST_QUEUE_STATS_PROP = 778,
    OF_LIST_ROLE_PROP = 779,
    OF_LIST_TABLE_DESC = 780,
    OF_LIST_TABLE_FEATURE_PROP = 781,
    OF_LIST_TABLE_FEATURES = 782,
    OF_LIST_TABLE_MOD_PROP = 783,
    OF_LIST_TABLE_STATS_ENTRY = 784,
    OF_LIST_UINT32 = 785,
    OF_LIST_UINT64 = 786,
    OF_LIST_UINT8 = 787,
