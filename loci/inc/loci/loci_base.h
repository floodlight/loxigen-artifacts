...
typedef enum of_object_id_e {
    ...
    OF_HELLO = 137,
    OF_HELLO_FAILED_ERROR_MSG = 138,
    OF_METER_CONFIG_STATS_REPLY = 139,
    OF_METER_CONFIG_STATS_REQUEST = 140,
    OF_METER_FEATURES_STATS_REPLY = 141,
    OF_METER_FEATURES_STATS_REQUEST = 142,
    OF_METER_MOD = 143,
    OF_METER_MOD_FAILED_ERROR_MSG = 144,
    OF_METER_STATS_REPLY = 145,
    OF_METER_STATS_REQUEST = 146,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 147,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 148,
    OF_NICIRA_HEADER = 149,
    OF_PACKET_IN = 150,
    OF_PACKET_OUT = 151,
    OF_PORT_DESC_STATS_REPLY = 152,
    OF_PORT_DESC_STATS_REQUEST = 153,
    OF_PORT_MOD = 154,
    OF_PORT_MOD_FAILED_ERROR_MSG = 155,
    OF_PORT_STATS_REPLY = 156,
    OF_PORT_STATS_REQUEST = 157,
    OF_PORT_STATUS = 158,
    OF_QUEUE_GET_CONFIG_REPLY = 159,
    OF_QUEUE_GET_CONFIG_REQUEST = 160,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 161,
    OF_QUEUE_STATS_REPLY = 162,
    OF_QUEUE_STATS_REQUEST = 163,
    OF_ROLE_REPLY = 164,
    OF_ROLE_REQUEST = 165,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 166,
    OF_SET_CONFIG = 167,
    OF_STATS_REPLY = 168,
    OF_STATS_REQUEST = 169,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 170,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 171,
    OF_TABLE_FEATURES_STATS_REPLY = 172,
    OF_TABLE_FEATURES_STATS_REQUEST = 173,
    OF_TABLE_MOD = 174,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 175,
    OF_TABLE_STATS_REPLY = 176,
    OF_TABLE_STATS_REQUEST = 177,

    /* Non-message objects */
    OF_ACTION = 178,
    OF_ACTION_BSN = 179,
    OF_ACTION_BSN_MIRROR = 180,
    OF_ACTION_BSN_SET_TUNNEL_DST = 181,
    OF_ACTION_COPY_TTL_IN = 182,
    OF_ACTION_COPY_TTL_OUT = 183,
    OF_ACTION_DEC_MPLS_TTL = 184,
    OF_ACTION_DEC_NW_TTL = 185,
    OF_ACTION_ENQUEUE = 186,
    OF_ACTION_EXPERIMENTER = 187,
    OF_ACTION_GROUP = 188,
    OF_ACTION_HEADER = 189,
    OF_ACTION_ID = 190,
    OF_ACTION_ID_BSN = 191,
    OF_ACTION_ID_BSN_MIRROR = 192,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 193,
    OF_ACTION_ID_COPY_TTL_IN = 194,
    OF_ACTION_ID_COPY_TTL_OUT = 195,
    OF_ACTION_ID_DEC_MPLS_TTL = 196,
    OF_ACTION_ID_DEC_NW_TTL = 197,
    OF_ACTION_ID_EXPERIMENTER = 198,
    OF_ACTION_ID_GROUP = 199,
    OF_ACTION_ID_HEADER = 200,
    OF_ACTION_ID_NICIRA = 201,
    OF_ACTION_ID_NICIRA_DEC_TTL = 202,
    OF_ACTION_ID_OUTPUT = 203,
    OF_ACTION_ID_POP_MPLS = 204,
    OF_ACTION_ID_POP_PBB = 205,
    OF_ACTION_ID_POP_VLAN = 206,
    OF_ACTION_ID_PUSH_MPLS = 207,
    OF_ACTION_ID_PUSH_PBB = 208,
    OF_ACTION_ID_PUSH_VLAN = 209,
    OF_ACTION_ID_SET_FIELD = 210,
    OF_ACTION_ID_SET_MPLS_TTL = 211,
    OF_ACTION_ID_SET_NW_TTL = 212,
    OF_ACTION_ID_SET_QUEUE = 213,
    OF_ACTION_NICIRA = 214,
    OF_ACTION_NICIRA_DEC_TTL = 215,
    OF_ACTION_OUTPUT = 216,
    OF_ACTION_POP_MPLS = 217,
    OF_ACTION_POP_PBB = 218,
    OF_ACTION_POP_VLAN = 219,
    OF_ACTION_PUSH_MPLS = 220,
    OF_ACTION_PUSH_PBB = 221,
    OF_ACTION_PUSH_VLAN = 222,
    OF_ACTION_SET_DL_DST = 223,
    OF_ACTION_SET_DL_SRC = 224,
    OF_ACTION_SET_FIELD = 225,
    OF_ACTION_SET_MPLS_LABEL = 226,
    OF_ACTION_SET_MPLS_TC = 227,
    OF_ACTION_SET_MPLS_TTL = 228,
    OF_ACTION_SET_NW_DST = 229,
    OF_ACTION_SET_NW_ECN = 230,
    OF_ACTION_SET_NW_SRC = 231,
    OF_ACTION_SET_NW_TOS = 232,
    OF_ACTION_SET_NW_TTL = 233,
    OF_ACTION_SET_QUEUE = 234,
    OF_ACTION_SET_TP_DST = 235,
    OF_ACTION_SET_TP_SRC = 236,
    OF_ACTION_SET_VLAN_PCP = 237,
    OF_ACTION_SET_VLAN_VID = 238,
    OF_ACTION_STRIP_VLAN = 239,
    OF_BSN_CONTROLLER_CONNECTION = 240,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 241,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 242,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 243,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 244,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 245,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 246,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 247,
    OF_BSN_GENTABLE_STATS_ENTRY = 248,
    OF_BSN_INTERFACE = 249,
    OF_BSN_LACP_STATS_ENTRY = 250,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 251,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 252,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 253,
    OF_BSN_TLV = 254,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 255,
    OF_BSN_TLV_CIRCUIT_ID = 256,
    OF_BSN_TLV_HEADER = 257,
    OF_BSN_TLV_IDLE_NOTIFICATION = 258,
    OF_BSN_TLV_IDLE_TIME = 259,
    OF_BSN_TLV_IDLE_TIMEOUT = 260,
    OF_BSN_TLV_IPV4 = 261,
    OF_BSN_TLV_MAC = 262,
    OF_BSN_TLV_MISS_PACKETS = 263,
    OF_BSN_TLV_PORT = 264,
    OF_BSN_TLV_REPLY_PACKETS = 265,
    OF_BSN_TLV_REQUEST_PACKETS = 266,
    OF_BSN_TLV_RX_PACKETS = 267,
    OF_BSN_TLV_TX_PACKETS = 268,
    OF_BSN_TLV_UDF_ANCHOR = 269,
    OF_BSN_TLV_UDF_ID = 270,
    OF_BSN_TLV_UDF_LENGTH = 271,
    OF_BSN_TLV_UDF_OFFSET = 272,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 273,
    OF_BSN_TLV_VLAN_VID = 274,
    OF_BSN_TLV_VRF = 275,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 276,
    OF_BSN_VPORT = 277,
    OF_BSN_VPORT_HEADER = 278,
    OF_BSN_VPORT_L2GRE = 279,
    OF_BSN_VPORT_Q_IN_Q = 280,
    OF_BUCKET = 281,
    OF_BUCKET_COUNTER = 282,
    OF_FLOW_STATS_ENTRY = 283,
    OF_GROUP_DESC_STATS_ENTRY = 284,
    OF_GROUP_STATS_ENTRY = 285,
    OF_HEADER = 286,
    OF_HELLO_ELEM = 287,
    ...
    OF_INSTRUCTION_CLEAR_ACTIONS = 300,
    OF_INSTRUCTION_EXPERIMENTER = 301,
    OF_INSTRUCTION_GOTO_TABLE = 302,
    OF_INSTRUCTION_HEADER = 303,
    OF_INSTRUCTION_ID = 304,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 305,
    OF_INSTRUCTION_ID_BSN = 306,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 307,
    OF_INSTRUCTION_ID_BSN_DENY = 308,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 309,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 310,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 311,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 312,
    OF_INSTRUCTION_ID_BSN_PERMIT = 313,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 314,
    OF_INSTRUCTION_ID_EXPERIMENTER = 315,
    OF_INSTRUCTION_ID_GOTO_TABLE = 316,
    OF_INSTRUCTION_ID_HEADER = 317,
    OF_INSTRUCTION_ID_METER = 318,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 319,
    OF_INSTRUCTION_ID_WRITE_METADATA = 320,
    OF_INSTRUCTION_METER = 321,
    OF_INSTRUCTION_WRITE_ACTIONS = 322,
    OF_INSTRUCTION_WRITE_METADATA = 323,
    OF_MATCH_V1 = 324,
    OF_MATCH_V2 = 325,
    OF_MATCH_V3 = 326,
    OF_METER_BAND = 327,
    OF_METER_BAND_DROP = 328,
    OF_METER_BAND_DSCP_REMARK = 329,
    OF_METER_BAND_EXPERIMENTER = 330,
    OF_METER_BAND_HEADER = 331,
    OF_METER_BAND_STATS = 332,
    OF_METER_CONFIG = 333,
    OF_METER_FEATURES = 334,
    OF_METER_STATS = 335,
    OF_OXM = 336,
    OF_OXM_ARP_OP = 337,
    OF_OXM_ARP_OP_MASKED = 338,
    OF_OXM_ARP_SHA = 339,
    OF_OXM_ARP_SHA_MASKED = 340,
    OF_OXM_ARP_SPA = 341,
    OF_OXM_ARP_SPA_MASKED = 342,
    OF_OXM_ARP_THA = 343,
    OF_OXM_ARP_THA_MASKED = 344,
    OF_OXM_ARP_TPA = 345,
    OF_OXM_ARP_TPA_MASKED = 346,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 347,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 348,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 349,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 350,
    OF_OXM_BSN_IN_PORTS_128 = 351,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 352,
    OF_OXM_BSN_L3_DST_CLASS_ID = 353,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 354,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 355,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 356,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 357,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 358,
    OF_OXM_BSN_LAG_ID = 359,
    OF_OXM_BSN_LAG_ID_MASKED = 360,
    OF_OXM_BSN_UDF0 = 361,
    OF_OXM_BSN_UDF0_MASKED = 362,
    OF_OXM_BSN_UDF1 = 363,
    OF_OXM_BSN_UDF1_MASKED = 364,
    OF_OXM_BSN_UDF2 = 365,
    OF_OXM_BSN_UDF2_MASKED = 366,
    OF_OXM_BSN_UDF3 = 367,
    OF_OXM_BSN_UDF3_MASKED = 368,
    OF_OXM_BSN_UDF4 = 369,
    OF_OXM_BSN_UDF4_MASKED = 370,
    OF_OXM_BSN_UDF5 = 371,
    OF_OXM_BSN_UDF5_MASKED = 372,
    OF_OXM_BSN_UDF6 = 373,
    OF_OXM_BSN_UDF6_MASKED = 374,
    OF_OXM_BSN_UDF7 = 375,
    OF_OXM_BSN_UDF7_MASKED = 376,
    OF_OXM_BSN_VRF = 377,
    OF_OXM_BSN_VRF_MASKED = 378,
    OF_OXM_ETH_DST = 379,
    OF_OXM_ETH_DST_MASKED = 380,
    OF_OXM_ETH_SRC = 381,
    OF_OXM_ETH_SRC_MASKED = 382,
    OF_OXM_ETH_TYPE = 383,
    OF_OXM_ETH_TYPE_MASKED = 384,
    OF_OXM_HEADER = 385,
    OF_OXM_ICMPV4_CODE = 386,
    OF_OXM_ICMPV4_CODE_MASKED = 387,
    OF_OXM_ICMPV4_TYPE = 388,
    OF_OXM_ICMPV4_TYPE_MASKED = 389,
    OF_OXM_ICMPV6_CODE = 390,
    OF_OXM_ICMPV6_CODE_MASKED = 391,
    OF_OXM_ICMPV6_TYPE = 392,
    OF_OXM_ICMPV6_TYPE_MASKED = 393,
    OF_OXM_IN_PHY_PORT = 394,
    OF_OXM_IN_PHY_PORT_MASKED = 395,
    OF_OXM_IN_PORT = 396,
    OF_OXM_IN_PORT_MASKED = 397,
    OF_OXM_IP_DSCP = 398,
    OF_OXM_IP_DSCP_MASKED = 399,
    OF_OXM_IP_ECN = 400,
    OF_OXM_IP_ECN_MASKED = 401,
    OF_OXM_IP_PROTO = 402,
    OF_OXM_IP_PROTO_MASKED = 403,
    OF_OXM_IPV4_DST = 404,
    OF_OXM_IPV4_DST_MASKED = 405,
    OF_OXM_IPV4_SRC = 406,
    OF_OXM_IPV4_SRC_MASKED = 407,
    OF_OXM_IPV6_DST = 408,
    OF_OXM_IPV6_DST_MASKED = 409,
    OF_OXM_IPV6_FLABEL = 410,
    OF_OXM_IPV6_FLABEL_MASKED = 411,
    OF_OXM_IPV6_ND_SLL = 412,
    OF_OXM_IPV6_ND_SLL_MASKED = 413,
    OF_OXM_IPV6_ND_TARGET = 414,
    OF_OXM_IPV6_ND_TARGET_MASKED = 415,
    OF_OXM_IPV6_ND_TLL = 416,
    OF_OXM_IPV6_ND_TLL_MASKED = 417,
    OF_OXM_IPV6_SRC = 418,
    OF_OXM_IPV6_SRC_MASKED = 419,
    OF_OXM_METADATA = 420,
    OF_OXM_METADATA_MASKED = 421,
    OF_OXM_MPLS_LABEL = 422,
    OF_OXM_MPLS_LABEL_MASKED = 423,
    OF_OXM_MPLS_TC = 424,
    OF_OXM_MPLS_TC_MASKED = 425,
    OF_OXM_SCTP_DST = 426,
    OF_OXM_SCTP_DST_MASKED = 427,
    OF_OXM_SCTP_SRC = 428,
    OF_OXM_SCTP_SRC_MASKED = 429,
    OF_OXM_TCP_DST = 430,
    OF_OXM_TCP_DST_MASKED = 431,
    OF_OXM_TCP_SRC = 432,
    OF_OXM_TCP_SRC_MASKED = 433,
    OF_OXM_UDP_DST = 434,
    OF_OXM_UDP_DST_MASKED = 435,
    OF_OXM_UDP_SRC = 436,
    OF_OXM_UDP_SRC_MASKED = 437,
    OF_OXM_VLAN_PCP = 438,
    OF_OXM_VLAN_PCP_MASKED = 439,
    OF_OXM_VLAN_VID = 440,
    OF_OXM_VLAN_VID_MASKED = 441,
    OF_PACKET_QUEUE = 442,
    OF_PORT_DESC = 443,
    OF_PORT_STATS_ENTRY = 444,
    OF_QUEUE_PROP = 445,
    OF_QUEUE_PROP_EXPERIMENTER = 446,
    OF_QUEUE_PROP_HEADER = 447,
    OF_QUEUE_PROP_MAX_RATE = 448,
    OF_QUEUE_PROP_MIN_RATE = 449,
    OF_QUEUE_STATS_ENTRY = 450,
    OF_TABLE_FEATURE_PROP = 451,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 452,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 453,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 454,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 455,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 456,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 457,
    OF_TABLE_FEATURE_PROP_HEADER = 458,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 459,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 460,
    OF_TABLE_FEATURE_PROP_MATCH = 461,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 462,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 463,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 464,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 465,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 466,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 467,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 468,
    OF_TABLE_FEATURES = 469,
    OF_TABLE_STATS_ENTRY = 470,
    OF_UINT32 = 471,
    OF_UINT64 = 472,
    OF_UINT8 = 473,
    ...
    /* List objects */
    OF_LIST_ACTION = 474,
    OF_LIST_ACTION_ID = 475,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 476,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 477,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 478,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 479,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 480,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 481,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 482,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 483,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 484,
    OF_LIST_BSN_INTERFACE = 485,
    OF_LIST_BSN_LACP_STATS_ENTRY = 486,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 487,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 488,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 489,
    OF_LIST_BSN_TLV = 490,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 491,
    OF_LIST_BUCKET = 492,
    OF_LIST_BUCKET_COUNTER = 493,
    OF_LIST_FLOW_STATS_ENTRY = 494,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 495,
    OF_LIST_GROUP_STATS_ENTRY = 496,
    OF_LIST_HELLO_ELEM = 497,
    OF_LIST_INSTRUCTION = 498,
    OF_LIST_INSTRUCTION_ID = 499,
    OF_LIST_METER_BAND = 500,
    OF_LIST_METER_BAND_STATS = 501,
    OF_LIST_METER_STATS = 502,
    OF_LIST_OXM = 503,
    OF_LIST_PACKET_QUEUE = 504,
    OF_LIST_PORT_DESC = 505,
    OF_LIST_PORT_STATS_ENTRY = 506,
    OF_LIST_QUEUE_PROP = 507,
    OF_LIST_QUEUE_STATS_ENTRY = 508,
    OF_LIST_TABLE_FEATURE_PROP = 509,
    OF_LIST_TABLE_FEATURES = 510,
    OF_LIST_TABLE_STATS_ENTRY = 511,
    OF_LIST_UINT32 = 512,
    OF_LIST_UINT64 = 513,
    OF_LIST_UINT8 = 514,
...
#define OF_MESSAGE_OBJECT_COUNT 178
