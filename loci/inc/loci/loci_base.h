...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_HEADER_SIZE = 325,
    OF_BSN_TLV_ICMP_CODE = 326,
    OF_BSN_TLV_ICMP_ID = 327,
    OF_BSN_TLV_ICMP_TYPE = 328,
    OF_BSN_TLV_IDLE_NOTIFICATION = 329,
    OF_BSN_TLV_IDLE_TIME = 330,
    OF_BSN_TLV_IDLE_TIMEOUT = 331,
    OF_BSN_TLV_IGMP_SNOOPING = 332,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 333,
    OF_BSN_TLV_INTERNAL_MAC = 334,
    OF_BSN_TLV_INTERVAL = 335,
    OF_BSN_TLV_IP_PROTO = 336,
    OF_BSN_TLV_IPV4 = 337,
    OF_BSN_TLV_IPV4_DST = 338,
    OF_BSN_TLV_IPV4_NETMASK = 339,
    OF_BSN_TLV_IPV4_SRC = 340,
    OF_BSN_TLV_IPV6 = 341,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 342,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 343,
    OF_BSN_TLV_MAC = 344,
    OF_BSN_TLV_MAC_MASK = 345,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 346,
    OF_BSN_TLV_MISS_PACKETS = 347,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 348,
    OF_BSN_TLV_MPLS_LABEL = 349,
    OF_BSN_TLV_MPLS_SEQUENCED = 350,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 351,
    OF_BSN_TLV_NAME = 352,
    OF_BSN_TLV_NEGATE = 353,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 354,
    OF_BSN_TLV_OFFSET = 355,
    OF_BSN_TLV_PARTNER_KEY = 356,
    OF_BSN_TLV_PARTNER_PORT_NUM = 357,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 358,
    OF_BSN_TLV_PARTNER_STATE = 359,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 360,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 361,
    OF_BSN_TLV_PORT = 362,
    OF_BSN_TLV_PORT_VXLAN_MODE = 363,
    OF_BSN_TLV_PRIORITY = 364,
    OF_BSN_TLV_QUEUE_ID = 365,
    OF_BSN_TLV_QUEUE_WEIGHT = 366,
    OF_BSN_TLV_RATE_UNIT = 367,
    OF_BSN_TLV_REFERENCE = 368,
    OF_BSN_TLV_REPLY_PACKETS = 369,
    OF_BSN_TLV_REQUEST_PACKETS = 370,
    OF_BSN_TLV_RX_BYTES = 371,
    OF_BSN_TLV_RX_PACKETS = 372,
    OF_BSN_TLV_SAMPLING_RATE = 373,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 374,
    OF_BSN_TLV_STATUS = 375,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 376,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 377,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 378,
    OF_BSN_TLV_SUB_AGENT_ID = 379,
    OF_BSN_TLV_TCP_DST = 380,
    OF_BSN_TLV_TCP_SRC = 381,
    OF_BSN_TLV_TX_BYTES = 382,
    OF_BSN_TLV_TX_PACKETS = 383,
    OF_BSN_TLV_UDF_ANCHOR = 384,
    OF_BSN_TLV_UDF_ID = 385,
    OF_BSN_TLV_UDF_LENGTH = 386,
    OF_BSN_TLV_UDF_OFFSET = 387,
    OF_BSN_TLV_UDP_DST = 388,
    OF_BSN_TLV_UDP_SRC = 389,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 390,
    OF_BSN_TLV_UNICAST_RATE = 391,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 392,
    OF_BSN_TLV_USE_PACKET_STATE = 393,
    OF_BSN_TLV_VFI = 394,
    OF_BSN_TLV_VLAN_MAC_LIST = 395,
    OF_BSN_TLV_VLAN_PCP = 396,
    OF_BSN_TLV_VLAN_VID = 397,
    OF_BSN_TLV_VLAN_VID_MASK = 398,
    OF_BSN_TLV_VNI = 399,
    OF_BSN_TLV_VRF = 400,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 401,
    OF_BSN_VLAN_MAC = 402,
    OF_BSN_VPORT = 403,
    OF_BSN_VPORT_L2GRE = 404,
    OF_BSN_VPORT_Q_IN_Q = 405,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 406,
    OF_BUCKET = 407,
    OF_BUCKET_COUNTER = 408,
    OF_BUNDLE_PROP = 409,
    OF_BUNDLE_PROP_EXPERIMENTER = 410,
    OF_FLOW_STATS_ENTRY = 411,
    OF_GROUP_DESC_STATS_ENTRY = 412,
    OF_GROUP_STATS_ENTRY = 413,
    OF_HELLO_ELEM = 414,
    OF_HELLO_ELEM_VERSIONBITMAP = 415,
    OF_INSTRUCTION = 416,
    OF_INSTRUCTION_APPLY_ACTIONS = 417,
    OF_INSTRUCTION_BSN = 418,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 419,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 420,
    OF_INSTRUCTION_BSN_DENY = 421,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 422,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 423,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 424,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 425,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 426,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 427,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 428,
    OF_INSTRUCTION_BSN_PERMIT = 429,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 430,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 431,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 432,
    OF_INSTRUCTION_CLEAR_ACTIONS = 433,
    OF_INSTRUCTION_EXPERIMENTER = 434,
    OF_INSTRUCTION_GOTO_TABLE = 435,
    OF_INSTRUCTION_ID = 436,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 437,
    OF_INSTRUCTION_ID_BSN = 438,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 439,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 440,
    OF_INSTRUCTION_ID_BSN_DENY = 441,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 442,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 443,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 444,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 445,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 446,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 447,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 448,
    OF_INSTRUCTION_ID_BSN_PERMIT = 449,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 450,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 451,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 452,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 453,
    OF_INSTRUCTION_ID_EXPERIMENTER = 454,
    OF_INSTRUCTION_ID_GOTO_TABLE = 455,
    OF_INSTRUCTION_ID_METER = 456,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 457,
    OF_INSTRUCTION_ID_WRITE_METADATA = 458,
    OF_INSTRUCTION_METER = 459,
    OF_INSTRUCTION_WRITE_ACTIONS = 460,
    OF_INSTRUCTION_WRITE_METADATA = 461,
    OF_MATCH_V1 = 462,
    OF_MATCH_V2 = 463,
    OF_MATCH_V3 = 464,
    OF_METER_BAND = 465,
    OF_METER_BAND_DROP = 466,
    OF_METER_BAND_DSCP_REMARK = 467,
    OF_METER_BAND_EXPERIMENTER = 468,
    OF_METER_BAND_STATS = 469,
    OF_METER_CONFIG = 470,
    OF_METER_FEATURES = 471,
    OF_METER_STATS = 472,
    OF_OXM = 473,
    OF_OXM_ARP_OP = 474,
    OF_OXM_ARP_OP_MASKED = 475,
    OF_OXM_ARP_SHA = 476,
    OF_OXM_ARP_SHA_MASKED = 477,
    OF_OXM_ARP_SPA = 478,
    OF_OXM_ARP_SPA_MASKED = 479,
    OF_OXM_ARP_THA = 480,
    OF_OXM_ARP_THA_MASKED = 481,
    OF_OXM_ARP_TPA = 482,
    OF_OXM_ARP_TPA_MASKED = 483,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 484,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 485,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 486,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 487,
    OF_OXM_BSN_IN_PORTS_128 = 488,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 489,
    OF_OXM_BSN_IN_PORTS_512 = 490,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 491,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 492,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 493,
    OF_OXM_BSN_INNER_ETH_DST = 494,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 495,
    OF_OXM_BSN_INNER_ETH_SRC = 496,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 497,
    OF_OXM_BSN_INNER_VLAN_VID = 498,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 499,
    OF_OXM_BSN_L2_CACHE_HIT = 500,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 501,
    OF_OXM_BSN_L3_DST_CLASS_ID = 502,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 503,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 504,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 505,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 506,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 507,
    OF_OXM_BSN_LAG_ID = 508,
    OF_OXM_BSN_LAG_ID_MASKED = 509,
    OF_OXM_BSN_TCP_FLAGS = 510,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 511,
    OF_OXM_BSN_UDF0 = 512,
    OF_OXM_BSN_UDF0_MASKED = 513,
    OF_OXM_BSN_UDF1 = 514,
    OF_OXM_BSN_UDF1_MASKED = 515,
    OF_OXM_BSN_UDF2 = 516,
    OF_OXM_BSN_UDF2_MASKED = 517,
    OF_OXM_BSN_UDF3 = 518,
    OF_OXM_BSN_UDF3_MASKED = 519,
    OF_OXM_BSN_UDF4 = 520,
    OF_OXM_BSN_UDF4_MASKED = 521,
    OF_OXM_BSN_UDF5 = 522,
    OF_OXM_BSN_UDF5_MASKED = 523,
    OF_OXM_BSN_UDF6 = 524,
    OF_OXM_BSN_UDF6_MASKED = 525,
    OF_OXM_BSN_UDF7 = 526,
    OF_OXM_BSN_UDF7_MASKED = 527,
    OF_OXM_BSN_VFI = 528,
    OF_OXM_BSN_VFI_MASKED = 529,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 530,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 531,
    OF_OXM_BSN_VRF = 532,
    OF_OXM_BSN_VRF_MASKED = 533,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 534,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 535,
    OF_OXM_ETH_DST = 536,
    OF_OXM_ETH_DST_MASKED = 537,
    OF_OXM_ETH_SRC = 538,
    OF_OXM_ETH_SRC_MASKED = 539,
    OF_OXM_ETH_TYPE = 540,
    OF_OXM_ETH_TYPE_MASKED = 541,
    OF_OXM_ICMPV4_CODE = 542,
    OF_OXM_ICMPV4_CODE_MASKED = 543,
    OF_OXM_ICMPV4_TYPE = 544,
    OF_OXM_ICMPV4_TYPE_MASKED = 545,
    OF_OXM_ICMPV6_CODE = 546,
    OF_OXM_ICMPV6_CODE_MASKED = 547,
    OF_OXM_ICMPV6_TYPE = 548,
    OF_OXM_ICMPV6_TYPE_MASKED = 549,
    OF_OXM_IN_PHY_PORT = 550,
    OF_OXM_IN_PHY_PORT_MASKED = 551,
    OF_OXM_IN_PORT = 552,
    OF_OXM_IN_PORT_MASKED = 553,
    OF_OXM_IP_DSCP = 554,
    OF_OXM_IP_DSCP_MASKED = 555,
    OF_OXM_IP_ECN = 556,
    OF_OXM_IP_ECN_MASKED = 557,
    OF_OXM_IP_PROTO = 558,
    OF_OXM_IP_PROTO_MASKED = 559,
    OF_OXM_IPV4_DST = 560,
    OF_OXM_IPV4_DST_MASKED = 561,
    OF_OXM_IPV4_SRC = 562,
    OF_OXM_IPV4_SRC_MASKED = 563,
    OF_OXM_IPV6_DST = 564,
    OF_OXM_IPV6_DST_MASKED = 565,
    OF_OXM_IPV6_EXTHDR = 566,
    OF_OXM_IPV6_EXTHDR_MASKED = 567,
    OF_OXM_IPV6_FLABEL = 568,
    OF_OXM_IPV6_FLABEL_MASKED = 569,
    OF_OXM_IPV6_ND_SLL = 570,
    OF_OXM_IPV6_ND_SLL_MASKED = 571,
    OF_OXM_IPV6_ND_TARGET = 572,
    OF_OXM_IPV6_ND_TARGET_MASKED = 573,
    OF_OXM_IPV6_ND_TLL = 574,
    OF_OXM_IPV6_ND_TLL_MASKED = 575,
    OF_OXM_IPV6_SRC = 576,
    OF_OXM_IPV6_SRC_MASKED = 577,
    OF_OXM_METADATA = 578,
    OF_OXM_METADATA_MASKED = 579,
    OF_OXM_MPLS_BOS = 580,
    OF_OXM_MPLS_BOS_MASKED = 581,
    OF_OXM_MPLS_LABEL = 582,
    OF_OXM_MPLS_LABEL_MASKED = 583,
    OF_OXM_MPLS_TC = 584,
    OF_OXM_MPLS_TC_MASKED = 585,
    OF_OXM_PBB_UCA = 586,
    OF_OXM_PBB_UCA_MASKED = 587,
    OF_OXM_SCTP_DST = 588,
    OF_OXM_SCTP_DST_MASKED = 589,
    OF_OXM_SCTP_SRC = 590,
    OF_OXM_SCTP_SRC_MASKED = 591,
    OF_OXM_TCP_DST = 592,
    OF_OXM_TCP_DST_MASKED = 593,
    OF_OXM_TCP_SRC = 594,
    OF_OXM_TCP_SRC_MASKED = 595,
    OF_OXM_TUNNEL_ID = 596,
    OF_OXM_TUNNEL_ID_MASKED = 597,
    OF_OXM_TUNNEL_IPV4_DST = 598,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 599,
    OF_OXM_TUNNEL_IPV4_SRC = 600,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 601,
    OF_OXM_UDP_DST = 602,
    OF_OXM_UDP_DST_MASKED = 603,
    OF_OXM_UDP_SRC = 604,
    OF_OXM_UDP_SRC_MASKED = 605,
    OF_OXM_VLAN_PCP = 606,
    OF_OXM_VLAN_PCP_MASKED = 607,
    OF_OXM_VLAN_VID = 608,
    OF_OXM_VLAN_VID_MASKED = 609,
    OF_PACKET_QUEUE = 610,
    OF_PORT_DESC = 611,
    OF_PORT_DESC_PROP = 612,
    OF_PORT_DESC_PROP_BSN = 613,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 614,
    OF_PORT_DESC_PROP_BSN_UPLINK = 615,
    OF_PORT_DESC_PROP_ETHERNET = 616,
    OF_PORT_DESC_PROP_EXPERIMENTER = 617,
    OF_PORT_DESC_PROP_OPTICAL = 618,
    OF_PORT_MOD_PROP = 619,
    OF_PORT_MOD_PROP_ETHERNET = 620,
    OF_PORT_MOD_PROP_EXPERIMENTER = 621,
    OF_PORT_MOD_PROP_OPTICAL = 622,
    OF_PORT_STATS_ENTRY = 623,
    OF_PORT_STATS_PROP = 624,
    OF_PORT_STATS_PROP_ETHERNET = 625,
    OF_PORT_STATS_PROP_EXPERIMENTER = 626,
    OF_PORT_STATS_PROP_OPTICAL = 627,
    OF_QUEUE_DESC = 628,
    OF_QUEUE_DESC_PROP = 629,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 630,
    OF_QUEUE_DESC_PROP_MAX_RATE = 631,
    OF_QUEUE_DESC_PROP_MIN_RATE = 632,
    OF_QUEUE_PROP = 633,
    OF_QUEUE_PROP_EXPERIMENTER = 634,
    OF_QUEUE_PROP_MAX_RATE = 635,
    OF_QUEUE_PROP_MIN_RATE = 636,
    OF_QUEUE_STATS_ENTRY = 637,
    OF_QUEUE_STATS_PROP = 638,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 639,
    OF_ROLE_PROP = 640,
    OF_ROLE_PROP_EXPERIMENTER = 641,
    OF_TABLE_DESC = 642,
    OF_TABLE_FEATURE_PROP = 643,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 644,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 645,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 646,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 647,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 648,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 649,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 650,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 651,
    OF_TABLE_FEATURE_PROP_MATCH = 652,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 653,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 654,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 655,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 656,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 657,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 658,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 659,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 660,
    OF_TABLE_FEATURES = 661,
    OF_TABLE_MOD_PROP = 662,
    OF_TABLE_MOD_PROP_EVICTION = 663,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 664,
    OF_TABLE_MOD_PROP_VACANCY = 665,
    OF_TABLE_STATS_ENTRY = 666,
    OF_UINT32 = 667,
    OF_UINT64 = 668,
    OF_UINT8 = 669,
    ...
    /* List objects */
    OF_LIST_ACTION = 670,
    OF_LIST_ACTION_ID = 671,
    OF_LIST_ASYNC_CONFIG_PROP = 672,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 673,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 674,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 675,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 676,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 677,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 678,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 679,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 680,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 681,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 682,
    OF_LIST_BSN_INTERFACE = 683,
    OF_LIST_BSN_LACP_STATS_ENTRY = 684,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 685,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 686,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 687,
    OF_LIST_BSN_TLV = 688,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 689,
    OF_LIST_BSN_VLAN_MAC = 690,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 691,
    OF_LIST_BUCKET = 692,
    OF_LIST_BUCKET_COUNTER = 693,
    OF_LIST_BUNDLE_PROP = 694,
    OF_LIST_FLOW_STATS_ENTRY = 695,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 696,
    OF_LIST_GROUP_STATS_ENTRY = 697,
    OF_LIST_HELLO_ELEM = 698,
    OF_LIST_INSTRUCTION = 699,
    OF_LIST_INSTRUCTION_ID = 700,
    OF_LIST_METER_BAND = 701,
    OF_LIST_METER_BAND_STATS = 702,
    OF_LIST_METER_CONFIG = 703,
    OF_LIST_METER_STATS = 704,
    OF_LIST_OXM = 705,
    OF_LIST_PACKET_QUEUE = 706,
    OF_LIST_PORT_DESC = 707,
    OF_LIST_PORT_DESC_PROP = 708,
    OF_LIST_PORT_MOD_PROP = 709,
    OF_LIST_PORT_STATS_ENTRY = 710,
    OF_LIST_PORT_STATS_PROP = 711,
    OF_LIST_QUEUE_DESC = 712,
    OF_LIST_QUEUE_DESC_PROP = 713,
    OF_LIST_QUEUE_PROP = 714,
    OF_LIST_QUEUE_STATS_ENTRY = 715,
    OF_LIST_QUEUE_STATS_PROP = 716,
    OF_LIST_ROLE_PROP = 717,
    OF_LIST_TABLE_DESC = 718,
    OF_LIST_TABLE_FEATURE_PROP = 719,
    OF_LIST_TABLE_FEATURES = 720,
    OF_LIST_TABLE_MOD_PROP = 721,
    OF_LIST_TABLE_STATS_ENTRY = 722,
    OF_LIST_UINT32 = 723,
    OF_LIST_UINT64 = 724,
    OF_LIST_UINT8 = 725,
