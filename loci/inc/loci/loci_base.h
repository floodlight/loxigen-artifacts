...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 372,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 373,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 374,
    OF_BSN_TLV_SUB_AGENT_ID = 375,
    OF_BSN_TLV_TCP_DST = 376,
    OF_BSN_TLV_TCP_SRC = 377,
    OF_BSN_TLV_TX_BYTES = 378,
    OF_BSN_TLV_TX_PACKETS = 379,
    OF_BSN_TLV_UDF_ANCHOR = 380,
    OF_BSN_TLV_UDF_ID = 381,
    OF_BSN_TLV_UDF_LENGTH = 382,
    OF_BSN_TLV_UDF_OFFSET = 383,
    OF_BSN_TLV_UDP_DST = 384,
    OF_BSN_TLV_UDP_SRC = 385,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 386,
    OF_BSN_TLV_UNICAST_RATE = 387,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 388,
    OF_BSN_TLV_USE_PACKET_STATE = 389,
    OF_BSN_TLV_VLAN_PCP = 390,
    OF_BSN_TLV_VLAN_VID = 391,
    OF_BSN_TLV_VLAN_VID_MASK = 392,
    OF_BSN_TLV_VNI = 393,
    OF_BSN_TLV_VRF = 394,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 395,
    OF_BSN_VPORT = 396,
    OF_BSN_VPORT_L2GRE = 397,
    OF_BSN_VPORT_Q_IN_Q = 398,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 399,
    OF_BUCKET = 400,
    OF_BUCKET_COUNTER = 401,
    OF_BUNDLE_PROP = 402,
    OF_BUNDLE_PROP_EXPERIMENTER = 403,
    OF_FLOW_STATS_ENTRY = 404,
    OF_GROUP_DESC_STATS_ENTRY = 405,
    OF_GROUP_STATS_ENTRY = 406,
    OF_HELLO_ELEM = 407,
    OF_HELLO_ELEM_VERSIONBITMAP = 408,
    OF_INSTRUCTION = 409,
    OF_INSTRUCTION_APPLY_ACTIONS = 410,
    OF_INSTRUCTION_BSN = 411,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 412,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 413,
    OF_INSTRUCTION_BSN_DENY = 414,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 415,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 416,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 417,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 418,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 419,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 420,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 421,
    OF_INSTRUCTION_BSN_PERMIT = 422,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 423,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 424,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 425,
    OF_INSTRUCTION_CLEAR_ACTIONS = 426,
    OF_INSTRUCTION_EXPERIMENTER = 427,
    OF_INSTRUCTION_GOTO_TABLE = 428,
    OF_INSTRUCTION_ID = 429,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 430,
    OF_INSTRUCTION_ID_BSN = 431,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 432,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 433,
    OF_INSTRUCTION_ID_BSN_DENY = 434,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 435,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 436,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 437,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 438,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 439,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 440,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 441,
    OF_INSTRUCTION_ID_BSN_PERMIT = 442,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 443,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 444,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 445,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 446,
    OF_INSTRUCTION_ID_EXPERIMENTER = 447,
    OF_INSTRUCTION_ID_GOTO_TABLE = 448,
    OF_INSTRUCTION_ID_METER = 449,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 450,
    OF_INSTRUCTION_ID_WRITE_METADATA = 451,
    OF_INSTRUCTION_METER = 452,
    OF_INSTRUCTION_WRITE_ACTIONS = 453,
    OF_INSTRUCTION_WRITE_METADATA = 454,
    OF_MATCH_V1 = 455,
    OF_MATCH_V2 = 456,
    OF_MATCH_V3 = 457,
    OF_METER_BAND = 458,
    OF_METER_BAND_DROP = 459,
    OF_METER_BAND_DSCP_REMARK = 460,
    OF_METER_BAND_EXPERIMENTER = 461,
    OF_METER_BAND_STATS = 462,
    OF_METER_CONFIG = 463,
    OF_METER_FEATURES = 464,
    OF_METER_STATS = 465,
    OF_OXM = 466,
    OF_OXM_ARP_OP = 467,
    OF_OXM_ARP_OP_MASKED = 468,
    OF_OXM_ARP_SHA = 469,
    OF_OXM_ARP_SHA_MASKED = 470,
    OF_OXM_ARP_SPA = 471,
    OF_OXM_ARP_SPA_MASKED = 472,
    OF_OXM_ARP_THA = 473,
    OF_OXM_ARP_THA_MASKED = 474,
    OF_OXM_ARP_TPA = 475,
    OF_OXM_ARP_TPA_MASKED = 476,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 477,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 478,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 479,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 480,
    OF_OXM_BSN_IN_PORTS_128 = 481,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 482,
    OF_OXM_BSN_IN_PORTS_512 = 483,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 484,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 485,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 486,
    OF_OXM_BSN_INNER_ETH_DST = 487,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 488,
    OF_OXM_BSN_INNER_ETH_SRC = 489,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 490,
    OF_OXM_BSN_INNER_VLAN_VID = 491,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 492,
    OF_OXM_BSN_L2_CACHE_HIT = 493,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 494,
    OF_OXM_BSN_L3_DST_CLASS_ID = 495,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 496,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 497,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 498,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 499,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 500,
    OF_OXM_BSN_LAG_ID = 501,
    OF_OXM_BSN_LAG_ID_MASKED = 502,
    OF_OXM_BSN_TCP_FLAGS = 503,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 504,
    OF_OXM_BSN_UDF0 = 505,
    OF_OXM_BSN_UDF0_MASKED = 506,
    OF_OXM_BSN_UDF1 = 507,
    OF_OXM_BSN_UDF1_MASKED = 508,
    OF_OXM_BSN_UDF2 = 509,
    OF_OXM_BSN_UDF2_MASKED = 510,
    OF_OXM_BSN_UDF3 = 511,
    OF_OXM_BSN_UDF3_MASKED = 512,
    OF_OXM_BSN_UDF4 = 513,
    OF_OXM_BSN_UDF4_MASKED = 514,
    OF_OXM_BSN_UDF5 = 515,
    OF_OXM_BSN_UDF5_MASKED = 516,
    OF_OXM_BSN_UDF6 = 517,
    OF_OXM_BSN_UDF6_MASKED = 518,
    OF_OXM_BSN_UDF7 = 519,
    OF_OXM_BSN_UDF7_MASKED = 520,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 521,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 522,
    OF_OXM_BSN_VRF = 523,
    OF_OXM_BSN_VRF_MASKED = 524,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 525,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 526,
    OF_OXM_ETH_DST = 527,
    OF_OXM_ETH_DST_MASKED = 528,
    OF_OXM_ETH_SRC = 529,
    OF_OXM_ETH_SRC_MASKED = 530,
    OF_OXM_ETH_TYPE = 531,
    OF_OXM_ETH_TYPE_MASKED = 532,
    OF_OXM_ICMPV4_CODE = 533,
    OF_OXM_ICMPV4_CODE_MASKED = 534,
    OF_OXM_ICMPV4_TYPE = 535,
    OF_OXM_ICMPV4_TYPE_MASKED = 536,
    OF_OXM_ICMPV6_CODE = 537,
    OF_OXM_ICMPV6_CODE_MASKED = 538,
    OF_OXM_ICMPV6_TYPE = 539,
    OF_OXM_ICMPV6_TYPE_MASKED = 540,
    OF_OXM_IN_PHY_PORT = 541,
    OF_OXM_IN_PHY_PORT_MASKED = 542,
    OF_OXM_IN_PORT = 543,
    OF_OXM_IN_PORT_MASKED = 544,
    OF_OXM_IP_DSCP = 545,
    OF_OXM_IP_DSCP_MASKED = 546,
    OF_OXM_IP_ECN = 547,
    OF_OXM_IP_ECN_MASKED = 548,
    OF_OXM_IP_PROTO = 549,
    OF_OXM_IP_PROTO_MASKED = 550,
    OF_OXM_IPV4_DST = 551,
    OF_OXM_IPV4_DST_MASKED = 552,
    OF_OXM_IPV4_SRC = 553,
    OF_OXM_IPV4_SRC_MASKED = 554,
    OF_OXM_IPV6_DST = 555,
    OF_OXM_IPV6_DST_MASKED = 556,
    OF_OXM_IPV6_EXTHDR = 557,
    OF_OXM_IPV6_EXTHDR_MASKED = 558,
    OF_OXM_IPV6_FLABEL = 559,
    OF_OXM_IPV6_FLABEL_MASKED = 560,
    OF_OXM_IPV6_ND_SLL = 561,
    OF_OXM_IPV6_ND_SLL_MASKED = 562,
    OF_OXM_IPV6_ND_TARGET = 563,
    OF_OXM_IPV6_ND_TARGET_MASKED = 564,
    OF_OXM_IPV6_ND_TLL = 565,
    OF_OXM_IPV6_ND_TLL_MASKED = 566,
    OF_OXM_IPV6_SRC = 567,
    OF_OXM_IPV6_SRC_MASKED = 568,
    OF_OXM_METADATA = 569,
    OF_OXM_METADATA_MASKED = 570,
    OF_OXM_MPLS_BOS = 571,
    OF_OXM_MPLS_BOS_MASKED = 572,
    OF_OXM_MPLS_LABEL = 573,
    OF_OXM_MPLS_LABEL_MASKED = 574,
    OF_OXM_MPLS_TC = 575,
    OF_OXM_MPLS_TC_MASKED = 576,
    OF_OXM_PBB_UCA = 577,
    OF_OXM_PBB_UCA_MASKED = 578,
    OF_OXM_SCTP_DST = 579,
    OF_OXM_SCTP_DST_MASKED = 580,
    OF_OXM_SCTP_SRC = 581,
    OF_OXM_SCTP_SRC_MASKED = 582,
    OF_OXM_TCP_DST = 583,
    OF_OXM_TCP_DST_MASKED = 584,
    OF_OXM_TCP_SRC = 585,
    OF_OXM_TCP_SRC_MASKED = 586,
    OF_OXM_TUNNEL_ID = 587,
    OF_OXM_TUNNEL_ID_MASKED = 588,
    OF_OXM_TUNNEL_IPV4_DST = 589,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 590,
    OF_OXM_TUNNEL_IPV4_SRC = 591,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 592,
    OF_OXM_UDP_DST = 593,
    OF_OXM_UDP_DST_MASKED = 594,
    OF_OXM_UDP_SRC = 595,
    OF_OXM_UDP_SRC_MASKED = 596,
    OF_OXM_VLAN_PCP = 597,
    OF_OXM_VLAN_PCP_MASKED = 598,
    OF_OXM_VLAN_VID = 599,
    OF_OXM_VLAN_VID_MASKED = 600,
    OF_PACKET_QUEUE = 601,
    OF_PORT_DESC = 602,
    OF_PORT_DESC_PROP = 603,
    OF_PORT_DESC_PROP_BSN = 604,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 605,
    OF_PORT_DESC_PROP_BSN_UPLINK = 606,
    OF_PORT_DESC_PROP_ETHERNET = 607,
    OF_PORT_DESC_PROP_EXPERIMENTER = 608,
    OF_PORT_DESC_PROP_OPTICAL = 609,
    OF_PORT_MOD_PROP = 610,
    OF_PORT_MOD_PROP_ETHERNET = 611,
    OF_PORT_MOD_PROP_EXPERIMENTER = 612,
    OF_PORT_MOD_PROP_OPTICAL = 613,
    OF_PORT_STATS_ENTRY = 614,
    OF_PORT_STATS_PROP = 615,
    OF_PORT_STATS_PROP_ETHERNET = 616,
    OF_PORT_STATS_PROP_EXPERIMENTER = 617,
    OF_PORT_STATS_PROP_OPTICAL = 618,
    OF_QUEUE_DESC = 619,
    OF_QUEUE_DESC_PROP = 620,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 621,
    OF_QUEUE_DESC_PROP_MAX_RATE = 622,
    OF_QUEUE_DESC_PROP_MIN_RATE = 623,
    OF_QUEUE_PROP = 624,
    OF_QUEUE_PROP_EXPERIMENTER = 625,
    OF_QUEUE_PROP_MAX_RATE = 626,
    OF_QUEUE_PROP_MIN_RATE = 627,
    OF_QUEUE_STATS_ENTRY = 628,
    OF_QUEUE_STATS_PROP = 629,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 630,
    OF_ROLE_PROP = 631,
    OF_ROLE_PROP_EXPERIMENTER = 632,
    OF_TABLE_DESC = 633,
    OF_TABLE_FEATURE_PROP = 634,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 635,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 636,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 637,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 638,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 639,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 640,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 641,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 642,
    OF_TABLE_FEATURE_PROP_MATCH = 643,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 644,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 645,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 646,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 647,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 648,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 649,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 650,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 651,
    OF_TABLE_FEATURES = 652,
    OF_TABLE_MOD_PROP = 653,
    OF_TABLE_MOD_PROP_EVICTION = 654,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 655,
    OF_TABLE_MOD_PROP_VACANCY = 656,
    OF_TABLE_STATS_ENTRY = 657,
    OF_UINT32 = 658,
    OF_UINT64 = 659,
    OF_UINT8 = 660,
    ...
    /* List objects */
    OF_LIST_ACTION = 661,
    OF_LIST_ACTION_ID = 662,
    OF_LIST_ASYNC_CONFIG_PROP = 663,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 664,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 665,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 666,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 667,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 668,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 669,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 670,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 671,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 672,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 673,
    OF_LIST_BSN_INTERFACE = 674,
    OF_LIST_BSN_LACP_STATS_ENTRY = 675,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 676,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 677,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 678,
    OF_LIST_BSN_TLV = 679,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 680,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 681,
    OF_LIST_BUCKET = 682,
    OF_LIST_BUCKET_COUNTER = 683,
    OF_LIST_BUNDLE_PROP = 684,
    OF_LIST_FLOW_STATS_ENTRY = 685,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 686,
    OF_LIST_GROUP_STATS_ENTRY = 687,
    OF_LIST_HELLO_ELEM = 688,
    OF_LIST_INSTRUCTION = 689,
    OF_LIST_INSTRUCTION_ID = 690,
    OF_LIST_METER_BAND = 691,
    OF_LIST_METER_BAND_STATS = 692,
    OF_LIST_METER_CONFIG = 693,
    OF_LIST_METER_STATS = 694,
    OF_LIST_OXM = 695,
    OF_LIST_PACKET_QUEUE = 696,
    OF_LIST_PORT_DESC = 697,
    OF_LIST_PORT_DESC_PROP = 698,
    OF_LIST_PORT_MOD_PROP = 699,
    OF_LIST_PORT_STATS_ENTRY = 700,
    OF_LIST_PORT_STATS_PROP = 701,
    OF_LIST_QUEUE_DESC = 702,
    OF_LIST_QUEUE_DESC_PROP = 703,
    OF_LIST_QUEUE_PROP = 704,
    OF_LIST_QUEUE_STATS_ENTRY = 705,
    OF_LIST_QUEUE_STATS_PROP = 706,
    OF_LIST_ROLE_PROP = 707,
    OF_LIST_TABLE_DESC = 708,
    OF_LIST_TABLE_FEATURE_PROP = 709,
    OF_LIST_TABLE_FEATURES = 710,
    OF_LIST_TABLE_MOD_PROP = 711,
    OF_LIST_TABLE_STATS_ENTRY = 712,
    OF_LIST_UINT32 = 713,
    OF_LIST_UINT64 = 714,
    OF_LIST_UINT8 = 715,
