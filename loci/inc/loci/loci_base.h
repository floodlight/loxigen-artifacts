...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_ETH_DST = 327,
    OF_BSN_TLV_ETH_SRC = 328,
    OF_BSN_TLV_ETH_TYPE = 329,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 330,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 331,
    OF_BSN_TLV_EXTERNAL_IP = 332,
    OF_BSN_TLV_EXTERNAL_MAC = 333,
    OF_BSN_TLV_EXTERNAL_NETMASK = 334,
    OF_BSN_TLV_GENERATION_ID = 335,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 336,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 337,
    OF_BSN_TLV_HASH_PACKET_FIELD = 338,
    OF_BSN_TLV_HASH_PACKET_TYPE = 339,
    OF_BSN_TLV_HASH_SEED = 340,
    OF_BSN_TLV_HASH_TYPE = 341,
    OF_BSN_TLV_HEADER_SIZE = 342,
    OF_BSN_TLV_ICMP_CODE = 343,
    OF_BSN_TLV_ICMP_ID = 344,
    OF_BSN_TLV_ICMP_TYPE = 345,
    OF_BSN_TLV_ICMPV6_CHKSUM = 346,
    OF_BSN_TLV_IDLE_NOTIFICATION = 347,
    OF_BSN_TLV_IDLE_TIME = 348,
    OF_BSN_TLV_IDLE_TIMEOUT = 349,
    OF_BSN_TLV_IGMP_SNOOPING = 350,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 351,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 352,
    OF_BSN_TLV_INTERNAL_MAC = 353,
    OF_BSN_TLV_INTERVAL = 354,
    OF_BSN_TLV_IP_PROTO = 355,
    OF_BSN_TLV_IPV4 = 356,
    OF_BSN_TLV_IPV4_DST = 357,
    OF_BSN_TLV_IPV4_NETMASK = 358,
    OF_BSN_TLV_IPV4_SRC = 359,
    OF_BSN_TLV_IPV6 = 360,
    OF_BSN_TLV_IPV6_DST = 361,
    OF_BSN_TLV_IPV6_PREFIX = 362,
    OF_BSN_TLV_IPV6_SRC = 363,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 364,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 365,
    OF_BSN_TLV_L3_DST_CLASS_ID = 366,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 367,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 368,
    OF_BSN_TLV_LOOPBACK_PORT = 369,
    OF_BSN_TLV_MAC = 370,
    OF_BSN_TLV_MAC_MASK = 371,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 372,
    OF_BSN_TLV_MISS_PACKETS = 373,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 374,
    OF_BSN_TLV_MPLS_LABEL = 375,
    OF_BSN_TLV_MPLS_SEQUENCED = 376,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 377,
    OF_BSN_TLV_NAME = 378,
    OF_BSN_TLV_NDP_OFFLOAD = 379,
    OF_BSN_TLV_NDP_STATIC = 380,
    OF_BSN_TLV_NEGATE = 381,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 382,
    OF_BSN_TLV_NEXT_HOP_MAC = 383,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 384,
    OF_BSN_TLV_OFFSET = 385,
    OF_BSN_TLV_PARENT_PORT = 386,
    OF_BSN_TLV_PARTNER_KEY = 387,
    OF_BSN_TLV_PARTNER_PORT_NUM = 388,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 389,
    OF_BSN_TLV_PARTNER_STATE = 390,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 391,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 392,
    OF_BSN_TLV_PORT = 393,
    OF_BSN_TLV_PORT_USAGE = 394,
    OF_BSN_TLV_PORT_VXLAN_MODE = 395,
    OF_BSN_TLV_PRIORITY = 396,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 397,
    OF_BSN_TLV_QOS_PRIORITY = 398,
    OF_BSN_TLV_QUEUE_ID = 399,
    OF_BSN_TLV_QUEUE_WEIGHT = 400,
    OF_BSN_TLV_RATE_LIMIT = 401,
    OF_BSN_TLV_RATE_UNIT = 402,
    OF_BSN_TLV_REFERENCE = 403,
    OF_BSN_TLV_REPLY_PACKETS = 404,
    OF_BSN_TLV_REQUEST_PACKETS = 405,
    OF_BSN_TLV_RX_BYTES = 406,
    OF_BSN_TLV_RX_PACKETS = 407,
    OF_BSN_TLV_SAMPLING_RATE = 408,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 409,
    OF_BSN_TLV_STATUS = 410,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 411,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 412,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 413,
    OF_BSN_TLV_SUB_AGENT_ID = 414,
    OF_BSN_TLV_TCP_DST = 415,
    OF_BSN_TLV_TCP_FLAGS = 416,
    OF_BSN_TLV_TCP_SRC = 417,
    OF_BSN_TLV_TTL = 418,
    OF_BSN_TLV_TX_BYTES = 419,
    OF_BSN_TLV_TX_PACKETS = 420,
    OF_BSN_TLV_UDF_ANCHOR = 421,
    OF_BSN_TLV_UDF_ID = 422,
    OF_BSN_TLV_UDF_LENGTH = 423,
    OF_BSN_TLV_UDF_OFFSET = 424,
    OF_BSN_TLV_UDP_DST = 425,
    OF_BSN_TLV_UDP_SRC = 426,
    OF_BSN_TLV_UINT64_LIST = 427,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 428,
    OF_BSN_TLV_UNICAST_RATE = 429,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 430,
    OF_BSN_TLV_UNTAGGED = 431,
    OF_BSN_TLV_USE_PACKET_STATE = 432,
    OF_BSN_TLV_VFI = 433,
    OF_BSN_TLV_VFP_CLASS_ID = 434,
    OF_BSN_TLV_VLAN_MAC_LIST = 435,
    OF_BSN_TLV_VLAN_PCP = 436,
    OF_BSN_TLV_VLAN_VID = 437,
    OF_BSN_TLV_VLAN_VID_MASK = 438,
    OF_BSN_TLV_VNI = 439,
    OF_BSN_TLV_VPN_KEY = 440,
    OF_BSN_TLV_VRF = 441,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 442,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 443,
    OF_BSN_VLAN_MAC = 444,
    OF_BSN_VPORT = 445,
    OF_BSN_VPORT_L2GRE = 446,
    OF_BSN_VPORT_Q_IN_Q = 447,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 448,
    OF_BUCKET = 449,
    OF_BUCKET_COUNTER = 450,
    OF_BUNDLE_PROP = 451,
    OF_BUNDLE_PROP_EXPERIMENTER = 452,
    OF_FLOW_STATS_ENTRY = 453,
    OF_GROUP_DESC_STATS_ENTRY = 454,
    OF_GROUP_STATS_ENTRY = 455,
    OF_HELLO_ELEM = 456,
    OF_HELLO_ELEM_VERSIONBITMAP = 457,
    OF_INSTRUCTION = 458,
    OF_INSTRUCTION_APPLY_ACTIONS = 459,
    OF_INSTRUCTION_BSN = 460,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 461,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 462,
    OF_INSTRUCTION_BSN_DENY = 463,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 464,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 465,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 466,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 467,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 468,
    OF_INSTRUCTION_BSN_HASH_SELECT = 469,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 470,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 471,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 472,
    OF_INSTRUCTION_BSN_PERMIT = 473,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 474,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 475,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 476,
    OF_INSTRUCTION_CLEAR_ACTIONS = 477,
    OF_INSTRUCTION_EXPERIMENTER = 478,
    OF_INSTRUCTION_GOTO_TABLE = 479,
    OF_INSTRUCTION_ID = 480,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 481,
    OF_INSTRUCTION_ID_BSN = 482,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 483,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 484,
    OF_INSTRUCTION_ID_BSN_DENY = 485,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 486,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 487,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 488,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 489,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 490,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 491,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 492,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 493,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 494,
    OF_INSTRUCTION_ID_BSN_PERMIT = 495,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 496,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 497,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 498,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 499,
    OF_INSTRUCTION_ID_EXPERIMENTER = 500,
    OF_INSTRUCTION_ID_GOTO_TABLE = 501,
    OF_INSTRUCTION_ID_METER = 502,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 503,
    OF_INSTRUCTION_ID_WRITE_METADATA = 504,
    OF_INSTRUCTION_METER = 505,
    OF_INSTRUCTION_WRITE_ACTIONS = 506,
    OF_INSTRUCTION_WRITE_METADATA = 507,
    OF_MATCH_V1 = 508,
    OF_MATCH_V2 = 509,
    OF_MATCH_V3 = 510,
    OF_METER_BAND = 511,
    OF_METER_BAND_DROP = 512,
    OF_METER_BAND_DSCP_REMARK = 513,
    OF_METER_BAND_EXPERIMENTER = 514,
    OF_METER_BAND_STATS = 515,
    OF_METER_CONFIG = 516,
    OF_METER_FEATURES = 517,
    OF_METER_STATS = 518,
    OF_OXM = 519,
    OF_OXM_ARP_OP = 520,
    OF_OXM_ARP_OP_MASKED = 521,
    OF_OXM_ARP_SHA = 522,
    OF_OXM_ARP_SHA_MASKED = 523,
    OF_OXM_ARP_SPA = 524,
    OF_OXM_ARP_SPA_MASKED = 525,
    OF_OXM_ARP_THA = 526,
    OF_OXM_ARP_THA_MASKED = 527,
    OF_OXM_ARP_TPA = 528,
    OF_OXM_ARP_TPA_MASKED = 529,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 530,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 531,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 532,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 533,
    OF_OXM_BSN_IN_PORTS_128 = 534,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 535,
    OF_OXM_BSN_IN_PORTS_512 = 536,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 537,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 538,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 539,
    OF_OXM_BSN_INNER_ETH_DST = 540,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 541,
    OF_OXM_BSN_INNER_ETH_SRC = 542,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 543,
    OF_OXM_BSN_INNER_VLAN_VID = 544,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 545,
    OF_OXM_BSN_IP_FRAGMENTATION = 546,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 547,
    OF_OXM_BSN_L2_CACHE_HIT = 548,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 549,
    OF_OXM_BSN_L3_DST_CLASS_ID = 550,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 551,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 552,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 553,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 554,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 555,
    OF_OXM_BSN_LAG_ID = 556,
    OF_OXM_BSN_LAG_ID_MASKED = 557,
    OF_OXM_BSN_TCP_FLAGS = 558,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 559,
    OF_OXM_BSN_UDF0 = 560,
    OF_OXM_BSN_UDF0_MASKED = 561,
    OF_OXM_BSN_UDF1 = 562,
    OF_OXM_BSN_UDF1_MASKED = 563,
    OF_OXM_BSN_UDF2 = 564,
    OF_OXM_BSN_UDF2_MASKED = 565,
    OF_OXM_BSN_UDF3 = 566,
    OF_OXM_BSN_UDF3_MASKED = 567,
    OF_OXM_BSN_UDF4 = 568,
    OF_OXM_BSN_UDF4_MASKED = 569,
    OF_OXM_BSN_UDF5 = 570,
    OF_OXM_BSN_UDF5_MASKED = 571,
    OF_OXM_BSN_UDF6 = 572,
    OF_OXM_BSN_UDF6_MASKED = 573,
    OF_OXM_BSN_UDF7 = 574,
    OF_OXM_BSN_UDF7_MASKED = 575,
    OF_OXM_BSN_VFI = 576,
    OF_OXM_BSN_VFI_MASKED = 577,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 578,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 579,
    OF_OXM_BSN_VRF = 580,
    OF_OXM_BSN_VRF_MASKED = 581,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 582,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 583,
    OF_OXM_ETH_DST = 584,
    OF_OXM_ETH_DST_MASKED = 585,
    OF_OXM_ETH_SRC = 586,
    OF_OXM_ETH_SRC_MASKED = 587,
    OF_OXM_ETH_TYPE = 588,
    OF_OXM_ETH_TYPE_MASKED = 589,
    OF_OXM_ICMPV4_CODE = 590,
    OF_OXM_ICMPV4_CODE_MASKED = 591,
    OF_OXM_ICMPV4_TYPE = 592,
    OF_OXM_ICMPV4_TYPE_MASKED = 593,
    OF_OXM_ICMPV6_CODE = 594,
    OF_OXM_ICMPV6_CODE_MASKED = 595,
    OF_OXM_ICMPV6_TYPE = 596,
    OF_OXM_ICMPV6_TYPE_MASKED = 597,
    OF_OXM_IN_PHY_PORT = 598,
    OF_OXM_IN_PHY_PORT_MASKED = 599,
    OF_OXM_IN_PORT = 600,
    OF_OXM_IN_PORT_MASKED = 601,
    OF_OXM_IP_DSCP = 602,
    OF_OXM_IP_DSCP_MASKED = 603,
    OF_OXM_IP_ECN = 604,
    OF_OXM_IP_ECN_MASKED = 605,
    OF_OXM_IP_PROTO = 606,
    OF_OXM_IP_PROTO_MASKED = 607,
    OF_OXM_IPV4_DST = 608,
    OF_OXM_IPV4_DST_MASKED = 609,
    OF_OXM_IPV4_SRC = 610,
    OF_OXM_IPV4_SRC_MASKED = 611,
    OF_OXM_IPV6_DST = 612,
    OF_OXM_IPV6_DST_MASKED = 613,
    OF_OXM_IPV6_EXTHDR = 614,
    OF_OXM_IPV6_EXTHDR_MASKED = 615,
    OF_OXM_IPV6_FLABEL = 616,
    OF_OXM_IPV6_FLABEL_MASKED = 617,
    OF_OXM_IPV6_ND_SLL = 618,
    OF_OXM_IPV6_ND_SLL_MASKED = 619,
    OF_OXM_IPV6_ND_TARGET = 620,
    OF_OXM_IPV6_ND_TARGET_MASKED = 621,
    OF_OXM_IPV6_ND_TLL = 622,
    OF_OXM_IPV6_ND_TLL_MASKED = 623,
    OF_OXM_IPV6_SRC = 624,
    OF_OXM_IPV6_SRC_MASKED = 625,
    OF_OXM_METADATA = 626,
    OF_OXM_METADATA_MASKED = 627,
    OF_OXM_MPLS_BOS = 628,
    OF_OXM_MPLS_BOS_MASKED = 629,
    OF_OXM_MPLS_LABEL = 630,
    OF_OXM_MPLS_LABEL_MASKED = 631,
    OF_OXM_MPLS_TC = 632,
    OF_OXM_MPLS_TC_MASKED = 633,
    OF_OXM_OVS_TCP_FLAGS = 634,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 635,
    OF_OXM_PBB_UCA = 636,
    OF_OXM_PBB_UCA_MASKED = 637,
    OF_OXM_SCTP_DST = 638,
    OF_OXM_SCTP_DST_MASKED = 639,
    OF_OXM_SCTP_SRC = 640,
    OF_OXM_SCTP_SRC_MASKED = 641,
    OF_OXM_TCP_DST = 642,
    OF_OXM_TCP_DST_MASKED = 643,
    OF_OXM_TCP_SRC = 644,
    OF_OXM_TCP_SRC_MASKED = 645,
    OF_OXM_TUNNEL_ID = 646,
    OF_OXM_TUNNEL_ID_MASKED = 647,
    OF_OXM_TUNNEL_IPV4_DST = 648,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 649,
    OF_OXM_TUNNEL_IPV4_SRC = 650,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 651,
    OF_OXM_UDP_DST = 652,
    OF_OXM_UDP_DST_MASKED = 653,
    OF_OXM_UDP_SRC = 654,
    OF_OXM_UDP_SRC_MASKED = 655,
    OF_OXM_VLAN_PCP = 656,
    OF_OXM_VLAN_PCP_MASKED = 657,
    OF_OXM_VLAN_VID = 658,
    OF_OXM_VLAN_VID_MASKED = 659,
    OF_PACKET_QUEUE = 660,
    OF_PORT_DESC = 661,
    OF_PORT_DESC_PROP = 662,
    OF_PORT_DESC_PROP_BSN = 663,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 664,
    OF_PORT_DESC_PROP_BSN_UPLINK = 665,
    OF_PORT_DESC_PROP_ETHERNET = 666,
    OF_PORT_DESC_PROP_EXPERIMENTER = 667,
    OF_PORT_DESC_PROP_OPTICAL = 668,
    OF_PORT_MOD_PROP = 669,
    OF_PORT_MOD_PROP_ETHERNET = 670,
    OF_PORT_MOD_PROP_EXPERIMENTER = 671,
    OF_PORT_MOD_PROP_OPTICAL = 672,
    OF_PORT_STATS_ENTRY = 673,
    OF_PORT_STATS_PROP = 674,
    OF_PORT_STATS_PROP_ETHERNET = 675,
    OF_PORT_STATS_PROP_EXPERIMENTER = 676,
    OF_PORT_STATS_PROP_OPTICAL = 677,
    OF_QUEUE_DESC = 678,
    OF_QUEUE_DESC_PROP = 679,
    OF_QUEUE_DESC_PROP_BSN = 680,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 681,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 682,
    OF_QUEUE_DESC_PROP_MAX_RATE = 683,
    OF_QUEUE_DESC_PROP_MIN_RATE = 684,
    OF_QUEUE_PROP = 685,
    OF_QUEUE_PROP_EXPERIMENTER = 686,
    OF_QUEUE_PROP_MAX_RATE = 687,
    OF_QUEUE_PROP_MIN_RATE = 688,
    OF_QUEUE_STATS_ENTRY = 689,
    OF_QUEUE_STATS_PROP = 690,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 691,
    OF_ROLE_PROP = 692,
    OF_ROLE_PROP_EXPERIMENTER = 693,
    OF_TABLE_DESC = 694,
    OF_TABLE_FEATURE_PROP = 695,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 696,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 697,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 698,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 699,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 700,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 701,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 702,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 703,
    OF_TABLE_FEATURE_PROP_MATCH = 704,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 705,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 706,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 707,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 708,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 709,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 710,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 711,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 712,
    OF_TABLE_FEATURES = 713,
    OF_TABLE_MOD_PROP = 714,
    OF_TABLE_MOD_PROP_EVICTION = 715,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 716,
    OF_TABLE_MOD_PROP_VACANCY = 717,
    OF_TABLE_STATS_ENTRY = 718,
    OF_UINT32 = 719,
    OF_UINT64 = 720,
    OF_UINT8 = 721,
    ...
    /* List objects */
    OF_LIST_ACTION = 722,
    OF_LIST_ACTION_ID = 723,
    OF_LIST_ASYNC_CONFIG_PROP = 724,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 725,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 726,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 727,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 728,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 729,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 730,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 731,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 732,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 733,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 734,
    OF_LIST_BSN_INTERFACE = 735,
    OF_LIST_BSN_LACP_STATS_ENTRY = 736,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 737,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 738,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 739,
    OF_LIST_BSN_TLV = 740,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 741,
    OF_LIST_BSN_VLAN_MAC = 742,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 743,
    OF_LIST_BUCKET = 744,
    OF_LIST_BUCKET_COUNTER = 745,
    OF_LIST_BUNDLE_PROP = 746,
    OF_LIST_FLOW_STATS_ENTRY = 747,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 748,
    OF_LIST_GROUP_STATS_ENTRY = 749,
    OF_LIST_HELLO_ELEM = 750,
    OF_LIST_INSTRUCTION = 751,
    OF_LIST_INSTRUCTION_ID = 752,
    OF_LIST_METER_BAND = 753,
    OF_LIST_METER_BAND_STATS = 754,
    OF_LIST_METER_CONFIG = 755,
    OF_LIST_METER_STATS = 756,
    OF_LIST_OXM = 757,
    OF_LIST_PACKET_QUEUE = 758,
    OF_LIST_PORT_DESC = 759,
    OF_LIST_PORT_DESC_PROP = 760,
    OF_LIST_PORT_MOD_PROP = 761,
    OF_LIST_PORT_STATS_ENTRY = 762,
    OF_LIST_PORT_STATS_PROP = 763,
    OF_LIST_QUEUE_DESC = 764,
    OF_LIST_QUEUE_DESC_PROP = 765,
    OF_LIST_QUEUE_PROP = 766,
    OF_LIST_QUEUE_STATS_ENTRY = 767,
    OF_LIST_QUEUE_STATS_PROP = 768,
    OF_LIST_ROLE_PROP = 769,
    OF_LIST_TABLE_DESC = 770,
    OF_LIST_TABLE_FEATURE_PROP = 771,
    OF_LIST_TABLE_FEATURES = 772,
    OF_LIST_TABLE_MOD_PROP = 773,
    OF_LIST_TABLE_STATS_ENTRY = 774,
    OF_LIST_UINT32 = 775,
    OF_LIST_UINT64 = 776,
    OF_LIST_UINT8 = 777,
