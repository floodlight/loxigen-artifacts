...
typedef enum of_object_id_e {
    ...
    OF_BSN_LOG = 65,
    OF_BSN_PDU_RX_REPLY = 66,
    OF_BSN_PDU_RX_REQUEST = 67,
    OF_BSN_PDU_RX_TIMEOUT = 68,
    OF_BSN_PDU_TX_REPLY = 69,
    OF_BSN_PDU_TX_REQUEST = 70,
    OF_BSN_PORT_COUNTER_STATS_REPLY = 71,
    OF_BSN_PORT_COUNTER_STATS_REQUEST = 72,
    OF_BSN_ROLE_STATUS = 73,
    OF_BSN_SET_AUX_CXNS_REPLY = 74,
    OF_BSN_SET_AUX_CXNS_REQUEST = 75,
    OF_BSN_SET_IP_MASK = 76,
    OF_BSN_SET_L2_TABLE_REPLY = 77,
    OF_BSN_SET_L2_TABLE_REQUEST = 78,
    OF_BSN_SET_LACP_REPLY = 79,
    OF_BSN_SET_LACP_REQUEST = 80,
    OF_BSN_SET_MIRRORING = 81,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 82,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 83,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 84,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 85,
    OF_BSN_SHELL_COMMAND = 86,
    OF_BSN_SHELL_OUTPUT = 87,
    OF_BSN_SHELL_STATUS = 88,
    OF_BSN_STATS_REPLY = 89,
    OF_BSN_STATS_REQUEST = 90,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 91,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 92,
    OF_BSN_TABLE_CHECKSUM_STATS_REPLY = 93,
    OF_BSN_TABLE_CHECKSUM_STATS_REQUEST = 94,
    OF_BSN_TABLE_SET_BUCKETS_SIZE = 95,
    OF_BSN_TIME_REPLY = 96,
    OF_BSN_TIME_REQUEST = 97,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 98,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 99,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 100,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 101,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 102,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 103,
    OF_BSN_VRF_COUNTER_STATS_REPLY = 104,
    OF_BSN_VRF_COUNTER_STATS_REQUEST = 105,
    OF_BUNDLE_ADD_MSG = 106,
    OF_BUNDLE_CTRL_MSG = 107,
    OF_DESC_STATS_REPLY = 108,
    OF_DESC_STATS_REQUEST = 109,
    OF_ECHO_REPLY = 110,
    OF_ECHO_REQUEST = 111,
    OF_ERROR_MSG = 112,
    OF_EXPERIMENTER = 113,
    OF_EXPERIMENTER_ERROR_MSG = 114,
    OF_EXPERIMENTER_STATS_REPLY = 115,
    OF_EXPERIMENTER_STATS_REQUEST = 116,
    OF_FEATURES_REPLY = 117,
    OF_FEATURES_REQUEST = 118,
    OF_FLOW_ADD = 119,
    OF_FLOW_DELETE = 120,
    OF_FLOW_DELETE_STRICT = 121,
    OF_FLOW_MOD = 122,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 123,
    OF_FLOW_MODIFY = 124,
    OF_FLOW_MODIFY_STRICT = 125,
    OF_FLOW_REMOVED = 126,
    OF_FLOW_STATS_REPLY = 127,
    OF_FLOW_STATS_REQUEST = 128,
    OF_GET_CONFIG_REPLY = 129,
    OF_GET_CONFIG_REQUEST = 130,
    OF_GROUP_ADD = 131,
    OF_GROUP_DELETE = 132,
    OF_GROUP_DESC_STATS_REPLY = 133,
    OF_GROUP_DESC_STATS_REQUEST = 134,
    OF_GROUP_FEATURES_STATS_REPLY = 135,
    OF_GROUP_FEATURES_STATS_REQUEST = 136,
    OF_GROUP_MOD = 137,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 138,
    OF_GROUP_MODIFY = 139,
    OF_GROUP_STATS_REPLY = 140,
    OF_GROUP_STATS_REQUEST = 141,
    OF_HEADER = 142,
    OF_HELLO = 143,
    OF_HELLO_FAILED_ERROR_MSG = 144,
    OF_METER_CONFIG_STATS_REPLY = 145,
    OF_METER_CONFIG_STATS_REQUEST = 146,
    OF_METER_FEATURES_STATS_REPLY = 147,
    OF_METER_FEATURES_STATS_REQUEST = 148,
    OF_METER_MOD = 149,
    OF_METER_MOD_FAILED_ERROR_MSG = 150,
    OF_METER_STATS_REPLY = 151,
    OF_METER_STATS_REQUEST = 152,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 153,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 154,
    OF_NICIRA_HEADER = 155,
    OF_PACKET_IN = 156,
    OF_PACKET_OUT = 157,
    OF_PORT_DESC_STATS_REPLY = 158,
    OF_PORT_DESC_STATS_REQUEST = 159,
    OF_PORT_MOD = 160,
    OF_PORT_MOD_FAILED_ERROR_MSG = 161,
    OF_PORT_STATS_REPLY = 162,
    OF_PORT_STATS_REQUEST = 163,
    OF_PORT_STATUS = 164,
    OF_QUEUE_DESC_STATS_REPLY = 165,
    OF_QUEUE_DESC_STATS_REQUEST = 166,
    OF_QUEUE_GET_CONFIG_REPLY = 167,
    OF_QUEUE_GET_CONFIG_REQUEST = 168,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 169,
    OF_QUEUE_STATS_REPLY = 170,
    OF_QUEUE_STATS_REQUEST = 171,
    OF_REQUESTFORWARD = 172,
    OF_ROLE_REPLY = 173,
    OF_ROLE_REQUEST = 174,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 175,
    OF_ROLE_STATUS = 176,
    OF_SET_CONFIG = 177,
    OF_STATS_REPLY = 178,
    OF_STATS_REQUEST = 179,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 180,
    OF_TABLE_DESC_STATS_REPLY = 181,
    OF_TABLE_DESC_STATS_REQUEST = 182,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 183,
    OF_TABLE_FEATURES_STATS_REPLY = 184,
    OF_TABLE_FEATURES_STATS_REQUEST = 185,
    OF_TABLE_MOD = 186,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 187,
    OF_TABLE_STATS_REPLY = 188,
    OF_TABLE_STATS_REQUEST = 189,
    OF_TABLE_STATUS = 190,

    /* Non-message objects */
    OF_ACTION = 191,
    OF_ACTION_BSN = 192,
    OF_ACTION_BSN_CHECKSUM = 193,
    OF_ACTION_BSN_GENTABLE = 194,
    OF_ACTION_BSN_MIRROR = 195,
    OF_ACTION_BSN_SET_TUNNEL_DST = 196,
    OF_ACTION_COPY_TTL_IN = 197,
    OF_ACTION_COPY_TTL_OUT = 198,
    OF_ACTION_DEC_MPLS_TTL = 199,
    OF_ACTION_DEC_NW_TTL = 200,
    OF_ACTION_ENQUEUE = 201,
    OF_ACTION_EXPERIMENTER = 202,
    OF_ACTION_GROUP = 203,
    OF_ACTION_HEADER = 204,
    OF_ACTION_ID = 205,
    OF_ACTION_ID_BSN = 206,
    OF_ACTION_ID_BSN_CHECKSUM = 207,
    OF_ACTION_ID_BSN_GENTABLE = 208,
    OF_ACTION_ID_BSN_MIRROR = 209,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 210,
    OF_ACTION_ID_COPY_TTL_IN = 211,
    OF_ACTION_ID_COPY_TTL_OUT = 212,
    OF_ACTION_ID_DEC_MPLS_TTL = 213,
    OF_ACTION_ID_DEC_NW_TTL = 214,
    OF_ACTION_ID_EXPERIMENTER = 215,
    OF_ACTION_ID_GROUP = 216,
    OF_ACTION_ID_HEADER = 217,
    OF_ACTION_ID_NICIRA = 218,
    OF_ACTION_ID_NICIRA_DEC_TTL = 219,
    OF_ACTION_ID_OUTPUT = 220,
    OF_ACTION_ID_POP_MPLS = 221,
    OF_ACTION_ID_POP_PBB = 222,
    OF_ACTION_ID_POP_VLAN = 223,
    OF_ACTION_ID_PUSH_MPLS = 224,
    OF_ACTION_ID_PUSH_PBB = 225,
    OF_ACTION_ID_PUSH_VLAN = 226,
    OF_ACTION_ID_SET_FIELD = 227,
    OF_ACTION_ID_SET_MPLS_TTL = 228,
    OF_ACTION_ID_SET_NW_TTL = 229,
    OF_ACTION_ID_SET_QUEUE = 230,
    OF_ACTION_NICIRA = 231,
    OF_ACTION_NICIRA_DEC_TTL = 232,
    OF_ACTION_OUTPUT = 233,
    OF_ACTION_POP_MPLS = 234,
    OF_ACTION_POP_PBB = 235,
    OF_ACTION_POP_VLAN = 236,
    OF_ACTION_PUSH_MPLS = 237,
    OF_ACTION_PUSH_PBB = 238,
    OF_ACTION_PUSH_VLAN = 239,
    OF_ACTION_SET_DL_DST = 240,
    OF_ACTION_SET_DL_SRC = 241,
    OF_ACTION_SET_FIELD = 242,
    OF_ACTION_SET_MPLS_LABEL = 243,
    OF_ACTION_SET_MPLS_TC = 244,
    OF_ACTION_SET_MPLS_TTL = 245,
    OF_ACTION_SET_NW_DST = 246,
    OF_ACTION_SET_NW_ECN = 247,
    OF_ACTION_SET_NW_SRC = 248,
    OF_ACTION_SET_NW_TOS = 249,
    OF_ACTION_SET_NW_TTL = 250,
    OF_ACTION_SET_QUEUE = 251,
    OF_ACTION_SET_TP_DST = 252,
    OF_ACTION_SET_TP_SRC = 253,
    OF_ACTION_SET_VLAN_PCP = 254,
    OF_ACTION_SET_VLAN_VID = 255,
    OF_ACTION_STRIP_VLAN = 256,
    OF_ASYNC_CONFIG_PROP = 257,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_MASTER = 258,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_SLAVE = 259,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_MASTER = 260,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_SLAVE = 261,
    OF_ASYNC_CONFIG_PROP_HEADER = 262,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_MASTER = 263,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_SLAVE = 264,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_MASTER = 265,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_SLAVE = 266,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_MASTER = 267,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_SLAVE = 268,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_MASTER = 269,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_SLAVE = 270,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_MASTER = 271,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_SLAVE = 272,
    OF_BSN_CONTROLLER_CONNECTION = 273,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 274,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 275,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 276,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 277,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 278,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 279,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 280,
    OF_BSN_GENTABLE_STATS_ENTRY = 281,
    OF_BSN_INTERFACE = 282,
    OF_BSN_LACP_STATS_ENTRY = 283,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 284,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 285,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 286,
    OF_BSN_TLV = 287,
    OF_BSN_TLV_ACTOR_KEY = 288,
    OF_BSN_TLV_ACTOR_PORT_NUM = 289,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 290,
    OF_BSN_TLV_ACTOR_STATE = 291,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 292,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 293,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 294,
    OF_BSN_TLV_CIRCUIT_ID = 295,
    OF_BSN_TLV_CONVERGENCE_STATUS = 296,
    OF_BSN_TLV_CRC_ENABLED = 297,
    OF_BSN_TLV_ETH_DST = 298,
    OF_BSN_TLV_ETH_SRC = 299,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 300,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 301,
    OF_BSN_TLV_EXTERNAL_IP = 302,
    OF_BSN_TLV_EXTERNAL_MAC = 303,
    OF_BSN_TLV_EXTERNAL_NETMASK = 304,
    OF_BSN_TLV_HEADER = 305,
    OF_BSN_TLV_HEADER_SIZE = 306,
    OF_BSN_TLV_IDLE_NOTIFICATION = 307,
    OF_BSN_TLV_IDLE_TIME = 308,
    OF_BSN_TLV_IDLE_TIMEOUT = 309,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 310,
    OF_BSN_TLV_INTERNAL_MAC = 311,
    OF_BSN_TLV_IPV4 = 312,
    OF_BSN_TLV_IPV4_DST = 313,
    OF_BSN_TLV_IPV4_SRC = 314,
    OF_BSN_TLV_MAC = 315,
    OF_BSN_TLV_MISS_PACKETS = 316,
    OF_BSN_TLV_NAME = 317,
    OF_BSN_TLV_PARTNER_KEY = 318,
    OF_BSN_TLV_PARTNER_PORT_NUM = 319,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 320,
    OF_BSN_TLV_PARTNER_STATE = 321,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 322,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 323,
    OF_BSN_TLV_PORT = 324,
    OF_BSN_TLV_QUEUE_ID = 325,
    OF_BSN_TLV_QUEUE_WEIGHT = 326,
    OF_BSN_TLV_REPLY_PACKETS = 327,
    OF_BSN_TLV_REQUEST_PACKETS = 328,
    OF_BSN_TLV_RX_PACKETS = 329,
    OF_BSN_TLV_SAMPLING_RATE = 330,
    OF_BSN_TLV_SUB_AGENT_ID = 331,
    OF_BSN_TLV_TX_BYTES = 332,
    OF_BSN_TLV_TX_PACKETS = 333,
    OF_BSN_TLV_UDF_ANCHOR = 334,
    OF_BSN_TLV_UDF_ID = 335,
    OF_BSN_TLV_UDF_LENGTH = 336,
    OF_BSN_TLV_UDF_OFFSET = 337,
    OF_BSN_TLV_UDP_DST = 338,
    OF_BSN_TLV_UDP_SRC = 339,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 340,
    OF_BSN_TLV_VLAN_VID = 341,
    OF_BSN_TLV_VRF = 342,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 343,
    OF_BSN_VPORT = 344,
    OF_BSN_VPORT_HEADER = 345,
    OF_BSN_VPORT_L2GRE = 346,
    OF_BSN_VPORT_Q_IN_Q = 347,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 348,
    OF_BUCKET = 349,
    OF_BUCKET_COUNTER = 350,
    OF_BUNDLE_PROP = 351,
    OF_BUNDLE_PROP_EXPERIMENTER = 352,
    OF_BUNDLE_PROP_HEADER = 353,
    OF_FLOW_STATS_ENTRY = 354,
    OF_GROUP_DESC_STATS_ENTRY = 355,
    OF_GROUP_STATS_ENTRY = 356,
    OF_HELLO_ELEM = 357,
    OF_HELLO_ELEM_HEADER = 358,
    OF_HELLO_ELEM_VERSIONBITMAP = 359,
    OF_INSTRUCTION = 360,
    OF_INSTRUCTION_APPLY_ACTIONS = 361,
    OF_INSTRUCTION_BSN = 362,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 363,
    OF_INSTRUCTION_BSN_DENY = 364,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 365,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 366,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 367,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 368,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 369,
    OF_INSTRUCTION_BSN_PERMIT = 370,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 371,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 372,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 373,
    OF_INSTRUCTION_CLEAR_ACTIONS = 374,
    OF_INSTRUCTION_EXPERIMENTER = 375,
    OF_INSTRUCTION_GOTO_TABLE = 376,
    OF_INSTRUCTION_HEADER = 377,
    ...
    OF_INSTRUCTION_ID_HEADER = 395,
    OF_INSTRUCTION_ID_METER = 396,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 397,
    OF_INSTRUCTION_ID_WRITE_METADATA = 398,
    OF_INSTRUCTION_METER = 399,
    OF_INSTRUCTION_WRITE_ACTIONS = 400,
    OF_INSTRUCTION_WRITE_METADATA = 401,
    OF_MATCH_V1 = 402,
    OF_MATCH_V2 = 403,
    OF_MATCH_V3 = 404,
    OF_METER_BAND = 405,
    OF_METER_BAND_DROP = 406,
    OF_METER_BAND_DSCP_REMARK = 407,
    OF_METER_BAND_EXPERIMENTER = 408,
    OF_METER_BAND_HEADER = 409,
    ...
    OF_OXM_HEADER = 467,
    OF_OXM_ICMPV4_CODE = 468,
    OF_OXM_ICMPV4_CODE_MASKED = 469,
    OF_OXM_ICMPV4_TYPE = 470,
    OF_OXM_ICMPV4_TYPE_MASKED = 471,
    OF_OXM_ICMPV6_CODE = 472,
    OF_OXM_ICMPV6_CODE_MASKED = 473,
    OF_OXM_ICMPV6_TYPE = 474,
    OF_OXM_ICMPV6_TYPE_MASKED = 475,
    OF_OXM_IN_PHY_PORT = 476,
    OF_OXM_IN_PHY_PORT_MASKED = 477,
    OF_OXM_IN_PORT = 478,
    OF_OXM_IN_PORT_MASKED = 479,
    OF_OXM_IP_DSCP = 480,
    OF_OXM_IP_DSCP_MASKED = 481,
    OF_OXM_IP_ECN = 482,
    OF_OXM_IP_ECN_MASKED = 483,
    OF_OXM_IP_PROTO = 484,
    OF_OXM_IP_PROTO_MASKED = 485,
    OF_OXM_IPV4_DST = 486,
    OF_OXM_IPV4_DST_MASKED = 487,
    OF_OXM_IPV4_SRC = 488,
    OF_OXM_IPV4_SRC_MASKED = 489,
    OF_OXM_IPV6_DST = 490,
    OF_OXM_IPV6_DST_MASKED = 491,
    OF_OXM_IPV6_FLABEL = 492,
    OF_OXM_IPV6_FLABEL_MASKED = 493,
    OF_OXM_IPV6_ND_SLL = 494,
    OF_OXM_IPV6_ND_SLL_MASKED = 495,
    OF_OXM_IPV6_ND_TARGET = 496,
    OF_OXM_IPV6_ND_TARGET_MASKED = 497,
    OF_OXM_IPV6_ND_TLL = 498,
    OF_OXM_IPV6_ND_TLL_MASKED = 499,
    OF_OXM_IPV6_SRC = 500,
    OF_OXM_IPV6_SRC_MASKED = 501,
    OF_OXM_METADATA = 502,
    OF_OXM_METADATA_MASKED = 503,
    OF_OXM_MPLS_BOS = 504,
    OF_OXM_MPLS_BOS_MASKED = 505,
    OF_OXM_MPLS_LABEL = 506,
    OF_OXM_MPLS_LABEL_MASKED = 507,
    OF_OXM_MPLS_TC = 508,
    OF_OXM_MPLS_TC_MASKED = 509,
    OF_OXM_SCTP_DST = 510,
    OF_OXM_SCTP_DST_MASKED = 511,
    OF_OXM_SCTP_SRC = 512,
    OF_OXM_SCTP_SRC_MASKED = 513,
    OF_OXM_TCP_DST = 514,
    OF_OXM_TCP_DST_MASKED = 515,
    OF_OXM_TCP_SRC = 516,
    OF_OXM_TCP_SRC_MASKED = 517,
    OF_OXM_TUNNEL_ID = 518,
    OF_OXM_TUNNEL_ID_MASKED = 519,
    OF_OXM_UDP_DST = 520,
    OF_OXM_UDP_DST_MASKED = 521,
    OF_OXM_UDP_SRC = 522,
    OF_OXM_UDP_SRC_MASKED = 523,
    OF_OXM_VLAN_PCP = 524,
    OF_OXM_VLAN_PCP_MASKED = 525,
    OF_OXM_VLAN_VID = 526,
    OF_OXM_VLAN_VID_MASKED = 527,
    OF_PACKET_QUEUE = 528,
    OF_PORT_DESC = 529,
    OF_PORT_DESC_PROP = 530,
    OF_PORT_DESC_PROP_ETHERNET = 531,
    OF_PORT_DESC_PROP_EXPERIMENTER = 532,
    OF_PORT_DESC_PROP_HEADER = 533,
    OF_PORT_DESC_PROP_OPTICAL = 534,
    OF_PORT_MOD_PROP = 535,
    OF_PORT_MOD_PROP_ETHERNET = 536,
    OF_PORT_MOD_PROP_EXPERIMENTER = 537,
    OF_PORT_MOD_PROP_HEADER = 538,
    OF_PORT_MOD_PROP_OPTICAL = 539,
    OF_PORT_STATS_ENTRY = 540,
    OF_PORT_STATS_PROP = 541,
    OF_PORT_STATS_PROP_ETHERNET = 542,
    OF_PORT_STATS_PROP_EXPERIMENTER = 543,
    OF_PORT_STATS_PROP_HEADER = 544,
    OF_PORT_STATS_PROP_OPTICAL = 545,
    OF_QUEUE_DESC = 546,
    OF_QUEUE_DESC_PROP = 547,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 548,
    OF_QUEUE_DESC_PROP_HEADER = 549,
    OF_QUEUE_DESC_PROP_MAX_RATE = 550,
    OF_QUEUE_DESC_PROP_MIN_RATE = 551,
    OF_QUEUE_PROP = 552,
    OF_QUEUE_PROP_EXPERIMENTER = 553,
    OF_QUEUE_PROP_HEADER = 554,
    ...
    OF_QUEUE_STATS_PROP_HEADER = 560,
    OF_ROLE_PROP = 561,
    OF_ROLE_PROP_EXPERIMENTER = 562,
    OF_ROLE_PROP_HEADER = 563,
    OF_TABLE_DESC = 564,
    OF_TABLE_FEATURE_PROP = 565,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 566,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 567,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 568,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 569,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 570,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 571,
    OF_TABLE_FEATURE_PROP_HEADER = 572,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 573,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 574,
    OF_TABLE_FEATURE_PROP_MATCH = 575,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 576,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 577,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 578,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 579,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 580,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 581,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 582,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 583,
    OF_TABLE_FEATURES = 584,
    OF_TABLE_MOD_PROP = 585,
    OF_TABLE_MOD_PROP_EVICTION = 586,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 587,
    OF_TABLE_MOD_PROP_VACANCY = 588,
    OF_TABLE_STATS_ENTRY = 589,
    OF_UINT32 = 590,
    OF_UINT64 = 591,
    OF_UINT8 = 592,
    ...
    /* List objects */
    OF_LIST_ACTION = 593,
    OF_LIST_ACTION_ID = 594,
    OF_LIST_ASYNC_CONFIG_PROP = 595,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 596,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 597,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 598,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 599,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 600,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 601,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 602,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 603,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 604,
    OF_LIST_BSN_INTERFACE = 605,
    OF_LIST_BSN_LACP_STATS_ENTRY = 606,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 607,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 608,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 609,
    OF_LIST_BSN_TLV = 610,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 611,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 612,
    OF_LIST_BUCKET = 613,
    OF_LIST_BUCKET_COUNTER = 614,
    OF_LIST_BUNDLE_PROP = 615,
    OF_LIST_FLOW_STATS_ENTRY = 616,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 617,
    OF_LIST_GROUP_STATS_ENTRY = 618,
    OF_LIST_HELLO_ELEM = 619,
    OF_LIST_INSTRUCTION = 620,
    OF_LIST_INSTRUCTION_ID = 621,
    OF_LIST_METER_BAND = 622,
    OF_LIST_METER_BAND_STATS = 623,
    OF_LIST_METER_STATS = 624,
    OF_LIST_OXM = 625,
    OF_LIST_PACKET_QUEUE = 626,
    OF_LIST_PORT_DESC = 627,
    OF_LIST_PORT_DESC_PROP = 628,
    OF_LIST_PORT_MOD_PROP = 629,
    OF_LIST_PORT_STATS_ENTRY = 630,
    OF_LIST_PORT_STATS_PROP = 631,
    OF_LIST_QUEUE_DESC = 632,
    OF_LIST_QUEUE_DESC_PROP = 633,
    OF_LIST_QUEUE_PROP = 634,
    OF_LIST_QUEUE_STATS_ENTRY = 635,
    OF_LIST_QUEUE_STATS_PROP = 636,
    OF_LIST_ROLE_PROP = 637,
    OF_LIST_TABLE_DESC = 638,
    OF_LIST_TABLE_FEATURE_PROP = 639,
    OF_LIST_TABLE_FEATURES = 640,
    OF_LIST_TABLE_MOD_PROP = 641,
    OF_LIST_TABLE_STATS_ENTRY = 642,
    OF_LIST_UINT32 = 643,
    OF_LIST_UINT64 = 644,
    OF_LIST_UINT8 = 645,
...
#define OF_MESSAGE_OBJECT_COUNT 191
