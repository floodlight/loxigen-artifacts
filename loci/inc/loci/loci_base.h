...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 335,
    OF_BSN_TLV_MAC = 336,
    OF_BSN_TLV_MAC_MASK = 337,
    OF_BSN_TLV_MISS_PACKETS = 338,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 339,
    OF_BSN_TLV_MPLS_LABEL = 340,
    OF_BSN_TLV_MPLS_SEQUENCED = 341,
    OF_BSN_TLV_NAME = 342,
    OF_BSN_TLV_NEGATE = 343,
    OF_BSN_TLV_OFFSET = 344,
    OF_BSN_TLV_PARTNER_KEY = 345,
    OF_BSN_TLV_PARTNER_PORT_NUM = 346,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 347,
    OF_BSN_TLV_PARTNER_STATE = 348,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 349,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 350,
    OF_BSN_TLV_PORT = 351,
    OF_BSN_TLV_PRIORITY = 352,
    OF_BSN_TLV_QUEUE_ID = 353,
    OF_BSN_TLV_QUEUE_WEIGHT = 354,
    OF_BSN_TLV_REFERENCE = 355,
    OF_BSN_TLV_REPLY_PACKETS = 356,
    OF_BSN_TLV_REQUEST_PACKETS = 357,
    OF_BSN_TLV_RX_BYTES = 358,
    OF_BSN_TLV_RX_PACKETS = 359,
    OF_BSN_TLV_SAMPLING_RATE = 360,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 361,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 362,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 363,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 364,
    OF_BSN_TLV_SUB_AGENT_ID = 365,
    OF_BSN_TLV_TCP_DST = 366,
    OF_BSN_TLV_TCP_SRC = 367,
    OF_BSN_TLV_TX_BYTES = 368,
    OF_BSN_TLV_TX_PACKETS = 369,
    OF_BSN_TLV_UDF_ANCHOR = 370,
    OF_BSN_TLV_UDF_ID = 371,
    OF_BSN_TLV_UDF_LENGTH = 372,
    OF_BSN_TLV_UDF_OFFSET = 373,
    OF_BSN_TLV_UDP_DST = 374,
    OF_BSN_TLV_UDP_SRC = 375,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 376,
    OF_BSN_TLV_VLAN_PCP = 377,
    OF_BSN_TLV_VLAN_VID = 378,
    OF_BSN_TLV_VLAN_VID_MASK = 379,
    OF_BSN_TLV_VRF = 380,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 381,
    OF_BSN_VPORT = 382,
    OF_BSN_VPORT_L2GRE = 383,
    OF_BSN_VPORT_Q_IN_Q = 384,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 385,
    OF_BUCKET = 386,
    OF_BUCKET_COUNTER = 387,
    OF_BUNDLE_PROP = 388,
    OF_BUNDLE_PROP_EXPERIMENTER = 389,
    OF_FLOW_STATS_ENTRY = 390,
    OF_GROUP_DESC_STATS_ENTRY = 391,
    OF_GROUP_STATS_ENTRY = 392,
    OF_HELLO_ELEM = 393,
    OF_HELLO_ELEM_VERSIONBITMAP = 394,
    OF_INSTRUCTION = 395,
    OF_INSTRUCTION_APPLY_ACTIONS = 396,
    OF_INSTRUCTION_BSN = 397,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 398,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 399,
    OF_INSTRUCTION_BSN_DENY = 400,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 401,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 402,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 403,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 404,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 405,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 406,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 407,
    OF_INSTRUCTION_BSN_PERMIT = 408,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 409,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 410,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 411,
    OF_INSTRUCTION_CLEAR_ACTIONS = 412,
    OF_INSTRUCTION_EXPERIMENTER = 413,
    OF_INSTRUCTION_GOTO_TABLE = 414,
    OF_INSTRUCTION_ID = 415,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 416,
    OF_INSTRUCTION_ID_BSN = 417,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 418,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 419,
    OF_INSTRUCTION_ID_BSN_DENY = 420,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 421,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 422,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 423,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 424,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 425,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 426,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 427,
    OF_INSTRUCTION_ID_BSN_PERMIT = 428,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 429,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 430,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 431,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 432,
    OF_INSTRUCTION_ID_EXPERIMENTER = 433,
    OF_INSTRUCTION_ID_GOTO_TABLE = 434,
    OF_INSTRUCTION_ID_METER = 435,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 436,
    OF_INSTRUCTION_ID_WRITE_METADATA = 437,
    OF_INSTRUCTION_METER = 438,
    OF_INSTRUCTION_WRITE_ACTIONS = 439,
    OF_INSTRUCTION_WRITE_METADATA = 440,
    OF_MATCH_V1 = 441,
    OF_MATCH_V2 = 442,
    OF_MATCH_V3 = 443,
    OF_METER_BAND = 444,
    OF_METER_BAND_DROP = 445,
    OF_METER_BAND_DSCP_REMARK = 446,
    OF_METER_BAND_EXPERIMENTER = 447,
    OF_METER_BAND_STATS = 448,
    OF_METER_CONFIG = 449,
    OF_METER_FEATURES = 450,
    OF_METER_STATS = 451,
    OF_OXM = 452,
    OF_OXM_ARP_OP = 453,
    OF_OXM_ARP_OP_MASKED = 454,
    OF_OXM_ARP_SHA = 455,
    OF_OXM_ARP_SHA_MASKED = 456,
    OF_OXM_ARP_SPA = 457,
    OF_OXM_ARP_SPA_MASKED = 458,
    OF_OXM_ARP_THA = 459,
    OF_OXM_ARP_THA_MASKED = 460,
    OF_OXM_ARP_TPA = 461,
    OF_OXM_ARP_TPA_MASKED = 462,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 463,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 464,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 465,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 466,
    OF_OXM_BSN_IN_PORTS_128 = 467,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 468,
    OF_OXM_BSN_IN_PORTS_512 = 469,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 470,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 471,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 472,
    OF_OXM_BSN_INNER_ETH_DST = 473,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 474,
    OF_OXM_BSN_INNER_ETH_SRC = 475,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 476,
    OF_OXM_BSN_INNER_VLAN_VID = 477,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 478,
    OF_OXM_BSN_L2_CACHE_HIT = 479,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 480,
    OF_OXM_BSN_L3_DST_CLASS_ID = 481,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 482,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 483,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 484,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 485,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 486,
    OF_OXM_BSN_LAG_ID = 487,
    OF_OXM_BSN_LAG_ID_MASKED = 488,
    OF_OXM_BSN_TCP_FLAGS = 489,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 490,
    OF_OXM_BSN_UDF0 = 491,
    OF_OXM_BSN_UDF0_MASKED = 492,
    OF_OXM_BSN_UDF1 = 493,
    OF_OXM_BSN_UDF1_MASKED = 494,
    OF_OXM_BSN_UDF2 = 495,
    OF_OXM_BSN_UDF2_MASKED = 496,
    OF_OXM_BSN_UDF3 = 497,
    OF_OXM_BSN_UDF3_MASKED = 498,
    OF_OXM_BSN_UDF4 = 499,
    OF_OXM_BSN_UDF4_MASKED = 500,
    OF_OXM_BSN_UDF5 = 501,
    OF_OXM_BSN_UDF5_MASKED = 502,
    OF_OXM_BSN_UDF6 = 503,
    OF_OXM_BSN_UDF6_MASKED = 504,
    OF_OXM_BSN_UDF7 = 505,
    OF_OXM_BSN_UDF7_MASKED = 506,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 507,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 508,
    OF_OXM_BSN_VRF = 509,
    OF_OXM_BSN_VRF_MASKED = 510,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 511,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 512,
    OF_OXM_ETH_DST = 513,
    OF_OXM_ETH_DST_MASKED = 514,
    OF_OXM_ETH_SRC = 515,
    OF_OXM_ETH_SRC_MASKED = 516,
    OF_OXM_ETH_TYPE = 517,
    OF_OXM_ETH_TYPE_MASKED = 518,
    OF_OXM_ICMPV4_CODE = 519,
    OF_OXM_ICMPV4_CODE_MASKED = 520,
    OF_OXM_ICMPV4_TYPE = 521,
    OF_OXM_ICMPV4_TYPE_MASKED = 522,
    OF_OXM_ICMPV6_CODE = 523,
    OF_OXM_ICMPV6_CODE_MASKED = 524,
    OF_OXM_ICMPV6_TYPE = 525,
    OF_OXM_ICMPV6_TYPE_MASKED = 526,
    OF_OXM_IN_PHY_PORT = 527,
    OF_OXM_IN_PHY_PORT_MASKED = 528,
    OF_OXM_IN_PORT = 529,
    OF_OXM_IN_PORT_MASKED = 530,
    OF_OXM_IP_DSCP = 531,
    OF_OXM_IP_DSCP_MASKED = 532,
    OF_OXM_IP_ECN = 533,
    OF_OXM_IP_ECN_MASKED = 534,
    OF_OXM_IP_PROTO = 535,
    OF_OXM_IP_PROTO_MASKED = 536,
    OF_OXM_IPV4_DST = 537,
    OF_OXM_IPV4_DST_MASKED = 538,
    OF_OXM_IPV4_SRC = 539,
    OF_OXM_IPV4_SRC_MASKED = 540,
    OF_OXM_IPV6_DST = 541,
    OF_OXM_IPV6_DST_MASKED = 542,
    OF_OXM_IPV6_EXTHDR = 543,
    OF_OXM_IPV6_EXTHDR_MASKED = 544,
    OF_OXM_IPV6_FLABEL = 545,
    OF_OXM_IPV6_FLABEL_MASKED = 546,
    OF_OXM_IPV6_ND_SLL = 547,
    OF_OXM_IPV6_ND_SLL_MASKED = 548,
    OF_OXM_IPV6_ND_TARGET = 549,
    OF_OXM_IPV6_ND_TARGET_MASKED = 550,
    OF_OXM_IPV6_ND_TLL = 551,
    OF_OXM_IPV6_ND_TLL_MASKED = 552,
    OF_OXM_IPV6_SRC = 553,
    OF_OXM_IPV6_SRC_MASKED = 554,
    OF_OXM_METADATA = 555,
    OF_OXM_METADATA_MASKED = 556,
    OF_OXM_MPLS_BOS = 557,
    OF_OXM_MPLS_BOS_MASKED = 558,
    OF_OXM_MPLS_LABEL = 559,
    OF_OXM_MPLS_LABEL_MASKED = 560,
    OF_OXM_MPLS_TC = 561,
    OF_OXM_MPLS_TC_MASKED = 562,
    OF_OXM_PBB_UCA = 563,
    OF_OXM_PBB_UCA_MASKED = 564,
    OF_OXM_SCTP_DST = 565,
    OF_OXM_SCTP_DST_MASKED = 566,
    OF_OXM_SCTP_SRC = 567,
    OF_OXM_SCTP_SRC_MASKED = 568,
    OF_OXM_TCP_DST = 569,
    OF_OXM_TCP_DST_MASKED = 570,
    OF_OXM_TCP_SRC = 571,
    OF_OXM_TCP_SRC_MASKED = 572,
    OF_OXM_TUNNEL_ID = 573,
    OF_OXM_TUNNEL_ID_MASKED = 574,
    OF_OXM_TUNNEL_IPV4_DST = 575,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 576,
    OF_OXM_TUNNEL_IPV4_SRC = 577,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 578,
    OF_OXM_UDP_DST = 579,
    OF_OXM_UDP_DST_MASKED = 580,
    OF_OXM_UDP_SRC = 581,
    OF_OXM_UDP_SRC_MASKED = 582,
    OF_OXM_VLAN_PCP = 583,
    OF_OXM_VLAN_PCP_MASKED = 584,
    OF_OXM_VLAN_VID = 585,
    OF_OXM_VLAN_VID_MASKED = 586,
    OF_PACKET_QUEUE = 587,
    OF_PORT_DESC = 588,
    OF_PORT_DESC_PROP = 589,
    OF_PORT_DESC_PROP_BSN = 590,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 591,
    OF_PORT_DESC_PROP_BSN_UPLINK = 592,
    OF_PORT_DESC_PROP_ETHERNET = 593,
    OF_PORT_DESC_PROP_EXPERIMENTER = 594,
    OF_PORT_DESC_PROP_OPTICAL = 595,
    OF_PORT_MOD_PROP = 596,
    OF_PORT_MOD_PROP_ETHERNET = 597,
    OF_PORT_MOD_PROP_EXPERIMENTER = 598,
    OF_PORT_MOD_PROP_OPTICAL = 599,
    OF_PORT_STATS_ENTRY = 600,
    OF_PORT_STATS_PROP = 601,
    OF_PORT_STATS_PROP_ETHERNET = 602,
    OF_PORT_STATS_PROP_EXPERIMENTER = 603,
    OF_PORT_STATS_PROP_OPTICAL = 604,
    OF_QUEUE_DESC = 605,
    OF_QUEUE_DESC_PROP = 606,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 607,
    OF_QUEUE_DESC_PROP_MAX_RATE = 608,
    OF_QUEUE_DESC_PROP_MIN_RATE = 609,
    OF_QUEUE_PROP = 610,
    OF_QUEUE_PROP_EXPERIMENTER = 611,
    OF_QUEUE_PROP_MAX_RATE = 612,
    OF_QUEUE_PROP_MIN_RATE = 613,
    OF_QUEUE_STATS_ENTRY = 614,
    OF_QUEUE_STATS_PROP = 615,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 616,
    OF_ROLE_PROP = 617,
    OF_ROLE_PROP_EXPERIMENTER = 618,
    OF_TABLE_DESC = 619,
    OF_TABLE_FEATURE_PROP = 620,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 621,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 622,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 623,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 624,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 625,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 626,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 627,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 628,
    OF_TABLE_FEATURE_PROP_MATCH = 629,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 630,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 631,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 632,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 633,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 634,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 635,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 636,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 637,
    OF_TABLE_FEATURES = 638,
    OF_TABLE_MOD_PROP = 639,
    OF_TABLE_MOD_PROP_EVICTION = 640,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 641,
    OF_TABLE_MOD_PROP_VACANCY = 642,
    OF_TABLE_STATS_ENTRY = 643,
    OF_UINT32 = 644,
    OF_UINT64 = 645,
    OF_UINT8 = 646,
    ...
    /* List objects */
    OF_LIST_ACTION = 647,
    OF_LIST_ACTION_ID = 648,
    OF_LIST_ASYNC_CONFIG_PROP = 649,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 650,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 651,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 652,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 653,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 654,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 655,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 656,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 657,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 658,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 659,
    OF_LIST_BSN_INTERFACE = 660,
    OF_LIST_BSN_LACP_STATS_ENTRY = 661,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 662,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 663,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 664,
    OF_LIST_BSN_TLV = 665,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 666,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 667,
    OF_LIST_BUCKET = 668,
    OF_LIST_BUCKET_COUNTER = 669,
    OF_LIST_BUNDLE_PROP = 670,
    OF_LIST_FLOW_STATS_ENTRY = 671,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 672,
    OF_LIST_GROUP_STATS_ENTRY = 673,
    OF_LIST_HELLO_ELEM = 674,
    OF_LIST_INSTRUCTION = 675,
    OF_LIST_INSTRUCTION_ID = 676,
    OF_LIST_METER_BAND = 677,
    OF_LIST_METER_BAND_STATS = 678,
    OF_LIST_METER_STATS = 679,
    OF_LIST_OXM = 680,
    OF_LIST_PACKET_QUEUE = 681,
    OF_LIST_PORT_DESC = 682,
    OF_LIST_PORT_DESC_PROP = 683,
    OF_LIST_PORT_MOD_PROP = 684,
    OF_LIST_PORT_STATS_ENTRY = 685,
    OF_LIST_PORT_STATS_PROP = 686,
    OF_LIST_QUEUE_DESC = 687,
    OF_LIST_QUEUE_DESC_PROP = 688,
    OF_LIST_QUEUE_PROP = 689,
    OF_LIST_QUEUE_STATS_ENTRY = 690,
    OF_LIST_QUEUE_STATS_PROP = 691,
    OF_LIST_ROLE_PROP = 692,
    OF_LIST_TABLE_DESC = 693,
    OF_LIST_TABLE_FEATURE_PROP = 694,
    OF_LIST_TABLE_FEATURES = 695,
    OF_LIST_TABLE_MOD_PROP = 696,
    OF_LIST_TABLE_STATS_ENTRY = 697,
    OF_LIST_UINT32 = 698,
    OF_LIST_UINT64 = 699,
    OF_LIST_UINT8 = 700,
