...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 307,
    OF_INSTRUCTION_BSN_PERMIT = 308,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 309,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 310,
    OF_INSTRUCTION_CLEAR_ACTIONS = 311,
    OF_INSTRUCTION_EXPERIMENTER = 312,
    OF_INSTRUCTION_GOTO_TABLE = 313,
    OF_INSTRUCTION_HEADER = 314,
    OF_INSTRUCTION_ID = 315,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 316,
    OF_INSTRUCTION_ID_BSN = 317,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 318,
    OF_INSTRUCTION_ID_BSN_DENY = 319,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 320,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 321,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 322,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 323,
    OF_INSTRUCTION_ID_BSN_PERMIT = 324,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 325,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 326,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 327,
    OF_INSTRUCTION_ID_EXPERIMENTER = 328,
    OF_INSTRUCTION_ID_GOTO_TABLE = 329,
    OF_INSTRUCTION_ID_HEADER = 330,
    OF_INSTRUCTION_ID_METER = 331,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 332,
    OF_INSTRUCTION_ID_WRITE_METADATA = 333,
    OF_INSTRUCTION_METER = 334,
    OF_INSTRUCTION_WRITE_ACTIONS = 335,
    OF_INSTRUCTION_WRITE_METADATA = 336,
    OF_MATCH_V1 = 337,
    OF_MATCH_V2 = 338,
    OF_MATCH_V3 = 339,
    OF_METER_BAND = 340,
    OF_METER_BAND_DROP = 341,
    OF_METER_BAND_DSCP_REMARK = 342,
    OF_METER_BAND_EXPERIMENTER = 343,
    OF_METER_BAND_HEADER = 344,
    OF_METER_BAND_STATS = 345,
    OF_METER_CONFIG = 346,
    OF_METER_FEATURES = 347,
    OF_METER_STATS = 348,
    OF_OXM = 349,
    OF_OXM_ARP_OP = 350,
    OF_OXM_ARP_OP_MASKED = 351,
    OF_OXM_ARP_SHA = 352,
    OF_OXM_ARP_SHA_MASKED = 353,
    OF_OXM_ARP_SPA = 354,
    OF_OXM_ARP_SPA_MASKED = 355,
    OF_OXM_ARP_THA = 356,
    OF_OXM_ARP_THA_MASKED = 357,
    OF_OXM_ARP_TPA = 358,
    OF_OXM_ARP_TPA_MASKED = 359,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 360,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 361,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 362,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 363,
    OF_OXM_BSN_IN_PORTS_128 = 364,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 365,
    OF_OXM_BSN_L3_DST_CLASS_ID = 366,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 367,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 368,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 369,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 370,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 371,
    OF_OXM_BSN_LAG_ID = 372,
    OF_OXM_BSN_LAG_ID_MASKED = 373,
    OF_OXM_BSN_TCP_FLAGS = 374,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 375,
    OF_OXM_BSN_UDF0 = 376,
    OF_OXM_BSN_UDF0_MASKED = 377,
    OF_OXM_BSN_UDF1 = 378,
    OF_OXM_BSN_UDF1_MASKED = 379,
    OF_OXM_BSN_UDF2 = 380,
    OF_OXM_BSN_UDF2_MASKED = 381,
    OF_OXM_BSN_UDF3 = 382,
    OF_OXM_BSN_UDF3_MASKED = 383,
    OF_OXM_BSN_UDF4 = 384,
    OF_OXM_BSN_UDF4_MASKED = 385,
    OF_OXM_BSN_UDF5 = 386,
    OF_OXM_BSN_UDF5_MASKED = 387,
    OF_OXM_BSN_UDF6 = 388,
    OF_OXM_BSN_UDF6_MASKED = 389,
    OF_OXM_BSN_UDF7 = 390,
    OF_OXM_BSN_UDF7_MASKED = 391,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 392,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 393,
    OF_OXM_BSN_VRF = 394,
    OF_OXM_BSN_VRF_MASKED = 395,
    OF_OXM_ETH_DST = 396,
    OF_OXM_ETH_DST_MASKED = 397,
    OF_OXM_ETH_SRC = 398,
    OF_OXM_ETH_SRC_MASKED = 399,
    OF_OXM_ETH_TYPE = 400,
    OF_OXM_ETH_TYPE_MASKED = 401,
    OF_OXM_HEADER = 402,
    OF_OXM_ICMPV4_CODE = 403,
    OF_OXM_ICMPV4_CODE_MASKED = 404,
    OF_OXM_ICMPV4_TYPE = 405,
    OF_OXM_ICMPV4_TYPE_MASKED = 406,
    OF_OXM_ICMPV6_CODE = 407,
    OF_OXM_ICMPV6_CODE_MASKED = 408,
    OF_OXM_ICMPV6_TYPE = 409,
    OF_OXM_ICMPV6_TYPE_MASKED = 410,
    OF_OXM_IN_PHY_PORT = 411,
    OF_OXM_IN_PHY_PORT_MASKED = 412,
    OF_OXM_IN_PORT = 413,
    OF_OXM_IN_PORT_MASKED = 414,
    OF_OXM_IP_DSCP = 415,
    OF_OXM_IP_DSCP_MASKED = 416,
    OF_OXM_IP_ECN = 417,
    OF_OXM_IP_ECN_MASKED = 418,
    OF_OXM_IP_PROTO = 419,
    OF_OXM_IP_PROTO_MASKED = 420,
    OF_OXM_IPV4_DST = 421,
    OF_OXM_IPV4_DST_MASKED = 422,
    OF_OXM_IPV4_SRC = 423,
    OF_OXM_IPV4_SRC_MASKED = 424,
    OF_OXM_IPV6_DST = 425,
    OF_OXM_IPV6_DST_MASKED = 426,
    OF_OXM_IPV6_FLABEL = 427,
    OF_OXM_IPV6_FLABEL_MASKED = 428,
    OF_OXM_IPV6_ND_SLL = 429,
    OF_OXM_IPV6_ND_SLL_MASKED = 430,
    OF_OXM_IPV6_ND_TARGET = 431,
    OF_OXM_IPV6_ND_TARGET_MASKED = 432,
    OF_OXM_IPV6_ND_TLL = 433,
    OF_OXM_IPV6_ND_TLL_MASKED = 434,
    OF_OXM_IPV6_SRC = 435,
    OF_OXM_IPV6_SRC_MASKED = 436,
    OF_OXM_METADATA = 437,
    OF_OXM_METADATA_MASKED = 438,
    OF_OXM_MPLS_LABEL = 439,
    OF_OXM_MPLS_LABEL_MASKED = 440,
    OF_OXM_MPLS_TC = 441,
    OF_OXM_MPLS_TC_MASKED = 442,
    OF_OXM_SCTP_DST = 443,
    OF_OXM_SCTP_DST_MASKED = 444,
    OF_OXM_SCTP_SRC = 445,
    OF_OXM_SCTP_SRC_MASKED = 446,
    OF_OXM_TCP_DST = 447,
    OF_OXM_TCP_DST_MASKED = 448,
    OF_OXM_TCP_SRC = 449,
    OF_OXM_TCP_SRC_MASKED = 450,
    OF_OXM_TUNNEL_ID = 451,
    OF_OXM_TUNNEL_ID_MASKED = 452,
    OF_OXM_UDP_DST = 453,
    OF_OXM_UDP_DST_MASKED = 454,
    OF_OXM_UDP_SRC = 455,
    OF_OXM_UDP_SRC_MASKED = 456,
    OF_OXM_VLAN_PCP = 457,
    OF_OXM_VLAN_PCP_MASKED = 458,
    OF_OXM_VLAN_VID = 459,
    OF_OXM_VLAN_VID_MASKED = 460,
    OF_PACKET_QUEUE = 461,
    OF_PORT_DESC = 462,
    OF_PORT_STATS_ENTRY = 463,
    OF_QUEUE_PROP = 464,
    OF_QUEUE_PROP_EXPERIMENTER = 465,
    OF_QUEUE_PROP_HEADER = 466,
    OF_QUEUE_PROP_MAX_RATE = 467,
    OF_QUEUE_PROP_MIN_RATE = 468,
    OF_QUEUE_STATS_ENTRY = 469,
    OF_TABLE_FEATURE_PROP = 470,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 471,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 472,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 473,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 474,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 475,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 476,
    OF_TABLE_FEATURE_PROP_HEADER = 477,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 478,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 479,
    OF_TABLE_FEATURE_PROP_MATCH = 480,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 481,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 482,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 483,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 484,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 485,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 486,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 487,
    OF_TABLE_FEATURES = 488,
    OF_TABLE_STATS_ENTRY = 489,
    OF_UINT32 = 490,
    OF_UINT64 = 491,
    OF_UINT8 = 492,
    ...
    /* List objects */
    OF_LIST_ACTION = 493,
    OF_LIST_ACTION_ID = 494,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 495,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 496,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 497,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 498,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 499,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 500,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 501,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 502,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 503,
    OF_LIST_BSN_INTERFACE = 504,
    OF_LIST_BSN_LACP_STATS_ENTRY = 505,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 506,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 507,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 508,
    OF_LIST_BSN_TLV = 509,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 510,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 511,
    OF_LIST_BUCKET = 512,
    OF_LIST_BUCKET_COUNTER = 513,
    OF_LIST_FLOW_STATS_ENTRY = 514,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 515,
    OF_LIST_GROUP_STATS_ENTRY = 516,
    OF_LIST_HELLO_ELEM = 517,
    OF_LIST_INSTRUCTION = 518,
    OF_LIST_INSTRUCTION_ID = 519,
    OF_LIST_METER_BAND = 520,
    OF_LIST_METER_BAND_STATS = 521,
    OF_LIST_METER_STATS = 522,
    OF_LIST_OXM = 523,
    OF_LIST_PACKET_QUEUE = 524,
    OF_LIST_PORT_DESC = 525,
    OF_LIST_PORT_STATS_ENTRY = 526,
    OF_LIST_QUEUE_PROP = 527,
    OF_LIST_QUEUE_STATS_ENTRY = 528,
    OF_LIST_TABLE_FEATURE_PROP = 529,
    OF_LIST_TABLE_FEATURES = 530,
    OF_LIST_TABLE_STATS_ENTRY = 531,
    OF_LIST_UINT32 = 532,
    OF_LIST_UINT64 = 533,
    OF_LIST_UINT8 = 534,
