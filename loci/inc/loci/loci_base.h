...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_DROP = 321,
    OF_BSN_TLV_DSCP = 322,
    OF_BSN_TLV_ETH_DST = 323,
    OF_BSN_TLV_ETH_SRC = 324,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 325,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 326,
    OF_BSN_TLV_EXTERNAL_IP = 327,
    OF_BSN_TLV_EXTERNAL_MAC = 328,
    OF_BSN_TLV_EXTERNAL_NETMASK = 329,
    OF_BSN_TLV_GENERATION_ID = 330,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 331,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 332,
    OF_BSN_TLV_HASH_PACKET_FIELD = 333,
    OF_BSN_TLV_HASH_PACKET_TYPE = 334,
    OF_BSN_TLV_HASH_SEED = 335,
    OF_BSN_TLV_HASH_TYPE = 336,
    OF_BSN_TLV_HEADER_SIZE = 337,
    OF_BSN_TLV_ICMP_CODE = 338,
    OF_BSN_TLV_ICMP_ID = 339,
    OF_BSN_TLV_ICMP_TYPE = 340,
    OF_BSN_TLV_ICMPV6_CHKSUM = 341,
    OF_BSN_TLV_IDLE_NOTIFICATION = 342,
    OF_BSN_TLV_IDLE_TIME = 343,
    OF_BSN_TLV_IDLE_TIMEOUT = 344,
    OF_BSN_TLV_IGMP_SNOOPING = 345,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 346,
    OF_BSN_TLV_INTERNAL_MAC = 347,
    OF_BSN_TLV_INTERVAL = 348,
    OF_BSN_TLV_IP_PROTO = 349,
    OF_BSN_TLV_IPV4 = 350,
    OF_BSN_TLV_IPV4_DST = 351,
    OF_BSN_TLV_IPV4_NETMASK = 352,
    OF_BSN_TLV_IPV4_SRC = 353,
    OF_BSN_TLV_IPV6 = 354,
    OF_BSN_TLV_IPV6_DST = 355,
    OF_BSN_TLV_IPV6_PREFIX = 356,
    OF_BSN_TLV_IPV6_SRC = 357,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 358,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 359,
    OF_BSN_TLV_LOOPBACK_PORT = 360,
    OF_BSN_TLV_MAC = 361,
    OF_BSN_TLV_MAC_MASK = 362,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 363,
    OF_BSN_TLV_MISS_PACKETS = 364,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 365,
    OF_BSN_TLV_MPLS_LABEL = 366,
    OF_BSN_TLV_MPLS_SEQUENCED = 367,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 368,
    OF_BSN_TLV_NAME = 369,
    OF_BSN_TLV_NDP_OFFLOAD = 370,
    OF_BSN_TLV_NDP_STATIC = 371,
    OF_BSN_TLV_NEGATE = 372,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 373,
    OF_BSN_TLV_NEXT_HOP_MAC = 374,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 375,
    OF_BSN_TLV_OFFSET = 376,
    OF_BSN_TLV_PARENT_PORT = 377,
    OF_BSN_TLV_PARTNER_KEY = 378,
    OF_BSN_TLV_PARTNER_PORT_NUM = 379,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 380,
    OF_BSN_TLV_PARTNER_STATE = 381,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 382,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 383,
    OF_BSN_TLV_PORT = 384,
    OF_BSN_TLV_PORT_VXLAN_MODE = 385,
    OF_BSN_TLV_PRIORITY = 386,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 387,
    OF_BSN_TLV_QOS_PRIORITY = 388,
    OF_BSN_TLV_QUEUE_ID = 389,
    OF_BSN_TLV_QUEUE_WEIGHT = 390,
    OF_BSN_TLV_RATE_LIMIT = 391,
    OF_BSN_TLV_RATE_UNIT = 392,
    OF_BSN_TLV_REFERENCE = 393,
    OF_BSN_TLV_REPLY_PACKETS = 394,
    OF_BSN_TLV_REQUEST_PACKETS = 395,
    OF_BSN_TLV_RX_BYTES = 396,
    OF_BSN_TLV_RX_PACKETS = 397,
    OF_BSN_TLV_SAMPLING_RATE = 398,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 399,
    OF_BSN_TLV_STATUS = 400,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 401,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 402,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 403,
    OF_BSN_TLV_SUB_AGENT_ID = 404,
    OF_BSN_TLV_TCP_DST = 405,
    OF_BSN_TLV_TCP_SRC = 406,
    OF_BSN_TLV_TTL = 407,
    OF_BSN_TLV_TX_BYTES = 408,
    OF_BSN_TLV_TX_PACKETS = 409,
    OF_BSN_TLV_UDF_ANCHOR = 410,
    OF_BSN_TLV_UDF_ID = 411,
    OF_BSN_TLV_UDF_LENGTH = 412,
    OF_BSN_TLV_UDF_OFFSET = 413,
    OF_BSN_TLV_UDP_DST = 414,
    OF_BSN_TLV_UDP_SRC = 415,
    OF_BSN_TLV_UINT64_LIST = 416,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 417,
    OF_BSN_TLV_UNICAST_RATE = 418,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 419,
    OF_BSN_TLV_UNTAGGED = 420,
    OF_BSN_TLV_USE_PACKET_STATE = 421,
    OF_BSN_TLV_VFI = 422,
    OF_BSN_TLV_VFP_CLASS_ID = 423,
    OF_BSN_TLV_VLAN_MAC_LIST = 424,
    OF_BSN_TLV_VLAN_PCP = 425,
    OF_BSN_TLV_VLAN_VID = 426,
    OF_BSN_TLV_VLAN_VID_MASK = 427,
    OF_BSN_TLV_VNI = 428,
    OF_BSN_TLV_VPN_KEY = 429,
    OF_BSN_TLV_VRF = 430,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 431,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 432,
    OF_BSN_VLAN_MAC = 433,
    OF_BSN_VPORT = 434,
    OF_BSN_VPORT_L2GRE = 435,
    OF_BSN_VPORT_Q_IN_Q = 436,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 437,
    OF_BUCKET = 438,
    OF_BUCKET_COUNTER = 439,
    OF_BUNDLE_PROP = 440,
    OF_BUNDLE_PROP_EXPERIMENTER = 441,
    OF_FLOW_STATS_ENTRY = 442,
    OF_GROUP_DESC_STATS_ENTRY = 443,
    OF_GROUP_STATS_ENTRY = 444,
    OF_HELLO_ELEM = 445,
    OF_HELLO_ELEM_VERSIONBITMAP = 446,
    OF_INSTRUCTION = 447,
    OF_INSTRUCTION_APPLY_ACTIONS = 448,
    OF_INSTRUCTION_BSN = 449,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 450,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 451,
    OF_INSTRUCTION_BSN_DENY = 452,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 453,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 454,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 455,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 456,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 457,
    OF_INSTRUCTION_BSN_HASH_SELECT = 458,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 459,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 460,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 461,
    OF_INSTRUCTION_BSN_PERMIT = 462,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 463,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 464,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 465,
    OF_INSTRUCTION_CLEAR_ACTIONS = 466,
    OF_INSTRUCTION_EXPERIMENTER = 467,
    OF_INSTRUCTION_GOTO_TABLE = 468,
    OF_INSTRUCTION_ID = 469,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 470,
    OF_INSTRUCTION_ID_BSN = 471,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 472,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 473,
    OF_INSTRUCTION_ID_BSN_DENY = 474,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 475,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 476,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 477,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 478,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 479,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 480,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 481,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 482,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 483,
    OF_INSTRUCTION_ID_BSN_PERMIT = 484,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 485,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 486,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 487,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 488,
    OF_INSTRUCTION_ID_EXPERIMENTER = 489,
    OF_INSTRUCTION_ID_GOTO_TABLE = 490,
    OF_INSTRUCTION_ID_METER = 491,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 492,
    OF_INSTRUCTION_ID_WRITE_METADATA = 493,
    OF_INSTRUCTION_METER = 494,
    OF_INSTRUCTION_WRITE_ACTIONS = 495,
    OF_INSTRUCTION_WRITE_METADATA = 496,
    OF_MATCH_V1 = 497,
    OF_MATCH_V2 = 498,
    OF_MATCH_V3 = 499,
    OF_METER_BAND = 500,
    OF_METER_BAND_DROP = 501,
    OF_METER_BAND_DSCP_REMARK = 502,
    OF_METER_BAND_EXPERIMENTER = 503,
    OF_METER_BAND_STATS = 504,
    OF_METER_CONFIG = 505,
    OF_METER_FEATURES = 506,
    OF_METER_STATS = 507,
    OF_OXM = 508,
    OF_OXM_ARP_OP = 509,
    OF_OXM_ARP_OP_MASKED = 510,
    OF_OXM_ARP_SHA = 511,
    OF_OXM_ARP_SHA_MASKED = 512,
    OF_OXM_ARP_SPA = 513,
    OF_OXM_ARP_SPA_MASKED = 514,
    OF_OXM_ARP_THA = 515,
    OF_OXM_ARP_THA_MASKED = 516,
    OF_OXM_ARP_TPA = 517,
    OF_OXM_ARP_TPA_MASKED = 518,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 519,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 520,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 521,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 522,
    OF_OXM_BSN_IN_PORTS_128 = 523,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 524,
    OF_OXM_BSN_IN_PORTS_512 = 525,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 526,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 527,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 528,
    OF_OXM_BSN_INNER_ETH_DST = 529,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 530,
    OF_OXM_BSN_INNER_ETH_SRC = 531,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 532,
    OF_OXM_BSN_INNER_VLAN_VID = 533,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 534,
    OF_OXM_BSN_L2_CACHE_HIT = 535,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 536,
    OF_OXM_BSN_L3_DST_CLASS_ID = 537,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 538,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 539,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 540,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 541,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 542,
    OF_OXM_BSN_LAG_ID = 543,
    OF_OXM_BSN_LAG_ID_MASKED = 544,
    OF_OXM_BSN_TCP_FLAGS = 545,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 546,
    OF_OXM_BSN_UDF0 = 547,
    OF_OXM_BSN_UDF0_MASKED = 548,
    OF_OXM_BSN_UDF1 = 549,
    OF_OXM_BSN_UDF1_MASKED = 550,
    OF_OXM_BSN_UDF2 = 551,
    OF_OXM_BSN_UDF2_MASKED = 552,
    OF_OXM_BSN_UDF3 = 553,
    OF_OXM_BSN_UDF3_MASKED = 554,
    OF_OXM_BSN_UDF4 = 555,
    OF_OXM_BSN_UDF4_MASKED = 556,
    OF_OXM_BSN_UDF5 = 557,
    OF_OXM_BSN_UDF5_MASKED = 558,
    OF_OXM_BSN_UDF6 = 559,
    OF_OXM_BSN_UDF6_MASKED = 560,
    OF_OXM_BSN_UDF7 = 561,
    OF_OXM_BSN_UDF7_MASKED = 562,
    OF_OXM_BSN_VFI = 563,
    OF_OXM_BSN_VFI_MASKED = 564,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 565,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 566,
    OF_OXM_BSN_VRF = 567,
    OF_OXM_BSN_VRF_MASKED = 568,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 569,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 570,
    OF_OXM_ETH_DST = 571,
    OF_OXM_ETH_DST_MASKED = 572,
    OF_OXM_ETH_SRC = 573,
    OF_OXM_ETH_SRC_MASKED = 574,
    OF_OXM_ETH_TYPE = 575,
    OF_OXM_ETH_TYPE_MASKED = 576,
    OF_OXM_ICMPV4_CODE = 577,
    OF_OXM_ICMPV4_CODE_MASKED = 578,
    OF_OXM_ICMPV4_TYPE = 579,
    OF_OXM_ICMPV4_TYPE_MASKED = 580,
    OF_OXM_ICMPV6_CODE = 581,
    OF_OXM_ICMPV6_CODE_MASKED = 582,
    OF_OXM_ICMPV6_TYPE = 583,
    OF_OXM_ICMPV6_TYPE_MASKED = 584,
    OF_OXM_IN_PHY_PORT = 585,
    OF_OXM_IN_PHY_PORT_MASKED = 586,
    OF_OXM_IN_PORT = 587,
    OF_OXM_IN_PORT_MASKED = 588,
    OF_OXM_IP_DSCP = 589,
    OF_OXM_IP_DSCP_MASKED = 590,
    OF_OXM_IP_ECN = 591,
    OF_OXM_IP_ECN_MASKED = 592,
    OF_OXM_IP_PROTO = 593,
    OF_OXM_IP_PROTO_MASKED = 594,
    OF_OXM_IPV4_DST = 595,
    OF_OXM_IPV4_DST_MASKED = 596,
    OF_OXM_IPV4_SRC = 597,
    OF_OXM_IPV4_SRC_MASKED = 598,
    OF_OXM_IPV6_DST = 599,
    OF_OXM_IPV6_DST_MASKED = 600,
    OF_OXM_IPV6_EXTHDR = 601,
    OF_OXM_IPV6_EXTHDR_MASKED = 602,
    OF_OXM_IPV6_FLABEL = 603,
    OF_OXM_IPV6_FLABEL_MASKED = 604,
    OF_OXM_IPV6_ND_SLL = 605,
    OF_OXM_IPV6_ND_SLL_MASKED = 606,
    OF_OXM_IPV6_ND_TARGET = 607,
    OF_OXM_IPV6_ND_TARGET_MASKED = 608,
    OF_OXM_IPV6_ND_TLL = 609,
    OF_OXM_IPV6_ND_TLL_MASKED = 610,
    OF_OXM_IPV6_SRC = 611,
    OF_OXM_IPV6_SRC_MASKED = 612,
    OF_OXM_METADATA = 613,
    OF_OXM_METADATA_MASKED = 614,
    OF_OXM_MPLS_BOS = 615,
    OF_OXM_MPLS_BOS_MASKED = 616,
    OF_OXM_MPLS_LABEL = 617,
    OF_OXM_MPLS_LABEL_MASKED = 618,
    OF_OXM_MPLS_TC = 619,
    OF_OXM_MPLS_TC_MASKED = 620,
    OF_OXM_OVS_TCP_FLAGS = 621,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 622,
    OF_OXM_PBB_UCA = 623,
    OF_OXM_PBB_UCA_MASKED = 624,
    OF_OXM_SCTP_DST = 625,
    OF_OXM_SCTP_DST_MASKED = 626,
    OF_OXM_SCTP_SRC = 627,
    OF_OXM_SCTP_SRC_MASKED = 628,
    OF_OXM_TCP_DST = 629,
    OF_OXM_TCP_DST_MASKED = 630,
    OF_OXM_TCP_SRC = 631,
    OF_OXM_TCP_SRC_MASKED = 632,
    OF_OXM_TUNNEL_ID = 633,
    OF_OXM_TUNNEL_ID_MASKED = 634,
    OF_OXM_TUNNEL_IPV4_DST = 635,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 636,
    OF_OXM_TUNNEL_IPV4_SRC = 637,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 638,
    OF_OXM_UDP_DST = 639,
    OF_OXM_UDP_DST_MASKED = 640,
    OF_OXM_UDP_SRC = 641,
    OF_OXM_UDP_SRC_MASKED = 642,
    OF_OXM_VLAN_PCP = 643,
    OF_OXM_VLAN_PCP_MASKED = 644,
    OF_OXM_VLAN_VID = 645,
    OF_OXM_VLAN_VID_MASKED = 646,
    OF_PACKET_QUEUE = 647,
    OF_PORT_DESC = 648,
    OF_PORT_DESC_PROP = 649,
    OF_PORT_DESC_PROP_BSN = 650,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 651,
    OF_PORT_DESC_PROP_BSN_UPLINK = 652,
    OF_PORT_DESC_PROP_ETHERNET = 653,
    OF_PORT_DESC_PROP_EXPERIMENTER = 654,
    OF_PORT_DESC_PROP_OPTICAL = 655,
    OF_PORT_MOD_PROP = 656,
    OF_PORT_MOD_PROP_ETHERNET = 657,
    OF_PORT_MOD_PROP_EXPERIMENTER = 658,
    OF_PORT_MOD_PROP_OPTICAL = 659,
    OF_PORT_STATS_ENTRY = 660,
    OF_PORT_STATS_PROP = 661,
    OF_PORT_STATS_PROP_ETHERNET = 662,
    OF_PORT_STATS_PROP_EXPERIMENTER = 663,
    OF_PORT_STATS_PROP_OPTICAL = 664,
    OF_QUEUE_DESC = 665,
    OF_QUEUE_DESC_PROP = 666,
    OF_QUEUE_DESC_PROP_BSN = 667,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 668,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 669,
    OF_QUEUE_DESC_PROP_MAX_RATE = 670,
    OF_QUEUE_DESC_PROP_MIN_RATE = 671,
    OF_QUEUE_PROP = 672,
    OF_QUEUE_PROP_EXPERIMENTER = 673,
    OF_QUEUE_PROP_MAX_RATE = 674,
    OF_QUEUE_PROP_MIN_RATE = 675,
    OF_QUEUE_STATS_ENTRY = 676,
    OF_QUEUE_STATS_PROP = 677,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 678,
    OF_ROLE_PROP = 679,
    OF_ROLE_PROP_EXPERIMENTER = 680,
    OF_TABLE_DESC = 681,
    OF_TABLE_FEATURE_PROP = 682,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 683,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 684,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 685,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 686,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 687,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 688,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 689,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 690,
    OF_TABLE_FEATURE_PROP_MATCH = 691,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 692,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 693,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 694,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 695,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 696,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 697,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 698,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 699,
    OF_TABLE_FEATURES = 700,
    OF_TABLE_MOD_PROP = 701,
    OF_TABLE_MOD_PROP_EVICTION = 702,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 703,
    OF_TABLE_MOD_PROP_VACANCY = 704,
    OF_TABLE_STATS_ENTRY = 705,
    OF_UINT32 = 706,
    OF_UINT64 = 707,
    OF_UINT8 = 708,
    ...
    /* List objects */
    OF_LIST_ACTION = 709,
    OF_LIST_ACTION_ID = 710,
    OF_LIST_ASYNC_CONFIG_PROP = 711,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 712,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 713,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 714,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 715,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 716,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 717,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 718,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 719,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 720,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 721,
    OF_LIST_BSN_INTERFACE = 722,
    OF_LIST_BSN_LACP_STATS_ENTRY = 723,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 724,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 725,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 726,
    OF_LIST_BSN_TLV = 727,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 728,
    OF_LIST_BSN_VLAN_MAC = 729,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 730,
    OF_LIST_BUCKET = 731,
    OF_LIST_BUCKET_COUNTER = 732,
    OF_LIST_BUNDLE_PROP = 733,
    OF_LIST_FLOW_STATS_ENTRY = 734,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 735,
    OF_LIST_GROUP_STATS_ENTRY = 736,
    OF_LIST_HELLO_ELEM = 737,
    OF_LIST_INSTRUCTION = 738,
    OF_LIST_INSTRUCTION_ID = 739,
    OF_LIST_METER_BAND = 740,
    OF_LIST_METER_BAND_STATS = 741,
    OF_LIST_METER_CONFIG = 742,
    OF_LIST_METER_STATS = 743,
    OF_LIST_OXM = 744,
    OF_LIST_PACKET_QUEUE = 745,
    OF_LIST_PORT_DESC = 746,
    OF_LIST_PORT_DESC_PROP = 747,
    OF_LIST_PORT_MOD_PROP = 748,
    OF_LIST_PORT_STATS_ENTRY = 749,
    OF_LIST_PORT_STATS_PROP = 750,
    OF_LIST_QUEUE_DESC = 751,
    OF_LIST_QUEUE_DESC_PROP = 752,
    OF_LIST_QUEUE_PROP = 753,
    OF_LIST_QUEUE_STATS_ENTRY = 754,
    OF_LIST_QUEUE_STATS_PROP = 755,
    OF_LIST_ROLE_PROP = 756,
    OF_LIST_TABLE_DESC = 757,
    OF_LIST_TABLE_FEATURE_PROP = 758,
    OF_LIST_TABLE_FEATURES = 759,
    OF_LIST_TABLE_MOD_PROP = 760,
    OF_LIST_TABLE_STATS_ENTRY = 761,
    OF_LIST_UINT32 = 762,
    OF_LIST_UINT64 = 763,
    OF_LIST_UINT8 = 764,
