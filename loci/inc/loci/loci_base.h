...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV = 303,
    OF_BSN_TLV_ACTIVE = 304,
    OF_BSN_TLV_ACTOR_KEY = 305,
    OF_BSN_TLV_ACTOR_PORT_NUM = 306,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 307,
    OF_BSN_TLV_ACTOR_STATE = 308,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 309,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 310,
    OF_BSN_TLV_ADMIN_STATE = 311,
    OF_BSN_TLV_ANALYTICS = 312,
    OF_BSN_TLV_ANCHOR = 313,
    OF_BSN_TLV_APPLY_BYTES = 314,
    OF_BSN_TLV_APPLY_PACKETS = 315,
    OF_BSN_TLV_ARP_SPA = 316,
    OF_BSN_TLV_ARP_TPA = 317,
    OF_BSN_TLV_AUTO_NEGOTIATION = 318,
    OF_BSN_TLV_BFD_ENDPOINT = 319,
    OF_BSN_TLV_BFD_STATE = 320,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 321,
    OF_BSN_TLV_BROADCAST_RATE = 322,
    OF_BSN_TLV_BUCKET = 323,
    OF_BSN_TLV_CIRCUIT_ID = 324,
    OF_BSN_TLV_CLIENT_LL_ADDR = 325,
    OF_BSN_TLV_CONVERGENCE_STATUS = 326,
    OF_BSN_TLV_CPU_LAG = 327,
    OF_BSN_TLV_CRC_ENABLED = 328,
    OF_BSN_TLV_DATA = 329,
    OF_BSN_TLV_DATA_MASK = 330,
    OF_BSN_TLV_DECAP = 331,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 332,
    OF_BSN_TLV_DISABLE_XMIT = 333,
    OF_BSN_TLV_DNS_ANALYTICS = 334,
    OF_BSN_TLV_DROP = 335,
    OF_BSN_TLV_DROP_CONTROL = 336,
    OF_BSN_TLV_DSCP = 337,
    OF_BSN_TLV_ECN = 338,
    OF_BSN_TLV_EGRESS_ONLY = 339,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 340,
    OF_BSN_TLV_EGRESS_SAMPLING_RATE = 341,
    OF_BSN_TLV_ENCAP = 342,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 343,
    OF_BSN_TLV_ETH_DST = 344,
    OF_BSN_TLV_ETH_SRC = 345,
    OF_BSN_TLV_ETH_TYPE = 346,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 347,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 348,
    OF_BSN_TLV_EXTERNAL_IP = 349,
    OF_BSN_TLV_EXTERNAL_MAC = 350,
    OF_BSN_TLV_EXTERNAL_NETMASK = 351,
    OF_BSN_TLV_FABRIC_PORT_ROLE = 352,
    OF_BSN_TLV_FAIL_COUNT = 353,
    OF_BSN_TLV_FLOOD = 354,
    OF_BSN_TLV_FLOW_CLASSIFIER = 355,
    OF_BSN_TLV_FLOW_CLASSIFY = 356,
    OF_BSN_TLV_FLOW_IDENTIFIER = 357,
    OF_BSN_TLV_FORCE_LINK_UP = 358,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 359,
    OF_BSN_TLV_FREE_COUNT = 360,
    OF_BSN_TLV_GENERATION_ID = 361,
    OF_BSN_TLV_HASH_ALGORITHM = 362,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 363,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 364,
    OF_BSN_TLV_HASH_PACKET_FIELD = 365,
    OF_BSN_TLV_HASH_PACKET_TYPE = 366,
    OF_BSN_TLV_HASH_SEED = 367,
    OF_BSN_TLV_HASH_TYPE = 368,
    OF_BSN_TLV_HEADER_SIZE = 369,
    OF_BSN_TLV_ICMP_CODE = 370,
    OF_BSN_TLV_ICMP_ID = 371,
    OF_BSN_TLV_ICMP_TYPE = 372,
    OF_BSN_TLV_ICMPV6_CHKSUM = 373,
    OF_BSN_TLV_ICMPV6_CODE = 374,
    OF_BSN_TLV_ICMPV6_TYPE = 375,
    OF_BSN_TLV_IDENTIFIER = 376,
    OF_BSN_TLV_IDLE_NOTIFICATION = 377,
    OF_BSN_TLV_IDLE_TIME = 378,
    OF_BSN_TLV_IDLE_TIMEOUT = 379,
    OF_BSN_TLV_IFP_CLASS_ID = 380,
    OF_BSN_TLV_IGMP_SNOOPING = 381,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 382,
    OF_BSN_TLV_INNER_VLAN_VID = 383,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 384,
    OF_BSN_TLV_INTERNAL_MAC = 385,
    OF_BSN_TLV_INTERVAL = 386,
    OF_BSN_TLV_IP_FRAGMENTATION = 387,
    OF_BSN_TLV_IP_PROTO = 388,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 389,
    OF_BSN_TLV_IPV4 = 390,
    OF_BSN_TLV_IPV4_DST = 391,
    OF_BSN_TLV_IPV4_NETMASK = 392,
    OF_BSN_TLV_IPV4_SRC = 393,
    OF_BSN_TLV_IPV6 = 394,
    OF_BSN_TLV_IPV6_DST = 395,
    OF_BSN_TLV_IPV6_PREFIX = 396,
    OF_BSN_TLV_IPV6_SRC = 397,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 398,
    OF_BSN_TLV_L2_CACHE_HIT = 399,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 400,
    OF_BSN_TLV_L3 = 401,
    OF_BSN_TLV_L3_DST_CLASS_ID = 402,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 403,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 404,
    OF_BSN_TLV_LAG_OPTIONS = 405,
    OF_BSN_TLV_LCORE = 406,
    OF_BSN_TLV_LINK_UP = 407,
    OF_BSN_TLV_LOAD = 408,
    OF_BSN_TLV_LOOKUP_COUNT = 409,
    OF_BSN_TLV_LOOPBACK_MODE = 410,
    OF_BSN_TLV_LOOPBACK_PORT = 411,
    OF_BSN_TLV_LOSSLESS = 412,
    OF_BSN_TLV_LR_ALL_ENABLED = 413,
    OF_BSN_TLV_MAC = 414,
    OF_BSN_TLV_MAC_MASK = 415,
    OF_BSN_TLV_MATCHED_COUNT = 416,
    OF_BSN_TLV_MAX_COUNT = 417,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 418,
    OF_BSN_TLV_METADATA = 419,
    OF_BSN_TLV_MGMT = 420,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 421,
    OF_BSN_TLV_MISS_PACKETS = 422,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 423,
    OF_BSN_TLV_MPLS_LABEL = 424,
    OF_BSN_TLV_MPLS_SEQUENCED = 425,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 426,
    OF_BSN_TLV_MULTICAST_PACKET = 427,
    OF_BSN_TLV_MULTIPLIER = 428,
    OF_BSN_TLV_NAME = 429,
    OF_BSN_TLV_NDP_OFFLOAD = 430,
    OF_BSN_TLV_NDP_STATIC = 431,
    OF_BSN_TLV_NEGATE = 432,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 433,
    OF_BSN_TLV_NEXT_HOP_MAC = 434,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 435,
    OF_BSN_TLV_NO_ARP_RESPONSE = 436,
    OF_BSN_TLV_NO_DROP = 437,
    OF_BSN_TLV_NO_NS_RESPONSE = 438,
    OF_BSN_TLV_OFFSET = 439,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 440,
    OF_BSN_TLV_OUTER_SRC_MAC = 441,
    OF_BSN_TLV_PACKET_FIELD = 442,
    OF_BSN_TLV_PARENT_PORT = 443,
    OF_BSN_TLV_PARTNER_KEY = 444,
    OF_BSN_TLV_PARTNER_PORT_NUM = 445,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 446,
    OF_BSN_TLV_PARTNER_STATE = 447,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 448,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 449,
    OF_BSN_TLV_PASSIVE = 450,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 451,
    OF_BSN_TLV_PIM_DR = 452,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 453,
    OF_BSN_TLV_PORT = 454,
    OF_BSN_TLV_PORT_MODE = 455,
    OF_BSN_TLV_PORT_SPEED_GBPS = 456,
    OF_BSN_TLV_PORT_USAGE = 457,
    OF_BSN_TLV_PORT_VXLAN_MODE = 458,
    OF_BSN_TLV_PRESERVE_VLAN = 459,
    OF_BSN_TLV_PRIORITY = 460,
    OF_BSN_TLV_PUSH_TWO_PER_POLICY = 461,
    OF_BSN_TLV_PUSH_TWO_TAGS_CAPABILITY = 462,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 463,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 464,
    OF_BSN_TLV_QOS_PRIORITY = 465,
    OF_BSN_TLV_QUEUE_ID = 466,
    OF_BSN_TLV_QUEUE_WEIGHT = 467,
    OF_BSN_TLV_RATE_LIMIT = 468,
    OF_BSN_TLV_RATE_UNIT = 469,
    OF_BSN_TLV_RECORD_PACKETS = 470,
    OF_BSN_TLV_REDUNDANT_MGMT = 471,
    OF_BSN_TLV_REFERENCE = 472,
    OF_BSN_TLV_REMOTE_ID = 473,
    OF_BSN_TLV_REPLY_PACKETS = 474,
    OF_BSN_TLV_REQUEST_PACKETS = 475,
    OF_BSN_TLV_REST_SERVER = 476,
    OF_BSN_TLV_ROUTING_PARAM = 477,
    OF_BSN_TLV_RX_BYTES = 478,
    OF_BSN_TLV_RX_PACKETS = 479,
    OF_BSN_TLV_SAMPLING_RATE = 480,
    OF_BSN_TLV_SCTP_DST = 481,
    OF_BSN_TLV_SCTP_SRC = 482,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 483,
    OF_BSN_TLV_SOCKET = 484,
    OF_BSN_TLV_SRC_MAC_CML = 485,
    OF_BSN_TLV_STATUS = 486,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 487,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 488,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 489,
    OF_BSN_TLV_SUB_AGENT_ID = 490,
    OF_BSN_TLV_TCP_DST = 491,
    OF_BSN_TLV_TCP_FLAGS = 492,
    OF_BSN_TLV_TCP_SRC = 493,
    OF_BSN_TLV_THREAD = 494,
    OF_BSN_TLV_TIMESTAMP = 495,
    OF_BSN_TLV_TTL = 496,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 497,
    OF_BSN_TLV_TX_BYTES = 498,
    OF_BSN_TLV_TX_PACKETS = 499,
    OF_BSN_TLV_UDF_ANCHOR = 500,
    OF_BSN_TLV_UDF_CAPABILITY = 501,
    OF_BSN_TLV_UDF_DATA = 502,
    OF_BSN_TLV_UDF_ID = 503,
    OF_BSN_TLV_UDF_LENGTH = 504,
    OF_BSN_TLV_UDF_OFFSET = 505,
    OF_BSN_TLV_UDP_DST = 506,
    OF_BSN_TLV_UDP_SRC = 507,
    OF_BSN_TLV_UINT32 = 508,
    OF_BSN_TLV_UINT64_LIST = 509,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 510,
    OF_BSN_TLV_UNICAST_RATE = 511,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 512,
    OF_BSN_TLV_UNTAGGED = 513,
    OF_BSN_TLV_UPGRADE = 514,
    OF_BSN_TLV_URI_SCHEME = 515,
    OF_BSN_TLV_USE_PACKET_STATE = 516,
    OF_BSN_TLV_USER_CONFIGURED = 517,
    OF_BSN_TLV_VFI = 518,
    OF_BSN_TLV_VFP_CLASS_ID = 519,
    OF_BSN_TLV_VIRTUAL = 520,
    OF_BSN_TLV_VLAN_MAC_LIST = 521,
    OF_BSN_TLV_VLAN_PCP = 522,
    OF_BSN_TLV_VLAN_VID = 523,
    OF_BSN_TLV_VLAN_VID_MASK = 524,
    OF_BSN_TLV_VNI = 525,
    OF_BSN_TLV_VPN_KEY = 526,
    OF_BSN_TLV_VRF = 527,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 528,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 529,
    OF_BSN_VLAN_MAC = 530,
    OF_BSN_VPORT = 531,
    OF_BSN_VPORT_L2GRE = 532,
    OF_BSN_VPORT_Q_IN_Q = 533,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 534,
    OF_BUCKET = 535,
    OF_BUCKET_COUNTER = 536,
    OF_BUNDLE_PROP = 537,
    OF_BUNDLE_PROP_EXPERIMENTER = 538,
    OF_FLOW_STATS_ENTRY = 539,
    OF_GROUP_DESC_STATS_ENTRY = 540,
    OF_GROUP_STATS_ENTRY = 541,
    OF_HELLO_ELEM = 542,
    OF_HELLO_ELEM_VERSIONBITMAP = 543,
    OF_INSTRUCTION = 544,
    OF_INSTRUCTION_APPLY_ACTIONS = 545,
    OF_INSTRUCTION_BSN = 546,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 547,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 548,
    OF_INSTRUCTION_BSN_DENY = 549,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 550,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 551,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 552,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 553,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 554,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 555,
    OF_INSTRUCTION_BSN_HASH_SELECT = 556,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 557,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 558,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 559,
    OF_INSTRUCTION_BSN_PERMIT = 560,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 561,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 562,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 563,
    OF_INSTRUCTION_CLEAR_ACTIONS = 564,
    OF_INSTRUCTION_EXPERIMENTER = 565,
    OF_INSTRUCTION_GOTO_TABLE = 566,
    OF_INSTRUCTION_ID = 567,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 568,
    OF_INSTRUCTION_ID_BSN = 569,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 570,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 571,
    OF_INSTRUCTION_ID_BSN_DENY = 572,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 573,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 574,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 575,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 576,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 577,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 578,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 579,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 580,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 581,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 582,
    OF_INSTRUCTION_ID_BSN_PERMIT = 583,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 584,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 585,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 586,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 587,
    OF_INSTRUCTION_ID_EXPERIMENTER = 588,
    OF_INSTRUCTION_ID_GOTO_TABLE = 589,
    OF_INSTRUCTION_ID_METER = 590,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 591,
    OF_INSTRUCTION_ID_WRITE_METADATA = 592,
    OF_INSTRUCTION_METER = 593,
    OF_INSTRUCTION_WRITE_ACTIONS = 594,
    OF_INSTRUCTION_WRITE_METADATA = 595,
    OF_MATCH_V1 = 596,
    OF_MATCH_V2 = 597,
    OF_MATCH_V3 = 598,
    OF_METER_BAND = 599,
    OF_METER_BAND_DROP = 600,
    OF_METER_BAND_DSCP_REMARK = 601,
    OF_METER_BAND_EXPERIMENTER = 602,
    OF_METER_BAND_STATS = 603,
    OF_METER_CONFIG = 604,
    OF_METER_FEATURES = 605,
    OF_METER_STATS = 606,
    OF_OXM = 607,
    OF_OXM_ARP_OP = 608,
    OF_OXM_ARP_OP_MASKED = 609,
    OF_OXM_ARP_SHA = 610,
    OF_OXM_ARP_SHA_MASKED = 611,
    OF_OXM_ARP_SPA = 612,
    OF_OXM_ARP_SPA_MASKED = 613,
    OF_OXM_ARP_THA = 614,
    OF_OXM_ARP_THA_MASKED = 615,
    OF_OXM_ARP_TPA = 616,
    OF_OXM_ARP_TPA_MASKED = 617,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 618,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 619,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 620,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 621,
    OF_OXM_BSN_IFP_CLASS_ID = 622,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 623,
    OF_OXM_BSN_IN_PORTS_128 = 624,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 625,
    OF_OXM_BSN_IN_PORTS_512 = 626,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 627,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 628,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 629,
    OF_OXM_BSN_INNER_ETH_DST = 630,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 631,
    OF_OXM_BSN_INNER_ETH_SRC = 632,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 633,
    OF_OXM_BSN_INNER_VLAN_VID = 634,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 635,
    OF_OXM_BSN_IP_FRAGMENTATION = 636,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 637,
    OF_OXM_BSN_L2_CACHE_HIT = 638,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 639,
    OF_OXM_BSN_L3_DST_CLASS_ID = 640,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 641,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 642,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 643,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 644,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 645,
    OF_OXM_BSN_LAG_ID = 646,
    OF_OXM_BSN_LAG_ID_MASKED = 647,
    OF_OXM_BSN_TCP_FLAGS = 648,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 649,
    OF_OXM_BSN_UDF0 = 650,
    OF_OXM_BSN_UDF0_MASKED = 651,
    OF_OXM_BSN_UDF1 = 652,
    OF_OXM_BSN_UDF1_MASKED = 653,
    OF_OXM_BSN_UDF2 = 654,
    OF_OXM_BSN_UDF2_MASKED = 655,
    OF_OXM_BSN_UDF3 = 656,
    OF_OXM_BSN_UDF3_MASKED = 657,
    OF_OXM_BSN_UDF4 = 658,
    OF_OXM_BSN_UDF4_MASKED = 659,
    OF_OXM_BSN_UDF5 = 660,
    OF_OXM_BSN_UDF5_MASKED = 661,
    OF_OXM_BSN_UDF6 = 662,
    OF_OXM_BSN_UDF6_MASKED = 663,
    OF_OXM_BSN_UDF7 = 664,
    OF_OXM_BSN_UDF7_MASKED = 665,
    OF_OXM_BSN_VFI = 666,
    OF_OXM_BSN_VFI_MASKED = 667,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 668,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 669,
    OF_OXM_BSN_VRF = 670,
    OF_OXM_BSN_VRF_MASKED = 671,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 672,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 673,
    OF_OXM_CONN_TRACKING_IPV6_DST = 674,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 675,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 676,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 677,
    OF_OXM_CONN_TRACKING_LABEL = 678,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 679,
    OF_OXM_CONN_TRACKING_MARK = 680,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 681,
    OF_OXM_CONN_TRACKING_NW_DST = 682,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 683,
    OF_OXM_CONN_TRACKING_NW_PROTO = 684,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 685,
    OF_OXM_CONN_TRACKING_NW_SRC = 686,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 687,
    OF_OXM_CONN_TRACKING_STATE = 688,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 689,
    OF_OXM_CONN_TRACKING_TP_DST = 690,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 691,
    OF_OXM_CONN_TRACKING_TP_SRC = 692,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 693,
    OF_OXM_CONN_TRACKING_ZONE = 694,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 695,
    OF_OXM_ETH_DST = 696,
    ...
    OF_OXM_ICMPV4_CODE = 702,
    OF_OXM_ICMPV4_CODE_MASKED = 703,
    OF_OXM_ICMPV4_TYPE = 704,
    OF_OXM_ICMPV4_TYPE_MASKED = 705,
    OF_OXM_ICMPV6_CODE = 706,
    OF_OXM_ICMPV6_CODE_MASKED = 707,
    OF_OXM_ICMPV6_TYPE = 708,
    OF_OXM_ICMPV6_TYPE_MASKED = 709,
    OF_OXM_IN_PHY_PORT = 710,
    OF_OXM_IN_PHY_PORT_MASKED = 711,
    OF_OXM_IN_PORT = 712,
    OF_OXM_IN_PORT_MASKED = 713,
    OF_OXM_IP_DSCP = 714,
    OF_OXM_IP_DSCP_MASKED = 715,
    OF_OXM_IP_ECN = 716,
    OF_OXM_IP_ECN_MASKED = 717,
    OF_OXM_IP_PROTO = 718,
    OF_OXM_IP_PROTO_MASKED = 719,
    OF_OXM_IPV4_DST = 720,
    OF_OXM_IPV4_DST_MASKED = 721,
    OF_OXM_IPV4_SRC = 722,
    OF_OXM_IPV4_SRC_MASKED = 723,
    OF_OXM_IPV6_DST = 724,
    OF_OXM_IPV6_DST_MASKED = 725,
    OF_OXM_IPV6_EXTHDR = 726,
    OF_OXM_IPV6_EXTHDR_MASKED = 727,
    OF_OXM_IPV6_FLABEL = 728,
    OF_OXM_IPV6_FLABEL_MASKED = 729,
    OF_OXM_IPV6_ND_SLL = 730,
    OF_OXM_IPV6_ND_SLL_MASKED = 731,
    OF_OXM_IPV6_ND_TARGET = 732,
    OF_OXM_IPV6_ND_TARGET_MASKED = 733,
    OF_OXM_IPV6_ND_TLL = 734,
    OF_OXM_IPV6_ND_TLL_MASKED = 735,
    OF_OXM_IPV6_SRC = 736,
    OF_OXM_IPV6_SRC_MASKED = 737,
    OF_OXM_METADATA = 738,
    OF_OXM_METADATA_MASKED = 739,
    OF_OXM_MPLS_BOS = 740,
    OF_OXM_MPLS_BOS_MASKED = 741,
    OF_OXM_MPLS_LABEL = 742,
    OF_OXM_MPLS_LABEL_MASKED = 743,
    OF_OXM_MPLS_TC = 744,
    OF_OXM_MPLS_TC_MASKED = 745,
    OF_OXM_OVS_TCP_FLAGS = 746,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 747,
    OF_OXM_PBB_UCA = 748,
    OF_OXM_PBB_UCA_MASKED = 749,
    OF_OXM_SCTP_DST = 750,
    OF_OXM_SCTP_DST_MASKED = 751,
    OF_OXM_SCTP_SRC = 752,
    OF_OXM_SCTP_SRC_MASKED = 753,
    OF_OXM_TCP_DST = 754,
    OF_OXM_TCP_DST_MASKED = 755,
    OF_OXM_TCP_SRC = 756,
    OF_OXM_TCP_SRC_MASKED = 757,
    OF_OXM_TUNNEL_ID = 758,
    OF_OXM_TUNNEL_ID_MASKED = 759,
    OF_OXM_TUNNEL_IPV4_DST = 760,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 761,
    OF_OXM_TUNNEL_IPV4_SRC = 762,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 763,
    OF_OXM_UDP_DST = 764,
    OF_OXM_UDP_DST_MASKED = 765,
    OF_OXM_UDP_SRC = 766,
    OF_OXM_UDP_SRC_MASKED = 767,
    OF_OXM_VLAN_PCP = 768,
    OF_OXM_VLAN_PCP_MASKED = 769,
    OF_OXM_VLAN_VID = 770,
    OF_OXM_VLAN_VID_MASKED = 771,
    OF_PACKET_QUEUE = 772,
    OF_PORT_DESC = 773,
    OF_PORT_DESC_PROP = 774,
    OF_PORT_DESC_PROP_BSN = 775,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 776,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 777,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 778,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 779,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 780,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 781,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 782,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 783,
    OF_PORT_DESC_PROP_BSN_UPLINK = 784,
    OF_PORT_DESC_PROP_ETHERNET = 785,
    OF_PORT_DESC_PROP_EXPERIMENTER = 786,
    OF_PORT_DESC_PROP_OPTICAL = 787,
    OF_PORT_MOD_PROP = 788,
    OF_PORT_MOD_PROP_ETHERNET = 789,
    OF_PORT_MOD_PROP_EXPERIMENTER = 790,
    OF_PORT_MOD_PROP_OPTICAL = 791,
    OF_PORT_STATS_ENTRY = 792,
    OF_PORT_STATS_PROP = 793,
    OF_PORT_STATS_PROP_ETHERNET = 794,
    OF_PORT_STATS_PROP_EXPERIMENTER = 795,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 796,
    OF_PORT_STATS_PROP_OPTICAL = 797,
    OF_QUEUE_DESC = 798,
    OF_QUEUE_DESC_PROP = 799,
    OF_QUEUE_DESC_PROP_BSN = 800,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 801,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 802,
    OF_QUEUE_DESC_PROP_MAX_RATE = 803,
    OF_QUEUE_DESC_PROP_MIN_RATE = 804,
    OF_QUEUE_PROP = 805,
    OF_QUEUE_PROP_EXPERIMENTER = 806,
    OF_QUEUE_PROP_MAX_RATE = 807,
    OF_QUEUE_PROP_MIN_RATE = 808,
    OF_QUEUE_STATS_ENTRY = 809,
    OF_QUEUE_STATS_PROP = 810,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 811,
    OF_ROLE_PROP = 812,
    OF_ROLE_PROP_EXPERIMENTER = 813,
    OF_TABLE_DESC = 814,
    OF_TABLE_FEATURE_PROP = 815,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 816,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 817,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 818,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 819,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 820,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 821,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 822,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 823,
    OF_TABLE_FEATURE_PROP_MATCH = 824,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 825,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 826,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 827,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 828,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 829,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 830,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 831,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 832,
    OF_TABLE_FEATURES = 833,
    OF_TABLE_MOD_PROP = 834,
    OF_TABLE_MOD_PROP_EVICTION = 835,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 836,
    OF_TABLE_MOD_PROP_VACANCY = 837,
    OF_TABLE_STATS_ENTRY = 838,
    OF_UINT32 = 839,
    OF_UINT64 = 840,
    OF_UINT8 = 841,
    ...
    /* List objects */
    OF_LIST_ACTION = 842,
    OF_LIST_ACTION_ID = 843,
    OF_LIST_ASYNC_CONFIG_PROP = 844,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 845,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 846,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 847,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 848,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 849,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 850,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 851,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 852,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 853,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 854,
    OF_LIST_BSN_INTERFACE = 855,
    OF_LIST_BSN_LACP_STATS_ENTRY = 856,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 857,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 858,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 859,
    OF_LIST_BSN_TLV = 860,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 861,
    OF_LIST_BSN_VLAN_MAC = 862,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 863,
    OF_LIST_BUCKET = 864,
    OF_LIST_BUCKET_COUNTER = 865,
    OF_LIST_BUNDLE_PROP = 866,
    OF_LIST_FLOW_STATS_ENTRY = 867,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 868,
    OF_LIST_GROUP_STATS_ENTRY = 869,
    OF_LIST_HELLO_ELEM = 870,
    OF_LIST_INSTRUCTION = 871,
    OF_LIST_INSTRUCTION_ID = 872,
    OF_LIST_METER_BAND = 873,
    OF_LIST_METER_BAND_STATS = 874,
    OF_LIST_METER_CONFIG = 875,
    OF_LIST_METER_STATS = 876,
    OF_LIST_OXM = 877,
    OF_LIST_PACKET_QUEUE = 878,
    OF_LIST_PORT_DESC = 879,
    OF_LIST_PORT_DESC_PROP = 880,
    OF_LIST_PORT_MOD_PROP = 881,
    OF_LIST_PORT_STATS_ENTRY = 882,
    OF_LIST_PORT_STATS_PROP = 883,
    OF_LIST_QUEUE_DESC = 884,
    OF_LIST_QUEUE_DESC_PROP = 885,
    OF_LIST_QUEUE_PROP = 886,
    OF_LIST_QUEUE_STATS_ENTRY = 887,
    OF_LIST_QUEUE_STATS_PROP = 888,
    OF_LIST_ROLE_PROP = 889,
    OF_LIST_TABLE_DESC = 890,
    OF_LIST_TABLE_FEATURE_PROP = 891,
    OF_LIST_TABLE_FEATURES = 892,
    OF_LIST_TABLE_MOD_PROP = 893,
    OF_LIST_TABLE_STATS_ENTRY = 894,
    OF_LIST_UINT32 = 895,
    OF_LIST_UINT64 = 896,
    OF_LIST_UINT8 = 897,
