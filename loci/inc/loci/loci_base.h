...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 339,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 340,
    OF_BSN_TLV_HASH_PACKET_FIELD = 341,
    OF_BSN_TLV_HASH_PACKET_TYPE = 342,
    OF_BSN_TLV_HASH_SEED = 343,
    OF_BSN_TLV_HASH_TYPE = 344,
    OF_BSN_TLV_HEADER_SIZE = 345,
    OF_BSN_TLV_ICMP_CODE = 346,
    OF_BSN_TLV_ICMP_ID = 347,
    OF_BSN_TLV_ICMP_TYPE = 348,
    OF_BSN_TLV_ICMPV6_CHKSUM = 349,
    OF_BSN_TLV_IDLE_NOTIFICATION = 350,
    OF_BSN_TLV_IDLE_TIME = 351,
    OF_BSN_TLV_IDLE_TIMEOUT = 352,
    OF_BSN_TLV_IGMP_SNOOPING = 353,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 354,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 355,
    OF_BSN_TLV_INTERNAL_MAC = 356,
    OF_BSN_TLV_INTERVAL = 357,
    OF_BSN_TLV_IP_PROTO = 358,
    OF_BSN_TLV_IPV4 = 359,
    OF_BSN_TLV_IPV4_DST = 360,
    OF_BSN_TLV_IPV4_NETMASK = 361,
    OF_BSN_TLV_IPV4_SRC = 362,
    OF_BSN_TLV_IPV6 = 363,
    OF_BSN_TLV_IPV6_DST = 364,
    OF_BSN_TLV_IPV6_PREFIX = 365,
    OF_BSN_TLV_IPV6_SRC = 366,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 367,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 368,
    OF_BSN_TLV_L3_DST_CLASS_ID = 369,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 370,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 371,
    OF_BSN_TLV_LOOPBACK_PORT = 372,
    OF_BSN_TLV_MAC = 373,
    OF_BSN_TLV_MAC_MASK = 374,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 375,
    OF_BSN_TLV_MISS_PACKETS = 376,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 377,
    OF_BSN_TLV_MPLS_LABEL = 378,
    OF_BSN_TLV_MPLS_SEQUENCED = 379,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 380,
    OF_BSN_TLV_NAME = 381,
    OF_BSN_TLV_NDP_OFFLOAD = 382,
    OF_BSN_TLV_NDP_STATIC = 383,
    OF_BSN_TLV_NEGATE = 384,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 385,
    OF_BSN_TLV_NEXT_HOP_MAC = 386,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 387,
    OF_BSN_TLV_OFFSET = 388,
    OF_BSN_TLV_PARENT_PORT = 389,
    OF_BSN_TLV_PARTNER_KEY = 390,
    OF_BSN_TLV_PARTNER_PORT_NUM = 391,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 392,
    OF_BSN_TLV_PARTNER_STATE = 393,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 394,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 395,
    OF_BSN_TLV_PORT = 396,
    OF_BSN_TLV_PORT_USAGE = 397,
    OF_BSN_TLV_PORT_VXLAN_MODE = 398,
    OF_BSN_TLV_PRIORITY = 399,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 400,
    OF_BSN_TLV_QOS_PRIORITY = 401,
    OF_BSN_TLV_QUEUE_ID = 402,
    OF_BSN_TLV_QUEUE_WEIGHT = 403,
    OF_BSN_TLV_RATE_LIMIT = 404,
    OF_BSN_TLV_RATE_UNIT = 405,
    OF_BSN_TLV_REFERENCE = 406,
    OF_BSN_TLV_REPLY_PACKETS = 407,
    OF_BSN_TLV_REQUEST_PACKETS = 408,
    OF_BSN_TLV_RX_BYTES = 409,
    OF_BSN_TLV_RX_PACKETS = 410,
    OF_BSN_TLV_SAMPLING_RATE = 411,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 412,
    OF_BSN_TLV_STATUS = 413,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 414,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 415,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 416,
    OF_BSN_TLV_SUB_AGENT_ID = 417,
    OF_BSN_TLV_TCP_DST = 418,
    OF_BSN_TLV_TCP_FLAGS = 419,
    OF_BSN_TLV_TCP_SRC = 420,
    OF_BSN_TLV_TTL = 421,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 422,
    OF_BSN_TLV_TX_BYTES = 423,
    OF_BSN_TLV_TX_PACKETS = 424,
    OF_BSN_TLV_UDF_ANCHOR = 425,
    OF_BSN_TLV_UDF_ID = 426,
    OF_BSN_TLV_UDF_LENGTH = 427,
    OF_BSN_TLV_UDF_OFFSET = 428,
    OF_BSN_TLV_UDP_DST = 429,
    OF_BSN_TLV_UDP_SRC = 430,
    OF_BSN_TLV_UINT64_LIST = 431,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 432,
    OF_BSN_TLV_UNICAST_RATE = 433,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 434,
    OF_BSN_TLV_UNTAGGED = 435,
    OF_BSN_TLV_USE_PACKET_STATE = 436,
    OF_BSN_TLV_VFI = 437,
    OF_BSN_TLV_VFP_CLASS_ID = 438,
    OF_BSN_TLV_VLAN_MAC_LIST = 439,
    OF_BSN_TLV_VLAN_PCP = 440,
    OF_BSN_TLV_VLAN_VID = 441,
    OF_BSN_TLV_VLAN_VID_MASK = 442,
    OF_BSN_TLV_VNI = 443,
    OF_BSN_TLV_VPN_KEY = 444,
    OF_BSN_TLV_VRF = 445,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 446,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 447,
    OF_BSN_VLAN_MAC = 448,
    OF_BSN_VPORT = 449,
    OF_BSN_VPORT_L2GRE = 450,
    OF_BSN_VPORT_Q_IN_Q = 451,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 452,
    OF_BUCKET = 453,
    OF_BUCKET_COUNTER = 454,
    OF_BUNDLE_PROP = 455,
    OF_BUNDLE_PROP_EXPERIMENTER = 456,
    OF_FLOW_STATS_ENTRY = 457,
    OF_GROUP_DESC_STATS_ENTRY = 458,
    OF_GROUP_STATS_ENTRY = 459,
    OF_HELLO_ELEM = 460,
    OF_HELLO_ELEM_VERSIONBITMAP = 461,
    OF_INSTRUCTION = 462,
    OF_INSTRUCTION_APPLY_ACTIONS = 463,
    OF_INSTRUCTION_BSN = 464,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 465,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 466,
    OF_INSTRUCTION_BSN_DENY = 467,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 468,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 469,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 470,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 471,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 472,
    OF_INSTRUCTION_BSN_HASH_SELECT = 473,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 474,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 475,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 476,
    OF_INSTRUCTION_BSN_PERMIT = 477,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 478,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 479,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 480,
    OF_INSTRUCTION_CLEAR_ACTIONS = 481,
    OF_INSTRUCTION_EXPERIMENTER = 482,
    OF_INSTRUCTION_GOTO_TABLE = 483,
    OF_INSTRUCTION_ID = 484,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 485,
    OF_INSTRUCTION_ID_BSN = 486,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 487,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 488,
    OF_INSTRUCTION_ID_BSN_DENY = 489,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 490,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 491,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 492,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 493,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 494,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 495,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 496,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 497,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 498,
    OF_INSTRUCTION_ID_BSN_PERMIT = 499,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 500,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 501,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 502,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 503,
    OF_INSTRUCTION_ID_EXPERIMENTER = 504,
    OF_INSTRUCTION_ID_GOTO_TABLE = 505,
    OF_INSTRUCTION_ID_METER = 506,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 507,
    OF_INSTRUCTION_ID_WRITE_METADATA = 508,
    OF_INSTRUCTION_METER = 509,
    OF_INSTRUCTION_WRITE_ACTIONS = 510,
    OF_INSTRUCTION_WRITE_METADATA = 511,
    OF_MATCH_V1 = 512,
    OF_MATCH_V2 = 513,
    OF_MATCH_V3 = 514,
    OF_METER_BAND = 515,
    OF_METER_BAND_DROP = 516,
    OF_METER_BAND_DSCP_REMARK = 517,
    OF_METER_BAND_EXPERIMENTER = 518,
    OF_METER_BAND_STATS = 519,
    OF_METER_CONFIG = 520,
    OF_METER_FEATURES = 521,
    OF_METER_STATS = 522,
    OF_OXM = 523,
    OF_OXM_ARP_OP = 524,
    OF_OXM_ARP_OP_MASKED = 525,
    OF_OXM_ARP_SHA = 526,
    OF_OXM_ARP_SHA_MASKED = 527,
    OF_OXM_ARP_SPA = 528,
    OF_OXM_ARP_SPA_MASKED = 529,
    OF_OXM_ARP_THA = 530,
    OF_OXM_ARP_THA_MASKED = 531,
    OF_OXM_ARP_TPA = 532,
    OF_OXM_ARP_TPA_MASKED = 533,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 534,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 535,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 536,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 537,
    OF_OXM_BSN_IN_PORTS_128 = 538,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 539,
    OF_OXM_BSN_IN_PORTS_512 = 540,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 541,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 542,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 543,
    OF_OXM_BSN_INNER_ETH_DST = 544,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 545,
    OF_OXM_BSN_INNER_ETH_SRC = 546,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 547,
    OF_OXM_BSN_INNER_VLAN_VID = 548,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 549,
    OF_OXM_BSN_IP_FRAGMENTATION = 550,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 551,
    OF_OXM_BSN_L2_CACHE_HIT = 552,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 553,
    OF_OXM_BSN_L3_DST_CLASS_ID = 554,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 555,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 556,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 557,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 558,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 559,
    OF_OXM_BSN_LAG_ID = 560,
    OF_OXM_BSN_LAG_ID_MASKED = 561,
    OF_OXM_BSN_TCP_FLAGS = 562,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 563,
    OF_OXM_BSN_UDF0 = 564,
    OF_OXM_BSN_UDF0_MASKED = 565,
    OF_OXM_BSN_UDF1 = 566,
    OF_OXM_BSN_UDF1_MASKED = 567,
    OF_OXM_BSN_UDF2 = 568,
    OF_OXM_BSN_UDF2_MASKED = 569,
    OF_OXM_BSN_UDF3 = 570,
    OF_OXM_BSN_UDF3_MASKED = 571,
    OF_OXM_BSN_UDF4 = 572,
    OF_OXM_BSN_UDF4_MASKED = 573,
    OF_OXM_BSN_UDF5 = 574,
    OF_OXM_BSN_UDF5_MASKED = 575,
    OF_OXM_BSN_UDF6 = 576,
    OF_OXM_BSN_UDF6_MASKED = 577,
    OF_OXM_BSN_UDF7 = 578,
    OF_OXM_BSN_UDF7_MASKED = 579,
    OF_OXM_BSN_VFI = 580,
    OF_OXM_BSN_VFI_MASKED = 581,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 582,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 583,
    OF_OXM_BSN_VRF = 584,
    OF_OXM_BSN_VRF_MASKED = 585,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 586,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 587,
    OF_OXM_ETH_DST = 588,
    OF_OXM_ETH_DST_MASKED = 589,
    OF_OXM_ETH_SRC = 590,
    OF_OXM_ETH_SRC_MASKED = 591,
    OF_OXM_ETH_TYPE = 592,
    OF_OXM_ETH_TYPE_MASKED = 593,
    OF_OXM_ICMPV4_CODE = 594,
    OF_OXM_ICMPV4_CODE_MASKED = 595,
    OF_OXM_ICMPV4_TYPE = 596,
    OF_OXM_ICMPV4_TYPE_MASKED = 597,
    OF_OXM_ICMPV6_CODE = 598,
    OF_OXM_ICMPV6_CODE_MASKED = 599,
    OF_OXM_ICMPV6_TYPE = 600,
    OF_OXM_ICMPV6_TYPE_MASKED = 601,
    OF_OXM_IN_PHY_PORT = 602,
    OF_OXM_IN_PHY_PORT_MASKED = 603,
    OF_OXM_IN_PORT = 604,
    OF_OXM_IN_PORT_MASKED = 605,
    OF_OXM_IP_DSCP = 606,
    OF_OXM_IP_DSCP_MASKED = 607,
    OF_OXM_IP_ECN = 608,
    OF_OXM_IP_ECN_MASKED = 609,
    OF_OXM_IP_PROTO = 610,
    OF_OXM_IP_PROTO_MASKED = 611,
    OF_OXM_IPV4_DST = 612,
    OF_OXM_IPV4_DST_MASKED = 613,
    OF_OXM_IPV4_SRC = 614,
    OF_OXM_IPV4_SRC_MASKED = 615,
    OF_OXM_IPV6_DST = 616,
    OF_OXM_IPV6_DST_MASKED = 617,
    OF_OXM_IPV6_EXTHDR = 618,
    OF_OXM_IPV6_EXTHDR_MASKED = 619,
    OF_OXM_IPV6_FLABEL = 620,
    OF_OXM_IPV6_FLABEL_MASKED = 621,
    OF_OXM_IPV6_ND_SLL = 622,
    OF_OXM_IPV6_ND_SLL_MASKED = 623,
    OF_OXM_IPV6_ND_TARGET = 624,
    OF_OXM_IPV6_ND_TARGET_MASKED = 625,
    OF_OXM_IPV6_ND_TLL = 626,
    OF_OXM_IPV6_ND_TLL_MASKED = 627,
    OF_OXM_IPV6_SRC = 628,
    OF_OXM_IPV6_SRC_MASKED = 629,
    OF_OXM_METADATA = 630,
    OF_OXM_METADATA_MASKED = 631,
    OF_OXM_MPLS_BOS = 632,
    OF_OXM_MPLS_BOS_MASKED = 633,
    OF_OXM_MPLS_LABEL = 634,
    OF_OXM_MPLS_LABEL_MASKED = 635,
    OF_OXM_MPLS_TC = 636,
    OF_OXM_MPLS_TC_MASKED = 637,
    OF_OXM_OVS_TCP_FLAGS = 638,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 639,
    OF_OXM_PBB_UCA = 640,
    OF_OXM_PBB_UCA_MASKED = 641,
    OF_OXM_SCTP_DST = 642,
    OF_OXM_SCTP_DST_MASKED = 643,
    OF_OXM_SCTP_SRC = 644,
    OF_OXM_SCTP_SRC_MASKED = 645,
    OF_OXM_TCP_DST = 646,
    OF_OXM_TCP_DST_MASKED = 647,
    OF_OXM_TCP_SRC = 648,
    OF_OXM_TCP_SRC_MASKED = 649,
    OF_OXM_TUNNEL_ID = 650,
    OF_OXM_TUNNEL_ID_MASKED = 651,
    OF_OXM_TUNNEL_IPV4_DST = 652,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 653,
    OF_OXM_TUNNEL_IPV4_SRC = 654,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 655,
    OF_OXM_UDP_DST = 656,
    OF_OXM_UDP_DST_MASKED = 657,
    OF_OXM_UDP_SRC = 658,
    OF_OXM_UDP_SRC_MASKED = 659,
    OF_OXM_VLAN_PCP = 660,
    OF_OXM_VLAN_PCP_MASKED = 661,
    OF_OXM_VLAN_VID = 662,
    OF_OXM_VLAN_VID_MASKED = 663,
    OF_PACKET_QUEUE = 664,
    OF_PORT_DESC = 665,
    OF_PORT_DESC_PROP = 666,
    OF_PORT_DESC_PROP_BSN = 667,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 668,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 669,
    OF_PORT_DESC_PROP_BSN_UPLINK = 670,
    OF_PORT_DESC_PROP_ETHERNET = 671,
    OF_PORT_DESC_PROP_EXPERIMENTER = 672,
    OF_PORT_DESC_PROP_OPTICAL = 673,
    OF_PORT_MOD_PROP = 674,
    OF_PORT_MOD_PROP_ETHERNET = 675,
    OF_PORT_MOD_PROP_EXPERIMENTER = 676,
    OF_PORT_MOD_PROP_OPTICAL = 677,
    OF_PORT_STATS_ENTRY = 678,
    OF_PORT_STATS_PROP = 679,
    OF_PORT_STATS_PROP_ETHERNET = 680,
    OF_PORT_STATS_PROP_EXPERIMENTER = 681,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 682,
