...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_GENERATION_ID = 357,
    OF_BSN_TLV_HASH_ALGORITHM = 358,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 359,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 360,
    OF_BSN_TLV_HASH_PACKET_FIELD = 361,
    OF_BSN_TLV_HASH_PACKET_TYPE = 362,
    OF_BSN_TLV_HASH_SEED = 363,
    OF_BSN_TLV_HASH_TYPE = 364,
    OF_BSN_TLV_HEADER_SIZE = 365,
    OF_BSN_TLV_ICMP_CODE = 366,
    OF_BSN_TLV_ICMP_ID = 367,
    OF_BSN_TLV_ICMP_TYPE = 368,
    OF_BSN_TLV_ICMPV6_CHKSUM = 369,
    OF_BSN_TLV_ICMPV6_CODE = 370,
    OF_BSN_TLV_ICMPV6_TYPE = 371,
    OF_BSN_TLV_IDENTIFIER = 372,
    OF_BSN_TLV_IDLE_NOTIFICATION = 373,
    OF_BSN_TLV_IDLE_TIME = 374,
    OF_BSN_TLV_IDLE_TIMEOUT = 375,
    OF_BSN_TLV_IFP_CLASS_ID = 376,
    OF_BSN_TLV_IGMP_SNOOPING = 377,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 378,
    OF_BSN_TLV_INNER_VLAN_VID = 379,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 380,
    OF_BSN_TLV_INTERNAL_MAC = 381,
    OF_BSN_TLV_INTERVAL = 382,
    OF_BSN_TLV_IP_FRAGMENTATION = 383,
    OF_BSN_TLV_IP_PROTO = 384,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 385,
    OF_BSN_TLV_IPV4 = 386,
    OF_BSN_TLV_IPV4_DST = 387,
    OF_BSN_TLV_IPV4_NETMASK = 388,
    OF_BSN_TLV_IPV4_SRC = 389,
    OF_BSN_TLV_IPV6 = 390,
    OF_BSN_TLV_IPV6_DST = 391,
    OF_BSN_TLV_IPV6_PREFIX = 392,
    OF_BSN_TLV_IPV6_SRC = 393,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 394,
    OF_BSN_TLV_L2_CACHE_HIT = 395,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 396,
    OF_BSN_TLV_L3 = 397,
    OF_BSN_TLV_L3_DST_CLASS_ID = 398,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 399,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 400,
    OF_BSN_TLV_LAG_OPTIONS = 401,
    OF_BSN_TLV_LCORE = 402,
    OF_BSN_TLV_LINK_UP = 403,
    OF_BSN_TLV_LOAD = 404,
    OF_BSN_TLV_LOOPBACK_MODE = 405,
    OF_BSN_TLV_LOOPBACK_PORT = 406,
    OF_BSN_TLV_LOSSLESS = 407,
    OF_BSN_TLV_LR_ALL_ENABLED = 408,
    OF_BSN_TLV_MAC = 409,
    OF_BSN_TLV_MAC_MASK = 410,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 411,
    OF_BSN_TLV_MGMT = 412,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 413,
    OF_BSN_TLV_MISS_PACKETS = 414,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 415,
    OF_BSN_TLV_MPLS_LABEL = 416,
    OF_BSN_TLV_MPLS_SEQUENCED = 417,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 418,
    OF_BSN_TLV_MULTICAST_PACKET = 419,
    OF_BSN_TLV_MULTIPLIER = 420,
    OF_BSN_TLV_NAME = 421,
    OF_BSN_TLV_NDP_OFFLOAD = 422,
    OF_BSN_TLV_NDP_STATIC = 423,
    OF_BSN_TLV_NEGATE = 424,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 425,
    OF_BSN_TLV_NEXT_HOP_MAC = 426,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 427,
    OF_BSN_TLV_NO_ARP_RESPONSE = 428,
    OF_BSN_TLV_NO_NS_RESPONSE = 429,
    OF_BSN_TLV_OFFSET = 430,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 431,
    OF_BSN_TLV_OUTER_SRC_MAC = 432,
    OF_BSN_TLV_PARENT_PORT = 433,
    OF_BSN_TLV_PARTNER_KEY = 434,
    OF_BSN_TLV_PARTNER_PORT_NUM = 435,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 436,
    OF_BSN_TLV_PARTNER_STATE = 437,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 438,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 439,
    OF_BSN_TLV_PASSIVE = 440,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 441,
    OF_BSN_TLV_PIM_DR = 442,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 443,
    OF_BSN_TLV_PORT = 444,
    OF_BSN_TLV_PORT_MODE = 445,
    OF_BSN_TLV_PORT_SPEED_GBPS = 446,
    OF_BSN_TLV_PORT_USAGE = 447,
    OF_BSN_TLV_PORT_VXLAN_MODE = 448,
    OF_BSN_TLV_PRESERVE_VLAN = 449,
    OF_BSN_TLV_PRIORITY = 450,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 451,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 452,
    OF_BSN_TLV_QOS_PRIORITY = 453,
    OF_BSN_TLV_QUEUE_ID = 454,
    OF_BSN_TLV_QUEUE_WEIGHT = 455,
    OF_BSN_TLV_RATE_LIMIT = 456,
    OF_BSN_TLV_RATE_UNIT = 457,
    OF_BSN_TLV_RECORD_PACKETS = 458,
    OF_BSN_TLV_REDUNDANT_MGMT = 459,
    OF_BSN_TLV_REFERENCE = 460,
    OF_BSN_TLV_REPLY_PACKETS = 461,
    OF_BSN_TLV_REQUEST_PACKETS = 462,
    OF_BSN_TLV_REST_SERVER = 463,
    OF_BSN_TLV_ROUTING_PARAM = 464,
    OF_BSN_TLV_RX_BYTES = 465,
    OF_BSN_TLV_RX_PACKETS = 466,
    OF_BSN_TLV_SAMPLING_RATE = 467,
    OF_BSN_TLV_SCTP_DST = 468,
    OF_BSN_TLV_SCTP_SRC = 469,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 470,
    OF_BSN_TLV_SOCKET = 471,
    OF_BSN_TLV_SRC_MAC_CML = 472,
    OF_BSN_TLV_STATUS = 473,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 474,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 475,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 476,
    OF_BSN_TLV_SUB_AGENT_ID = 477,
    OF_BSN_TLV_TCP_DST = 478,
    OF_BSN_TLV_TCP_FLAGS = 479,
    OF_BSN_TLV_TCP_SRC = 480,
    OF_BSN_TLV_THREAD = 481,
    OF_BSN_TLV_TIMESTAMP = 482,
    OF_BSN_TLV_TTL = 483,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 484,
    OF_BSN_TLV_TX_BYTES = 485,
    OF_BSN_TLV_TX_PACKETS = 486,
    OF_BSN_TLV_UDF_ANCHOR = 487,
    OF_BSN_TLV_UDF_CAPABILITY = 488,
    OF_BSN_TLV_UDF_DATA = 489,
    OF_BSN_TLV_UDF_ID = 490,
    OF_BSN_TLV_UDF_LENGTH = 491,
    OF_BSN_TLV_UDF_OFFSET = 492,
    OF_BSN_TLV_UDP_DST = 493,
    OF_BSN_TLV_UDP_SRC = 494,
    OF_BSN_TLV_UINT32 = 495,
    OF_BSN_TLV_UINT64_LIST = 496,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 497,
    OF_BSN_TLV_UNICAST_RATE = 498,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 499,
    OF_BSN_TLV_UNTAGGED = 500,
    OF_BSN_TLV_UPGRADE = 501,
    OF_BSN_TLV_URI_SCHEME = 502,
    OF_BSN_TLV_USE_PACKET_STATE = 503,
    OF_BSN_TLV_USER_CONFIGURED = 504,
    OF_BSN_TLV_VFI = 505,
    OF_BSN_TLV_VFP_CLASS_ID = 506,
    OF_BSN_TLV_VIRTUAL = 507,
    OF_BSN_TLV_VLAN_MAC_LIST = 508,
    OF_BSN_TLV_VLAN_PCP = 509,
    OF_BSN_TLV_VLAN_VID = 510,
    OF_BSN_TLV_VLAN_VID_MASK = 511,
    OF_BSN_TLV_VNI = 512,
    OF_BSN_TLV_VPN_KEY = 513,
    OF_BSN_TLV_VRF = 514,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 515,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 516,
    OF_BSN_VLAN_MAC = 517,
    OF_BSN_VPORT = 518,
    OF_BSN_VPORT_L2GRE = 519,
    OF_BSN_VPORT_Q_IN_Q = 520,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 521,
    OF_BUCKET = 522,
    OF_BUCKET_COUNTER = 523,
    OF_BUNDLE_PROP = 524,
    OF_BUNDLE_PROP_EXPERIMENTER = 525,
    OF_FLOW_STATS_ENTRY = 526,
    OF_GROUP_DESC_STATS_ENTRY = 527,
    OF_GROUP_STATS_ENTRY = 528,
    OF_HELLO_ELEM = 529,
    OF_HELLO_ELEM_VERSIONBITMAP = 530,
    OF_INSTRUCTION = 531,
    OF_INSTRUCTION_APPLY_ACTIONS = 532,
    OF_INSTRUCTION_BSN = 533,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 534,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 535,
    OF_INSTRUCTION_BSN_DENY = 536,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 537,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 538,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 539,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 540,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 541,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 542,
    OF_INSTRUCTION_BSN_HASH_SELECT = 543,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 544,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 545,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 546,
    OF_INSTRUCTION_BSN_PERMIT = 547,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 548,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 549,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 550,
    OF_INSTRUCTION_CLEAR_ACTIONS = 551,
    OF_INSTRUCTION_EXPERIMENTER = 552,
    OF_INSTRUCTION_GOTO_TABLE = 553,
    OF_INSTRUCTION_ID = 554,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 555,
    OF_INSTRUCTION_ID_BSN = 556,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 557,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 558,
    OF_INSTRUCTION_ID_BSN_DENY = 559,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 560,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 561,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 562,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 563,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 564,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 565,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 566,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 567,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 568,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 569,
    OF_INSTRUCTION_ID_BSN_PERMIT = 570,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 571,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 572,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 573,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 574,
    OF_INSTRUCTION_ID_EXPERIMENTER = 575,
    OF_INSTRUCTION_ID_GOTO_TABLE = 576,
    OF_INSTRUCTION_ID_METER = 577,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 578,
    OF_INSTRUCTION_ID_WRITE_METADATA = 579,
    OF_INSTRUCTION_METER = 580,
    OF_INSTRUCTION_WRITE_ACTIONS = 581,
    OF_INSTRUCTION_WRITE_METADATA = 582,
    OF_MATCH_V1 = 583,
    OF_MATCH_V2 = 584,
    OF_MATCH_V3 = 585,
    OF_METER_BAND = 586,
    OF_METER_BAND_DROP = 587,
    OF_METER_BAND_DSCP_REMARK = 588,
    OF_METER_BAND_EXPERIMENTER = 589,
    OF_METER_BAND_STATS = 590,
    OF_METER_CONFIG = 591,
    OF_METER_FEATURES = 592,
    OF_METER_STATS = 593,
    OF_OXM = 594,
    OF_OXM_ARP_OP = 595,
    OF_OXM_ARP_OP_MASKED = 596,
    OF_OXM_ARP_SHA = 597,
    OF_OXM_ARP_SHA_MASKED = 598,
    OF_OXM_ARP_SPA = 599,
    OF_OXM_ARP_SPA_MASKED = 600,
    OF_OXM_ARP_THA = 601,
    OF_OXM_ARP_THA_MASKED = 602,
    OF_OXM_ARP_TPA = 603,
    OF_OXM_ARP_TPA_MASKED = 604,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 605,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 606,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 607,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 608,
    OF_OXM_BSN_IFP_CLASS_ID = 609,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 610,
    OF_OXM_BSN_IN_PORTS_128 = 611,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 612,
    OF_OXM_BSN_IN_PORTS_512 = 613,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 614,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 615,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 616,
    OF_OXM_BSN_INNER_ETH_DST = 617,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 618,
    OF_OXM_BSN_INNER_ETH_SRC = 619,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 620,
    OF_OXM_BSN_INNER_VLAN_VID = 621,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 622,
    OF_OXM_BSN_IP_FRAGMENTATION = 623,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 624,
    OF_OXM_BSN_L2_CACHE_HIT = 625,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 626,
    OF_OXM_BSN_L3_DST_CLASS_ID = 627,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 628,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 629,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 630,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 631,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 632,
    OF_OXM_BSN_LAG_ID = 633,
    OF_OXM_BSN_LAG_ID_MASKED = 634,
    OF_OXM_BSN_TCP_FLAGS = 635,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 636,
    OF_OXM_BSN_UDF0 = 637,
    OF_OXM_BSN_UDF0_MASKED = 638,
    OF_OXM_BSN_UDF1 = 639,
    OF_OXM_BSN_UDF1_MASKED = 640,
    OF_OXM_BSN_UDF2 = 641,
    OF_OXM_BSN_UDF2_MASKED = 642,
    OF_OXM_BSN_UDF3 = 643,
    OF_OXM_BSN_UDF3_MASKED = 644,
    OF_OXM_BSN_UDF4 = 645,
    OF_OXM_BSN_UDF4_MASKED = 646,
    OF_OXM_BSN_UDF5 = 647,
    OF_OXM_BSN_UDF5_MASKED = 648,
    OF_OXM_BSN_UDF6 = 649,
    OF_OXM_BSN_UDF6_MASKED = 650,
    OF_OXM_BSN_UDF7 = 651,
    OF_OXM_BSN_UDF7_MASKED = 652,
    OF_OXM_BSN_VFI = 653,
    OF_OXM_BSN_VFI_MASKED = 654,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 655,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 656,
    OF_OXM_BSN_VRF = 657,
    OF_OXM_BSN_VRF_MASKED = 658,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 659,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 660,
    OF_OXM_CONN_TRACKING_IPV6_DST = 661,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 662,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 663,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 664,
    OF_OXM_CONN_TRACKING_LABEL = 665,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 666,
    OF_OXM_CONN_TRACKING_MARK = 667,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 668,
    OF_OXM_CONN_TRACKING_NW_DST = 669,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 670,
    OF_OXM_CONN_TRACKING_NW_PROTO = 671,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 672,
    OF_OXM_CONN_TRACKING_NW_SRC = 673,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 674,
    OF_OXM_CONN_TRACKING_STATE = 675,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 676,
    OF_OXM_CONN_TRACKING_TP_DST = 677,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 678,
    OF_OXM_CONN_TRACKING_TP_SRC = 679,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 680,
    OF_OXM_CONN_TRACKING_ZONE = 681,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 682,
    OF_OXM_ETH_DST = 683,
    OF_OXM_ETH_DST_MASKED = 684,
    OF_OXM_ETH_SRC = 685,
    OF_OXM_ETH_SRC_MASKED = 686,
    OF_OXM_ETH_TYPE = 687,
    OF_OXM_ETH_TYPE_MASKED = 688,
    OF_OXM_ICMPV4_CODE = 689,
    OF_OXM_ICMPV4_CODE_MASKED = 690,
    OF_OXM_ICMPV4_TYPE = 691,
    OF_OXM_ICMPV4_TYPE_MASKED = 692,
    OF_OXM_ICMPV6_CODE = 693,
    OF_OXM_ICMPV6_CODE_MASKED = 694,
    OF_OXM_ICMPV6_TYPE = 695,
    OF_OXM_ICMPV6_TYPE_MASKED = 696,
    OF_OXM_IN_PHY_PORT = 697,
    OF_OXM_IN_PHY_PORT_MASKED = 698,
    OF_OXM_IN_PORT = 699,
    OF_OXM_IN_PORT_MASKED = 700,
    OF_OXM_IP_DSCP = 701,
    OF_OXM_IP_DSCP_MASKED = 702,
    OF_OXM_IP_ECN = 703,
    OF_OXM_IP_ECN_MASKED = 704,
    OF_OXM_IP_PROTO = 705,
    OF_OXM_IP_PROTO_MASKED = 706,
    OF_OXM_IPV4_DST = 707,
    OF_OXM_IPV4_DST_MASKED = 708,
    OF_OXM_IPV4_SRC = 709,
    OF_OXM_IPV4_SRC_MASKED = 710,
    OF_OXM_IPV6_DST = 711,
    OF_OXM_IPV6_DST_MASKED = 712,
    OF_OXM_IPV6_EXTHDR = 713,
    OF_OXM_IPV6_EXTHDR_MASKED = 714,
    OF_OXM_IPV6_FLABEL = 715,
    OF_OXM_IPV6_FLABEL_MASKED = 716,
    OF_OXM_IPV6_ND_SLL = 717,
    OF_OXM_IPV6_ND_SLL_MASKED = 718,
    OF_OXM_IPV6_ND_TARGET = 719,
    OF_OXM_IPV6_ND_TARGET_MASKED = 720,
    OF_OXM_IPV6_ND_TLL = 721,
    OF_OXM_IPV6_ND_TLL_MASKED = 722,
    OF_OXM_IPV6_SRC = 723,
    OF_OXM_IPV6_SRC_MASKED = 724,
    OF_OXM_METADATA = 725,
    OF_OXM_METADATA_MASKED = 726,
    OF_OXM_MPLS_BOS = 727,
    OF_OXM_MPLS_BOS_MASKED = 728,
    OF_OXM_MPLS_LABEL = 729,
    OF_OXM_MPLS_LABEL_MASKED = 730,
    OF_OXM_MPLS_TC = 731,
    OF_OXM_MPLS_TC_MASKED = 732,
    OF_OXM_OVS_TCP_FLAGS = 733,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 734,
    OF_OXM_PBB_UCA = 735,
    OF_OXM_PBB_UCA_MASKED = 736,
    OF_OXM_SCTP_DST = 737,
    OF_OXM_SCTP_DST_MASKED = 738,
    OF_OXM_SCTP_SRC = 739,
    OF_OXM_SCTP_SRC_MASKED = 740,
    OF_OXM_TCP_DST = 741,
    OF_OXM_TCP_DST_MASKED = 742,
    OF_OXM_TCP_SRC = 743,
    OF_OXM_TCP_SRC_MASKED = 744,
    OF_OXM_TUNNEL_ID = 745,
    OF_OXM_TUNNEL_ID_MASKED = 746,
    OF_OXM_TUNNEL_IPV4_DST = 747,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 748,
    OF_OXM_TUNNEL_IPV4_SRC = 749,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 750,
    OF_OXM_UDP_DST = 751,
    OF_OXM_UDP_DST_MASKED = 752,
    OF_OXM_UDP_SRC = 753,
    OF_OXM_UDP_SRC_MASKED = 754,
    OF_OXM_VLAN_PCP = 755,
    OF_OXM_VLAN_PCP_MASKED = 756,
    OF_OXM_VLAN_VID = 757,
    OF_OXM_VLAN_VID_MASKED = 758,
    OF_PACKET_QUEUE = 759,
    OF_PORT_DESC = 760,
    OF_PORT_DESC_PROP = 761,
    OF_PORT_DESC_PROP_BSN = 762,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 763,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 764,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 765,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 766,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 767,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 768,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 769,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 770,
    OF_PORT_DESC_PROP_BSN_UPLINK = 771,
    OF_PORT_DESC_PROP_ETHERNET = 772,
    OF_PORT_DESC_PROP_EXPERIMENTER = 773,
    OF_PORT_DESC_PROP_OPTICAL = 774,
    OF_PORT_MOD_PROP = 775,
    OF_PORT_MOD_PROP_ETHERNET = 776,
    OF_PORT_MOD_PROP_EXPERIMENTER = 777,
    OF_PORT_MOD_PROP_OPTICAL = 778,
    OF_PORT_STATS_ENTRY = 779,
    OF_PORT_STATS_PROP = 780,
    OF_PORT_STATS_PROP_ETHERNET = 781,
    OF_PORT_STATS_PROP_EXPERIMENTER = 782,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 783,
    OF_PORT_STATS_PROP_OPTICAL = 784,
    OF_QUEUE_DESC = 785,
    OF_QUEUE_DESC_PROP = 786,
    OF_QUEUE_DESC_PROP_BSN = 787,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 788,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 789,
    OF_QUEUE_DESC_PROP_MAX_RATE = 790,
    OF_QUEUE_DESC_PROP_MIN_RATE = 791,
    OF_QUEUE_PROP = 792,
    OF_QUEUE_PROP_EXPERIMENTER = 793,
    OF_QUEUE_PROP_MAX_RATE = 794,
    OF_QUEUE_PROP_MIN_RATE = 795,
    OF_QUEUE_STATS_ENTRY = 796,
    OF_QUEUE_STATS_PROP = 797,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 798,
    OF_ROLE_PROP = 799,
    OF_ROLE_PROP_EXPERIMENTER = 800,
    OF_TABLE_DESC = 801,
    OF_TABLE_FEATURE_PROP = 802,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 803,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 804,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 805,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 806,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 807,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 808,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 809,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 810,
    OF_TABLE_FEATURE_PROP_MATCH = 811,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 812,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 813,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 814,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 815,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 816,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 817,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 818,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 819,
    OF_TABLE_FEATURES = 820,
    OF_TABLE_MOD_PROP = 821,
    OF_TABLE_MOD_PROP_EVICTION = 822,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 823,
    OF_TABLE_MOD_PROP_VACANCY = 824,
    OF_TABLE_STATS_ENTRY = 825,
    OF_UINT32 = 826,
    OF_UINT64 = 827,
    OF_UINT8 = 828,
    ...
    /* List objects */
    OF_LIST_ACTION = 829,
    OF_LIST_ACTION_ID = 830,
    OF_LIST_ASYNC_CONFIG_PROP = 831,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 832,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 833,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 834,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 835,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 836,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 837,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 838,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 839,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 840,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 841,
    OF_LIST_BSN_INTERFACE = 842,
    OF_LIST_BSN_LACP_STATS_ENTRY = 843,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 844,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 845,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 846,
    OF_LIST_BSN_TLV = 847,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 848,
    OF_LIST_BSN_VLAN_MAC = 849,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 850,
    OF_LIST_BUCKET = 851,
    OF_LIST_BUCKET_COUNTER = 852,
    OF_LIST_BUNDLE_PROP = 853,
    OF_LIST_FLOW_STATS_ENTRY = 854,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 855,
    OF_LIST_GROUP_STATS_ENTRY = 856,
    OF_LIST_HELLO_ELEM = 857,
    OF_LIST_INSTRUCTION = 858,
    OF_LIST_INSTRUCTION_ID = 859,
    OF_LIST_METER_BAND = 860,
    OF_LIST_METER_BAND_STATS = 861,
    OF_LIST_METER_CONFIG = 862,
    OF_LIST_METER_STATS = 863,
    OF_LIST_OXM = 864,
    OF_LIST_PACKET_QUEUE = 865,
    OF_LIST_PORT_DESC = 866,
    OF_LIST_PORT_DESC_PROP = 867,
    OF_LIST_PORT_MOD_PROP = 868,
    OF_LIST_PORT_STATS_ENTRY = 869,
    OF_LIST_PORT_STATS_PROP = 870,
    OF_LIST_QUEUE_DESC = 871,
    OF_LIST_QUEUE_DESC_PROP = 872,
    OF_LIST_QUEUE_PROP = 873,
    OF_LIST_QUEUE_STATS_ENTRY = 874,
    OF_LIST_QUEUE_STATS_PROP = 875,
    OF_LIST_ROLE_PROP = 876,
    OF_LIST_TABLE_DESC = 877,
    OF_LIST_TABLE_FEATURE_PROP = 878,
    OF_LIST_TABLE_FEATURES = 879,
    OF_LIST_TABLE_MOD_PROP = 880,
    OF_LIST_TABLE_STATS_ENTRY = 881,
    OF_LIST_UINT32 = 882,
    OF_LIST_UINT64 = 883,
    OF_LIST_UINT8 = 884,
