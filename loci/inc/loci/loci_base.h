...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_MISS_PACKETS = 341,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 342,
    OF_BSN_TLV_MPLS_LABEL = 343,
    OF_BSN_TLV_MPLS_SEQUENCED = 344,
    OF_BSN_TLV_NAME = 345,
    OF_BSN_TLV_NEGATE = 346,
    OF_BSN_TLV_OFFSET = 347,
    OF_BSN_TLV_PARTNER_KEY = 348,
    OF_BSN_TLV_PARTNER_PORT_NUM = 349,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 350,
    OF_BSN_TLV_PARTNER_STATE = 351,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 352,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 353,
    OF_BSN_TLV_PORT = 354,
    OF_BSN_TLV_PRIORITY = 355,
    OF_BSN_TLV_QUEUE_ID = 356,
    OF_BSN_TLV_QUEUE_WEIGHT = 357,
    OF_BSN_TLV_REFERENCE = 358,
    OF_BSN_TLV_REPLY_PACKETS = 359,
    OF_BSN_TLV_REQUEST_PACKETS = 360,
    OF_BSN_TLV_RX_BYTES = 361,
    OF_BSN_TLV_RX_PACKETS = 362,
    OF_BSN_TLV_SAMPLING_RATE = 363,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 364,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 365,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 366,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 367,
    OF_BSN_TLV_SUB_AGENT_ID = 368,
    OF_BSN_TLV_TCP_DST = 369,
    OF_BSN_TLV_TCP_SRC = 370,
    OF_BSN_TLV_TX_BYTES = 371,
    OF_BSN_TLV_TX_PACKETS = 372,
    OF_BSN_TLV_UDF_ANCHOR = 373,
    OF_BSN_TLV_UDF_ID = 374,
    OF_BSN_TLV_UDF_LENGTH = 375,
    OF_BSN_TLV_UDF_OFFSET = 376,
    OF_BSN_TLV_UDP_DST = 377,
    OF_BSN_TLV_UDP_SRC = 378,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 379,
    OF_BSN_TLV_VLAN_PCP = 380,
    OF_BSN_TLV_VLAN_VID = 381,
    OF_BSN_TLV_VLAN_VID_MASK = 382,
    OF_BSN_TLV_VRF = 383,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 384,
    OF_BSN_VPORT = 385,
    OF_BSN_VPORT_L2GRE = 386,
    OF_BSN_VPORT_Q_IN_Q = 387,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 388,
    OF_BUCKET = 389,
    OF_BUCKET_COUNTER = 390,
    OF_BUNDLE_PROP = 391,
    OF_BUNDLE_PROP_EXPERIMENTER = 392,
    OF_FLOW_STATS_ENTRY = 393,
    OF_GROUP_DESC_STATS_ENTRY = 394,
    OF_GROUP_STATS_ENTRY = 395,
    OF_HELLO_ELEM = 396,
    OF_HELLO_ELEM_VERSIONBITMAP = 397,
    OF_INSTRUCTION = 398,
    OF_INSTRUCTION_APPLY_ACTIONS = 399,
    OF_INSTRUCTION_BSN = 400,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 401,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 402,
    OF_INSTRUCTION_BSN_DENY = 403,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 404,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 405,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 406,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 407,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 408,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 409,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 410,
    OF_INSTRUCTION_BSN_PERMIT = 411,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 412,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 413,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 414,
    OF_INSTRUCTION_CLEAR_ACTIONS = 415,
    OF_INSTRUCTION_EXPERIMENTER = 416,
    OF_INSTRUCTION_GOTO_TABLE = 417,
    OF_INSTRUCTION_ID = 418,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 419,
    OF_INSTRUCTION_ID_BSN = 420,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 421,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 422,
    OF_INSTRUCTION_ID_BSN_DENY = 423,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 424,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 425,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 426,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 427,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 428,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 429,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 430,
    OF_INSTRUCTION_ID_BSN_PERMIT = 431,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 432,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 433,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 434,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 435,
    OF_INSTRUCTION_ID_EXPERIMENTER = 436,
    OF_INSTRUCTION_ID_GOTO_TABLE = 437,
    OF_INSTRUCTION_ID_METER = 438,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 439,
    OF_INSTRUCTION_ID_WRITE_METADATA = 440,
    OF_INSTRUCTION_METER = 441,
    OF_INSTRUCTION_WRITE_ACTIONS = 442,
    OF_INSTRUCTION_WRITE_METADATA = 443,
    OF_MATCH_V1 = 444,
    OF_MATCH_V2 = 445,
    OF_MATCH_V3 = 446,
    OF_METER_BAND = 447,
    OF_METER_BAND_DROP = 448,
    OF_METER_BAND_DSCP_REMARK = 449,
    OF_METER_BAND_EXPERIMENTER = 450,
    OF_METER_BAND_STATS = 451,
    OF_METER_CONFIG = 452,
    OF_METER_FEATURES = 453,
    OF_METER_STATS = 454,
    OF_OXM = 455,
    OF_OXM_ARP_OP = 456,
    OF_OXM_ARP_OP_MASKED = 457,
    OF_OXM_ARP_SHA = 458,
    OF_OXM_ARP_SHA_MASKED = 459,
    OF_OXM_ARP_SPA = 460,
    OF_OXM_ARP_SPA_MASKED = 461,
    OF_OXM_ARP_THA = 462,
    OF_OXM_ARP_THA_MASKED = 463,
    OF_OXM_ARP_TPA = 464,
    OF_OXM_ARP_TPA_MASKED = 465,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 466,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 467,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 468,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 469,
    OF_OXM_BSN_IN_PORTS_128 = 470,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 471,
    OF_OXM_BSN_IN_PORTS_512 = 472,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 473,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 474,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 475,
    OF_OXM_BSN_INNER_ETH_DST = 476,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 477,
    OF_OXM_BSN_INNER_ETH_SRC = 478,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 479,
    OF_OXM_BSN_INNER_VLAN_VID = 480,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 481,
    OF_OXM_BSN_L2_CACHE_HIT = 482,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 483,
    OF_OXM_BSN_L3_DST_CLASS_ID = 484,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 485,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 486,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 487,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 488,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 489,
    OF_OXM_BSN_LAG_ID = 490,
    OF_OXM_BSN_LAG_ID_MASKED = 491,
    OF_OXM_BSN_TCP_FLAGS = 492,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 493,
    OF_OXM_BSN_UDF0 = 494,
    OF_OXM_BSN_UDF0_MASKED = 495,
    OF_OXM_BSN_UDF1 = 496,
    OF_OXM_BSN_UDF1_MASKED = 497,
    OF_OXM_BSN_UDF2 = 498,
    OF_OXM_BSN_UDF2_MASKED = 499,
    OF_OXM_BSN_UDF3 = 500,
    OF_OXM_BSN_UDF3_MASKED = 501,
    OF_OXM_BSN_UDF4 = 502,
    OF_OXM_BSN_UDF4_MASKED = 503,
    OF_OXM_BSN_UDF5 = 504,
    OF_OXM_BSN_UDF5_MASKED = 505,
    OF_OXM_BSN_UDF6 = 506,
    OF_OXM_BSN_UDF6_MASKED = 507,
    OF_OXM_BSN_UDF7 = 508,
    OF_OXM_BSN_UDF7_MASKED = 509,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 510,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 511,
    OF_OXM_BSN_VRF = 512,
    OF_OXM_BSN_VRF_MASKED = 513,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 514,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 515,
    OF_OXM_ETH_DST = 516,
    OF_OXM_ETH_DST_MASKED = 517,
    OF_OXM_ETH_SRC = 518,
    OF_OXM_ETH_SRC_MASKED = 519,
    OF_OXM_ETH_TYPE = 520,
    OF_OXM_ETH_TYPE_MASKED = 521,
    OF_OXM_ICMPV4_CODE = 522,
    OF_OXM_ICMPV4_CODE_MASKED = 523,
    OF_OXM_ICMPV4_TYPE = 524,
    OF_OXM_ICMPV4_TYPE_MASKED = 525,
    OF_OXM_ICMPV6_CODE = 526,
    OF_OXM_ICMPV6_CODE_MASKED = 527,
    OF_OXM_ICMPV6_TYPE = 528,
    OF_OXM_ICMPV6_TYPE_MASKED = 529,
    OF_OXM_IN_PHY_PORT = 530,
    OF_OXM_IN_PHY_PORT_MASKED = 531,
    OF_OXM_IN_PORT = 532,
    OF_OXM_IN_PORT_MASKED = 533,
    OF_OXM_IP_DSCP = 534,
    OF_OXM_IP_DSCP_MASKED = 535,
    OF_OXM_IP_ECN = 536,
    OF_OXM_IP_ECN_MASKED = 537,
    OF_OXM_IP_PROTO = 538,
    OF_OXM_IP_PROTO_MASKED = 539,
    OF_OXM_IPV4_DST = 540,
    OF_OXM_IPV4_DST_MASKED = 541,
    OF_OXM_IPV4_SRC = 542,
    OF_OXM_IPV4_SRC_MASKED = 543,
    OF_OXM_IPV6_DST = 544,
    OF_OXM_IPV6_DST_MASKED = 545,
    OF_OXM_IPV6_EXTHDR = 546,
    OF_OXM_IPV6_EXTHDR_MASKED = 547,
    OF_OXM_IPV6_FLABEL = 548,
    OF_OXM_IPV6_FLABEL_MASKED = 549,
    OF_OXM_IPV6_ND_SLL = 550,
    OF_OXM_IPV6_ND_SLL_MASKED = 551,
    OF_OXM_IPV6_ND_TARGET = 552,
    OF_OXM_IPV6_ND_TARGET_MASKED = 553,
    OF_OXM_IPV6_ND_TLL = 554,
    OF_OXM_IPV6_ND_TLL_MASKED = 555,
    OF_OXM_IPV6_SRC = 556,
    OF_OXM_IPV6_SRC_MASKED = 557,
    OF_OXM_METADATA = 558,
    OF_OXM_METADATA_MASKED = 559,
    OF_OXM_MPLS_BOS = 560,
    OF_OXM_MPLS_BOS_MASKED = 561,
    OF_OXM_MPLS_LABEL = 562,
    OF_OXM_MPLS_LABEL_MASKED = 563,
    OF_OXM_MPLS_TC = 564,
    OF_OXM_MPLS_TC_MASKED = 565,
    OF_OXM_PBB_UCA = 566,
    OF_OXM_PBB_UCA_MASKED = 567,
    OF_OXM_SCTP_DST = 568,
    OF_OXM_SCTP_DST_MASKED = 569,
    OF_OXM_SCTP_SRC = 570,
    OF_OXM_SCTP_SRC_MASKED = 571,
    OF_OXM_TCP_DST = 572,
    OF_OXM_TCP_DST_MASKED = 573,
    OF_OXM_TCP_SRC = 574,
    OF_OXM_TCP_SRC_MASKED = 575,
    OF_OXM_TUNNEL_ID = 576,
    OF_OXM_TUNNEL_ID_MASKED = 577,
    OF_OXM_TUNNEL_IPV4_DST = 578,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 579,
    OF_OXM_TUNNEL_IPV4_SRC = 580,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 581,
    OF_OXM_UDP_DST = 582,
    OF_OXM_UDP_DST_MASKED = 583,
    OF_OXM_UDP_SRC = 584,
    OF_OXM_UDP_SRC_MASKED = 585,
    OF_OXM_VLAN_PCP = 586,
    OF_OXM_VLAN_PCP_MASKED = 587,
    OF_OXM_VLAN_VID = 588,
    OF_OXM_VLAN_VID_MASKED = 589,
    OF_PACKET_QUEUE = 590,
    OF_PORT_DESC = 591,
    OF_PORT_DESC_PROP = 592,
    OF_PORT_DESC_PROP_BSN = 593,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 594,
    OF_PORT_DESC_PROP_BSN_UPLINK = 595,
    OF_PORT_DESC_PROP_ETHERNET = 596,
    OF_PORT_DESC_PROP_EXPERIMENTER = 597,
    OF_PORT_DESC_PROP_OPTICAL = 598,
    OF_PORT_MOD_PROP = 599,
    OF_PORT_MOD_PROP_ETHERNET = 600,
    OF_PORT_MOD_PROP_EXPERIMENTER = 601,
    OF_PORT_MOD_PROP_OPTICAL = 602,
    OF_PORT_STATS_ENTRY = 603,
    OF_PORT_STATS_PROP = 604,
    OF_PORT_STATS_PROP_ETHERNET = 605,
    OF_PORT_STATS_PROP_EXPERIMENTER = 606,
    OF_PORT_STATS_PROP_OPTICAL = 607,
    OF_QUEUE_DESC = 608,
    OF_QUEUE_DESC_PROP = 609,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 610,
    OF_QUEUE_DESC_PROP_MAX_RATE = 611,
    OF_QUEUE_DESC_PROP_MIN_RATE = 612,
    OF_QUEUE_PROP = 613,
    OF_QUEUE_PROP_EXPERIMENTER = 614,
    OF_QUEUE_PROP_MAX_RATE = 615,
    OF_QUEUE_PROP_MIN_RATE = 616,
    OF_QUEUE_STATS_ENTRY = 617,
    OF_QUEUE_STATS_PROP = 618,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 619,
    OF_ROLE_PROP = 620,
    OF_ROLE_PROP_EXPERIMENTER = 621,
    OF_TABLE_DESC = 622,
    OF_TABLE_FEATURE_PROP = 623,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 624,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 625,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 626,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 627,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 628,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 629,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 630,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 631,
    OF_TABLE_FEATURE_PROP_MATCH = 632,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 633,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 634,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 635,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 636,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 637,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 638,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 639,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 640,
    OF_TABLE_FEATURES = 641,
    OF_TABLE_MOD_PROP = 642,
    OF_TABLE_MOD_PROP_EVICTION = 643,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 644,
    OF_TABLE_MOD_PROP_VACANCY = 645,
    OF_TABLE_STATS_ENTRY = 646,
    OF_UINT32 = 647,
    OF_UINT64 = 648,
    OF_UINT8 = 649,
    ...
    /* List objects */
    OF_LIST_ACTION = 650,
    OF_LIST_ACTION_ID = 651,
    OF_LIST_ASYNC_CONFIG_PROP = 652,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 653,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 654,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 655,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 656,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 657,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 658,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 659,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 660,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 661,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 662,
    OF_LIST_BSN_INTERFACE = 663,
    OF_LIST_BSN_LACP_STATS_ENTRY = 664,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 665,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 666,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 667,
    OF_LIST_BSN_TLV = 668,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 669,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 670,
    OF_LIST_BUCKET = 671,
    OF_LIST_BUCKET_COUNTER = 672,
    OF_LIST_BUNDLE_PROP = 673,
    OF_LIST_FLOW_STATS_ENTRY = 674,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 675,
    OF_LIST_GROUP_STATS_ENTRY = 676,
    OF_LIST_HELLO_ELEM = 677,
    OF_LIST_INSTRUCTION = 678,
    OF_LIST_INSTRUCTION_ID = 679,
    OF_LIST_METER_BAND = 680,
    OF_LIST_METER_BAND_STATS = 681,
    OF_LIST_METER_CONFIG = 682,
    OF_LIST_METER_STATS = 683,
    OF_LIST_OXM = 684,
    OF_LIST_PACKET_QUEUE = 685,
    OF_LIST_PORT_DESC = 686,
    OF_LIST_PORT_DESC_PROP = 687,
    OF_LIST_PORT_MOD_PROP = 688,
    OF_LIST_PORT_STATS_ENTRY = 689,
    OF_LIST_PORT_STATS_PROP = 690,
    OF_LIST_QUEUE_DESC = 691,
    OF_LIST_QUEUE_DESC_PROP = 692,
    OF_LIST_QUEUE_PROP = 693,
    OF_LIST_QUEUE_STATS_ENTRY = 694,
    OF_LIST_QUEUE_STATS_PROP = 695,
    OF_LIST_ROLE_PROP = 696,
    OF_LIST_TABLE_DESC = 697,
    OF_LIST_TABLE_FEATURE_PROP = 698,
    OF_LIST_TABLE_FEATURES = 699,
    OF_LIST_TABLE_MOD_PROP = 700,
    OF_LIST_TABLE_STATS_ENTRY = 701,
    OF_LIST_UINT32 = 702,
    OF_LIST_UINT64 = 703,
    OF_LIST_UINT8 = 704,
