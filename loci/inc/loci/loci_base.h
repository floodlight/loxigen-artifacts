...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_MULTICAST_PACKET = 394,
    OF_BSN_TLV_MULTIPLIER = 395,
    OF_BSN_TLV_NAME = 396,
    OF_BSN_TLV_NDP_OFFLOAD = 397,
    OF_BSN_TLV_NDP_STATIC = 398,
    OF_BSN_TLV_NEGATE = 399,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 400,
    OF_BSN_TLV_NEXT_HOP_MAC = 401,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 402,
    OF_BSN_TLV_NO_ARP_RESPONSE = 403,
    OF_BSN_TLV_NO_NS_RESPONSE = 404,
    OF_BSN_TLV_OFFSET = 405,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 406,
    OF_BSN_TLV_OUTER_SRC_MAC = 407,
    OF_BSN_TLV_PARENT_PORT = 408,
    OF_BSN_TLV_PARTNER_KEY = 409,
    OF_BSN_TLV_PARTNER_PORT_NUM = 410,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 411,
    OF_BSN_TLV_PARTNER_STATE = 412,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 413,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 414,
    OF_BSN_TLV_PASSIVE = 415,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 416,
    OF_BSN_TLV_PIM_DR = 417,
    OF_BSN_TLV_PORT = 418,
    OF_BSN_TLV_PORT_SPEED_GBPS = 419,
    OF_BSN_TLV_PORT_USAGE = 420,
    OF_BSN_TLV_PORT_VXLAN_MODE = 421,
    OF_BSN_TLV_PRIORITY = 422,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 423,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 424,
    OF_BSN_TLV_QOS_PRIORITY = 425,
    OF_BSN_TLV_QUEUE_ID = 426,
    OF_BSN_TLV_QUEUE_WEIGHT = 427,
    OF_BSN_TLV_RATE_LIMIT = 428,
    OF_BSN_TLV_RATE_UNIT = 429,
    OF_BSN_TLV_RECORD_PACKETS = 430,
    OF_BSN_TLV_REFERENCE = 431,
    OF_BSN_TLV_REPLY_PACKETS = 432,
    OF_BSN_TLV_REQUEST_PACKETS = 433,
    OF_BSN_TLV_REST_SERVER = 434,
    OF_BSN_TLV_ROUTING_PARAM = 435,
    OF_BSN_TLV_RX_BYTES = 436,
    OF_BSN_TLV_RX_PACKETS = 437,
    OF_BSN_TLV_SAMPLING_RATE = 438,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 439,
    OF_BSN_TLV_STATUS = 440,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 441,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 442,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 443,
    OF_BSN_TLV_SUB_AGENT_ID = 444,
    OF_BSN_TLV_TCP_DST = 445,
    OF_BSN_TLV_TCP_FLAGS = 446,
    OF_BSN_TLV_TCP_SRC = 447,
    OF_BSN_TLV_TIMESTAMP = 448,
    OF_BSN_TLV_TTL = 449,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 450,
    OF_BSN_TLV_TX_BYTES = 451,
    OF_BSN_TLV_TX_PACKETS = 452,
    OF_BSN_TLV_UDF_ANCHOR = 453,
    OF_BSN_TLV_UDF_ID = 454,
    OF_BSN_TLV_UDF_LENGTH = 455,
    OF_BSN_TLV_UDF_OFFSET = 456,
    OF_BSN_TLV_UDP_DST = 457,
    OF_BSN_TLV_UDP_SRC = 458,
    OF_BSN_TLV_UINT32 = 459,
    OF_BSN_TLV_UINT64_LIST = 460,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 461,
    OF_BSN_TLV_UNICAST_RATE = 462,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 463,
    OF_BSN_TLV_UNTAGGED = 464,
    OF_BSN_TLV_UPGRADE = 465,
    OF_BSN_TLV_URI_SCHEME = 466,
    OF_BSN_TLV_USE_PACKET_STATE = 467,
    OF_BSN_TLV_USER_CONFIGURED = 468,
    OF_BSN_TLV_VFI = 469,
    OF_BSN_TLV_VFP_CLASS_ID = 470,
    OF_BSN_TLV_VIRTUAL = 471,
    OF_BSN_TLV_VLAN_MAC_LIST = 472,
    OF_BSN_TLV_VLAN_PCP = 473,
    OF_BSN_TLV_VLAN_VID = 474,
    OF_BSN_TLV_VLAN_VID_MASK = 475,
    OF_BSN_TLV_VNI = 476,
    OF_BSN_TLV_VPN_KEY = 477,
    OF_BSN_TLV_VRF = 478,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 479,
    OF_BSN_UNIT = 480,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 481,
    OF_BSN_VLAN_MAC = 482,
    OF_BSN_VPORT = 483,
    OF_BSN_VPORT_L2GRE = 484,
    OF_BSN_VPORT_Q_IN_Q = 485,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 486,
    OF_BUCKET = 487,
    OF_BUCKET_COUNTER = 488,
    OF_BUNDLE_PROP = 489,
    OF_BUNDLE_PROP_EXPERIMENTER = 490,
    OF_FLOW_STATS_ENTRY = 491,
    OF_GROUP_DESC_STATS_ENTRY = 492,
    OF_GROUP_STATS_ENTRY = 493,
    OF_HELLO_ELEM = 494,
    OF_HELLO_ELEM_VERSIONBITMAP = 495,
    OF_INSTRUCTION = 496,
    OF_INSTRUCTION_APPLY_ACTIONS = 497,
    OF_INSTRUCTION_BSN = 498,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 499,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 500,
    OF_INSTRUCTION_BSN_DENY = 501,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 502,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 503,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 504,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 505,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 506,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 507,
    OF_INSTRUCTION_BSN_HASH_SELECT = 508,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 509,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 510,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 511,
    OF_INSTRUCTION_BSN_PERMIT = 512,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 513,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 514,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 515,
    OF_INSTRUCTION_CLEAR_ACTIONS = 516,
    OF_INSTRUCTION_EXPERIMENTER = 517,
    OF_INSTRUCTION_GOTO_TABLE = 518,
    OF_INSTRUCTION_ID = 519,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 520,
    OF_INSTRUCTION_ID_BSN = 521,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 522,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 523,
    OF_INSTRUCTION_ID_BSN_DENY = 524,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 525,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 526,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 527,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 528,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 529,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 530,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 531,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 532,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 533,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 534,
    OF_INSTRUCTION_ID_BSN_PERMIT = 535,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 536,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 537,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 538,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 539,
    OF_INSTRUCTION_ID_EXPERIMENTER = 540,
    OF_INSTRUCTION_ID_GOTO_TABLE = 541,
    OF_INSTRUCTION_ID_METER = 542,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 543,
    OF_INSTRUCTION_ID_WRITE_METADATA = 544,
    OF_INSTRUCTION_METER = 545,
    OF_INSTRUCTION_WRITE_ACTIONS = 546,
    OF_INSTRUCTION_WRITE_METADATA = 547,
    OF_MATCH_V1 = 548,
    OF_MATCH_V2 = 549,
    OF_MATCH_V3 = 550,
    OF_METER_BAND = 551,
    OF_METER_BAND_DROP = 552,
    OF_METER_BAND_DSCP_REMARK = 553,
    OF_METER_BAND_EXPERIMENTER = 554,
    OF_METER_BAND_STATS = 555,
    OF_METER_CONFIG = 556,
    OF_METER_FEATURES = 557,
    OF_METER_STATS = 558,
    OF_OXM = 559,
    OF_OXM_ARP_OP = 560,
    OF_OXM_ARP_OP_MASKED = 561,
    OF_OXM_ARP_SHA = 562,
    OF_OXM_ARP_SHA_MASKED = 563,
    OF_OXM_ARP_SPA = 564,
    OF_OXM_ARP_SPA_MASKED = 565,
    OF_OXM_ARP_THA = 566,
    OF_OXM_ARP_THA_MASKED = 567,
    OF_OXM_ARP_TPA = 568,
    OF_OXM_ARP_TPA_MASKED = 569,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 570,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 571,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 572,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 573,
    OF_OXM_BSN_IFP_CLASS_ID = 574,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 575,
    OF_OXM_BSN_IN_PORTS_128 = 576,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 577,
    OF_OXM_BSN_IN_PORTS_512 = 578,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 579,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 580,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 581,
    OF_OXM_BSN_INNER_ETH_DST = 582,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 583,
    OF_OXM_BSN_INNER_ETH_SRC = 584,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 585,
    OF_OXM_BSN_INNER_VLAN_VID = 586,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 587,
    OF_OXM_BSN_IP_FRAGMENTATION = 588,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 589,
    OF_OXM_BSN_L2_CACHE_HIT = 590,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 591,
    OF_OXM_BSN_L3_DST_CLASS_ID = 592,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 593,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 594,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 595,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 596,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 597,
    OF_OXM_BSN_LAG_ID = 598,
    OF_OXM_BSN_LAG_ID_MASKED = 599,
    OF_OXM_BSN_TCP_FLAGS = 600,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 601,
    OF_OXM_BSN_UDF0 = 602,
    OF_OXM_BSN_UDF0_MASKED = 603,
    OF_OXM_BSN_UDF1 = 604,
    OF_OXM_BSN_UDF1_MASKED = 605,
    OF_OXM_BSN_UDF2 = 606,
    OF_OXM_BSN_UDF2_MASKED = 607,
    OF_OXM_BSN_UDF3 = 608,
    OF_OXM_BSN_UDF3_MASKED = 609,
    OF_OXM_BSN_UDF4 = 610,
    OF_OXM_BSN_UDF4_MASKED = 611,
    OF_OXM_BSN_UDF5 = 612,
    OF_OXM_BSN_UDF5_MASKED = 613,
    OF_OXM_BSN_UDF6 = 614,
    OF_OXM_BSN_UDF6_MASKED = 615,
    OF_OXM_BSN_UDF7 = 616,
    OF_OXM_BSN_UDF7_MASKED = 617,
    OF_OXM_BSN_VFI = 618,
    OF_OXM_BSN_VFI_MASKED = 619,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 620,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 621,
    OF_OXM_BSN_VRF = 622,
    OF_OXM_BSN_VRF_MASKED = 623,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 624,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 625,
    OF_OXM_CONN_TRACKING_IPV6_DST = 626,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 627,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 628,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 629,
    OF_OXM_CONN_TRACKING_LABEL = 630,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 631,
    OF_OXM_CONN_TRACKING_MARK = 632,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 633,
    OF_OXM_CONN_TRACKING_NW_DST = 634,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 635,
    OF_OXM_CONN_TRACKING_NW_PROTO = 636,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 637,
    OF_OXM_CONN_TRACKING_NW_SRC = 638,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 639,
    OF_OXM_CONN_TRACKING_STATE = 640,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 641,
    OF_OXM_CONN_TRACKING_TP_DST = 642,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 643,
    OF_OXM_CONN_TRACKING_TP_SRC = 644,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 645,
    OF_OXM_CONN_TRACKING_ZONE = 646,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 647,
    OF_OXM_ETH_DST = 648,
    OF_OXM_ETH_DST_MASKED = 649,
    OF_OXM_ETH_SRC = 650,
    OF_OXM_ETH_SRC_MASKED = 651,
    OF_OXM_ETH_TYPE = 652,
    OF_OXM_ETH_TYPE_MASKED = 653,
    OF_OXM_ICMPV4_CODE = 654,
    OF_OXM_ICMPV4_CODE_MASKED = 655,
    OF_OXM_ICMPV4_TYPE = 656,
    OF_OXM_ICMPV4_TYPE_MASKED = 657,
    OF_OXM_ICMPV6_CODE = 658,
    OF_OXM_ICMPV6_CODE_MASKED = 659,
    OF_OXM_ICMPV6_TYPE = 660,
    OF_OXM_ICMPV6_TYPE_MASKED = 661,
    OF_OXM_IN_PHY_PORT = 662,
    OF_OXM_IN_PHY_PORT_MASKED = 663,
    OF_OXM_IN_PORT = 664,
    OF_OXM_IN_PORT_MASKED = 665,
    OF_OXM_IP_DSCP = 666,
    OF_OXM_IP_DSCP_MASKED = 667,
    OF_OXM_IP_ECN = 668,
    OF_OXM_IP_ECN_MASKED = 669,
    OF_OXM_IP_PROTO = 670,
    OF_OXM_IP_PROTO_MASKED = 671,
    OF_OXM_IPV4_DST = 672,
    OF_OXM_IPV4_DST_MASKED = 673,
    OF_OXM_IPV4_SRC = 674,
    OF_OXM_IPV4_SRC_MASKED = 675,
    OF_OXM_IPV6_DST = 676,
    OF_OXM_IPV6_DST_MASKED = 677,
    OF_OXM_IPV6_EXTHDR = 678,
    OF_OXM_IPV6_EXTHDR_MASKED = 679,
    OF_OXM_IPV6_FLABEL = 680,
    OF_OXM_IPV6_FLABEL_MASKED = 681,
    OF_OXM_IPV6_ND_SLL = 682,
    OF_OXM_IPV6_ND_SLL_MASKED = 683,
    OF_OXM_IPV6_ND_TARGET = 684,
    OF_OXM_IPV6_ND_TARGET_MASKED = 685,
    OF_OXM_IPV6_ND_TLL = 686,
    OF_OXM_IPV6_ND_TLL_MASKED = 687,
    OF_OXM_IPV6_SRC = 688,
    OF_OXM_IPV6_SRC_MASKED = 689,
    OF_OXM_METADATA = 690,
    OF_OXM_METADATA_MASKED = 691,
    OF_OXM_MPLS_BOS = 692,
    OF_OXM_MPLS_BOS_MASKED = 693,
    OF_OXM_MPLS_LABEL = 694,
    OF_OXM_MPLS_LABEL_MASKED = 695,
    OF_OXM_MPLS_TC = 696,
    OF_OXM_MPLS_TC_MASKED = 697,
    OF_OXM_OVS_TCP_FLAGS = 698,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 699,
    OF_OXM_PBB_UCA = 700,
    OF_OXM_PBB_UCA_MASKED = 701,
    OF_OXM_SCTP_DST = 702,
    OF_OXM_SCTP_DST_MASKED = 703,
    OF_OXM_SCTP_SRC = 704,
    OF_OXM_SCTP_SRC_MASKED = 705,
    OF_OXM_TCP_DST = 706,
    OF_OXM_TCP_DST_MASKED = 707,
    OF_OXM_TCP_SRC = 708,
    OF_OXM_TCP_SRC_MASKED = 709,
    OF_OXM_TUNNEL_ID = 710,
    OF_OXM_TUNNEL_ID_MASKED = 711,
    OF_OXM_TUNNEL_IPV4_DST = 712,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 713,
    OF_OXM_TUNNEL_IPV4_SRC = 714,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 715,
    OF_OXM_UDP_DST = 716,
    OF_OXM_UDP_DST_MASKED = 717,
    OF_OXM_UDP_SRC = 718,
    OF_OXM_UDP_SRC_MASKED = 719,
    OF_OXM_VLAN_PCP = 720,
    OF_OXM_VLAN_PCP_MASKED = 721,
    OF_OXM_VLAN_VID = 722,
    OF_OXM_VLAN_VID_MASKED = 723,
    OF_PACKET_QUEUE = 724,
    OF_PORT_DESC = 725,
    OF_PORT_DESC_PROP = 726,
    OF_PORT_DESC_PROP_BSN = 727,
    OF_PORT_DESC_PROP_BSN_ALARM = 728,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 729,
    OF_PORT_DESC_PROP_BSN_DIAG = 730,
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 731,
    ...
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 735,
    OF_PORT_DESC_PROP_BSN_UPLINK = 736,
    OF_PORT_DESC_PROP_ETHERNET = 737,
    OF_PORT_DESC_PROP_EXPERIMENTER = 738,
    OF_PORT_DESC_PROP_OPTICAL = 739,
    OF_PORT_MOD_PROP = 740,
    OF_PORT_MOD_PROP_ETHERNET = 741,
    OF_PORT_MOD_PROP_EXPERIMENTER = 742,
    OF_PORT_MOD_PROP_OPTICAL = 743,
    OF_PORT_STATS_ENTRY = 744,
    OF_PORT_STATS_PROP = 745,
    OF_PORT_STATS_PROP_ETHERNET = 746,
    OF_PORT_STATS_PROP_EXPERIMENTER = 747,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 748,
    OF_PORT_STATS_PROP_OPTICAL = 749,
    OF_QUEUE_DESC = 750,
    OF_QUEUE_DESC_PROP = 751,
    OF_QUEUE_DESC_PROP_BSN = 752,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 753,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 754,
    OF_QUEUE_DESC_PROP_MAX_RATE = 755,
    OF_QUEUE_DESC_PROP_MIN_RATE = 756,
    OF_QUEUE_PROP = 757,
    OF_QUEUE_PROP_EXPERIMENTER = 758,
    OF_QUEUE_PROP_MAX_RATE = 759,
    OF_QUEUE_PROP_MIN_RATE = 760,
    OF_QUEUE_STATS_ENTRY = 761,
    OF_QUEUE_STATS_PROP = 762,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 763,
    OF_ROLE_PROP = 764,
    OF_ROLE_PROP_EXPERIMENTER = 765,
    OF_TABLE_DESC = 766,
    OF_TABLE_FEATURE_PROP = 767,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 768,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 769,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 770,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 771,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 772,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 773,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 774,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 775,
    OF_TABLE_FEATURE_PROP_MATCH = 776,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 777,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 778,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 779,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 780,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 781,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 782,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 783,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 784,
    OF_TABLE_FEATURES = 785,
    OF_TABLE_MOD_PROP = 786,
    OF_TABLE_MOD_PROP_EVICTION = 787,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 788,
    OF_TABLE_MOD_PROP_VACANCY = 789,
    OF_TABLE_STATS_ENTRY = 790,
    OF_UINT32 = 791,
    OF_UINT64 = 792,
    OF_UINT8 = 793,
    OFP_BSN_MODULE_EEPROM_TRANSCEIVER = 794,
