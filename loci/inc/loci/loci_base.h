...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_IDLE_NOTIFICATION = 339,
    OF_BSN_TLV_IDLE_TIME = 340,
    OF_BSN_TLV_IDLE_TIMEOUT = 341,
    OF_BSN_TLV_IGMP_SNOOPING = 342,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 343,
    OF_BSN_TLV_INTERNAL_MAC = 344,
    OF_BSN_TLV_INTERVAL = 345,
    OF_BSN_TLV_IP_PROTO = 346,
    OF_BSN_TLV_IPV4 = 347,
    OF_BSN_TLV_IPV4_DST = 348,
    OF_BSN_TLV_IPV4_NETMASK = 349,
    OF_BSN_TLV_IPV4_SRC = 350,
    OF_BSN_TLV_IPV6 = 351,
    OF_BSN_TLV_IPV6_PREFIX = 352,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 353,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 354,
    OF_BSN_TLV_LOOPBACK_PORT = 355,
    OF_BSN_TLV_MAC = 356,
    OF_BSN_TLV_MAC_MASK = 357,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 358,
    OF_BSN_TLV_MISS_PACKETS = 359,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 360,
    OF_BSN_TLV_MPLS_LABEL = 361,
    OF_BSN_TLV_MPLS_SEQUENCED = 362,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 363,
    OF_BSN_TLV_NAME = 364,
    OF_BSN_TLV_NDP_OFFLOAD = 365,
    OF_BSN_TLV_NEGATE = 366,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 367,
    OF_BSN_TLV_NEXT_HOP_MAC = 368,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 369,
    OF_BSN_TLV_OFFSET = 370,
    OF_BSN_TLV_PARENT_PORT = 371,
    OF_BSN_TLV_PARTNER_KEY = 372,
    OF_BSN_TLV_PARTNER_PORT_NUM = 373,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 374,
    OF_BSN_TLV_PARTNER_STATE = 375,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 376,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 377,
    OF_BSN_TLV_PORT = 378,
    OF_BSN_TLV_PORT_VXLAN_MODE = 379,
    OF_BSN_TLV_PRIORITY = 380,
    OF_BSN_TLV_QOS_PRIORITY = 381,
    OF_BSN_TLV_QUEUE_ID = 382,
    OF_BSN_TLV_QUEUE_WEIGHT = 383,
    OF_BSN_TLV_RATE_LIMIT = 384,
    OF_BSN_TLV_RATE_UNIT = 385,
    OF_BSN_TLV_REFERENCE = 386,
    OF_BSN_TLV_REPLY_PACKETS = 387,
    OF_BSN_TLV_REQUEST_PACKETS = 388,
    OF_BSN_TLV_RX_BYTES = 389,
    OF_BSN_TLV_RX_PACKETS = 390,
    OF_BSN_TLV_SAMPLING_RATE = 391,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 392,
    OF_BSN_TLV_STATUS = 393,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 394,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 395,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 396,
    OF_BSN_TLV_SUB_AGENT_ID = 397,
    OF_BSN_TLV_TCP_DST = 398,
    OF_BSN_TLV_TCP_SRC = 399,
    OF_BSN_TLV_TTL = 400,
    OF_BSN_TLV_TX_BYTES = 401,
    OF_BSN_TLV_TX_PACKETS = 402,
    OF_BSN_TLV_UDF_ANCHOR = 403,
    OF_BSN_TLV_UDF_ID = 404,
    OF_BSN_TLV_UDF_LENGTH = 405,
    OF_BSN_TLV_UDF_OFFSET = 406,
    OF_BSN_TLV_UDP_DST = 407,
    OF_BSN_TLV_UDP_SRC = 408,
    OF_BSN_TLV_UINT64_LIST = 409,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 410,
    OF_BSN_TLV_UNICAST_RATE = 411,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 412,
    OF_BSN_TLV_UNTAGGED = 413,
    OF_BSN_TLV_USE_PACKET_STATE = 414,
    OF_BSN_TLV_VFI = 415,
    OF_BSN_TLV_VFP_CLASS_ID = 416,
    OF_BSN_TLV_VLAN_MAC_LIST = 417,
    OF_BSN_TLV_VLAN_PCP = 418,
    OF_BSN_TLV_VLAN_VID = 419,
    OF_BSN_TLV_VLAN_VID_MASK = 420,
    OF_BSN_TLV_VNI = 421,
    OF_BSN_TLV_VPN_KEY = 422,
    OF_BSN_TLV_VRF = 423,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 424,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 425,
    OF_BSN_VLAN_MAC = 426,
    OF_BSN_VPORT = 427,
    OF_BSN_VPORT_L2GRE = 428,
    OF_BSN_VPORT_Q_IN_Q = 429,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 430,
    OF_BUCKET = 431,
    OF_BUCKET_COUNTER = 432,
    OF_BUNDLE_PROP = 433,
    OF_BUNDLE_PROP_EXPERIMENTER = 434,
    OF_FLOW_STATS_ENTRY = 435,
    OF_GROUP_DESC_STATS_ENTRY = 436,
    OF_GROUP_STATS_ENTRY = 437,
    OF_HELLO_ELEM = 438,
    OF_HELLO_ELEM_VERSIONBITMAP = 439,
    OF_INSTRUCTION = 440,
    OF_INSTRUCTION_APPLY_ACTIONS = 441,
    OF_INSTRUCTION_BSN = 442,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 443,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 444,
    OF_INSTRUCTION_BSN_DENY = 445,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 446,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 447,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 448,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 449,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 450,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 451,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 452,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 453,
    OF_INSTRUCTION_BSN_PERMIT = 454,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 455,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 456,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 457,
    OF_INSTRUCTION_CLEAR_ACTIONS = 458,
    OF_INSTRUCTION_EXPERIMENTER = 459,
    OF_INSTRUCTION_GOTO_TABLE = 460,
    OF_INSTRUCTION_ID = 461,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 462,
    OF_INSTRUCTION_ID_BSN = 463,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 464,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 465,
    OF_INSTRUCTION_ID_BSN_DENY = 466,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 467,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 468,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 469,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 470,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 471,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 472,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 473,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 474,
    OF_INSTRUCTION_ID_BSN_PERMIT = 475,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 476,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 477,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 478,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 479,
    OF_INSTRUCTION_ID_EXPERIMENTER = 480,
    OF_INSTRUCTION_ID_GOTO_TABLE = 481,
    OF_INSTRUCTION_ID_METER = 482,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 483,
    OF_INSTRUCTION_ID_WRITE_METADATA = 484,
    OF_INSTRUCTION_METER = 485,
    OF_INSTRUCTION_WRITE_ACTIONS = 486,
    OF_INSTRUCTION_WRITE_METADATA = 487,
    OF_MATCH_V1 = 488,
    OF_MATCH_V2 = 489,
    OF_MATCH_V3 = 490,
    OF_METER_BAND = 491,
    OF_METER_BAND_DROP = 492,
    OF_METER_BAND_DSCP_REMARK = 493,
    OF_METER_BAND_EXPERIMENTER = 494,
    OF_METER_BAND_STATS = 495,
    OF_METER_CONFIG = 496,
    OF_METER_FEATURES = 497,
    OF_METER_STATS = 498,
    OF_OXM = 499,
    OF_OXM_ARP_OP = 500,
    OF_OXM_ARP_OP_MASKED = 501,
    OF_OXM_ARP_SHA = 502,
    OF_OXM_ARP_SHA_MASKED = 503,
    OF_OXM_ARP_SPA = 504,
    OF_OXM_ARP_SPA_MASKED = 505,
    OF_OXM_ARP_THA = 506,
    OF_OXM_ARP_THA_MASKED = 507,
    OF_OXM_ARP_TPA = 508,
    OF_OXM_ARP_TPA_MASKED = 509,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 510,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 511,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 512,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 513,
    OF_OXM_BSN_IN_PORTS_128 = 514,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 515,
    OF_OXM_BSN_IN_PORTS_512 = 516,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 517,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 518,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 519,
    OF_OXM_BSN_INNER_ETH_DST = 520,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 521,
    OF_OXM_BSN_INNER_ETH_SRC = 522,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 523,
    OF_OXM_BSN_INNER_VLAN_VID = 524,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 525,
    OF_OXM_BSN_L2_CACHE_HIT = 526,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 527,
    OF_OXM_BSN_L3_DST_CLASS_ID = 528,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 529,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 530,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 531,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 532,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 533,
    OF_OXM_BSN_LAG_ID = 534,
    OF_OXM_BSN_LAG_ID_MASKED = 535,
    OF_OXM_BSN_TCP_FLAGS = 536,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 537,
    OF_OXM_BSN_UDF0 = 538,
    OF_OXM_BSN_UDF0_MASKED = 539,
    OF_OXM_BSN_UDF1 = 540,
    OF_OXM_BSN_UDF1_MASKED = 541,
    OF_OXM_BSN_UDF2 = 542,
    OF_OXM_BSN_UDF2_MASKED = 543,
    OF_OXM_BSN_UDF3 = 544,
    OF_OXM_BSN_UDF3_MASKED = 545,
    OF_OXM_BSN_UDF4 = 546,
    OF_OXM_BSN_UDF4_MASKED = 547,
    OF_OXM_BSN_UDF5 = 548,
    OF_OXM_BSN_UDF5_MASKED = 549,
    OF_OXM_BSN_UDF6 = 550,
    OF_OXM_BSN_UDF6_MASKED = 551,
    OF_OXM_BSN_UDF7 = 552,
    OF_OXM_BSN_UDF7_MASKED = 553,
    OF_OXM_BSN_VFI = 554,
    OF_OXM_BSN_VFI_MASKED = 555,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 556,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 557,
    OF_OXM_BSN_VRF = 558,
    OF_OXM_BSN_VRF_MASKED = 559,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 560,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 561,
    OF_OXM_ETH_DST = 562,
    OF_OXM_ETH_DST_MASKED = 563,
    OF_OXM_ETH_SRC = 564,
    OF_OXM_ETH_SRC_MASKED = 565,
    OF_OXM_ETH_TYPE = 566,
    OF_OXM_ETH_TYPE_MASKED = 567,
    OF_OXM_ICMPV4_CODE = 568,
    OF_OXM_ICMPV4_CODE_MASKED = 569,
    OF_OXM_ICMPV4_TYPE = 570,
    OF_OXM_ICMPV4_TYPE_MASKED = 571,
    OF_OXM_ICMPV6_CODE = 572,
    OF_OXM_ICMPV6_CODE_MASKED = 573,
    OF_OXM_ICMPV6_TYPE = 574,
    OF_OXM_ICMPV6_TYPE_MASKED = 575,
    OF_OXM_IN_PHY_PORT = 576,
    OF_OXM_IN_PHY_PORT_MASKED = 577,
    OF_OXM_IN_PORT = 578,
    OF_OXM_IN_PORT_MASKED = 579,
    OF_OXM_IP_DSCP = 580,
    OF_OXM_IP_DSCP_MASKED = 581,
    OF_OXM_IP_ECN = 582,
    OF_OXM_IP_ECN_MASKED = 583,
    OF_OXM_IP_PROTO = 584,
    OF_OXM_IP_PROTO_MASKED = 585,
    OF_OXM_IPV4_DST = 586,
    OF_OXM_IPV4_DST_MASKED = 587,
    OF_OXM_IPV4_SRC = 588,
    OF_OXM_IPV4_SRC_MASKED = 589,
    OF_OXM_IPV6_DST = 590,
    OF_OXM_IPV6_DST_MASKED = 591,
    OF_OXM_IPV6_EXTHDR = 592,
    OF_OXM_IPV6_EXTHDR_MASKED = 593,
    OF_OXM_IPV6_FLABEL = 594,
    OF_OXM_IPV6_FLABEL_MASKED = 595,
    OF_OXM_IPV6_ND_SLL = 596,
    OF_OXM_IPV6_ND_SLL_MASKED = 597,
    OF_OXM_IPV6_ND_TARGET = 598,
    OF_OXM_IPV6_ND_TARGET_MASKED = 599,
    OF_OXM_IPV6_ND_TLL = 600,
    OF_OXM_IPV6_ND_TLL_MASKED = 601,
    OF_OXM_IPV6_SRC = 602,
    OF_OXM_IPV6_SRC_MASKED = 603,
    OF_OXM_METADATA = 604,
    OF_OXM_METADATA_MASKED = 605,
    OF_OXM_MPLS_BOS = 606,
    OF_OXM_MPLS_BOS_MASKED = 607,
    OF_OXM_MPLS_LABEL = 608,
    OF_OXM_MPLS_LABEL_MASKED = 609,
    OF_OXM_MPLS_TC = 610,
    OF_OXM_MPLS_TC_MASKED = 611,
    OF_OXM_PBB_UCA = 612,
    OF_OXM_PBB_UCA_MASKED = 613,
    OF_OXM_SCTP_DST = 614,
    OF_OXM_SCTP_DST_MASKED = 615,
    OF_OXM_SCTP_SRC = 616,
    OF_OXM_SCTP_SRC_MASKED = 617,
    OF_OXM_TCP_DST = 618,
    OF_OXM_TCP_DST_MASKED = 619,
    OF_OXM_TCP_SRC = 620,
    OF_OXM_TCP_SRC_MASKED = 621,
    OF_OXM_TUNNEL_ID = 622,
    OF_OXM_TUNNEL_ID_MASKED = 623,
    OF_OXM_TUNNEL_IPV4_DST = 624,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 625,
    OF_OXM_TUNNEL_IPV4_SRC = 626,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 627,
    OF_OXM_UDP_DST = 628,
    OF_OXM_UDP_DST_MASKED = 629,
    OF_OXM_UDP_SRC = 630,
    OF_OXM_UDP_SRC_MASKED = 631,
    OF_OXM_VLAN_PCP = 632,
    OF_OXM_VLAN_PCP_MASKED = 633,
    OF_OXM_VLAN_VID = 634,
    OF_OXM_VLAN_VID_MASKED = 635,
    OF_PACKET_QUEUE = 636,
    OF_PORT_DESC = 637,
    OF_PORT_DESC_PROP = 638,
    OF_PORT_DESC_PROP_BSN = 639,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 640,
    OF_PORT_DESC_PROP_BSN_UPLINK = 641,
    OF_PORT_DESC_PROP_ETHERNET = 642,
    OF_PORT_DESC_PROP_EXPERIMENTER = 643,
    OF_PORT_DESC_PROP_OPTICAL = 644,
    OF_PORT_MOD_PROP = 645,
    OF_PORT_MOD_PROP_ETHERNET = 646,
    OF_PORT_MOD_PROP_EXPERIMENTER = 647,
    OF_PORT_MOD_PROP_OPTICAL = 648,
    OF_PORT_STATS_ENTRY = 649,
    OF_PORT_STATS_PROP = 650,
    OF_PORT_STATS_PROP_ETHERNET = 651,
    OF_PORT_STATS_PROP_EXPERIMENTER = 652,
    OF_PORT_STATS_PROP_OPTICAL = 653,
    OF_QUEUE_DESC = 654,
    OF_QUEUE_DESC_PROP = 655,
    OF_QUEUE_DESC_PROP_BSN = 656,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 657,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 658,
    OF_QUEUE_DESC_PROP_MAX_RATE = 659,
    OF_QUEUE_DESC_PROP_MIN_RATE = 660,
    OF_QUEUE_PROP = 661,
    OF_QUEUE_PROP_EXPERIMENTER = 662,
    OF_QUEUE_PROP_MAX_RATE = 663,
    OF_QUEUE_PROP_MIN_RATE = 664,
    OF_QUEUE_STATS_ENTRY = 665,
    OF_QUEUE_STATS_PROP = 666,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 667,
    OF_ROLE_PROP = 668,
    OF_ROLE_PROP_EXPERIMENTER = 669,
    OF_TABLE_DESC = 670,
    OF_TABLE_FEATURE_PROP = 671,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 672,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 673,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 674,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 675,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 676,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 677,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 678,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 679,
    OF_TABLE_FEATURE_PROP_MATCH = 680,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 681,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 682,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 683,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 684,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 685,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 686,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 687,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 688,
    OF_TABLE_FEATURES = 689,
    OF_TABLE_MOD_PROP = 690,
    OF_TABLE_MOD_PROP_EVICTION = 691,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 692,
    OF_TABLE_MOD_PROP_VACANCY = 693,
    OF_TABLE_STATS_ENTRY = 694,
    OF_UINT32 = 695,
    OF_UINT64 = 696,
    OF_UINT8 = 697,
    ...
    /* List objects */
    OF_LIST_ACTION = 698,
    OF_LIST_ACTION_ID = 699,
    OF_LIST_ASYNC_CONFIG_PROP = 700,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 701,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 702,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 703,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 704,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 705,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 706,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 707,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 708,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 709,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 710,
    OF_LIST_BSN_INTERFACE = 711,
    OF_LIST_BSN_LACP_STATS_ENTRY = 712,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 713,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 714,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 715,
    OF_LIST_BSN_TLV = 716,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 717,
    OF_LIST_BSN_VLAN_MAC = 718,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 719,
    OF_LIST_BUCKET = 720,
    OF_LIST_BUCKET_COUNTER = 721,
    OF_LIST_BUNDLE_PROP = 722,
    OF_LIST_FLOW_STATS_ENTRY = 723,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 724,
    OF_LIST_GROUP_STATS_ENTRY = 725,
    OF_LIST_HELLO_ELEM = 726,
    OF_LIST_INSTRUCTION = 727,
    OF_LIST_INSTRUCTION_ID = 728,
    OF_LIST_METER_BAND = 729,
    OF_LIST_METER_BAND_STATS = 730,
    OF_LIST_METER_CONFIG = 731,
    OF_LIST_METER_STATS = 732,
    OF_LIST_OXM = 733,
    OF_LIST_PACKET_QUEUE = 734,
    OF_LIST_PORT_DESC = 735,
    OF_LIST_PORT_DESC_PROP = 736,
    OF_LIST_PORT_MOD_PROP = 737,
    OF_LIST_PORT_STATS_ENTRY = 738,
    OF_LIST_PORT_STATS_PROP = 739,
    OF_LIST_QUEUE_DESC = 740,
    OF_LIST_QUEUE_DESC_PROP = 741,
    OF_LIST_QUEUE_PROP = 742,
    OF_LIST_QUEUE_STATS_ENTRY = 743,
    OF_LIST_QUEUE_STATS_PROP = 744,
    OF_LIST_ROLE_PROP = 745,
    OF_LIST_TABLE_DESC = 746,
    OF_LIST_TABLE_FEATURE_PROP = 747,
    OF_LIST_TABLE_FEATURES = 748,
    OF_LIST_TABLE_MOD_PROP = 749,
    OF_LIST_TABLE_STATS_ENTRY = 750,
    OF_LIST_UINT32 = 751,
    OF_LIST_UINT64 = 752,
    OF_LIST_UINT8 = 753,
