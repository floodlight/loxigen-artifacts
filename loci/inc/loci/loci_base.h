...
typedef enum of_object_id_e {
    ...
    OF_ACTION_BSN_MIRROR = 185,
    OF_ACTION_BSN_SET_TUNNEL_DST = 186,
    OF_ACTION_COPY_TTL_IN = 187,
    OF_ACTION_COPY_TTL_OUT = 188,
    OF_ACTION_DEC_MPLS_TTL = 189,
    OF_ACTION_DEC_NW_TTL = 190,
    OF_ACTION_ENQUEUE = 191,
    OF_ACTION_EXPERIMENTER = 192,
    OF_ACTION_GROUP = 193,
    OF_ACTION_HEADER = 194,
    OF_ACTION_ID = 195,
    OF_ACTION_ID_BSN = 196,
    OF_ACTION_ID_BSN_CHECKSUM = 197,
    OF_ACTION_ID_BSN_MIRROR = 198,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 199,
    OF_ACTION_ID_COPY_TTL_IN = 200,
    OF_ACTION_ID_COPY_TTL_OUT = 201,
    OF_ACTION_ID_DEC_MPLS_TTL = 202,
    OF_ACTION_ID_DEC_NW_TTL = 203,
    OF_ACTION_ID_EXPERIMENTER = 204,
    OF_ACTION_ID_GROUP = 205,
    OF_ACTION_ID_HEADER = 206,
    OF_ACTION_ID_NICIRA = 207,
    OF_ACTION_ID_NICIRA_DEC_TTL = 208,
    OF_ACTION_ID_OUTPUT = 209,
    OF_ACTION_ID_POP_MPLS = 210,
    OF_ACTION_ID_POP_PBB = 211,
    OF_ACTION_ID_POP_VLAN = 212,
    OF_ACTION_ID_PUSH_MPLS = 213,
    OF_ACTION_ID_PUSH_PBB = 214,
    OF_ACTION_ID_PUSH_VLAN = 215,
    OF_ACTION_ID_SET_FIELD = 216,
    OF_ACTION_ID_SET_MPLS_TTL = 217,
    OF_ACTION_ID_SET_NW_TTL = 218,
    OF_ACTION_ID_SET_QUEUE = 219,
    OF_ACTION_NICIRA = 220,
    OF_ACTION_NICIRA_DEC_TTL = 221,
    OF_ACTION_OUTPUT = 222,
    OF_ACTION_POP_MPLS = 223,
    OF_ACTION_POP_PBB = 224,
    OF_ACTION_POP_VLAN = 225,
    OF_ACTION_PUSH_MPLS = 226,
    OF_ACTION_PUSH_PBB = 227,
    OF_ACTION_PUSH_VLAN = 228,
    OF_ACTION_SET_DL_DST = 229,
    OF_ACTION_SET_DL_SRC = 230,
    OF_ACTION_SET_FIELD = 231,
    OF_ACTION_SET_MPLS_LABEL = 232,
    OF_ACTION_SET_MPLS_TC = 233,
    OF_ACTION_SET_MPLS_TTL = 234,
    OF_ACTION_SET_NW_DST = 235,
    OF_ACTION_SET_NW_ECN = 236,
    OF_ACTION_SET_NW_SRC = 237,
    OF_ACTION_SET_NW_TOS = 238,
    OF_ACTION_SET_NW_TTL = 239,
    OF_ACTION_SET_QUEUE = 240,
    OF_ACTION_SET_TP_DST = 241,
    OF_ACTION_SET_TP_SRC = 242,
    OF_ACTION_SET_VLAN_PCP = 243,
    OF_ACTION_SET_VLAN_VID = 244,
    OF_ACTION_STRIP_VLAN = 245,
    OF_BSN_CONTROLLER_CONNECTION = 246,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 247,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 248,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 249,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 250,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 251,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 252,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 253,
    OF_BSN_GENTABLE_STATS_ENTRY = 254,
    OF_BSN_INTERFACE = 255,
    OF_BSN_LACP_STATS_ENTRY = 256,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 257,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 258,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 259,
    OF_BSN_TLV = 260,
    OF_BSN_TLV_ACTOR_KEY = 261,
    OF_BSN_TLV_ACTOR_PORT_NUM = 262,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 263,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 264,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 265,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 266,
    OF_BSN_TLV_CIRCUIT_ID = 267,
    OF_BSN_TLV_CONVERGENCE_STATUS = 268,
    OF_BSN_TLV_CRC_ENABLED = 269,
    OF_BSN_TLV_ETH_DST = 270,
    OF_BSN_TLV_ETH_SRC = 271,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 272,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 273,
    OF_BSN_TLV_EXTERNAL_IP = 274,
    OF_BSN_TLV_EXTERNAL_MAC = 275,
    OF_BSN_TLV_EXTERNAL_NETMASK = 276,
    OF_BSN_TLV_HEADER = 277,
    OF_BSN_TLV_HEADER_SIZE = 278,
    OF_BSN_TLV_IDLE_NOTIFICATION = 279,
    OF_BSN_TLV_IDLE_TIME = 280,
    OF_BSN_TLV_IDLE_TIMEOUT = 281,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 282,
    OF_BSN_TLV_INTERNAL_MAC = 283,
    OF_BSN_TLV_IPV4 = 284,
    OF_BSN_TLV_IPV4_DST = 285,
    OF_BSN_TLV_IPV4_SRC = 286,
    OF_BSN_TLV_MAC = 287,
    OF_BSN_TLV_MISS_PACKETS = 288,
    OF_BSN_TLV_NAME = 289,
    OF_BSN_TLV_PARTNER_KEY = 290,
    OF_BSN_TLV_PARTNER_PORT_NUM = 291,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 292,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 293,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 294,
    OF_BSN_TLV_PORT = 295,
    OF_BSN_TLV_QUEUE_ID = 296,
    OF_BSN_TLV_QUEUE_WEIGHT = 297,
    OF_BSN_TLV_REPLY_PACKETS = 298,
    OF_BSN_TLV_REQUEST_PACKETS = 299,
    OF_BSN_TLV_RX_PACKETS = 300,
    OF_BSN_TLV_SAMPLING_RATE = 301,
    OF_BSN_TLV_SUB_AGENT_ID = 302,
    OF_BSN_TLV_TX_BYTES = 303,
    OF_BSN_TLV_TX_PACKETS = 304,
    OF_BSN_TLV_UDF_ANCHOR = 305,
    OF_BSN_TLV_UDF_ID = 306,
    OF_BSN_TLV_UDF_LENGTH = 307,
    OF_BSN_TLV_UDF_OFFSET = 308,
    OF_BSN_TLV_UDP_DST = 309,
    OF_BSN_TLV_UDP_SRC = 310,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 311,
    OF_BSN_TLV_VLAN_VID = 312,
    OF_BSN_TLV_VRF = 313,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 314,
    OF_BSN_VPORT = 315,
    OF_BSN_VPORT_HEADER = 316,
    OF_BSN_VPORT_L2GRE = 317,
    OF_BSN_VPORT_Q_IN_Q = 318,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 319,
    OF_BUCKET = 320,
    OF_BUCKET_COUNTER = 321,
    OF_FLOW_STATS_ENTRY = 322,
    OF_GROUP_DESC_STATS_ENTRY = 323,
    OF_GROUP_STATS_ENTRY = 324,
    OF_HELLO_ELEM = 325,
    OF_HELLO_ELEM_HEADER = 326,
    OF_HELLO_ELEM_VERSIONBITMAP = 327,
    OF_INSTRUCTION = 328,
    OF_INSTRUCTION_APPLY_ACTIONS = 329,
    OF_INSTRUCTION_BSN = 330,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 331,
    OF_INSTRUCTION_BSN_DENY = 332,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 333,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 334,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 335,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 336,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 337,
    OF_INSTRUCTION_BSN_PERMIT = 338,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 339,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 340,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 341,
    OF_INSTRUCTION_CLEAR_ACTIONS = 342,
    OF_INSTRUCTION_EXPERIMENTER = 343,
    OF_INSTRUCTION_GOTO_TABLE = 344,
    OF_INSTRUCTION_HEADER = 345,
    OF_INSTRUCTION_ID = 346,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 347,
    OF_INSTRUCTION_ID_BSN = 348,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 349,
    OF_INSTRUCTION_ID_BSN_DENY = 350,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 351,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 352,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 353,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 354,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 355,
    OF_INSTRUCTION_ID_BSN_PERMIT = 356,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 357,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 358,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 359,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 360,
    OF_INSTRUCTION_ID_EXPERIMENTER = 361,
    OF_INSTRUCTION_ID_GOTO_TABLE = 362,
    OF_INSTRUCTION_ID_HEADER = 363,
    OF_INSTRUCTION_ID_METER = 364,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 365,
    OF_INSTRUCTION_ID_WRITE_METADATA = 366,
    OF_INSTRUCTION_METER = 367,
    OF_INSTRUCTION_WRITE_ACTIONS = 368,
    OF_INSTRUCTION_WRITE_METADATA = 369,
    OF_MATCH_V1 = 370,
    OF_MATCH_V2 = 371,
    OF_MATCH_V3 = 372,
    OF_METER_BAND = 373,
    OF_METER_BAND_DROP = 374,
    OF_METER_BAND_DSCP_REMARK = 375,
    OF_METER_BAND_EXPERIMENTER = 376,
    OF_METER_BAND_HEADER = 377,
    OF_METER_BAND_STATS = 378,
    OF_METER_CONFIG = 379,
    OF_METER_FEATURES = 380,
    OF_METER_STATS = 381,
    OF_OXM = 382,
    OF_OXM_ARP_OP = 383,
    OF_OXM_ARP_OP_MASKED = 384,
    OF_OXM_ARP_SHA = 385,
    OF_OXM_ARP_SHA_MASKED = 386,
    OF_OXM_ARP_SPA = 387,
    OF_OXM_ARP_SPA_MASKED = 388,
    OF_OXM_ARP_THA = 389,
    OF_OXM_ARP_THA_MASKED = 390,
    OF_OXM_ARP_TPA = 391,
    OF_OXM_ARP_TPA_MASKED = 392,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 393,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 394,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 395,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 396,
    OF_OXM_BSN_IN_PORTS_128 = 397,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 398,
    OF_OXM_BSN_L3_DST_CLASS_ID = 399,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 400,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 401,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 402,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 403,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 404,
    OF_OXM_BSN_LAG_ID = 405,
    OF_OXM_BSN_LAG_ID_MASKED = 406,
    OF_OXM_BSN_TCP_FLAGS = 407,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 408,
    OF_OXM_BSN_UDF0 = 409,
    OF_OXM_BSN_UDF0_MASKED = 410,
    OF_OXM_BSN_UDF1 = 411,
    OF_OXM_BSN_UDF1_MASKED = 412,
    OF_OXM_BSN_UDF2 = 413,
    OF_OXM_BSN_UDF2_MASKED = 414,
    OF_OXM_BSN_UDF3 = 415,
    OF_OXM_BSN_UDF3_MASKED = 416,
    OF_OXM_BSN_UDF4 = 417,
    OF_OXM_BSN_UDF4_MASKED = 418,
    OF_OXM_BSN_UDF5 = 419,
    OF_OXM_BSN_UDF5_MASKED = 420,
    OF_OXM_BSN_UDF6 = 421,
    OF_OXM_BSN_UDF6_MASKED = 422,
    OF_OXM_BSN_UDF7 = 423,
    OF_OXM_BSN_UDF7_MASKED = 424,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 425,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 426,
    OF_OXM_BSN_VRF = 427,
    OF_OXM_BSN_VRF_MASKED = 428,
    OF_OXM_ETH_DST = 429,
    OF_OXM_ETH_DST_MASKED = 430,
    OF_OXM_ETH_SRC = 431,
    OF_OXM_ETH_SRC_MASKED = 432,
    OF_OXM_ETH_TYPE = 433,
    OF_OXM_ETH_TYPE_MASKED = 434,
    OF_OXM_HEADER = 435,
    OF_OXM_ICMPV4_CODE = 436,
    OF_OXM_ICMPV4_CODE_MASKED = 437,
    OF_OXM_ICMPV4_TYPE = 438,
    OF_OXM_ICMPV4_TYPE_MASKED = 439,
    OF_OXM_ICMPV6_CODE = 440,
    OF_OXM_ICMPV6_CODE_MASKED = 441,
    OF_OXM_ICMPV6_TYPE = 442,
    OF_OXM_ICMPV6_TYPE_MASKED = 443,
    OF_OXM_IN_PHY_PORT = 444,
    OF_OXM_IN_PHY_PORT_MASKED = 445,
    OF_OXM_IN_PORT = 446,
    OF_OXM_IN_PORT_MASKED = 447,
    OF_OXM_IP_DSCP = 448,
    OF_OXM_IP_DSCP_MASKED = 449,
    OF_OXM_IP_ECN = 450,
    OF_OXM_IP_ECN_MASKED = 451,
    OF_OXM_IP_PROTO = 452,
    OF_OXM_IP_PROTO_MASKED = 453,
    OF_OXM_IPV4_DST = 454,
    OF_OXM_IPV4_DST_MASKED = 455,
    OF_OXM_IPV4_SRC = 456,
    OF_OXM_IPV4_SRC_MASKED = 457,
    OF_OXM_IPV6_DST = 458,
    OF_OXM_IPV6_DST_MASKED = 459,
    OF_OXM_IPV6_FLABEL = 460,
    OF_OXM_IPV6_FLABEL_MASKED = 461,
    OF_OXM_IPV6_ND_SLL = 462,
    OF_OXM_IPV6_ND_SLL_MASKED = 463,
    OF_OXM_IPV6_ND_TARGET = 464,
    OF_OXM_IPV6_ND_TARGET_MASKED = 465,
    OF_OXM_IPV6_ND_TLL = 466,
    OF_OXM_IPV6_ND_TLL_MASKED = 467,
    OF_OXM_IPV6_SRC = 468,
    OF_OXM_IPV6_SRC_MASKED = 469,
    OF_OXM_METADATA = 470,
    OF_OXM_METADATA_MASKED = 471,
    OF_OXM_MPLS_BOS = 472,
    OF_OXM_MPLS_BOS_MASKED = 473,
    OF_OXM_MPLS_LABEL = 474,
    OF_OXM_MPLS_LABEL_MASKED = 475,
    OF_OXM_MPLS_TC = 476,
    OF_OXM_MPLS_TC_MASKED = 477,
    OF_OXM_SCTP_DST = 478,
    OF_OXM_SCTP_DST_MASKED = 479,
    OF_OXM_SCTP_SRC = 480,
    OF_OXM_SCTP_SRC_MASKED = 481,
    OF_OXM_TCP_DST = 482,
    OF_OXM_TCP_DST_MASKED = 483,
    OF_OXM_TCP_SRC = 484,
    OF_OXM_TCP_SRC_MASKED = 485,
    OF_OXM_TUNNEL_ID = 486,
    OF_OXM_TUNNEL_ID_MASKED = 487,
    OF_OXM_UDP_DST = 488,
    OF_OXM_UDP_DST_MASKED = 489,
    OF_OXM_UDP_SRC = 490,
    OF_OXM_UDP_SRC_MASKED = 491,
    OF_OXM_VLAN_PCP = 492,
    OF_OXM_VLAN_PCP_MASKED = 493,
    OF_OXM_VLAN_VID = 494,
    OF_OXM_VLAN_VID_MASKED = 495,
    OF_PACKET_QUEUE = 496,
    OF_PORT_DESC = 497,
    OF_PORT_STATS_ENTRY = 498,
    OF_QUEUE_PROP = 499,
    OF_QUEUE_PROP_EXPERIMENTER = 500,
    OF_QUEUE_PROP_HEADER = 501,
    OF_QUEUE_PROP_MAX_RATE = 502,
    OF_QUEUE_PROP_MIN_RATE = 503,
    OF_QUEUE_STATS_ENTRY = 504,
    OF_TABLE_FEATURE_PROP = 505,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 506,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 507,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 508,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 509,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 510,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 511,
    OF_TABLE_FEATURE_PROP_HEADER = 512,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 513,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 514,
    OF_TABLE_FEATURE_PROP_MATCH = 515,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 516,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 517,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 518,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 519,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 520,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 521,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 522,
    OF_TABLE_FEATURES = 523,
    OF_TABLE_STATS_ENTRY = 524,
    OF_UINT32 = 525,
    OF_UINT64 = 526,
    OF_UINT8 = 527,
    ...
    /* List objects */
    OF_LIST_ACTION = 528,
    OF_LIST_ACTION_ID = 529,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 530,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 531,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 532,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 533,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 534,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 535,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 536,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 537,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 538,
    OF_LIST_BSN_INTERFACE = 539,
    OF_LIST_BSN_LACP_STATS_ENTRY = 540,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 541,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 542,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 543,
    OF_LIST_BSN_TLV = 544,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 545,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 546,
    OF_LIST_BUCKET = 547,
    OF_LIST_BUCKET_COUNTER = 548,
    OF_LIST_FLOW_STATS_ENTRY = 549,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 550,
    OF_LIST_GROUP_STATS_ENTRY = 551,
    OF_LIST_HELLO_ELEM = 552,
    OF_LIST_INSTRUCTION = 553,
    OF_LIST_INSTRUCTION_ID = 554,
    OF_LIST_METER_BAND = 555,
    OF_LIST_METER_BAND_STATS = 556,
    OF_LIST_METER_STATS = 557,
    OF_LIST_OXM = 558,
    OF_LIST_PACKET_QUEUE = 559,
    OF_LIST_PORT_DESC = 560,
    OF_LIST_PORT_STATS_ENTRY = 561,
    OF_LIST_QUEUE_PROP = 562,
    OF_LIST_QUEUE_STATS_ENTRY = 563,
    OF_LIST_TABLE_FEATURE_PROP = 564,
    OF_LIST_TABLE_FEATURES = 565,
    OF_LIST_TABLE_STATS_ENTRY = 566,
    OF_LIST_UINT32 = 567,
    OF_LIST_UINT64 = 568,
    OF_LIST_UINT8 = 569,
