...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_DENY = 334,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 335,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 336,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 337,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 338,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 339,
    OF_INSTRUCTION_BSN_PERMIT = 340,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 341,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 342,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 343,
    OF_INSTRUCTION_CLEAR_ACTIONS = 344,
    OF_INSTRUCTION_EXPERIMENTER = 345,
    OF_INSTRUCTION_GOTO_TABLE = 346,
    OF_INSTRUCTION_HEADER = 347,
    OF_INSTRUCTION_ID = 348,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 349,
    OF_INSTRUCTION_ID_BSN = 350,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 351,
    OF_INSTRUCTION_ID_BSN_DENY = 352,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 353,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 354,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 355,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 356,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 357,
    OF_INSTRUCTION_ID_BSN_PERMIT = 358,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 359,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 360,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 361,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 362,
    OF_INSTRUCTION_ID_EXPERIMENTER = 363,
    OF_INSTRUCTION_ID_GOTO_TABLE = 364,
    OF_INSTRUCTION_ID_HEADER = 365,
    OF_INSTRUCTION_ID_METER = 366,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 367,
    OF_INSTRUCTION_ID_WRITE_METADATA = 368,
    OF_INSTRUCTION_METER = 369,
    OF_INSTRUCTION_WRITE_ACTIONS = 370,
    OF_INSTRUCTION_WRITE_METADATA = 371,
    OF_MATCH_V1 = 372,
    OF_MATCH_V2 = 373,
    OF_MATCH_V3 = 374,
    OF_METER_BAND = 375,
    OF_METER_BAND_DROP = 376,
    OF_METER_BAND_DSCP_REMARK = 377,
    OF_METER_BAND_EXPERIMENTER = 378,
    OF_METER_BAND_HEADER = 379,
    OF_METER_BAND_STATS = 380,
    OF_METER_CONFIG = 381,
    OF_METER_FEATURES = 382,
    OF_METER_STATS = 383,
    OF_OXM = 384,
    OF_OXM_ARP_OP = 385,
    OF_OXM_ARP_OP_MASKED = 386,
    OF_OXM_ARP_SHA = 387,
    OF_OXM_ARP_SHA_MASKED = 388,
    OF_OXM_ARP_SPA = 389,
    OF_OXM_ARP_SPA_MASKED = 390,
    OF_OXM_ARP_THA = 391,
    OF_OXM_ARP_THA_MASKED = 392,
    OF_OXM_ARP_TPA = 393,
    OF_OXM_ARP_TPA_MASKED = 394,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 395,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 396,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 397,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 398,
    OF_OXM_BSN_IN_PORTS_128 = 399,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 400,
    OF_OXM_BSN_L3_DST_CLASS_ID = 401,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 402,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 403,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 404,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 405,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 406,
    OF_OXM_BSN_LAG_ID = 407,
    OF_OXM_BSN_LAG_ID_MASKED = 408,
    OF_OXM_BSN_TCP_FLAGS = 409,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 410,
    OF_OXM_BSN_UDF0 = 411,
    OF_OXM_BSN_UDF0_MASKED = 412,
    OF_OXM_BSN_UDF1 = 413,
    OF_OXM_BSN_UDF1_MASKED = 414,
    OF_OXM_BSN_UDF2 = 415,
    OF_OXM_BSN_UDF2_MASKED = 416,
    OF_OXM_BSN_UDF3 = 417,
    OF_OXM_BSN_UDF3_MASKED = 418,
    OF_OXM_BSN_UDF4 = 419,
    OF_OXM_BSN_UDF4_MASKED = 420,
    OF_OXM_BSN_UDF5 = 421,
    OF_OXM_BSN_UDF5_MASKED = 422,
    OF_OXM_BSN_UDF6 = 423,
    OF_OXM_BSN_UDF6_MASKED = 424,
    OF_OXM_BSN_UDF7 = 425,
    OF_OXM_BSN_UDF7_MASKED = 426,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 427,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 428,
    OF_OXM_BSN_VRF = 429,
    OF_OXM_BSN_VRF_MASKED = 430,
    OF_OXM_ETH_DST = 431,
    OF_OXM_ETH_DST_MASKED = 432,
    OF_OXM_ETH_SRC = 433,
    OF_OXM_ETH_SRC_MASKED = 434,
    OF_OXM_ETH_TYPE = 435,
    OF_OXM_ETH_TYPE_MASKED = 436,
    OF_OXM_HEADER = 437,
    OF_OXM_ICMPV4_CODE = 438,
    OF_OXM_ICMPV4_CODE_MASKED = 439,
    OF_OXM_ICMPV4_TYPE = 440,
    OF_OXM_ICMPV4_TYPE_MASKED = 441,
    OF_OXM_ICMPV6_CODE = 442,
    OF_OXM_ICMPV6_CODE_MASKED = 443,
    OF_OXM_ICMPV6_TYPE = 444,
    OF_OXM_ICMPV6_TYPE_MASKED = 445,
    OF_OXM_IN_PHY_PORT = 446,
    OF_OXM_IN_PHY_PORT_MASKED = 447,
    OF_OXM_IN_PORT = 448,
    OF_OXM_IN_PORT_MASKED = 449,
    OF_OXM_IP_DSCP = 450,
    OF_OXM_IP_DSCP_MASKED = 451,
    OF_OXM_IP_ECN = 452,
    OF_OXM_IP_ECN_MASKED = 453,
    OF_OXM_IP_PROTO = 454,
    OF_OXM_IP_PROTO_MASKED = 455,
    OF_OXM_IPV4_DST = 456,
    OF_OXM_IPV4_DST_MASKED = 457,
    OF_OXM_IPV4_SRC = 458,
    OF_OXM_IPV4_SRC_MASKED = 459,
    OF_OXM_IPV6_DST = 460,
    OF_OXM_IPV6_DST_MASKED = 461,
    OF_OXM_IPV6_FLABEL = 462,
    OF_OXM_IPV6_FLABEL_MASKED = 463,
    OF_OXM_IPV6_ND_SLL = 464,
    OF_OXM_IPV6_ND_SLL_MASKED = 465,
    OF_OXM_IPV6_ND_TARGET = 466,
    OF_OXM_IPV6_ND_TARGET_MASKED = 467,
    OF_OXM_IPV6_ND_TLL = 468,
    OF_OXM_IPV6_ND_TLL_MASKED = 469,
    OF_OXM_IPV6_SRC = 470,
    OF_OXM_IPV6_SRC_MASKED = 471,
    OF_OXM_METADATA = 472,
    OF_OXM_METADATA_MASKED = 473,
    OF_OXM_MPLS_BOS = 474,
    OF_OXM_MPLS_BOS_MASKED = 475,
    OF_OXM_MPLS_LABEL = 476,
    OF_OXM_MPLS_LABEL_MASKED = 477,
    OF_OXM_MPLS_TC = 478,
    OF_OXM_MPLS_TC_MASKED = 479,
    OF_OXM_SCTP_DST = 480,
    OF_OXM_SCTP_DST_MASKED = 481,
    OF_OXM_SCTP_SRC = 482,
    OF_OXM_SCTP_SRC_MASKED = 483,
    OF_OXM_TCP_DST = 484,
    OF_OXM_TCP_DST_MASKED = 485,
    OF_OXM_TCP_SRC = 486,
    OF_OXM_TCP_SRC_MASKED = 487,
    OF_OXM_TUNNEL_ID = 488,
    OF_OXM_TUNNEL_ID_MASKED = 489,
    OF_OXM_UDP_DST = 490,
    OF_OXM_UDP_DST_MASKED = 491,
    OF_OXM_UDP_SRC = 492,
    OF_OXM_UDP_SRC_MASKED = 493,
    OF_OXM_VLAN_PCP = 494,
    OF_OXM_VLAN_PCP_MASKED = 495,
    OF_OXM_VLAN_VID = 496,
    OF_OXM_VLAN_VID_MASKED = 497,
    OF_PACKET_QUEUE = 498,
    OF_PORT_DESC = 499,
    OF_PORT_STATS_ENTRY = 500,
    OF_QUEUE_PROP = 501,
    OF_QUEUE_PROP_EXPERIMENTER = 502,
    OF_QUEUE_PROP_HEADER = 503,
    OF_QUEUE_PROP_MAX_RATE = 504,
    OF_QUEUE_PROP_MIN_RATE = 505,
    OF_QUEUE_STATS_ENTRY = 506,
    OF_TABLE_FEATURE_PROP = 507,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 508,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 509,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 510,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 511,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 512,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 513,
    OF_TABLE_FEATURE_PROP_HEADER = 514,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 515,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 516,
    OF_TABLE_FEATURE_PROP_MATCH = 517,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 518,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 519,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 520,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 521,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 522,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 523,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 524,
    OF_TABLE_FEATURES = 525,
    OF_TABLE_STATS_ENTRY = 526,
    OF_UINT32 = 527,
    OF_UINT64 = 528,
    OF_UINT8 = 529,
    ...
    /* List objects */
    OF_LIST_ACTION = 530,
    OF_LIST_ACTION_ID = 531,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 532,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 533,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 534,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 535,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 536,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 537,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 538,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 539,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 540,
    OF_LIST_BSN_INTERFACE = 541,
    OF_LIST_BSN_LACP_STATS_ENTRY = 542,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 543,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 544,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 545,
    OF_LIST_BSN_TLV = 546,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 547,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 548,
    OF_LIST_BUCKET = 549,
    OF_LIST_BUCKET_COUNTER = 550,
    OF_LIST_FLOW_STATS_ENTRY = 551,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 552,
    OF_LIST_GROUP_STATS_ENTRY = 553,
    OF_LIST_HELLO_ELEM = 554,
    OF_LIST_INSTRUCTION = 555,
    OF_LIST_INSTRUCTION_ID = 556,
    OF_LIST_METER_BAND = 557,
    OF_LIST_METER_BAND_STATS = 558,
    OF_LIST_METER_STATS = 559,
    OF_LIST_OXM = 560,
    OF_LIST_PACKET_QUEUE = 561,
    OF_LIST_PORT_DESC = 562,
    OF_LIST_PORT_STATS_ENTRY = 563,
    OF_LIST_QUEUE_PROP = 564,
    OF_LIST_QUEUE_STATS_ENTRY = 565,
    OF_LIST_TABLE_FEATURE_PROP = 566,
    OF_LIST_TABLE_FEATURES = 567,
    OF_LIST_TABLE_STATS_ENTRY = 568,
    OF_LIST_UINT32 = 569,
    OF_LIST_UINT64 = 570,
    OF_LIST_UINT8 = 571,
