...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 412,
    OF_BSN_TLV_QOS_PRIORITY = 413,
    OF_BSN_TLV_QUEUE_ID = 414,
    OF_BSN_TLV_QUEUE_WEIGHT = 415,
    OF_BSN_TLV_RATE_LIMIT = 416,
    OF_BSN_TLV_RATE_UNIT = 417,
    OF_BSN_TLV_RECORD_PACKETS = 418,
    OF_BSN_TLV_REFERENCE = 419,
    OF_BSN_TLV_REPLY_PACKETS = 420,
    OF_BSN_TLV_REQUEST_PACKETS = 421,
    OF_BSN_TLV_REST_SERVER = 422,
    OF_BSN_TLV_ROUTING_PARAM = 423,
    OF_BSN_TLV_RX_BYTES = 424,
    OF_BSN_TLV_RX_PACKETS = 425,
    OF_BSN_TLV_SAMPLING_RATE = 426,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 427,
    OF_BSN_TLV_STATUS = 428,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 429,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 430,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 431,
    OF_BSN_TLV_SUB_AGENT_ID = 432,
    OF_BSN_TLV_TCP_DST = 433,
    OF_BSN_TLV_TCP_FLAGS = 434,
    OF_BSN_TLV_TCP_SRC = 435,
    OF_BSN_TLV_TIMESTAMP = 436,
    OF_BSN_TLV_TTL = 437,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 438,
    OF_BSN_TLV_TX_BYTES = 439,
    OF_BSN_TLV_TX_PACKETS = 440,
    OF_BSN_TLV_UDF_ANCHOR = 441,
    OF_BSN_TLV_UDF_ID = 442,
    OF_BSN_TLV_UDF_LENGTH = 443,
    OF_BSN_TLV_UDF_OFFSET = 444,
    OF_BSN_TLV_UDP_DST = 445,
    OF_BSN_TLV_UDP_SRC = 446,
    OF_BSN_TLV_UINT64_LIST = 447,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 448,
    OF_BSN_TLV_UNICAST_RATE = 449,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 450,
    OF_BSN_TLV_UNTAGGED = 451,
    OF_BSN_TLV_URI_SCHEME = 452,
    OF_BSN_TLV_USE_PACKET_STATE = 453,
    OF_BSN_TLV_VFI = 454,
    OF_BSN_TLV_VFP_CLASS_ID = 455,
    OF_BSN_TLV_VIRTUAL = 456,
    OF_BSN_TLV_VLAN_MAC_LIST = 457,
    OF_BSN_TLV_VLAN_PCP = 458,
    OF_BSN_TLV_VLAN_VID = 459,
    OF_BSN_TLV_VLAN_VID_MASK = 460,
    OF_BSN_TLV_VNI = 461,
    OF_BSN_TLV_VPN_KEY = 462,
    OF_BSN_TLV_VRF = 463,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 464,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 465,
    OF_BSN_VLAN_MAC = 466,
    OF_BSN_VPORT = 467,
    OF_BSN_VPORT_L2GRE = 468,
    OF_BSN_VPORT_Q_IN_Q = 469,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 470,
    OF_BUCKET = 471,
    OF_BUCKET_COUNTER = 472,
    OF_BUNDLE_PROP = 473,
    OF_BUNDLE_PROP_EXPERIMENTER = 474,
    OF_FLOW_STATS_ENTRY = 475,
    OF_GROUP_DESC_STATS_ENTRY = 476,
    OF_GROUP_STATS_ENTRY = 477,
    OF_HELLO_ELEM = 478,
    OF_HELLO_ELEM_VERSIONBITMAP = 479,
    OF_INSTRUCTION = 480,
    OF_INSTRUCTION_APPLY_ACTIONS = 481,
    OF_INSTRUCTION_BSN = 482,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 483,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 484,
    OF_INSTRUCTION_BSN_DENY = 485,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 486,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 487,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 488,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 489,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 490,
    OF_INSTRUCTION_BSN_HASH_SELECT = 491,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 492,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 493,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 494,
    OF_INSTRUCTION_BSN_PERMIT = 495,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 496,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 497,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 498,
    OF_INSTRUCTION_CLEAR_ACTIONS = 499,
    OF_INSTRUCTION_EXPERIMENTER = 500,
    OF_INSTRUCTION_GOTO_TABLE = 501,
    OF_INSTRUCTION_ID = 502,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 503,
    OF_INSTRUCTION_ID_BSN = 504,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 505,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 506,
    OF_INSTRUCTION_ID_BSN_DENY = 507,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 508,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 509,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 510,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 511,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 512,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 513,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 514,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 515,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 516,
    OF_INSTRUCTION_ID_BSN_PERMIT = 517,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 518,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 519,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 520,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 521,
    OF_INSTRUCTION_ID_EXPERIMENTER = 522,
    OF_INSTRUCTION_ID_GOTO_TABLE = 523,
    OF_INSTRUCTION_ID_METER = 524,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 525,
    OF_INSTRUCTION_ID_WRITE_METADATA = 526,
    OF_INSTRUCTION_METER = 527,
    OF_INSTRUCTION_WRITE_ACTIONS = 528,
    OF_INSTRUCTION_WRITE_METADATA = 529,
    OF_MATCH_V1 = 530,
    OF_MATCH_V2 = 531,
    OF_MATCH_V3 = 532,
    OF_METER_BAND = 533,
    OF_METER_BAND_DROP = 534,
    OF_METER_BAND_DSCP_REMARK = 535,
    OF_METER_BAND_EXPERIMENTER = 536,
    OF_METER_BAND_STATS = 537,
    OF_METER_CONFIG = 538,
    OF_METER_FEATURES = 539,
    OF_METER_STATS = 540,
    OF_OXM = 541,
    OF_OXM_ARP_OP = 542,
    OF_OXM_ARP_OP_MASKED = 543,
    OF_OXM_ARP_SHA = 544,
    OF_OXM_ARP_SHA_MASKED = 545,
    OF_OXM_ARP_SPA = 546,
    OF_OXM_ARP_SPA_MASKED = 547,
    OF_OXM_ARP_THA = 548,
    OF_OXM_ARP_THA_MASKED = 549,
    OF_OXM_ARP_TPA = 550,
    OF_OXM_ARP_TPA_MASKED = 551,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 552,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 553,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 554,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 555,
    OF_OXM_BSN_IFP_CLASS_ID = 556,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 557,
    OF_OXM_BSN_IN_PORTS_128 = 558,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 559,
    OF_OXM_BSN_IN_PORTS_512 = 560,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 561,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 562,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 563,
    OF_OXM_BSN_INNER_ETH_DST = 564,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 565,
    OF_OXM_BSN_INNER_ETH_SRC = 566,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 567,
    OF_OXM_BSN_INNER_VLAN_VID = 568,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 569,
    OF_OXM_BSN_IP_FRAGMENTATION = 570,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 571,
    OF_OXM_BSN_L2_CACHE_HIT = 572,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 573,
    OF_OXM_BSN_L3_DST_CLASS_ID = 574,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 575,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 576,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 577,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 578,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 579,
    OF_OXM_BSN_LAG_ID = 580,
    OF_OXM_BSN_LAG_ID_MASKED = 581,
    OF_OXM_BSN_TCP_FLAGS = 582,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 583,
    OF_OXM_BSN_UDF0 = 584,
    OF_OXM_BSN_UDF0_MASKED = 585,
    OF_OXM_BSN_UDF1 = 586,
    OF_OXM_BSN_UDF1_MASKED = 587,
    OF_OXM_BSN_UDF2 = 588,
    OF_OXM_BSN_UDF2_MASKED = 589,
    OF_OXM_BSN_UDF3 = 590,
    OF_OXM_BSN_UDF3_MASKED = 591,
    OF_OXM_BSN_UDF4 = 592,
    OF_OXM_BSN_UDF4_MASKED = 593,
    OF_OXM_BSN_UDF5 = 594,
    OF_OXM_BSN_UDF5_MASKED = 595,
    OF_OXM_BSN_UDF6 = 596,
    OF_OXM_BSN_UDF6_MASKED = 597,
    OF_OXM_BSN_UDF7 = 598,
    OF_OXM_BSN_UDF7_MASKED = 599,
    OF_OXM_BSN_VFI = 600,
    OF_OXM_BSN_VFI_MASKED = 601,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 602,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 603,
    OF_OXM_BSN_VRF = 604,
    OF_OXM_BSN_VRF_MASKED = 605,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 606,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 607,
    OF_OXM_ETH_DST = 608,
    OF_OXM_ETH_DST_MASKED = 609,
    OF_OXM_ETH_SRC = 610,
    OF_OXM_ETH_SRC_MASKED = 611,
    OF_OXM_ETH_TYPE = 612,
    OF_OXM_ETH_TYPE_MASKED = 613,
    OF_OXM_ICMPV4_CODE = 614,
    OF_OXM_ICMPV4_CODE_MASKED = 615,
    OF_OXM_ICMPV4_TYPE = 616,
    OF_OXM_ICMPV4_TYPE_MASKED = 617,
    OF_OXM_ICMPV6_CODE = 618,
    OF_OXM_ICMPV6_CODE_MASKED = 619,
    OF_OXM_ICMPV6_TYPE = 620,
    OF_OXM_ICMPV6_TYPE_MASKED = 621,
    OF_OXM_IN_PHY_PORT = 622,
    OF_OXM_IN_PHY_PORT_MASKED = 623,
    OF_OXM_IN_PORT = 624,
    OF_OXM_IN_PORT_MASKED = 625,
    OF_OXM_IP_DSCP = 626,
    OF_OXM_IP_DSCP_MASKED = 627,
    OF_OXM_IP_ECN = 628,
    OF_OXM_IP_ECN_MASKED = 629,
    OF_OXM_IP_PROTO = 630,
    OF_OXM_IP_PROTO_MASKED = 631,
    OF_OXM_IPV4_DST = 632,
    OF_OXM_IPV4_DST_MASKED = 633,
    OF_OXM_IPV4_SRC = 634,
    OF_OXM_IPV4_SRC_MASKED = 635,
    OF_OXM_IPV6_DST = 636,
    OF_OXM_IPV6_DST_MASKED = 637,
    OF_OXM_IPV6_EXTHDR = 638,
    OF_OXM_IPV6_EXTHDR_MASKED = 639,
    OF_OXM_IPV6_FLABEL = 640,
    OF_OXM_IPV6_FLABEL_MASKED = 641,
    OF_OXM_IPV6_ND_SLL = 642,
    OF_OXM_IPV6_ND_SLL_MASKED = 643,
    OF_OXM_IPV6_ND_TARGET = 644,
    OF_OXM_IPV6_ND_TARGET_MASKED = 645,
    OF_OXM_IPV6_ND_TLL = 646,
    OF_OXM_IPV6_ND_TLL_MASKED = 647,
    OF_OXM_IPV6_SRC = 648,
    OF_OXM_IPV6_SRC_MASKED = 649,
    OF_OXM_METADATA = 650,
    OF_OXM_METADATA_MASKED = 651,
    OF_OXM_MPLS_BOS = 652,
    OF_OXM_MPLS_BOS_MASKED = 653,
    OF_OXM_MPLS_LABEL = 654,
    OF_OXM_MPLS_LABEL_MASKED = 655,
    OF_OXM_MPLS_TC = 656,
    OF_OXM_MPLS_TC_MASKED = 657,
    OF_OXM_OVS_TCP_FLAGS = 658,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 659,
    OF_OXM_PBB_UCA = 660,
    OF_OXM_PBB_UCA_MASKED = 661,
    OF_OXM_SCTP_DST = 662,
    OF_OXM_SCTP_DST_MASKED = 663,
    OF_OXM_SCTP_SRC = 664,
    OF_OXM_SCTP_SRC_MASKED = 665,
    OF_OXM_TCP_DST = 666,
    OF_OXM_TCP_DST_MASKED = 667,
    OF_OXM_TCP_SRC = 668,
    OF_OXM_TCP_SRC_MASKED = 669,
    OF_OXM_TUNNEL_ID = 670,
    OF_OXM_TUNNEL_ID_MASKED = 671,
    OF_OXM_TUNNEL_IPV4_DST = 672,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 673,
    OF_OXM_TUNNEL_IPV4_SRC = 674,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 675,
    OF_OXM_UDP_DST = 676,
    OF_OXM_UDP_DST_MASKED = 677,
    OF_OXM_UDP_SRC = 678,
    OF_OXM_UDP_SRC_MASKED = 679,
    OF_OXM_VLAN_PCP = 680,
    OF_OXM_VLAN_PCP_MASKED = 681,
    OF_OXM_VLAN_VID = 682,
    OF_OXM_VLAN_VID_MASKED = 683,
    OF_PACKET_QUEUE = 684,
    OF_PORT_DESC = 685,
    OF_PORT_DESC_PROP = 686,
    OF_PORT_DESC_PROP_BSN = 687,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 688,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 689,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 690,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 691,
    OF_PORT_DESC_PROP_BSN_UPLINK = 692,
    OF_PORT_DESC_PROP_ETHERNET = 693,
    OF_PORT_DESC_PROP_EXPERIMENTER = 694,
    OF_PORT_DESC_PROP_OPTICAL = 695,
    OF_PORT_MOD_PROP = 696,
    OF_PORT_MOD_PROP_ETHERNET = 697,
    OF_PORT_MOD_PROP_EXPERIMENTER = 698,
    OF_PORT_MOD_PROP_OPTICAL = 699,
    OF_PORT_STATS_ENTRY = 700,
    OF_PORT_STATS_PROP = 701,
    OF_PORT_STATS_PROP_ETHERNET = 702,
    OF_PORT_STATS_PROP_EXPERIMENTER = 703,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 704,
    OF_PORT_STATS_PROP_OPTICAL = 705,
    OF_QUEUE_DESC = 706,
    OF_QUEUE_DESC_PROP = 707,
    OF_QUEUE_DESC_PROP_BSN = 708,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 709,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 710,
    OF_QUEUE_DESC_PROP_MAX_RATE = 711,
    OF_QUEUE_DESC_PROP_MIN_RATE = 712,
    OF_QUEUE_PROP = 713,
    OF_QUEUE_PROP_EXPERIMENTER = 714,
    OF_QUEUE_PROP_MAX_RATE = 715,
    OF_QUEUE_PROP_MIN_RATE = 716,
    OF_QUEUE_STATS_ENTRY = 717,
    OF_QUEUE_STATS_PROP = 718,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 719,
    OF_ROLE_PROP = 720,
    OF_ROLE_PROP_EXPERIMENTER = 721,
    OF_TABLE_DESC = 722,
    OF_TABLE_FEATURE_PROP = 723,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 724,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 725,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 726,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 727,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 728,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 729,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 730,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 731,
    OF_TABLE_FEATURE_PROP_MATCH = 732,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 733,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 734,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 735,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 736,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 737,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 738,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 739,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 740,
    OF_TABLE_FEATURES = 741,
    OF_TABLE_MOD_PROP = 742,
    OF_TABLE_MOD_PROP_EVICTION = 743,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 744,
    OF_TABLE_MOD_PROP_VACANCY = 745,
    OF_TABLE_STATS_ENTRY = 746,
    OF_UINT32 = 747,
    OF_UINT64 = 748,
    OF_UINT8 = 749,
    ...
    /* List objects */
    OF_LIST_ACTION = 750,
    OF_LIST_ACTION_ID = 751,
    OF_LIST_ASYNC_CONFIG_PROP = 752,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 753,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 754,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 755,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 756,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 757,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 758,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 759,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 760,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 761,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 762,
    OF_LIST_BSN_INTERFACE = 763,
    OF_LIST_BSN_LACP_STATS_ENTRY = 764,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 765,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 766,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 767,
    OF_LIST_BSN_TLV = 768,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 769,
    OF_LIST_BSN_VLAN_MAC = 770,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 771,
    OF_LIST_BUCKET = 772,
    OF_LIST_BUCKET_COUNTER = 773,
    OF_LIST_BUNDLE_PROP = 774,
    OF_LIST_FLOW_STATS_ENTRY = 775,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 776,
    OF_LIST_GROUP_STATS_ENTRY = 777,
    OF_LIST_HELLO_ELEM = 778,
    OF_LIST_INSTRUCTION = 779,
    OF_LIST_INSTRUCTION_ID = 780,
    OF_LIST_METER_BAND = 781,
    OF_LIST_METER_BAND_STATS = 782,
    OF_LIST_METER_CONFIG = 783,
    OF_LIST_METER_STATS = 784,
    OF_LIST_OXM = 785,
    OF_LIST_PACKET_QUEUE = 786,
    OF_LIST_PORT_DESC = 787,
    OF_LIST_PORT_DESC_PROP = 788,
    OF_LIST_PORT_MOD_PROP = 789,
    OF_LIST_PORT_STATS_ENTRY = 790,
    OF_LIST_PORT_STATS_PROP = 791,
    OF_LIST_QUEUE_DESC = 792,
    OF_LIST_QUEUE_DESC_PROP = 793,
    OF_LIST_QUEUE_PROP = 794,
    OF_LIST_QUEUE_STATS_ENTRY = 795,
    OF_LIST_QUEUE_STATS_PROP = 796,
    OF_LIST_ROLE_PROP = 797,
    OF_LIST_TABLE_DESC = 798,
    OF_LIST_TABLE_FEATURE_PROP = 799,
    OF_LIST_TABLE_FEATURES = 800,
    OF_LIST_TABLE_MOD_PROP = 801,
    OF_LIST_TABLE_STATS_ENTRY = 802,
    OF_LIST_UINT32 = 803,
    OF_LIST_UINT64 = 804,
    OF_LIST_UINT8 = 805,
