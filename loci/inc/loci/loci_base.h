...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 304,
    OF_BSN_TLV_BUCKET = 305,
    OF_BSN_TLV_CIRCUIT_ID = 306,
    OF_BSN_TLV_CONVERGENCE_STATUS = 307,
    OF_BSN_TLV_CRC_ENABLED = 308,
    OF_BSN_TLV_DATA = 309,
    OF_BSN_TLV_ETH_DST = 310,
    OF_BSN_TLV_ETH_SRC = 311,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 312,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 313,
    OF_BSN_TLV_EXTERNAL_IP = 314,
    OF_BSN_TLV_EXTERNAL_MAC = 315,
    OF_BSN_TLV_EXTERNAL_NETMASK = 316,
    OF_BSN_TLV_HEADER_SIZE = 317,
    OF_BSN_TLV_ICMP_CODE = 318,
    OF_BSN_TLV_ICMP_ID = 319,
    OF_BSN_TLV_ICMP_TYPE = 320,
    OF_BSN_TLV_IDLE_NOTIFICATION = 321,
    OF_BSN_TLV_IDLE_TIME = 322,
    OF_BSN_TLV_IDLE_TIMEOUT = 323,
    OF_BSN_TLV_IGMP_SNOOPING = 324,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 325,
    OF_BSN_TLV_INTERNAL_MAC = 326,
    OF_BSN_TLV_INTERVAL = 327,
    OF_BSN_TLV_IP_PROTO = 328,
    OF_BSN_TLV_IPV4 = 329,
    OF_BSN_TLV_IPV4_DST = 330,
    OF_BSN_TLV_IPV4_NETMASK = 331,
    OF_BSN_TLV_IPV4_SRC = 332,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 333,
    OF_BSN_TLV_MAC = 334,
    OF_BSN_TLV_MAC_MASK = 335,
    OF_BSN_TLV_MISS_PACKETS = 336,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 337,
    OF_BSN_TLV_MPLS_LABEL = 338,
    OF_BSN_TLV_MPLS_SEQUENCED = 339,
    OF_BSN_TLV_NAME = 340,
    OF_BSN_TLV_PARTNER_KEY = 341,
    OF_BSN_TLV_PARTNER_PORT_NUM = 342,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 343,
    OF_BSN_TLV_PARTNER_STATE = 344,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 345,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 346,
    OF_BSN_TLV_PORT = 347,
    OF_BSN_TLV_PRIORITY = 348,
    OF_BSN_TLV_QUEUE_ID = 349,
    OF_BSN_TLV_QUEUE_WEIGHT = 350,
    OF_BSN_TLV_REFERENCE = 351,
    OF_BSN_TLV_REPLY_PACKETS = 352,
    OF_BSN_TLV_REQUEST_PACKETS = 353,
    OF_BSN_TLV_RX_BYTES = 354,
    OF_BSN_TLV_RX_PACKETS = 355,
    OF_BSN_TLV_SAMPLING_RATE = 356,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 357,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 358,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 359,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 360,
    OF_BSN_TLV_SUB_AGENT_ID = 361,
    OF_BSN_TLV_TCP_DST = 362,
    OF_BSN_TLV_TCP_SRC = 363,
    OF_BSN_TLV_TX_BYTES = 364,
    OF_BSN_TLV_TX_PACKETS = 365,
    OF_BSN_TLV_UDF_ANCHOR = 366,
    OF_BSN_TLV_UDF_ID = 367,
    OF_BSN_TLV_UDF_LENGTH = 368,
    OF_BSN_TLV_UDF_OFFSET = 369,
    OF_BSN_TLV_UDP_DST = 370,
    OF_BSN_TLV_UDP_SRC = 371,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 372,
    OF_BSN_TLV_VLAN_PCP = 373,
    OF_BSN_TLV_VLAN_VID = 374,
    OF_BSN_TLV_VLAN_VID_MASK = 375,
    OF_BSN_TLV_VRF = 376,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 377,
    OF_BSN_VPORT = 378,
    OF_BSN_VPORT_L2GRE = 379,
    OF_BSN_VPORT_Q_IN_Q = 380,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 381,
    OF_BUCKET = 382,
    OF_BUCKET_COUNTER = 383,
    OF_BUNDLE_PROP = 384,
    OF_BUNDLE_PROP_EXPERIMENTER = 385,
    OF_FLOW_STATS_ENTRY = 386,
    OF_GROUP_DESC_STATS_ENTRY = 387,
    OF_GROUP_STATS_ENTRY = 388,
    OF_HELLO_ELEM = 389,
    OF_HELLO_ELEM_VERSIONBITMAP = 390,
    OF_INSTRUCTION = 391,
    OF_INSTRUCTION_APPLY_ACTIONS = 392,
    OF_INSTRUCTION_BSN = 393,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 394,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 395,
    OF_INSTRUCTION_BSN_DENY = 396,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 397,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 398,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 399,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 400,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 401,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 402,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 403,
    OF_INSTRUCTION_BSN_PERMIT = 404,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 405,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 406,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 407,
    OF_INSTRUCTION_CLEAR_ACTIONS = 408,
    OF_INSTRUCTION_EXPERIMENTER = 409,
    OF_INSTRUCTION_GOTO_TABLE = 410,
    OF_INSTRUCTION_ID = 411,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 412,
    OF_INSTRUCTION_ID_BSN = 413,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 414,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 415,
    OF_INSTRUCTION_ID_BSN_DENY = 416,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 417,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 418,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 419,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 420,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 421,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 422,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 423,
    OF_INSTRUCTION_ID_BSN_PERMIT = 424,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 425,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 426,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 427,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 428,
    OF_INSTRUCTION_ID_EXPERIMENTER = 429,
    OF_INSTRUCTION_ID_GOTO_TABLE = 430,
    OF_INSTRUCTION_ID_METER = 431,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 432,
    OF_INSTRUCTION_ID_WRITE_METADATA = 433,
    OF_INSTRUCTION_METER = 434,
    OF_INSTRUCTION_WRITE_ACTIONS = 435,
    OF_INSTRUCTION_WRITE_METADATA = 436,
    OF_MATCH_V1 = 437,
    OF_MATCH_V2 = 438,
    OF_MATCH_V3 = 439,
    OF_METER_BAND = 440,
    OF_METER_BAND_DROP = 441,
    OF_METER_BAND_DSCP_REMARK = 442,
    OF_METER_BAND_EXPERIMENTER = 443,
    OF_METER_BAND_STATS = 444,
    OF_METER_CONFIG = 445,
    OF_METER_FEATURES = 446,
    OF_METER_STATS = 447,
    OF_OXM = 448,
    OF_OXM_ARP_OP = 449,
    OF_OXM_ARP_OP_MASKED = 450,
    OF_OXM_ARP_SHA = 451,
    OF_OXM_ARP_SHA_MASKED = 452,
    OF_OXM_ARP_SPA = 453,
    OF_OXM_ARP_SPA_MASKED = 454,
    OF_OXM_ARP_THA = 455,
    OF_OXM_ARP_THA_MASKED = 456,
    OF_OXM_ARP_TPA = 457,
    OF_OXM_ARP_TPA_MASKED = 458,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 459,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 460,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 461,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 462,
    OF_OXM_BSN_IN_PORTS_128 = 463,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 464,
    OF_OXM_BSN_IN_PORTS_512 = 465,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 466,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 467,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 468,
    OF_OXM_BSN_INNER_ETH_DST = 469,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 470,
    OF_OXM_BSN_INNER_ETH_SRC = 471,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 472,
    OF_OXM_BSN_L2_CACHE_HIT = 473,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 474,
    OF_OXM_BSN_L3_DST_CLASS_ID = 475,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 476,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 477,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 478,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 479,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 480,
    OF_OXM_BSN_LAG_ID = 481,
    OF_OXM_BSN_LAG_ID_MASKED = 482,
    OF_OXM_BSN_TCP_FLAGS = 483,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 484,
    OF_OXM_BSN_UDF0 = 485,
    OF_OXM_BSN_UDF0_MASKED = 486,
    OF_OXM_BSN_UDF1 = 487,
    OF_OXM_BSN_UDF1_MASKED = 488,
    OF_OXM_BSN_UDF2 = 489,
    OF_OXM_BSN_UDF2_MASKED = 490,
    OF_OXM_BSN_UDF3 = 491,
    OF_OXM_BSN_UDF3_MASKED = 492,
    OF_OXM_BSN_UDF4 = 493,
    OF_OXM_BSN_UDF4_MASKED = 494,
    OF_OXM_BSN_UDF5 = 495,
    OF_OXM_BSN_UDF5_MASKED = 496,
    OF_OXM_BSN_UDF6 = 497,
    OF_OXM_BSN_UDF6_MASKED = 498,
    OF_OXM_BSN_UDF7 = 499,
    OF_OXM_BSN_UDF7_MASKED = 500,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 501,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 502,
    OF_OXM_BSN_VRF = 503,
    OF_OXM_BSN_VRF_MASKED = 504,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 505,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 506,
    OF_OXM_ETH_DST = 507,
    OF_OXM_ETH_DST_MASKED = 508,
    OF_OXM_ETH_SRC = 509,
    OF_OXM_ETH_SRC_MASKED = 510,
    OF_OXM_ETH_TYPE = 511,
    OF_OXM_ETH_TYPE_MASKED = 512,
    OF_OXM_ICMPV4_CODE = 513,
    OF_OXM_ICMPV4_CODE_MASKED = 514,
    OF_OXM_ICMPV4_TYPE = 515,
    OF_OXM_ICMPV4_TYPE_MASKED = 516,
    OF_OXM_ICMPV6_CODE = 517,
    OF_OXM_ICMPV6_CODE_MASKED = 518,
    OF_OXM_ICMPV6_TYPE = 519,
    OF_OXM_ICMPV6_TYPE_MASKED = 520,
    OF_OXM_IN_PHY_PORT = 521,
    OF_OXM_IN_PHY_PORT_MASKED = 522,
    OF_OXM_IN_PORT = 523,
    OF_OXM_IN_PORT_MASKED = 524,
    OF_OXM_IP_DSCP = 525,
    OF_OXM_IP_DSCP_MASKED = 526,
    OF_OXM_IP_ECN = 527,
    OF_OXM_IP_ECN_MASKED = 528,
    OF_OXM_IP_PROTO = 529,
    OF_OXM_IP_PROTO_MASKED = 530,
    OF_OXM_IPV4_DST = 531,
    OF_OXM_IPV4_DST_MASKED = 532,
    OF_OXM_IPV4_SRC = 533,
    OF_OXM_IPV4_SRC_MASKED = 534,
    OF_OXM_IPV6_DST = 535,
    OF_OXM_IPV6_DST_MASKED = 536,
    OF_OXM_IPV6_EXTHDR = 537,
    OF_OXM_IPV6_EXTHDR_MASKED = 538,
    OF_OXM_IPV6_FLABEL = 539,
    OF_OXM_IPV6_FLABEL_MASKED = 540,
    OF_OXM_IPV6_ND_SLL = 541,
    OF_OXM_IPV6_ND_SLL_MASKED = 542,
    OF_OXM_IPV6_ND_TARGET = 543,
    OF_OXM_IPV6_ND_TARGET_MASKED = 544,
    OF_OXM_IPV6_ND_TLL = 545,
    OF_OXM_IPV6_ND_TLL_MASKED = 546,
    OF_OXM_IPV6_SRC = 547,
    OF_OXM_IPV6_SRC_MASKED = 548,
    OF_OXM_METADATA = 549,
    OF_OXM_METADATA_MASKED = 550,
    OF_OXM_MPLS_BOS = 551,
    OF_OXM_MPLS_BOS_MASKED = 552,
    OF_OXM_MPLS_LABEL = 553,
    OF_OXM_MPLS_LABEL_MASKED = 554,
    OF_OXM_MPLS_TC = 555,
    OF_OXM_MPLS_TC_MASKED = 556,
    OF_OXM_PBB_UCA = 557,
    OF_OXM_PBB_UCA_MASKED = 558,
    OF_OXM_SCTP_DST = 559,
    OF_OXM_SCTP_DST_MASKED = 560,
    OF_OXM_SCTP_SRC = 561,
    OF_OXM_SCTP_SRC_MASKED = 562,
    OF_OXM_TCP_DST = 563,
    OF_OXM_TCP_DST_MASKED = 564,
    OF_OXM_TCP_SRC = 565,
    OF_OXM_TCP_SRC_MASKED = 566,
    OF_OXM_TUNNEL_ID = 567,
    OF_OXM_TUNNEL_ID_MASKED = 568,
    OF_OXM_TUNNEL_IPV4_DST = 569,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 570,
    OF_OXM_TUNNEL_IPV4_SRC = 571,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 572,
    OF_OXM_UDP_DST = 573,
    OF_OXM_UDP_DST_MASKED = 574,
    OF_OXM_UDP_SRC = 575,
    OF_OXM_UDP_SRC_MASKED = 576,
    OF_OXM_VLAN_PCP = 577,
    OF_OXM_VLAN_PCP_MASKED = 578,
    OF_OXM_VLAN_VID = 579,
    OF_OXM_VLAN_VID_MASKED = 580,
    OF_PACKET_QUEUE = 581,
    OF_PORT_DESC = 582,
    OF_PORT_DESC_PROP = 583,
    OF_PORT_DESC_PROP_BSN = 584,
    OF_PORT_DESC_PROP_BSN_UPLINK = 585,
    OF_PORT_DESC_PROP_ETHERNET = 586,
    OF_PORT_DESC_PROP_EXPERIMENTER = 587,
    OF_PORT_DESC_PROP_OPTICAL = 588,
    OF_PORT_MOD_PROP = 589,
    OF_PORT_MOD_PROP_ETHERNET = 590,
    OF_PORT_MOD_PROP_EXPERIMENTER = 591,
    OF_PORT_MOD_PROP_OPTICAL = 592,
    OF_PORT_STATS_ENTRY = 593,
    OF_PORT_STATS_PROP = 594,
    OF_PORT_STATS_PROP_ETHERNET = 595,
    OF_PORT_STATS_PROP_EXPERIMENTER = 596,
    OF_PORT_STATS_PROP_OPTICAL = 597,
    OF_QUEUE_DESC = 598,
    OF_QUEUE_DESC_PROP = 599,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 600,
    OF_QUEUE_DESC_PROP_MAX_RATE = 601,
    OF_QUEUE_DESC_PROP_MIN_RATE = 602,
    OF_QUEUE_PROP = 603,
    OF_QUEUE_PROP_EXPERIMENTER = 604,
    OF_QUEUE_PROP_MAX_RATE = 605,
    OF_QUEUE_PROP_MIN_RATE = 606,
    OF_QUEUE_STATS_ENTRY = 607,
    OF_QUEUE_STATS_PROP = 608,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 609,
    OF_ROLE_PROP = 610,
    OF_ROLE_PROP_EXPERIMENTER = 611,
    OF_TABLE_DESC = 612,
    OF_TABLE_FEATURE_PROP = 613,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 614,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 615,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 616,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 617,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 618,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 619,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 620,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 621,
    OF_TABLE_FEATURE_PROP_MATCH = 622,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 623,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 624,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 625,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 626,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 627,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 628,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 629,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 630,
    OF_TABLE_FEATURES = 631,
    OF_TABLE_MOD_PROP = 632,
    OF_TABLE_MOD_PROP_EVICTION = 633,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 634,
    OF_TABLE_MOD_PROP_VACANCY = 635,
    OF_TABLE_STATS_ENTRY = 636,
    OF_UINT32 = 637,
    OF_UINT64 = 638,
    OF_UINT8 = 639,
    ...
    /* List objects */
    OF_LIST_ACTION = 640,
    OF_LIST_ACTION_ID = 641,
    OF_LIST_ASYNC_CONFIG_PROP = 642,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 643,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 644,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 645,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 646,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 647,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 648,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 649,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 650,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 651,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 652,
    OF_LIST_BSN_INTERFACE = 653,
    OF_LIST_BSN_LACP_STATS_ENTRY = 654,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 655,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 656,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 657,
    OF_LIST_BSN_TLV = 658,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 659,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 660,
    OF_LIST_BUCKET = 661,
    OF_LIST_BUCKET_COUNTER = 662,
    OF_LIST_BUNDLE_PROP = 663,
    OF_LIST_FLOW_STATS_ENTRY = 664,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 665,
    OF_LIST_GROUP_STATS_ENTRY = 666,
    OF_LIST_HELLO_ELEM = 667,
    OF_LIST_INSTRUCTION = 668,
    OF_LIST_INSTRUCTION_ID = 669,
    OF_LIST_METER_BAND = 670,
    OF_LIST_METER_BAND_STATS = 671,
    OF_LIST_METER_STATS = 672,
    OF_LIST_OXM = 673,
    OF_LIST_PACKET_QUEUE = 674,
    OF_LIST_PORT_DESC = 675,
    OF_LIST_PORT_DESC_PROP = 676,
    OF_LIST_PORT_MOD_PROP = 677,
    OF_LIST_PORT_STATS_ENTRY = 678,
    OF_LIST_PORT_STATS_PROP = 679,
    OF_LIST_QUEUE_DESC = 680,
    OF_LIST_QUEUE_DESC_PROP = 681,
    OF_LIST_QUEUE_PROP = 682,
    OF_LIST_QUEUE_STATS_ENTRY = 683,
    OF_LIST_QUEUE_STATS_PROP = 684,
    OF_LIST_ROLE_PROP = 685,
    OF_LIST_TABLE_DESC = 686,
    OF_LIST_TABLE_FEATURE_PROP = 687,
    OF_LIST_TABLE_FEATURES = 688,
    OF_LIST_TABLE_MOD_PROP = 689,
    OF_LIST_TABLE_STATS_ENTRY = 690,
    OF_LIST_UINT32 = 691,
    OF_LIST_UINT64 = 692,
    OF_LIST_UINT8 = 693,
