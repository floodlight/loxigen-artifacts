...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_IDLE_NOTIFICATION = 316,
    OF_BSN_TLV_IDLE_TIME = 317,
    OF_BSN_TLV_IDLE_TIMEOUT = 318,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 319,
    OF_BSN_TLV_INTERNAL_MAC = 320,
    OF_BSN_TLV_INTERVAL = 321,
    OF_BSN_TLV_IPV4 = 322,
    OF_BSN_TLV_IPV4_DST = 323,
    OF_BSN_TLV_IPV4_NETMASK = 324,
    OF_BSN_TLV_IPV4_SRC = 325,
    OF_BSN_TLV_MAC = 326,
    OF_BSN_TLV_MAC_MASK = 327,
    OF_BSN_TLV_MISS_PACKETS = 328,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 329,
    OF_BSN_TLV_MPLS_LABEL = 330,
    OF_BSN_TLV_MPLS_SEQUENCED = 331,
    OF_BSN_TLV_NAME = 332,
    OF_BSN_TLV_PARTNER_KEY = 333,
    OF_BSN_TLV_PARTNER_PORT_NUM = 334,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 335,
    OF_BSN_TLV_PARTNER_STATE = 336,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 337,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 338,
    OF_BSN_TLV_PORT = 339,
    OF_BSN_TLV_PRIORITY = 340,
    OF_BSN_TLV_QUEUE_ID = 341,
    OF_BSN_TLV_QUEUE_WEIGHT = 342,
    OF_BSN_TLV_REFERENCE = 343,
    OF_BSN_TLV_REPLY_PACKETS = 344,
    OF_BSN_TLV_REQUEST_PACKETS = 345,
    OF_BSN_TLV_RX_PACKETS = 346,
    OF_BSN_TLV_SAMPLING_RATE = 347,
    OF_BSN_TLV_SUB_AGENT_ID = 348,
    OF_BSN_TLV_TX_BYTES = 349,
    ...
    OF_BSN_TLV_UDP_DST = 355,
    OF_BSN_TLV_UDP_SRC = 356,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 357,
    OF_BSN_TLV_VLAN_VID = 358,
    OF_BSN_TLV_VRF = 359,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 360,
    OF_BSN_VPORT = 361,
    OF_BSN_VPORT_L2GRE = 362,
    OF_BSN_VPORT_Q_IN_Q = 363,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 364,
    OF_BUCKET = 365,
    OF_BUCKET_COUNTER = 366,
    OF_BUNDLE_PROP = 367,
    OF_BUNDLE_PROP_EXPERIMENTER = 368,
    OF_FLOW_STATS_ENTRY = 369,
    OF_GROUP_DESC_STATS_ENTRY = 370,
    OF_GROUP_STATS_ENTRY = 371,
    OF_HELLO_ELEM = 372,
    OF_HELLO_ELEM_VERSIONBITMAP = 373,
    OF_INSTRUCTION = 374,
    OF_INSTRUCTION_APPLY_ACTIONS = 375,
    OF_INSTRUCTION_BSN = 376,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 377,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 378,
    OF_INSTRUCTION_BSN_DENY = 379,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 380,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 381,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 382,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 383,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 384,
    OF_INSTRUCTION_BSN_PERMIT = 385,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 386,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 387,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 388,
    OF_INSTRUCTION_CLEAR_ACTIONS = 389,
    OF_INSTRUCTION_EXPERIMENTER = 390,
    OF_INSTRUCTION_GOTO_TABLE = 391,
    OF_INSTRUCTION_ID = 392,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 393,
    OF_INSTRUCTION_ID_BSN = 394,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 395,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 396,
    OF_INSTRUCTION_ID_BSN_DENY = 397,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 398,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 399,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 400,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 401,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 402,
    OF_INSTRUCTION_ID_BSN_PERMIT = 403,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 404,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 405,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 406,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 407,
    OF_INSTRUCTION_ID_EXPERIMENTER = 408,
    OF_INSTRUCTION_ID_GOTO_TABLE = 409,
    OF_INSTRUCTION_ID_METER = 410,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 411,
    OF_INSTRUCTION_ID_WRITE_METADATA = 412,
    OF_INSTRUCTION_METER = 413,
    OF_INSTRUCTION_WRITE_ACTIONS = 414,
    OF_INSTRUCTION_WRITE_METADATA = 415,
    OF_MATCH_V1 = 416,
    OF_MATCH_V2 = 417,
    OF_MATCH_V3 = 418,
    OF_METER_BAND = 419,
    OF_METER_BAND_DROP = 420,
    OF_METER_BAND_DSCP_REMARK = 421,
    OF_METER_BAND_EXPERIMENTER = 422,
    OF_METER_BAND_STATS = 423,
    OF_METER_CONFIG = 424,
    OF_METER_FEATURES = 425,
    OF_METER_STATS = 426,
    OF_OXM = 427,
    OF_OXM_ARP_OP = 428,
    OF_OXM_ARP_OP_MASKED = 429,
    OF_OXM_ARP_SHA = 430,
    OF_OXM_ARP_SHA_MASKED = 431,
    OF_OXM_ARP_SPA = 432,
    OF_OXM_ARP_SPA_MASKED = 433,
    OF_OXM_ARP_THA = 434,
    OF_OXM_ARP_THA_MASKED = 435,
    OF_OXM_ARP_TPA = 436,
    OF_OXM_ARP_TPA_MASKED = 437,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 438,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 439,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 440,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 441,
    OF_OXM_BSN_IN_PORTS_128 = 442,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 443,
    OF_OXM_BSN_IN_PORTS_512 = 444,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 445,
    OF_OXM_BSN_L2_CACHE_HIT = 446,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 447,
    OF_OXM_BSN_L3_DST_CLASS_ID = 448,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 449,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 450,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 451,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 452,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 453,
    OF_OXM_BSN_LAG_ID = 454,
    OF_OXM_BSN_LAG_ID_MASKED = 455,
    OF_OXM_BSN_TCP_FLAGS = 456,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 457,
    OF_OXM_BSN_UDF0 = 458,
    OF_OXM_BSN_UDF0_MASKED = 459,
    OF_OXM_BSN_UDF1 = 460,
    OF_OXM_BSN_UDF1_MASKED = 461,
    OF_OXM_BSN_UDF2 = 462,
    OF_OXM_BSN_UDF2_MASKED = 463,
    OF_OXM_BSN_UDF3 = 464,
    OF_OXM_BSN_UDF3_MASKED = 465,
    OF_OXM_BSN_UDF4 = 466,
    OF_OXM_BSN_UDF4_MASKED = 467,
    OF_OXM_BSN_UDF5 = 468,
    OF_OXM_BSN_UDF5_MASKED = 469,
    OF_OXM_BSN_UDF6 = 470,
    OF_OXM_BSN_UDF6_MASKED = 471,
    OF_OXM_BSN_UDF7 = 472,
    OF_OXM_BSN_UDF7_MASKED = 473,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 474,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 475,
    OF_OXM_BSN_VRF = 476,
    OF_OXM_BSN_VRF_MASKED = 477,
    OF_OXM_ETH_DST = 478,
    OF_OXM_ETH_DST_MASKED = 479,
    OF_OXM_ETH_SRC = 480,
    OF_OXM_ETH_SRC_MASKED = 481,
    OF_OXM_ETH_TYPE = 482,
    OF_OXM_ETH_TYPE_MASKED = 483,
    OF_OXM_ICMPV4_CODE = 484,
    OF_OXM_ICMPV4_CODE_MASKED = 485,
    OF_OXM_ICMPV4_TYPE = 486,
    OF_OXM_ICMPV4_TYPE_MASKED = 487,
    OF_OXM_ICMPV6_CODE = 488,
    OF_OXM_ICMPV6_CODE_MASKED = 489,
    OF_OXM_ICMPV6_TYPE = 490,
    OF_OXM_ICMPV6_TYPE_MASKED = 491,
    OF_OXM_IN_PHY_PORT = 492,
    OF_OXM_IN_PHY_PORT_MASKED = 493,
    OF_OXM_IN_PORT = 494,
    OF_OXM_IN_PORT_MASKED = 495,
    OF_OXM_IP_DSCP = 496,
    OF_OXM_IP_DSCP_MASKED = 497,
    OF_OXM_IP_ECN = 498,
    OF_OXM_IP_ECN_MASKED = 499,
    OF_OXM_IP_PROTO = 500,
    OF_OXM_IP_PROTO_MASKED = 501,
    OF_OXM_IPV4_DST = 502,
    OF_OXM_IPV4_DST_MASKED = 503,
    OF_OXM_IPV4_SRC = 504,
    OF_OXM_IPV4_SRC_MASKED = 505,
    OF_OXM_IPV6_DST = 506,
    OF_OXM_IPV6_DST_MASKED = 507,
    OF_OXM_IPV6_EXTHDR = 508,
    OF_OXM_IPV6_EXTHDR_MASKED = 509,
    OF_OXM_IPV6_FLABEL = 510,
    OF_OXM_IPV6_FLABEL_MASKED = 511,
    OF_OXM_IPV6_ND_SLL = 512,
    OF_OXM_IPV6_ND_SLL_MASKED = 513,
    OF_OXM_IPV6_ND_TARGET = 514,
    OF_OXM_IPV6_ND_TARGET_MASKED = 515,
    OF_OXM_IPV6_ND_TLL = 516,
    OF_OXM_IPV6_ND_TLL_MASKED = 517,
    OF_OXM_IPV6_SRC = 518,
    OF_OXM_IPV6_SRC_MASKED = 519,
    OF_OXM_METADATA = 520,
    OF_OXM_METADATA_MASKED = 521,
    OF_OXM_MPLS_BOS = 522,
    OF_OXM_MPLS_BOS_MASKED = 523,
    OF_OXM_MPLS_LABEL = 524,
    OF_OXM_MPLS_LABEL_MASKED = 525,
    OF_OXM_MPLS_TC = 526,
    OF_OXM_MPLS_TC_MASKED = 527,
    OF_OXM_PBB_UCA = 528,
    OF_OXM_PBB_UCA_MASKED = 529,
    OF_OXM_SCTP_DST = 530,
    OF_OXM_SCTP_DST_MASKED = 531,
    OF_OXM_SCTP_SRC = 532,
    OF_OXM_SCTP_SRC_MASKED = 533,
    OF_OXM_TCP_DST = 534,
    OF_OXM_TCP_DST_MASKED = 535,
    OF_OXM_TCP_SRC = 536,
    OF_OXM_TCP_SRC_MASKED = 537,
    OF_OXM_TUNNEL_ID = 538,
    OF_OXM_TUNNEL_ID_MASKED = 539,
    OF_OXM_TUNNEL_IPV4_DST = 540,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 541,
    OF_OXM_TUNNEL_IPV4_SRC = 542,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 543,
    OF_OXM_UDP_DST = 544,
    OF_OXM_UDP_DST_MASKED = 545,
    OF_OXM_UDP_SRC = 546,
    OF_OXM_UDP_SRC_MASKED = 547,
    OF_OXM_VLAN_PCP = 548,
    OF_OXM_VLAN_PCP_MASKED = 549,
    OF_OXM_VLAN_VID = 550,
    OF_OXM_VLAN_VID_MASKED = 551,
    OF_PACKET_QUEUE = 552,
    OF_PORT_DESC = 553,
    OF_PORT_DESC_PROP = 554,
    OF_PORT_DESC_PROP_ETHERNET = 555,
    OF_PORT_DESC_PROP_EXPERIMENTER = 556,
    OF_PORT_DESC_PROP_OPTICAL = 557,
    OF_PORT_MOD_PROP = 558,
    OF_PORT_MOD_PROP_ETHERNET = 559,
    OF_PORT_MOD_PROP_EXPERIMENTER = 560,
    OF_PORT_MOD_PROP_OPTICAL = 561,
    OF_PORT_STATS_ENTRY = 562,
    OF_PORT_STATS_PROP = 563,
    OF_PORT_STATS_PROP_ETHERNET = 564,
    OF_PORT_STATS_PROP_EXPERIMENTER = 565,
    OF_PORT_STATS_PROP_OPTICAL = 566,
    OF_QUEUE_DESC = 567,
    OF_QUEUE_DESC_PROP = 568,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 569,
    OF_QUEUE_DESC_PROP_MAX_RATE = 570,
    OF_QUEUE_DESC_PROP_MIN_RATE = 571,
    OF_QUEUE_PROP = 572,
    OF_QUEUE_PROP_EXPERIMENTER = 573,
    OF_QUEUE_PROP_MAX_RATE = 574,
    OF_QUEUE_PROP_MIN_RATE = 575,
    OF_QUEUE_STATS_ENTRY = 576,
    OF_QUEUE_STATS_PROP = 577,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 578,
    OF_ROLE_PROP = 579,
    OF_ROLE_PROP_EXPERIMENTER = 580,
    OF_TABLE_DESC = 581,
    OF_TABLE_FEATURE_PROP = 582,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 583,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 584,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 585,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 586,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 587,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 588,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 589,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 590,
    OF_TABLE_FEATURE_PROP_MATCH = 591,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 592,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 593,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 594,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 595,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 596,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 597,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 598,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 599,
    OF_TABLE_FEATURES = 600,
    OF_TABLE_MOD_PROP = 601,
    OF_TABLE_MOD_PROP_EVICTION = 602,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 603,
    OF_TABLE_MOD_PROP_VACANCY = 604,
    OF_TABLE_STATS_ENTRY = 605,
    OF_UINT32 = 606,
    OF_UINT64 = 607,
    OF_UINT8 = 608,
    ...
    /* List objects */
    OF_LIST_ACTION = 609,
    OF_LIST_ACTION_ID = 610,
    OF_LIST_ASYNC_CONFIG_PROP = 611,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 612,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 613,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 614,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 615,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 616,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 617,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 618,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 619,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 620,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 621,
    OF_LIST_BSN_INTERFACE = 622,
    OF_LIST_BSN_LACP_STATS_ENTRY = 623,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 624,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 625,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 626,
    OF_LIST_BSN_TLV = 627,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 628,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 629,
    OF_LIST_BUCKET = 630,
    OF_LIST_BUCKET_COUNTER = 631,
    OF_LIST_BUNDLE_PROP = 632,
    OF_LIST_FLOW_STATS_ENTRY = 633,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 634,
    OF_LIST_GROUP_STATS_ENTRY = 635,
    OF_LIST_HELLO_ELEM = 636,
    OF_LIST_INSTRUCTION = 637,
    OF_LIST_INSTRUCTION_ID = 638,
    OF_LIST_METER_BAND = 639,
    OF_LIST_METER_BAND_STATS = 640,
    OF_LIST_METER_STATS = 641,
    OF_LIST_OXM = 642,
    OF_LIST_PACKET_QUEUE = 643,
    OF_LIST_PORT_DESC = 644,
    OF_LIST_PORT_DESC_PROP = 645,
    OF_LIST_PORT_MOD_PROP = 646,
    OF_LIST_PORT_STATS_ENTRY = 647,
    OF_LIST_PORT_STATS_PROP = 648,
    OF_LIST_QUEUE_DESC = 649,
    OF_LIST_QUEUE_DESC_PROP = 650,
    OF_LIST_QUEUE_PROP = 651,
    OF_LIST_QUEUE_STATS_ENTRY = 652,
    OF_LIST_QUEUE_STATS_PROP = 653,
    OF_LIST_ROLE_PROP = 654,
    OF_LIST_TABLE_DESC = 655,
    OF_LIST_TABLE_FEATURE_PROP = 656,
    OF_LIST_TABLE_FEATURES = 657,
    OF_LIST_TABLE_MOD_PROP = 658,
    OF_LIST_TABLE_STATS_ENTRY = 659,
    OF_LIST_UINT32 = 660,
    OF_LIST_UINT64 = 661,
    OF_LIST_UINT8 = 662,
