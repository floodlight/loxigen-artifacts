...
typedef enum of_object_id_e {
    ...
    OF_OXM_BSN_L2_CACHE_HIT = 476,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 477,
    OF_OXM_BSN_L3_DST_CLASS_ID = 478,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 479,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 480,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 481,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 482,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 483,
    OF_OXM_BSN_LAG_ID = 484,
    OF_OXM_BSN_LAG_ID_MASKED = 485,
    OF_OXM_BSN_TCP_FLAGS = 486,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 487,
    OF_OXM_BSN_UDF0 = 488,
    OF_OXM_BSN_UDF0_MASKED = 489,
    OF_OXM_BSN_UDF1 = 490,
    OF_OXM_BSN_UDF1_MASKED = 491,
    OF_OXM_BSN_UDF2 = 492,
    OF_OXM_BSN_UDF2_MASKED = 493,
    OF_OXM_BSN_UDF3 = 494,
    OF_OXM_BSN_UDF3_MASKED = 495,
    OF_OXM_BSN_UDF4 = 496,
    OF_OXM_BSN_UDF4_MASKED = 497,
    OF_OXM_BSN_UDF5 = 498,
    OF_OXM_BSN_UDF5_MASKED = 499,
    OF_OXM_BSN_UDF6 = 500,
    OF_OXM_BSN_UDF6_MASKED = 501,
    OF_OXM_BSN_UDF7 = 502,
    OF_OXM_BSN_UDF7_MASKED = 503,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 504,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 505,
    OF_OXM_BSN_VRF = 506,
    OF_OXM_BSN_VRF_MASKED = 507,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 508,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 509,
    OF_OXM_ETH_DST = 510,
    OF_OXM_ETH_DST_MASKED = 511,
    OF_OXM_ETH_SRC = 512,
    OF_OXM_ETH_SRC_MASKED = 513,
    OF_OXM_ETH_TYPE = 514,
    OF_OXM_ETH_TYPE_MASKED = 515,
    OF_OXM_ICMPV4_CODE = 516,
    OF_OXM_ICMPV4_CODE_MASKED = 517,
    OF_OXM_ICMPV4_TYPE = 518,
    OF_OXM_ICMPV4_TYPE_MASKED = 519,
    OF_OXM_ICMPV6_CODE = 520,
    OF_OXM_ICMPV6_CODE_MASKED = 521,
    OF_OXM_ICMPV6_TYPE = 522,
    OF_OXM_ICMPV6_TYPE_MASKED = 523,
    OF_OXM_IN_PHY_PORT = 524,
    OF_OXM_IN_PHY_PORT_MASKED = 525,
    OF_OXM_IN_PORT = 526,
    OF_OXM_IN_PORT_MASKED = 527,
    OF_OXM_IP_DSCP = 528,
    OF_OXM_IP_DSCP_MASKED = 529,
    OF_OXM_IP_ECN = 530,
    OF_OXM_IP_ECN_MASKED = 531,
    OF_OXM_IP_PROTO = 532,
    OF_OXM_IP_PROTO_MASKED = 533,
    OF_OXM_IPV4_DST = 534,
    OF_OXM_IPV4_DST_MASKED = 535,
    OF_OXM_IPV4_SRC = 536,
    OF_OXM_IPV4_SRC_MASKED = 537,
    OF_OXM_IPV6_DST = 538,
    OF_OXM_IPV6_DST_MASKED = 539,
    OF_OXM_IPV6_EXTHDR = 540,
    OF_OXM_IPV6_EXTHDR_MASKED = 541,
    OF_OXM_IPV6_FLABEL = 542,
    OF_OXM_IPV6_FLABEL_MASKED = 543,
    OF_OXM_IPV6_ND_SLL = 544,
    OF_OXM_IPV6_ND_SLL_MASKED = 545,
    OF_OXM_IPV6_ND_TARGET = 546,
    OF_OXM_IPV6_ND_TARGET_MASKED = 547,
    OF_OXM_IPV6_ND_TLL = 548,
    OF_OXM_IPV6_ND_TLL_MASKED = 549,
    OF_OXM_IPV6_SRC = 550,
    OF_OXM_IPV6_SRC_MASKED = 551,
    OF_OXM_METADATA = 552,
    OF_OXM_METADATA_MASKED = 553,
    OF_OXM_MPLS_BOS = 554,
    OF_OXM_MPLS_BOS_MASKED = 555,
    OF_OXM_MPLS_LABEL = 556,
    OF_OXM_MPLS_LABEL_MASKED = 557,
    OF_OXM_MPLS_TC = 558,
    OF_OXM_MPLS_TC_MASKED = 559,
    OF_OXM_PBB_UCA = 560,
    OF_OXM_PBB_UCA_MASKED = 561,
    OF_OXM_SCTP_DST = 562,
    OF_OXM_SCTP_DST_MASKED = 563,
    OF_OXM_SCTP_SRC = 564,
    OF_OXM_SCTP_SRC_MASKED = 565,
    OF_OXM_TCP_DST = 566,
    OF_OXM_TCP_DST_MASKED = 567,
    OF_OXM_TCP_SRC = 568,
    OF_OXM_TCP_SRC_MASKED = 569,
    OF_OXM_TUNNEL_ID = 570,
    OF_OXM_TUNNEL_ID_MASKED = 571,
    OF_OXM_TUNNEL_IPV4_DST = 572,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 573,
    OF_OXM_TUNNEL_IPV4_SRC = 574,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 575,
    OF_OXM_UDP_DST = 576,
    OF_OXM_UDP_DST_MASKED = 577,
    OF_OXM_UDP_SRC = 578,
    OF_OXM_UDP_SRC_MASKED = 579,
    OF_OXM_VLAN_PCP = 580,
    OF_OXM_VLAN_PCP_MASKED = 581,
    OF_OXM_VLAN_VID = 582,
    OF_OXM_VLAN_VID_MASKED = 583,
    OF_PACKET_QUEUE = 584,
    OF_PORT_DESC = 585,
    OF_PORT_DESC_PROP = 586,
    OF_PORT_DESC_PROP_BSN = 587,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 588,
    OF_PORT_DESC_PROP_BSN_UPLINK = 589,
    OF_PORT_DESC_PROP_ETHERNET = 590,
    OF_PORT_DESC_PROP_EXPERIMENTER = 591,
    OF_PORT_DESC_PROP_OPTICAL = 592,
    OF_PORT_MOD_PROP = 593,
    OF_PORT_MOD_PROP_ETHERNET = 594,
    OF_PORT_MOD_PROP_EXPERIMENTER = 595,
    OF_PORT_MOD_PROP_OPTICAL = 596,
    OF_PORT_STATS_ENTRY = 597,
    OF_PORT_STATS_PROP = 598,
    OF_PORT_STATS_PROP_ETHERNET = 599,
    OF_PORT_STATS_PROP_EXPERIMENTER = 600,
    OF_PORT_STATS_PROP_OPTICAL = 601,
    OF_QUEUE_DESC = 602,
    OF_QUEUE_DESC_PROP = 603,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 604,
    OF_QUEUE_DESC_PROP_MAX_RATE = 605,
    OF_QUEUE_DESC_PROP_MIN_RATE = 606,
    OF_QUEUE_PROP = 607,
    OF_QUEUE_PROP_EXPERIMENTER = 608,
    OF_QUEUE_PROP_MAX_RATE = 609,
    OF_QUEUE_PROP_MIN_RATE = 610,
    OF_QUEUE_STATS_ENTRY = 611,
    OF_QUEUE_STATS_PROP = 612,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 613,
    OF_ROLE_PROP = 614,
    OF_ROLE_PROP_EXPERIMENTER = 615,
    OF_TABLE_DESC = 616,
    OF_TABLE_FEATURE_PROP = 617,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 618,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 619,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 620,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 621,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 622,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 623,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 624,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 625,
    OF_TABLE_FEATURE_PROP_MATCH = 626,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 627,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 628,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 629,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 630,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 631,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 632,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 633,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 634,
    OF_TABLE_FEATURES = 635,
    OF_TABLE_MOD_PROP = 636,
    OF_TABLE_MOD_PROP_EVICTION = 637,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 638,
    OF_TABLE_MOD_PROP_VACANCY = 639,
    OF_TABLE_STATS_ENTRY = 640,
    OF_UINT32 = 641,
    OF_UINT64 = 642,
    OF_UINT8 = 643,
    ...
    /* List objects */
    OF_LIST_ACTION = 644,
    OF_LIST_ACTION_ID = 645,
    OF_LIST_ASYNC_CONFIG_PROP = 646,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 647,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 648,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 649,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 650,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 651,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 652,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 653,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 654,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 655,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 656,
    OF_LIST_BSN_INTERFACE = 657,
    OF_LIST_BSN_LACP_STATS_ENTRY = 658,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 659,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 660,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 661,
    OF_LIST_BSN_TLV = 662,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 663,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 664,
    OF_LIST_BUCKET = 665,
    OF_LIST_BUCKET_COUNTER = 666,
    OF_LIST_BUNDLE_PROP = 667,
    OF_LIST_FLOW_STATS_ENTRY = 668,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 669,
    OF_LIST_GROUP_STATS_ENTRY = 670,
    OF_LIST_HELLO_ELEM = 671,
    OF_LIST_INSTRUCTION = 672,
    OF_LIST_INSTRUCTION_ID = 673,
    OF_LIST_METER_BAND = 674,
    OF_LIST_METER_BAND_STATS = 675,
    OF_LIST_METER_STATS = 676,
    OF_LIST_OXM = 677,
    OF_LIST_PACKET_QUEUE = 678,
    OF_LIST_PORT_DESC = 679,
    OF_LIST_PORT_DESC_PROP = 680,
    OF_LIST_PORT_MOD_PROP = 681,
    OF_LIST_PORT_STATS_ENTRY = 682,
    OF_LIST_PORT_STATS_PROP = 683,
    OF_LIST_QUEUE_DESC = 684,
    OF_LIST_QUEUE_DESC_PROP = 685,
    OF_LIST_QUEUE_PROP = 686,
    OF_LIST_QUEUE_STATS_ENTRY = 687,
    OF_LIST_QUEUE_STATS_PROP = 688,
    OF_LIST_ROLE_PROP = 689,
    OF_LIST_TABLE_DESC = 690,
    OF_LIST_TABLE_FEATURE_PROP = 691,
    OF_LIST_TABLE_FEATURES = 692,
    OF_LIST_TABLE_MOD_PROP = 693,
    OF_LIST_TABLE_STATS_ENTRY = 694,
    OF_LIST_UINT32 = 695,
    OF_LIST_UINT64 = 696,
    OF_LIST_UINT8 = 697,
