...
typedef enum of_object_id_e {
    ...
    OF_BSN_LOG = 69,
    OF_BSN_PDU_RX_REPLY = 70,
    OF_BSN_PDU_RX_REQUEST = 71,
    OF_BSN_PDU_RX_TIMEOUT = 72,
    OF_BSN_PDU_TX_REPLY = 73,
    OF_BSN_PDU_TX_REQUEST = 74,
    OF_BSN_PORT_COUNTER_STATS_REPLY = 75,
    OF_BSN_PORT_COUNTER_STATS_REQUEST = 76,
    OF_BSN_ROLE_STATUS = 77,
    OF_BSN_SET_AUX_CXNS_REPLY = 78,
    OF_BSN_SET_AUX_CXNS_REQUEST = 79,
    OF_BSN_SET_IP_MASK = 80,
    OF_BSN_SET_L2_TABLE_REPLY = 81,
    OF_BSN_SET_L2_TABLE_REQUEST = 82,
    OF_BSN_SET_LACP_REPLY = 83,
    OF_BSN_SET_LACP_REQUEST = 84,
    OF_BSN_SET_MIRRORING = 85,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 86,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 87,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 88,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 89,
    OF_BSN_SHELL_COMMAND = 90,
    OF_BSN_SHELL_OUTPUT = 91,
    OF_BSN_SHELL_STATUS = 92,
    OF_BSN_STATS_REPLY = 93,
    OF_BSN_STATS_REQUEST = 94,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 95,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 96,
    OF_BSN_TABLE_CHECKSUM_STATS_REPLY = 97,
    OF_BSN_TABLE_CHECKSUM_STATS_REQUEST = 98,
    OF_BSN_TABLE_SET_BUCKETS_SIZE = 99,
    OF_BSN_TIME_REPLY = 100,
    OF_BSN_TIME_REQUEST = 101,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 102,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 103,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 104,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 105,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 106,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 107,
    OF_BSN_VRF_COUNTER_STATS_REPLY = 108,
    OF_BSN_VRF_COUNTER_STATS_REQUEST = 109,
    OF_BUNDLE_ADD_MSG = 110,
    OF_BUNDLE_CTRL_MSG = 111,
    OF_BUNDLE_FAILED_ERROR_MSG = 112,
    OF_DESC_STATS_REPLY = 113,
    OF_DESC_STATS_REQUEST = 114,
    OF_ECHO_REPLY = 115,
    OF_ECHO_REQUEST = 116,
    OF_ERROR_MSG = 117,
    OF_EXPERIMENTER = 118,
    OF_EXPERIMENTER_ERROR_MSG = 119,
    OF_EXPERIMENTER_STATS_REPLY = 120,
    OF_EXPERIMENTER_STATS_REQUEST = 121,
    OF_FEATURES_REPLY = 122,
    OF_FEATURES_REQUEST = 123,
    OF_FLOW_ADD = 124,
    OF_FLOW_DELETE = 125,
    OF_FLOW_DELETE_STRICT = 126,
    OF_FLOW_MOD = 127,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 128,
    OF_FLOW_MODIFY = 129,
    OF_FLOW_MODIFY_STRICT = 130,
    OF_FLOW_MONITOR_FAILED_ERROR_MSG = 131,
    OF_FLOW_REMOVED = 132,
    OF_FLOW_STATS_REPLY = 133,
    OF_FLOW_STATS_REQUEST = 134,
    OF_GET_CONFIG_REPLY = 135,
    OF_GET_CONFIG_REQUEST = 136,
    OF_GROUP_ADD = 137,
    OF_GROUP_DELETE = 138,
    OF_GROUP_DESC_STATS_REPLY = 139,
    OF_GROUP_DESC_STATS_REQUEST = 140,
    OF_GROUP_FEATURES_STATS_REPLY = 141,
    OF_GROUP_FEATURES_STATS_REQUEST = 142,
    OF_GROUP_MOD = 143,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 144,
    OF_GROUP_MODIFY = 145,
    OF_GROUP_STATS_REPLY = 146,
    OF_GROUP_STATS_REQUEST = 147,
    OF_HEADER = 148,
    OF_HELLO = 149,
    OF_HELLO_FAILED_ERROR_MSG = 150,
    OF_METER_CONFIG_STATS_REPLY = 151,
    OF_METER_CONFIG_STATS_REQUEST = 152,
    OF_METER_FEATURES_STATS_REPLY = 153,
    OF_METER_FEATURES_STATS_REQUEST = 154,
    OF_METER_MOD = 155,
    OF_METER_MOD_FAILED_ERROR_MSG = 156,
    OF_METER_STATS_REPLY = 157,
    OF_METER_STATS_REQUEST = 158,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 159,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 160,
    OF_NICIRA_HEADER = 161,
    OF_PACKET_IN = 162,
    OF_PACKET_OUT = 163,
    OF_PORT_DESC_STATS_REPLY = 164,
    OF_PORT_DESC_STATS_REQUEST = 165,
    OF_PORT_MOD = 166,
    OF_PORT_MOD_FAILED_ERROR_MSG = 167,
    OF_PORT_STATS_REPLY = 168,
    OF_PORT_STATS_REQUEST = 169,
    OF_PORT_STATUS = 170,
    OF_QUEUE_DESC_STATS_REPLY = 171,
    OF_QUEUE_DESC_STATS_REQUEST = 172,
    OF_QUEUE_GET_CONFIG_REPLY = 173,
    OF_QUEUE_GET_CONFIG_REQUEST = 174,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 175,
    OF_QUEUE_STATS_REPLY = 176,
    OF_QUEUE_STATS_REQUEST = 177,
    OF_REQUESTFORWARD = 178,
    OF_ROLE_REPLY = 179,
    OF_ROLE_REQUEST = 180,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 181,
    OF_ROLE_STATUS = 182,
    OF_SET_CONFIG = 183,
    OF_STATS_REPLY = 184,
    OF_STATS_REQUEST = 185,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 186,
    OF_TABLE_DESC_STATS_REPLY = 187,
    OF_TABLE_DESC_STATS_REQUEST = 188,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 189,
    OF_TABLE_FEATURES_STATS_REPLY = 190,
    OF_TABLE_FEATURES_STATS_REQUEST = 191,
    OF_TABLE_MOD = 192,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 193,
    OF_TABLE_STATS_REPLY = 194,
    OF_TABLE_STATS_REQUEST = 195,
    OF_TABLE_STATUS = 196,

    /* Non-message objects */
    OF_ACTION = 197,
    OF_ACTION_BSN = 198,
    OF_ACTION_BSN_CHECKSUM = 199,
    OF_ACTION_BSN_GENTABLE = 200,
    OF_ACTION_BSN_MIRROR = 201,
    OF_ACTION_BSN_SET_TUNNEL_DST = 202,
    OF_ACTION_COPY_TTL_IN = 203,
    OF_ACTION_COPY_TTL_OUT = 204,
    OF_ACTION_DEC_MPLS_TTL = 205,
    OF_ACTION_DEC_NW_TTL = 206,
    OF_ACTION_ENQUEUE = 207,
    OF_ACTION_EXPERIMENTER = 208,
    OF_ACTION_GROUP = 209,
    OF_ACTION_ID = 210,
    OF_ACTION_ID_BSN = 211,
    OF_ACTION_ID_BSN_CHECKSUM = 212,
    OF_ACTION_ID_BSN_GENTABLE = 213,
    OF_ACTION_ID_BSN_MIRROR = 214,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 215,
    OF_ACTION_ID_COPY_TTL_IN = 216,
    OF_ACTION_ID_COPY_TTL_OUT = 217,
    OF_ACTION_ID_DEC_MPLS_TTL = 218,
    OF_ACTION_ID_DEC_NW_TTL = 219,
    OF_ACTION_ID_EXPERIMENTER = 220,
    OF_ACTION_ID_GROUP = 221,
    ...
    OF_ASYNC_CONFIG_PROP_PACKET_IN_MASTER = 266,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_SLAVE = 267,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_MASTER = 268,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_SLAVE = 269,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_MASTER = 270,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_SLAVE = 271,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_MASTER = 272,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_SLAVE = 273,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_MASTER = 274,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_SLAVE = 275,
    OF_BSN_CONTROLLER_CONNECTION = 276,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 277,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 278,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 279,
    OF_BSN_GENERIC_STATS_ENTRY = 280,
    ...
    OF_BSN_TLV_HEADER_SIZE = 310,
    OF_BSN_TLV_IDLE_NOTIFICATION = 311,
    OF_BSN_TLV_IDLE_TIME = 312,
    OF_BSN_TLV_IDLE_TIMEOUT = 313,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 314,
    OF_BSN_TLV_INTERNAL_MAC = 315,
    OF_BSN_TLV_INTERVAL = 316,
    OF_BSN_TLV_IPV4 = 317,
    OF_BSN_TLV_IPV4_DST = 318,
    OF_BSN_TLV_IPV4_NETMASK = 319,
    OF_BSN_TLV_IPV4_SRC = 320,
    OF_BSN_TLV_MAC = 321,
    OF_BSN_TLV_MAC_MASK = 322,
    OF_BSN_TLV_MISS_PACKETS = 323,
    OF_BSN_TLV_NAME = 324,
    OF_BSN_TLV_PARTNER_KEY = 325,
    OF_BSN_TLV_PARTNER_PORT_NUM = 326,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 327,
    OF_BSN_TLV_PARTNER_STATE = 328,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 329,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 330,
    OF_BSN_TLV_PORT = 331,
    OF_BSN_TLV_PRIORITY = 332,
    OF_BSN_TLV_QUEUE_ID = 333,
    OF_BSN_TLV_QUEUE_WEIGHT = 334,
    OF_BSN_TLV_REFERENCE = 335,
    OF_BSN_TLV_REPLY_PACKETS = 336,
    OF_BSN_TLV_REQUEST_PACKETS = 337,
    OF_BSN_TLV_RX_PACKETS = 338,
    OF_BSN_TLV_SAMPLING_RATE = 339,
    OF_BSN_TLV_SUB_AGENT_ID = 340,
    OF_BSN_TLV_TX_BYTES = 341,
    OF_BSN_TLV_TX_PACKETS = 342,
    OF_BSN_TLV_UDF_ANCHOR = 343,
    OF_BSN_TLV_UDF_ID = 344,
    OF_BSN_TLV_UDF_LENGTH = 345,
    OF_BSN_TLV_UDF_OFFSET = 346,
    OF_BSN_TLV_UDP_DST = 347,
    OF_BSN_TLV_UDP_SRC = 348,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 349,
    OF_BSN_TLV_VLAN_VID = 350,
    OF_BSN_TLV_VRF = 351,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 352,
    OF_BSN_VPORT = 353,
    OF_BSN_VPORT_L2GRE = 354,
    OF_BSN_VPORT_Q_IN_Q = 355,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 356,
    OF_BUCKET = 357,
    OF_BUCKET_COUNTER = 358,
    OF_BUNDLE_PROP = 359,
    OF_BUNDLE_PROP_EXPERIMENTER = 360,
    OF_FLOW_STATS_ENTRY = 361,
    OF_GROUP_DESC_STATS_ENTRY = 362,
    OF_GROUP_STATS_ENTRY = 363,
    OF_HELLO_ELEM = 364,
    OF_HELLO_ELEM_VERSIONBITMAP = 365,
    OF_INSTRUCTION = 366,
    OF_INSTRUCTION_APPLY_ACTIONS = 367,
    OF_INSTRUCTION_BSN = 368,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 369,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 370,
    ...
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 388,
    ...
    OF_INSTRUCTION_ID_METER = 402,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 403,
    OF_INSTRUCTION_ID_WRITE_METADATA = 404,
    OF_INSTRUCTION_METER = 405,
    OF_INSTRUCTION_WRITE_ACTIONS = 406,
    OF_INSTRUCTION_WRITE_METADATA = 407,
    OF_MATCH_V1 = 408,
    OF_MATCH_V2 = 409,
    OF_MATCH_V3 = 410,
    OF_METER_BAND = 411,
    OF_METER_BAND_DROP = 412,
    OF_METER_BAND_DSCP_REMARK = 413,
    OF_METER_BAND_EXPERIMENTER = 414,
    ...
    OF_OXM_BSN_L2_CACHE_HIT = 436,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 437,
    ...
    OF_OXM_ICMPV4_CODE = 474,
    OF_OXM_ICMPV4_CODE_MASKED = 475,
    OF_OXM_ICMPV4_TYPE = 476,
    OF_OXM_ICMPV4_TYPE_MASKED = 477,
    OF_OXM_ICMPV6_CODE = 478,
    OF_OXM_ICMPV6_CODE_MASKED = 479,
    OF_OXM_ICMPV6_TYPE = 480,
    OF_OXM_ICMPV6_TYPE_MASKED = 481,
    OF_OXM_IN_PHY_PORT = 482,
    OF_OXM_IN_PHY_PORT_MASKED = 483,
    OF_OXM_IN_PORT = 484,
    OF_OXM_IN_PORT_MASKED = 485,
    OF_OXM_IP_DSCP = 486,
    OF_OXM_IP_DSCP_MASKED = 487,
    OF_OXM_IP_ECN = 488,
    OF_OXM_IP_ECN_MASKED = 489,
    OF_OXM_IP_PROTO = 490,
    OF_OXM_IP_PROTO_MASKED = 491,
    OF_OXM_IPV4_DST = 492,
    OF_OXM_IPV4_DST_MASKED = 493,
    OF_OXM_IPV4_SRC = 494,
    OF_OXM_IPV4_SRC_MASKED = 495,
    OF_OXM_IPV6_DST = 496,
    OF_OXM_IPV6_DST_MASKED = 497,
    OF_OXM_IPV6_EXTHDR = 498,
    OF_OXM_IPV6_EXTHDR_MASKED = 499,
    OF_OXM_IPV6_FLABEL = 500,
    OF_OXM_IPV6_FLABEL_MASKED = 501,
    OF_OXM_IPV6_ND_SLL = 502,
    OF_OXM_IPV6_ND_SLL_MASKED = 503,
    OF_OXM_IPV6_ND_TARGET = 504,
    OF_OXM_IPV6_ND_TARGET_MASKED = 505,
    OF_OXM_IPV6_ND_TLL = 506,
    OF_OXM_IPV6_ND_TLL_MASKED = 507,
    OF_OXM_IPV6_SRC = 508,
    OF_OXM_IPV6_SRC_MASKED = 509,
    OF_OXM_METADATA = 510,
    OF_OXM_METADATA_MASKED = 511,
    OF_OXM_MPLS_BOS = 512,
    OF_OXM_MPLS_BOS_MASKED = 513,
    OF_OXM_MPLS_LABEL = 514,
    OF_OXM_MPLS_LABEL_MASKED = 515,
    OF_OXM_MPLS_TC = 516,
    OF_OXM_MPLS_TC_MASKED = 517,
    OF_OXM_PBB_UCA = 518,
    OF_OXM_PBB_UCA_MASKED = 519,
    OF_OXM_SCTP_DST = 520,
    OF_OXM_SCTP_DST_MASKED = 521,
    OF_OXM_SCTP_SRC = 522,
    OF_OXM_SCTP_SRC_MASKED = 523,
    OF_OXM_TCP_DST = 524,
    OF_OXM_TCP_DST_MASKED = 525,
    OF_OXM_TCP_SRC = 526,
    OF_OXM_TCP_SRC_MASKED = 527,
    OF_OXM_TUNNEL_ID = 528,
    OF_OXM_TUNNEL_ID_MASKED = 529,
    OF_OXM_TUNNEL_IPV4_DST = 530,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 531,
    OF_OXM_TUNNEL_IPV4_SRC = 532,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 533,
    OF_OXM_UDP_DST = 534,
    OF_OXM_UDP_DST_MASKED = 535,
    OF_OXM_UDP_SRC = 536,
    OF_OXM_UDP_SRC_MASKED = 537,
    OF_OXM_VLAN_PCP = 538,
    OF_OXM_VLAN_PCP_MASKED = 539,
    OF_OXM_VLAN_VID = 540,
    OF_OXM_VLAN_VID_MASKED = 541,
    OF_PACKET_QUEUE = 542,
    OF_PORT_DESC = 543,
    OF_PORT_DESC_PROP = 544,
    OF_PORT_DESC_PROP_ETHERNET = 545,
    OF_PORT_DESC_PROP_EXPERIMENTER = 546,
    OF_PORT_DESC_PROP_OPTICAL = 547,
    OF_PORT_MOD_PROP = 548,
    OF_PORT_MOD_PROP_ETHERNET = 549,
    OF_PORT_MOD_PROP_EXPERIMENTER = 550,
    OF_PORT_MOD_PROP_OPTICAL = 551,
    OF_PORT_STATS_ENTRY = 552,
    OF_PORT_STATS_PROP = 553,
    OF_PORT_STATS_PROP_ETHERNET = 554,
    OF_PORT_STATS_PROP_EXPERIMENTER = 555,
    OF_PORT_STATS_PROP_OPTICAL = 556,
    OF_QUEUE_DESC = 557,
    OF_QUEUE_DESC_PROP = 558,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 559,
    OF_QUEUE_DESC_PROP_MAX_RATE = 560,
    OF_QUEUE_DESC_PROP_MIN_RATE = 561,
    OF_QUEUE_PROP = 562,
    OF_QUEUE_PROP_EXPERIMENTER = 563,
    ...
    OF_ROLE_PROP = 569,
    OF_ROLE_PROP_EXPERIMENTER = 570,
    OF_TABLE_DESC = 571,
    OF_TABLE_FEATURE_PROP = 572,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 573,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 574,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 575,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 576,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 577,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 578,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 579,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 580,
    OF_TABLE_FEATURE_PROP_MATCH = 581,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 582,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 583,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 584,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 585,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 586,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 587,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 588,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 589,
    OF_TABLE_FEATURES = 590,
    OF_TABLE_MOD_PROP = 591,
    OF_TABLE_MOD_PROP_EVICTION = 592,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 593,
    OF_TABLE_MOD_PROP_VACANCY = 594,
    OF_TABLE_STATS_ENTRY = 595,
    OF_UINT32 = 596,
    OF_UINT64 = 597,
    OF_UINT8 = 598,
    ...
    /* List objects */
    OF_LIST_ACTION = 599,
    OF_LIST_ACTION_ID = 600,
    OF_LIST_ASYNC_CONFIG_PROP = 601,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 602,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 603,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 604,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 605,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 606,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 607,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 608,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 609,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 610,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 611,
    OF_LIST_BSN_INTERFACE = 612,
    OF_LIST_BSN_LACP_STATS_ENTRY = 613,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 614,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 615,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 616,
    OF_LIST_BSN_TLV = 617,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 618,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 619,
    OF_LIST_BUCKET = 620,
    OF_LIST_BUCKET_COUNTER = 621,
    OF_LIST_BUNDLE_PROP = 622,
    OF_LIST_FLOW_STATS_ENTRY = 623,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 624,
    OF_LIST_GROUP_STATS_ENTRY = 625,
    OF_LIST_HELLO_ELEM = 626,
    OF_LIST_INSTRUCTION = 627,
    OF_LIST_INSTRUCTION_ID = 628,
    OF_LIST_METER_BAND = 629,
    OF_LIST_METER_BAND_STATS = 630,
    OF_LIST_METER_STATS = 631,
    OF_LIST_OXM = 632,
    OF_LIST_PACKET_QUEUE = 633,
    OF_LIST_PORT_DESC = 634,
    OF_LIST_PORT_DESC_PROP = 635,
    OF_LIST_PORT_MOD_PROP = 636,
    OF_LIST_PORT_STATS_ENTRY = 637,
    OF_LIST_PORT_STATS_PROP = 638,
    OF_LIST_QUEUE_DESC = 639,
    OF_LIST_QUEUE_DESC_PROP = 640,
    OF_LIST_QUEUE_PROP = 641,
    OF_LIST_QUEUE_STATS_ENTRY = 642,
    OF_LIST_QUEUE_STATS_PROP = 643,
    OF_LIST_ROLE_PROP = 644,
    OF_LIST_TABLE_DESC = 645,
    OF_LIST_TABLE_FEATURE_PROP = 646,
    OF_LIST_TABLE_FEATURES = 647,
    OF_LIST_TABLE_MOD_PROP = 648,
    OF_LIST_TABLE_STATS_ENTRY = 649,
    OF_LIST_UINT32 = 650,
    OF_LIST_UINT64 = 651,
    OF_LIST_UINT8 = 652,
...
#define OF_MESSAGE_OBJECT_COUNT 197
