...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_BUCKET = 299,
    OF_BSN_TLV_CIRCUIT_ID = 300,
    OF_BSN_TLV_CONVERGENCE_STATUS = 301,
    OF_BSN_TLV_CRC_ENABLED = 302,
    OF_BSN_TLV_DATA = 303,
    OF_BSN_TLV_ETH_DST = 304,
    OF_BSN_TLV_ETH_SRC = 305,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 306,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 307,
    OF_BSN_TLV_EXTERNAL_IP = 308,
    OF_BSN_TLV_EXTERNAL_MAC = 309,
    OF_BSN_TLV_EXTERNAL_NETMASK = 310,
    ...
    OF_BSN_TLV_INTERVAL = 317,
    OF_BSN_TLV_IPV4 = 318,
    OF_BSN_TLV_IPV4_DST = 319,
    OF_BSN_TLV_IPV4_NETMASK = 320,
    OF_BSN_TLV_IPV4_SRC = 321,
    OF_BSN_TLV_MAC = 322,
    OF_BSN_TLV_MAC_MASK = 323,
    OF_BSN_TLV_MISS_PACKETS = 324,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 325,
    OF_BSN_TLV_MPLS_LABEL = 326,
    OF_BSN_TLV_MPLS_SEQUENCED = 327,
    OF_BSN_TLV_NAME = 328,
    OF_BSN_TLV_PARTNER_KEY = 329,
    OF_BSN_TLV_PARTNER_PORT_NUM = 330,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 331,
    OF_BSN_TLV_PARTNER_STATE = 332,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 333,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 334,
    OF_BSN_TLV_PORT = 335,
    OF_BSN_TLV_PRIORITY = 336,
    OF_BSN_TLV_QUEUE_ID = 337,
    OF_BSN_TLV_QUEUE_WEIGHT = 338,
    OF_BSN_TLV_REFERENCE = 339,
    OF_BSN_TLV_REPLY_PACKETS = 340,
    OF_BSN_TLV_REQUEST_PACKETS = 341,
    OF_BSN_TLV_RX_PACKETS = 342,
    OF_BSN_TLV_SAMPLING_RATE = 343,
    OF_BSN_TLV_SUB_AGENT_ID = 344,
    OF_BSN_TLV_TX_BYTES = 345,
    OF_BSN_TLV_TX_PACKETS = 346,
    OF_BSN_TLV_UDF_ANCHOR = 347,
    OF_BSN_TLV_UDF_ID = 348,
    OF_BSN_TLV_UDF_LENGTH = 349,
    OF_BSN_TLV_UDF_OFFSET = 350,
    OF_BSN_TLV_UDP_DST = 351,
    OF_BSN_TLV_UDP_SRC = 352,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 353,
    OF_BSN_TLV_VLAN_VID = 354,
    OF_BSN_TLV_VRF = 355,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 356,
    OF_BSN_VPORT = 357,
    OF_BSN_VPORT_L2GRE = 358,
    OF_BSN_VPORT_Q_IN_Q = 359,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 360,
    OF_BUCKET = 361,
    OF_BUCKET_COUNTER = 362,
    OF_BUNDLE_PROP = 363,
    OF_BUNDLE_PROP_EXPERIMENTER = 364,
    OF_FLOW_STATS_ENTRY = 365,
    OF_GROUP_DESC_STATS_ENTRY = 366,
    OF_GROUP_STATS_ENTRY = 367,
    OF_HELLO_ELEM = 368,
    ...
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 374,
    OF_INSTRUCTION_BSN_DENY = 375,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 376,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 377,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 378,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 379,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 380,
    OF_INSTRUCTION_BSN_PERMIT = 381,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 382,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 383,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 384,
    OF_INSTRUCTION_CLEAR_ACTIONS = 385,
    OF_INSTRUCTION_EXPERIMENTER = 386,
    OF_INSTRUCTION_GOTO_TABLE = 387,
    OF_INSTRUCTION_ID = 388,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 389,
    OF_INSTRUCTION_ID_BSN = 390,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 391,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 392,
    OF_INSTRUCTION_ID_BSN_DENY = 393,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 394,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 395,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 396,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 397,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 398,
    OF_INSTRUCTION_ID_BSN_PERMIT = 399,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 400,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 401,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 402,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 403,
    OF_INSTRUCTION_ID_EXPERIMENTER = 404,
    OF_INSTRUCTION_ID_GOTO_TABLE = 405,
    OF_INSTRUCTION_ID_METER = 406,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 407,
    OF_INSTRUCTION_ID_WRITE_METADATA = 408,
    OF_INSTRUCTION_METER = 409,
    OF_INSTRUCTION_WRITE_ACTIONS = 410,
    OF_INSTRUCTION_WRITE_METADATA = 411,
    OF_MATCH_V1 = 412,
    OF_MATCH_V2 = 413,
    OF_MATCH_V3 = 414,
    OF_METER_BAND = 415,
    OF_METER_BAND_DROP = 416,
    OF_METER_BAND_DSCP_REMARK = 417,
    OF_METER_BAND_EXPERIMENTER = 418,
    OF_METER_BAND_STATS = 419,
    OF_METER_CONFIG = 420,
    OF_METER_FEATURES = 421,
    OF_METER_STATS = 422,
    OF_OXM = 423,
    OF_OXM_ARP_OP = 424,
    OF_OXM_ARP_OP_MASKED = 425,
    OF_OXM_ARP_SHA = 426,
    OF_OXM_ARP_SHA_MASKED = 427,
    OF_OXM_ARP_SPA = 428,
    OF_OXM_ARP_SPA_MASKED = 429,
    OF_OXM_ARP_THA = 430,
    OF_OXM_ARP_THA_MASKED = 431,
    OF_OXM_ARP_TPA = 432,
    OF_OXM_ARP_TPA_MASKED = 433,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 434,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 435,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 436,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 437,
    OF_OXM_BSN_IN_PORTS_128 = 438,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 439,
    OF_OXM_BSN_L2_CACHE_HIT = 440,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 441,
    OF_OXM_BSN_L3_DST_CLASS_ID = 442,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 443,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 444,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 445,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 446,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 447,
    OF_OXM_BSN_LAG_ID = 448,
    OF_OXM_BSN_LAG_ID_MASKED = 449,
    OF_OXM_BSN_TCP_FLAGS = 450,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 451,
    OF_OXM_BSN_UDF0 = 452,
    OF_OXM_BSN_UDF0_MASKED = 453,
    OF_OXM_BSN_UDF1 = 454,
    OF_OXM_BSN_UDF1_MASKED = 455,
    OF_OXM_BSN_UDF2 = 456,
    OF_OXM_BSN_UDF2_MASKED = 457,
    OF_OXM_BSN_UDF3 = 458,
    OF_OXM_BSN_UDF3_MASKED = 459,
    OF_OXM_BSN_UDF4 = 460,
    OF_OXM_BSN_UDF4_MASKED = 461,
    OF_OXM_BSN_UDF5 = 462,
    OF_OXM_BSN_UDF5_MASKED = 463,
    OF_OXM_BSN_UDF6 = 464,
    OF_OXM_BSN_UDF6_MASKED = 465,
    OF_OXM_BSN_UDF7 = 466,
    OF_OXM_BSN_UDF7_MASKED = 467,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 468,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 469,
    OF_OXM_BSN_VRF = 470,
    OF_OXM_BSN_VRF_MASKED = 471,
    OF_OXM_ETH_DST = 472,
    OF_OXM_ETH_DST_MASKED = 473,
    OF_OXM_ETH_SRC = 474,
    OF_OXM_ETH_SRC_MASKED = 475,
    OF_OXM_ETH_TYPE = 476,
    OF_OXM_ETH_TYPE_MASKED = 477,
    OF_OXM_ICMPV4_CODE = 478,
    OF_OXM_ICMPV4_CODE_MASKED = 479,
    OF_OXM_ICMPV4_TYPE = 480,
    OF_OXM_ICMPV4_TYPE_MASKED = 481,
    OF_OXM_ICMPV6_CODE = 482,
    OF_OXM_ICMPV6_CODE_MASKED = 483,
    OF_OXM_ICMPV6_TYPE = 484,
    OF_OXM_ICMPV6_TYPE_MASKED = 485,
    OF_OXM_IN_PHY_PORT = 486,
    OF_OXM_IN_PHY_PORT_MASKED = 487,
    OF_OXM_IN_PORT = 488,
    OF_OXM_IN_PORT_MASKED = 489,
    OF_OXM_IP_DSCP = 490,
    OF_OXM_IP_DSCP_MASKED = 491,
    OF_OXM_IP_ECN = 492,
    OF_OXM_IP_ECN_MASKED = 493,
    OF_OXM_IP_PROTO = 494,
    OF_OXM_IP_PROTO_MASKED = 495,
    OF_OXM_IPV4_DST = 496,
    OF_OXM_IPV4_DST_MASKED = 497,
    OF_OXM_IPV4_SRC = 498,
    OF_OXM_IPV4_SRC_MASKED = 499,
    OF_OXM_IPV6_DST = 500,
    OF_OXM_IPV6_DST_MASKED = 501,
    OF_OXM_IPV6_EXTHDR = 502,
    OF_OXM_IPV6_EXTHDR_MASKED = 503,
    OF_OXM_IPV6_FLABEL = 504,
    OF_OXM_IPV6_FLABEL_MASKED = 505,
    OF_OXM_IPV6_ND_SLL = 506,
    OF_OXM_IPV6_ND_SLL_MASKED = 507,
    OF_OXM_IPV6_ND_TARGET = 508,
    OF_OXM_IPV6_ND_TARGET_MASKED = 509,
    OF_OXM_IPV6_ND_TLL = 510,
    OF_OXM_IPV6_ND_TLL_MASKED = 511,
    OF_OXM_IPV6_SRC = 512,
    OF_OXM_IPV6_SRC_MASKED = 513,
    OF_OXM_METADATA = 514,
    OF_OXM_METADATA_MASKED = 515,
    OF_OXM_MPLS_BOS = 516,
    OF_OXM_MPLS_BOS_MASKED = 517,
    OF_OXM_MPLS_LABEL = 518,
    OF_OXM_MPLS_LABEL_MASKED = 519,
    OF_OXM_MPLS_TC = 520,
    OF_OXM_MPLS_TC_MASKED = 521,
    OF_OXM_PBB_UCA = 522,
    OF_OXM_PBB_UCA_MASKED = 523,
    OF_OXM_SCTP_DST = 524,
    OF_OXM_SCTP_DST_MASKED = 525,
    OF_OXM_SCTP_SRC = 526,
    OF_OXM_SCTP_SRC_MASKED = 527,
    OF_OXM_TCP_DST = 528,
    OF_OXM_TCP_DST_MASKED = 529,
    OF_OXM_TCP_SRC = 530,
    OF_OXM_TCP_SRC_MASKED = 531,
    OF_OXM_TUNNEL_ID = 532,
    OF_OXM_TUNNEL_ID_MASKED = 533,
    OF_OXM_TUNNEL_IPV4_DST = 534,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 535,
    OF_OXM_TUNNEL_IPV4_SRC = 536,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 537,
    OF_OXM_UDP_DST = 538,
    OF_OXM_UDP_DST_MASKED = 539,
    OF_OXM_UDP_SRC = 540,
    OF_OXM_UDP_SRC_MASKED = 541,
    OF_OXM_VLAN_PCP = 542,
    OF_OXM_VLAN_PCP_MASKED = 543,
    OF_OXM_VLAN_VID = 544,
    OF_OXM_VLAN_VID_MASKED = 545,
    OF_PACKET_QUEUE = 546,
    OF_PORT_DESC = 547,
    OF_PORT_DESC_PROP = 548,
    OF_PORT_DESC_PROP_ETHERNET = 549,
    OF_PORT_DESC_PROP_EXPERIMENTER = 550,
    OF_PORT_DESC_PROP_OPTICAL = 551,
    OF_PORT_MOD_PROP = 552,
    OF_PORT_MOD_PROP_ETHERNET = 553,
    OF_PORT_MOD_PROP_EXPERIMENTER = 554,
    OF_PORT_MOD_PROP_OPTICAL = 555,
    OF_PORT_STATS_ENTRY = 556,
    OF_PORT_STATS_PROP = 557,
    OF_PORT_STATS_PROP_ETHERNET = 558,
    OF_PORT_STATS_PROP_EXPERIMENTER = 559,
    OF_PORT_STATS_PROP_OPTICAL = 560,
    OF_QUEUE_DESC = 561,
    OF_QUEUE_DESC_PROP = 562,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 563,
    OF_QUEUE_DESC_PROP_MAX_RATE = 564,
    OF_QUEUE_DESC_PROP_MIN_RATE = 565,
    OF_QUEUE_PROP = 566,
    OF_QUEUE_PROP_EXPERIMENTER = 567,
    ...
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 583,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 584,
    OF_TABLE_FEATURE_PROP_MATCH = 585,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 586,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 587,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 588,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 589,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 590,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 591,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 592,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 593,
    OF_TABLE_FEATURES = 594,
    OF_TABLE_MOD_PROP = 595,
    OF_TABLE_MOD_PROP_EVICTION = 596,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 597,
    OF_TABLE_MOD_PROP_VACANCY = 598,
    OF_TABLE_STATS_ENTRY = 599,
    OF_UINT32 = 600,
    OF_UINT64 = 601,
    OF_UINT8 = 602,
    ...
    /* List objects */
    OF_LIST_ACTION = 603,
    OF_LIST_ACTION_ID = 604,
    OF_LIST_ASYNC_CONFIG_PROP = 605,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 606,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 607,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 608,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 609,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 610,
