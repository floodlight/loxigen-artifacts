...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 405,
    OF_BSN_TLV_UNICAST_RATE = 406,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 407,
    OF_BSN_TLV_UNTAGGED = 408,
    OF_BSN_TLV_USE_PACKET_STATE = 409,
    OF_BSN_TLV_VFI = 410,
    OF_BSN_TLV_VFP_CLASS_ID = 411,
    OF_BSN_TLV_VLAN_MAC_LIST = 412,
    OF_BSN_TLV_VLAN_PCP = 413,
    OF_BSN_TLV_VLAN_VID = 414,
    OF_BSN_TLV_VLAN_VID_MASK = 415,
    OF_BSN_TLV_VNI = 416,
    OF_BSN_TLV_VPN_KEY = 417,
    OF_BSN_TLV_VRF = 418,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 419,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 420,
    OF_BSN_VLAN_MAC = 421,
    OF_BSN_VPORT = 422,
    OF_BSN_VPORT_L2GRE = 423,
    OF_BSN_VPORT_Q_IN_Q = 424,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 425,
    OF_BUCKET = 426,
    OF_BUCKET_COUNTER = 427,
    OF_BUNDLE_PROP = 428,
    OF_BUNDLE_PROP_EXPERIMENTER = 429,
    OF_FLOW_STATS_ENTRY = 430,
    OF_GROUP_DESC_STATS_ENTRY = 431,
    OF_GROUP_STATS_ENTRY = 432,
    OF_HELLO_ELEM = 433,
    OF_HELLO_ELEM_VERSIONBITMAP = 434,
    OF_INSTRUCTION = 435,
    OF_INSTRUCTION_APPLY_ACTIONS = 436,
    OF_INSTRUCTION_BSN = 437,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 438,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 439,
    OF_INSTRUCTION_BSN_DENY = 440,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 441,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 442,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 443,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 444,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 445,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 446,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 447,
    OF_INSTRUCTION_BSN_PERMIT = 448,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 449,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 450,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 451,
    OF_INSTRUCTION_CLEAR_ACTIONS = 452,
    OF_INSTRUCTION_EXPERIMENTER = 453,
    OF_INSTRUCTION_GOTO_TABLE = 454,
    OF_INSTRUCTION_ID = 455,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 456,
    OF_INSTRUCTION_ID_BSN = 457,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 458,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 459,
    OF_INSTRUCTION_ID_BSN_DENY = 460,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 461,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 462,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 463,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 464,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 465,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 466,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 467,
    OF_INSTRUCTION_ID_BSN_PERMIT = 468,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 469,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 470,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 471,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 472,
    OF_INSTRUCTION_ID_EXPERIMENTER = 473,
    OF_INSTRUCTION_ID_GOTO_TABLE = 474,
    OF_INSTRUCTION_ID_METER = 475,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 476,
    OF_INSTRUCTION_ID_WRITE_METADATA = 477,
    OF_INSTRUCTION_METER = 478,
    OF_INSTRUCTION_WRITE_ACTIONS = 479,
    OF_INSTRUCTION_WRITE_METADATA = 480,
    OF_MATCH_V1 = 481,
    OF_MATCH_V2 = 482,
    OF_MATCH_V3 = 483,
    OF_METER_BAND = 484,
    OF_METER_BAND_DROP = 485,
    OF_METER_BAND_DSCP_REMARK = 486,
    OF_METER_BAND_EXPERIMENTER = 487,
    OF_METER_BAND_STATS = 488,
    OF_METER_CONFIG = 489,
    OF_METER_FEATURES = 490,
    OF_METER_STATS = 491,
    OF_OXM = 492,
    OF_OXM_ARP_OP = 493,
    OF_OXM_ARP_OP_MASKED = 494,
    OF_OXM_ARP_SHA = 495,
    OF_OXM_ARP_SHA_MASKED = 496,
    OF_OXM_ARP_SPA = 497,
    OF_OXM_ARP_SPA_MASKED = 498,
    OF_OXM_ARP_THA = 499,
    OF_OXM_ARP_THA_MASKED = 500,
    OF_OXM_ARP_TPA = 501,
    OF_OXM_ARP_TPA_MASKED = 502,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 503,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 504,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 505,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 506,
    OF_OXM_BSN_IN_PORTS_128 = 507,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 508,
    OF_OXM_BSN_IN_PORTS_512 = 509,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 510,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 511,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 512,
    OF_OXM_BSN_INNER_ETH_DST = 513,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 514,
    OF_OXM_BSN_INNER_ETH_SRC = 515,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 516,
    OF_OXM_BSN_INNER_VLAN_VID = 517,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 518,
    OF_OXM_BSN_L2_CACHE_HIT = 519,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 520,
    OF_OXM_BSN_L3_DST_CLASS_ID = 521,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 522,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 523,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 524,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 525,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 526,
    OF_OXM_BSN_LAG_ID = 527,
    OF_OXM_BSN_LAG_ID_MASKED = 528,
    OF_OXM_BSN_TCP_FLAGS = 529,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 530,
    OF_OXM_BSN_UDF0 = 531,
    OF_OXM_BSN_UDF0_MASKED = 532,
    OF_OXM_BSN_UDF1 = 533,
    OF_OXM_BSN_UDF1_MASKED = 534,
    OF_OXM_BSN_UDF2 = 535,
    OF_OXM_BSN_UDF2_MASKED = 536,
    OF_OXM_BSN_UDF3 = 537,
    OF_OXM_BSN_UDF3_MASKED = 538,
    OF_OXM_BSN_UDF4 = 539,
    OF_OXM_BSN_UDF4_MASKED = 540,
    OF_OXM_BSN_UDF5 = 541,
    OF_OXM_BSN_UDF5_MASKED = 542,
    OF_OXM_BSN_UDF6 = 543,
    OF_OXM_BSN_UDF6_MASKED = 544,
    OF_OXM_BSN_UDF7 = 545,
    OF_OXM_BSN_UDF7_MASKED = 546,
    OF_OXM_BSN_VFI = 547,
    OF_OXM_BSN_VFI_MASKED = 548,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 549,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 550,
    OF_OXM_BSN_VRF = 551,
    OF_OXM_BSN_VRF_MASKED = 552,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 553,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 554,
    OF_OXM_ETH_DST = 555,
    OF_OXM_ETH_DST_MASKED = 556,
    OF_OXM_ETH_SRC = 557,
    OF_OXM_ETH_SRC_MASKED = 558,
    OF_OXM_ETH_TYPE = 559,
    OF_OXM_ETH_TYPE_MASKED = 560,
    OF_OXM_ICMPV4_CODE = 561,
    OF_OXM_ICMPV4_CODE_MASKED = 562,
    OF_OXM_ICMPV4_TYPE = 563,
    OF_OXM_ICMPV4_TYPE_MASKED = 564,
    OF_OXM_ICMPV6_CODE = 565,
    OF_OXM_ICMPV6_CODE_MASKED = 566,
    OF_OXM_ICMPV6_TYPE = 567,
    OF_OXM_ICMPV6_TYPE_MASKED = 568,
    OF_OXM_IN_PHY_PORT = 569,
    OF_OXM_IN_PHY_PORT_MASKED = 570,
    OF_OXM_IN_PORT = 571,
    OF_OXM_IN_PORT_MASKED = 572,
    OF_OXM_IP_DSCP = 573,
    OF_OXM_IP_DSCP_MASKED = 574,
    OF_OXM_IP_ECN = 575,
    OF_OXM_IP_ECN_MASKED = 576,
    OF_OXM_IP_PROTO = 577,
    OF_OXM_IP_PROTO_MASKED = 578,
    OF_OXM_IPV4_DST = 579,
    OF_OXM_IPV4_DST_MASKED = 580,
    OF_OXM_IPV4_SRC = 581,
    OF_OXM_IPV4_SRC_MASKED = 582,
    OF_OXM_IPV6_DST = 583,
    OF_OXM_IPV6_DST_MASKED = 584,
    OF_OXM_IPV6_EXTHDR = 585,
    OF_OXM_IPV6_EXTHDR_MASKED = 586,
    OF_OXM_IPV6_FLABEL = 587,
    OF_OXM_IPV6_FLABEL_MASKED = 588,
    OF_OXM_IPV6_ND_SLL = 589,
    OF_OXM_IPV6_ND_SLL_MASKED = 590,
    OF_OXM_IPV6_ND_TARGET = 591,
    OF_OXM_IPV6_ND_TARGET_MASKED = 592,
    OF_OXM_IPV6_ND_TLL = 593,
    OF_OXM_IPV6_ND_TLL_MASKED = 594,
    OF_OXM_IPV6_SRC = 595,
    OF_OXM_IPV6_SRC_MASKED = 596,
    OF_OXM_METADATA = 597,
    OF_OXM_METADATA_MASKED = 598,
    OF_OXM_MPLS_BOS = 599,
    OF_OXM_MPLS_BOS_MASKED = 600,
    OF_OXM_MPLS_LABEL = 601,
    OF_OXM_MPLS_LABEL_MASKED = 602,
    OF_OXM_MPLS_TC = 603,
    OF_OXM_MPLS_TC_MASKED = 604,
    OF_OXM_PBB_UCA = 605,
    OF_OXM_PBB_UCA_MASKED = 606,
    OF_OXM_SCTP_DST = 607,
    OF_OXM_SCTP_DST_MASKED = 608,
    OF_OXM_SCTP_SRC = 609,
    OF_OXM_SCTP_SRC_MASKED = 610,
    OF_OXM_TCP_DST = 611,
    OF_OXM_TCP_DST_MASKED = 612,
    OF_OXM_TCP_SRC = 613,
    OF_OXM_TCP_SRC_MASKED = 614,
    OF_OXM_TUNNEL_ID = 615,
    OF_OXM_TUNNEL_ID_MASKED = 616,
    OF_OXM_TUNNEL_IPV4_DST = 617,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 618,
    OF_OXM_TUNNEL_IPV4_SRC = 619,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 620,
    OF_OXM_UDP_DST = 621,
    OF_OXM_UDP_DST_MASKED = 622,
    OF_OXM_UDP_SRC = 623,
    OF_OXM_UDP_SRC_MASKED = 624,
    OF_OXM_VLAN_PCP = 625,
    OF_OXM_VLAN_PCP_MASKED = 626,
    OF_OXM_VLAN_VID = 627,
    OF_OXM_VLAN_VID_MASKED = 628,
    OF_PACKET_QUEUE = 629,
    OF_PORT_DESC = 630,
    OF_PORT_DESC_PROP = 631,
    OF_PORT_DESC_PROP_BSN = 632,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 633,
    OF_PORT_DESC_PROP_BSN_UPLINK = 634,
    OF_PORT_DESC_PROP_ETHERNET = 635,
    OF_PORT_DESC_PROP_EXPERIMENTER = 636,
    OF_PORT_DESC_PROP_OPTICAL = 637,
    OF_PORT_MOD_PROP = 638,
    OF_PORT_MOD_PROP_ETHERNET = 639,
    OF_PORT_MOD_PROP_EXPERIMENTER = 640,
    OF_PORT_MOD_PROP_OPTICAL = 641,
    OF_PORT_STATS_ENTRY = 642,
    OF_PORT_STATS_PROP = 643,
    OF_PORT_STATS_PROP_ETHERNET = 644,
    OF_PORT_STATS_PROP_EXPERIMENTER = 645,
    OF_PORT_STATS_PROP_OPTICAL = 646,
    OF_QUEUE_DESC = 647,
    OF_QUEUE_DESC_PROP = 648,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 649,
    OF_QUEUE_DESC_PROP_MAX_RATE = 650,
    OF_QUEUE_DESC_PROP_MIN_RATE = 651,
    OF_QUEUE_PROP = 652,
    OF_QUEUE_PROP_EXPERIMENTER = 653,
    OF_QUEUE_PROP_MAX_RATE = 654,
    OF_QUEUE_PROP_MIN_RATE = 655,
    OF_QUEUE_STATS_ENTRY = 656,
    OF_QUEUE_STATS_PROP = 657,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 658,
    OF_ROLE_PROP = 659,
    OF_ROLE_PROP_EXPERIMENTER = 660,
    OF_TABLE_DESC = 661,
    OF_TABLE_FEATURE_PROP = 662,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 663,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 664,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 665,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 666,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 667,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 668,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 669,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 670,
    OF_TABLE_FEATURE_PROP_MATCH = 671,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 672,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 673,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 674,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 675,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 676,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 677,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 678,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 679,
    OF_TABLE_FEATURES = 680,
    OF_TABLE_MOD_PROP = 681,
    OF_TABLE_MOD_PROP_EVICTION = 682,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 683,
    OF_TABLE_MOD_PROP_VACANCY = 684,
    OF_TABLE_STATS_ENTRY = 685,
    OF_UINT32 = 686,
    OF_UINT64 = 687,
    OF_UINT8 = 688,
    ...
    /* List objects */
    OF_LIST_ACTION = 689,
    OF_LIST_ACTION_ID = 690,
    OF_LIST_ASYNC_CONFIG_PROP = 691,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 692,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 693,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 694,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 695,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 696,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 697,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 698,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 699,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 700,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 701,
    OF_LIST_BSN_INTERFACE = 702,
    OF_LIST_BSN_LACP_STATS_ENTRY = 703,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 704,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 705,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 706,
    OF_LIST_BSN_TLV = 707,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 708,
    OF_LIST_BSN_VLAN_MAC = 709,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 710,
    OF_LIST_BUCKET = 711,
    OF_LIST_BUCKET_COUNTER = 712,
    OF_LIST_BUNDLE_PROP = 713,
    OF_LIST_FLOW_STATS_ENTRY = 714,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 715,
    OF_LIST_GROUP_STATS_ENTRY = 716,
    OF_LIST_HELLO_ELEM = 717,
    OF_LIST_INSTRUCTION = 718,
    OF_LIST_INSTRUCTION_ID = 719,
    OF_LIST_METER_BAND = 720,
    OF_LIST_METER_BAND_STATS = 721,
    OF_LIST_METER_CONFIG = 722,
    OF_LIST_METER_STATS = 723,
    OF_LIST_OXM = 724,
    OF_LIST_PACKET_QUEUE = 725,
    OF_LIST_PORT_DESC = 726,
    OF_LIST_PORT_DESC_PROP = 727,
    OF_LIST_PORT_MOD_PROP = 728,
    OF_LIST_PORT_STATS_ENTRY = 729,
    OF_LIST_PORT_STATS_PROP = 730,
    OF_LIST_QUEUE_DESC = 731,
    OF_LIST_QUEUE_DESC_PROP = 732,
    OF_LIST_QUEUE_PROP = 733,
    OF_LIST_QUEUE_STATS_ENTRY = 734,
    OF_LIST_QUEUE_STATS_PROP = 735,
    OF_LIST_ROLE_PROP = 736,
    OF_LIST_TABLE_DESC = 737,
    OF_LIST_TABLE_FEATURE_PROP = 738,
    OF_LIST_TABLE_FEATURES = 739,
    OF_LIST_TABLE_MOD_PROP = 740,
    OF_LIST_TABLE_STATS_ENTRY = 741,
    OF_LIST_UINT32 = 742,
    OF_LIST_UINT64 = 743,
    OF_LIST_UINT8 = 744,
