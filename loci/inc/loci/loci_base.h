...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_BFD_ENDPOINT = 313,
    OF_BSN_TLV_BFD_STATE = 314,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 315,
    OF_BSN_TLV_BROADCAST_RATE = 316,
    OF_BSN_TLV_BUCKET = 317,
    OF_BSN_TLV_CIRCUIT_ID = 318,
    OF_BSN_TLV_CONVERGENCE_STATUS = 319,
    OF_BSN_TLV_CPU_LAG = 320,
    OF_BSN_TLV_CRC_ENABLED = 321,
    OF_BSN_TLV_DATA = 322,
    OF_BSN_TLV_DATA_MASK = 323,
    OF_BSN_TLV_DECAP = 324,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 325,
    OF_BSN_TLV_DISABLE_XMIT = 326,
    OF_BSN_TLV_DNS_ANALYTICS = 327,
    OF_BSN_TLV_DROP = 328,
    OF_BSN_TLV_DROP_CONTROL = 329,
    OF_BSN_TLV_DSCP = 330,
    OF_BSN_TLV_ECN = 331,
    OF_BSN_TLV_EGRESS_ONLY = 332,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 333,
    OF_BSN_TLV_ENCAP = 334,
    ...
    OF_BSN_TLV_FLOW_CLASSIFIER = 346,
    OF_BSN_TLV_FLOW_CLASSIFY = 347,
    OF_BSN_TLV_FLOW_IDENTIFIER = 348,
    OF_BSN_TLV_FORCE_LINK_UP = 349,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 350,
    OF_BSN_TLV_GENERATION_ID = 351,
    OF_BSN_TLV_HASH_ALGORITHM = 352,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 353,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 354,
    OF_BSN_TLV_HASH_PACKET_FIELD = 355,
    OF_BSN_TLV_HASH_PACKET_TYPE = 356,
    OF_BSN_TLV_HASH_SEED = 357,
    OF_BSN_TLV_HASH_TYPE = 358,
    OF_BSN_TLV_HEADER_SIZE = 359,
    OF_BSN_TLV_ICMP_CODE = 360,
    OF_BSN_TLV_ICMP_ID = 361,
    OF_BSN_TLV_ICMP_TYPE = 362,
    OF_BSN_TLV_ICMPV6_CHKSUM = 363,
    OF_BSN_TLV_IDENTIFIER = 364,
    OF_BSN_TLV_IDLE_NOTIFICATION = 365,
    OF_BSN_TLV_IDLE_TIME = 366,
    OF_BSN_TLV_IDLE_TIMEOUT = 367,
    OF_BSN_TLV_IGMP_SNOOPING = 368,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 369,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 370,
    OF_BSN_TLV_INTERNAL_MAC = 371,
    OF_BSN_TLV_INTERVAL = 372,
    OF_BSN_TLV_IP_PROTO = 373,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 374,
    OF_BSN_TLV_IPV4 = 375,
    OF_BSN_TLV_IPV4_DST = 376,
    OF_BSN_TLV_IPV4_NETMASK = 377,
    OF_BSN_TLV_IPV4_SRC = 378,
    OF_BSN_TLV_IPV6 = 379,
    OF_BSN_TLV_IPV6_DST = 380,
    OF_BSN_TLV_IPV6_PREFIX = 381,
    OF_BSN_TLV_IPV6_SRC = 382,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 383,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 384,
    OF_BSN_TLV_L3 = 385,
    OF_BSN_TLV_L3_DST_CLASS_ID = 386,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 387,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 388,
    OF_BSN_TLV_LAG_OPTIONS = 389,
    OF_BSN_TLV_LOOPBACK_MODE = 390,
    OF_BSN_TLV_LOOPBACK_PORT = 391,
    OF_BSN_TLV_LOSSLESS = 392,
    OF_BSN_TLV_LR_ALL_ENABLED = 393,
    OF_BSN_TLV_MAC = 394,
    OF_BSN_TLV_MAC_MASK = 395,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 396,
    OF_BSN_TLV_MISS_PACKETS = 397,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 398,
    OF_BSN_TLV_MPLS_LABEL = 399,
    OF_BSN_TLV_MPLS_SEQUENCED = 400,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 401,
    OF_BSN_TLV_MULTICAST_PACKET = 402,
    OF_BSN_TLV_MULTIPLIER = 403,
    OF_BSN_TLV_NAME = 404,
    OF_BSN_TLV_NDP_OFFLOAD = 405,
    OF_BSN_TLV_NDP_STATIC = 406,
    OF_BSN_TLV_NEGATE = 407,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 408,
    OF_BSN_TLV_NEXT_HOP_MAC = 409,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 410,
    OF_BSN_TLV_NO_ARP_RESPONSE = 411,
    OF_BSN_TLV_NO_NS_RESPONSE = 412,
    OF_BSN_TLV_OFFSET = 413,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 414,
    OF_BSN_TLV_OUTER_SRC_MAC = 415,
    OF_BSN_TLV_PARENT_PORT = 416,
    OF_BSN_TLV_PARTNER_KEY = 417,
    OF_BSN_TLV_PARTNER_PORT_NUM = 418,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 419,
    OF_BSN_TLV_PARTNER_STATE = 420,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 421,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 422,
    OF_BSN_TLV_PASSIVE = 423,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 424,
    OF_BSN_TLV_PIM_DR = 425,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 426,
    OF_BSN_TLV_PORT = 427,
    OF_BSN_TLV_PORT_MODE = 428,
    OF_BSN_TLV_PORT_SPEED_GBPS = 429,
    OF_BSN_TLV_PORT_USAGE = 430,
    OF_BSN_TLV_PORT_VXLAN_MODE = 431,
    OF_BSN_TLV_PRESERVE_VLAN = 432,
    ...
    OF_BSN_TLV_REDUNDANT_MGMT = 442,
    OF_BSN_TLV_REFERENCE = 443,
    OF_BSN_TLV_REPLY_PACKETS = 444,
    OF_BSN_TLV_REQUEST_PACKETS = 445,
    OF_BSN_TLV_REST_SERVER = 446,
    OF_BSN_TLV_ROUTING_PARAM = 447,
    OF_BSN_TLV_RX_BYTES = 448,
    OF_BSN_TLV_RX_PACKETS = 449,
    OF_BSN_TLV_SAMPLING_RATE = 450,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 451,
    OF_BSN_TLV_SRC_MAC_CML = 452,
    OF_BSN_TLV_STATUS = 453,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 454,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 455,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 456,
    OF_BSN_TLV_SUB_AGENT_ID = 457,
    OF_BSN_TLV_TCP_DST = 458,
    OF_BSN_TLV_TCP_FLAGS = 459,
    OF_BSN_TLV_TCP_SRC = 460,
    OF_BSN_TLV_TIMESTAMP = 461,
    OF_BSN_TLV_TTL = 462,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 463,
    OF_BSN_TLV_TX_BYTES = 464,
    OF_BSN_TLV_TX_PACKETS = 465,
    OF_BSN_TLV_UDF_ANCHOR = 466,
    OF_BSN_TLV_UDF_CAPABILITY = 467,
    OF_BSN_TLV_UDF_ID = 468,
    OF_BSN_TLV_UDF_LENGTH = 469,
    OF_BSN_TLV_UDF_OFFSET = 470,
    OF_BSN_TLV_UDP_DST = 471,
    OF_BSN_TLV_UDP_SRC = 472,
    OF_BSN_TLV_UINT32 = 473,
    OF_BSN_TLV_UINT64_LIST = 474,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 475,
    OF_BSN_TLV_UNICAST_RATE = 476,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 477,
    OF_BSN_TLV_UNTAGGED = 478,
    OF_BSN_TLV_UPGRADE = 479,
    OF_BSN_TLV_URI_SCHEME = 480,
    OF_BSN_TLV_USE_PACKET_STATE = 481,
    OF_BSN_TLV_USER_CONFIGURED = 482,
    OF_BSN_TLV_VFI = 483,
    OF_BSN_TLV_VFP_CLASS_ID = 484,
    OF_BSN_TLV_VIRTUAL = 485,
    OF_BSN_TLV_VLAN_MAC_LIST = 486,
    OF_BSN_TLV_VLAN_PCP = 487,
    OF_BSN_TLV_VLAN_VID = 488,
    OF_BSN_TLV_VLAN_VID_MASK = 489,
    OF_BSN_TLV_VNI = 490,
    OF_BSN_TLV_VPN_KEY = 491,
    OF_BSN_TLV_VRF = 492,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 493,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 494,
    OF_BSN_VLAN_MAC = 495,
    OF_BSN_VPORT = 496,
    OF_BSN_VPORT_L2GRE = 497,
    OF_BSN_VPORT_Q_IN_Q = 498,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 499,
    OF_BUCKET = 500,
    OF_BUCKET_COUNTER = 501,
    OF_BUNDLE_PROP = 502,
    OF_BUNDLE_PROP_EXPERIMENTER = 503,
    OF_FLOW_STATS_ENTRY = 504,
    OF_GROUP_DESC_STATS_ENTRY = 505,
    OF_GROUP_STATS_ENTRY = 506,
    OF_HELLO_ELEM = 507,
    OF_HELLO_ELEM_VERSIONBITMAP = 508,
    OF_INSTRUCTION = 509,
    OF_INSTRUCTION_APPLY_ACTIONS = 510,
    OF_INSTRUCTION_BSN = 511,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 512,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 513,
    OF_INSTRUCTION_BSN_DENY = 514,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 515,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 516,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 517,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 518,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 519,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 520,
    OF_INSTRUCTION_BSN_HASH_SELECT = 521,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 522,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 523,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 524,
    OF_INSTRUCTION_BSN_PERMIT = 525,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 526,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 527,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 528,
    OF_INSTRUCTION_CLEAR_ACTIONS = 529,
    OF_INSTRUCTION_EXPERIMENTER = 530,
    OF_INSTRUCTION_GOTO_TABLE = 531,
    OF_INSTRUCTION_ID = 532,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 533,
    OF_INSTRUCTION_ID_BSN = 534,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 535,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 536,
    OF_INSTRUCTION_ID_BSN_DENY = 537,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 538,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 539,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 540,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 541,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 542,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 543,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 544,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 545,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 546,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 547,
    OF_INSTRUCTION_ID_BSN_PERMIT = 548,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 549,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 550,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 551,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 552,
    OF_INSTRUCTION_ID_EXPERIMENTER = 553,
    OF_INSTRUCTION_ID_GOTO_TABLE = 554,
    OF_INSTRUCTION_ID_METER = 555,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 556,
    OF_INSTRUCTION_ID_WRITE_METADATA = 557,
    OF_INSTRUCTION_METER = 558,
    OF_INSTRUCTION_WRITE_ACTIONS = 559,
    OF_INSTRUCTION_WRITE_METADATA = 560,
    OF_MATCH_V1 = 561,
    OF_MATCH_V2 = 562,
    OF_MATCH_V3 = 563,
    OF_METER_BAND = 564,
    OF_METER_BAND_DROP = 565,
    OF_METER_BAND_DSCP_REMARK = 566,
    OF_METER_BAND_EXPERIMENTER = 567,
    OF_METER_BAND_STATS = 568,
    OF_METER_CONFIG = 569,
    OF_METER_FEATURES = 570,
    OF_METER_STATS = 571,
    OF_OXM = 572,
    OF_OXM_ARP_OP = 573,
    OF_OXM_ARP_OP_MASKED = 574,
    OF_OXM_ARP_SHA = 575,
    OF_OXM_ARP_SHA_MASKED = 576,
    OF_OXM_ARP_SPA = 577,
    OF_OXM_ARP_SPA_MASKED = 578,
    OF_OXM_ARP_THA = 579,
    OF_OXM_ARP_THA_MASKED = 580,
    OF_OXM_ARP_TPA = 581,
    OF_OXM_ARP_TPA_MASKED = 582,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 583,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 584,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 585,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 586,
    OF_OXM_BSN_IFP_CLASS_ID = 587,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 588,
    OF_OXM_BSN_IN_PORTS_128 = 589,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 590,
    OF_OXM_BSN_IN_PORTS_512 = 591,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 592,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 593,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 594,
    OF_OXM_BSN_INNER_ETH_DST = 595,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 596,
    OF_OXM_BSN_INNER_ETH_SRC = 597,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 598,
    OF_OXM_BSN_INNER_VLAN_VID = 599,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 600,
    OF_OXM_BSN_IP_FRAGMENTATION = 601,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 602,
    OF_OXM_BSN_L2_CACHE_HIT = 603,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 604,
    OF_OXM_BSN_L3_DST_CLASS_ID = 605,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 606,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 607,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 608,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 609,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 610,
    OF_OXM_BSN_LAG_ID = 611,
    OF_OXM_BSN_LAG_ID_MASKED = 612,
    OF_OXM_BSN_TCP_FLAGS = 613,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 614,
    OF_OXM_BSN_UDF0 = 615,
    OF_OXM_BSN_UDF0_MASKED = 616,
    OF_OXM_BSN_UDF1 = 617,
    OF_OXM_BSN_UDF1_MASKED = 618,
    OF_OXM_BSN_UDF2 = 619,
    OF_OXM_BSN_UDF2_MASKED = 620,
    OF_OXM_BSN_UDF3 = 621,
    OF_OXM_BSN_UDF3_MASKED = 622,
    OF_OXM_BSN_UDF4 = 623,
    OF_OXM_BSN_UDF4_MASKED = 624,
    OF_OXM_BSN_UDF5 = 625,
    OF_OXM_BSN_UDF5_MASKED = 626,
    OF_OXM_BSN_UDF6 = 627,
    OF_OXM_BSN_UDF6_MASKED = 628,
    OF_OXM_BSN_UDF7 = 629,
    OF_OXM_BSN_UDF7_MASKED = 630,
    OF_OXM_BSN_VFI = 631,
    OF_OXM_BSN_VFI_MASKED = 632,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 633,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 634,
    OF_OXM_BSN_VRF = 635,
    OF_OXM_BSN_VRF_MASKED = 636,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 637,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 638,
    OF_OXM_CONN_TRACKING_IPV6_DST = 639,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 640,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 641,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 642,
    OF_OXM_CONN_TRACKING_LABEL = 643,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 644,
    OF_OXM_CONN_TRACKING_MARK = 645,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 646,
    OF_OXM_CONN_TRACKING_NW_DST = 647,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 648,
    OF_OXM_CONN_TRACKING_NW_PROTO = 649,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 650,
    OF_OXM_CONN_TRACKING_NW_SRC = 651,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 652,
    OF_OXM_CONN_TRACKING_STATE = 653,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 654,
    OF_OXM_CONN_TRACKING_TP_DST = 655,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 656,
    OF_OXM_CONN_TRACKING_TP_SRC = 657,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 658,
    OF_OXM_CONN_TRACKING_ZONE = 659,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 660,
    OF_OXM_ETH_DST = 661,
    OF_OXM_ETH_DST_MASKED = 662,
    OF_OXM_ETH_SRC = 663,
    OF_OXM_ETH_SRC_MASKED = 664,
    OF_OXM_ETH_TYPE = 665,
    OF_OXM_ETH_TYPE_MASKED = 666,
    OF_OXM_ICMPV4_CODE = 667,
    OF_OXM_ICMPV4_CODE_MASKED = 668,
    OF_OXM_ICMPV4_TYPE = 669,
    OF_OXM_ICMPV4_TYPE_MASKED = 670,
    OF_OXM_ICMPV6_CODE = 671,
    OF_OXM_ICMPV6_CODE_MASKED = 672,
    OF_OXM_ICMPV6_TYPE = 673,
    OF_OXM_ICMPV6_TYPE_MASKED = 674,
    OF_OXM_IN_PHY_PORT = 675,
    OF_OXM_IN_PHY_PORT_MASKED = 676,
    OF_OXM_IN_PORT = 677,
    OF_OXM_IN_PORT_MASKED = 678,
    OF_OXM_IP_DSCP = 679,
    OF_OXM_IP_DSCP_MASKED = 680,
    OF_OXM_IP_ECN = 681,
    OF_OXM_IP_ECN_MASKED = 682,
    OF_OXM_IP_PROTO = 683,
    OF_OXM_IP_PROTO_MASKED = 684,
    OF_OXM_IPV4_DST = 685,
    OF_OXM_IPV4_DST_MASKED = 686,
    OF_OXM_IPV4_SRC = 687,
    OF_OXM_IPV4_SRC_MASKED = 688,
    OF_OXM_IPV6_DST = 689,
    OF_OXM_IPV6_DST_MASKED = 690,
    OF_OXM_IPV6_EXTHDR = 691,
    OF_OXM_IPV6_EXTHDR_MASKED = 692,
    OF_OXM_IPV6_FLABEL = 693,
    OF_OXM_IPV6_FLABEL_MASKED = 694,
    OF_OXM_IPV6_ND_SLL = 695,
    OF_OXM_IPV6_ND_SLL_MASKED = 696,
    OF_OXM_IPV6_ND_TARGET = 697,
    OF_OXM_IPV6_ND_TARGET_MASKED = 698,
    OF_OXM_IPV6_ND_TLL = 699,
    OF_OXM_IPV6_ND_TLL_MASKED = 700,
    OF_OXM_IPV6_SRC = 701,
    OF_OXM_IPV6_SRC_MASKED = 702,
    OF_OXM_METADATA = 703,
    OF_OXM_METADATA_MASKED = 704,
    OF_OXM_MPLS_BOS = 705,
    OF_OXM_MPLS_BOS_MASKED = 706,
    OF_OXM_MPLS_LABEL = 707,
    OF_OXM_MPLS_LABEL_MASKED = 708,
    OF_OXM_MPLS_TC = 709,
    OF_OXM_MPLS_TC_MASKED = 710,
    OF_OXM_OVS_TCP_FLAGS = 711,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 712,
    OF_OXM_PBB_UCA = 713,
    OF_OXM_PBB_UCA_MASKED = 714,
    OF_OXM_SCTP_DST = 715,
    OF_OXM_SCTP_DST_MASKED = 716,
    OF_OXM_SCTP_SRC = 717,
    OF_OXM_SCTP_SRC_MASKED = 718,
    OF_OXM_TCP_DST = 719,
    OF_OXM_TCP_DST_MASKED = 720,
    OF_OXM_TCP_SRC = 721,
    OF_OXM_TCP_SRC_MASKED = 722,
    OF_OXM_TUNNEL_ID = 723,
    OF_OXM_TUNNEL_ID_MASKED = 724,
    OF_OXM_TUNNEL_IPV4_DST = 725,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 726,
    OF_OXM_TUNNEL_IPV4_SRC = 727,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 728,
    OF_OXM_UDP_DST = 729,
    OF_OXM_UDP_DST_MASKED = 730,
    OF_OXM_UDP_SRC = 731,
    OF_OXM_UDP_SRC_MASKED = 732,
    OF_OXM_VLAN_PCP = 733,
    OF_OXM_VLAN_PCP_MASKED = 734,
    OF_OXM_VLAN_VID = 735,
    OF_OXM_VLAN_VID_MASKED = 736,
    OF_PACKET_QUEUE = 737,
    OF_PORT_DESC = 738,
    OF_PORT_DESC_PROP = 739,
    OF_PORT_DESC_PROP_BSN = 740,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 741,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 742,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 743,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 744,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 745,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 746,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 747,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 748,
    OF_PORT_DESC_PROP_BSN_UPLINK = 749,
    OF_PORT_DESC_PROP_ETHERNET = 750,
    OF_PORT_DESC_PROP_EXPERIMENTER = 751,
    OF_PORT_DESC_PROP_OPTICAL = 752,
    OF_PORT_MOD_PROP = 753,
    OF_PORT_MOD_PROP_ETHERNET = 754,
    OF_PORT_MOD_PROP_EXPERIMENTER = 755,
    OF_PORT_MOD_PROP_OPTICAL = 756,
    OF_PORT_STATS_ENTRY = 757,
    OF_PORT_STATS_PROP = 758,
    OF_PORT_STATS_PROP_ETHERNET = 759,
    OF_PORT_STATS_PROP_EXPERIMENTER = 760,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 761,
    OF_PORT_STATS_PROP_OPTICAL = 762,
    OF_QUEUE_DESC = 763,
    OF_QUEUE_DESC_PROP = 764,
    OF_QUEUE_DESC_PROP_BSN = 765,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 766,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 767,
    OF_QUEUE_DESC_PROP_MAX_RATE = 768,
    OF_QUEUE_DESC_PROP_MIN_RATE = 769,
    OF_QUEUE_PROP = 770,
    OF_QUEUE_PROP_EXPERIMENTER = 771,
    OF_QUEUE_PROP_MAX_RATE = 772,
    OF_QUEUE_PROP_MIN_RATE = 773,
    OF_QUEUE_STATS_ENTRY = 774,
    OF_QUEUE_STATS_PROP = 775,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 776,
    OF_ROLE_PROP = 777,
    OF_ROLE_PROP_EXPERIMENTER = 778,
    OF_TABLE_DESC = 779,
    OF_TABLE_FEATURE_PROP = 780,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 781,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 782,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 783,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 784,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 785,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 786,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 787,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 788,
    OF_TABLE_FEATURE_PROP_MATCH = 789,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 790,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 791,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 792,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 793,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 794,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 795,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 796,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 797,
    OF_TABLE_FEATURES = 798,
    OF_TABLE_MOD_PROP = 799,
    OF_TABLE_MOD_PROP_EVICTION = 800,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 801,
    OF_TABLE_MOD_PROP_VACANCY = 802,
    OF_TABLE_STATS_ENTRY = 803,
    OF_UINT32 = 804,
    OF_UINT64 = 805,
    OF_UINT8 = 806,
    ...
    /* List objects */
    OF_LIST_ACTION = 807,
    OF_LIST_ACTION_ID = 808,
    OF_LIST_ASYNC_CONFIG_PROP = 809,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 810,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 811,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 812,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 813,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 814,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 815,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 816,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 817,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 818,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 819,
    OF_LIST_BSN_INTERFACE = 820,
    OF_LIST_BSN_LACP_STATS_ENTRY = 821,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 822,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 823,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 824,
    OF_LIST_BSN_TLV = 825,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 826,
    OF_LIST_BSN_VLAN_MAC = 827,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 828,
    OF_LIST_BUCKET = 829,
    OF_LIST_BUCKET_COUNTER = 830,
    OF_LIST_BUNDLE_PROP = 831,
    OF_LIST_FLOW_STATS_ENTRY = 832,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 833,
    OF_LIST_GROUP_STATS_ENTRY = 834,
    OF_LIST_HELLO_ELEM = 835,
    OF_LIST_INSTRUCTION = 836,
    OF_LIST_INSTRUCTION_ID = 837,
    OF_LIST_METER_BAND = 838,
    OF_LIST_METER_BAND_STATS = 839,
    OF_LIST_METER_CONFIG = 840,
    OF_LIST_METER_STATS = 841,
    OF_LIST_OXM = 842,
    OF_LIST_PACKET_QUEUE = 843,
    OF_LIST_PORT_DESC = 844,
    OF_LIST_PORT_DESC_PROP = 845,
    OF_LIST_PORT_MOD_PROP = 846,
    OF_LIST_PORT_STATS_ENTRY = 847,
    OF_LIST_PORT_STATS_PROP = 848,
    OF_LIST_QUEUE_DESC = 849,
    OF_LIST_QUEUE_DESC_PROP = 850,
    OF_LIST_QUEUE_PROP = 851,
    OF_LIST_QUEUE_STATS_ENTRY = 852,
    OF_LIST_QUEUE_STATS_PROP = 853,
    OF_LIST_ROLE_PROP = 854,
    OF_LIST_TABLE_DESC = 855,
    OF_LIST_TABLE_FEATURE_PROP = 856,
    OF_LIST_TABLE_FEATURES = 857,
    OF_LIST_TABLE_MOD_PROP = 858,
    OF_LIST_TABLE_STATS_ENTRY = 859,
    OF_LIST_UINT32 = 860,
    OF_LIST_UINT64 = 861,
    OF_LIST_UINT8 = 862,
