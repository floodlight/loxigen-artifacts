...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_BFD_ENDPOINT = 314,
    OF_BSN_TLV_BFD_STATE = 315,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 316,
    OF_BSN_TLV_BROADCAST_RATE = 317,
    OF_BSN_TLV_BUCKET = 318,
    OF_BSN_TLV_CIRCUIT_ID = 319,
    OF_BSN_TLV_CONVERGENCE_STATUS = 320,
    OF_BSN_TLV_CPU_LAG = 321,
    OF_BSN_TLV_CRC_ENABLED = 322,
    OF_BSN_TLV_DATA = 323,
    OF_BSN_TLV_DATA_MASK = 324,
    OF_BSN_TLV_DECAP = 325,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 326,
    OF_BSN_TLV_DISABLE_XMIT = 327,
    OF_BSN_TLV_DNS_ANALYTICS = 328,
    OF_BSN_TLV_DROP = 329,
    OF_BSN_TLV_DROP_CONTROL = 330,
    OF_BSN_TLV_DSCP = 331,
    OF_BSN_TLV_ECN = 332,
    OF_BSN_TLV_EGRESS_ONLY = 333,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 334,
    OF_BSN_TLV_EGRESS_SAMPLING_RATE = 335,
    OF_BSN_TLV_ENCAP = 336,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 337,
    OF_BSN_TLV_ETH_DST = 338,
    OF_BSN_TLV_ETH_SRC = 339,
    OF_BSN_TLV_ETH_TYPE = 340,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 341,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 342,
    OF_BSN_TLV_EXTERNAL_IP = 343,
    OF_BSN_TLV_EXTERNAL_MAC = 344,
    OF_BSN_TLV_EXTERNAL_NETMASK = 345,
    OF_BSN_TLV_FABRIC_PORT_ROLE = 346,
    OF_BSN_TLV_FAIL_COUNT = 347,
    OF_BSN_TLV_FLOOD = 348,
    OF_BSN_TLV_FLOW_CLASSIFIER = 349,
    OF_BSN_TLV_FLOW_CLASSIFY = 350,
    OF_BSN_TLV_FLOW_IDENTIFIER = 351,
    OF_BSN_TLV_FORCE_LINK_UP = 352,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 353,
    OF_BSN_TLV_GENERATION_ID = 354,
    OF_BSN_TLV_HASH_ALGORITHM = 355,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 356,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 357,
    OF_BSN_TLV_HASH_PACKET_FIELD = 358,
    OF_BSN_TLV_HASH_PACKET_TYPE = 359,
    OF_BSN_TLV_HASH_SEED = 360,
    OF_BSN_TLV_HASH_TYPE = 361,
    OF_BSN_TLV_HEADER_SIZE = 362,
    OF_BSN_TLV_ICMP_CODE = 363,
    OF_BSN_TLV_ICMP_ID = 364,
    OF_BSN_TLV_ICMP_TYPE = 365,
    OF_BSN_TLV_ICMPV6_CHKSUM = 366,
    OF_BSN_TLV_IDENTIFIER = 367,
    OF_BSN_TLV_IDLE_NOTIFICATION = 368,
    OF_BSN_TLV_IDLE_TIME = 369,
    OF_BSN_TLV_IDLE_TIMEOUT = 370,
    OF_BSN_TLV_IGMP_SNOOPING = 371,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 372,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 373,
    OF_BSN_TLV_INTERNAL_MAC = 374,
    OF_BSN_TLV_INTERVAL = 375,
    OF_BSN_TLV_IP_PROTO = 376,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 377,
    OF_BSN_TLV_IPV4 = 378,
    OF_BSN_TLV_IPV4_DST = 379,
    OF_BSN_TLV_IPV4_NETMASK = 380,
    OF_BSN_TLV_IPV4_SRC = 381,
    OF_BSN_TLV_IPV6 = 382,
    OF_BSN_TLV_IPV6_DST = 383,
    OF_BSN_TLV_IPV6_PREFIX = 384,
    OF_BSN_TLV_IPV6_SRC = 385,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 386,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 387,
    OF_BSN_TLV_L3 = 388,
    OF_BSN_TLV_L3_DST_CLASS_ID = 389,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 390,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 391,
    OF_BSN_TLV_LAG_OPTIONS = 392,
    OF_BSN_TLV_LINK_UP = 393,
    OF_BSN_TLV_LOOPBACK_MODE = 394,
    OF_BSN_TLV_LOOPBACK_PORT = 395,
    OF_BSN_TLV_LOSSLESS = 396,
    OF_BSN_TLV_LR_ALL_ENABLED = 397,
    OF_BSN_TLV_MAC = 398,
    OF_BSN_TLV_MAC_MASK = 399,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 400,
    OF_BSN_TLV_MISS_PACKETS = 401,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 402,
    OF_BSN_TLV_MPLS_LABEL = 403,
    OF_BSN_TLV_MPLS_SEQUENCED = 404,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 405,
    OF_BSN_TLV_MULTICAST_PACKET = 406,
    OF_BSN_TLV_MULTIPLIER = 407,
    OF_BSN_TLV_NAME = 408,
    OF_BSN_TLV_NDP_OFFLOAD = 409,
    OF_BSN_TLV_NDP_STATIC = 410,
    OF_BSN_TLV_NEGATE = 411,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 412,
    OF_BSN_TLV_NEXT_HOP_MAC = 413,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 414,
    OF_BSN_TLV_NO_ARP_RESPONSE = 415,
    OF_BSN_TLV_NO_NS_RESPONSE = 416,
    OF_BSN_TLV_OFFSET = 417,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 418,
    OF_BSN_TLV_OUTER_SRC_MAC = 419,
    OF_BSN_TLV_PARENT_PORT = 420,
    OF_BSN_TLV_PARTNER_KEY = 421,
    OF_BSN_TLV_PARTNER_PORT_NUM = 422,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 423,
    OF_BSN_TLV_PARTNER_STATE = 424,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 425,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 426,
    OF_BSN_TLV_PASSIVE = 427,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 428,
    OF_BSN_TLV_PIM_DR = 429,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 430,
    OF_BSN_TLV_PORT = 431,
    OF_BSN_TLV_PORT_MODE = 432,
    OF_BSN_TLV_PORT_SPEED_GBPS = 433,
    OF_BSN_TLV_PORT_USAGE = 434,
    OF_BSN_TLV_PORT_VXLAN_MODE = 435,
    OF_BSN_TLV_PRESERVE_VLAN = 436,
    OF_BSN_TLV_PRIORITY = 437,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 438,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 439,
    OF_BSN_TLV_QOS_PRIORITY = 440,
    OF_BSN_TLV_QUEUE_ID = 441,
    OF_BSN_TLV_QUEUE_WEIGHT = 442,
    OF_BSN_TLV_RATE_LIMIT = 443,
    OF_BSN_TLV_RATE_UNIT = 444,
    OF_BSN_TLV_RECORD_PACKETS = 445,
    OF_BSN_TLV_REDUNDANT_MGMT = 446,
    OF_BSN_TLV_REFERENCE = 447,
    OF_BSN_TLV_REPLY_PACKETS = 448,
    OF_BSN_TLV_REQUEST_PACKETS = 449,
    OF_BSN_TLV_REST_SERVER = 450,
    OF_BSN_TLV_ROUTING_PARAM = 451,
    OF_BSN_TLV_RX_BYTES = 452,
    OF_BSN_TLV_RX_PACKETS = 453,
    OF_BSN_TLV_SAMPLING_RATE = 454,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 455,
    OF_BSN_TLV_SRC_MAC_CML = 456,
    OF_BSN_TLV_STATUS = 457,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 458,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 459,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 460,
    OF_BSN_TLV_SUB_AGENT_ID = 461,
    OF_BSN_TLV_TCP_DST = 462,
    OF_BSN_TLV_TCP_FLAGS = 463,
    OF_BSN_TLV_TCP_SRC = 464,
    OF_BSN_TLV_TIMESTAMP = 465,
    OF_BSN_TLV_TTL = 466,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 467,
    OF_BSN_TLV_TX_BYTES = 468,
    OF_BSN_TLV_TX_PACKETS = 469,
    OF_BSN_TLV_UDF_ANCHOR = 470,
    OF_BSN_TLV_UDF_CAPABILITY = 471,
    OF_BSN_TLV_UDF_ID = 472,
    OF_BSN_TLV_UDF_LENGTH = 473,
    OF_BSN_TLV_UDF_OFFSET = 474,
    OF_BSN_TLV_UDP_DST = 475,
    OF_BSN_TLV_UDP_SRC = 476,
    OF_BSN_TLV_UINT32 = 477,
    OF_BSN_TLV_UINT64_LIST = 478,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 479,
    OF_BSN_TLV_UNICAST_RATE = 480,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 481,
    OF_BSN_TLV_UNTAGGED = 482,
    OF_BSN_TLV_UPGRADE = 483,
    OF_BSN_TLV_URI_SCHEME = 484,
    OF_BSN_TLV_USE_PACKET_STATE = 485,
    OF_BSN_TLV_USER_CONFIGURED = 486,
    OF_BSN_TLV_VFI = 487,
    OF_BSN_TLV_VFP_CLASS_ID = 488,
    OF_BSN_TLV_VIRTUAL = 489,
    OF_BSN_TLV_VLAN_MAC_LIST = 490,
    OF_BSN_TLV_VLAN_PCP = 491,
    OF_BSN_TLV_VLAN_VID = 492,
    OF_BSN_TLV_VLAN_VID_MASK = 493,
    OF_BSN_TLV_VNI = 494,
    OF_BSN_TLV_VPN_KEY = 495,
    OF_BSN_TLV_VRF = 496,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 497,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 498,
    OF_BSN_VLAN_MAC = 499,
    OF_BSN_VPORT = 500,
    OF_BSN_VPORT_L2GRE = 501,
    OF_BSN_VPORT_Q_IN_Q = 502,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 503,
    OF_BUCKET = 504,
    OF_BUCKET_COUNTER = 505,
    OF_BUNDLE_PROP = 506,
    OF_BUNDLE_PROP_EXPERIMENTER = 507,
    OF_FLOW_STATS_ENTRY = 508,
    OF_GROUP_DESC_STATS_ENTRY = 509,
    OF_GROUP_STATS_ENTRY = 510,
    OF_HELLO_ELEM = 511,
    OF_HELLO_ELEM_VERSIONBITMAP = 512,
    OF_INSTRUCTION = 513,
    OF_INSTRUCTION_APPLY_ACTIONS = 514,
    OF_INSTRUCTION_BSN = 515,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 516,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 517,
    OF_INSTRUCTION_BSN_DENY = 518,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 519,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 520,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 521,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 522,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 523,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 524,
    OF_INSTRUCTION_BSN_HASH_SELECT = 525,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 526,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 527,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 528,
    OF_INSTRUCTION_BSN_PERMIT = 529,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 530,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 531,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 532,
    OF_INSTRUCTION_CLEAR_ACTIONS = 533,
    OF_INSTRUCTION_EXPERIMENTER = 534,
    OF_INSTRUCTION_GOTO_TABLE = 535,
    OF_INSTRUCTION_ID = 536,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 537,
    OF_INSTRUCTION_ID_BSN = 538,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 539,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 540,
    OF_INSTRUCTION_ID_BSN_DENY = 541,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 542,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 543,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 544,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 545,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 546,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 547,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 548,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 549,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 550,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 551,
    OF_INSTRUCTION_ID_BSN_PERMIT = 552,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 553,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 554,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 555,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 556,
    OF_INSTRUCTION_ID_EXPERIMENTER = 557,
    OF_INSTRUCTION_ID_GOTO_TABLE = 558,
    OF_INSTRUCTION_ID_METER = 559,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 560,
    OF_INSTRUCTION_ID_WRITE_METADATA = 561,
    OF_INSTRUCTION_METER = 562,
    OF_INSTRUCTION_WRITE_ACTIONS = 563,
    OF_INSTRUCTION_WRITE_METADATA = 564,
    OF_MATCH_V1 = 565,
    OF_MATCH_V2 = 566,
    OF_MATCH_V3 = 567,
    OF_METER_BAND = 568,
    OF_METER_BAND_DROP = 569,
    OF_METER_BAND_DSCP_REMARK = 570,
    OF_METER_BAND_EXPERIMENTER = 571,
    OF_METER_BAND_STATS = 572,
    OF_METER_CONFIG = 573,
    OF_METER_FEATURES = 574,
    OF_METER_STATS = 575,
    OF_OXM = 576,
    OF_OXM_ARP_OP = 577,
    OF_OXM_ARP_OP_MASKED = 578,
    OF_OXM_ARP_SHA = 579,
    OF_OXM_ARP_SHA_MASKED = 580,
    OF_OXM_ARP_SPA = 581,
    OF_OXM_ARP_SPA_MASKED = 582,
    OF_OXM_ARP_THA = 583,
    OF_OXM_ARP_THA_MASKED = 584,
    OF_OXM_ARP_TPA = 585,
    OF_OXM_ARP_TPA_MASKED = 586,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 587,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 588,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 589,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 590,
    OF_OXM_BSN_IFP_CLASS_ID = 591,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 592,
    OF_OXM_BSN_IN_PORTS_128 = 593,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 594,
    OF_OXM_BSN_IN_PORTS_512 = 595,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 596,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 597,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 598,
    OF_OXM_BSN_INNER_ETH_DST = 599,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 600,
    OF_OXM_BSN_INNER_ETH_SRC = 601,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 602,
    OF_OXM_BSN_INNER_VLAN_VID = 603,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 604,
    OF_OXM_BSN_IP_FRAGMENTATION = 605,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 606,
    OF_OXM_BSN_L2_CACHE_HIT = 607,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 608,
    OF_OXM_BSN_L3_DST_CLASS_ID = 609,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 610,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 611,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 612,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 613,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 614,
    OF_OXM_BSN_LAG_ID = 615,
    OF_OXM_BSN_LAG_ID_MASKED = 616,
    OF_OXM_BSN_TCP_FLAGS = 617,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 618,
    OF_OXM_BSN_UDF0 = 619,
    OF_OXM_BSN_UDF0_MASKED = 620,
    OF_OXM_BSN_UDF1 = 621,
    OF_OXM_BSN_UDF1_MASKED = 622,
    OF_OXM_BSN_UDF2 = 623,
    OF_OXM_BSN_UDF2_MASKED = 624,
    OF_OXM_BSN_UDF3 = 625,
    OF_OXM_BSN_UDF3_MASKED = 626,
    OF_OXM_BSN_UDF4 = 627,
    OF_OXM_BSN_UDF4_MASKED = 628,
    OF_OXM_BSN_UDF5 = 629,
    OF_OXM_BSN_UDF5_MASKED = 630,
    OF_OXM_BSN_UDF6 = 631,
    OF_OXM_BSN_UDF6_MASKED = 632,
    OF_OXM_BSN_UDF7 = 633,
    OF_OXM_BSN_UDF7_MASKED = 634,
    OF_OXM_BSN_VFI = 635,
    OF_OXM_BSN_VFI_MASKED = 636,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 637,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 638,
    OF_OXM_BSN_VRF = 639,
    OF_OXM_BSN_VRF_MASKED = 640,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 641,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 642,
    OF_OXM_CONN_TRACKING_IPV6_DST = 643,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 644,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 645,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 646,
    OF_OXM_CONN_TRACKING_LABEL = 647,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 648,
    OF_OXM_CONN_TRACKING_MARK = 649,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 650,
    OF_OXM_CONN_TRACKING_NW_DST = 651,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 652,
    OF_OXM_CONN_TRACKING_NW_PROTO = 653,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 654,
    OF_OXM_CONN_TRACKING_NW_SRC = 655,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 656,
    OF_OXM_CONN_TRACKING_STATE = 657,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 658,
    OF_OXM_CONN_TRACKING_TP_DST = 659,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 660,
    OF_OXM_CONN_TRACKING_TP_SRC = 661,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 662,
    OF_OXM_CONN_TRACKING_ZONE = 663,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 664,
    OF_OXM_ETH_DST = 665,
    OF_OXM_ETH_DST_MASKED = 666,
    OF_OXM_ETH_SRC = 667,
    OF_OXM_ETH_SRC_MASKED = 668,
    OF_OXM_ETH_TYPE = 669,
    OF_OXM_ETH_TYPE_MASKED = 670,
    OF_OXM_ICMPV4_CODE = 671,
    OF_OXM_ICMPV4_CODE_MASKED = 672,
    OF_OXM_ICMPV4_TYPE = 673,
    OF_OXM_ICMPV4_TYPE_MASKED = 674,
    OF_OXM_ICMPV6_CODE = 675,
    OF_OXM_ICMPV6_CODE_MASKED = 676,
    OF_OXM_ICMPV6_TYPE = 677,
    OF_OXM_ICMPV6_TYPE_MASKED = 678,
    OF_OXM_IN_PHY_PORT = 679,
    OF_OXM_IN_PHY_PORT_MASKED = 680,
    OF_OXM_IN_PORT = 681,
    OF_OXM_IN_PORT_MASKED = 682,
    OF_OXM_IP_DSCP = 683,
    OF_OXM_IP_DSCP_MASKED = 684,
    OF_OXM_IP_ECN = 685,
    OF_OXM_IP_ECN_MASKED = 686,
    OF_OXM_IP_PROTO = 687,
    OF_OXM_IP_PROTO_MASKED = 688,
    OF_OXM_IPV4_DST = 689,
    OF_OXM_IPV4_DST_MASKED = 690,
    OF_OXM_IPV4_SRC = 691,
    OF_OXM_IPV4_SRC_MASKED = 692,
    OF_OXM_IPV6_DST = 693,
    OF_OXM_IPV6_DST_MASKED = 694,
    OF_OXM_IPV6_EXTHDR = 695,
    OF_OXM_IPV6_EXTHDR_MASKED = 696,
    OF_OXM_IPV6_FLABEL = 697,
    OF_OXM_IPV6_FLABEL_MASKED = 698,
    OF_OXM_IPV6_ND_SLL = 699,
    OF_OXM_IPV6_ND_SLL_MASKED = 700,
    OF_OXM_IPV6_ND_TARGET = 701,
    OF_OXM_IPV6_ND_TARGET_MASKED = 702,
    OF_OXM_IPV6_ND_TLL = 703,
    OF_OXM_IPV6_ND_TLL_MASKED = 704,
    OF_OXM_IPV6_SRC = 705,
    OF_OXM_IPV6_SRC_MASKED = 706,
    OF_OXM_METADATA = 707,
    OF_OXM_METADATA_MASKED = 708,
    OF_OXM_MPLS_BOS = 709,
    OF_OXM_MPLS_BOS_MASKED = 710,
    OF_OXM_MPLS_LABEL = 711,
    OF_OXM_MPLS_LABEL_MASKED = 712,
    OF_OXM_MPLS_TC = 713,
    OF_OXM_MPLS_TC_MASKED = 714,
    OF_OXM_OVS_TCP_FLAGS = 715,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 716,
    OF_OXM_PBB_UCA = 717,
    OF_OXM_PBB_UCA_MASKED = 718,
    OF_OXM_SCTP_DST = 719,
    OF_OXM_SCTP_DST_MASKED = 720,
    OF_OXM_SCTP_SRC = 721,
    OF_OXM_SCTP_SRC_MASKED = 722,
    OF_OXM_TCP_DST = 723,
    OF_OXM_TCP_DST_MASKED = 724,
    OF_OXM_TCP_SRC = 725,
    OF_OXM_TCP_SRC_MASKED = 726,
    OF_OXM_TUNNEL_ID = 727,
    OF_OXM_TUNNEL_ID_MASKED = 728,
    OF_OXM_TUNNEL_IPV4_DST = 729,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 730,
    OF_OXM_TUNNEL_IPV4_SRC = 731,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 732,
    OF_OXM_UDP_DST = 733,
    OF_OXM_UDP_DST_MASKED = 734,
    OF_OXM_UDP_SRC = 735,
    OF_OXM_UDP_SRC_MASKED = 736,
    OF_OXM_VLAN_PCP = 737,
    OF_OXM_VLAN_PCP_MASKED = 738,
    OF_OXM_VLAN_VID = 739,
    OF_OXM_VLAN_VID_MASKED = 740,
    OF_PACKET_QUEUE = 741,
    OF_PORT_DESC = 742,
    OF_PORT_DESC_PROP = 743,
    OF_PORT_DESC_PROP_BSN = 744,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 745,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 746,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 747,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 748,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 749,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 750,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 751,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 752,
    OF_PORT_DESC_PROP_BSN_UPLINK = 753,
    OF_PORT_DESC_PROP_ETHERNET = 754,
    OF_PORT_DESC_PROP_EXPERIMENTER = 755,
    OF_PORT_DESC_PROP_OPTICAL = 756,
    OF_PORT_MOD_PROP = 757,
    OF_PORT_MOD_PROP_ETHERNET = 758,
    OF_PORT_MOD_PROP_EXPERIMENTER = 759,
    OF_PORT_MOD_PROP_OPTICAL = 760,
    OF_PORT_STATS_ENTRY = 761,
    OF_PORT_STATS_PROP = 762,
    OF_PORT_STATS_PROP_ETHERNET = 763,
    OF_PORT_STATS_PROP_EXPERIMENTER = 764,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 765,
    OF_PORT_STATS_PROP_OPTICAL = 766,
    OF_QUEUE_DESC = 767,
    OF_QUEUE_DESC_PROP = 768,
    OF_QUEUE_DESC_PROP_BSN = 769,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 770,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 771,
    OF_QUEUE_DESC_PROP_MAX_RATE = 772,
    OF_QUEUE_DESC_PROP_MIN_RATE = 773,
    OF_QUEUE_PROP = 774,
    OF_QUEUE_PROP_EXPERIMENTER = 775,
    OF_QUEUE_PROP_MAX_RATE = 776,
    OF_QUEUE_PROP_MIN_RATE = 777,
    OF_QUEUE_STATS_ENTRY = 778,
    OF_QUEUE_STATS_PROP = 779,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 780,
    OF_ROLE_PROP = 781,
    OF_ROLE_PROP_EXPERIMENTER = 782,
    OF_TABLE_DESC = 783,
    OF_TABLE_FEATURE_PROP = 784,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 785,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 786,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 787,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 788,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 789,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 790,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 791,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 792,
    OF_TABLE_FEATURE_PROP_MATCH = 793,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 794,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 795,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 796,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 797,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 798,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 799,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 800,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 801,
    OF_TABLE_FEATURES = 802,
    OF_TABLE_MOD_PROP = 803,
    OF_TABLE_MOD_PROP_EVICTION = 804,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 805,
    OF_TABLE_MOD_PROP_VACANCY = 806,
    OF_TABLE_STATS_ENTRY = 807,
    OF_UINT32 = 808,
    OF_UINT64 = 809,
    OF_UINT8 = 810,
    ...
    /* List objects */
    OF_LIST_ACTION = 811,
    OF_LIST_ACTION_ID = 812,
    OF_LIST_ASYNC_CONFIG_PROP = 813,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 814,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 815,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 816,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 817,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 818,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 819,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 820,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 821,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 822,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 823,
    OF_LIST_BSN_INTERFACE = 824,
    OF_LIST_BSN_LACP_STATS_ENTRY = 825,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 826,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 827,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 828,
    OF_LIST_BSN_TLV = 829,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 830,
    OF_LIST_BSN_VLAN_MAC = 831,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 832,
    OF_LIST_BUCKET = 833,
    OF_LIST_BUCKET_COUNTER = 834,
    OF_LIST_BUNDLE_PROP = 835,
    OF_LIST_FLOW_STATS_ENTRY = 836,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 837,
    OF_LIST_GROUP_STATS_ENTRY = 838,
    OF_LIST_HELLO_ELEM = 839,
    OF_LIST_INSTRUCTION = 840,
    OF_LIST_INSTRUCTION_ID = 841,
    OF_LIST_METER_BAND = 842,
    OF_LIST_METER_BAND_STATS = 843,
    OF_LIST_METER_CONFIG = 844,
    OF_LIST_METER_STATS = 845,
    OF_LIST_OXM = 846,
    OF_LIST_PACKET_QUEUE = 847,
    OF_LIST_PORT_DESC = 848,
    OF_LIST_PORT_DESC_PROP = 849,
    OF_LIST_PORT_MOD_PROP = 850,
    OF_LIST_PORT_STATS_ENTRY = 851,
    OF_LIST_PORT_STATS_PROP = 852,
    OF_LIST_QUEUE_DESC = 853,
    OF_LIST_QUEUE_DESC_PROP = 854,
    OF_LIST_QUEUE_PROP = 855,
    OF_LIST_QUEUE_STATS_ENTRY = 856,
    OF_LIST_QUEUE_STATS_PROP = 857,
    OF_LIST_ROLE_PROP = 858,
    OF_LIST_TABLE_DESC = 859,
    OF_LIST_TABLE_FEATURE_PROP = 860,
    OF_LIST_TABLE_FEATURES = 861,
    OF_LIST_TABLE_MOD_PROP = 862,
    OF_LIST_TABLE_STATS_ENTRY = 863,
    OF_LIST_UINT32 = 864,
    OF_LIST_UINT64 = 865,
    OF_LIST_UINT8 = 866,
