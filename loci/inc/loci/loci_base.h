...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_DENY = 365,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 366,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 367,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 368,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 369,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 370,
    OF_INSTRUCTION_BSN_PERMIT = 371,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 372,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 373,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 374,
    OF_INSTRUCTION_CLEAR_ACTIONS = 375,
    OF_INSTRUCTION_EXPERIMENTER = 376,
    OF_INSTRUCTION_GOTO_TABLE = 377,
    OF_INSTRUCTION_ID = 378,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 379,
    OF_INSTRUCTION_ID_BSN = 380,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 381,
    OF_INSTRUCTION_ID_BSN_DENY = 382,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 383,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 384,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 385,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 386,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 387,
    OF_INSTRUCTION_ID_BSN_PERMIT = 388,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 389,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 390,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 391,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 392,
    OF_INSTRUCTION_ID_EXPERIMENTER = 393,
    OF_INSTRUCTION_ID_GOTO_TABLE = 394,
    OF_INSTRUCTION_ID_METER = 395,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 396,
    OF_INSTRUCTION_ID_WRITE_METADATA = 397,
    OF_INSTRUCTION_METER = 398,
    OF_INSTRUCTION_WRITE_ACTIONS = 399,
    OF_INSTRUCTION_WRITE_METADATA = 400,
    OF_MATCH_V1 = 401,
    OF_MATCH_V2 = 402,
    OF_MATCH_V3 = 403,
    OF_METER_BAND = 404,
    OF_METER_BAND_DROP = 405,
    OF_METER_BAND_DSCP_REMARK = 406,
    OF_METER_BAND_EXPERIMENTER = 407,
    OF_METER_BAND_STATS = 408,
    OF_METER_CONFIG = 409,
    OF_METER_FEATURES = 410,
    OF_METER_STATS = 411,
    OF_OXM = 412,
    OF_OXM_ARP_OP = 413,
    OF_OXM_ARP_OP_MASKED = 414,
    OF_OXM_ARP_SHA = 415,
    OF_OXM_ARP_SHA_MASKED = 416,
    OF_OXM_ARP_SPA = 417,
    OF_OXM_ARP_SPA_MASKED = 418,
    OF_OXM_ARP_THA = 419,
    OF_OXM_ARP_THA_MASKED = 420,
    OF_OXM_ARP_TPA = 421,
    OF_OXM_ARP_TPA_MASKED = 422,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 423,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 424,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 425,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 426,
    OF_OXM_BSN_IN_PORTS_128 = 427,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 428,
    OF_OXM_BSN_L2_CACHE_HIT = 429,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 430,
    OF_OXM_BSN_L3_DST_CLASS_ID = 431,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 432,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 433,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 434,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 435,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 436,
    OF_OXM_BSN_LAG_ID = 437,
    OF_OXM_BSN_LAG_ID_MASKED = 438,
    OF_OXM_BSN_TCP_FLAGS = 439,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 440,
    OF_OXM_BSN_UDF0 = 441,
    OF_OXM_BSN_UDF0_MASKED = 442,
    OF_OXM_BSN_UDF1 = 443,
    OF_OXM_BSN_UDF1_MASKED = 444,
    OF_OXM_BSN_UDF2 = 445,
    OF_OXM_BSN_UDF2_MASKED = 446,
    OF_OXM_BSN_UDF3 = 447,
    OF_OXM_BSN_UDF3_MASKED = 448,
    OF_OXM_BSN_UDF4 = 449,
    OF_OXM_BSN_UDF4_MASKED = 450,
    OF_OXM_BSN_UDF5 = 451,
    OF_OXM_BSN_UDF5_MASKED = 452,
    OF_OXM_BSN_UDF6 = 453,
    OF_OXM_BSN_UDF6_MASKED = 454,
    OF_OXM_BSN_UDF7 = 455,
    OF_OXM_BSN_UDF7_MASKED = 456,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 457,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 458,
    OF_OXM_BSN_VRF = 459,
    OF_OXM_BSN_VRF_MASKED = 460,
    OF_OXM_ETH_DST = 461,
    OF_OXM_ETH_DST_MASKED = 462,
    OF_OXM_ETH_SRC = 463,
    OF_OXM_ETH_SRC_MASKED = 464,
    OF_OXM_ETH_TYPE = 465,
    OF_OXM_ETH_TYPE_MASKED = 466,
    ...
    OF_OXM_IPV6_EXTHDR = 491,
    OF_OXM_IPV6_EXTHDR_MASKED = 492,
    OF_OXM_IPV6_FLABEL = 493,
    OF_OXM_IPV6_FLABEL_MASKED = 494,
    OF_OXM_IPV6_ND_SLL = 495,
    OF_OXM_IPV6_ND_SLL_MASKED = 496,
    OF_OXM_IPV6_ND_TARGET = 497,
    OF_OXM_IPV6_ND_TARGET_MASKED = 498,
    OF_OXM_IPV6_ND_TLL = 499,
    OF_OXM_IPV6_ND_TLL_MASKED = 500,
    OF_OXM_IPV6_SRC = 501,
    OF_OXM_IPV6_SRC_MASKED = 502,
    OF_OXM_METADATA = 503,
    OF_OXM_METADATA_MASKED = 504,
    OF_OXM_MPLS_BOS = 505,
    OF_OXM_MPLS_BOS_MASKED = 506,
    OF_OXM_MPLS_LABEL = 507,
    OF_OXM_MPLS_LABEL_MASKED = 508,
    OF_OXM_MPLS_TC = 509,
    OF_OXM_MPLS_TC_MASKED = 510,
    OF_OXM_PBB_UCA = 511,
    OF_OXM_PBB_UCA_MASKED = 512,
    OF_OXM_SCTP_DST = 513,
    OF_OXM_SCTP_DST_MASKED = 514,
    OF_OXM_SCTP_SRC = 515,
    OF_OXM_SCTP_SRC_MASKED = 516,
    OF_OXM_TCP_DST = 517,
    OF_OXM_TCP_DST_MASKED = 518,
    OF_OXM_TCP_SRC = 519,
    OF_OXM_TCP_SRC_MASKED = 520,
    OF_OXM_TUNNEL_ID = 521,
    OF_OXM_TUNNEL_ID_MASKED = 522,
    OF_OXM_UDP_DST = 523,
    OF_OXM_UDP_DST_MASKED = 524,
    OF_OXM_UDP_SRC = 525,
    OF_OXM_UDP_SRC_MASKED = 526,
    OF_OXM_VLAN_PCP = 527,
    OF_OXM_VLAN_PCP_MASKED = 528,
    OF_OXM_VLAN_VID = 529,
    OF_OXM_VLAN_VID_MASKED = 530,
    OF_PACKET_QUEUE = 531,
    OF_PORT_DESC = 532,
    OF_PORT_DESC_PROP = 533,
    OF_PORT_DESC_PROP_ETHERNET = 534,
    OF_PORT_DESC_PROP_EXPERIMENTER = 535,
    OF_PORT_DESC_PROP_OPTICAL = 536,
    OF_PORT_MOD_PROP = 537,
    OF_PORT_MOD_PROP_ETHERNET = 538,
    OF_PORT_MOD_PROP_EXPERIMENTER = 539,
    OF_PORT_MOD_PROP_OPTICAL = 540,
    OF_PORT_STATS_ENTRY = 541,
    OF_PORT_STATS_PROP = 542,
    OF_PORT_STATS_PROP_ETHERNET = 543,
    OF_PORT_STATS_PROP_EXPERIMENTER = 544,
    OF_PORT_STATS_PROP_OPTICAL = 545,
    OF_QUEUE_DESC = 546,
    OF_QUEUE_DESC_PROP = 547,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 548,
    OF_QUEUE_DESC_PROP_MAX_RATE = 549,
    OF_QUEUE_DESC_PROP_MIN_RATE = 550,
    OF_QUEUE_PROP = 551,
    OF_QUEUE_PROP_EXPERIMENTER = 552,
    OF_QUEUE_PROP_MAX_RATE = 553,
    OF_QUEUE_PROP_MIN_RATE = 554,
    OF_QUEUE_STATS_ENTRY = 555,
    OF_QUEUE_STATS_PROP = 556,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 557,
    OF_ROLE_PROP = 558,
    OF_ROLE_PROP_EXPERIMENTER = 559,
    OF_TABLE_DESC = 560,
    OF_TABLE_FEATURE_PROP = 561,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 562,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 563,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 564,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 565,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 566,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 567,
    ...
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 573,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 574,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 575,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 576,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 577,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 578,
    OF_TABLE_FEATURES = 579,
    OF_TABLE_MOD_PROP = 580,
    OF_TABLE_MOD_PROP_EVICTION = 581,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 582,
    OF_TABLE_MOD_PROP_VACANCY = 583,
    OF_TABLE_STATS_ENTRY = 584,
    OF_UINT32 = 585,
    OF_UINT64 = 586,
    OF_UINT8 = 587,
    ...
    OF_LIST_ASYNC_CONFIG_PROP = 590,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 591,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 592,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 593,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 594,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 595,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 596,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 597,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 598,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 599,
    OF_LIST_BSN_INTERFACE = 600,
    OF_LIST_BSN_LACP_STATS_ENTRY = 601,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 602,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 603,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 604,
    OF_LIST_BSN_TLV = 605,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 606,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 607,
    OF_LIST_BUCKET = 608,
    OF_LIST_BUCKET_COUNTER = 609,
    OF_LIST_BUNDLE_PROP = 610,
    OF_LIST_FLOW_STATS_ENTRY = 611,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 612,
    OF_LIST_GROUP_STATS_ENTRY = 613,
    OF_LIST_HELLO_ELEM = 614,
    OF_LIST_INSTRUCTION = 615,
    OF_LIST_INSTRUCTION_ID = 616,
    OF_LIST_METER_BAND = 617,
    OF_LIST_METER_BAND_STATS = 618,
    OF_LIST_METER_STATS = 619,
    OF_LIST_OXM = 620,
    OF_LIST_PACKET_QUEUE = 621,
    OF_LIST_PORT_DESC = 622,
    OF_LIST_PORT_DESC_PROP = 623,
    OF_LIST_PORT_MOD_PROP = 624,
    OF_LIST_PORT_STATS_ENTRY = 625,
    OF_LIST_PORT_STATS_PROP = 626,
    OF_LIST_QUEUE_DESC = 627,
    OF_LIST_QUEUE_DESC_PROP = 628,
    OF_LIST_QUEUE_PROP = 629,
    OF_LIST_QUEUE_STATS_ENTRY = 630,
    OF_LIST_QUEUE_STATS_PROP = 631,
    OF_LIST_ROLE_PROP = 632,
    OF_LIST_TABLE_DESC = 633,
    OF_LIST_TABLE_FEATURE_PROP = 634,
    OF_LIST_TABLE_FEATURES = 635,
    OF_LIST_TABLE_MOD_PROP = 636,
    OF_LIST_TABLE_STATS_ENTRY = 637,
    OF_LIST_UINT32 = 638,
    OF_LIST_UINT64 = 639,
    OF_LIST_UINT8 = 640,
