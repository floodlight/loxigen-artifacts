...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV = 303,
    OF_BSN_TLV_ACTOR_KEY = 304,
    OF_BSN_TLV_ACTOR_PORT_NUM = 305,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 306,
    OF_BSN_TLV_ACTOR_STATE = 307,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 308,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 309,
    OF_BSN_TLV_ANCHOR = 310,
    OF_BSN_TLV_APPLY_BYTES = 311,
    OF_BSN_TLV_APPLY_PACKETS = 312,
    OF_BSN_TLV_AUTO_NEGOTIATION = 313,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 314,
    OF_BSN_TLV_BROADCAST_RATE = 315,
    OF_BSN_TLV_BUCKET = 316,
    OF_BSN_TLV_CIRCUIT_ID = 317,
    OF_BSN_TLV_CONVERGENCE_STATUS = 318,
    OF_BSN_TLV_CPU_LAG = 319,
    OF_BSN_TLV_CRC_ENABLED = 320,
    OF_BSN_TLV_DATA = 321,
    OF_BSN_TLV_DATA_MASK = 322,
    OF_BSN_TLV_DECAP = 323,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 324,
    OF_BSN_TLV_DROP = 325,
    OF_BSN_TLV_DSCP = 326,
    OF_BSN_TLV_ECN = 327,
    OF_BSN_TLV_EGRESS_ONLY = 328,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 329,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 330,
    OF_BSN_TLV_ETH_DST = 331,
    OF_BSN_TLV_ETH_SRC = 332,
    OF_BSN_TLV_ETH_TYPE = 333,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 334,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 335,
    OF_BSN_TLV_EXTERNAL_IP = 336,
    OF_BSN_TLV_EXTERNAL_MAC = 337,
    OF_BSN_TLV_EXTERNAL_NETMASK = 338,
    OF_BSN_TLV_GENERATION_ID = 339,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 340,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 341,
    OF_BSN_TLV_HASH_PACKET_FIELD = 342,
    OF_BSN_TLV_HASH_PACKET_TYPE = 343,
    OF_BSN_TLV_HASH_SEED = 344,
    OF_BSN_TLV_HASH_TYPE = 345,
    OF_BSN_TLV_HEADER_SIZE = 346,
    OF_BSN_TLV_ICMP_CODE = 347,
    OF_BSN_TLV_ICMP_ID = 348,
    OF_BSN_TLV_ICMP_TYPE = 349,
    OF_BSN_TLV_ICMPV6_CHKSUM = 350,
    OF_BSN_TLV_IDLE_NOTIFICATION = 351,
    OF_BSN_TLV_IDLE_TIME = 352,
    OF_BSN_TLV_IDLE_TIMEOUT = 353,
    OF_BSN_TLV_IGMP_SNOOPING = 354,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 355,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 356,
    OF_BSN_TLV_INTERNAL_MAC = 357,
    OF_BSN_TLV_INTERVAL = 358,
    OF_BSN_TLV_IP_PROTO = 359,
    OF_BSN_TLV_IPV4 = 360,
    OF_BSN_TLV_IPV4_DST = 361,
    OF_BSN_TLV_IPV4_NETMASK = 362,
    OF_BSN_TLV_IPV4_SRC = 363,
    OF_BSN_TLV_IPV6 = 364,
    OF_BSN_TLV_IPV6_DST = 365,
    OF_BSN_TLV_IPV6_PREFIX = 366,
    OF_BSN_TLV_IPV6_SRC = 367,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 368,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 369,
    OF_BSN_TLV_L3_DST_CLASS_ID = 370,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 371,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 372,
    OF_BSN_TLV_LOOPBACK_PORT = 373,
    OF_BSN_TLV_MAC = 374,
    OF_BSN_TLV_MAC_MASK = 375,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 376,
    OF_BSN_TLV_MISS_PACKETS = 377,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 378,
    OF_BSN_TLV_MPLS_LABEL = 379,
    OF_BSN_TLV_MPLS_SEQUENCED = 380,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 381,
    OF_BSN_TLV_NAME = 382,
    OF_BSN_TLV_NDP_OFFLOAD = 383,
    OF_BSN_TLV_NDP_STATIC = 384,
    OF_BSN_TLV_NEGATE = 385,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 386,
    OF_BSN_TLV_NEXT_HOP_MAC = 387,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 388,
    OF_BSN_TLV_OFFSET = 389,
    OF_BSN_TLV_PARENT_PORT = 390,
    OF_BSN_TLV_PARTNER_KEY = 391,
    OF_BSN_TLV_PARTNER_PORT_NUM = 392,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 393,
    OF_BSN_TLV_PARTNER_STATE = 394,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 395,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 396,
    OF_BSN_TLV_PORT = 397,
    OF_BSN_TLV_PORT_USAGE = 398,
    OF_BSN_TLV_PORT_VXLAN_MODE = 399,
    OF_BSN_TLV_PRIORITY = 400,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 401,
    OF_BSN_TLV_QOS_PRIORITY = 402,
    OF_BSN_TLV_QUEUE_ID = 403,
    OF_BSN_TLV_QUEUE_WEIGHT = 404,
    OF_BSN_TLV_RATE_LIMIT = 405,
    OF_BSN_TLV_RATE_UNIT = 406,
    OF_BSN_TLV_REFERENCE = 407,
    OF_BSN_TLV_REPLY_PACKETS = 408,
    OF_BSN_TLV_REQUEST_PACKETS = 409,
    OF_BSN_TLV_RX_BYTES = 410,
    OF_BSN_TLV_RX_PACKETS = 411,
    OF_BSN_TLV_SAMPLING_RATE = 412,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 413,
    OF_BSN_TLV_STATUS = 414,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 415,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 416,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 417,
    OF_BSN_TLV_SUB_AGENT_ID = 418,
    OF_BSN_TLV_TCP_DST = 419,
    OF_BSN_TLV_TCP_FLAGS = 420,
    OF_BSN_TLV_TCP_SRC = 421,
    OF_BSN_TLV_TTL = 422,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 423,
    OF_BSN_TLV_TX_BYTES = 424,
    OF_BSN_TLV_TX_PACKETS = 425,
    OF_BSN_TLV_UDF_ANCHOR = 426,
    OF_BSN_TLV_UDF_ID = 427,
    OF_BSN_TLV_UDF_LENGTH = 428,
    OF_BSN_TLV_UDF_OFFSET = 429,
    OF_BSN_TLV_UDP_DST = 430,
    OF_BSN_TLV_UDP_SRC = 431,
    OF_BSN_TLV_UINT64_LIST = 432,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 433,
    OF_BSN_TLV_UNICAST_RATE = 434,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 435,
    OF_BSN_TLV_UNTAGGED = 436,
    OF_BSN_TLV_USE_PACKET_STATE = 437,
    OF_BSN_TLV_VFI = 438,
    OF_BSN_TLV_VFP_CLASS_ID = 439,
    OF_BSN_TLV_VLAN_MAC_LIST = 440,
    OF_BSN_TLV_VLAN_PCP = 441,
    OF_BSN_TLV_VLAN_VID = 442,
    OF_BSN_TLV_VLAN_VID_MASK = 443,
    OF_BSN_TLV_VNI = 444,
    OF_BSN_TLV_VPN_KEY = 445,
    OF_BSN_TLV_VRF = 446,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 447,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 448,
    OF_BSN_VLAN_MAC = 449,
    OF_BSN_VPORT = 450,
    OF_BSN_VPORT_L2GRE = 451,
    OF_BSN_VPORT_Q_IN_Q = 452,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 453,
    OF_BUCKET = 454,
    OF_BUCKET_COUNTER = 455,
    OF_BUNDLE_PROP = 456,
    OF_BUNDLE_PROP_EXPERIMENTER = 457,
    OF_FLOW_STATS_ENTRY = 458,
    OF_GROUP_DESC_STATS_ENTRY = 459,
    OF_GROUP_STATS_ENTRY = 460,
    OF_HELLO_ELEM = 461,
    OF_HELLO_ELEM_VERSIONBITMAP = 462,
    OF_INSTRUCTION = 463,
    OF_INSTRUCTION_APPLY_ACTIONS = 464,
    OF_INSTRUCTION_BSN = 465,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 466,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 467,
    OF_INSTRUCTION_BSN_DENY = 468,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 469,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 470,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 471,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 472,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 473,
    OF_INSTRUCTION_BSN_HASH_SELECT = 474,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 475,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 476,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 477,
    OF_INSTRUCTION_BSN_PERMIT = 478,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 479,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 480,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 481,
    OF_INSTRUCTION_CLEAR_ACTIONS = 482,
    OF_INSTRUCTION_EXPERIMENTER = 483,
    OF_INSTRUCTION_GOTO_TABLE = 484,
    OF_INSTRUCTION_ID = 485,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 486,
    OF_INSTRUCTION_ID_BSN = 487,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 488,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 489,
    OF_INSTRUCTION_ID_BSN_DENY = 490,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 491,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 492,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 493,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 494,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 495,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 496,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 497,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 498,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 499,
    OF_INSTRUCTION_ID_BSN_PERMIT = 500,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 501,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 502,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 503,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 504,
    OF_INSTRUCTION_ID_EXPERIMENTER = 505,
    OF_INSTRUCTION_ID_GOTO_TABLE = 506,
    OF_INSTRUCTION_ID_METER = 507,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 508,
    OF_INSTRUCTION_ID_WRITE_METADATA = 509,
    OF_INSTRUCTION_METER = 510,
    OF_INSTRUCTION_WRITE_ACTIONS = 511,
    OF_INSTRUCTION_WRITE_METADATA = 512,
    OF_MATCH_V1 = 513,
    OF_MATCH_V2 = 514,
    OF_MATCH_V3 = 515,
    OF_METER_BAND = 516,
    OF_METER_BAND_DROP = 517,
    OF_METER_BAND_DSCP_REMARK = 518,
    OF_METER_BAND_EXPERIMENTER = 519,
    OF_METER_BAND_STATS = 520,
    OF_METER_CONFIG = 521,
    OF_METER_FEATURES = 522,
    OF_METER_STATS = 523,
    OF_OXM = 524,
    OF_OXM_ARP_OP = 525,
    OF_OXM_ARP_OP_MASKED = 526,
    OF_OXM_ARP_SHA = 527,
    OF_OXM_ARP_SHA_MASKED = 528,
    OF_OXM_ARP_SPA = 529,
    OF_OXM_ARP_SPA_MASKED = 530,
    OF_OXM_ARP_THA = 531,
    OF_OXM_ARP_THA_MASKED = 532,
    OF_OXM_ARP_TPA = 533,
    OF_OXM_ARP_TPA_MASKED = 534,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 535,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 536,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 537,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 538,
    OF_OXM_BSN_IN_PORTS_128 = 539,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 540,
    OF_OXM_BSN_IN_PORTS_512 = 541,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 542,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 543,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 544,
    OF_OXM_BSN_INNER_ETH_DST = 545,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 546,
    OF_OXM_BSN_INNER_ETH_SRC = 547,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 548,
    OF_OXM_BSN_INNER_VLAN_VID = 549,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 550,
    OF_OXM_BSN_IP_FRAGMENTATION = 551,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 552,
    OF_OXM_BSN_L2_CACHE_HIT = 553,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 554,
    OF_OXM_BSN_L3_DST_CLASS_ID = 555,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 556,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 557,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 558,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 559,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 560,
    OF_OXM_BSN_LAG_ID = 561,
    OF_OXM_BSN_LAG_ID_MASKED = 562,
    OF_OXM_BSN_TCP_FLAGS = 563,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 564,
    OF_OXM_BSN_UDF0 = 565,
    OF_OXM_BSN_UDF0_MASKED = 566,
    OF_OXM_BSN_UDF1 = 567,
    OF_OXM_BSN_UDF1_MASKED = 568,
    OF_OXM_BSN_UDF2 = 569,
    OF_OXM_BSN_UDF2_MASKED = 570,
    OF_OXM_BSN_UDF3 = 571,
    OF_OXM_BSN_UDF3_MASKED = 572,
    OF_OXM_BSN_UDF4 = 573,
    OF_OXM_BSN_UDF4_MASKED = 574,
    OF_OXM_BSN_UDF5 = 575,
    OF_OXM_BSN_UDF5_MASKED = 576,
    OF_OXM_BSN_UDF6 = 577,
    OF_OXM_BSN_UDF6_MASKED = 578,
    OF_OXM_BSN_UDF7 = 579,
    OF_OXM_BSN_UDF7_MASKED = 580,
    OF_OXM_BSN_VFI = 581,
    OF_OXM_BSN_VFI_MASKED = 582,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 583,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 584,
    OF_OXM_BSN_VRF = 585,
    OF_OXM_BSN_VRF_MASKED = 586,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 587,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 588,
    OF_OXM_ETH_DST = 589,
    OF_OXM_ETH_DST_MASKED = 590,
    OF_OXM_ETH_SRC = 591,
    OF_OXM_ETH_SRC_MASKED = 592,
    OF_OXM_ETH_TYPE = 593,
    OF_OXM_ETH_TYPE_MASKED = 594,
    OF_OXM_ICMPV4_CODE = 595,
    OF_OXM_ICMPV4_CODE_MASKED = 596,
    OF_OXM_ICMPV4_TYPE = 597,
    OF_OXM_ICMPV4_TYPE_MASKED = 598,
    OF_OXM_ICMPV6_CODE = 599,
    OF_OXM_ICMPV6_CODE_MASKED = 600,
    OF_OXM_ICMPV6_TYPE = 601,
    OF_OXM_ICMPV6_TYPE_MASKED = 602,
    OF_OXM_IN_PHY_PORT = 603,
    OF_OXM_IN_PHY_PORT_MASKED = 604,
    OF_OXM_IN_PORT = 605,
    OF_OXM_IN_PORT_MASKED = 606,
    OF_OXM_IP_DSCP = 607,
    OF_OXM_IP_DSCP_MASKED = 608,
    OF_OXM_IP_ECN = 609,
    OF_OXM_IP_ECN_MASKED = 610,
    OF_OXM_IP_PROTO = 611,
    OF_OXM_IP_PROTO_MASKED = 612,
    OF_OXM_IPV4_DST = 613,
    OF_OXM_IPV4_DST_MASKED = 614,
    OF_OXM_IPV4_SRC = 615,
    OF_OXM_IPV4_SRC_MASKED = 616,
    OF_OXM_IPV6_DST = 617,
    OF_OXM_IPV6_DST_MASKED = 618,
    OF_OXM_IPV6_EXTHDR = 619,
    OF_OXM_IPV6_EXTHDR_MASKED = 620,
    OF_OXM_IPV6_FLABEL = 621,
    OF_OXM_IPV6_FLABEL_MASKED = 622,
    OF_OXM_IPV6_ND_SLL = 623,
    OF_OXM_IPV6_ND_SLL_MASKED = 624,
    OF_OXM_IPV6_ND_TARGET = 625,
    OF_OXM_IPV6_ND_TARGET_MASKED = 626,
    OF_OXM_IPV6_ND_TLL = 627,
    OF_OXM_IPV6_ND_TLL_MASKED = 628,
    OF_OXM_IPV6_SRC = 629,
    OF_OXM_IPV6_SRC_MASKED = 630,
    OF_OXM_METADATA = 631,
    OF_OXM_METADATA_MASKED = 632,
    OF_OXM_MPLS_BOS = 633,
    OF_OXM_MPLS_BOS_MASKED = 634,
    OF_OXM_MPLS_LABEL = 635,
    OF_OXM_MPLS_LABEL_MASKED = 636,
    OF_OXM_MPLS_TC = 637,
    OF_OXM_MPLS_TC_MASKED = 638,
    OF_OXM_OVS_TCP_FLAGS = 639,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 640,
    OF_OXM_PBB_UCA = 641,
    OF_OXM_PBB_UCA_MASKED = 642,
    OF_OXM_SCTP_DST = 643,
    OF_OXM_SCTP_DST_MASKED = 644,
    OF_OXM_SCTP_SRC = 645,
    OF_OXM_SCTP_SRC_MASKED = 646,
    OF_OXM_TCP_DST = 647,
    OF_OXM_TCP_DST_MASKED = 648,
    OF_OXM_TCP_SRC = 649,
    OF_OXM_TCP_SRC_MASKED = 650,
    OF_OXM_TUNNEL_ID = 651,
    OF_OXM_TUNNEL_ID_MASKED = 652,
    OF_OXM_TUNNEL_IPV4_DST = 653,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 654,
    OF_OXM_TUNNEL_IPV4_SRC = 655,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 656,
    OF_OXM_UDP_DST = 657,
    OF_OXM_UDP_DST_MASKED = 658,
    OF_OXM_UDP_SRC = 659,
    OF_OXM_UDP_SRC_MASKED = 660,
    OF_OXM_VLAN_PCP = 661,
    OF_OXM_VLAN_PCP_MASKED = 662,
    OF_OXM_VLAN_VID = 663,
    OF_OXM_VLAN_VID_MASKED = 664,
    OF_PACKET_QUEUE = 665,
    OF_PORT_DESC = 666,
    OF_PORT_DESC_PROP = 667,
    OF_PORT_DESC_PROP_BSN = 668,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 669,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 670,
    OF_PORT_DESC_PROP_BSN_UPLINK = 671,
    OF_PORT_DESC_PROP_ETHERNET = 672,
    OF_PORT_DESC_PROP_EXPERIMENTER = 673,
    OF_PORT_DESC_PROP_OPTICAL = 674,
    OF_PORT_MOD_PROP = 675,
    OF_PORT_MOD_PROP_ETHERNET = 676,
    OF_PORT_MOD_PROP_EXPERIMENTER = 677,
    OF_PORT_MOD_PROP_OPTICAL = 678,
    OF_PORT_STATS_ENTRY = 679,
    OF_PORT_STATS_PROP = 680,
    OF_PORT_STATS_PROP_ETHERNET = 681,
    OF_PORT_STATS_PROP_EXPERIMENTER = 682,
    OF_PORT_STATS_PROP_OPTICAL = 683,
    OF_QUEUE_DESC = 684,
    OF_QUEUE_DESC_PROP = 685,
    OF_QUEUE_DESC_PROP_BSN = 686,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 687,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 688,
    OF_QUEUE_DESC_PROP_MAX_RATE = 689,
    OF_QUEUE_DESC_PROP_MIN_RATE = 690,
    OF_QUEUE_PROP = 691,
    OF_QUEUE_PROP_EXPERIMENTER = 692,
    OF_QUEUE_PROP_MAX_RATE = 693,
    OF_QUEUE_PROP_MIN_RATE = 694,
    OF_QUEUE_STATS_ENTRY = 695,
    OF_QUEUE_STATS_PROP = 696,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 697,
    OF_ROLE_PROP = 698,
    OF_ROLE_PROP_EXPERIMENTER = 699,
    OF_TABLE_DESC = 700,
    OF_TABLE_FEATURE_PROP = 701,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 702,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 703,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 704,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 705,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 706,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 707,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 708,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 709,
    OF_TABLE_FEATURE_PROP_MATCH = 710,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 711,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 712,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 713,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 714,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 715,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 716,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 717,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 718,
    OF_TABLE_FEATURES = 719,
    OF_TABLE_MOD_PROP = 720,
    OF_TABLE_MOD_PROP_EVICTION = 721,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 722,
    OF_TABLE_MOD_PROP_VACANCY = 723,
    OF_TABLE_STATS_ENTRY = 724,
    OF_UINT32 = 725,
    OF_UINT64 = 726,
    OF_UINT8 = 727,
    ...
    /* List objects */
    OF_LIST_ACTION = 728,
    OF_LIST_ACTION_ID = 729,
    OF_LIST_ASYNC_CONFIG_PROP = 730,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 731,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 732,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 733,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 734,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 735,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 736,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 737,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 738,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 739,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 740,
    OF_LIST_BSN_INTERFACE = 741,
    OF_LIST_BSN_LACP_STATS_ENTRY = 742,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 743,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 744,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 745,
    OF_LIST_BSN_TLV = 746,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 747,
    OF_LIST_BSN_VLAN_MAC = 748,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 749,
    OF_LIST_BUCKET = 750,
    OF_LIST_BUCKET_COUNTER = 751,
    OF_LIST_BUNDLE_PROP = 752,
    OF_LIST_FLOW_STATS_ENTRY = 753,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 754,
    OF_LIST_GROUP_STATS_ENTRY = 755,
    OF_LIST_HELLO_ELEM = 756,
    OF_LIST_INSTRUCTION = 757,
    OF_LIST_INSTRUCTION_ID = 758,
    OF_LIST_METER_BAND = 759,
    OF_LIST_METER_BAND_STATS = 760,
    OF_LIST_METER_CONFIG = 761,
    OF_LIST_METER_STATS = 762,
    OF_LIST_OXM = 763,
    OF_LIST_PACKET_QUEUE = 764,
    OF_LIST_PORT_DESC = 765,
    OF_LIST_PORT_DESC_PROP = 766,
    OF_LIST_PORT_MOD_PROP = 767,
    OF_LIST_PORT_STATS_ENTRY = 768,
    OF_LIST_PORT_STATS_PROP = 769,
    OF_LIST_QUEUE_DESC = 770,
    OF_LIST_QUEUE_DESC_PROP = 771,
    OF_LIST_QUEUE_PROP = 772,
    OF_LIST_QUEUE_STATS_ENTRY = 773,
    OF_LIST_QUEUE_STATS_PROP = 774,
    OF_LIST_ROLE_PROP = 775,
    OF_LIST_TABLE_DESC = 776,
    OF_LIST_TABLE_FEATURE_PROP = 777,
    OF_LIST_TABLE_FEATURES = 778,
    OF_LIST_TABLE_MOD_PROP = 779,
    OF_LIST_TABLE_STATS_ENTRY = 780,
    OF_LIST_UINT32 = 781,
    OF_LIST_UINT64 = 782,
    OF_LIST_UINT8 = 783,
