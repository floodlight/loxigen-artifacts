...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_UDF_ID = 483,
    OF_BSN_TLV_UDF_LENGTH = 484,
    OF_BSN_TLV_UDF_OFFSET = 485,
    OF_BSN_TLV_UDP_DST = 486,
    OF_BSN_TLV_UDP_SRC = 487,
    OF_BSN_TLV_UINT32 = 488,
    OF_BSN_TLV_UINT64_LIST = 489,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 490,
    OF_BSN_TLV_UNICAST_RATE = 491,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 492,
    OF_BSN_TLV_UNTAGGED = 493,
    OF_BSN_TLV_UPGRADE = 494,
    OF_BSN_TLV_URI_SCHEME = 495,
    OF_BSN_TLV_USE_PACKET_STATE = 496,
    OF_BSN_TLV_USER_CONFIGURED = 497,
    OF_BSN_TLV_VFI = 498,
    OF_BSN_TLV_VFP_CLASS_ID = 499,
    OF_BSN_TLV_VIRTUAL = 500,
    OF_BSN_TLV_VLAN_MAC_LIST = 501,
    OF_BSN_TLV_VLAN_PCP = 502,
    OF_BSN_TLV_VLAN_VID = 503,
    OF_BSN_TLV_VLAN_VID_MASK = 504,
    OF_BSN_TLV_VNI = 505,
    OF_BSN_TLV_VPN_KEY = 506,
    OF_BSN_TLV_VRF = 507,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 508,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 509,
    OF_BSN_VLAN_MAC = 510,
    OF_BSN_VPORT = 511,
    OF_BSN_VPORT_L2GRE = 512,
    OF_BSN_VPORT_Q_IN_Q = 513,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 514,
    OF_BUCKET = 515,
    OF_BUCKET_COUNTER = 516,
    OF_BUNDLE_PROP = 517,
    OF_BUNDLE_PROP_EXPERIMENTER = 518,
    OF_FLOW_STATS_ENTRY = 519,
    OF_GROUP_DESC_STATS_ENTRY = 520,
    OF_GROUP_STATS_ENTRY = 521,
    OF_HELLO_ELEM = 522,
    OF_HELLO_ELEM_VERSIONBITMAP = 523,
    OF_INSTRUCTION = 524,
    OF_INSTRUCTION_APPLY_ACTIONS = 525,
    OF_INSTRUCTION_BSN = 526,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 527,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 528,
    OF_INSTRUCTION_BSN_DENY = 529,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 530,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 531,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 532,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 533,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 534,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 535,
    OF_INSTRUCTION_BSN_HASH_SELECT = 536,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 537,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 538,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 539,
    OF_INSTRUCTION_BSN_PERMIT = 540,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 541,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 542,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 543,
    OF_INSTRUCTION_CLEAR_ACTIONS = 544,
    OF_INSTRUCTION_EXPERIMENTER = 545,
    OF_INSTRUCTION_GOTO_TABLE = 546,
    OF_INSTRUCTION_ID = 547,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 548,
    OF_INSTRUCTION_ID_BSN = 549,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 550,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 551,
    OF_INSTRUCTION_ID_BSN_DENY = 552,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 553,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 554,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 555,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 556,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 557,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 558,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 559,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 560,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 561,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 562,
    OF_INSTRUCTION_ID_BSN_PERMIT = 563,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 564,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 565,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 566,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 567,
    OF_INSTRUCTION_ID_EXPERIMENTER = 568,
    OF_INSTRUCTION_ID_GOTO_TABLE = 569,
    OF_INSTRUCTION_ID_METER = 570,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 571,
    OF_INSTRUCTION_ID_WRITE_METADATA = 572,
    OF_INSTRUCTION_METER = 573,
    OF_INSTRUCTION_WRITE_ACTIONS = 574,
    OF_INSTRUCTION_WRITE_METADATA = 575,
    OF_MATCH_V1 = 576,
    OF_MATCH_V2 = 577,
    OF_MATCH_V3 = 578,
    OF_METER_BAND = 579,
    OF_METER_BAND_DROP = 580,
    OF_METER_BAND_DSCP_REMARK = 581,
    OF_METER_BAND_EXPERIMENTER = 582,
    OF_METER_BAND_STATS = 583,
    OF_METER_CONFIG = 584,
    OF_METER_FEATURES = 585,
    OF_METER_STATS = 586,
    OF_OXM = 587,
    OF_OXM_ARP_OP = 588,
    OF_OXM_ARP_OP_MASKED = 589,
    OF_OXM_ARP_SHA = 590,
    OF_OXM_ARP_SHA_MASKED = 591,
    OF_OXM_ARP_SPA = 592,
    OF_OXM_ARP_SPA_MASKED = 593,
    OF_OXM_ARP_THA = 594,
    OF_OXM_ARP_THA_MASKED = 595,
    OF_OXM_ARP_TPA = 596,
    OF_OXM_ARP_TPA_MASKED = 597,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 598,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 599,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 600,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 601,
    OF_OXM_BSN_IFP_CLASS_ID = 602,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 603,
    OF_OXM_BSN_IN_PORTS_128 = 604,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 605,
    OF_OXM_BSN_IN_PORTS_512 = 606,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 607,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 608,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 609,
    OF_OXM_BSN_INNER_ETH_DST = 610,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 611,
    OF_OXM_BSN_INNER_ETH_SRC = 612,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 613,
    OF_OXM_BSN_INNER_VLAN_VID = 614,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 615,
    OF_OXM_BSN_IP_FRAGMENTATION = 616,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 617,
    OF_OXM_BSN_L2_CACHE_HIT = 618,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 619,
    OF_OXM_BSN_L3_DST_CLASS_ID = 620,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 621,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 622,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 623,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 624,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 625,
    OF_OXM_BSN_LAG_ID = 626,
    OF_OXM_BSN_LAG_ID_MASKED = 627,
    OF_OXM_BSN_TCP_FLAGS = 628,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 629,
    OF_OXM_BSN_UDF0 = 630,
    OF_OXM_BSN_UDF0_MASKED = 631,
    OF_OXM_BSN_UDF1 = 632,
    OF_OXM_BSN_UDF1_MASKED = 633,
    OF_OXM_BSN_UDF2 = 634,
    OF_OXM_BSN_UDF2_MASKED = 635,
    OF_OXM_BSN_UDF3 = 636,
    OF_OXM_BSN_UDF3_MASKED = 637,
    OF_OXM_BSN_UDF4 = 638,
    OF_OXM_BSN_UDF4_MASKED = 639,
    OF_OXM_BSN_UDF5 = 640,
    OF_OXM_BSN_UDF5_MASKED = 641,
    OF_OXM_BSN_UDF6 = 642,
    OF_OXM_BSN_UDF6_MASKED = 643,
    OF_OXM_BSN_UDF7 = 644,
    OF_OXM_BSN_UDF7_MASKED = 645,
    OF_OXM_BSN_VFI = 646,
    OF_OXM_BSN_VFI_MASKED = 647,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 648,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 649,
    OF_OXM_BSN_VRF = 650,
    OF_OXM_BSN_VRF_MASKED = 651,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 652,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 653,
    OF_OXM_CONN_TRACKING_IPV6_DST = 654,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 655,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 656,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 657,
    OF_OXM_CONN_TRACKING_LABEL = 658,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 659,
    OF_OXM_CONN_TRACKING_MARK = 660,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 661,
    OF_OXM_CONN_TRACKING_NW_DST = 662,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 663,
    OF_OXM_CONN_TRACKING_NW_PROTO = 664,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 665,
    OF_OXM_CONN_TRACKING_NW_SRC = 666,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 667,
    OF_OXM_CONN_TRACKING_STATE = 668,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 669,
    OF_OXM_CONN_TRACKING_TP_DST = 670,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 671,
    OF_OXM_CONN_TRACKING_TP_SRC = 672,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 673,
    OF_OXM_CONN_TRACKING_ZONE = 674,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 675,
    OF_OXM_ETH_DST = 676,
    OF_OXM_ETH_DST_MASKED = 677,
    OF_OXM_ETH_SRC = 678,
    OF_OXM_ETH_SRC_MASKED = 679,
    OF_OXM_ETH_TYPE = 680,
    OF_OXM_ETH_TYPE_MASKED = 681,
    OF_OXM_ICMPV4_CODE = 682,
    OF_OXM_ICMPV4_CODE_MASKED = 683,
    OF_OXM_ICMPV4_TYPE = 684,
    OF_OXM_ICMPV4_TYPE_MASKED = 685,
    OF_OXM_ICMPV6_CODE = 686,
    OF_OXM_ICMPV6_CODE_MASKED = 687,
    OF_OXM_ICMPV6_TYPE = 688,
    OF_OXM_ICMPV6_TYPE_MASKED = 689,
    OF_OXM_IN_PHY_PORT = 690,
    OF_OXM_IN_PHY_PORT_MASKED = 691,
    OF_OXM_IN_PORT = 692,
    OF_OXM_IN_PORT_MASKED = 693,
    OF_OXM_IP_DSCP = 694,
    OF_OXM_IP_DSCP_MASKED = 695,
    OF_OXM_IP_ECN = 696,
    OF_OXM_IP_ECN_MASKED = 697,
    OF_OXM_IP_PROTO = 698,
    OF_OXM_IP_PROTO_MASKED = 699,
    OF_OXM_IPV4_DST = 700,
    OF_OXM_IPV4_DST_MASKED = 701,
    OF_OXM_IPV4_SRC = 702,
    OF_OXM_IPV4_SRC_MASKED = 703,
    OF_OXM_IPV6_DST = 704,
    OF_OXM_IPV6_DST_MASKED = 705,
    OF_OXM_IPV6_EXTHDR = 706,
    OF_OXM_IPV6_EXTHDR_MASKED = 707,
    OF_OXM_IPV6_FLABEL = 708,
    OF_OXM_IPV6_FLABEL_MASKED = 709,
    OF_OXM_IPV6_ND_SLL = 710,
    OF_OXM_IPV6_ND_SLL_MASKED = 711,
    OF_OXM_IPV6_ND_TARGET = 712,
    OF_OXM_IPV6_ND_TARGET_MASKED = 713,
    OF_OXM_IPV6_ND_TLL = 714,
    OF_OXM_IPV6_ND_TLL_MASKED = 715,
    OF_OXM_IPV6_SRC = 716,
    OF_OXM_IPV6_SRC_MASKED = 717,
    OF_OXM_METADATA = 718,
    OF_OXM_METADATA_MASKED = 719,
    OF_OXM_MPLS_BOS = 720,
    OF_OXM_MPLS_BOS_MASKED = 721,
    OF_OXM_MPLS_LABEL = 722,
    OF_OXM_MPLS_LABEL_MASKED = 723,
    OF_OXM_MPLS_TC = 724,
    OF_OXM_MPLS_TC_MASKED = 725,
    OF_OXM_OVS_TCP_FLAGS = 726,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 727,
    OF_OXM_PBB_UCA = 728,
    OF_OXM_PBB_UCA_MASKED = 729,
    OF_OXM_SCTP_DST = 730,
    OF_OXM_SCTP_DST_MASKED = 731,
    OF_OXM_SCTP_SRC = 732,
    OF_OXM_SCTP_SRC_MASKED = 733,
    OF_OXM_TCP_DST = 734,
    OF_OXM_TCP_DST_MASKED = 735,
    OF_OXM_TCP_SRC = 736,
    OF_OXM_TCP_SRC_MASKED = 737,
    OF_OXM_TUNNEL_ID = 738,
    OF_OXM_TUNNEL_ID_MASKED = 739,
    OF_OXM_TUNNEL_IPV4_DST = 740,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 741,
    OF_OXM_TUNNEL_IPV4_SRC = 742,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 743,
    OF_OXM_UDP_DST = 744,
    OF_OXM_UDP_DST_MASKED = 745,
    OF_OXM_UDP_SRC = 746,
    OF_OXM_UDP_SRC_MASKED = 747,
    OF_OXM_VLAN_PCP = 748,
    OF_OXM_VLAN_PCP_MASKED = 749,
    OF_OXM_VLAN_VID = 750,
    OF_OXM_VLAN_VID_MASKED = 751,
    OF_PACKET_QUEUE = 752,
    OF_PORT_DESC = 753,
    OF_PORT_DESC_PROP = 754,
    OF_PORT_DESC_PROP_BSN = 755,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 756,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 757,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 758,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 759,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 760,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 761,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 762,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 763,
    OF_PORT_DESC_PROP_BSN_UPLINK = 764,
    OF_PORT_DESC_PROP_ETHERNET = 765,
    OF_PORT_DESC_PROP_EXPERIMENTER = 766,
    OF_PORT_DESC_PROP_OPTICAL = 767,
    OF_PORT_MOD_PROP = 768,
    OF_PORT_MOD_PROP_ETHERNET = 769,
    OF_PORT_MOD_PROP_EXPERIMENTER = 770,
    OF_PORT_MOD_PROP_OPTICAL = 771,
    OF_PORT_STATS_ENTRY = 772,
    OF_PORT_STATS_PROP = 773,
    OF_PORT_STATS_PROP_ETHERNET = 774,
    OF_PORT_STATS_PROP_EXPERIMENTER = 775,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 776,
    OF_PORT_STATS_PROP_OPTICAL = 777,
    OF_QUEUE_DESC = 778,
    OF_QUEUE_DESC_PROP = 779,
    OF_QUEUE_DESC_PROP_BSN = 780,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 781,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 782,
    OF_QUEUE_DESC_PROP_MAX_RATE = 783,
    OF_QUEUE_DESC_PROP_MIN_RATE = 784,
    OF_QUEUE_PROP = 785,
    OF_QUEUE_PROP_EXPERIMENTER = 786,
    OF_QUEUE_PROP_MAX_RATE = 787,
    OF_QUEUE_PROP_MIN_RATE = 788,
    OF_QUEUE_STATS_ENTRY = 789,
    OF_QUEUE_STATS_PROP = 790,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 791,
    OF_ROLE_PROP = 792,
    OF_ROLE_PROP_EXPERIMENTER = 793,
    OF_TABLE_DESC = 794,
    OF_TABLE_FEATURE_PROP = 795,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 796,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 797,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 798,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 799,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 800,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 801,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 802,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 803,
    OF_TABLE_FEATURE_PROP_MATCH = 804,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 805,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 806,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 807,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 808,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 809,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 810,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 811,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 812,
    OF_TABLE_FEATURES = 813,
    OF_TABLE_MOD_PROP = 814,
    OF_TABLE_MOD_PROP_EVICTION = 815,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 816,
    OF_TABLE_MOD_PROP_VACANCY = 817,
    OF_TABLE_STATS_ENTRY = 818,
    OF_UINT32 = 819,
    OF_UINT64 = 820,
    OF_UINT8 = 821,
    ...
    /* List objects */
    OF_LIST_ACTION = 822,
    OF_LIST_ACTION_ID = 823,
    OF_LIST_ASYNC_CONFIG_PROP = 824,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 825,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 826,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 827,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 828,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 829,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 830,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 831,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 832,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 833,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 834,
    OF_LIST_BSN_INTERFACE = 835,
    OF_LIST_BSN_LACP_STATS_ENTRY = 836,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 837,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 838,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 839,
    OF_LIST_BSN_TLV = 840,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 841,
    OF_LIST_BSN_VLAN_MAC = 842,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 843,
    OF_LIST_BUCKET = 844,
    OF_LIST_BUCKET_COUNTER = 845,
    OF_LIST_BUNDLE_PROP = 846,
    OF_LIST_FLOW_STATS_ENTRY = 847,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 848,
    OF_LIST_GROUP_STATS_ENTRY = 849,
    OF_LIST_HELLO_ELEM = 850,
    OF_LIST_INSTRUCTION = 851,
    OF_LIST_INSTRUCTION_ID = 852,
    OF_LIST_METER_BAND = 853,
    OF_LIST_METER_BAND_STATS = 854,
    OF_LIST_METER_CONFIG = 855,
    OF_LIST_METER_STATS = 856,
    OF_LIST_OXM = 857,
    OF_LIST_PACKET_QUEUE = 858,
    OF_LIST_PORT_DESC = 859,
    OF_LIST_PORT_DESC_PROP = 860,
    OF_LIST_PORT_MOD_PROP = 861,
    OF_LIST_PORT_STATS_ENTRY = 862,
    OF_LIST_PORT_STATS_PROP = 863,
    OF_LIST_QUEUE_DESC = 864,
    OF_LIST_QUEUE_DESC_PROP = 865,
    OF_LIST_QUEUE_PROP = 866,
    OF_LIST_QUEUE_STATS_ENTRY = 867,
    OF_LIST_QUEUE_STATS_PROP = 868,
    OF_LIST_ROLE_PROP = 869,
    OF_LIST_TABLE_DESC = 870,
    OF_LIST_TABLE_FEATURE_PROP = 871,
    OF_LIST_TABLE_FEATURES = 872,
    OF_LIST_TABLE_MOD_PROP = 873,
    OF_LIST_TABLE_STATS_ENTRY = 874,
    OF_LIST_UINT32 = 875,
    OF_LIST_UINT64 = 876,
    OF_LIST_UINT8 = 877,
