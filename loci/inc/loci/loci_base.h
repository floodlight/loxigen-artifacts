...
typedef enum of_object_id_e {
    ...
    OF_OXM_BSN_L2_CACHE_HIT = 464,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 465,
    OF_OXM_BSN_L3_DST_CLASS_ID = 466,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 467,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 468,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 469,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 470,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 471,
    OF_OXM_BSN_LAG_ID = 472,
    OF_OXM_BSN_LAG_ID_MASKED = 473,
    OF_OXM_BSN_TCP_FLAGS = 474,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 475,
    OF_OXM_BSN_UDF0 = 476,
    OF_OXM_BSN_UDF0_MASKED = 477,
    OF_OXM_BSN_UDF1 = 478,
    OF_OXM_BSN_UDF1_MASKED = 479,
    OF_OXM_BSN_UDF2 = 480,
    OF_OXM_BSN_UDF2_MASKED = 481,
    OF_OXM_BSN_UDF3 = 482,
    OF_OXM_BSN_UDF3_MASKED = 483,
    OF_OXM_BSN_UDF4 = 484,
    OF_OXM_BSN_UDF4_MASKED = 485,
    OF_OXM_BSN_UDF5 = 486,
    OF_OXM_BSN_UDF5_MASKED = 487,
    OF_OXM_BSN_UDF6 = 488,
    OF_OXM_BSN_UDF6_MASKED = 489,
    OF_OXM_BSN_UDF7 = 490,
    OF_OXM_BSN_UDF7_MASKED = 491,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 492,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 493,
    OF_OXM_BSN_VRF = 494,
    OF_OXM_BSN_VRF_MASKED = 495,
    OF_OXM_ETH_DST = 496,
    OF_OXM_ETH_DST_MASKED = 497,
    OF_OXM_ETH_SRC = 498,
    OF_OXM_ETH_SRC_MASKED = 499,
    OF_OXM_ETH_TYPE = 500,
    OF_OXM_ETH_TYPE_MASKED = 501,
    OF_OXM_ICMPV4_CODE = 502,
    OF_OXM_ICMPV4_CODE_MASKED = 503,
    OF_OXM_ICMPV4_TYPE = 504,
    OF_OXM_ICMPV4_TYPE_MASKED = 505,
    OF_OXM_ICMPV6_CODE = 506,
    OF_OXM_ICMPV6_CODE_MASKED = 507,
    OF_OXM_ICMPV6_TYPE = 508,
    OF_OXM_ICMPV6_TYPE_MASKED = 509,
    OF_OXM_IN_PHY_PORT = 510,
    OF_OXM_IN_PHY_PORT_MASKED = 511,
    OF_OXM_IN_PORT = 512,
    OF_OXM_IN_PORT_MASKED = 513,
    OF_OXM_IP_DSCP = 514,
    OF_OXM_IP_DSCP_MASKED = 515,
    OF_OXM_IP_ECN = 516,
    OF_OXM_IP_ECN_MASKED = 517,
    OF_OXM_IP_PROTO = 518,
    OF_OXM_IP_PROTO_MASKED = 519,
    OF_OXM_IPV4_DST = 520,
    OF_OXM_IPV4_DST_MASKED = 521,
    OF_OXM_IPV4_SRC = 522,
    OF_OXM_IPV4_SRC_MASKED = 523,
    OF_OXM_IPV6_DST = 524,
    OF_OXM_IPV6_DST_MASKED = 525,
    OF_OXM_IPV6_EXTHDR = 526,
    OF_OXM_IPV6_EXTHDR_MASKED = 527,
    OF_OXM_IPV6_FLABEL = 528,
    OF_OXM_IPV6_FLABEL_MASKED = 529,
    OF_OXM_IPV6_ND_SLL = 530,
    OF_OXM_IPV6_ND_SLL_MASKED = 531,
    OF_OXM_IPV6_ND_TARGET = 532,
    OF_OXM_IPV6_ND_TARGET_MASKED = 533,
    OF_OXM_IPV6_ND_TLL = 534,
    OF_OXM_IPV6_ND_TLL_MASKED = 535,
    OF_OXM_IPV6_SRC = 536,
    OF_OXM_IPV6_SRC_MASKED = 537,
    OF_OXM_METADATA = 538,
    OF_OXM_METADATA_MASKED = 539,
    OF_OXM_MPLS_BOS = 540,
    OF_OXM_MPLS_BOS_MASKED = 541,
    OF_OXM_MPLS_LABEL = 542,
    OF_OXM_MPLS_LABEL_MASKED = 543,
    OF_OXM_MPLS_TC = 544,
    OF_OXM_MPLS_TC_MASKED = 545,
    OF_OXM_PBB_UCA = 546,
    OF_OXM_PBB_UCA_MASKED = 547,
    OF_OXM_SCTP_DST = 548,
    OF_OXM_SCTP_DST_MASKED = 549,
    OF_OXM_SCTP_SRC = 550,
    OF_OXM_SCTP_SRC_MASKED = 551,
    OF_OXM_TCP_DST = 552,
    OF_OXM_TCP_DST_MASKED = 553,
    OF_OXM_TCP_SRC = 554,
    OF_OXM_TCP_SRC_MASKED = 555,
    OF_OXM_TUNNEL_ID = 556,
    OF_OXM_TUNNEL_ID_MASKED = 557,
    OF_OXM_TUNNEL_IPV4_DST = 558,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 559,
    OF_OXM_TUNNEL_IPV4_SRC = 560,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 561,
    OF_OXM_UDP_DST = 562,
    OF_OXM_UDP_DST_MASKED = 563,
    OF_OXM_UDP_SRC = 564,
    OF_OXM_UDP_SRC_MASKED = 565,
    OF_OXM_VLAN_PCP = 566,
    OF_OXM_VLAN_PCP_MASKED = 567,
    OF_OXM_VLAN_VID = 568,
    OF_OXM_VLAN_VID_MASKED = 569,
    OF_PACKET_QUEUE = 570,
    OF_PORT_DESC = 571,
    OF_PORT_DESC_PROP = 572,
    OF_PORT_DESC_PROP_BSN = 573,
    OF_PORT_DESC_PROP_BSN_UPLINK = 574,
    OF_PORT_DESC_PROP_ETHERNET = 575,
    OF_PORT_DESC_PROP_EXPERIMENTER = 576,
    OF_PORT_DESC_PROP_OPTICAL = 577,
    OF_PORT_MOD_PROP = 578,
    OF_PORT_MOD_PROP_ETHERNET = 579,
    OF_PORT_MOD_PROP_EXPERIMENTER = 580,
    OF_PORT_MOD_PROP_OPTICAL = 581,
    OF_PORT_STATS_ENTRY = 582,
    OF_PORT_STATS_PROP = 583,
    OF_PORT_STATS_PROP_ETHERNET = 584,
    OF_PORT_STATS_PROP_EXPERIMENTER = 585,
    OF_PORT_STATS_PROP_OPTICAL = 586,
    OF_QUEUE_DESC = 587,
    OF_QUEUE_DESC_PROP = 588,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 589,
    OF_QUEUE_DESC_PROP_MAX_RATE = 590,
    OF_QUEUE_DESC_PROP_MIN_RATE = 591,
    OF_QUEUE_PROP = 592,
    OF_QUEUE_PROP_EXPERIMENTER = 593,
    OF_QUEUE_PROP_MAX_RATE = 594,
    OF_QUEUE_PROP_MIN_RATE = 595,
    OF_QUEUE_STATS_ENTRY = 596,
    OF_QUEUE_STATS_PROP = 597,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 598,
    OF_ROLE_PROP = 599,
    OF_ROLE_PROP_EXPERIMENTER = 600,
    OF_TABLE_DESC = 601,
    OF_TABLE_FEATURE_PROP = 602,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 603,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 604,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 605,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 606,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 607,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 608,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 609,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 610,
    OF_TABLE_FEATURE_PROP_MATCH = 611,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 612,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 613,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 614,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 615,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 616,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 617,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 618,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 619,
    OF_TABLE_FEATURES = 620,
    OF_TABLE_MOD_PROP = 621,
    OF_TABLE_MOD_PROP_EVICTION = 622,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 623,
    OF_TABLE_MOD_PROP_VACANCY = 624,
    OF_TABLE_STATS_ENTRY = 625,
    OF_UINT32 = 626,
    OF_UINT64 = 627,
    OF_UINT8 = 628,
    ...
    /* List objects */
    OF_LIST_ACTION = 629,
    OF_LIST_ACTION_ID = 630,
    OF_LIST_ASYNC_CONFIG_PROP = 631,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 632,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 633,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 634,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 635,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 636,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 637,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 638,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 639,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 640,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 641,
    OF_LIST_BSN_INTERFACE = 642,
    OF_LIST_BSN_LACP_STATS_ENTRY = 643,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 644,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 645,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 646,
    OF_LIST_BSN_TLV = 647,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 648,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 649,
    OF_LIST_BUCKET = 650,
    OF_LIST_BUCKET_COUNTER = 651,
    OF_LIST_BUNDLE_PROP = 652,
    OF_LIST_FLOW_STATS_ENTRY = 653,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 654,
    OF_LIST_GROUP_STATS_ENTRY = 655,
    OF_LIST_HELLO_ELEM = 656,
    OF_LIST_INSTRUCTION = 657,
    OF_LIST_INSTRUCTION_ID = 658,
    OF_LIST_METER_BAND = 659,
    OF_LIST_METER_BAND_STATS = 660,
    OF_LIST_METER_STATS = 661,
    OF_LIST_OXM = 662,
    OF_LIST_PACKET_QUEUE = 663,
    OF_LIST_PORT_DESC = 664,
    OF_LIST_PORT_DESC_PROP = 665,
    OF_LIST_PORT_MOD_PROP = 666,
    OF_LIST_PORT_STATS_ENTRY = 667,
    OF_LIST_PORT_STATS_PROP = 668,
    OF_LIST_QUEUE_DESC = 669,
    OF_LIST_QUEUE_DESC_PROP = 670,
    OF_LIST_QUEUE_PROP = 671,
    OF_LIST_QUEUE_STATS_ENTRY = 672,
    OF_LIST_QUEUE_STATS_PROP = 673,
    OF_LIST_ROLE_PROP = 674,
    OF_LIST_TABLE_DESC = 675,
    OF_LIST_TABLE_FEATURE_PROP = 676,
    OF_LIST_TABLE_FEATURES = 677,
    OF_LIST_TABLE_MOD_PROP = 678,
    OF_LIST_TABLE_STATS_ENTRY = 679,
    OF_LIST_UINT32 = 680,
    OF_LIST_UINT64 = 681,
    OF_LIST_UINT8 = 682,
