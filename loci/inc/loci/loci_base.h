...
typedef enum of_object_id_e {
    ...
    OF_ACTION_GROUP = 207,
    OF_ACTION_ID = 208,
    OF_ACTION_ID_BSN = 209,
    OF_ACTION_ID_BSN_CHECKSUM = 210,
    OF_ACTION_ID_BSN_GENTABLE = 211,
    OF_ACTION_ID_BSN_MIRROR = 212,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 213,
    OF_ACTION_ID_COPY_TTL_IN = 214,
    OF_ACTION_ID_COPY_TTL_OUT = 215,
    OF_ACTION_ID_DEC_MPLS_TTL = 216,
    OF_ACTION_ID_DEC_NW_TTL = 217,
    OF_ACTION_ID_EXPERIMENTER = 218,
    OF_ACTION_ID_GROUP = 219,
    OF_ACTION_ID_NICIRA = 220,
    OF_ACTION_ID_NICIRA_DEC_TTL = 221,
    OF_ACTION_ID_OUTPUT = 222,
    OF_ACTION_ID_POP_MPLS = 223,
    OF_ACTION_ID_POP_PBB = 224,
    OF_ACTION_ID_POP_VLAN = 225,
    OF_ACTION_ID_PUSH_MPLS = 226,
    OF_ACTION_ID_PUSH_PBB = 227,
    OF_ACTION_ID_PUSH_VLAN = 228,
    OF_ACTION_ID_SET_FIELD = 229,
    OF_ACTION_ID_SET_MPLS_TTL = 230,
    OF_ACTION_ID_SET_NW_TTL = 231,
    OF_ACTION_ID_SET_QUEUE = 232,
    OF_ACTION_NICIRA = 233,
    OF_ACTION_NICIRA_DEC_TTL = 234,
    OF_ACTION_OUTPUT = 235,
    OF_ACTION_POP_MPLS = 236,
    OF_ACTION_POP_PBB = 237,
    OF_ACTION_POP_VLAN = 238,
    OF_ACTION_PUSH_MPLS = 239,
    OF_ACTION_PUSH_PBB = 240,
    OF_ACTION_PUSH_VLAN = 241,
    OF_ACTION_SET_DL_DST = 242,
    OF_ACTION_SET_DL_SRC = 243,
    OF_ACTION_SET_FIELD = 244,
    OF_ACTION_SET_MPLS_LABEL = 245,
    OF_ACTION_SET_MPLS_TC = 246,
    OF_ACTION_SET_MPLS_TTL = 247,
    OF_ACTION_SET_NW_DST = 248,
    OF_ACTION_SET_NW_ECN = 249,
    OF_ACTION_SET_NW_SRC = 250,
    OF_ACTION_SET_NW_TOS = 251,
    OF_ACTION_SET_NW_TTL = 252,
    OF_ACTION_SET_QUEUE = 253,
    OF_ACTION_SET_TP_DST = 254,
    OF_ACTION_SET_TP_SRC = 255,
    OF_ACTION_SET_VLAN_PCP = 256,
    OF_ACTION_SET_VLAN_VID = 257,
    OF_ACTION_STRIP_VLAN = 258,
    OF_ASYNC_CONFIG_PROP = 259,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_MASTER = 260,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_SLAVE = 261,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_MASTER = 262,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_SLAVE = 263,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_MASTER = 264,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_SLAVE = 265,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_MASTER = 266,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_SLAVE = 267,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_MASTER = 268,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_SLAVE = 269,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_MASTER = 270,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_SLAVE = 271,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_MASTER = 272,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_SLAVE = 273,
    OF_BSN_CONTROLLER_CONNECTION = 274,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 275,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 276,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 277,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 278,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 279,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 280,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 281,
    OF_BSN_GENTABLE_STATS_ENTRY = 282,
    OF_BSN_INTERFACE = 283,
    OF_BSN_LACP_STATS_ENTRY = 284,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 285,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 286,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 287,
    OF_BSN_TLV = 288,
    OF_BSN_TLV_ACTOR_KEY = 289,
    OF_BSN_TLV_ACTOR_PORT_NUM = 290,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 291,
    OF_BSN_TLV_ACTOR_STATE = 292,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 293,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 294,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 295,
    OF_BSN_TLV_CIRCUIT_ID = 296,
    OF_BSN_TLV_CONVERGENCE_STATUS = 297,
    OF_BSN_TLV_CRC_ENABLED = 298,
    OF_BSN_TLV_DATA = 299,
    OF_BSN_TLV_ETH_DST = 300,
    OF_BSN_TLV_ETH_SRC = 301,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 302,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 303,
    OF_BSN_TLV_EXTERNAL_IP = 304,
    OF_BSN_TLV_EXTERNAL_MAC = 305,
    OF_BSN_TLV_EXTERNAL_NETMASK = 306,
    OF_BSN_TLV_HEADER_SIZE = 307,
    OF_BSN_TLV_IDLE_NOTIFICATION = 308,
    OF_BSN_TLV_IDLE_TIME = 309,
    OF_BSN_TLV_IDLE_TIMEOUT = 310,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 311,
    OF_BSN_TLV_INTERNAL_MAC = 312,
    OF_BSN_TLV_INTERVAL = 313,
    OF_BSN_TLV_IPV4 = 314,
    OF_BSN_TLV_IPV4_DST = 315,
    OF_BSN_TLV_IPV4_SRC = 316,
    OF_BSN_TLV_MAC = 317,
    OF_BSN_TLV_MAC_MASK = 318,
    OF_BSN_TLV_MISS_PACKETS = 319,
    OF_BSN_TLV_NAME = 320,
    OF_BSN_TLV_PARTNER_KEY = 321,
    OF_BSN_TLV_PARTNER_PORT_NUM = 322,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 323,
    OF_BSN_TLV_PARTNER_STATE = 324,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 325,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 326,
    OF_BSN_TLV_PORT = 327,
    OF_BSN_TLV_PRIORITY = 328,
    OF_BSN_TLV_QUEUE_ID = 329,
    OF_BSN_TLV_QUEUE_WEIGHT = 330,
    OF_BSN_TLV_REPLY_PACKETS = 331,
    OF_BSN_TLV_REQUEST_PACKETS = 332,
    OF_BSN_TLV_RX_PACKETS = 333,
    OF_BSN_TLV_SAMPLING_RATE = 334,
    OF_BSN_TLV_SUB_AGENT_ID = 335,
    OF_BSN_TLV_TX_BYTES = 336,
    OF_BSN_TLV_TX_PACKETS = 337,
    OF_BSN_TLV_UDF_ANCHOR = 338,
    OF_BSN_TLV_UDF_ID = 339,
    OF_BSN_TLV_UDF_LENGTH = 340,
    OF_BSN_TLV_UDF_OFFSET = 341,
    OF_BSN_TLV_UDP_DST = 342,
    OF_BSN_TLV_UDP_SRC = 343,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 344,
    OF_BSN_TLV_VLAN_VID = 345,
    OF_BSN_TLV_VRF = 346,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 347,
    OF_BSN_VPORT = 348,
    OF_BSN_VPORT_L2GRE = 349,
    OF_BSN_VPORT_Q_IN_Q = 350,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 351,
    OF_BUCKET = 352,
    OF_BUCKET_COUNTER = 353,
    OF_BUNDLE_PROP = 354,
    OF_BUNDLE_PROP_EXPERIMENTER = 355,
    OF_FLOW_STATS_ENTRY = 356,
    OF_GROUP_DESC_STATS_ENTRY = 357,
    OF_GROUP_STATS_ENTRY = 358,
    OF_HELLO_ELEM = 359,
    OF_HELLO_ELEM_VERSIONBITMAP = 360,
    OF_INSTRUCTION = 361,
    OF_INSTRUCTION_APPLY_ACTIONS = 362,
    OF_INSTRUCTION_BSN = 363,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 364,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 365,
    OF_INSTRUCTION_BSN_DENY = 366,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 367,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 368,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 369,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 370,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 371,
    OF_INSTRUCTION_BSN_PERMIT = 372,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 373,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 374,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 375,
    OF_INSTRUCTION_CLEAR_ACTIONS = 376,
    OF_INSTRUCTION_EXPERIMENTER = 377,
    OF_INSTRUCTION_GOTO_TABLE = 378,
    OF_INSTRUCTION_ID = 379,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 380,
    OF_INSTRUCTION_ID_BSN = 381,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 382,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 383,
    OF_INSTRUCTION_ID_BSN_DENY = 384,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 385,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 386,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 387,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 388,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 389,
    OF_INSTRUCTION_ID_BSN_PERMIT = 390,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 391,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 392,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 393,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 394,
    OF_INSTRUCTION_ID_EXPERIMENTER = 395,
    OF_INSTRUCTION_ID_GOTO_TABLE = 396,
    OF_INSTRUCTION_ID_METER = 397,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 398,
    OF_INSTRUCTION_ID_WRITE_METADATA = 399,
    OF_INSTRUCTION_METER = 400,
    OF_INSTRUCTION_WRITE_ACTIONS = 401,
    OF_INSTRUCTION_WRITE_METADATA = 402,
    OF_MATCH_V1 = 403,
    OF_MATCH_V2 = 404,
    OF_MATCH_V3 = 405,
    OF_METER_BAND = 406,
    OF_METER_BAND_DROP = 407,
    OF_METER_BAND_DSCP_REMARK = 408,
    OF_METER_BAND_EXPERIMENTER = 409,
    OF_METER_BAND_STATS = 410,
    OF_METER_CONFIG = 411,
    OF_METER_FEATURES = 412,
    OF_METER_STATS = 413,
    OF_OXM = 414,
    OF_OXM_ARP_OP = 415,
    OF_OXM_ARP_OP_MASKED = 416,
    OF_OXM_ARP_SHA = 417,
    OF_OXM_ARP_SHA_MASKED = 418,
    OF_OXM_ARP_SPA = 419,
    OF_OXM_ARP_SPA_MASKED = 420,
    OF_OXM_ARP_THA = 421,
    OF_OXM_ARP_THA_MASKED = 422,
    OF_OXM_ARP_TPA = 423,
    OF_OXM_ARP_TPA_MASKED = 424,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 425,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 426,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 427,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 428,
    OF_OXM_BSN_IN_PORTS_128 = 429,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 430,
    OF_OXM_BSN_L2_CACHE_HIT = 431,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 432,
    OF_OXM_BSN_L3_DST_CLASS_ID = 433,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 434,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 435,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 436,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 437,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 438,
    OF_OXM_BSN_LAG_ID = 439,
    OF_OXM_BSN_LAG_ID_MASKED = 440,
    OF_OXM_BSN_TCP_FLAGS = 441,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 442,
    OF_OXM_BSN_UDF0 = 443,
    OF_OXM_BSN_UDF0_MASKED = 444,
    OF_OXM_BSN_UDF1 = 445,
    OF_OXM_BSN_UDF1_MASKED = 446,
    OF_OXM_BSN_UDF2 = 447,
    OF_OXM_BSN_UDF2_MASKED = 448,
    OF_OXM_BSN_UDF3 = 449,
    OF_OXM_BSN_UDF3_MASKED = 450,
    OF_OXM_BSN_UDF4 = 451,
    OF_OXM_BSN_UDF4_MASKED = 452,
    OF_OXM_BSN_UDF5 = 453,
    OF_OXM_BSN_UDF5_MASKED = 454,
    OF_OXM_BSN_UDF6 = 455,
    OF_OXM_BSN_UDF6_MASKED = 456,
    OF_OXM_BSN_UDF7 = 457,
    OF_OXM_BSN_UDF7_MASKED = 458,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 459,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 460,
    OF_OXM_BSN_VRF = 461,
    OF_OXM_BSN_VRF_MASKED = 462,
    OF_OXM_ETH_DST = 463,
    OF_OXM_ETH_DST_MASKED = 464,
    OF_OXM_ETH_SRC = 465,
    OF_OXM_ETH_SRC_MASKED = 466,
    OF_OXM_ETH_TYPE = 467,
    OF_OXM_ETH_TYPE_MASKED = 468,
    OF_OXM_ICMPV4_CODE = 469,
    OF_OXM_ICMPV4_CODE_MASKED = 470,
    OF_OXM_ICMPV4_TYPE = 471,
    OF_OXM_ICMPV4_TYPE_MASKED = 472,
    OF_OXM_ICMPV6_CODE = 473,
    OF_OXM_ICMPV6_CODE_MASKED = 474,
    OF_OXM_ICMPV6_TYPE = 475,
    OF_OXM_ICMPV6_TYPE_MASKED = 476,
    OF_OXM_IN_PHY_PORT = 477,
    OF_OXM_IN_PHY_PORT_MASKED = 478,
    OF_OXM_IN_PORT = 479,
    OF_OXM_IN_PORT_MASKED = 480,
    OF_OXM_IP_DSCP = 481,
    OF_OXM_IP_DSCP_MASKED = 482,
    OF_OXM_IP_ECN = 483,
    OF_OXM_IP_ECN_MASKED = 484,
    OF_OXM_IP_PROTO = 485,
    OF_OXM_IP_PROTO_MASKED = 486,
    OF_OXM_IPV4_DST = 487,
    OF_OXM_IPV4_DST_MASKED = 488,
    OF_OXM_IPV4_SRC = 489,
    OF_OXM_IPV4_SRC_MASKED = 490,
    OF_OXM_IPV6_DST = 491,
    OF_OXM_IPV6_DST_MASKED = 492,
    OF_OXM_IPV6_EXTHDR = 493,
    OF_OXM_IPV6_EXTHDR_MASKED = 494,
    OF_OXM_IPV6_FLABEL = 495,
    OF_OXM_IPV6_FLABEL_MASKED = 496,
    OF_OXM_IPV6_ND_SLL = 497,
    OF_OXM_IPV6_ND_SLL_MASKED = 498,
    OF_OXM_IPV6_ND_TARGET = 499,
    OF_OXM_IPV6_ND_TARGET_MASKED = 500,
    OF_OXM_IPV6_ND_TLL = 501,
    OF_OXM_IPV6_ND_TLL_MASKED = 502,
    OF_OXM_IPV6_SRC = 503,
    OF_OXM_IPV6_SRC_MASKED = 504,
    OF_OXM_METADATA = 505,
    OF_OXM_METADATA_MASKED = 506,
    OF_OXM_MPLS_BOS = 507,
    OF_OXM_MPLS_BOS_MASKED = 508,
    OF_OXM_MPLS_LABEL = 509,
    OF_OXM_MPLS_LABEL_MASKED = 510,
    OF_OXM_MPLS_TC = 511,
    OF_OXM_MPLS_TC_MASKED = 512,
    OF_OXM_PBB_UCA = 513,
    OF_OXM_PBB_UCA_MASKED = 514,
    OF_OXM_SCTP_DST = 515,
    OF_OXM_SCTP_DST_MASKED = 516,
    OF_OXM_SCTP_SRC = 517,
    OF_OXM_SCTP_SRC_MASKED = 518,
    OF_OXM_TCP_DST = 519,
    OF_OXM_TCP_DST_MASKED = 520,
    OF_OXM_TCP_SRC = 521,
    OF_OXM_TCP_SRC_MASKED = 522,
    OF_OXM_TUNNEL_ID = 523,
    OF_OXM_TUNNEL_ID_MASKED = 524,
    OF_OXM_TUNNEL_IPV4_DST = 525,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 526,
    OF_OXM_TUNNEL_IPV4_SRC = 527,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 528,
    OF_OXM_UDP_DST = 529,
    OF_OXM_UDP_DST_MASKED = 530,
    OF_OXM_UDP_SRC = 531,
    OF_OXM_UDP_SRC_MASKED = 532,
    OF_OXM_VLAN_PCP = 533,
    OF_OXM_VLAN_PCP_MASKED = 534,
    OF_OXM_VLAN_VID = 535,
    OF_OXM_VLAN_VID_MASKED = 536,
    OF_PACKET_QUEUE = 537,
    OF_PORT_DESC = 538,
    OF_PORT_DESC_PROP = 539,
    OF_PORT_DESC_PROP_ETHERNET = 540,
    OF_PORT_DESC_PROP_EXPERIMENTER = 541,
    OF_PORT_DESC_PROP_OPTICAL = 542,
    OF_PORT_MOD_PROP = 543,
    OF_PORT_MOD_PROP_ETHERNET = 544,
    OF_PORT_MOD_PROP_EXPERIMENTER = 545,
    OF_PORT_MOD_PROP_OPTICAL = 546,
    OF_PORT_STATS_ENTRY = 547,
    OF_PORT_STATS_PROP = 548,
    OF_PORT_STATS_PROP_ETHERNET = 549,
    OF_PORT_STATS_PROP_EXPERIMENTER = 550,
    OF_PORT_STATS_PROP_OPTICAL = 551,
    OF_QUEUE_DESC = 552,
    OF_QUEUE_DESC_PROP = 553,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 554,
    OF_QUEUE_DESC_PROP_MAX_RATE = 555,
    OF_QUEUE_DESC_PROP_MIN_RATE = 556,
    OF_QUEUE_PROP = 557,
    OF_QUEUE_PROP_EXPERIMENTER = 558,
    OF_QUEUE_PROP_MAX_RATE = 559,
    OF_QUEUE_PROP_MIN_RATE = 560,
    OF_QUEUE_STATS_ENTRY = 561,
    OF_QUEUE_STATS_PROP = 562,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 563,
    OF_ROLE_PROP = 564,
    OF_ROLE_PROP_EXPERIMENTER = 565,
    OF_TABLE_DESC = 566,
    OF_TABLE_FEATURE_PROP = 567,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 568,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 569,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 570,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 571,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 572,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 573,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 574,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 575,
    OF_TABLE_FEATURE_PROP_MATCH = 576,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 577,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 578,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 579,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 580,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 581,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 582,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 583,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 584,
    OF_TABLE_FEATURES = 585,
    OF_TABLE_MOD_PROP = 586,
    OF_TABLE_MOD_PROP_EVICTION = 587,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 588,
    OF_TABLE_MOD_PROP_VACANCY = 589,
    OF_TABLE_STATS_ENTRY = 590,
    OF_UINT32 = 591,
    OF_UINT64 = 592,
    OF_UINT8 = 593,
    ...
    /* List objects */
    OF_LIST_ACTION = 594,
    OF_LIST_ACTION_ID = 595,
    OF_LIST_ASYNC_CONFIG_PROP = 596,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 597,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 598,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 599,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 600,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 601,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 602,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 603,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 604,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 605,
    OF_LIST_BSN_INTERFACE = 606,
    OF_LIST_BSN_LACP_STATS_ENTRY = 607,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 608,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 609,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 610,
    OF_LIST_BSN_TLV = 611,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 612,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 613,
    OF_LIST_BUCKET = 614,
    OF_LIST_BUCKET_COUNTER = 615,
    OF_LIST_BUNDLE_PROP = 616,
    OF_LIST_FLOW_STATS_ENTRY = 617,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 618,
    OF_LIST_GROUP_STATS_ENTRY = 619,
    OF_LIST_HELLO_ELEM = 620,
    OF_LIST_INSTRUCTION = 621,
    OF_LIST_INSTRUCTION_ID = 622,
    OF_LIST_METER_BAND = 623,
    OF_LIST_METER_BAND_STATS = 624,
    OF_LIST_METER_STATS = 625,
    OF_LIST_OXM = 626,
    OF_LIST_PACKET_QUEUE = 627,
    OF_LIST_PORT_DESC = 628,
    OF_LIST_PORT_DESC_PROP = 629,
    OF_LIST_PORT_MOD_PROP = 630,
    OF_LIST_PORT_STATS_ENTRY = 631,
    OF_LIST_PORT_STATS_PROP = 632,
    OF_LIST_QUEUE_DESC = 633,
    OF_LIST_QUEUE_DESC_PROP = 634,
    OF_LIST_QUEUE_PROP = 635,
    OF_LIST_QUEUE_STATS_ENTRY = 636,
    OF_LIST_QUEUE_STATS_PROP = 637,
    OF_LIST_ROLE_PROP = 638,
    OF_LIST_TABLE_DESC = 639,
    OF_LIST_TABLE_FEATURE_PROP = 640,
    OF_LIST_TABLE_FEATURES = 641,
    OF_LIST_TABLE_MOD_PROP = 642,
    OF_LIST_TABLE_STATS_ENTRY = 643,
    OF_LIST_UINT32 = 644,
    OF_LIST_UINT64 = 645,
    OF_LIST_UINT8 = 646,
