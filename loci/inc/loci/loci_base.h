...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_NO_DROP = 435,
    OF_BSN_TLV_NO_NS_RESPONSE = 436,
    OF_BSN_TLV_OFFSET = 437,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 438,
    OF_BSN_TLV_OUTER_SRC_MAC = 439,
    OF_BSN_TLV_PACKET_FIELD = 440,
    OF_BSN_TLV_PARENT_PORT = 441,
    OF_BSN_TLV_PARTNER_KEY = 442,
    OF_BSN_TLV_PARTNER_PORT_NUM = 443,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 444,
    OF_BSN_TLV_PARTNER_STATE = 445,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 446,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 447,
    OF_BSN_TLV_PASSIVE = 448,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 449,
    OF_BSN_TLV_PIM_DR = 450,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 451,
    OF_BSN_TLV_PORT = 452,
    OF_BSN_TLV_PORT_MODE = 453,
    OF_BSN_TLV_PORT_SPEED_GBPS = 454,
    OF_BSN_TLV_PORT_USAGE = 455,
    OF_BSN_TLV_PORT_VXLAN_MODE = 456,
    OF_BSN_TLV_PRESERVE_VLAN = 457,
    OF_BSN_TLV_PRIORITY = 458,
    OF_BSN_TLV_PUSH_TWO_PER_POLICY = 459,
    OF_BSN_TLV_PUSH_TWO_TAGS_CAPABILITY = 460,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 461,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 462,
    OF_BSN_TLV_QOS_PRIORITY = 463,
    OF_BSN_TLV_QUEUE_ID = 464,
    OF_BSN_TLV_QUEUE_WEIGHT = 465,
    OF_BSN_TLV_RATE_LIMIT = 466,
    OF_BSN_TLV_RATE_UNIT = 467,
    OF_BSN_TLV_RECORD_PACKETS = 468,
    OF_BSN_TLV_REDUNDANT_MGMT = 469,
    OF_BSN_TLV_REFERENCE = 470,
    OF_BSN_TLV_REPLY_PACKETS = 471,
    OF_BSN_TLV_REQUEST_PACKETS = 472,
    OF_BSN_TLV_REST_SERVER = 473,
    OF_BSN_TLV_ROUTING_PARAM = 474,
    OF_BSN_TLV_RX_BYTES = 475,
    OF_BSN_TLV_RX_PACKETS = 476,
    OF_BSN_TLV_SAMPLING_RATE = 477,
    OF_BSN_TLV_SCTP_DST = 478,
    OF_BSN_TLV_SCTP_SRC = 479,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 480,
    OF_BSN_TLV_SOCKET = 481,
    OF_BSN_TLV_SRC_MAC_CML = 482,
    OF_BSN_TLV_STATUS = 483,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 484,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 485,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 486,
    OF_BSN_TLV_SUB_AGENT_ID = 487,
    OF_BSN_TLV_TCP_DST = 488,
    OF_BSN_TLV_TCP_FLAGS = 489,
    OF_BSN_TLV_TCP_SRC = 490,
    OF_BSN_TLV_THREAD = 491,
    OF_BSN_TLV_TIMESTAMP = 492,
    OF_BSN_TLV_TTL = 493,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 494,
    OF_BSN_TLV_TX_BYTES = 495,
    OF_BSN_TLV_TX_PACKETS = 496,
    OF_BSN_TLV_UDF_ANCHOR = 497,
    OF_BSN_TLV_UDF_CAPABILITY = 498,
    OF_BSN_TLV_UDF_DATA = 499,
    OF_BSN_TLV_UDF_ID = 500,
    OF_BSN_TLV_UDF_LENGTH = 501,
    OF_BSN_TLV_UDF_OFFSET = 502,
    OF_BSN_TLV_UDP_DST = 503,
    OF_BSN_TLV_UDP_SRC = 504,
    OF_BSN_TLV_UINT32 = 505,
    OF_BSN_TLV_UINT64_LIST = 506,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 507,
    OF_BSN_TLV_UNICAST_RATE = 508,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 509,
    OF_BSN_TLV_UNTAGGED = 510,
    OF_BSN_TLV_UPGRADE = 511,
    OF_BSN_TLV_URI_SCHEME = 512,
    OF_BSN_TLV_USE_PACKET_STATE = 513,
    OF_BSN_TLV_USER_CONFIGURED = 514,
    OF_BSN_TLV_VFI = 515,
    OF_BSN_TLV_VFP_CLASS_ID = 516,
    OF_BSN_TLV_VIRTUAL = 517,
    OF_BSN_TLV_VLAN_MAC_LIST = 518,
    OF_BSN_TLV_VLAN_PCP = 519,
    OF_BSN_TLV_VLAN_VID = 520,
    OF_BSN_TLV_VLAN_VID_MASK = 521,
    OF_BSN_TLV_VNI = 522,
    OF_BSN_TLV_VPN_KEY = 523,
    OF_BSN_TLV_VRF = 524,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 525,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 526,
    OF_BSN_VLAN_MAC = 527,
    OF_BSN_VPORT = 528,
    OF_BSN_VPORT_L2GRE = 529,
    OF_BSN_VPORT_Q_IN_Q = 530,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 531,
    OF_BUCKET = 532,
    OF_BUCKET_COUNTER = 533,
    OF_BUNDLE_PROP = 534,
    OF_BUNDLE_PROP_EXPERIMENTER = 535,
    OF_FLOW_STATS_ENTRY = 536,
    OF_GROUP_DESC_STATS_ENTRY = 537,
    OF_GROUP_STATS_ENTRY = 538,
    OF_HELLO_ELEM = 539,
    OF_HELLO_ELEM_VERSIONBITMAP = 540,
    OF_INSTRUCTION = 541,
    OF_INSTRUCTION_APPLY_ACTIONS = 542,
    OF_INSTRUCTION_BSN = 543,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 544,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 545,
    OF_INSTRUCTION_BSN_DENY = 546,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 547,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 548,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 549,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 550,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 551,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 552,
    OF_INSTRUCTION_BSN_HASH_SELECT = 553,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 554,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 555,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 556,
    OF_INSTRUCTION_BSN_PERMIT = 557,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 558,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 559,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 560,
    OF_INSTRUCTION_CLEAR_ACTIONS = 561,
    OF_INSTRUCTION_EXPERIMENTER = 562,
    OF_INSTRUCTION_GOTO_TABLE = 563,
    OF_INSTRUCTION_ID = 564,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 565,
    OF_INSTRUCTION_ID_BSN = 566,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 567,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 568,
    OF_INSTRUCTION_ID_BSN_DENY = 569,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 570,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 571,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 572,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 573,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 574,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 575,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 576,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 577,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 578,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 579,
    OF_INSTRUCTION_ID_BSN_PERMIT = 580,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 581,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 582,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 583,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 584,
    OF_INSTRUCTION_ID_EXPERIMENTER = 585,
    OF_INSTRUCTION_ID_GOTO_TABLE = 586,
    OF_INSTRUCTION_ID_METER = 587,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 588,
    OF_INSTRUCTION_ID_WRITE_METADATA = 589,
    OF_INSTRUCTION_METER = 590,
    OF_INSTRUCTION_WRITE_ACTIONS = 591,
    OF_INSTRUCTION_WRITE_METADATA = 592,
    OF_MATCH_V1 = 593,
    OF_MATCH_V2 = 594,
    OF_MATCH_V3 = 595,
    OF_METER_BAND = 596,
    OF_METER_BAND_DROP = 597,
    OF_METER_BAND_DSCP_REMARK = 598,
    OF_METER_BAND_EXPERIMENTER = 599,
    OF_METER_BAND_STATS = 600,
    OF_METER_CONFIG = 601,
    OF_METER_FEATURES = 602,
    OF_METER_STATS = 603,
    OF_OXM = 604,
    OF_OXM_ARP_OP = 605,
    OF_OXM_ARP_OP_MASKED = 606,
    OF_OXM_ARP_SHA = 607,
    OF_OXM_ARP_SHA_MASKED = 608,
    OF_OXM_ARP_SPA = 609,
    OF_OXM_ARP_SPA_MASKED = 610,
    OF_OXM_ARP_THA = 611,
    OF_OXM_ARP_THA_MASKED = 612,
    OF_OXM_ARP_TPA = 613,
    OF_OXM_ARP_TPA_MASKED = 614,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 615,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 616,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 617,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 618,
    OF_OXM_BSN_IFP_CLASS_ID = 619,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 620,
    OF_OXM_BSN_IN_PORTS_128 = 621,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 622,
    OF_OXM_BSN_IN_PORTS_512 = 623,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 624,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 625,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 626,
    OF_OXM_BSN_INNER_ETH_DST = 627,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 628,
    OF_OXM_BSN_INNER_ETH_SRC = 629,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 630,
    OF_OXM_BSN_INNER_VLAN_VID = 631,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 632,
    OF_OXM_BSN_IP_FRAGMENTATION = 633,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 634,
    OF_OXM_BSN_L2_CACHE_HIT = 635,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 636,
    OF_OXM_BSN_L3_DST_CLASS_ID = 637,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 638,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 639,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 640,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 641,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 642,
    OF_OXM_BSN_LAG_ID = 643,
    OF_OXM_BSN_LAG_ID_MASKED = 644,
    OF_OXM_BSN_TCP_FLAGS = 645,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 646,
    OF_OXM_BSN_UDF0 = 647,
    OF_OXM_BSN_UDF0_MASKED = 648,
    OF_OXM_BSN_UDF1 = 649,
    OF_OXM_BSN_UDF1_MASKED = 650,
    OF_OXM_BSN_UDF2 = 651,
    OF_OXM_BSN_UDF2_MASKED = 652,
    OF_OXM_BSN_UDF3 = 653,
    OF_OXM_BSN_UDF3_MASKED = 654,
    OF_OXM_BSN_UDF4 = 655,
    OF_OXM_BSN_UDF4_MASKED = 656,
    OF_OXM_BSN_UDF5 = 657,
    OF_OXM_BSN_UDF5_MASKED = 658,
    OF_OXM_BSN_UDF6 = 659,
    OF_OXM_BSN_UDF6_MASKED = 660,
    OF_OXM_BSN_UDF7 = 661,
    OF_OXM_BSN_UDF7_MASKED = 662,
    OF_OXM_BSN_VFI = 663,
    OF_OXM_BSN_VFI_MASKED = 664,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 665,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 666,
    OF_OXM_BSN_VRF = 667,
    OF_OXM_BSN_VRF_MASKED = 668,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 669,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 670,
    OF_OXM_CONN_TRACKING_IPV6_DST = 671,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 672,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 673,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 674,
    OF_OXM_CONN_TRACKING_LABEL = 675,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 676,
    OF_OXM_CONN_TRACKING_MARK = 677,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 678,
    OF_OXM_CONN_TRACKING_NW_DST = 679,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 680,
    OF_OXM_CONN_TRACKING_NW_PROTO = 681,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 682,
    OF_OXM_CONN_TRACKING_NW_SRC = 683,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 684,
    OF_OXM_CONN_TRACKING_STATE = 685,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 686,
    OF_OXM_CONN_TRACKING_TP_DST = 687,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 688,
    OF_OXM_CONN_TRACKING_TP_SRC = 689,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 690,
    OF_OXM_CONN_TRACKING_ZONE = 691,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 692,
    OF_OXM_ETH_DST = 693,
    OF_OXM_ETH_DST_MASKED = 694,
    OF_OXM_ETH_SRC = 695,
    OF_OXM_ETH_SRC_MASKED = 696,
    OF_OXM_ETH_TYPE = 697,
    OF_OXM_ETH_TYPE_MASKED = 698,
    OF_OXM_ICMPV4_CODE = 699,
    OF_OXM_ICMPV4_CODE_MASKED = 700,
    OF_OXM_ICMPV4_TYPE = 701,
    OF_OXM_ICMPV4_TYPE_MASKED = 702,
    OF_OXM_ICMPV6_CODE = 703,
    OF_OXM_ICMPV6_CODE_MASKED = 704,
    OF_OXM_ICMPV6_TYPE = 705,
    OF_OXM_ICMPV6_TYPE_MASKED = 706,
    OF_OXM_IN_PHY_PORT = 707,
    OF_OXM_IN_PHY_PORT_MASKED = 708,
    OF_OXM_IN_PORT = 709,
    OF_OXM_IN_PORT_MASKED = 710,
    OF_OXM_IP_DSCP = 711,
    OF_OXM_IP_DSCP_MASKED = 712,
    OF_OXM_IP_ECN = 713,
    OF_OXM_IP_ECN_MASKED = 714,
    OF_OXM_IP_PROTO = 715,
    OF_OXM_IP_PROTO_MASKED = 716,
    OF_OXM_IPV4_DST = 717,
    OF_OXM_IPV4_DST_MASKED = 718,
    OF_OXM_IPV4_SRC = 719,
    OF_OXM_IPV4_SRC_MASKED = 720,
    OF_OXM_IPV6_DST = 721,
    OF_OXM_IPV6_DST_MASKED = 722,
    OF_OXM_IPV6_EXTHDR = 723,
    OF_OXM_IPV6_EXTHDR_MASKED = 724,
    OF_OXM_IPV6_FLABEL = 725,
    OF_OXM_IPV6_FLABEL_MASKED = 726,
    OF_OXM_IPV6_ND_SLL = 727,
    OF_OXM_IPV6_ND_SLL_MASKED = 728,
    OF_OXM_IPV6_ND_TARGET = 729,
    OF_OXM_IPV6_ND_TARGET_MASKED = 730,
    OF_OXM_IPV6_ND_TLL = 731,
    OF_OXM_IPV6_ND_TLL_MASKED = 732,
    OF_OXM_IPV6_SRC = 733,
    OF_OXM_IPV6_SRC_MASKED = 734,
    OF_OXM_METADATA = 735,
    OF_OXM_METADATA_MASKED = 736,
    OF_OXM_MPLS_BOS = 737,
    OF_OXM_MPLS_BOS_MASKED = 738,
    OF_OXM_MPLS_LABEL = 739,
    OF_OXM_MPLS_LABEL_MASKED = 740,
    OF_OXM_MPLS_TC = 741,
    OF_OXM_MPLS_TC_MASKED = 742,
    OF_OXM_OVS_TCP_FLAGS = 743,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 744,
    OF_OXM_PBB_UCA = 745,
    OF_OXM_PBB_UCA_MASKED = 746,
    OF_OXM_SCTP_DST = 747,
    OF_OXM_SCTP_DST_MASKED = 748,
    OF_OXM_SCTP_SRC = 749,
    OF_OXM_SCTP_SRC_MASKED = 750,
    OF_OXM_TCP_DST = 751,
    OF_OXM_TCP_DST_MASKED = 752,
    OF_OXM_TCP_SRC = 753,
    OF_OXM_TCP_SRC_MASKED = 754,
    OF_OXM_TUNNEL_ID = 755,
    OF_OXM_TUNNEL_ID_MASKED = 756,
    OF_OXM_TUNNEL_IPV4_DST = 757,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 758,
    OF_OXM_TUNNEL_IPV4_SRC = 759,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 760,
    OF_OXM_UDP_DST = 761,
    OF_OXM_UDP_DST_MASKED = 762,
    OF_OXM_UDP_SRC = 763,
    OF_OXM_UDP_SRC_MASKED = 764,
    OF_OXM_VLAN_PCP = 765,
    OF_OXM_VLAN_PCP_MASKED = 766,
    OF_OXM_VLAN_VID = 767,
    OF_OXM_VLAN_VID_MASKED = 768,
    OF_PACKET_QUEUE = 769,
    OF_PORT_DESC = 770,
    OF_PORT_DESC_PROP = 771,
    OF_PORT_DESC_PROP_BSN = 772,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 773,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 774,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 775,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 776,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 777,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 778,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 779,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 780,
    OF_PORT_DESC_PROP_BSN_UPLINK = 781,
    OF_PORT_DESC_PROP_ETHERNET = 782,
    OF_PORT_DESC_PROP_EXPERIMENTER = 783,
    OF_PORT_DESC_PROP_OPTICAL = 784,
    OF_PORT_MOD_PROP = 785,
    OF_PORT_MOD_PROP_ETHERNET = 786,
    OF_PORT_MOD_PROP_EXPERIMENTER = 787,
    OF_PORT_MOD_PROP_OPTICAL = 788,
    OF_PORT_STATS_ENTRY = 789,
    OF_PORT_STATS_PROP = 790,
    OF_PORT_STATS_PROP_ETHERNET = 791,
    OF_PORT_STATS_PROP_EXPERIMENTER = 792,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 793,
    OF_PORT_STATS_PROP_OPTICAL = 794,
    OF_QUEUE_DESC = 795,
    OF_QUEUE_DESC_PROP = 796,
    OF_QUEUE_DESC_PROP_BSN = 797,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 798,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 799,
    OF_QUEUE_DESC_PROP_MAX_RATE = 800,
    OF_QUEUE_DESC_PROP_MIN_RATE = 801,
    OF_QUEUE_PROP = 802,
    OF_QUEUE_PROP_EXPERIMENTER = 803,
    OF_QUEUE_PROP_MAX_RATE = 804,
    OF_QUEUE_PROP_MIN_RATE = 805,
    OF_QUEUE_STATS_ENTRY = 806,
    OF_QUEUE_STATS_PROP = 807,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 808,
    OF_ROLE_PROP = 809,
    OF_ROLE_PROP_EXPERIMENTER = 810,
    OF_TABLE_DESC = 811,
    OF_TABLE_FEATURE_PROP = 812,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 813,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 814,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 815,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 816,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 817,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 818,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 819,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 820,
    OF_TABLE_FEATURE_PROP_MATCH = 821,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 822,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 823,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 824,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 825,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 826,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 827,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 828,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 829,
    OF_TABLE_FEATURES = 830,
    OF_TABLE_MOD_PROP = 831,
    OF_TABLE_MOD_PROP_EVICTION = 832,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 833,
    OF_TABLE_MOD_PROP_VACANCY = 834,
    OF_TABLE_STATS_ENTRY = 835,
    OF_UINT32 = 836,
    OF_UINT64 = 837,
    OF_UINT8 = 838,
    ...
    /* List objects */
    OF_LIST_ACTION = 839,
    OF_LIST_ACTION_ID = 840,
    OF_LIST_ASYNC_CONFIG_PROP = 841,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 842,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 843,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 844,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 845,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 846,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 847,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 848,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 849,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 850,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 851,
    OF_LIST_BSN_INTERFACE = 852,
    OF_LIST_BSN_LACP_STATS_ENTRY = 853,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 854,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 855,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 856,
    OF_LIST_BSN_TLV = 857,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 858,
    OF_LIST_BSN_VLAN_MAC = 859,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 860,
    OF_LIST_BUCKET = 861,
    OF_LIST_BUCKET_COUNTER = 862,
    OF_LIST_BUNDLE_PROP = 863,
    OF_LIST_FLOW_STATS_ENTRY = 864,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 865,
    OF_LIST_GROUP_STATS_ENTRY = 866,
    OF_LIST_HELLO_ELEM = 867,
    OF_LIST_INSTRUCTION = 868,
    OF_LIST_INSTRUCTION_ID = 869,
    OF_LIST_METER_BAND = 870,
    OF_LIST_METER_BAND_STATS = 871,
    OF_LIST_METER_CONFIG = 872,
    OF_LIST_METER_STATS = 873,
    OF_LIST_OXM = 874,
    OF_LIST_PACKET_QUEUE = 875,
    OF_LIST_PORT_DESC = 876,
    OF_LIST_PORT_DESC_PROP = 877,
    OF_LIST_PORT_MOD_PROP = 878,
    OF_LIST_PORT_STATS_ENTRY = 879,
    OF_LIST_PORT_STATS_PROP = 880,
    OF_LIST_QUEUE_DESC = 881,
    OF_LIST_QUEUE_DESC_PROP = 882,
    OF_LIST_QUEUE_PROP = 883,
    OF_LIST_QUEUE_STATS_ENTRY = 884,
    OF_LIST_QUEUE_STATS_PROP = 885,
    OF_LIST_ROLE_PROP = 886,
    OF_LIST_TABLE_DESC = 887,
    OF_LIST_TABLE_FEATURE_PROP = 888,
    OF_LIST_TABLE_FEATURES = 889,
    OF_LIST_TABLE_MOD_PROP = 890,
    OF_LIST_TABLE_STATS_ENTRY = 891,
    OF_LIST_UINT32 = 892,
    OF_LIST_UINT64 = 893,
    OF_LIST_UINT8 = 894,
