...
typedef enum of_object_id_e {
    ...
    OF_BSN_GET_INTERFACES_REPLY = 25,
    OF_BSN_GET_INTERFACES_REQUEST = 26,
    OF_BSN_GET_IP_MASK_REPLY = 27,
    OF_BSN_GET_IP_MASK_REQUEST = 28,
    OF_BSN_GET_L2_TABLE_REPLY = 29,
    OF_BSN_GET_L2_TABLE_REQUEST = 30,
    OF_BSN_GET_MIRRORING_REPLY = 31,
    OF_BSN_GET_MIRRORING_REQUEST = 32,
    OF_BSN_GET_SWITCH_PIPELINE_REPLY = 33,
    OF_BSN_GET_SWITCH_PIPELINE_REQUEST = 34,
    OF_BSN_HEADER = 35,
    OF_BSN_HYBRID_GET_REPLY = 36,
    OF_BSN_HYBRID_GET_REQUEST = 37,
    OF_BSN_LACP_CONVERGENCE_NOTIF = 38,
    OF_BSN_LACP_STATS_REPLY = 39,
    OF_BSN_LACP_STATS_REQUEST = 40,
    OF_BSN_PDU_RX_REPLY = 41,
    OF_BSN_PDU_RX_REQUEST = 42,
    OF_BSN_PDU_RX_TIMEOUT = 43,
    OF_BSN_PDU_TX_REPLY = 44,
    OF_BSN_PDU_TX_REQUEST = 45,
    OF_BSN_PORT_COUNTER_STATS_REPLY = 46,
    OF_BSN_PORT_COUNTER_STATS_REQUEST = 47,
    OF_BSN_ROLE_STATUS = 48,
    OF_BSN_SET_IP_MASK = 49,
    OF_BSN_SET_L2_TABLE_REPLY = 50,
    OF_BSN_SET_L2_TABLE_REQUEST = 51,
    OF_BSN_SET_LACP_REPLY = 52,
    OF_BSN_SET_LACP_REQUEST = 53,
    OF_BSN_SET_MIRRORING = 54,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 55,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 56,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 57,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 58,
    OF_BSN_SHELL_COMMAND = 59,
    OF_BSN_SHELL_OUTPUT = 60,
    OF_BSN_SHELL_STATUS = 61,
    OF_BSN_STATS_REPLY = 62,
    OF_BSN_STATS_REQUEST = 63,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 64,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 65,
    OF_BSN_TIME_REPLY = 66,
    OF_BSN_TIME_REQUEST = 67,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 68,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 69,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 70,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 71,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 72,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 73,
    OF_DESC_STATS_REPLY = 74,
    OF_DESC_STATS_REQUEST = 75,
    OF_ECHO_REPLY = 76,
    OF_ECHO_REQUEST = 77,
    OF_ERROR_MSG = 78,
    OF_EXPERIMENTER = 79,
    OF_EXPERIMENTER_ERROR_MSG = 80,
    OF_EXPERIMENTER_STATS_REPLY = 81,
    OF_EXPERIMENTER_STATS_REQUEST = 82,
    OF_FEATURES_REPLY = 83,
    OF_FEATURES_REQUEST = 84,
    OF_FLOW_ADD = 85,
    OF_FLOW_DELETE = 86,
    OF_FLOW_DELETE_STRICT = 87,
    OF_FLOW_MOD = 88,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 89,
    OF_FLOW_MODIFY = 90,
    OF_FLOW_MODIFY_STRICT = 91,
    OF_FLOW_REMOVED = 92,
    OF_FLOW_STATS_REPLY = 93,
    OF_FLOW_STATS_REQUEST = 94,
    OF_GET_CONFIG_REPLY = 95,
    OF_GET_CONFIG_REQUEST = 96,
    OF_GROUP_ADD = 97,
    OF_GROUP_DELETE = 98,
    OF_GROUP_DESC_STATS_REPLY = 99,
    OF_GROUP_DESC_STATS_REQUEST = 100,
    OF_GROUP_FEATURES_STATS_REPLY = 101,
    OF_GROUP_FEATURES_STATS_REQUEST = 102,
    OF_GROUP_MOD = 103,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 104,
    OF_GROUP_MODIFY = 105,
    OF_GROUP_STATS_REPLY = 106,
    OF_GROUP_STATS_REQUEST = 107,
    OF_HELLO = 108,
    OF_HELLO_FAILED_ERROR_MSG = 109,
    OF_METER_CONFIG_STATS_REPLY = 110,
    OF_METER_CONFIG_STATS_REQUEST = 111,
    OF_METER_FEATURES_STATS_REPLY = 112,
    OF_METER_FEATURES_STATS_REQUEST = 113,
    OF_METER_MOD = 114,
    OF_METER_MOD_FAILED_ERROR_MSG = 115,
    OF_METER_STATS_REPLY = 116,
    OF_METER_STATS_REQUEST = 117,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 118,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 119,
    OF_NICIRA_HEADER = 120,
    OF_PACKET_IN = 121,
    OF_PACKET_OUT = 122,
    OF_PORT_DESC_STATS_REPLY = 123,
    OF_PORT_DESC_STATS_REQUEST = 124,
    OF_PORT_MOD = 125,
    OF_PORT_MOD_FAILED_ERROR_MSG = 126,
    OF_PORT_STATS_REPLY = 127,
    OF_PORT_STATS_REQUEST = 128,
    OF_PORT_STATUS = 129,
    OF_QUEUE_GET_CONFIG_REPLY = 130,
    OF_QUEUE_GET_CONFIG_REQUEST = 131,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 132,
    OF_QUEUE_STATS_REPLY = 133,
    OF_QUEUE_STATS_REQUEST = 134,
    OF_ROLE_REPLY = 135,
    OF_ROLE_REQUEST = 136,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 137,
    OF_SET_CONFIG = 138,
    OF_STATS_REPLY = 139,
    OF_STATS_REQUEST = 140,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 141,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 142,
    OF_TABLE_FEATURES_STATS_REPLY = 143,
    OF_TABLE_FEATURES_STATS_REQUEST = 144,
    OF_TABLE_MOD = 145,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 146,
    OF_TABLE_STATS_REPLY = 147,
    OF_TABLE_STATS_REQUEST = 148,

    /* Non-message objects */
    OF_ACTION = 149,
    OF_ACTION_BSN = 150,
    OF_ACTION_BSN_MIRROR = 151,
    OF_ACTION_BSN_SET_TUNNEL_DST = 152,
    OF_ACTION_COPY_TTL_IN = 153,
    OF_ACTION_COPY_TTL_OUT = 154,
    OF_ACTION_DEC_MPLS_TTL = 155,
    OF_ACTION_DEC_NW_TTL = 156,
    OF_ACTION_ENQUEUE = 157,
    OF_ACTION_EXPERIMENTER = 158,
    OF_ACTION_GROUP = 159,
    OF_ACTION_HEADER = 160,
    OF_ACTION_ID = 161,
    OF_ACTION_ID_BSN = 162,
    OF_ACTION_ID_BSN_MIRROR = 163,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 164,
    OF_ACTION_ID_COPY_TTL_IN = 165,
    OF_ACTION_ID_COPY_TTL_OUT = 166,
    OF_ACTION_ID_DEC_MPLS_TTL = 167,
    OF_ACTION_ID_DEC_NW_TTL = 168,
    OF_ACTION_ID_EXPERIMENTER = 169,
    OF_ACTION_ID_GROUP = 170,
    OF_ACTION_ID_HEADER = 171,
    OF_ACTION_ID_NICIRA = 172,
    OF_ACTION_ID_NICIRA_DEC_TTL = 173,
    OF_ACTION_ID_OUTPUT = 174,
    OF_ACTION_ID_POP_MPLS = 175,
    OF_ACTION_ID_POP_PBB = 176,
    OF_ACTION_ID_POP_VLAN = 177,
    OF_ACTION_ID_PUSH_MPLS = 178,
    OF_ACTION_ID_PUSH_PBB = 179,
    OF_ACTION_ID_PUSH_VLAN = 180,
    OF_ACTION_ID_SET_FIELD = 181,
    OF_ACTION_ID_SET_MPLS_TTL = 182,
    OF_ACTION_ID_SET_NW_TTL = 183,
    OF_ACTION_ID_SET_QUEUE = 184,
    OF_ACTION_NICIRA = 185,
    OF_ACTION_NICIRA_DEC_TTL = 186,
    OF_ACTION_OUTPUT = 187,
    OF_ACTION_POP_MPLS = 188,
    OF_ACTION_POP_PBB = 189,
    OF_ACTION_POP_VLAN = 190,
    OF_ACTION_PUSH_MPLS = 191,
    OF_ACTION_PUSH_PBB = 192,
    OF_ACTION_PUSH_VLAN = 193,
    OF_ACTION_SET_DL_DST = 194,
    OF_ACTION_SET_DL_SRC = 195,
    OF_ACTION_SET_FIELD = 196,
    OF_ACTION_SET_MPLS_LABEL = 197,
    OF_ACTION_SET_MPLS_TC = 198,
    OF_ACTION_SET_MPLS_TTL = 199,
    OF_ACTION_SET_NW_DST = 200,
    OF_ACTION_SET_NW_ECN = 201,
    OF_ACTION_SET_NW_SRC = 202,
    OF_ACTION_SET_NW_TOS = 203,
    OF_ACTION_SET_NW_TTL = 204,
    OF_ACTION_SET_QUEUE = 205,
    OF_ACTION_SET_TP_DST = 206,
    OF_ACTION_SET_TP_SRC = 207,
    OF_ACTION_SET_VLAN_PCP = 208,
    OF_ACTION_SET_VLAN_VID = 209,
    OF_ACTION_STRIP_VLAN = 210,
    OF_BSN_CONTROLLER_CONNECTION = 211,
    OF_BSN_INTERFACE = 212,
    OF_BSN_LACP_STATS_ENTRY = 213,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 214,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 215,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 216,
    OF_BSN_VPORT = 217,
    OF_BSN_VPORT_HEADER = 218,
    OF_BSN_VPORT_Q_IN_Q = 219,
    OF_BUCKET = 220,
    OF_BUCKET_COUNTER = 221,
    OF_EXPERIMENTER_STATS_HEADER = 222,
    OF_FLOW_STATS_ENTRY = 223,
    OF_GROUP_DESC_STATS_ENTRY = 224,
    OF_GROUP_STATS_ENTRY = 225,
    OF_HEADER = 226,
    OF_HELLO_ELEM = 227,
    OF_HELLO_ELEM_HEADER = 228,
    OF_HELLO_ELEM_VERSIONBITMAP = 229,
    OF_INSTRUCTION = 230,
    OF_INSTRUCTION_APPLY_ACTIONS = 231,
    OF_INSTRUCTION_BSN = 232,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 233,
    OF_INSTRUCTION_CLEAR_ACTIONS = 234,
    OF_INSTRUCTION_EXPERIMENTER = 235,
    OF_INSTRUCTION_GOTO_TABLE = 236,
    OF_INSTRUCTION_HEADER = 237,
    OF_INSTRUCTION_ID = 238,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 239,
    OF_INSTRUCTION_ID_BSN = 240,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 241,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 242,
    OF_INSTRUCTION_ID_EXPERIMENTER = 243,
    OF_INSTRUCTION_ID_GOTO_TABLE = 244,
    OF_INSTRUCTION_ID_HEADER = 245,
    OF_INSTRUCTION_ID_METER = 246,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 247,
    OF_INSTRUCTION_ID_WRITE_METADATA = 248,
    OF_INSTRUCTION_METER = 249,
    OF_INSTRUCTION_WRITE_ACTIONS = 250,
    OF_INSTRUCTION_WRITE_METADATA = 251,
    OF_MATCH_V1 = 252,
    OF_MATCH_V2 = 253,
    OF_MATCH_V3 = 254,
    OF_METER_BAND = 255,
    OF_METER_BAND_DROP = 256,
    OF_METER_BAND_DSCP_REMARK = 257,
    OF_METER_BAND_EXPERIMENTER = 258,
    OF_METER_BAND_HEADER = 259,
    OF_METER_BAND_STATS = 260,
    OF_METER_CONFIG = 261,
    OF_METER_FEATURES = 262,
    OF_METER_STATS = 263,
    OF_OXM = 264,
    OF_OXM_ARP_OP = 265,
    OF_OXM_ARP_OP_MASKED = 266,
    OF_OXM_ARP_SHA = 267,
    OF_OXM_ARP_SHA_MASKED = 268,
    OF_OXM_ARP_SPA = 269,
    OF_OXM_ARP_SPA_MASKED = 270,
    OF_OXM_ARP_THA = 271,
    OF_OXM_ARP_THA_MASKED = 272,
    OF_OXM_ARP_TPA = 273,
    OF_OXM_ARP_TPA_MASKED = 274,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 275,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 276,
    OF_OXM_BSN_IN_PORTS_128 = 277,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 278,
    OF_OXM_BSN_L3_DST_CLASS_ID = 279,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 280,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 281,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 282,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 283,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 284,
    OF_OXM_BSN_LAG_ID = 285,
    OF_OXM_BSN_LAG_ID_MASKED = 286,
    OF_OXM_BSN_VRF = 287,
    OF_OXM_BSN_VRF_MASKED = 288,
    OF_OXM_ETH_DST = 289,
    OF_OXM_ETH_DST_MASKED = 290,
    OF_OXM_ETH_SRC = 291,
    OF_OXM_ETH_SRC_MASKED = 292,
    OF_OXM_ETH_TYPE = 293,
    OF_OXM_ETH_TYPE_MASKED = 294,
    OF_OXM_HEADER = 295,
    OF_OXM_ICMPV4_CODE = 296,
    OF_OXM_ICMPV4_CODE_MASKED = 297,
    OF_OXM_ICMPV4_TYPE = 298,
    OF_OXM_ICMPV4_TYPE_MASKED = 299,
    OF_OXM_ICMPV6_CODE = 300,
    OF_OXM_ICMPV6_CODE_MASKED = 301,
    OF_OXM_ICMPV6_TYPE = 302,
    OF_OXM_ICMPV6_TYPE_MASKED = 303,
    OF_OXM_IN_PHY_PORT = 304,
    OF_OXM_IN_PHY_PORT_MASKED = 305,
    OF_OXM_IN_PORT = 306,
    OF_OXM_IN_PORT_MASKED = 307,
    OF_OXM_IP_DSCP = 308,
    OF_OXM_IP_DSCP_MASKED = 309,
    OF_OXM_IP_ECN = 310,
    OF_OXM_IP_ECN_MASKED = 311,
    OF_OXM_IP_PROTO = 312,
    OF_OXM_IP_PROTO_MASKED = 313,
    OF_OXM_IPV4_DST = 314,
    OF_OXM_IPV4_DST_MASKED = 315,
    OF_OXM_IPV4_SRC = 316,
    OF_OXM_IPV4_SRC_MASKED = 317,
    OF_OXM_IPV6_DST = 318,
    OF_OXM_IPV6_DST_MASKED = 319,
    OF_OXM_IPV6_FLABEL = 320,
    OF_OXM_IPV6_FLABEL_MASKED = 321,
    OF_OXM_IPV6_ND_SLL = 322,
    OF_OXM_IPV6_ND_SLL_MASKED = 323,
    OF_OXM_IPV6_ND_TARGET = 324,
    OF_OXM_IPV6_ND_TARGET_MASKED = 325,
    OF_OXM_IPV6_ND_TLL = 326,
    OF_OXM_IPV6_ND_TLL_MASKED = 327,
    OF_OXM_IPV6_SRC = 328,
    OF_OXM_IPV6_SRC_MASKED = 329,
    OF_OXM_METADATA = 330,
    OF_OXM_METADATA_MASKED = 331,
    OF_OXM_MPLS_LABEL = 332,
    OF_OXM_MPLS_LABEL_MASKED = 333,
    OF_OXM_MPLS_TC = 334,
    OF_OXM_MPLS_TC_MASKED = 335,
    OF_OXM_SCTP_DST = 336,
    OF_OXM_SCTP_DST_MASKED = 337,
    OF_OXM_SCTP_SRC = 338,
    OF_OXM_SCTP_SRC_MASKED = 339,
    OF_OXM_TCP_DST = 340,
    OF_OXM_TCP_DST_MASKED = 341,
    OF_OXM_TCP_SRC = 342,
    OF_OXM_TCP_SRC_MASKED = 343,
    OF_OXM_UDP_DST = 344,
    OF_OXM_UDP_DST_MASKED = 345,
    OF_OXM_UDP_SRC = 346,
    OF_OXM_UDP_SRC_MASKED = 347,
    OF_OXM_VLAN_PCP = 348,
    OF_OXM_VLAN_PCP_MASKED = 349,
    OF_OXM_VLAN_VID = 350,
    OF_OXM_VLAN_VID_MASKED = 351,
    OF_PACKET_QUEUE = 352,
    OF_PORT_DESC = 353,
    OF_PORT_STATS_ENTRY = 354,
    OF_QUEUE_PROP = 355,
    OF_QUEUE_PROP_EXPERIMENTER = 356,
    OF_QUEUE_PROP_HEADER = 357,
    OF_QUEUE_PROP_MAX_RATE = 358,
    OF_QUEUE_PROP_MIN_RATE = 359,
    OF_QUEUE_STATS_ENTRY = 360,
    OF_TABLE_FEATURE_PROP = 361,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 362,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 363,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 364,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 365,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 366,
    OF_TABLE_FEATURE_PROP_HEADER = 367,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 368,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 369,
    OF_TABLE_FEATURE_PROP_MATCH = 370,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 371,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 372,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 373,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 374,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 375,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 376,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 377,
    OF_TABLE_FEATURES = 378,
    OF_TABLE_STATS_ENTRY = 379,
    OF_UINT32 = 380,
    OF_UINT64 = 381,
    OF_UINT8 = 382,
    ...
    /* List objects */
    OF_LIST_ACTION = 383,
    OF_LIST_ACTION_ID = 384,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 385,
    OF_LIST_BSN_INTERFACE = 386,
    OF_LIST_BSN_LACP_STATS_ENTRY = 387,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 388,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 389,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 390,
    OF_LIST_BUCKET = 391,
    OF_LIST_BUCKET_COUNTER = 392,
    OF_LIST_FLOW_STATS_ENTRY = 393,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 394,
    OF_LIST_GROUP_STATS_ENTRY = 395,
    OF_LIST_HELLO_ELEM = 396,
    OF_LIST_INSTRUCTION = 397,
    OF_LIST_METER_BAND = 398,
    OF_LIST_METER_BAND_STATS = 399,
    OF_LIST_METER_STATS = 400,
    OF_LIST_OXM = 401,
    OF_LIST_PACKET_QUEUE = 402,
    OF_LIST_PORT_DESC = 403,
    OF_LIST_PORT_STATS_ENTRY = 404,
    OF_LIST_QUEUE_PROP = 405,
    OF_LIST_QUEUE_STATS_ENTRY = 406,
    OF_LIST_TABLE_FEATURE_PROP = 407,
    OF_LIST_TABLE_FEATURES = 408,
    OF_LIST_TABLE_STATS_ENTRY = 409,
    OF_LIST_UINT32 = 410,
    OF_LIST_UINT64 = 411,
    OF_LIST_UINT8 = 412,
...
#define OF_MESSAGE_OBJECT_COUNT 149
