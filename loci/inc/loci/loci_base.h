...
typedef enum of_object_id_e {
    ...
    OF_DESC_STATS_REPLY = 106,
    OF_DESC_STATS_REQUEST = 107,
    OF_ECHO_REPLY = 108,
    OF_ECHO_REQUEST = 109,
    OF_ERROR_MSG = 110,
    OF_EXPERIMENTER = 111,
    OF_EXPERIMENTER_ERROR_MSG = 112,
    OF_EXPERIMENTER_STATS_REPLY = 113,
    OF_EXPERIMENTER_STATS_REQUEST = 114,
    OF_FEATURES_REPLY = 115,
    OF_FEATURES_REQUEST = 116,
    OF_FLOW_ADD = 117,
    OF_FLOW_DELETE = 118,
    OF_FLOW_DELETE_STRICT = 119,
    OF_FLOW_MOD = 120,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 121,
    OF_FLOW_MODIFY = 122,
    OF_FLOW_MODIFY_STRICT = 123,
    OF_FLOW_REMOVED = 124,
    OF_FLOW_STATS_REPLY = 125,
    OF_FLOW_STATS_REQUEST = 126,
    OF_GET_CONFIG_REPLY = 127,
    OF_GET_CONFIG_REQUEST = 128,
    OF_GROUP_ADD = 129,
    OF_GROUP_DELETE = 130,
    OF_GROUP_DESC_STATS_REPLY = 131,
    OF_GROUP_DESC_STATS_REQUEST = 132,
    OF_GROUP_FEATURES_STATS_REPLY = 133,
    OF_GROUP_FEATURES_STATS_REQUEST = 134,
    OF_GROUP_MOD = 135,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 136,
    OF_GROUP_MODIFY = 137,
    OF_GROUP_STATS_REPLY = 138,
    OF_GROUP_STATS_REQUEST = 139,
    OF_HEADER = 140,
    OF_HELLO = 141,
    OF_HELLO_FAILED_ERROR_MSG = 142,
    OF_METER_CONFIG_STATS_REPLY = 143,
    OF_METER_CONFIG_STATS_REQUEST = 144,
    OF_METER_FEATURES_STATS_REPLY = 145,
    OF_METER_FEATURES_STATS_REQUEST = 146,
    OF_METER_MOD = 147,
    OF_METER_MOD_FAILED_ERROR_MSG = 148,
    ...
    OF_PACKET_IN = 154,
    OF_PACKET_OUT = 155,
    OF_PORT_DESC_STATS_REPLY = 156,
    OF_PORT_DESC_STATS_REQUEST = 157,
    OF_PORT_MOD = 158,
    OF_PORT_MOD_FAILED_ERROR_MSG = 159,
    OF_PORT_STATS_REPLY = 160,
    OF_PORT_STATS_REQUEST = 161,
    OF_PORT_STATUS = 162,
    OF_QUEUE_GET_CONFIG_REPLY = 163,
    OF_QUEUE_GET_CONFIG_REQUEST = 164,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 165,
    OF_QUEUE_STATS_REPLY = 166,
    OF_QUEUE_STATS_REQUEST = 167,
    OF_ROLE_REPLY = 168,
    OF_ROLE_REQUEST = 169,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 170,
    OF_SET_CONFIG = 171,
    OF_STATS_REPLY = 172,
    OF_STATS_REQUEST = 173,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 174,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 175,
    OF_TABLE_FEATURES_STATS_REPLY = 176,
    OF_TABLE_FEATURES_STATS_REQUEST = 177,
    OF_TABLE_MOD = 178,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 179,
    OF_TABLE_STATS_REPLY = 180,
    OF_TABLE_STATS_REQUEST = 181,

    /* Non-message objects */
    OF_ACTION = 182,
    OF_ACTION_BSN = 183,
    OF_ACTION_BSN_CHECKSUM = 184,
    OF_ACTION_BSN_GENTABLE = 185,
    OF_ACTION_BSN_MIRROR = 186,
    OF_ACTION_BSN_SET_TUNNEL_DST = 187,
    OF_ACTION_COPY_TTL_IN = 188,
    OF_ACTION_COPY_TTL_OUT = 189,
    OF_ACTION_DEC_MPLS_TTL = 190,
    OF_ACTION_DEC_NW_TTL = 191,
    OF_ACTION_ENQUEUE = 192,
    OF_ACTION_EXPERIMENTER = 193,
    OF_ACTION_GROUP = 194,
    OF_ACTION_HEADER = 195,
    OF_ACTION_ID = 196,
    OF_ACTION_ID_BSN = 197,
    OF_ACTION_ID_BSN_CHECKSUM = 198,
    OF_ACTION_ID_BSN_GENTABLE = 199,
    OF_ACTION_ID_BSN_MIRROR = 200,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 201,
    OF_ACTION_ID_COPY_TTL_IN = 202,
    OF_ACTION_ID_COPY_TTL_OUT = 203,
    OF_ACTION_ID_DEC_MPLS_TTL = 204,
    OF_ACTION_ID_DEC_NW_TTL = 205,
    OF_ACTION_ID_EXPERIMENTER = 206,
    OF_ACTION_ID_GROUP = 207,
    OF_ACTION_ID_HEADER = 208,
    OF_ACTION_ID_NICIRA = 209,
    OF_ACTION_ID_NICIRA_DEC_TTL = 210,
    OF_ACTION_ID_OUTPUT = 211,
    OF_ACTION_ID_POP_MPLS = 212,
    OF_ACTION_ID_POP_PBB = 213,
    OF_ACTION_ID_POP_VLAN = 214,
    OF_ACTION_ID_PUSH_MPLS = 215,
    OF_ACTION_ID_PUSH_PBB = 216,
    OF_ACTION_ID_PUSH_VLAN = 217,
    OF_ACTION_ID_SET_FIELD = 218,
    OF_ACTION_ID_SET_MPLS_TTL = 219,
    OF_ACTION_ID_SET_NW_TTL = 220,
    OF_ACTION_ID_SET_QUEUE = 221,
    OF_ACTION_NICIRA = 222,
    OF_ACTION_NICIRA_DEC_TTL = 223,
    OF_ACTION_OUTPUT = 224,
    OF_ACTION_POP_MPLS = 225,
    OF_ACTION_POP_PBB = 226,
    OF_ACTION_POP_VLAN = 227,
    OF_ACTION_PUSH_MPLS = 228,
    OF_ACTION_PUSH_PBB = 229,
    OF_ACTION_PUSH_VLAN = 230,
    OF_ACTION_SET_DL_DST = 231,
    OF_ACTION_SET_DL_SRC = 232,
    OF_ACTION_SET_FIELD = 233,
    OF_ACTION_SET_MPLS_LABEL = 234,
    OF_ACTION_SET_MPLS_TC = 235,
    OF_ACTION_SET_MPLS_TTL = 236,
    OF_ACTION_SET_NW_DST = 237,
    OF_ACTION_SET_NW_ECN = 238,
    OF_ACTION_SET_NW_SRC = 239,
    OF_ACTION_SET_NW_TOS = 240,
    OF_ACTION_SET_NW_TTL = 241,
    OF_ACTION_SET_QUEUE = 242,
    OF_ACTION_SET_TP_DST = 243,
    OF_ACTION_SET_TP_SRC = 244,
    OF_ACTION_SET_VLAN_PCP = 245,
    OF_ACTION_SET_VLAN_VID = 246,
    OF_ACTION_STRIP_VLAN = 247,
    OF_BSN_CONTROLLER_CONNECTION = 248,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 249,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 250,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 251,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 252,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 253,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 254,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 255,
    OF_BSN_GENTABLE_STATS_ENTRY = 256,
    OF_BSN_INTERFACE = 257,
    OF_BSN_LACP_STATS_ENTRY = 258,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 259,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 260,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 261,
    OF_BSN_TLV = 262,
    OF_BSN_TLV_ACTOR_KEY = 263,
    OF_BSN_TLV_ACTOR_PORT_NUM = 264,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 265,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 266,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 267,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 268,
    OF_BSN_TLV_CIRCUIT_ID = 269,
    OF_BSN_TLV_CONVERGENCE_STATUS = 270,
    OF_BSN_TLV_CRC_ENABLED = 271,
    OF_BSN_TLV_ETH_DST = 272,
    OF_BSN_TLV_ETH_SRC = 273,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 274,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 275,
    OF_BSN_TLV_EXTERNAL_IP = 276,
    OF_BSN_TLV_EXTERNAL_MAC = 277,
    OF_BSN_TLV_EXTERNAL_NETMASK = 278,
    OF_BSN_TLV_HEADER = 279,
    OF_BSN_TLV_HEADER_SIZE = 280,
    OF_BSN_TLV_IDLE_NOTIFICATION = 281,
    OF_BSN_TLV_IDLE_TIME = 282,
    OF_BSN_TLV_IDLE_TIMEOUT = 283,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 284,
    OF_BSN_TLV_INTERNAL_MAC = 285,
    OF_BSN_TLV_IPV4 = 286,
    OF_BSN_TLV_IPV4_DST = 287,
    OF_BSN_TLV_IPV4_SRC = 288,
    OF_BSN_TLV_MAC = 289,
    OF_BSN_TLV_MISS_PACKETS = 290,
    OF_BSN_TLV_NAME = 291,
    OF_BSN_TLV_PARTNER_KEY = 292,
    OF_BSN_TLV_PARTNER_PORT_NUM = 293,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 294,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 295,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 296,
    OF_BSN_TLV_PORT = 297,
    OF_BSN_TLV_QUEUE_ID = 298,
    OF_BSN_TLV_QUEUE_WEIGHT = 299,
    OF_BSN_TLV_REPLY_PACKETS = 300,
    OF_BSN_TLV_REQUEST_PACKETS = 301,
    OF_BSN_TLV_RX_PACKETS = 302,
    OF_BSN_TLV_SAMPLING_RATE = 303,
    OF_BSN_TLV_SUB_AGENT_ID = 304,
    OF_BSN_TLV_TX_BYTES = 305,
    OF_BSN_TLV_TX_PACKETS = 306,
    OF_BSN_TLV_UDF_ANCHOR = 307,
    OF_BSN_TLV_UDF_ID = 308,
    OF_BSN_TLV_UDF_LENGTH = 309,
    OF_BSN_TLV_UDF_OFFSET = 310,
    OF_BSN_TLV_UDP_DST = 311,
    OF_BSN_TLV_UDP_SRC = 312,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 313,
    OF_BSN_TLV_VLAN_VID = 314,
    OF_BSN_TLV_VRF = 315,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 316,
    OF_BSN_VPORT = 317,
    OF_BSN_VPORT_HEADER = 318,
    OF_BSN_VPORT_L2GRE = 319,
    OF_BSN_VPORT_Q_IN_Q = 320,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 321,
    OF_BUCKET = 322,
    OF_BUCKET_COUNTER = 323,
    OF_FLOW_STATS_ENTRY = 324,
    OF_GROUP_DESC_STATS_ENTRY = 325,
    OF_GROUP_STATS_ENTRY = 326,
    OF_HELLO_ELEM = 327,
    OF_HELLO_ELEM_HEADER = 328,
    OF_HELLO_ELEM_VERSIONBITMAP = 329,
    OF_INSTRUCTION = 330,
    OF_INSTRUCTION_APPLY_ACTIONS = 331,
    OF_INSTRUCTION_BSN = 332,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 333,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 334,
    OF_INSTRUCTION_BSN_DENY = 335,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 336,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 337,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 338,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 339,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 340,
    OF_INSTRUCTION_BSN_PERMIT = 341,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 342,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 343,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 344,
    OF_INSTRUCTION_CLEAR_ACTIONS = 345,
    OF_INSTRUCTION_EXPERIMENTER = 346,
    OF_INSTRUCTION_GOTO_TABLE = 347,
    OF_INSTRUCTION_HEADER = 348,
    OF_INSTRUCTION_ID = 349,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 350,
    OF_INSTRUCTION_ID_BSN = 351,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 352,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 353,
    OF_INSTRUCTION_ID_BSN_DENY = 354,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 355,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 356,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 357,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 358,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 359,
    OF_INSTRUCTION_ID_BSN_PERMIT = 360,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 361,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 362,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 363,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 364,
    OF_INSTRUCTION_ID_EXPERIMENTER = 365,
    OF_INSTRUCTION_ID_GOTO_TABLE = 366,
    OF_INSTRUCTION_ID_HEADER = 367,
    OF_INSTRUCTION_ID_METER = 368,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 369,
    OF_INSTRUCTION_ID_WRITE_METADATA = 370,
    OF_INSTRUCTION_METER = 371,
    OF_INSTRUCTION_WRITE_ACTIONS = 372,
    OF_INSTRUCTION_WRITE_METADATA = 373,
    OF_MATCH_V1 = 374,
    OF_MATCH_V2 = 375,
    OF_MATCH_V3 = 376,
    OF_METER_BAND = 377,
    OF_METER_BAND_DROP = 378,
    OF_METER_BAND_DSCP_REMARK = 379,
    OF_METER_BAND_EXPERIMENTER = 380,
    OF_METER_BAND_HEADER = 381,
    OF_METER_BAND_STATS = 382,
    OF_METER_CONFIG = 383,
    OF_METER_FEATURES = 384,
    OF_METER_STATS = 385,
    OF_OXM = 386,
    OF_OXM_ARP_OP = 387,
    OF_OXM_ARP_OP_MASKED = 388,
    OF_OXM_ARP_SHA = 389,
    OF_OXM_ARP_SHA_MASKED = 390,
    OF_OXM_ARP_SPA = 391,
    OF_OXM_ARP_SPA_MASKED = 392,
    OF_OXM_ARP_THA = 393,
    OF_OXM_ARP_THA_MASKED = 394,
    OF_OXM_ARP_TPA = 395,
    OF_OXM_ARP_TPA_MASKED = 396,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 397,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 398,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 399,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 400,
    OF_OXM_BSN_IN_PORTS_128 = 401,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 402,
    OF_OXM_BSN_L3_DST_CLASS_ID = 403,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 404,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 405,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 406,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 407,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 408,
    OF_OXM_BSN_LAG_ID = 409,
    OF_OXM_BSN_LAG_ID_MASKED = 410,
    OF_OXM_BSN_TCP_FLAGS = 411,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 412,
    OF_OXM_BSN_UDF0 = 413,
    OF_OXM_BSN_UDF0_MASKED = 414,
    OF_OXM_BSN_UDF1 = 415,
    OF_OXM_BSN_UDF1_MASKED = 416,
    OF_OXM_BSN_UDF2 = 417,
    OF_OXM_BSN_UDF2_MASKED = 418,
    OF_OXM_BSN_UDF3 = 419,
    OF_OXM_BSN_UDF3_MASKED = 420,
    OF_OXM_BSN_UDF4 = 421,
    OF_OXM_BSN_UDF4_MASKED = 422,
    OF_OXM_BSN_UDF5 = 423,
    OF_OXM_BSN_UDF5_MASKED = 424,
    OF_OXM_BSN_UDF6 = 425,
    OF_OXM_BSN_UDF6_MASKED = 426,
    OF_OXM_BSN_UDF7 = 427,
    OF_OXM_BSN_UDF7_MASKED = 428,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 429,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 430,
    OF_OXM_BSN_VRF = 431,
    OF_OXM_BSN_VRF_MASKED = 432,
    OF_OXM_ETH_DST = 433,
    OF_OXM_ETH_DST_MASKED = 434,
    OF_OXM_ETH_SRC = 435,
    OF_OXM_ETH_SRC_MASKED = 436,
    OF_OXM_ETH_TYPE = 437,
    OF_OXM_ETH_TYPE_MASKED = 438,
    OF_OXM_HEADER = 439,
    OF_OXM_ICMPV4_CODE = 440,
    OF_OXM_ICMPV4_CODE_MASKED = 441,
    OF_OXM_ICMPV4_TYPE = 442,
    OF_OXM_ICMPV4_TYPE_MASKED = 443,
    OF_OXM_ICMPV6_CODE = 444,
    OF_OXM_ICMPV6_CODE_MASKED = 445,
    OF_OXM_ICMPV6_TYPE = 446,
    OF_OXM_ICMPV6_TYPE_MASKED = 447,
    OF_OXM_IN_PHY_PORT = 448,
    OF_OXM_IN_PHY_PORT_MASKED = 449,
    OF_OXM_IN_PORT = 450,
    OF_OXM_IN_PORT_MASKED = 451,
    OF_OXM_IP_DSCP = 452,
    OF_OXM_IP_DSCP_MASKED = 453,
    OF_OXM_IP_ECN = 454,
    OF_OXM_IP_ECN_MASKED = 455,
    OF_OXM_IP_PROTO = 456,
    OF_OXM_IP_PROTO_MASKED = 457,
    OF_OXM_IPV4_DST = 458,
    OF_OXM_IPV4_DST_MASKED = 459,
    OF_OXM_IPV4_SRC = 460,
    OF_OXM_IPV4_SRC_MASKED = 461,
    OF_OXM_IPV6_DST = 462,
    OF_OXM_IPV6_DST_MASKED = 463,
    OF_OXM_IPV6_FLABEL = 464,
    OF_OXM_IPV6_FLABEL_MASKED = 465,
    OF_OXM_IPV6_ND_SLL = 466,
    OF_OXM_IPV6_ND_SLL_MASKED = 467,
    OF_OXM_IPV6_ND_TARGET = 468,
    OF_OXM_IPV6_ND_TARGET_MASKED = 469,
    OF_OXM_IPV6_ND_TLL = 470,
    OF_OXM_IPV6_ND_TLL_MASKED = 471,
    OF_OXM_IPV6_SRC = 472,
    OF_OXM_IPV6_SRC_MASKED = 473,
    OF_OXM_METADATA = 474,
    OF_OXM_METADATA_MASKED = 475,
    OF_OXM_MPLS_BOS = 476,
    OF_OXM_MPLS_BOS_MASKED = 477,
    OF_OXM_MPLS_LABEL = 478,
    OF_OXM_MPLS_LABEL_MASKED = 479,
    OF_OXM_MPLS_TC = 480,
    OF_OXM_MPLS_TC_MASKED = 481,
    OF_OXM_SCTP_DST = 482,
    OF_OXM_SCTP_DST_MASKED = 483,
    OF_OXM_SCTP_SRC = 484,
    OF_OXM_SCTP_SRC_MASKED = 485,
    OF_OXM_TCP_DST = 486,
    OF_OXM_TCP_DST_MASKED = 487,
    OF_OXM_TCP_SRC = 488,
    OF_OXM_TCP_SRC_MASKED = 489,
    OF_OXM_TUNNEL_ID = 490,
    OF_OXM_TUNNEL_ID_MASKED = 491,
    OF_OXM_UDP_DST = 492,
    OF_OXM_UDP_DST_MASKED = 493,
    OF_OXM_UDP_SRC = 494,
    OF_OXM_UDP_SRC_MASKED = 495,
    OF_OXM_VLAN_PCP = 496,
    OF_OXM_VLAN_PCP_MASKED = 497,
    OF_OXM_VLAN_VID = 498,
    OF_OXM_VLAN_VID_MASKED = 499,
    OF_PACKET_QUEUE = 500,
    OF_PORT_DESC = 501,
    OF_PORT_STATS_ENTRY = 502,
    OF_QUEUE_PROP = 503,
    OF_QUEUE_PROP_EXPERIMENTER = 504,
    OF_QUEUE_PROP_HEADER = 505,
    OF_QUEUE_PROP_MAX_RATE = 506,
    OF_QUEUE_PROP_MIN_RATE = 507,
    OF_QUEUE_STATS_ENTRY = 508,
    OF_TABLE_FEATURE_PROP = 509,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 510,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 511,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 512,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 513,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 514,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 515,
    OF_TABLE_FEATURE_PROP_HEADER = 516,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 517,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 518,
    OF_TABLE_FEATURE_PROP_MATCH = 519,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 520,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 521,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 522,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 523,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 524,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 525,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 526,
    OF_TABLE_FEATURES = 527,
    OF_TABLE_STATS_ENTRY = 528,
    OF_UINT32 = 529,
    OF_UINT64 = 530,
    OF_UINT8 = 531,
    ...
    /* List objects */
    OF_LIST_ACTION = 532,
    OF_LIST_ACTION_ID = 533,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 534,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 535,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 536,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 537,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 538,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 539,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 540,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 541,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 542,
    OF_LIST_BSN_INTERFACE = 543,
    OF_LIST_BSN_LACP_STATS_ENTRY = 544,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 545,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 546,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 547,
    OF_LIST_BSN_TLV = 548,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 549,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 550,
    OF_LIST_BUCKET = 551,
    OF_LIST_BUCKET_COUNTER = 552,
    OF_LIST_FLOW_STATS_ENTRY = 553,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 554,
    OF_LIST_GROUP_STATS_ENTRY = 555,
    OF_LIST_HELLO_ELEM = 556,
    OF_LIST_INSTRUCTION = 557,
    OF_LIST_INSTRUCTION_ID = 558,
    OF_LIST_METER_BAND = 559,
    OF_LIST_METER_BAND_STATS = 560,
    OF_LIST_METER_STATS = 561,
    OF_LIST_OXM = 562,
    OF_LIST_PACKET_QUEUE = 563,
    OF_LIST_PORT_DESC = 564,
    OF_LIST_PORT_STATS_ENTRY = 565,
    OF_LIST_QUEUE_PROP = 566,
    OF_LIST_QUEUE_STATS_ENTRY = 567,
    OF_LIST_TABLE_FEATURE_PROP = 568,
    OF_LIST_TABLE_FEATURES = 569,
    OF_LIST_TABLE_STATS_ENTRY = 570,
    OF_LIST_UINT32 = 571,
    OF_LIST_UINT64 = 572,
    OF_LIST_UINT8 = 573,
