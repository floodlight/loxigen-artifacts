...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_MAC = 320,
    OF_BSN_TLV_MISS_PACKETS = 321,
    OF_BSN_TLV_NAME = 322,
    OF_BSN_TLV_PARTNER_KEY = 323,
    OF_BSN_TLV_PARTNER_PORT_NUM = 324,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 325,
    OF_BSN_TLV_PARTNER_STATE = 326,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 327,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 328,
    OF_BSN_TLV_PORT = 329,
    ...
    OF_BUNDLE_PROP_HEADER = 358,
    OF_FLOW_STATS_ENTRY = 359,
    OF_GROUP_DESC_STATS_ENTRY = 360,
    OF_GROUP_STATS_ENTRY = 361,
    OF_HELLO_ELEM = 362,
    OF_HELLO_ELEM_HEADER = 363,
    OF_HELLO_ELEM_VERSIONBITMAP = 364,
    OF_INSTRUCTION = 365,
    OF_INSTRUCTION_APPLY_ACTIONS = 366,
    OF_INSTRUCTION_BSN = 367,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 368,
    OF_INSTRUCTION_BSN_DENY = 369,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 370,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 371,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 372,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 373,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 374,
    OF_INSTRUCTION_BSN_PERMIT = 375,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 376,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 377,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 378,
    OF_INSTRUCTION_CLEAR_ACTIONS = 379,
    OF_INSTRUCTION_EXPERIMENTER = 380,
    OF_INSTRUCTION_GOTO_TABLE = 381,
    OF_INSTRUCTION_HEADER = 382,
    OF_INSTRUCTION_ID = 383,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 384,
    OF_INSTRUCTION_ID_BSN = 385,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 386,
    OF_INSTRUCTION_ID_BSN_DENY = 387,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 388,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 389,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 390,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 391,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 392,
    OF_INSTRUCTION_ID_BSN_PERMIT = 393,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 394,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 395,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 396,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 397,
    OF_INSTRUCTION_ID_EXPERIMENTER = 398,
    OF_INSTRUCTION_ID_GOTO_TABLE = 399,
    OF_INSTRUCTION_ID_HEADER = 400,
    OF_INSTRUCTION_ID_METER = 401,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 402,
    OF_INSTRUCTION_ID_WRITE_METADATA = 403,
    OF_INSTRUCTION_METER = 404,
    OF_INSTRUCTION_WRITE_ACTIONS = 405,
    OF_INSTRUCTION_WRITE_METADATA = 406,
    OF_MATCH_V1 = 407,
    OF_MATCH_V2 = 408,
    OF_MATCH_V3 = 409,
    OF_METER_BAND = 410,
    OF_METER_BAND_DROP = 411,
    OF_METER_BAND_DSCP_REMARK = 412,
    OF_METER_BAND_EXPERIMENTER = 413,
    OF_METER_BAND_HEADER = 414,
    OF_METER_BAND_STATS = 415,
    OF_METER_CONFIG = 416,
    OF_METER_FEATURES = 417,
    OF_METER_STATS = 418,
    OF_OXM = 419,
    OF_OXM_ARP_OP = 420,
    OF_OXM_ARP_OP_MASKED = 421,
    OF_OXM_ARP_SHA = 422,
    OF_OXM_ARP_SHA_MASKED = 423,
    OF_OXM_ARP_SPA = 424,
    OF_OXM_ARP_SPA_MASKED = 425,
    OF_OXM_ARP_THA = 426,
    OF_OXM_ARP_THA_MASKED = 427,
    OF_OXM_ARP_TPA = 428,
    OF_OXM_ARP_TPA_MASKED = 429,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 430,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 431,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 432,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 433,
    OF_OXM_BSN_IN_PORTS_128 = 434,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 435,
    OF_OXM_BSN_L3_DST_CLASS_ID = 436,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 437,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 438,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 439,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 440,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 441,
    OF_OXM_BSN_LAG_ID = 442,
    OF_OXM_BSN_LAG_ID_MASKED = 443,
    OF_OXM_BSN_TCP_FLAGS = 444,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 445,
    OF_OXM_BSN_UDF0 = 446,
    OF_OXM_BSN_UDF0_MASKED = 447,
    OF_OXM_BSN_UDF1 = 448,
    OF_OXM_BSN_UDF1_MASKED = 449,
    OF_OXM_BSN_UDF2 = 450,
    OF_OXM_BSN_UDF2_MASKED = 451,
    OF_OXM_BSN_UDF3 = 452,
    OF_OXM_BSN_UDF3_MASKED = 453,
    OF_OXM_BSN_UDF4 = 454,
    OF_OXM_BSN_UDF4_MASKED = 455,
    OF_OXM_BSN_UDF5 = 456,
    OF_OXM_BSN_UDF5_MASKED = 457,
    OF_OXM_BSN_UDF6 = 458,
    OF_OXM_BSN_UDF6_MASKED = 459,
    OF_OXM_BSN_UDF7 = 460,
    OF_OXM_BSN_UDF7_MASKED = 461,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 462,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 463,
    OF_OXM_BSN_VRF = 464,
    OF_OXM_BSN_VRF_MASKED = 465,
    OF_OXM_ETH_DST = 466,
    OF_OXM_ETH_DST_MASKED = 467,
    OF_OXM_ETH_SRC = 468,
    OF_OXM_ETH_SRC_MASKED = 469,
    OF_OXM_ETH_TYPE = 470,
    OF_OXM_ETH_TYPE_MASKED = 471,
    OF_OXM_HEADER = 472,
    OF_OXM_ICMPV4_CODE = 473,
    OF_OXM_ICMPV4_CODE_MASKED = 474,
    OF_OXM_ICMPV4_TYPE = 475,
    OF_OXM_ICMPV4_TYPE_MASKED = 476,
    OF_OXM_ICMPV6_CODE = 477,
    OF_OXM_ICMPV6_CODE_MASKED = 478,
    OF_OXM_ICMPV6_TYPE = 479,
    OF_OXM_ICMPV6_TYPE_MASKED = 480,
    OF_OXM_IN_PHY_PORT = 481,
    OF_OXM_IN_PHY_PORT_MASKED = 482,
    OF_OXM_IN_PORT = 483,
    OF_OXM_IN_PORT_MASKED = 484,
    OF_OXM_IP_DSCP = 485,
    OF_OXM_IP_DSCP_MASKED = 486,
    OF_OXM_IP_ECN = 487,
    OF_OXM_IP_ECN_MASKED = 488,
    OF_OXM_IP_PROTO = 489,
    OF_OXM_IP_PROTO_MASKED = 490,
    OF_OXM_IPV4_DST = 491,
    OF_OXM_IPV4_DST_MASKED = 492,
    OF_OXM_IPV4_SRC = 493,
    OF_OXM_IPV4_SRC_MASKED = 494,
    OF_OXM_IPV6_DST = 495,
    OF_OXM_IPV6_DST_MASKED = 496,
    OF_OXM_IPV6_EXTHDR = 497,
    OF_OXM_IPV6_EXTHDR_MASKED = 498,
    OF_OXM_IPV6_FLABEL = 499,
    OF_OXM_IPV6_FLABEL_MASKED = 500,
    OF_OXM_IPV6_ND_SLL = 501,
    OF_OXM_IPV6_ND_SLL_MASKED = 502,
    OF_OXM_IPV6_ND_TARGET = 503,
    OF_OXM_IPV6_ND_TARGET_MASKED = 504,
    OF_OXM_IPV6_ND_TLL = 505,
    OF_OXM_IPV6_ND_TLL_MASKED = 506,
    OF_OXM_IPV6_SRC = 507,
    OF_OXM_IPV6_SRC_MASKED = 508,
    OF_OXM_METADATA = 509,
    OF_OXM_METADATA_MASKED = 510,
    OF_OXM_MPLS_BOS = 511,
    OF_OXM_MPLS_BOS_MASKED = 512,
    OF_OXM_MPLS_LABEL = 513,
    OF_OXM_MPLS_LABEL_MASKED = 514,
    OF_OXM_MPLS_TC = 515,
    OF_OXM_MPLS_TC_MASKED = 516,
    OF_OXM_PBB_UCA = 517,
    OF_OXM_PBB_UCA_MASKED = 518,
    OF_OXM_SCTP_DST = 519,
    OF_OXM_SCTP_DST_MASKED = 520,
    OF_OXM_SCTP_SRC = 521,
    OF_OXM_SCTP_SRC_MASKED = 522,
    OF_OXM_TCP_DST = 523,
    OF_OXM_TCP_DST_MASKED = 524,
    OF_OXM_TCP_SRC = 525,
    OF_OXM_TCP_SRC_MASKED = 526,
    OF_OXM_TUNNEL_ID = 527,
    OF_OXM_TUNNEL_ID_MASKED = 528,
    OF_OXM_UDP_DST = 529,
    ...
    OF_PORT_STATS_PROP_HEADER = 553,
    OF_PORT_STATS_PROP_OPTICAL = 554,
    OF_QUEUE_DESC = 555,
    OF_QUEUE_DESC_PROP = 556,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 557,
    OF_QUEUE_DESC_PROP_HEADER = 558,
    OF_QUEUE_DESC_PROP_MAX_RATE = 559,
    OF_QUEUE_DESC_PROP_MIN_RATE = 560,
    OF_QUEUE_PROP = 561,
    OF_QUEUE_PROP_EXPERIMENTER = 562,
    OF_QUEUE_PROP_HEADER = 563,
    OF_QUEUE_PROP_MAX_RATE = 564,
    OF_QUEUE_PROP_MIN_RATE = 565,
    OF_QUEUE_STATS_ENTRY = 566,
    OF_QUEUE_STATS_PROP = 567,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 568,
    OF_QUEUE_STATS_PROP_HEADER = 569,
    OF_ROLE_PROP = 570,
    OF_ROLE_PROP_EXPERIMENTER = 571,
    OF_ROLE_PROP_HEADER = 572,
    OF_TABLE_DESC = 573,
    OF_TABLE_FEATURE_PROP = 574,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 575,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 576,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 577,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 578,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 579,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 580,
    OF_TABLE_FEATURE_PROP_HEADER = 581,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 582,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 583,
    OF_TABLE_FEATURE_PROP_MATCH = 584,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 585,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 586,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 587,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 588,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 589,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 590,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 591,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 592,
    OF_TABLE_FEATURES = 593,
    OF_TABLE_MOD_PROP = 594,
    OF_TABLE_MOD_PROP_EVICTION = 595,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 596,
    OF_TABLE_MOD_PROP_VACANCY = 597,
    OF_TABLE_STATS_ENTRY = 598,
    OF_UINT32 = 599,
    OF_UINT64 = 600,
    OF_UINT8 = 601,
    ...
    /* List objects */
    OF_LIST_ACTION = 602,
    OF_LIST_ACTION_ID = 603,
    OF_LIST_ASYNC_CONFIG_PROP = 604,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 605,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 606,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 607,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 608,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 609,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 610,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 611,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 612,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 613,
    OF_LIST_BSN_INTERFACE = 614,
    OF_LIST_BSN_LACP_STATS_ENTRY = 615,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 616,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 617,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 618,
    OF_LIST_BSN_TLV = 619,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 620,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 621,
    OF_LIST_BUCKET = 622,
    OF_LIST_BUCKET_COUNTER = 623,
    OF_LIST_BUNDLE_PROP = 624,
    OF_LIST_FLOW_STATS_ENTRY = 625,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 626,
    OF_LIST_GROUP_STATS_ENTRY = 627,
    OF_LIST_HELLO_ELEM = 628,
    OF_LIST_INSTRUCTION = 629,
    OF_LIST_INSTRUCTION_ID = 630,
    OF_LIST_METER_BAND = 631,
    OF_LIST_METER_BAND_STATS = 632,
    OF_LIST_METER_STATS = 633,
    OF_LIST_OXM = 634,
    OF_LIST_PACKET_QUEUE = 635,
    OF_LIST_PORT_DESC = 636,
    OF_LIST_PORT_DESC_PROP = 637,
    OF_LIST_PORT_MOD_PROP = 638,
    OF_LIST_PORT_STATS_ENTRY = 639,
    OF_LIST_PORT_STATS_PROP = 640,
    OF_LIST_QUEUE_DESC = 641,
    OF_LIST_QUEUE_DESC_PROP = 642,
    OF_LIST_QUEUE_PROP = 643,
    OF_LIST_QUEUE_STATS_ENTRY = 644,
    OF_LIST_QUEUE_STATS_PROP = 645,
    OF_LIST_ROLE_PROP = 646,
    OF_LIST_TABLE_DESC = 647,
    OF_LIST_TABLE_FEATURE_PROP = 648,
    OF_LIST_TABLE_FEATURES = 649,
    OF_LIST_TABLE_MOD_PROP = 650,
    OF_LIST_TABLE_STATS_ENTRY = 651,
    OF_LIST_UINT32 = 652,
    OF_LIST_UINT64 = 653,
    OF_LIST_UINT8 = 654,
