...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 451,
    OF_INSTRUCTION_BSN_PERMIT = 452,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 453,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 454,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 455,
    OF_INSTRUCTION_CLEAR_ACTIONS = 456,
    OF_INSTRUCTION_EXPERIMENTER = 457,
    OF_INSTRUCTION_GOTO_TABLE = 458,
    OF_INSTRUCTION_ID = 459,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 460,
    OF_INSTRUCTION_ID_BSN = 461,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 462,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 463,
    OF_INSTRUCTION_ID_BSN_DENY = 464,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 465,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 466,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 467,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 468,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 469,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 470,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 471,
    OF_INSTRUCTION_ID_BSN_PERMIT = 472,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 473,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 474,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 475,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 476,
    OF_INSTRUCTION_ID_EXPERIMENTER = 477,
    OF_INSTRUCTION_ID_GOTO_TABLE = 478,
    OF_INSTRUCTION_ID_METER = 479,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 480,
    OF_INSTRUCTION_ID_WRITE_METADATA = 481,
    OF_INSTRUCTION_METER = 482,
    OF_INSTRUCTION_WRITE_ACTIONS = 483,
    OF_INSTRUCTION_WRITE_METADATA = 484,
    OF_MATCH_V1 = 485,
    OF_MATCH_V2 = 486,
    OF_MATCH_V3 = 487,
    OF_METER_BAND = 488,
    OF_METER_BAND_DROP = 489,
    OF_METER_BAND_DSCP_REMARK = 490,
    OF_METER_BAND_EXPERIMENTER = 491,
    OF_METER_BAND_STATS = 492,
    OF_METER_CONFIG = 493,
    OF_METER_FEATURES = 494,
    OF_METER_STATS = 495,
    OF_OXM = 496,
    OF_OXM_ARP_OP = 497,
    OF_OXM_ARP_OP_MASKED = 498,
    OF_OXM_ARP_SHA = 499,
    OF_OXM_ARP_SHA_MASKED = 500,
    OF_OXM_ARP_SPA = 501,
    OF_OXM_ARP_SPA_MASKED = 502,
    OF_OXM_ARP_THA = 503,
    OF_OXM_ARP_THA_MASKED = 504,
    OF_OXM_ARP_TPA = 505,
    OF_OXM_ARP_TPA_MASKED = 506,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 507,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 508,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 509,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 510,
    OF_OXM_BSN_IN_PORTS_128 = 511,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 512,
    OF_OXM_BSN_IN_PORTS_512 = 513,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 514,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 515,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 516,
    OF_OXM_BSN_INNER_ETH_DST = 517,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 518,
    OF_OXM_BSN_INNER_ETH_SRC = 519,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 520,
    OF_OXM_BSN_INNER_VLAN_VID = 521,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 522,
    OF_OXM_BSN_L2_CACHE_HIT = 523,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 524,
    OF_OXM_BSN_L3_DST_CLASS_ID = 525,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 526,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 527,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 528,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 529,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 530,
    OF_OXM_BSN_LAG_ID = 531,
    OF_OXM_BSN_LAG_ID_MASKED = 532,
    OF_OXM_BSN_TCP_FLAGS = 533,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 534,
    OF_OXM_BSN_UDF0 = 535,
    OF_OXM_BSN_UDF0_MASKED = 536,
    OF_OXM_BSN_UDF1 = 537,
    OF_OXM_BSN_UDF1_MASKED = 538,
    OF_OXM_BSN_UDF2 = 539,
    OF_OXM_BSN_UDF2_MASKED = 540,
    OF_OXM_BSN_UDF3 = 541,
    OF_OXM_BSN_UDF3_MASKED = 542,
    OF_OXM_BSN_UDF4 = 543,
    OF_OXM_BSN_UDF4_MASKED = 544,
    OF_OXM_BSN_UDF5 = 545,
    OF_OXM_BSN_UDF5_MASKED = 546,
    OF_OXM_BSN_UDF6 = 547,
    OF_OXM_BSN_UDF6_MASKED = 548,
    OF_OXM_BSN_UDF7 = 549,
    OF_OXM_BSN_UDF7_MASKED = 550,
    OF_OXM_BSN_VFI = 551,
    OF_OXM_BSN_VFI_MASKED = 552,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 553,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 554,
    OF_OXM_BSN_VRF = 555,
    OF_OXM_BSN_VRF_MASKED = 556,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 557,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 558,
    OF_OXM_ETH_DST = 559,
    OF_OXM_ETH_DST_MASKED = 560,
    OF_OXM_ETH_SRC = 561,
    OF_OXM_ETH_SRC_MASKED = 562,
    OF_OXM_ETH_TYPE = 563,
    OF_OXM_ETH_TYPE_MASKED = 564,
    OF_OXM_ICMPV4_CODE = 565,
    OF_OXM_ICMPV4_CODE_MASKED = 566,
    OF_OXM_ICMPV4_TYPE = 567,
    OF_OXM_ICMPV4_TYPE_MASKED = 568,
    OF_OXM_ICMPV6_CODE = 569,
    OF_OXM_ICMPV6_CODE_MASKED = 570,
    OF_OXM_ICMPV6_TYPE = 571,
    OF_OXM_ICMPV6_TYPE_MASKED = 572,
    OF_OXM_IN_PHY_PORT = 573,
    OF_OXM_IN_PHY_PORT_MASKED = 574,
    OF_OXM_IN_PORT = 575,
    OF_OXM_IN_PORT_MASKED = 576,
    OF_OXM_IP_DSCP = 577,
    OF_OXM_IP_DSCP_MASKED = 578,
    OF_OXM_IP_ECN = 579,
    OF_OXM_IP_ECN_MASKED = 580,
    OF_OXM_IP_PROTO = 581,
    OF_OXM_IP_PROTO_MASKED = 582,
    OF_OXM_IPV4_DST = 583,
    OF_OXM_IPV4_DST_MASKED = 584,
    OF_OXM_IPV4_SRC = 585,
    OF_OXM_IPV4_SRC_MASKED = 586,
    OF_OXM_IPV6_DST = 587,
    OF_OXM_IPV6_DST_MASKED = 588,
    OF_OXM_IPV6_EXTHDR = 589,
    OF_OXM_IPV6_EXTHDR_MASKED = 590,
    OF_OXM_IPV6_FLABEL = 591,
    OF_OXM_IPV6_FLABEL_MASKED = 592,
    OF_OXM_IPV6_ND_SLL = 593,
    OF_OXM_IPV6_ND_SLL_MASKED = 594,
    OF_OXM_IPV6_ND_TARGET = 595,
    OF_OXM_IPV6_ND_TARGET_MASKED = 596,
    OF_OXM_IPV6_ND_TLL = 597,
    OF_OXM_IPV6_ND_TLL_MASKED = 598,
    OF_OXM_IPV6_SRC = 599,
    OF_OXM_IPV6_SRC_MASKED = 600,
    OF_OXM_METADATA = 601,
    OF_OXM_METADATA_MASKED = 602,
    OF_OXM_MPLS_BOS = 603,
    OF_OXM_MPLS_BOS_MASKED = 604,
    OF_OXM_MPLS_LABEL = 605,
    OF_OXM_MPLS_LABEL_MASKED = 606,
    OF_OXM_MPLS_TC = 607,
    OF_OXM_MPLS_TC_MASKED = 608,
    OF_OXM_PBB_UCA = 609,
    OF_OXM_PBB_UCA_MASKED = 610,
    OF_OXM_SCTP_DST = 611,
    OF_OXM_SCTP_DST_MASKED = 612,
    OF_OXM_SCTP_SRC = 613,
    OF_OXM_SCTP_SRC_MASKED = 614,
    OF_OXM_TCP_DST = 615,
    OF_OXM_TCP_DST_MASKED = 616,
    OF_OXM_TCP_SRC = 617,
    OF_OXM_TCP_SRC_MASKED = 618,
    OF_OXM_TUNNEL_ID = 619,
    OF_OXM_TUNNEL_ID_MASKED = 620,
    OF_OXM_TUNNEL_IPV4_DST = 621,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 622,
    OF_OXM_TUNNEL_IPV4_SRC = 623,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 624,
    OF_OXM_UDP_DST = 625,
    OF_OXM_UDP_DST_MASKED = 626,
    OF_OXM_UDP_SRC = 627,
    OF_OXM_UDP_SRC_MASKED = 628,
    OF_OXM_VLAN_PCP = 629,
    OF_OXM_VLAN_PCP_MASKED = 630,
    OF_OXM_VLAN_VID = 631,
    OF_OXM_VLAN_VID_MASKED = 632,
    OF_PACKET_QUEUE = 633,
    OF_PORT_DESC = 634,
    OF_PORT_DESC_PROP = 635,
    OF_PORT_DESC_PROP_BSN = 636,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 637,
    OF_PORT_DESC_PROP_BSN_UPLINK = 638,
    OF_PORT_DESC_PROP_ETHERNET = 639,
    OF_PORT_DESC_PROP_EXPERIMENTER = 640,
    OF_PORT_DESC_PROP_OPTICAL = 641,
    OF_PORT_MOD_PROP = 642,
    OF_PORT_MOD_PROP_ETHERNET = 643,
    OF_PORT_MOD_PROP_EXPERIMENTER = 644,
    OF_PORT_MOD_PROP_OPTICAL = 645,
    OF_PORT_STATS_ENTRY = 646,
    OF_PORT_STATS_PROP = 647,
    OF_PORT_STATS_PROP_ETHERNET = 648,
    OF_PORT_STATS_PROP_EXPERIMENTER = 649,
    OF_PORT_STATS_PROP_OPTICAL = 650,
    OF_QUEUE_DESC = 651,
    OF_QUEUE_DESC_PROP = 652,
    OF_QUEUE_DESC_PROP_BSN = 653,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 654,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 655,
    OF_QUEUE_DESC_PROP_MAX_RATE = 656,
    OF_QUEUE_DESC_PROP_MIN_RATE = 657,
    OF_QUEUE_PROP = 658,
    OF_QUEUE_PROP_EXPERIMENTER = 659,
    OF_QUEUE_PROP_MAX_RATE = 660,
    OF_QUEUE_PROP_MIN_RATE = 661,
    OF_QUEUE_STATS_ENTRY = 662,
    OF_QUEUE_STATS_PROP = 663,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 664,
    OF_ROLE_PROP = 665,
    OF_ROLE_PROP_EXPERIMENTER = 666,
    OF_TABLE_DESC = 667,
    OF_TABLE_FEATURE_PROP = 668,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 669,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 670,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 671,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 672,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 673,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 674,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 675,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 676,
    OF_TABLE_FEATURE_PROP_MATCH = 677,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 678,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 679,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 680,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 681,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 682,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 683,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 684,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 685,
    OF_TABLE_FEATURES = 686,
    OF_TABLE_MOD_PROP = 687,
    OF_TABLE_MOD_PROP_EVICTION = 688,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 689,
    OF_TABLE_MOD_PROP_VACANCY = 690,
    OF_TABLE_STATS_ENTRY = 691,
    OF_UINT32 = 692,
    OF_UINT64 = 693,
    OF_UINT8 = 694,
    ...
    /* List objects */
    OF_LIST_ACTION = 695,
    OF_LIST_ACTION_ID = 696,
    OF_LIST_ASYNC_CONFIG_PROP = 697,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 698,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 699,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 700,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 701,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 702,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 703,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 704,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 705,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 706,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 707,
    OF_LIST_BSN_INTERFACE = 708,
    OF_LIST_BSN_LACP_STATS_ENTRY = 709,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 710,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 711,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 712,
    OF_LIST_BSN_TLV = 713,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 714,
    OF_LIST_BSN_VLAN_MAC = 715,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 716,
    OF_LIST_BUCKET = 717,
    OF_LIST_BUCKET_COUNTER = 718,
    OF_LIST_BUNDLE_PROP = 719,
    OF_LIST_FLOW_STATS_ENTRY = 720,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 721,
    OF_LIST_GROUP_STATS_ENTRY = 722,
    OF_LIST_HELLO_ELEM = 723,
    OF_LIST_INSTRUCTION = 724,
    OF_LIST_INSTRUCTION_ID = 725,
    OF_LIST_METER_BAND = 726,
    OF_LIST_METER_BAND_STATS = 727,
    OF_LIST_METER_CONFIG = 728,
    OF_LIST_METER_STATS = 729,
    OF_LIST_OXM = 730,
    OF_LIST_PACKET_QUEUE = 731,
    OF_LIST_PORT_DESC = 732,
    OF_LIST_PORT_DESC_PROP = 733,
    OF_LIST_PORT_MOD_PROP = 734,
    OF_LIST_PORT_STATS_ENTRY = 735,
    OF_LIST_PORT_STATS_PROP = 736,
    OF_LIST_QUEUE_DESC = 737,
    OF_LIST_QUEUE_DESC_PROP = 738,
    OF_LIST_QUEUE_PROP = 739,
    OF_LIST_QUEUE_STATS_ENTRY = 740,
    OF_LIST_QUEUE_STATS_PROP = 741,
    OF_LIST_ROLE_PROP = 742,
    OF_LIST_TABLE_DESC = 743,
    OF_LIST_TABLE_FEATURE_PROP = 744,
    OF_LIST_TABLE_FEATURES = 745,
    OF_LIST_TABLE_MOD_PROP = 746,
    OF_LIST_TABLE_STATS_ENTRY = 747,
    OF_LIST_UINT32 = 748,
    OF_LIST_UINT64 = 749,
    OF_LIST_UINT8 = 750,
