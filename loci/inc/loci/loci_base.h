...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_ETH_DST = 317,
    OF_BSN_TLV_ETH_SRC = 318,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 319,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 320,
    OF_BSN_TLV_EXTERNAL_IP = 321,
    OF_BSN_TLV_EXTERNAL_MAC = 322,
    OF_BSN_TLV_EXTERNAL_NETMASK = 323,
    OF_BSN_TLV_GENERATION_ID = 324,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 325,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 326,
    OF_BSN_TLV_HASH_PACKET_FIELD = 327,
    OF_BSN_TLV_HASH_PACKET_TYPE = 328,
    OF_BSN_TLV_HASH_SEED = 329,
    OF_BSN_TLV_HASH_TYPE = 330,
    OF_BSN_TLV_HEADER_SIZE = 331,
    OF_BSN_TLV_ICMP_CODE = 332,
    OF_BSN_TLV_ICMP_ID = 333,
    OF_BSN_TLV_ICMP_TYPE = 334,
    OF_BSN_TLV_IDLE_NOTIFICATION = 335,
    OF_BSN_TLV_IDLE_TIME = 336,
    OF_BSN_TLV_IDLE_TIMEOUT = 337,
    OF_BSN_TLV_IGMP_SNOOPING = 338,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 339,
    OF_BSN_TLV_INTERNAL_MAC = 340,
    OF_BSN_TLV_INTERVAL = 341,
    OF_BSN_TLV_IP_PROTO = 342,
    OF_BSN_TLV_IPV4 = 343,
    OF_BSN_TLV_IPV4_DST = 344,
    OF_BSN_TLV_IPV4_NETMASK = 345,
    OF_BSN_TLV_IPV4_SRC = 346,
    OF_BSN_TLV_IPV6 = 347,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 348,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 349,
    OF_BSN_TLV_MAC = 350,
    OF_BSN_TLV_MAC_MASK = 351,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 352,
    OF_BSN_TLV_MISS_PACKETS = 353,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 354,
    OF_BSN_TLV_MPLS_LABEL = 355,
    OF_BSN_TLV_MPLS_SEQUENCED = 356,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 357,
    OF_BSN_TLV_NAME = 358,
    OF_BSN_TLV_NEGATE = 359,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 360,
    OF_BSN_TLV_OFFSET = 361,
    OF_BSN_TLV_PARTNER_KEY = 362,
    OF_BSN_TLV_PARTNER_PORT_NUM = 363,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 364,
    OF_BSN_TLV_PARTNER_STATE = 365,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 366,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 367,
    OF_BSN_TLV_PORT = 368,
    OF_BSN_TLV_PORT_VXLAN_MODE = 369,
    OF_BSN_TLV_PRIORITY = 370,
    OF_BSN_TLV_QOS_PRIORITY = 371,
    OF_BSN_TLV_QUEUE_ID = 372,
    OF_BSN_TLV_QUEUE_WEIGHT = 373,
    OF_BSN_TLV_RATE_UNIT = 374,
    OF_BSN_TLV_REFERENCE = 375,
    OF_BSN_TLV_REPLY_PACKETS = 376,
    OF_BSN_TLV_REQUEST_PACKETS = 377,
    OF_BSN_TLV_RX_BYTES = 378,
    OF_BSN_TLV_RX_PACKETS = 379,
    OF_BSN_TLV_SAMPLING_RATE = 380,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 381,
    OF_BSN_TLV_STATUS = 382,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 383,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 384,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 385,
    OF_BSN_TLV_SUB_AGENT_ID = 386,
    OF_BSN_TLV_TCP_DST = 387,
    OF_BSN_TLV_TCP_SRC = 388,
    OF_BSN_TLV_TX_BYTES = 389,
    OF_BSN_TLV_TX_PACKETS = 390,
    OF_BSN_TLV_UDF_ANCHOR = 391,
    OF_BSN_TLV_UDF_ID = 392,
    OF_BSN_TLV_UDF_LENGTH = 393,
    OF_BSN_TLV_UDF_OFFSET = 394,
    OF_BSN_TLV_UDP_DST = 395,
    OF_BSN_TLV_UDP_SRC = 396,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 397,
    OF_BSN_TLV_UNICAST_RATE = 398,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 399,
    OF_BSN_TLV_UNTAGGED = 400,
    OF_BSN_TLV_USE_PACKET_STATE = 401,
    OF_BSN_TLV_VFI = 402,
    OF_BSN_TLV_VFP_CLASS_ID = 403,
    OF_BSN_TLV_VLAN_MAC_LIST = 404,
    OF_BSN_TLV_VLAN_PCP = 405,
    OF_BSN_TLV_VLAN_VID = 406,
    OF_BSN_TLV_VLAN_VID_MASK = 407,
    OF_BSN_TLV_VNI = 408,
    OF_BSN_TLV_VRF = 409,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 410,
    OF_BSN_VLAN_MAC = 411,
    OF_BSN_VPORT = 412,
    OF_BSN_VPORT_L2GRE = 413,
    OF_BSN_VPORT_Q_IN_Q = 414,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 415,
    OF_BUCKET = 416,
    OF_BUCKET_COUNTER = 417,
    OF_BUNDLE_PROP = 418,
    OF_BUNDLE_PROP_EXPERIMENTER = 419,
    OF_FLOW_STATS_ENTRY = 420,
    OF_GROUP_DESC_STATS_ENTRY = 421,
    OF_GROUP_STATS_ENTRY = 422,
    OF_HELLO_ELEM = 423,
    OF_HELLO_ELEM_VERSIONBITMAP = 424,
    OF_INSTRUCTION = 425,
    OF_INSTRUCTION_APPLY_ACTIONS = 426,
    OF_INSTRUCTION_BSN = 427,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 428,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 429,
    OF_INSTRUCTION_BSN_DENY = 430,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 431,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 432,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 433,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 434,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 435,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 436,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 437,
    OF_INSTRUCTION_BSN_PERMIT = 438,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 439,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 440,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 441,
    OF_INSTRUCTION_CLEAR_ACTIONS = 442,
    OF_INSTRUCTION_EXPERIMENTER = 443,
    OF_INSTRUCTION_GOTO_TABLE = 444,
    OF_INSTRUCTION_ID = 445,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 446,
    OF_INSTRUCTION_ID_BSN = 447,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 448,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 449,
    OF_INSTRUCTION_ID_BSN_DENY = 450,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 451,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 452,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 453,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 454,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 455,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 456,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 457,
    OF_INSTRUCTION_ID_BSN_PERMIT = 458,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 459,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 460,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 461,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 462,
    OF_INSTRUCTION_ID_EXPERIMENTER = 463,
    OF_INSTRUCTION_ID_GOTO_TABLE = 464,
    OF_INSTRUCTION_ID_METER = 465,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 466,
    OF_INSTRUCTION_ID_WRITE_METADATA = 467,
    OF_INSTRUCTION_METER = 468,
    OF_INSTRUCTION_WRITE_ACTIONS = 469,
    OF_INSTRUCTION_WRITE_METADATA = 470,
    OF_MATCH_V1 = 471,
    OF_MATCH_V2 = 472,
    OF_MATCH_V3 = 473,
    OF_METER_BAND = 474,
    OF_METER_BAND_DROP = 475,
    OF_METER_BAND_DSCP_REMARK = 476,
    OF_METER_BAND_EXPERIMENTER = 477,
    OF_METER_BAND_STATS = 478,
    OF_METER_CONFIG = 479,
    OF_METER_FEATURES = 480,
    OF_METER_STATS = 481,
    OF_OXM = 482,
    OF_OXM_ARP_OP = 483,
    OF_OXM_ARP_OP_MASKED = 484,
    OF_OXM_ARP_SHA = 485,
    OF_OXM_ARP_SHA_MASKED = 486,
    OF_OXM_ARP_SPA = 487,
    OF_OXM_ARP_SPA_MASKED = 488,
    OF_OXM_ARP_THA = 489,
    OF_OXM_ARP_THA_MASKED = 490,
    OF_OXM_ARP_TPA = 491,
    OF_OXM_ARP_TPA_MASKED = 492,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 493,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 494,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 495,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 496,
    OF_OXM_BSN_IN_PORTS_128 = 497,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 498,
    OF_OXM_BSN_IN_PORTS_512 = 499,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 500,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 501,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 502,
    OF_OXM_BSN_INNER_ETH_DST = 503,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 504,
    OF_OXM_BSN_INNER_ETH_SRC = 505,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 506,
    OF_OXM_BSN_INNER_VLAN_VID = 507,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 508,
    OF_OXM_BSN_L2_CACHE_HIT = 509,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 510,
    OF_OXM_BSN_L3_DST_CLASS_ID = 511,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 512,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 513,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 514,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 515,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 516,
    OF_OXM_BSN_LAG_ID = 517,
    OF_OXM_BSN_LAG_ID_MASKED = 518,
    OF_OXM_BSN_TCP_FLAGS = 519,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 520,
    OF_OXM_BSN_UDF0 = 521,
    OF_OXM_BSN_UDF0_MASKED = 522,
    OF_OXM_BSN_UDF1 = 523,
    OF_OXM_BSN_UDF1_MASKED = 524,
    OF_OXM_BSN_UDF2 = 525,
    OF_OXM_BSN_UDF2_MASKED = 526,
    OF_OXM_BSN_UDF3 = 527,
    OF_OXM_BSN_UDF3_MASKED = 528,
    OF_OXM_BSN_UDF4 = 529,
    OF_OXM_BSN_UDF4_MASKED = 530,
    OF_OXM_BSN_UDF5 = 531,
    OF_OXM_BSN_UDF5_MASKED = 532,
    OF_OXM_BSN_UDF6 = 533,
    OF_OXM_BSN_UDF6_MASKED = 534,
    OF_OXM_BSN_UDF7 = 535,
    OF_OXM_BSN_UDF7_MASKED = 536,
    OF_OXM_BSN_VFI = 537,
    OF_OXM_BSN_VFI_MASKED = 538,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 539,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 540,
    OF_OXM_BSN_VRF = 541,
    OF_OXM_BSN_VRF_MASKED = 542,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 543,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 544,
    OF_OXM_ETH_DST = 545,
    OF_OXM_ETH_DST_MASKED = 546,
    OF_OXM_ETH_SRC = 547,
    OF_OXM_ETH_SRC_MASKED = 548,
    OF_OXM_ETH_TYPE = 549,
    OF_OXM_ETH_TYPE_MASKED = 550,
    OF_OXM_ICMPV4_CODE = 551,
    OF_OXM_ICMPV4_CODE_MASKED = 552,
    OF_OXM_ICMPV4_TYPE = 553,
    OF_OXM_ICMPV4_TYPE_MASKED = 554,
    OF_OXM_ICMPV6_CODE = 555,
    OF_OXM_ICMPV6_CODE_MASKED = 556,
    OF_OXM_ICMPV6_TYPE = 557,
    OF_OXM_ICMPV6_TYPE_MASKED = 558,
    OF_OXM_IN_PHY_PORT = 559,
    OF_OXM_IN_PHY_PORT_MASKED = 560,
    OF_OXM_IN_PORT = 561,
    OF_OXM_IN_PORT_MASKED = 562,
    OF_OXM_IP_DSCP = 563,
    OF_OXM_IP_DSCP_MASKED = 564,
    OF_OXM_IP_ECN = 565,
    OF_OXM_IP_ECN_MASKED = 566,
    OF_OXM_IP_PROTO = 567,
    OF_OXM_IP_PROTO_MASKED = 568,
    OF_OXM_IPV4_DST = 569,
    OF_OXM_IPV4_DST_MASKED = 570,
    OF_OXM_IPV4_SRC = 571,
    OF_OXM_IPV4_SRC_MASKED = 572,
    OF_OXM_IPV6_DST = 573,
    OF_OXM_IPV6_DST_MASKED = 574,
    OF_OXM_IPV6_EXTHDR = 575,
    OF_OXM_IPV6_EXTHDR_MASKED = 576,
    OF_OXM_IPV6_FLABEL = 577,
    OF_OXM_IPV6_FLABEL_MASKED = 578,
    OF_OXM_IPV6_ND_SLL = 579,
    OF_OXM_IPV6_ND_SLL_MASKED = 580,
    OF_OXM_IPV6_ND_TARGET = 581,
    OF_OXM_IPV6_ND_TARGET_MASKED = 582,
    OF_OXM_IPV6_ND_TLL = 583,
    OF_OXM_IPV6_ND_TLL_MASKED = 584,
    OF_OXM_IPV6_SRC = 585,
    OF_OXM_IPV6_SRC_MASKED = 586,
    OF_OXM_METADATA = 587,
    OF_OXM_METADATA_MASKED = 588,
    OF_OXM_MPLS_BOS = 589,
    OF_OXM_MPLS_BOS_MASKED = 590,
    OF_OXM_MPLS_LABEL = 591,
    OF_OXM_MPLS_LABEL_MASKED = 592,
    OF_OXM_MPLS_TC = 593,
    OF_OXM_MPLS_TC_MASKED = 594,
    OF_OXM_PBB_UCA = 595,
    OF_OXM_PBB_UCA_MASKED = 596,
    OF_OXM_SCTP_DST = 597,
    OF_OXM_SCTP_DST_MASKED = 598,
    OF_OXM_SCTP_SRC = 599,
    OF_OXM_SCTP_SRC_MASKED = 600,
    OF_OXM_TCP_DST = 601,
    OF_OXM_TCP_DST_MASKED = 602,
    OF_OXM_TCP_SRC = 603,
    OF_OXM_TCP_SRC_MASKED = 604,
    OF_OXM_TUNNEL_ID = 605,
    OF_OXM_TUNNEL_ID_MASKED = 606,
    OF_OXM_TUNNEL_IPV4_DST = 607,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 608,
    OF_OXM_TUNNEL_IPV4_SRC = 609,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 610,
    OF_OXM_UDP_DST = 611,
    OF_OXM_UDP_DST_MASKED = 612,
    OF_OXM_UDP_SRC = 613,
    OF_OXM_UDP_SRC_MASKED = 614,
    OF_OXM_VLAN_PCP = 615,
    OF_OXM_VLAN_PCP_MASKED = 616,
    OF_OXM_VLAN_VID = 617,
    OF_OXM_VLAN_VID_MASKED = 618,
    OF_PACKET_QUEUE = 619,
    OF_PORT_DESC = 620,
    OF_PORT_DESC_PROP = 621,
    OF_PORT_DESC_PROP_BSN = 622,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 623,
    OF_PORT_DESC_PROP_BSN_UPLINK = 624,
    OF_PORT_DESC_PROP_ETHERNET = 625,
    OF_PORT_DESC_PROP_EXPERIMENTER = 626,
    OF_PORT_DESC_PROP_OPTICAL = 627,
    OF_PORT_MOD_PROP = 628,
    OF_PORT_MOD_PROP_ETHERNET = 629,
    OF_PORT_MOD_PROP_EXPERIMENTER = 630,
    OF_PORT_MOD_PROP_OPTICAL = 631,
    OF_PORT_STATS_ENTRY = 632,
    OF_PORT_STATS_PROP = 633,
    OF_PORT_STATS_PROP_ETHERNET = 634,
    OF_PORT_STATS_PROP_EXPERIMENTER = 635,
    OF_PORT_STATS_PROP_OPTICAL = 636,
    OF_QUEUE_DESC = 637,
    OF_QUEUE_DESC_PROP = 638,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 639,
    OF_QUEUE_DESC_PROP_MAX_RATE = 640,
    OF_QUEUE_DESC_PROP_MIN_RATE = 641,
    OF_QUEUE_PROP = 642,
    OF_QUEUE_PROP_EXPERIMENTER = 643,
    OF_QUEUE_PROP_MAX_RATE = 644,
    OF_QUEUE_PROP_MIN_RATE = 645,
    OF_QUEUE_STATS_ENTRY = 646,
    OF_QUEUE_STATS_PROP = 647,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 648,
    OF_ROLE_PROP = 649,
    OF_ROLE_PROP_EXPERIMENTER = 650,
    OF_TABLE_DESC = 651,
    OF_TABLE_FEATURE_PROP = 652,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 653,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 654,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 655,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 656,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 657,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 658,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 659,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 660,
    OF_TABLE_FEATURE_PROP_MATCH = 661,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 662,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 663,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 664,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 665,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 666,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 667,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 668,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 669,
    OF_TABLE_FEATURES = 670,
    OF_TABLE_MOD_PROP = 671,
    OF_TABLE_MOD_PROP_EVICTION = 672,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 673,
    OF_TABLE_MOD_PROP_VACANCY = 674,
    OF_TABLE_STATS_ENTRY = 675,
    OF_UINT32 = 676,
    OF_UINT64 = 677,
    OF_UINT8 = 678,
    ...
    /* List objects */
    OF_LIST_ACTION = 679,
    OF_LIST_ACTION_ID = 680,
    OF_LIST_ASYNC_CONFIG_PROP = 681,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 682,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 683,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 684,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 685,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 686,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 687,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 688,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 689,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 690,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 691,
    OF_LIST_BSN_INTERFACE = 692,
    OF_LIST_BSN_LACP_STATS_ENTRY = 693,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 694,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 695,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 696,
    OF_LIST_BSN_TLV = 697,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 698,
    OF_LIST_BSN_VLAN_MAC = 699,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 700,
    OF_LIST_BUCKET = 701,
    OF_LIST_BUCKET_COUNTER = 702,
    OF_LIST_BUNDLE_PROP = 703,
    OF_LIST_FLOW_STATS_ENTRY = 704,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 705,
    OF_LIST_GROUP_STATS_ENTRY = 706,
    OF_LIST_HELLO_ELEM = 707,
    OF_LIST_INSTRUCTION = 708,
    OF_LIST_INSTRUCTION_ID = 709,
    OF_LIST_METER_BAND = 710,
    OF_LIST_METER_BAND_STATS = 711,
    OF_LIST_METER_CONFIG = 712,
    OF_LIST_METER_STATS = 713,
    OF_LIST_OXM = 714,
    OF_LIST_PACKET_QUEUE = 715,
    OF_LIST_PORT_DESC = 716,
    OF_LIST_PORT_DESC_PROP = 717,
    OF_LIST_PORT_MOD_PROP = 718,
    OF_LIST_PORT_STATS_ENTRY = 719,
    OF_LIST_PORT_STATS_PROP = 720,
    OF_LIST_QUEUE_DESC = 721,
    OF_LIST_QUEUE_DESC_PROP = 722,
    OF_LIST_QUEUE_PROP = 723,
    OF_LIST_QUEUE_STATS_ENTRY = 724,
    OF_LIST_QUEUE_STATS_PROP = 725,
    OF_LIST_ROLE_PROP = 726,
    OF_LIST_TABLE_DESC = 727,
    OF_LIST_TABLE_FEATURE_PROP = 728,
    OF_LIST_TABLE_FEATURES = 729,
    OF_LIST_TABLE_MOD_PROP = 730,
    OF_LIST_TABLE_STATS_ENTRY = 731,
    OF_LIST_UINT32 = 732,
    OF_LIST_UINT64 = 733,
    OF_LIST_UINT8 = 734,
