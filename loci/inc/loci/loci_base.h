...
typedef enum of_object_id_e {
    ...
    OF_BSN_FLOW_IDLE = 21,
    OF_BSN_FLOW_IDLE_ENABLE_GET_REPLY = 22,
    OF_BSN_FLOW_IDLE_ENABLE_GET_REQUEST = 23,
    OF_BSN_FLOW_IDLE_ENABLE_SET_REPLY = 24,
    OF_BSN_FLOW_IDLE_ENABLE_SET_REQUEST = 25,
    OF_BSN_GENTABLE_BUCKET_STATS_REPLY = 26,
    OF_BSN_GENTABLE_BUCKET_STATS_REQUEST = 27,
    OF_BSN_GENTABLE_CLEAR_REPLY = 28,
    OF_BSN_GENTABLE_CLEAR_REQUEST = 29,
    OF_BSN_GENTABLE_DESC_STATS_REPLY = 30,
    OF_BSN_GENTABLE_DESC_STATS_REQUEST = 31,
    OF_BSN_GENTABLE_ENTRY_ADD = 32,
    OF_BSN_GENTABLE_ENTRY_DELETE = 33,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_REPLY = 34,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_REQUEST = 35,
    OF_BSN_GENTABLE_ENTRY_STATS_REPLY = 36,
    OF_BSN_GENTABLE_ENTRY_STATS_REQUEST = 37,
    OF_BSN_GENTABLE_SET_BUCKETS_SIZE = 38,
    OF_BSN_GENTABLE_STATS_REPLY = 39,
    OF_BSN_GENTABLE_STATS_REQUEST = 40,
    OF_BSN_GET_INTERFACES_REPLY = 41,
    OF_BSN_GET_INTERFACES_REQUEST = 42,
    OF_BSN_GET_IP_MASK_REPLY = 43,
    OF_BSN_GET_IP_MASK_REQUEST = 44,
    OF_BSN_GET_L2_TABLE_REPLY = 45,
    OF_BSN_GET_L2_TABLE_REQUEST = 46,
    OF_BSN_GET_MIRRORING_REPLY = 47,
    OF_BSN_GET_MIRRORING_REQUEST = 48,
    OF_BSN_GET_SWITCH_PIPELINE_REPLY = 49,
    OF_BSN_GET_SWITCH_PIPELINE_REQUEST = 50,
    OF_BSN_HEADER = 51,
    OF_BSN_HYBRID_GET_REPLY = 52,
    OF_BSN_HYBRID_GET_REQUEST = 53,
    OF_BSN_LACP_CONVERGENCE_NOTIF = 54,
    OF_BSN_LACP_STATS_REPLY = 55,
    OF_BSN_LACP_STATS_REQUEST = 56,
    OF_BSN_PDU_RX_REPLY = 57,
    OF_BSN_PDU_RX_REQUEST = 58,
    OF_BSN_PDU_RX_TIMEOUT = 59,
    OF_BSN_PDU_TX_REPLY = 60,
    OF_BSN_PDU_TX_REQUEST = 61,
    OF_BSN_PORT_COUNTER_STATS_REPLY = 62,
    OF_BSN_PORT_COUNTER_STATS_REQUEST = 63,
    OF_BSN_ROLE_STATUS = 64,
    OF_BSN_SET_AUX_CXNS_REPLY = 65,
    OF_BSN_SET_AUX_CXNS_REQUEST = 66,
    OF_BSN_SET_IP_MASK = 67,
    OF_BSN_SET_L2_TABLE_REPLY = 68,
    OF_BSN_SET_L2_TABLE_REQUEST = 69,
    OF_BSN_SET_LACP_REPLY = 70,
    OF_BSN_SET_LACP_REQUEST = 71,
    OF_BSN_SET_MIRRORING = 72,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 73,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 74,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 75,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 76,
    OF_BSN_SHELL_COMMAND = 77,
    OF_BSN_SHELL_OUTPUT = 78,
    OF_BSN_SHELL_STATUS = 79,
    OF_BSN_STATS_REPLY = 80,
    OF_BSN_STATS_REQUEST = 81,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 82,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 83,
    OF_BSN_TIME_REPLY = 84,
    OF_BSN_TIME_REQUEST = 85,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 86,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 87,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 88,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 89,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 90,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 91,
    OF_DESC_STATS_REPLY = 92,
    OF_DESC_STATS_REQUEST = 93,
    OF_ECHO_REPLY = 94,
    OF_ECHO_REQUEST = 95,
    OF_ERROR_MSG = 96,
    OF_EXPERIMENTER = 97,
    OF_EXPERIMENTER_ERROR_MSG = 98,
    OF_EXPERIMENTER_STATS_REPLY = 99,
    OF_EXPERIMENTER_STATS_REQUEST = 100,
    OF_FEATURES_REPLY = 101,
    OF_FEATURES_REQUEST = 102,
    OF_FLOW_ADD = 103,
    OF_FLOW_DELETE = 104,
    OF_FLOW_DELETE_STRICT = 105,
    OF_FLOW_MOD = 106,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 107,
    OF_FLOW_MODIFY = 108,
    OF_FLOW_MODIFY_STRICT = 109,
    OF_FLOW_REMOVED = 110,
    OF_FLOW_STATS_REPLY = 111,
    OF_FLOW_STATS_REQUEST = 112,
    OF_GET_CONFIG_REPLY = 113,
    OF_GET_CONFIG_REQUEST = 114,
    OF_GROUP_ADD = 115,
    OF_GROUP_DELETE = 116,
    OF_GROUP_DESC_STATS_REPLY = 117,
    OF_GROUP_DESC_STATS_REQUEST = 118,
    OF_GROUP_FEATURES_STATS_REPLY = 119,
    OF_GROUP_FEATURES_STATS_REQUEST = 120,
    OF_GROUP_MOD = 121,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 122,
    OF_GROUP_MODIFY = 123,
    OF_GROUP_STATS_REPLY = 124,
    OF_GROUP_STATS_REQUEST = 125,
    OF_HELLO = 126,
    OF_HELLO_FAILED_ERROR_MSG = 127,
    OF_METER_CONFIG_STATS_REPLY = 128,
    OF_METER_CONFIG_STATS_REQUEST = 129,
    OF_METER_FEATURES_STATS_REPLY = 130,
    OF_METER_FEATURES_STATS_REQUEST = 131,
    OF_METER_MOD = 132,
    OF_METER_MOD_FAILED_ERROR_MSG = 133,
    OF_METER_STATS_REPLY = 134,
    OF_METER_STATS_REQUEST = 135,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 136,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 137,
    OF_NICIRA_HEADER = 138,
    OF_PACKET_IN = 139,
    OF_PACKET_OUT = 140,
    OF_PORT_DESC_STATS_REPLY = 141,
    OF_PORT_DESC_STATS_REQUEST = 142,
    OF_PORT_MOD = 143,
    OF_PORT_MOD_FAILED_ERROR_MSG = 144,
    OF_PORT_STATS_REPLY = 145,
    OF_PORT_STATS_REQUEST = 146,
    OF_PORT_STATUS = 147,
    OF_QUEUE_GET_CONFIG_REPLY = 148,
    OF_QUEUE_GET_CONFIG_REQUEST = 149,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 150,
    OF_QUEUE_STATS_REPLY = 151,
    OF_QUEUE_STATS_REQUEST = 152,
    OF_ROLE_REPLY = 153,
    OF_ROLE_REQUEST = 154,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 155,
    OF_SET_CONFIG = 156,
    OF_STATS_REPLY = 157,
    OF_STATS_REQUEST = 158,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 159,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 160,
    OF_TABLE_FEATURES_STATS_REPLY = 161,
    OF_TABLE_FEATURES_STATS_REQUEST = 162,
    OF_TABLE_MOD = 163,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 164,
    OF_TABLE_STATS_REPLY = 165,
    OF_TABLE_STATS_REQUEST = 166,

    /* Non-message objects */
    OF_ACTION = 167,
    OF_ACTION_BSN = 168,
    OF_ACTION_BSN_MIRROR = 169,
    OF_ACTION_BSN_SET_TUNNEL_DST = 170,
    OF_ACTION_COPY_TTL_IN = 171,
    OF_ACTION_COPY_TTL_OUT = 172,
    OF_ACTION_DEC_MPLS_TTL = 173,
    OF_ACTION_DEC_NW_TTL = 174,
    OF_ACTION_ENQUEUE = 175,
    OF_ACTION_EXPERIMENTER = 176,
    OF_ACTION_GROUP = 177,
    OF_ACTION_HEADER = 178,
    OF_ACTION_ID = 179,
    OF_ACTION_ID_BSN = 180,
    OF_ACTION_ID_BSN_MIRROR = 181,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 182,
    OF_ACTION_ID_COPY_TTL_IN = 183,
    OF_ACTION_ID_COPY_TTL_OUT = 184,
    OF_ACTION_ID_DEC_MPLS_TTL = 185,
    OF_ACTION_ID_DEC_NW_TTL = 186,
    OF_ACTION_ID_EXPERIMENTER = 187,
    OF_ACTION_ID_GROUP = 188,
    OF_ACTION_ID_HEADER = 189,
    OF_ACTION_ID_NICIRA = 190,
    OF_ACTION_ID_NICIRA_DEC_TTL = 191,
    OF_ACTION_ID_OUTPUT = 192,
    OF_ACTION_ID_POP_MPLS = 193,
    OF_ACTION_ID_POP_PBB = 194,
    OF_ACTION_ID_POP_VLAN = 195,
    OF_ACTION_ID_PUSH_MPLS = 196,
    OF_ACTION_ID_PUSH_PBB = 197,
    OF_ACTION_ID_PUSH_VLAN = 198,
    OF_ACTION_ID_SET_FIELD = 199,
    OF_ACTION_ID_SET_MPLS_TTL = 200,
    OF_ACTION_ID_SET_NW_TTL = 201,
    OF_ACTION_ID_SET_QUEUE = 202,
    OF_ACTION_NICIRA = 203,
    OF_ACTION_NICIRA_DEC_TTL = 204,
    OF_ACTION_OUTPUT = 205,
    OF_ACTION_POP_MPLS = 206,
    OF_ACTION_POP_PBB = 207,
    OF_ACTION_POP_VLAN = 208,
    OF_ACTION_PUSH_MPLS = 209,
    OF_ACTION_PUSH_PBB = 210,
    OF_ACTION_PUSH_VLAN = 211,
    OF_ACTION_SET_DL_DST = 212,
    OF_ACTION_SET_DL_SRC = 213,
    OF_ACTION_SET_FIELD = 214,
    OF_ACTION_SET_MPLS_LABEL = 215,
    OF_ACTION_SET_MPLS_TC = 216,
    OF_ACTION_SET_MPLS_TTL = 217,
    OF_ACTION_SET_NW_DST = 218,
    OF_ACTION_SET_NW_ECN = 219,
    OF_ACTION_SET_NW_SRC = 220,
    OF_ACTION_SET_NW_TOS = 221,
    OF_ACTION_SET_NW_TTL = 222,
    OF_ACTION_SET_QUEUE = 223,
    OF_ACTION_SET_TP_DST = 224,
    OF_ACTION_SET_TP_SRC = 225,
    OF_ACTION_SET_VLAN_PCP = 226,
    OF_ACTION_SET_VLAN_VID = 227,
    OF_ACTION_STRIP_VLAN = 228,
    OF_BSN_CONTROLLER_CONNECTION = 229,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 230,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 231,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 232,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 233,
    OF_BSN_GENTABLE_STATS_ENTRY = 234,
    OF_BSN_INTERFACE = 235,
    OF_BSN_LACP_STATS_ENTRY = 236,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 237,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 238,
    OF_BSN_TLV = 239,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 240,
    OF_BSN_TLV_CIRCUIT_ID = 241,
    OF_BSN_TLV_HEADER = 242,
    OF_BSN_TLV_IDLE_NOTIFICATION = 243,
    OF_BSN_TLV_IDLE_TIME = 244,
    OF_BSN_TLV_IDLE_TIMEOUT = 245,
    OF_BSN_TLV_IPV4 = 246,
    OF_BSN_TLV_MAC = 247,
    OF_BSN_TLV_MISS_PACKETS = 248,
    OF_BSN_TLV_PORT = 249,
    OF_BSN_TLV_REPLY_PACKETS = 250,
    OF_BSN_TLV_REQUEST_PACKETS = 251,
    OF_BSN_TLV_RX_PACKETS = 252,
    OF_BSN_TLV_TX_PACKETS = 253,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 254,
    OF_BSN_TLV_VLAN_VID = 255,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 256,
    OF_BSN_VPORT = 257,
    OF_BSN_VPORT_HEADER = 258,
    OF_BSN_VPORT_Q_IN_Q = 259,
    OF_BUCKET = 260,
    OF_BUCKET_COUNTER = 261,
    OF_EXPERIMENTER_STATS_HEADER = 262,
    OF_FLOW_STATS_ENTRY = 263,
    OF_GROUP_DESC_STATS_ENTRY = 264,
    OF_GROUP_STATS_ENTRY = 265,
    OF_HEADER = 266,
    OF_HELLO_ELEM = 267,
    OF_HELLO_ELEM_HEADER = 268,
    OF_HELLO_ELEM_VERSIONBITMAP = 269,
    OF_INSTRUCTION = 270,
    OF_INSTRUCTION_APPLY_ACTIONS = 271,
    OF_INSTRUCTION_BSN = 272,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 273,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 274,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 275,
    OF_INSTRUCTION_CLEAR_ACTIONS = 276,
    OF_INSTRUCTION_EXPERIMENTER = 277,
    OF_INSTRUCTION_GOTO_TABLE = 278,
    OF_INSTRUCTION_HEADER = 279,
    OF_INSTRUCTION_ID = 280,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 281,
    OF_INSTRUCTION_ID_BSN = 282,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 283,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 284,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 285,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 286,
    OF_INSTRUCTION_ID_EXPERIMENTER = 287,
    OF_INSTRUCTION_ID_GOTO_TABLE = 288,
    OF_INSTRUCTION_ID_HEADER = 289,
    OF_INSTRUCTION_ID_METER = 290,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 291,
    OF_INSTRUCTION_ID_WRITE_METADATA = 292,
    OF_INSTRUCTION_METER = 293,
    OF_INSTRUCTION_WRITE_ACTIONS = 294,
    OF_INSTRUCTION_WRITE_METADATA = 295,
    OF_MATCH_V1 = 296,
    OF_MATCH_V2 = 297,
    OF_MATCH_V3 = 298,
    OF_METER_BAND = 299,
    OF_METER_BAND_DROP = 300,
    OF_METER_BAND_DSCP_REMARK = 301,
    OF_METER_BAND_EXPERIMENTER = 302,
    OF_METER_BAND_HEADER = 303,
    OF_METER_BAND_STATS = 304,
    OF_METER_CONFIG = 305,
    OF_METER_FEATURES = 306,
    OF_METER_STATS = 307,
    OF_OXM = 308,
    OF_OXM_ARP_OP = 309,
    OF_OXM_ARP_OP_MASKED = 310,
    OF_OXM_ARP_SHA = 311,
    OF_OXM_ARP_SHA_MASKED = 312,
    OF_OXM_ARP_SPA = 313,
    OF_OXM_ARP_SPA_MASKED = 314,
    OF_OXM_ARP_THA = 315,
    OF_OXM_ARP_THA_MASKED = 316,
    OF_OXM_ARP_TPA = 317,
    OF_OXM_ARP_TPA_MASKED = 318,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 319,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 320,
    OF_OXM_BSN_IN_PORTS_128 = 321,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 322,
    OF_OXM_BSN_L3_DST_CLASS_ID = 323,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 324,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 325,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 326,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 327,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 328,
    OF_OXM_BSN_LAG_ID = 329,
    OF_OXM_BSN_LAG_ID_MASKED = 330,
    OF_OXM_BSN_VRF = 331,
    OF_OXM_BSN_VRF_MASKED = 332,
    OF_OXM_ETH_DST = 333,
    OF_OXM_ETH_DST_MASKED = 334,
    OF_OXM_ETH_SRC = 335,
    OF_OXM_ETH_SRC_MASKED = 336,
    OF_OXM_ETH_TYPE = 337,
    OF_OXM_ETH_TYPE_MASKED = 338,
    OF_OXM_HEADER = 339,
    OF_OXM_ICMPV4_CODE = 340,
    OF_OXM_ICMPV4_CODE_MASKED = 341,
    OF_OXM_ICMPV4_TYPE = 342,
    OF_OXM_ICMPV4_TYPE_MASKED = 343,
    OF_OXM_ICMPV6_CODE = 344,
    OF_OXM_ICMPV6_CODE_MASKED = 345,
    OF_OXM_ICMPV6_TYPE = 346,
    OF_OXM_ICMPV6_TYPE_MASKED = 347,
    OF_OXM_IN_PHY_PORT = 348,
    OF_OXM_IN_PHY_PORT_MASKED = 349,
    OF_OXM_IN_PORT = 350,
    OF_OXM_IN_PORT_MASKED = 351,
    OF_OXM_IP_DSCP = 352,
    OF_OXM_IP_DSCP_MASKED = 353,
    OF_OXM_IP_ECN = 354,
    OF_OXM_IP_ECN_MASKED = 355,
    OF_OXM_IP_PROTO = 356,
    OF_OXM_IP_PROTO_MASKED = 357,
    OF_OXM_IPV4_DST = 358,
    OF_OXM_IPV4_DST_MASKED = 359,
    OF_OXM_IPV4_SRC = 360,
    OF_OXM_IPV4_SRC_MASKED = 361,
    OF_OXM_IPV6_DST = 362,
    OF_OXM_IPV6_DST_MASKED = 363,
    OF_OXM_IPV6_FLABEL = 364,
    OF_OXM_IPV6_FLABEL_MASKED = 365,
    OF_OXM_IPV6_ND_SLL = 366,
    OF_OXM_IPV6_ND_SLL_MASKED = 367,
    OF_OXM_IPV6_ND_TARGET = 368,
    OF_OXM_IPV6_ND_TARGET_MASKED = 369,
    OF_OXM_IPV6_ND_TLL = 370,
    OF_OXM_IPV6_ND_TLL_MASKED = 371,
    OF_OXM_IPV6_SRC = 372,
    OF_OXM_IPV6_SRC_MASKED = 373,
    OF_OXM_METADATA = 374,
    OF_OXM_METADATA_MASKED = 375,
    OF_OXM_MPLS_LABEL = 376,
    OF_OXM_MPLS_LABEL_MASKED = 377,
    OF_OXM_MPLS_TC = 378,
    OF_OXM_MPLS_TC_MASKED = 379,
    OF_OXM_SCTP_DST = 380,
    OF_OXM_SCTP_DST_MASKED = 381,
    OF_OXM_SCTP_SRC = 382,
    OF_OXM_SCTP_SRC_MASKED = 383,
    OF_OXM_TCP_DST = 384,
    OF_OXM_TCP_DST_MASKED = 385,
    OF_OXM_TCP_SRC = 386,
    OF_OXM_TCP_SRC_MASKED = 387,
    OF_OXM_UDP_DST = 388,
    OF_OXM_UDP_DST_MASKED = 389,
    OF_OXM_UDP_SRC = 390,
    OF_OXM_UDP_SRC_MASKED = 391,
    OF_OXM_VLAN_PCP = 392,
    OF_OXM_VLAN_PCP_MASKED = 393,
    OF_OXM_VLAN_VID = 394,
    OF_OXM_VLAN_VID_MASKED = 395,
    OF_PACKET_QUEUE = 396,
    OF_PORT_DESC = 397,
    OF_PORT_STATS_ENTRY = 398,
    OF_QUEUE_PROP = 399,
    OF_QUEUE_PROP_EXPERIMENTER = 400,
    OF_QUEUE_PROP_HEADER = 401,
    OF_QUEUE_PROP_MAX_RATE = 402,
    OF_QUEUE_PROP_MIN_RATE = 403,
    OF_QUEUE_STATS_ENTRY = 404,
    OF_TABLE_FEATURE_PROP = 405,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 406,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 407,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 408,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 409,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 410,
    OF_TABLE_FEATURE_PROP_HEADER = 411,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 412,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 413,
    OF_TABLE_FEATURE_PROP_MATCH = 414,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 415,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 416,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 417,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 418,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 419,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 420,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 421,
    OF_TABLE_FEATURES = 422,
    OF_TABLE_STATS_ENTRY = 423,
    OF_UINT32 = 424,
    OF_UINT64 = 425,
    OF_UINT8 = 426,
    ...
    /* List objects */
    OF_LIST_ACTION = 427,
    OF_LIST_ACTION_ID = 428,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 429,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 430,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 431,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 432,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 433,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 434,
    OF_LIST_BSN_INTERFACE = 435,
    OF_LIST_BSN_LACP_STATS_ENTRY = 436,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 437,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 438,
    OF_LIST_BSN_TLV = 439,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 440,
    OF_LIST_BUCKET = 441,
    OF_LIST_BUCKET_COUNTER = 442,
    OF_LIST_FLOW_STATS_ENTRY = 443,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 444,
    OF_LIST_GROUP_STATS_ENTRY = 445,
    OF_LIST_HELLO_ELEM = 446,
    OF_LIST_INSTRUCTION = 447,
    OF_LIST_METER_BAND = 448,
    OF_LIST_METER_BAND_STATS = 449,
    OF_LIST_METER_STATS = 450,
    OF_LIST_OXM = 451,
    OF_LIST_PACKET_QUEUE = 452,
    OF_LIST_PORT_DESC = 453,
    OF_LIST_PORT_STATS_ENTRY = 454,
    OF_LIST_QUEUE_PROP = 455,
    OF_LIST_QUEUE_STATS_ENTRY = 456,
    OF_LIST_TABLE_FEATURE_PROP = 457,
    OF_LIST_TABLE_FEATURES = 458,
    OF_LIST_TABLE_STATS_ENTRY = 459,
    OF_LIST_UINT32 = 460,
    OF_LIST_UINT64 = 461,
    OF_LIST_UINT8 = 462,
...
#define OF_MESSAGE_OBJECT_COUNT 167
