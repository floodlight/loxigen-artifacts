...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_RX_PACKETS = 350,
    OF_BSN_TLV_SAMPLING_RATE = 351,
    OF_BSN_TLV_SUB_AGENT_ID = 352,
    OF_BSN_TLV_TCP_DST = 353,
    OF_BSN_TLV_TCP_SRC = 354,
    OF_BSN_TLV_TX_BYTES = 355,
    OF_BSN_TLV_TX_PACKETS = 356,
    OF_BSN_TLV_UDF_ANCHOR = 357,
    OF_BSN_TLV_UDF_ID = 358,
    OF_BSN_TLV_UDF_LENGTH = 359,
    OF_BSN_TLV_UDF_OFFSET = 360,
    OF_BSN_TLV_UDP_DST = 361,
    OF_BSN_TLV_UDP_SRC = 362,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 363,
    OF_BSN_TLV_VLAN_VID = 364,
    OF_BSN_TLV_VRF = 365,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 366,
    OF_BSN_VPORT = 367,
    OF_BSN_VPORT_L2GRE = 368,
    OF_BSN_VPORT_Q_IN_Q = 369,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 370,
    OF_BUCKET = 371,
    OF_BUCKET_COUNTER = 372,
    OF_BUNDLE_PROP = 373,
    OF_BUNDLE_PROP_EXPERIMENTER = 374,
    OF_FLOW_STATS_ENTRY = 375,
    OF_GROUP_DESC_STATS_ENTRY = 376,
    OF_GROUP_STATS_ENTRY = 377,
    OF_HELLO_ELEM = 378,
    OF_HELLO_ELEM_VERSIONBITMAP = 379,
    OF_INSTRUCTION = 380,
    OF_INSTRUCTION_APPLY_ACTIONS = 381,
    OF_INSTRUCTION_BSN = 382,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 383,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 384,
    OF_INSTRUCTION_BSN_DENY = 385,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 386,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 387,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 388,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 389,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 390,
    OF_INSTRUCTION_BSN_PERMIT = 391,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 392,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 393,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 394,
    OF_INSTRUCTION_CLEAR_ACTIONS = 395,
    OF_INSTRUCTION_EXPERIMENTER = 396,
    OF_INSTRUCTION_GOTO_TABLE = 397,
    OF_INSTRUCTION_ID = 398,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 399,
    OF_INSTRUCTION_ID_BSN = 400,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 401,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 402,
    OF_INSTRUCTION_ID_BSN_DENY = 403,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 404,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 405,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 406,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 407,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 408,
    OF_INSTRUCTION_ID_BSN_PERMIT = 409,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 410,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 411,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 412,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 413,
    OF_INSTRUCTION_ID_EXPERIMENTER = 414,
    OF_INSTRUCTION_ID_GOTO_TABLE = 415,
    OF_INSTRUCTION_ID_METER = 416,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 417,
    OF_INSTRUCTION_ID_WRITE_METADATA = 418,
    OF_INSTRUCTION_METER = 419,
    OF_INSTRUCTION_WRITE_ACTIONS = 420,
    OF_INSTRUCTION_WRITE_METADATA = 421,
    OF_MATCH_V1 = 422,
    OF_MATCH_V2 = 423,
    OF_MATCH_V3 = 424,
    OF_METER_BAND = 425,
    OF_METER_BAND_DROP = 426,
    OF_METER_BAND_DSCP_REMARK = 427,
    OF_METER_BAND_EXPERIMENTER = 428,
    OF_METER_BAND_STATS = 429,
    OF_METER_CONFIG = 430,
    OF_METER_FEATURES = 431,
    OF_METER_STATS = 432,
    OF_OXM = 433,
    OF_OXM_ARP_OP = 434,
    OF_OXM_ARP_OP_MASKED = 435,
    OF_OXM_ARP_SHA = 436,
    OF_OXM_ARP_SHA_MASKED = 437,
    OF_OXM_ARP_SPA = 438,
    OF_OXM_ARP_SPA_MASKED = 439,
    OF_OXM_ARP_THA = 440,
    OF_OXM_ARP_THA_MASKED = 441,
    OF_OXM_ARP_TPA = 442,
    OF_OXM_ARP_TPA_MASKED = 443,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 444,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 445,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 446,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 447,
    OF_OXM_BSN_IN_PORTS_128 = 448,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 449,
    OF_OXM_BSN_IN_PORTS_512 = 450,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 451,
    OF_OXM_BSN_L2_CACHE_HIT = 452,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 453,
    OF_OXM_BSN_L3_DST_CLASS_ID = 454,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 455,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 456,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 457,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 458,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 459,
    OF_OXM_BSN_LAG_ID = 460,
    OF_OXM_BSN_LAG_ID_MASKED = 461,
    OF_OXM_BSN_TCP_FLAGS = 462,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 463,
    OF_OXM_BSN_UDF0 = 464,
    OF_OXM_BSN_UDF0_MASKED = 465,
    OF_OXM_BSN_UDF1 = 466,
    OF_OXM_BSN_UDF1_MASKED = 467,
    OF_OXM_BSN_UDF2 = 468,
    OF_OXM_BSN_UDF2_MASKED = 469,
    OF_OXM_BSN_UDF3 = 470,
    OF_OXM_BSN_UDF3_MASKED = 471,
    OF_OXM_BSN_UDF4 = 472,
    OF_OXM_BSN_UDF4_MASKED = 473,
    OF_OXM_BSN_UDF5 = 474,
    OF_OXM_BSN_UDF5_MASKED = 475,
    OF_OXM_BSN_UDF6 = 476,
    OF_OXM_BSN_UDF6_MASKED = 477,
    OF_OXM_BSN_UDF7 = 478,
    OF_OXM_BSN_UDF7_MASKED = 479,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 480,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 481,
    OF_OXM_BSN_VRF = 482,
    OF_OXM_BSN_VRF_MASKED = 483,
    OF_OXM_ETH_DST = 484,
    OF_OXM_ETH_DST_MASKED = 485,
    OF_OXM_ETH_SRC = 486,
    OF_OXM_ETH_SRC_MASKED = 487,
    OF_OXM_ETH_TYPE = 488,
    OF_OXM_ETH_TYPE_MASKED = 489,
    OF_OXM_ICMPV4_CODE = 490,
    OF_OXM_ICMPV4_CODE_MASKED = 491,
    OF_OXM_ICMPV4_TYPE = 492,
    OF_OXM_ICMPV4_TYPE_MASKED = 493,
    OF_OXM_ICMPV6_CODE = 494,
    OF_OXM_ICMPV6_CODE_MASKED = 495,
    OF_OXM_ICMPV6_TYPE = 496,
    OF_OXM_ICMPV6_TYPE_MASKED = 497,
    OF_OXM_IN_PHY_PORT = 498,
    OF_OXM_IN_PHY_PORT_MASKED = 499,
    OF_OXM_IN_PORT = 500,
    OF_OXM_IN_PORT_MASKED = 501,
    OF_OXM_IP_DSCP = 502,
    OF_OXM_IP_DSCP_MASKED = 503,
    OF_OXM_IP_ECN = 504,
    OF_OXM_IP_ECN_MASKED = 505,
    OF_OXM_IP_PROTO = 506,
    OF_OXM_IP_PROTO_MASKED = 507,
    OF_OXM_IPV4_DST = 508,
    OF_OXM_IPV4_DST_MASKED = 509,
    OF_OXM_IPV4_SRC = 510,
    OF_OXM_IPV4_SRC_MASKED = 511,
    OF_OXM_IPV6_DST = 512,
    OF_OXM_IPV6_DST_MASKED = 513,
    OF_OXM_IPV6_EXTHDR = 514,
    OF_OXM_IPV6_EXTHDR_MASKED = 515,
    OF_OXM_IPV6_FLABEL = 516,
    OF_OXM_IPV6_FLABEL_MASKED = 517,
    OF_OXM_IPV6_ND_SLL = 518,
    OF_OXM_IPV6_ND_SLL_MASKED = 519,
    OF_OXM_IPV6_ND_TARGET = 520,
    OF_OXM_IPV6_ND_TARGET_MASKED = 521,
    OF_OXM_IPV6_ND_TLL = 522,
    OF_OXM_IPV6_ND_TLL_MASKED = 523,
    OF_OXM_IPV6_SRC = 524,
    OF_OXM_IPV6_SRC_MASKED = 525,
    OF_OXM_METADATA = 526,
    OF_OXM_METADATA_MASKED = 527,
    OF_OXM_MPLS_BOS = 528,
    OF_OXM_MPLS_BOS_MASKED = 529,
    OF_OXM_MPLS_LABEL = 530,
    OF_OXM_MPLS_LABEL_MASKED = 531,
    OF_OXM_MPLS_TC = 532,
    OF_OXM_MPLS_TC_MASKED = 533,
    OF_OXM_PBB_UCA = 534,
    OF_OXM_PBB_UCA_MASKED = 535,
    OF_OXM_SCTP_DST = 536,
    OF_OXM_SCTP_DST_MASKED = 537,
    OF_OXM_SCTP_SRC = 538,
    OF_OXM_SCTP_SRC_MASKED = 539,
    OF_OXM_TCP_DST = 540,
    OF_OXM_TCP_DST_MASKED = 541,
    OF_OXM_TCP_SRC = 542,
    OF_OXM_TCP_SRC_MASKED = 543,
    OF_OXM_TUNNEL_ID = 544,
    OF_OXM_TUNNEL_ID_MASKED = 545,
    OF_OXM_TUNNEL_IPV4_DST = 546,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 547,
    OF_OXM_TUNNEL_IPV4_SRC = 548,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 549,
    OF_OXM_UDP_DST = 550,
    OF_OXM_UDP_DST_MASKED = 551,
    OF_OXM_UDP_SRC = 552,
    OF_OXM_UDP_SRC_MASKED = 553,
    OF_OXM_VLAN_PCP = 554,
    OF_OXM_VLAN_PCP_MASKED = 555,
    OF_OXM_VLAN_VID = 556,
    OF_OXM_VLAN_VID_MASKED = 557,
    OF_PACKET_QUEUE = 558,
    OF_PORT_DESC = 559,
    OF_PORT_DESC_PROP = 560,
    OF_PORT_DESC_PROP_ETHERNET = 561,
    OF_PORT_DESC_PROP_EXPERIMENTER = 562,
    OF_PORT_DESC_PROP_OPTICAL = 563,
    OF_PORT_MOD_PROP = 564,
    OF_PORT_MOD_PROP_ETHERNET = 565,
    OF_PORT_MOD_PROP_EXPERIMENTER = 566,
    OF_PORT_MOD_PROP_OPTICAL = 567,
    OF_PORT_STATS_ENTRY = 568,
    OF_PORT_STATS_PROP = 569,
    OF_PORT_STATS_PROP_ETHERNET = 570,
    OF_PORT_STATS_PROP_EXPERIMENTER = 571,
    OF_PORT_STATS_PROP_OPTICAL = 572,
    OF_QUEUE_DESC = 573,
    OF_QUEUE_DESC_PROP = 574,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 575,
    OF_QUEUE_DESC_PROP_MAX_RATE = 576,
    OF_QUEUE_DESC_PROP_MIN_RATE = 577,
    OF_QUEUE_PROP = 578,
    OF_QUEUE_PROP_EXPERIMENTER = 579,
    OF_QUEUE_PROP_MAX_RATE = 580,
    OF_QUEUE_PROP_MIN_RATE = 581,
    OF_QUEUE_STATS_ENTRY = 582,
    OF_QUEUE_STATS_PROP = 583,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 584,
    OF_ROLE_PROP = 585,
    OF_ROLE_PROP_EXPERIMENTER = 586,
    OF_TABLE_DESC = 587,
    OF_TABLE_FEATURE_PROP = 588,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 589,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 590,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 591,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 592,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 593,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 594,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 595,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 596,
    OF_TABLE_FEATURE_PROP_MATCH = 597,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 598,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 599,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 600,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 601,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 602,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 603,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 604,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 605,
    OF_TABLE_FEATURES = 606,
    OF_TABLE_MOD_PROP = 607,
    OF_TABLE_MOD_PROP_EVICTION = 608,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 609,
    OF_TABLE_MOD_PROP_VACANCY = 610,
    OF_TABLE_STATS_ENTRY = 611,
    OF_UINT32 = 612,
    OF_UINT64 = 613,
    OF_UINT8 = 614,
    ...
    /* List objects */
    OF_LIST_ACTION = 615,
    OF_LIST_ACTION_ID = 616,
    OF_LIST_ASYNC_CONFIG_PROP = 617,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 618,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 619,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 620,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 621,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 622,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 623,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 624,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 625,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 626,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 627,
    OF_LIST_BSN_INTERFACE = 628,
    OF_LIST_BSN_LACP_STATS_ENTRY = 629,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 630,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 631,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 632,
    OF_LIST_BSN_TLV = 633,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 634,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 635,
    OF_LIST_BUCKET = 636,
    OF_LIST_BUCKET_COUNTER = 637,
    OF_LIST_BUNDLE_PROP = 638,
    OF_LIST_FLOW_STATS_ENTRY = 639,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 640,
    OF_LIST_GROUP_STATS_ENTRY = 641,
    OF_LIST_HELLO_ELEM = 642,
    OF_LIST_INSTRUCTION = 643,
    OF_LIST_INSTRUCTION_ID = 644,
    OF_LIST_METER_BAND = 645,
    OF_LIST_METER_BAND_STATS = 646,
    OF_LIST_METER_STATS = 647,
    OF_LIST_OXM = 648,
    OF_LIST_PACKET_QUEUE = 649,
    OF_LIST_PORT_DESC = 650,
    OF_LIST_PORT_DESC_PROP = 651,
    OF_LIST_PORT_MOD_PROP = 652,
    OF_LIST_PORT_STATS_ENTRY = 653,
    OF_LIST_PORT_STATS_PROP = 654,
    OF_LIST_QUEUE_DESC = 655,
    OF_LIST_QUEUE_DESC_PROP = 656,
    OF_LIST_QUEUE_PROP = 657,
    OF_LIST_QUEUE_STATS_ENTRY = 658,
    OF_LIST_QUEUE_STATS_PROP = 659,
    OF_LIST_ROLE_PROP = 660,
    OF_LIST_TABLE_DESC = 661,
    OF_LIST_TABLE_FEATURE_PROP = 662,
    OF_LIST_TABLE_FEATURES = 663,
    OF_LIST_TABLE_MOD_PROP = 664,
    OF_LIST_TABLE_STATS_ENTRY = 665,
    OF_LIST_UINT32 = 666,
    OF_LIST_UINT64 = 667,
    OF_LIST_UINT8 = 668,
