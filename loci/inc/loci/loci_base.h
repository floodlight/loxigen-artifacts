...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_FORCE_LINK_UP = 343,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 344,
    OF_BSN_TLV_GENERATION_ID = 345,
    OF_BSN_TLV_HASH_ALGORITHM = 346,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 347,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 348,
    OF_BSN_TLV_HASH_PACKET_FIELD = 349,
    OF_BSN_TLV_HASH_PACKET_TYPE = 350,
    OF_BSN_TLV_HASH_SEED = 351,
    OF_BSN_TLV_HASH_TYPE = 352,
    OF_BSN_TLV_HEADER_SIZE = 353,
    OF_BSN_TLV_ICMP_CODE = 354,
    OF_BSN_TLV_ICMP_ID = 355,
    OF_BSN_TLV_ICMP_TYPE = 356,
    OF_BSN_TLV_ICMPV6_CHKSUM = 357,
    OF_BSN_TLV_IDENTIFIER = 358,
    OF_BSN_TLV_IDLE_NOTIFICATION = 359,
    OF_BSN_TLV_IDLE_TIME = 360,
    OF_BSN_TLV_IDLE_TIMEOUT = 361,
    OF_BSN_TLV_IGMP_SNOOPING = 362,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 363,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 364,
    OF_BSN_TLV_INTERNAL_MAC = 365,
    OF_BSN_TLV_INTERVAL = 366,
    OF_BSN_TLV_IP_PROTO = 367,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 368,
    OF_BSN_TLV_IPV4 = 369,
    OF_BSN_TLV_IPV4_DST = 370,
    OF_BSN_TLV_IPV4_NETMASK = 371,
    OF_BSN_TLV_IPV4_SRC = 372,
    OF_BSN_TLV_IPV6 = 373,
    OF_BSN_TLV_IPV6_DST = 374,
    OF_BSN_TLV_IPV6_PREFIX = 375,
    OF_BSN_TLV_IPV6_SRC = 376,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 377,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 378,
    OF_BSN_TLV_L3 = 379,
    ...
    OF_BSN_TLV_LR_ALL_ENABLED = 386,
    OF_BSN_TLV_MAC = 387,
    OF_BSN_TLV_MAC_MASK = 388,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 389,
    OF_BSN_TLV_MISS_PACKETS = 390,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 391,
    OF_BSN_TLV_MPLS_LABEL = 392,
    OF_BSN_TLV_MPLS_SEQUENCED = 393,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 394,
    OF_BSN_TLV_MULTICAST_PACKET = 395,
    OF_BSN_TLV_MULTIPLIER = 396,
    OF_BSN_TLV_NAME = 397,
    OF_BSN_TLV_NDP_OFFLOAD = 398,
    OF_BSN_TLV_NDP_STATIC = 399,
    OF_BSN_TLV_NEGATE = 400,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 401,
    OF_BSN_TLV_NEXT_HOP_MAC = 402,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 403,
    OF_BSN_TLV_NO_ARP_RESPONSE = 404,
    OF_BSN_TLV_NO_NS_RESPONSE = 405,
    OF_BSN_TLV_OFFSET = 406,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 407,
    OF_BSN_TLV_OUTER_SRC_MAC = 408,
    OF_BSN_TLV_PARENT_PORT = 409,
    OF_BSN_TLV_PARTNER_KEY = 410,
    OF_BSN_TLV_PARTNER_PORT_NUM = 411,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 412,
    OF_BSN_TLV_PARTNER_STATE = 413,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 414,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 415,
    OF_BSN_TLV_PASSIVE = 416,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 417,
    OF_BSN_TLV_PIM_DR = 418,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 419,
    OF_BSN_TLV_PORT = 420,
    OF_BSN_TLV_PORT_MODE = 421,
    OF_BSN_TLV_PORT_SPEED_GBPS = 422,
    OF_BSN_TLV_PORT_USAGE = 423,
    OF_BSN_TLV_PORT_VXLAN_MODE = 424,
    OF_BSN_TLV_PRIORITY = 425,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 426,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 427,
    OF_BSN_TLV_QOS_PRIORITY = 428,
    OF_BSN_TLV_QUEUE_ID = 429,
    OF_BSN_TLV_QUEUE_WEIGHT = 430,
    OF_BSN_TLV_RATE_LIMIT = 431,
    OF_BSN_TLV_RATE_UNIT = 432,
    OF_BSN_TLV_RECORD_PACKETS = 433,
    OF_BSN_TLV_REFERENCE = 434,
    OF_BSN_TLV_REPLY_PACKETS = 435,
    OF_BSN_TLV_REQUEST_PACKETS = 436,
    OF_BSN_TLV_REST_SERVER = 437,
    OF_BSN_TLV_ROUTING_PARAM = 438,
    OF_BSN_TLV_RX_BYTES = 439,
    OF_BSN_TLV_RX_PACKETS = 440,
    OF_BSN_TLV_SAMPLING_RATE = 441,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 442,
    OF_BSN_TLV_STATUS = 443,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 444,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 445,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 446,
    OF_BSN_TLV_SUB_AGENT_ID = 447,
    OF_BSN_TLV_TCP_DST = 448,
    OF_BSN_TLV_TCP_FLAGS = 449,
    OF_BSN_TLV_TCP_SRC = 450,
    OF_BSN_TLV_TIMESTAMP = 451,
    OF_BSN_TLV_TTL = 452,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 453,
    OF_BSN_TLV_TX_BYTES = 454,
    OF_BSN_TLV_TX_PACKETS = 455,
    OF_BSN_TLV_UDF_ANCHOR = 456,
    OF_BSN_TLV_UDF_CAPABILITY = 457,
    OF_BSN_TLV_UDF_ID = 458,
    OF_BSN_TLV_UDF_LENGTH = 459,
    OF_BSN_TLV_UDF_OFFSET = 460,
    OF_BSN_TLV_UDP_DST = 461,
    OF_BSN_TLV_UDP_SRC = 462,
    OF_BSN_TLV_UINT32 = 463,
    OF_BSN_TLV_UINT64_LIST = 464,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 465,
    OF_BSN_TLV_UNICAST_RATE = 466,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 467,
    OF_BSN_TLV_UNTAGGED = 468,
    OF_BSN_TLV_UPGRADE = 469,
    OF_BSN_TLV_URI_SCHEME = 470,
    OF_BSN_TLV_USE_PACKET_STATE = 471,
    OF_BSN_TLV_USER_CONFIGURED = 472,
    OF_BSN_TLV_VFI = 473,
    OF_BSN_TLV_VFP_CLASS_ID = 474,
    OF_BSN_TLV_VIRTUAL = 475,
    OF_BSN_TLV_VLAN_MAC_LIST = 476,
    OF_BSN_TLV_VLAN_PCP = 477,
    OF_BSN_TLV_VLAN_VID = 478,
    OF_BSN_TLV_VLAN_VID_MASK = 479,
    OF_BSN_TLV_VNI = 480,
    OF_BSN_TLV_VPN_KEY = 481,
    OF_BSN_TLV_VRF = 482,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 483,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 484,
    OF_BSN_VLAN_MAC = 485,
    OF_BSN_VPORT = 486,
    OF_BSN_VPORT_L2GRE = 487,
    OF_BSN_VPORT_Q_IN_Q = 488,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 489,
    OF_BUCKET = 490,
    OF_BUCKET_COUNTER = 491,
    OF_BUNDLE_PROP = 492,
    OF_BUNDLE_PROP_EXPERIMENTER = 493,
    OF_FLOW_STATS_ENTRY = 494,
    OF_GROUP_DESC_STATS_ENTRY = 495,
    OF_GROUP_STATS_ENTRY = 496,
    OF_HELLO_ELEM = 497,
    OF_HELLO_ELEM_VERSIONBITMAP = 498,
    OF_INSTRUCTION = 499,
    OF_INSTRUCTION_APPLY_ACTIONS = 500,
    OF_INSTRUCTION_BSN = 501,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 502,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 503,
    OF_INSTRUCTION_BSN_DENY = 504,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 505,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 506,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 507,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 508,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 509,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 510,
    OF_INSTRUCTION_BSN_HASH_SELECT = 511,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 512,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 513,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 514,
    OF_INSTRUCTION_BSN_PERMIT = 515,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 516,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 517,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 518,
    OF_INSTRUCTION_CLEAR_ACTIONS = 519,
    OF_INSTRUCTION_EXPERIMENTER = 520,
    OF_INSTRUCTION_GOTO_TABLE = 521,
    OF_INSTRUCTION_ID = 522,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 523,
    OF_INSTRUCTION_ID_BSN = 524,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 525,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 526,
    OF_INSTRUCTION_ID_BSN_DENY = 527,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 528,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 529,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 530,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 531,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 532,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 533,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 534,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 535,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 536,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 537,
    OF_INSTRUCTION_ID_BSN_PERMIT = 538,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 539,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 540,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 541,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 542,
    OF_INSTRUCTION_ID_EXPERIMENTER = 543,
    OF_INSTRUCTION_ID_GOTO_TABLE = 544,
    OF_INSTRUCTION_ID_METER = 545,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 546,
    OF_INSTRUCTION_ID_WRITE_METADATA = 547,
    OF_INSTRUCTION_METER = 548,
    OF_INSTRUCTION_WRITE_ACTIONS = 549,
    OF_INSTRUCTION_WRITE_METADATA = 550,
    OF_MATCH_V1 = 551,
    OF_MATCH_V2 = 552,
    OF_MATCH_V3 = 553,
    OF_METER_BAND = 554,
    OF_METER_BAND_DROP = 555,
    OF_METER_BAND_DSCP_REMARK = 556,
    OF_METER_BAND_EXPERIMENTER = 557,
    OF_METER_BAND_STATS = 558,
    OF_METER_CONFIG = 559,
    OF_METER_FEATURES = 560,
    OF_METER_STATS = 561,
    OF_OXM = 562,
    OF_OXM_ARP_OP = 563,
    OF_OXM_ARP_OP_MASKED = 564,
    OF_OXM_ARP_SHA = 565,
    OF_OXM_ARP_SHA_MASKED = 566,
    OF_OXM_ARP_SPA = 567,
    OF_OXM_ARP_SPA_MASKED = 568,
    OF_OXM_ARP_THA = 569,
    OF_OXM_ARP_THA_MASKED = 570,
    OF_OXM_ARP_TPA = 571,
    OF_OXM_ARP_TPA_MASKED = 572,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 573,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 574,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 575,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 576,
    OF_OXM_BSN_IFP_CLASS_ID = 577,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 578,
    OF_OXM_BSN_IN_PORTS_128 = 579,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 580,
    OF_OXM_BSN_IN_PORTS_512 = 581,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 582,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 583,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 584,
    OF_OXM_BSN_INNER_ETH_DST = 585,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 586,
    OF_OXM_BSN_INNER_ETH_SRC = 587,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 588,
    OF_OXM_BSN_INNER_VLAN_VID = 589,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 590,
    OF_OXM_BSN_IP_FRAGMENTATION = 591,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 592,
    OF_OXM_BSN_L2_CACHE_HIT = 593,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 594,
    OF_OXM_BSN_L3_DST_CLASS_ID = 595,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 596,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 597,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 598,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 599,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 600,
    OF_OXM_BSN_LAG_ID = 601,
    OF_OXM_BSN_LAG_ID_MASKED = 602,
    OF_OXM_BSN_TCP_FLAGS = 603,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 604,
    OF_OXM_BSN_UDF0 = 605,
    OF_OXM_BSN_UDF0_MASKED = 606,
    OF_OXM_BSN_UDF1 = 607,
    OF_OXM_BSN_UDF1_MASKED = 608,
    OF_OXM_BSN_UDF2 = 609,
    OF_OXM_BSN_UDF2_MASKED = 610,
    OF_OXM_BSN_UDF3 = 611,
    OF_OXM_BSN_UDF3_MASKED = 612,
    OF_OXM_BSN_UDF4 = 613,
    OF_OXM_BSN_UDF4_MASKED = 614,
    OF_OXM_BSN_UDF5 = 615,
    OF_OXM_BSN_UDF5_MASKED = 616,
    OF_OXM_BSN_UDF6 = 617,
    OF_OXM_BSN_UDF6_MASKED = 618,
    OF_OXM_BSN_UDF7 = 619,
    OF_OXM_BSN_UDF7_MASKED = 620,
    OF_OXM_BSN_VFI = 621,
    OF_OXM_BSN_VFI_MASKED = 622,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 623,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 624,
    OF_OXM_BSN_VRF = 625,
    OF_OXM_BSN_VRF_MASKED = 626,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 627,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 628,
    OF_OXM_CONN_TRACKING_IPV6_DST = 629,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 630,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 631,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 632,
    OF_OXM_CONN_TRACKING_LABEL = 633,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 634,
    OF_OXM_CONN_TRACKING_MARK = 635,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 636,
    OF_OXM_CONN_TRACKING_NW_DST = 637,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 638,
    OF_OXM_CONN_TRACKING_NW_PROTO = 639,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 640,
    OF_OXM_CONN_TRACKING_NW_SRC = 641,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 642,
    OF_OXM_CONN_TRACKING_STATE = 643,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 644,
    OF_OXM_CONN_TRACKING_TP_DST = 645,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 646,
    OF_OXM_CONN_TRACKING_TP_SRC = 647,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 648,
    OF_OXM_CONN_TRACKING_ZONE = 649,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 650,
    OF_OXM_ETH_DST = 651,
    OF_OXM_ETH_DST_MASKED = 652,
    OF_OXM_ETH_SRC = 653,
    OF_OXM_ETH_SRC_MASKED = 654,
    OF_OXM_ETH_TYPE = 655,
    OF_OXM_ETH_TYPE_MASKED = 656,
    OF_OXM_ICMPV4_CODE = 657,
    OF_OXM_ICMPV4_CODE_MASKED = 658,
    OF_OXM_ICMPV4_TYPE = 659,
    OF_OXM_ICMPV4_TYPE_MASKED = 660,
    OF_OXM_ICMPV6_CODE = 661,
    OF_OXM_ICMPV6_CODE_MASKED = 662,
    OF_OXM_ICMPV6_TYPE = 663,
    OF_OXM_ICMPV6_TYPE_MASKED = 664,
    OF_OXM_IN_PHY_PORT = 665,
    OF_OXM_IN_PHY_PORT_MASKED = 666,
    OF_OXM_IN_PORT = 667,
    OF_OXM_IN_PORT_MASKED = 668,
    OF_OXM_IP_DSCP = 669,
    OF_OXM_IP_DSCP_MASKED = 670,
    OF_OXM_IP_ECN = 671,
    OF_OXM_IP_ECN_MASKED = 672,
    OF_OXM_IP_PROTO = 673,
    OF_OXM_IP_PROTO_MASKED = 674,
    OF_OXM_IPV4_DST = 675,
    OF_OXM_IPV4_DST_MASKED = 676,
    OF_OXM_IPV4_SRC = 677,
    OF_OXM_IPV4_SRC_MASKED = 678,
    OF_OXM_IPV6_DST = 679,
    OF_OXM_IPV6_DST_MASKED = 680,
    OF_OXM_IPV6_EXTHDR = 681,
    OF_OXM_IPV6_EXTHDR_MASKED = 682,
    OF_OXM_IPV6_FLABEL = 683,
    OF_OXM_IPV6_FLABEL_MASKED = 684,
    OF_OXM_IPV6_ND_SLL = 685,
    OF_OXM_IPV6_ND_SLL_MASKED = 686,
    OF_OXM_IPV6_ND_TARGET = 687,
    OF_OXM_IPV6_ND_TARGET_MASKED = 688,
    OF_OXM_IPV6_ND_TLL = 689,
    OF_OXM_IPV6_ND_TLL_MASKED = 690,
    OF_OXM_IPV6_SRC = 691,
    OF_OXM_IPV6_SRC_MASKED = 692,
    OF_OXM_METADATA = 693,
    OF_OXM_METADATA_MASKED = 694,
    OF_OXM_MPLS_BOS = 695,
    OF_OXM_MPLS_BOS_MASKED = 696,
    OF_OXM_MPLS_LABEL = 697,
    OF_OXM_MPLS_LABEL_MASKED = 698,
    OF_OXM_MPLS_TC = 699,
    OF_OXM_MPLS_TC_MASKED = 700,
    OF_OXM_OVS_TCP_FLAGS = 701,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 702,
    OF_OXM_PBB_UCA = 703,
    OF_OXM_PBB_UCA_MASKED = 704,
    OF_OXM_SCTP_DST = 705,
    OF_OXM_SCTP_DST_MASKED = 706,
    OF_OXM_SCTP_SRC = 707,
    OF_OXM_SCTP_SRC_MASKED = 708,
    OF_OXM_TCP_DST = 709,
    OF_OXM_TCP_DST_MASKED = 710,
    OF_OXM_TCP_SRC = 711,
    OF_OXM_TCP_SRC_MASKED = 712,
    OF_OXM_TUNNEL_ID = 713,
    OF_OXM_TUNNEL_ID_MASKED = 714,
    OF_OXM_TUNNEL_IPV4_DST = 715,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 716,
    OF_OXM_TUNNEL_IPV4_SRC = 717,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 718,
    OF_OXM_UDP_DST = 719,
    OF_OXM_UDP_DST_MASKED = 720,
    OF_OXM_UDP_SRC = 721,
    OF_OXM_UDP_SRC_MASKED = 722,
    OF_OXM_VLAN_PCP = 723,
    OF_OXM_VLAN_PCP_MASKED = 724,
    OF_OXM_VLAN_VID = 725,
    OF_OXM_VLAN_VID_MASKED = 726,
    OF_PACKET_QUEUE = 727,
    OF_PORT_DESC = 728,
    OF_PORT_DESC_PROP = 729,
    OF_PORT_DESC_PROP_BSN = 730,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 731,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO = 732,
    OF_PORT_DESC_PROP_BSN_FIRMWARE_INFO = 733,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 734,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 735,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 736,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 737,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 738,
    OF_PORT_DESC_PROP_BSN_UPLINK = 739,
    OF_PORT_DESC_PROP_ETHERNET = 740,
    OF_PORT_DESC_PROP_EXPERIMENTER = 741,
    OF_PORT_DESC_PROP_OPTICAL = 742,
    OF_PORT_MOD_PROP = 743,
    OF_PORT_MOD_PROP_ETHERNET = 744,
    OF_PORT_MOD_PROP_EXPERIMENTER = 745,
    OF_PORT_MOD_PROP_OPTICAL = 746,
    OF_PORT_STATS_ENTRY = 747,
    OF_PORT_STATS_PROP = 748,
    OF_PORT_STATS_PROP_ETHERNET = 749,
    OF_PORT_STATS_PROP_EXPERIMENTER = 750,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 751,
    OF_PORT_STATS_PROP_OPTICAL = 752,
    OF_QUEUE_DESC = 753,
    OF_QUEUE_DESC_PROP = 754,
    OF_QUEUE_DESC_PROP_BSN = 755,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 756,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 757,
    OF_QUEUE_DESC_PROP_MAX_RATE = 758,
    OF_QUEUE_DESC_PROP_MIN_RATE = 759,
    OF_QUEUE_PROP = 760,
    OF_QUEUE_PROP_EXPERIMENTER = 761,
    OF_QUEUE_PROP_MAX_RATE = 762,
    OF_QUEUE_PROP_MIN_RATE = 763,
    OF_QUEUE_STATS_ENTRY = 764,
    OF_QUEUE_STATS_PROP = 765,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 766,
    OF_ROLE_PROP = 767,
    OF_ROLE_PROP_EXPERIMENTER = 768,
    OF_TABLE_DESC = 769,
    OF_TABLE_FEATURE_PROP = 770,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 771,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 772,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 773,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 774,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 775,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 776,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 777,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 778,
    OF_TABLE_FEATURE_PROP_MATCH = 779,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 780,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 781,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 782,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 783,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 784,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 785,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 786,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 787,
    OF_TABLE_FEATURES = 788,
    OF_TABLE_MOD_PROP = 789,
    OF_TABLE_MOD_PROP_EVICTION = 790,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 791,
    OF_TABLE_MOD_PROP_VACANCY = 792,
    OF_TABLE_STATS_ENTRY = 793,
    OF_UINT32 = 794,
    OF_UINT64 = 795,
    OF_UINT8 = 796,
    ...
    /* List objects */
    OF_LIST_ACTION = 797,
    OF_LIST_ACTION_ID = 798,
    OF_LIST_ASYNC_CONFIG_PROP = 799,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 800,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 801,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 802,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 803,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 804,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 805,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 806,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 807,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 808,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 809,
    OF_LIST_BSN_INTERFACE = 810,
    OF_LIST_BSN_LACP_STATS_ENTRY = 811,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 812,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 813,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 814,
    OF_LIST_BSN_TLV = 815,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 816,
    OF_LIST_BSN_VLAN_MAC = 817,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 818,
    OF_LIST_BUCKET = 819,
    OF_LIST_BUCKET_COUNTER = 820,
    OF_LIST_BUNDLE_PROP = 821,
    OF_LIST_FLOW_STATS_ENTRY = 822,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 823,
    OF_LIST_GROUP_STATS_ENTRY = 824,
    OF_LIST_HELLO_ELEM = 825,
    OF_LIST_INSTRUCTION = 826,
    OF_LIST_INSTRUCTION_ID = 827,
    OF_LIST_METER_BAND = 828,
    OF_LIST_METER_BAND_STATS = 829,
    OF_LIST_METER_CONFIG = 830,
    OF_LIST_METER_STATS = 831,
    OF_LIST_OXM = 832,
    OF_LIST_PACKET_QUEUE = 833,
    OF_LIST_PORT_DESC = 834,
    OF_LIST_PORT_DESC_PROP = 835,
    OF_LIST_PORT_MOD_PROP = 836,
    OF_LIST_PORT_STATS_ENTRY = 837,
    OF_LIST_PORT_STATS_PROP = 838,
    OF_LIST_QUEUE_DESC = 839,
    OF_LIST_QUEUE_DESC_PROP = 840,
    OF_LIST_QUEUE_PROP = 841,
    OF_LIST_QUEUE_STATS_ENTRY = 842,
    OF_LIST_QUEUE_STATS_PROP = 843,
    OF_LIST_ROLE_PROP = 844,
    OF_LIST_TABLE_DESC = 845,
    OF_LIST_TABLE_FEATURE_PROP = 846,
    OF_LIST_TABLE_FEATURES = 847,
    OF_LIST_TABLE_MOD_PROP = 848,
    OF_LIST_TABLE_STATS_ENTRY = 849,
    OF_LIST_UINT32 = 850,
    OF_LIST_UINT64 = 851,
    OF_LIST_UINT8 = 852,
