...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 456,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 457,
    OF_BSN_TLV_QOS_PRIORITY = 458,
    OF_BSN_TLV_QUEUE_ID = 459,
    OF_BSN_TLV_QUEUE_WEIGHT = 460,
    OF_BSN_TLV_RATE_LIMIT = 461,
    OF_BSN_TLV_RATE_UNIT = 462,
    OF_BSN_TLV_RECORD_PACKETS = 463,
    OF_BSN_TLV_REDUNDANT_MGMT = 464,
    OF_BSN_TLV_REFERENCE = 465,
    OF_BSN_TLV_REPLY_PACKETS = 466,
    OF_BSN_TLV_REQUEST_PACKETS = 467,
    OF_BSN_TLV_REST_SERVER = 468,
    OF_BSN_TLV_ROUTING_PARAM = 469,
    OF_BSN_TLV_RX_BYTES = 470,
    OF_BSN_TLV_RX_PACKETS = 471,
    OF_BSN_TLV_SAMPLING_RATE = 472,
    OF_BSN_TLV_SCTP_DST = 473,
    OF_BSN_TLV_SCTP_SRC = 474,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 475,
    OF_BSN_TLV_SOCKET = 476,
    OF_BSN_TLV_SRC_MAC_CML = 477,
    OF_BSN_TLV_STATUS = 478,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 479,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 480,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 481,
    OF_BSN_TLV_SUB_AGENT_ID = 482,
    OF_BSN_TLV_TCP_DST = 483,
    OF_BSN_TLV_TCP_FLAGS = 484,
    OF_BSN_TLV_TCP_SRC = 485,
    OF_BSN_TLV_THREAD = 486,
    OF_BSN_TLV_TIMESTAMP = 487,
    OF_BSN_TLV_TTL = 488,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 489,
    OF_BSN_TLV_TX_BYTES = 490,
    OF_BSN_TLV_TX_PACKETS = 491,
    OF_BSN_TLV_UDF_ANCHOR = 492,
    OF_BSN_TLV_UDF_CAPABILITY = 493,
    OF_BSN_TLV_UDF_DATA = 494,
    OF_BSN_TLV_UDF_ID = 495,
    OF_BSN_TLV_UDF_LENGTH = 496,
    OF_BSN_TLV_UDF_OFFSET = 497,
    OF_BSN_TLV_UDP_DST = 498,
    OF_BSN_TLV_UDP_SRC = 499,
    OF_BSN_TLV_UINT32 = 500,
    OF_BSN_TLV_UINT64_LIST = 501,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 502,
    OF_BSN_TLV_UNICAST_RATE = 503,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 504,
    OF_BSN_TLV_UNTAGGED = 505,
    OF_BSN_TLV_UPGRADE = 506,
    OF_BSN_TLV_URI_SCHEME = 507,
    OF_BSN_TLV_USE_PACKET_STATE = 508,
    OF_BSN_TLV_USER_CONFIGURED = 509,
    OF_BSN_TLV_VFI = 510,
    OF_BSN_TLV_VFP_CLASS_ID = 511,
    OF_BSN_TLV_VIRTUAL = 512,
    OF_BSN_TLV_VLAN_MAC_LIST = 513,
    OF_BSN_TLV_VLAN_PCP = 514,
    OF_BSN_TLV_VLAN_VID = 515,
    OF_BSN_TLV_VLAN_VID_MASK = 516,
    OF_BSN_TLV_VNI = 517,
    OF_BSN_TLV_VPN_KEY = 518,
    OF_BSN_TLV_VRF = 519,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 520,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 521,
    OF_BSN_VLAN_MAC = 522,
    OF_BSN_VPORT = 523,
    OF_BSN_VPORT_L2GRE = 524,
    OF_BSN_VPORT_Q_IN_Q = 525,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 526,
    OF_BUCKET = 527,
    OF_BUCKET_COUNTER = 528,
    OF_BUNDLE_PROP = 529,
    OF_BUNDLE_PROP_EXPERIMENTER = 530,
    OF_FLOW_STATS_ENTRY = 531,
    OF_GROUP_DESC_STATS_ENTRY = 532,
    OF_GROUP_STATS_ENTRY = 533,
    OF_HELLO_ELEM = 534,
    OF_HELLO_ELEM_VERSIONBITMAP = 535,
    OF_INSTRUCTION = 536,
    OF_INSTRUCTION_APPLY_ACTIONS = 537,
    OF_INSTRUCTION_BSN = 538,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 539,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 540,
    OF_INSTRUCTION_BSN_DENY = 541,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 542,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 543,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 544,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 545,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 546,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 547,
    OF_INSTRUCTION_BSN_HASH_SELECT = 548,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 549,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 550,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 551,
    OF_INSTRUCTION_BSN_PERMIT = 552,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 553,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 554,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 555,
    OF_INSTRUCTION_CLEAR_ACTIONS = 556,
    OF_INSTRUCTION_EXPERIMENTER = 557,
    OF_INSTRUCTION_GOTO_TABLE = 558,
    OF_INSTRUCTION_ID = 559,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 560,
    OF_INSTRUCTION_ID_BSN = 561,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 562,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 563,
    OF_INSTRUCTION_ID_BSN_DENY = 564,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 565,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 566,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 567,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 568,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 569,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 570,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 571,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 572,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 573,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 574,
    OF_INSTRUCTION_ID_BSN_PERMIT = 575,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 576,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 577,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 578,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 579,
    OF_INSTRUCTION_ID_EXPERIMENTER = 580,
    OF_INSTRUCTION_ID_GOTO_TABLE = 581,
    OF_INSTRUCTION_ID_METER = 582,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 583,
    OF_INSTRUCTION_ID_WRITE_METADATA = 584,
    OF_INSTRUCTION_METER = 585,
    OF_INSTRUCTION_WRITE_ACTIONS = 586,
    OF_INSTRUCTION_WRITE_METADATA = 587,
    OF_MATCH_V1 = 588,
    OF_MATCH_V2 = 589,
    OF_MATCH_V3 = 590,
    OF_METER_BAND = 591,
    OF_METER_BAND_DROP = 592,
    OF_METER_BAND_DSCP_REMARK = 593,
    OF_METER_BAND_EXPERIMENTER = 594,
    OF_METER_BAND_STATS = 595,
    OF_METER_CONFIG = 596,
    OF_METER_FEATURES = 597,
    OF_METER_STATS = 598,
    OF_OXM = 599,
    OF_OXM_ARP_OP = 600,
    OF_OXM_ARP_OP_MASKED = 601,
    OF_OXM_ARP_SHA = 602,
    OF_OXM_ARP_SHA_MASKED = 603,
    OF_OXM_ARP_SPA = 604,
    OF_OXM_ARP_SPA_MASKED = 605,
    OF_OXM_ARP_THA = 606,
    OF_OXM_ARP_THA_MASKED = 607,
    OF_OXM_ARP_TPA = 608,
    OF_OXM_ARP_TPA_MASKED = 609,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 610,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 611,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 612,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 613,
    OF_OXM_BSN_IFP_CLASS_ID = 614,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 615,
    OF_OXM_BSN_IN_PORTS_128 = 616,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 617,
    OF_OXM_BSN_IN_PORTS_512 = 618,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 619,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 620,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 621,
    OF_OXM_BSN_INNER_ETH_DST = 622,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 623,
    OF_OXM_BSN_INNER_ETH_SRC = 624,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 625,
    OF_OXM_BSN_INNER_VLAN_VID = 626,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 627,
    OF_OXM_BSN_IP_FRAGMENTATION = 628,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 629,
    OF_OXM_BSN_L2_CACHE_HIT = 630,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 631,
    OF_OXM_BSN_L3_DST_CLASS_ID = 632,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 633,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 634,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 635,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 636,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 637,
    OF_OXM_BSN_LAG_ID = 638,
    OF_OXM_BSN_LAG_ID_MASKED = 639,
    OF_OXM_BSN_TCP_FLAGS = 640,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 641,
    OF_OXM_BSN_UDF0 = 642,
    OF_OXM_BSN_UDF0_MASKED = 643,
    OF_OXM_BSN_UDF1 = 644,
    OF_OXM_BSN_UDF1_MASKED = 645,
    OF_OXM_BSN_UDF2 = 646,
    OF_OXM_BSN_UDF2_MASKED = 647,
    OF_OXM_BSN_UDF3 = 648,
    OF_OXM_BSN_UDF3_MASKED = 649,
    OF_OXM_BSN_UDF4 = 650,
    OF_OXM_BSN_UDF4_MASKED = 651,
    OF_OXM_BSN_UDF5 = 652,
    OF_OXM_BSN_UDF5_MASKED = 653,
    OF_OXM_BSN_UDF6 = 654,
    OF_OXM_BSN_UDF6_MASKED = 655,
    OF_OXM_BSN_UDF7 = 656,
    OF_OXM_BSN_UDF7_MASKED = 657,
    OF_OXM_BSN_VFI = 658,
    OF_OXM_BSN_VFI_MASKED = 659,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 660,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 661,
    OF_OXM_BSN_VRF = 662,
    OF_OXM_BSN_VRF_MASKED = 663,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 664,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 665,
    OF_OXM_CONN_TRACKING_IPV6_DST = 666,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 667,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 668,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 669,
    OF_OXM_CONN_TRACKING_LABEL = 670,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 671,
    OF_OXM_CONN_TRACKING_MARK = 672,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 673,
    OF_OXM_CONN_TRACKING_NW_DST = 674,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 675,
    OF_OXM_CONN_TRACKING_NW_PROTO = 676,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 677,
    OF_OXM_CONN_TRACKING_NW_SRC = 678,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 679,
    OF_OXM_CONN_TRACKING_STATE = 680,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 681,
    OF_OXM_CONN_TRACKING_TP_DST = 682,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 683,
    OF_OXM_CONN_TRACKING_TP_SRC = 684,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 685,
    OF_OXM_CONN_TRACKING_ZONE = 686,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 687,
    OF_OXM_ETH_DST = 688,
    OF_OXM_ETH_DST_MASKED = 689,
    OF_OXM_ETH_SRC = 690,
    OF_OXM_ETH_SRC_MASKED = 691,
    OF_OXM_ETH_TYPE = 692,
    OF_OXM_ETH_TYPE_MASKED = 693,
    OF_OXM_ICMPV4_CODE = 694,
    OF_OXM_ICMPV4_CODE_MASKED = 695,
    OF_OXM_ICMPV4_TYPE = 696,
    OF_OXM_ICMPV4_TYPE_MASKED = 697,
    OF_OXM_ICMPV6_CODE = 698,
    OF_OXM_ICMPV6_CODE_MASKED = 699,
    OF_OXM_ICMPV6_TYPE = 700,
    OF_OXM_ICMPV6_TYPE_MASKED = 701,
    OF_OXM_IN_PHY_PORT = 702,
    OF_OXM_IN_PHY_PORT_MASKED = 703,
    OF_OXM_IN_PORT = 704,
    OF_OXM_IN_PORT_MASKED = 705,
    OF_OXM_IP_DSCP = 706,
    OF_OXM_IP_DSCP_MASKED = 707,
    OF_OXM_IP_ECN = 708,
    OF_OXM_IP_ECN_MASKED = 709,
    OF_OXM_IP_PROTO = 710,
    OF_OXM_IP_PROTO_MASKED = 711,
    OF_OXM_IPV4_DST = 712,
    OF_OXM_IPV4_DST_MASKED = 713,
    OF_OXM_IPV4_SRC = 714,
    OF_OXM_IPV4_SRC_MASKED = 715,
    OF_OXM_IPV6_DST = 716,
    OF_OXM_IPV6_DST_MASKED = 717,
    OF_OXM_IPV6_EXTHDR = 718,
    OF_OXM_IPV6_EXTHDR_MASKED = 719,
    OF_OXM_IPV6_FLABEL = 720,
    OF_OXM_IPV6_FLABEL_MASKED = 721,
    OF_OXM_IPV6_ND_SLL = 722,
    OF_OXM_IPV6_ND_SLL_MASKED = 723,
    OF_OXM_IPV6_ND_TARGET = 724,
    OF_OXM_IPV6_ND_TARGET_MASKED = 725,
    OF_OXM_IPV6_ND_TLL = 726,
    OF_OXM_IPV6_ND_TLL_MASKED = 727,
    OF_OXM_IPV6_SRC = 728,
    OF_OXM_IPV6_SRC_MASKED = 729,
    OF_OXM_METADATA = 730,
    OF_OXM_METADATA_MASKED = 731,
    OF_OXM_MPLS_BOS = 732,
    OF_OXM_MPLS_BOS_MASKED = 733,
    OF_OXM_MPLS_LABEL = 734,
    OF_OXM_MPLS_LABEL_MASKED = 735,
    OF_OXM_MPLS_TC = 736,
    OF_OXM_MPLS_TC_MASKED = 737,
    OF_OXM_OVS_TCP_FLAGS = 738,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 739,
    OF_OXM_PBB_UCA = 740,
    OF_OXM_PBB_UCA_MASKED = 741,
    OF_OXM_SCTP_DST = 742,
    OF_OXM_SCTP_DST_MASKED = 743,
    OF_OXM_SCTP_SRC = 744,
    OF_OXM_SCTP_SRC_MASKED = 745,
    OF_OXM_TCP_DST = 746,
    OF_OXM_TCP_DST_MASKED = 747,
    OF_OXM_TCP_SRC = 748,
    OF_OXM_TCP_SRC_MASKED = 749,
    OF_OXM_TUNNEL_ID = 750,
    OF_OXM_TUNNEL_ID_MASKED = 751,
    OF_OXM_TUNNEL_IPV4_DST = 752,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 753,
    OF_OXM_TUNNEL_IPV4_SRC = 754,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 755,
    OF_OXM_UDP_DST = 756,
    OF_OXM_UDP_DST_MASKED = 757,
    OF_OXM_UDP_SRC = 758,
    OF_OXM_UDP_SRC_MASKED = 759,
    OF_OXM_VLAN_PCP = 760,
    OF_OXM_VLAN_PCP_MASKED = 761,
    OF_OXM_VLAN_VID = 762,
    OF_OXM_VLAN_VID_MASKED = 763,
    OF_PACKET_QUEUE = 764,
    OF_PORT_DESC = 765,
    OF_PORT_DESC_PROP = 766,
    OF_PORT_DESC_PROP_BSN = 767,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 768,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 769,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 770,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 771,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 772,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 773,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 774,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 775,
    OF_PORT_DESC_PROP_BSN_UPLINK = 776,
    OF_PORT_DESC_PROP_ETHERNET = 777,
    OF_PORT_DESC_PROP_EXPERIMENTER = 778,
    OF_PORT_DESC_PROP_OPTICAL = 779,
    OF_PORT_MOD_PROP = 780,
    OF_PORT_MOD_PROP_ETHERNET = 781,
    OF_PORT_MOD_PROP_EXPERIMENTER = 782,
    OF_PORT_MOD_PROP_OPTICAL = 783,
    OF_PORT_STATS_ENTRY = 784,
    OF_PORT_STATS_PROP = 785,
    OF_PORT_STATS_PROP_ETHERNET = 786,
    OF_PORT_STATS_PROP_EXPERIMENTER = 787,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 788,
    OF_PORT_STATS_PROP_OPTICAL = 789,
    OF_QUEUE_DESC = 790,
    OF_QUEUE_DESC_PROP = 791,
    OF_QUEUE_DESC_PROP_BSN = 792,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 793,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 794,
    OF_QUEUE_DESC_PROP_MAX_RATE = 795,
    OF_QUEUE_DESC_PROP_MIN_RATE = 796,
    OF_QUEUE_PROP = 797,
    OF_QUEUE_PROP_EXPERIMENTER = 798,
    OF_QUEUE_PROP_MAX_RATE = 799,
    OF_QUEUE_PROP_MIN_RATE = 800,
    OF_QUEUE_STATS_ENTRY = 801,
    OF_QUEUE_STATS_PROP = 802,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 803,
    OF_ROLE_PROP = 804,
    OF_ROLE_PROP_EXPERIMENTER = 805,
    OF_TABLE_DESC = 806,
    OF_TABLE_FEATURE_PROP = 807,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 808,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 809,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 810,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 811,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 812,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 813,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 814,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 815,
    OF_TABLE_FEATURE_PROP_MATCH = 816,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 817,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 818,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 819,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 820,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 821,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 822,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 823,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 824,
    OF_TABLE_FEATURES = 825,
    OF_TABLE_MOD_PROP = 826,
    OF_TABLE_MOD_PROP_EVICTION = 827,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 828,
    OF_TABLE_MOD_PROP_VACANCY = 829,
    OF_TABLE_STATS_ENTRY = 830,
    OF_UINT32 = 831,
    OF_UINT64 = 832,
    OF_UINT8 = 833,
    ...
    /* List objects */
    OF_LIST_ACTION = 834,
    OF_LIST_ACTION_ID = 835,
    OF_LIST_ASYNC_CONFIG_PROP = 836,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 837,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 838,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 839,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 840,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 841,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 842,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 843,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 844,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 845,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 846,
    OF_LIST_BSN_INTERFACE = 847,
    OF_LIST_BSN_LACP_STATS_ENTRY = 848,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 849,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 850,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 851,
    OF_LIST_BSN_TLV = 852,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 853,
    OF_LIST_BSN_VLAN_MAC = 854,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 855,
    OF_LIST_BUCKET = 856,
    OF_LIST_BUCKET_COUNTER = 857,
    OF_LIST_BUNDLE_PROP = 858,
    OF_LIST_FLOW_STATS_ENTRY = 859,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 860,
    OF_LIST_GROUP_STATS_ENTRY = 861,
    OF_LIST_HELLO_ELEM = 862,
    OF_LIST_INSTRUCTION = 863,
    OF_LIST_INSTRUCTION_ID = 864,
    OF_LIST_METER_BAND = 865,
    OF_LIST_METER_BAND_STATS = 866,
    OF_LIST_METER_CONFIG = 867,
    OF_LIST_METER_STATS = 868,
    OF_LIST_OXM = 869,
    OF_LIST_PACKET_QUEUE = 870,
    OF_LIST_PORT_DESC = 871,
    OF_LIST_PORT_DESC_PROP = 872,
    OF_LIST_PORT_MOD_PROP = 873,
    OF_LIST_PORT_STATS_ENTRY = 874,
    OF_LIST_PORT_STATS_PROP = 875,
    OF_LIST_QUEUE_DESC = 876,
    OF_LIST_QUEUE_DESC_PROP = 877,
    OF_LIST_QUEUE_PROP = 878,
    OF_LIST_QUEUE_STATS_ENTRY = 879,
    OF_LIST_QUEUE_STATS_PROP = 880,
    OF_LIST_ROLE_PROP = 881,
    OF_LIST_TABLE_DESC = 882,
    OF_LIST_TABLE_FEATURE_PROP = 883,
    OF_LIST_TABLE_FEATURES = 884,
    OF_LIST_TABLE_MOD_PROP = 885,
    OF_LIST_TABLE_STATS_ENTRY = 886,
    OF_LIST_UINT32 = 887,
    OF_LIST_UINT64 = 888,
    OF_LIST_UINT8 = 889,
