...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_MISS_PACKETS = 410,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 411,
    OF_BSN_TLV_MPLS_LABEL = 412,
    OF_BSN_TLV_MPLS_SEQUENCED = 413,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 414,
    OF_BSN_TLV_MULTICAST_PACKET = 415,
    OF_BSN_TLV_MULTIPLIER = 416,
    OF_BSN_TLV_NAME = 417,
    OF_BSN_TLV_NDP_OFFLOAD = 418,
    OF_BSN_TLV_NDP_STATIC = 419,
    OF_BSN_TLV_NEGATE = 420,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 421,
    OF_BSN_TLV_NEXT_HOP_MAC = 422,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 423,
    OF_BSN_TLV_NO_ARP_RESPONSE = 424,
    OF_BSN_TLV_NO_NS_RESPONSE = 425,
    OF_BSN_TLV_OFFSET = 426,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 427,
    OF_BSN_TLV_OUTER_SRC_MAC = 428,
    OF_BSN_TLV_PARENT_PORT = 429,
    OF_BSN_TLV_PARTNER_KEY = 430,
    OF_BSN_TLV_PARTNER_PORT_NUM = 431,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 432,
    OF_BSN_TLV_PARTNER_STATE = 433,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 434,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 435,
    OF_BSN_TLV_PASSIVE = 436,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 437,
    OF_BSN_TLV_PIM_DR = 438,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 439,
    OF_BSN_TLV_PORT = 440,
    OF_BSN_TLV_PORT_MODE = 441,
    OF_BSN_TLV_PORT_SPEED_GBPS = 442,
    OF_BSN_TLV_PORT_USAGE = 443,
    OF_BSN_TLV_PORT_VXLAN_MODE = 444,
    OF_BSN_TLV_PRESERVE_VLAN = 445,
    OF_BSN_TLV_PRIORITY = 446,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 447,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 448,
    OF_BSN_TLV_QOS_PRIORITY = 449,
    OF_BSN_TLV_QUEUE_ID = 450,
    OF_BSN_TLV_QUEUE_WEIGHT = 451,
    OF_BSN_TLV_RATE_LIMIT = 452,
    OF_BSN_TLV_RATE_UNIT = 453,
    OF_BSN_TLV_RECORD_PACKETS = 454,
    OF_BSN_TLV_REDUNDANT_MGMT = 455,
    OF_BSN_TLV_REDUNDANT_MGMT_RESELECT = 456,
