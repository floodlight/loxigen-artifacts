...
typedef enum of_object_id_e {
    ...
    OF_OXM_BSN_IFP_CLASS_ID = 555,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 556,
    OF_OXM_BSN_IN_PORTS_128 = 557,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 558,
    OF_OXM_BSN_IN_PORTS_512 = 559,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 560,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 561,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 562,
    OF_OXM_BSN_INNER_ETH_DST = 563,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 564,
    OF_OXM_BSN_INNER_ETH_SRC = 565,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 566,
    OF_OXM_BSN_INNER_VLAN_VID = 567,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 568,
    OF_OXM_BSN_IP_FRAGMENTATION = 569,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 570,
    OF_OXM_BSN_L2_CACHE_HIT = 571,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 572,
    OF_OXM_BSN_L3_DST_CLASS_ID = 573,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 574,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 575,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 576,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 577,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 578,
    OF_OXM_BSN_LAG_ID = 579,
    OF_OXM_BSN_LAG_ID_MASKED = 580,
    OF_OXM_BSN_TCP_FLAGS = 581,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 582,
    OF_OXM_BSN_UDF0 = 583,
    OF_OXM_BSN_UDF0_MASKED = 584,
    OF_OXM_BSN_UDF1 = 585,
    OF_OXM_BSN_UDF1_MASKED = 586,
    OF_OXM_BSN_UDF2 = 587,
    OF_OXM_BSN_UDF2_MASKED = 588,
    OF_OXM_BSN_UDF3 = 589,
    OF_OXM_BSN_UDF3_MASKED = 590,
    OF_OXM_BSN_UDF4 = 591,
    OF_OXM_BSN_UDF4_MASKED = 592,
    OF_OXM_BSN_UDF5 = 593,
    OF_OXM_BSN_UDF5_MASKED = 594,
    OF_OXM_BSN_UDF6 = 595,
    OF_OXM_BSN_UDF6_MASKED = 596,
    OF_OXM_BSN_UDF7 = 597,
    OF_OXM_BSN_UDF7_MASKED = 598,
    OF_OXM_BSN_VFI = 599,
    OF_OXM_BSN_VFI_MASKED = 600,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 601,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 602,
    OF_OXM_BSN_VRF = 603,
    OF_OXM_BSN_VRF_MASKED = 604,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 605,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 606,
    OF_OXM_ETH_DST = 607,
    OF_OXM_ETH_DST_MASKED = 608,
    OF_OXM_ETH_SRC = 609,
    OF_OXM_ETH_SRC_MASKED = 610,
    OF_OXM_ETH_TYPE = 611,
    OF_OXM_ETH_TYPE_MASKED = 612,
    OF_OXM_ICMPV4_CODE = 613,
    OF_OXM_ICMPV4_CODE_MASKED = 614,
    OF_OXM_ICMPV4_TYPE = 615,
    OF_OXM_ICMPV4_TYPE_MASKED = 616,
    OF_OXM_ICMPV6_CODE = 617,
    OF_OXM_ICMPV6_CODE_MASKED = 618,
    OF_OXM_ICMPV6_TYPE = 619,
    OF_OXM_ICMPV6_TYPE_MASKED = 620,
    OF_OXM_IN_PHY_PORT = 621,
    OF_OXM_IN_PHY_PORT_MASKED = 622,
    OF_OXM_IN_PORT = 623,
    OF_OXM_IN_PORT_MASKED = 624,
    OF_OXM_IP_DSCP = 625,
    OF_OXM_IP_DSCP_MASKED = 626,
    OF_OXM_IP_ECN = 627,
    OF_OXM_IP_ECN_MASKED = 628,
    OF_OXM_IP_PROTO = 629,
    OF_OXM_IP_PROTO_MASKED = 630,
    OF_OXM_IPV4_DST = 631,
    OF_OXM_IPV4_DST_MASKED = 632,
    OF_OXM_IPV4_SRC = 633,
    OF_OXM_IPV4_SRC_MASKED = 634,
    OF_OXM_IPV6_DST = 635,
    OF_OXM_IPV6_DST_MASKED = 636,
    OF_OXM_IPV6_EXTHDR = 637,
    OF_OXM_IPV6_EXTHDR_MASKED = 638,
    OF_OXM_IPV6_FLABEL = 639,
    OF_OXM_IPV6_FLABEL_MASKED = 640,
    OF_OXM_IPV6_ND_SLL = 641,
    OF_OXM_IPV6_ND_SLL_MASKED = 642,
    OF_OXM_IPV6_ND_TARGET = 643,
    OF_OXM_IPV6_ND_TARGET_MASKED = 644,
    OF_OXM_IPV6_ND_TLL = 645,
    OF_OXM_IPV6_ND_TLL_MASKED = 646,
    OF_OXM_IPV6_SRC = 647,
    OF_OXM_IPV6_SRC_MASKED = 648,
    OF_OXM_METADATA = 649,
    OF_OXM_METADATA_MASKED = 650,
    OF_OXM_MPLS_BOS = 651,
    OF_OXM_MPLS_BOS_MASKED = 652,
    OF_OXM_MPLS_LABEL = 653,
    OF_OXM_MPLS_LABEL_MASKED = 654,
    OF_OXM_MPLS_TC = 655,
    OF_OXM_MPLS_TC_MASKED = 656,
    OF_OXM_OVS_TCP_FLAGS = 657,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 658,
    OF_OXM_PBB_UCA = 659,
    OF_OXM_PBB_UCA_MASKED = 660,
    OF_OXM_SCTP_DST = 661,
    OF_OXM_SCTP_DST_MASKED = 662,
    OF_OXM_SCTP_SRC = 663,
    OF_OXM_SCTP_SRC_MASKED = 664,
    OF_OXM_TCP_DST = 665,
    OF_OXM_TCP_DST_MASKED = 666,
    OF_OXM_TCP_SRC = 667,
    OF_OXM_TCP_SRC_MASKED = 668,
    OF_OXM_TUNNEL_ID = 669,
    OF_OXM_TUNNEL_ID_MASKED = 670,
    OF_OXM_TUNNEL_IPV4_DST = 671,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 672,
    OF_OXM_TUNNEL_IPV4_SRC = 673,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 674,
    OF_OXM_UDP_DST = 675,
    OF_OXM_UDP_DST_MASKED = 676,
    OF_OXM_UDP_SRC = 677,
    OF_OXM_UDP_SRC_MASKED = 678,
    OF_OXM_VLAN_PCP = 679,
    OF_OXM_VLAN_PCP_MASKED = 680,
    OF_OXM_VLAN_VID = 681,
    OF_OXM_VLAN_VID_MASKED = 682,
    OF_PACKET_QUEUE = 683,
    OF_PORT_DESC = 684,
    OF_PORT_DESC_PROP = 685,
    OF_PORT_DESC_PROP_BSN = 686,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 687,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 688,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 689,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 690,
