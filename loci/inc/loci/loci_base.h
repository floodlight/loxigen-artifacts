...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_QOS_PRIORITY = 385,
    OF_BSN_TLV_QUEUE_ID = 386,
    OF_BSN_TLV_QUEUE_WEIGHT = 387,
    OF_BSN_TLV_RATE_LIMIT = 388,
    OF_BSN_TLV_RATE_UNIT = 389,
    OF_BSN_TLV_REFERENCE = 390,
    OF_BSN_TLV_REPLY_PACKETS = 391,
    OF_BSN_TLV_REQUEST_PACKETS = 392,
    OF_BSN_TLV_RX_BYTES = 393,
    OF_BSN_TLV_RX_PACKETS = 394,
    OF_BSN_TLV_SAMPLING_RATE = 395,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 396,
    OF_BSN_TLV_STATUS = 397,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 398,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 399,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 400,
    OF_BSN_TLV_SUB_AGENT_ID = 401,
    OF_BSN_TLV_TCP_DST = 402,
    OF_BSN_TLV_TCP_SRC = 403,
    OF_BSN_TLV_TTL = 404,
    OF_BSN_TLV_TX_BYTES = 405,
    OF_BSN_TLV_TX_PACKETS = 406,
    OF_BSN_TLV_UDF_ANCHOR = 407,
    OF_BSN_TLV_UDF_ID = 408,
    OF_BSN_TLV_UDF_LENGTH = 409,
    OF_BSN_TLV_UDF_OFFSET = 410,
    OF_BSN_TLV_UDP_DST = 411,
    OF_BSN_TLV_UDP_SRC = 412,
    OF_BSN_TLV_UINT64_LIST = 413,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 414,
    OF_BSN_TLV_UNICAST_RATE = 415,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 416,
    OF_BSN_TLV_UNTAGGED = 417,
    OF_BSN_TLV_USE_PACKET_STATE = 418,
    OF_BSN_TLV_VFI = 419,
    OF_BSN_TLV_VFP_CLASS_ID = 420,
    OF_BSN_TLV_VLAN_MAC_LIST = 421,
    OF_BSN_TLV_VLAN_PCP = 422,
    OF_BSN_TLV_VLAN_VID = 423,
    OF_BSN_TLV_VLAN_VID_MASK = 424,
    OF_BSN_TLV_VNI = 425,
    OF_BSN_TLV_VPN_KEY = 426,
    OF_BSN_TLV_VRF = 427,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 428,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 429,
    OF_BSN_VLAN_MAC = 430,
    OF_BSN_VPORT = 431,
    OF_BSN_VPORT_L2GRE = 432,
    OF_BSN_VPORT_Q_IN_Q = 433,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 434,
    OF_BUCKET = 435,
    OF_BUCKET_COUNTER = 436,
    OF_BUNDLE_PROP = 437,
    OF_BUNDLE_PROP_EXPERIMENTER = 438,
    OF_FLOW_STATS_ENTRY = 439,
    OF_GROUP_DESC_STATS_ENTRY = 440,
    OF_GROUP_STATS_ENTRY = 441,
    OF_HELLO_ELEM = 442,
    OF_HELLO_ELEM_VERSIONBITMAP = 443,
    OF_INSTRUCTION = 444,
    OF_INSTRUCTION_APPLY_ACTIONS = 445,
    OF_INSTRUCTION_BSN = 446,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 447,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 448,
    OF_INSTRUCTION_BSN_DENY = 449,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 450,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 451,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 452,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 453,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 454,
    OF_INSTRUCTION_BSN_HASH_SELECT = 455,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 456,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 457,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 458,
    OF_INSTRUCTION_BSN_PERMIT = 459,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 460,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 461,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 462,
    OF_INSTRUCTION_CLEAR_ACTIONS = 463,
    OF_INSTRUCTION_EXPERIMENTER = 464,
    OF_INSTRUCTION_GOTO_TABLE = 465,
    OF_INSTRUCTION_ID = 466,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 467,
    OF_INSTRUCTION_ID_BSN = 468,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 469,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 470,
    OF_INSTRUCTION_ID_BSN_DENY = 471,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 472,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 473,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 474,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 475,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 476,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 477,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 478,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 479,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 480,
    OF_INSTRUCTION_ID_BSN_PERMIT = 481,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 482,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 483,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 484,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 485,
    OF_INSTRUCTION_ID_EXPERIMENTER = 486,
    OF_INSTRUCTION_ID_GOTO_TABLE = 487,
    OF_INSTRUCTION_ID_METER = 488,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 489,
    OF_INSTRUCTION_ID_WRITE_METADATA = 490,
    OF_INSTRUCTION_METER = 491,
    OF_INSTRUCTION_WRITE_ACTIONS = 492,
    OF_INSTRUCTION_WRITE_METADATA = 493,
    OF_MATCH_V1 = 494,
    OF_MATCH_V2 = 495,
    OF_MATCH_V3 = 496,
    OF_METER_BAND = 497,
    OF_METER_BAND_DROP = 498,
    OF_METER_BAND_DSCP_REMARK = 499,
    OF_METER_BAND_EXPERIMENTER = 500,
    OF_METER_BAND_STATS = 501,
    OF_METER_CONFIG = 502,
    OF_METER_FEATURES = 503,
    OF_METER_STATS = 504,
    OF_OXM = 505,
    OF_OXM_ARP_OP = 506,
    OF_OXM_ARP_OP_MASKED = 507,
    OF_OXM_ARP_SHA = 508,
    OF_OXM_ARP_SHA_MASKED = 509,
    OF_OXM_ARP_SPA = 510,
    OF_OXM_ARP_SPA_MASKED = 511,
    OF_OXM_ARP_THA = 512,
    OF_OXM_ARP_THA_MASKED = 513,
    OF_OXM_ARP_TPA = 514,
    OF_OXM_ARP_TPA_MASKED = 515,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 516,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 517,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 518,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 519,
    OF_OXM_BSN_IN_PORTS_128 = 520,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 521,
    OF_OXM_BSN_IN_PORTS_512 = 522,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 523,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 524,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 525,
    OF_OXM_BSN_INNER_ETH_DST = 526,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 527,
    OF_OXM_BSN_INNER_ETH_SRC = 528,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 529,
    OF_OXM_BSN_INNER_VLAN_VID = 530,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 531,
    OF_OXM_BSN_L2_CACHE_HIT = 532,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 533,
    OF_OXM_BSN_L3_DST_CLASS_ID = 534,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 535,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 536,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 537,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 538,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 539,
    OF_OXM_BSN_LAG_ID = 540,
    OF_OXM_BSN_LAG_ID_MASKED = 541,
    OF_OXM_BSN_TCP_FLAGS = 542,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 543,
    OF_OXM_BSN_UDF0 = 544,
    OF_OXM_BSN_UDF0_MASKED = 545,
    OF_OXM_BSN_UDF1 = 546,
    OF_OXM_BSN_UDF1_MASKED = 547,
    OF_OXM_BSN_UDF2 = 548,
    OF_OXM_BSN_UDF2_MASKED = 549,
    OF_OXM_BSN_UDF3 = 550,
    OF_OXM_BSN_UDF3_MASKED = 551,
    OF_OXM_BSN_UDF4 = 552,
    OF_OXM_BSN_UDF4_MASKED = 553,
    OF_OXM_BSN_UDF5 = 554,
    OF_OXM_BSN_UDF5_MASKED = 555,
    OF_OXM_BSN_UDF6 = 556,
    OF_OXM_BSN_UDF6_MASKED = 557,
    OF_OXM_BSN_UDF7 = 558,
    OF_OXM_BSN_UDF7_MASKED = 559,
    OF_OXM_BSN_VFI = 560,
    OF_OXM_BSN_VFI_MASKED = 561,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 562,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 563,
    OF_OXM_BSN_VRF = 564,
    OF_OXM_BSN_VRF_MASKED = 565,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 566,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 567,
    OF_OXM_ETH_DST = 568,
    OF_OXM_ETH_DST_MASKED = 569,
    OF_OXM_ETH_SRC = 570,
    OF_OXM_ETH_SRC_MASKED = 571,
    OF_OXM_ETH_TYPE = 572,
    OF_OXM_ETH_TYPE_MASKED = 573,
    OF_OXM_ICMPV4_CODE = 574,
    OF_OXM_ICMPV4_CODE_MASKED = 575,
    OF_OXM_ICMPV4_TYPE = 576,
    OF_OXM_ICMPV4_TYPE_MASKED = 577,
    OF_OXM_ICMPV6_CODE = 578,
    OF_OXM_ICMPV6_CODE_MASKED = 579,
    OF_OXM_ICMPV6_TYPE = 580,
    OF_OXM_ICMPV6_TYPE_MASKED = 581,
    OF_OXM_IN_PHY_PORT = 582,
    OF_OXM_IN_PHY_PORT_MASKED = 583,
    OF_OXM_IN_PORT = 584,
    OF_OXM_IN_PORT_MASKED = 585,
    OF_OXM_IP_DSCP = 586,
    OF_OXM_IP_DSCP_MASKED = 587,
    OF_OXM_IP_ECN = 588,
    OF_OXM_IP_ECN_MASKED = 589,
    OF_OXM_IP_PROTO = 590,
    OF_OXM_IP_PROTO_MASKED = 591,
    OF_OXM_IPV4_DST = 592,
    OF_OXM_IPV4_DST_MASKED = 593,
    OF_OXM_IPV4_SRC = 594,
    OF_OXM_IPV4_SRC_MASKED = 595,
    OF_OXM_IPV6_DST = 596,
    OF_OXM_IPV6_DST_MASKED = 597,
    OF_OXM_IPV6_EXTHDR = 598,
    OF_OXM_IPV6_EXTHDR_MASKED = 599,
    OF_OXM_IPV6_FLABEL = 600,
    OF_OXM_IPV6_FLABEL_MASKED = 601,
    OF_OXM_IPV6_ND_SLL = 602,
    OF_OXM_IPV6_ND_SLL_MASKED = 603,
    OF_OXM_IPV6_ND_TARGET = 604,
    OF_OXM_IPV6_ND_TARGET_MASKED = 605,
    OF_OXM_IPV6_ND_TLL = 606,
    OF_OXM_IPV6_ND_TLL_MASKED = 607,
    OF_OXM_IPV6_SRC = 608,
    OF_OXM_IPV6_SRC_MASKED = 609,
    OF_OXM_METADATA = 610,
    OF_OXM_METADATA_MASKED = 611,
    OF_OXM_MPLS_BOS = 612,
    OF_OXM_MPLS_BOS_MASKED = 613,
    OF_OXM_MPLS_LABEL = 614,
    OF_OXM_MPLS_LABEL_MASKED = 615,
    OF_OXM_MPLS_TC = 616,
    OF_OXM_MPLS_TC_MASKED = 617,
    OF_OXM_PBB_UCA = 618,
    OF_OXM_PBB_UCA_MASKED = 619,
    OF_OXM_SCTP_DST = 620,
    OF_OXM_SCTP_DST_MASKED = 621,
    OF_OXM_SCTP_SRC = 622,
    OF_OXM_SCTP_SRC_MASKED = 623,
    OF_OXM_TCP_DST = 624,
    OF_OXM_TCP_DST_MASKED = 625,
    OF_OXM_TCP_SRC = 626,
    OF_OXM_TCP_SRC_MASKED = 627,
    OF_OXM_TUNNEL_ID = 628,
    OF_OXM_TUNNEL_ID_MASKED = 629,
    OF_OXM_TUNNEL_IPV4_DST = 630,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 631,
    OF_OXM_TUNNEL_IPV4_SRC = 632,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 633,
    OF_OXM_UDP_DST = 634,
    OF_OXM_UDP_DST_MASKED = 635,
    OF_OXM_UDP_SRC = 636,
    OF_OXM_UDP_SRC_MASKED = 637,
    OF_OXM_VLAN_PCP = 638,
    OF_OXM_VLAN_PCP_MASKED = 639,
    OF_OXM_VLAN_VID = 640,
    OF_OXM_VLAN_VID_MASKED = 641,
    OF_PACKET_QUEUE = 642,
    OF_PORT_DESC = 643,
    OF_PORT_DESC_PROP = 644,
    OF_PORT_DESC_PROP_BSN = 645,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 646,
    OF_PORT_DESC_PROP_BSN_UPLINK = 647,
    OF_PORT_DESC_PROP_ETHERNET = 648,
    OF_PORT_DESC_PROP_EXPERIMENTER = 649,
    OF_PORT_DESC_PROP_OPTICAL = 650,
    OF_PORT_MOD_PROP = 651,
    OF_PORT_MOD_PROP_ETHERNET = 652,
    OF_PORT_MOD_PROP_EXPERIMENTER = 653,
    OF_PORT_MOD_PROP_OPTICAL = 654,
    OF_PORT_STATS_ENTRY = 655,
    OF_PORT_STATS_PROP = 656,
    OF_PORT_STATS_PROP_ETHERNET = 657,
    OF_PORT_STATS_PROP_EXPERIMENTER = 658,
    OF_PORT_STATS_PROP_OPTICAL = 659,
    OF_QUEUE_DESC = 660,
    OF_QUEUE_DESC_PROP = 661,
    OF_QUEUE_DESC_PROP_BSN = 662,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 663,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 664,
    OF_QUEUE_DESC_PROP_MAX_RATE = 665,
    OF_QUEUE_DESC_PROP_MIN_RATE = 666,
    OF_QUEUE_PROP = 667,
    OF_QUEUE_PROP_EXPERIMENTER = 668,
    OF_QUEUE_PROP_MAX_RATE = 669,
    OF_QUEUE_PROP_MIN_RATE = 670,
    OF_QUEUE_STATS_ENTRY = 671,
    OF_QUEUE_STATS_PROP = 672,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 673,
    OF_ROLE_PROP = 674,
    OF_ROLE_PROP_EXPERIMENTER = 675,
    OF_TABLE_DESC = 676,
    OF_TABLE_FEATURE_PROP = 677,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 678,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 679,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 680,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 681,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 682,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 683,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 684,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 685,
    OF_TABLE_FEATURE_PROP_MATCH = 686,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 687,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 688,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 689,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 690,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 691,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 692,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 693,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 694,
    OF_TABLE_FEATURES = 695,
    OF_TABLE_MOD_PROP = 696,
    OF_TABLE_MOD_PROP_EVICTION = 697,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 698,
    OF_TABLE_MOD_PROP_VACANCY = 699,
    OF_TABLE_STATS_ENTRY = 700,
    OF_UINT32 = 701,
    OF_UINT64 = 702,
    OF_UINT8 = 703,
    ...
    /* List objects */
    OF_LIST_ACTION = 704,
    OF_LIST_ACTION_ID = 705,
    OF_LIST_ASYNC_CONFIG_PROP = 706,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 707,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 708,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 709,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 710,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 711,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 712,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 713,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 714,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 715,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 716,
    OF_LIST_BSN_INTERFACE = 717,
    OF_LIST_BSN_LACP_STATS_ENTRY = 718,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 719,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 720,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 721,
    OF_LIST_BSN_TLV = 722,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 723,
    OF_LIST_BSN_VLAN_MAC = 724,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 725,
    OF_LIST_BUCKET = 726,
    OF_LIST_BUCKET_COUNTER = 727,
    OF_LIST_BUNDLE_PROP = 728,
    OF_LIST_FLOW_STATS_ENTRY = 729,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 730,
    OF_LIST_GROUP_STATS_ENTRY = 731,
    OF_LIST_HELLO_ELEM = 732,
    OF_LIST_INSTRUCTION = 733,
    OF_LIST_INSTRUCTION_ID = 734,
    OF_LIST_METER_BAND = 735,
    OF_LIST_METER_BAND_STATS = 736,
    OF_LIST_METER_CONFIG = 737,
    OF_LIST_METER_STATS = 738,
    OF_LIST_OXM = 739,
    OF_LIST_PACKET_QUEUE = 740,
    OF_LIST_PORT_DESC = 741,
    OF_LIST_PORT_DESC_PROP = 742,
    OF_LIST_PORT_MOD_PROP = 743,
    OF_LIST_PORT_STATS_ENTRY = 744,
    OF_LIST_PORT_STATS_PROP = 745,
    OF_LIST_QUEUE_DESC = 746,
    OF_LIST_QUEUE_DESC_PROP = 747,
    OF_LIST_QUEUE_PROP = 748,
    OF_LIST_QUEUE_STATS_ENTRY = 749,
    OF_LIST_QUEUE_STATS_PROP = 750,
    OF_LIST_ROLE_PROP = 751,
    OF_LIST_TABLE_DESC = 752,
    OF_LIST_TABLE_FEATURE_PROP = 753,
    OF_LIST_TABLE_FEATURES = 754,
    OF_LIST_TABLE_MOD_PROP = 755,
    OF_LIST_TABLE_STATS_ENTRY = 756,
    OF_LIST_UINT32 = 757,
    OF_LIST_UINT64 = 758,
    OF_LIST_UINT8 = 759,
