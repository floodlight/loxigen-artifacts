...
typedef enum of_object_id_e {
    ...
    OF_BSN_VPORT_Q_IN_Q = 277,
    OF_BUCKET = 278,
    OF_BUCKET_COUNTER = 279,
    OF_FLOW_STATS_ENTRY = 280,
    OF_GROUP_DESC_STATS_ENTRY = 281,
    OF_GROUP_STATS_ENTRY = 282,
    OF_HEADER = 283,
    OF_HELLO_ELEM = 284,
    OF_HELLO_ELEM_HEADER = 285,
    OF_HELLO_ELEM_VERSIONBITMAP = 286,
    OF_INSTRUCTION = 287,
    OF_INSTRUCTION_APPLY_ACTIONS = 288,
    OF_INSTRUCTION_BSN = 289,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 290,
    OF_INSTRUCTION_BSN_DENY = 291,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 292,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 293,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 294,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 295,
    OF_INSTRUCTION_BSN_PERMIT = 296,
    OF_INSTRUCTION_CLEAR_ACTIONS = 297,
    OF_INSTRUCTION_EXPERIMENTER = 298,
    OF_INSTRUCTION_GOTO_TABLE = 299,
    OF_INSTRUCTION_HEADER = 300,
    OF_INSTRUCTION_ID = 301,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 302,
    OF_INSTRUCTION_ID_BSN = 303,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 304,
    OF_INSTRUCTION_ID_BSN_DENY = 305,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 306,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 307,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 308,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 309,
    OF_INSTRUCTION_ID_BSN_PERMIT = 310,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 311,
    OF_INSTRUCTION_ID_EXPERIMENTER = 312,
    OF_INSTRUCTION_ID_GOTO_TABLE = 313,
    OF_INSTRUCTION_ID_HEADER = 314,
    OF_INSTRUCTION_ID_METER = 315,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 316,
    OF_INSTRUCTION_ID_WRITE_METADATA = 317,
    OF_INSTRUCTION_METER = 318,
    OF_INSTRUCTION_WRITE_ACTIONS = 319,
    OF_INSTRUCTION_WRITE_METADATA = 320,
    OF_MATCH_V1 = 321,
    OF_MATCH_V2 = 322,
    OF_MATCH_V3 = 323,
    OF_METER_BAND = 324,
    OF_METER_BAND_DROP = 325,
    OF_METER_BAND_DSCP_REMARK = 326,
    OF_METER_BAND_EXPERIMENTER = 327,
    OF_METER_BAND_HEADER = 328,
    OF_METER_BAND_STATS = 329,
    OF_METER_CONFIG = 330,
    OF_METER_FEATURES = 331,
    OF_METER_STATS = 332,
    OF_OXM = 333,
    OF_OXM_ARP_OP = 334,
    OF_OXM_ARP_OP_MASKED = 335,
    OF_OXM_ARP_SHA = 336,
    OF_OXM_ARP_SHA_MASKED = 337,
    OF_OXM_ARP_SPA = 338,
    OF_OXM_ARP_SPA_MASKED = 339,
    OF_OXM_ARP_THA = 340,
    OF_OXM_ARP_THA_MASKED = 341,
    OF_OXM_ARP_TPA = 342,
    OF_OXM_ARP_TPA_MASKED = 343,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 344,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 345,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 346,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 347,
    OF_OXM_BSN_IN_PORTS_128 = 348,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 349,
    OF_OXM_BSN_L3_DST_CLASS_ID = 350,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 351,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 352,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 353,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 354,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 355,
    OF_OXM_BSN_LAG_ID = 356,
    OF_OXM_BSN_LAG_ID_MASKED = 357,
    OF_OXM_BSN_UDF0 = 358,
    OF_OXM_BSN_UDF0_MASKED = 359,
    OF_OXM_BSN_UDF1 = 360,
    OF_OXM_BSN_UDF1_MASKED = 361,
    OF_OXM_BSN_UDF2 = 362,
    OF_OXM_BSN_UDF2_MASKED = 363,
    OF_OXM_BSN_UDF3 = 364,
    OF_OXM_BSN_UDF3_MASKED = 365,
    OF_OXM_BSN_UDF4 = 366,
    OF_OXM_BSN_UDF4_MASKED = 367,
    OF_OXM_BSN_UDF5 = 368,
    OF_OXM_BSN_UDF5_MASKED = 369,
    OF_OXM_BSN_UDF6 = 370,
    OF_OXM_BSN_UDF6_MASKED = 371,
    OF_OXM_BSN_UDF7 = 372,
    OF_OXM_BSN_UDF7_MASKED = 373,
    OF_OXM_BSN_VRF = 374,
    OF_OXM_BSN_VRF_MASKED = 375,
    OF_OXM_ETH_DST = 376,
    OF_OXM_ETH_DST_MASKED = 377,
    OF_OXM_ETH_SRC = 378,
    OF_OXM_ETH_SRC_MASKED = 379,
    OF_OXM_ETH_TYPE = 380,
    OF_OXM_ETH_TYPE_MASKED = 381,
    OF_OXM_HEADER = 382,
    OF_OXM_ICMPV4_CODE = 383,
    OF_OXM_ICMPV4_CODE_MASKED = 384,
    OF_OXM_ICMPV4_TYPE = 385,
    OF_OXM_ICMPV4_TYPE_MASKED = 386,
    OF_OXM_ICMPV6_CODE = 387,
    OF_OXM_ICMPV6_CODE_MASKED = 388,
    OF_OXM_ICMPV6_TYPE = 389,
    OF_OXM_ICMPV6_TYPE_MASKED = 390,
    OF_OXM_IN_PHY_PORT = 391,
    OF_OXM_IN_PHY_PORT_MASKED = 392,
    OF_OXM_IN_PORT = 393,
    OF_OXM_IN_PORT_MASKED = 394,
    OF_OXM_IP_DSCP = 395,
    OF_OXM_IP_DSCP_MASKED = 396,
    OF_OXM_IP_ECN = 397,
    OF_OXM_IP_ECN_MASKED = 398,
    OF_OXM_IP_PROTO = 399,
    OF_OXM_IP_PROTO_MASKED = 400,
    OF_OXM_IPV4_DST = 401,
    OF_OXM_IPV4_DST_MASKED = 402,
    OF_OXM_IPV4_SRC = 403,
    OF_OXM_IPV4_SRC_MASKED = 404,
    OF_OXM_IPV6_DST = 405,
    OF_OXM_IPV6_DST_MASKED = 406,
    OF_OXM_IPV6_FLABEL = 407,
    OF_OXM_IPV6_FLABEL_MASKED = 408,
    OF_OXM_IPV6_ND_SLL = 409,
    OF_OXM_IPV6_ND_SLL_MASKED = 410,
    OF_OXM_IPV6_ND_TARGET = 411,
    OF_OXM_IPV6_ND_TARGET_MASKED = 412,
    OF_OXM_IPV6_ND_TLL = 413,
    OF_OXM_IPV6_ND_TLL_MASKED = 414,
    OF_OXM_IPV6_SRC = 415,
    OF_OXM_IPV6_SRC_MASKED = 416,
    OF_OXM_METADATA = 417,
    OF_OXM_METADATA_MASKED = 418,
    OF_OXM_MPLS_LABEL = 419,
    OF_OXM_MPLS_LABEL_MASKED = 420,
    OF_OXM_MPLS_TC = 421,
    OF_OXM_MPLS_TC_MASKED = 422,
    OF_OXM_SCTP_DST = 423,
    OF_OXM_SCTP_DST_MASKED = 424,
    OF_OXM_SCTP_SRC = 425,
    OF_OXM_SCTP_SRC_MASKED = 426,
    OF_OXM_TCP_DST = 427,
    OF_OXM_TCP_DST_MASKED = 428,
    OF_OXM_TCP_SRC = 429,
    OF_OXM_TCP_SRC_MASKED = 430,
    OF_OXM_UDP_DST = 431,
    OF_OXM_UDP_DST_MASKED = 432,
    OF_OXM_UDP_SRC = 433,
    OF_OXM_UDP_SRC_MASKED = 434,
    OF_OXM_VLAN_PCP = 435,
    OF_OXM_VLAN_PCP_MASKED = 436,
    OF_OXM_VLAN_VID = 437,
    OF_OXM_VLAN_VID_MASKED = 438,
    OF_PACKET_QUEUE = 439,
    OF_PORT_DESC = 440,
    OF_PORT_STATS_ENTRY = 441,
    OF_QUEUE_PROP = 442,
    OF_QUEUE_PROP_EXPERIMENTER = 443,
    OF_QUEUE_PROP_HEADER = 444,
    OF_QUEUE_PROP_MAX_RATE = 445,
    OF_QUEUE_PROP_MIN_RATE = 446,
    OF_QUEUE_STATS_ENTRY = 447,
    OF_TABLE_FEATURE_PROP = 448,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 449,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 450,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 451,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 452,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 453,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 454,
    OF_TABLE_FEATURE_PROP_HEADER = 455,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 456,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 457,
    OF_TABLE_FEATURE_PROP_MATCH = 458,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 459,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 460,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 461,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 462,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 463,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 464,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 465,
    OF_TABLE_FEATURES = 466,
    OF_TABLE_STATS_ENTRY = 467,
    OF_UINT32 = 468,
    OF_UINT64 = 469,
    OF_UINT8 = 470,
    ...
    /* List objects */
    OF_LIST_ACTION = 471,
    OF_LIST_ACTION_ID = 472,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 473,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 474,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 475,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 476,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 477,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 478,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 479,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 480,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 481,
    OF_LIST_BSN_INTERFACE = 482,
    OF_LIST_BSN_LACP_STATS_ENTRY = 483,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 484,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 485,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 486,
    OF_LIST_BSN_TLV = 487,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 488,
    OF_LIST_BUCKET = 489,
    OF_LIST_BUCKET_COUNTER = 490,
    OF_LIST_FLOW_STATS_ENTRY = 491,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 492,
    OF_LIST_GROUP_STATS_ENTRY = 493,
    OF_LIST_HELLO_ELEM = 494,
    OF_LIST_INSTRUCTION = 495,
    OF_LIST_INSTRUCTION_ID = 496,
    OF_LIST_METER_BAND = 497,
    OF_LIST_METER_BAND_STATS = 498,
    OF_LIST_METER_STATS = 499,
    OF_LIST_OXM = 500,
    OF_LIST_PACKET_QUEUE = 501,
    OF_LIST_PORT_DESC = 502,
    OF_LIST_PORT_STATS_ENTRY = 503,
    OF_LIST_QUEUE_PROP = 504,
    OF_LIST_QUEUE_STATS_ENTRY = 505,
    OF_LIST_TABLE_FEATURE_PROP = 506,
    OF_LIST_TABLE_FEATURES = 507,
    OF_LIST_TABLE_STATS_ENTRY = 508,
    OF_LIST_UINT32 = 509,
    OF_LIST_UINT64 = 510,
    OF_LIST_UINT8 = 511,
