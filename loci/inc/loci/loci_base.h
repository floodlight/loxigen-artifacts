...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_IPV6 = 352,
    OF_BSN_TLV_IPV6_DST = 353,
    OF_BSN_TLV_IPV6_PREFIX = 354,
    OF_BSN_TLV_IPV6_SRC = 355,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 356,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 357,
    OF_BSN_TLV_LOOPBACK_PORT = 358,
    OF_BSN_TLV_MAC = 359,
    OF_BSN_TLV_MAC_MASK = 360,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 361,
    OF_BSN_TLV_MISS_PACKETS = 362,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 363,
    OF_BSN_TLV_MPLS_LABEL = 364,
    OF_BSN_TLV_MPLS_SEQUENCED = 365,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 366,
    OF_BSN_TLV_NAME = 367,
    OF_BSN_TLV_NDP_OFFLOAD = 368,
    OF_BSN_TLV_NDP_STATIC = 369,
    OF_BSN_TLV_NEGATE = 370,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 371,
    OF_BSN_TLV_NEXT_HOP_MAC = 372,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 373,
    OF_BSN_TLV_OFFSET = 374,
    OF_BSN_TLV_PARENT_PORT = 375,
    OF_BSN_TLV_PARTNER_KEY = 376,
    OF_BSN_TLV_PARTNER_PORT_NUM = 377,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 378,
    OF_BSN_TLV_PARTNER_STATE = 379,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 380,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 381,
    OF_BSN_TLV_PORT = 382,
    OF_BSN_TLV_PORT_VXLAN_MODE = 383,
    OF_BSN_TLV_PRIORITY = 384,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 385,
    OF_BSN_TLV_QOS_PRIORITY = 386,
    OF_BSN_TLV_QUEUE_ID = 387,
    OF_BSN_TLV_QUEUE_WEIGHT = 388,
    OF_BSN_TLV_RATE_LIMIT = 389,
    OF_BSN_TLV_RATE_UNIT = 390,
    OF_BSN_TLV_REFERENCE = 391,
    OF_BSN_TLV_REPLY_PACKETS = 392,
    OF_BSN_TLV_REQUEST_PACKETS = 393,
    OF_BSN_TLV_RX_BYTES = 394,
    OF_BSN_TLV_RX_PACKETS = 395,
    OF_BSN_TLV_SAMPLING_RATE = 396,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 397,
    OF_BSN_TLV_STATUS = 398,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 399,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 400,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 401,
    OF_BSN_TLV_SUB_AGENT_ID = 402,
    OF_BSN_TLV_TCP_DST = 403,
    OF_BSN_TLV_TCP_SRC = 404,
    OF_BSN_TLV_TTL = 405,
    OF_BSN_TLV_TX_BYTES = 406,
    OF_BSN_TLV_TX_PACKETS = 407,
    OF_BSN_TLV_UDF_ANCHOR = 408,
    OF_BSN_TLV_UDF_ID = 409,
    OF_BSN_TLV_UDF_LENGTH = 410,
    OF_BSN_TLV_UDF_OFFSET = 411,
    OF_BSN_TLV_UDP_DST = 412,
    OF_BSN_TLV_UDP_SRC = 413,
    OF_BSN_TLV_UINT64_LIST = 414,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 415,
    OF_BSN_TLV_UNICAST_RATE = 416,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 417,
    OF_BSN_TLV_UNTAGGED = 418,
    OF_BSN_TLV_USE_PACKET_STATE = 419,
    OF_BSN_TLV_VFI = 420,
    OF_BSN_TLV_VFP_CLASS_ID = 421,
    OF_BSN_TLV_VLAN_MAC_LIST = 422,
    OF_BSN_TLV_VLAN_PCP = 423,
    OF_BSN_TLV_VLAN_VID = 424,
    OF_BSN_TLV_VLAN_VID_MASK = 425,
    OF_BSN_TLV_VNI = 426,
    OF_BSN_TLV_VPN_KEY = 427,
    OF_BSN_TLV_VRF = 428,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 429,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 430,
    OF_BSN_VLAN_MAC = 431,
    OF_BSN_VPORT = 432,
    OF_BSN_VPORT_L2GRE = 433,
    OF_BSN_VPORT_Q_IN_Q = 434,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 435,
    OF_BUCKET = 436,
    OF_BUCKET_COUNTER = 437,
    OF_BUNDLE_PROP = 438,
    OF_BUNDLE_PROP_EXPERIMENTER = 439,
    OF_FLOW_STATS_ENTRY = 440,
    OF_GROUP_DESC_STATS_ENTRY = 441,
    OF_GROUP_STATS_ENTRY = 442,
    OF_HELLO_ELEM = 443,
    OF_HELLO_ELEM_VERSIONBITMAP = 444,
    OF_INSTRUCTION = 445,
    OF_INSTRUCTION_APPLY_ACTIONS = 446,
    OF_INSTRUCTION_BSN = 447,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 448,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 449,
    OF_INSTRUCTION_BSN_DENY = 450,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 451,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 452,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 453,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 454,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 455,
    OF_INSTRUCTION_BSN_HASH_SELECT = 456,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 457,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 458,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 459,
    OF_INSTRUCTION_BSN_PERMIT = 460,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 461,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 462,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 463,
    OF_INSTRUCTION_CLEAR_ACTIONS = 464,
    OF_INSTRUCTION_EXPERIMENTER = 465,
    OF_INSTRUCTION_GOTO_TABLE = 466,
    OF_INSTRUCTION_ID = 467,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 468,
    OF_INSTRUCTION_ID_BSN = 469,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 470,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 471,
    OF_INSTRUCTION_ID_BSN_DENY = 472,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 473,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 474,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 475,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 476,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 477,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 478,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 479,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 480,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 481,
    OF_INSTRUCTION_ID_BSN_PERMIT = 482,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 483,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 484,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 485,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 486,
    OF_INSTRUCTION_ID_EXPERIMENTER = 487,
    OF_INSTRUCTION_ID_GOTO_TABLE = 488,
    OF_INSTRUCTION_ID_METER = 489,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 490,
    OF_INSTRUCTION_ID_WRITE_METADATA = 491,
    OF_INSTRUCTION_METER = 492,
    OF_INSTRUCTION_WRITE_ACTIONS = 493,
    OF_INSTRUCTION_WRITE_METADATA = 494,
    OF_MATCH_V1 = 495,
    OF_MATCH_V2 = 496,
    OF_MATCH_V3 = 497,
    OF_METER_BAND = 498,
    OF_METER_BAND_DROP = 499,
    OF_METER_BAND_DSCP_REMARK = 500,
    OF_METER_BAND_EXPERIMENTER = 501,
    OF_METER_BAND_STATS = 502,
    OF_METER_CONFIG = 503,
    OF_METER_FEATURES = 504,
    OF_METER_STATS = 505,
    OF_OXM = 506,
    OF_OXM_ARP_OP = 507,
    OF_OXM_ARP_OP_MASKED = 508,
    OF_OXM_ARP_SHA = 509,
    OF_OXM_ARP_SHA_MASKED = 510,
    OF_OXM_ARP_SPA = 511,
    OF_OXM_ARP_SPA_MASKED = 512,
    OF_OXM_ARP_THA = 513,
    OF_OXM_ARP_THA_MASKED = 514,
    OF_OXM_ARP_TPA = 515,
    OF_OXM_ARP_TPA_MASKED = 516,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 517,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 518,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 519,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 520,
    OF_OXM_BSN_IN_PORTS_128 = 521,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 522,
    OF_OXM_BSN_IN_PORTS_512 = 523,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 524,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 525,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 526,
    OF_OXM_BSN_INNER_ETH_DST = 527,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 528,
    OF_OXM_BSN_INNER_ETH_SRC = 529,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 530,
    OF_OXM_BSN_INNER_VLAN_VID = 531,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 532,
    OF_OXM_BSN_L2_CACHE_HIT = 533,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 534,
    OF_OXM_BSN_L3_DST_CLASS_ID = 535,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 536,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 537,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 538,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 539,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 540,
    OF_OXM_BSN_LAG_ID = 541,
    OF_OXM_BSN_LAG_ID_MASKED = 542,
    OF_OXM_BSN_TCP_FLAGS = 543,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 544,
    OF_OXM_BSN_UDF0 = 545,
    OF_OXM_BSN_UDF0_MASKED = 546,
    OF_OXM_BSN_UDF1 = 547,
    OF_OXM_BSN_UDF1_MASKED = 548,
    OF_OXM_BSN_UDF2 = 549,
    OF_OXM_BSN_UDF2_MASKED = 550,
    OF_OXM_BSN_UDF3 = 551,
    OF_OXM_BSN_UDF3_MASKED = 552,
    OF_OXM_BSN_UDF4 = 553,
    OF_OXM_BSN_UDF4_MASKED = 554,
    OF_OXM_BSN_UDF5 = 555,
    OF_OXM_BSN_UDF5_MASKED = 556,
    OF_OXM_BSN_UDF6 = 557,
    OF_OXM_BSN_UDF6_MASKED = 558,
    OF_OXM_BSN_UDF7 = 559,
    OF_OXM_BSN_UDF7_MASKED = 560,
    OF_OXM_BSN_VFI = 561,
    OF_OXM_BSN_VFI_MASKED = 562,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 563,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 564,
    OF_OXM_BSN_VRF = 565,
    OF_OXM_BSN_VRF_MASKED = 566,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 567,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 568,
    OF_OXM_ETH_DST = 569,
    OF_OXM_ETH_DST_MASKED = 570,
    OF_OXM_ETH_SRC = 571,
    OF_OXM_ETH_SRC_MASKED = 572,
    OF_OXM_ETH_TYPE = 573,
    OF_OXM_ETH_TYPE_MASKED = 574,
    OF_OXM_ICMPV4_CODE = 575,
    OF_OXM_ICMPV4_CODE_MASKED = 576,
    OF_OXM_ICMPV4_TYPE = 577,
    OF_OXM_ICMPV4_TYPE_MASKED = 578,
    OF_OXM_ICMPV6_CODE = 579,
    OF_OXM_ICMPV6_CODE_MASKED = 580,
    OF_OXM_ICMPV6_TYPE = 581,
    OF_OXM_ICMPV6_TYPE_MASKED = 582,
    OF_OXM_IN_PHY_PORT = 583,
    OF_OXM_IN_PHY_PORT_MASKED = 584,
    OF_OXM_IN_PORT = 585,
    OF_OXM_IN_PORT_MASKED = 586,
    OF_OXM_IP_DSCP = 587,
    OF_OXM_IP_DSCP_MASKED = 588,
    OF_OXM_IP_ECN = 589,
    OF_OXM_IP_ECN_MASKED = 590,
    OF_OXM_IP_PROTO = 591,
    OF_OXM_IP_PROTO_MASKED = 592,
    OF_OXM_IPV4_DST = 593,
    OF_OXM_IPV4_DST_MASKED = 594,
    OF_OXM_IPV4_SRC = 595,
    OF_OXM_IPV4_SRC_MASKED = 596,
    OF_OXM_IPV6_DST = 597,
    OF_OXM_IPV6_DST_MASKED = 598,
    OF_OXM_IPV6_EXTHDR = 599,
    OF_OXM_IPV6_EXTHDR_MASKED = 600,
    OF_OXM_IPV6_FLABEL = 601,
    OF_OXM_IPV6_FLABEL_MASKED = 602,
    OF_OXM_IPV6_ND_SLL = 603,
    OF_OXM_IPV6_ND_SLL_MASKED = 604,
    OF_OXM_IPV6_ND_TARGET = 605,
    OF_OXM_IPV6_ND_TARGET_MASKED = 606,
    OF_OXM_IPV6_ND_TLL = 607,
    OF_OXM_IPV6_ND_TLL_MASKED = 608,
    OF_OXM_IPV6_SRC = 609,
    OF_OXM_IPV6_SRC_MASKED = 610,
    OF_OXM_METADATA = 611,
    OF_OXM_METADATA_MASKED = 612,
    OF_OXM_MPLS_BOS = 613,
    OF_OXM_MPLS_BOS_MASKED = 614,
    OF_OXM_MPLS_LABEL = 615,
    OF_OXM_MPLS_LABEL_MASKED = 616,
    OF_OXM_MPLS_TC = 617,
    OF_OXM_MPLS_TC_MASKED = 618,
    OF_OXM_PBB_UCA = 619,
    OF_OXM_PBB_UCA_MASKED = 620,
    OF_OXM_SCTP_DST = 621,
    OF_OXM_SCTP_DST_MASKED = 622,
    OF_OXM_SCTP_SRC = 623,
    OF_OXM_SCTP_SRC_MASKED = 624,
    OF_OXM_TCP_DST = 625,
    OF_OXM_TCP_DST_MASKED = 626,
    OF_OXM_TCP_SRC = 627,
    OF_OXM_TCP_SRC_MASKED = 628,
    OF_OXM_TUNNEL_ID = 629,
    OF_OXM_TUNNEL_ID_MASKED = 630,
    OF_OXM_TUNNEL_IPV4_DST = 631,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 632,
    OF_OXM_TUNNEL_IPV4_SRC = 633,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 634,
    OF_OXM_UDP_DST = 635,
    OF_OXM_UDP_DST_MASKED = 636,
    OF_OXM_UDP_SRC = 637,
    OF_OXM_UDP_SRC_MASKED = 638,
    OF_OXM_VLAN_PCP = 639,
    OF_OXM_VLAN_PCP_MASKED = 640,
    OF_OXM_VLAN_VID = 641,
    OF_OXM_VLAN_VID_MASKED = 642,
    OF_PACKET_QUEUE = 643,
    OF_PORT_DESC = 644,
    OF_PORT_DESC_PROP = 645,
    OF_PORT_DESC_PROP_BSN = 646,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 647,
    OF_PORT_DESC_PROP_BSN_UPLINK = 648,
    OF_PORT_DESC_PROP_ETHERNET = 649,
    OF_PORT_DESC_PROP_EXPERIMENTER = 650,
    OF_PORT_DESC_PROP_OPTICAL = 651,
    OF_PORT_MOD_PROP = 652,
    OF_PORT_MOD_PROP_ETHERNET = 653,
    OF_PORT_MOD_PROP_EXPERIMENTER = 654,
    OF_PORT_MOD_PROP_OPTICAL = 655,
    OF_PORT_STATS_ENTRY = 656,
    OF_PORT_STATS_PROP = 657,
    OF_PORT_STATS_PROP_ETHERNET = 658,
    OF_PORT_STATS_PROP_EXPERIMENTER = 659,
    OF_PORT_STATS_PROP_OPTICAL = 660,
    OF_QUEUE_DESC = 661,
    OF_QUEUE_DESC_PROP = 662,
    OF_QUEUE_DESC_PROP_BSN = 663,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 664,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 665,
    OF_QUEUE_DESC_PROP_MAX_RATE = 666,
    OF_QUEUE_DESC_PROP_MIN_RATE = 667,
    OF_QUEUE_PROP = 668,
    OF_QUEUE_PROP_EXPERIMENTER = 669,
    OF_QUEUE_PROP_MAX_RATE = 670,
    OF_QUEUE_PROP_MIN_RATE = 671,
    OF_QUEUE_STATS_ENTRY = 672,
    OF_QUEUE_STATS_PROP = 673,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 674,
    OF_ROLE_PROP = 675,
    OF_ROLE_PROP_EXPERIMENTER = 676,
    OF_TABLE_DESC = 677,
    OF_TABLE_FEATURE_PROP = 678,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 679,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 680,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 681,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 682,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 683,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 684,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 685,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 686,
    OF_TABLE_FEATURE_PROP_MATCH = 687,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 688,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 689,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 690,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 691,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 692,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 693,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 694,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 695,
    OF_TABLE_FEATURES = 696,
    OF_TABLE_MOD_PROP = 697,
    OF_TABLE_MOD_PROP_EVICTION = 698,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 699,
    OF_TABLE_MOD_PROP_VACANCY = 700,
    OF_TABLE_STATS_ENTRY = 701,
    OF_UINT32 = 702,
    OF_UINT64 = 703,
    OF_UINT8 = 704,
    ...
    /* List objects */
    OF_LIST_ACTION = 705,
    OF_LIST_ACTION_ID = 706,
    OF_LIST_ASYNC_CONFIG_PROP = 707,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 708,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 709,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 710,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 711,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 712,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 713,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 714,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 715,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 716,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 717,
    OF_LIST_BSN_INTERFACE = 718,
    OF_LIST_BSN_LACP_STATS_ENTRY = 719,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 720,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 721,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 722,
    OF_LIST_BSN_TLV = 723,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 724,
    OF_LIST_BSN_VLAN_MAC = 725,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 726,
    OF_LIST_BUCKET = 727,
    OF_LIST_BUCKET_COUNTER = 728,
    OF_LIST_BUNDLE_PROP = 729,
    OF_LIST_FLOW_STATS_ENTRY = 730,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 731,
    OF_LIST_GROUP_STATS_ENTRY = 732,
    OF_LIST_HELLO_ELEM = 733,
    OF_LIST_INSTRUCTION = 734,
    OF_LIST_INSTRUCTION_ID = 735,
    OF_LIST_METER_BAND = 736,
    OF_LIST_METER_BAND_STATS = 737,
    OF_LIST_METER_CONFIG = 738,
    OF_LIST_METER_STATS = 739,
    OF_LIST_OXM = 740,
    OF_LIST_PACKET_QUEUE = 741,
    OF_LIST_PORT_DESC = 742,
    OF_LIST_PORT_DESC_PROP = 743,
    OF_LIST_PORT_MOD_PROP = 744,
    OF_LIST_PORT_STATS_ENTRY = 745,
    OF_LIST_PORT_STATS_PROP = 746,
    OF_LIST_QUEUE_DESC = 747,
    OF_LIST_QUEUE_DESC_PROP = 748,
    OF_LIST_QUEUE_PROP = 749,
    OF_LIST_QUEUE_STATS_ENTRY = 750,
    OF_LIST_QUEUE_STATS_PROP = 751,
    OF_LIST_ROLE_PROP = 752,
    OF_LIST_TABLE_DESC = 753,
    OF_LIST_TABLE_FEATURE_PROP = 754,
    OF_LIST_TABLE_FEATURES = 755,
    OF_LIST_TABLE_MOD_PROP = 756,
    OF_LIST_TABLE_STATS_ENTRY = 757,
    OF_LIST_UINT32 = 758,
    OF_LIST_UINT64 = 759,
    OF_LIST_UINT8 = 760,
