...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 455,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 456,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 457,
    OF_INSTRUCTION_BSN_PERMIT = 458,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 459,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 460,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 461,
    OF_INSTRUCTION_CLEAR_ACTIONS = 462,
    OF_INSTRUCTION_EXPERIMENTER = 463,
    OF_INSTRUCTION_GOTO_TABLE = 464,
    OF_INSTRUCTION_ID = 465,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 466,
    OF_INSTRUCTION_ID_BSN = 467,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 468,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 469,
    OF_INSTRUCTION_ID_BSN_DENY = 470,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 471,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 472,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 473,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 474,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 475,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 476,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 477,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 478,
    OF_INSTRUCTION_ID_BSN_PERMIT = 479,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 480,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 481,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 482,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 483,
    OF_INSTRUCTION_ID_EXPERIMENTER = 484,
    OF_INSTRUCTION_ID_GOTO_TABLE = 485,
    OF_INSTRUCTION_ID_METER = 486,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 487,
    OF_INSTRUCTION_ID_WRITE_METADATA = 488,
    OF_INSTRUCTION_METER = 489,
    OF_INSTRUCTION_WRITE_ACTIONS = 490,
    OF_INSTRUCTION_WRITE_METADATA = 491,
    OF_MATCH_V1 = 492,
    OF_MATCH_V2 = 493,
    OF_MATCH_V3 = 494,
    OF_METER_BAND = 495,
    OF_METER_BAND_DROP = 496,
    OF_METER_BAND_DSCP_REMARK = 497,
    OF_METER_BAND_EXPERIMENTER = 498,
    OF_METER_BAND_STATS = 499,
    OF_METER_CONFIG = 500,
    OF_METER_FEATURES = 501,
    OF_METER_STATS = 502,
    OF_OXM = 503,
    OF_OXM_ARP_OP = 504,
    OF_OXM_ARP_OP_MASKED = 505,
    OF_OXM_ARP_SHA = 506,
    OF_OXM_ARP_SHA_MASKED = 507,
    OF_OXM_ARP_SPA = 508,
    OF_OXM_ARP_SPA_MASKED = 509,
    OF_OXM_ARP_THA = 510,
    OF_OXM_ARP_THA_MASKED = 511,
    OF_OXM_ARP_TPA = 512,
    OF_OXM_ARP_TPA_MASKED = 513,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 514,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 515,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 516,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 517,
    OF_OXM_BSN_IN_PORTS_128 = 518,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 519,
    OF_OXM_BSN_IN_PORTS_512 = 520,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 521,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 522,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 523,
    OF_OXM_BSN_INNER_ETH_DST = 524,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 525,
    OF_OXM_BSN_INNER_ETH_SRC = 526,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 527,
    OF_OXM_BSN_INNER_VLAN_VID = 528,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 529,
    OF_OXM_BSN_L2_CACHE_HIT = 530,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 531,
    OF_OXM_BSN_L3_DST_CLASS_ID = 532,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 533,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 534,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 535,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 536,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 537,
    OF_OXM_BSN_LAG_ID = 538,
    OF_OXM_BSN_LAG_ID_MASKED = 539,
    OF_OXM_BSN_TCP_FLAGS = 540,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 541,
    OF_OXM_BSN_UDF0 = 542,
    OF_OXM_BSN_UDF0_MASKED = 543,
    OF_OXM_BSN_UDF1 = 544,
    OF_OXM_BSN_UDF1_MASKED = 545,
    OF_OXM_BSN_UDF2 = 546,
    OF_OXM_BSN_UDF2_MASKED = 547,
    OF_OXM_BSN_UDF3 = 548,
    OF_OXM_BSN_UDF3_MASKED = 549,
    OF_OXM_BSN_UDF4 = 550,
    OF_OXM_BSN_UDF4_MASKED = 551,
    OF_OXM_BSN_UDF5 = 552,
    OF_OXM_BSN_UDF5_MASKED = 553,
    OF_OXM_BSN_UDF6 = 554,
    OF_OXM_BSN_UDF6_MASKED = 555,
    OF_OXM_BSN_UDF7 = 556,
    OF_OXM_BSN_UDF7_MASKED = 557,
    OF_OXM_BSN_VFI = 558,
    OF_OXM_BSN_VFI_MASKED = 559,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 560,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 561,
    OF_OXM_BSN_VRF = 562,
    OF_OXM_BSN_VRF_MASKED = 563,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 564,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 565,
    OF_OXM_ETH_DST = 566,
    OF_OXM_ETH_DST_MASKED = 567,
    OF_OXM_ETH_SRC = 568,
    OF_OXM_ETH_SRC_MASKED = 569,
    OF_OXM_ETH_TYPE = 570,
    OF_OXM_ETH_TYPE_MASKED = 571,
    OF_OXM_ICMPV4_CODE = 572,
    OF_OXM_ICMPV4_CODE_MASKED = 573,
    OF_OXM_ICMPV4_TYPE = 574,
    OF_OXM_ICMPV4_TYPE_MASKED = 575,
    OF_OXM_ICMPV6_CODE = 576,
    OF_OXM_ICMPV6_CODE_MASKED = 577,
    OF_OXM_ICMPV6_TYPE = 578,
    OF_OXM_ICMPV6_TYPE_MASKED = 579,
    OF_OXM_IN_PHY_PORT = 580,
    OF_OXM_IN_PHY_PORT_MASKED = 581,
    OF_OXM_IN_PORT = 582,
    OF_OXM_IN_PORT_MASKED = 583,
    OF_OXM_IP_DSCP = 584,
    OF_OXM_IP_DSCP_MASKED = 585,
    OF_OXM_IP_ECN = 586,
    OF_OXM_IP_ECN_MASKED = 587,
    OF_OXM_IP_PROTO = 588,
    OF_OXM_IP_PROTO_MASKED = 589,
    OF_OXM_IPV4_DST = 590,
    OF_OXM_IPV4_DST_MASKED = 591,
    OF_OXM_IPV4_SRC = 592,
    OF_OXM_IPV4_SRC_MASKED = 593,
    OF_OXM_IPV6_DST = 594,
    OF_OXM_IPV6_DST_MASKED = 595,
    OF_OXM_IPV6_EXTHDR = 596,
    OF_OXM_IPV6_EXTHDR_MASKED = 597,
    OF_OXM_IPV6_FLABEL = 598,
    OF_OXM_IPV6_FLABEL_MASKED = 599,
    OF_OXM_IPV6_ND_SLL = 600,
    OF_OXM_IPV6_ND_SLL_MASKED = 601,
    OF_OXM_IPV6_ND_TARGET = 602,
    OF_OXM_IPV6_ND_TARGET_MASKED = 603,
    OF_OXM_IPV6_ND_TLL = 604,
    OF_OXM_IPV6_ND_TLL_MASKED = 605,
    OF_OXM_IPV6_SRC = 606,
    OF_OXM_IPV6_SRC_MASKED = 607,
    OF_OXM_METADATA = 608,
    OF_OXM_METADATA_MASKED = 609,
    OF_OXM_MPLS_BOS = 610,
    OF_OXM_MPLS_BOS_MASKED = 611,
    OF_OXM_MPLS_LABEL = 612,
    OF_OXM_MPLS_LABEL_MASKED = 613,
    OF_OXM_MPLS_TC = 614,
    OF_OXM_MPLS_TC_MASKED = 615,
    OF_OXM_PBB_UCA = 616,
    OF_OXM_PBB_UCA_MASKED = 617,
    OF_OXM_SCTP_DST = 618,
    OF_OXM_SCTP_DST_MASKED = 619,
    OF_OXM_SCTP_SRC = 620,
    OF_OXM_SCTP_SRC_MASKED = 621,
    OF_OXM_TCP_DST = 622,
    OF_OXM_TCP_DST_MASKED = 623,
    OF_OXM_TCP_SRC = 624,
    OF_OXM_TCP_SRC_MASKED = 625,
    OF_OXM_TUNNEL_ID = 626,
    OF_OXM_TUNNEL_ID_MASKED = 627,
    OF_OXM_TUNNEL_IPV4_DST = 628,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 629,
    OF_OXM_TUNNEL_IPV4_SRC = 630,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 631,
    OF_OXM_UDP_DST = 632,
    OF_OXM_UDP_DST_MASKED = 633,
    OF_OXM_UDP_SRC = 634,
    OF_OXM_UDP_SRC_MASKED = 635,
    OF_OXM_VLAN_PCP = 636,
    OF_OXM_VLAN_PCP_MASKED = 637,
    OF_OXM_VLAN_VID = 638,
    OF_OXM_VLAN_VID_MASKED = 639,
    OF_PACKET_QUEUE = 640,
    OF_PORT_DESC = 641,
    OF_PORT_DESC_PROP = 642,
    OF_PORT_DESC_PROP_BSN = 643,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 644,
    OF_PORT_DESC_PROP_BSN_UPLINK = 645,
    OF_PORT_DESC_PROP_ETHERNET = 646,
    OF_PORT_DESC_PROP_EXPERIMENTER = 647,
    OF_PORT_DESC_PROP_OPTICAL = 648,
    OF_PORT_MOD_PROP = 649,
    OF_PORT_MOD_PROP_ETHERNET = 650,
    OF_PORT_MOD_PROP_EXPERIMENTER = 651,
    OF_PORT_MOD_PROP_OPTICAL = 652,
    OF_PORT_STATS_ENTRY = 653,
    OF_PORT_STATS_PROP = 654,
    OF_PORT_STATS_PROP_ETHERNET = 655,
    OF_PORT_STATS_PROP_EXPERIMENTER = 656,
    OF_PORT_STATS_PROP_OPTICAL = 657,
    OF_QUEUE_DESC = 658,
    OF_QUEUE_DESC_PROP = 659,
    OF_QUEUE_DESC_PROP_BSN = 660,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 661,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 662,
    OF_QUEUE_DESC_PROP_MAX_RATE = 663,
    OF_QUEUE_DESC_PROP_MIN_RATE = 664,
    OF_QUEUE_PROP = 665,
    OF_QUEUE_PROP_EXPERIMENTER = 666,
    OF_QUEUE_PROP_MAX_RATE = 667,
    OF_QUEUE_PROP_MIN_RATE = 668,
    OF_QUEUE_STATS_ENTRY = 669,
    OF_QUEUE_STATS_PROP = 670,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 671,
    OF_ROLE_PROP = 672,
    OF_ROLE_PROP_EXPERIMENTER = 673,
    OF_TABLE_DESC = 674,
    OF_TABLE_FEATURE_PROP = 675,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 676,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 677,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 678,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 679,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 680,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 681,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 682,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 683,
    OF_TABLE_FEATURE_PROP_MATCH = 684,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 685,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 686,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 687,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 688,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 689,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 690,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 691,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 692,
    OF_TABLE_FEATURES = 693,
    OF_TABLE_MOD_PROP = 694,
    OF_TABLE_MOD_PROP_EVICTION = 695,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 696,
    OF_TABLE_MOD_PROP_VACANCY = 697,
    OF_TABLE_STATS_ENTRY = 698,
    OF_UINT32 = 699,
    OF_UINT64 = 700,
    OF_UINT8 = 701,
    ...
    /* List objects */
    OF_LIST_ACTION = 702,
    OF_LIST_ACTION_ID = 703,
    OF_LIST_ASYNC_CONFIG_PROP = 704,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 705,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 706,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 707,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 708,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 709,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 710,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 711,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 712,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 713,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 714,
    OF_LIST_BSN_INTERFACE = 715,
    OF_LIST_BSN_LACP_STATS_ENTRY = 716,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 717,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 718,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 719,
    OF_LIST_BSN_TLV = 720,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 721,
    OF_LIST_BSN_VLAN_MAC = 722,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 723,
    OF_LIST_BUCKET = 724,
    OF_LIST_BUCKET_COUNTER = 725,
    OF_LIST_BUNDLE_PROP = 726,
    OF_LIST_FLOW_STATS_ENTRY = 727,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 728,
    OF_LIST_GROUP_STATS_ENTRY = 729,
    OF_LIST_HELLO_ELEM = 730,
    OF_LIST_INSTRUCTION = 731,
    OF_LIST_INSTRUCTION_ID = 732,
    OF_LIST_METER_BAND = 733,
    OF_LIST_METER_BAND_STATS = 734,
    OF_LIST_METER_CONFIG = 735,
    OF_LIST_METER_STATS = 736,
    OF_LIST_OXM = 737,
    OF_LIST_PACKET_QUEUE = 738,
    OF_LIST_PORT_DESC = 739,
    OF_LIST_PORT_DESC_PROP = 740,
    OF_LIST_PORT_MOD_PROP = 741,
    OF_LIST_PORT_STATS_ENTRY = 742,
    OF_LIST_PORT_STATS_PROP = 743,
    OF_LIST_QUEUE_DESC = 744,
    OF_LIST_QUEUE_DESC_PROP = 745,
    OF_LIST_QUEUE_PROP = 746,
    OF_LIST_QUEUE_STATS_ENTRY = 747,
    OF_LIST_QUEUE_STATS_PROP = 748,
    OF_LIST_ROLE_PROP = 749,
    OF_LIST_TABLE_DESC = 750,
    OF_LIST_TABLE_FEATURE_PROP = 751,
    OF_LIST_TABLE_FEATURES = 752,
    OF_LIST_TABLE_MOD_PROP = 753,
    OF_LIST_TABLE_STATS_ENTRY = 754,
    OF_LIST_UINT32 = 755,
    OF_LIST_UINT64 = 756,
    OF_LIST_UINT8 = 757,
