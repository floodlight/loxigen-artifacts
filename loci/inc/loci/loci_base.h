...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_REFERENCE = 441,
    OF_BSN_TLV_REPLY_PACKETS = 442,
    OF_BSN_TLV_REQUEST_PACKETS = 443,
    OF_BSN_TLV_REST_SERVER = 444,
    OF_BSN_TLV_ROUTING_PARAM = 445,
    OF_BSN_TLV_RX_BYTES = 446,
    OF_BSN_TLV_RX_PACKETS = 447,
    OF_BSN_TLV_SAMPLING_RATE = 448,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 449,
    OF_BSN_TLV_STATUS = 450,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 451,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 452,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 453,
    OF_BSN_TLV_SUB_AGENT_ID = 454,
    OF_BSN_TLV_TCP_DST = 455,
    OF_BSN_TLV_TCP_FLAGS = 456,
    OF_BSN_TLV_TCP_SRC = 457,
    OF_BSN_TLV_TIMESTAMP = 458,
    OF_BSN_TLV_TTL = 459,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 460,
    OF_BSN_TLV_TX_BYTES = 461,
    OF_BSN_TLV_TX_PACKETS = 462,
    OF_BSN_TLV_UDF_ANCHOR = 463,
    OF_BSN_TLV_UDF_CAPABILITY = 464,
    ...
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 491,
    OF_BSN_VLAN_MAC = 492,
    OF_BSN_VPORT = 493,
    OF_BSN_VPORT_L2GRE = 494,
    OF_BSN_VPORT_Q_IN_Q = 495,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 496,
    OF_BUCKET = 497,
    OF_BUCKET_COUNTER = 498,
    OF_BUNDLE_PROP = 499,
    OF_BUNDLE_PROP_EXPERIMENTER = 500,
    OF_FLOW_STATS_ENTRY = 501,
    OF_GROUP_DESC_STATS_ENTRY = 502,
    OF_GROUP_STATS_ENTRY = 503,
    OF_HELLO_ELEM = 504,
    OF_HELLO_ELEM_VERSIONBITMAP = 505,
    OF_INSTRUCTION = 506,
    OF_INSTRUCTION_APPLY_ACTIONS = 507,
    OF_INSTRUCTION_BSN = 508,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 509,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 510,
    OF_INSTRUCTION_BSN_DENY = 511,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 512,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 513,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 514,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 515,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 516,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 517,
    OF_INSTRUCTION_BSN_HASH_SELECT = 518,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 519,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 520,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 521,
    OF_INSTRUCTION_BSN_PERMIT = 522,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 523,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 524,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 525,
    OF_INSTRUCTION_CLEAR_ACTIONS = 526,
    OF_INSTRUCTION_EXPERIMENTER = 527,
    OF_INSTRUCTION_GOTO_TABLE = 528,
    OF_INSTRUCTION_ID = 529,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 530,
    OF_INSTRUCTION_ID_BSN = 531,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 532,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 533,
    OF_INSTRUCTION_ID_BSN_DENY = 534,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 535,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 536,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 537,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 538,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 539,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 540,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 541,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 542,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 543,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 544,
    OF_INSTRUCTION_ID_BSN_PERMIT = 545,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 546,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 547,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 548,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 549,
    OF_INSTRUCTION_ID_EXPERIMENTER = 550,
    OF_INSTRUCTION_ID_GOTO_TABLE = 551,
    OF_INSTRUCTION_ID_METER = 552,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 553,
    OF_INSTRUCTION_ID_WRITE_METADATA = 554,
    OF_INSTRUCTION_METER = 555,
    OF_INSTRUCTION_WRITE_ACTIONS = 556,
    OF_INSTRUCTION_WRITE_METADATA = 557,
    OF_MATCH_V1 = 558,
    OF_MATCH_V2 = 559,
    OF_MATCH_V3 = 560,
    OF_METER_BAND = 561,
    OF_METER_BAND_DROP = 562,
    OF_METER_BAND_DSCP_REMARK = 563,
    OF_METER_BAND_EXPERIMENTER = 564,
    OF_METER_BAND_STATS = 565,
    OF_METER_CONFIG = 566,
    OF_METER_FEATURES = 567,
    OF_METER_STATS = 568,
    OF_OXM = 569,
    OF_OXM_ARP_OP = 570,
    OF_OXM_ARP_OP_MASKED = 571,
    OF_OXM_ARP_SHA = 572,
    OF_OXM_ARP_SHA_MASKED = 573,
    OF_OXM_ARP_SPA = 574,
    OF_OXM_ARP_SPA_MASKED = 575,
    OF_OXM_ARP_THA = 576,
    OF_OXM_ARP_THA_MASKED = 577,
    OF_OXM_ARP_TPA = 578,
    OF_OXM_ARP_TPA_MASKED = 579,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 580,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 581,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 582,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 583,
    OF_OXM_BSN_IFP_CLASS_ID = 584,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 585,
    OF_OXM_BSN_IN_PORTS_128 = 586,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 587,
    OF_OXM_BSN_IN_PORTS_512 = 588,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 589,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 590,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 591,
    OF_OXM_BSN_INNER_ETH_DST = 592,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 593,
    OF_OXM_BSN_INNER_ETH_SRC = 594,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 595,
    OF_OXM_BSN_INNER_VLAN_VID = 596,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 597,
    OF_OXM_BSN_IP_FRAGMENTATION = 598,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 599,
    OF_OXM_BSN_L2_CACHE_HIT = 600,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 601,
    OF_OXM_BSN_L3_DST_CLASS_ID = 602,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 603,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 604,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 605,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 606,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 607,
    OF_OXM_BSN_LAG_ID = 608,
    OF_OXM_BSN_LAG_ID_MASKED = 609,
    OF_OXM_BSN_TCP_FLAGS = 610,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 611,
    OF_OXM_BSN_UDF0 = 612,
    OF_OXM_BSN_UDF0_MASKED = 613,
    OF_OXM_BSN_UDF1 = 614,
    OF_OXM_BSN_UDF1_MASKED = 615,
    OF_OXM_BSN_UDF2 = 616,
    OF_OXM_BSN_UDF2_MASKED = 617,
    OF_OXM_BSN_UDF3 = 618,
    OF_OXM_BSN_UDF3_MASKED = 619,
    OF_OXM_BSN_UDF4 = 620,
    OF_OXM_BSN_UDF4_MASKED = 621,
    OF_OXM_BSN_UDF5 = 622,
    OF_OXM_BSN_UDF5_MASKED = 623,
    OF_OXM_BSN_UDF6 = 624,
    OF_OXM_BSN_UDF6_MASKED = 625,
    OF_OXM_BSN_UDF7 = 626,
    OF_OXM_BSN_UDF7_MASKED = 627,
    OF_OXM_BSN_VFI = 628,
    OF_OXM_BSN_VFI_MASKED = 629,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 630,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 631,
    OF_OXM_BSN_VRF = 632,
    OF_OXM_BSN_VRF_MASKED = 633,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 634,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 635,
    OF_OXM_CONN_TRACKING_IPV6_DST = 636,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 637,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 638,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 639,
    OF_OXM_CONN_TRACKING_LABEL = 640,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 641,
    OF_OXM_CONN_TRACKING_MARK = 642,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 643,
    OF_OXM_CONN_TRACKING_NW_DST = 644,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 645,
    OF_OXM_CONN_TRACKING_NW_PROTO = 646,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 647,
    OF_OXM_CONN_TRACKING_NW_SRC = 648,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 649,
    OF_OXM_CONN_TRACKING_STATE = 650,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 651,
    OF_OXM_CONN_TRACKING_TP_DST = 652,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 653,
    OF_OXM_CONN_TRACKING_TP_SRC = 654,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 655,
    OF_OXM_CONN_TRACKING_ZONE = 656,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 657,
    OF_OXM_ETH_DST = 658,
    OF_OXM_ETH_DST_MASKED = 659,
    OF_OXM_ETH_SRC = 660,
    OF_OXM_ETH_SRC_MASKED = 661,
    OF_OXM_ETH_TYPE = 662,
    OF_OXM_ETH_TYPE_MASKED = 663,
    OF_OXM_ICMPV4_CODE = 664,
    OF_OXM_ICMPV4_CODE_MASKED = 665,
    OF_OXM_ICMPV4_TYPE = 666,
    OF_OXM_ICMPV4_TYPE_MASKED = 667,
    OF_OXM_ICMPV6_CODE = 668,
    OF_OXM_ICMPV6_CODE_MASKED = 669,
    OF_OXM_ICMPV6_TYPE = 670,
    OF_OXM_ICMPV6_TYPE_MASKED = 671,
    OF_OXM_IN_PHY_PORT = 672,
    OF_OXM_IN_PHY_PORT_MASKED = 673,
    OF_OXM_IN_PORT = 674,
    OF_OXM_IN_PORT_MASKED = 675,
    OF_OXM_IP_DSCP = 676,
    OF_OXM_IP_DSCP_MASKED = 677,
    OF_OXM_IP_ECN = 678,
    OF_OXM_IP_ECN_MASKED = 679,
    OF_OXM_IP_PROTO = 680,
    OF_OXM_IP_PROTO_MASKED = 681,
    OF_OXM_IPV4_DST = 682,
    OF_OXM_IPV4_DST_MASKED = 683,
    OF_OXM_IPV4_SRC = 684,
    OF_OXM_IPV4_SRC_MASKED = 685,
    OF_OXM_IPV6_DST = 686,
    OF_OXM_IPV6_DST_MASKED = 687,
    OF_OXM_IPV6_EXTHDR = 688,
    OF_OXM_IPV6_EXTHDR_MASKED = 689,
    OF_OXM_IPV6_FLABEL = 690,
    OF_OXM_IPV6_FLABEL_MASKED = 691,
    OF_OXM_IPV6_ND_SLL = 692,
    OF_OXM_IPV6_ND_SLL_MASKED = 693,
    OF_OXM_IPV6_ND_TARGET = 694,
    OF_OXM_IPV6_ND_TARGET_MASKED = 695,
    OF_OXM_IPV6_ND_TLL = 696,
    OF_OXM_IPV6_ND_TLL_MASKED = 697,
    OF_OXM_IPV6_SRC = 698,
    OF_OXM_IPV6_SRC_MASKED = 699,
    OF_OXM_METADATA = 700,
    OF_OXM_METADATA_MASKED = 701,
    OF_OXM_MPLS_BOS = 702,
    OF_OXM_MPLS_BOS_MASKED = 703,
    OF_OXM_MPLS_LABEL = 704,
    OF_OXM_MPLS_LABEL_MASKED = 705,
    OF_OXM_MPLS_TC = 706,
    OF_OXM_MPLS_TC_MASKED = 707,
    OF_OXM_OVS_TCP_FLAGS = 708,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 709,
    OF_OXM_PBB_UCA = 710,
    OF_OXM_PBB_UCA_MASKED = 711,
    OF_OXM_SCTP_DST = 712,
    OF_OXM_SCTP_DST_MASKED = 713,
    OF_OXM_SCTP_SRC = 714,
    OF_OXM_SCTP_SRC_MASKED = 715,
    OF_OXM_TCP_DST = 716,
    OF_OXM_TCP_DST_MASKED = 717,
    OF_OXM_TCP_SRC = 718,
    OF_OXM_TCP_SRC_MASKED = 719,
    OF_OXM_TUNNEL_ID = 720,
    OF_OXM_TUNNEL_ID_MASKED = 721,
    OF_OXM_TUNNEL_IPV4_DST = 722,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 723,
    OF_OXM_TUNNEL_IPV4_SRC = 724,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 725,
    OF_OXM_UDP_DST = 726,
    OF_OXM_UDP_DST_MASKED = 727,
    OF_OXM_UDP_SRC = 728,
    OF_OXM_UDP_SRC_MASKED = 729,
    OF_OXM_VLAN_PCP = 730,
    OF_OXM_VLAN_PCP_MASKED = 731,
    OF_OXM_VLAN_VID = 732,
    OF_OXM_VLAN_VID_MASKED = 733,
    OF_PACKET_QUEUE = 734,
    OF_PORT_DESC = 735,
    OF_PORT_DESC_PROP = 736,
    OF_PORT_DESC_PROP_BSN = 737,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 738,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 739,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 740,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 741,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 742,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 743,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 744,
    OF_PORT_DESC_PROP_BSN_UPLINK = 745,
    OF_PORT_DESC_PROP_ETHERNET = 746,
    OF_PORT_DESC_PROP_EXPERIMENTER = 747,
    OF_PORT_DESC_PROP_OPTICAL = 748,
    OF_PORT_MOD_PROP = 749,
    OF_PORT_MOD_PROP_ETHERNET = 750,
    OF_PORT_MOD_PROP_EXPERIMENTER = 751,
    OF_PORT_MOD_PROP_OPTICAL = 752,
    OF_PORT_STATS_ENTRY = 753,
    OF_PORT_STATS_PROP = 754,
    OF_PORT_STATS_PROP_ETHERNET = 755,
    OF_PORT_STATS_PROP_EXPERIMENTER = 756,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 757,
    OF_PORT_STATS_PROP_OPTICAL = 758,
    OF_QUEUE_DESC = 759,
    OF_QUEUE_DESC_PROP = 760,
    OF_QUEUE_DESC_PROP_BSN = 761,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 762,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 763,
    OF_QUEUE_DESC_PROP_MAX_RATE = 764,
    OF_QUEUE_DESC_PROP_MIN_RATE = 765,
    OF_QUEUE_PROP = 766,
    OF_QUEUE_PROP_EXPERIMENTER = 767,
    OF_QUEUE_PROP_MAX_RATE = 768,
    OF_QUEUE_PROP_MIN_RATE = 769,
    OF_QUEUE_STATS_ENTRY = 770,
    OF_QUEUE_STATS_PROP = 771,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 772,
    OF_ROLE_PROP = 773,
    OF_ROLE_PROP_EXPERIMENTER = 774,
    OF_TABLE_DESC = 775,
    OF_TABLE_FEATURE_PROP = 776,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 777,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 778,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 779,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 780,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 781,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 782,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 783,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 784,
    OF_TABLE_FEATURE_PROP_MATCH = 785,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 786,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 787,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 788,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 789,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 790,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 791,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 792,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 793,
    OF_TABLE_FEATURES = 794,
    OF_TABLE_MOD_PROP = 795,
    OF_TABLE_MOD_PROP_EVICTION = 796,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 797,
    OF_TABLE_MOD_PROP_VACANCY = 798,
    OF_TABLE_STATS_ENTRY = 799,
    OF_UINT32 = 800,
    OF_UINT64 = 801,
    OF_UINT8 = 802,
    ...
    /* List objects */
    OF_LIST_ACTION = 803,
    OF_LIST_ACTION_ID = 804,
    OF_LIST_ASYNC_CONFIG_PROP = 805,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 806,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 807,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 808,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 809,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 810,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 811,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 812,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 813,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 814,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 815,
    OF_LIST_BSN_INTERFACE = 816,
    OF_LIST_BSN_LACP_STATS_ENTRY = 817,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 818,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 819,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 820,
    OF_LIST_BSN_TLV = 821,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 822,
    OF_LIST_BSN_VLAN_MAC = 823,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 824,
    OF_LIST_BUCKET = 825,
    OF_LIST_BUCKET_COUNTER = 826,
    OF_LIST_BUNDLE_PROP = 827,
    OF_LIST_FLOW_STATS_ENTRY = 828,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 829,
    OF_LIST_GROUP_STATS_ENTRY = 830,
    OF_LIST_HELLO_ELEM = 831,
    OF_LIST_INSTRUCTION = 832,
    OF_LIST_INSTRUCTION_ID = 833,
    OF_LIST_METER_BAND = 834,
    OF_LIST_METER_BAND_STATS = 835,
    OF_LIST_METER_CONFIG = 836,
    OF_LIST_METER_STATS = 837,
    OF_LIST_OXM = 838,
    OF_LIST_PACKET_QUEUE = 839,
    OF_LIST_PORT_DESC = 840,
    OF_LIST_PORT_DESC_PROP = 841,
    OF_LIST_PORT_MOD_PROP = 842,
    OF_LIST_PORT_STATS_ENTRY = 843,
    OF_LIST_PORT_STATS_PROP = 844,
    OF_LIST_QUEUE_DESC = 845,
    OF_LIST_QUEUE_DESC_PROP = 846,
    OF_LIST_QUEUE_PROP = 847,
    OF_LIST_QUEUE_STATS_ENTRY = 848,
    OF_LIST_QUEUE_STATS_PROP = 849,
    OF_LIST_ROLE_PROP = 850,
    OF_LIST_TABLE_DESC = 851,
    OF_LIST_TABLE_FEATURE_PROP = 852,
    OF_LIST_TABLE_FEATURES = 853,
    OF_LIST_TABLE_MOD_PROP = 854,
    OF_LIST_TABLE_STATS_ENTRY = 855,
    OF_LIST_UINT32 = 856,
    OF_LIST_UINT64 = 857,
    OF_LIST_UINT8 = 858,
