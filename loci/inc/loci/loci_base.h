...
typedef enum of_object_id_e {
    ...
    OF_TABLE_FEATURE_PROP_HEADER = 420,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 421,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 422,
    OF_TABLE_FEATURE_PROP_MATCH = 423,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 424,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 425,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 426,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 427,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 428,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 429,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 430,
    OF_TABLE_FEATURES = 431,
    OF_TABLE_STATS_ENTRY = 432,
    OF_UINT32 = 433,
    OF_UINT64 = 434,
    OF_UINT8 = 435,
    ...
    /* List objects */
    OF_LIST_ACTION = 436,
    OF_LIST_ACTION_ID = 437,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 438,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 439,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 440,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 441,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 442,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 443,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 444,
    OF_LIST_BSN_INTERFACE = 445,
    OF_LIST_BSN_LACP_STATS_ENTRY = 446,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 447,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 448,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 449,
    OF_LIST_BSN_TLV = 450,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 451,
    OF_LIST_BUCKET = 452,
    OF_LIST_BUCKET_COUNTER = 453,
    OF_LIST_FLOW_STATS_ENTRY = 454,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 455,
    OF_LIST_GROUP_STATS_ENTRY = 456,
    OF_LIST_HELLO_ELEM = 457,
    OF_LIST_INSTRUCTION = 458,
    OF_LIST_METER_BAND = 459,
    OF_LIST_METER_BAND_STATS = 460,
    OF_LIST_METER_STATS = 461,
    OF_LIST_OXM = 462,
    OF_LIST_PACKET_QUEUE = 463,
    OF_LIST_PORT_DESC = 464,
    OF_LIST_PORT_STATS_ENTRY = 465,
    OF_LIST_QUEUE_PROP = 466,
    OF_LIST_QUEUE_STATS_ENTRY = 467,
    OF_LIST_TABLE_FEATURE_PROP = 468,
    OF_LIST_TABLE_FEATURES = 469,
    OF_LIST_TABLE_STATS_ENTRY = 470,
    OF_LIST_UINT32 = 471,
    OF_LIST_UINT64 = 472,
    OF_LIST_UINT8 = 473,
