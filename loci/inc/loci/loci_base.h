...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PORT = 393,
    OF_BSN_TLV_PORT_VXLAN_MODE = 394,
    OF_BSN_TLV_PRIORITY = 395,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 396,
    OF_BSN_TLV_QOS_PRIORITY = 397,
    OF_BSN_TLV_QUEUE_ID = 398,
    OF_BSN_TLV_QUEUE_WEIGHT = 399,
    OF_BSN_TLV_RATE_LIMIT = 400,
    OF_BSN_TLV_RATE_UNIT = 401,
    OF_BSN_TLV_REFERENCE = 402,
    OF_BSN_TLV_REPLY_PACKETS = 403,
    OF_BSN_TLV_REQUEST_PACKETS = 404,
    OF_BSN_TLV_RX_BYTES = 405,
    OF_BSN_TLV_RX_PACKETS = 406,
    OF_BSN_TLV_SAMPLING_RATE = 407,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 408,
    OF_BSN_TLV_STATUS = 409,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 410,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 411,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 412,
    OF_BSN_TLV_SUB_AGENT_ID = 413,
    OF_BSN_TLV_TCP_DST = 414,
    OF_BSN_TLV_TCP_FLAGS = 415,
    OF_BSN_TLV_TCP_SRC = 416,
    OF_BSN_TLV_TTL = 417,
    OF_BSN_TLV_TX_BYTES = 418,
    OF_BSN_TLV_TX_PACKETS = 419,
    OF_BSN_TLV_UDF_ANCHOR = 420,
    OF_BSN_TLV_UDF_ID = 421,
    OF_BSN_TLV_UDF_LENGTH = 422,
    OF_BSN_TLV_UDF_OFFSET = 423,
    OF_BSN_TLV_UDP_DST = 424,
    OF_BSN_TLV_UDP_SRC = 425,
    OF_BSN_TLV_UINT64_LIST = 426,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 427,
    OF_BSN_TLV_UNICAST_RATE = 428,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 429,
    OF_BSN_TLV_UNTAGGED = 430,
    OF_BSN_TLV_USE_PACKET_STATE = 431,
    OF_BSN_TLV_VFI = 432,
    OF_BSN_TLV_VFP_CLASS_ID = 433,
    OF_BSN_TLV_VLAN_MAC_LIST = 434,
    OF_BSN_TLV_VLAN_PCP = 435,
    OF_BSN_TLV_VLAN_VID = 436,
    OF_BSN_TLV_VLAN_VID_MASK = 437,
    OF_BSN_TLV_VNI = 438,
    OF_BSN_TLV_VPN_KEY = 439,
    OF_BSN_TLV_VRF = 440,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 441,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 442,
    OF_BSN_VLAN_MAC = 443,
    OF_BSN_VPORT = 444,
    OF_BSN_VPORT_L2GRE = 445,
    OF_BSN_VPORT_Q_IN_Q = 446,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 447,
    OF_BUCKET = 448,
    OF_BUCKET_COUNTER = 449,
    OF_BUNDLE_PROP = 450,
    OF_BUNDLE_PROP_EXPERIMENTER = 451,
    OF_FLOW_STATS_ENTRY = 452,
    OF_GROUP_DESC_STATS_ENTRY = 453,
    OF_GROUP_STATS_ENTRY = 454,
    OF_HELLO_ELEM = 455,
    OF_HELLO_ELEM_VERSIONBITMAP = 456,
    OF_INSTRUCTION = 457,
    OF_INSTRUCTION_APPLY_ACTIONS = 458,
    OF_INSTRUCTION_BSN = 459,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 460,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 461,
    OF_INSTRUCTION_BSN_DENY = 462,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 463,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 464,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 465,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 466,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 467,
    OF_INSTRUCTION_BSN_HASH_SELECT = 468,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 469,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 470,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 471,
    OF_INSTRUCTION_BSN_PERMIT = 472,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 473,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 474,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 475,
    OF_INSTRUCTION_CLEAR_ACTIONS = 476,
    OF_INSTRUCTION_EXPERIMENTER = 477,
    OF_INSTRUCTION_GOTO_TABLE = 478,
    OF_INSTRUCTION_ID = 479,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 480,
    OF_INSTRUCTION_ID_BSN = 481,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 482,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 483,
    OF_INSTRUCTION_ID_BSN_DENY = 484,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 485,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 486,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 487,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 488,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 489,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 490,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 491,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 492,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 493,
    OF_INSTRUCTION_ID_BSN_PERMIT = 494,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 495,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 496,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 497,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 498,
    OF_INSTRUCTION_ID_EXPERIMENTER = 499,
    OF_INSTRUCTION_ID_GOTO_TABLE = 500,
    OF_INSTRUCTION_ID_METER = 501,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 502,
    OF_INSTRUCTION_ID_WRITE_METADATA = 503,
    OF_INSTRUCTION_METER = 504,
    OF_INSTRUCTION_WRITE_ACTIONS = 505,
    OF_INSTRUCTION_WRITE_METADATA = 506,
    OF_MATCH_V1 = 507,
    OF_MATCH_V2 = 508,
    OF_MATCH_V3 = 509,
    OF_METER_BAND = 510,
    OF_METER_BAND_DROP = 511,
    OF_METER_BAND_DSCP_REMARK = 512,
    OF_METER_BAND_EXPERIMENTER = 513,
    OF_METER_BAND_STATS = 514,
    OF_METER_CONFIG = 515,
    OF_METER_FEATURES = 516,
    OF_METER_STATS = 517,
    OF_OXM = 518,
    OF_OXM_ARP_OP = 519,
    OF_OXM_ARP_OP_MASKED = 520,
    OF_OXM_ARP_SHA = 521,
    OF_OXM_ARP_SHA_MASKED = 522,
    OF_OXM_ARP_SPA = 523,
    OF_OXM_ARP_SPA_MASKED = 524,
    OF_OXM_ARP_THA = 525,
    OF_OXM_ARP_THA_MASKED = 526,
    OF_OXM_ARP_TPA = 527,
    OF_OXM_ARP_TPA_MASKED = 528,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 529,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 530,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 531,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 532,
    OF_OXM_BSN_IN_PORTS_128 = 533,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 534,
    OF_OXM_BSN_IN_PORTS_512 = 535,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 536,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 537,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 538,
    OF_OXM_BSN_INNER_ETH_DST = 539,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 540,
    OF_OXM_BSN_INNER_ETH_SRC = 541,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 542,
    OF_OXM_BSN_INNER_VLAN_VID = 543,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 544,
    OF_OXM_BSN_IP_FRAGMENTATION = 545,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 546,
    OF_OXM_BSN_L2_CACHE_HIT = 547,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 548,
    OF_OXM_BSN_L3_DST_CLASS_ID = 549,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 550,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 551,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 552,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 553,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 554,
    OF_OXM_BSN_LAG_ID = 555,
    OF_OXM_BSN_LAG_ID_MASKED = 556,
    OF_OXM_BSN_TCP_FLAGS = 557,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 558,
    OF_OXM_BSN_UDF0 = 559,
    OF_OXM_BSN_UDF0_MASKED = 560,
    OF_OXM_BSN_UDF1 = 561,
    OF_OXM_BSN_UDF1_MASKED = 562,
    OF_OXM_BSN_UDF2 = 563,
    OF_OXM_BSN_UDF2_MASKED = 564,
    OF_OXM_BSN_UDF3 = 565,
    OF_OXM_BSN_UDF3_MASKED = 566,
    OF_OXM_BSN_UDF4 = 567,
    OF_OXM_BSN_UDF4_MASKED = 568,
    OF_OXM_BSN_UDF5 = 569,
    OF_OXM_BSN_UDF5_MASKED = 570,
    OF_OXM_BSN_UDF6 = 571,
    OF_OXM_BSN_UDF6_MASKED = 572,
    OF_OXM_BSN_UDF7 = 573,
    OF_OXM_BSN_UDF7_MASKED = 574,
    OF_OXM_BSN_VFI = 575,
    OF_OXM_BSN_VFI_MASKED = 576,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 577,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 578,
    OF_OXM_BSN_VRF = 579,
    OF_OXM_BSN_VRF_MASKED = 580,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 581,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 582,
    OF_OXM_ETH_DST = 583,
    OF_OXM_ETH_DST_MASKED = 584,
    OF_OXM_ETH_SRC = 585,
    OF_OXM_ETH_SRC_MASKED = 586,
    OF_OXM_ETH_TYPE = 587,
    OF_OXM_ETH_TYPE_MASKED = 588,
    OF_OXM_ICMPV4_CODE = 589,
    OF_OXM_ICMPV4_CODE_MASKED = 590,
    OF_OXM_ICMPV4_TYPE = 591,
    OF_OXM_ICMPV4_TYPE_MASKED = 592,
    OF_OXM_ICMPV6_CODE = 593,
    OF_OXM_ICMPV6_CODE_MASKED = 594,
    OF_OXM_ICMPV6_TYPE = 595,
    OF_OXM_ICMPV6_TYPE_MASKED = 596,
    OF_OXM_IN_PHY_PORT = 597,
    OF_OXM_IN_PHY_PORT_MASKED = 598,
    OF_OXM_IN_PORT = 599,
    OF_OXM_IN_PORT_MASKED = 600,
    OF_OXM_IP_DSCP = 601,
    OF_OXM_IP_DSCP_MASKED = 602,
    OF_OXM_IP_ECN = 603,
    OF_OXM_IP_ECN_MASKED = 604,
    OF_OXM_IP_PROTO = 605,
    OF_OXM_IP_PROTO_MASKED = 606,
    OF_OXM_IPV4_DST = 607,
    OF_OXM_IPV4_DST_MASKED = 608,
    OF_OXM_IPV4_SRC = 609,
    OF_OXM_IPV4_SRC_MASKED = 610,
    OF_OXM_IPV6_DST = 611,
    OF_OXM_IPV6_DST_MASKED = 612,
    OF_OXM_IPV6_EXTHDR = 613,
    OF_OXM_IPV6_EXTHDR_MASKED = 614,
    OF_OXM_IPV6_FLABEL = 615,
    OF_OXM_IPV6_FLABEL_MASKED = 616,
    OF_OXM_IPV6_ND_SLL = 617,
    OF_OXM_IPV6_ND_SLL_MASKED = 618,
    OF_OXM_IPV6_ND_TARGET = 619,
    OF_OXM_IPV6_ND_TARGET_MASKED = 620,
    OF_OXM_IPV6_ND_TLL = 621,
    OF_OXM_IPV6_ND_TLL_MASKED = 622,
    OF_OXM_IPV6_SRC = 623,
    OF_OXM_IPV6_SRC_MASKED = 624,
    OF_OXM_METADATA = 625,
    OF_OXM_METADATA_MASKED = 626,
    OF_OXM_MPLS_BOS = 627,
    OF_OXM_MPLS_BOS_MASKED = 628,
    OF_OXM_MPLS_LABEL = 629,
    OF_OXM_MPLS_LABEL_MASKED = 630,
    OF_OXM_MPLS_TC = 631,
    OF_OXM_MPLS_TC_MASKED = 632,
    OF_OXM_OVS_TCP_FLAGS = 633,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 634,
    OF_OXM_PBB_UCA = 635,
    OF_OXM_PBB_UCA_MASKED = 636,
    OF_OXM_SCTP_DST = 637,
    OF_OXM_SCTP_DST_MASKED = 638,
    OF_OXM_SCTP_SRC = 639,
    OF_OXM_SCTP_SRC_MASKED = 640,
    OF_OXM_TCP_DST = 641,
    OF_OXM_TCP_DST_MASKED = 642,
    OF_OXM_TCP_SRC = 643,
    OF_OXM_TCP_SRC_MASKED = 644,
    OF_OXM_TUNNEL_ID = 645,
    OF_OXM_TUNNEL_ID_MASKED = 646,
    OF_OXM_TUNNEL_IPV4_DST = 647,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 648,
    OF_OXM_TUNNEL_IPV4_SRC = 649,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 650,
    OF_OXM_UDP_DST = 651,
    OF_OXM_UDP_DST_MASKED = 652,
    OF_OXM_UDP_SRC = 653,
    OF_OXM_UDP_SRC_MASKED = 654,
    OF_OXM_VLAN_PCP = 655,
    OF_OXM_VLAN_PCP_MASKED = 656,
    OF_OXM_VLAN_VID = 657,
    OF_OXM_VLAN_VID_MASKED = 658,
    OF_PACKET_QUEUE = 659,
    OF_PORT_DESC = 660,
    OF_PORT_DESC_PROP = 661,
    OF_PORT_DESC_PROP_BSN = 662,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 663,
    OF_PORT_DESC_PROP_BSN_UPLINK = 664,
    OF_PORT_DESC_PROP_ETHERNET = 665,
    OF_PORT_DESC_PROP_EXPERIMENTER = 666,
    OF_PORT_DESC_PROP_OPTICAL = 667,
    OF_PORT_MOD_PROP = 668,
    OF_PORT_MOD_PROP_ETHERNET = 669,
    OF_PORT_MOD_PROP_EXPERIMENTER = 670,
    OF_PORT_MOD_PROP_OPTICAL = 671,
    OF_PORT_STATS_ENTRY = 672,
    OF_PORT_STATS_PROP = 673,
    OF_PORT_STATS_PROP_ETHERNET = 674,
    OF_PORT_STATS_PROP_EXPERIMENTER = 675,
    OF_PORT_STATS_PROP_OPTICAL = 676,
    OF_QUEUE_DESC = 677,
    OF_QUEUE_DESC_PROP = 678,
    OF_QUEUE_DESC_PROP_BSN = 679,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 680,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 681,
    OF_QUEUE_DESC_PROP_MAX_RATE = 682,
    OF_QUEUE_DESC_PROP_MIN_RATE = 683,
    OF_QUEUE_PROP = 684,
    OF_QUEUE_PROP_EXPERIMENTER = 685,
    OF_QUEUE_PROP_MAX_RATE = 686,
    OF_QUEUE_PROP_MIN_RATE = 687,
    OF_QUEUE_STATS_ENTRY = 688,
    OF_QUEUE_STATS_PROP = 689,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 690,
    OF_ROLE_PROP = 691,
    OF_ROLE_PROP_EXPERIMENTER = 692,
    OF_TABLE_DESC = 693,
    OF_TABLE_FEATURE_PROP = 694,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 695,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 696,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 697,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 698,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 699,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 700,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 701,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 702,
    OF_TABLE_FEATURE_PROP_MATCH = 703,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 704,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 705,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 706,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 707,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 708,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 709,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 710,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 711,
    OF_TABLE_FEATURES = 712,
    OF_TABLE_MOD_PROP = 713,
    OF_TABLE_MOD_PROP_EVICTION = 714,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 715,
    OF_TABLE_MOD_PROP_VACANCY = 716,
    OF_TABLE_STATS_ENTRY = 717,
    OF_UINT32 = 718,
    OF_UINT64 = 719,
    OF_UINT8 = 720,
    ...
    /* List objects */
    OF_LIST_ACTION = 721,
    OF_LIST_ACTION_ID = 722,
    OF_LIST_ASYNC_CONFIG_PROP = 723,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 724,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 725,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 726,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 727,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 728,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 729,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 730,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 731,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 732,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 733,
    OF_LIST_BSN_INTERFACE = 734,
    OF_LIST_BSN_LACP_STATS_ENTRY = 735,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 736,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 737,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 738,
    OF_LIST_BSN_TLV = 739,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 740,
    OF_LIST_BSN_VLAN_MAC = 741,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 742,
    OF_LIST_BUCKET = 743,
    OF_LIST_BUCKET_COUNTER = 744,
    OF_LIST_BUNDLE_PROP = 745,
    OF_LIST_FLOW_STATS_ENTRY = 746,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 747,
    OF_LIST_GROUP_STATS_ENTRY = 748,
    OF_LIST_HELLO_ELEM = 749,
    OF_LIST_INSTRUCTION = 750,
    OF_LIST_INSTRUCTION_ID = 751,
    OF_LIST_METER_BAND = 752,
    OF_LIST_METER_BAND_STATS = 753,
    OF_LIST_METER_CONFIG = 754,
    OF_LIST_METER_STATS = 755,
    OF_LIST_OXM = 756,
    OF_LIST_PACKET_QUEUE = 757,
    OF_LIST_PORT_DESC = 758,
    OF_LIST_PORT_DESC_PROP = 759,
    OF_LIST_PORT_MOD_PROP = 760,
    OF_LIST_PORT_STATS_ENTRY = 761,
    OF_LIST_PORT_STATS_PROP = 762,
    OF_LIST_QUEUE_DESC = 763,
    OF_LIST_QUEUE_DESC_PROP = 764,
    OF_LIST_QUEUE_PROP = 765,
    OF_LIST_QUEUE_STATS_ENTRY = 766,
    OF_LIST_QUEUE_STATS_PROP = 767,
    OF_LIST_ROLE_PROP = 768,
    OF_LIST_TABLE_DESC = 769,
    OF_LIST_TABLE_FEATURE_PROP = 770,
    OF_LIST_TABLE_FEATURES = 771,
    OF_LIST_TABLE_MOD_PROP = 772,
    OF_LIST_TABLE_STATS_ENTRY = 773,
    OF_LIST_UINT32 = 774,
    OF_LIST_UINT64 = 775,
    OF_LIST_UINT8 = 776,
