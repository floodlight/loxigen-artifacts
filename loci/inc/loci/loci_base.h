...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_LINK_UP = 402,
    OF_BSN_TLV_LOOPBACK_MODE = 403,
    OF_BSN_TLV_LOOPBACK_PORT = 404,
    OF_BSN_TLV_LOSSLESS = 405,
    OF_BSN_TLV_LR_ALL_ENABLED = 406,
    OF_BSN_TLV_MAC = 407,
    OF_BSN_TLV_MAC_MASK = 408,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 409,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 410,
    OF_BSN_TLV_MISS_PACKETS = 411,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 412,
    OF_BSN_TLV_MPLS_LABEL = 413,
    OF_BSN_TLV_MPLS_SEQUENCED = 414,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 415,
    OF_BSN_TLV_MULTICAST_PACKET = 416,
    OF_BSN_TLV_MULTIPLIER = 417,
    OF_BSN_TLV_NAME = 418,
    OF_BSN_TLV_NDP_OFFLOAD = 419,
    OF_BSN_TLV_NDP_STATIC = 420,
    OF_BSN_TLV_NEGATE = 421,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 422,
    OF_BSN_TLV_NEXT_HOP_MAC = 423,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 424,
    OF_BSN_TLV_NO_ARP_RESPONSE = 425,
    OF_BSN_TLV_NO_NS_RESPONSE = 426,
    OF_BSN_TLV_OFFSET = 427,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 428,
    OF_BSN_TLV_OUTER_SRC_MAC = 429,
    OF_BSN_TLV_PARENT_PORT = 430,
    OF_BSN_TLV_PARTNER_KEY = 431,
    OF_BSN_TLV_PARTNER_PORT_NUM = 432,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 433,
    OF_BSN_TLV_PARTNER_STATE = 434,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 435,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 436,
    OF_BSN_TLV_PASSIVE = 437,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 438,
    OF_BSN_TLV_PIM_DR = 439,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 440,
    OF_BSN_TLV_PORT = 441,
    OF_BSN_TLV_PORT_MODE = 442,
    OF_BSN_TLV_PORT_SPEED_GBPS = 443,
    OF_BSN_TLV_PORT_USAGE = 444,
    OF_BSN_TLV_PORT_VXLAN_MODE = 445,
    OF_BSN_TLV_PRESERVE_VLAN = 446,
    OF_BSN_TLV_PRIORITY = 447,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 448,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 449,
    OF_BSN_TLV_QOS_PRIORITY = 450,
    OF_BSN_TLV_QUEUE_ID = 451,
    OF_BSN_TLV_QUEUE_WEIGHT = 452,
    OF_BSN_TLV_RATE_LIMIT = 453,
    OF_BSN_TLV_RATE_UNIT = 454,
    OF_BSN_TLV_RECORD_PACKETS = 455,
    OF_BSN_TLV_REDUNDANT_MGMT = 456,
    OF_BSN_TLV_REFERENCE = 457,
    OF_BSN_TLV_REPLY_PACKETS = 458,
    OF_BSN_TLV_REQUEST_PACKETS = 459,
    OF_BSN_TLV_REST_SERVER = 460,
    OF_BSN_TLV_ROUTING_PARAM = 461,
    OF_BSN_TLV_RX_BYTES = 462,
    OF_BSN_TLV_RX_PACKETS = 463,
    OF_BSN_TLV_SAMPLING_RATE = 464,
    OF_BSN_TLV_SCTP_DST = 465,
    OF_BSN_TLV_SCTP_SRC = 466,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 467,
    OF_BSN_TLV_SRC_MAC_CML = 468,
    OF_BSN_TLV_STATUS = 469,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 470,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 471,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 472,
    OF_BSN_TLV_SUB_AGENT_ID = 473,
    OF_BSN_TLV_TCP_DST = 474,
    OF_BSN_TLV_TCP_FLAGS = 475,
    OF_BSN_TLV_TCP_SRC = 476,
    OF_BSN_TLV_TIMESTAMP = 477,
    OF_BSN_TLV_TTL = 478,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 479,
    OF_BSN_TLV_TX_BYTES = 480,
    OF_BSN_TLV_TX_PACKETS = 481,
    OF_BSN_TLV_UDF_ANCHOR = 482,
    OF_BSN_TLV_UDF_CAPABILITY = 483,
    OF_BSN_TLV_UDF_DATA = 484,
    OF_BSN_TLV_UDF_ID = 485,
    OF_BSN_TLV_UDF_LENGTH = 486,
    OF_BSN_TLV_UDF_OFFSET = 487,
    OF_BSN_TLV_UDP_DST = 488,
    OF_BSN_TLV_UDP_SRC = 489,
    OF_BSN_TLV_UINT32 = 490,
    OF_BSN_TLV_UINT64_LIST = 491,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 492,
    OF_BSN_TLV_UNICAST_RATE = 493,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 494,
    OF_BSN_TLV_UNTAGGED = 495,
    OF_BSN_TLV_UPGRADE = 496,
    OF_BSN_TLV_URI_SCHEME = 497,
    OF_BSN_TLV_USE_PACKET_STATE = 498,
    OF_BSN_TLV_USER_CONFIGURED = 499,
    OF_BSN_TLV_VFI = 500,
    OF_BSN_TLV_VFP_CLASS_ID = 501,
    OF_BSN_TLV_VIRTUAL = 502,
    OF_BSN_TLV_VLAN_MAC_LIST = 503,
    OF_BSN_TLV_VLAN_PCP = 504,
    OF_BSN_TLV_VLAN_VID = 505,
    OF_BSN_TLV_VLAN_VID_MASK = 506,
    OF_BSN_TLV_VNI = 507,
    OF_BSN_TLV_VPN_KEY = 508,
    OF_BSN_TLV_VRF = 509,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 510,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 511,
    OF_BSN_VLAN_MAC = 512,
    OF_BSN_VPORT = 513,
    OF_BSN_VPORT_L2GRE = 514,
    OF_BSN_VPORT_Q_IN_Q = 515,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 516,
    OF_BUCKET = 517,
    OF_BUCKET_COUNTER = 518,
    OF_BUNDLE_PROP = 519,
    OF_BUNDLE_PROP_EXPERIMENTER = 520,
    OF_FLOW_STATS_ENTRY = 521,
    OF_GROUP_DESC_STATS_ENTRY = 522,
    OF_GROUP_STATS_ENTRY = 523,
    OF_HELLO_ELEM = 524,
    OF_HELLO_ELEM_VERSIONBITMAP = 525,
    OF_INSTRUCTION = 526,
    OF_INSTRUCTION_APPLY_ACTIONS = 527,
    OF_INSTRUCTION_BSN = 528,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 529,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 530,
    OF_INSTRUCTION_BSN_DENY = 531,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 532,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 533,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 534,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 535,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 536,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 537,
    OF_INSTRUCTION_BSN_HASH_SELECT = 538,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 539,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 540,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 541,
    OF_INSTRUCTION_BSN_PERMIT = 542,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 543,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 544,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 545,
    OF_INSTRUCTION_CLEAR_ACTIONS = 546,
    OF_INSTRUCTION_EXPERIMENTER = 547,
    OF_INSTRUCTION_GOTO_TABLE = 548,
    OF_INSTRUCTION_ID = 549,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 550,
    OF_INSTRUCTION_ID_BSN = 551,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 552,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 553,
    OF_INSTRUCTION_ID_BSN_DENY = 554,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 555,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 556,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 557,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 558,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 559,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 560,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 561,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 562,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 563,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 564,
    OF_INSTRUCTION_ID_BSN_PERMIT = 565,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 566,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 567,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 568,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 569,
    OF_INSTRUCTION_ID_EXPERIMENTER = 570,
    OF_INSTRUCTION_ID_GOTO_TABLE = 571,
    OF_INSTRUCTION_ID_METER = 572,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 573,
    OF_INSTRUCTION_ID_WRITE_METADATA = 574,
    OF_INSTRUCTION_METER = 575,
    OF_INSTRUCTION_WRITE_ACTIONS = 576,
    OF_INSTRUCTION_WRITE_METADATA = 577,
    OF_MATCH_V1 = 578,
    OF_MATCH_V2 = 579,
    OF_MATCH_V3 = 580,
    OF_METER_BAND = 581,
    OF_METER_BAND_DROP = 582,
    OF_METER_BAND_DSCP_REMARK = 583,
    OF_METER_BAND_EXPERIMENTER = 584,
    OF_METER_BAND_STATS = 585,
    OF_METER_CONFIG = 586,
    OF_METER_FEATURES = 587,
    OF_METER_STATS = 588,
    OF_OXM = 589,
    OF_OXM_ARP_OP = 590,
    OF_OXM_ARP_OP_MASKED = 591,
    OF_OXM_ARP_SHA = 592,
    OF_OXM_ARP_SHA_MASKED = 593,
    OF_OXM_ARP_SPA = 594,
    OF_OXM_ARP_SPA_MASKED = 595,
    OF_OXM_ARP_THA = 596,
    OF_OXM_ARP_THA_MASKED = 597,
    OF_OXM_ARP_TPA = 598,
    OF_OXM_ARP_TPA_MASKED = 599,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 600,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 601,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 602,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 603,
    OF_OXM_BSN_IFP_CLASS_ID = 604,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 605,
    OF_OXM_BSN_IN_PORTS_128 = 606,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 607,
    OF_OXM_BSN_IN_PORTS_512 = 608,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 609,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 610,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 611,
    OF_OXM_BSN_INNER_ETH_DST = 612,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 613,
    OF_OXM_BSN_INNER_ETH_SRC = 614,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 615,
    OF_OXM_BSN_INNER_VLAN_VID = 616,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 617,
    OF_OXM_BSN_IP_FRAGMENTATION = 618,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 619,
    OF_OXM_BSN_L2_CACHE_HIT = 620,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 621,
    OF_OXM_BSN_L3_DST_CLASS_ID = 622,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 623,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 624,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 625,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 626,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 627,
    OF_OXM_BSN_LAG_ID = 628,
    OF_OXM_BSN_LAG_ID_MASKED = 629,
    OF_OXM_BSN_TCP_FLAGS = 630,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 631,
    OF_OXM_BSN_UDF0 = 632,
    OF_OXM_BSN_UDF0_MASKED = 633,
    OF_OXM_BSN_UDF1 = 634,
    OF_OXM_BSN_UDF1_MASKED = 635,
    OF_OXM_BSN_UDF2 = 636,
    OF_OXM_BSN_UDF2_MASKED = 637,
    OF_OXM_BSN_UDF3 = 638,
    OF_OXM_BSN_UDF3_MASKED = 639,
    OF_OXM_BSN_UDF4 = 640,
    OF_OXM_BSN_UDF4_MASKED = 641,
    OF_OXM_BSN_UDF5 = 642,
    OF_OXM_BSN_UDF5_MASKED = 643,
    OF_OXM_BSN_UDF6 = 644,
    OF_OXM_BSN_UDF6_MASKED = 645,
    OF_OXM_BSN_UDF7 = 646,
    OF_OXM_BSN_UDF7_MASKED = 647,
    OF_OXM_BSN_VFI = 648,
    OF_OXM_BSN_VFI_MASKED = 649,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 650,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 651,
    OF_OXM_BSN_VRF = 652,
    OF_OXM_BSN_VRF_MASKED = 653,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 654,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 655,
    OF_OXM_CONN_TRACKING_IPV6_DST = 656,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 657,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 658,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 659,
    OF_OXM_CONN_TRACKING_LABEL = 660,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 661,
    OF_OXM_CONN_TRACKING_MARK = 662,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 663,
    OF_OXM_CONN_TRACKING_NW_DST = 664,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 665,
    OF_OXM_CONN_TRACKING_NW_PROTO = 666,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 667,
    OF_OXM_CONN_TRACKING_NW_SRC = 668,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 669,
    OF_OXM_CONN_TRACKING_STATE = 670,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 671,
    OF_OXM_CONN_TRACKING_TP_DST = 672,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 673,
    OF_OXM_CONN_TRACKING_TP_SRC = 674,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 675,
    OF_OXM_CONN_TRACKING_ZONE = 676,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 677,
    OF_OXM_ETH_DST = 678,
    OF_OXM_ETH_DST_MASKED = 679,
    OF_OXM_ETH_SRC = 680,
    OF_OXM_ETH_SRC_MASKED = 681,
    OF_OXM_ETH_TYPE = 682,
    OF_OXM_ETH_TYPE_MASKED = 683,
    OF_OXM_ICMPV4_CODE = 684,
    OF_OXM_ICMPV4_CODE_MASKED = 685,
    OF_OXM_ICMPV4_TYPE = 686,
    OF_OXM_ICMPV4_TYPE_MASKED = 687,
    OF_OXM_ICMPV6_CODE = 688,
    OF_OXM_ICMPV6_CODE_MASKED = 689,
    OF_OXM_ICMPV6_TYPE = 690,
    OF_OXM_ICMPV6_TYPE_MASKED = 691,
    OF_OXM_IN_PHY_PORT = 692,
    OF_OXM_IN_PHY_PORT_MASKED = 693,
    OF_OXM_IN_PORT = 694,
    OF_OXM_IN_PORT_MASKED = 695,
    OF_OXM_IP_DSCP = 696,
    OF_OXM_IP_DSCP_MASKED = 697,
    OF_OXM_IP_ECN = 698,
    OF_OXM_IP_ECN_MASKED = 699,
    OF_OXM_IP_PROTO = 700,
    OF_OXM_IP_PROTO_MASKED = 701,
    OF_OXM_IPV4_DST = 702,
    OF_OXM_IPV4_DST_MASKED = 703,
    OF_OXM_IPV4_SRC = 704,
    OF_OXM_IPV4_SRC_MASKED = 705,
    OF_OXM_IPV6_DST = 706,
    OF_OXM_IPV6_DST_MASKED = 707,
    OF_OXM_IPV6_EXTHDR = 708,
    OF_OXM_IPV6_EXTHDR_MASKED = 709,
    OF_OXM_IPV6_FLABEL = 710,
    OF_OXM_IPV6_FLABEL_MASKED = 711,
    OF_OXM_IPV6_ND_SLL = 712,
    OF_OXM_IPV6_ND_SLL_MASKED = 713,
    OF_OXM_IPV6_ND_TARGET = 714,
    OF_OXM_IPV6_ND_TARGET_MASKED = 715,
    OF_OXM_IPV6_ND_TLL = 716,
    OF_OXM_IPV6_ND_TLL_MASKED = 717,
    OF_OXM_IPV6_SRC = 718,
    OF_OXM_IPV6_SRC_MASKED = 719,
    OF_OXM_METADATA = 720,
    OF_OXM_METADATA_MASKED = 721,
    OF_OXM_MPLS_BOS = 722,
    OF_OXM_MPLS_BOS_MASKED = 723,
    OF_OXM_MPLS_LABEL = 724,
    OF_OXM_MPLS_LABEL_MASKED = 725,
    OF_OXM_MPLS_TC = 726,
    OF_OXM_MPLS_TC_MASKED = 727,
    OF_OXM_OVS_TCP_FLAGS = 728,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 729,
    OF_OXM_PBB_UCA = 730,
    OF_OXM_PBB_UCA_MASKED = 731,
    OF_OXM_SCTP_DST = 732,
    OF_OXM_SCTP_DST_MASKED = 733,
    OF_OXM_SCTP_SRC = 734,
    OF_OXM_SCTP_SRC_MASKED = 735,
    OF_OXM_TCP_DST = 736,
    OF_OXM_TCP_DST_MASKED = 737,
    OF_OXM_TCP_SRC = 738,
    OF_OXM_TCP_SRC_MASKED = 739,
    OF_OXM_TUNNEL_ID = 740,
    OF_OXM_TUNNEL_ID_MASKED = 741,
    OF_OXM_TUNNEL_IPV4_DST = 742,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 743,
    OF_OXM_TUNNEL_IPV4_SRC = 744,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 745,
    OF_OXM_UDP_DST = 746,
    OF_OXM_UDP_DST_MASKED = 747,
    OF_OXM_UDP_SRC = 748,
    OF_OXM_UDP_SRC_MASKED = 749,
    OF_OXM_VLAN_PCP = 750,
    OF_OXM_VLAN_PCP_MASKED = 751,
    OF_OXM_VLAN_VID = 752,
    OF_OXM_VLAN_VID_MASKED = 753,
    OF_PACKET_QUEUE = 754,
    OF_PORT_DESC = 755,
    OF_PORT_DESC_PROP = 756,
    OF_PORT_DESC_PROP_BSN = 757,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 758,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 759,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 760,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 761,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 762,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 763,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 764,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 765,
    OF_PORT_DESC_PROP_BSN_UPLINK = 766,
    OF_PORT_DESC_PROP_ETHERNET = 767,
    OF_PORT_DESC_PROP_EXPERIMENTER = 768,
    OF_PORT_DESC_PROP_OPTICAL = 769,
    OF_PORT_MOD_PROP = 770,
    OF_PORT_MOD_PROP_ETHERNET = 771,
    OF_PORT_MOD_PROP_EXPERIMENTER = 772,
    OF_PORT_MOD_PROP_OPTICAL = 773,
    OF_PORT_STATS_ENTRY = 774,
    OF_PORT_STATS_PROP = 775,
    OF_PORT_STATS_PROP_ETHERNET = 776,
    OF_PORT_STATS_PROP_EXPERIMENTER = 777,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 778,
    OF_PORT_STATS_PROP_OPTICAL = 779,
    OF_QUEUE_DESC = 780,
    OF_QUEUE_DESC_PROP = 781,
    OF_QUEUE_DESC_PROP_BSN = 782,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 783,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 784,
    OF_QUEUE_DESC_PROP_MAX_RATE = 785,
    OF_QUEUE_DESC_PROP_MIN_RATE = 786,
    OF_QUEUE_PROP = 787,
    OF_QUEUE_PROP_EXPERIMENTER = 788,
    OF_QUEUE_PROP_MAX_RATE = 789,
    OF_QUEUE_PROP_MIN_RATE = 790,
    OF_QUEUE_STATS_ENTRY = 791,
    OF_QUEUE_STATS_PROP = 792,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 793,
    OF_ROLE_PROP = 794,
    OF_ROLE_PROP_EXPERIMENTER = 795,
    OF_TABLE_DESC = 796,
    OF_TABLE_FEATURE_PROP = 797,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 798,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 799,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 800,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 801,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 802,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 803,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 804,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 805,
    OF_TABLE_FEATURE_PROP_MATCH = 806,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 807,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 808,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 809,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 810,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 811,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 812,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 813,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 814,
    OF_TABLE_FEATURES = 815,
    OF_TABLE_MOD_PROP = 816,
    OF_TABLE_MOD_PROP_EVICTION = 817,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 818,
    OF_TABLE_MOD_PROP_VACANCY = 819,
    OF_TABLE_STATS_ENTRY = 820,
    OF_UINT32 = 821,
    OF_UINT64 = 822,
    OF_UINT8 = 823,
    ...
    /* List objects */
    OF_LIST_ACTION = 824,
    OF_LIST_ACTION_ID = 825,
    OF_LIST_ASYNC_CONFIG_PROP = 826,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 827,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 828,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 829,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 830,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 831,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 832,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 833,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 834,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 835,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 836,
    OF_LIST_BSN_INTERFACE = 837,
    OF_LIST_BSN_LACP_STATS_ENTRY = 838,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 839,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 840,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 841,
    OF_LIST_BSN_TLV = 842,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 843,
    OF_LIST_BSN_VLAN_MAC = 844,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 845,
    OF_LIST_BUCKET = 846,
    OF_LIST_BUCKET_COUNTER = 847,
    OF_LIST_BUNDLE_PROP = 848,
    OF_LIST_FLOW_STATS_ENTRY = 849,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 850,
    OF_LIST_GROUP_STATS_ENTRY = 851,
    OF_LIST_HELLO_ELEM = 852,
    OF_LIST_INSTRUCTION = 853,
    OF_LIST_INSTRUCTION_ID = 854,
    OF_LIST_METER_BAND = 855,
    OF_LIST_METER_BAND_STATS = 856,
    OF_LIST_METER_CONFIG = 857,
    OF_LIST_METER_STATS = 858,
    OF_LIST_OXM = 859,
    OF_LIST_PACKET_QUEUE = 860,
    OF_LIST_PORT_DESC = 861,
    OF_LIST_PORT_DESC_PROP = 862,
    OF_LIST_PORT_MOD_PROP = 863,
    OF_LIST_PORT_STATS_ENTRY = 864,
    OF_LIST_PORT_STATS_PROP = 865,
    OF_LIST_QUEUE_DESC = 866,
    OF_LIST_QUEUE_DESC_PROP = 867,
    OF_LIST_QUEUE_PROP = 868,
    OF_LIST_QUEUE_STATS_ENTRY = 869,
    OF_LIST_QUEUE_STATS_PROP = 870,
    OF_LIST_ROLE_PROP = 871,
    OF_LIST_TABLE_DESC = 872,
    OF_LIST_TABLE_FEATURE_PROP = 873,
    OF_LIST_TABLE_FEATURES = 874,
    OF_LIST_TABLE_MOD_PROP = 875,
    OF_LIST_TABLE_STATS_ENTRY = 876,
    OF_LIST_UINT32 = 877,
    OF_LIST_UINT64 = 878,
    OF_LIST_UINT8 = 879,
