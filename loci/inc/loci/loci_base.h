...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_HEADER = 264,
    OF_BSN_TLV_IDLE_NOTIFICATION = 265,
    OF_BSN_TLV_IDLE_TIME = 266,
    OF_BSN_TLV_IDLE_TIMEOUT = 267,
    OF_BSN_TLV_IPV4 = 268,
    OF_BSN_TLV_MAC = 269,
    OF_BSN_TLV_MISS_PACKETS = 270,
    OF_BSN_TLV_PORT = 271,
    OF_BSN_TLV_QUEUE_ID = 272,
    OF_BSN_TLV_QUEUE_WEIGHT = 273,
    OF_BSN_TLV_REPLY_PACKETS = 274,
    OF_BSN_TLV_REQUEST_PACKETS = 275,
    OF_BSN_TLV_RX_PACKETS = 276,
    OF_BSN_TLV_TX_PACKETS = 277,
    OF_BSN_TLV_UDF_ANCHOR = 278,
    OF_BSN_TLV_UDF_ID = 279,
    OF_BSN_TLV_UDF_LENGTH = 280,
    OF_BSN_TLV_UDF_OFFSET = 281,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 282,
    OF_BSN_TLV_VLAN_VID = 283,
    OF_BSN_TLV_VRF = 284,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 285,
    OF_BSN_VPORT = 286,
    OF_BSN_VPORT_HEADER = 287,
    OF_BSN_VPORT_L2GRE = 288,
    OF_BSN_VPORT_Q_IN_Q = 289,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 290,
    OF_BUCKET = 291,
    OF_BUCKET_COUNTER = 292,
    OF_FLOW_STATS_ENTRY = 293,
    OF_GROUP_DESC_STATS_ENTRY = 294,
    OF_GROUP_STATS_ENTRY = 295,
    OF_HELLO_ELEM = 296,
    OF_HELLO_ELEM_HEADER = 297,
    OF_HELLO_ELEM_VERSIONBITMAP = 298,
    OF_INSTRUCTION = 299,
    OF_INSTRUCTION_APPLY_ACTIONS = 300,
    OF_INSTRUCTION_BSN = 301,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 302,
    OF_INSTRUCTION_BSN_DENY = 303,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 304,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 305,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 306,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 307,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 308,
    OF_INSTRUCTION_BSN_PERMIT = 309,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 310,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 311,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 312,
    OF_INSTRUCTION_CLEAR_ACTIONS = 313,
    OF_INSTRUCTION_EXPERIMENTER = 314,
    OF_INSTRUCTION_GOTO_TABLE = 315,
    OF_INSTRUCTION_HEADER = 316,
    OF_INSTRUCTION_ID = 317,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 318,
    OF_INSTRUCTION_ID_BSN = 319,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 320,
    OF_INSTRUCTION_ID_BSN_DENY = 321,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 322,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 323,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 324,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 325,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 326,
    OF_INSTRUCTION_ID_BSN_PERMIT = 327,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 328,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 329,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 330,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 331,
    OF_INSTRUCTION_ID_EXPERIMENTER = 332,
    OF_INSTRUCTION_ID_GOTO_TABLE = 333,
    OF_INSTRUCTION_ID_HEADER = 334,
    OF_INSTRUCTION_ID_METER = 335,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 336,
    OF_INSTRUCTION_ID_WRITE_METADATA = 337,
    OF_INSTRUCTION_METER = 338,
    OF_INSTRUCTION_WRITE_ACTIONS = 339,
    OF_INSTRUCTION_WRITE_METADATA = 340,
    OF_MATCH_V1 = 341,
    OF_MATCH_V2 = 342,
    OF_MATCH_V3 = 343,
    OF_METER_BAND = 344,
    OF_METER_BAND_DROP = 345,
    OF_METER_BAND_DSCP_REMARK = 346,
    OF_METER_BAND_EXPERIMENTER = 347,
    OF_METER_BAND_HEADER = 348,
    OF_METER_BAND_STATS = 349,
    OF_METER_CONFIG = 350,
    OF_METER_FEATURES = 351,
    OF_METER_STATS = 352,
    OF_OXM = 353,
    OF_OXM_ARP_OP = 354,
    OF_OXM_ARP_OP_MASKED = 355,
    OF_OXM_ARP_SHA = 356,
    OF_OXM_ARP_SHA_MASKED = 357,
    OF_OXM_ARP_SPA = 358,
    OF_OXM_ARP_SPA_MASKED = 359,
    OF_OXM_ARP_THA = 360,
    OF_OXM_ARP_THA_MASKED = 361,
    OF_OXM_ARP_TPA = 362,
    OF_OXM_ARP_TPA_MASKED = 363,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 364,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 365,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 366,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 367,
    OF_OXM_BSN_IN_PORTS_128 = 368,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 369,
    OF_OXM_BSN_L3_DST_CLASS_ID = 370,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 371,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 372,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 373,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 374,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 375,
    OF_OXM_BSN_LAG_ID = 376,
    OF_OXM_BSN_LAG_ID_MASKED = 377,
    OF_OXM_BSN_TCP_FLAGS = 378,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 379,
    OF_OXM_BSN_UDF0 = 380,
    OF_OXM_BSN_UDF0_MASKED = 381,
    OF_OXM_BSN_UDF1 = 382,
    OF_OXM_BSN_UDF1_MASKED = 383,
    OF_OXM_BSN_UDF2 = 384,
    OF_OXM_BSN_UDF2_MASKED = 385,
    OF_OXM_BSN_UDF3 = 386,
    OF_OXM_BSN_UDF3_MASKED = 387,
    OF_OXM_BSN_UDF4 = 388,
    OF_OXM_BSN_UDF4_MASKED = 389,
    OF_OXM_BSN_UDF5 = 390,
    OF_OXM_BSN_UDF5_MASKED = 391,
    OF_OXM_BSN_UDF6 = 392,
    OF_OXM_BSN_UDF6_MASKED = 393,
    OF_OXM_BSN_UDF7 = 394,
    OF_OXM_BSN_UDF7_MASKED = 395,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 396,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 397,
    OF_OXM_BSN_VRF = 398,
    OF_OXM_BSN_VRF_MASKED = 399,
    OF_OXM_ETH_DST = 400,
    OF_OXM_ETH_DST_MASKED = 401,
    OF_OXM_ETH_SRC = 402,
    OF_OXM_ETH_SRC_MASKED = 403,
    OF_OXM_ETH_TYPE = 404,
    OF_OXM_ETH_TYPE_MASKED = 405,
    OF_OXM_HEADER = 406,
    OF_OXM_ICMPV4_CODE = 407,
    OF_OXM_ICMPV4_CODE_MASKED = 408,
    OF_OXM_ICMPV4_TYPE = 409,
    OF_OXM_ICMPV4_TYPE_MASKED = 410,
    OF_OXM_ICMPV6_CODE = 411,
    OF_OXM_ICMPV6_CODE_MASKED = 412,
    OF_OXM_ICMPV6_TYPE = 413,
    OF_OXM_ICMPV6_TYPE_MASKED = 414,
    OF_OXM_IN_PHY_PORT = 415,
    OF_OXM_IN_PHY_PORT_MASKED = 416,
    OF_OXM_IN_PORT = 417,
    OF_OXM_IN_PORT_MASKED = 418,
    OF_OXM_IP_DSCP = 419,
    OF_OXM_IP_DSCP_MASKED = 420,
    OF_OXM_IP_ECN = 421,
    OF_OXM_IP_ECN_MASKED = 422,
    OF_OXM_IP_PROTO = 423,
    OF_OXM_IP_PROTO_MASKED = 424,
    OF_OXM_IPV4_DST = 425,
    OF_OXM_IPV4_DST_MASKED = 426,
    OF_OXM_IPV4_SRC = 427,
    OF_OXM_IPV4_SRC_MASKED = 428,
    OF_OXM_IPV6_DST = 429,
    OF_OXM_IPV6_DST_MASKED = 430,
    OF_OXM_IPV6_FLABEL = 431,
    OF_OXM_IPV6_FLABEL_MASKED = 432,
    OF_OXM_IPV6_ND_SLL = 433,
    OF_OXM_IPV6_ND_SLL_MASKED = 434,
    OF_OXM_IPV6_ND_TARGET = 435,
    OF_OXM_IPV6_ND_TARGET_MASKED = 436,
    OF_OXM_IPV6_ND_TLL = 437,
    OF_OXM_IPV6_ND_TLL_MASKED = 438,
    OF_OXM_IPV6_SRC = 439,
    OF_OXM_IPV6_SRC_MASKED = 440,
    OF_OXM_METADATA = 441,
    OF_OXM_METADATA_MASKED = 442,
    OF_OXM_MPLS_LABEL = 443,
    OF_OXM_MPLS_LABEL_MASKED = 444,
    OF_OXM_MPLS_TC = 445,
    OF_OXM_MPLS_TC_MASKED = 446,
    OF_OXM_SCTP_DST = 447,
    OF_OXM_SCTP_DST_MASKED = 448,
    OF_OXM_SCTP_SRC = 449,
    OF_OXM_SCTP_SRC_MASKED = 450,
    OF_OXM_TCP_DST = 451,
    OF_OXM_TCP_DST_MASKED = 452,
    OF_OXM_TCP_SRC = 453,
    OF_OXM_TCP_SRC_MASKED = 454,
    OF_OXM_TUNNEL_ID = 455,
    OF_OXM_TUNNEL_ID_MASKED = 456,
    OF_OXM_UDP_DST = 457,
    OF_OXM_UDP_DST_MASKED = 458,
    OF_OXM_UDP_SRC = 459,
    OF_OXM_UDP_SRC_MASKED = 460,
    OF_OXM_VLAN_PCP = 461,
    OF_OXM_VLAN_PCP_MASKED = 462,
    OF_OXM_VLAN_VID = 463,
    OF_OXM_VLAN_VID_MASKED = 464,
    OF_PACKET_QUEUE = 465,
    OF_PORT_DESC = 466,
    OF_PORT_STATS_ENTRY = 467,
    OF_QUEUE_PROP = 468,
    OF_QUEUE_PROP_EXPERIMENTER = 469,
    OF_QUEUE_PROP_HEADER = 470,
    OF_QUEUE_PROP_MAX_RATE = 471,
    OF_QUEUE_PROP_MIN_RATE = 472,
    OF_QUEUE_STATS_ENTRY = 473,
    OF_TABLE_FEATURE_PROP = 474,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 475,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 476,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 477,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 478,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 479,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 480,
    OF_TABLE_FEATURE_PROP_HEADER = 481,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 482,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 483,
    OF_TABLE_FEATURE_PROP_MATCH = 484,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 485,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 486,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 487,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 488,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 489,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 490,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 491,
    OF_TABLE_FEATURES = 492,
    OF_TABLE_STATS_ENTRY = 493,
    OF_UINT32 = 494,
    OF_UINT64 = 495,
    OF_UINT8 = 496,
    ...
    /* List objects */
    OF_LIST_ACTION = 497,
    OF_LIST_ACTION_ID = 498,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 499,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 500,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 501,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 502,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 503,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 504,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 505,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 506,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 507,
    OF_LIST_BSN_INTERFACE = 508,
    OF_LIST_BSN_LACP_STATS_ENTRY = 509,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 510,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 511,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 512,
    OF_LIST_BSN_TLV = 513,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 514,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 515,
    OF_LIST_BUCKET = 516,
    OF_LIST_BUCKET_COUNTER = 517,
    OF_LIST_FLOW_STATS_ENTRY = 518,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 519,
    OF_LIST_GROUP_STATS_ENTRY = 520,
    OF_LIST_HELLO_ELEM = 521,
    OF_LIST_INSTRUCTION = 522,
    OF_LIST_INSTRUCTION_ID = 523,
    OF_LIST_METER_BAND = 524,
    OF_LIST_METER_BAND_STATS = 525,
    OF_LIST_METER_STATS = 526,
    OF_LIST_OXM = 527,
    OF_LIST_PACKET_QUEUE = 528,
    OF_LIST_PORT_DESC = 529,
    OF_LIST_PORT_STATS_ENTRY = 530,
    OF_LIST_QUEUE_PROP = 531,
    OF_LIST_QUEUE_STATS_ENTRY = 532,
    OF_LIST_TABLE_FEATURE_PROP = 533,
    OF_LIST_TABLE_FEATURES = 534,
    OF_LIST_TABLE_STATS_ENTRY = 535,
    OF_LIST_UINT32 = 536,
    OF_LIST_UINT64 = 537,
    OF_LIST_UINT8 = 538,
