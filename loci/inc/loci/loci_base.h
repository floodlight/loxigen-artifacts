...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_BUCKET = 307,
    OF_BSN_TLV_CIRCUIT_ID = 308,
    OF_BSN_TLV_CONVERGENCE_STATUS = 309,
    OF_BSN_TLV_CRC_ENABLED = 310,
    OF_BSN_TLV_DATA = 311,
    OF_BSN_TLV_DECAP = 312,
    OF_BSN_TLV_ETH_DST = 313,
    OF_BSN_TLV_ETH_SRC = 314,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 315,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 316,
    OF_BSN_TLV_EXTERNAL_IP = 317,
    OF_BSN_TLV_EXTERNAL_MAC = 318,
    OF_BSN_TLV_EXTERNAL_NETMASK = 319,
    OF_BSN_TLV_GENERATION_ID = 320,
    OF_BSN_TLV_HEADER_SIZE = 321,
    OF_BSN_TLV_ICMP_CODE = 322,
    OF_BSN_TLV_ICMP_ID = 323,
    OF_BSN_TLV_ICMP_TYPE = 324,
    OF_BSN_TLV_IDLE_NOTIFICATION = 325,
    OF_BSN_TLV_IDLE_TIME = 326,
    OF_BSN_TLV_IDLE_TIMEOUT = 327,
    OF_BSN_TLV_IGMP_SNOOPING = 328,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 329,
    OF_BSN_TLV_INTERNAL_MAC = 330,
    OF_BSN_TLV_INTERVAL = 331,
    OF_BSN_TLV_IP_PROTO = 332,
    OF_BSN_TLV_IPV4 = 333,
    OF_BSN_TLV_IPV4_DST = 334,
    OF_BSN_TLV_IPV4_NETMASK = 335,
    OF_BSN_TLV_IPV4_SRC = 336,
    OF_BSN_TLV_IPV6 = 337,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 338,
    OF_BSN_TLV_MAC = 339,
    OF_BSN_TLV_MAC_MASK = 340,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 341,
    OF_BSN_TLV_MISS_PACKETS = 342,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 343,
    OF_BSN_TLV_MPLS_LABEL = 344,
    OF_BSN_TLV_MPLS_SEQUENCED = 345,
    OF_BSN_TLV_NAME = 346,
    OF_BSN_TLV_NEGATE = 347,
    OF_BSN_TLV_OFFSET = 348,
    OF_BSN_TLV_PARTNER_KEY = 349,
    OF_BSN_TLV_PARTNER_PORT_NUM = 350,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 351,
    OF_BSN_TLV_PARTNER_STATE = 352,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 353,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 354,
    OF_BSN_TLV_PORT = 355,
    OF_BSN_TLV_PORT_VXLAN_MODE = 356,
    OF_BSN_TLV_PRIORITY = 357,
    OF_BSN_TLV_QUEUE_ID = 358,
    OF_BSN_TLV_QUEUE_WEIGHT = 359,
    OF_BSN_TLV_REFERENCE = 360,
    OF_BSN_TLV_REPLY_PACKETS = 361,
    OF_BSN_TLV_REQUEST_PACKETS = 362,
    OF_BSN_TLV_RX_BYTES = 363,
    OF_BSN_TLV_RX_PACKETS = 364,
    OF_BSN_TLV_SAMPLING_RATE = 365,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 366,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 367,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 368,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 369,
    OF_BSN_TLV_SUB_AGENT_ID = 370,
    OF_BSN_TLV_TCP_DST = 371,
    OF_BSN_TLV_TCP_SRC = 372,
    OF_BSN_TLV_TX_BYTES = 373,
    OF_BSN_TLV_TX_PACKETS = 374,
    OF_BSN_TLV_UDF_ANCHOR = 375,
    OF_BSN_TLV_UDF_ID = 376,
    OF_BSN_TLV_UDF_LENGTH = 377,
    OF_BSN_TLV_UDF_OFFSET = 378,
    OF_BSN_TLV_UDP_DST = 379,
    OF_BSN_TLV_UDP_SRC = 380,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 381,
    OF_BSN_TLV_VLAN_PCP = 382,
    OF_BSN_TLV_VLAN_VID = 383,
    OF_BSN_TLV_VLAN_VID_MASK = 384,
    OF_BSN_TLV_VNI = 385,
    OF_BSN_TLV_VRF = 386,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 387,
    OF_BSN_VPORT = 388,
    OF_BSN_VPORT_L2GRE = 389,
    OF_BSN_VPORT_Q_IN_Q = 390,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 391,
    OF_BUCKET = 392,
    OF_BUCKET_COUNTER = 393,
    OF_BUNDLE_PROP = 394,
    OF_BUNDLE_PROP_EXPERIMENTER = 395,
    OF_FLOW_STATS_ENTRY = 396,
    OF_GROUP_DESC_STATS_ENTRY = 397,
    OF_GROUP_STATS_ENTRY = 398,
    OF_HELLO_ELEM = 399,
    OF_HELLO_ELEM_VERSIONBITMAP = 400,
    OF_INSTRUCTION = 401,
    OF_INSTRUCTION_APPLY_ACTIONS = 402,
    OF_INSTRUCTION_BSN = 403,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 404,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 405,
    OF_INSTRUCTION_BSN_DENY = 406,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 407,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 408,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 409,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 410,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 411,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 412,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 413,
    OF_INSTRUCTION_BSN_PERMIT = 414,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 415,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 416,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 417,
    OF_INSTRUCTION_CLEAR_ACTIONS = 418,
    OF_INSTRUCTION_EXPERIMENTER = 419,
    OF_INSTRUCTION_GOTO_TABLE = 420,
    OF_INSTRUCTION_ID = 421,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 422,
    OF_INSTRUCTION_ID_BSN = 423,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 424,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 425,
    OF_INSTRUCTION_ID_BSN_DENY = 426,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 427,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 428,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 429,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 430,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 431,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 432,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 433,
    OF_INSTRUCTION_ID_BSN_PERMIT = 434,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 435,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 436,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 437,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 438,
    OF_INSTRUCTION_ID_EXPERIMENTER = 439,
    OF_INSTRUCTION_ID_GOTO_TABLE = 440,
    OF_INSTRUCTION_ID_METER = 441,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 442,
    OF_INSTRUCTION_ID_WRITE_METADATA = 443,
    OF_INSTRUCTION_METER = 444,
    OF_INSTRUCTION_WRITE_ACTIONS = 445,
    OF_INSTRUCTION_WRITE_METADATA = 446,
    OF_MATCH_V1 = 447,
    OF_MATCH_V2 = 448,
    OF_MATCH_V3 = 449,
    OF_METER_BAND = 450,
    OF_METER_BAND_DROP = 451,
    OF_METER_BAND_DSCP_REMARK = 452,
    OF_METER_BAND_EXPERIMENTER = 453,
    OF_METER_BAND_STATS = 454,
    OF_METER_CONFIG = 455,
    OF_METER_FEATURES = 456,
    OF_METER_STATS = 457,
    OF_OXM = 458,
    OF_OXM_ARP_OP = 459,
    OF_OXM_ARP_OP_MASKED = 460,
    OF_OXM_ARP_SHA = 461,
    OF_OXM_ARP_SHA_MASKED = 462,
    OF_OXM_ARP_SPA = 463,
    OF_OXM_ARP_SPA_MASKED = 464,
    OF_OXM_ARP_THA = 465,
    OF_OXM_ARP_THA_MASKED = 466,
    OF_OXM_ARP_TPA = 467,
    OF_OXM_ARP_TPA_MASKED = 468,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 469,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 470,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 471,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 472,
    OF_OXM_BSN_IN_PORTS_128 = 473,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 474,
    OF_OXM_BSN_IN_PORTS_512 = 475,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 476,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 477,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 478,
    OF_OXM_BSN_INNER_ETH_DST = 479,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 480,
    OF_OXM_BSN_INNER_ETH_SRC = 481,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 482,
    OF_OXM_BSN_INNER_VLAN_VID = 483,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 484,
    OF_OXM_BSN_L2_CACHE_HIT = 485,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 486,
    OF_OXM_BSN_L3_DST_CLASS_ID = 487,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 488,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 489,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 490,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 491,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 492,
    OF_OXM_BSN_LAG_ID = 493,
    OF_OXM_BSN_LAG_ID_MASKED = 494,
    OF_OXM_BSN_TCP_FLAGS = 495,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 496,
    OF_OXM_BSN_UDF0 = 497,
    OF_OXM_BSN_UDF0_MASKED = 498,
    OF_OXM_BSN_UDF1 = 499,
    OF_OXM_BSN_UDF1_MASKED = 500,
    OF_OXM_BSN_UDF2 = 501,
    OF_OXM_BSN_UDF2_MASKED = 502,
    OF_OXM_BSN_UDF3 = 503,
    OF_OXM_BSN_UDF3_MASKED = 504,
    OF_OXM_BSN_UDF4 = 505,
    OF_OXM_BSN_UDF4_MASKED = 506,
    OF_OXM_BSN_UDF5 = 507,
    OF_OXM_BSN_UDF5_MASKED = 508,
    OF_OXM_BSN_UDF6 = 509,
    OF_OXM_BSN_UDF6_MASKED = 510,
    OF_OXM_BSN_UDF7 = 511,
    OF_OXM_BSN_UDF7_MASKED = 512,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 513,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 514,
    OF_OXM_BSN_VRF = 515,
    OF_OXM_BSN_VRF_MASKED = 516,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 517,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 518,
    OF_OXM_ETH_DST = 519,
    OF_OXM_ETH_DST_MASKED = 520,
    OF_OXM_ETH_SRC = 521,
    OF_OXM_ETH_SRC_MASKED = 522,
    OF_OXM_ETH_TYPE = 523,
    OF_OXM_ETH_TYPE_MASKED = 524,
    OF_OXM_ICMPV4_CODE = 525,
    OF_OXM_ICMPV4_CODE_MASKED = 526,
    OF_OXM_ICMPV4_TYPE = 527,
    OF_OXM_ICMPV4_TYPE_MASKED = 528,
    OF_OXM_ICMPV6_CODE = 529,
    OF_OXM_ICMPV6_CODE_MASKED = 530,
    OF_OXM_ICMPV6_TYPE = 531,
    OF_OXM_ICMPV6_TYPE_MASKED = 532,
    OF_OXM_IN_PHY_PORT = 533,
    OF_OXM_IN_PHY_PORT_MASKED = 534,
    OF_OXM_IN_PORT = 535,
    OF_OXM_IN_PORT_MASKED = 536,
    OF_OXM_IP_DSCP = 537,
    OF_OXM_IP_DSCP_MASKED = 538,
    OF_OXM_IP_ECN = 539,
    OF_OXM_IP_ECN_MASKED = 540,
    OF_OXM_IP_PROTO = 541,
    OF_OXM_IP_PROTO_MASKED = 542,
    OF_OXM_IPV4_DST = 543,
    OF_OXM_IPV4_DST_MASKED = 544,
    OF_OXM_IPV4_SRC = 545,
    OF_OXM_IPV4_SRC_MASKED = 546,
    OF_OXM_IPV6_DST = 547,
    OF_OXM_IPV6_DST_MASKED = 548,
    OF_OXM_IPV6_EXTHDR = 549,
    OF_OXM_IPV6_EXTHDR_MASKED = 550,
    OF_OXM_IPV6_FLABEL = 551,
    OF_OXM_IPV6_FLABEL_MASKED = 552,
    OF_OXM_IPV6_ND_SLL = 553,
    OF_OXM_IPV6_ND_SLL_MASKED = 554,
    OF_OXM_IPV6_ND_TARGET = 555,
    OF_OXM_IPV6_ND_TARGET_MASKED = 556,
    OF_OXM_IPV6_ND_TLL = 557,
    OF_OXM_IPV6_ND_TLL_MASKED = 558,
    OF_OXM_IPV6_SRC = 559,
    OF_OXM_IPV6_SRC_MASKED = 560,
    OF_OXM_METADATA = 561,
    OF_OXM_METADATA_MASKED = 562,
    OF_OXM_MPLS_BOS = 563,
    OF_OXM_MPLS_BOS_MASKED = 564,
    OF_OXM_MPLS_LABEL = 565,
    OF_OXM_MPLS_LABEL_MASKED = 566,
    OF_OXM_MPLS_TC = 567,
    OF_OXM_MPLS_TC_MASKED = 568,
    OF_OXM_PBB_UCA = 569,
    OF_OXM_PBB_UCA_MASKED = 570,
    OF_OXM_SCTP_DST = 571,
    OF_OXM_SCTP_DST_MASKED = 572,
    OF_OXM_SCTP_SRC = 573,
    OF_OXM_SCTP_SRC_MASKED = 574,
    OF_OXM_TCP_DST = 575,
    OF_OXM_TCP_DST_MASKED = 576,
    OF_OXM_TCP_SRC = 577,
    OF_OXM_TCP_SRC_MASKED = 578,
    OF_OXM_TUNNEL_ID = 579,
    OF_OXM_TUNNEL_ID_MASKED = 580,
    OF_OXM_TUNNEL_IPV4_DST = 581,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 582,
    OF_OXM_TUNNEL_IPV4_SRC = 583,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 584,
    OF_OXM_UDP_DST = 585,
    OF_OXM_UDP_DST_MASKED = 586,
    OF_OXM_UDP_SRC = 587,
    OF_OXM_UDP_SRC_MASKED = 588,
    OF_OXM_VLAN_PCP = 589,
    OF_OXM_VLAN_PCP_MASKED = 590,
    OF_OXM_VLAN_VID = 591,
    OF_OXM_VLAN_VID_MASKED = 592,
    OF_PACKET_QUEUE = 593,
    OF_PORT_DESC = 594,
    OF_PORT_DESC_PROP = 595,
    OF_PORT_DESC_PROP_BSN = 596,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 597,
    OF_PORT_DESC_PROP_BSN_UPLINK = 598,
    OF_PORT_DESC_PROP_ETHERNET = 599,
    OF_PORT_DESC_PROP_EXPERIMENTER = 600,
    OF_PORT_DESC_PROP_OPTICAL = 601,
    OF_PORT_MOD_PROP = 602,
    OF_PORT_MOD_PROP_ETHERNET = 603,
    OF_PORT_MOD_PROP_EXPERIMENTER = 604,
    OF_PORT_MOD_PROP_OPTICAL = 605,
    OF_PORT_STATS_ENTRY = 606,
    OF_PORT_STATS_PROP = 607,
    OF_PORT_STATS_PROP_ETHERNET = 608,
    OF_PORT_STATS_PROP_EXPERIMENTER = 609,
    OF_PORT_STATS_PROP_OPTICAL = 610,
    OF_QUEUE_DESC = 611,
    OF_QUEUE_DESC_PROP = 612,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 613,
    OF_QUEUE_DESC_PROP_MAX_RATE = 614,
    OF_QUEUE_DESC_PROP_MIN_RATE = 615,
    OF_QUEUE_PROP = 616,
    OF_QUEUE_PROP_EXPERIMENTER = 617,
    OF_QUEUE_PROP_MAX_RATE = 618,
    OF_QUEUE_PROP_MIN_RATE = 619,
    OF_QUEUE_STATS_ENTRY = 620,
    OF_QUEUE_STATS_PROP = 621,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 622,
    OF_ROLE_PROP = 623,
    OF_ROLE_PROP_EXPERIMENTER = 624,
    OF_TABLE_DESC = 625,
    OF_TABLE_FEATURE_PROP = 626,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 627,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 628,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 629,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 630,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 631,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 632,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 633,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 634,
    OF_TABLE_FEATURE_PROP_MATCH = 635,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 636,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 637,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 638,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 639,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 640,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 641,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 642,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 643,
    OF_TABLE_FEATURES = 644,
    OF_TABLE_MOD_PROP = 645,
    OF_TABLE_MOD_PROP_EVICTION = 646,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 647,
    OF_TABLE_MOD_PROP_VACANCY = 648,
    OF_TABLE_STATS_ENTRY = 649,
    OF_UINT32 = 650,
    OF_UINT64 = 651,
    OF_UINT8 = 652,
    ...
    /* List objects */
    OF_LIST_ACTION = 653,
    OF_LIST_ACTION_ID = 654,
    OF_LIST_ASYNC_CONFIG_PROP = 655,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 656,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 657,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 658,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 659,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 660,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 661,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 662,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 663,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 664,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 665,
    OF_LIST_BSN_INTERFACE = 666,
    OF_LIST_BSN_LACP_STATS_ENTRY = 667,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 668,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 669,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 670,
    OF_LIST_BSN_TLV = 671,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 672,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 673,
    OF_LIST_BUCKET = 674,
    OF_LIST_BUCKET_COUNTER = 675,
    OF_LIST_BUNDLE_PROP = 676,
    OF_LIST_FLOW_STATS_ENTRY = 677,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 678,
    OF_LIST_GROUP_STATS_ENTRY = 679,
    OF_LIST_HELLO_ELEM = 680,
    OF_LIST_INSTRUCTION = 681,
    OF_LIST_INSTRUCTION_ID = 682,
    OF_LIST_METER_BAND = 683,
    OF_LIST_METER_BAND_STATS = 684,
    OF_LIST_METER_CONFIG = 685,
    OF_LIST_METER_STATS = 686,
    OF_LIST_OXM = 687,
    OF_LIST_PACKET_QUEUE = 688,
    OF_LIST_PORT_DESC = 689,
    OF_LIST_PORT_DESC_PROP = 690,
    OF_LIST_PORT_MOD_PROP = 691,
    OF_LIST_PORT_STATS_ENTRY = 692,
    OF_LIST_PORT_STATS_PROP = 693,
    OF_LIST_QUEUE_DESC = 694,
    OF_LIST_QUEUE_DESC_PROP = 695,
    OF_LIST_QUEUE_PROP = 696,
    OF_LIST_QUEUE_STATS_ENTRY = 697,
    OF_LIST_QUEUE_STATS_PROP = 698,
    OF_LIST_ROLE_PROP = 699,
    OF_LIST_TABLE_DESC = 700,
    OF_LIST_TABLE_FEATURE_PROP = 701,
    OF_LIST_TABLE_FEATURES = 702,
    OF_LIST_TABLE_MOD_PROP = 703,
    OF_LIST_TABLE_STATS_ENTRY = 704,
    OF_LIST_UINT32 = 705,
    OF_LIST_UINT64 = 706,
    OF_LIST_UINT8 = 707,
