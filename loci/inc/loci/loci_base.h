...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_OFFSET = 350,
    OF_BSN_TLV_PARTNER_KEY = 351,
    OF_BSN_TLV_PARTNER_PORT_NUM = 352,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 353,
    OF_BSN_TLV_PARTNER_STATE = 354,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 355,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 356,
    OF_BSN_TLV_PORT = 357,
    OF_BSN_TLV_PORT_VXLAN_MODE = 358,
    OF_BSN_TLV_PRIORITY = 359,
    OF_BSN_TLV_QUEUE_ID = 360,
    OF_BSN_TLV_QUEUE_WEIGHT = 361,
    OF_BSN_TLV_RATE_UNIT = 362,
    OF_BSN_TLV_REFERENCE = 363,
    OF_BSN_TLV_REPLY_PACKETS = 364,
    OF_BSN_TLV_REQUEST_PACKETS = 365,
    OF_BSN_TLV_RX_BYTES = 366,
    OF_BSN_TLV_RX_PACKETS = 367,
    OF_BSN_TLV_SAMPLING_RATE = 368,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 369,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 370,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 371,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 372,
    OF_BSN_TLV_SUB_AGENT_ID = 373,
    OF_BSN_TLV_TCP_DST = 374,
    OF_BSN_TLV_TCP_SRC = 375,
    OF_BSN_TLV_TX_BYTES = 376,
    OF_BSN_TLV_TX_PACKETS = 377,
    OF_BSN_TLV_UDF_ANCHOR = 378,
    OF_BSN_TLV_UDF_ID = 379,
    OF_BSN_TLV_UDF_LENGTH = 380,
    OF_BSN_TLV_UDF_OFFSET = 381,
    OF_BSN_TLV_UDP_DST = 382,
    OF_BSN_TLV_UDP_SRC = 383,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 384,
    OF_BSN_TLV_UNICAST_RATE = 385,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 386,
    OF_BSN_TLV_VLAN_PCP = 387,
    OF_BSN_TLV_VLAN_VID = 388,
    OF_BSN_TLV_VLAN_VID_MASK = 389,
    OF_BSN_TLV_VNI = 390,
    OF_BSN_TLV_VRF = 391,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 392,
    OF_BSN_VPORT = 393,
    OF_BSN_VPORT_L2GRE = 394,
    OF_BSN_VPORT_Q_IN_Q = 395,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 396,
    OF_BUCKET = 397,
    OF_BUCKET_COUNTER = 398,
    OF_BUNDLE_PROP = 399,
    OF_BUNDLE_PROP_EXPERIMENTER = 400,
    OF_FLOW_STATS_ENTRY = 401,
    OF_GROUP_DESC_STATS_ENTRY = 402,
    OF_GROUP_STATS_ENTRY = 403,
    OF_HELLO_ELEM = 404,
    OF_HELLO_ELEM_VERSIONBITMAP = 405,
    OF_INSTRUCTION = 406,
    OF_INSTRUCTION_APPLY_ACTIONS = 407,
    OF_INSTRUCTION_BSN = 408,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 409,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 410,
    OF_INSTRUCTION_BSN_DENY = 411,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 412,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 413,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 414,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 415,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 416,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 417,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 418,
    OF_INSTRUCTION_BSN_PERMIT = 419,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 420,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 421,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 422,
    OF_INSTRUCTION_CLEAR_ACTIONS = 423,
    OF_INSTRUCTION_EXPERIMENTER = 424,
    OF_INSTRUCTION_GOTO_TABLE = 425,
    OF_INSTRUCTION_ID = 426,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 427,
    OF_INSTRUCTION_ID_BSN = 428,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 429,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 430,
    OF_INSTRUCTION_ID_BSN_DENY = 431,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 432,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 433,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 434,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 435,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 436,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 437,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 438,
    OF_INSTRUCTION_ID_BSN_PERMIT = 439,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 440,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 441,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 442,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 443,
    OF_INSTRUCTION_ID_EXPERIMENTER = 444,
    OF_INSTRUCTION_ID_GOTO_TABLE = 445,
    OF_INSTRUCTION_ID_METER = 446,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 447,
    OF_INSTRUCTION_ID_WRITE_METADATA = 448,
    OF_INSTRUCTION_METER = 449,
    OF_INSTRUCTION_WRITE_ACTIONS = 450,
    OF_INSTRUCTION_WRITE_METADATA = 451,
    OF_MATCH_V1 = 452,
    OF_MATCH_V2 = 453,
    OF_MATCH_V3 = 454,
    OF_METER_BAND = 455,
    OF_METER_BAND_DROP = 456,
    OF_METER_BAND_DSCP_REMARK = 457,
    OF_METER_BAND_EXPERIMENTER = 458,
    OF_METER_BAND_STATS = 459,
    OF_METER_CONFIG = 460,
    OF_METER_FEATURES = 461,
    OF_METER_STATS = 462,
    OF_OXM = 463,
    OF_OXM_ARP_OP = 464,
    OF_OXM_ARP_OP_MASKED = 465,
    OF_OXM_ARP_SHA = 466,
    OF_OXM_ARP_SHA_MASKED = 467,
    OF_OXM_ARP_SPA = 468,
    OF_OXM_ARP_SPA_MASKED = 469,
    OF_OXM_ARP_THA = 470,
    OF_OXM_ARP_THA_MASKED = 471,
    OF_OXM_ARP_TPA = 472,
    OF_OXM_ARP_TPA_MASKED = 473,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 474,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 475,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 476,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 477,
    OF_OXM_BSN_IN_PORTS_128 = 478,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 479,
    OF_OXM_BSN_IN_PORTS_512 = 480,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 481,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 482,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 483,
    OF_OXM_BSN_INNER_ETH_DST = 484,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 485,
    OF_OXM_BSN_INNER_ETH_SRC = 486,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 487,
    OF_OXM_BSN_INNER_VLAN_VID = 488,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 489,
    OF_OXM_BSN_L2_CACHE_HIT = 490,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 491,
    OF_OXM_BSN_L3_DST_CLASS_ID = 492,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 493,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 494,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 495,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 496,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 497,
    OF_OXM_BSN_LAG_ID = 498,
    OF_OXM_BSN_LAG_ID_MASKED = 499,
    OF_OXM_BSN_TCP_FLAGS = 500,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 501,
    OF_OXM_BSN_UDF0 = 502,
    OF_OXM_BSN_UDF0_MASKED = 503,
    OF_OXM_BSN_UDF1 = 504,
    OF_OXM_BSN_UDF1_MASKED = 505,
    OF_OXM_BSN_UDF2 = 506,
    OF_OXM_BSN_UDF2_MASKED = 507,
    OF_OXM_BSN_UDF3 = 508,
    OF_OXM_BSN_UDF3_MASKED = 509,
    OF_OXM_BSN_UDF4 = 510,
    OF_OXM_BSN_UDF4_MASKED = 511,
    OF_OXM_BSN_UDF5 = 512,
    OF_OXM_BSN_UDF5_MASKED = 513,
    OF_OXM_BSN_UDF6 = 514,
    OF_OXM_BSN_UDF6_MASKED = 515,
    OF_OXM_BSN_UDF7 = 516,
    OF_OXM_BSN_UDF7_MASKED = 517,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 518,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 519,
    OF_OXM_BSN_VRF = 520,
    OF_OXM_BSN_VRF_MASKED = 521,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 522,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 523,
    OF_OXM_ETH_DST = 524,
    OF_OXM_ETH_DST_MASKED = 525,
    OF_OXM_ETH_SRC = 526,
    OF_OXM_ETH_SRC_MASKED = 527,
    OF_OXM_ETH_TYPE = 528,
    OF_OXM_ETH_TYPE_MASKED = 529,
    OF_OXM_ICMPV4_CODE = 530,
    OF_OXM_ICMPV4_CODE_MASKED = 531,
    OF_OXM_ICMPV4_TYPE = 532,
    OF_OXM_ICMPV4_TYPE_MASKED = 533,
    OF_OXM_ICMPV6_CODE = 534,
    OF_OXM_ICMPV6_CODE_MASKED = 535,
    OF_OXM_ICMPV6_TYPE = 536,
    OF_OXM_ICMPV6_TYPE_MASKED = 537,
    OF_OXM_IN_PHY_PORT = 538,
    OF_OXM_IN_PHY_PORT_MASKED = 539,
    OF_OXM_IN_PORT = 540,
    OF_OXM_IN_PORT_MASKED = 541,
    OF_OXM_IP_DSCP = 542,
    OF_OXM_IP_DSCP_MASKED = 543,
    OF_OXM_IP_ECN = 544,
    OF_OXM_IP_ECN_MASKED = 545,
    OF_OXM_IP_PROTO = 546,
    OF_OXM_IP_PROTO_MASKED = 547,
    OF_OXM_IPV4_DST = 548,
    OF_OXM_IPV4_DST_MASKED = 549,
    OF_OXM_IPV4_SRC = 550,
    OF_OXM_IPV4_SRC_MASKED = 551,
    OF_OXM_IPV6_DST = 552,
    OF_OXM_IPV6_DST_MASKED = 553,
    OF_OXM_IPV6_EXTHDR = 554,
    OF_OXM_IPV6_EXTHDR_MASKED = 555,
    OF_OXM_IPV6_FLABEL = 556,
    OF_OXM_IPV6_FLABEL_MASKED = 557,
    OF_OXM_IPV6_ND_SLL = 558,
    OF_OXM_IPV6_ND_SLL_MASKED = 559,
    OF_OXM_IPV6_ND_TARGET = 560,
    OF_OXM_IPV6_ND_TARGET_MASKED = 561,
    OF_OXM_IPV6_ND_TLL = 562,
    OF_OXM_IPV6_ND_TLL_MASKED = 563,
    OF_OXM_IPV6_SRC = 564,
    OF_OXM_IPV6_SRC_MASKED = 565,
    OF_OXM_METADATA = 566,
    OF_OXM_METADATA_MASKED = 567,
    OF_OXM_MPLS_BOS = 568,
    OF_OXM_MPLS_BOS_MASKED = 569,
    OF_OXM_MPLS_LABEL = 570,
    OF_OXM_MPLS_LABEL_MASKED = 571,
    OF_OXM_MPLS_TC = 572,
    OF_OXM_MPLS_TC_MASKED = 573,
    OF_OXM_PBB_UCA = 574,
    OF_OXM_PBB_UCA_MASKED = 575,
    OF_OXM_SCTP_DST = 576,
    OF_OXM_SCTP_DST_MASKED = 577,
    OF_OXM_SCTP_SRC = 578,
    OF_OXM_SCTP_SRC_MASKED = 579,
    OF_OXM_TCP_DST = 580,
    OF_OXM_TCP_DST_MASKED = 581,
    OF_OXM_TCP_SRC = 582,
    OF_OXM_TCP_SRC_MASKED = 583,
    OF_OXM_TUNNEL_ID = 584,
    OF_OXM_TUNNEL_ID_MASKED = 585,
    OF_OXM_TUNNEL_IPV4_DST = 586,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 587,
    OF_OXM_TUNNEL_IPV4_SRC = 588,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 589,
    OF_OXM_UDP_DST = 590,
    OF_OXM_UDP_DST_MASKED = 591,
    OF_OXM_UDP_SRC = 592,
    OF_OXM_UDP_SRC_MASKED = 593,
    OF_OXM_VLAN_PCP = 594,
    OF_OXM_VLAN_PCP_MASKED = 595,
    OF_OXM_VLAN_VID = 596,
    OF_OXM_VLAN_VID_MASKED = 597,
    OF_PACKET_QUEUE = 598,
    OF_PORT_DESC = 599,
    OF_PORT_DESC_PROP = 600,
    OF_PORT_DESC_PROP_BSN = 601,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 602,
    OF_PORT_DESC_PROP_BSN_UPLINK = 603,
    OF_PORT_DESC_PROP_ETHERNET = 604,
    OF_PORT_DESC_PROP_EXPERIMENTER = 605,
    OF_PORT_DESC_PROP_OPTICAL = 606,
    OF_PORT_MOD_PROP = 607,
    OF_PORT_MOD_PROP_ETHERNET = 608,
    OF_PORT_MOD_PROP_EXPERIMENTER = 609,
    OF_PORT_MOD_PROP_OPTICAL = 610,
    OF_PORT_STATS_ENTRY = 611,
    OF_PORT_STATS_PROP = 612,
    OF_PORT_STATS_PROP_ETHERNET = 613,
    OF_PORT_STATS_PROP_EXPERIMENTER = 614,
    OF_PORT_STATS_PROP_OPTICAL = 615,
    OF_QUEUE_DESC = 616,
    OF_QUEUE_DESC_PROP = 617,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 618,
    OF_QUEUE_DESC_PROP_MAX_RATE = 619,
    OF_QUEUE_DESC_PROP_MIN_RATE = 620,
    OF_QUEUE_PROP = 621,
    OF_QUEUE_PROP_EXPERIMENTER = 622,
    OF_QUEUE_PROP_MAX_RATE = 623,
    OF_QUEUE_PROP_MIN_RATE = 624,
    OF_QUEUE_STATS_ENTRY = 625,
    OF_QUEUE_STATS_PROP = 626,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 627,
    OF_ROLE_PROP = 628,
    OF_ROLE_PROP_EXPERIMENTER = 629,
    OF_TABLE_DESC = 630,
    OF_TABLE_FEATURE_PROP = 631,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 632,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 633,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 634,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 635,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 636,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 637,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 638,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 639,
    OF_TABLE_FEATURE_PROP_MATCH = 640,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 641,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 642,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 643,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 644,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 645,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 646,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 647,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 648,
    OF_TABLE_FEATURES = 649,
    OF_TABLE_MOD_PROP = 650,
    OF_TABLE_MOD_PROP_EVICTION = 651,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 652,
    OF_TABLE_MOD_PROP_VACANCY = 653,
    OF_TABLE_STATS_ENTRY = 654,
    OF_UINT32 = 655,
    OF_UINT64 = 656,
    OF_UINT8 = 657,
    ...
    /* List objects */
    OF_LIST_ACTION = 658,
    OF_LIST_ACTION_ID = 659,
    OF_LIST_ASYNC_CONFIG_PROP = 660,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 661,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 662,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 663,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 664,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 665,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 666,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 667,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 668,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 669,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 670,
    OF_LIST_BSN_INTERFACE = 671,
    OF_LIST_BSN_LACP_STATS_ENTRY = 672,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 673,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 674,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 675,
    OF_LIST_BSN_TLV = 676,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 677,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 678,
    OF_LIST_BUCKET = 679,
    OF_LIST_BUCKET_COUNTER = 680,
    OF_LIST_BUNDLE_PROP = 681,
    OF_LIST_FLOW_STATS_ENTRY = 682,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 683,
    OF_LIST_GROUP_STATS_ENTRY = 684,
    OF_LIST_HELLO_ELEM = 685,
    OF_LIST_INSTRUCTION = 686,
    OF_LIST_INSTRUCTION_ID = 687,
    OF_LIST_METER_BAND = 688,
    OF_LIST_METER_BAND_STATS = 689,
    OF_LIST_METER_CONFIG = 690,
    OF_LIST_METER_STATS = 691,
    OF_LIST_OXM = 692,
    OF_LIST_PACKET_QUEUE = 693,
    OF_LIST_PORT_DESC = 694,
    OF_LIST_PORT_DESC_PROP = 695,
    OF_LIST_PORT_MOD_PROP = 696,
    OF_LIST_PORT_STATS_ENTRY = 697,
    OF_LIST_PORT_STATS_PROP = 698,
    OF_LIST_QUEUE_DESC = 699,
    OF_LIST_QUEUE_DESC_PROP = 700,
    OF_LIST_QUEUE_PROP = 701,
    OF_LIST_QUEUE_STATS_ENTRY = 702,
    OF_LIST_QUEUE_STATS_PROP = 703,
    OF_LIST_ROLE_PROP = 704,
    OF_LIST_TABLE_DESC = 705,
    OF_LIST_TABLE_FEATURE_PROP = 706,
    OF_LIST_TABLE_FEATURES = 707,
    OF_LIST_TABLE_MOD_PROP = 708,
    OF_LIST_TABLE_STATS_ENTRY = 709,
    OF_LIST_UINT32 = 710,
    OF_LIST_UINT64 = 711,
    OF_LIST_UINT8 = 712,
