...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 391,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 392,
    OF_INSTRUCTION_BSN_PERMIT = 393,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 394,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 395,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 396,
    OF_INSTRUCTION_CLEAR_ACTIONS = 397,
    OF_INSTRUCTION_EXPERIMENTER = 398,
    OF_INSTRUCTION_GOTO_TABLE = 399,
    OF_INSTRUCTION_ID = 400,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 401,
    OF_INSTRUCTION_ID_BSN = 402,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 403,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 404,
    OF_INSTRUCTION_ID_BSN_DENY = 405,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 406,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 407,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 408,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 409,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 410,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 411,
    OF_INSTRUCTION_ID_BSN_PERMIT = 412,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 413,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 414,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 415,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 416,
    OF_INSTRUCTION_ID_EXPERIMENTER = 417,
    OF_INSTRUCTION_ID_GOTO_TABLE = 418,
    OF_INSTRUCTION_ID_METER = 419,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 420,
    OF_INSTRUCTION_ID_WRITE_METADATA = 421,
    OF_INSTRUCTION_METER = 422,
    OF_INSTRUCTION_WRITE_ACTIONS = 423,
    OF_INSTRUCTION_WRITE_METADATA = 424,
    OF_MATCH_V1 = 425,
    OF_MATCH_V2 = 426,
    OF_MATCH_V3 = 427,
    OF_METER_BAND = 428,
    OF_METER_BAND_DROP = 429,
    OF_METER_BAND_DSCP_REMARK = 430,
    OF_METER_BAND_EXPERIMENTER = 431,
    OF_METER_BAND_STATS = 432,
    OF_METER_CONFIG = 433,
    OF_METER_FEATURES = 434,
    OF_METER_STATS = 435,
    OF_OXM = 436,
    OF_OXM_ARP_OP = 437,
    OF_OXM_ARP_OP_MASKED = 438,
    OF_OXM_ARP_SHA = 439,
    OF_OXM_ARP_SHA_MASKED = 440,
    OF_OXM_ARP_SPA = 441,
    OF_OXM_ARP_SPA_MASKED = 442,
    OF_OXM_ARP_THA = 443,
    OF_OXM_ARP_THA_MASKED = 444,
    OF_OXM_ARP_TPA = 445,
    OF_OXM_ARP_TPA_MASKED = 446,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 447,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 448,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 449,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 450,
    OF_OXM_BSN_IN_PORTS_128 = 451,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 452,
    OF_OXM_BSN_IN_PORTS_512 = 453,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 454,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 455,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 456,
    OF_OXM_BSN_L2_CACHE_HIT = 457,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 458,
    OF_OXM_BSN_L3_DST_CLASS_ID = 459,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 460,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 461,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 462,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 463,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 464,
    OF_OXM_BSN_LAG_ID = 465,
    OF_OXM_BSN_LAG_ID_MASKED = 466,
    OF_OXM_BSN_TCP_FLAGS = 467,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 468,
    OF_OXM_BSN_UDF0 = 469,
    OF_OXM_BSN_UDF0_MASKED = 470,
    OF_OXM_BSN_UDF1 = 471,
    OF_OXM_BSN_UDF1_MASKED = 472,
    OF_OXM_BSN_UDF2 = 473,
    OF_OXM_BSN_UDF2_MASKED = 474,
    OF_OXM_BSN_UDF3 = 475,
    OF_OXM_BSN_UDF3_MASKED = 476,
    OF_OXM_BSN_UDF4 = 477,
    OF_OXM_BSN_UDF4_MASKED = 478,
    OF_OXM_BSN_UDF5 = 479,
    OF_OXM_BSN_UDF5_MASKED = 480,
    OF_OXM_BSN_UDF6 = 481,
    OF_OXM_BSN_UDF6_MASKED = 482,
    OF_OXM_BSN_UDF7 = 483,
    OF_OXM_BSN_UDF7_MASKED = 484,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 485,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 486,
    OF_OXM_BSN_VRF = 487,
    OF_OXM_BSN_VRF_MASKED = 488,
    OF_OXM_ETH_DST = 489,
    OF_OXM_ETH_DST_MASKED = 490,
    OF_OXM_ETH_SRC = 491,
    OF_OXM_ETH_SRC_MASKED = 492,
    OF_OXM_ETH_TYPE = 493,
    OF_OXM_ETH_TYPE_MASKED = 494,
    OF_OXM_ICMPV4_CODE = 495,
    OF_OXM_ICMPV4_CODE_MASKED = 496,
    OF_OXM_ICMPV4_TYPE = 497,
    OF_OXM_ICMPV4_TYPE_MASKED = 498,
    OF_OXM_ICMPV6_CODE = 499,
    OF_OXM_ICMPV6_CODE_MASKED = 500,
    OF_OXM_ICMPV6_TYPE = 501,
    OF_OXM_ICMPV6_TYPE_MASKED = 502,
    OF_OXM_IN_PHY_PORT = 503,
    OF_OXM_IN_PHY_PORT_MASKED = 504,
    OF_OXM_IN_PORT = 505,
    OF_OXM_IN_PORT_MASKED = 506,
    OF_OXM_IP_DSCP = 507,
    OF_OXM_IP_DSCP_MASKED = 508,
    OF_OXM_IP_ECN = 509,
    OF_OXM_IP_ECN_MASKED = 510,
    OF_OXM_IP_PROTO = 511,
    OF_OXM_IP_PROTO_MASKED = 512,
    OF_OXM_IPV4_DST = 513,
    OF_OXM_IPV4_DST_MASKED = 514,
    OF_OXM_IPV4_SRC = 515,
    OF_OXM_IPV4_SRC_MASKED = 516,
    OF_OXM_IPV6_DST = 517,
    OF_OXM_IPV6_DST_MASKED = 518,
    OF_OXM_IPV6_EXTHDR = 519,
    OF_OXM_IPV6_EXTHDR_MASKED = 520,
    OF_OXM_IPV6_FLABEL = 521,
    OF_OXM_IPV6_FLABEL_MASKED = 522,
    OF_OXM_IPV6_ND_SLL = 523,
    OF_OXM_IPV6_ND_SLL_MASKED = 524,
    OF_OXM_IPV6_ND_TARGET = 525,
    OF_OXM_IPV6_ND_TARGET_MASKED = 526,
    OF_OXM_IPV6_ND_TLL = 527,
    OF_OXM_IPV6_ND_TLL_MASKED = 528,
    OF_OXM_IPV6_SRC = 529,
    OF_OXM_IPV6_SRC_MASKED = 530,
    OF_OXM_METADATA = 531,
    OF_OXM_METADATA_MASKED = 532,
    OF_OXM_MPLS_BOS = 533,
    OF_OXM_MPLS_BOS_MASKED = 534,
    OF_OXM_MPLS_LABEL = 535,
    OF_OXM_MPLS_LABEL_MASKED = 536,
    OF_OXM_MPLS_TC = 537,
    OF_OXM_MPLS_TC_MASKED = 538,
    OF_OXM_PBB_UCA = 539,
    OF_OXM_PBB_UCA_MASKED = 540,
    OF_OXM_SCTP_DST = 541,
    OF_OXM_SCTP_DST_MASKED = 542,
    OF_OXM_SCTP_SRC = 543,
    OF_OXM_SCTP_SRC_MASKED = 544,
    OF_OXM_TCP_DST = 545,
    OF_OXM_TCP_DST_MASKED = 546,
    OF_OXM_TCP_SRC = 547,
    OF_OXM_TCP_SRC_MASKED = 548,
    OF_OXM_TUNNEL_ID = 549,
    OF_OXM_TUNNEL_ID_MASKED = 550,
    OF_OXM_TUNNEL_IPV4_DST = 551,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 552,
    OF_OXM_TUNNEL_IPV4_SRC = 553,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 554,
    OF_OXM_UDP_DST = 555,
    OF_OXM_UDP_DST_MASKED = 556,
    OF_OXM_UDP_SRC = 557,
    OF_OXM_UDP_SRC_MASKED = 558,
    OF_OXM_VLAN_PCP = 559,
    OF_OXM_VLAN_PCP_MASKED = 560,
    OF_OXM_VLAN_VID = 561,
    OF_OXM_VLAN_VID_MASKED = 562,
    OF_PACKET_QUEUE = 563,
    OF_PORT_DESC = 564,
    OF_PORT_DESC_PROP = 565,
    OF_PORT_DESC_PROP_BSN = 566,
    OF_PORT_DESC_PROP_BSN_UPLINK = 567,
    OF_PORT_DESC_PROP_ETHERNET = 568,
    OF_PORT_DESC_PROP_EXPERIMENTER = 569,
    OF_PORT_DESC_PROP_OPTICAL = 570,
    OF_PORT_MOD_PROP = 571,
    OF_PORT_MOD_PROP_ETHERNET = 572,
    OF_PORT_MOD_PROP_EXPERIMENTER = 573,
    OF_PORT_MOD_PROP_OPTICAL = 574,
    OF_PORT_STATS_ENTRY = 575,
    OF_PORT_STATS_PROP = 576,
    OF_PORT_STATS_PROP_ETHERNET = 577,
    OF_PORT_STATS_PROP_EXPERIMENTER = 578,
    OF_PORT_STATS_PROP_OPTICAL = 579,
    OF_QUEUE_DESC = 580,
    OF_QUEUE_DESC_PROP = 581,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 582,
    OF_QUEUE_DESC_PROP_MAX_RATE = 583,
    OF_QUEUE_DESC_PROP_MIN_RATE = 584,
    OF_QUEUE_PROP = 585,
    OF_QUEUE_PROP_EXPERIMENTER = 586,
    OF_QUEUE_PROP_MAX_RATE = 587,
    OF_QUEUE_PROP_MIN_RATE = 588,
    OF_QUEUE_STATS_ENTRY = 589,
    OF_QUEUE_STATS_PROP = 590,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 591,
    OF_ROLE_PROP = 592,
    OF_ROLE_PROP_EXPERIMENTER = 593,
    OF_TABLE_DESC = 594,
    OF_TABLE_FEATURE_PROP = 595,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 596,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 597,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 598,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 599,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 600,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 601,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 602,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 603,
    OF_TABLE_FEATURE_PROP_MATCH = 604,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 605,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 606,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 607,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 608,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 609,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 610,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 611,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 612,
    OF_TABLE_FEATURES = 613,
    OF_TABLE_MOD_PROP = 614,
    OF_TABLE_MOD_PROP_EVICTION = 615,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 616,
    OF_TABLE_MOD_PROP_VACANCY = 617,
    OF_TABLE_STATS_ENTRY = 618,
    OF_UINT32 = 619,
    OF_UINT64 = 620,
    OF_UINT8 = 621,
    ...
    /* List objects */
    OF_LIST_ACTION = 622,
    OF_LIST_ACTION_ID = 623,
    OF_LIST_ASYNC_CONFIG_PROP = 624,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 625,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 626,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 627,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 628,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 629,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 630,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 631,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 632,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 633,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 634,
    OF_LIST_BSN_INTERFACE = 635,
    OF_LIST_BSN_LACP_STATS_ENTRY = 636,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 637,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 638,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 639,
    OF_LIST_BSN_TLV = 640,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 641,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 642,
    OF_LIST_BUCKET = 643,
    OF_LIST_BUCKET_COUNTER = 644,
    OF_LIST_BUNDLE_PROP = 645,
    OF_LIST_FLOW_STATS_ENTRY = 646,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 647,
    OF_LIST_GROUP_STATS_ENTRY = 648,
    OF_LIST_HELLO_ELEM = 649,
    OF_LIST_INSTRUCTION = 650,
    OF_LIST_INSTRUCTION_ID = 651,
    OF_LIST_METER_BAND = 652,
    OF_LIST_METER_BAND_STATS = 653,
    OF_LIST_METER_STATS = 654,
    OF_LIST_OXM = 655,
    OF_LIST_PACKET_QUEUE = 656,
    OF_LIST_PORT_DESC = 657,
    OF_LIST_PORT_DESC_PROP = 658,
    OF_LIST_PORT_MOD_PROP = 659,
    OF_LIST_PORT_STATS_ENTRY = 660,
    OF_LIST_PORT_STATS_PROP = 661,
    OF_LIST_QUEUE_DESC = 662,
    OF_LIST_QUEUE_DESC_PROP = 663,
    OF_LIST_QUEUE_PROP = 664,
    OF_LIST_QUEUE_STATS_ENTRY = 665,
    OF_LIST_QUEUE_STATS_PROP = 666,
    OF_LIST_ROLE_PROP = 667,
    OF_LIST_TABLE_DESC = 668,
    OF_LIST_TABLE_FEATURE_PROP = 669,
    OF_LIST_TABLE_FEATURES = 670,
    OF_LIST_TABLE_MOD_PROP = 671,
    OF_LIST_TABLE_STATS_ENTRY = 672,
    OF_LIST_UINT32 = 673,
    OF_LIST_UINT64 = 674,
    OF_LIST_UINT8 = 675,
