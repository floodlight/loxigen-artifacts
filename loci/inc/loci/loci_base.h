...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 338,
    OF_BSN_TLV_GENERATION_ID = 339,
    OF_BSN_TLV_HASH_ALGORITHM = 340,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 341,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 342,
    OF_BSN_TLV_HASH_PACKET_FIELD = 343,
    OF_BSN_TLV_HASH_PACKET_TYPE = 344,
    OF_BSN_TLV_HASH_SEED = 345,
    OF_BSN_TLV_HASH_TYPE = 346,
    OF_BSN_TLV_HEADER_SIZE = 347,
    OF_BSN_TLV_ICMP_CODE = 348,
    OF_BSN_TLV_ICMP_ID = 349,
    OF_BSN_TLV_ICMP_TYPE = 350,
    OF_BSN_TLV_ICMPV6_CHKSUM = 351,
    OF_BSN_TLV_IDLE_NOTIFICATION = 352,
    OF_BSN_TLV_IDLE_TIME = 353,
    OF_BSN_TLV_IDLE_TIMEOUT = 354,
    OF_BSN_TLV_IGMP_SNOOPING = 355,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 356,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 357,
    OF_BSN_TLV_INTERNAL_MAC = 358,
    OF_BSN_TLV_INTERVAL = 359,
    OF_BSN_TLV_IP_PROTO = 360,
    OF_BSN_TLV_IPV4 = 361,
    OF_BSN_TLV_IPV4_DST = 362,
    OF_BSN_TLV_IPV4_NETMASK = 363,
    OF_BSN_TLV_IPV4_SRC = 364,
    OF_BSN_TLV_IPV6 = 365,
    OF_BSN_TLV_IPV6_DST = 366,
    OF_BSN_TLV_IPV6_PREFIX = 367,
    OF_BSN_TLV_IPV6_SRC = 368,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 369,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 370,
    OF_BSN_TLV_L3_DST_CLASS_ID = 371,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 372,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 373,
    OF_BSN_TLV_LOOPBACK_MODE = 374,
    OF_BSN_TLV_LOOPBACK_PORT = 375,
    OF_BSN_TLV_MAC = 376,
    OF_BSN_TLV_MAC_MASK = 377,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 378,
    OF_BSN_TLV_MISS_PACKETS = 379,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 380,
    OF_BSN_TLV_MPLS_LABEL = 381,
    OF_BSN_TLV_MPLS_SEQUENCED = 382,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 383,
    OF_BSN_TLV_NAME = 384,
    OF_BSN_TLV_NDP_OFFLOAD = 385,
    OF_BSN_TLV_NDP_STATIC = 386,
    OF_BSN_TLV_NEGATE = 387,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 388,
    OF_BSN_TLV_NEXT_HOP_MAC = 389,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 390,
    OF_BSN_TLV_NO_ARP_RESPONSE = 391,
    OF_BSN_TLV_NO_NS_RESPONSE = 392,
    OF_BSN_TLV_OFFSET = 393,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 394,
    OF_BSN_TLV_PARENT_PORT = 395,
    OF_BSN_TLV_PARTNER_KEY = 396,
    OF_BSN_TLV_PARTNER_PORT_NUM = 397,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 398,
    OF_BSN_TLV_PARTNER_STATE = 399,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 400,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 401,
    OF_BSN_TLV_PORT = 402,
    OF_BSN_TLV_PORT_USAGE = 403,
    OF_BSN_TLV_PORT_VXLAN_MODE = 404,
    OF_BSN_TLV_PRIORITY = 405,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 406,
    OF_BSN_TLV_QOS_PRIORITY = 407,
    OF_BSN_TLV_QUEUE_ID = 408,
    OF_BSN_TLV_QUEUE_WEIGHT = 409,
    OF_BSN_TLV_RATE_LIMIT = 410,
    OF_BSN_TLV_RATE_UNIT = 411,
    OF_BSN_TLV_REFERENCE = 412,
    OF_BSN_TLV_REPLY_PACKETS = 413,
    OF_BSN_TLV_REQUEST_PACKETS = 414,
    OF_BSN_TLV_RX_BYTES = 415,
    OF_BSN_TLV_RX_PACKETS = 416,
    OF_BSN_TLV_SAMPLING_RATE = 417,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 418,
    OF_BSN_TLV_STATUS = 419,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 420,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 421,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 422,
    OF_BSN_TLV_SUB_AGENT_ID = 423,
    OF_BSN_TLV_TCP_DST = 424,
    OF_BSN_TLV_TCP_FLAGS = 425,
    OF_BSN_TLV_TCP_SRC = 426,
    OF_BSN_TLV_TTL = 427,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 428,
    OF_BSN_TLV_TX_BYTES = 429,
    OF_BSN_TLV_TX_PACKETS = 430,
    OF_BSN_TLV_UDF_ANCHOR = 431,
    OF_BSN_TLV_UDF_ID = 432,
    OF_BSN_TLV_UDF_LENGTH = 433,
    OF_BSN_TLV_UDF_OFFSET = 434,
    OF_BSN_TLV_UDP_DST = 435,
    OF_BSN_TLV_UDP_SRC = 436,
    OF_BSN_TLV_UINT64_LIST = 437,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 438,
    OF_BSN_TLV_UNICAST_RATE = 439,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 440,
    OF_BSN_TLV_UNTAGGED = 441,
    OF_BSN_TLV_USE_PACKET_STATE = 442,
    OF_BSN_TLV_VFI = 443,
    OF_BSN_TLV_VFP_CLASS_ID = 444,
    OF_BSN_TLV_VLAN_MAC_LIST = 445,
    OF_BSN_TLV_VLAN_PCP = 446,
    OF_BSN_TLV_VLAN_VID = 447,
    OF_BSN_TLV_VLAN_VID_MASK = 448,
    OF_BSN_TLV_VNI = 449,
    OF_BSN_TLV_VPN_KEY = 450,
    OF_BSN_TLV_VRF = 451,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 452,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 453,
    OF_BSN_VLAN_MAC = 454,
    OF_BSN_VPORT = 455,
    OF_BSN_VPORT_L2GRE = 456,
    OF_BSN_VPORT_Q_IN_Q = 457,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 458,
    OF_BUCKET = 459,
    OF_BUCKET_COUNTER = 460,
    OF_BUNDLE_PROP = 461,
    OF_BUNDLE_PROP_EXPERIMENTER = 462,
    OF_FLOW_STATS_ENTRY = 463,
    OF_GROUP_DESC_STATS_ENTRY = 464,
    OF_GROUP_STATS_ENTRY = 465,
    OF_HELLO_ELEM = 466,
    OF_HELLO_ELEM_VERSIONBITMAP = 467,
    OF_INSTRUCTION = 468,
    OF_INSTRUCTION_APPLY_ACTIONS = 469,
    OF_INSTRUCTION_BSN = 470,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 471,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 472,
    OF_INSTRUCTION_BSN_DENY = 473,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 474,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 475,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 476,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 477,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 478,
    OF_INSTRUCTION_BSN_HASH_SELECT = 479,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 480,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 481,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 482,
    OF_INSTRUCTION_BSN_PERMIT = 483,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 484,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 485,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 486,
    OF_INSTRUCTION_CLEAR_ACTIONS = 487,
    OF_INSTRUCTION_EXPERIMENTER = 488,
    OF_INSTRUCTION_GOTO_TABLE = 489,
    OF_INSTRUCTION_ID = 490,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 491,
    OF_INSTRUCTION_ID_BSN = 492,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 493,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 494,
    OF_INSTRUCTION_ID_BSN_DENY = 495,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 496,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 497,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 498,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 499,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 500,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 501,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 502,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 503,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 504,
    OF_INSTRUCTION_ID_BSN_PERMIT = 505,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 506,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 507,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 508,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 509,
    OF_INSTRUCTION_ID_EXPERIMENTER = 510,
    OF_INSTRUCTION_ID_GOTO_TABLE = 511,
    OF_INSTRUCTION_ID_METER = 512,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 513,
    OF_INSTRUCTION_ID_WRITE_METADATA = 514,
    OF_INSTRUCTION_METER = 515,
    OF_INSTRUCTION_WRITE_ACTIONS = 516,
    OF_INSTRUCTION_WRITE_METADATA = 517,
    OF_MATCH_V1 = 518,
    OF_MATCH_V2 = 519,
    OF_MATCH_V3 = 520,
    OF_METER_BAND = 521,
    OF_METER_BAND_DROP = 522,
    OF_METER_BAND_DSCP_REMARK = 523,
    OF_METER_BAND_EXPERIMENTER = 524,
    OF_METER_BAND_STATS = 525,
    OF_METER_CONFIG = 526,
    OF_METER_FEATURES = 527,
    OF_METER_STATS = 528,
    OF_OXM = 529,
    OF_OXM_ARP_OP = 530,
    OF_OXM_ARP_OP_MASKED = 531,
    OF_OXM_ARP_SHA = 532,
    OF_OXM_ARP_SHA_MASKED = 533,
    OF_OXM_ARP_SPA = 534,
    OF_OXM_ARP_SPA_MASKED = 535,
    OF_OXM_ARP_THA = 536,
    OF_OXM_ARP_THA_MASKED = 537,
    OF_OXM_ARP_TPA = 538,
    OF_OXM_ARP_TPA_MASKED = 539,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 540,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 541,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 542,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 543,
    OF_OXM_BSN_IN_PORTS_128 = 544,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 545,
    OF_OXM_BSN_IN_PORTS_512 = 546,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 547,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 548,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 549,
    OF_OXM_BSN_INNER_ETH_DST = 550,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 551,
    OF_OXM_BSN_INNER_ETH_SRC = 552,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 553,
    OF_OXM_BSN_INNER_VLAN_VID = 554,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 555,
    OF_OXM_BSN_IP_FRAGMENTATION = 556,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 557,
    OF_OXM_BSN_L2_CACHE_HIT = 558,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 559,
    OF_OXM_BSN_L3_DST_CLASS_ID = 560,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 561,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 562,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 563,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 564,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 565,
    OF_OXM_BSN_LAG_ID = 566,
    OF_OXM_BSN_LAG_ID_MASKED = 567,
    OF_OXM_BSN_TCP_FLAGS = 568,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 569,
    OF_OXM_BSN_UDF0 = 570,
    OF_OXM_BSN_UDF0_MASKED = 571,
    OF_OXM_BSN_UDF1 = 572,
    OF_OXM_BSN_UDF1_MASKED = 573,
    OF_OXM_BSN_UDF2 = 574,
    OF_OXM_BSN_UDF2_MASKED = 575,
    OF_OXM_BSN_UDF3 = 576,
    OF_OXM_BSN_UDF3_MASKED = 577,
    OF_OXM_BSN_UDF4 = 578,
    OF_OXM_BSN_UDF4_MASKED = 579,
    OF_OXM_BSN_UDF5 = 580,
    OF_OXM_BSN_UDF5_MASKED = 581,
    OF_OXM_BSN_UDF6 = 582,
    OF_OXM_BSN_UDF6_MASKED = 583,
    OF_OXM_BSN_UDF7 = 584,
    OF_OXM_BSN_UDF7_MASKED = 585,
    OF_OXM_BSN_VFI = 586,
    OF_OXM_BSN_VFI_MASKED = 587,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 588,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 589,
    OF_OXM_BSN_VRF = 590,
    OF_OXM_BSN_VRF_MASKED = 591,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 592,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 593,
    OF_OXM_ETH_DST = 594,
    OF_OXM_ETH_DST_MASKED = 595,
    OF_OXM_ETH_SRC = 596,
    OF_OXM_ETH_SRC_MASKED = 597,
    OF_OXM_ETH_TYPE = 598,
    OF_OXM_ETH_TYPE_MASKED = 599,
    OF_OXM_ICMPV4_CODE = 600,
    OF_OXM_ICMPV4_CODE_MASKED = 601,
    OF_OXM_ICMPV4_TYPE = 602,
    OF_OXM_ICMPV4_TYPE_MASKED = 603,
    OF_OXM_ICMPV6_CODE = 604,
    OF_OXM_ICMPV6_CODE_MASKED = 605,
    OF_OXM_ICMPV6_TYPE = 606,
    OF_OXM_ICMPV6_TYPE_MASKED = 607,
    OF_OXM_IN_PHY_PORT = 608,
    OF_OXM_IN_PHY_PORT_MASKED = 609,
    OF_OXM_IN_PORT = 610,
    OF_OXM_IN_PORT_MASKED = 611,
    OF_OXM_IP_DSCP = 612,
    OF_OXM_IP_DSCP_MASKED = 613,
    OF_OXM_IP_ECN = 614,
    OF_OXM_IP_ECN_MASKED = 615,
    OF_OXM_IP_PROTO = 616,
    OF_OXM_IP_PROTO_MASKED = 617,
    OF_OXM_IPV4_DST = 618,
    OF_OXM_IPV4_DST_MASKED = 619,
    OF_OXM_IPV4_SRC = 620,
    OF_OXM_IPV4_SRC_MASKED = 621,
    OF_OXM_IPV6_DST = 622,
    OF_OXM_IPV6_DST_MASKED = 623,
    OF_OXM_IPV6_EXTHDR = 624,
    OF_OXM_IPV6_EXTHDR_MASKED = 625,
    OF_OXM_IPV6_FLABEL = 626,
    OF_OXM_IPV6_FLABEL_MASKED = 627,
    OF_OXM_IPV6_ND_SLL = 628,
    OF_OXM_IPV6_ND_SLL_MASKED = 629,
    OF_OXM_IPV6_ND_TARGET = 630,
    OF_OXM_IPV6_ND_TARGET_MASKED = 631,
    OF_OXM_IPV6_ND_TLL = 632,
    OF_OXM_IPV6_ND_TLL_MASKED = 633,
    OF_OXM_IPV6_SRC = 634,
    OF_OXM_IPV6_SRC_MASKED = 635,
    OF_OXM_METADATA = 636,
    OF_OXM_METADATA_MASKED = 637,
    OF_OXM_MPLS_BOS = 638,
    OF_OXM_MPLS_BOS_MASKED = 639,
    OF_OXM_MPLS_LABEL = 640,
    OF_OXM_MPLS_LABEL_MASKED = 641,
    OF_OXM_MPLS_TC = 642,
    OF_OXM_MPLS_TC_MASKED = 643,
    OF_OXM_OVS_TCP_FLAGS = 644,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 645,
    OF_OXM_PBB_UCA = 646,
    OF_OXM_PBB_UCA_MASKED = 647,
    OF_OXM_SCTP_DST = 648,
    OF_OXM_SCTP_DST_MASKED = 649,
    OF_OXM_SCTP_SRC = 650,
    OF_OXM_SCTP_SRC_MASKED = 651,
    OF_OXM_TCP_DST = 652,
    OF_OXM_TCP_DST_MASKED = 653,
    OF_OXM_TCP_SRC = 654,
    OF_OXM_TCP_SRC_MASKED = 655,
    OF_OXM_TUNNEL_ID = 656,
    OF_OXM_TUNNEL_ID_MASKED = 657,
    OF_OXM_TUNNEL_IPV4_DST = 658,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 659,
    OF_OXM_TUNNEL_IPV4_SRC = 660,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 661,
    OF_OXM_UDP_DST = 662,
    OF_OXM_UDP_DST_MASKED = 663,
    OF_OXM_UDP_SRC = 664,
    OF_OXM_UDP_SRC_MASKED = 665,
    OF_OXM_VLAN_PCP = 666,
    OF_OXM_VLAN_PCP_MASKED = 667,
    OF_OXM_VLAN_VID = 668,
    OF_OXM_VLAN_VID_MASKED = 669,
    OF_PACKET_QUEUE = 670,
    OF_PORT_DESC = 671,
    OF_PORT_DESC_PROP = 672,
    OF_PORT_DESC_PROP_BSN = 673,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 674,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 675,
    OF_PORT_DESC_PROP_BSN_UPLINK = 676,
    OF_PORT_DESC_PROP_ETHERNET = 677,
    OF_PORT_DESC_PROP_EXPERIMENTER = 678,
    OF_PORT_DESC_PROP_OPTICAL = 679,
    OF_PORT_MOD_PROP = 680,
    OF_PORT_MOD_PROP_ETHERNET = 681,
    OF_PORT_MOD_PROP_EXPERIMENTER = 682,
    OF_PORT_MOD_PROP_OPTICAL = 683,
    OF_PORT_STATS_ENTRY = 684,
    OF_PORT_STATS_PROP = 685,
    OF_PORT_STATS_PROP_ETHERNET = 686,
    OF_PORT_STATS_PROP_EXPERIMENTER = 687,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 688,
    OF_PORT_STATS_PROP_OPTICAL = 689,
    OF_QUEUE_DESC = 690,
    OF_QUEUE_DESC_PROP = 691,
    OF_QUEUE_DESC_PROP_BSN = 692,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 693,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 694,
    OF_QUEUE_DESC_PROP_MAX_RATE = 695,
    OF_QUEUE_DESC_PROP_MIN_RATE = 696,
    OF_QUEUE_PROP = 697,
    OF_QUEUE_PROP_EXPERIMENTER = 698,
    OF_QUEUE_PROP_MAX_RATE = 699,
    OF_QUEUE_PROP_MIN_RATE = 700,
    OF_QUEUE_STATS_ENTRY = 701,
    OF_QUEUE_STATS_PROP = 702,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 703,
    OF_ROLE_PROP = 704,
    OF_ROLE_PROP_EXPERIMENTER = 705,
    OF_TABLE_DESC = 706,
    OF_TABLE_FEATURE_PROP = 707,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 708,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 709,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 710,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 711,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 712,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 713,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 714,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 715,
    OF_TABLE_FEATURE_PROP_MATCH = 716,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 717,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 718,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 719,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 720,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 721,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 722,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 723,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 724,
    OF_TABLE_FEATURES = 725,
    OF_TABLE_MOD_PROP = 726,
    OF_TABLE_MOD_PROP_EVICTION = 727,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 728,
    OF_TABLE_MOD_PROP_VACANCY = 729,
    OF_TABLE_STATS_ENTRY = 730,
    OF_UINT32 = 731,
    OF_UINT64 = 732,
    OF_UINT8 = 733,
    ...
    /* List objects */
    OF_LIST_ACTION = 734,
    OF_LIST_ACTION_ID = 735,
    OF_LIST_ASYNC_CONFIG_PROP = 736,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 737,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 738,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 739,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 740,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 741,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 742,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 743,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 744,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 745,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 746,
    OF_LIST_BSN_INTERFACE = 747,
    OF_LIST_BSN_LACP_STATS_ENTRY = 748,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 749,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 750,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 751,
    OF_LIST_BSN_TLV = 752,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 753,
    OF_LIST_BSN_VLAN_MAC = 754,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 755,
    OF_LIST_BUCKET = 756,
    OF_LIST_BUCKET_COUNTER = 757,
    OF_LIST_BUNDLE_PROP = 758,
    OF_LIST_FLOW_STATS_ENTRY = 759,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 760,
    OF_LIST_GROUP_STATS_ENTRY = 761,
    OF_LIST_HELLO_ELEM = 762,
    OF_LIST_INSTRUCTION = 763,
    OF_LIST_INSTRUCTION_ID = 764,
    OF_LIST_METER_BAND = 765,
    OF_LIST_METER_BAND_STATS = 766,
    OF_LIST_METER_CONFIG = 767,
    OF_LIST_METER_STATS = 768,
    OF_LIST_OXM = 769,
    OF_LIST_PACKET_QUEUE = 770,
    OF_LIST_PORT_DESC = 771,
    OF_LIST_PORT_DESC_PROP = 772,
    OF_LIST_PORT_MOD_PROP = 773,
    OF_LIST_PORT_STATS_ENTRY = 774,
    OF_LIST_PORT_STATS_PROP = 775,
    OF_LIST_QUEUE_DESC = 776,
    OF_LIST_QUEUE_DESC_PROP = 777,
    OF_LIST_QUEUE_PROP = 778,
    OF_LIST_QUEUE_STATS_ENTRY = 779,
    OF_LIST_QUEUE_STATS_PROP = 780,
    OF_LIST_ROLE_PROP = 781,
    OF_LIST_TABLE_DESC = 782,
    OF_LIST_TABLE_FEATURE_PROP = 783,
    OF_LIST_TABLE_FEATURES = 784,
    OF_LIST_TABLE_MOD_PROP = 785,
    OF_LIST_TABLE_STATS_ENTRY = 786,
    OF_LIST_UINT32 = 787,
    OF_LIST_UINT64 = 788,
    OF_LIST_UINT8 = 789,
