...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_ANALYTICS = 310,
    OF_BSN_TLV_ANCHOR = 311,
    OF_BSN_TLV_APPLY_BYTES = 312,
    OF_BSN_TLV_APPLY_PACKETS = 313,
    OF_BSN_TLV_ARP_SPA = 314,
    OF_BSN_TLV_ARP_TPA = 315,
    OF_BSN_TLV_AUTO_NEGOTIATION = 316,
    OF_BSN_TLV_BFD_ENDPOINT = 317,
    OF_BSN_TLV_BFD_STATE = 318,
    ...
    OF_BSN_TLV_DISABLE_XMIT = 330,
    OF_BSN_TLV_DNS_ANALYTICS = 331,
    OF_BSN_TLV_DROP = 332,
    OF_BSN_TLV_DROP_CONTROL = 333,
    OF_BSN_TLV_DSCP = 334,
    OF_BSN_TLV_ECN = 335,
    OF_BSN_TLV_EGRESS_ONLY = 336,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 337,
    OF_BSN_TLV_EGRESS_SAMPLING_RATE = 338,
    OF_BSN_TLV_ENCAP = 339,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 340,
    OF_BSN_TLV_ETH_DST = 341,
    OF_BSN_TLV_ETH_SRC = 342,
    OF_BSN_TLV_ETH_TYPE = 343,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 344,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 345,
    OF_BSN_TLV_EXTERNAL_IP = 346,
    OF_BSN_TLV_EXTERNAL_MAC = 347,
    OF_BSN_TLV_EXTERNAL_NETMASK = 348,
    OF_BSN_TLV_FABRIC_PORT_ROLE = 349,
    OF_BSN_TLV_FAIL_COUNT = 350,
    OF_BSN_TLV_FLOOD = 351,
    OF_BSN_TLV_FLOW_CLASSIFIER = 352,
    OF_BSN_TLV_FLOW_CLASSIFY = 353,
    OF_BSN_TLV_FLOW_IDENTIFIER = 354,
    OF_BSN_TLV_FORCE_LINK_UP = 355,
    OF_BSN_TLV_FORWARD_ERROR_CORRECTION = 356,
    OF_BSN_TLV_FREE_COUNT = 357,
    OF_BSN_TLV_GENERATION_ID = 358,
    OF_BSN_TLV_HASH_ALGORITHM = 359,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 360,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 361,
    OF_BSN_TLV_HASH_PACKET_FIELD = 362,
    OF_BSN_TLV_HASH_PACKET_TYPE = 363,
    OF_BSN_TLV_HASH_SEED = 364,
    OF_BSN_TLV_HASH_TYPE = 365,
    OF_BSN_TLV_HEADER_SIZE = 366,
    OF_BSN_TLV_ICMP_CODE = 367,
    OF_BSN_TLV_ICMP_ID = 368,
    OF_BSN_TLV_ICMP_TYPE = 369,
    OF_BSN_TLV_ICMPV6_CHKSUM = 370,
    OF_BSN_TLV_ICMPV6_CODE = 371,
    OF_BSN_TLV_ICMPV6_TYPE = 372,
    OF_BSN_TLV_IDENTIFIER = 373,
    OF_BSN_TLV_IDLE_NOTIFICATION = 374,
    OF_BSN_TLV_IDLE_TIME = 375,
    OF_BSN_TLV_IDLE_TIMEOUT = 376,
    OF_BSN_TLV_IFP_CLASS_ID = 377,
    OF_BSN_TLV_IGMP_SNOOPING = 378,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 379,
    OF_BSN_TLV_INNER_VLAN_VID = 380,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 381,
    OF_BSN_TLV_INTERNAL_MAC = 382,
    OF_BSN_TLV_INTERVAL = 383,
    OF_BSN_TLV_IP_FRAGMENTATION = 384,
    OF_BSN_TLV_IP_PROTO = 385,
    OF_BSN_TLV_IP_TUNNEL_TYPE = 386,
    OF_BSN_TLV_IPV4 = 387,
    OF_BSN_TLV_IPV4_DST = 388,
    OF_BSN_TLV_IPV4_NETMASK = 389,
    OF_BSN_TLV_IPV4_SRC = 390,
    OF_BSN_TLV_IPV6 = 391,
    OF_BSN_TLV_IPV6_DST = 392,
    OF_BSN_TLV_IPV6_PREFIX = 393,
    OF_BSN_TLV_IPV6_SRC = 394,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 395,
    OF_BSN_TLV_L2_CACHE_HIT = 396,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 397,
    OF_BSN_TLV_L3 = 398,
    OF_BSN_TLV_L3_DST_CLASS_ID = 399,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 400,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 401,
    OF_BSN_TLV_LAG_OPTIONS = 402,
    OF_BSN_TLV_LCORE = 403,
    OF_BSN_TLV_LINK_UP = 404,
    OF_BSN_TLV_LOAD = 405,
    OF_BSN_TLV_LOOPBACK_MODE = 406,
    OF_BSN_TLV_LOOPBACK_PORT = 407,
    OF_BSN_TLV_LOSSLESS = 408,
    OF_BSN_TLV_LR_ALL_ENABLED = 409,
    OF_BSN_TLV_MAC = 410,
    OF_BSN_TLV_MAC_MASK = 411,
    OF_BSN_TLV_MAX_COUNT = 412,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 413,
    OF_BSN_TLV_MGMT = 414,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 415,
    OF_BSN_TLV_MISS_PACKETS = 416,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 417,
    OF_BSN_TLV_MPLS_LABEL = 418,
    OF_BSN_TLV_MPLS_SEQUENCED = 419,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 420,
    OF_BSN_TLV_MULTICAST_PACKET = 421,
    OF_BSN_TLV_MULTIPLIER = 422,
    OF_BSN_TLV_NAME = 423,
    OF_BSN_TLV_NDP_OFFLOAD = 424,
    OF_BSN_TLV_NDP_STATIC = 425,
    OF_BSN_TLV_NEGATE = 426,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 427,
    OF_BSN_TLV_NEXT_HOP_MAC = 428,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 429,
    OF_BSN_TLV_NO_ARP_RESPONSE = 430,
    OF_BSN_TLV_NO_NS_RESPONSE = 431,
    OF_BSN_TLV_OFFSET = 432,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 433,
    OF_BSN_TLV_OUTER_SRC_MAC = 434,
    OF_BSN_TLV_PARENT_PORT = 435,
    OF_BSN_TLV_PARTNER_KEY = 436,
    OF_BSN_TLV_PARTNER_PORT_NUM = 437,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 438,
    OF_BSN_TLV_PARTNER_STATE = 439,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 440,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 441,
    OF_BSN_TLV_PASSIVE = 442,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 443,
    OF_BSN_TLV_PIM_DR = 444,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 445,
    OF_BSN_TLV_PORT = 446,
    OF_BSN_TLV_PORT_MODE = 447,
    OF_BSN_TLV_PORT_SPEED_GBPS = 448,
    OF_BSN_TLV_PORT_USAGE = 449,
    OF_BSN_TLV_PORT_VXLAN_MODE = 450,
    OF_BSN_TLV_PRESERVE_VLAN = 451,
    OF_BSN_TLV_PRIORITY = 452,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 453,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 454,
    OF_BSN_TLV_QOS_PRIORITY = 455,
    OF_BSN_TLV_QUEUE_ID = 456,
    OF_BSN_TLV_QUEUE_WEIGHT = 457,
    OF_BSN_TLV_RATE_LIMIT = 458,
    OF_BSN_TLV_RATE_UNIT = 459,
    OF_BSN_TLV_RECORD_PACKETS = 460,
    OF_BSN_TLV_REDUNDANT_MGMT = 461,
    OF_BSN_TLV_REFERENCE = 462,
    OF_BSN_TLV_REPLY_PACKETS = 463,
    OF_BSN_TLV_REQUEST_PACKETS = 464,
    OF_BSN_TLV_REST_SERVER = 465,
    OF_BSN_TLV_ROUTING_PARAM = 466,
    OF_BSN_TLV_RX_BYTES = 467,
    OF_BSN_TLV_RX_PACKETS = 468,
    OF_BSN_TLV_SAMPLING_RATE = 469,
    OF_BSN_TLV_SCTP_DST = 470,
    OF_BSN_TLV_SCTP_SRC = 471,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 472,
    OF_BSN_TLV_SOCKET = 473,
    OF_BSN_TLV_SRC_MAC_CML = 474,
    OF_BSN_TLV_STATUS = 475,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 476,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 477,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 478,
    OF_BSN_TLV_SUB_AGENT_ID = 479,
    OF_BSN_TLV_TCP_DST = 480,
    OF_BSN_TLV_TCP_FLAGS = 481,
    OF_BSN_TLV_TCP_SRC = 482,
    OF_BSN_TLV_THREAD = 483,
    OF_BSN_TLV_TIMESTAMP = 484,
    OF_BSN_TLV_TTL = 485,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 486,
    OF_BSN_TLV_TX_BYTES = 487,
    OF_BSN_TLV_TX_PACKETS = 488,
    OF_BSN_TLV_UDF_ANCHOR = 489,
    OF_BSN_TLV_UDF_CAPABILITY = 490,
    OF_BSN_TLV_UDF_DATA = 491,
    OF_BSN_TLV_UDF_ID = 492,
    OF_BSN_TLV_UDF_LENGTH = 493,
    OF_BSN_TLV_UDF_OFFSET = 494,
    OF_BSN_TLV_UDP_DST = 495,
    OF_BSN_TLV_UDP_SRC = 496,
    OF_BSN_TLV_UINT32 = 497,
    OF_BSN_TLV_UINT64_LIST = 498,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 499,
    OF_BSN_TLV_UNICAST_RATE = 500,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 501,
    OF_BSN_TLV_UNTAGGED = 502,
    OF_BSN_TLV_UPGRADE = 503,
    OF_BSN_TLV_URI_SCHEME = 504,
    OF_BSN_TLV_USE_PACKET_STATE = 505,
    OF_BSN_TLV_USER_CONFIGURED = 506,
    OF_BSN_TLV_VFI = 507,
    OF_BSN_TLV_VFP_CLASS_ID = 508,
    OF_BSN_TLV_VIRTUAL = 509,
    OF_BSN_TLV_VLAN_MAC_LIST = 510,
    OF_BSN_TLV_VLAN_PCP = 511,
    OF_BSN_TLV_VLAN_VID = 512,
    OF_BSN_TLV_VLAN_VID_MASK = 513,
    OF_BSN_TLV_VNI = 514,
    OF_BSN_TLV_VPN_KEY = 515,
    OF_BSN_TLV_VRF = 516,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 517,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 518,
    OF_BSN_VLAN_MAC = 519,
    OF_BSN_VPORT = 520,
    OF_BSN_VPORT_L2GRE = 521,
    OF_BSN_VPORT_Q_IN_Q = 522,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 523,
    OF_BUCKET = 524,
    OF_BUCKET_COUNTER = 525,
    OF_BUNDLE_PROP = 526,
    OF_BUNDLE_PROP_EXPERIMENTER = 527,
    OF_FLOW_STATS_ENTRY = 528,
    OF_GROUP_DESC_STATS_ENTRY = 529,
    OF_GROUP_STATS_ENTRY = 530,
    OF_HELLO_ELEM = 531,
    OF_HELLO_ELEM_VERSIONBITMAP = 532,
    OF_INSTRUCTION = 533,
    OF_INSTRUCTION_APPLY_ACTIONS = 534,
    OF_INSTRUCTION_BSN = 535,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 536,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 537,
    OF_INSTRUCTION_BSN_DENY = 538,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 539,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 540,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 541,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 542,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 543,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 544,
    OF_INSTRUCTION_BSN_HASH_SELECT = 545,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 546,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 547,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 548,
    OF_INSTRUCTION_BSN_PERMIT = 549,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 550,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 551,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 552,
    OF_INSTRUCTION_CLEAR_ACTIONS = 553,
    OF_INSTRUCTION_EXPERIMENTER = 554,
    OF_INSTRUCTION_GOTO_TABLE = 555,
    OF_INSTRUCTION_ID = 556,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 557,
    OF_INSTRUCTION_ID_BSN = 558,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 559,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 560,
    OF_INSTRUCTION_ID_BSN_DENY = 561,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 562,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 563,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 564,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 565,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 566,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 567,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 568,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 569,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 570,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 571,
    OF_INSTRUCTION_ID_BSN_PERMIT = 572,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 573,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 574,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 575,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 576,
    OF_INSTRUCTION_ID_EXPERIMENTER = 577,
    OF_INSTRUCTION_ID_GOTO_TABLE = 578,
    OF_INSTRUCTION_ID_METER = 579,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 580,
    OF_INSTRUCTION_ID_WRITE_METADATA = 581,
    OF_INSTRUCTION_METER = 582,
    OF_INSTRUCTION_WRITE_ACTIONS = 583,
    OF_INSTRUCTION_WRITE_METADATA = 584,
    OF_MATCH_V1 = 585,
    OF_MATCH_V2 = 586,
    OF_MATCH_V3 = 587,
    OF_METER_BAND = 588,
    OF_METER_BAND_DROP = 589,
    OF_METER_BAND_DSCP_REMARK = 590,
    OF_METER_BAND_EXPERIMENTER = 591,
    OF_METER_BAND_STATS = 592,
    OF_METER_CONFIG = 593,
    OF_METER_FEATURES = 594,
    OF_METER_STATS = 595,
    OF_OXM = 596,
    OF_OXM_ARP_OP = 597,
    OF_OXM_ARP_OP_MASKED = 598,
    OF_OXM_ARP_SHA = 599,
    OF_OXM_ARP_SHA_MASKED = 600,
    OF_OXM_ARP_SPA = 601,
    OF_OXM_ARP_SPA_MASKED = 602,
    OF_OXM_ARP_THA = 603,
    OF_OXM_ARP_THA_MASKED = 604,
    OF_OXM_ARP_TPA = 605,
    OF_OXM_ARP_TPA_MASKED = 606,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 607,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 608,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 609,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 610,
    OF_OXM_BSN_IFP_CLASS_ID = 611,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 612,
    OF_OXM_BSN_IN_PORTS_128 = 613,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 614,
    OF_OXM_BSN_IN_PORTS_512 = 615,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 616,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 617,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 618,
    OF_OXM_BSN_INNER_ETH_DST = 619,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 620,
    OF_OXM_BSN_INNER_ETH_SRC = 621,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 622,
    OF_OXM_BSN_INNER_VLAN_VID = 623,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 624,
    OF_OXM_BSN_IP_FRAGMENTATION = 625,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 626,
    OF_OXM_BSN_L2_CACHE_HIT = 627,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 628,
    OF_OXM_BSN_L3_DST_CLASS_ID = 629,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 630,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 631,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 632,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 633,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 634,
    OF_OXM_BSN_LAG_ID = 635,
    OF_OXM_BSN_LAG_ID_MASKED = 636,
    OF_OXM_BSN_TCP_FLAGS = 637,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 638,
    OF_OXM_BSN_UDF0 = 639,
    OF_OXM_BSN_UDF0_MASKED = 640,
    OF_OXM_BSN_UDF1 = 641,
    OF_OXM_BSN_UDF1_MASKED = 642,
    OF_OXM_BSN_UDF2 = 643,
    OF_OXM_BSN_UDF2_MASKED = 644,
    OF_OXM_BSN_UDF3 = 645,
    OF_OXM_BSN_UDF3_MASKED = 646,
    OF_OXM_BSN_UDF4 = 647,
    OF_OXM_BSN_UDF4_MASKED = 648,
    OF_OXM_BSN_UDF5 = 649,
    OF_OXM_BSN_UDF5_MASKED = 650,
    OF_OXM_BSN_UDF6 = 651,
    OF_OXM_BSN_UDF6_MASKED = 652,
    OF_OXM_BSN_UDF7 = 653,
    OF_OXM_BSN_UDF7_MASKED = 654,
    OF_OXM_BSN_VFI = 655,
    OF_OXM_BSN_VFI_MASKED = 656,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 657,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 658,
    OF_OXM_BSN_VRF = 659,
    OF_OXM_BSN_VRF_MASKED = 660,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 661,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 662,
    OF_OXM_CONN_TRACKING_IPV6_DST = 663,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 664,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 665,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 666,
    OF_OXM_CONN_TRACKING_LABEL = 667,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 668,
    OF_OXM_CONN_TRACKING_MARK = 669,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 670,
    OF_OXM_CONN_TRACKING_NW_DST = 671,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 672,
    OF_OXM_CONN_TRACKING_NW_PROTO = 673,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 674,
    OF_OXM_CONN_TRACKING_NW_SRC = 675,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 676,
    OF_OXM_CONN_TRACKING_STATE = 677,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 678,
    OF_OXM_CONN_TRACKING_TP_DST = 679,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 680,
    OF_OXM_CONN_TRACKING_TP_SRC = 681,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 682,
    OF_OXM_CONN_TRACKING_ZONE = 683,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 684,
    OF_OXM_ETH_DST = 685,
    OF_OXM_ETH_DST_MASKED = 686,
    OF_OXM_ETH_SRC = 687,
    OF_OXM_ETH_SRC_MASKED = 688,
    OF_OXM_ETH_TYPE = 689,
    OF_OXM_ETH_TYPE_MASKED = 690,
    OF_OXM_ICMPV4_CODE = 691,
    OF_OXM_ICMPV4_CODE_MASKED = 692,
    OF_OXM_ICMPV4_TYPE = 693,
    OF_OXM_ICMPV4_TYPE_MASKED = 694,
    OF_OXM_ICMPV6_CODE = 695,
    OF_OXM_ICMPV6_CODE_MASKED = 696,
    OF_OXM_ICMPV6_TYPE = 697,
    OF_OXM_ICMPV6_TYPE_MASKED = 698,
    OF_OXM_IN_PHY_PORT = 699,
    OF_OXM_IN_PHY_PORT_MASKED = 700,
    OF_OXM_IN_PORT = 701,
    OF_OXM_IN_PORT_MASKED = 702,
    OF_OXM_IP_DSCP = 703,
    OF_OXM_IP_DSCP_MASKED = 704,
    OF_OXM_IP_ECN = 705,
    OF_OXM_IP_ECN_MASKED = 706,
    OF_OXM_IP_PROTO = 707,
    OF_OXM_IP_PROTO_MASKED = 708,
    OF_OXM_IPV4_DST = 709,
    OF_OXM_IPV4_DST_MASKED = 710,
    OF_OXM_IPV4_SRC = 711,
    OF_OXM_IPV4_SRC_MASKED = 712,
    OF_OXM_IPV6_DST = 713,
    OF_OXM_IPV6_DST_MASKED = 714,
    OF_OXM_IPV6_EXTHDR = 715,
    OF_OXM_IPV6_EXTHDR_MASKED = 716,
    OF_OXM_IPV6_FLABEL = 717,
    OF_OXM_IPV6_FLABEL_MASKED = 718,
    OF_OXM_IPV6_ND_SLL = 719,
    OF_OXM_IPV6_ND_SLL_MASKED = 720,
    OF_OXM_IPV6_ND_TARGET = 721,
    OF_OXM_IPV6_ND_TARGET_MASKED = 722,
    OF_OXM_IPV6_ND_TLL = 723,
    OF_OXM_IPV6_ND_TLL_MASKED = 724,
    OF_OXM_IPV6_SRC = 725,
    OF_OXM_IPV6_SRC_MASKED = 726,
    OF_OXM_METADATA = 727,
    OF_OXM_METADATA_MASKED = 728,
    OF_OXM_MPLS_BOS = 729,
    OF_OXM_MPLS_BOS_MASKED = 730,
    OF_OXM_MPLS_LABEL = 731,
    OF_OXM_MPLS_LABEL_MASKED = 732,
    OF_OXM_MPLS_TC = 733,
    OF_OXM_MPLS_TC_MASKED = 734,
    OF_OXM_OVS_TCP_FLAGS = 735,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 736,
    OF_OXM_PBB_UCA = 737,
    OF_OXM_PBB_UCA_MASKED = 738,
    OF_OXM_SCTP_DST = 739,
    OF_OXM_SCTP_DST_MASKED = 740,
    OF_OXM_SCTP_SRC = 741,
    OF_OXM_SCTP_SRC_MASKED = 742,
    OF_OXM_TCP_DST = 743,
    OF_OXM_TCP_DST_MASKED = 744,
    OF_OXM_TCP_SRC = 745,
    OF_OXM_TCP_SRC_MASKED = 746,
    OF_OXM_TUNNEL_ID = 747,
    OF_OXM_TUNNEL_ID_MASKED = 748,
    OF_OXM_TUNNEL_IPV4_DST = 749,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 750,
    OF_OXM_TUNNEL_IPV4_SRC = 751,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 752,
    OF_OXM_UDP_DST = 753,
    OF_OXM_UDP_DST_MASKED = 754,
    OF_OXM_UDP_SRC = 755,
    OF_OXM_UDP_SRC_MASKED = 756,
    OF_OXM_VLAN_PCP = 757,
    OF_OXM_VLAN_PCP_MASKED = 758,
    OF_OXM_VLAN_VID = 759,
    OF_OXM_VLAN_VID_MASKED = 760,
    OF_PACKET_QUEUE = 761,
    OF_PORT_DESC = 762,
    OF_PORT_DESC_PROP = 763,
    OF_PORT_DESC_PROP_BSN = 764,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 765,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 766,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 767,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 768,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 769,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 770,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 771,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 772,
    OF_PORT_DESC_PROP_BSN_UPLINK = 773,
    OF_PORT_DESC_PROP_ETHERNET = 774,
    OF_PORT_DESC_PROP_EXPERIMENTER = 775,
    OF_PORT_DESC_PROP_OPTICAL = 776,
    OF_PORT_MOD_PROP = 777,
    OF_PORT_MOD_PROP_ETHERNET = 778,
    OF_PORT_MOD_PROP_EXPERIMENTER = 779,
    OF_PORT_MOD_PROP_OPTICAL = 780,
    OF_PORT_STATS_ENTRY = 781,
    OF_PORT_STATS_PROP = 782,
    OF_PORT_STATS_PROP_ETHERNET = 783,
    OF_PORT_STATS_PROP_EXPERIMENTER = 784,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 785,
    OF_PORT_STATS_PROP_OPTICAL = 786,
    OF_QUEUE_DESC = 787,
    OF_QUEUE_DESC_PROP = 788,
    OF_QUEUE_DESC_PROP_BSN = 789,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 790,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 791,
    OF_QUEUE_DESC_PROP_MAX_RATE = 792,
    OF_QUEUE_DESC_PROP_MIN_RATE = 793,
    OF_QUEUE_PROP = 794,
    OF_QUEUE_PROP_EXPERIMENTER = 795,
    OF_QUEUE_PROP_MAX_RATE = 796,
    OF_QUEUE_PROP_MIN_RATE = 797,
    OF_QUEUE_STATS_ENTRY = 798,
    OF_QUEUE_STATS_PROP = 799,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 800,
    OF_ROLE_PROP = 801,
    OF_ROLE_PROP_EXPERIMENTER = 802,
    OF_TABLE_DESC = 803,
    OF_TABLE_FEATURE_PROP = 804,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 805,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 806,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 807,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 808,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 809,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 810,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 811,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 812,
    OF_TABLE_FEATURE_PROP_MATCH = 813,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 814,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 815,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 816,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 817,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 818,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 819,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 820,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 821,
    OF_TABLE_FEATURES = 822,
    OF_TABLE_MOD_PROP = 823,
    OF_TABLE_MOD_PROP_EVICTION = 824,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 825,
    OF_TABLE_MOD_PROP_VACANCY = 826,
    OF_TABLE_STATS_ENTRY = 827,
    OF_UINT32 = 828,
    OF_UINT64 = 829,
    OF_UINT8 = 830,
    ...
    /* List objects */
    OF_LIST_ACTION = 831,
    OF_LIST_ACTION_ID = 832,
    OF_LIST_ASYNC_CONFIG_PROP = 833,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 834,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 835,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 836,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 837,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 838,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 839,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 840,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 841,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 842,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 843,
    OF_LIST_BSN_INTERFACE = 844,
    OF_LIST_BSN_LACP_STATS_ENTRY = 845,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 846,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 847,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 848,
    OF_LIST_BSN_TLV = 849,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 850,
    OF_LIST_BSN_VLAN_MAC = 851,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 852,
    OF_LIST_BUCKET = 853,
    OF_LIST_BUCKET_COUNTER = 854,
    OF_LIST_BUNDLE_PROP = 855,
    OF_LIST_FLOW_STATS_ENTRY = 856,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 857,
    OF_LIST_GROUP_STATS_ENTRY = 858,
    OF_LIST_HELLO_ELEM = 859,
    OF_LIST_INSTRUCTION = 860,
    OF_LIST_INSTRUCTION_ID = 861,
    OF_LIST_METER_BAND = 862,
    OF_LIST_METER_BAND_STATS = 863,
    OF_LIST_METER_CONFIG = 864,
    OF_LIST_METER_STATS = 865,
    OF_LIST_OXM = 866,
    OF_LIST_PACKET_QUEUE = 867,
    OF_LIST_PORT_DESC = 868,
    OF_LIST_PORT_DESC_PROP = 869,
    OF_LIST_PORT_MOD_PROP = 870,
    OF_LIST_PORT_STATS_ENTRY = 871,
    OF_LIST_PORT_STATS_PROP = 872,
    OF_LIST_QUEUE_DESC = 873,
    OF_LIST_QUEUE_DESC_PROP = 874,
    OF_LIST_QUEUE_PROP = 875,
    OF_LIST_QUEUE_STATS_ENTRY = 876,
    OF_LIST_QUEUE_STATS_PROP = 877,
    OF_LIST_ROLE_PROP = 878,
    OF_LIST_TABLE_DESC = 879,
    OF_LIST_TABLE_FEATURE_PROP = 880,
    OF_LIST_TABLE_FEATURES = 881,
    OF_LIST_TABLE_MOD_PROP = 882,
    OF_LIST_TABLE_STATS_ENTRY = 883,
    OF_LIST_UINT32 = 884,
    OF_LIST_UINT64 = 885,
    OF_LIST_UINT8 = 886,
