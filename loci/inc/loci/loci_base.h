...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_TTL = 428,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 429,
    OF_BSN_TLV_TX_BYTES = 430,
    OF_BSN_TLV_TX_PACKETS = 431,
    OF_BSN_TLV_UDF_ANCHOR = 432,
    OF_BSN_TLV_UDF_ID = 433,
    OF_BSN_TLV_UDF_LENGTH = 434,
    OF_BSN_TLV_UDF_OFFSET = 435,
    OF_BSN_TLV_UDP_DST = 436,
    OF_BSN_TLV_UDP_SRC = 437,
    OF_BSN_TLV_UINT64_LIST = 438,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 439,
    OF_BSN_TLV_UNICAST_RATE = 440,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 441,
    OF_BSN_TLV_UNTAGGED = 442,
    OF_BSN_TLV_USE_PACKET_STATE = 443,
    OF_BSN_TLV_VFI = 444,
    OF_BSN_TLV_VFP_CLASS_ID = 445,
    OF_BSN_TLV_VLAN_MAC_LIST = 446,
    OF_BSN_TLV_VLAN_PCP = 447,
    OF_BSN_TLV_VLAN_VID = 448,
    OF_BSN_TLV_VLAN_VID_MASK = 449,
    OF_BSN_TLV_VNI = 450,
    OF_BSN_TLV_VPN_KEY = 451,
    OF_BSN_TLV_VRF = 452,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 453,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 454,
    OF_BSN_VLAN_MAC = 455,
    OF_BSN_VPORT = 456,
    OF_BSN_VPORT_L2GRE = 457,
    OF_BSN_VPORT_Q_IN_Q = 458,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 459,
    OF_BUCKET = 460,
    OF_BUCKET_COUNTER = 461,
    OF_BUNDLE_PROP = 462,
    OF_BUNDLE_PROP_EXPERIMENTER = 463,
    OF_FLOW_STATS_ENTRY = 464,
    OF_GROUP_DESC_STATS_ENTRY = 465,
    OF_GROUP_STATS_ENTRY = 466,
    OF_HELLO_ELEM = 467,
    OF_HELLO_ELEM_VERSIONBITMAP = 468,
    OF_INSTRUCTION = 469,
    OF_INSTRUCTION_APPLY_ACTIONS = 470,
    OF_INSTRUCTION_BSN = 471,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 472,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 473,
    OF_INSTRUCTION_BSN_DENY = 474,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 475,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 476,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 477,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 478,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 479,
    OF_INSTRUCTION_BSN_HASH_SELECT = 480,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 481,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 482,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 483,
    OF_INSTRUCTION_BSN_PERMIT = 484,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 485,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 486,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 487,
    OF_INSTRUCTION_CLEAR_ACTIONS = 488,
    OF_INSTRUCTION_EXPERIMENTER = 489,
    OF_INSTRUCTION_GOTO_TABLE = 490,
    OF_INSTRUCTION_ID = 491,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 492,
    OF_INSTRUCTION_ID_BSN = 493,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 494,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 495,
    OF_INSTRUCTION_ID_BSN_DENY = 496,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 497,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 498,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 499,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 500,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 501,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 502,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 503,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 504,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 505,
    OF_INSTRUCTION_ID_BSN_PERMIT = 506,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 507,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 508,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 509,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 510,
    OF_INSTRUCTION_ID_EXPERIMENTER = 511,
    OF_INSTRUCTION_ID_GOTO_TABLE = 512,
    OF_INSTRUCTION_ID_METER = 513,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 514,
    OF_INSTRUCTION_ID_WRITE_METADATA = 515,
    OF_INSTRUCTION_METER = 516,
    OF_INSTRUCTION_WRITE_ACTIONS = 517,
    OF_INSTRUCTION_WRITE_METADATA = 518,
    OF_MATCH_V1 = 519,
    OF_MATCH_V2 = 520,
    OF_MATCH_V3 = 521,
    OF_METER_BAND = 522,
    OF_METER_BAND_DROP = 523,
    OF_METER_BAND_DSCP_REMARK = 524,
    OF_METER_BAND_EXPERIMENTER = 525,
    OF_METER_BAND_STATS = 526,
    OF_METER_CONFIG = 527,
    OF_METER_FEATURES = 528,
    OF_METER_STATS = 529,
    OF_OXM = 530,
    OF_OXM_ARP_OP = 531,
    OF_OXM_ARP_OP_MASKED = 532,
    OF_OXM_ARP_SHA = 533,
    OF_OXM_ARP_SHA_MASKED = 534,
    OF_OXM_ARP_SPA = 535,
    OF_OXM_ARP_SPA_MASKED = 536,
    OF_OXM_ARP_THA = 537,
    OF_OXM_ARP_THA_MASKED = 538,
    OF_OXM_ARP_TPA = 539,
    OF_OXM_ARP_TPA_MASKED = 540,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 541,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 542,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 543,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 544,
    OF_OXM_BSN_IN_PORTS_128 = 545,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 546,
    OF_OXM_BSN_IN_PORTS_512 = 547,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 548,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 549,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 550,
    OF_OXM_BSN_INNER_ETH_DST = 551,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 552,
    OF_OXM_BSN_INNER_ETH_SRC = 553,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 554,
    OF_OXM_BSN_INNER_VLAN_VID = 555,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 556,
    OF_OXM_BSN_IP_FRAGMENTATION = 557,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 558,
    OF_OXM_BSN_L2_CACHE_HIT = 559,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 560,
    OF_OXM_BSN_L3_DST_CLASS_ID = 561,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 562,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 563,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 564,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 565,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 566,
    OF_OXM_BSN_LAG_ID = 567,
    OF_OXM_BSN_LAG_ID_MASKED = 568,
    OF_OXM_BSN_TCP_FLAGS = 569,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 570,
    OF_OXM_BSN_UDF0 = 571,
    OF_OXM_BSN_UDF0_MASKED = 572,
    OF_OXM_BSN_UDF1 = 573,
    OF_OXM_BSN_UDF1_MASKED = 574,
    OF_OXM_BSN_UDF2 = 575,
    OF_OXM_BSN_UDF2_MASKED = 576,
    OF_OXM_BSN_UDF3 = 577,
    OF_OXM_BSN_UDF3_MASKED = 578,
    OF_OXM_BSN_UDF4 = 579,
    OF_OXM_BSN_UDF4_MASKED = 580,
    OF_OXM_BSN_UDF5 = 581,
    OF_OXM_BSN_UDF5_MASKED = 582,
    OF_OXM_BSN_UDF6 = 583,
    OF_OXM_BSN_UDF6_MASKED = 584,
    OF_OXM_BSN_UDF7 = 585,
    OF_OXM_BSN_UDF7_MASKED = 586,
    OF_OXM_BSN_VFI = 587,
    OF_OXM_BSN_VFI_MASKED = 588,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 589,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 590,
    OF_OXM_BSN_VRF = 591,
    OF_OXM_BSN_VRF_MASKED = 592,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 593,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 594,
    OF_OXM_ETH_DST = 595,
    OF_OXM_ETH_DST_MASKED = 596,
    OF_OXM_ETH_SRC = 597,
    OF_OXM_ETH_SRC_MASKED = 598,
    OF_OXM_ETH_TYPE = 599,
    OF_OXM_ETH_TYPE_MASKED = 600,
    OF_OXM_ICMPV4_CODE = 601,
    OF_OXM_ICMPV4_CODE_MASKED = 602,
    OF_OXM_ICMPV4_TYPE = 603,
    OF_OXM_ICMPV4_TYPE_MASKED = 604,
    OF_OXM_ICMPV6_CODE = 605,
    OF_OXM_ICMPV6_CODE_MASKED = 606,
    OF_OXM_ICMPV6_TYPE = 607,
    OF_OXM_ICMPV6_TYPE_MASKED = 608,
    OF_OXM_IN_PHY_PORT = 609,
    OF_OXM_IN_PHY_PORT_MASKED = 610,
    OF_OXM_IN_PORT = 611,
    OF_OXM_IN_PORT_MASKED = 612,
    OF_OXM_IP_DSCP = 613,
    OF_OXM_IP_DSCP_MASKED = 614,
    OF_OXM_IP_ECN = 615,
    OF_OXM_IP_ECN_MASKED = 616,
    OF_OXM_IP_PROTO = 617,
    OF_OXM_IP_PROTO_MASKED = 618,
    OF_OXM_IPV4_DST = 619,
    OF_OXM_IPV4_DST_MASKED = 620,
    OF_OXM_IPV4_SRC = 621,
    OF_OXM_IPV4_SRC_MASKED = 622,
    OF_OXM_IPV6_DST = 623,
    OF_OXM_IPV6_DST_MASKED = 624,
    OF_OXM_IPV6_EXTHDR = 625,
    OF_OXM_IPV6_EXTHDR_MASKED = 626,
    OF_OXM_IPV6_FLABEL = 627,
    OF_OXM_IPV6_FLABEL_MASKED = 628,
    OF_OXM_IPV6_ND_SLL = 629,
    OF_OXM_IPV6_ND_SLL_MASKED = 630,
    OF_OXM_IPV6_ND_TARGET = 631,
    OF_OXM_IPV6_ND_TARGET_MASKED = 632,
    OF_OXM_IPV6_ND_TLL = 633,
    OF_OXM_IPV6_ND_TLL_MASKED = 634,
    OF_OXM_IPV6_SRC = 635,
    OF_OXM_IPV6_SRC_MASKED = 636,
    OF_OXM_METADATA = 637,
    OF_OXM_METADATA_MASKED = 638,
    OF_OXM_MPLS_BOS = 639,
    OF_OXM_MPLS_BOS_MASKED = 640,
    OF_OXM_MPLS_LABEL = 641,
    OF_OXM_MPLS_LABEL_MASKED = 642,
    OF_OXM_MPLS_TC = 643,
    OF_OXM_MPLS_TC_MASKED = 644,
    OF_OXM_OVS_TCP_FLAGS = 645,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 646,
    OF_OXM_PBB_UCA = 647,
    OF_OXM_PBB_UCA_MASKED = 648,
    OF_OXM_SCTP_DST = 649,
    OF_OXM_SCTP_DST_MASKED = 650,
    OF_OXM_SCTP_SRC = 651,
    OF_OXM_SCTP_SRC_MASKED = 652,
    OF_OXM_TCP_DST = 653,
    OF_OXM_TCP_DST_MASKED = 654,
    OF_OXM_TCP_SRC = 655,
    OF_OXM_TCP_SRC_MASKED = 656,
    OF_OXM_TUNNEL_ID = 657,
    OF_OXM_TUNNEL_ID_MASKED = 658,
    OF_OXM_TUNNEL_IPV4_DST = 659,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 660,
    OF_OXM_TUNNEL_IPV4_SRC = 661,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 662,
    OF_OXM_UDP_DST = 663,
    OF_OXM_UDP_DST_MASKED = 664,
    OF_OXM_UDP_SRC = 665,
    OF_OXM_UDP_SRC_MASKED = 666,
    OF_OXM_VLAN_PCP = 667,
    OF_OXM_VLAN_PCP_MASKED = 668,
    OF_OXM_VLAN_VID = 669,
    OF_OXM_VLAN_VID_MASKED = 670,
    OF_PACKET_QUEUE = 671,
    OF_PORT_DESC = 672,
    OF_PORT_DESC_PROP = 673,
    OF_PORT_DESC_PROP_BSN = 674,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 675,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 676,
    OF_PORT_DESC_PROP_BSN_UPLINK = 677,
    OF_PORT_DESC_PROP_ETHERNET = 678,
    OF_PORT_DESC_PROP_EXPERIMENTER = 679,
    OF_PORT_DESC_PROP_OPTICAL = 680,
    OF_PORT_MOD_PROP = 681,
    OF_PORT_MOD_PROP_ETHERNET = 682,
    OF_PORT_MOD_PROP_EXPERIMENTER = 683,
    OF_PORT_MOD_PROP_OPTICAL = 684,
    OF_PORT_STATS_ENTRY = 685,
    OF_PORT_STATS_PROP = 686,
    OF_PORT_STATS_PROP_ETHERNET = 687,
    OF_PORT_STATS_PROP_EXPERIMENTER = 688,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 689,
    OF_PORT_STATS_PROP_OPTICAL = 690,
    OF_QUEUE_DESC = 691,
    OF_QUEUE_DESC_PROP = 692,
    OF_QUEUE_DESC_PROP_BSN = 693,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 694,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 695,
    OF_QUEUE_DESC_PROP_MAX_RATE = 696,
    OF_QUEUE_DESC_PROP_MIN_RATE = 697,
    OF_QUEUE_PROP = 698,
    OF_QUEUE_PROP_EXPERIMENTER = 699,
    OF_QUEUE_PROP_MAX_RATE = 700,
    OF_QUEUE_PROP_MIN_RATE = 701,
    OF_QUEUE_STATS_ENTRY = 702,
    OF_QUEUE_STATS_PROP = 703,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 704,
    OF_ROLE_PROP = 705,
    OF_ROLE_PROP_EXPERIMENTER = 706,
    OF_TABLE_DESC = 707,
    OF_TABLE_FEATURE_PROP = 708,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 709,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 710,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 711,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 712,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 713,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 714,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 715,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 716,
    OF_TABLE_FEATURE_PROP_MATCH = 717,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 718,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 719,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 720,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 721,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 722,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 723,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 724,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 725,
    OF_TABLE_FEATURES = 726,
    OF_TABLE_MOD_PROP = 727,
    OF_TABLE_MOD_PROP_EVICTION = 728,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 729,
    OF_TABLE_MOD_PROP_VACANCY = 730,
    OF_TABLE_STATS_ENTRY = 731,
    OF_UINT32 = 732,
    OF_UINT64 = 733,
    OF_UINT8 = 734,
    ...
    /* List objects */
    OF_LIST_ACTION = 735,
    OF_LIST_ACTION_ID = 736,
    OF_LIST_ASYNC_CONFIG_PROP = 737,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 738,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 739,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 740,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 741,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 742,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 743,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 744,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 745,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 746,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 747,
    OF_LIST_BSN_INTERFACE = 748,
    OF_LIST_BSN_LACP_STATS_ENTRY = 749,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 750,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 751,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 752,
    OF_LIST_BSN_TLV = 753,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 754,
    OF_LIST_BSN_VLAN_MAC = 755,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 756,
    OF_LIST_BUCKET = 757,
    OF_LIST_BUCKET_COUNTER = 758,
    OF_LIST_BUNDLE_PROP = 759,
    OF_LIST_FLOW_STATS_ENTRY = 760,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 761,
    OF_LIST_GROUP_STATS_ENTRY = 762,
    OF_LIST_HELLO_ELEM = 763,
    OF_LIST_INSTRUCTION = 764,
    OF_LIST_INSTRUCTION_ID = 765,
    OF_LIST_METER_BAND = 766,
    OF_LIST_METER_BAND_STATS = 767,
    OF_LIST_METER_CONFIG = 768,
    OF_LIST_METER_STATS = 769,
    OF_LIST_OXM = 770,
    OF_LIST_PACKET_QUEUE = 771,
    OF_LIST_PORT_DESC = 772,
    OF_LIST_PORT_DESC_PROP = 773,
    OF_LIST_PORT_MOD_PROP = 774,
    OF_LIST_PORT_STATS_ENTRY = 775,
    OF_LIST_PORT_STATS_PROP = 776,
    OF_LIST_QUEUE_DESC = 777,
    OF_LIST_QUEUE_DESC_PROP = 778,
    OF_LIST_QUEUE_PROP = 779,
    OF_LIST_QUEUE_STATS_ENTRY = 780,
    OF_LIST_QUEUE_STATS_PROP = 781,
    OF_LIST_ROLE_PROP = 782,
    OF_LIST_TABLE_DESC = 783,
    OF_LIST_TABLE_FEATURE_PROP = 784,
    OF_LIST_TABLE_FEATURES = 785,
    OF_LIST_TABLE_MOD_PROP = 786,
    OF_LIST_TABLE_STATS_ENTRY = 787,
    OF_LIST_UINT32 = 788,
    OF_LIST_UINT64 = 789,
    OF_LIST_UINT8 = 790,
