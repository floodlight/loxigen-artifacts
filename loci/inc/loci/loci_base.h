...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 393,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 394,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 395,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 396,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 397,
    OF_INSTRUCTION_BSN_PERMIT = 398,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 399,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 400,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 401,
    OF_INSTRUCTION_CLEAR_ACTIONS = 402,
    OF_INSTRUCTION_EXPERIMENTER = 403,
    OF_INSTRUCTION_GOTO_TABLE = 404,
    OF_INSTRUCTION_ID = 405,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 406,
    OF_INSTRUCTION_ID_BSN = 407,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 408,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 409,
    OF_INSTRUCTION_ID_BSN_DENY = 410,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 411,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 412,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 413,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 414,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 415,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 416,
    OF_INSTRUCTION_ID_BSN_PERMIT = 417,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 418,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 419,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 420,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 421,
    OF_INSTRUCTION_ID_EXPERIMENTER = 422,
    OF_INSTRUCTION_ID_GOTO_TABLE = 423,
    OF_INSTRUCTION_ID_METER = 424,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 425,
    OF_INSTRUCTION_ID_WRITE_METADATA = 426,
    OF_INSTRUCTION_METER = 427,
    OF_INSTRUCTION_WRITE_ACTIONS = 428,
    OF_INSTRUCTION_WRITE_METADATA = 429,
    OF_MATCH_V1 = 430,
    OF_MATCH_V2 = 431,
    OF_MATCH_V3 = 432,
    OF_METER_BAND = 433,
    OF_METER_BAND_DROP = 434,
    OF_METER_BAND_DSCP_REMARK = 435,
    OF_METER_BAND_EXPERIMENTER = 436,
    OF_METER_BAND_STATS = 437,
    OF_METER_CONFIG = 438,
    OF_METER_FEATURES = 439,
    OF_METER_STATS = 440,
    OF_OXM = 441,
    OF_OXM_ARP_OP = 442,
    OF_OXM_ARP_OP_MASKED = 443,
    OF_OXM_ARP_SHA = 444,
    OF_OXM_ARP_SHA_MASKED = 445,
    OF_OXM_ARP_SPA = 446,
    OF_OXM_ARP_SPA_MASKED = 447,
    OF_OXM_ARP_THA = 448,
    OF_OXM_ARP_THA_MASKED = 449,
    OF_OXM_ARP_TPA = 450,
    OF_OXM_ARP_TPA_MASKED = 451,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 452,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 453,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 454,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 455,
    OF_OXM_BSN_IN_PORTS_128 = 456,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 457,
    OF_OXM_BSN_IN_PORTS_512 = 458,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 459,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 460,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 461,
    OF_OXM_BSN_L2_CACHE_HIT = 462,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 463,
    OF_OXM_BSN_L3_DST_CLASS_ID = 464,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 465,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 466,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 467,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 468,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 469,
    OF_OXM_BSN_LAG_ID = 470,
    OF_OXM_BSN_LAG_ID_MASKED = 471,
    OF_OXM_BSN_TCP_FLAGS = 472,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 473,
    OF_OXM_BSN_UDF0 = 474,
    OF_OXM_BSN_UDF0_MASKED = 475,
    OF_OXM_BSN_UDF1 = 476,
    OF_OXM_BSN_UDF1_MASKED = 477,
    OF_OXM_BSN_UDF2 = 478,
    OF_OXM_BSN_UDF2_MASKED = 479,
    OF_OXM_BSN_UDF3 = 480,
    OF_OXM_BSN_UDF3_MASKED = 481,
    OF_OXM_BSN_UDF4 = 482,
    OF_OXM_BSN_UDF4_MASKED = 483,
    OF_OXM_BSN_UDF5 = 484,
    OF_OXM_BSN_UDF5_MASKED = 485,
    OF_OXM_BSN_UDF6 = 486,
    OF_OXM_BSN_UDF6_MASKED = 487,
    OF_OXM_BSN_UDF7 = 488,
    OF_OXM_BSN_UDF7_MASKED = 489,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 490,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 491,
    OF_OXM_BSN_VRF = 492,
    OF_OXM_BSN_VRF_MASKED = 493,
    OF_OXM_ETH_DST = 494,
    OF_OXM_ETH_DST_MASKED = 495,
    OF_OXM_ETH_SRC = 496,
    OF_OXM_ETH_SRC_MASKED = 497,
    OF_OXM_ETH_TYPE = 498,
    OF_OXM_ETH_TYPE_MASKED = 499,
    OF_OXM_ICMPV4_CODE = 500,
    OF_OXM_ICMPV4_CODE_MASKED = 501,
    OF_OXM_ICMPV4_TYPE = 502,
    OF_OXM_ICMPV4_TYPE_MASKED = 503,
    OF_OXM_ICMPV6_CODE = 504,
    OF_OXM_ICMPV6_CODE_MASKED = 505,
    OF_OXM_ICMPV6_TYPE = 506,
    OF_OXM_ICMPV6_TYPE_MASKED = 507,
    OF_OXM_IN_PHY_PORT = 508,
    OF_OXM_IN_PHY_PORT_MASKED = 509,
    OF_OXM_IN_PORT = 510,
    OF_OXM_IN_PORT_MASKED = 511,
    OF_OXM_IP_DSCP = 512,
    OF_OXM_IP_DSCP_MASKED = 513,
    OF_OXM_IP_ECN = 514,
    OF_OXM_IP_ECN_MASKED = 515,
    OF_OXM_IP_PROTO = 516,
    OF_OXM_IP_PROTO_MASKED = 517,
    OF_OXM_IPV4_DST = 518,
    OF_OXM_IPV4_DST_MASKED = 519,
    OF_OXM_IPV4_SRC = 520,
    OF_OXM_IPV4_SRC_MASKED = 521,
    OF_OXM_IPV6_DST = 522,
    OF_OXM_IPV6_DST_MASKED = 523,
    OF_OXM_IPV6_EXTHDR = 524,
    OF_OXM_IPV6_EXTHDR_MASKED = 525,
    OF_OXM_IPV6_FLABEL = 526,
    OF_OXM_IPV6_FLABEL_MASKED = 527,
    OF_OXM_IPV6_ND_SLL = 528,
    OF_OXM_IPV6_ND_SLL_MASKED = 529,
    OF_OXM_IPV6_ND_TARGET = 530,
    OF_OXM_IPV6_ND_TARGET_MASKED = 531,
    OF_OXM_IPV6_ND_TLL = 532,
    OF_OXM_IPV6_ND_TLL_MASKED = 533,
    OF_OXM_IPV6_SRC = 534,
    OF_OXM_IPV6_SRC_MASKED = 535,
    OF_OXM_METADATA = 536,
    OF_OXM_METADATA_MASKED = 537,
    OF_OXM_MPLS_BOS = 538,
    OF_OXM_MPLS_BOS_MASKED = 539,
    OF_OXM_MPLS_LABEL = 540,
    OF_OXM_MPLS_LABEL_MASKED = 541,
    OF_OXM_MPLS_TC = 542,
    OF_OXM_MPLS_TC_MASKED = 543,
    OF_OXM_PBB_UCA = 544,
    OF_OXM_PBB_UCA_MASKED = 545,
    OF_OXM_SCTP_DST = 546,
    OF_OXM_SCTP_DST_MASKED = 547,
    OF_OXM_SCTP_SRC = 548,
    OF_OXM_SCTP_SRC_MASKED = 549,
    OF_OXM_TCP_DST = 550,
    OF_OXM_TCP_DST_MASKED = 551,
    OF_OXM_TCP_SRC = 552,
    OF_OXM_TCP_SRC_MASKED = 553,
    OF_OXM_TUNNEL_ID = 554,
    OF_OXM_TUNNEL_ID_MASKED = 555,
    OF_OXM_TUNNEL_IPV4_DST = 556,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 557,
    OF_OXM_TUNNEL_IPV4_SRC = 558,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 559,
    OF_OXM_UDP_DST = 560,
    OF_OXM_UDP_DST_MASKED = 561,
    OF_OXM_UDP_SRC = 562,
    OF_OXM_UDP_SRC_MASKED = 563,
    OF_OXM_VLAN_PCP = 564,
    OF_OXM_VLAN_PCP_MASKED = 565,
    OF_OXM_VLAN_VID = 566,
    OF_OXM_VLAN_VID_MASKED = 567,
    OF_PACKET_QUEUE = 568,
    OF_PORT_DESC = 569,
    OF_PORT_DESC_PROP = 570,
    OF_PORT_DESC_PROP_BSN = 571,
    OF_PORT_DESC_PROP_BSN_UPLINK = 572,
    OF_PORT_DESC_PROP_ETHERNET = 573,
    OF_PORT_DESC_PROP_EXPERIMENTER = 574,
    OF_PORT_DESC_PROP_OPTICAL = 575,
    OF_PORT_MOD_PROP = 576,
    OF_PORT_MOD_PROP_ETHERNET = 577,
    OF_PORT_MOD_PROP_EXPERIMENTER = 578,
    OF_PORT_MOD_PROP_OPTICAL = 579,
    OF_PORT_STATS_ENTRY = 580,
    OF_PORT_STATS_PROP = 581,
    OF_PORT_STATS_PROP_ETHERNET = 582,
    OF_PORT_STATS_PROP_EXPERIMENTER = 583,
    OF_PORT_STATS_PROP_OPTICAL = 584,
    OF_QUEUE_DESC = 585,
    OF_QUEUE_DESC_PROP = 586,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 587,
    OF_QUEUE_DESC_PROP_MAX_RATE = 588,
    OF_QUEUE_DESC_PROP_MIN_RATE = 589,
    OF_QUEUE_PROP = 590,
    OF_QUEUE_PROP_EXPERIMENTER = 591,
    OF_QUEUE_PROP_MAX_RATE = 592,
    OF_QUEUE_PROP_MIN_RATE = 593,
    OF_QUEUE_STATS_ENTRY = 594,
    OF_QUEUE_STATS_PROP = 595,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 596,
    OF_ROLE_PROP = 597,
    OF_ROLE_PROP_EXPERIMENTER = 598,
    OF_TABLE_DESC = 599,
    OF_TABLE_FEATURE_PROP = 600,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 601,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 602,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 603,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 604,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 605,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 606,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 607,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 608,
    OF_TABLE_FEATURE_PROP_MATCH = 609,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 610,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 611,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 612,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 613,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 614,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 615,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 616,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 617,
    OF_TABLE_FEATURES = 618,
    OF_TABLE_MOD_PROP = 619,
    OF_TABLE_MOD_PROP_EVICTION = 620,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 621,
    OF_TABLE_MOD_PROP_VACANCY = 622,
    OF_TABLE_STATS_ENTRY = 623,
    OF_UINT32 = 624,
    OF_UINT64 = 625,
    OF_UINT8 = 626,
    ...
    /* List objects */
    OF_LIST_ACTION = 627,
    OF_LIST_ACTION_ID = 628,
    OF_LIST_ASYNC_CONFIG_PROP = 629,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 630,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 631,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 632,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 633,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 634,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 635,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 636,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 637,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 638,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 639,
    OF_LIST_BSN_INTERFACE = 640,
    OF_LIST_BSN_LACP_STATS_ENTRY = 641,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 642,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 643,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 644,
    OF_LIST_BSN_TLV = 645,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 646,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 647,
    OF_LIST_BUCKET = 648,
    OF_LIST_BUCKET_COUNTER = 649,
    OF_LIST_BUNDLE_PROP = 650,
    OF_LIST_FLOW_STATS_ENTRY = 651,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 652,
    OF_LIST_GROUP_STATS_ENTRY = 653,
    OF_LIST_HELLO_ELEM = 654,
    OF_LIST_INSTRUCTION = 655,
    OF_LIST_INSTRUCTION_ID = 656,
    OF_LIST_METER_BAND = 657,
    OF_LIST_METER_BAND_STATS = 658,
    OF_LIST_METER_STATS = 659,
    OF_LIST_OXM = 660,
    OF_LIST_PACKET_QUEUE = 661,
    OF_LIST_PORT_DESC = 662,
    OF_LIST_PORT_DESC_PROP = 663,
    OF_LIST_PORT_MOD_PROP = 664,
    OF_LIST_PORT_STATS_ENTRY = 665,
    OF_LIST_PORT_STATS_PROP = 666,
    OF_LIST_QUEUE_DESC = 667,
    OF_LIST_QUEUE_DESC_PROP = 668,
    OF_LIST_QUEUE_PROP = 669,
    OF_LIST_QUEUE_STATS_ENTRY = 670,
    OF_LIST_QUEUE_STATS_PROP = 671,
    OF_LIST_ROLE_PROP = 672,
    OF_LIST_TABLE_DESC = 673,
    OF_LIST_TABLE_FEATURE_PROP = 674,
    OF_LIST_TABLE_FEATURES = 675,
    OF_LIST_TABLE_MOD_PROP = 676,
    OF_LIST_TABLE_STATS_ENTRY = 677,
    OF_LIST_UINT32 = 678,
    OF_LIST_UINT64 = 679,
    OF_LIST_UINT8 = 680,
