...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PARENT_PORT = 396,
    OF_BSN_TLV_PARTNER_KEY = 397,
    OF_BSN_TLV_PARTNER_PORT_NUM = 398,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 399,
    OF_BSN_TLV_PARTNER_STATE = 400,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 401,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 402,
    OF_BSN_TLV_PORT = 403,
    OF_BSN_TLV_PORT_SPEED_GBPS = 404,
    OF_BSN_TLV_PORT_USAGE = 405,
    OF_BSN_TLV_PORT_VXLAN_MODE = 406,
    OF_BSN_TLV_PRIORITY = 407,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 408,
    OF_BSN_TLV_QOS_PRIORITY = 409,
    OF_BSN_TLV_QUEUE_ID = 410,
    OF_BSN_TLV_QUEUE_WEIGHT = 411,
    OF_BSN_TLV_RATE_LIMIT = 412,
    OF_BSN_TLV_RATE_UNIT = 413,
    OF_BSN_TLV_RECORD_PACKETS = 414,
    OF_BSN_TLV_REFERENCE = 415,
    OF_BSN_TLV_REPLY_PACKETS = 416,
    OF_BSN_TLV_REQUEST_PACKETS = 417,
    OF_BSN_TLV_REST_SERVER = 418,
    OF_BSN_TLV_RX_BYTES = 419,
    OF_BSN_TLV_RX_PACKETS = 420,
    OF_BSN_TLV_SAMPLING_RATE = 421,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 422,
    OF_BSN_TLV_STATUS = 423,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 424,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 425,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 426,
    OF_BSN_TLV_SUB_AGENT_ID = 427,
    OF_BSN_TLV_TCP_DST = 428,
    OF_BSN_TLV_TCP_FLAGS = 429,
    OF_BSN_TLV_TCP_SRC = 430,
    OF_BSN_TLV_TIMESTAMP = 431,
    OF_BSN_TLV_TTL = 432,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 433,
    OF_BSN_TLV_TX_BYTES = 434,
    OF_BSN_TLV_TX_PACKETS = 435,
    OF_BSN_TLV_UDF_ANCHOR = 436,
    OF_BSN_TLV_UDF_ID = 437,
    OF_BSN_TLV_UDF_LENGTH = 438,
    OF_BSN_TLV_UDF_OFFSET = 439,
    OF_BSN_TLV_UDP_DST = 440,
    OF_BSN_TLV_UDP_SRC = 441,
    OF_BSN_TLV_UINT64_LIST = 442,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 443,
    OF_BSN_TLV_UNICAST_RATE = 444,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 445,
    OF_BSN_TLV_UNTAGGED = 446,
    OF_BSN_TLV_URI_SCHEME = 447,
    OF_BSN_TLV_USE_PACKET_STATE = 448,
    OF_BSN_TLV_VFI = 449,
    OF_BSN_TLV_VFP_CLASS_ID = 450,
    OF_BSN_TLV_VLAN_MAC_LIST = 451,
    OF_BSN_TLV_VLAN_PCP = 452,
    OF_BSN_TLV_VLAN_VID = 453,
    OF_BSN_TLV_VLAN_VID_MASK = 454,
    OF_BSN_TLV_VNI = 455,
    OF_BSN_TLV_VPN_KEY = 456,
    OF_BSN_TLV_VRF = 457,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 458,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 459,
    OF_BSN_VLAN_MAC = 460,
    OF_BSN_VPORT = 461,
    OF_BSN_VPORT_L2GRE = 462,
    OF_BSN_VPORT_Q_IN_Q = 463,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 464,
    OF_BUCKET = 465,
    OF_BUCKET_COUNTER = 466,
    OF_BUNDLE_PROP = 467,
    OF_BUNDLE_PROP_EXPERIMENTER = 468,
    OF_FLOW_STATS_ENTRY = 469,
    OF_GROUP_DESC_STATS_ENTRY = 470,
    OF_GROUP_STATS_ENTRY = 471,
    OF_HELLO_ELEM = 472,
    OF_HELLO_ELEM_VERSIONBITMAP = 473,
    OF_INSTRUCTION = 474,
    OF_INSTRUCTION_APPLY_ACTIONS = 475,
    OF_INSTRUCTION_BSN = 476,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 477,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 478,
    OF_INSTRUCTION_BSN_DENY = 479,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 480,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 481,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 482,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 483,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 484,
    OF_INSTRUCTION_BSN_HASH_SELECT = 485,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 486,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 487,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 488,
    OF_INSTRUCTION_BSN_PERMIT = 489,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 490,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 491,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 492,
    OF_INSTRUCTION_CLEAR_ACTIONS = 493,
    OF_INSTRUCTION_EXPERIMENTER = 494,
    OF_INSTRUCTION_GOTO_TABLE = 495,
    OF_INSTRUCTION_ID = 496,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 497,
    OF_INSTRUCTION_ID_BSN = 498,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 499,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 500,
    OF_INSTRUCTION_ID_BSN_DENY = 501,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 502,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 503,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 504,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 505,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 506,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 507,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 508,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 509,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 510,
    OF_INSTRUCTION_ID_BSN_PERMIT = 511,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 512,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 513,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 514,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 515,
    OF_INSTRUCTION_ID_EXPERIMENTER = 516,
    OF_INSTRUCTION_ID_GOTO_TABLE = 517,
    OF_INSTRUCTION_ID_METER = 518,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 519,
    OF_INSTRUCTION_ID_WRITE_METADATA = 520,
    OF_INSTRUCTION_METER = 521,
    OF_INSTRUCTION_WRITE_ACTIONS = 522,
    OF_INSTRUCTION_WRITE_METADATA = 523,
    OF_MATCH_V1 = 524,
    OF_MATCH_V2 = 525,
    OF_MATCH_V3 = 526,
    OF_METER_BAND = 527,
    OF_METER_BAND_DROP = 528,
    OF_METER_BAND_DSCP_REMARK = 529,
    OF_METER_BAND_EXPERIMENTER = 530,
    OF_METER_BAND_STATS = 531,
    OF_METER_CONFIG = 532,
    OF_METER_FEATURES = 533,
    OF_METER_STATS = 534,
    OF_OXM = 535,
    OF_OXM_ARP_OP = 536,
    OF_OXM_ARP_OP_MASKED = 537,
    OF_OXM_ARP_SHA = 538,
    OF_OXM_ARP_SHA_MASKED = 539,
    OF_OXM_ARP_SPA = 540,
    OF_OXM_ARP_SPA_MASKED = 541,
    OF_OXM_ARP_THA = 542,
    OF_OXM_ARP_THA_MASKED = 543,
    OF_OXM_ARP_TPA = 544,
    OF_OXM_ARP_TPA_MASKED = 545,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 546,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 547,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 548,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 549,
    OF_OXM_BSN_IN_PORTS_128 = 550,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 551,
    OF_OXM_BSN_IN_PORTS_512 = 552,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 553,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 554,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 555,
    OF_OXM_BSN_INNER_ETH_DST = 556,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 557,
    OF_OXM_BSN_INNER_ETH_SRC = 558,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 559,
    OF_OXM_BSN_INNER_VLAN_VID = 560,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 561,
    OF_OXM_BSN_IP_FRAGMENTATION = 562,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 563,
    OF_OXM_BSN_L2_CACHE_HIT = 564,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 565,
    OF_OXM_BSN_L3_DST_CLASS_ID = 566,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 567,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 568,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 569,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 570,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 571,
    OF_OXM_BSN_LAG_ID = 572,
    OF_OXM_BSN_LAG_ID_MASKED = 573,
    OF_OXM_BSN_TCP_FLAGS = 574,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 575,
    OF_OXM_BSN_UDF0 = 576,
    OF_OXM_BSN_UDF0_MASKED = 577,
    OF_OXM_BSN_UDF1 = 578,
    OF_OXM_BSN_UDF1_MASKED = 579,
    OF_OXM_BSN_UDF2 = 580,
    OF_OXM_BSN_UDF2_MASKED = 581,
    OF_OXM_BSN_UDF3 = 582,
    OF_OXM_BSN_UDF3_MASKED = 583,
    OF_OXM_BSN_UDF4 = 584,
    OF_OXM_BSN_UDF4_MASKED = 585,
    OF_OXM_BSN_UDF5 = 586,
    OF_OXM_BSN_UDF5_MASKED = 587,
    OF_OXM_BSN_UDF6 = 588,
    OF_OXM_BSN_UDF6_MASKED = 589,
    OF_OXM_BSN_UDF7 = 590,
    OF_OXM_BSN_UDF7_MASKED = 591,
    OF_OXM_BSN_VFI = 592,
    OF_OXM_BSN_VFI_MASKED = 593,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 594,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 595,
    OF_OXM_BSN_VRF = 596,
    OF_OXM_BSN_VRF_MASKED = 597,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 598,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 599,
    OF_OXM_ETH_DST = 600,
    OF_OXM_ETH_DST_MASKED = 601,
    OF_OXM_ETH_SRC = 602,
    OF_OXM_ETH_SRC_MASKED = 603,
    OF_OXM_ETH_TYPE = 604,
    OF_OXM_ETH_TYPE_MASKED = 605,
    OF_OXM_ICMPV4_CODE = 606,
    OF_OXM_ICMPV4_CODE_MASKED = 607,
    OF_OXM_ICMPV4_TYPE = 608,
    OF_OXM_ICMPV4_TYPE_MASKED = 609,
    OF_OXM_ICMPV6_CODE = 610,
    OF_OXM_ICMPV6_CODE_MASKED = 611,
    OF_OXM_ICMPV6_TYPE = 612,
    OF_OXM_ICMPV6_TYPE_MASKED = 613,
    OF_OXM_IN_PHY_PORT = 614,
    OF_OXM_IN_PHY_PORT_MASKED = 615,
    OF_OXM_IN_PORT = 616,
    OF_OXM_IN_PORT_MASKED = 617,
    OF_OXM_IP_DSCP = 618,
    OF_OXM_IP_DSCP_MASKED = 619,
    OF_OXM_IP_ECN = 620,
    OF_OXM_IP_ECN_MASKED = 621,
    OF_OXM_IP_PROTO = 622,
    OF_OXM_IP_PROTO_MASKED = 623,
    OF_OXM_IPV4_DST = 624,
    OF_OXM_IPV4_DST_MASKED = 625,
    OF_OXM_IPV4_SRC = 626,
    OF_OXM_IPV4_SRC_MASKED = 627,
    OF_OXM_IPV6_DST = 628,
    OF_OXM_IPV6_DST_MASKED = 629,
    OF_OXM_IPV6_EXTHDR = 630,
    OF_OXM_IPV6_EXTHDR_MASKED = 631,
    OF_OXM_IPV6_FLABEL = 632,
    OF_OXM_IPV6_FLABEL_MASKED = 633,
    OF_OXM_IPV6_ND_SLL = 634,
    OF_OXM_IPV6_ND_SLL_MASKED = 635,
    OF_OXM_IPV6_ND_TARGET = 636,
    OF_OXM_IPV6_ND_TARGET_MASKED = 637,
    OF_OXM_IPV6_ND_TLL = 638,
    OF_OXM_IPV6_ND_TLL_MASKED = 639,
    OF_OXM_IPV6_SRC = 640,
    OF_OXM_IPV6_SRC_MASKED = 641,
    OF_OXM_METADATA = 642,
    OF_OXM_METADATA_MASKED = 643,
    OF_OXM_MPLS_BOS = 644,
    OF_OXM_MPLS_BOS_MASKED = 645,
    OF_OXM_MPLS_LABEL = 646,
    OF_OXM_MPLS_LABEL_MASKED = 647,
    OF_OXM_MPLS_TC = 648,
    OF_OXM_MPLS_TC_MASKED = 649,
    OF_OXM_OVS_TCP_FLAGS = 650,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 651,
    OF_OXM_PBB_UCA = 652,
    OF_OXM_PBB_UCA_MASKED = 653,
    OF_OXM_SCTP_DST = 654,
    OF_OXM_SCTP_DST_MASKED = 655,
    OF_OXM_SCTP_SRC = 656,
    OF_OXM_SCTP_SRC_MASKED = 657,
    OF_OXM_TCP_DST = 658,
    OF_OXM_TCP_DST_MASKED = 659,
    OF_OXM_TCP_SRC = 660,
    OF_OXM_TCP_SRC_MASKED = 661,
    OF_OXM_TUNNEL_ID = 662,
    OF_OXM_TUNNEL_ID_MASKED = 663,
    OF_OXM_TUNNEL_IPV4_DST = 664,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 665,
    OF_OXM_TUNNEL_IPV4_SRC = 666,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 667,
    OF_OXM_UDP_DST = 668,
    OF_OXM_UDP_DST_MASKED = 669,
    OF_OXM_UDP_SRC = 670,
    OF_OXM_UDP_SRC_MASKED = 671,
    OF_OXM_VLAN_PCP = 672,
    OF_OXM_VLAN_PCP_MASKED = 673,
    OF_OXM_VLAN_VID = 674,
    OF_OXM_VLAN_VID_MASKED = 675,
    OF_PACKET_QUEUE = 676,
    OF_PORT_DESC = 677,
    OF_PORT_DESC_PROP = 678,
    OF_PORT_DESC_PROP_BSN = 679,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 680,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 681,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 682,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 683,
    OF_PORT_DESC_PROP_BSN_UPLINK = 684,
    OF_PORT_DESC_PROP_ETHERNET = 685,
    OF_PORT_DESC_PROP_EXPERIMENTER = 686,
    OF_PORT_DESC_PROP_OPTICAL = 687,
    OF_PORT_MOD_PROP = 688,
    OF_PORT_MOD_PROP_ETHERNET = 689,
    OF_PORT_MOD_PROP_EXPERIMENTER = 690,
    OF_PORT_MOD_PROP_OPTICAL = 691,
    OF_PORT_STATS_ENTRY = 692,
    OF_PORT_STATS_PROP = 693,
    OF_PORT_STATS_PROP_ETHERNET = 694,
    OF_PORT_STATS_PROP_EXPERIMENTER = 695,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 696,
    OF_PORT_STATS_PROP_OPTICAL = 697,
    OF_QUEUE_DESC = 698,
    OF_QUEUE_DESC_PROP = 699,
    OF_QUEUE_DESC_PROP_BSN = 700,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 701,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 702,
    OF_QUEUE_DESC_PROP_MAX_RATE = 703,
    OF_QUEUE_DESC_PROP_MIN_RATE = 704,
    OF_QUEUE_PROP = 705,
    OF_QUEUE_PROP_EXPERIMENTER = 706,
    OF_QUEUE_PROP_MAX_RATE = 707,
    OF_QUEUE_PROP_MIN_RATE = 708,
    OF_QUEUE_STATS_ENTRY = 709,
    OF_QUEUE_STATS_PROP = 710,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 711,
    OF_ROLE_PROP = 712,
    OF_ROLE_PROP_EXPERIMENTER = 713,
    OF_TABLE_DESC = 714,
    OF_TABLE_FEATURE_PROP = 715,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 716,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 717,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 718,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 719,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 720,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 721,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 722,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 723,
    OF_TABLE_FEATURE_PROP_MATCH = 724,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 725,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 726,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 727,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 728,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 729,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 730,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 731,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 732,
    OF_TABLE_FEATURES = 733,
    OF_TABLE_MOD_PROP = 734,
    OF_TABLE_MOD_PROP_EVICTION = 735,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 736,
    OF_TABLE_MOD_PROP_VACANCY = 737,
    OF_TABLE_STATS_ENTRY = 738,
    OF_UINT32 = 739,
    OF_UINT64 = 740,
    OF_UINT8 = 741,
    ...
    /* List objects */
    OF_LIST_ACTION = 742,
    OF_LIST_ACTION_ID = 743,
    OF_LIST_ASYNC_CONFIG_PROP = 744,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 745,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 746,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 747,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 748,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 749,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 750,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 751,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 752,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 753,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 754,
    OF_LIST_BSN_INTERFACE = 755,
    OF_LIST_BSN_LACP_STATS_ENTRY = 756,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 757,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 758,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 759,
    OF_LIST_BSN_TLV = 760,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 761,
    OF_LIST_BSN_VLAN_MAC = 762,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 763,
    OF_LIST_BUCKET = 764,
    OF_LIST_BUCKET_COUNTER = 765,
    OF_LIST_BUNDLE_PROP = 766,
    OF_LIST_FLOW_STATS_ENTRY = 767,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 768,
    OF_LIST_GROUP_STATS_ENTRY = 769,
    OF_LIST_HELLO_ELEM = 770,
    OF_LIST_INSTRUCTION = 771,
    OF_LIST_INSTRUCTION_ID = 772,
    OF_LIST_METER_BAND = 773,
    OF_LIST_METER_BAND_STATS = 774,
    OF_LIST_METER_CONFIG = 775,
    OF_LIST_METER_STATS = 776,
    OF_LIST_OXM = 777,
    OF_LIST_PACKET_QUEUE = 778,
    OF_LIST_PORT_DESC = 779,
    OF_LIST_PORT_DESC_PROP = 780,
    OF_LIST_PORT_MOD_PROP = 781,
    OF_LIST_PORT_STATS_ENTRY = 782,
    OF_LIST_PORT_STATS_PROP = 783,
    OF_LIST_QUEUE_DESC = 784,
    OF_LIST_QUEUE_DESC_PROP = 785,
    OF_LIST_QUEUE_PROP = 786,
    OF_LIST_QUEUE_STATS_ENTRY = 787,
    OF_LIST_QUEUE_STATS_PROP = 788,
    OF_LIST_ROLE_PROP = 789,
    OF_LIST_TABLE_DESC = 790,
    OF_LIST_TABLE_FEATURE_PROP = 791,
    OF_LIST_TABLE_FEATURES = 792,
    OF_LIST_TABLE_MOD_PROP = 793,
    OF_LIST_TABLE_STATS_ENTRY = 794,
    OF_LIST_UINT32 = 795,
    OF_LIST_UINT64 = 796,
    OF_LIST_UINT8 = 797,
