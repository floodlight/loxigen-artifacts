...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_CLEAR_ACTIONS = 284,
    OF_INSTRUCTION_EXPERIMENTER = 285,
    OF_INSTRUCTION_GOTO_TABLE = 286,
    OF_INSTRUCTION_HEADER = 287,
    OF_INSTRUCTION_ID = 288,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 289,
    OF_INSTRUCTION_ID_BSN = 290,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 291,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 292,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 293,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 294,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 295,
    OF_INSTRUCTION_ID_EXPERIMENTER = 296,
    OF_INSTRUCTION_ID_GOTO_TABLE = 297,
    OF_INSTRUCTION_ID_HEADER = 298,
    OF_INSTRUCTION_ID_METER = 299,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 300,
    OF_INSTRUCTION_ID_WRITE_METADATA = 301,
    OF_INSTRUCTION_METER = 302,
    OF_INSTRUCTION_WRITE_ACTIONS = 303,
    OF_INSTRUCTION_WRITE_METADATA = 304,
    OF_MATCH_V1 = 305,
    OF_MATCH_V2 = 306,
    OF_MATCH_V3 = 307,
    OF_METER_BAND = 308,
    OF_METER_BAND_DROP = 309,
    OF_METER_BAND_DSCP_REMARK = 310,
    OF_METER_BAND_EXPERIMENTER = 311,
    OF_METER_BAND_HEADER = 312,
    OF_METER_BAND_STATS = 313,
    OF_METER_CONFIG = 314,
    OF_METER_FEATURES = 315,
    OF_METER_STATS = 316,
    OF_OXM = 317,
    OF_OXM_ARP_OP = 318,
    OF_OXM_ARP_OP_MASKED = 319,
    OF_OXM_ARP_SHA = 320,
    OF_OXM_ARP_SHA_MASKED = 321,
    OF_OXM_ARP_SPA = 322,
    OF_OXM_ARP_SPA_MASKED = 323,
    OF_OXM_ARP_THA = 324,
    OF_OXM_ARP_THA_MASKED = 325,
    OF_OXM_ARP_TPA = 326,
    OF_OXM_ARP_TPA_MASKED = 327,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 328,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 329,
    OF_OXM_BSN_IN_PORTS_128 = 330,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 331,
    OF_OXM_BSN_L3_DST_CLASS_ID = 332,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 333,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 334,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 335,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 336,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 337,
    OF_OXM_BSN_LAG_ID = 338,
    OF_OXM_BSN_LAG_ID_MASKED = 339,
    OF_OXM_BSN_VRF = 340,
    OF_OXM_BSN_VRF_MASKED = 341,
    OF_OXM_ETH_DST = 342,
    OF_OXM_ETH_DST_MASKED = 343,
    OF_OXM_ETH_SRC = 344,
    OF_OXM_ETH_SRC_MASKED = 345,
    OF_OXM_ETH_TYPE = 346,
    OF_OXM_ETH_TYPE_MASKED = 347,
    OF_OXM_HEADER = 348,
    OF_OXM_ICMPV4_CODE = 349,
    OF_OXM_ICMPV4_CODE_MASKED = 350,
    OF_OXM_ICMPV4_TYPE = 351,
    OF_OXM_ICMPV4_TYPE_MASKED = 352,
    OF_OXM_ICMPV6_CODE = 353,
    OF_OXM_ICMPV6_CODE_MASKED = 354,
    OF_OXM_ICMPV6_TYPE = 355,
    OF_OXM_ICMPV6_TYPE_MASKED = 356,
    OF_OXM_IN_PHY_PORT = 357,
    OF_OXM_IN_PHY_PORT_MASKED = 358,
    OF_OXM_IN_PORT = 359,
    OF_OXM_IN_PORT_MASKED = 360,
    OF_OXM_IP_DSCP = 361,
    OF_OXM_IP_DSCP_MASKED = 362,
    OF_OXM_IP_ECN = 363,
    OF_OXM_IP_ECN_MASKED = 364,
    OF_OXM_IP_PROTO = 365,
    OF_OXM_IP_PROTO_MASKED = 366,
    OF_OXM_IPV4_DST = 367,
    OF_OXM_IPV4_DST_MASKED = 368,
    OF_OXM_IPV4_SRC = 369,
    OF_OXM_IPV4_SRC_MASKED = 370,
    OF_OXM_IPV6_DST = 371,
    OF_OXM_IPV6_DST_MASKED = 372,
    OF_OXM_IPV6_FLABEL = 373,
    OF_OXM_IPV6_FLABEL_MASKED = 374,
    OF_OXM_IPV6_ND_SLL = 375,
    OF_OXM_IPV6_ND_SLL_MASKED = 376,
    OF_OXM_IPV6_ND_TARGET = 377,
    OF_OXM_IPV6_ND_TARGET_MASKED = 378,
    OF_OXM_IPV6_ND_TLL = 379,
    OF_OXM_IPV6_ND_TLL_MASKED = 380,
    OF_OXM_IPV6_SRC = 381,
    OF_OXM_IPV6_SRC_MASKED = 382,
    OF_OXM_METADATA = 383,
    OF_OXM_METADATA_MASKED = 384,
    OF_OXM_MPLS_LABEL = 385,
    OF_OXM_MPLS_LABEL_MASKED = 386,
    OF_OXM_MPLS_TC = 387,
    OF_OXM_MPLS_TC_MASKED = 388,
    OF_OXM_SCTP_DST = 389,
    OF_OXM_SCTP_DST_MASKED = 390,
    OF_OXM_SCTP_SRC = 391,
    OF_OXM_SCTP_SRC_MASKED = 392,
    OF_OXM_TCP_DST = 393,
    OF_OXM_TCP_DST_MASKED = 394,
    OF_OXM_TCP_SRC = 395,
    OF_OXM_TCP_SRC_MASKED = 396,
    OF_OXM_UDP_DST = 397,
    OF_OXM_UDP_DST_MASKED = 398,
    OF_OXM_UDP_SRC = 399,
    OF_OXM_UDP_SRC_MASKED = 400,
    OF_OXM_VLAN_PCP = 401,
    OF_OXM_VLAN_PCP_MASKED = 402,
    OF_OXM_VLAN_VID = 403,
    OF_OXM_VLAN_VID_MASKED = 404,
    OF_PACKET_QUEUE = 405,
    OF_PORT_DESC = 406,
    OF_PORT_STATS_ENTRY = 407,
    OF_QUEUE_PROP = 408,
    OF_QUEUE_PROP_EXPERIMENTER = 409,
    OF_QUEUE_PROP_HEADER = 410,
    OF_QUEUE_PROP_MAX_RATE = 411,
    OF_QUEUE_PROP_MIN_RATE = 412,
    OF_QUEUE_STATS_ENTRY = 413,
    OF_TABLE_FEATURE_PROP = 414,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 415,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 416,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 417,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 418,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 419,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 420,
    OF_TABLE_FEATURE_PROP_HEADER = 421,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 422,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 423,
    OF_TABLE_FEATURE_PROP_MATCH = 424,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 425,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 426,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 427,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 428,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 429,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 430,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 431,
    OF_TABLE_FEATURES = 432,
    OF_TABLE_STATS_ENTRY = 433,
    OF_UINT32 = 434,
    OF_UINT64 = 435,
    OF_UINT8 = 436,
    ...
    /* List objects */
    OF_LIST_ACTION = 437,
    OF_LIST_ACTION_ID = 438,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 439,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 440,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 441,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 442,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 443,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 444,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 445,
    OF_LIST_BSN_INTERFACE = 446,
    OF_LIST_BSN_LACP_STATS_ENTRY = 447,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 448,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 449,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 450,
    OF_LIST_BSN_TLV = 451,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 452,
    OF_LIST_BUCKET = 453,
    OF_LIST_BUCKET_COUNTER = 454,
    OF_LIST_FLOW_STATS_ENTRY = 455,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 456,
    OF_LIST_GROUP_STATS_ENTRY = 457,
    OF_LIST_HELLO_ELEM = 458,
    OF_LIST_INSTRUCTION = 459,
    OF_LIST_METER_BAND = 460,
    OF_LIST_METER_BAND_STATS = 461,
    OF_LIST_METER_STATS = 462,
    OF_LIST_OXM = 463,
    OF_LIST_PACKET_QUEUE = 464,
    OF_LIST_PORT_DESC = 465,
    OF_LIST_PORT_STATS_ENTRY = 466,
    OF_LIST_QUEUE_PROP = 467,
    OF_LIST_QUEUE_STATS_ENTRY = 468,
    OF_LIST_TABLE_FEATURE_PROP = 469,
    OF_LIST_TABLE_FEATURES = 470,
    OF_LIST_TABLE_STATS_ENTRY = 471,
    OF_LIST_UINT32 = 472,
    OF_LIST_UINT64 = 473,
    OF_LIST_UINT8 = 474,
