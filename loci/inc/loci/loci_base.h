...
typedef enum of_object_id_e {
    ...
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 472,
    OF_BSN_VLAN_MAC = 473,
    OF_BSN_VPORT = 474,
    OF_BSN_VPORT_L2GRE = 475,
    OF_BSN_VPORT_Q_IN_Q = 476,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 477,
    OF_BUCKET = 478,
    OF_BUCKET_COUNTER = 479,
    OF_BUNDLE_PROP = 480,
    OF_BUNDLE_PROP_EXPERIMENTER = 481,
    OF_FLOW_STATS_ENTRY = 482,
    OF_GROUP_DESC_STATS_ENTRY = 483,
    OF_GROUP_STATS_ENTRY = 484,
    OF_HELLO_ELEM = 485,
    OF_HELLO_ELEM_VERSIONBITMAP = 486,
    OF_INSTRUCTION = 487,
    OF_INSTRUCTION_APPLY_ACTIONS = 488,
    OF_INSTRUCTION_BSN = 489,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 490,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 491,
    OF_INSTRUCTION_BSN_DENY = 492,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 493,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 494,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 495,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 496,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 497,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 498,
    OF_INSTRUCTION_BSN_HASH_SELECT = 499,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 500,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 501,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 502,
    OF_INSTRUCTION_BSN_PERMIT = 503,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 504,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 505,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 506,
    OF_INSTRUCTION_CLEAR_ACTIONS = 507,
    OF_INSTRUCTION_EXPERIMENTER = 508,
    OF_INSTRUCTION_GOTO_TABLE = 509,
    OF_INSTRUCTION_ID = 510,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 511,
    OF_INSTRUCTION_ID_BSN = 512,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 513,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 514,
    OF_INSTRUCTION_ID_BSN_DENY = 515,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 516,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 517,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 518,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 519,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 520,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 521,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 522,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 523,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 524,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 525,
    OF_INSTRUCTION_ID_BSN_PERMIT = 526,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 527,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 528,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 529,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 530,
    OF_INSTRUCTION_ID_EXPERIMENTER = 531,
    OF_INSTRUCTION_ID_GOTO_TABLE = 532,
    OF_INSTRUCTION_ID_METER = 533,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 534,
    OF_INSTRUCTION_ID_WRITE_METADATA = 535,
    OF_INSTRUCTION_METER = 536,
    OF_INSTRUCTION_WRITE_ACTIONS = 537,
    OF_INSTRUCTION_WRITE_METADATA = 538,
    OF_MATCH_V1 = 539,
    OF_MATCH_V2 = 540,
    OF_MATCH_V3 = 541,
    OF_METER_BAND = 542,
    OF_METER_BAND_DROP = 543,
    OF_METER_BAND_DSCP_REMARK = 544,
    OF_METER_BAND_EXPERIMENTER = 545,
    OF_METER_BAND_STATS = 546,
    OF_METER_CONFIG = 547,
    OF_METER_FEATURES = 548,
    OF_METER_STATS = 549,
    OF_OXM = 550,
    OF_OXM_ARP_OP = 551,
    OF_OXM_ARP_OP_MASKED = 552,
    OF_OXM_ARP_SHA = 553,
    OF_OXM_ARP_SHA_MASKED = 554,
    OF_OXM_ARP_SPA = 555,
    OF_OXM_ARP_SPA_MASKED = 556,
    OF_OXM_ARP_THA = 557,
    OF_OXM_ARP_THA_MASKED = 558,
    OF_OXM_ARP_TPA = 559,
    OF_OXM_ARP_TPA_MASKED = 560,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 561,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 562,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 563,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 564,
    OF_OXM_BSN_IFP_CLASS_ID = 565,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 566,
    OF_OXM_BSN_IN_PORTS_128 = 567,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 568,
    OF_OXM_BSN_IN_PORTS_512 = 569,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 570,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 571,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 572,
    OF_OXM_BSN_INNER_ETH_DST = 573,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 574,
    OF_OXM_BSN_INNER_ETH_SRC = 575,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 576,
    OF_OXM_BSN_INNER_VLAN_VID = 577,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 578,
    OF_OXM_BSN_IP_FRAGMENTATION = 579,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 580,
    OF_OXM_BSN_L2_CACHE_HIT = 581,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 582,
    OF_OXM_BSN_L3_DST_CLASS_ID = 583,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 584,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 585,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 586,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 587,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 588,
    OF_OXM_BSN_LAG_ID = 589,
    OF_OXM_BSN_LAG_ID_MASKED = 590,
    OF_OXM_BSN_TCP_FLAGS = 591,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 592,
    OF_OXM_BSN_UDF0 = 593,
    OF_OXM_BSN_UDF0_MASKED = 594,
    OF_OXM_BSN_UDF1 = 595,
    OF_OXM_BSN_UDF1_MASKED = 596,
    OF_OXM_BSN_UDF2 = 597,
    OF_OXM_BSN_UDF2_MASKED = 598,
    OF_OXM_BSN_UDF3 = 599,
    OF_OXM_BSN_UDF3_MASKED = 600,
    OF_OXM_BSN_UDF4 = 601,
    OF_OXM_BSN_UDF4_MASKED = 602,
    OF_OXM_BSN_UDF5 = 603,
    OF_OXM_BSN_UDF5_MASKED = 604,
    OF_OXM_BSN_UDF6 = 605,
    OF_OXM_BSN_UDF6_MASKED = 606,
    OF_OXM_BSN_UDF7 = 607,
    OF_OXM_BSN_UDF7_MASKED = 608,
    OF_OXM_BSN_VFI = 609,
    OF_OXM_BSN_VFI_MASKED = 610,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 611,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 612,
    OF_OXM_BSN_VRF = 613,
    OF_OXM_BSN_VRF_MASKED = 614,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 615,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 616,
    OF_OXM_CONN_TRACKING_IPV6_DST = 617,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 618,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 619,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 620,
    OF_OXM_CONN_TRACKING_LABEL = 621,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 622,
    OF_OXM_CONN_TRACKING_MARK = 623,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 624,
    OF_OXM_CONN_TRACKING_NW_DST = 625,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 626,
    OF_OXM_CONN_TRACKING_NW_PROTO = 627,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 628,
    OF_OXM_CONN_TRACKING_NW_SRC = 629,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 630,
    OF_OXM_CONN_TRACKING_STATE = 631,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 632,
    OF_OXM_CONN_TRACKING_TP_DST = 633,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 634,
    OF_OXM_CONN_TRACKING_TP_SRC = 635,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 636,
    OF_OXM_CONN_TRACKING_ZONE = 637,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 638,
    OF_OXM_ETH_DST = 639,
    OF_OXM_ETH_DST_MASKED = 640,
    OF_OXM_ETH_SRC = 641,
    OF_OXM_ETH_SRC_MASKED = 642,
    OF_OXM_ETH_TYPE = 643,
    OF_OXM_ETH_TYPE_MASKED = 644,
    OF_OXM_ICMPV4_CODE = 645,
    OF_OXM_ICMPV4_CODE_MASKED = 646,
    OF_OXM_ICMPV4_TYPE = 647,
    OF_OXM_ICMPV4_TYPE_MASKED = 648,
    OF_OXM_ICMPV6_CODE = 649,
    OF_OXM_ICMPV6_CODE_MASKED = 650,
    OF_OXM_ICMPV6_TYPE = 651,
    OF_OXM_ICMPV6_TYPE_MASKED = 652,
    OF_OXM_IN_PHY_PORT = 653,
    OF_OXM_IN_PHY_PORT_MASKED = 654,
    OF_OXM_IN_PORT = 655,
    OF_OXM_IN_PORT_MASKED = 656,
    OF_OXM_IP_DSCP = 657,
    OF_OXM_IP_DSCP_MASKED = 658,
    OF_OXM_IP_ECN = 659,
    OF_OXM_IP_ECN_MASKED = 660,
    OF_OXM_IP_PROTO = 661,
    OF_OXM_IP_PROTO_MASKED = 662,
    OF_OXM_IPV4_DST = 663,
    OF_OXM_IPV4_DST_MASKED = 664,
    OF_OXM_IPV4_SRC = 665,
    OF_OXM_IPV4_SRC_MASKED = 666,
    OF_OXM_IPV6_DST = 667,
    OF_OXM_IPV6_DST_MASKED = 668,
    OF_OXM_IPV6_EXTHDR = 669,
    OF_OXM_IPV6_EXTHDR_MASKED = 670,
    OF_OXM_IPV6_FLABEL = 671,
    OF_OXM_IPV6_FLABEL_MASKED = 672,
    OF_OXM_IPV6_ND_SLL = 673,
    OF_OXM_IPV6_ND_SLL_MASKED = 674,
    OF_OXM_IPV6_ND_TARGET = 675,
    OF_OXM_IPV6_ND_TARGET_MASKED = 676,
    OF_OXM_IPV6_ND_TLL = 677,
    OF_OXM_IPV6_ND_TLL_MASKED = 678,
    OF_OXM_IPV6_SRC = 679,
    OF_OXM_IPV6_SRC_MASKED = 680,
    OF_OXM_METADATA = 681,
    OF_OXM_METADATA_MASKED = 682,
    OF_OXM_MPLS_BOS = 683,
    OF_OXM_MPLS_BOS_MASKED = 684,
    OF_OXM_MPLS_LABEL = 685,
    OF_OXM_MPLS_LABEL_MASKED = 686,
    OF_OXM_MPLS_TC = 687,
    OF_OXM_MPLS_TC_MASKED = 688,
    OF_OXM_OVS_TCP_FLAGS = 689,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 690,
    OF_OXM_PBB_UCA = 691,
    OF_OXM_PBB_UCA_MASKED = 692,
    OF_OXM_SCTP_DST = 693,
    OF_OXM_SCTP_DST_MASKED = 694,
    OF_OXM_SCTP_SRC = 695,
    OF_OXM_SCTP_SRC_MASKED = 696,
    OF_OXM_TCP_DST = 697,
    OF_OXM_TCP_DST_MASKED = 698,
    OF_OXM_TCP_SRC = 699,
    OF_OXM_TCP_SRC_MASKED = 700,
    OF_OXM_TUNNEL_ID = 701,
    OF_OXM_TUNNEL_ID_MASKED = 702,
    OF_OXM_TUNNEL_IPV4_DST = 703,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 704,
    OF_OXM_TUNNEL_IPV4_SRC = 705,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 706,
    OF_OXM_UDP_DST = 707,
    ...
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 720,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 721,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 722,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 723,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 724,
    OF_PORT_DESC_PROP_BSN_UPLINK = 725,
    OF_PORT_DESC_PROP_ETHERNET = 726,
    OF_PORT_DESC_PROP_EXPERIMENTER = 727,
    OF_PORT_DESC_PROP_OPTICAL = 728,
    OF_PORT_MOD_PROP = 729,
    OF_PORT_MOD_PROP_ETHERNET = 730,
    OF_PORT_MOD_PROP_EXPERIMENTER = 731,
    OF_PORT_MOD_PROP_OPTICAL = 732,
    OF_PORT_STATS_ENTRY = 733,
    OF_PORT_STATS_PROP = 734,
    OF_PORT_STATS_PROP_ETHERNET = 735,
    OF_PORT_STATS_PROP_EXPERIMENTER = 736,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 737,
    OF_PORT_STATS_PROP_OPTICAL = 738,
    OF_QUEUE_DESC = 739,
    OF_QUEUE_DESC_PROP = 740,
    OF_QUEUE_DESC_PROP_BSN = 741,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 742,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 743,
    OF_QUEUE_DESC_PROP_MAX_RATE = 744,
    OF_QUEUE_DESC_PROP_MIN_RATE = 745,
    OF_QUEUE_PROP = 746,
    OF_QUEUE_PROP_EXPERIMENTER = 747,
    OF_QUEUE_PROP_MAX_RATE = 748,
    OF_QUEUE_PROP_MIN_RATE = 749,
    OF_QUEUE_STATS_ENTRY = 750,
    OF_QUEUE_STATS_PROP = 751,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 752,
    OF_ROLE_PROP = 753,
    OF_ROLE_PROP_EXPERIMENTER = 754,
    OF_TABLE_DESC = 755,
    OF_TABLE_FEATURE_PROP = 756,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 757,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 758,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 759,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 760,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 761,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 762,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 763,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 764,
    OF_TABLE_FEATURE_PROP_MATCH = 765,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 766,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 767,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 768,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 769,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 770,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 771,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 772,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 773,
    OF_TABLE_FEATURES = 774,
    OF_TABLE_MOD_PROP = 775,
    OF_TABLE_MOD_PROP_EVICTION = 776,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 777,
    OF_TABLE_MOD_PROP_VACANCY = 778,
    OF_TABLE_STATS_ENTRY = 779,
    OF_UINT32 = 780,
    OF_UINT64 = 781,
    OF_UINT8 = 782,
    ...
    /* List objects */
    OF_LIST_ACTION = 783,
    OF_LIST_ACTION_ID = 784,
    OF_LIST_ASYNC_CONFIG_PROP = 785,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 786,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 787,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 788,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 789,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 790,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 791,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 792,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 793,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 794,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 795,
    OF_LIST_BSN_INTERFACE = 796,
    OF_LIST_BSN_LACP_STATS_ENTRY = 797,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 798,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 799,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 800,
    OF_LIST_BSN_TLV = 801,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 802,
    OF_LIST_BSN_VLAN_MAC = 803,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 804,
    OF_LIST_BUCKET = 805,
    OF_LIST_BUCKET_COUNTER = 806,
    OF_LIST_BUNDLE_PROP = 807,
    OF_LIST_FLOW_STATS_ENTRY = 808,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 809,
    OF_LIST_GROUP_STATS_ENTRY = 810,
    OF_LIST_HELLO_ELEM = 811,
    OF_LIST_INSTRUCTION = 812,
    OF_LIST_INSTRUCTION_ID = 813,
    OF_LIST_METER_BAND = 814,
    OF_LIST_METER_BAND_STATS = 815,
    OF_LIST_METER_CONFIG = 816,
    OF_LIST_METER_STATS = 817,
    OF_LIST_OXM = 818,
    OF_LIST_PACKET_QUEUE = 819,
    OF_LIST_PORT_DESC = 820,
    OF_LIST_PORT_DESC_PROP = 821,
    OF_LIST_PORT_MOD_PROP = 822,
    OF_LIST_PORT_STATS_ENTRY = 823,
    OF_LIST_PORT_STATS_PROP = 824,
    OF_LIST_QUEUE_DESC = 825,
    OF_LIST_QUEUE_DESC_PROP = 826,
    OF_LIST_QUEUE_PROP = 827,
    OF_LIST_QUEUE_STATS_ENTRY = 828,
    OF_LIST_QUEUE_STATS_PROP = 829,
    OF_LIST_ROLE_PROP = 830,
    OF_LIST_TABLE_DESC = 831,
    OF_LIST_TABLE_FEATURE_PROP = 832,
    OF_LIST_TABLE_FEATURES = 833,
    OF_LIST_TABLE_MOD_PROP = 834,
    OF_LIST_TABLE_STATS_ENTRY = 835,
    OF_LIST_UINT32 = 836,
    OF_LIST_UINT64 = 837,
    OF_LIST_UINT8 = 838,
