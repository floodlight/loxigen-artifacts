...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_APPLY_BYTES = 309,
    OF_BSN_TLV_APPLY_PACKETS = 310,
    OF_BSN_TLV_AUTO_NEGOTIATION = 311,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 312,
    OF_BSN_TLV_BROADCAST_RATE = 313,
    OF_BSN_TLV_BUCKET = 314,
    OF_BSN_TLV_CIRCUIT_ID = 315,
    OF_BSN_TLV_CONVERGENCE_STATUS = 316,
    OF_BSN_TLV_CPU_LAG = 317,
    OF_BSN_TLV_CRC_ENABLED = 318,
    OF_BSN_TLV_DATA = 319,
    OF_BSN_TLV_DATA_MASK = 320,
    OF_BSN_TLV_DECAP = 321,
    OF_BSN_TLV_DISABLE_SRC_MAC_CHECK = 322,
    OF_BSN_TLV_DROP = 323,
    OF_BSN_TLV_DSCP = 324,
    OF_BSN_TLV_ECN = 325,
    OF_BSN_TLV_EGRESS_ONLY = 326,
    OF_BSN_TLV_EGRESS_PORT_GROUP_ID = 327,
    OF_BSN_TLV_ENHANCED_HASH_CAPABILITY = 328,
    OF_BSN_TLV_ETH_DST = 329,
    OF_BSN_TLV_ETH_SRC = 330,
    OF_BSN_TLV_ETH_TYPE = 331,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 332,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 333,
    OF_BSN_TLV_EXTERNAL_IP = 334,
    OF_BSN_TLV_EXTERNAL_MAC = 335,
    OF_BSN_TLV_EXTERNAL_NETMASK = 336,
    OF_BSN_TLV_GENERATION_ID = 337,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 338,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 339,
    OF_BSN_TLV_HASH_PACKET_FIELD = 340,
    OF_BSN_TLV_HASH_PACKET_TYPE = 341,
    OF_BSN_TLV_HASH_SEED = 342,
    OF_BSN_TLV_HASH_TYPE = 343,
    OF_BSN_TLV_HEADER_SIZE = 344,
    OF_BSN_TLV_ICMP_CODE = 345,
    OF_BSN_TLV_ICMP_ID = 346,
    OF_BSN_TLV_ICMP_TYPE = 347,
    OF_BSN_TLV_ICMPV6_CHKSUM = 348,
    OF_BSN_TLV_IDLE_NOTIFICATION = 349,
    OF_BSN_TLV_IDLE_TIME = 350,
    OF_BSN_TLV_IDLE_TIMEOUT = 351,
    OF_BSN_TLV_IGMP_SNOOPING = 352,
    OF_BSN_TLV_INGRESS_PORT_GROUP_ID = 353,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 354,
    OF_BSN_TLV_INTERNAL_MAC = 355,
    OF_BSN_TLV_INTERVAL = 356,
    OF_BSN_TLV_IP_PROTO = 357,
    OF_BSN_TLV_IPV4 = 358,
    OF_BSN_TLV_IPV4_DST = 359,
    OF_BSN_TLV_IPV4_NETMASK = 360,
    OF_BSN_TLV_IPV4_SRC = 361,
    OF_BSN_TLV_IPV6 = 362,
    OF_BSN_TLV_IPV6_DST = 363,
    OF_BSN_TLV_IPV6_PREFIX = 364,
    OF_BSN_TLV_IPV6_SRC = 365,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 366,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 367,
    OF_BSN_TLV_L3_DST_CLASS_ID = 368,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 369,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 370,
    OF_BSN_TLV_LOOPBACK_PORT = 371,
    OF_BSN_TLV_MAC = 372,
    OF_BSN_TLV_MAC_MASK = 373,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 374,
    OF_BSN_TLV_MISS_PACKETS = 375,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 376,
    OF_BSN_TLV_MPLS_LABEL = 377,
    OF_BSN_TLV_MPLS_SEQUENCED = 378,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 379,
    OF_BSN_TLV_NAME = 380,
    OF_BSN_TLV_NDP_OFFLOAD = 381,
    OF_BSN_TLV_NDP_STATIC = 382,
    OF_BSN_TLV_NEGATE = 383,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 384,
    OF_BSN_TLV_NEXT_HOP_MAC = 385,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 386,
    OF_BSN_TLV_OFFSET = 387,
    OF_BSN_TLV_PARENT_PORT = 388,
    OF_BSN_TLV_PARTNER_KEY = 389,
    OF_BSN_TLV_PARTNER_PORT_NUM = 390,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 391,
    OF_BSN_TLV_PARTNER_STATE = 392,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 393,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 394,
    OF_BSN_TLV_PORT = 395,
    OF_BSN_TLV_PORT_USAGE = 396,
    OF_BSN_TLV_PORT_VXLAN_MODE = 397,
    OF_BSN_TLV_PRIORITY = 398,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 399,
    OF_BSN_TLV_QOS_PRIORITY = 400,
    OF_BSN_TLV_QUEUE_ID = 401,
    OF_BSN_TLV_QUEUE_WEIGHT = 402,
    OF_BSN_TLV_RATE_LIMIT = 403,
    OF_BSN_TLV_RATE_UNIT = 404,
    OF_BSN_TLV_REFERENCE = 405,
    OF_BSN_TLV_REPLY_PACKETS = 406,
    OF_BSN_TLV_REQUEST_PACKETS = 407,
    OF_BSN_TLV_RX_BYTES = 408,
    OF_BSN_TLV_RX_PACKETS = 409,
    OF_BSN_TLV_SAMPLING_RATE = 410,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 411,
    OF_BSN_TLV_STATUS = 412,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 413,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 414,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 415,
    OF_BSN_TLV_SUB_AGENT_ID = 416,
    OF_BSN_TLV_TCP_DST = 417,
    OF_BSN_TLV_TCP_FLAGS = 418,
    OF_BSN_TLV_TCP_SRC = 419,
    OF_BSN_TLV_TTL = 420,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 421,
    OF_BSN_TLV_TX_BYTES = 422,
    OF_BSN_TLV_TX_PACKETS = 423,
    OF_BSN_TLV_UDF_ANCHOR = 424,
    OF_BSN_TLV_UDF_ID = 425,
    OF_BSN_TLV_UDF_LENGTH = 426,
    OF_BSN_TLV_UDF_OFFSET = 427,
    OF_BSN_TLV_UDP_DST = 428,
    OF_BSN_TLV_UDP_SRC = 429,
    OF_BSN_TLV_UINT64_LIST = 430,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 431,
    OF_BSN_TLV_UNICAST_RATE = 432,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 433,
    OF_BSN_TLV_UNTAGGED = 434,
    OF_BSN_TLV_USE_PACKET_STATE = 435,
    OF_BSN_TLV_VFI = 436,
    OF_BSN_TLV_VFP_CLASS_ID = 437,
    OF_BSN_TLV_VLAN_MAC_LIST = 438,
    OF_BSN_TLV_VLAN_PCP = 439,
    OF_BSN_TLV_VLAN_VID = 440,
    OF_BSN_TLV_VLAN_VID_MASK = 441,
    OF_BSN_TLV_VNI = 442,
    OF_BSN_TLV_VPN_KEY = 443,
    OF_BSN_TLV_VRF = 444,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 445,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 446,
    OF_BSN_VLAN_MAC = 447,
    OF_BSN_VPORT = 448,
    OF_BSN_VPORT_L2GRE = 449,
    OF_BSN_VPORT_Q_IN_Q = 450,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 451,
    OF_BUCKET = 452,
    OF_BUCKET_COUNTER = 453,
    OF_BUNDLE_PROP = 454,
    OF_BUNDLE_PROP_EXPERIMENTER = 455,
    OF_FLOW_STATS_ENTRY = 456,
    OF_GROUP_DESC_STATS_ENTRY = 457,
    OF_GROUP_STATS_ENTRY = 458,
    OF_HELLO_ELEM = 459,
    OF_HELLO_ELEM_VERSIONBITMAP = 460,
    OF_INSTRUCTION = 461,
    OF_INSTRUCTION_APPLY_ACTIONS = 462,
    OF_INSTRUCTION_BSN = 463,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 464,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 465,
    OF_INSTRUCTION_BSN_DENY = 466,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 467,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 468,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 469,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 470,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 471,
    OF_INSTRUCTION_BSN_HASH_SELECT = 472,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 473,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 474,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 475,
    OF_INSTRUCTION_BSN_PERMIT = 476,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 477,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 478,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 479,
    OF_INSTRUCTION_CLEAR_ACTIONS = 480,
    OF_INSTRUCTION_EXPERIMENTER = 481,
    OF_INSTRUCTION_GOTO_TABLE = 482,
    OF_INSTRUCTION_ID = 483,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 484,
    OF_INSTRUCTION_ID_BSN = 485,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 486,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 487,
    OF_INSTRUCTION_ID_BSN_DENY = 488,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 489,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 490,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 491,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 492,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 493,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 494,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 495,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 496,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 497,
    OF_INSTRUCTION_ID_BSN_PERMIT = 498,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 499,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 500,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 501,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 502,
    OF_INSTRUCTION_ID_EXPERIMENTER = 503,
    OF_INSTRUCTION_ID_GOTO_TABLE = 504,
    OF_INSTRUCTION_ID_METER = 505,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 506,
    OF_INSTRUCTION_ID_WRITE_METADATA = 507,
    OF_INSTRUCTION_METER = 508,
    OF_INSTRUCTION_WRITE_ACTIONS = 509,
    OF_INSTRUCTION_WRITE_METADATA = 510,
    OF_MATCH_V1 = 511,
    OF_MATCH_V2 = 512,
    OF_MATCH_V3 = 513,
    OF_METER_BAND = 514,
    OF_METER_BAND_DROP = 515,
    OF_METER_BAND_DSCP_REMARK = 516,
    OF_METER_BAND_EXPERIMENTER = 517,
    OF_METER_BAND_STATS = 518,
    OF_METER_CONFIG = 519,
    OF_METER_FEATURES = 520,
    OF_METER_STATS = 521,
    OF_OXM = 522,
    OF_OXM_ARP_OP = 523,
    OF_OXM_ARP_OP_MASKED = 524,
    OF_OXM_ARP_SHA = 525,
    OF_OXM_ARP_SHA_MASKED = 526,
    OF_OXM_ARP_SPA = 527,
    OF_OXM_ARP_SPA_MASKED = 528,
    OF_OXM_ARP_THA = 529,
    OF_OXM_ARP_THA_MASKED = 530,
    OF_OXM_ARP_TPA = 531,
    OF_OXM_ARP_TPA_MASKED = 532,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 533,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 534,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 535,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 536,
    OF_OXM_BSN_IN_PORTS_128 = 537,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 538,
    OF_OXM_BSN_IN_PORTS_512 = 539,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 540,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 541,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 542,
    OF_OXM_BSN_INNER_ETH_DST = 543,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 544,
    OF_OXM_BSN_INNER_ETH_SRC = 545,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 546,
    OF_OXM_BSN_INNER_VLAN_VID = 547,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 548,
    OF_OXM_BSN_IP_FRAGMENTATION = 549,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 550,
    OF_OXM_BSN_L2_CACHE_HIT = 551,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 552,
    OF_OXM_BSN_L3_DST_CLASS_ID = 553,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 554,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 555,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 556,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 557,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 558,
    OF_OXM_BSN_LAG_ID = 559,
    OF_OXM_BSN_LAG_ID_MASKED = 560,
    OF_OXM_BSN_TCP_FLAGS = 561,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 562,
    OF_OXM_BSN_UDF0 = 563,
    OF_OXM_BSN_UDF0_MASKED = 564,
    OF_OXM_BSN_UDF1 = 565,
    OF_OXM_BSN_UDF1_MASKED = 566,
    OF_OXM_BSN_UDF2 = 567,
    OF_OXM_BSN_UDF2_MASKED = 568,
    OF_OXM_BSN_UDF3 = 569,
    OF_OXM_BSN_UDF3_MASKED = 570,
    OF_OXM_BSN_UDF4 = 571,
    OF_OXM_BSN_UDF4_MASKED = 572,
    OF_OXM_BSN_UDF5 = 573,
    OF_OXM_BSN_UDF5_MASKED = 574,
    OF_OXM_BSN_UDF6 = 575,
    OF_OXM_BSN_UDF6_MASKED = 576,
    OF_OXM_BSN_UDF7 = 577,
    OF_OXM_BSN_UDF7_MASKED = 578,
    OF_OXM_BSN_VFI = 579,
    OF_OXM_BSN_VFI_MASKED = 580,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 581,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 582,
    OF_OXM_BSN_VRF = 583,
    OF_OXM_BSN_VRF_MASKED = 584,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 585,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 586,
    OF_OXM_ETH_DST = 587,
    OF_OXM_ETH_DST_MASKED = 588,
    OF_OXM_ETH_SRC = 589,
    OF_OXM_ETH_SRC_MASKED = 590,
    OF_OXM_ETH_TYPE = 591,
    OF_OXM_ETH_TYPE_MASKED = 592,
    OF_OXM_ICMPV4_CODE = 593,
    OF_OXM_ICMPV4_CODE_MASKED = 594,
    OF_OXM_ICMPV4_TYPE = 595,
    OF_OXM_ICMPV4_TYPE_MASKED = 596,
    OF_OXM_ICMPV6_CODE = 597,
    OF_OXM_ICMPV6_CODE_MASKED = 598,
    OF_OXM_ICMPV6_TYPE = 599,
    OF_OXM_ICMPV6_TYPE_MASKED = 600,
    OF_OXM_IN_PHY_PORT = 601,
    OF_OXM_IN_PHY_PORT_MASKED = 602,
    OF_OXM_IN_PORT = 603,
    OF_OXM_IN_PORT_MASKED = 604,
    OF_OXM_IP_DSCP = 605,
    OF_OXM_IP_DSCP_MASKED = 606,
    OF_OXM_IP_ECN = 607,
    OF_OXM_IP_ECN_MASKED = 608,
    OF_OXM_IP_PROTO = 609,
    OF_OXM_IP_PROTO_MASKED = 610,
    OF_OXM_IPV4_DST = 611,
    OF_OXM_IPV4_DST_MASKED = 612,
    OF_OXM_IPV4_SRC = 613,
    OF_OXM_IPV4_SRC_MASKED = 614,
    OF_OXM_IPV6_DST = 615,
    OF_OXM_IPV6_DST_MASKED = 616,
    OF_OXM_IPV6_EXTHDR = 617,
    OF_OXM_IPV6_EXTHDR_MASKED = 618,
    OF_OXM_IPV6_FLABEL = 619,
    OF_OXM_IPV6_FLABEL_MASKED = 620,
    OF_OXM_IPV6_ND_SLL = 621,
    OF_OXM_IPV6_ND_SLL_MASKED = 622,
    OF_OXM_IPV6_ND_TARGET = 623,
    OF_OXM_IPV6_ND_TARGET_MASKED = 624,
    OF_OXM_IPV6_ND_TLL = 625,
    OF_OXM_IPV6_ND_TLL_MASKED = 626,
    OF_OXM_IPV6_SRC = 627,
    OF_OXM_IPV6_SRC_MASKED = 628,
    OF_OXM_METADATA = 629,
    OF_OXM_METADATA_MASKED = 630,
    OF_OXM_MPLS_BOS = 631,
    OF_OXM_MPLS_BOS_MASKED = 632,
    OF_OXM_MPLS_LABEL = 633,
    OF_OXM_MPLS_LABEL_MASKED = 634,
    OF_OXM_MPLS_TC = 635,
    OF_OXM_MPLS_TC_MASKED = 636,
    OF_OXM_OVS_TCP_FLAGS = 637,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 638,
    OF_OXM_PBB_UCA = 639,
    OF_OXM_PBB_UCA_MASKED = 640,
    OF_OXM_SCTP_DST = 641,
    OF_OXM_SCTP_DST_MASKED = 642,
    OF_OXM_SCTP_SRC = 643,
    OF_OXM_SCTP_SRC_MASKED = 644,
    OF_OXM_TCP_DST = 645,
    OF_OXM_TCP_DST_MASKED = 646,
    OF_OXM_TCP_SRC = 647,
    OF_OXM_TCP_SRC_MASKED = 648,
    OF_OXM_TUNNEL_ID = 649,
    OF_OXM_TUNNEL_ID_MASKED = 650,
    OF_OXM_TUNNEL_IPV4_DST = 651,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 652,
    OF_OXM_TUNNEL_IPV4_SRC = 653,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 654,
    OF_OXM_UDP_DST = 655,
    OF_OXM_UDP_DST_MASKED = 656,
    OF_OXM_UDP_SRC = 657,
    OF_OXM_UDP_SRC_MASKED = 658,
    OF_OXM_VLAN_PCP = 659,
    OF_OXM_VLAN_PCP_MASKED = 660,
    OF_OXM_VLAN_VID = 661,
    OF_OXM_VLAN_VID_MASKED = 662,
    OF_PACKET_QUEUE = 663,
    OF_PORT_DESC = 664,
    OF_PORT_DESC_PROP = 665,
    OF_PORT_DESC_PROP_BSN = 666,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 667,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 668,
    OF_PORT_DESC_PROP_BSN_UPLINK = 669,
    OF_PORT_DESC_PROP_ETHERNET = 670,
    OF_PORT_DESC_PROP_EXPERIMENTER = 671,
    OF_PORT_DESC_PROP_OPTICAL = 672,
    OF_PORT_MOD_PROP = 673,
    OF_PORT_MOD_PROP_ETHERNET = 674,
    OF_PORT_MOD_PROP_EXPERIMENTER = 675,
    OF_PORT_MOD_PROP_OPTICAL = 676,
    OF_PORT_STATS_ENTRY = 677,
    OF_PORT_STATS_PROP = 678,
    OF_PORT_STATS_PROP_ETHERNET = 679,
    OF_PORT_STATS_PROP_EXPERIMENTER = 680,
    OF_PORT_STATS_PROP_OPTICAL = 681,
    OF_QUEUE_DESC = 682,
    OF_QUEUE_DESC_PROP = 683,
    OF_QUEUE_DESC_PROP_BSN = 684,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 685,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 686,
    OF_QUEUE_DESC_PROP_MAX_RATE = 687,
    OF_QUEUE_DESC_PROP_MIN_RATE = 688,
    OF_QUEUE_PROP = 689,
    OF_QUEUE_PROP_EXPERIMENTER = 690,
    OF_QUEUE_PROP_MAX_RATE = 691,
    OF_QUEUE_PROP_MIN_RATE = 692,
    OF_QUEUE_STATS_ENTRY = 693,
    OF_QUEUE_STATS_PROP = 694,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 695,
    OF_ROLE_PROP = 696,
    OF_ROLE_PROP_EXPERIMENTER = 697,
    OF_TABLE_DESC = 698,
    OF_TABLE_FEATURE_PROP = 699,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 700,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 701,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 702,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 703,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 704,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 705,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 706,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 707,
    OF_TABLE_FEATURE_PROP_MATCH = 708,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 709,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 710,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 711,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 712,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 713,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 714,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 715,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 716,
    OF_TABLE_FEATURES = 717,
    OF_TABLE_MOD_PROP = 718,
    OF_TABLE_MOD_PROP_EVICTION = 719,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 720,
    OF_TABLE_MOD_PROP_VACANCY = 721,
    OF_TABLE_STATS_ENTRY = 722,
    OF_UINT32 = 723,
    OF_UINT64 = 724,
    OF_UINT8 = 725,
    ...
    /* List objects */
    OF_LIST_ACTION = 726,
    OF_LIST_ACTION_ID = 727,
    OF_LIST_ASYNC_CONFIG_PROP = 728,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 729,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 730,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 731,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 732,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 733,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 734,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 735,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 736,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 737,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 738,
    OF_LIST_BSN_INTERFACE = 739,
    OF_LIST_BSN_LACP_STATS_ENTRY = 740,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 741,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 742,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 743,
    OF_LIST_BSN_TLV = 744,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 745,
    OF_LIST_BSN_VLAN_MAC = 746,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 747,
    OF_LIST_BUCKET = 748,
    OF_LIST_BUCKET_COUNTER = 749,
    OF_LIST_BUNDLE_PROP = 750,
    OF_LIST_FLOW_STATS_ENTRY = 751,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 752,
    OF_LIST_GROUP_STATS_ENTRY = 753,
    OF_LIST_HELLO_ELEM = 754,
    OF_LIST_INSTRUCTION = 755,
    OF_LIST_INSTRUCTION_ID = 756,
    OF_LIST_METER_BAND = 757,
    OF_LIST_METER_BAND_STATS = 758,
    OF_LIST_METER_CONFIG = 759,
    OF_LIST_METER_STATS = 760,
    OF_LIST_OXM = 761,
    OF_LIST_PACKET_QUEUE = 762,
    OF_LIST_PORT_DESC = 763,
    OF_LIST_PORT_DESC_PROP = 764,
    OF_LIST_PORT_MOD_PROP = 765,
    OF_LIST_PORT_STATS_ENTRY = 766,
    OF_LIST_PORT_STATS_PROP = 767,
    OF_LIST_QUEUE_DESC = 768,
    OF_LIST_QUEUE_DESC_PROP = 769,
    OF_LIST_QUEUE_PROP = 770,
    OF_LIST_QUEUE_STATS_ENTRY = 771,
    OF_LIST_QUEUE_STATS_PROP = 772,
    OF_LIST_ROLE_PROP = 773,
    OF_LIST_TABLE_DESC = 774,
    OF_LIST_TABLE_FEATURE_PROP = 775,
    OF_LIST_TABLE_FEATURES = 776,
    OF_LIST_TABLE_MOD_PROP = 777,
    OF_LIST_TABLE_STATS_ENTRY = 778,
    OF_LIST_UINT32 = 779,
    OF_LIST_UINT64 = 780,
    OF_LIST_UINT8 = 781,
