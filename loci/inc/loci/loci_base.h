...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_LOAD = 406,
    OF_BSN_TLV_LOOPBACK_MODE = 407,
    OF_BSN_TLV_LOOPBACK_PORT = 408,
    OF_BSN_TLV_LOSSLESS = 409,
    OF_BSN_TLV_LR_ALL_ENABLED = 410,
    OF_BSN_TLV_MAC = 411,
    OF_BSN_TLV_MAC_MASK = 412,
    OF_BSN_TLV_MAX_COUNT = 413,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 414,
    OF_BSN_TLV_MGMT = 415,
    OF_BSN_TLV_MGMT_RESELECT_ON_FAILURE = 416,
    OF_BSN_TLV_MISS_PACKETS = 417,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 418,
    OF_BSN_TLV_MPLS_LABEL = 419,
    OF_BSN_TLV_MPLS_SEQUENCED = 420,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 421,
    OF_BSN_TLV_MULTICAST_PACKET = 422,
    OF_BSN_TLV_MULTIPLIER = 423,
    OF_BSN_TLV_NAME = 424,
    OF_BSN_TLV_NDP_OFFLOAD = 425,
    OF_BSN_TLV_NDP_STATIC = 426,
    OF_BSN_TLV_NEGATE = 427,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 428,
    OF_BSN_TLV_NEXT_HOP_MAC = 429,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 430,
    OF_BSN_TLV_NO_ARP_RESPONSE = 431,
    OF_BSN_TLV_NO_NS_RESPONSE = 432,
    OF_BSN_TLV_OFFSET = 433,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 434,
    OF_BSN_TLV_OUTER_SRC_MAC = 435,
    OF_BSN_TLV_PARENT_PORT = 436,
    OF_BSN_TLV_PARTNER_KEY = 437,
    OF_BSN_TLV_PARTNER_PORT_NUM = 438,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 439,
    OF_BSN_TLV_PARTNER_STATE = 440,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 441,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 442,
    OF_BSN_TLV_PASSIVE = 443,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 444,
    OF_BSN_TLV_PIM_DR = 445,
    OF_BSN_TLV_PIM_HELLO_FLOOD = 446,
    OF_BSN_TLV_PORT = 447,
    OF_BSN_TLV_PORT_MODE = 448,
    OF_BSN_TLV_PORT_SPEED_GBPS = 449,
    OF_BSN_TLV_PORT_USAGE = 450,
    OF_BSN_TLV_PORT_VXLAN_MODE = 451,
    OF_BSN_TLV_PRESERVE_VLAN = 452,
    OF_BSN_TLV_PRIORITY = 453,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 454,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 455,
    OF_BSN_TLV_QOS_PRIORITY = 456,
    OF_BSN_TLV_QUEUE_ID = 457,
    OF_BSN_TLV_QUEUE_WEIGHT = 458,
    OF_BSN_TLV_RATE_LIMIT = 459,
    OF_BSN_TLV_RATE_UNIT = 460,
    OF_BSN_TLV_RECORD_PACKETS = 461,
    OF_BSN_TLV_REDUNDANT_MGMT = 462,
    OF_BSN_TLV_REFERENCE = 463,
    OF_BSN_TLV_REPLY_PACKETS = 464,
    OF_BSN_TLV_REQUEST_PACKETS = 465,
    OF_BSN_TLV_REST_SERVER = 466,
    OF_BSN_TLV_ROUTING_PARAM = 467,
    OF_BSN_TLV_RX_BYTES = 468,
    OF_BSN_TLV_RX_PACKETS = 469,
    OF_BSN_TLV_SAMPLING_RATE = 470,
    OF_BSN_TLV_SCTP_DST = 471,
    OF_BSN_TLV_SCTP_SRC = 472,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 473,
    OF_BSN_TLV_SOCKET = 474,
    OF_BSN_TLV_SRC_MAC_CML = 475,
    OF_BSN_TLV_STATUS = 476,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 477,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 478,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 479,
    OF_BSN_TLV_SUB_AGENT_ID = 480,
    OF_BSN_TLV_TCP_DST = 481,
    OF_BSN_TLV_TCP_FLAGS = 482,
    OF_BSN_TLV_TCP_SRC = 483,
    OF_BSN_TLV_THREAD = 484,
    OF_BSN_TLV_TIMESTAMP = 485,
    OF_BSN_TLV_TTL = 486,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 487,
    OF_BSN_TLV_TX_BYTES = 488,
    OF_BSN_TLV_TX_PACKETS = 489,
    OF_BSN_TLV_UDF_ANCHOR = 490,
    OF_BSN_TLV_UDF_CAPABILITY = 491,
    OF_BSN_TLV_UDF_DATA = 492,
    OF_BSN_TLV_UDF_ID = 493,
    OF_BSN_TLV_UDF_LENGTH = 494,
    OF_BSN_TLV_UDF_OFFSET = 495,
    OF_BSN_TLV_UDP_DST = 496,
    OF_BSN_TLV_UDP_SRC = 497,
    OF_BSN_TLV_UINT32 = 498,
    OF_BSN_TLV_UINT64_LIST = 499,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 500,
    OF_BSN_TLV_UNICAST_RATE = 501,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 502,
    OF_BSN_TLV_UNTAGGED = 503,
    OF_BSN_TLV_UPGRADE = 504,
    OF_BSN_TLV_URI_SCHEME = 505,
    OF_BSN_TLV_USE_PACKET_STATE = 506,
    OF_BSN_TLV_USER_CONFIGURED = 507,
    OF_BSN_TLV_VFI = 508,
    OF_BSN_TLV_VFP_CLASS_ID = 509,
    OF_BSN_TLV_VIRTUAL = 510,
    ...
    OF_FLOW_STATS_ENTRY = 529,
    OF_GROUP_DESC_STATS_ENTRY = 530,
    OF_GROUP_STATS_ENTRY = 531,
    OF_HELLO_ELEM = 532,
    OF_HELLO_ELEM_VERSIONBITMAP = 533,
    OF_INSTRUCTION = 534,
    OF_INSTRUCTION_APPLY_ACTIONS = 535,
    OF_INSTRUCTION_BSN = 536,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 537,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 538,
    OF_INSTRUCTION_BSN_DENY = 539,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 540,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 541,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 542,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 543,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 544,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 545,
    OF_INSTRUCTION_BSN_HASH_SELECT = 546,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 547,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 548,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 549,
    OF_INSTRUCTION_BSN_PERMIT = 550,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 551,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 552,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 553,
    OF_INSTRUCTION_CLEAR_ACTIONS = 554,
    OF_INSTRUCTION_EXPERIMENTER = 555,
    OF_INSTRUCTION_GOTO_TABLE = 556,
    OF_INSTRUCTION_ID = 557,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 558,
    OF_INSTRUCTION_ID_BSN = 559,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 560,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 561,
    OF_INSTRUCTION_ID_BSN_DENY = 562,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 563,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 564,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 565,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 566,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 567,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 568,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 569,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 570,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 571,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 572,
    OF_INSTRUCTION_ID_BSN_PERMIT = 573,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 574,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 575,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 576,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 577,
    OF_INSTRUCTION_ID_EXPERIMENTER = 578,
    OF_INSTRUCTION_ID_GOTO_TABLE = 579,
    OF_INSTRUCTION_ID_METER = 580,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 581,
    OF_INSTRUCTION_ID_WRITE_METADATA = 582,
    OF_INSTRUCTION_METER = 583,
    OF_INSTRUCTION_WRITE_ACTIONS = 584,
    OF_INSTRUCTION_WRITE_METADATA = 585,
    OF_MATCH_V1 = 586,
    OF_MATCH_V2 = 587,
    OF_MATCH_V3 = 588,
    OF_METER_BAND = 589,
    OF_METER_BAND_DROP = 590,
    OF_METER_BAND_DSCP_REMARK = 591,
    OF_METER_BAND_EXPERIMENTER = 592,
    OF_METER_BAND_STATS = 593,
    OF_METER_CONFIG = 594,
    OF_METER_FEATURES = 595,
    OF_METER_STATS = 596,
    OF_OXM = 597,
    OF_OXM_ARP_OP = 598,
    OF_OXM_ARP_OP_MASKED = 599,
    OF_OXM_ARP_SHA = 600,
    OF_OXM_ARP_SHA_MASKED = 601,
    OF_OXM_ARP_SPA = 602,
    OF_OXM_ARP_SPA_MASKED = 603,
    OF_OXM_ARP_THA = 604,
    OF_OXM_ARP_THA_MASKED = 605,
    OF_OXM_ARP_TPA = 606,
    OF_OXM_ARP_TPA_MASKED = 607,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 608,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 609,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 610,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 611,
    OF_OXM_BSN_IFP_CLASS_ID = 612,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 613,
    OF_OXM_BSN_IN_PORTS_128 = 614,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 615,
    OF_OXM_BSN_IN_PORTS_512 = 616,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 617,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 618,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 619,
    OF_OXM_BSN_INNER_ETH_DST = 620,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 621,
    OF_OXM_BSN_INNER_ETH_SRC = 622,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 623,
    OF_OXM_BSN_INNER_VLAN_VID = 624,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 625,
    OF_OXM_BSN_IP_FRAGMENTATION = 626,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 627,
    OF_OXM_BSN_L2_CACHE_HIT = 628,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 629,
    OF_OXM_BSN_L3_DST_CLASS_ID = 630,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 631,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 632,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 633,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 634,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 635,
    OF_OXM_BSN_LAG_ID = 636,
    OF_OXM_BSN_LAG_ID_MASKED = 637,
    OF_OXM_BSN_TCP_FLAGS = 638,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 639,
    OF_OXM_BSN_UDF0 = 640,
    OF_OXM_BSN_UDF0_MASKED = 641,
    OF_OXM_BSN_UDF1 = 642,
    OF_OXM_BSN_UDF1_MASKED = 643,
    OF_OXM_BSN_UDF2 = 644,
    OF_OXM_BSN_UDF2_MASKED = 645,
    OF_OXM_BSN_UDF3 = 646,
    OF_OXM_BSN_UDF3_MASKED = 647,
    OF_OXM_BSN_UDF4 = 648,
    OF_OXM_BSN_UDF4_MASKED = 649,
    OF_OXM_BSN_UDF5 = 650,
    OF_OXM_BSN_UDF5_MASKED = 651,
    OF_OXM_BSN_UDF6 = 652,
    OF_OXM_BSN_UDF6_MASKED = 653,
    OF_OXM_BSN_UDF7 = 654,
    OF_OXM_BSN_UDF7_MASKED = 655,
    OF_OXM_BSN_VFI = 656,
    OF_OXM_BSN_VFI_MASKED = 657,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 658,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 659,
    OF_OXM_BSN_VRF = 660,
    OF_OXM_BSN_VRF_MASKED = 661,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 662,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 663,
    OF_OXM_CONN_TRACKING_IPV6_DST = 664,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 665,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 666,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 667,
    OF_OXM_CONN_TRACKING_LABEL = 668,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 669,
    OF_OXM_CONN_TRACKING_MARK = 670,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 671,
    OF_OXM_CONN_TRACKING_NW_DST = 672,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 673,
    OF_OXM_CONN_TRACKING_NW_PROTO = 674,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 675,
    OF_OXM_CONN_TRACKING_NW_SRC = 676,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 677,
    OF_OXM_CONN_TRACKING_STATE = 678,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 679,
    OF_OXM_CONN_TRACKING_TP_DST = 680,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 681,
    OF_OXM_CONN_TRACKING_TP_SRC = 682,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 683,
    OF_OXM_CONN_TRACKING_ZONE = 684,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 685,
    OF_OXM_ETH_DST = 686,
    OF_OXM_ETH_DST_MASKED = 687,
    OF_OXM_ETH_SRC = 688,
    OF_OXM_ETH_SRC_MASKED = 689,
    OF_OXM_ETH_TYPE = 690,
    OF_OXM_ETH_TYPE_MASKED = 691,
    OF_OXM_ICMPV4_CODE = 692,
    OF_OXM_ICMPV4_CODE_MASKED = 693,
    OF_OXM_ICMPV4_TYPE = 694,
    OF_OXM_ICMPV4_TYPE_MASKED = 695,
    OF_OXM_ICMPV6_CODE = 696,
    OF_OXM_ICMPV6_CODE_MASKED = 697,
    OF_OXM_ICMPV6_TYPE = 698,
    OF_OXM_ICMPV6_TYPE_MASKED = 699,
    OF_OXM_IN_PHY_PORT = 700,
    OF_OXM_IN_PHY_PORT_MASKED = 701,
    OF_OXM_IN_PORT = 702,
    OF_OXM_IN_PORT_MASKED = 703,
    OF_OXM_IP_DSCP = 704,
    OF_OXM_IP_DSCP_MASKED = 705,
    OF_OXM_IP_ECN = 706,
    OF_OXM_IP_ECN_MASKED = 707,
    OF_OXM_IP_PROTO = 708,
    OF_OXM_IP_PROTO_MASKED = 709,
    OF_OXM_IPV4_DST = 710,
    OF_OXM_IPV4_DST_MASKED = 711,
    OF_OXM_IPV4_SRC = 712,
    OF_OXM_IPV4_SRC_MASKED = 713,
    OF_OXM_IPV6_DST = 714,
    OF_OXM_IPV6_DST_MASKED = 715,
    OF_OXM_IPV6_EXTHDR = 716,
    OF_OXM_IPV6_EXTHDR_MASKED = 717,
    OF_OXM_IPV6_FLABEL = 718,
    OF_OXM_IPV6_FLABEL_MASKED = 719,
    OF_OXM_IPV6_ND_SLL = 720,
    OF_OXM_IPV6_ND_SLL_MASKED = 721,
    OF_OXM_IPV6_ND_TARGET = 722,
    OF_OXM_IPV6_ND_TARGET_MASKED = 723,
    OF_OXM_IPV6_ND_TLL = 724,
    OF_OXM_IPV6_ND_TLL_MASKED = 725,
    OF_OXM_IPV6_SRC = 726,
    OF_OXM_IPV6_SRC_MASKED = 727,
    OF_OXM_METADATA = 728,
    OF_OXM_METADATA_MASKED = 729,
    OF_OXM_MPLS_BOS = 730,
    OF_OXM_MPLS_BOS_MASKED = 731,
    OF_OXM_MPLS_LABEL = 732,
    OF_OXM_MPLS_LABEL_MASKED = 733,
    OF_OXM_MPLS_TC = 734,
    OF_OXM_MPLS_TC_MASKED = 735,
    OF_OXM_OVS_TCP_FLAGS = 736,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 737,
    OF_OXM_PBB_UCA = 738,
    OF_OXM_PBB_UCA_MASKED = 739,
    OF_OXM_SCTP_DST = 740,
    OF_OXM_SCTP_DST_MASKED = 741,
    OF_OXM_SCTP_SRC = 742,
    OF_OXM_SCTP_SRC_MASKED = 743,
    OF_OXM_TCP_DST = 744,
    OF_OXM_TCP_DST_MASKED = 745,
    OF_OXM_TCP_SRC = 746,
    OF_OXM_TCP_SRC_MASKED = 747,
    OF_OXM_TUNNEL_ID = 748,
    OF_OXM_TUNNEL_ID_MASKED = 749,
    OF_OXM_TUNNEL_IPV4_DST = 750,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 751,
    OF_OXM_TUNNEL_IPV4_SRC = 752,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 753,
    OF_OXM_UDP_DST = 754,
    OF_OXM_UDP_DST_MASKED = 755,
    OF_OXM_UDP_SRC = 756,
    OF_OXM_UDP_SRC_MASKED = 757,
    OF_OXM_VLAN_PCP = 758,
    OF_OXM_VLAN_PCP_MASKED = 759,
    OF_OXM_VLAN_VID = 760,
    OF_OXM_VLAN_VID_MASKED = 761,
    OF_PACKET_QUEUE = 762,
    OF_PORT_DESC = 763,
    OF_PORT_DESC_PROP = 764,
    OF_PORT_DESC_PROP_BSN = 765,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 766,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 767,
    OF_PORT_DESC_PROP_BSN_EXTENDED_CAPABILITIES = 768,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 769,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 770,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 771,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 772,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 773,
    OF_PORT_DESC_PROP_BSN_UPLINK = 774,
    OF_PORT_DESC_PROP_ETHERNET = 775,
    OF_PORT_DESC_PROP_EXPERIMENTER = 776,
    OF_PORT_DESC_PROP_OPTICAL = 777,
    OF_PORT_MOD_PROP = 778,
    OF_PORT_MOD_PROP_ETHERNET = 779,
    OF_PORT_MOD_PROP_EXPERIMENTER = 780,
    OF_PORT_MOD_PROP_OPTICAL = 781,
    OF_PORT_STATS_ENTRY = 782,
    OF_PORT_STATS_PROP = 783,
    OF_PORT_STATS_PROP_ETHERNET = 784,
    OF_PORT_STATS_PROP_EXPERIMENTER = 785,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 786,
    OF_PORT_STATS_PROP_OPTICAL = 787,
    OF_QUEUE_DESC = 788,
    OF_QUEUE_DESC_PROP = 789,
    OF_QUEUE_DESC_PROP_BSN = 790,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 791,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 792,
    OF_QUEUE_DESC_PROP_MAX_RATE = 793,
    OF_QUEUE_DESC_PROP_MIN_RATE = 794,
    OF_QUEUE_PROP = 795,
    OF_QUEUE_PROP_EXPERIMENTER = 796,
    OF_QUEUE_PROP_MAX_RATE = 797,
    OF_QUEUE_PROP_MIN_RATE = 798,
    OF_QUEUE_STATS_ENTRY = 799,
    OF_QUEUE_STATS_PROP = 800,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 801,
    OF_ROLE_PROP = 802,
    OF_ROLE_PROP_EXPERIMENTER = 803,
    OF_TABLE_DESC = 804,
    OF_TABLE_FEATURE_PROP = 805,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 806,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 807,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 808,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 809,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 810,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 811,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 812,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 813,
    OF_TABLE_FEATURE_PROP_MATCH = 814,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 815,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 816,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 817,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 818,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 819,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 820,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 821,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 822,
    OF_TABLE_FEATURES = 823,
    OF_TABLE_MOD_PROP = 824,
    OF_TABLE_MOD_PROP_EVICTION = 825,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 826,
    OF_TABLE_MOD_PROP_VACANCY = 827,
    OF_TABLE_STATS_ENTRY = 828,
    OF_UINT32 = 829,
    OF_UINT64 = 830,
    OF_UINT8 = 831,
    ...
    /* List objects */
    OF_LIST_ACTION = 832,
    OF_LIST_ACTION_ID = 833,
    OF_LIST_ASYNC_CONFIG_PROP = 834,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 835,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 836,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 837,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 838,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 839,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 840,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 841,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 842,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 843,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 844,
    OF_LIST_BSN_INTERFACE = 845,
    OF_LIST_BSN_LACP_STATS_ENTRY = 846,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 847,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 848,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 849,
    OF_LIST_BSN_TLV = 850,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 851,
    OF_LIST_BSN_VLAN_MAC = 852,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 853,
    OF_LIST_BUCKET = 854,
    OF_LIST_BUCKET_COUNTER = 855,
    OF_LIST_BUNDLE_PROP = 856,
    OF_LIST_FLOW_STATS_ENTRY = 857,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 858,
    OF_LIST_GROUP_STATS_ENTRY = 859,
    OF_LIST_HELLO_ELEM = 860,
    OF_LIST_INSTRUCTION = 861,
    OF_LIST_INSTRUCTION_ID = 862,
    OF_LIST_METER_BAND = 863,
    OF_LIST_METER_BAND_STATS = 864,
    OF_LIST_METER_CONFIG = 865,
    OF_LIST_METER_STATS = 866,
    OF_LIST_OXM = 867,
    OF_LIST_PACKET_QUEUE = 868,
    OF_LIST_PORT_DESC = 869,
    OF_LIST_PORT_DESC_PROP = 870,
    OF_LIST_PORT_MOD_PROP = 871,
    OF_LIST_PORT_STATS_ENTRY = 872,
    OF_LIST_PORT_STATS_PROP = 873,
    OF_LIST_QUEUE_DESC = 874,
    OF_LIST_QUEUE_DESC_PROP = 875,
    OF_LIST_QUEUE_PROP = 876,
    OF_LIST_QUEUE_STATS_ENTRY = 877,
    OF_LIST_QUEUE_STATS_PROP = 878,
    OF_LIST_ROLE_PROP = 879,
    OF_LIST_TABLE_DESC = 880,
    OF_LIST_TABLE_FEATURE_PROP = 881,
    OF_LIST_TABLE_FEATURES = 882,
    OF_LIST_TABLE_MOD_PROP = 883,
    OF_LIST_TABLE_STATS_ENTRY = 884,
    OF_LIST_UINT32 = 885,
    OF_LIST_UINT64 = 886,
    OF_LIST_UINT8 = 887,
