...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_USER_CONFIGURED = 457,
    OF_BSN_TLV_VFI = 458,
    OF_BSN_TLV_VFP_CLASS_ID = 459,
    OF_BSN_TLV_VIRTUAL = 460,
    OF_BSN_TLV_VLAN_MAC_LIST = 461,
    OF_BSN_TLV_VLAN_PCP = 462,
    OF_BSN_TLV_VLAN_VID = 463,
    OF_BSN_TLV_VLAN_VID_MASK = 464,
    OF_BSN_TLV_VNI = 465,
    OF_BSN_TLV_VPN_KEY = 466,
    OF_BSN_TLV_VRF = 467,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 468,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 469,
    OF_BSN_VLAN_MAC = 470,
    OF_BSN_VPORT = 471,
    OF_BSN_VPORT_L2GRE = 472,
    OF_BSN_VPORT_Q_IN_Q = 473,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 474,
    OF_BUCKET = 475,
    OF_BUCKET_COUNTER = 476,
    OF_BUNDLE_PROP = 477,
    OF_BUNDLE_PROP_EXPERIMENTER = 478,
    OF_FLOW_STATS_ENTRY = 479,
    OF_GROUP_DESC_STATS_ENTRY = 480,
    OF_GROUP_STATS_ENTRY = 481,
    OF_HELLO_ELEM = 482,
    OF_HELLO_ELEM_VERSIONBITMAP = 483,
    OF_INSTRUCTION = 484,
    OF_INSTRUCTION_APPLY_ACTIONS = 485,
    OF_INSTRUCTION_BSN = 486,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 487,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 488,
    OF_INSTRUCTION_BSN_DENY = 489,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 490,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 491,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 492,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 493,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 494,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 495,
    OF_INSTRUCTION_BSN_HASH_SELECT = 496,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 497,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 498,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 499,
    OF_INSTRUCTION_BSN_PERMIT = 500,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 501,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 502,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 503,
    OF_INSTRUCTION_CLEAR_ACTIONS = 504,
    OF_INSTRUCTION_EXPERIMENTER = 505,
    OF_INSTRUCTION_GOTO_TABLE = 506,
    OF_INSTRUCTION_ID = 507,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 508,
    OF_INSTRUCTION_ID_BSN = 509,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 510,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 511,
    OF_INSTRUCTION_ID_BSN_DENY = 512,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 513,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 514,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 515,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 516,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 517,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 518,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 519,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 520,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 521,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 522,
    OF_INSTRUCTION_ID_BSN_PERMIT = 523,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 524,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 525,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 526,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 527,
    OF_INSTRUCTION_ID_EXPERIMENTER = 528,
    OF_INSTRUCTION_ID_GOTO_TABLE = 529,
    OF_INSTRUCTION_ID_METER = 530,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 531,
    OF_INSTRUCTION_ID_WRITE_METADATA = 532,
    OF_INSTRUCTION_METER = 533,
    OF_INSTRUCTION_WRITE_ACTIONS = 534,
    OF_INSTRUCTION_WRITE_METADATA = 535,
    OF_MATCH_V1 = 536,
    OF_MATCH_V2 = 537,
    OF_MATCH_V3 = 538,
    OF_METER_BAND = 539,
    OF_METER_BAND_DROP = 540,
    OF_METER_BAND_DSCP_REMARK = 541,
    OF_METER_BAND_EXPERIMENTER = 542,
    OF_METER_BAND_STATS = 543,
    OF_METER_CONFIG = 544,
    OF_METER_FEATURES = 545,
    OF_METER_STATS = 546,
    OF_OXM = 547,
    OF_OXM_ARP_OP = 548,
    OF_OXM_ARP_OP_MASKED = 549,
    OF_OXM_ARP_SHA = 550,
    OF_OXM_ARP_SHA_MASKED = 551,
    OF_OXM_ARP_SPA = 552,
    OF_OXM_ARP_SPA_MASKED = 553,
    OF_OXM_ARP_THA = 554,
    OF_OXM_ARP_THA_MASKED = 555,
    OF_OXM_ARP_TPA = 556,
    OF_OXM_ARP_TPA_MASKED = 557,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 558,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 559,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 560,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 561,
    OF_OXM_BSN_IFP_CLASS_ID = 562,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 563,
    OF_OXM_BSN_IN_PORTS_128 = 564,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 565,
    OF_OXM_BSN_IN_PORTS_512 = 566,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 567,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 568,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 569,
    OF_OXM_BSN_INNER_ETH_DST = 570,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 571,
    OF_OXM_BSN_INNER_ETH_SRC = 572,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 573,
    OF_OXM_BSN_INNER_VLAN_VID = 574,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 575,
    OF_OXM_BSN_IP_FRAGMENTATION = 576,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 577,
    OF_OXM_BSN_L2_CACHE_HIT = 578,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 579,
    OF_OXM_BSN_L3_DST_CLASS_ID = 580,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 581,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 582,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 583,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 584,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 585,
    OF_OXM_BSN_LAG_ID = 586,
    OF_OXM_BSN_LAG_ID_MASKED = 587,
    OF_OXM_BSN_TCP_FLAGS = 588,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 589,
    OF_OXM_BSN_UDF0 = 590,
    OF_OXM_BSN_UDF0_MASKED = 591,
    OF_OXM_BSN_UDF1 = 592,
    OF_OXM_BSN_UDF1_MASKED = 593,
    OF_OXM_BSN_UDF2 = 594,
    OF_OXM_BSN_UDF2_MASKED = 595,
    OF_OXM_BSN_UDF3 = 596,
    OF_OXM_BSN_UDF3_MASKED = 597,
    OF_OXM_BSN_UDF4 = 598,
    OF_OXM_BSN_UDF4_MASKED = 599,
    OF_OXM_BSN_UDF5 = 600,
    OF_OXM_BSN_UDF5_MASKED = 601,
    OF_OXM_BSN_UDF6 = 602,
    OF_OXM_BSN_UDF6_MASKED = 603,
    OF_OXM_BSN_UDF7 = 604,
    OF_OXM_BSN_UDF7_MASKED = 605,
    OF_OXM_BSN_VFI = 606,
    OF_OXM_BSN_VFI_MASKED = 607,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 608,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 609,
    OF_OXM_BSN_VRF = 610,
    OF_OXM_BSN_VRF_MASKED = 611,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 612,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 613,
    OF_OXM_CONN_TRACKING_IPV6_DST = 614,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 615,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 616,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 617,
    OF_OXM_CONN_TRACKING_LABEL = 618,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 619,
    OF_OXM_CONN_TRACKING_MARK = 620,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 621,
    OF_OXM_CONN_TRACKING_NW_DST = 622,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 623,
    OF_OXM_CONN_TRACKING_NW_PROTO = 624,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 625,
    OF_OXM_CONN_TRACKING_NW_SRC = 626,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 627,
    OF_OXM_CONN_TRACKING_STATE = 628,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 629,
    OF_OXM_CONN_TRACKING_TP_DST = 630,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 631,
    OF_OXM_CONN_TRACKING_TP_SRC = 632,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 633,
    OF_OXM_CONN_TRACKING_ZONE = 634,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 635,
    OF_OXM_ETH_DST = 636,
    OF_OXM_ETH_DST_MASKED = 637,
    OF_OXM_ETH_SRC = 638,
    OF_OXM_ETH_SRC_MASKED = 639,
    OF_OXM_ETH_TYPE = 640,
    OF_OXM_ETH_TYPE_MASKED = 641,
    OF_OXM_ICMPV4_CODE = 642,
    OF_OXM_ICMPV4_CODE_MASKED = 643,
    OF_OXM_ICMPV4_TYPE = 644,
    OF_OXM_ICMPV4_TYPE_MASKED = 645,
    OF_OXM_ICMPV6_CODE = 646,
    OF_OXM_ICMPV6_CODE_MASKED = 647,
    OF_OXM_ICMPV6_TYPE = 648,
    OF_OXM_ICMPV6_TYPE_MASKED = 649,
    OF_OXM_IN_PHY_PORT = 650,
    OF_OXM_IN_PHY_PORT_MASKED = 651,
    OF_OXM_IN_PORT = 652,
    OF_OXM_IN_PORT_MASKED = 653,
    OF_OXM_IP_DSCP = 654,
    OF_OXM_IP_DSCP_MASKED = 655,
    OF_OXM_IP_ECN = 656,
    OF_OXM_IP_ECN_MASKED = 657,
    OF_OXM_IP_PROTO = 658,
    OF_OXM_IP_PROTO_MASKED = 659,
    OF_OXM_IPV4_DST = 660,
    OF_OXM_IPV4_DST_MASKED = 661,
    OF_OXM_IPV4_SRC = 662,
    OF_OXM_IPV4_SRC_MASKED = 663,
    OF_OXM_IPV6_DST = 664,
    OF_OXM_IPV6_DST_MASKED = 665,
    OF_OXM_IPV6_EXTHDR = 666,
    OF_OXM_IPV6_EXTHDR_MASKED = 667,
    OF_OXM_IPV6_FLABEL = 668,
    OF_OXM_IPV6_FLABEL_MASKED = 669,
    OF_OXM_IPV6_ND_SLL = 670,
    OF_OXM_IPV6_ND_SLL_MASKED = 671,
    OF_OXM_IPV6_ND_TARGET = 672,
    OF_OXM_IPV6_ND_TARGET_MASKED = 673,
    OF_OXM_IPV6_ND_TLL = 674,
    OF_OXM_IPV6_ND_TLL_MASKED = 675,
    OF_OXM_IPV6_SRC = 676,
    OF_OXM_IPV6_SRC_MASKED = 677,
    OF_OXM_METADATA = 678,
    OF_OXM_METADATA_MASKED = 679,
    OF_OXM_MPLS_BOS = 680,
    OF_OXM_MPLS_BOS_MASKED = 681,
    OF_OXM_MPLS_LABEL = 682,
    OF_OXM_MPLS_LABEL_MASKED = 683,
    OF_OXM_MPLS_TC = 684,
    OF_OXM_MPLS_TC_MASKED = 685,
    OF_OXM_OVS_TCP_FLAGS = 686,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 687,
    OF_OXM_PBB_UCA = 688,
    OF_OXM_PBB_UCA_MASKED = 689,
    OF_OXM_SCTP_DST = 690,
    OF_OXM_SCTP_DST_MASKED = 691,
    OF_OXM_SCTP_SRC = 692,
    OF_OXM_SCTP_SRC_MASKED = 693,
    OF_OXM_TCP_DST = 694,
    OF_OXM_TCP_DST_MASKED = 695,
    OF_OXM_TCP_SRC = 696,
    OF_OXM_TCP_SRC_MASKED = 697,
    OF_OXM_TUNNEL_ID = 698,
    OF_OXM_TUNNEL_ID_MASKED = 699,
    OF_OXM_TUNNEL_IPV4_DST = 700,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 701,
    OF_OXM_TUNNEL_IPV4_SRC = 702,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 703,
    OF_OXM_UDP_DST = 704,
    OF_OXM_UDP_DST_MASKED = 705,
    OF_OXM_UDP_SRC = 706,
    OF_OXM_UDP_SRC_MASKED = 707,
    OF_OXM_VLAN_PCP = 708,
    OF_OXM_VLAN_PCP_MASKED = 709,
    OF_OXM_VLAN_VID = 710,
    OF_OXM_VLAN_VID_MASKED = 711,
    OF_PACKET_QUEUE = 712,
    OF_PORT_DESC = 713,
    OF_PORT_DESC_PROP = 714,
    OF_PORT_DESC_PROP_BSN = 715,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 716,
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 717,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 718,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 719,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 720,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 721,
    OF_PORT_DESC_PROP_BSN_UPLINK = 722,
    OF_PORT_DESC_PROP_ETHERNET = 723,
    OF_PORT_DESC_PROP_EXPERIMENTER = 724,
    OF_PORT_DESC_PROP_OPTICAL = 725,
    OF_PORT_MOD_PROP = 726,
    OF_PORT_MOD_PROP_ETHERNET = 727,
    OF_PORT_MOD_PROP_EXPERIMENTER = 728,
    OF_PORT_MOD_PROP_OPTICAL = 729,
    OF_PORT_STATS_ENTRY = 730,
    OF_PORT_STATS_PROP = 731,
    OF_PORT_STATS_PROP_ETHERNET = 732,
    OF_PORT_STATS_PROP_EXPERIMENTER = 733,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 734,
    OF_PORT_STATS_PROP_OPTICAL = 735,
    OF_QUEUE_DESC = 736,
    OF_QUEUE_DESC_PROP = 737,
    OF_QUEUE_DESC_PROP_BSN = 738,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 739,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 740,
    OF_QUEUE_DESC_PROP_MAX_RATE = 741,
    OF_QUEUE_DESC_PROP_MIN_RATE = 742,
    OF_QUEUE_PROP = 743,
    OF_QUEUE_PROP_EXPERIMENTER = 744,
    OF_QUEUE_PROP_MAX_RATE = 745,
    OF_QUEUE_PROP_MIN_RATE = 746,
    OF_QUEUE_STATS_ENTRY = 747,
    OF_QUEUE_STATS_PROP = 748,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 749,
    OF_ROLE_PROP = 750,
    OF_ROLE_PROP_EXPERIMENTER = 751,
    OF_TABLE_DESC = 752,
    OF_TABLE_FEATURE_PROP = 753,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 754,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 755,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 756,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 757,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 758,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 759,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 760,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 761,
    OF_TABLE_FEATURE_PROP_MATCH = 762,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 763,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 764,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 765,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 766,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 767,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 768,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 769,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 770,
    OF_TABLE_FEATURES = 771,
    OF_TABLE_MOD_PROP = 772,
    OF_TABLE_MOD_PROP_EVICTION = 773,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 774,
    OF_TABLE_MOD_PROP_VACANCY = 775,
    OF_TABLE_STATS_ENTRY = 776,
    OF_UINT32 = 777,
    OF_UINT64 = 778,
    OF_UINT8 = 779,
    ...
    /* List objects */
    OF_LIST_ACTION = 780,
    OF_LIST_ACTION_ID = 781,
    OF_LIST_ASYNC_CONFIG_PROP = 782,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 783,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 784,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 785,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 786,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 787,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 788,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 789,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 790,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 791,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 792,
    OF_LIST_BSN_INTERFACE = 793,
    OF_LIST_BSN_LACP_STATS_ENTRY = 794,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 795,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 796,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 797,
    OF_LIST_BSN_TLV = 798,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 799,
    OF_LIST_BSN_VLAN_MAC = 800,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 801,
    OF_LIST_BUCKET = 802,
    OF_LIST_BUCKET_COUNTER = 803,
    OF_LIST_BUNDLE_PROP = 804,
    OF_LIST_FLOW_STATS_ENTRY = 805,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 806,
    OF_LIST_GROUP_STATS_ENTRY = 807,
    OF_LIST_HELLO_ELEM = 808,
    OF_LIST_INSTRUCTION = 809,
    OF_LIST_INSTRUCTION_ID = 810,
    OF_LIST_METER_BAND = 811,
    OF_LIST_METER_BAND_STATS = 812,
    OF_LIST_METER_CONFIG = 813,
    OF_LIST_METER_STATS = 814,
    OF_LIST_OXM = 815,
    OF_LIST_PACKET_QUEUE = 816,
    OF_LIST_PORT_DESC = 817,
    OF_LIST_PORT_DESC_PROP = 818,
    OF_LIST_PORT_MOD_PROP = 819,
    OF_LIST_PORT_STATS_ENTRY = 820,
    OF_LIST_PORT_STATS_PROP = 821,
    OF_LIST_QUEUE_DESC = 822,
    OF_LIST_QUEUE_DESC_PROP = 823,
    OF_LIST_QUEUE_PROP = 824,
    OF_LIST_QUEUE_STATS_ENTRY = 825,
    OF_LIST_QUEUE_STATS_PROP = 826,
    OF_LIST_ROLE_PROP = 827,
    OF_LIST_TABLE_DESC = 828,
    OF_LIST_TABLE_FEATURE_PROP = 829,
    OF_LIST_TABLE_FEATURES = 830,
    OF_LIST_TABLE_MOD_PROP = 831,
    OF_LIST_TABLE_STATS_ENTRY = 832,
    OF_LIST_UINT32 = 833,
    OF_LIST_UINT64 = 834,
    OF_LIST_UINT8 = 835,
