...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_IP_TUNNEL_TYPE = 364,
    OF_BSN_TLV_IPV4 = 365,
    OF_BSN_TLV_IPV4_DST = 366,
    OF_BSN_TLV_IPV4_NETMASK = 367,
    OF_BSN_TLV_IPV4_SRC = 368,
    OF_BSN_TLV_IPV6 = 369,
    OF_BSN_TLV_IPV6_DST = 370,
    OF_BSN_TLV_IPV6_PREFIX = 371,
    OF_BSN_TLV_IPV6_SRC = 372,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 373,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 374,
    OF_BSN_TLV_L3 = 375,
    OF_BSN_TLV_L3_DST_CLASS_ID = 376,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 377,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 378,
    OF_BSN_TLV_LAG_OPTIONS = 379,
    OF_BSN_TLV_LOOPBACK_MODE = 380,
    OF_BSN_TLV_LOOPBACK_PORT = 381,
    OF_BSN_TLV_MAC = 382,
    OF_BSN_TLV_MAC_MASK = 383,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 384,
    OF_BSN_TLV_MISS_PACKETS = 385,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 386,
    OF_BSN_TLV_MPLS_LABEL = 387,
    OF_BSN_TLV_MPLS_SEQUENCED = 388,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 389,
    OF_BSN_TLV_MULTICAST_PACKET_TYPE = 390,
    OF_BSN_TLV_NAME = 391,
    OF_BSN_TLV_NDP_OFFLOAD = 392,
    OF_BSN_TLV_NDP_STATIC = 393,
    OF_BSN_TLV_NEGATE = 394,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 395,
    OF_BSN_TLV_NEXT_HOP_MAC = 396,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 397,
    OF_BSN_TLV_NO_ARP_RESPONSE = 398,
    OF_BSN_TLV_NO_NS_RESPONSE = 399,
    OF_BSN_TLV_OFFSET = 400,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 401,
    OF_BSN_TLV_OUTER_SRC_MAC = 402,
    OF_BSN_TLV_PARENT_PORT = 403,
    OF_BSN_TLV_PARTNER_KEY = 404,
    OF_BSN_TLV_PARTNER_PORT_NUM = 405,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 406,
    OF_BSN_TLV_PARTNER_STATE = 407,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 408,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 409,
    OF_BSN_TLV_PASSIVE = 410,
    OF_BSN_TLV_PDUA_RX_INSTANCE = 411,
    OF_BSN_TLV_PIM_DR = 412,
    OF_BSN_TLV_PORT = 413,
    OF_BSN_TLV_PORT_SPEED_GBPS = 414,
    OF_BSN_TLV_PORT_USAGE = 415,
    OF_BSN_TLV_PORT_VXLAN_MODE = 416,
    OF_BSN_TLV_PRIORITY = 417,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 418,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 419,
    OF_BSN_TLV_QOS_PRIORITY = 420,
    OF_BSN_TLV_QUEUE_ID = 421,
    OF_BSN_TLV_QUEUE_WEIGHT = 422,
    OF_BSN_TLV_RATE_LIMIT = 423,
    OF_BSN_TLV_RATE_UNIT = 424,
    OF_BSN_TLV_RECORD_PACKETS = 425,
    OF_BSN_TLV_REFERENCE = 426,
    OF_BSN_TLV_REPLY_PACKETS = 427,
    OF_BSN_TLV_REQUEST_PACKETS = 428,
    OF_BSN_TLV_REST_SERVER = 429,
    OF_BSN_TLV_ROUTING_PARAM = 430,
    OF_BSN_TLV_RX_BYTES = 431,
    OF_BSN_TLV_RX_PACKETS = 432,
    OF_BSN_TLV_SAMPLING_RATE = 433,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 434,
    OF_BSN_TLV_STATUS = 435,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 436,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 437,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 438,
    OF_BSN_TLV_SUB_AGENT_ID = 439,
    OF_BSN_TLV_TCP_DST = 440,
    OF_BSN_TLV_TCP_FLAGS = 441,
    OF_BSN_TLV_TCP_SRC = 442,
    OF_BSN_TLV_TIMESTAMP = 443,
    OF_BSN_TLV_TTL = 444,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 445,
    OF_BSN_TLV_TX_BYTES = 446,
    OF_BSN_TLV_TX_PACKETS = 447,
    OF_BSN_TLV_UDF_ANCHOR = 448,
    OF_BSN_TLV_UDF_ID = 449,
    OF_BSN_TLV_UDF_LENGTH = 450,
    OF_BSN_TLV_UDF_OFFSET = 451,
    OF_BSN_TLV_UDP_DST = 452,
    OF_BSN_TLV_UDP_SRC = 453,
    OF_BSN_TLV_UINT32 = 454,
    ...
    OF_BSN_TLV_USER_CONFIGURED = 463,
    OF_BSN_TLV_VFI = 464,
    OF_BSN_TLV_VFP_CLASS_ID = 465,
    OF_BSN_TLV_VIRTUAL = 466,
    OF_BSN_TLV_VLAN_MAC_LIST = 467,
    OF_BSN_TLV_VLAN_PCP = 468,
    OF_BSN_TLV_VLAN_VID = 469,
    OF_BSN_TLV_VLAN_VID_MASK = 470,
    OF_BSN_TLV_VNI = 471,
    OF_BSN_TLV_VPN_KEY = 472,
    OF_BSN_TLV_VRF = 473,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 474,
    OF_BSN_UNIT = 475,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 476,
    OF_BSN_VLAN_MAC = 477,
    OF_BSN_VPORT = 478,
    OF_BSN_VPORT_L2GRE = 479,
    OF_BSN_VPORT_Q_IN_Q = 480,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 481,
    OF_BUCKET = 482,
    OF_BUCKET_COUNTER = 483,
    OF_BUNDLE_PROP = 484,
    OF_BUNDLE_PROP_EXPERIMENTER = 485,
    OF_FLOW_STATS_ENTRY = 486,
    OF_GROUP_DESC_STATS_ENTRY = 487,
    OF_GROUP_STATS_ENTRY = 488,
    OF_HELLO_ELEM = 489,
    OF_HELLO_ELEM_VERSIONBITMAP = 490,
    OF_INSTRUCTION = 491,
    OF_INSTRUCTION_APPLY_ACTIONS = 492,
    OF_INSTRUCTION_BSN = 493,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 494,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 495,
    OF_INSTRUCTION_BSN_DENY = 496,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 497,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 498,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 499,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 500,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 501,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 502,
    OF_INSTRUCTION_BSN_HASH_SELECT = 503,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 504,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 505,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 506,
    OF_INSTRUCTION_BSN_PERMIT = 507,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 508,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 509,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 510,
    OF_INSTRUCTION_CLEAR_ACTIONS = 511,
    OF_INSTRUCTION_EXPERIMENTER = 512,
    OF_INSTRUCTION_GOTO_TABLE = 513,
    OF_INSTRUCTION_ID = 514,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 515,
    OF_INSTRUCTION_ID_BSN = 516,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 517,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 518,
    OF_INSTRUCTION_ID_BSN_DENY = 519,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 520,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 521,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 522,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 523,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 524,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 525,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 526,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 527,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 528,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 529,
    OF_INSTRUCTION_ID_BSN_PERMIT = 530,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 531,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 532,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 533,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 534,
    OF_INSTRUCTION_ID_EXPERIMENTER = 535,
    OF_INSTRUCTION_ID_GOTO_TABLE = 536,
    OF_INSTRUCTION_ID_METER = 537,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 538,
    OF_INSTRUCTION_ID_WRITE_METADATA = 539,
    OF_INSTRUCTION_METER = 540,
    OF_INSTRUCTION_WRITE_ACTIONS = 541,
    OF_INSTRUCTION_WRITE_METADATA = 542,
    OF_MATCH_V1 = 543,
    OF_MATCH_V2 = 544,
    OF_MATCH_V3 = 545,
    OF_METER_BAND = 546,
    OF_METER_BAND_DROP = 547,
    OF_METER_BAND_DSCP_REMARK = 548,
    OF_METER_BAND_EXPERIMENTER = 549,
    OF_METER_BAND_STATS = 550,
    OF_METER_CONFIG = 551,
    OF_METER_FEATURES = 552,
    OF_METER_STATS = 553,
    OF_OXM = 554,
    OF_OXM_ARP_OP = 555,
    OF_OXM_ARP_OP_MASKED = 556,
    OF_OXM_ARP_SHA = 557,
    OF_OXM_ARP_SHA_MASKED = 558,
    OF_OXM_ARP_SPA = 559,
    OF_OXM_ARP_SPA_MASKED = 560,
    OF_OXM_ARP_THA = 561,
    OF_OXM_ARP_THA_MASKED = 562,
    OF_OXM_ARP_TPA = 563,
    OF_OXM_ARP_TPA_MASKED = 564,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 565,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 566,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 567,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 568,
    OF_OXM_BSN_IFP_CLASS_ID = 569,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 570,
    OF_OXM_BSN_IN_PORTS_128 = 571,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 572,
    OF_OXM_BSN_IN_PORTS_512 = 573,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 574,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 575,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 576,
    OF_OXM_BSN_INNER_ETH_DST = 577,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 578,
    OF_OXM_BSN_INNER_ETH_SRC = 579,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 580,
    OF_OXM_BSN_INNER_VLAN_VID = 581,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 582,
    OF_OXM_BSN_IP_FRAGMENTATION = 583,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 584,
    OF_OXM_BSN_L2_CACHE_HIT = 585,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 586,
    OF_OXM_BSN_L3_DST_CLASS_ID = 587,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 588,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 589,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 590,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 591,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 592,
    OF_OXM_BSN_LAG_ID = 593,
    OF_OXM_BSN_LAG_ID_MASKED = 594,
    OF_OXM_BSN_TCP_FLAGS = 595,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 596,
    OF_OXM_BSN_UDF0 = 597,
    OF_OXM_BSN_UDF0_MASKED = 598,
    OF_OXM_BSN_UDF1 = 599,
    OF_OXM_BSN_UDF1_MASKED = 600,
    OF_OXM_BSN_UDF2 = 601,
    OF_OXM_BSN_UDF2_MASKED = 602,
    OF_OXM_BSN_UDF3 = 603,
    OF_OXM_BSN_UDF3_MASKED = 604,
    OF_OXM_BSN_UDF4 = 605,
    OF_OXM_BSN_UDF4_MASKED = 606,
    OF_OXM_BSN_UDF5 = 607,
    OF_OXM_BSN_UDF5_MASKED = 608,
    OF_OXM_BSN_UDF6 = 609,
    OF_OXM_BSN_UDF6_MASKED = 610,
    OF_OXM_BSN_UDF7 = 611,
    OF_OXM_BSN_UDF7_MASKED = 612,
    OF_OXM_BSN_VFI = 613,
    OF_OXM_BSN_VFI_MASKED = 614,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 615,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 616,
    OF_OXM_BSN_VRF = 617,
    OF_OXM_BSN_VRF_MASKED = 618,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 619,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 620,
    OF_OXM_CONN_TRACKING_IPV6_DST = 621,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 622,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 623,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 624,
    OF_OXM_CONN_TRACKING_LABEL = 625,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 626,
    OF_OXM_CONN_TRACKING_MARK = 627,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 628,
    OF_OXM_CONN_TRACKING_NW_DST = 629,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 630,
    OF_OXM_CONN_TRACKING_NW_PROTO = 631,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 632,
    OF_OXM_CONN_TRACKING_NW_SRC = 633,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 634,
    OF_OXM_CONN_TRACKING_STATE = 635,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 636,
    OF_OXM_CONN_TRACKING_TP_DST = 637,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 638,
    OF_OXM_CONN_TRACKING_TP_SRC = 639,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 640,
    OF_OXM_CONN_TRACKING_ZONE = 641,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 642,
    OF_OXM_ETH_DST = 643,
    OF_OXM_ETH_DST_MASKED = 644,
    OF_OXM_ETH_SRC = 645,
    OF_OXM_ETH_SRC_MASKED = 646,
    OF_OXM_ETH_TYPE = 647,
    OF_OXM_ETH_TYPE_MASKED = 648,
    OF_OXM_ICMPV4_CODE = 649,
    OF_OXM_ICMPV4_CODE_MASKED = 650,
    OF_OXM_ICMPV4_TYPE = 651,
    OF_OXM_ICMPV4_TYPE_MASKED = 652,
    OF_OXM_ICMPV6_CODE = 653,
    OF_OXM_ICMPV6_CODE_MASKED = 654,
    OF_OXM_ICMPV6_TYPE = 655,
    OF_OXM_ICMPV6_TYPE_MASKED = 656,
    OF_OXM_IN_PHY_PORT = 657,
    OF_OXM_IN_PHY_PORT_MASKED = 658,
    OF_OXM_IN_PORT = 659,
    OF_OXM_IN_PORT_MASKED = 660,
    OF_OXM_IP_DSCP = 661,
    OF_OXM_IP_DSCP_MASKED = 662,
    OF_OXM_IP_ECN = 663,
    OF_OXM_IP_ECN_MASKED = 664,
    OF_OXM_IP_PROTO = 665,
    OF_OXM_IP_PROTO_MASKED = 666,
    OF_OXM_IPV4_DST = 667,
    OF_OXM_IPV4_DST_MASKED = 668,
    OF_OXM_IPV4_SRC = 669,
    OF_OXM_IPV4_SRC_MASKED = 670,
    OF_OXM_IPV6_DST = 671,
    OF_OXM_IPV6_DST_MASKED = 672,
    OF_OXM_IPV6_EXTHDR = 673,
    OF_OXM_IPV6_EXTHDR_MASKED = 674,
    OF_OXM_IPV6_FLABEL = 675,
    OF_OXM_IPV6_FLABEL_MASKED = 676,
    OF_OXM_IPV6_ND_SLL = 677,
    OF_OXM_IPV6_ND_SLL_MASKED = 678,
    OF_OXM_IPV6_ND_TARGET = 679,
    OF_OXM_IPV6_ND_TARGET_MASKED = 680,
    OF_OXM_IPV6_ND_TLL = 681,
    OF_OXM_IPV6_ND_TLL_MASKED = 682,
    OF_OXM_IPV6_SRC = 683,
    OF_OXM_IPV6_SRC_MASKED = 684,
    OF_OXM_METADATA = 685,
    OF_OXM_METADATA_MASKED = 686,
    OF_OXM_MPLS_BOS = 687,
    OF_OXM_MPLS_BOS_MASKED = 688,
    OF_OXM_MPLS_LABEL = 689,
    OF_OXM_MPLS_LABEL_MASKED = 690,
    OF_OXM_MPLS_TC = 691,
    OF_OXM_MPLS_TC_MASKED = 692,
    OF_OXM_OVS_TCP_FLAGS = 693,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 694,
    OF_OXM_PBB_UCA = 695,
    OF_OXM_PBB_UCA_MASKED = 696,
    OF_OXM_SCTP_DST = 697,
    OF_OXM_SCTP_DST_MASKED = 698,
    OF_OXM_SCTP_SRC = 699,
    OF_OXM_SCTP_SRC_MASKED = 700,
    OF_OXM_TCP_DST = 701,
    OF_OXM_TCP_DST_MASKED = 702,
    OF_OXM_TCP_SRC = 703,
    OF_OXM_TCP_SRC_MASKED = 704,
    OF_OXM_TUNNEL_ID = 705,
    OF_OXM_TUNNEL_ID_MASKED = 706,
    OF_OXM_TUNNEL_IPV4_DST = 707,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 708,
    OF_OXM_TUNNEL_IPV4_SRC = 709,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 710,
    OF_OXM_UDP_DST = 711,
    OF_OXM_UDP_DST_MASKED = 712,
    OF_OXM_UDP_SRC = 713,
    OF_OXM_UDP_SRC_MASKED = 714,
    OF_OXM_VLAN_PCP = 715,
    OF_OXM_VLAN_PCP_MASKED = 716,
    OF_OXM_VLAN_VID = 717,
    OF_OXM_VLAN_VID_MASKED = 718,
    OF_PACKET_QUEUE = 719,
    OF_PORT_DESC = 720,
    OF_PORT_DESC_PROP = 721,
    OF_PORT_DESC_PROP_BSN = 722,
    OF_PORT_DESC_PROP_BSN_ALARM = 723,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 724,
    OF_PORT_DESC_PROP_BSN_DIAG = 725,
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 726,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 727,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 728,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 729,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 730,
    OF_PORT_DESC_PROP_BSN_UPLINK = 731,
    OF_PORT_DESC_PROP_ETHERNET = 732,
    OF_PORT_DESC_PROP_EXPERIMENTER = 733,
    OF_PORT_DESC_PROP_OPTICAL = 734,
    OF_PORT_MOD_PROP = 735,
    OF_PORT_MOD_PROP_ETHERNET = 736,
    OF_PORT_MOD_PROP_EXPERIMENTER = 737,
    OF_PORT_MOD_PROP_OPTICAL = 738,
    OF_PORT_STATS_ENTRY = 739,
    OF_PORT_STATS_PROP = 740,
    OF_PORT_STATS_PROP_ETHERNET = 741,
    OF_PORT_STATS_PROP_EXPERIMENTER = 742,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 743,
    OF_PORT_STATS_PROP_OPTICAL = 744,
    OF_QUEUE_DESC = 745,
    OF_QUEUE_DESC_PROP = 746,
    OF_QUEUE_DESC_PROP_BSN = 747,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 748,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 749,
    OF_QUEUE_DESC_PROP_MAX_RATE = 750,
    OF_QUEUE_DESC_PROP_MIN_RATE = 751,
    OF_QUEUE_PROP = 752,
    OF_QUEUE_PROP_EXPERIMENTER = 753,
    OF_QUEUE_PROP_MAX_RATE = 754,
    OF_QUEUE_PROP_MIN_RATE = 755,
    OF_QUEUE_STATS_ENTRY = 756,
    OF_QUEUE_STATS_PROP = 757,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 758,
    OF_ROLE_PROP = 759,
    OF_ROLE_PROP_EXPERIMENTER = 760,
    OF_TABLE_DESC = 761,
    OF_TABLE_FEATURE_PROP = 762,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 763,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 764,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 765,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 766,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 767,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 768,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 769,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 770,
    OF_TABLE_FEATURE_PROP_MATCH = 771,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 772,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 773,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 774,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 775,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 776,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 777,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 778,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 779,
    OF_TABLE_FEATURES = 780,
    OF_TABLE_MOD_PROP = 781,
    OF_TABLE_MOD_PROP_EVICTION = 782,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 783,
    OF_TABLE_MOD_PROP_VACANCY = 784,
    OF_TABLE_STATS_ENTRY = 785,
    OF_UINT32 = 786,
    OF_UINT64 = 787,
    OF_UINT8 = 788,
    OFP_BSN_MODULE_EEPROM_TRANSCEIVER = 789,

    /* List objects */
    OF_LIST_ACTION = 790,
    OF_LIST_ACTION_ID = 791,
    OF_LIST_ASYNC_CONFIG_PROP = 792,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 793,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 794,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 795,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 796,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 797,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 798,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 799,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 800,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 801,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 802,
    OF_LIST_BSN_INTERFACE = 803,
    OF_LIST_BSN_LACP_STATS_ENTRY = 804,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 805,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 806,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 807,
    OF_LIST_BSN_TLV = 808,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 809,
    OF_LIST_BSN_VLAN_MAC = 810,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 811,
    OF_LIST_BUCKET = 812,
    OF_LIST_BUCKET_COUNTER = 813,
    OF_LIST_BUNDLE_PROP = 814,
    OF_LIST_FLOW_STATS_ENTRY = 815,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 816,
    OF_LIST_GROUP_STATS_ENTRY = 817,
    OF_LIST_HELLO_ELEM = 818,
    OF_LIST_INSTRUCTION = 819,
    OF_LIST_INSTRUCTION_ID = 820,
    OF_LIST_METER_BAND = 821,
    OF_LIST_METER_BAND_STATS = 822,
    OF_LIST_METER_CONFIG = 823,
    OF_LIST_METER_STATS = 824,
    OF_LIST_OXM = 825,
    OF_LIST_PACKET_QUEUE = 826,
    OF_LIST_PORT_DESC = 827,
    OF_LIST_PORT_DESC_PROP = 828,
    OF_LIST_PORT_MOD_PROP = 829,
    OF_LIST_PORT_STATS_ENTRY = 830,
    OF_LIST_PORT_STATS_PROP = 831,
    OF_LIST_QUEUE_DESC = 832,
    OF_LIST_QUEUE_DESC_PROP = 833,
    OF_LIST_QUEUE_PROP = 834,
    OF_LIST_QUEUE_STATS_ENTRY = 835,
    OF_LIST_QUEUE_STATS_PROP = 836,
    OF_LIST_ROLE_PROP = 837,
    OF_LIST_TABLE_DESC = 838,
    OF_LIST_TABLE_FEATURE_PROP = 839,
    OF_LIST_TABLE_FEATURES = 840,
    OF_LIST_TABLE_MOD_PROP = 841,
    OF_LIST_TABLE_STATS_ENTRY = 842,
    OF_LIST_UINT32 = 843,
    OF_LIST_UINT64 = 844,
    OF_LIST_UINT8 = 845,
