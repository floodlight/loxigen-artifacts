...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_VLAN_PCP = 389,
    OF_BSN_TLV_VLAN_VID = 390,
    OF_BSN_TLV_VLAN_VID_MASK = 391,
    OF_BSN_TLV_VNI = 392,
    OF_BSN_TLV_VRF = 393,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 394,
    OF_BSN_VPORT = 395,
    OF_BSN_VPORT_L2GRE = 396,
    OF_BSN_VPORT_Q_IN_Q = 397,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 398,
    OF_BUCKET = 399,
    OF_BUCKET_COUNTER = 400,
    OF_BUNDLE_PROP = 401,
    OF_BUNDLE_PROP_EXPERIMENTER = 402,
    OF_FLOW_STATS_ENTRY = 403,
    OF_GROUP_DESC_STATS_ENTRY = 404,
    OF_GROUP_STATS_ENTRY = 405,
    OF_HELLO_ELEM = 406,
    OF_HELLO_ELEM_VERSIONBITMAP = 407,
    OF_INSTRUCTION = 408,
    OF_INSTRUCTION_APPLY_ACTIONS = 409,
    OF_INSTRUCTION_BSN = 410,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 411,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 412,
    OF_INSTRUCTION_BSN_DENY = 413,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 414,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 415,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 416,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 417,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 418,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 419,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 420,
    OF_INSTRUCTION_BSN_PERMIT = 421,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 422,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 423,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 424,
    OF_INSTRUCTION_CLEAR_ACTIONS = 425,
    OF_INSTRUCTION_EXPERIMENTER = 426,
    OF_INSTRUCTION_GOTO_TABLE = 427,
    OF_INSTRUCTION_ID = 428,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 429,
    OF_INSTRUCTION_ID_BSN = 430,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 431,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 432,
    OF_INSTRUCTION_ID_BSN_DENY = 433,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 434,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 435,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 436,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 437,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 438,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 439,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 440,
    OF_INSTRUCTION_ID_BSN_PERMIT = 441,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 442,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 443,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 444,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 445,
    OF_INSTRUCTION_ID_EXPERIMENTER = 446,
    OF_INSTRUCTION_ID_GOTO_TABLE = 447,
    OF_INSTRUCTION_ID_METER = 448,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 449,
    OF_INSTRUCTION_ID_WRITE_METADATA = 450,
    OF_INSTRUCTION_METER = 451,
    OF_INSTRUCTION_WRITE_ACTIONS = 452,
    OF_INSTRUCTION_WRITE_METADATA = 453,
    OF_MATCH_V1 = 454,
    OF_MATCH_V2 = 455,
    OF_MATCH_V3 = 456,
    OF_METER_BAND = 457,
    OF_METER_BAND_DROP = 458,
    OF_METER_BAND_DSCP_REMARK = 459,
    OF_METER_BAND_EXPERIMENTER = 460,
    OF_METER_BAND_STATS = 461,
    OF_METER_CONFIG = 462,
    OF_METER_FEATURES = 463,
    OF_METER_STATS = 464,
    OF_OXM = 465,
    OF_OXM_ARP_OP = 466,
    OF_OXM_ARP_OP_MASKED = 467,
    OF_OXM_ARP_SHA = 468,
    OF_OXM_ARP_SHA_MASKED = 469,
    OF_OXM_ARP_SPA = 470,
    OF_OXM_ARP_SPA_MASKED = 471,
    OF_OXM_ARP_THA = 472,
    OF_OXM_ARP_THA_MASKED = 473,
    OF_OXM_ARP_TPA = 474,
    OF_OXM_ARP_TPA_MASKED = 475,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 476,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 477,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 478,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 479,
    OF_OXM_BSN_IN_PORTS_128 = 480,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 481,
    OF_OXM_BSN_IN_PORTS_512 = 482,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 483,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 484,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 485,
    OF_OXM_BSN_INNER_ETH_DST = 486,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 487,
    OF_OXM_BSN_INNER_ETH_SRC = 488,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 489,
    OF_OXM_BSN_INNER_VLAN_VID = 490,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 491,
    OF_OXM_BSN_L2_CACHE_HIT = 492,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 493,
    OF_OXM_BSN_L3_DST_CLASS_ID = 494,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 495,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 496,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 497,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 498,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 499,
    OF_OXM_BSN_LAG_ID = 500,
    OF_OXM_BSN_LAG_ID_MASKED = 501,
    OF_OXM_BSN_TCP_FLAGS = 502,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 503,
    OF_OXM_BSN_UDF0 = 504,
    OF_OXM_BSN_UDF0_MASKED = 505,
    OF_OXM_BSN_UDF1 = 506,
    OF_OXM_BSN_UDF1_MASKED = 507,
    OF_OXM_BSN_UDF2 = 508,
    OF_OXM_BSN_UDF2_MASKED = 509,
    OF_OXM_BSN_UDF3 = 510,
    OF_OXM_BSN_UDF3_MASKED = 511,
    OF_OXM_BSN_UDF4 = 512,
    OF_OXM_BSN_UDF4_MASKED = 513,
    OF_OXM_BSN_UDF5 = 514,
    OF_OXM_BSN_UDF5_MASKED = 515,
    OF_OXM_BSN_UDF6 = 516,
    OF_OXM_BSN_UDF6_MASKED = 517,
    OF_OXM_BSN_UDF7 = 518,
    OF_OXM_BSN_UDF7_MASKED = 519,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 520,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 521,
    OF_OXM_BSN_VRF = 522,
    OF_OXM_BSN_VRF_MASKED = 523,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 524,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 525,
    OF_OXM_ETH_DST = 526,
    OF_OXM_ETH_DST_MASKED = 527,
    OF_OXM_ETH_SRC = 528,
    OF_OXM_ETH_SRC_MASKED = 529,
    OF_OXM_ETH_TYPE = 530,
    OF_OXM_ETH_TYPE_MASKED = 531,
    OF_OXM_ICMPV4_CODE = 532,
    OF_OXM_ICMPV4_CODE_MASKED = 533,
    OF_OXM_ICMPV4_TYPE = 534,
    OF_OXM_ICMPV4_TYPE_MASKED = 535,
    OF_OXM_ICMPV6_CODE = 536,
    OF_OXM_ICMPV6_CODE_MASKED = 537,
    OF_OXM_ICMPV6_TYPE = 538,
    OF_OXM_ICMPV6_TYPE_MASKED = 539,
    OF_OXM_IN_PHY_PORT = 540,
    OF_OXM_IN_PHY_PORT_MASKED = 541,
    OF_OXM_IN_PORT = 542,
    OF_OXM_IN_PORT_MASKED = 543,
    OF_OXM_IP_DSCP = 544,
    OF_OXM_IP_DSCP_MASKED = 545,
    OF_OXM_IP_ECN = 546,
    OF_OXM_IP_ECN_MASKED = 547,
    OF_OXM_IP_PROTO = 548,
    OF_OXM_IP_PROTO_MASKED = 549,
    OF_OXM_IPV4_DST = 550,
    OF_OXM_IPV4_DST_MASKED = 551,
    OF_OXM_IPV4_SRC = 552,
    OF_OXM_IPV4_SRC_MASKED = 553,
    OF_OXM_IPV6_DST = 554,
    OF_OXM_IPV6_DST_MASKED = 555,
    OF_OXM_IPV6_EXTHDR = 556,
    OF_OXM_IPV6_EXTHDR_MASKED = 557,
    OF_OXM_IPV6_FLABEL = 558,
    OF_OXM_IPV6_FLABEL_MASKED = 559,
    OF_OXM_IPV6_ND_SLL = 560,
    OF_OXM_IPV6_ND_SLL_MASKED = 561,
    OF_OXM_IPV6_ND_TARGET = 562,
    OF_OXM_IPV6_ND_TARGET_MASKED = 563,
    OF_OXM_IPV6_ND_TLL = 564,
    OF_OXM_IPV6_ND_TLL_MASKED = 565,
    OF_OXM_IPV6_SRC = 566,
    OF_OXM_IPV6_SRC_MASKED = 567,
    OF_OXM_METADATA = 568,
    OF_OXM_METADATA_MASKED = 569,
    OF_OXM_MPLS_BOS = 570,
    OF_OXM_MPLS_BOS_MASKED = 571,
    OF_OXM_MPLS_LABEL = 572,
    OF_OXM_MPLS_LABEL_MASKED = 573,
    OF_OXM_MPLS_TC = 574,
    OF_OXM_MPLS_TC_MASKED = 575,
    OF_OXM_PBB_UCA = 576,
    OF_OXM_PBB_UCA_MASKED = 577,
    OF_OXM_SCTP_DST = 578,
    OF_OXM_SCTP_DST_MASKED = 579,
    OF_OXM_SCTP_SRC = 580,
    OF_OXM_SCTP_SRC_MASKED = 581,
    OF_OXM_TCP_DST = 582,
    OF_OXM_TCP_DST_MASKED = 583,
    OF_OXM_TCP_SRC = 584,
    OF_OXM_TCP_SRC_MASKED = 585,
    OF_OXM_TUNNEL_ID = 586,
    OF_OXM_TUNNEL_ID_MASKED = 587,
    OF_OXM_TUNNEL_IPV4_DST = 588,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 589,
    OF_OXM_TUNNEL_IPV4_SRC = 590,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 591,
    OF_OXM_UDP_DST = 592,
    OF_OXM_UDP_DST_MASKED = 593,
    OF_OXM_UDP_SRC = 594,
    OF_OXM_UDP_SRC_MASKED = 595,
    OF_OXM_VLAN_PCP = 596,
    OF_OXM_VLAN_PCP_MASKED = 597,
    OF_OXM_VLAN_VID = 598,
    OF_OXM_VLAN_VID_MASKED = 599,
    OF_PACKET_QUEUE = 600,
    OF_PORT_DESC = 601,
    OF_PORT_DESC_PROP = 602,
    OF_PORT_DESC_PROP_BSN = 603,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 604,
    OF_PORT_DESC_PROP_BSN_UPLINK = 605,
    OF_PORT_DESC_PROP_ETHERNET = 606,
    OF_PORT_DESC_PROP_EXPERIMENTER = 607,
    OF_PORT_DESC_PROP_OPTICAL = 608,
    OF_PORT_MOD_PROP = 609,
    OF_PORT_MOD_PROP_ETHERNET = 610,
    OF_PORT_MOD_PROP_EXPERIMENTER = 611,
    OF_PORT_MOD_PROP_OPTICAL = 612,
    OF_PORT_STATS_ENTRY = 613,
    OF_PORT_STATS_PROP = 614,
    OF_PORT_STATS_PROP_ETHERNET = 615,
    OF_PORT_STATS_PROP_EXPERIMENTER = 616,
    OF_PORT_STATS_PROP_OPTICAL = 617,
    OF_QUEUE_DESC = 618,
    OF_QUEUE_DESC_PROP = 619,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 620,
    OF_QUEUE_DESC_PROP_MAX_RATE = 621,
    OF_QUEUE_DESC_PROP_MIN_RATE = 622,
    OF_QUEUE_PROP = 623,
    OF_QUEUE_PROP_EXPERIMENTER = 624,
    OF_QUEUE_PROP_MAX_RATE = 625,
    OF_QUEUE_PROP_MIN_RATE = 626,
    OF_QUEUE_STATS_ENTRY = 627,
    OF_QUEUE_STATS_PROP = 628,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 629,
    OF_ROLE_PROP = 630,
    OF_ROLE_PROP_EXPERIMENTER = 631,
    OF_TABLE_DESC = 632,
    OF_TABLE_FEATURE_PROP = 633,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 634,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 635,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 636,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 637,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 638,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 639,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 640,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 641,
    OF_TABLE_FEATURE_PROP_MATCH = 642,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 643,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 644,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 645,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 646,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 647,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 648,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 649,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 650,
    OF_TABLE_FEATURES = 651,
    OF_TABLE_MOD_PROP = 652,
    OF_TABLE_MOD_PROP_EVICTION = 653,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 654,
    OF_TABLE_MOD_PROP_VACANCY = 655,
    OF_TABLE_STATS_ENTRY = 656,
    OF_UINT32 = 657,
    OF_UINT64 = 658,
    OF_UINT8 = 659,
    ...
    /* List objects */
    OF_LIST_ACTION = 660,
    OF_LIST_ACTION_ID = 661,
    OF_LIST_ASYNC_CONFIG_PROP = 662,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 663,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 664,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 665,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 666,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 667,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 668,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 669,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 670,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 671,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 672,
    OF_LIST_BSN_INTERFACE = 673,
    OF_LIST_BSN_LACP_STATS_ENTRY = 674,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 675,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 676,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 677,
    OF_LIST_BSN_TLV = 678,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 679,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 680,
    OF_LIST_BUCKET = 681,
    OF_LIST_BUCKET_COUNTER = 682,
    OF_LIST_BUNDLE_PROP = 683,
    OF_LIST_FLOW_STATS_ENTRY = 684,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 685,
    OF_LIST_GROUP_STATS_ENTRY = 686,
    OF_LIST_HELLO_ELEM = 687,
    OF_LIST_INSTRUCTION = 688,
    OF_LIST_INSTRUCTION_ID = 689,
    OF_LIST_METER_BAND = 690,
    OF_LIST_METER_BAND_STATS = 691,
    OF_LIST_METER_CONFIG = 692,
    OF_LIST_METER_STATS = 693,
    OF_LIST_OXM = 694,
    OF_LIST_PACKET_QUEUE = 695,
    OF_LIST_PORT_DESC = 696,
    OF_LIST_PORT_DESC_PROP = 697,
    OF_LIST_PORT_MOD_PROP = 698,
    OF_LIST_PORT_STATS_ENTRY = 699,
    OF_LIST_PORT_STATS_PROP = 700,
    OF_LIST_QUEUE_DESC = 701,
    OF_LIST_QUEUE_DESC_PROP = 702,
    OF_LIST_QUEUE_PROP = 703,
    OF_LIST_QUEUE_STATS_ENTRY = 704,
    OF_LIST_QUEUE_STATS_PROP = 705,
    OF_LIST_ROLE_PROP = 706,
    OF_LIST_TABLE_DESC = 707,
    OF_LIST_TABLE_FEATURE_PROP = 708,
    OF_LIST_TABLE_FEATURES = 709,
    OF_LIST_TABLE_MOD_PROP = 710,
    OF_LIST_TABLE_STATS_ENTRY = 711,
    OF_LIST_UINT32 = 712,
    OF_LIST_UINT64 = 713,
    OF_LIST_UINT8 = 714,
