...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_STATUS = 452,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 453,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 454,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 455,
    OF_BSN_TLV_SUB_AGENT_ID = 456,
    OF_BSN_TLV_TCP_DST = 457,
    OF_BSN_TLV_TCP_FLAGS = 458,
    OF_BSN_TLV_TCP_SRC = 459,
    OF_BSN_TLV_TIMESTAMP = 460,
    OF_BSN_TLV_TTL = 461,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 462,
    OF_BSN_TLV_TX_BYTES = 463,
    OF_BSN_TLV_TX_PACKETS = 464,
    OF_BSN_TLV_UDF_ANCHOR = 465,
    OF_BSN_TLV_UDF_CAPABILITY = 466,
    OF_BSN_TLV_UDF_ID = 467,
    OF_BSN_TLV_UDF_LENGTH = 468,
    OF_BSN_TLV_UDF_OFFSET = 469,
    OF_BSN_TLV_UDP_DST = 470,
    OF_BSN_TLV_UDP_SRC = 471,
    OF_BSN_TLV_UINT32 = 472,
    OF_BSN_TLV_UINT64_LIST = 473,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 474,
    OF_BSN_TLV_UNICAST_RATE = 475,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 476,
    OF_BSN_TLV_UNTAGGED = 477,
    OF_BSN_TLV_UPGRADE = 478,
    OF_BSN_TLV_URI_SCHEME = 479,
    OF_BSN_TLV_USE_PACKET_STATE = 480,
    OF_BSN_TLV_USER_CONFIGURED = 481,
    OF_BSN_TLV_VFI = 482,
    OF_BSN_TLV_VFP_CLASS_ID = 483,
    OF_BSN_TLV_VIRTUAL = 484,
    OF_BSN_TLV_VLAN_MAC_LIST = 485,
    OF_BSN_TLV_VLAN_PCP = 486,
    OF_BSN_TLV_VLAN_VID = 487,
    OF_BSN_TLV_VLAN_VID_MASK = 488,
    OF_BSN_TLV_VNI = 489,
    OF_BSN_TLV_VPN_KEY = 490,
    OF_BSN_TLV_VRF = 491,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 492,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 493,
    OF_BSN_VLAN_MAC = 494,
    OF_BSN_VPORT = 495,
    OF_BSN_VPORT_L2GRE = 496,
    OF_BSN_VPORT_Q_IN_Q = 497,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 498,
    OF_BUCKET = 499,
    OF_BUCKET_COUNTER = 500,
    OF_BUNDLE_PROP = 501,
    OF_BUNDLE_PROP_EXPERIMENTER = 502,
    OF_FLOW_STATS_ENTRY = 503,
    OF_GROUP_DESC_STATS_ENTRY = 504,
    OF_GROUP_STATS_ENTRY = 505,
    OF_HELLO_ELEM = 506,
    OF_HELLO_ELEM_VERSIONBITMAP = 507,
    OF_INSTRUCTION = 508,
    OF_INSTRUCTION_APPLY_ACTIONS = 509,
    OF_INSTRUCTION_BSN = 510,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 511,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 512,
    OF_INSTRUCTION_BSN_DENY = 513,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 514,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 515,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 516,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 517,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 518,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 519,
    OF_INSTRUCTION_BSN_HASH_SELECT = 520,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 521,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 522,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 523,
    OF_INSTRUCTION_BSN_PERMIT = 524,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 525,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 526,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 527,
    OF_INSTRUCTION_CLEAR_ACTIONS = 528,
    OF_INSTRUCTION_EXPERIMENTER = 529,
    OF_INSTRUCTION_GOTO_TABLE = 530,
    OF_INSTRUCTION_ID = 531,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 532,
    OF_INSTRUCTION_ID_BSN = 533,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 534,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 535,
    OF_INSTRUCTION_ID_BSN_DENY = 536,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 537,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 538,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 539,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 540,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 541,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 542,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 543,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 544,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 545,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 546,
    OF_INSTRUCTION_ID_BSN_PERMIT = 547,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 548,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 549,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 550,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 551,
    OF_INSTRUCTION_ID_EXPERIMENTER = 552,
    OF_INSTRUCTION_ID_GOTO_TABLE = 553,
    OF_INSTRUCTION_ID_METER = 554,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 555,
    OF_INSTRUCTION_ID_WRITE_METADATA = 556,
    OF_INSTRUCTION_METER = 557,
    OF_INSTRUCTION_WRITE_ACTIONS = 558,
    OF_INSTRUCTION_WRITE_METADATA = 559,
    OF_MATCH_V1 = 560,
    OF_MATCH_V2 = 561,
    OF_MATCH_V3 = 562,
    OF_METER_BAND = 563,
    OF_METER_BAND_DROP = 564,
    OF_METER_BAND_DSCP_REMARK = 565,
    OF_METER_BAND_EXPERIMENTER = 566,
    OF_METER_BAND_STATS = 567,
    OF_METER_CONFIG = 568,
    OF_METER_FEATURES = 569,
    OF_METER_STATS = 570,
    OF_OXM = 571,
    OF_OXM_ARP_OP = 572,
    OF_OXM_ARP_OP_MASKED = 573,
    OF_OXM_ARP_SHA = 574,
    OF_OXM_ARP_SHA_MASKED = 575,
    OF_OXM_ARP_SPA = 576,
    OF_OXM_ARP_SPA_MASKED = 577,
    OF_OXM_ARP_THA = 578,
    OF_OXM_ARP_THA_MASKED = 579,
    OF_OXM_ARP_TPA = 580,
    OF_OXM_ARP_TPA_MASKED = 581,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 582,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 583,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 584,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 585,
    OF_OXM_BSN_IFP_CLASS_ID = 586,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 587,
    OF_OXM_BSN_IN_PORTS_128 = 588,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 589,
    OF_OXM_BSN_IN_PORTS_512 = 590,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 591,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 592,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 593,
    OF_OXM_BSN_INNER_ETH_DST = 594,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 595,
    OF_OXM_BSN_INNER_ETH_SRC = 596,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 597,
    OF_OXM_BSN_INNER_VLAN_VID = 598,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 599,
    OF_OXM_BSN_IP_FRAGMENTATION = 600,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 601,
    OF_OXM_BSN_L2_CACHE_HIT = 602,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 603,
    OF_OXM_BSN_L3_DST_CLASS_ID = 604,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 605,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 606,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 607,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 608,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 609,
    OF_OXM_BSN_LAG_ID = 610,
    OF_OXM_BSN_LAG_ID_MASKED = 611,
    OF_OXM_BSN_TCP_FLAGS = 612,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 613,
    OF_OXM_BSN_UDF0 = 614,
    OF_OXM_BSN_UDF0_MASKED = 615,
    OF_OXM_BSN_UDF1 = 616,
    OF_OXM_BSN_UDF1_MASKED = 617,
    OF_OXM_BSN_UDF2 = 618,
    OF_OXM_BSN_UDF2_MASKED = 619,
    OF_OXM_BSN_UDF3 = 620,
    OF_OXM_BSN_UDF3_MASKED = 621,
    OF_OXM_BSN_UDF4 = 622,
    OF_OXM_BSN_UDF4_MASKED = 623,
    OF_OXM_BSN_UDF5 = 624,
    OF_OXM_BSN_UDF5_MASKED = 625,
    OF_OXM_BSN_UDF6 = 626,
    OF_OXM_BSN_UDF6_MASKED = 627,
    OF_OXM_BSN_UDF7 = 628,
    OF_OXM_BSN_UDF7_MASKED = 629,
    OF_OXM_BSN_VFI = 630,
    OF_OXM_BSN_VFI_MASKED = 631,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 632,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 633,
    OF_OXM_BSN_VRF = 634,
    OF_OXM_BSN_VRF_MASKED = 635,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 636,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 637,
    OF_OXM_CONN_TRACKING_IPV6_DST = 638,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 639,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 640,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 641,
    OF_OXM_CONN_TRACKING_LABEL = 642,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 643,
    OF_OXM_CONN_TRACKING_MARK = 644,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 645,
    OF_OXM_CONN_TRACKING_NW_DST = 646,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 647,
    OF_OXM_CONN_TRACKING_NW_PROTO = 648,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 649,
    OF_OXM_CONN_TRACKING_NW_SRC = 650,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 651,
    OF_OXM_CONN_TRACKING_STATE = 652,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 653,
    OF_OXM_CONN_TRACKING_TP_DST = 654,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 655,
    OF_OXM_CONN_TRACKING_TP_SRC = 656,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 657,
    OF_OXM_CONN_TRACKING_ZONE = 658,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 659,
    OF_OXM_ETH_DST = 660,
    OF_OXM_ETH_DST_MASKED = 661,
    OF_OXM_ETH_SRC = 662,
    OF_OXM_ETH_SRC_MASKED = 663,
    OF_OXM_ETH_TYPE = 664,
    OF_OXM_ETH_TYPE_MASKED = 665,
    OF_OXM_ICMPV4_CODE = 666,
    OF_OXM_ICMPV4_CODE_MASKED = 667,
    OF_OXM_ICMPV4_TYPE = 668,
    OF_OXM_ICMPV4_TYPE_MASKED = 669,
    OF_OXM_ICMPV6_CODE = 670,
    OF_OXM_ICMPV6_CODE_MASKED = 671,
    OF_OXM_ICMPV6_TYPE = 672,
    OF_OXM_ICMPV6_TYPE_MASKED = 673,
    OF_OXM_IN_PHY_PORT = 674,
    OF_OXM_IN_PHY_PORT_MASKED = 675,
    OF_OXM_IN_PORT = 676,
    OF_OXM_IN_PORT_MASKED = 677,
    OF_OXM_IP_DSCP = 678,
    OF_OXM_IP_DSCP_MASKED = 679,
    OF_OXM_IP_ECN = 680,
    OF_OXM_IP_ECN_MASKED = 681,
    OF_OXM_IP_PROTO = 682,
    OF_OXM_IP_PROTO_MASKED = 683,
    OF_OXM_IPV4_DST = 684,
    OF_OXM_IPV4_DST_MASKED = 685,
    OF_OXM_IPV4_SRC = 686,
    OF_OXM_IPV4_SRC_MASKED = 687,
    OF_OXM_IPV6_DST = 688,
    OF_OXM_IPV6_DST_MASKED = 689,
    OF_OXM_IPV6_EXTHDR = 690,
    OF_OXM_IPV6_EXTHDR_MASKED = 691,
    OF_OXM_IPV6_FLABEL = 692,
    OF_OXM_IPV6_FLABEL_MASKED = 693,
    OF_OXM_IPV6_ND_SLL = 694,
    OF_OXM_IPV6_ND_SLL_MASKED = 695,
    OF_OXM_IPV6_ND_TARGET = 696,
    OF_OXM_IPV6_ND_TARGET_MASKED = 697,
    OF_OXM_IPV6_ND_TLL = 698,
    OF_OXM_IPV6_ND_TLL_MASKED = 699,
    OF_OXM_IPV6_SRC = 700,
    OF_OXM_IPV6_SRC_MASKED = 701,
    OF_OXM_METADATA = 702,
    OF_OXM_METADATA_MASKED = 703,
    OF_OXM_MPLS_BOS = 704,
    OF_OXM_MPLS_BOS_MASKED = 705,
    OF_OXM_MPLS_LABEL = 706,
    OF_OXM_MPLS_LABEL_MASKED = 707,
    OF_OXM_MPLS_TC = 708,
    OF_OXM_MPLS_TC_MASKED = 709,
    OF_OXM_OVS_TCP_FLAGS = 710,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 711,
    OF_OXM_PBB_UCA = 712,
    OF_OXM_PBB_UCA_MASKED = 713,
    OF_OXM_SCTP_DST = 714,
    OF_OXM_SCTP_DST_MASKED = 715,
    OF_OXM_SCTP_SRC = 716,
    OF_OXM_SCTP_SRC_MASKED = 717,
    OF_OXM_TCP_DST = 718,
    OF_OXM_TCP_DST_MASKED = 719,
    OF_OXM_TCP_SRC = 720,
    OF_OXM_TCP_SRC_MASKED = 721,
    OF_OXM_TUNNEL_ID = 722,
    OF_OXM_TUNNEL_ID_MASKED = 723,
    OF_OXM_TUNNEL_IPV4_DST = 724,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 725,
    OF_OXM_TUNNEL_IPV4_SRC = 726,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 727,
    OF_OXM_UDP_DST = 728,
    OF_OXM_UDP_DST_MASKED = 729,
    OF_OXM_UDP_SRC = 730,
    OF_OXM_UDP_SRC_MASKED = 731,
    OF_OXM_VLAN_PCP = 732,
    OF_OXM_VLAN_PCP_MASKED = 733,
    OF_OXM_VLAN_VID = 734,
    OF_OXM_VLAN_VID_MASKED = 735,
    OF_PACKET_QUEUE = 736,
    OF_PORT_DESC = 737,
    OF_PORT_DESC_PROP = 738,
    OF_PORT_DESC_PROP_BSN = 739,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 740,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 741,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 742,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 743,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 744,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 745,
    ...
    /* List objects */
    OF_LIST_ACTION = 805,
    OF_LIST_ACTION_ID = 806,
    OF_LIST_ASYNC_CONFIG_PROP = 807,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 808,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 809,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 810,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 811,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 812,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 813,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 814,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 815,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 816,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 817,
    OF_LIST_BSN_INTERFACE = 818,
    OF_LIST_BSN_LACP_STATS_ENTRY = 819,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 820,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 821,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 822,
    OF_LIST_BSN_TLV = 823,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 824,
    OF_LIST_BSN_VLAN_MAC = 825,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 826,
    OF_LIST_BUCKET = 827,
    OF_LIST_BUCKET_COUNTER = 828,
    OF_LIST_BUNDLE_PROP = 829,
    OF_LIST_FLOW_STATS_ENTRY = 830,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 831,
    OF_LIST_GROUP_STATS_ENTRY = 832,
    OF_LIST_HELLO_ELEM = 833,
    OF_LIST_INSTRUCTION = 834,
    OF_LIST_INSTRUCTION_ID = 835,
    OF_LIST_METER_BAND = 836,
    OF_LIST_METER_BAND_STATS = 837,
    OF_LIST_METER_CONFIG = 838,
    OF_LIST_METER_STATS = 839,
    OF_LIST_OXM = 840,
    OF_LIST_PACKET_QUEUE = 841,
    OF_LIST_PORT_DESC = 842,
    OF_LIST_PORT_DESC_PROP = 843,
    OF_LIST_PORT_MOD_PROP = 844,
    OF_LIST_PORT_STATS_ENTRY = 845,
    OF_LIST_PORT_STATS_PROP = 846,
    OF_LIST_QUEUE_DESC = 847,
    OF_LIST_QUEUE_DESC_PROP = 848,
    OF_LIST_QUEUE_PROP = 849,
    OF_LIST_QUEUE_STATS_ENTRY = 850,
    OF_LIST_QUEUE_STATS_PROP = 851,
    OF_LIST_ROLE_PROP = 852,
    OF_LIST_TABLE_DESC = 853,
    OF_LIST_TABLE_FEATURE_PROP = 854,
    OF_LIST_TABLE_FEATURES = 855,
    OF_LIST_TABLE_MOD_PROP = 856,
    OF_LIST_TABLE_STATS_ENTRY = 857,
    OF_LIST_UINT32 = 858,
    OF_LIST_UINT64 = 859,
    OF_LIST_UINT8 = 860,
