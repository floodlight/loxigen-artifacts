...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PORT = 265,
    OF_BSN_TLV_REPLY_PACKETS = 266,
    OF_BSN_TLV_REQUEST_PACKETS = 267,
    OF_BSN_TLV_RX_PACKETS = 268,
    OF_BSN_TLV_TX_PACKETS = 269,
    OF_BSN_TLV_UDF_ANCHOR = 270,
    OF_BSN_TLV_UDF_ID = 271,
    OF_BSN_TLV_UDF_LENGTH = 272,
    OF_BSN_TLV_UDF_OFFSET = 273,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 274,
    OF_BSN_TLV_VLAN_VID = 275,
    OF_BSN_TLV_VRF = 276,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 277,
    OF_BSN_VPORT = 278,
    OF_BSN_VPORT_HEADER = 279,
    OF_BSN_VPORT_L2GRE = 280,
    OF_BSN_VPORT_Q_IN_Q = 281,
    OF_BUCKET = 282,
    OF_BUCKET_COUNTER = 283,
    OF_FLOW_STATS_ENTRY = 284,
    OF_GROUP_DESC_STATS_ENTRY = 285,
    OF_GROUP_STATS_ENTRY = 286,
    OF_HELLO_ELEM = 287,
    OF_HELLO_ELEM_HEADER = 288,
    OF_HELLO_ELEM_VERSIONBITMAP = 289,
    OF_INSTRUCTION = 290,
    OF_INSTRUCTION_APPLY_ACTIONS = 291,
    OF_INSTRUCTION_BSN = 292,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 293,
    OF_INSTRUCTION_BSN_DENY = 294,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 295,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 296,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 297,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 298,
    OF_INSTRUCTION_BSN_PERMIT = 299,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 300,
    OF_INSTRUCTION_CLEAR_ACTIONS = 301,
    OF_INSTRUCTION_EXPERIMENTER = 302,
    OF_INSTRUCTION_GOTO_TABLE = 303,
    OF_INSTRUCTION_HEADER = 304,
    OF_INSTRUCTION_ID = 305,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 306,
    OF_INSTRUCTION_ID_BSN = 307,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 308,
    OF_INSTRUCTION_ID_BSN_DENY = 309,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 310,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 311,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 312,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 313,
    OF_INSTRUCTION_ID_BSN_PERMIT = 314,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 315,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 316,
    OF_INSTRUCTION_ID_EXPERIMENTER = 317,
    OF_INSTRUCTION_ID_GOTO_TABLE = 318,
    OF_INSTRUCTION_ID_HEADER = 319,
    OF_INSTRUCTION_ID_METER = 320,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 321,
    OF_INSTRUCTION_ID_WRITE_METADATA = 322,
    OF_INSTRUCTION_METER = 323,
    OF_INSTRUCTION_WRITE_ACTIONS = 324,
    OF_INSTRUCTION_WRITE_METADATA = 325,
    OF_MATCH_V1 = 326,
    OF_MATCH_V2 = 327,
    OF_MATCH_V3 = 328,
    OF_METER_BAND = 329,
    OF_METER_BAND_DROP = 330,
    OF_METER_BAND_DSCP_REMARK = 331,
    OF_METER_BAND_EXPERIMENTER = 332,
    OF_METER_BAND_HEADER = 333,
    OF_METER_BAND_STATS = 334,
    OF_METER_CONFIG = 335,
    OF_METER_FEATURES = 336,
    OF_METER_STATS = 337,
    OF_OXM = 338,
    OF_OXM_ARP_OP = 339,
    OF_OXM_ARP_OP_MASKED = 340,
    OF_OXM_ARP_SHA = 341,
    OF_OXM_ARP_SHA_MASKED = 342,
    OF_OXM_ARP_SPA = 343,
    OF_OXM_ARP_SPA_MASKED = 344,
    OF_OXM_ARP_THA = 345,
    OF_OXM_ARP_THA_MASKED = 346,
    OF_OXM_ARP_TPA = 347,
    OF_OXM_ARP_TPA_MASKED = 348,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 349,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 350,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 351,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 352,
    OF_OXM_BSN_IN_PORTS_128 = 353,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 354,
    OF_OXM_BSN_L3_DST_CLASS_ID = 355,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 356,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 357,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 358,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 359,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 360,
    OF_OXM_BSN_LAG_ID = 361,
    OF_OXM_BSN_LAG_ID_MASKED = 362,
    OF_OXM_BSN_UDF0 = 363,
    OF_OXM_BSN_UDF0_MASKED = 364,
    OF_OXM_BSN_UDF1 = 365,
    OF_OXM_BSN_UDF1_MASKED = 366,
    OF_OXM_BSN_UDF2 = 367,
    OF_OXM_BSN_UDF2_MASKED = 368,
    OF_OXM_BSN_UDF3 = 369,
    OF_OXM_BSN_UDF3_MASKED = 370,
    OF_OXM_BSN_UDF4 = 371,
    OF_OXM_BSN_UDF4_MASKED = 372,
    OF_OXM_BSN_UDF5 = 373,
    OF_OXM_BSN_UDF5_MASKED = 374,
    OF_OXM_BSN_UDF6 = 375,
    OF_OXM_BSN_UDF6_MASKED = 376,
    OF_OXM_BSN_UDF7 = 377,
    OF_OXM_BSN_UDF7_MASKED = 378,
    OF_OXM_BSN_VRF = 379,
    OF_OXM_BSN_VRF_MASKED = 380,
    OF_OXM_ETH_DST = 381,
    OF_OXM_ETH_DST_MASKED = 382,
    OF_OXM_ETH_SRC = 383,
    OF_OXM_ETH_SRC_MASKED = 384,
    OF_OXM_ETH_TYPE = 385,
    OF_OXM_ETH_TYPE_MASKED = 386,
    OF_OXM_HEADER = 387,
    OF_OXM_ICMPV4_CODE = 388,
    OF_OXM_ICMPV4_CODE_MASKED = 389,
    OF_OXM_ICMPV4_TYPE = 390,
    OF_OXM_ICMPV4_TYPE_MASKED = 391,
    OF_OXM_ICMPV6_CODE = 392,
    OF_OXM_ICMPV6_CODE_MASKED = 393,
    OF_OXM_ICMPV6_TYPE = 394,
    OF_OXM_ICMPV6_TYPE_MASKED = 395,
    OF_OXM_IN_PHY_PORT = 396,
    OF_OXM_IN_PHY_PORT_MASKED = 397,
    OF_OXM_IN_PORT = 398,
    OF_OXM_IN_PORT_MASKED = 399,
    OF_OXM_IP_DSCP = 400,
    OF_OXM_IP_DSCP_MASKED = 401,
    OF_OXM_IP_ECN = 402,
    OF_OXM_IP_ECN_MASKED = 403,
    OF_OXM_IP_PROTO = 404,
    OF_OXM_IP_PROTO_MASKED = 405,
    OF_OXM_IPV4_DST = 406,
    OF_OXM_IPV4_DST_MASKED = 407,
    OF_OXM_IPV4_SRC = 408,
    OF_OXM_IPV4_SRC_MASKED = 409,
    OF_OXM_IPV6_DST = 410,
    OF_OXM_IPV6_DST_MASKED = 411,
    OF_OXM_IPV6_FLABEL = 412,
    OF_OXM_IPV6_FLABEL_MASKED = 413,
    OF_OXM_IPV6_ND_SLL = 414,
    OF_OXM_IPV6_ND_SLL_MASKED = 415,
    OF_OXM_IPV6_ND_TARGET = 416,
    OF_OXM_IPV6_ND_TARGET_MASKED = 417,
    OF_OXM_IPV6_ND_TLL = 418,
    OF_OXM_IPV6_ND_TLL_MASKED = 419,
    OF_OXM_IPV6_SRC = 420,
    OF_OXM_IPV6_SRC_MASKED = 421,
    OF_OXM_METADATA = 422,
    OF_OXM_METADATA_MASKED = 423,
    OF_OXM_MPLS_LABEL = 424,
    OF_OXM_MPLS_LABEL_MASKED = 425,
    OF_OXM_MPLS_TC = 426,
    OF_OXM_MPLS_TC_MASKED = 427,
    OF_OXM_SCTP_DST = 428,
    OF_OXM_SCTP_DST_MASKED = 429,
    OF_OXM_SCTP_SRC = 430,
    OF_OXM_SCTP_SRC_MASKED = 431,
    OF_OXM_TCP_DST = 432,
    OF_OXM_TCP_DST_MASKED = 433,
    OF_OXM_TCP_SRC = 434,
    OF_OXM_TCP_SRC_MASKED = 435,
    OF_OXM_UDP_DST = 436,
    OF_OXM_UDP_DST_MASKED = 437,
    OF_OXM_UDP_SRC = 438,
    OF_OXM_UDP_SRC_MASKED = 439,
    OF_OXM_VLAN_PCP = 440,
    OF_OXM_VLAN_PCP_MASKED = 441,
    OF_OXM_VLAN_VID = 442,
    OF_OXM_VLAN_VID_MASKED = 443,
    OF_PACKET_QUEUE = 444,
    OF_PORT_DESC = 445,
    OF_PORT_STATS_ENTRY = 446,
    OF_QUEUE_PROP = 447,
    OF_QUEUE_PROP_EXPERIMENTER = 448,
    OF_QUEUE_PROP_HEADER = 449,
    OF_QUEUE_PROP_MAX_RATE = 450,
    OF_QUEUE_PROP_MIN_RATE = 451,
    OF_QUEUE_STATS_ENTRY = 452,
    OF_TABLE_FEATURE_PROP = 453,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 454,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 455,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 456,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 457,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 458,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 459,
    OF_TABLE_FEATURE_PROP_HEADER = 460,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 461,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 462,
    OF_TABLE_FEATURE_PROP_MATCH = 463,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 464,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 465,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 466,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 467,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 468,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 469,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 470,
    OF_TABLE_FEATURES = 471,
    OF_TABLE_STATS_ENTRY = 472,
    OF_UINT32 = 473,
    OF_UINT64 = 474,
    OF_UINT8 = 475,
    ...
    /* List objects */
    OF_LIST_ACTION = 476,
    OF_LIST_ACTION_ID = 477,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 478,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 479,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 480,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 481,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 482,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 483,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 484,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 485,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 486,
    OF_LIST_BSN_INTERFACE = 487,
    OF_LIST_BSN_LACP_STATS_ENTRY = 488,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 489,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 490,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 491,
    OF_LIST_BSN_TLV = 492,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 493,
    OF_LIST_BUCKET = 494,
    OF_LIST_BUCKET_COUNTER = 495,
    OF_LIST_FLOW_STATS_ENTRY = 496,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 497,
    OF_LIST_GROUP_STATS_ENTRY = 498,
    OF_LIST_HELLO_ELEM = 499,
    OF_LIST_INSTRUCTION = 500,
    OF_LIST_INSTRUCTION_ID = 501,
    OF_LIST_METER_BAND = 502,
    OF_LIST_METER_BAND_STATS = 503,
    OF_LIST_METER_STATS = 504,
    OF_LIST_OXM = 505,
    OF_LIST_PACKET_QUEUE = 506,
    OF_LIST_PORT_DESC = 507,
    OF_LIST_PORT_STATS_ENTRY = 508,
    OF_LIST_QUEUE_PROP = 509,
    OF_LIST_QUEUE_STATS_ENTRY = 510,
    OF_LIST_TABLE_FEATURE_PROP = 511,
    OF_LIST_TABLE_FEATURES = 512,
    OF_LIST_TABLE_STATS_ENTRY = 513,
    OF_LIST_UINT32 = 514,
    OF_LIST_UINT64 = 515,
    OF_LIST_UINT8 = 516,
