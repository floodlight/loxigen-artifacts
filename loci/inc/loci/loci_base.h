...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_VFI = 445,
    OF_BSN_TLV_VFP_CLASS_ID = 446,
    OF_BSN_TLV_VLAN_MAC_LIST = 447,
    OF_BSN_TLV_VLAN_PCP = 448,
    OF_BSN_TLV_VLAN_VID = 449,
    OF_BSN_TLV_VLAN_VID_MASK = 450,
    OF_BSN_TLV_VNI = 451,
    OF_BSN_TLV_VPN_KEY = 452,
    OF_BSN_TLV_VRF = 453,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 454,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 455,
    OF_BSN_VLAN_MAC = 456,
    OF_BSN_VPORT = 457,
    OF_BSN_VPORT_L2GRE = 458,
    OF_BSN_VPORT_Q_IN_Q = 459,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 460,
    OF_BUCKET = 461,
    OF_BUCKET_COUNTER = 462,
    OF_BUNDLE_PROP = 463,
    OF_BUNDLE_PROP_EXPERIMENTER = 464,
    OF_FLOW_STATS_ENTRY = 465,
    OF_GROUP_DESC_STATS_ENTRY = 466,
    OF_GROUP_STATS_ENTRY = 467,
    OF_HELLO_ELEM = 468,
    OF_HELLO_ELEM_VERSIONBITMAP = 469,
    OF_INSTRUCTION = 470,
    OF_INSTRUCTION_APPLY_ACTIONS = 471,
    OF_INSTRUCTION_BSN = 472,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 473,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 474,
    OF_INSTRUCTION_BSN_DENY = 475,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 476,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 477,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 478,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 479,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 480,
    OF_INSTRUCTION_BSN_HASH_SELECT = 481,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 482,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 483,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 484,
    OF_INSTRUCTION_BSN_PERMIT = 485,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 486,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 487,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 488,
    OF_INSTRUCTION_CLEAR_ACTIONS = 489,
    OF_INSTRUCTION_EXPERIMENTER = 490,
    OF_INSTRUCTION_GOTO_TABLE = 491,
    OF_INSTRUCTION_ID = 492,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 493,
    OF_INSTRUCTION_ID_BSN = 494,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 495,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 496,
    OF_INSTRUCTION_ID_BSN_DENY = 497,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 498,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 499,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 500,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 501,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 502,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 503,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 504,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 505,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 506,
    OF_INSTRUCTION_ID_BSN_PERMIT = 507,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 508,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 509,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 510,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 511,
    OF_INSTRUCTION_ID_EXPERIMENTER = 512,
    OF_INSTRUCTION_ID_GOTO_TABLE = 513,
    OF_INSTRUCTION_ID_METER = 514,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 515,
    OF_INSTRUCTION_ID_WRITE_METADATA = 516,
    OF_INSTRUCTION_METER = 517,
    OF_INSTRUCTION_WRITE_ACTIONS = 518,
    OF_INSTRUCTION_WRITE_METADATA = 519,
    OF_MATCH_V1 = 520,
    OF_MATCH_V2 = 521,
    OF_MATCH_V3 = 522,
    OF_METER_BAND = 523,
    OF_METER_BAND_DROP = 524,
    OF_METER_BAND_DSCP_REMARK = 525,
    OF_METER_BAND_EXPERIMENTER = 526,
    OF_METER_BAND_STATS = 527,
    OF_METER_CONFIG = 528,
    OF_METER_FEATURES = 529,
    OF_METER_STATS = 530,
    OF_OXM = 531,
    OF_OXM_ARP_OP = 532,
    OF_OXM_ARP_OP_MASKED = 533,
    OF_OXM_ARP_SHA = 534,
    OF_OXM_ARP_SHA_MASKED = 535,
    OF_OXM_ARP_SPA = 536,
    OF_OXM_ARP_SPA_MASKED = 537,
    OF_OXM_ARP_THA = 538,
    OF_OXM_ARP_THA_MASKED = 539,
    OF_OXM_ARP_TPA = 540,
    OF_OXM_ARP_TPA_MASKED = 541,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 542,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 543,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 544,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 545,
    OF_OXM_BSN_IN_PORTS_128 = 546,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 547,
    OF_OXM_BSN_IN_PORTS_512 = 548,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 549,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 550,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 551,
    OF_OXM_BSN_INNER_ETH_DST = 552,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 553,
    OF_OXM_BSN_INNER_ETH_SRC = 554,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 555,
    OF_OXM_BSN_INNER_VLAN_VID = 556,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 557,
    OF_OXM_BSN_IP_FRAGMENTATION = 558,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 559,
    OF_OXM_BSN_L2_CACHE_HIT = 560,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 561,
    OF_OXM_BSN_L3_DST_CLASS_ID = 562,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 563,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 564,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 565,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 566,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 567,
    OF_OXM_BSN_LAG_ID = 568,
    OF_OXM_BSN_LAG_ID_MASKED = 569,
    OF_OXM_BSN_TCP_FLAGS = 570,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 571,
    OF_OXM_BSN_UDF0 = 572,
    OF_OXM_BSN_UDF0_MASKED = 573,
    OF_OXM_BSN_UDF1 = 574,
    OF_OXM_BSN_UDF1_MASKED = 575,
    OF_OXM_BSN_UDF2 = 576,
    OF_OXM_BSN_UDF2_MASKED = 577,
    OF_OXM_BSN_UDF3 = 578,
    OF_OXM_BSN_UDF3_MASKED = 579,
    OF_OXM_BSN_UDF4 = 580,
    OF_OXM_BSN_UDF4_MASKED = 581,
    OF_OXM_BSN_UDF5 = 582,
    OF_OXM_BSN_UDF5_MASKED = 583,
    OF_OXM_BSN_UDF6 = 584,
    OF_OXM_BSN_UDF6_MASKED = 585,
    OF_OXM_BSN_UDF7 = 586,
    OF_OXM_BSN_UDF7_MASKED = 587,
    OF_OXM_BSN_VFI = 588,
    OF_OXM_BSN_VFI_MASKED = 589,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 590,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 591,
    OF_OXM_BSN_VRF = 592,
    OF_OXM_BSN_VRF_MASKED = 593,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 594,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 595,
    OF_OXM_ETH_DST = 596,
    OF_OXM_ETH_DST_MASKED = 597,
    OF_OXM_ETH_SRC = 598,
    OF_OXM_ETH_SRC_MASKED = 599,
    OF_OXM_ETH_TYPE = 600,
    OF_OXM_ETH_TYPE_MASKED = 601,
    OF_OXM_ICMPV4_CODE = 602,
    OF_OXM_ICMPV4_CODE_MASKED = 603,
    OF_OXM_ICMPV4_TYPE = 604,
    OF_OXM_ICMPV4_TYPE_MASKED = 605,
    OF_OXM_ICMPV6_CODE = 606,
    OF_OXM_ICMPV6_CODE_MASKED = 607,
    OF_OXM_ICMPV6_TYPE = 608,
    OF_OXM_ICMPV6_TYPE_MASKED = 609,
    OF_OXM_IN_PHY_PORT = 610,
    OF_OXM_IN_PHY_PORT_MASKED = 611,
    OF_OXM_IN_PORT = 612,
    OF_OXM_IN_PORT_MASKED = 613,
    OF_OXM_IP_DSCP = 614,
    OF_OXM_IP_DSCP_MASKED = 615,
    OF_OXM_IP_ECN = 616,
    OF_OXM_IP_ECN_MASKED = 617,
    OF_OXM_IP_PROTO = 618,
    OF_OXM_IP_PROTO_MASKED = 619,
    OF_OXM_IPV4_DST = 620,
    OF_OXM_IPV4_DST_MASKED = 621,
    OF_OXM_IPV4_SRC = 622,
    OF_OXM_IPV4_SRC_MASKED = 623,
    OF_OXM_IPV6_DST = 624,
    OF_OXM_IPV6_DST_MASKED = 625,
    OF_OXM_IPV6_EXTHDR = 626,
    OF_OXM_IPV6_EXTHDR_MASKED = 627,
    OF_OXM_IPV6_FLABEL = 628,
    OF_OXM_IPV6_FLABEL_MASKED = 629,
    OF_OXM_IPV6_ND_SLL = 630,
    OF_OXM_IPV6_ND_SLL_MASKED = 631,
    OF_OXM_IPV6_ND_TARGET = 632,
    OF_OXM_IPV6_ND_TARGET_MASKED = 633,
    OF_OXM_IPV6_ND_TLL = 634,
    OF_OXM_IPV6_ND_TLL_MASKED = 635,
    OF_OXM_IPV6_SRC = 636,
    OF_OXM_IPV6_SRC_MASKED = 637,
    OF_OXM_METADATA = 638,
    OF_OXM_METADATA_MASKED = 639,
    OF_OXM_MPLS_BOS = 640,
    OF_OXM_MPLS_BOS_MASKED = 641,
    OF_OXM_MPLS_LABEL = 642,
    OF_OXM_MPLS_LABEL_MASKED = 643,
    OF_OXM_MPLS_TC = 644,
    OF_OXM_MPLS_TC_MASKED = 645,
    OF_OXM_OVS_TCP_FLAGS = 646,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 647,
    OF_OXM_PBB_UCA = 648,
    OF_OXM_PBB_UCA_MASKED = 649,
    OF_OXM_SCTP_DST = 650,
    OF_OXM_SCTP_DST_MASKED = 651,
    OF_OXM_SCTP_SRC = 652,
    OF_OXM_SCTP_SRC_MASKED = 653,
    OF_OXM_TCP_DST = 654,
    OF_OXM_TCP_DST_MASKED = 655,
    OF_OXM_TCP_SRC = 656,
    OF_OXM_TCP_SRC_MASKED = 657,
    OF_OXM_TUNNEL_ID = 658,
    OF_OXM_TUNNEL_ID_MASKED = 659,
    OF_OXM_TUNNEL_IPV4_DST = 660,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 661,
    OF_OXM_TUNNEL_IPV4_SRC = 662,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 663,
    OF_OXM_UDP_DST = 664,
    OF_OXM_UDP_DST_MASKED = 665,
    OF_OXM_UDP_SRC = 666,
    OF_OXM_UDP_SRC_MASKED = 667,
    OF_OXM_VLAN_PCP = 668,
    OF_OXM_VLAN_PCP_MASKED = 669,
    OF_OXM_VLAN_VID = 670,
    OF_OXM_VLAN_VID_MASKED = 671,
    OF_PACKET_QUEUE = 672,
    OF_PORT_DESC = 673,
    OF_PORT_DESC_PROP = 674,
    OF_PORT_DESC_PROP_BSN = 675,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 676,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 677,
    OF_PORT_DESC_PROP_BSN_UPLINK = 678,
    OF_PORT_DESC_PROP_ETHERNET = 679,
    OF_PORT_DESC_PROP_EXPERIMENTER = 680,
    OF_PORT_DESC_PROP_OPTICAL = 681,
    OF_PORT_MOD_PROP = 682,
    OF_PORT_MOD_PROP_ETHERNET = 683,
    OF_PORT_MOD_PROP_EXPERIMENTER = 684,
    OF_PORT_MOD_PROP_OPTICAL = 685,
    OF_PORT_STATS_ENTRY = 686,
    OF_PORT_STATS_PROP = 687,
    OF_PORT_STATS_PROP_ETHERNET = 688,
    OF_PORT_STATS_PROP_EXPERIMENTER = 689,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 690,
    OF_PORT_STATS_PROP_OPTICAL = 691,
    OF_QUEUE_DESC = 692,
    OF_QUEUE_DESC_PROP = 693,
    OF_QUEUE_DESC_PROP_BSN = 694,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 695,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 696,
    OF_QUEUE_DESC_PROP_MAX_RATE = 697,
    OF_QUEUE_DESC_PROP_MIN_RATE = 698,
    OF_QUEUE_PROP = 699,
    OF_QUEUE_PROP_EXPERIMENTER = 700,
    OF_QUEUE_PROP_MAX_RATE = 701,
    OF_QUEUE_PROP_MIN_RATE = 702,
    OF_QUEUE_STATS_ENTRY = 703,
    OF_QUEUE_STATS_PROP = 704,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 705,
    OF_ROLE_PROP = 706,
    OF_ROLE_PROP_EXPERIMENTER = 707,
    OF_TABLE_DESC = 708,
    OF_TABLE_FEATURE_PROP = 709,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 710,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 711,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 712,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 713,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 714,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 715,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 716,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 717,
    OF_TABLE_FEATURE_PROP_MATCH = 718,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 719,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 720,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 721,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 722,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 723,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 724,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 725,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 726,
    OF_TABLE_FEATURES = 727,
    OF_TABLE_MOD_PROP = 728,
    OF_TABLE_MOD_PROP_EVICTION = 729,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 730,
    OF_TABLE_MOD_PROP_VACANCY = 731,
    OF_TABLE_STATS_ENTRY = 732,
    OF_UINT32 = 733,
    OF_UINT64 = 734,
    OF_UINT8 = 735,
    ...
    /* List objects */
    OF_LIST_ACTION = 736,
    OF_LIST_ACTION_ID = 737,
    OF_LIST_ASYNC_CONFIG_PROP = 738,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 739,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 740,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 741,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 742,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 743,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 744,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 745,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 746,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 747,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 748,
    OF_LIST_BSN_INTERFACE = 749,
    OF_LIST_BSN_LACP_STATS_ENTRY = 750,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 751,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 752,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 753,
    OF_LIST_BSN_TLV = 754,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 755,
    OF_LIST_BSN_VLAN_MAC = 756,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 757,
    OF_LIST_BUCKET = 758,
    OF_LIST_BUCKET_COUNTER = 759,
    OF_LIST_BUNDLE_PROP = 760,
    OF_LIST_FLOW_STATS_ENTRY = 761,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 762,
    OF_LIST_GROUP_STATS_ENTRY = 763,
    OF_LIST_HELLO_ELEM = 764,
    OF_LIST_INSTRUCTION = 765,
    OF_LIST_INSTRUCTION_ID = 766,
    OF_LIST_METER_BAND = 767,
    OF_LIST_METER_BAND_STATS = 768,
    OF_LIST_METER_CONFIG = 769,
    OF_LIST_METER_STATS = 770,
    OF_LIST_OXM = 771,
    OF_LIST_PACKET_QUEUE = 772,
    OF_LIST_PORT_DESC = 773,
    OF_LIST_PORT_DESC_PROP = 774,
    OF_LIST_PORT_MOD_PROP = 775,
    OF_LIST_PORT_STATS_ENTRY = 776,
    OF_LIST_PORT_STATS_PROP = 777,
    OF_LIST_QUEUE_DESC = 778,
    OF_LIST_QUEUE_DESC_PROP = 779,
    OF_LIST_QUEUE_PROP = 780,
    OF_LIST_QUEUE_STATS_ENTRY = 781,
    OF_LIST_QUEUE_STATS_PROP = 782,
    OF_LIST_ROLE_PROP = 783,
    OF_LIST_TABLE_DESC = 784,
    OF_LIST_TABLE_FEATURE_PROP = 785,
    OF_LIST_TABLE_FEATURES = 786,
    OF_LIST_TABLE_MOD_PROP = 787,
    OF_LIST_TABLE_STATS_ENTRY = 788,
    OF_LIST_UINT32 = 789,
    OF_LIST_UINT64 = 790,
    OF_LIST_UINT8 = 791,
