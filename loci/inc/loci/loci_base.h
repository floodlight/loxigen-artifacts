...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PDUA_RX_INSTANCE = 404,
    OF_BSN_TLV_PORT = 405,
    OF_BSN_TLV_PORT_SPEED_GBPS = 406,
    OF_BSN_TLV_PORT_USAGE = 407,
    OF_BSN_TLV_PORT_VXLAN_MODE = 408,
    OF_BSN_TLV_PRIORITY = 409,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 410,
    OF_BSN_TLV_QOS_PRIORITY = 411,
    OF_BSN_TLV_QUEUE_ID = 412,
    OF_BSN_TLV_QUEUE_WEIGHT = 413,
    OF_BSN_TLV_RATE_LIMIT = 414,
    OF_BSN_TLV_RATE_UNIT = 415,
    OF_BSN_TLV_RECORD_PACKETS = 416,
    OF_BSN_TLV_REFERENCE = 417,
    OF_BSN_TLV_REPLY_PACKETS = 418,
    OF_BSN_TLV_REQUEST_PACKETS = 419,
    OF_BSN_TLV_REST_SERVER = 420,
    OF_BSN_TLV_RX_BYTES = 421,
    OF_BSN_TLV_RX_PACKETS = 422,
    OF_BSN_TLV_SAMPLING_RATE = 423,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 424,
    OF_BSN_TLV_STATUS = 425,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 426,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 427,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 428,
    OF_BSN_TLV_SUB_AGENT_ID = 429,
    OF_BSN_TLV_TCP_DST = 430,
    OF_BSN_TLV_TCP_FLAGS = 431,
    OF_BSN_TLV_TCP_SRC = 432,
    OF_BSN_TLV_TIMESTAMP = 433,
    OF_BSN_TLV_TTL = 434,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 435,
    OF_BSN_TLV_TX_BYTES = 436,
    OF_BSN_TLV_TX_PACKETS = 437,
    OF_BSN_TLV_UDF_ANCHOR = 438,
    OF_BSN_TLV_UDF_ID = 439,
    OF_BSN_TLV_UDF_LENGTH = 440,
    OF_BSN_TLV_UDF_OFFSET = 441,
    OF_BSN_TLV_UDP_DST = 442,
    OF_BSN_TLV_UDP_SRC = 443,
    OF_BSN_TLV_UINT64_LIST = 444,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 445,
    OF_BSN_TLV_UNICAST_RATE = 446,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 447,
    OF_BSN_TLV_UNTAGGED = 448,
    OF_BSN_TLV_URI_SCHEME = 449,
    OF_BSN_TLV_USE_PACKET_STATE = 450,
    OF_BSN_TLV_VFI = 451,
    OF_BSN_TLV_VFP_CLASS_ID = 452,
    OF_BSN_TLV_VIRTUAL = 453,
    OF_BSN_TLV_VLAN_MAC_LIST = 454,
    OF_BSN_TLV_VLAN_PCP = 455,
    OF_BSN_TLV_VLAN_VID = 456,
    OF_BSN_TLV_VLAN_VID_MASK = 457,
    OF_BSN_TLV_VNI = 458,
    OF_BSN_TLV_VPN_KEY = 459,
    OF_BSN_TLV_VRF = 460,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 461,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 462,
    OF_BSN_VLAN_MAC = 463,
    OF_BSN_VPORT = 464,
    OF_BSN_VPORT_L2GRE = 465,
    OF_BSN_VPORT_Q_IN_Q = 466,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 467,
    OF_BUCKET = 468,
    OF_BUCKET_COUNTER = 469,
    OF_BUNDLE_PROP = 470,
    OF_BUNDLE_PROP_EXPERIMENTER = 471,
    OF_FLOW_STATS_ENTRY = 472,
    OF_GROUP_DESC_STATS_ENTRY = 473,
    OF_GROUP_STATS_ENTRY = 474,
    OF_HELLO_ELEM = 475,
    OF_HELLO_ELEM_VERSIONBITMAP = 476,
    OF_INSTRUCTION = 477,
    OF_INSTRUCTION_APPLY_ACTIONS = 478,
    OF_INSTRUCTION_BSN = 479,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 480,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 481,
    OF_INSTRUCTION_BSN_DENY = 482,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 483,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 484,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 485,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 486,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 487,
    OF_INSTRUCTION_BSN_HASH_SELECT = 488,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 489,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 490,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 491,
    OF_INSTRUCTION_BSN_PERMIT = 492,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 493,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 494,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 495,
    OF_INSTRUCTION_CLEAR_ACTIONS = 496,
    OF_INSTRUCTION_EXPERIMENTER = 497,
    OF_INSTRUCTION_GOTO_TABLE = 498,
    OF_INSTRUCTION_ID = 499,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 500,
    OF_INSTRUCTION_ID_BSN = 501,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 502,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 503,
    OF_INSTRUCTION_ID_BSN_DENY = 504,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 505,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 506,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 507,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 508,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 509,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 510,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 511,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 512,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 513,
    OF_INSTRUCTION_ID_BSN_PERMIT = 514,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 515,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 516,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 517,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 518,
    OF_INSTRUCTION_ID_EXPERIMENTER = 519,
    OF_INSTRUCTION_ID_GOTO_TABLE = 520,
    OF_INSTRUCTION_ID_METER = 521,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 522,
    OF_INSTRUCTION_ID_WRITE_METADATA = 523,
    OF_INSTRUCTION_METER = 524,
    OF_INSTRUCTION_WRITE_ACTIONS = 525,
    OF_INSTRUCTION_WRITE_METADATA = 526,
    OF_MATCH_V1 = 527,
    OF_MATCH_V2 = 528,
    OF_MATCH_V3 = 529,
    OF_METER_BAND = 530,
    OF_METER_BAND_DROP = 531,
    OF_METER_BAND_DSCP_REMARK = 532,
    OF_METER_BAND_EXPERIMENTER = 533,
    OF_METER_BAND_STATS = 534,
    OF_METER_CONFIG = 535,
    OF_METER_FEATURES = 536,
    OF_METER_STATS = 537,
    OF_OXM = 538,
    OF_OXM_ARP_OP = 539,
    OF_OXM_ARP_OP_MASKED = 540,
    OF_OXM_ARP_SHA = 541,
    OF_OXM_ARP_SHA_MASKED = 542,
    OF_OXM_ARP_SPA = 543,
    OF_OXM_ARP_SPA_MASKED = 544,
    OF_OXM_ARP_THA = 545,
    OF_OXM_ARP_THA_MASKED = 546,
    OF_OXM_ARP_TPA = 547,
    OF_OXM_ARP_TPA_MASKED = 548,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 549,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 550,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 551,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 552,
    OF_OXM_BSN_IN_PORTS_128 = 553,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 554,
    OF_OXM_BSN_IN_PORTS_512 = 555,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 556,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 557,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 558,
    OF_OXM_BSN_INNER_ETH_DST = 559,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 560,
    OF_OXM_BSN_INNER_ETH_SRC = 561,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 562,
    OF_OXM_BSN_INNER_VLAN_VID = 563,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 564,
    OF_OXM_BSN_IP_FRAGMENTATION = 565,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 566,
    OF_OXM_BSN_L2_CACHE_HIT = 567,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 568,
    OF_OXM_BSN_L3_DST_CLASS_ID = 569,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 570,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 571,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 572,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 573,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 574,
    OF_OXM_BSN_LAG_ID = 575,
    OF_OXM_BSN_LAG_ID_MASKED = 576,
    OF_OXM_BSN_TCP_FLAGS = 577,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 578,
    OF_OXM_BSN_UDF0 = 579,
    OF_OXM_BSN_UDF0_MASKED = 580,
    OF_OXM_BSN_UDF1 = 581,
    OF_OXM_BSN_UDF1_MASKED = 582,
    OF_OXM_BSN_UDF2 = 583,
    OF_OXM_BSN_UDF2_MASKED = 584,
    OF_OXM_BSN_UDF3 = 585,
    OF_OXM_BSN_UDF3_MASKED = 586,
    OF_OXM_BSN_UDF4 = 587,
    OF_OXM_BSN_UDF4_MASKED = 588,
    OF_OXM_BSN_UDF5 = 589,
    OF_OXM_BSN_UDF5_MASKED = 590,
    OF_OXM_BSN_UDF6 = 591,
    OF_OXM_BSN_UDF6_MASKED = 592,
    OF_OXM_BSN_UDF7 = 593,
    OF_OXM_BSN_UDF7_MASKED = 594,
    OF_OXM_BSN_VFI = 595,
    OF_OXM_BSN_VFI_MASKED = 596,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 597,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 598,
    OF_OXM_BSN_VRF = 599,
    OF_OXM_BSN_VRF_MASKED = 600,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 601,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 602,
    OF_OXM_ETH_DST = 603,
    OF_OXM_ETH_DST_MASKED = 604,
    OF_OXM_ETH_SRC = 605,
    OF_OXM_ETH_SRC_MASKED = 606,
    OF_OXM_ETH_TYPE = 607,
    OF_OXM_ETH_TYPE_MASKED = 608,
    OF_OXM_ICMPV4_CODE = 609,
    OF_OXM_ICMPV4_CODE_MASKED = 610,
    OF_OXM_ICMPV4_TYPE = 611,
    OF_OXM_ICMPV4_TYPE_MASKED = 612,
    OF_OXM_ICMPV6_CODE = 613,
    OF_OXM_ICMPV6_CODE_MASKED = 614,
    OF_OXM_ICMPV6_TYPE = 615,
    OF_OXM_ICMPV6_TYPE_MASKED = 616,
    OF_OXM_IN_PHY_PORT = 617,
    OF_OXM_IN_PHY_PORT_MASKED = 618,
    OF_OXM_IN_PORT = 619,
    OF_OXM_IN_PORT_MASKED = 620,
    OF_OXM_IP_DSCP = 621,
    OF_OXM_IP_DSCP_MASKED = 622,
    OF_OXM_IP_ECN = 623,
    OF_OXM_IP_ECN_MASKED = 624,
    OF_OXM_IP_PROTO = 625,
    OF_OXM_IP_PROTO_MASKED = 626,
    OF_OXM_IPV4_DST = 627,
    OF_OXM_IPV4_DST_MASKED = 628,
    OF_OXM_IPV4_SRC = 629,
    OF_OXM_IPV4_SRC_MASKED = 630,
    OF_OXM_IPV6_DST = 631,
    OF_OXM_IPV6_DST_MASKED = 632,
    OF_OXM_IPV6_EXTHDR = 633,
    OF_OXM_IPV6_EXTHDR_MASKED = 634,
    OF_OXM_IPV6_FLABEL = 635,
    OF_OXM_IPV6_FLABEL_MASKED = 636,
    OF_OXM_IPV6_ND_SLL = 637,
    OF_OXM_IPV6_ND_SLL_MASKED = 638,
    OF_OXM_IPV6_ND_TARGET = 639,
    OF_OXM_IPV6_ND_TARGET_MASKED = 640,
    OF_OXM_IPV6_ND_TLL = 641,
    OF_OXM_IPV6_ND_TLL_MASKED = 642,
    OF_OXM_IPV6_SRC = 643,
    OF_OXM_IPV6_SRC_MASKED = 644,
    OF_OXM_METADATA = 645,
    OF_OXM_METADATA_MASKED = 646,
    OF_OXM_MPLS_BOS = 647,
    OF_OXM_MPLS_BOS_MASKED = 648,
    OF_OXM_MPLS_LABEL = 649,
    OF_OXM_MPLS_LABEL_MASKED = 650,
    OF_OXM_MPLS_TC = 651,
    OF_OXM_MPLS_TC_MASKED = 652,
    OF_OXM_OVS_TCP_FLAGS = 653,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 654,
    OF_OXM_PBB_UCA = 655,
    OF_OXM_PBB_UCA_MASKED = 656,
    OF_OXM_SCTP_DST = 657,
    OF_OXM_SCTP_DST_MASKED = 658,
    OF_OXM_SCTP_SRC = 659,
    OF_OXM_SCTP_SRC_MASKED = 660,
    OF_OXM_TCP_DST = 661,
    OF_OXM_TCP_DST_MASKED = 662,
    OF_OXM_TCP_SRC = 663,
    OF_OXM_TCP_SRC_MASKED = 664,
    OF_OXM_TUNNEL_ID = 665,
    OF_OXM_TUNNEL_ID_MASKED = 666,
    OF_OXM_TUNNEL_IPV4_DST = 667,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 668,
    OF_OXM_TUNNEL_IPV4_SRC = 669,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 670,
    OF_OXM_UDP_DST = 671,
    OF_OXM_UDP_DST_MASKED = 672,
    OF_OXM_UDP_SRC = 673,
    OF_OXM_UDP_SRC_MASKED = 674,
    OF_OXM_VLAN_PCP = 675,
    OF_OXM_VLAN_PCP_MASKED = 676,
    OF_OXM_VLAN_VID = 677,
    OF_OXM_VLAN_VID_MASKED = 678,
    OF_PACKET_QUEUE = 679,
    OF_PORT_DESC = 680,
    OF_PORT_DESC_PROP = 681,
    OF_PORT_DESC_PROP_BSN = 682,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 683,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 684,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 685,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 686,
    OF_PORT_DESC_PROP_BSN_UPLINK = 687,
    OF_PORT_DESC_PROP_ETHERNET = 688,
    OF_PORT_DESC_PROP_EXPERIMENTER = 689,
    OF_PORT_DESC_PROP_OPTICAL = 690,
    OF_PORT_MOD_PROP = 691,
    OF_PORT_MOD_PROP_ETHERNET = 692,
    OF_PORT_MOD_PROP_EXPERIMENTER = 693,
    OF_PORT_MOD_PROP_OPTICAL = 694,
    OF_PORT_STATS_ENTRY = 695,
    OF_PORT_STATS_PROP = 696,
    OF_PORT_STATS_PROP_ETHERNET = 697,
    OF_PORT_STATS_PROP_EXPERIMENTER = 698,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 699,
    OF_PORT_STATS_PROP_OPTICAL = 700,
    OF_QUEUE_DESC = 701,
    OF_QUEUE_DESC_PROP = 702,
    OF_QUEUE_DESC_PROP_BSN = 703,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 704,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 705,
    OF_QUEUE_DESC_PROP_MAX_RATE = 706,
    OF_QUEUE_DESC_PROP_MIN_RATE = 707,
    OF_QUEUE_PROP = 708,
    OF_QUEUE_PROP_EXPERIMENTER = 709,
    OF_QUEUE_PROP_MAX_RATE = 710,
    OF_QUEUE_PROP_MIN_RATE = 711,
    OF_QUEUE_STATS_ENTRY = 712,
    OF_QUEUE_STATS_PROP = 713,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 714,
    OF_ROLE_PROP = 715,
    OF_ROLE_PROP_EXPERIMENTER = 716,
    OF_TABLE_DESC = 717,
    OF_TABLE_FEATURE_PROP = 718,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 719,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 720,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 721,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 722,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 723,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 724,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 725,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 726,
    OF_TABLE_FEATURE_PROP_MATCH = 727,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 728,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 729,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 730,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 731,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 732,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 733,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 734,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 735,
    OF_TABLE_FEATURES = 736,
    OF_TABLE_MOD_PROP = 737,
    OF_TABLE_MOD_PROP_EVICTION = 738,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 739,
    OF_TABLE_MOD_PROP_VACANCY = 740,
    OF_TABLE_STATS_ENTRY = 741,
    OF_UINT32 = 742,
    OF_UINT64 = 743,
    OF_UINT8 = 744,
    ...
    /* List objects */
    OF_LIST_ACTION = 745,
    OF_LIST_ACTION_ID = 746,
    OF_LIST_ASYNC_CONFIG_PROP = 747,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 748,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 749,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 750,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 751,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 752,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 753,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 754,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 755,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 756,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 757,
    OF_LIST_BSN_INTERFACE = 758,
    OF_LIST_BSN_LACP_STATS_ENTRY = 759,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 760,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 761,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 762,
    OF_LIST_BSN_TLV = 763,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 764,
    OF_LIST_BSN_VLAN_MAC = 765,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 766,
    OF_LIST_BUCKET = 767,
    OF_LIST_BUCKET_COUNTER = 768,
    OF_LIST_BUNDLE_PROP = 769,
    OF_LIST_FLOW_STATS_ENTRY = 770,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 771,
    OF_LIST_GROUP_STATS_ENTRY = 772,
    OF_LIST_HELLO_ELEM = 773,
    OF_LIST_INSTRUCTION = 774,
    OF_LIST_INSTRUCTION_ID = 775,
    OF_LIST_METER_BAND = 776,
    OF_LIST_METER_BAND_STATS = 777,
    OF_LIST_METER_CONFIG = 778,
    OF_LIST_METER_STATS = 779,
    OF_LIST_OXM = 780,
    OF_LIST_PACKET_QUEUE = 781,
    OF_LIST_PORT_DESC = 782,
    OF_LIST_PORT_DESC_PROP = 783,
    OF_LIST_PORT_MOD_PROP = 784,
    OF_LIST_PORT_STATS_ENTRY = 785,
    OF_LIST_PORT_STATS_PROP = 786,
    OF_LIST_QUEUE_DESC = 787,
    OF_LIST_QUEUE_DESC_PROP = 788,
    OF_LIST_QUEUE_PROP = 789,
    OF_LIST_QUEUE_STATS_ENTRY = 790,
    OF_LIST_QUEUE_STATS_PROP = 791,
    OF_LIST_ROLE_PROP = 792,
    OF_LIST_TABLE_DESC = 793,
    OF_LIST_TABLE_FEATURE_PROP = 794,
    OF_LIST_TABLE_FEATURES = 795,
    OF_LIST_TABLE_MOD_PROP = 796,
    OF_LIST_TABLE_STATS_ENTRY = 797,
    OF_LIST_UINT32 = 798,
    OF_LIST_UINT64 = 799,
    OF_LIST_UINT8 = 800,
