...
typedef enum of_object_id_e {
    ...
    OF_BSN_SET_IP_MASK = 64,
    OF_BSN_SET_L2_TABLE_REPLY = 65,
    OF_BSN_SET_L2_TABLE_REQUEST = 66,
    OF_BSN_SET_LACP_REPLY = 67,
    OF_BSN_SET_LACP_REQUEST = 68,
    OF_BSN_SET_MIRRORING = 69,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 70,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 71,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 72,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 73,
    OF_BSN_SHELL_COMMAND = 74,
    OF_BSN_SHELL_OUTPUT = 75,
    OF_BSN_SHELL_STATUS = 76,
    OF_BSN_STATS_REPLY = 77,
    OF_BSN_STATS_REQUEST = 78,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 79,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 80,
    OF_BSN_TIME_REPLY = 81,
    OF_BSN_TIME_REQUEST = 82,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 83,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 84,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 85,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 86,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 87,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 88,
    OF_DESC_STATS_REPLY = 89,
    OF_DESC_STATS_REQUEST = 90,
    OF_ECHO_REPLY = 91,
    OF_ECHO_REQUEST = 92,
    OF_ERROR_MSG = 93,
    OF_EXPERIMENTER = 94,
    OF_EXPERIMENTER_ERROR_MSG = 95,
    OF_EXPERIMENTER_STATS_REPLY = 96,
    OF_EXPERIMENTER_STATS_REQUEST = 97,
    OF_FEATURES_REPLY = 98,
    OF_FEATURES_REQUEST = 99,
    OF_FLOW_ADD = 100,
    OF_FLOW_DELETE = 101,
    OF_FLOW_DELETE_STRICT = 102,
    OF_FLOW_MOD = 103,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 104,
    OF_FLOW_MODIFY = 105,
    OF_FLOW_MODIFY_STRICT = 106,
    OF_FLOW_REMOVED = 107,
    OF_FLOW_STATS_REPLY = 108,
    OF_FLOW_STATS_REQUEST = 109,
    OF_GET_CONFIG_REPLY = 110,
    OF_GET_CONFIG_REQUEST = 111,
    OF_GROUP_ADD = 112,
    OF_GROUP_DELETE = 113,
    OF_GROUP_DESC_STATS_REPLY = 114,
    OF_GROUP_DESC_STATS_REQUEST = 115,
    OF_GROUP_FEATURES_STATS_REPLY = 116,
    OF_GROUP_FEATURES_STATS_REQUEST = 117,
    OF_GROUP_MOD = 118,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 119,
    OF_GROUP_MODIFY = 120,
    OF_GROUP_STATS_REPLY = 121,
    OF_GROUP_STATS_REQUEST = 122,
    OF_HELLO = 123,
    OF_HELLO_FAILED_ERROR_MSG = 124,
    OF_METER_CONFIG_STATS_REPLY = 125,
    OF_METER_CONFIG_STATS_REQUEST = 126,
    OF_METER_FEATURES_STATS_REPLY = 127,
    OF_METER_FEATURES_STATS_REQUEST = 128,
    OF_METER_MOD = 129,
    OF_METER_MOD_FAILED_ERROR_MSG = 130,
    OF_METER_STATS_REPLY = 131,
    OF_METER_STATS_REQUEST = 132,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 133,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 134,
    OF_NICIRA_HEADER = 135,
    OF_PACKET_IN = 136,
    OF_PACKET_OUT = 137,
    OF_PORT_DESC_STATS_REPLY = 138,
    OF_PORT_DESC_STATS_REQUEST = 139,
    OF_PORT_MOD = 140,
    OF_PORT_MOD_FAILED_ERROR_MSG = 141,
    OF_PORT_STATS_REPLY = 142,
    OF_PORT_STATS_REQUEST = 143,
    OF_PORT_STATUS = 144,
    OF_QUEUE_GET_CONFIG_REPLY = 145,
    OF_QUEUE_GET_CONFIG_REQUEST = 146,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 147,
    OF_QUEUE_STATS_REPLY = 148,
    OF_QUEUE_STATS_REQUEST = 149,
    OF_ROLE_REPLY = 150,
    OF_ROLE_REQUEST = 151,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 152,
    OF_SET_CONFIG = 153,
    OF_STATS_REPLY = 154,
    OF_STATS_REQUEST = 155,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 156,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 157,
    OF_TABLE_FEATURES_STATS_REPLY = 158,
    OF_TABLE_FEATURES_STATS_REQUEST = 159,
    OF_TABLE_MOD = 160,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 161,
    OF_TABLE_STATS_REPLY = 162,
    OF_TABLE_STATS_REQUEST = 163,

    /* Non-message objects */
    OF_ACTION = 164,
    OF_ACTION_BSN = 165,
    OF_ACTION_BSN_MIRROR = 166,
    OF_ACTION_BSN_SET_TUNNEL_DST = 167,
    OF_ACTION_COPY_TTL_IN = 168,
    OF_ACTION_COPY_TTL_OUT = 169,
    OF_ACTION_DEC_MPLS_TTL = 170,
    OF_ACTION_DEC_NW_TTL = 171,
    OF_ACTION_ENQUEUE = 172,
    OF_ACTION_EXPERIMENTER = 173,
    OF_ACTION_GROUP = 174,
    OF_ACTION_HEADER = 175,
    OF_ACTION_ID = 176,
    OF_ACTION_ID_BSN = 177,
    OF_ACTION_ID_BSN_MIRROR = 178,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 179,
    OF_ACTION_ID_COPY_TTL_IN = 180,
    OF_ACTION_ID_COPY_TTL_OUT = 181,
    OF_ACTION_ID_DEC_MPLS_TTL = 182,
    OF_ACTION_ID_DEC_NW_TTL = 183,
    OF_ACTION_ID_EXPERIMENTER = 184,
    OF_ACTION_ID_GROUP = 185,
    OF_ACTION_ID_HEADER = 186,
    OF_ACTION_ID_NICIRA = 187,
    OF_ACTION_ID_NICIRA_DEC_TTL = 188,
    OF_ACTION_ID_OUTPUT = 189,
    OF_ACTION_ID_POP_MPLS = 190,
    OF_ACTION_ID_POP_PBB = 191,
    OF_ACTION_ID_POP_VLAN = 192,
    OF_ACTION_ID_PUSH_MPLS = 193,
    OF_ACTION_ID_PUSH_PBB = 194,
    OF_ACTION_ID_PUSH_VLAN = 195,
    OF_ACTION_ID_SET_FIELD = 196,
    OF_ACTION_ID_SET_MPLS_TTL = 197,
    OF_ACTION_ID_SET_NW_TTL = 198,
    OF_ACTION_ID_SET_QUEUE = 199,
    OF_ACTION_NICIRA = 200,
    OF_ACTION_NICIRA_DEC_TTL = 201,
    OF_ACTION_OUTPUT = 202,
    OF_ACTION_POP_MPLS = 203,
    OF_ACTION_POP_PBB = 204,
    OF_ACTION_POP_VLAN = 205,
    OF_ACTION_PUSH_MPLS = 206,
    OF_ACTION_PUSH_PBB = 207,
    OF_ACTION_PUSH_VLAN = 208,
    OF_ACTION_SET_DL_DST = 209,
    OF_ACTION_SET_DL_SRC = 210,
    OF_ACTION_SET_FIELD = 211,
    OF_ACTION_SET_MPLS_LABEL = 212,
    OF_ACTION_SET_MPLS_TC = 213,
    OF_ACTION_SET_MPLS_TTL = 214,
    OF_ACTION_SET_NW_DST = 215,
    OF_ACTION_SET_NW_ECN = 216,
    OF_ACTION_SET_NW_SRC = 217,
    OF_ACTION_SET_NW_TOS = 218,
    OF_ACTION_SET_NW_TTL = 219,
    OF_ACTION_SET_QUEUE = 220,
    OF_ACTION_SET_TP_DST = 221,
    OF_ACTION_SET_TP_SRC = 222,
    OF_ACTION_SET_VLAN_PCP = 223,
    OF_ACTION_SET_VLAN_VID = 224,
    OF_ACTION_STRIP_VLAN = 225,
    OF_BSN_CONTROLLER_CONNECTION = 226,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 227,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 228,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 229,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 230,
    OF_BSN_GENTABLE_STATS_ENTRY = 231,
    OF_BSN_INTERFACE = 232,
    OF_BSN_LACP_STATS_ENTRY = 233,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 234,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 235,
    OF_BSN_TLV = 236,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 237,
    OF_BSN_TLV_HEADER = 238,
    OF_BSN_TLV_IDLE_NOTIFICATION = 239,
    OF_BSN_TLV_IDLE_TIME = 240,
    OF_BSN_TLV_IDLE_TIMEOUT = 241,
    OF_BSN_TLV_IPV4 = 242,
    OF_BSN_TLV_MAC = 243,
    OF_BSN_TLV_MISS_PACKETS = 244,
    OF_BSN_TLV_PORT = 245,
    OF_BSN_TLV_REPLY_PACKETS = 246,
    OF_BSN_TLV_REQUEST_PACKETS = 247,
    OF_BSN_TLV_RX_PACKETS = 248,
    OF_BSN_TLV_TX_PACKETS = 249,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 250,
    OF_BSN_TLV_VLAN_VID = 251,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 252,
    OF_BSN_VPORT = 253,
    OF_BSN_VPORT_HEADER = 254,
    OF_BSN_VPORT_Q_IN_Q = 255,
    OF_BUCKET = 256,
    OF_BUCKET_COUNTER = 257,
    OF_EXPERIMENTER_STATS_HEADER = 258,
    OF_FLOW_STATS_ENTRY = 259,
    OF_GROUP_DESC_STATS_ENTRY = 260,
    OF_GROUP_STATS_ENTRY = 261,
    OF_HEADER = 262,
    OF_HELLO_ELEM = 263,
    OF_HELLO_ELEM_HEADER = 264,
    OF_HELLO_ELEM_VERSIONBITMAP = 265,
    OF_INSTRUCTION = 266,
    OF_INSTRUCTION_APPLY_ACTIONS = 267,
    OF_INSTRUCTION_BSN = 268,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 269,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 270,
    OF_INSTRUCTION_CLEAR_ACTIONS = 271,
    OF_INSTRUCTION_EXPERIMENTER = 272,
    OF_INSTRUCTION_GOTO_TABLE = 273,
    OF_INSTRUCTION_HEADER = 274,
    OF_INSTRUCTION_ID = 275,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 276,
    OF_INSTRUCTION_ID_BSN = 277,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 278,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 279,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 280,
    OF_INSTRUCTION_ID_EXPERIMENTER = 281,
    OF_INSTRUCTION_ID_GOTO_TABLE = 282,
    OF_INSTRUCTION_ID_HEADER = 283,
    OF_INSTRUCTION_ID_METER = 284,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 285,
    OF_INSTRUCTION_ID_WRITE_METADATA = 286,
    OF_INSTRUCTION_METER = 287,
    OF_INSTRUCTION_WRITE_ACTIONS = 288,
    OF_INSTRUCTION_WRITE_METADATA = 289,
    OF_MATCH_V1 = 290,
    OF_MATCH_V2 = 291,
    OF_MATCH_V3 = 292,
    OF_METER_BAND = 293,
    OF_METER_BAND_DROP = 294,
    OF_METER_BAND_DSCP_REMARK = 295,
    OF_METER_BAND_EXPERIMENTER = 296,
    OF_METER_BAND_HEADER = 297,
    OF_METER_BAND_STATS = 298,
    OF_METER_CONFIG = 299,
    OF_METER_FEATURES = 300,
    OF_METER_STATS = 301,
    OF_OXM = 302,
    OF_OXM_ARP_OP = 303,
    OF_OXM_ARP_OP_MASKED = 304,
    OF_OXM_ARP_SHA = 305,
    OF_OXM_ARP_SHA_MASKED = 306,
    OF_OXM_ARP_SPA = 307,
    OF_OXM_ARP_SPA_MASKED = 308,
    OF_OXM_ARP_THA = 309,
    OF_OXM_ARP_THA_MASKED = 310,
    OF_OXM_ARP_TPA = 311,
    OF_OXM_ARP_TPA_MASKED = 312,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 313,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 314,
    OF_OXM_BSN_IN_PORTS_128 = 315,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 316,
    OF_OXM_BSN_L3_DST_CLASS_ID = 317,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 318,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 319,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 320,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 321,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 322,
    OF_OXM_BSN_LAG_ID = 323,
    OF_OXM_BSN_LAG_ID_MASKED = 324,
    OF_OXM_BSN_VRF = 325,
    OF_OXM_BSN_VRF_MASKED = 326,
    OF_OXM_ETH_DST = 327,
    OF_OXM_ETH_DST_MASKED = 328,
    OF_OXM_ETH_SRC = 329,
    OF_OXM_ETH_SRC_MASKED = 330,
    OF_OXM_ETH_TYPE = 331,
    OF_OXM_ETH_TYPE_MASKED = 332,
    OF_OXM_HEADER = 333,
    OF_OXM_ICMPV4_CODE = 334,
    OF_OXM_ICMPV4_CODE_MASKED = 335,
    OF_OXM_ICMPV4_TYPE = 336,
    OF_OXM_ICMPV4_TYPE_MASKED = 337,
    OF_OXM_ICMPV6_CODE = 338,
    OF_OXM_ICMPV6_CODE_MASKED = 339,
    OF_OXM_ICMPV6_TYPE = 340,
    OF_OXM_ICMPV6_TYPE_MASKED = 341,
    OF_OXM_IN_PHY_PORT = 342,
    OF_OXM_IN_PHY_PORT_MASKED = 343,
    OF_OXM_IN_PORT = 344,
    OF_OXM_IN_PORT_MASKED = 345,
    OF_OXM_IP_DSCP = 346,
    OF_OXM_IP_DSCP_MASKED = 347,
    OF_OXM_IP_ECN = 348,
    OF_OXM_IP_ECN_MASKED = 349,
    OF_OXM_IP_PROTO = 350,
    OF_OXM_IP_PROTO_MASKED = 351,
    OF_OXM_IPV4_DST = 352,
    OF_OXM_IPV4_DST_MASKED = 353,
    OF_OXM_IPV4_SRC = 354,
    OF_OXM_IPV4_SRC_MASKED = 355,
    OF_OXM_IPV6_DST = 356,
    OF_OXM_IPV6_DST_MASKED = 357,
    OF_OXM_IPV6_FLABEL = 358,
    OF_OXM_IPV6_FLABEL_MASKED = 359,
    OF_OXM_IPV6_ND_SLL = 360,
    OF_OXM_IPV6_ND_SLL_MASKED = 361,
    OF_OXM_IPV6_ND_TARGET = 362,
    OF_OXM_IPV6_ND_TARGET_MASKED = 363,
    OF_OXM_IPV6_ND_TLL = 364,
    OF_OXM_IPV6_ND_TLL_MASKED = 365,
    OF_OXM_IPV6_SRC = 366,
    OF_OXM_IPV6_SRC_MASKED = 367,
    OF_OXM_METADATA = 368,
    OF_OXM_METADATA_MASKED = 369,
    OF_OXM_MPLS_LABEL = 370,
    OF_OXM_MPLS_LABEL_MASKED = 371,
    OF_OXM_MPLS_TC = 372,
    OF_OXM_MPLS_TC_MASKED = 373,
    OF_OXM_SCTP_DST = 374,
    OF_OXM_SCTP_DST_MASKED = 375,
    OF_OXM_SCTP_SRC = 376,
    OF_OXM_SCTP_SRC_MASKED = 377,
    OF_OXM_TCP_DST = 378,
    OF_OXM_TCP_DST_MASKED = 379,
    OF_OXM_TCP_SRC = 380,
    OF_OXM_TCP_SRC_MASKED = 381,
    OF_OXM_UDP_DST = 382,
    OF_OXM_UDP_DST_MASKED = 383,
    OF_OXM_UDP_SRC = 384,
    OF_OXM_UDP_SRC_MASKED = 385,
    OF_OXM_VLAN_PCP = 386,
    OF_OXM_VLAN_PCP_MASKED = 387,
    OF_OXM_VLAN_VID = 388,
    OF_OXM_VLAN_VID_MASKED = 389,
    OF_PACKET_QUEUE = 390,
    OF_PORT_DESC = 391,
    OF_PORT_STATS_ENTRY = 392,
    OF_QUEUE_PROP = 393,
    OF_QUEUE_PROP_EXPERIMENTER = 394,
    OF_QUEUE_PROP_HEADER = 395,
    OF_QUEUE_PROP_MAX_RATE = 396,
    OF_QUEUE_PROP_MIN_RATE = 397,
    OF_QUEUE_STATS_ENTRY = 398,
    OF_TABLE_FEATURE_PROP = 399,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 400,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 401,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 402,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 403,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 404,
    OF_TABLE_FEATURE_PROP_HEADER = 405,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 406,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 407,
    OF_TABLE_FEATURE_PROP_MATCH = 408,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 409,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 410,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 411,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 412,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 413,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 414,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 415,
    OF_TABLE_FEATURES = 416,
    OF_TABLE_STATS_ENTRY = 417,
    OF_UINT32 = 418,
    OF_UINT64 = 419,
    OF_UINT8 = 420,
    ...
    /* List objects */
    OF_LIST_ACTION = 421,
    OF_LIST_ACTION_ID = 422,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 423,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 424,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 425,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 426,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 427,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 428,
    OF_LIST_BSN_INTERFACE = 429,
    OF_LIST_BSN_LACP_STATS_ENTRY = 430,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 431,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 432,
    OF_LIST_BSN_TLV = 433,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 434,
    OF_LIST_BUCKET = 435,
    OF_LIST_BUCKET_COUNTER = 436,
    OF_LIST_FLOW_STATS_ENTRY = 437,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 438,
    OF_LIST_GROUP_STATS_ENTRY = 439,
    OF_LIST_HELLO_ELEM = 440,
    OF_LIST_INSTRUCTION = 441,
    OF_LIST_METER_BAND = 442,
    OF_LIST_METER_BAND_STATS = 443,
    OF_LIST_METER_STATS = 444,
    OF_LIST_OXM = 445,
    OF_LIST_PACKET_QUEUE = 446,
    OF_LIST_PORT_DESC = 447,
    OF_LIST_PORT_STATS_ENTRY = 448,
    OF_LIST_QUEUE_PROP = 449,
    OF_LIST_QUEUE_STATS_ENTRY = 450,
    OF_LIST_TABLE_FEATURE_PROP = 451,
    OF_LIST_TABLE_FEATURES = 452,
    OF_LIST_TABLE_STATS_ENTRY = 453,
    OF_LIST_UINT32 = 454,
    OF_LIST_UINT64 = 455,
    OF_LIST_UINT8 = 456,
...
#define OF_MESSAGE_OBJECT_COUNT 164
