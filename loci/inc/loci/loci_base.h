...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_NAME = 342,
    OF_BSN_TLV_OFFSET = 343,
    OF_BSN_TLV_PARTNER_KEY = 344,
    OF_BSN_TLV_PARTNER_PORT_NUM = 345,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 346,
    OF_BSN_TLV_PARTNER_STATE = 347,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 348,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 349,
    OF_BSN_TLV_PORT = 350,
    OF_BSN_TLV_PRIORITY = 351,
    OF_BSN_TLV_QUEUE_ID = 352,
    OF_BSN_TLV_QUEUE_WEIGHT = 353,
    OF_BSN_TLV_REFERENCE = 354,
    OF_BSN_TLV_REPLY_PACKETS = 355,
    OF_BSN_TLV_REQUEST_PACKETS = 356,
    OF_BSN_TLV_RX_BYTES = 357,
    OF_BSN_TLV_RX_PACKETS = 358,
    OF_BSN_TLV_SAMPLING_RATE = 359,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 360,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 361,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 362,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 363,
    OF_BSN_TLV_SUB_AGENT_ID = 364,
    OF_BSN_TLV_TCP_DST = 365,
    OF_BSN_TLV_TCP_SRC = 366,
    OF_BSN_TLV_TX_BYTES = 367,
    OF_BSN_TLV_TX_PACKETS = 368,
    OF_BSN_TLV_UDF_ANCHOR = 369,
    OF_BSN_TLV_UDF_ID = 370,
    OF_BSN_TLV_UDF_LENGTH = 371,
    OF_BSN_TLV_UDF_OFFSET = 372,
    OF_BSN_TLV_UDP_DST = 373,
    OF_BSN_TLV_UDP_SRC = 374,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 375,
    OF_BSN_TLV_VLAN_PCP = 376,
    OF_BSN_TLV_VLAN_VID = 377,
    OF_BSN_TLV_VLAN_VID_MASK = 378,
    OF_BSN_TLV_VRF = 379,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 380,
    OF_BSN_VPORT = 381,
    OF_BSN_VPORT_L2GRE = 382,
    OF_BSN_VPORT_Q_IN_Q = 383,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 384,
    OF_BUCKET = 385,
    OF_BUCKET_COUNTER = 386,
    OF_BUNDLE_PROP = 387,
    OF_BUNDLE_PROP_EXPERIMENTER = 388,
    OF_FLOW_STATS_ENTRY = 389,
    OF_GROUP_DESC_STATS_ENTRY = 390,
    OF_GROUP_STATS_ENTRY = 391,
    OF_HELLO_ELEM = 392,
    OF_HELLO_ELEM_VERSIONBITMAP = 393,
    OF_INSTRUCTION = 394,
    OF_INSTRUCTION_APPLY_ACTIONS = 395,
    OF_INSTRUCTION_BSN = 396,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 397,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 398,
    OF_INSTRUCTION_BSN_DENY = 399,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 400,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 401,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 402,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 403,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 404,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 405,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 406,
    OF_INSTRUCTION_BSN_PERMIT = 407,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 408,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 409,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 410,
    OF_INSTRUCTION_CLEAR_ACTIONS = 411,
    OF_INSTRUCTION_EXPERIMENTER = 412,
    OF_INSTRUCTION_GOTO_TABLE = 413,
    OF_INSTRUCTION_ID = 414,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 415,
    OF_INSTRUCTION_ID_BSN = 416,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 417,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 418,
    OF_INSTRUCTION_ID_BSN_DENY = 419,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 420,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 421,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 422,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 423,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 424,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 425,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 426,
    OF_INSTRUCTION_ID_BSN_PERMIT = 427,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 428,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 429,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 430,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 431,
    OF_INSTRUCTION_ID_EXPERIMENTER = 432,
    OF_INSTRUCTION_ID_GOTO_TABLE = 433,
    OF_INSTRUCTION_ID_METER = 434,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 435,
    OF_INSTRUCTION_ID_WRITE_METADATA = 436,
    OF_INSTRUCTION_METER = 437,
    OF_INSTRUCTION_WRITE_ACTIONS = 438,
    OF_INSTRUCTION_WRITE_METADATA = 439,
    OF_MATCH_V1 = 440,
    OF_MATCH_V2 = 441,
    OF_MATCH_V3 = 442,
    OF_METER_BAND = 443,
    OF_METER_BAND_DROP = 444,
    OF_METER_BAND_DSCP_REMARK = 445,
    OF_METER_BAND_EXPERIMENTER = 446,
    OF_METER_BAND_STATS = 447,
    OF_METER_CONFIG = 448,
    OF_METER_FEATURES = 449,
    OF_METER_STATS = 450,
    OF_OXM = 451,
    OF_OXM_ARP_OP = 452,
    OF_OXM_ARP_OP_MASKED = 453,
    OF_OXM_ARP_SHA = 454,
    OF_OXM_ARP_SHA_MASKED = 455,
    OF_OXM_ARP_SPA = 456,
    OF_OXM_ARP_SPA_MASKED = 457,
    OF_OXM_ARP_THA = 458,
    OF_OXM_ARP_THA_MASKED = 459,
    OF_OXM_ARP_TPA = 460,
    OF_OXM_ARP_TPA_MASKED = 461,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 462,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 463,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 464,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 465,
    OF_OXM_BSN_IN_PORTS_128 = 466,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 467,
    OF_OXM_BSN_IN_PORTS_512 = 468,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 469,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 470,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 471,
    OF_OXM_BSN_INNER_ETH_DST = 472,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 473,
    OF_OXM_BSN_INNER_ETH_SRC = 474,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 475,
    OF_OXM_BSN_INNER_VLAN_VID = 476,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 477,
    OF_OXM_BSN_L2_CACHE_HIT = 478,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 479,
    OF_OXM_BSN_L3_DST_CLASS_ID = 480,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 481,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 482,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 483,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 484,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 485,
    OF_OXM_BSN_LAG_ID = 486,
    OF_OXM_BSN_LAG_ID_MASKED = 487,
    OF_OXM_BSN_TCP_FLAGS = 488,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 489,
    OF_OXM_BSN_UDF0 = 490,
    OF_OXM_BSN_UDF0_MASKED = 491,
    OF_OXM_BSN_UDF1 = 492,
    OF_OXM_BSN_UDF1_MASKED = 493,
    OF_OXM_BSN_UDF2 = 494,
    OF_OXM_BSN_UDF2_MASKED = 495,
    OF_OXM_BSN_UDF3 = 496,
    OF_OXM_BSN_UDF3_MASKED = 497,
    OF_OXM_BSN_UDF4 = 498,
    OF_OXM_BSN_UDF4_MASKED = 499,
    OF_OXM_BSN_UDF5 = 500,
    OF_OXM_BSN_UDF5_MASKED = 501,
    OF_OXM_BSN_UDF6 = 502,
    OF_OXM_BSN_UDF6_MASKED = 503,
    OF_OXM_BSN_UDF7 = 504,
    OF_OXM_BSN_UDF7_MASKED = 505,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 506,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 507,
    OF_OXM_BSN_VRF = 508,
    OF_OXM_BSN_VRF_MASKED = 509,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 510,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 511,
    OF_OXM_ETH_DST = 512,
    OF_OXM_ETH_DST_MASKED = 513,
    OF_OXM_ETH_SRC = 514,
    OF_OXM_ETH_SRC_MASKED = 515,
    OF_OXM_ETH_TYPE = 516,
    OF_OXM_ETH_TYPE_MASKED = 517,
    OF_OXM_ICMPV4_CODE = 518,
    OF_OXM_ICMPV4_CODE_MASKED = 519,
    OF_OXM_ICMPV4_TYPE = 520,
    OF_OXM_ICMPV4_TYPE_MASKED = 521,
    OF_OXM_ICMPV6_CODE = 522,
    OF_OXM_ICMPV6_CODE_MASKED = 523,
    OF_OXM_ICMPV6_TYPE = 524,
    OF_OXM_ICMPV6_TYPE_MASKED = 525,
    OF_OXM_IN_PHY_PORT = 526,
    OF_OXM_IN_PHY_PORT_MASKED = 527,
    OF_OXM_IN_PORT = 528,
    OF_OXM_IN_PORT_MASKED = 529,
    OF_OXM_IP_DSCP = 530,
    OF_OXM_IP_DSCP_MASKED = 531,
    OF_OXM_IP_ECN = 532,
    OF_OXM_IP_ECN_MASKED = 533,
    OF_OXM_IP_PROTO = 534,
    OF_OXM_IP_PROTO_MASKED = 535,
    OF_OXM_IPV4_DST = 536,
    OF_OXM_IPV4_DST_MASKED = 537,
    OF_OXM_IPV4_SRC = 538,
    OF_OXM_IPV4_SRC_MASKED = 539,
    OF_OXM_IPV6_DST = 540,
    OF_OXM_IPV6_DST_MASKED = 541,
    OF_OXM_IPV6_EXTHDR = 542,
    OF_OXM_IPV6_EXTHDR_MASKED = 543,
    OF_OXM_IPV6_FLABEL = 544,
    OF_OXM_IPV6_FLABEL_MASKED = 545,
    OF_OXM_IPV6_ND_SLL = 546,
    OF_OXM_IPV6_ND_SLL_MASKED = 547,
    OF_OXM_IPV6_ND_TARGET = 548,
    OF_OXM_IPV6_ND_TARGET_MASKED = 549,
    OF_OXM_IPV6_ND_TLL = 550,
    OF_OXM_IPV6_ND_TLL_MASKED = 551,
    OF_OXM_IPV6_SRC = 552,
    OF_OXM_IPV6_SRC_MASKED = 553,
    OF_OXM_METADATA = 554,
    OF_OXM_METADATA_MASKED = 555,
    OF_OXM_MPLS_BOS = 556,
    OF_OXM_MPLS_BOS_MASKED = 557,
    OF_OXM_MPLS_LABEL = 558,
    OF_OXM_MPLS_LABEL_MASKED = 559,
    OF_OXM_MPLS_TC = 560,
    OF_OXM_MPLS_TC_MASKED = 561,
    OF_OXM_PBB_UCA = 562,
    OF_OXM_PBB_UCA_MASKED = 563,
    OF_OXM_SCTP_DST = 564,
    OF_OXM_SCTP_DST_MASKED = 565,
    OF_OXM_SCTP_SRC = 566,
    OF_OXM_SCTP_SRC_MASKED = 567,
    OF_OXM_TCP_DST = 568,
    OF_OXM_TCP_DST_MASKED = 569,
    OF_OXM_TCP_SRC = 570,
    OF_OXM_TCP_SRC_MASKED = 571,
    OF_OXM_TUNNEL_ID = 572,
    OF_OXM_TUNNEL_ID_MASKED = 573,
    OF_OXM_TUNNEL_IPV4_DST = 574,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 575,
    OF_OXM_TUNNEL_IPV4_SRC = 576,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 577,
    OF_OXM_UDP_DST = 578,
    OF_OXM_UDP_DST_MASKED = 579,
    OF_OXM_UDP_SRC = 580,
    OF_OXM_UDP_SRC_MASKED = 581,
    OF_OXM_VLAN_PCP = 582,
    OF_OXM_VLAN_PCP_MASKED = 583,
    OF_OXM_VLAN_VID = 584,
    OF_OXM_VLAN_VID_MASKED = 585,
    OF_PACKET_QUEUE = 586,
    OF_PORT_DESC = 587,
    OF_PORT_DESC_PROP = 588,
    OF_PORT_DESC_PROP_BSN = 589,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 590,
    OF_PORT_DESC_PROP_BSN_UPLINK = 591,
    OF_PORT_DESC_PROP_ETHERNET = 592,
    OF_PORT_DESC_PROP_EXPERIMENTER = 593,
    OF_PORT_DESC_PROP_OPTICAL = 594,
    OF_PORT_MOD_PROP = 595,
    OF_PORT_MOD_PROP_ETHERNET = 596,
    OF_PORT_MOD_PROP_EXPERIMENTER = 597,
    OF_PORT_MOD_PROP_OPTICAL = 598,
    OF_PORT_STATS_ENTRY = 599,
    OF_PORT_STATS_PROP = 600,
    OF_PORT_STATS_PROP_ETHERNET = 601,
    OF_PORT_STATS_PROP_EXPERIMENTER = 602,
    OF_PORT_STATS_PROP_OPTICAL = 603,
    OF_QUEUE_DESC = 604,
    OF_QUEUE_DESC_PROP = 605,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 606,
    OF_QUEUE_DESC_PROP_MAX_RATE = 607,
    OF_QUEUE_DESC_PROP_MIN_RATE = 608,
    OF_QUEUE_PROP = 609,
    OF_QUEUE_PROP_EXPERIMENTER = 610,
    OF_QUEUE_PROP_MAX_RATE = 611,
    OF_QUEUE_PROP_MIN_RATE = 612,
    OF_QUEUE_STATS_ENTRY = 613,
    OF_QUEUE_STATS_PROP = 614,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 615,
    OF_ROLE_PROP = 616,
    OF_ROLE_PROP_EXPERIMENTER = 617,
    OF_TABLE_DESC = 618,
    OF_TABLE_FEATURE_PROP = 619,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 620,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 621,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 622,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 623,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 624,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 625,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 626,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 627,
    OF_TABLE_FEATURE_PROP_MATCH = 628,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 629,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 630,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 631,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 632,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 633,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 634,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 635,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 636,
    OF_TABLE_FEATURES = 637,
    OF_TABLE_MOD_PROP = 638,
    OF_TABLE_MOD_PROP_EVICTION = 639,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 640,
    OF_TABLE_MOD_PROP_VACANCY = 641,
    OF_TABLE_STATS_ENTRY = 642,
    OF_UINT32 = 643,
    OF_UINT64 = 644,
    OF_UINT8 = 645,
    ...
    /* List objects */
    OF_LIST_ACTION = 646,
    OF_LIST_ACTION_ID = 647,
    OF_LIST_ASYNC_CONFIG_PROP = 648,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 649,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 650,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 651,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 652,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 653,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 654,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 655,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 656,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 657,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 658,
    OF_LIST_BSN_INTERFACE = 659,
    OF_LIST_BSN_LACP_STATS_ENTRY = 660,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 661,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 662,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 663,
    OF_LIST_BSN_TLV = 664,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 665,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 666,
    OF_LIST_BUCKET = 667,
    OF_LIST_BUCKET_COUNTER = 668,
    OF_LIST_BUNDLE_PROP = 669,
    OF_LIST_FLOW_STATS_ENTRY = 670,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 671,
    OF_LIST_GROUP_STATS_ENTRY = 672,
    OF_LIST_HELLO_ELEM = 673,
    OF_LIST_INSTRUCTION = 674,
    OF_LIST_INSTRUCTION_ID = 675,
    OF_LIST_METER_BAND = 676,
    OF_LIST_METER_BAND_STATS = 677,
    OF_LIST_METER_STATS = 678,
    OF_LIST_OXM = 679,
    OF_LIST_PACKET_QUEUE = 680,
    OF_LIST_PORT_DESC = 681,
    OF_LIST_PORT_DESC_PROP = 682,
    OF_LIST_PORT_MOD_PROP = 683,
    OF_LIST_PORT_STATS_ENTRY = 684,
    OF_LIST_PORT_STATS_PROP = 685,
    OF_LIST_QUEUE_DESC = 686,
    OF_LIST_QUEUE_DESC_PROP = 687,
    OF_LIST_QUEUE_PROP = 688,
    OF_LIST_QUEUE_STATS_ENTRY = 689,
    OF_LIST_QUEUE_STATS_PROP = 690,
    OF_LIST_ROLE_PROP = 691,
    OF_LIST_TABLE_DESC = 692,
    OF_LIST_TABLE_FEATURE_PROP = 693,
    OF_LIST_TABLE_FEATURES = 694,
    OF_LIST_TABLE_MOD_PROP = 695,
    OF_LIST_TABLE_STATS_ENTRY = 696,
    OF_LIST_UINT32 = 697,
    OF_LIST_UINT64 = 698,
    OF_LIST_UINT8 = 699,
