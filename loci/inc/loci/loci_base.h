...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_PRIORITY = 429,
    OF_BSN_TLV_PUSH_VLAN_ON_EGRESS = 430,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 431,
    OF_BSN_TLV_QOS_PRIORITY = 432,
    OF_BSN_TLV_QUEUE_ID = 433,
    OF_BSN_TLV_QUEUE_WEIGHT = 434,
    OF_BSN_TLV_RATE_LIMIT = 435,
    OF_BSN_TLV_RATE_UNIT = 436,
    OF_BSN_TLV_RECORD_PACKETS = 437,
    OF_BSN_TLV_REFERENCE = 438,
    OF_BSN_TLV_REPLY_PACKETS = 439,
    OF_BSN_TLV_REQUEST_PACKETS = 440,
    OF_BSN_TLV_REST_SERVER = 441,
    OF_BSN_TLV_ROUTING_PARAM = 442,
    OF_BSN_TLV_RX_BYTES = 443,
    OF_BSN_TLV_RX_PACKETS = 444,
    OF_BSN_TLV_SAMPLING_RATE = 445,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 446,
    OF_BSN_TLV_STATUS = 447,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 448,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 449,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 450,
    OF_BSN_TLV_SUB_AGENT_ID = 451,
    OF_BSN_TLV_TCP_DST = 452,
    OF_BSN_TLV_TCP_FLAGS = 453,
    OF_BSN_TLV_TCP_SRC = 454,
    OF_BSN_TLV_TIMESTAMP = 455,
    OF_BSN_TLV_TTL = 456,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 457,
    OF_BSN_TLV_TX_BYTES = 458,
    OF_BSN_TLV_TX_PACKETS = 459,
    OF_BSN_TLV_UDF_ANCHOR = 460,
    OF_BSN_TLV_UDF_CAPABILITY = 461,
    OF_BSN_TLV_UDF_ID = 462,
    OF_BSN_TLV_UDF_LENGTH = 463,
    OF_BSN_TLV_UDF_OFFSET = 464,
    OF_BSN_TLV_UDP_DST = 465,
    OF_BSN_TLV_UDP_SRC = 466,
    OF_BSN_TLV_UINT32 = 467,
    OF_BSN_TLV_UINT64_LIST = 468,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 469,
    OF_BSN_TLV_UNICAST_RATE = 470,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 471,
    OF_BSN_TLV_UNTAGGED = 472,
    OF_BSN_TLV_UPGRADE = 473,
    OF_BSN_TLV_URI_SCHEME = 474,
    OF_BSN_TLV_USE_PACKET_STATE = 475,
    OF_BSN_TLV_USER_CONFIGURED = 476,
    OF_BSN_TLV_VFI = 477,
    OF_BSN_TLV_VFP_CLASS_ID = 478,
    OF_BSN_TLV_VIRTUAL = 479,
    OF_BSN_TLV_VLAN_MAC_LIST = 480,
    OF_BSN_TLV_VLAN_PCP = 481,
    OF_BSN_TLV_VLAN_VID = 482,
    OF_BSN_TLV_VLAN_VID_MASK = 483,
    OF_BSN_TLV_VNI = 484,
    OF_BSN_TLV_VPN_KEY = 485,
    OF_BSN_TLV_VRF = 486,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 487,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 488,
    OF_BSN_VLAN_MAC = 489,
    OF_BSN_VPORT = 490,
    OF_BSN_VPORT_L2GRE = 491,
    OF_BSN_VPORT_Q_IN_Q = 492,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 493,
    OF_BUCKET = 494,
    OF_BUCKET_COUNTER = 495,
    OF_BUNDLE_PROP = 496,
    OF_BUNDLE_PROP_EXPERIMENTER = 497,
    OF_FLOW_STATS_ENTRY = 498,
    OF_GROUP_DESC_STATS_ENTRY = 499,
    OF_GROUP_STATS_ENTRY = 500,
    OF_HELLO_ELEM = 501,
    OF_HELLO_ELEM_VERSIONBITMAP = 502,
    OF_INSTRUCTION = 503,
    OF_INSTRUCTION_APPLY_ACTIONS = 504,
    OF_INSTRUCTION_BSN = 505,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 506,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 507,
    OF_INSTRUCTION_BSN_DENY = 508,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 509,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 510,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 511,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 512,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 513,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 514,
    OF_INSTRUCTION_BSN_HASH_SELECT = 515,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 516,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 517,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 518,
    OF_INSTRUCTION_BSN_PERMIT = 519,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 520,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 521,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 522,
    OF_INSTRUCTION_CLEAR_ACTIONS = 523,
    OF_INSTRUCTION_EXPERIMENTER = 524,
    OF_INSTRUCTION_GOTO_TABLE = 525,
    OF_INSTRUCTION_ID = 526,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 527,
    OF_INSTRUCTION_ID_BSN = 528,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 529,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 530,
    OF_INSTRUCTION_ID_BSN_DENY = 531,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 532,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 533,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 534,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 535,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 536,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 537,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 538,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 539,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 540,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 541,
    OF_INSTRUCTION_ID_BSN_PERMIT = 542,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 543,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 544,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 545,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 546,
    OF_INSTRUCTION_ID_EXPERIMENTER = 547,
    OF_INSTRUCTION_ID_GOTO_TABLE = 548,
    OF_INSTRUCTION_ID_METER = 549,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 550,
    OF_INSTRUCTION_ID_WRITE_METADATA = 551,
    OF_INSTRUCTION_METER = 552,
    OF_INSTRUCTION_WRITE_ACTIONS = 553,
    OF_INSTRUCTION_WRITE_METADATA = 554,
    OF_MATCH_V1 = 555,
    OF_MATCH_V2 = 556,
    OF_MATCH_V3 = 557,
    OF_METER_BAND = 558,
    OF_METER_BAND_DROP = 559,
    OF_METER_BAND_DSCP_REMARK = 560,
    OF_METER_BAND_EXPERIMENTER = 561,
    OF_METER_BAND_STATS = 562,
    OF_METER_CONFIG = 563,
    OF_METER_FEATURES = 564,
    OF_METER_STATS = 565,
    OF_OXM = 566,
    OF_OXM_ARP_OP = 567,
    OF_OXM_ARP_OP_MASKED = 568,
    OF_OXM_ARP_SHA = 569,
    OF_OXM_ARP_SHA_MASKED = 570,
    OF_OXM_ARP_SPA = 571,
    OF_OXM_ARP_SPA_MASKED = 572,
    OF_OXM_ARP_THA = 573,
    OF_OXM_ARP_THA_MASKED = 574,
    OF_OXM_ARP_TPA = 575,
    OF_OXM_ARP_TPA_MASKED = 576,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 577,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 578,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 579,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 580,
    OF_OXM_BSN_IFP_CLASS_ID = 581,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 582,
    OF_OXM_BSN_IN_PORTS_128 = 583,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 584,
    OF_OXM_BSN_IN_PORTS_512 = 585,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 586,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 587,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 588,
    OF_OXM_BSN_INNER_ETH_DST = 589,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 590,
    OF_OXM_BSN_INNER_ETH_SRC = 591,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 592,
    OF_OXM_BSN_INNER_VLAN_VID = 593,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 594,
    OF_OXM_BSN_IP_FRAGMENTATION = 595,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 596,
    OF_OXM_BSN_L2_CACHE_HIT = 597,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 598,
    OF_OXM_BSN_L3_DST_CLASS_ID = 599,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 600,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 601,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 602,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 603,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 604,
    OF_OXM_BSN_LAG_ID = 605,
    OF_OXM_BSN_LAG_ID_MASKED = 606,
    OF_OXM_BSN_TCP_FLAGS = 607,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 608,
    OF_OXM_BSN_UDF0 = 609,
    OF_OXM_BSN_UDF0_MASKED = 610,
    OF_OXM_BSN_UDF1 = 611,
    OF_OXM_BSN_UDF1_MASKED = 612,
    OF_OXM_BSN_UDF2 = 613,
    OF_OXM_BSN_UDF2_MASKED = 614,
    OF_OXM_BSN_UDF3 = 615,
    OF_OXM_BSN_UDF3_MASKED = 616,
    OF_OXM_BSN_UDF4 = 617,
    OF_OXM_BSN_UDF4_MASKED = 618,
    OF_OXM_BSN_UDF5 = 619,
    OF_OXM_BSN_UDF5_MASKED = 620,
    OF_OXM_BSN_UDF6 = 621,
    OF_OXM_BSN_UDF6_MASKED = 622,
    OF_OXM_BSN_UDF7 = 623,
    OF_OXM_BSN_UDF7_MASKED = 624,
    OF_OXM_BSN_VFI = 625,
    OF_OXM_BSN_VFI_MASKED = 626,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 627,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 628,
    OF_OXM_BSN_VRF = 629,
    OF_OXM_BSN_VRF_MASKED = 630,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 631,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 632,
    OF_OXM_CONN_TRACKING_IPV6_DST = 633,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 634,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 635,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 636,
    OF_OXM_CONN_TRACKING_LABEL = 637,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 638,
    OF_OXM_CONN_TRACKING_MARK = 639,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 640,
    OF_OXM_CONN_TRACKING_NW_DST = 641,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 642,
    OF_OXM_CONN_TRACKING_NW_PROTO = 643,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 644,
    OF_OXM_CONN_TRACKING_NW_SRC = 645,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 646,
    OF_OXM_CONN_TRACKING_STATE = 647,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 648,
    OF_OXM_CONN_TRACKING_TP_DST = 649,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 650,
    OF_OXM_CONN_TRACKING_TP_SRC = 651,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 652,
    OF_OXM_CONN_TRACKING_ZONE = 653,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 654,
    OF_OXM_ETH_DST = 655,
    OF_OXM_ETH_DST_MASKED = 656,
    OF_OXM_ETH_SRC = 657,
    OF_OXM_ETH_SRC_MASKED = 658,
    OF_OXM_ETH_TYPE = 659,
    OF_OXM_ETH_TYPE_MASKED = 660,
    OF_OXM_ICMPV4_CODE = 661,
    OF_OXM_ICMPV4_CODE_MASKED = 662,
    OF_OXM_ICMPV4_TYPE = 663,
    OF_OXM_ICMPV4_TYPE_MASKED = 664,
    OF_OXM_ICMPV6_CODE = 665,
    OF_OXM_ICMPV6_CODE_MASKED = 666,
    OF_OXM_ICMPV6_TYPE = 667,
    OF_OXM_ICMPV6_TYPE_MASKED = 668,
    OF_OXM_IN_PHY_PORT = 669,
    OF_OXM_IN_PHY_PORT_MASKED = 670,
    OF_OXM_IN_PORT = 671,
    OF_OXM_IN_PORT_MASKED = 672,
    OF_OXM_IP_DSCP = 673,
    OF_OXM_IP_DSCP_MASKED = 674,
    OF_OXM_IP_ECN = 675,
    OF_OXM_IP_ECN_MASKED = 676,
    OF_OXM_IP_PROTO = 677,
    OF_OXM_IP_PROTO_MASKED = 678,
    OF_OXM_IPV4_DST = 679,
    OF_OXM_IPV4_DST_MASKED = 680,
    OF_OXM_IPV4_SRC = 681,
    OF_OXM_IPV4_SRC_MASKED = 682,
    OF_OXM_IPV6_DST = 683,
    OF_OXM_IPV6_DST_MASKED = 684,
    OF_OXM_IPV6_EXTHDR = 685,
    OF_OXM_IPV6_EXTHDR_MASKED = 686,
    OF_OXM_IPV6_FLABEL = 687,
    OF_OXM_IPV6_FLABEL_MASKED = 688,
    OF_OXM_IPV6_ND_SLL = 689,
    OF_OXM_IPV6_ND_SLL_MASKED = 690,
    OF_OXM_IPV6_ND_TARGET = 691,
    OF_OXM_IPV6_ND_TARGET_MASKED = 692,
    OF_OXM_IPV6_ND_TLL = 693,
    OF_OXM_IPV6_ND_TLL_MASKED = 694,
    OF_OXM_IPV6_SRC = 695,
    OF_OXM_IPV6_SRC_MASKED = 696,
    OF_OXM_METADATA = 697,
    OF_OXM_METADATA_MASKED = 698,
    OF_OXM_MPLS_BOS = 699,
    OF_OXM_MPLS_BOS_MASKED = 700,
    OF_OXM_MPLS_LABEL = 701,
    OF_OXM_MPLS_LABEL_MASKED = 702,
    OF_OXM_MPLS_TC = 703,
    OF_OXM_MPLS_TC_MASKED = 704,
    OF_OXM_OVS_TCP_FLAGS = 705,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 706,
    OF_OXM_PBB_UCA = 707,
    OF_OXM_PBB_UCA_MASKED = 708,
    OF_OXM_SCTP_DST = 709,
    OF_OXM_SCTP_DST_MASKED = 710,
    OF_OXM_SCTP_SRC = 711,
    OF_OXM_SCTP_SRC_MASKED = 712,
    OF_OXM_TCP_DST = 713,
    OF_OXM_TCP_DST_MASKED = 714,
    OF_OXM_TCP_SRC = 715,
    OF_OXM_TCP_SRC_MASKED = 716,
    OF_OXM_TUNNEL_ID = 717,
    OF_OXM_TUNNEL_ID_MASKED = 718,
    OF_OXM_TUNNEL_IPV4_DST = 719,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 720,
    OF_OXM_TUNNEL_IPV4_SRC = 721,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 722,
    OF_OXM_UDP_DST = 723,
    OF_OXM_UDP_DST_MASKED = 724,
    OF_OXM_UDP_SRC = 725,
    OF_OXM_UDP_SRC_MASKED = 726,
    OF_OXM_VLAN_PCP = 727,
    OF_OXM_VLAN_PCP_MASKED = 728,
    OF_OXM_VLAN_VID = 729,
    OF_OXM_VLAN_VID_MASKED = 730,
    OF_PACKET_QUEUE = 731,
    OF_PORT_DESC = 732,
    OF_PORT_DESC_PROP = 733,
    OF_PORT_DESC_PROP_BSN = 734,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 735,
    OF_PORT_DESC_PROP_BSN_DRIVER_INFO_JSON = 736,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 737,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 738,
    OF_PORT_DESC_PROP_BSN_MISC_CAPABILITIES = 739,
    OF_PORT_DESC_PROP_BSN_SFF_JSON = 740,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 741,
    OF_PORT_DESC_PROP_BSN_UPLINK = 742,
    OF_PORT_DESC_PROP_ETHERNET = 743,
    OF_PORT_DESC_PROP_EXPERIMENTER = 744,
    OF_PORT_DESC_PROP_OPTICAL = 745,
    OF_PORT_MOD_PROP = 746,
    OF_PORT_MOD_PROP_ETHERNET = 747,
    OF_PORT_MOD_PROP_EXPERIMENTER = 748,
    OF_PORT_MOD_PROP_OPTICAL = 749,
    OF_PORT_STATS_ENTRY = 750,
    OF_PORT_STATS_PROP = 751,
    OF_PORT_STATS_PROP_ETHERNET = 752,
    OF_PORT_STATS_PROP_EXPERIMENTER = 753,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 754,
    OF_PORT_STATS_PROP_OPTICAL = 755,
    OF_QUEUE_DESC = 756,
    OF_QUEUE_DESC_PROP = 757,
    OF_QUEUE_DESC_PROP_BSN = 758,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 759,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 760,
    OF_QUEUE_DESC_PROP_MAX_RATE = 761,
    OF_QUEUE_DESC_PROP_MIN_RATE = 762,
    OF_QUEUE_PROP = 763,
    OF_QUEUE_PROP_EXPERIMENTER = 764,
    OF_QUEUE_PROP_MAX_RATE = 765,
    OF_QUEUE_PROP_MIN_RATE = 766,
    OF_QUEUE_STATS_ENTRY = 767,
    OF_QUEUE_STATS_PROP = 768,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 769,
    OF_ROLE_PROP = 770,
    OF_ROLE_PROP_EXPERIMENTER = 771,
    OF_TABLE_DESC = 772,
    OF_TABLE_FEATURE_PROP = 773,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 774,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 775,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 776,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 777,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 778,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 779,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 780,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 781,
    OF_TABLE_FEATURE_PROP_MATCH = 782,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 783,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 784,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 785,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 786,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 787,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 788,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 789,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 790,
    OF_TABLE_FEATURES = 791,
    OF_TABLE_MOD_PROP = 792,
    OF_TABLE_MOD_PROP_EVICTION = 793,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 794,
    OF_TABLE_MOD_PROP_VACANCY = 795,
    OF_TABLE_STATS_ENTRY = 796,
    OF_UINT32 = 797,
    OF_UINT64 = 798,
    OF_UINT8 = 799,
    ...
    /* List objects */
    OF_LIST_ACTION = 800,
    OF_LIST_ACTION_ID = 801,
    OF_LIST_ASYNC_CONFIG_PROP = 802,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 803,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 804,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 805,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 806,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 807,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 808,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 809,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 810,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 811,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 812,
    OF_LIST_BSN_INTERFACE = 813,
    OF_LIST_BSN_LACP_STATS_ENTRY = 814,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 815,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 816,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 817,
    OF_LIST_BSN_TLV = 818,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 819,
    OF_LIST_BSN_VLAN_MAC = 820,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 821,
    OF_LIST_BUCKET = 822,
    OF_LIST_BUCKET_COUNTER = 823,
    OF_LIST_BUNDLE_PROP = 824,
    OF_LIST_FLOW_STATS_ENTRY = 825,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 826,
    OF_LIST_GROUP_STATS_ENTRY = 827,
    OF_LIST_HELLO_ELEM = 828,
    OF_LIST_INSTRUCTION = 829,
    OF_LIST_INSTRUCTION_ID = 830,
    OF_LIST_METER_BAND = 831,
    OF_LIST_METER_BAND_STATS = 832,
    OF_LIST_METER_CONFIG = 833,
    OF_LIST_METER_STATS = 834,
    OF_LIST_OXM = 835,
    OF_LIST_PACKET_QUEUE = 836,
    OF_LIST_PORT_DESC = 837,
    OF_LIST_PORT_DESC_PROP = 838,
    OF_LIST_PORT_MOD_PROP = 839,
    OF_LIST_PORT_STATS_ENTRY = 840,
    OF_LIST_PORT_STATS_PROP = 841,
    OF_LIST_QUEUE_DESC = 842,
    OF_LIST_QUEUE_DESC_PROP = 843,
    OF_LIST_QUEUE_PROP = 844,
    OF_LIST_QUEUE_STATS_ENTRY = 845,
    OF_LIST_QUEUE_STATS_PROP = 846,
    OF_LIST_ROLE_PROP = 847,
    OF_LIST_TABLE_DESC = 848,
    OF_LIST_TABLE_FEATURE_PROP = 849,
    OF_LIST_TABLE_FEATURES = 850,
    OF_LIST_TABLE_MOD_PROP = 851,
    OF_LIST_TABLE_STATS_ENTRY = 852,
    OF_LIST_UINT32 = 853,
    OF_LIST_UINT64 = 854,
    OF_LIST_UINT8 = 855,
