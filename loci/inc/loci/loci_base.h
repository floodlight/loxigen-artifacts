...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_HEADER = 241,
    OF_BSN_TLV_IDLE_NOTIFICATION = 242,
    OF_BSN_TLV_IDLE_TIME = 243,
    OF_BSN_TLV_IDLE_TIMEOUT = 244,
    OF_BSN_TLV_IPV4 = 245,
    OF_BSN_TLV_MAC = 246,
    OF_BSN_TLV_MISS_PACKETS = 247,
    OF_BSN_TLV_PORT = 248,
    OF_BSN_TLV_REPLY_PACKETS = 249,
    OF_BSN_TLV_REQUEST_PACKETS = 250,
    OF_BSN_TLV_RX_PACKETS = 251,
    OF_BSN_TLV_TX_PACKETS = 252,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 253,
    OF_BSN_TLV_VLAN_VID = 254,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 255,
    OF_BSN_VPORT = 256,
    OF_BSN_VPORT_HEADER = 257,
    OF_BSN_VPORT_Q_IN_Q = 258,
    OF_BUCKET = 259,
    OF_BUCKET_COUNTER = 260,
    OF_EXPERIMENTER_STATS_HEADER = 261,
    OF_FLOW_STATS_ENTRY = 262,
    OF_GROUP_DESC_STATS_ENTRY = 263,
    OF_GROUP_STATS_ENTRY = 264,
    OF_HEADER = 265,
    OF_HELLO_ELEM = 266,
    OF_HELLO_ELEM_HEADER = 267,
    OF_HELLO_ELEM_VERSIONBITMAP = 268,
    OF_INSTRUCTION = 269,
    OF_INSTRUCTION_APPLY_ACTIONS = 270,
    OF_INSTRUCTION_BSN = 271,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 272,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 273,
    OF_INSTRUCTION_CLEAR_ACTIONS = 274,
    OF_INSTRUCTION_EXPERIMENTER = 275,
    OF_INSTRUCTION_GOTO_TABLE = 276,
    OF_INSTRUCTION_HEADER = 277,
    OF_INSTRUCTION_ID = 278,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 279,
    OF_INSTRUCTION_ID_BSN = 280,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 281,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 282,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 283,
    OF_INSTRUCTION_ID_EXPERIMENTER = 284,
    OF_INSTRUCTION_ID_GOTO_TABLE = 285,
    OF_INSTRUCTION_ID_HEADER = 286,
    OF_INSTRUCTION_ID_METER = 287,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 288,
    OF_INSTRUCTION_ID_WRITE_METADATA = 289,
    OF_INSTRUCTION_METER = 290,
    OF_INSTRUCTION_WRITE_ACTIONS = 291,
    OF_INSTRUCTION_WRITE_METADATA = 292,
    OF_MATCH_V1 = 293,
    OF_MATCH_V2 = 294,
    OF_MATCH_V3 = 295,
    OF_METER_BAND = 296,
    OF_METER_BAND_DROP = 297,
    OF_METER_BAND_DSCP_REMARK = 298,
    OF_METER_BAND_EXPERIMENTER = 299,
    OF_METER_BAND_HEADER = 300,
    OF_METER_BAND_STATS = 301,
    OF_METER_CONFIG = 302,
    OF_METER_FEATURES = 303,
    OF_METER_STATS = 304,
    OF_OXM = 305,
    OF_OXM_ARP_OP = 306,
    OF_OXM_ARP_OP_MASKED = 307,
    OF_OXM_ARP_SHA = 308,
    OF_OXM_ARP_SHA_MASKED = 309,
    OF_OXM_ARP_SPA = 310,
    OF_OXM_ARP_SPA_MASKED = 311,
    OF_OXM_ARP_THA = 312,
    OF_OXM_ARP_THA_MASKED = 313,
    OF_OXM_ARP_TPA = 314,
    OF_OXM_ARP_TPA_MASKED = 315,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 316,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 317,
    OF_OXM_BSN_IN_PORTS_128 = 318,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 319,
    OF_OXM_BSN_L3_DST_CLASS_ID = 320,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 321,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 322,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 323,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 324,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 325,
    OF_OXM_BSN_LAG_ID = 326,
    OF_OXM_BSN_LAG_ID_MASKED = 327,
    OF_OXM_BSN_VRF = 328,
    OF_OXM_BSN_VRF_MASKED = 329,
    OF_OXM_ETH_DST = 330,
    OF_OXM_ETH_DST_MASKED = 331,
    OF_OXM_ETH_SRC = 332,
    OF_OXM_ETH_SRC_MASKED = 333,
    OF_OXM_ETH_TYPE = 334,
    OF_OXM_ETH_TYPE_MASKED = 335,
    OF_OXM_HEADER = 336,
    OF_OXM_ICMPV4_CODE = 337,
    OF_OXM_ICMPV4_CODE_MASKED = 338,
    OF_OXM_ICMPV4_TYPE = 339,
    OF_OXM_ICMPV4_TYPE_MASKED = 340,
    OF_OXM_ICMPV6_CODE = 341,
    OF_OXM_ICMPV6_CODE_MASKED = 342,
    OF_OXM_ICMPV6_TYPE = 343,
    OF_OXM_ICMPV6_TYPE_MASKED = 344,
    OF_OXM_IN_PHY_PORT = 345,
    OF_OXM_IN_PHY_PORT_MASKED = 346,
    OF_OXM_IN_PORT = 347,
    OF_OXM_IN_PORT_MASKED = 348,
    OF_OXM_IP_DSCP = 349,
    OF_OXM_IP_DSCP_MASKED = 350,
    OF_OXM_IP_ECN = 351,
    OF_OXM_IP_ECN_MASKED = 352,
    OF_OXM_IP_PROTO = 353,
    OF_OXM_IP_PROTO_MASKED = 354,
    OF_OXM_IPV4_DST = 355,
    OF_OXM_IPV4_DST_MASKED = 356,
    OF_OXM_IPV4_SRC = 357,
    OF_OXM_IPV4_SRC_MASKED = 358,
    OF_OXM_IPV6_DST = 359,
    OF_OXM_IPV6_DST_MASKED = 360,
    OF_OXM_IPV6_FLABEL = 361,
    OF_OXM_IPV6_FLABEL_MASKED = 362,
    OF_OXM_IPV6_ND_SLL = 363,
    OF_OXM_IPV6_ND_SLL_MASKED = 364,
    OF_OXM_IPV6_ND_TARGET = 365,
    OF_OXM_IPV6_ND_TARGET_MASKED = 366,
    OF_OXM_IPV6_ND_TLL = 367,
    OF_OXM_IPV6_ND_TLL_MASKED = 368,
    OF_OXM_IPV6_SRC = 369,
    OF_OXM_IPV6_SRC_MASKED = 370,
    OF_OXM_METADATA = 371,
    OF_OXM_METADATA_MASKED = 372,
    OF_OXM_MPLS_LABEL = 373,
    OF_OXM_MPLS_LABEL_MASKED = 374,
    OF_OXM_MPLS_TC = 375,
    OF_OXM_MPLS_TC_MASKED = 376,
    OF_OXM_SCTP_DST = 377,
    OF_OXM_SCTP_DST_MASKED = 378,
    OF_OXM_SCTP_SRC = 379,
    OF_OXM_SCTP_SRC_MASKED = 380,
    OF_OXM_TCP_DST = 381,
    OF_OXM_TCP_DST_MASKED = 382,
    OF_OXM_TCP_SRC = 383,
    OF_OXM_TCP_SRC_MASKED = 384,
    OF_OXM_UDP_DST = 385,
    OF_OXM_UDP_DST_MASKED = 386,
    OF_OXM_UDP_SRC = 387,
    OF_OXM_UDP_SRC_MASKED = 388,
    OF_OXM_VLAN_PCP = 389,
    OF_OXM_VLAN_PCP_MASKED = 390,
    OF_OXM_VLAN_VID = 391,
    OF_OXM_VLAN_VID_MASKED = 392,
    OF_PACKET_QUEUE = 393,
    OF_PORT_DESC = 394,
    OF_PORT_STATS_ENTRY = 395,
    OF_QUEUE_PROP = 396,
    OF_QUEUE_PROP_EXPERIMENTER = 397,
    OF_QUEUE_PROP_HEADER = 398,
    OF_QUEUE_PROP_MAX_RATE = 399,
    OF_QUEUE_PROP_MIN_RATE = 400,
    OF_QUEUE_STATS_ENTRY = 401,
    OF_TABLE_FEATURE_PROP = 402,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 403,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 404,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 405,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 406,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 407,
    OF_TABLE_FEATURE_PROP_HEADER = 408,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 409,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 410,
    OF_TABLE_FEATURE_PROP_MATCH = 411,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 412,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 413,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 414,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 415,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 416,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 417,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 418,
    OF_TABLE_FEATURES = 419,
    OF_TABLE_STATS_ENTRY = 420,
    OF_UINT32 = 421,
    OF_UINT64 = 422,
    OF_UINT8 = 423,
    ...
    /* List objects */
    OF_LIST_ACTION = 424,
    OF_LIST_ACTION_ID = 425,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 426,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 427,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 428,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 429,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 430,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 431,
    OF_LIST_BSN_INTERFACE = 432,
    OF_LIST_BSN_LACP_STATS_ENTRY = 433,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 434,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 435,
    OF_LIST_BSN_TLV = 436,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 437,
    OF_LIST_BUCKET = 438,
    OF_LIST_BUCKET_COUNTER = 439,
    OF_LIST_FLOW_STATS_ENTRY = 440,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 441,
    OF_LIST_GROUP_STATS_ENTRY = 442,
    OF_LIST_HELLO_ELEM = 443,
    OF_LIST_INSTRUCTION = 444,
    OF_LIST_METER_BAND = 445,
    OF_LIST_METER_BAND_STATS = 446,
    OF_LIST_METER_STATS = 447,
    OF_LIST_OXM = 448,
    OF_LIST_PACKET_QUEUE = 449,
    OF_LIST_PORT_DESC = 450,
    OF_LIST_PORT_STATS_ENTRY = 451,
    OF_LIST_QUEUE_PROP = 452,
    OF_LIST_QUEUE_STATS_ENTRY = 453,
    OF_LIST_TABLE_FEATURE_PROP = 454,
    OF_LIST_TABLE_FEATURES = 455,
    OF_LIST_TABLE_STATS_ENTRY = 456,
    OF_LIST_UINT32 = 457,
    OF_LIST_UINT64 = 458,
    OF_LIST_UINT8 = 459,
