...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_ETH_DST = 325,
    OF_BSN_TLV_ETH_SRC = 326,
    OF_BSN_TLV_ETH_TYPE = 327,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 328,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 329,
    OF_BSN_TLV_EXTERNAL_IP = 330,
    OF_BSN_TLV_EXTERNAL_MAC = 331,
    OF_BSN_TLV_EXTERNAL_NETMASK = 332,
    OF_BSN_TLV_GENERATION_ID = 333,
    OF_BSN_TLV_HASH_GTP_HEADER_MATCH = 334,
    OF_BSN_TLV_HASH_GTP_PORT_MATCH = 335,
    OF_BSN_TLV_HASH_PACKET_FIELD = 336,
    OF_BSN_TLV_HASH_PACKET_TYPE = 337,
    OF_BSN_TLV_HASH_SEED = 338,
    OF_BSN_TLV_HASH_TYPE = 339,
    OF_BSN_TLV_HEADER_SIZE = 340,
    OF_BSN_TLV_ICMP_CODE = 341,
    OF_BSN_TLV_ICMP_ID = 342,
    OF_BSN_TLV_ICMP_TYPE = 343,
    OF_BSN_TLV_ICMPV6_CHKSUM = 344,
    OF_BSN_TLV_IDLE_NOTIFICATION = 345,
    OF_BSN_TLV_IDLE_TIME = 346,
    OF_BSN_TLV_IDLE_TIMEOUT = 347,
    OF_BSN_TLV_IGMP_SNOOPING = 348,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 349,
    OF_BSN_TLV_INTERNAL_MAC = 350,
    OF_BSN_TLV_INTERVAL = 351,
    OF_BSN_TLV_IP_PROTO = 352,
    OF_BSN_TLV_IPV4 = 353,
    OF_BSN_TLV_IPV4_DST = 354,
    OF_BSN_TLV_IPV4_NETMASK = 355,
    OF_BSN_TLV_IPV4_SRC = 356,
    OF_BSN_TLV_IPV6 = 357,
    OF_BSN_TLV_IPV6_DST = 358,
    OF_BSN_TLV_IPV6_PREFIX = 359,
    OF_BSN_TLV_IPV6_SRC = 360,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 361,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 362,
    OF_BSN_TLV_L3_DST_CLASS_ID = 363,
    OF_BSN_TLV_L3_INTERFACE_CLASS_ID = 364,
    OF_BSN_TLV_L3_SRC_CLASS_ID = 365,
    OF_BSN_TLV_LOOPBACK_PORT = 366,
    OF_BSN_TLV_MAC = 367,
    OF_BSN_TLV_MAC_MASK = 368,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 369,
    OF_BSN_TLV_MISS_PACKETS = 370,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 371,
    OF_BSN_TLV_MPLS_LABEL = 372,
    OF_BSN_TLV_MPLS_SEQUENCED = 373,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 374,
    OF_BSN_TLV_NAME = 375,
    OF_BSN_TLV_NDP_OFFLOAD = 376,
    OF_BSN_TLV_NDP_STATIC = 377,
    OF_BSN_TLV_NEGATE = 378,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 379,
    OF_BSN_TLV_NEXT_HOP_MAC = 380,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 381,
    OF_BSN_TLV_OFFSET = 382,
    OF_BSN_TLV_PARENT_PORT = 383,
    OF_BSN_TLV_PARTNER_KEY = 384,
    OF_BSN_TLV_PARTNER_PORT_NUM = 385,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 386,
    OF_BSN_TLV_PARTNER_STATE = 387,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 388,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 389,
    OF_BSN_TLV_PORT = 390,
    OF_BSN_TLV_PORT_VXLAN_MODE = 391,
    OF_BSN_TLV_PRIORITY = 392,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 393,
    OF_BSN_TLV_QOS_PRIORITY = 394,
    OF_BSN_TLV_QUEUE_ID = 395,
    OF_BSN_TLV_QUEUE_WEIGHT = 396,
    OF_BSN_TLV_RATE_LIMIT = 397,
    OF_BSN_TLV_RATE_UNIT = 398,
    OF_BSN_TLV_REFERENCE = 399,
    OF_BSN_TLV_REPLY_PACKETS = 400,
    OF_BSN_TLV_REQUEST_PACKETS = 401,
    OF_BSN_TLV_RX_BYTES = 402,
    OF_BSN_TLV_RX_PACKETS = 403,
    OF_BSN_TLV_SAMPLING_RATE = 404,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 405,
    OF_BSN_TLV_STATUS = 406,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 407,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 408,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 409,
    OF_BSN_TLV_SUB_AGENT_ID = 410,
    OF_BSN_TLV_TCP_DST = 411,
    OF_BSN_TLV_TCP_FLAGS = 412,
    OF_BSN_TLV_TCP_SRC = 413,
    OF_BSN_TLV_TTL = 414,
    OF_BSN_TLV_TX_BYTES = 415,
    OF_BSN_TLV_TX_PACKETS = 416,
    OF_BSN_TLV_UDF_ANCHOR = 417,
    OF_BSN_TLV_UDF_ID = 418,
    OF_BSN_TLV_UDF_LENGTH = 419,
    OF_BSN_TLV_UDF_OFFSET = 420,
    OF_BSN_TLV_UDP_DST = 421,
    OF_BSN_TLV_UDP_SRC = 422,
    OF_BSN_TLV_UINT64_LIST = 423,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 424,
    OF_BSN_TLV_UNICAST_RATE = 425,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 426,
    OF_BSN_TLV_UNTAGGED = 427,
    OF_BSN_TLV_USE_PACKET_STATE = 428,
    OF_BSN_TLV_VFI = 429,
    OF_BSN_TLV_VFP_CLASS_ID = 430,
    OF_BSN_TLV_VLAN_MAC_LIST = 431,
    OF_BSN_TLV_VLAN_PCP = 432,
    OF_BSN_TLV_VLAN_VID = 433,
    OF_BSN_TLV_VLAN_VID_MASK = 434,
    OF_BSN_TLV_VNI = 435,
    OF_BSN_TLV_VPN_KEY = 436,
    OF_BSN_TLV_VRF = 437,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 438,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 439,
    OF_BSN_VLAN_MAC = 440,
    OF_BSN_VPORT = 441,
    OF_BSN_VPORT_L2GRE = 442,
    OF_BSN_VPORT_Q_IN_Q = 443,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 444,
    OF_BUCKET = 445,
    OF_BUCKET_COUNTER = 446,
    OF_BUNDLE_PROP = 447,
    OF_BUNDLE_PROP_EXPERIMENTER = 448,
    OF_FLOW_STATS_ENTRY = 449,
    OF_GROUP_DESC_STATS_ENTRY = 450,
    OF_GROUP_STATS_ENTRY = 451,
    OF_HELLO_ELEM = 452,
    OF_HELLO_ELEM_VERSIONBITMAP = 453,
    OF_INSTRUCTION = 454,
    OF_INSTRUCTION_APPLY_ACTIONS = 455,
    OF_INSTRUCTION_BSN = 456,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 457,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 458,
    OF_INSTRUCTION_BSN_DENY = 459,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 460,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 461,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 462,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 463,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 464,
    OF_INSTRUCTION_BSN_HASH_SELECT = 465,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 466,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 467,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 468,
    OF_INSTRUCTION_BSN_PERMIT = 469,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 470,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 471,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 472,
    OF_INSTRUCTION_CLEAR_ACTIONS = 473,
    OF_INSTRUCTION_EXPERIMENTER = 474,
    OF_INSTRUCTION_GOTO_TABLE = 475,
    OF_INSTRUCTION_ID = 476,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 477,
    OF_INSTRUCTION_ID_BSN = 478,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 479,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 480,
    OF_INSTRUCTION_ID_BSN_DENY = 481,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 482,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 483,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 484,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 485,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 486,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 487,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 488,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 489,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 490,
    OF_INSTRUCTION_ID_BSN_PERMIT = 491,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 492,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 493,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 494,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 495,
    OF_INSTRUCTION_ID_EXPERIMENTER = 496,
    OF_INSTRUCTION_ID_GOTO_TABLE = 497,
    OF_INSTRUCTION_ID_METER = 498,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 499,
    OF_INSTRUCTION_ID_WRITE_METADATA = 500,
    OF_INSTRUCTION_METER = 501,
    OF_INSTRUCTION_WRITE_ACTIONS = 502,
    OF_INSTRUCTION_WRITE_METADATA = 503,
    OF_MATCH_V1 = 504,
    OF_MATCH_V2 = 505,
    OF_MATCH_V3 = 506,
    OF_METER_BAND = 507,
    OF_METER_BAND_DROP = 508,
    OF_METER_BAND_DSCP_REMARK = 509,
    OF_METER_BAND_EXPERIMENTER = 510,
    OF_METER_BAND_STATS = 511,
    OF_METER_CONFIG = 512,
    OF_METER_FEATURES = 513,
    OF_METER_STATS = 514,
    OF_OXM = 515,
    OF_OXM_ARP_OP = 516,
    OF_OXM_ARP_OP_MASKED = 517,
    OF_OXM_ARP_SHA = 518,
    OF_OXM_ARP_SHA_MASKED = 519,
    OF_OXM_ARP_SPA = 520,
    OF_OXM_ARP_SPA_MASKED = 521,
    OF_OXM_ARP_THA = 522,
    OF_OXM_ARP_THA_MASKED = 523,
    OF_OXM_ARP_TPA = 524,
    OF_OXM_ARP_TPA_MASKED = 525,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 526,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 527,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 528,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 529,
    OF_OXM_BSN_IN_PORTS_128 = 530,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 531,
    OF_OXM_BSN_IN_PORTS_512 = 532,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 533,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 534,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 535,
    OF_OXM_BSN_INNER_ETH_DST = 536,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 537,
    OF_OXM_BSN_INNER_ETH_SRC = 538,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 539,
    OF_OXM_BSN_INNER_VLAN_VID = 540,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 541,
    OF_OXM_BSN_L2_CACHE_HIT = 542,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 543,
    OF_OXM_BSN_L3_DST_CLASS_ID = 544,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 545,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 546,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 547,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 548,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 549,
    OF_OXM_BSN_LAG_ID = 550,
    OF_OXM_BSN_LAG_ID_MASKED = 551,
    OF_OXM_BSN_TCP_FLAGS = 552,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 553,
    OF_OXM_BSN_UDF0 = 554,
    OF_OXM_BSN_UDF0_MASKED = 555,
    OF_OXM_BSN_UDF1 = 556,
    OF_OXM_BSN_UDF1_MASKED = 557,
    OF_OXM_BSN_UDF2 = 558,
    OF_OXM_BSN_UDF2_MASKED = 559,
    OF_OXM_BSN_UDF3 = 560,
    OF_OXM_BSN_UDF3_MASKED = 561,
    OF_OXM_BSN_UDF4 = 562,
    OF_OXM_BSN_UDF4_MASKED = 563,
    OF_OXM_BSN_UDF5 = 564,
    OF_OXM_BSN_UDF5_MASKED = 565,
    OF_OXM_BSN_UDF6 = 566,
    OF_OXM_BSN_UDF6_MASKED = 567,
    OF_OXM_BSN_UDF7 = 568,
    OF_OXM_BSN_UDF7_MASKED = 569,
    OF_OXM_BSN_VFI = 570,
    OF_OXM_BSN_VFI_MASKED = 571,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 572,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 573,
    OF_OXM_BSN_VRF = 574,
    OF_OXM_BSN_VRF_MASKED = 575,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 576,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 577,
    OF_OXM_ETH_DST = 578,
    OF_OXM_ETH_DST_MASKED = 579,
    OF_OXM_ETH_SRC = 580,
    OF_OXM_ETH_SRC_MASKED = 581,
    OF_OXM_ETH_TYPE = 582,
    OF_OXM_ETH_TYPE_MASKED = 583,
    OF_OXM_ICMPV4_CODE = 584,
    OF_OXM_ICMPV4_CODE_MASKED = 585,
    OF_OXM_ICMPV4_TYPE = 586,
    OF_OXM_ICMPV4_TYPE_MASKED = 587,
    OF_OXM_ICMPV6_CODE = 588,
    OF_OXM_ICMPV6_CODE_MASKED = 589,
    OF_OXM_ICMPV6_TYPE = 590,
    OF_OXM_ICMPV6_TYPE_MASKED = 591,
    OF_OXM_IN_PHY_PORT = 592,
    OF_OXM_IN_PHY_PORT_MASKED = 593,
    OF_OXM_IN_PORT = 594,
    OF_OXM_IN_PORT_MASKED = 595,
    OF_OXM_IP_DSCP = 596,
    OF_OXM_IP_DSCP_MASKED = 597,
    OF_OXM_IP_ECN = 598,
    OF_OXM_IP_ECN_MASKED = 599,
    OF_OXM_IP_PROTO = 600,
    OF_OXM_IP_PROTO_MASKED = 601,
    OF_OXM_IPV4_DST = 602,
    OF_OXM_IPV4_DST_MASKED = 603,
    OF_OXM_IPV4_SRC = 604,
    OF_OXM_IPV4_SRC_MASKED = 605,
    OF_OXM_IPV6_DST = 606,
    OF_OXM_IPV6_DST_MASKED = 607,
    OF_OXM_IPV6_EXTHDR = 608,
    OF_OXM_IPV6_EXTHDR_MASKED = 609,
    OF_OXM_IPV6_FLABEL = 610,
    OF_OXM_IPV6_FLABEL_MASKED = 611,
    OF_OXM_IPV6_ND_SLL = 612,
    OF_OXM_IPV6_ND_SLL_MASKED = 613,
    OF_OXM_IPV6_ND_TARGET = 614,
    OF_OXM_IPV6_ND_TARGET_MASKED = 615,
    OF_OXM_IPV6_ND_TLL = 616,
    OF_OXM_IPV6_ND_TLL_MASKED = 617,
    OF_OXM_IPV6_SRC = 618,
    OF_OXM_IPV6_SRC_MASKED = 619,
    OF_OXM_METADATA = 620,
    OF_OXM_METADATA_MASKED = 621,
    OF_OXM_MPLS_BOS = 622,
    OF_OXM_MPLS_BOS_MASKED = 623,
    OF_OXM_MPLS_LABEL = 624,
    OF_OXM_MPLS_LABEL_MASKED = 625,
    OF_OXM_MPLS_TC = 626,
    OF_OXM_MPLS_TC_MASKED = 627,
    OF_OXM_OVS_TCP_FLAGS = 628,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 629,
    OF_OXM_PBB_UCA = 630,
    OF_OXM_PBB_UCA_MASKED = 631,
    OF_OXM_SCTP_DST = 632,
    OF_OXM_SCTP_DST_MASKED = 633,
    OF_OXM_SCTP_SRC = 634,
    OF_OXM_SCTP_SRC_MASKED = 635,
    OF_OXM_TCP_DST = 636,
    OF_OXM_TCP_DST_MASKED = 637,
    OF_OXM_TCP_SRC = 638,
    OF_OXM_TCP_SRC_MASKED = 639,
    OF_OXM_TUNNEL_ID = 640,
    OF_OXM_TUNNEL_ID_MASKED = 641,
    OF_OXM_TUNNEL_IPV4_DST = 642,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 643,
    OF_OXM_TUNNEL_IPV4_SRC = 644,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 645,
    OF_OXM_UDP_DST = 646,
    OF_OXM_UDP_DST_MASKED = 647,
    OF_OXM_UDP_SRC = 648,
    OF_OXM_UDP_SRC_MASKED = 649,
    OF_OXM_VLAN_PCP = 650,
    OF_OXM_VLAN_PCP_MASKED = 651,
    OF_OXM_VLAN_VID = 652,
    OF_OXM_VLAN_VID_MASKED = 653,
    OF_PACKET_QUEUE = 654,
    OF_PORT_DESC = 655,
    OF_PORT_DESC_PROP = 656,
    OF_PORT_DESC_PROP_BSN = 657,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 658,
    OF_PORT_DESC_PROP_BSN_UPLINK = 659,
    OF_PORT_DESC_PROP_ETHERNET = 660,
    OF_PORT_DESC_PROP_EXPERIMENTER = 661,
    OF_PORT_DESC_PROP_OPTICAL = 662,
    OF_PORT_MOD_PROP = 663,
    OF_PORT_MOD_PROP_ETHERNET = 664,
    OF_PORT_MOD_PROP_EXPERIMENTER = 665,
    OF_PORT_MOD_PROP_OPTICAL = 666,
    OF_PORT_STATS_ENTRY = 667,
    OF_PORT_STATS_PROP = 668,
    OF_PORT_STATS_PROP_ETHERNET = 669,
    OF_PORT_STATS_PROP_EXPERIMENTER = 670,
    OF_PORT_STATS_PROP_OPTICAL = 671,
    OF_QUEUE_DESC = 672,
    OF_QUEUE_DESC_PROP = 673,
    OF_QUEUE_DESC_PROP_BSN = 674,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 675,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 676,
    OF_QUEUE_DESC_PROP_MAX_RATE = 677,
    OF_QUEUE_DESC_PROP_MIN_RATE = 678,
    OF_QUEUE_PROP = 679,
    OF_QUEUE_PROP_EXPERIMENTER = 680,
    OF_QUEUE_PROP_MAX_RATE = 681,
    OF_QUEUE_PROP_MIN_RATE = 682,
    OF_QUEUE_STATS_ENTRY = 683,
    OF_QUEUE_STATS_PROP = 684,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 685,
    OF_ROLE_PROP = 686,
    OF_ROLE_PROP_EXPERIMENTER = 687,
    OF_TABLE_DESC = 688,
    OF_TABLE_FEATURE_PROP = 689,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 690,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 691,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 692,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 693,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 694,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 695,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 696,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 697,
    OF_TABLE_FEATURE_PROP_MATCH = 698,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 699,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 700,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 701,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 702,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 703,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 704,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 705,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 706,
    OF_TABLE_FEATURES = 707,
    OF_TABLE_MOD_PROP = 708,
    OF_TABLE_MOD_PROP_EVICTION = 709,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 710,
    OF_TABLE_MOD_PROP_VACANCY = 711,
    OF_TABLE_STATS_ENTRY = 712,
    OF_UINT32 = 713,
    OF_UINT64 = 714,
    OF_UINT8 = 715,
    ...
    /* List objects */
    OF_LIST_ACTION = 716,
    OF_LIST_ACTION_ID = 717,
    OF_LIST_ASYNC_CONFIG_PROP = 718,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 719,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 720,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 721,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 722,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 723,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 724,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 725,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 726,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 727,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 728,
    OF_LIST_BSN_INTERFACE = 729,
    OF_LIST_BSN_LACP_STATS_ENTRY = 730,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 731,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 732,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 733,
    OF_LIST_BSN_TLV = 734,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 735,
    OF_LIST_BSN_VLAN_MAC = 736,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 737,
    OF_LIST_BUCKET = 738,
    OF_LIST_BUCKET_COUNTER = 739,
    OF_LIST_BUNDLE_PROP = 740,
    OF_LIST_FLOW_STATS_ENTRY = 741,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 742,
    OF_LIST_GROUP_STATS_ENTRY = 743,
    OF_LIST_HELLO_ELEM = 744,
    OF_LIST_INSTRUCTION = 745,
    OF_LIST_INSTRUCTION_ID = 746,
    OF_LIST_METER_BAND = 747,
    OF_LIST_METER_BAND_STATS = 748,
    OF_LIST_METER_CONFIG = 749,
    OF_LIST_METER_STATS = 750,
    OF_LIST_OXM = 751,
    OF_LIST_PACKET_QUEUE = 752,
    OF_LIST_PORT_DESC = 753,
    OF_LIST_PORT_DESC_PROP = 754,
    OF_LIST_PORT_MOD_PROP = 755,
    OF_LIST_PORT_STATS_ENTRY = 756,
    OF_LIST_PORT_STATS_PROP = 757,
    OF_LIST_QUEUE_DESC = 758,
    OF_LIST_QUEUE_DESC_PROP = 759,
    OF_LIST_QUEUE_PROP = 760,
    OF_LIST_QUEUE_STATS_ENTRY = 761,
    OF_LIST_QUEUE_STATS_PROP = 762,
    OF_LIST_ROLE_PROP = 763,
    OF_LIST_TABLE_DESC = 764,
    OF_LIST_TABLE_FEATURE_PROP = 765,
    OF_LIST_TABLE_FEATURES = 766,
    OF_LIST_TABLE_MOD_PROP = 767,
    OF_LIST_TABLE_STATS_ENTRY = 768,
    OF_LIST_UINT32 = 769,
    OF_LIST_UINT64 = 770,
    OF_LIST_UINT8 = 771,
