...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_HASH_PACKET_FIELD = 325,
    OF_BSN_TLV_HASH_PACKET_TYPE = 326,
    OF_BSN_TLV_HASH_SEED = 327,
    OF_BSN_TLV_HASH_TYPE = 328,
    OF_BSN_TLV_HEADER_SIZE = 329,
    OF_BSN_TLV_ICMP_CODE = 330,
    OF_BSN_TLV_ICMP_ID = 331,
    OF_BSN_TLV_ICMP_TYPE = 332,
    OF_BSN_TLV_IDLE_NOTIFICATION = 333,
    OF_BSN_TLV_IDLE_TIME = 334,
    OF_BSN_TLV_IDLE_TIMEOUT = 335,
    OF_BSN_TLV_IGMP_SNOOPING = 336,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 337,
    OF_BSN_TLV_INTERNAL_MAC = 338,
    OF_BSN_TLV_INTERVAL = 339,
    OF_BSN_TLV_IP_PROTO = 340,
    OF_BSN_TLV_IPV4 = 341,
    OF_BSN_TLV_IPV4_DST = 342,
    OF_BSN_TLV_IPV4_NETMASK = 343,
    OF_BSN_TLV_IPV4_SRC = 344,
    OF_BSN_TLV_IPV6 = 345,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 346,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 347,
    OF_BSN_TLV_MAC = 348,
    OF_BSN_TLV_MAC_MASK = 349,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 350,
    OF_BSN_TLV_MISS_PACKETS = 351,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 352,
    OF_BSN_TLV_MPLS_LABEL = 353,
    OF_BSN_TLV_MPLS_SEQUENCED = 354,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 355,
    OF_BSN_TLV_NAME = 356,
    OF_BSN_TLV_NEGATE = 357,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 358,
    OF_BSN_TLV_OFFSET = 359,
    OF_BSN_TLV_PARTNER_KEY = 360,
    OF_BSN_TLV_PARTNER_PORT_NUM = 361,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 362,
    OF_BSN_TLV_PARTNER_STATE = 363,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 364,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 365,
    OF_BSN_TLV_PORT = 366,
    OF_BSN_TLV_PORT_VXLAN_MODE = 367,
    OF_BSN_TLV_PRIORITY = 368,
    OF_BSN_TLV_QUEUE_ID = 369,
    OF_BSN_TLV_QUEUE_WEIGHT = 370,
    OF_BSN_TLV_RATE_UNIT = 371,
    OF_BSN_TLV_REFERENCE = 372,
    OF_BSN_TLV_REPLY_PACKETS = 373,
    OF_BSN_TLV_REQUEST_PACKETS = 374,
    OF_BSN_TLV_RX_BYTES = 375,
    OF_BSN_TLV_RX_PACKETS = 376,
    OF_BSN_TLV_SAMPLING_RATE = 377,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 378,
    OF_BSN_TLV_STATUS = 379,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 380,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 381,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 382,
    OF_BSN_TLV_SUB_AGENT_ID = 383,
    OF_BSN_TLV_TCP_DST = 384,
    OF_BSN_TLV_TCP_SRC = 385,
    OF_BSN_TLV_TX_BYTES = 386,
    OF_BSN_TLV_TX_PACKETS = 387,
    OF_BSN_TLV_UDF_ANCHOR = 388,
    OF_BSN_TLV_UDF_ID = 389,
    OF_BSN_TLV_UDF_LENGTH = 390,
    OF_BSN_TLV_UDF_OFFSET = 391,
    OF_BSN_TLV_UDP_DST = 392,
    OF_BSN_TLV_UDP_SRC = 393,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 394,
    OF_BSN_TLV_UNICAST_RATE = 395,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 396,
    OF_BSN_TLV_USE_PACKET_STATE = 397,
    OF_BSN_TLV_VFI = 398,
    OF_BSN_TLV_VLAN_MAC_LIST = 399,
    OF_BSN_TLV_VLAN_PCP = 400,
    OF_BSN_TLV_VLAN_VID = 401,
    OF_BSN_TLV_VLAN_VID_MASK = 402,
    OF_BSN_TLV_VNI = 403,
    OF_BSN_TLV_VRF = 404,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 405,
    OF_BSN_VLAN_MAC = 406,
    OF_BSN_VPORT = 407,
    OF_BSN_VPORT_L2GRE = 408,
    OF_BSN_VPORT_Q_IN_Q = 409,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 410,
    OF_BUCKET = 411,
    OF_BUCKET_COUNTER = 412,
    OF_BUNDLE_PROP = 413,
    OF_BUNDLE_PROP_EXPERIMENTER = 414,
    OF_FLOW_STATS_ENTRY = 415,
    OF_GROUP_DESC_STATS_ENTRY = 416,
    OF_GROUP_STATS_ENTRY = 417,
    OF_HELLO_ELEM = 418,
    OF_HELLO_ELEM_VERSIONBITMAP = 419,
    OF_INSTRUCTION = 420,
    OF_INSTRUCTION_APPLY_ACTIONS = 421,
    OF_INSTRUCTION_BSN = 422,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 423,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 424,
    OF_INSTRUCTION_BSN_DENY = 425,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 426,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 427,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 428,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 429,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 430,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 431,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 432,
    OF_INSTRUCTION_BSN_PERMIT = 433,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 434,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 435,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 436,
    OF_INSTRUCTION_CLEAR_ACTIONS = 437,
    OF_INSTRUCTION_EXPERIMENTER = 438,
    OF_INSTRUCTION_GOTO_TABLE = 439,
    OF_INSTRUCTION_ID = 440,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 441,
    OF_INSTRUCTION_ID_BSN = 442,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 443,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 444,
    OF_INSTRUCTION_ID_BSN_DENY = 445,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 446,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 447,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 448,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 449,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 450,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 451,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 452,
    OF_INSTRUCTION_ID_BSN_PERMIT = 453,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 454,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 455,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 456,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 457,
    OF_INSTRUCTION_ID_EXPERIMENTER = 458,
    OF_INSTRUCTION_ID_GOTO_TABLE = 459,
    OF_INSTRUCTION_ID_METER = 460,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 461,
    OF_INSTRUCTION_ID_WRITE_METADATA = 462,
    OF_INSTRUCTION_METER = 463,
    OF_INSTRUCTION_WRITE_ACTIONS = 464,
    OF_INSTRUCTION_WRITE_METADATA = 465,
    OF_MATCH_V1 = 466,
    OF_MATCH_V2 = 467,
    OF_MATCH_V3 = 468,
    OF_METER_BAND = 469,
    OF_METER_BAND_DROP = 470,
    OF_METER_BAND_DSCP_REMARK = 471,
    OF_METER_BAND_EXPERIMENTER = 472,
    OF_METER_BAND_STATS = 473,
    OF_METER_CONFIG = 474,
    OF_METER_FEATURES = 475,
    OF_METER_STATS = 476,
    OF_OXM = 477,
    OF_OXM_ARP_OP = 478,
    OF_OXM_ARP_OP_MASKED = 479,
    OF_OXM_ARP_SHA = 480,
    OF_OXM_ARP_SHA_MASKED = 481,
    OF_OXM_ARP_SPA = 482,
    OF_OXM_ARP_SPA_MASKED = 483,
    OF_OXM_ARP_THA = 484,
    OF_OXM_ARP_THA_MASKED = 485,
    OF_OXM_ARP_TPA = 486,
    OF_OXM_ARP_TPA_MASKED = 487,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 488,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 489,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 490,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 491,
    OF_OXM_BSN_IN_PORTS_128 = 492,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 493,
    OF_OXM_BSN_IN_PORTS_512 = 494,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 495,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 496,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 497,
    OF_OXM_BSN_INNER_ETH_DST = 498,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 499,
    OF_OXM_BSN_INNER_ETH_SRC = 500,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 501,
    OF_OXM_BSN_INNER_VLAN_VID = 502,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 503,
    OF_OXM_BSN_L2_CACHE_HIT = 504,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 505,
    OF_OXM_BSN_L3_DST_CLASS_ID = 506,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 507,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 508,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 509,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 510,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 511,
    OF_OXM_BSN_LAG_ID = 512,
    OF_OXM_BSN_LAG_ID_MASKED = 513,
    OF_OXM_BSN_TCP_FLAGS = 514,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 515,
    OF_OXM_BSN_UDF0 = 516,
    OF_OXM_BSN_UDF0_MASKED = 517,
    OF_OXM_BSN_UDF1 = 518,
    OF_OXM_BSN_UDF1_MASKED = 519,
    OF_OXM_BSN_UDF2 = 520,
    OF_OXM_BSN_UDF2_MASKED = 521,
    OF_OXM_BSN_UDF3 = 522,
    OF_OXM_BSN_UDF3_MASKED = 523,
    OF_OXM_BSN_UDF4 = 524,
    OF_OXM_BSN_UDF4_MASKED = 525,
    OF_OXM_BSN_UDF5 = 526,
    OF_OXM_BSN_UDF5_MASKED = 527,
    OF_OXM_BSN_UDF6 = 528,
    OF_OXM_BSN_UDF6_MASKED = 529,
    OF_OXM_BSN_UDF7 = 530,
    OF_OXM_BSN_UDF7_MASKED = 531,
    OF_OXM_BSN_VFI = 532,
    OF_OXM_BSN_VFI_MASKED = 533,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 534,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 535,
    OF_OXM_BSN_VRF = 536,
    OF_OXM_BSN_VRF_MASKED = 537,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 538,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 539,
    OF_OXM_ETH_DST = 540,
    OF_OXM_ETH_DST_MASKED = 541,
    OF_OXM_ETH_SRC = 542,
    OF_OXM_ETH_SRC_MASKED = 543,
    OF_OXM_ETH_TYPE = 544,
    OF_OXM_ETH_TYPE_MASKED = 545,
    OF_OXM_ICMPV4_CODE = 546,
    OF_OXM_ICMPV4_CODE_MASKED = 547,
    OF_OXM_ICMPV4_TYPE = 548,
    OF_OXM_ICMPV4_TYPE_MASKED = 549,
    OF_OXM_ICMPV6_CODE = 550,
    OF_OXM_ICMPV6_CODE_MASKED = 551,
    OF_OXM_ICMPV6_TYPE = 552,
    OF_OXM_ICMPV6_TYPE_MASKED = 553,
    OF_OXM_IN_PHY_PORT = 554,
    OF_OXM_IN_PHY_PORT_MASKED = 555,
    OF_OXM_IN_PORT = 556,
    OF_OXM_IN_PORT_MASKED = 557,
    OF_OXM_IP_DSCP = 558,
    OF_OXM_IP_DSCP_MASKED = 559,
    OF_OXM_IP_ECN = 560,
    OF_OXM_IP_ECN_MASKED = 561,
    OF_OXM_IP_PROTO = 562,
    OF_OXM_IP_PROTO_MASKED = 563,
    OF_OXM_IPV4_DST = 564,
    OF_OXM_IPV4_DST_MASKED = 565,
    OF_OXM_IPV4_SRC = 566,
    OF_OXM_IPV4_SRC_MASKED = 567,
    OF_OXM_IPV6_DST = 568,
    OF_OXM_IPV6_DST_MASKED = 569,
    OF_OXM_IPV6_EXTHDR = 570,
    OF_OXM_IPV6_EXTHDR_MASKED = 571,
    OF_OXM_IPV6_FLABEL = 572,
    OF_OXM_IPV6_FLABEL_MASKED = 573,
    OF_OXM_IPV6_ND_SLL = 574,
    OF_OXM_IPV6_ND_SLL_MASKED = 575,
    OF_OXM_IPV6_ND_TARGET = 576,
    OF_OXM_IPV6_ND_TARGET_MASKED = 577,
    OF_OXM_IPV6_ND_TLL = 578,
    OF_OXM_IPV6_ND_TLL_MASKED = 579,
    OF_OXM_IPV6_SRC = 580,
    OF_OXM_IPV6_SRC_MASKED = 581,
    OF_OXM_METADATA = 582,
    OF_OXM_METADATA_MASKED = 583,
    OF_OXM_MPLS_BOS = 584,
    OF_OXM_MPLS_BOS_MASKED = 585,
    OF_OXM_MPLS_LABEL = 586,
    OF_OXM_MPLS_LABEL_MASKED = 587,
    OF_OXM_MPLS_TC = 588,
    OF_OXM_MPLS_TC_MASKED = 589,
    OF_OXM_PBB_UCA = 590,
    OF_OXM_PBB_UCA_MASKED = 591,
    OF_OXM_SCTP_DST = 592,
    OF_OXM_SCTP_DST_MASKED = 593,
    OF_OXM_SCTP_SRC = 594,
    OF_OXM_SCTP_SRC_MASKED = 595,
    OF_OXM_TCP_DST = 596,
    OF_OXM_TCP_DST_MASKED = 597,
    OF_OXM_TCP_SRC = 598,
    OF_OXM_TCP_SRC_MASKED = 599,
    OF_OXM_TUNNEL_ID = 600,
    OF_OXM_TUNNEL_ID_MASKED = 601,
    OF_OXM_TUNNEL_IPV4_DST = 602,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 603,
    OF_OXM_TUNNEL_IPV4_SRC = 604,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 605,
    OF_OXM_UDP_DST = 606,
    OF_OXM_UDP_DST_MASKED = 607,
    OF_OXM_UDP_SRC = 608,
    OF_OXM_UDP_SRC_MASKED = 609,
    OF_OXM_VLAN_PCP = 610,
    OF_OXM_VLAN_PCP_MASKED = 611,
    OF_OXM_VLAN_VID = 612,
    OF_OXM_VLAN_VID_MASKED = 613,
    OF_PACKET_QUEUE = 614,
    OF_PORT_DESC = 615,
    OF_PORT_DESC_PROP = 616,
    OF_PORT_DESC_PROP_BSN = 617,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 618,
    OF_PORT_DESC_PROP_BSN_UPLINK = 619,
    OF_PORT_DESC_PROP_ETHERNET = 620,
    OF_PORT_DESC_PROP_EXPERIMENTER = 621,
    OF_PORT_DESC_PROP_OPTICAL = 622,
    OF_PORT_MOD_PROP = 623,
    OF_PORT_MOD_PROP_ETHERNET = 624,
    OF_PORT_MOD_PROP_EXPERIMENTER = 625,
    OF_PORT_MOD_PROP_OPTICAL = 626,
    OF_PORT_STATS_ENTRY = 627,
    OF_PORT_STATS_PROP = 628,
    OF_PORT_STATS_PROP_ETHERNET = 629,
    OF_PORT_STATS_PROP_EXPERIMENTER = 630,
    OF_PORT_STATS_PROP_OPTICAL = 631,
    OF_QUEUE_DESC = 632,
    OF_QUEUE_DESC_PROP = 633,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 634,
    OF_QUEUE_DESC_PROP_MAX_RATE = 635,
    OF_QUEUE_DESC_PROP_MIN_RATE = 636,
    OF_QUEUE_PROP = 637,
    OF_QUEUE_PROP_EXPERIMENTER = 638,
    OF_QUEUE_PROP_MAX_RATE = 639,
    OF_QUEUE_PROP_MIN_RATE = 640,
    OF_QUEUE_STATS_ENTRY = 641,
    OF_QUEUE_STATS_PROP = 642,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 643,
    OF_ROLE_PROP = 644,
    OF_ROLE_PROP_EXPERIMENTER = 645,
    OF_TABLE_DESC = 646,
    OF_TABLE_FEATURE_PROP = 647,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 648,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 649,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 650,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 651,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 652,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 653,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 654,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 655,
    OF_TABLE_FEATURE_PROP_MATCH = 656,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 657,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 658,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 659,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 660,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 661,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 662,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 663,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 664,
    OF_TABLE_FEATURES = 665,
    OF_TABLE_MOD_PROP = 666,
    OF_TABLE_MOD_PROP_EVICTION = 667,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 668,
    OF_TABLE_MOD_PROP_VACANCY = 669,
    OF_TABLE_STATS_ENTRY = 670,
    OF_UINT32 = 671,
    OF_UINT64 = 672,
    OF_UINT8 = 673,
    ...
    /* List objects */
    OF_LIST_ACTION = 674,
    OF_LIST_ACTION_ID = 675,
    OF_LIST_ASYNC_CONFIG_PROP = 676,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 677,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 678,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 679,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 680,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 681,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 682,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 683,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 684,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 685,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 686,
    OF_LIST_BSN_INTERFACE = 687,
    OF_LIST_BSN_LACP_STATS_ENTRY = 688,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 689,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 690,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 691,
    OF_LIST_BSN_TLV = 692,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 693,
    OF_LIST_BSN_VLAN_MAC = 694,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 695,
    OF_LIST_BUCKET = 696,
    OF_LIST_BUCKET_COUNTER = 697,
    OF_LIST_BUNDLE_PROP = 698,
    OF_LIST_FLOW_STATS_ENTRY = 699,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 700,
    OF_LIST_GROUP_STATS_ENTRY = 701,
    OF_LIST_HELLO_ELEM = 702,
    OF_LIST_INSTRUCTION = 703,
    OF_LIST_INSTRUCTION_ID = 704,
    OF_LIST_METER_BAND = 705,
    OF_LIST_METER_BAND_STATS = 706,
    OF_LIST_METER_CONFIG = 707,
    OF_LIST_METER_STATS = 708,
    OF_LIST_OXM = 709,
    OF_LIST_PACKET_QUEUE = 710,
    OF_LIST_PORT_DESC = 711,
    OF_LIST_PORT_DESC_PROP = 712,
    OF_LIST_PORT_MOD_PROP = 713,
    OF_LIST_PORT_STATS_ENTRY = 714,
    OF_LIST_PORT_STATS_PROP = 715,
    OF_LIST_QUEUE_DESC = 716,
    OF_LIST_QUEUE_DESC_PROP = 717,
    OF_LIST_QUEUE_PROP = 718,
    OF_LIST_QUEUE_STATS_ENTRY = 719,
    OF_LIST_QUEUE_STATS_PROP = 720,
    OF_LIST_ROLE_PROP = 721,
    OF_LIST_TABLE_DESC = 722,
    OF_LIST_TABLE_FEATURE_PROP = 723,
    OF_LIST_TABLE_FEATURES = 724,
    OF_LIST_TABLE_MOD_PROP = 725,
    OF_LIST_TABLE_STATS_ENTRY = 726,
    OF_LIST_UINT32 = 727,
    OF_LIST_UINT64 = 728,
    OF_LIST_UINT8 = 729,
