...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_UDF_ID = 456,
    OF_BSN_TLV_UDF_LENGTH = 457,
    OF_BSN_TLV_UDF_OFFSET = 458,
    OF_BSN_TLV_UDP_DST = 459,
    OF_BSN_TLV_UDP_SRC = 460,
    OF_BSN_TLV_UINT32 = 461,
    OF_BSN_TLV_UINT64_LIST = 462,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 463,
    OF_BSN_TLV_UNICAST_RATE = 464,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 465,
    OF_BSN_TLV_UNTAGGED = 466,
    OF_BSN_TLV_UPGRADE = 467,
    OF_BSN_TLV_URI_SCHEME = 468,
    OF_BSN_TLV_USE_PACKET_STATE = 469,
    OF_BSN_TLV_USER_CONFIGURED = 470,
    OF_BSN_TLV_VFI = 471,
    OF_BSN_TLV_VFP_CLASS_ID = 472,
    OF_BSN_TLV_VIRTUAL = 473,
    OF_BSN_TLV_VLAN_MAC_LIST = 474,
    OF_BSN_TLV_VLAN_PCP = 475,
    OF_BSN_TLV_VLAN_VID = 476,
    OF_BSN_TLV_VLAN_VID_MASK = 477,
    OF_BSN_TLV_VNI = 478,
    OF_BSN_TLV_VPN_KEY = 479,
    OF_BSN_TLV_VRF = 480,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 481,
    OF_BSN_UNIT = 482,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 483,
    OF_BSN_VLAN_MAC = 484,
    OF_BSN_VPORT = 485,
    OF_BSN_VPORT_L2GRE = 486,
    OF_BSN_VPORT_Q_IN_Q = 487,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 488,
    OF_BUCKET = 489,
    OF_BUCKET_COUNTER = 490,
    OF_BUNDLE_PROP = 491,
    OF_BUNDLE_PROP_EXPERIMENTER = 492,
    OF_FLOW_STATS_ENTRY = 493,
    OF_GROUP_DESC_STATS_ENTRY = 494,
    OF_GROUP_STATS_ENTRY = 495,
    OF_HELLO_ELEM = 496,
    OF_HELLO_ELEM_VERSIONBITMAP = 497,
    OF_INSTRUCTION = 498,
    OF_INSTRUCTION_APPLY_ACTIONS = 499,
    OF_INSTRUCTION_BSN = 500,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 501,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 502,
    OF_INSTRUCTION_BSN_DENY = 503,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 504,
    OF_INSTRUCTION_BSN_DIRECTED_BROADCAST = 505,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 506,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 507,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 508,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 509,
    OF_INSTRUCTION_BSN_HASH_SELECT = 510,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 511,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 512,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 513,
    OF_INSTRUCTION_BSN_PERMIT = 514,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 515,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 516,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 517,
    OF_INSTRUCTION_CLEAR_ACTIONS = 518,
    OF_INSTRUCTION_EXPERIMENTER = 519,
    OF_INSTRUCTION_GOTO_TABLE = 520,
    OF_INSTRUCTION_ID = 521,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 522,
    OF_INSTRUCTION_ID_BSN = 523,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 524,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 525,
    OF_INSTRUCTION_ID_BSN_DENY = 526,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 527,
    OF_INSTRUCTION_ID_BSN_DIRECTED_BROADCAST = 528,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 529,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 530,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 531,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 532,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 533,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 534,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 535,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 536,
    OF_INSTRUCTION_ID_BSN_PERMIT = 537,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 538,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 539,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 540,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 541,
    OF_INSTRUCTION_ID_EXPERIMENTER = 542,
    OF_INSTRUCTION_ID_GOTO_TABLE = 543,
    OF_INSTRUCTION_ID_METER = 544,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 545,
    OF_INSTRUCTION_ID_WRITE_METADATA = 546,
    OF_INSTRUCTION_METER = 547,
    OF_INSTRUCTION_WRITE_ACTIONS = 548,
    OF_INSTRUCTION_WRITE_METADATA = 549,
    OF_MATCH_V1 = 550,
    OF_MATCH_V2 = 551,
    OF_MATCH_V3 = 552,
    OF_METER_BAND = 553,
    OF_METER_BAND_DROP = 554,
    OF_METER_BAND_DSCP_REMARK = 555,
    OF_METER_BAND_EXPERIMENTER = 556,
    OF_METER_BAND_STATS = 557,
    OF_METER_CONFIG = 558,
    OF_METER_FEATURES = 559,
    OF_METER_STATS = 560,
    OF_OXM = 561,
    OF_OXM_ARP_OP = 562,
    OF_OXM_ARP_OP_MASKED = 563,
    OF_OXM_ARP_SHA = 564,
    OF_OXM_ARP_SHA_MASKED = 565,
    OF_OXM_ARP_SPA = 566,
    OF_OXM_ARP_SPA_MASKED = 567,
    OF_OXM_ARP_THA = 568,
    OF_OXM_ARP_THA_MASKED = 569,
    OF_OXM_ARP_TPA = 570,
    OF_OXM_ARP_TPA_MASKED = 571,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 572,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 573,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 574,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 575,
    OF_OXM_BSN_IFP_CLASS_ID = 576,
    OF_OXM_BSN_IFP_CLASS_ID_MASKED = 577,
    OF_OXM_BSN_IN_PORTS_128 = 578,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 579,
    OF_OXM_BSN_IN_PORTS_512 = 580,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 581,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 582,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 583,
    OF_OXM_BSN_INNER_ETH_DST = 584,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 585,
    OF_OXM_BSN_INNER_ETH_SRC = 586,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 587,
    OF_OXM_BSN_INNER_VLAN_VID = 588,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 589,
    OF_OXM_BSN_IP_FRAGMENTATION = 590,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 591,
    OF_OXM_BSN_L2_CACHE_HIT = 592,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 593,
    OF_OXM_BSN_L3_DST_CLASS_ID = 594,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 595,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 596,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 597,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 598,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 599,
    OF_OXM_BSN_LAG_ID = 600,
    OF_OXM_BSN_LAG_ID_MASKED = 601,
    OF_OXM_BSN_TCP_FLAGS = 602,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 603,
    OF_OXM_BSN_UDF0 = 604,
    OF_OXM_BSN_UDF0_MASKED = 605,
    OF_OXM_BSN_UDF1 = 606,
    OF_OXM_BSN_UDF1_MASKED = 607,
    OF_OXM_BSN_UDF2 = 608,
    OF_OXM_BSN_UDF2_MASKED = 609,
    OF_OXM_BSN_UDF3 = 610,
    OF_OXM_BSN_UDF3_MASKED = 611,
    OF_OXM_BSN_UDF4 = 612,
    OF_OXM_BSN_UDF4_MASKED = 613,
    OF_OXM_BSN_UDF5 = 614,
    OF_OXM_BSN_UDF5_MASKED = 615,
    OF_OXM_BSN_UDF6 = 616,
    OF_OXM_BSN_UDF6_MASKED = 617,
    OF_OXM_BSN_UDF7 = 618,
    OF_OXM_BSN_UDF7_MASKED = 619,
    OF_OXM_BSN_VFI = 620,
    OF_OXM_BSN_VFI_MASKED = 621,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 622,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 623,
    OF_OXM_BSN_VRF = 624,
    OF_OXM_BSN_VRF_MASKED = 625,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 626,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 627,
    OF_OXM_CONN_TRACKING_IPV6_DST = 628,
    OF_OXM_CONN_TRACKING_IPV6_DST_MASKED = 629,
    OF_OXM_CONN_TRACKING_IPV6_SRC = 630,
    OF_OXM_CONN_TRACKING_IPV6_SRC_MASKED = 631,
    OF_OXM_CONN_TRACKING_LABEL = 632,
    OF_OXM_CONN_TRACKING_LABEL_MASKED = 633,
    OF_OXM_CONN_TRACKING_MARK = 634,
    OF_OXM_CONN_TRACKING_MARK_MASKED = 635,
    OF_OXM_CONN_TRACKING_NW_DST = 636,
    OF_OXM_CONN_TRACKING_NW_DST_MASKED = 637,
    OF_OXM_CONN_TRACKING_NW_PROTO = 638,
    OF_OXM_CONN_TRACKING_NW_PROTO_MASKED = 639,
    OF_OXM_CONN_TRACKING_NW_SRC = 640,
    OF_OXM_CONN_TRACKING_NW_SRC_MASKED = 641,
    OF_OXM_CONN_TRACKING_STATE = 642,
    OF_OXM_CONN_TRACKING_STATE_MASKED = 643,
    OF_OXM_CONN_TRACKING_TP_DST = 644,
    OF_OXM_CONN_TRACKING_TP_DST_MASKED = 645,
    OF_OXM_CONN_TRACKING_TP_SRC = 646,
    OF_OXM_CONN_TRACKING_TP_SRC_MASKED = 647,
    OF_OXM_CONN_TRACKING_ZONE = 648,
    OF_OXM_CONN_TRACKING_ZONE_MASKED = 649,
    OF_OXM_ETH_DST = 650,
    OF_OXM_ETH_DST_MASKED = 651,
    OF_OXM_ETH_SRC = 652,
    OF_OXM_ETH_SRC_MASKED = 653,
    OF_OXM_ETH_TYPE = 654,
    OF_OXM_ETH_TYPE_MASKED = 655,
    OF_OXM_ICMPV4_CODE = 656,
    OF_OXM_ICMPV4_CODE_MASKED = 657,
    OF_OXM_ICMPV4_TYPE = 658,
    OF_OXM_ICMPV4_TYPE_MASKED = 659,
    OF_OXM_ICMPV6_CODE = 660,
    OF_OXM_ICMPV6_CODE_MASKED = 661,
    OF_OXM_ICMPV6_TYPE = 662,
    OF_OXM_ICMPV6_TYPE_MASKED = 663,
    OF_OXM_IN_PHY_PORT = 664,
    OF_OXM_IN_PHY_PORT_MASKED = 665,
    OF_OXM_IN_PORT = 666,
    OF_OXM_IN_PORT_MASKED = 667,
    OF_OXM_IP_DSCP = 668,
    OF_OXM_IP_DSCP_MASKED = 669,
    OF_OXM_IP_ECN = 670,
    OF_OXM_IP_ECN_MASKED = 671,
    OF_OXM_IP_PROTO = 672,
    OF_OXM_IP_PROTO_MASKED = 673,
    OF_OXM_IPV4_DST = 674,
    OF_OXM_IPV4_DST_MASKED = 675,
    OF_OXM_IPV4_SRC = 676,
    OF_OXM_IPV4_SRC_MASKED = 677,
    OF_OXM_IPV6_DST = 678,
    OF_OXM_IPV6_DST_MASKED = 679,
    OF_OXM_IPV6_EXTHDR = 680,
    OF_OXM_IPV6_EXTHDR_MASKED = 681,
    OF_OXM_IPV6_FLABEL = 682,
    OF_OXM_IPV6_FLABEL_MASKED = 683,
    OF_OXM_IPV6_ND_SLL = 684,
    OF_OXM_IPV6_ND_SLL_MASKED = 685,
    OF_OXM_IPV6_ND_TARGET = 686,
    OF_OXM_IPV6_ND_TARGET_MASKED = 687,
    OF_OXM_IPV6_ND_TLL = 688,
    OF_OXM_IPV6_ND_TLL_MASKED = 689,
    OF_OXM_IPV6_SRC = 690,
    OF_OXM_IPV6_SRC_MASKED = 691,
    OF_OXM_METADATA = 692,
    OF_OXM_METADATA_MASKED = 693,
    OF_OXM_MPLS_BOS = 694,
    OF_OXM_MPLS_BOS_MASKED = 695,
    OF_OXM_MPLS_LABEL = 696,
    OF_OXM_MPLS_LABEL_MASKED = 697,
    OF_OXM_MPLS_TC = 698,
    OF_OXM_MPLS_TC_MASKED = 699,
    OF_OXM_OVS_TCP_FLAGS = 700,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 701,
    OF_OXM_PBB_UCA = 702,
    OF_OXM_PBB_UCA_MASKED = 703,
    OF_OXM_SCTP_DST = 704,
    OF_OXM_SCTP_DST_MASKED = 705,
    OF_OXM_SCTP_SRC = 706,
    OF_OXM_SCTP_SRC_MASKED = 707,
    OF_OXM_TCP_DST = 708,
    OF_OXM_TCP_DST_MASKED = 709,
    OF_OXM_TCP_SRC = 710,
    OF_OXM_TCP_SRC_MASKED = 711,
    OF_OXM_TUNNEL_ID = 712,
    OF_OXM_TUNNEL_ID_MASKED = 713,
    OF_OXM_TUNNEL_IPV4_DST = 714,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 715,
    OF_OXM_TUNNEL_IPV4_SRC = 716,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 717,
    OF_OXM_UDP_DST = 718,
    OF_OXM_UDP_DST_MASKED = 719,
    OF_OXM_UDP_SRC = 720,
    OF_OXM_UDP_SRC_MASKED = 721,
    OF_OXM_VLAN_PCP = 722,
    OF_OXM_VLAN_PCP_MASKED = 723,
    OF_OXM_VLAN_VID = 724,
    OF_OXM_VLAN_VID_MASKED = 725,
    OF_PACKET_QUEUE = 726,
    OF_PORT_DESC = 727,
    OF_PORT_DESC_PROP = 728,
    OF_PORT_DESC_PROP_BSN = 729,
    OF_PORT_DESC_PROP_BSN_ALARM = 730,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 731,
    OF_PORT_DESC_PROP_BSN_DIAG = 732,
    OF_PORT_DESC_PROP_BSN_ETHTOOL = 733,
    ...
    OF_UINT64 = 794,
    OF_UINT8 = 795,
    OFP_BSN_MODULE_EEPROM_TRANSCEIVER = 796,
