...
typedef enum of_object_id_e {
    ...
    OF_OXM_BSN_L2_CACHE_HIT = 545,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 546,
    OF_OXM_BSN_L3_DST_CLASS_ID = 547,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 548,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 549,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 550,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 551,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 552,
    OF_OXM_BSN_LAG_ID = 553,
    OF_OXM_BSN_LAG_ID_MASKED = 554,
    OF_OXM_BSN_TCP_FLAGS = 555,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 556,
    OF_OXM_BSN_UDF0 = 557,
    OF_OXM_BSN_UDF0_MASKED = 558,
    OF_OXM_BSN_UDF1 = 559,
    OF_OXM_BSN_UDF1_MASKED = 560,
    OF_OXM_BSN_UDF2 = 561,
    OF_OXM_BSN_UDF2_MASKED = 562,
    OF_OXM_BSN_UDF3 = 563,
    OF_OXM_BSN_UDF3_MASKED = 564,
    OF_OXM_BSN_UDF4 = 565,
    OF_OXM_BSN_UDF4_MASKED = 566,
    OF_OXM_BSN_UDF5 = 567,
    OF_OXM_BSN_UDF5_MASKED = 568,
    OF_OXM_BSN_UDF6 = 569,
    OF_OXM_BSN_UDF6_MASKED = 570,
    OF_OXM_BSN_UDF7 = 571,
    OF_OXM_BSN_UDF7_MASKED = 572,
    OF_OXM_BSN_VFI = 573,
    OF_OXM_BSN_VFI_MASKED = 574,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 575,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 576,
    OF_OXM_BSN_VRF = 577,
    OF_OXM_BSN_VRF_MASKED = 578,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 579,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 580,
    OF_OXM_ETH_DST = 581,
    OF_OXM_ETH_DST_MASKED = 582,
    OF_OXM_ETH_SRC = 583,
    OF_OXM_ETH_SRC_MASKED = 584,
    OF_OXM_ETH_TYPE = 585,
    OF_OXM_ETH_TYPE_MASKED = 586,
    OF_OXM_ICMPV4_CODE = 587,
    OF_OXM_ICMPV4_CODE_MASKED = 588,
    OF_OXM_ICMPV4_TYPE = 589,
    OF_OXM_ICMPV4_TYPE_MASKED = 590,
    OF_OXM_ICMPV6_CODE = 591,
    OF_OXM_ICMPV6_CODE_MASKED = 592,
    OF_OXM_ICMPV6_TYPE = 593,
    OF_OXM_ICMPV6_TYPE_MASKED = 594,
    OF_OXM_IN_PHY_PORT = 595,
    OF_OXM_IN_PHY_PORT_MASKED = 596,
    OF_OXM_IN_PORT = 597,
    OF_OXM_IN_PORT_MASKED = 598,
    OF_OXM_IP_DSCP = 599,
    OF_OXM_IP_DSCP_MASKED = 600,
    OF_OXM_IP_ECN = 601,
    OF_OXM_IP_ECN_MASKED = 602,
    OF_OXM_IP_PROTO = 603,
    OF_OXM_IP_PROTO_MASKED = 604,
    OF_OXM_IPV4_DST = 605,
    OF_OXM_IPV4_DST_MASKED = 606,
    OF_OXM_IPV4_SRC = 607,
    OF_OXM_IPV4_SRC_MASKED = 608,
    OF_OXM_IPV6_DST = 609,
    OF_OXM_IPV6_DST_MASKED = 610,
    OF_OXM_IPV6_EXTHDR = 611,
    OF_OXM_IPV6_EXTHDR_MASKED = 612,
    OF_OXM_IPV6_FLABEL = 613,
    OF_OXM_IPV6_FLABEL_MASKED = 614,
    OF_OXM_IPV6_ND_SLL = 615,
    OF_OXM_IPV6_ND_SLL_MASKED = 616,
    OF_OXM_IPV6_ND_TARGET = 617,
    OF_OXM_IPV6_ND_TARGET_MASKED = 618,
    OF_OXM_IPV6_ND_TLL = 619,
    OF_OXM_IPV6_ND_TLL_MASKED = 620,
    OF_OXM_IPV6_SRC = 621,
    OF_OXM_IPV6_SRC_MASKED = 622,
    OF_OXM_METADATA = 623,
    OF_OXM_METADATA_MASKED = 624,
    OF_OXM_MPLS_BOS = 625,
    OF_OXM_MPLS_BOS_MASKED = 626,
    OF_OXM_MPLS_LABEL = 627,
    OF_OXM_MPLS_LABEL_MASKED = 628,
    OF_OXM_MPLS_TC = 629,
    OF_OXM_MPLS_TC_MASKED = 630,
    OF_OXM_OVS_TCP_FLAGS = 631,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 632,
    OF_OXM_PBB_UCA = 633,
    OF_OXM_PBB_UCA_MASKED = 634,
    OF_OXM_SCTP_DST = 635,
    OF_OXM_SCTP_DST_MASKED = 636,
    OF_OXM_SCTP_SRC = 637,
    OF_OXM_SCTP_SRC_MASKED = 638,
    OF_OXM_TCP_DST = 639,
    OF_OXM_TCP_DST_MASKED = 640,
    OF_OXM_TCP_SRC = 641,
    OF_OXM_TCP_SRC_MASKED = 642,
    OF_OXM_TUNNEL_ID = 643,
    OF_OXM_TUNNEL_ID_MASKED = 644,
    OF_OXM_TUNNEL_IPV4_DST = 645,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 646,
    OF_OXM_TUNNEL_IPV4_SRC = 647,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 648,
    OF_OXM_UDP_DST = 649,
    OF_OXM_UDP_DST_MASKED = 650,
    OF_OXM_UDP_SRC = 651,
    OF_OXM_UDP_SRC_MASKED = 652,
    OF_OXM_VLAN_PCP = 653,
    OF_OXM_VLAN_PCP_MASKED = 654,
    OF_OXM_VLAN_VID = 655,
    OF_OXM_VLAN_VID_MASKED = 656,
    OF_PACKET_QUEUE = 657,
    OF_PORT_DESC = 658,
    OF_PORT_DESC_PROP = 659,
    OF_PORT_DESC_PROP_BSN = 660,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 661,
    OF_PORT_DESC_PROP_BSN_UPLINK = 662,
    OF_PORT_DESC_PROP_ETHERNET = 663,
    OF_PORT_DESC_PROP_EXPERIMENTER = 664,
    OF_PORT_DESC_PROP_OPTICAL = 665,
    OF_PORT_MOD_PROP = 666,
    OF_PORT_MOD_PROP_ETHERNET = 667,
    OF_PORT_MOD_PROP_EXPERIMENTER = 668,
    OF_PORT_MOD_PROP_OPTICAL = 669,
    OF_PORT_STATS_ENTRY = 670,
    OF_PORT_STATS_PROP = 671,
    OF_PORT_STATS_PROP_ETHERNET = 672,
    OF_PORT_STATS_PROP_EXPERIMENTER = 673,
    OF_PORT_STATS_PROP_OPTICAL = 674,
    OF_QUEUE_DESC = 675,
    OF_QUEUE_DESC_PROP = 676,
    OF_QUEUE_DESC_PROP_BSN = 677,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 678,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 679,
    OF_QUEUE_DESC_PROP_MAX_RATE = 680,
    OF_QUEUE_DESC_PROP_MIN_RATE = 681,
    OF_QUEUE_PROP = 682,
    OF_QUEUE_PROP_EXPERIMENTER = 683,
    OF_QUEUE_PROP_MAX_RATE = 684,
    OF_QUEUE_PROP_MIN_RATE = 685,
    OF_QUEUE_STATS_ENTRY = 686,
    OF_QUEUE_STATS_PROP = 687,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 688,
    OF_ROLE_PROP = 689,
    OF_ROLE_PROP_EXPERIMENTER = 690,
    OF_TABLE_DESC = 691,
    OF_TABLE_FEATURE_PROP = 692,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 693,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 694,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 695,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 696,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 697,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 698,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 699,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 700,
    OF_TABLE_FEATURE_PROP_MATCH = 701,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 702,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 703,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 704,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 705,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 706,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 707,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 708,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 709,
    OF_TABLE_FEATURES = 710,
    OF_TABLE_MOD_PROP = 711,
    OF_TABLE_MOD_PROP_EVICTION = 712,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 713,
    OF_TABLE_MOD_PROP_VACANCY = 714,
    OF_TABLE_STATS_ENTRY = 715,
    OF_UINT32 = 716,
    OF_UINT64 = 717,
    OF_UINT8 = 718,
    ...
    /* List objects */
    OF_LIST_ACTION = 719,
    OF_LIST_ACTION_ID = 720,
    OF_LIST_ASYNC_CONFIG_PROP = 721,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 722,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 723,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 724,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 725,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 726,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 727,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 728,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 729,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 730,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 731,
    OF_LIST_BSN_INTERFACE = 732,
    OF_LIST_BSN_LACP_STATS_ENTRY = 733,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 734,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 735,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 736,
    OF_LIST_BSN_TLV = 737,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 738,
    OF_LIST_BSN_VLAN_MAC = 739,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 740,
    OF_LIST_BUCKET = 741,
    OF_LIST_BUCKET_COUNTER = 742,
    OF_LIST_BUNDLE_PROP = 743,
    OF_LIST_FLOW_STATS_ENTRY = 744,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 745,
    OF_LIST_GROUP_STATS_ENTRY = 746,
    OF_LIST_HELLO_ELEM = 747,
    OF_LIST_INSTRUCTION = 748,
    OF_LIST_INSTRUCTION_ID = 749,
    OF_LIST_METER_BAND = 750,
    OF_LIST_METER_BAND_STATS = 751,
    OF_LIST_METER_CONFIG = 752,
    OF_LIST_METER_STATS = 753,
    OF_LIST_OXM = 754,
    OF_LIST_PACKET_QUEUE = 755,
    OF_LIST_PORT_DESC = 756,
    OF_LIST_PORT_DESC_PROP = 757,
    OF_LIST_PORT_MOD_PROP = 758,
    OF_LIST_PORT_STATS_ENTRY = 759,
    OF_LIST_PORT_STATS_PROP = 760,
    OF_LIST_QUEUE_DESC = 761,
    OF_LIST_QUEUE_DESC_PROP = 762,
    OF_LIST_QUEUE_PROP = 763,
    OF_LIST_QUEUE_STATS_ENTRY = 764,
    OF_LIST_QUEUE_STATS_PROP = 765,
    OF_LIST_ROLE_PROP = 766,
    OF_LIST_TABLE_DESC = 767,
    OF_LIST_TABLE_FEATURE_PROP = 768,
    OF_LIST_TABLE_FEATURES = 769,
    OF_LIST_TABLE_MOD_PROP = 770,
    OF_LIST_TABLE_STATS_ENTRY = 771,
    OF_LIST_UINT32 = 772,
    OF_LIST_UINT64 = 773,
    OF_LIST_UINT8 = 774,
