...
/**
 * Structure for of_bsn_tlv_upgrade_stage object.  Get/set
 * accessors available in all versions unless noted otherwise
 *
 * @param value_get/set ( OF_1_3 OF_1_4).
 *   Accessors for value, a variable of type uint16.  Functions
 *   are of type of_bsn_tlv_upgrade_stage_uint16_get_f and _set_f.
 *
 */
typedef struct of_bsn_tlv_upgrade_stage_s of_bsn_tlv_upgrade_stage_t;
