...
class bsn_base_error(experimenter_error_msg):
    ...
    def pack(self):
        ...
        packed.append(struct.pack("!H", self.subtype))
        packed.append(struct.pack("!L", self.experimenter))
        packed.append(struct.pack("!256s", self.err_msg.encode()))
        packed.append(self.data)
        length = sum([len(x) for x in packed])
        packed[2] = struct.pack("!H", length)
        return functools.reduce(lambda x,y: x+y, packed)
    ...
    def unpack(reader):
        ...
        _experimenter = reader.read("!L")[0]
        assert(_experimenter == 6035143)
        obj.err_msg = reader.read("!256s")[0].decode().rstrip("\x00")
        obj.data = reader.read_all()
        return obj
...
class bsn_generic_command_reply(bsn_header):
    version = 6
    type = 4
    experimenter = 6035143
    subtype = 72

    def __init__(self, xid=None, status=None, tlvs=None):
        if xid != None:
            self.xid = xid
        else:
            self.xid = None
    ...
    def pretty_print(self, q):
        q.text("bsn_generic_command_reply {")
        with q.group():
            with q.indent(2):
                q.breakable()
                q.text("xid = ");
...
bsn_header.subtypes[72] = bsn_generic_command_reply
...
class bsn_gentable_error(bsn_base_error):
    ...
    def pack(self):
        ...
        packed.append(struct.pack("!H", self.subtype))
        packed.append(struct.pack("!L", self.experimenter))
        packed.append(struct.pack("!H", self.error_code))
        packed.append(struct.pack("!H", self.table_id))
        packed.append(struct.pack("!256s", self.err_msg.encode()))
        packed.append(self.data)
        length = sum([len(x) for x in packed])
    ...
    def unpack(reader):
        ...
        _experimenter = reader.read("!L")[0]
        assert(_experimenter == 6035143)
        obj.error_code = reader.read("!H")[0]
        obj.table_id = reader.read("!H")[0]
        obj.err_msg = reader.read("!256s")[0].decode().rstrip("\x00")
        obj.data = reader.read_all()
        return obj
    ...
    def __eq__(self, other):
        if type(self) != type(other): return False
        if self.xid != other.xid: return False
        if self.error_code != other.error_code: return False
        if self.table_id != other.table_id: return False
        if self.err_msg != other.err_msg: return False
        if self.data != other.data: return False
        return True
...
class bsn_image_desc_stats_reply(bsn_stats_reply):
    ...
    def pack(self):
        ...
        packed.append(struct.pack("!L", self.experimenter))
        packed.append(struct.pack("!L", self.subtype))
        packed.append(struct.pack("!256s", self.image_checksum.encode()))
        packed.append(struct.pack("!256s", self.startup_config_checksum.encode()))
        length = sum([len(x) for x in packed])
        packed[2] = struct.pack("!H", length)
        return functools.reduce(lambda x,y: x+y, packed)
    ...
    def unpack(reader):
        ...
        _subtype = reader.read("!L")[0]
        assert(_subtype == 14)
        obj.image_checksum = reader.read("!256s")[0].decode().rstrip("\x00")
        obj.startup_config_checksum = reader.read("!256s")[0].decode().rstrip("\x00")
        return obj
...
class bsn_lua_upload(bsn_header):
    ...
    def pack(self):
        ...
        packed.append(struct.pack("!L", self.subtype))
        packed.append(struct.pack("!H", self.flags))
        packed.append(struct.pack("!64s", self.filename.encode()))
        packed.append(self.data)
        length = sum([len(x) for x in packed])
        packed[2] = struct.pack("!H", length)
        return functools.reduce(lambda x,y: x+y, packed)
    ...
    def unpack(reader):
        ...
        assert(_subtype == 64)
        obj.flags = reader.read("!H")[0]
        obj.filename = reader.read("!64s")[0].decode().rstrip("\x00")
        obj.data = reader.read_all()
        return obj
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("flags = ");
                value_name_map = {1: 'OFPBF_ATOMIC', 2: 'OFPBF_ORDERED', 4: 'OFPBF_TIME'}
                q.text(util.pretty_flags(self.flags, value_name_map.values()))
                q.text(","); q.breakable()
                q.text("message = ");
                q.pp(self.message)
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("capabilities = ");
                value_name_map = {1: 'OFPBF_TIMESTAMP', 2: 'OFPBF_TIME_SET_SCHED'}
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                value_name_map = {1: 'OFPBF_TIMESTAMP', 2: 'OFPBF_TIME_SET_SCHED'}
                q.text(util.pretty_flags(self.feature_request_flags, value_name_map.values()))
                q.text(","); q.breakable()
                q.text("properties = ");
                q.pp(self.properties)
            q.breakable()
...
class desc_stats_reply(stats_reply):
    ...
    def pack(self):
        ...
        packed.append(struct.pack("!H", self.flags))
        packed.append(b'\x00' * 4)
        packed.append(struct.pack("!256s", self.mfr_desc.encode()))
        packed.append(struct.pack("!256s", self.hw_desc.encode()))
        packed.append(struct.pack("!256s", self.sw_desc.encode()))
        packed.append(struct.pack("!32s", self.serial_num.encode()))
        packed.append(struct.pack("!256s", self.dp_desc.encode()))
        length = sum([len(x) for x in packed])
        packed[2] = struct.pack("!H", length)
        return functools.reduce(lambda x,y: x+y, packed)
    ...
    def unpack(reader):
        ...
        obj.flags = reader.read("!H")[0]
        reader.skip(4)
        obj.mfr_desc = reader.read("!256s")[0].decode().rstrip("\x00")
        obj.hw_desc = reader.read("!256s")[0].decode().rstrip("\x00")
        obj.sw_desc = reader.read("!256s")[0].decode().rstrip("\x00")
        obj.serial_num = reader.read("!32s")[0].decode().rstrip("\x00")
        obj.dp_desc = reader.read("!256s")[0].decode().rstrip("\x00")
        return obj
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("capabilities = ");
                value_name_map = {1: 'OFPC_FLOW_STATS', 2: 'OFPC_TABLE_STATS', 4: 'OFPC_PORT_STATS', 8: 'OFPC_GROUP_STATS', 32: 'OFPC_IP_REASM', 64: 'OFPC_QUEUE_STATS', 256: 'OFPC_PORT_BLOCKED', 512: 'OFPC_BUNDLES', 1024: 'OFPC_FLOW_MONITORING'}
                q.text(util.pretty_flags(self.capabilities, value_name_map.values()))
                q.text(","); q.breakable()
                q.text("reserved = ");
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("code = ");
                value_name_map = {0: 'OFPTFFC_BAD_TABLE', 1: 'OFPTFFC_BAD_METADATA', 5: 'OFPTFFC_EPERM', 6: 'OFPTFFC_BAD_CAPA', 7: 'OFPTFFC_BAD_MAX_ENT', 8: 'OFPTFFC_BAD_FEATURES', 9: 'OFPTFFC_BAD_COMMAND', 10: 'OFPTFFC_TOO_MANY'}
                if self.code in value_name_map:
                    q.text("%s(%d)" % (value_name_map[self.code], self.code))
                else:
                    q.text("%#x" % self.code)
