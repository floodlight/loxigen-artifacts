...
class oxs_byte_count_masked(oxs):
    type_len = 2147617040
    ...
    @staticmethod
    def unpack(reader):
        obj = oxs_byte_count_masked()
        _type_len = reader.read("!L")[0]
        assert(_type_len == 2147617040)
        obj.value = reader.read("!H")[0]
...
oxs.subtypes[2147617040] = oxs_byte_count_masked
...
class oxs_duration_masked(oxs):
    ...
    @staticmethod
    def unpack(reader):
        obj = oxs_duration_masked()
        _type_len = reader.read("!L")[0]
        assert(_type_len == 2147614992)
        obj.value = reader.read("!H")[0]
        obj.value_mask = reader.read("!H")[0]
        return obj
...
oxs.subtypes[2147614992] = oxs_duration_masked
...
class oxs_flow_count_masked(oxs):
    type_len = 2147616008
    ...
    @staticmethod
    def unpack(reader):
        obj = oxs_flow_count_masked()
        _type_len = reader.read("!L")[0]
        assert(_type_len == 2147616008)
        obj.value = reader.read("!H")[0]
        obj.value_mask = reader.read("!H")[0]
        return obj
...
oxs.subtypes[2147616008] = oxs_flow_count_masked
...
class oxs_idle_time_masked(oxs):
    type_len = 2147615504
    ...
    @staticmethod
    def unpack(reader):
        obj = oxs_idle_time_masked()
        _type_len = reader.read("!L")[0]
        assert(_type_len == 2147615504)
        obj.value = reader.read("!H")[0]
        obj.value_mask = reader.read("!H")[0]
        return obj
...
oxs.subtypes[2147615504] = oxs_idle_time_masked
...
class oxs_packet_count_masked(oxs):
    type_len = 2147616528
    ...
    @staticmethod
    def unpack(reader):
        obj = oxs_packet_count_masked()
        _type_len = reader.read("!L")[0]
        assert(_type_len == 2147616528)
        obj.value = reader.read("!H")[0]
        obj.value_mask = reader.read("!H")[0]
        return obj
    ...
    def pretty_print(self, q):
        q.text("oxs_packet_count_masked {")
        with q.group():
            with q.indent(2):
                q.breakable()
                q.text("value = ");
...
oxs.subtypes[2147616528] = oxs_packet_count_masked
