...
class flow_desc_reply(stats_reply):
    version = 6
    type = 19
    stats_type = 1
    ...
    def unpack(reader):
        ...
        obj.flags = reader.read("!H")[0]
        reader.skip(4)
        obj.entries = loxi.generic_util.unpack_list(reader, ofp.common.flow_desc_entry.unpack)
        return obj
...
stats_reply.subtypes[1] = flow_desc_reply

class flow_desc_request(stats_request):
    version = 6
    type = 18
    stats_type = 1
...
stats_request.subtypes[1] = flow_desc_request
...
stats_reply.subtypes[17] = flow_stats_reply
...
stats_request.subtypes[17] = flow_stats_request
