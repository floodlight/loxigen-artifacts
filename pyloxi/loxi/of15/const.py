...
# Identifiers from group ofp_bsn_extended_capabilities_configurability
OFP_BSN_EXT_CAP_CONFIGURABILITY_AN_DEFAULT = 1
OFP_BSN_EXT_CAP_CONFIGURABILITY_AN_ENABLED = 2
OFP_BSN_EXT_CAP_CONFIGURABILITY_AN_DISABLED = 4
OFP_BSN_EXT_CAP_CONFIGURABILITY_FEC_DEFAULT = 8
OFP_BSN_EXT_CAP_CONFIGURABILITY_FEC_ENABLED = 16
OFP_BSN_EXT_CAP_CONFIGURABILITY_FEC_DISABLED = 32

ofp_bsn_extended_capabilities_configurability_map = {
    1: 'OFP_BSN_EXT_CAP_CONFIGURABILITY_AN_DEFAULT',
    2: 'OFP_BSN_EXT_CAP_CONFIGURABILITY_AN_ENABLED',
    4: 'OFP_BSN_EXT_CAP_CONFIGURABILITY_AN_DISABLED',
    8: 'OFP_BSN_EXT_CAP_CONFIGURABILITY_FEC_DEFAULT',
    16: 'OFP_BSN_EXT_CAP_CONFIGURABILITY_FEC_ENABLED',
    32: 'OFP_BSN_EXT_CAP_CONFIGURABILITY_FEC_DISABLED',
}

# Identifiers from group ofp_bsn_extended_capabilities_conflict
OFP_BSN_EXT_CAP_CONFLICT_AN = 1
OFP_BSN_EXT_CAP_CONFLICT_FEC = 2

ofp_bsn_extended_capabilities_conflict_map = {
    1: 'OFP_BSN_EXT_CAP_CONFLICT_AN',
    2: 'OFP_BSN_EXT_CAP_CONFLICT_FEC',
}
