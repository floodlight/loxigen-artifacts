...
OFPACPT_EXPERIMENTER_SLAVE = 65534
OFPACPT_EXPERIMENTER_MASTER = 65535

ofp_async_config_prop_type_map = {
...
# Identifiers from group ofp_bsn_bfd_encap_type
OFP_BSN_BFD_ENCAP_TYPE_UNUSED = 0
OFP_BSN_BFD_ENCAP_TYPE_V4_UDP = 1
OFP_BSN_BFD_ENCAP_TYPE_V6_UDP = 2

ofp_bsn_bfd_encap_type_map = {
    0: 'OFP_BSN_BFD_ENCAP_TYPE_UNUSED',
    1: 'OFP_BSN_BFD_ENCAP_TYPE_V4_UDP',
    2: 'OFP_BSN_BFD_ENCAP_TYPE_V6_UDP',
}

# Identifiers from group ofp_bsn_bfd_endpoint_event
OF_BSN_BFD_ENDPOINT_EVENT_UNUSED = 0
OF_BSN_BFD_ENDPOINT_EVENT_STATE_DOWN = 1
OF_BSN_BFD_ENDPOINT_EVENT_STATE_INIT = 2
OF_BSN_BFD_ENDPOINT_EVENT_STATE_UP = 3
OF_BSN_BFD_ENDPOINT_EVENT_SESSION_ERROR = 4

ofp_bsn_bfd_endpoint_event_map = {
...
# Identifiers from group ofp_bsn_bfd_endpoint_type
OFP_BSN_BFD_TYPE_UNUSED = 0
OFP_BSN_BFD_TYPE_MICRO = 1
OFP_BSN_BFD_TYPE_1_HOP = 2
OFP_BSN_BFD_TYPE_MULTI_HOP = 3

ofp_bsn_bfd_endpoint_type_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_alarm_set
OFP_BSN_MODULE_EEPROM_ALARM_NOT_SET = 0
OFP_BSN_MODULE_EEPROM_ALARM_HI_SET = 1
OFP_BSN_MODULE_EEPROM_ALARM_LOW_SET = 2
OFP_BSN_MODULE_EEPROM_ALARM_HI_WARN_SET = 4
OFP_BSN_MODULE_EEPROM_ALARM_LOW_WARN_SET = 8

ofp_bsn_module_eeprom_alarm_set_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_connector
OFP_BSN_MODULE_EEPROM_CONNECTOR_NONE = 0
OFP_BSN_MODULE_EEPROM_CONNECTOR_SC = 1
OFP_BSN_MODULE_EEPROM_CONNECTOR_FC_1_COPPER = 2
OFP_BSN_MODULE_EEPROM_CONNECTOR_FC_2_COPPER = 3
OFP_BSN_MODULE_EEPROM_CONNECTOR_BNC_TNC = 4
OFP_BSN_MODULE_EEPROM_CONNECTOR_FC_COAX = 5
OFP_BSN_MODULE_EEPROM_CONNECTOR_FIBRE_JACK = 6
OFP_BSN_MODULE_EEPROM_CONNECTOR_LC = 7
OFP_BSN_MODULE_EEPROM_CONNECTOR_MT_RJ = 8
OFP_BSN_MODULE_EEPROM_CONNECTOR_MU = 9
OFP_BSN_MODULE_EEPROM_CONNECTOR_SG = 10
OFP_BSN_MODULE_EEPROM_CONNECTOR_OPTICAL_PIGTAIL = 11
OFP_BSN_MODULE_EEPROM_CONNECTOR_MPO_PARALLEL_OPTIC = 12
OFP_BSN_MODULE_EEPROM_CONNECTOR_HSSDC = 32
OFP_BSN_MODULE_EEPROM_CONNECTOR_COPPER_PIGTAIL = 33
OFP_BSN_MODULE_EEPROM_CONNECTOR_RJ45 = 34

ofp_bsn_module_eeprom_connector_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_cu_cmplnce
OFP_BSN_MODULE_EEPROM_CU_CMPLLNCE_UNSPECIFIED = 0
OFP_BSN_MODULE_EEPROM_CU_CMPLLNCE_SFF_8431_APP_E = 1
OFP_BSN_MODULE_EEPROM_CU_CMPLLNCE_SFF_8431_LIMITING = 4

ofp_bsn_module_eeprom_cu_cmplnce_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_diag_type
OFP_BSN_MODULE_EEPROM_DIAG_CURR = 0
OFP_BSN_MODULE_EEPROM_DIAG_VOLT = 1
OFP_BSN_MODULE_EEPROM_DIAG_TEMP = 2
OFP_BSN_MODULE_EEPROM_DIAG_RECP = 3
OFP_BSN_MODULE_EEPROM_DIAG_OUTP = 4

ofp_bsn_module_eeprom_diag_type_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_encoding
OFP_BSN_MODULE_EEPROM_ENCODING_UNSPECIFIED = 0
OFP_BSN_MODULE_EEPROM_ENCODING_8B_10B = 1
OFP_BSN_MODULE_EEPROM_ENCODING_4B_5B = 2
OFP_BSN_MODULE_EEPROM_ENCODING_NRZ = 3
OFP_BSN_MODULE_EEPROM_ENCODING_MANCHESTER = 4
OFP_BSN_MODULE_EEPROM_ENCODING_SONET_SCRAMBLED = 5
OFP_BSN_MODULE_EEPROM_ENCODING_64B_66B = 6

ofp_bsn_module_eeprom_encoding_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_extended_identifier
OFP_BSN_MODULE_EEPROM_EXT_IDENTIFIER_NON_GBIC = 0
OFP_BSN_MODULE_EEPROM_EXT_IDENTIFIER_GBIC_SFP = 4
OFP_BSN_MODULE_EEPROM_EXT_IDENTIFIER_GBIC_MOD_DEF = 7
OFP_BSN_MODULE_EEPROM_EXT_IDENTIFIER_UNKNOWN = 8

ofp_bsn_module_eeprom_extended_identifier_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_identifier
OFP_BSN_MODULE_EEPROM_IDENTIFIER_NONE = 0
OFP_BSN_MODULE_EEPROM_IDENTIFIER_GBIC = 1
OFP_BSN_MODULE_EEPROM_IDENTIFIER_ONBOARD = 2
OFP_BSN_MODULE_EEPROM_IDENTIFIER_SFP = 3

ofp_bsn_module_eeprom_identifier_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_rate_identifier
OFP_BSN_MODULE_EEPROM_RATE_IDENTIFIER_UNSPECIFIED = 0
OFP_BSN_MODULE_EEPROM_RATE_IDENTIFIER_4G_2G_1G_AS0_AS1 = 1
OFP_BSN_MODULE_EEPROM_RATE_IDENTIFIER_8G_4G_2G_RX_RATE_SELECT_ONLY = 2
OFP_BSN_MODULE_EEPROM_RATE_IDENTIFIER_8G_4G_2G_INDEPENDENT_RX_TX = 3
OFP_BSN_MODULE_EEPROM_RATE_IDENTIFIER_8G_4G_2G_TX_RATE_SELECT_ONLY = 4

ofp_bsn_module_eeprom_rate_identifier_map = {
...
# Identifiers from group ofp_bsn_module_eeprom_recv_signal_type
OFP_BSN_MODULE_EEPROM_RECV_SIGNAL_OMA = 0
OFP_BSN_MODULE_EEPROM_RECV_SIGNAL_AVG = 1

ofp_bsn_module_eeprom_recv_signal_type_map = {
...
# Identifiers from group ofp_bsn_unit_type
OFP_BSN_UNIT_NONE = 0
OFP_BSN_UNIT_AMP = 2
OFP_BSN_UNIT_VOL = 3
OFP_BSN_UNIT_KM = 4
...
OFPBF_TIMESTAMP = 1
OFPBF_TIME_SET_SCHED = 2

ofp_bundle_feature_flags_map = {
    1: 'OFPBF_TIMESTAMP',
    2: 'OFPBF_TIME_SET_SCHED',
}

# Identifiers from group ofp_bundle_features_prop_type
OFPTMPBF_TIME_CAPABILITY = 1
OFPTMPBF_EXPERIMENTER = 65535

ofp_bundle_features_prop_type_map = {
...
OFPBPT_TIME = 1
OFPBPT_EXPERIMENTER = 65535

ofp_bundle_prop_type_map = {
    1: 'OFPBPT_TIME',
...
ofp_control_channel_status_map = {
    0: 'OFPCT_STATUS_UP',
    1: 'OFPCT_STATUS_DOWN',
}
...
OFPCSPT_URI = 0
OFPCSPT_EXPERIMENTER = 65535

ofp_controller_status_prop_type_map = {
    0: 'OFPCSPT_URI',
...
ofp_controller_status_reason_map = {
    0: 'OFPCSR_REQUEST',
...
OFPFMF_REMOVED = 4
OFPFMF_MODIFY = 8
OFPFMF_INSTRUCTIONS = 16
OFPFMF_NO_ABBREV = 32
OFPFMF_ONLY_OWN = 64

ofp_flow_monitor_flags_map = {
    1: 'OFPFMF_INITIAL',
    2: 'OFPFMF_ADD',
    4: 'OFPFMF_REMOVED',
    8: 'OFPFMF_MODIFY',
...
OFPG_BUCKET_MAX = 4294967040
OFPG_BUCKET_FIRST = 4294967293
OFPG_BUCKET_LAST = 4294967294
OFPG_BUCKET_ALL = 4294967295

ofp_group_bucket_map = {
...
OFPGBPT_EXPERIMENTER = 65535

ofp_group_bucket_prop_type_map = {
    0: 'OFPGBPT_WEIGHT',
...
OFPGPT_EXPERIMENTER = 65535

ofp_group_prop_type_map = {
...
OFPHTO_ETHERNET = 0
OFPHTO_NO_HEADER = 1
OFPHTO_OXM_EXPERIMENTER = 65535

ofp_header_type_onf_map = {
    0: 'OFPHTO_ETHERNET',
    1: 'OFPHTO_NO_HEADER',
...
OFPMFF_ACTION_SET = 1
OFPMFF_ANY_POSITION = 2
OFPMFF_MULTI_LIST = 4

ofp_meter_feature_flags_map = {
    1: 'OFPMFF_ACTION_SET',
...
OFPXSC_OPENFLOW_BASIC = 32770
OFPXSC_EXPERIMENTER = 65535
...
OFPPDPT_EXPERIMENTER = 65535

ofp_port_desc_prop_type_map = {
    0: 'OFPPDPT_ETHERNET',
    1: 'OFPPDPT_OPTICAL',
...
OFPPMPT_ETHERNET = 0
OFPPMPT_OPTICAL = 1
OFPPMPT_EXPERIMENTER = 65535

ofp_port_mod_prop_type_map = {
    0: 'OFPPMPT_ETHERNET',
    1: 'OFPPMPT_OPTICAL',
...
OFPQDPT_MIN_RATE = 1
OFPQDPT_MAX_RATE = 2
OFPQDPT_EXPERIMENTER = 65535

ofp_queue_desc_prop_type_map = {
    1: 'OFPQDPT_MIN_RATE',
    2: 'OFPQDPT_MAX_RATE',
...
OFPQSPT_EXPERIMENTER = 65535

ofp_queue_stats_prop_type_map = {
...
OFPRPT_EXPERIMENTER = 65535

ofp_role_prop_type_map = {
...
OFPTFF_INGRESS_TABLE = 1
OFPTFF_EGRESS_TABLE = 2
OFPTFF_FIRST_EGRESS = 16

ofp_table_feature_flag_map = {
...
ofp_table_features_command_map = {
    0: 'OFPTFC_REPLACE',
    1: 'OFPTFC_MODIFY',
    2: 'OFPTFC_ENABLE',
    3: 'OFPTFC_DISABLE',
...
OFPTMPT_EVICTION = 2
OFPTMPT_VACANCY = 3
OFPTMPT_EXPERIMENTER = 65535

ofp_table_mod_prop_type_map = {
    2: 'OFPTMPT_EVICTION',
    3: 'OFPTMPT_VACANCY',
