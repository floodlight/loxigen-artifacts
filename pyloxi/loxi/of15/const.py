...
# Identifiers from group ofp_bsn_module_eeprom_cmplnce_type
OFP_BSN_MODULE_EEPROM_COMPLIANCE_TYPE_UNSPECIFIED = 0
OFP_BSN_MODULE_EEPROM_COMPLIANCE_TYPE_CU_PASSIVE = 4
OFP_BSN_MODULE_EEPROM_COMPLIANCE_TYPE_CU_ACTIVE = 8

ofp_bsn_module_eeprom_cmplnce_type_map = {
...
OFP_BSN_MODULE_EEPROM_CU_COMPLIANCE_SFF_8431_APP_E = 1
OFP_BSN_MODULE_EEPROM_CU_COMPLIANCE_SFF_8431_LIMITING = 4
