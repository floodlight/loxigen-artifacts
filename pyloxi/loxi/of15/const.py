...
OFP_BSN_BFD_ENDPOINT_REMOTE_ADMINDOWN = 4
OFP_BSN_BFD_ENDPOINT_SESSION_ERROR = 5
...
ofp_bsn_bfd_endpoint_state_map = {
    ...
    4: 'OFP_BSN_BFD_ENDPOINT_REMOTE_ADMINDOWN',
    5: 'OFP_BSN_BFD_ENDPOINT_SESSION_ERROR',
}
