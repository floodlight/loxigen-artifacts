...
bsn_tlv.subtypes[182] = bum_packet
...
bsn_tlv.subtypes[184] = flow_class_id

class flow_classify_enable(bsn_tlv):
    type = 183
...
bsn_tlv.subtypes[183] = flow_classify_enable
