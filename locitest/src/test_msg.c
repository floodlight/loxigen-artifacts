...
static int
test_of_bsn_table_full_error_create_OF_VERSION_1_3(void)
{
    ...
    obj = of_bsn_table_full_error_new(OF_VERSION_1_3);
    TEST_ASSERT(obj != NULL);
    TEST_ASSERT(obj->version == OF_VERSION_1_3);
    TEST_ASSERT(obj->length == 272);
    TEST_ASSERT(obj->parent == NULL);
    TEST_ASSERT(obj->object_id == OF_BSN_TABLE_FULL_ERROR);

    of_header_wire_object_id_get(obj, &object_id);
    TEST_ASSERT(object_id == OF_BSN_TABLE_FULL_ERROR);

    /* Set up incrementing values for scalar members */
    value = of_bsn_table_full_error_OF_VERSION_1_3_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_bsn_table_full_error_OF_VERSION_1_3_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_bsn_table_full_error_create_OF_VERSION_1_4(void)
{
    of_bsn_table_full_error_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    obj = of_bsn_table_full_error_new(OF_VERSION_1_4);
    TEST_ASSERT(obj != NULL);
    TEST_ASSERT(obj->version == OF_VERSION_1_4);
    TEST_ASSERT(obj->length == 272);
    TEST_ASSERT(obj->parent == NULL);
    ...
    /* Set up incrementing values for scalar members */
    value = of_bsn_table_full_error_OF_VERSION_1_4_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_bsn_table_full_error_OF_VERSION_1_4_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
run_message_tests(void)
{
    ...
    RUN_TEST(of_bsn_table_full_error_create_OF_VERSION_1_3);
    ...
    RUN_TEST(of_bsn_table_full_error_create_OF_VERSION_1_4);
