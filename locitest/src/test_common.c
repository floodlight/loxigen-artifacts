...
test_ident_macros(void)
{
    ...
    TEST_ASSERT(flags == 0);
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_SFLOW_EGRESS_TEST(flags, OF_VERSION_1_3));
    value = OFP_BSN_PKTIN_FLAG_DHCPV6;
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_DHCPV6_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_DHCPV6_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_DHCPV6_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_DHCPV6_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_DHCPV6_SUPPORTED(OF_VERSION_1_4));

    flags = 0;
    OFP_BSN_PKTIN_FLAG_DHCPV6_SET(flags, OF_VERSION_1_3);
    TEST_ASSERT(flags == OFP_BSN_PKTIN_FLAG_DHCPV6_BY_VERSION(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_DHCPV6_TEST(flags, OF_VERSION_1_3));
    OFP_BSN_PKTIN_FLAG_DHCPV6_CLEAR(flags, OF_VERSION_1_3);
    TEST_ASSERT(flags == 0);
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_DHCPV6_TEST(flags, OF_VERSION_1_3));
    value = OFP_BSN_PKTIN_FLAG_IP_HELPER;
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_IP_HELPER_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_IP_HELPER_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_IP_HELPER_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_IP_HELPER_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_IP_HELPER_SUPPORTED(OF_VERSION_1_4));

    flags = 0;
    OFP_BSN_PKTIN_FLAG_IP_HELPER_SET(flags, OF_VERSION_1_3);
    TEST_ASSERT(flags == OFP_BSN_PKTIN_FLAG_IP_HELPER_BY_VERSION(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_IP_HELPER_TEST(flags, OF_VERSION_1_3));
    OFP_BSN_PKTIN_FLAG_IP_HELPER_CLEAR(flags, OF_VERSION_1_3);
    TEST_ASSERT(flags == 0);
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_IP_HELPER_TEST(flags, OF_VERSION_1_3));
    ...
    value = OFP_BSN_UDF_ANCHOR_TD3_L2_START;
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L2_START_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L2_START_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L2_START_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_UDF_ANCHOR_TD3_L2_START_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_UDF_ANCHOR_TD3_L2_START_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_UDF_ANCHOR_TD3_L3_IPV4_START_WITHOUT_OPTIONS;
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L3_IPV4_START_WITHOUT_OPTIONS_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L3_IPV4_START_WITHOUT_OPTIONS_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L3_IPV4_START_WITHOUT_OPTIONS_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_UDF_ANCHOR_TD3_L3_IPV4_START_WITHOUT_OPTIONS_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_UDF_ANCHOR_TD3_L3_IPV4_START_WITHOUT_OPTIONS_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_UDF_ANCHOR_TD3_L3_IPV6_START;
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L3_IPV6_START_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L3_IPV6_START_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_L3_IPV6_START_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_UDF_ANCHOR_TD3_L3_IPV6_START_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_UDF_ANCHOR_TD3_L3_IPV6_START_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_UDF_ANCHOR_TD3_UDP_UNKNOWN_L5_START;
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_UDP_UNKNOWN_L5_START_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_UDP_UNKNOWN_L5_START_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_UDF_ANCHOR_TD3_UDP_UNKNOWN_L5_START_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_UDF_ANCHOR_TD3_UDP_UNKNOWN_L5_START_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_UDF_ANCHOR_TD3_UDP_UNKNOWN_L5_START_SUPPORTED(OF_VERSION_1_4));
    ...
    value = OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_FIRE_CODE;
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_FIRE_CODE_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_FIRE_CODE_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_FIRE_CODE_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_FIRE_CODE_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_FIRE_CODE_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON;
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON544;
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_FORWARD_ERROR_CORRECTION_ENABLE_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_4));
    ...
    TEST_ASSERT(flags == 0);
    TEST_ASSERT(!OFP_BSN_LAG_FLAG_AUTO_RECOVERY_TEST(flags, OF_VERSION_1_3));
    value = OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY;
    TEST_ASSERT(!OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_SUPPORTED(OF_VERSION_1_4));

    flags = 0;
    OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_SET(flags, OF_VERSION_1_3);
    TEST_ASSERT(flags == OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_BY_VERSION(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_TEST(flags, OF_VERSION_1_3));
    OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_CLEAR(flags, OF_VERSION_1_3);
    TEST_ASSERT(flags == 0);
    TEST_ASSERT(!OFP_BSN_LAG_FLAG_ADD_PEER_ON_EMPTY_TEST(flags, OF_VERSION_1_3));
    ...
    value = OFP_BSN_PORT_MODE_8X50;
    TEST_ASSERT(!OFP_BSN_PORT_MODE_8X50_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_8X50_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_8X50_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PORT_MODE_8X50_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PORT_MODE_8X50_SUPPORTED(OF_VERSION_1_4));
    ...
    value = OFP_BSN_PORT_MODE_8X10;
    TEST_ASSERT(!OFP_BSN_PORT_MODE_8X10_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_8X10_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_8X10_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PORT_MODE_8X10_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PORT_MODE_8X10_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_PORT_MODE_4X100;
    TEST_ASSERT(!OFP_BSN_PORT_MODE_4X100_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_4X100_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_4X100_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PORT_MODE_4X100_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PORT_MODE_4X100_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_PORT_MODE_2X40;
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X40_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X40_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X40_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PORT_MODE_2X40_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PORT_MODE_2X40_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_PORT_MODE_2X100;
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X100_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X100_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X100_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PORT_MODE_2X100_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PORT_MODE_2X100_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_PORT_MODE_2X200;
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X200_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X200_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PORT_MODE_2X200_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PORT_MODE_2X200_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PORT_MODE_2X200_SUPPORTED(OF_VERSION_1_4));
    ...
    value = OFP_BSN_UDF_6X2_BYTES;
    TEST_ASSERT(!OFP_BSN_UDF_6X2_BYTES_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_UDF_6X2_BYTES_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_UDF_6X2_BYTES_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_UDF_6X2_BYTES_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_UDF_6X2_BYTES_SUPPORTED(OF_VERSION_1_4));
    ...
    value = OFP_BSN_PACKET_FIELD_SRC_MAC;
    TEST_ASSERT(!OFP_BSN_PACKET_FIELD_SRC_MAC_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PACKET_FIELD_SRC_MAC_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PACKET_FIELD_SRC_MAC_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PACKET_FIELD_SRC_MAC_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PACKET_FIELD_SRC_MAC_SUPPORTED(OF_VERSION_1_4));
    ...
    value = OFP_BSN_LAG_TYPE_OTHER;
    TEST_ASSERT(!OFP_BSN_LAG_TYPE_OTHER_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_LAG_TYPE_OTHER_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_LAG_TYPE_OTHER_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_LAG_TYPE_OTHER_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_LAG_TYPE_OTHER_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_LAG_TYPE_PEER;
    TEST_ASSERT(!OFP_BSN_LAG_TYPE_PEER_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_LAG_TYPE_PEER_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_LAG_TYPE_PEER_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_LAG_TYPE_PEER_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_LAG_TYPE_PEER_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_LAG_TYPE_SPINE;
    TEST_ASSERT(!OFP_BSN_LAG_TYPE_SPINE_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_LAG_TYPE_SPINE_SUPPORTED(OF_VERSION_1_1));
    ...
    value = OFP_BSN_SPEED_CAP_200GB;
    TEST_ASSERT(!OFP_BSN_SPEED_CAP_200GB_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_SPEED_CAP_200GB_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_SPEED_CAP_200GB_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_SPEED_CAP_200GB_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_SPEED_CAP_200GB_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_SPEED_CAP_400GB;
    TEST_ASSERT(!OFP_BSN_SPEED_CAP_400GB_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_SPEED_CAP_400GB_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_SPEED_CAP_400GB_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_SPEED_CAP_400GB_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_SPEED_CAP_400GB_SUPPORTED(OF_VERSION_1_4));
    ...
    value = OFP_BSN_MISC_CAP_FEC_FIRE_CODE;
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_MISC_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_MISC_CAP_FEC_REED_SOLOMON;
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_MISC_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_MISC_CAP_FEC_REED_SOLOMON544;
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_MISC_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_MISC_CAP_FEC_DISABLE;
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_MISC_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_MISC_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_4));
    ...
    value = OFP_BSN_EXT_CAP_FEC_FIRE_CODE;
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_EXT_CAP_FEC_FIRE_CODE_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_EXT_CAP_FEC_REED_SOLOMON;
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_EXT_CAP_FEC_REED_SOLOMON_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_EXT_CAP_FEC_REED_SOLOMON544;
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_EXT_CAP_FEC_REED_SOLOMON544_SUPPORTED(OF_VERSION_1_4));
    value = OFP_BSN_EXT_CAP_FEC_DISABLE;
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(!OFP_BSN_EXT_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_EXT_CAP_FEC_DISABLE_SUPPORTED(OF_VERSION_1_4));
...
test_dump_objs(void)
{
    ...
    obj = (of_object_t *)of_bsn_tlv_client_ll_addr_new(OF_VERSION_1_3);
    of_object_dump((loci_writer_f)fprintf, out, obj);
    of_object_delete(obj);
    ...
    obj = (of_object_t *)of_bsn_tlv_lag_type_new(OF_VERSION_1_3);
    of_object_dump((loci_writer_f)fprintf, out, obj);
    of_object_delete(obj);
    ...
    obj = (of_object_t *)of_bsn_tlv_no_drop_new(OF_VERSION_1_3);
    of_object_dump((loci_writer_f)fprintf, out, obj);
    of_object_delete(obj);
    ...
    obj = (of_object_t *)of_bsn_tlv_remote_id_new(OF_VERSION_1_3);
    of_object_dump((loci_writer_f)fprintf, out, obj);
    of_object_delete(obj);
    ...
    obj = (of_object_t *)of_bsn_tlv_client_ll_addr_new(OF_VERSION_1_4);
    of_object_dump((loci_writer_f)fprintf, out, obj);
    of_object_delete(obj);
    ...
    obj = (of_object_t *)of_bsn_tlv_lag_type_new(OF_VERSION_1_4);
    of_object_dump((loci_writer_f)fprintf, out, obj);
    of_object_delete(obj);
    ...
    obj = (of_object_t *)of_bsn_tlv_no_drop_new(OF_VERSION_1_4);
    of_object_dump((loci_writer_f)fprintf, out, obj);
    of_object_delete(obj);
    ...
    obj = (of_object_t *)of_bsn_tlv_remote_id_new(OF_VERSION_1_4);
    of_object_dump((loci_writer_f)fprintf, out, obj);
    of_object_delete(obj);
