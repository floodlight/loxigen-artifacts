...
test_ident_macros(void)
{
    ...
    TEST_ASSERT(flags == 0);
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_SFLOW_EGRESS_TEST(flags, OF_VERSION_1_3));
    value = OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET;
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_SUPPORTED(OF_VERSION_1_0));
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_SUPPORTED(OF_VERSION_1_1));
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_SUPPORTED(OF_VERSION_1_2));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_SUPPORTED(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_SUPPORTED(OF_VERSION_1_4));

    flags = 0;
    OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_SET(flags, OF_VERSION_1_3);
    TEST_ASSERT(flags == OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_BY_VERSION(OF_VERSION_1_3));
    TEST_ASSERT(OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_TEST(flags, OF_VERSION_1_3));
    OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_CLEAR(flags, OF_VERSION_1_3);
    TEST_ASSERT(flags == 0);
    TEST_ASSERT(!OFP_BSN_PKTIN_FLAG_DHCPV6_AGNET_TEST(flags, OF_VERSION_1_3));
