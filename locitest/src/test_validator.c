...
test_validate_all(void)
{
    ...
    {
        of_bsn_gentable_full_error_t *obj = of_bsn_gentable_full_error_new(OF_VERSION_1_3);
        of_message_t msg;
        of_bsn_gentable_full_error_OF_VERSION_1_3_populate(obj, 1);
        msg = OF_OBJECT_TO_MESSAGE(obj);
        TEST_ASSERT(of_validate_message(msg, of_message_length_get(msg)) == 0);
        of_bsn_gentable_full_error_delete(obj);
    }

    {
        of_bsn_gentable_error_t *obj = of_bsn_gentable_error_new(OF_VERSION_1_3);
        of_message_t msg;
        of_bsn_gentable_error_OF_VERSION_1_3_populate(obj, 1);
        msg = OF_OBJECT_TO_MESSAGE(obj);
        TEST_ASSERT(of_validate_message(msg, of_message_length_get(msg)) == 0);
    ...
    {
        of_bsn_gentable_full_error_t *obj = of_bsn_gentable_full_error_new(OF_VERSION_1_4);
        of_message_t msg;
        of_bsn_gentable_full_error_OF_VERSION_1_4_populate(obj, 1);
        msg = OF_OBJECT_TO_MESSAGE(obj);
        TEST_ASSERT(of_validate_message(msg, of_message_length_get(msg)) == 0);
        of_bsn_gentable_full_error_delete(obj);
    }
    ...
    {
        of_bsn_gentable_error_t *obj = of_bsn_gentable_error_new(OF_VERSION_1_4);
        of_message_t msg;
        of_bsn_gentable_error_OF_VERSION_1_4_populate(obj, 1);
        msg = OF_OBJECT_TO_MESSAGE(obj);
        TEST_ASSERT(of_validate_message(msg, of_message_length_get(msg)) == 0);
        of_bsn_gentable_error_delete(obj);
    }
