...
extern int of_bsn_gentable_full_error_OF_VERSION_1_3_populate(
    of_bsn_gentable_full_error_t *obj, int value);
extern int of_bsn_gentable_full_error_OF_VERSION_1_3_check(
    of_bsn_gentable_full_error_t *obj, int value);
extern int of_bsn_gentable_full_error_OF_VERSION_1_3_populate_scalars(
    of_bsn_gentable_full_error_t *obj, int value);
extern int of_bsn_gentable_full_error_OF_VERSION_1_3_check_scalars(
    of_bsn_gentable_full_error_t *obj, int value);
...
extern int of_bsn_gentable_full_error_OF_VERSION_1_4_populate(
    of_bsn_gentable_full_error_t *obj, int value);
extern int of_bsn_gentable_full_error_OF_VERSION_1_4_check(
    of_bsn_gentable_full_error_t *obj, int value);
extern int of_bsn_gentable_full_error_OF_VERSION_1_4_populate_scalars(
    of_bsn_gentable_full_error_t *obj, int value);
extern int of_bsn_gentable_full_error_OF_VERSION_1_4_check_scalars(
    of_bsn_gentable_full_error_t *obj, int value);
