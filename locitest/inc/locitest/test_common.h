...
extern int of_port_desc_prop_bsn_ethtool_OF_VERSION_1_4_check(
    of_port_desc_prop_bsn_ethtool_t *obj, int value);
extern int of_port_desc_prop_bsn_ethtool_OF_VERSION_1_4_populate_scalars(
    of_port_desc_prop_bsn_ethtool_t *obj, int value);
extern int of_port_desc_prop_bsn_ethtool_OF_VERSION_1_4_check_scalars(
    of_port_desc_prop_bsn_ethtool_t *obj, int value);
